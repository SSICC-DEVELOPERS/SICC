...
@Entity
@Table(name="APE_HISTO_LISTA_PICAD_ERRSF")
@NamedQueries({
@NamedQuery(name="HistoricoListaPicadoErrorSFLocal.FindAll",query="select object(o) from HistoricoListaPicadoErrorSFLocal o")
})
public class HistoricoListaPicadoErrorSFLocal implements Serializable {

    public HistoricoListaPicadoErrorSFLocal() {}

    public HistoricoListaPicadoErrorSFLocal(Long oid, Long codigoPosicion, Long unidadesProducto,
            ...
            Long producto, Long sistemaPicado, String obsRevision, Long codigoError) {
        ...
        setObservacionesRevision(obsRevision);
        setCodigoError(codigoError);
    }

    @Id
    @Column(name="OID_HLPE")
    private Long oid;
    @Column(name="COD_POSI")
