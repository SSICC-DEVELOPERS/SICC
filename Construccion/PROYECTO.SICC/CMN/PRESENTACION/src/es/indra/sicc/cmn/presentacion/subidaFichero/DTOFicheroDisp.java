...
public class DTOFicheroDisp extends DTOAuditableSICC {
    ...
    public DTOFicheroDisp(String filePath, String fileName, String description, String typeProc, Object data) {
        super();
