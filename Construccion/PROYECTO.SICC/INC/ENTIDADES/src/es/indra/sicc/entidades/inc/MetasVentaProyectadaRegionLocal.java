...
@Entity
@Table(name="INC_METAS_VENTA_PROYE_REGIO")
@NamedQueries({
@NamedQuery(name="MetasVentaProyectadaRegionLocal.FindAll",query="select object(o) from MetasVentaProyectadaRegionLocal o"),
@NamedQuery(name="MetasVentaProyectadaRegionLocal.FindByConcurso",query="SELECT OBJECT(a) FROM MetasVentaProyectadaRegionLocal AS a WHERE a.concurso = ?1"),
@NamedQuery(name="MetasVentaProyectadaRegionLocal.FindByUk",query="select OBJECT (a) "
+ " from MetasVentaProyectadaRegionLocal as a "
+ " where a.periodoCalculado = ?1 "
+ " and a.cliente = ?2 "
+ " and a.concurso= ?3 "
+ " and a.region = ?4")
})
public class MetasVentaProyectadaRegionLocal implements Serializable {

	public MetasVentaProyectadaRegionLocal() {}

	public MetasVentaProyectadaRegionLocal(Long oid, Integer valAnioCome, Integer numActiInic, Integer numActiFina, Integer impIngr, Integer impRein, Integer impEgre, Integer numOrde, Integer numPedi, Integer numUnidVend, Integer numClie, BigDecimal impVentNetaEsta, Long zorgOidRegi, Long clieOidClie, Long copaOidParaGral, Long perdOidPeri)	{
	...
	@Id
	@Column(name="OID_META_VENT_PROY_REGI")
	private Long oid;
