...
@Entity
@Table(name="INC_RESUL_VENTA_PROYE_SUBGE")
@NamedQueries({
@NamedQuery(name="ResultadosVentaProyectadaSubgeLocal.FindAll",query="select object(o) from ResultadosVentaProyectadaSubgeLocal o")
})
public class ResultadosVentaProyectadaSubgeLocal implements Serializable {

	public ResultadosVentaProyectadaSubgeLocal() {}

	public ResultadosVentaProyectadaSubgeLocal(Long oid, Integer activasIniciales, Integer activasFinales,Integer ingresos, Integer reingresos,Integer egresos, Integer numeroOrdenes, Integer numeroPedidos,BigDecimal ventaNetaEstadisticable, Long meta, Long periodoCalculado)	{
	...
	@Id
	@Column(name="OID_RESU_VENT_PROY_SUBG")
	private Long oid;
	...
	@Column(name="MVPS_OID_META_VENT_PROY_SUBG")
	private Long meta;
