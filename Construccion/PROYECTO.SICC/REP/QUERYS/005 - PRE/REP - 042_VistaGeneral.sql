SELECT 
	  I18PAIS.VAL_I18N PAIS, I18CANAL.VAL_I18N CANAL, MARCA.DES_MARC as MARCA, PERI.VAL_NOMB_PERI as CAMPANIA,   
	  OFEDET.VAL_CODI_VENT, PROD.COD_SAP, I18PROD.VAL_I18N as DESC_PROD, I18EST.VAL_I18N ESTRATEGIA,   
	  CVIDA.COD_CICL_VIDA || ' / ' || TOFE.COD_TIPO_OFER AS CICLO_OFERTA,
	  CAT.COD_CATA,
	  ...
	  ACC.COD_ACCE, OFEDET.IMP_PREC_CATA, OFEDET.IMP_PREC_POSI
FROM
	  CRA_PERIO PERI,
	  PRE_OFERT OFE,
...
/*	  AND PERI.OID_PERI = 57		 		   -- PARAMETRO --
	  AND OFE.ACCE_OID_ACCE IN (4)					   -- PARAMETRO --
...
/*	  AND ES.TIES_OID_TIPO_ESTR = 3				   -- PARAMETRO --
	  ...
	  AND CAT.OID_CATA IN (69)	   	  				   -- PARAMETRO --
	  AND OFEDET.NUM_PAGI_CATA >= 1				   -- PARAMETRO --
	  AND OFEDET.NUM_PAGI_CATA <= 10			   -- PARAMETRO --
	  AND OFE.FOPA_OID_FORM_PAGO IN (7)			   -- PARAMETRO --
*/ORDER BY
