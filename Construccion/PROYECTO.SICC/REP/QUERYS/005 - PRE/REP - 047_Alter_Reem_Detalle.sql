(
	...
	FROM
		...
		SELECT 
			  ...
			  OFEDET.IMP_PREC_CATA, I18EST.VAL_I18N ESTRAT, OFEDET.VAL_FACT_REPE, PERI.VAL_NOMB_PERI, 
	...
	WHERE
		...
		AND ALTERN.VAL_CODI_VENT >= 1 
		AND ALTERN.VAL_CODI_VENT <= 9999999 
)
UNION ALL
(
	SELECT 
