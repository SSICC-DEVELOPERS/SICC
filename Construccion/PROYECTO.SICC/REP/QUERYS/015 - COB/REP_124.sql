SELECT CLI.COD_CLIE COD_CONS,
	   ...
	   ASI_COB.IMP_DEUD_ASIG IMPORTE,
	   ASI_COB.IMP_DEUD_ASIG - ASI_COB.IMP_DEUD_CANC SALDO,
	   NVL(PQ_APL_REP.FN_CU_CALC_SALDO_CTA_CTE(CLI.PAIS_OID_PAIS, CLI.OID_CLIE), 0) DEUDA_TOTAL,
	   NVL(CLI_DAT.IMP_MONT_LINE_CRED, 0) - NVL(PQ_APL_REP.FN_CU_CALC_SALDO_CTA_CTE(CLI.PAIS_OID_PAIS, CLI.OID_CLIE), 0) LINEA_DISPONIBLE,
	   NVL(CLI_DAT.IMP_MONT_LINE_CRED, 0) LINEA_CREDITO 
FROM MAE_CLIEN CLI,
