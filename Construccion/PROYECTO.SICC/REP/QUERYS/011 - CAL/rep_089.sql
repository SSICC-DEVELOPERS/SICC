SELECT  VAL_I18N PAIS, DES_REGI, VAL_NOMB_PERI, DES_ZONA, POSTULANTES, ATEN_RETRASO, ATEN_A_TIEMPO, ELIMINADAS, CONSULTORAS,
...
FROM
(
SELECT VAL_I18N, MARC_OID_MARC, CANA_OID_CANA, COD_REGI, COD_ZONA, OID_TIPO_CLIE, DES_REGI, VAL_NOMB_PERI, DES_ZONA,
...
FROM(
	SELECT GEN_PAIS.VAL_I18N, CON.OID_CONT, REG.MARC_OID_MARC, REG.CANA_OID_CANA, REG.COD_REGI, ZON.COD_ZONA, REG.DES_REGI, 
	 ...
	 FROM ZON_REGIO REG,
          ...
          (
          SELECT CRA.FEC_INIC, CRA.FEC_FINA, VAL_NOMB_PERI, CRA.OID_PERI -- DE LA TABLA CRA_PERIO SELECCIONO FECHA DE INICIO Y FECHA DE FIN, FILTRANDO POR PAIS, MARCA, CANAL Y PERIODO --
   		  FROM CRA_PERIO CRA
