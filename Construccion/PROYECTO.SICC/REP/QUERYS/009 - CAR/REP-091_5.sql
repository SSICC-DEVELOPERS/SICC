...
ORDER BY
	  PERI.VAL_NOMB_PERI,  
 	  GEN_ESTADO_FINAL.ESTADO_FINAL,
	  SOL_ENTR.FEC_DOCU,
	  (DECODE(SOL_ENTR.IND_VALI_1,1,'B1 ','') || DECODE(SOL_ENTR.IND_VALI_2,1,'B2 ','') || DECODE(SOL_ENTR.IND_VALI_3,1,'B3 ','') || DECODE(SOL_ENTR.IND_VALI_4,1,'B4 ',''))
	  SOL_ENTR.EJCU_OID_USUA_LIBE	  
