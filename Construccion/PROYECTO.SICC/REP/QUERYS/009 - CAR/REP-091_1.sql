SELECT 
	  ...
	  USUARIO_LIBERACION.NOMBREUSUARIO AS EJCU_OID_USUA_LIBE
FROM
...
--	  AND (DECODE(SOL_ENTR.IND_VALI_1,1,'B1 ','') || DECODE(SOL_ENTR.IND_VALI_2,1,'B2 ','') || DECODE(SOL_ENTR.IND_VALI_3,1,'B3 ','') || DECODE(SOL_ENTR.IND_VALI_4,1,'B4 ','')) like '%B2%'
