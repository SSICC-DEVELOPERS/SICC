...
@Entity
@Table(name="DTO_BASE_APLIC_DETAL")
public class BaseAplicacionDetalleLocal implements Serializable {

	public BaseAplicacionDetalleLocal() {}

	public BaseAplicacionDetalleLocal(Long oid, Long oidCicloVida, Long oidCabecera, Long oidSuperGenerico, 
                                            Long oidProducto, Long oidGenerico, Long oidMarcaProducto, Long oidUnidadNegocio, 
                                            Long oidNegocio, Long oidTipoOferta) {
	
		this.oid=oid;
                this.civi_oid_cicl_vida = oidCicloVida;
                this.baca_oid_cabe = oidCabecera;
