...
@Entity
@Table(name="DTO_VALOR_PARAM_BOOLE")
public class ParametroBooleanLocal implements Serializable {

	public ParametroBooleanLocal() {}

	public ParametroBooleanLocal(Long oid, Long ind_valo_defe, Long val_para, Long ptdt_para_tipo_desc)	{
            this.oid=oid;
	...
	public Long getVal_para() {return val_para;}
      
	public void setVal_para(Long val_para){this.val_para=val_para;}
