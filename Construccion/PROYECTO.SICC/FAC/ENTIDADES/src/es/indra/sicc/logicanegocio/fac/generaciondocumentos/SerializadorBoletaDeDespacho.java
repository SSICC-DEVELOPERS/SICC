...
public class SerializadorBoletaDeDespacho extends FixedDocument implements ISerializableDocument
{
  public SerializadorBoletaDeDespacho()
  {
  ...
  public void rellenarTabla(Hashtable documento)
    {
        UtilidadesLog.info("SerializadorBoletaDeDespacho.rellenarTabla(Hashtable documento): Entrada");
        ...
        UtilidadesLog.info("SerializadorBoletaDeDespacho.rellenarTabla(Hashtable documento): Salida");
   
    }   
    
    // Modificado por la BELC300016798 
    public void componerDocumento() {
        UtilidadesLog.info("SerializadorBoletaDeDespacho.componerDocumento(): Entrada");
        ...
        UtilidadesLog.info("SerializadorBoletaDeDespacho.componerDocumento(): Salida");
    } 
