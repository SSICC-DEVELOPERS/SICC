...
public class SerializadorBoletaRecojoColombia extends FixedDocument implements ISerializableDocument {

    public SerializadorBoletaRecojoColombia() {
   ...
   public void rellenarTabla(Hashtable documento) {
        UtilidadesLog.info("SerializadorBoletaRecojoColombia.rellenarTabla(Hashtable documento): Entrada");
        ...
        UtilidadesLog.info("SerializadorBoletaRecojoColombia.rellenarTabla(Hashtable documento): Salida");
   
    }       
    
    public void componerDocumento() {
        UtilidadesLog.info("SerializadorBoletaRecojoColombia.componerDocumento(): Entrada");
        ...
        UtilidadesLog.info("SerializadorBoletaRecojoColombia.componerDocumento(): Salida");
    }   
