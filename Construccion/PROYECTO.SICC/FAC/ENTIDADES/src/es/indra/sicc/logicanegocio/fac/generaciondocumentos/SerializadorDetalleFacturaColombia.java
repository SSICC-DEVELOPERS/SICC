...
public class SerializadorDetalleFacturaColombia extends FixedDocument implements ISerializableDocument  {

    public SerializadorDetalleFacturaColombia() {
        ...
        UtilidadesLog.info("SerializadorDetalleFacturaColombia.rellenarTabla(Hashtable documento): Entrada");
        ...
        UtilidadesLog.info("SerializadorDetalleFacturaColombia.rellenarTabla(Hashtable documento): Salida");
   
    }       
    
    public void componerDocumento() {
        UtilidadesLog.info("SerializadorDetalleFacturaColombia.componerDocumento(): Entrada");
        ...
        UtilidadesLog.info("SerializadorDetalleFacturaColombia.componerDocumento(): Salida");
    }   
