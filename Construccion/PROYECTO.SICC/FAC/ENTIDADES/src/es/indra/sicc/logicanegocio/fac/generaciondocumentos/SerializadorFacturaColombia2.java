...
public class SerializadorFacturaColombia2 extends FixedDocument implements ISerializableDocument   {
    
    public SerializadorFacturaColombia2() {
     ...
     public void rellenarTabla(Hashtable documento) {
        UtilidadesLog.info("SerializadorFacturaColombia1.rellenarTabla(Hashtable documento): Entrada");
        ...
        UtilidadesLog.info("SerializadorFacturaColombia1.rellenarTabla(Hashtable documento): Salida");   
    }   
    
    public void componerDocumento() {
        UtilidadesLog.info("SerializadorFacturaColombia1.componerDocumento(): Entrada");
        ...
        UtilidadesLog.info("SerializadorFacturaColombia1.componerDocumento(): Salida");
    } 
