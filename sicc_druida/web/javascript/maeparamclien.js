...
/*
    INDRA/CAR/mmg
    $Id: maeparamclien.js,v 1.1 2009/12/03 19:02:14 pecbazalar Exp $
    DESC
*/
...
accionesFoco.cargar([[2,'','','','','',''],[3,'','focaliza("maeParamClienFrm.codTipoAsig");','focaliza("maeParamClienFrm.codTipoAsig");','','focaliza("maeParamClienFrm.codTipoAsig");','focaliza("maeParamClienFrm.codTipoAsig");']]);
...
accionesFocoModificacion.cargar([[3,'','focaliza("maeParamClienFrm.codTipoAsig");','focaliza("maeParamClienFrm.codTipoAsig");','','focaliza("maeParamClienFrm.codTipoAsig");','focaliza("maeParamClienFrm.codTipoAsig");']]);
...
function maeParamClienInitComponents(){
	...
	//alert('accion :' + get('maeParamClienFrm.accion'));
...
function maeParamClienUpdateInitComponents(){
	...
	if(get('maeParamClienFrm.origen') == "pagina"){
		...
		setMV('maeParamClienFrm.codTipoAsig','S', GestionarMensaje('MaeParamClien.codTipoAsig.requiered.message'));
			...
			focusFirstFieldModify('maeParamClienFrm', true);
	}else{
		//Los campos de los atributos de tipo list los desactivamos
...
function maeParamClienPostQueryActions(datos){
	...
	maeParamClienLastQuery = generateQuery();
	...
	for(var i=0; i < datosTmp.longitud; i++){ 
		switch(datosTmp.ij(i, 1)){
			case 'M': datosTmp.ij2(GestionarMensaje('MaeParamClien.codTipoAsig.M.value'), i, 1); break;
			case 'A': datosTmp.ij2(GestionarMensaje('MaeParamClien.codTipoAsig.A.value'), i, 1); break;
...
function maeParamClienUpdateSelection(){
	...
	if(validacion){
		...
		var result = mostrarModalSICC('MaeParamClienLPStartUp', get('maeParamClienFrm.accion'), parametros, null, null);
...
function maeParamClienViewDetail(idRegistro){
	...
	mostrarModalSICC('MaeParamClienLPStartUp', 'view', parametros, null, null);
}
...
function Limpiar(){
	...
	if(get('maeParamClienFrm.paisOidPais').toString() == ''){
		set('maeParamClienFrm.paisOidPais', []);
		mmgResetCombosOnCascade('paisOidPais', 'paisOidPais', 'maeParamClien');
