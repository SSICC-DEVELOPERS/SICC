...
/*
    INDRA/CAR/mmg
    $Id: maeconficampo_old.js,v 1.1 2009/12/03 19:02:02 pecbazalar Exp $
    DESC
*/
...
var maeConfiCampoChoiceColumn = 5;
...
accionesFoco.cargar([[1,'focalizaComboDependence("maeConfiCampo","sbtiOidSubtClie", false);','focalizaComboDependence("maeConfiCampo","sbtiOidSubtClie", false);','','focalizaComboDependence("maeConfiCampo","sbtiOidSubtClie", true);','focalizaComboDependence("maeConfiCampo","sbtiOidSubtClie", true);',''],[2,'focalizaComboDependence("maeConfiCampo","atreOidAtriEspe", false);','focalizaComboDependence("maeConfiCampo","atreOidAtriEspe", false);','','focalizaComboDependence("maeConfiCampo","atreOidAtriEspe", true);','focalizaComboDependence("maeConfiCampo","atreOidAtriEspe", true);',''],[3,'focaliza("maeConfiCampoFrm.indObli");','focaliza("maeConfiCampoFrm.indObli");','focaliza("maeConfiCampoFrm.indObli");','focaliza("maeConfiCampoFrm.indObli");','focaliza("maeConfiCampoFrm.indObli");','focaliza("maeConfiCampoFrm.indObli");'],[4,'focaliza("maeConfiCampoFrm.indModi");','focaliza("maeConfiCampoFrm.indModi");','focaliza("maeConfiCampoFrm.indModi");','focaliza("maeConfiCampoFrm.indModi");','focaliza("maeConfiCampoFrm.indModi");','focaliza("maeConfiCampoFrm.indModi");'],[5,'focaliza("maeConfiCampoFrm.valDefe");','focaliza("maeConfiCampoFrm.valDefe");','focaliza("maeConfiCampoFrm.valDefe");','focaliza("maeConfiCampoFrm.valDefe");','focaliza("maeConfiCampoFrm.valDefe");','focaliza("maeConfiCampoFrm.valDefe");'],[7,'','','','','','']]);
...
padresTmp =  new Vector();
padresTmp.cargar(['paisOidPais_moneOidMoneAlt','paisOidPais_fopaOidFormPago','paisOidPais_moneOidMone'])
...
function maeConfiCampoCreateInitComponents(){
	...
	setMV('maeConfiCampoFrm.sbtiOidSubtClie','S', GestionarMensaje('MaeConfiCampo.sbtiOidSubtClie.requiered.message'));
	...
	setMV('maeConfiCampoFrm.valDefe','S', GestionarMensaje('MaeConfiCampo.valDefe.requiered.message'));
...
function maeConfiCampoCmdQuery(pageNumber){
	...
	maeConfiCampoLastQuery = parametros;
...
function maeConfiCampoCmdRequery(){
	...
	set('maeConfiCampoFrm.indObli', (paramsRequery.ij(i++) == 'true'? 'S': 'N'));
...
function maeConfiCampoPostQueryActions(datos){
	...
	if(datos.length == 0){
		...
		visibilidad('maeConfiCampoPreListLayer', 'O');
	...
	maeConfiCampoList.setDatos(datosTmp.filtrar([0,1,2,3,4,5],'*'));
	
	//La última fila de datos representa a los timestamps que debemos guardarlos
	maeConfiCampoTimeStamps = datosTmp.filtrar([6],'*');
	...
	visibilidad('maeConfiCampoPreListLayer', 'V');
...
function maeConfiCampoUpdateSelection(){
	...
	if(validacion){
		/*set('maeConfiCampoFrm.previousAction', 'update');
		set('maeConfiCampoFrm.ON', 'MaeConfiCampoLPStartUp');
		set('maeConfiCampoFrm.conectorAction', 'MaeConfiCampoLPStartUp');
		set('maeConfiCampoFrm.origen', 'pagina');
		...
		var result = mostrarModalSICC('MaeConfiCampoLPStartUp', get('maeConfiCampoFrm.accion'), parametros, null, sizeFormView + 30);
...
function maeConfiCampoViewSelection(){
	...
	//ido al view
	set('maeConfiCampoFrm.previousAction', get('maeConfiCampoFrm.accion'));
	set('maeConfiCampoFrm.accion', 'view');
	set('maeConfiCampoFrm.origen', 'pagina');
	set('maeConfiCampoFrm.ON', 'MaeConfiCampoLPStartUp');
...
function maeConfiCampoViewDetail(idRegistro){
	...
	parametros["accion"] = get('maeConfiCampoFrm.accion');
	parametros["origen"] = 'pagina';
	mostrarModalSICC('MaeConfiCampoLPStartUp', get('maeConfiCampoFrm.accion'), parametros, null, sizeFormView + 30);
}
...
function Guardar(){
	...
	if(validacion)envia('maeConfiCampoFrm');
}
...
function Volver(){
	...
	if(accionTmp == 'update' && origenTmp == 'pagina'){
		...
		set('maeConfiCampoFrm.performRequery', 'true');
		set('maeConfiCampoFrm.accion', 
			get('maeConfiCampoFrm.previousAction'));
		set('maeConfiCampoFrm.origen', 'menu');
		set('maeConfiCampoFrm.ON', 'MaeConfiCampoLPStartUp');
		set('maeConfiCampoFrm.conectorAction', 'MaeConfiCampoLPStartUp');
...
function generateQuery(){
	...
	jsMaeConfiCampoAtreOidAtriEspe = get('maeConfiCampoFrm.atreOidAtriEspe')[0];
		...
		if(get('maeConfiCampoFrm.indObli').toString() == 'S') jsMaeConfiCampoIndObli = "true";
		else jsMaeConfiCampoIndObli = "false";
...
function populateJs2Form(){
	...
	set('maeConfiCampoFrm.atreOidAtriEspe', [jsMaeConfiCampoAtreOidAtriEspe]);
		...
		if(jsMaeConfiCampoIndObli == "true") set('maeConfiCampoFrm.indObli', 'S');
		else set('maeConfiCampoFrm.indObli', 'N');
