		  ...
		  case '1024': return cdos_mostrarAlert("El campo N° tipo hasta debe ser un numero entero");break;
				  ...
				  case '1050': return "Empresa"; break;
                    ...
                    case '1080': return cdos_mostrarAlert("Debe ingresar una clasificación completa."); break;    
						...
						case '1584': return cdos_mostrarAlert("No se pueden guardar premios consuelo sin especificar el campo mensaje"); break;
					...
					case 'UICAR004': return cdos_mostrarAlert("Monto de la orden Desde es mayor que el campo Monto de la orden hasta");break;
    	   ...
    	   case 'UIZON006': return cdos_mostrarAlert("Esta UA no tiene responsable asignado"); break;
			...
			//BELC300021669
			case 'REC023': return cdos_mostrarAlert("No autorizado para realizar transacciones sobre registro."); break;
			
			//BELC300021620
			case 'REC024': return cdos_mostrarAlert("El producto " + arg1 + " ya ha sido ingresado"); break;
			...
			//	Agregado por Sapaza - Fecha 16/12/2010 - PER-SiCC-2010-0699
			case 'carga.valido.errores': return cdos_mostrarConfirm("Hay registros con error en el archivo. Solo se cargaran los registros válidos. ¿Desea proceder?");
			case 'carga.valido.valido': return cdos_mostrarConfirm("¿Está seguro de cargar los registros?");
			
			case 'error.codigoRegionVacio': return "Columna Region esta vacia"; 
			case 'error.codigoZonaVacio': return "Columna Zona esta vacia";
			case 'error.unidadesVacio': return "Columna Unidades esta vacia";
			case 'error.noRegistroFila': return "Fila no tiene ningún dato";
			case 'error.noExisteRegion': return "No existe la region";
			case 'error.noExisteZona': return "No existe la zona";
			case 'error.noFormatoNumeroUnidades': return "No tiene formato de unidades válido";
			
			case 'error.codigoPaisVacio': return "Columna CodigoPaís esta vacia";
			case 'error.codigoClienteVacio': return "Columna Codigo Cliente esta vacia";
			case 'error.paisNoActivo': return "Codigo País no esta activo";
			case 'error.noExisteConsultora': return "No existe la consultora";
			case 'error.existenDuplicados': return "Existe clientes duplicados en el archivo";

			case '3385': return cdos_mostrarConfirm("¿El concurso seleccionado se encuentra vigente, Desea modificarlo?"); break;
			
			//	Agregado por Sapaza - Fecha 02/08/2011 - PER-SiCC-2010-0544
			case '3386': return cdos_mostrarAlert("No se puede realizar Cierre de Zona, no existen zonas aprobadas para cerrar para la campaña y fecha indicada"); break;
			case '3387': return cdos_mostrarAlert("No se puede realizar Cierre de Región, no existen regiones aprobadas para cerrar para la campaña y fecha indicada"); break;
			case '3388': return cdos_mostrarAlert("No se puede realizar Cierre de Campaña, no existe campaña aprobada para cerrar"); break;
			
			case '3389': return cdos_mostrarAlert("No puede modificar producto debido a que el producto actual ya ha sido atendido"); break;
			case '3390': return cdos_mostrarAlert("Reemplazo ya  tiene atenciones, no puede eliminar"); break;
			
			//	Agregado por Sapaza - Fecha 16/05/2012 - PER-SiCC-2012-0082
			case '3391': return cdos_mostrarAlert("El Concurso es MultiMarca, el Ind Agrupación debe tener el valor de Obligatorio"); break;

			//	Agregado por Sapaza - Fecha 04/04/2013 - PER-SiCC-2013-0355
			case '3392': return cdos_mostrarAlert("El precio contable debe ser mayor a cero"); break;
			
			//	Agregado por Sapaza - Fecha 04/04/2013 - PER-SiCC-2013-0355
			case '3393': return cdos_mostrarAlert("No existe el parámetro del Precio Catalogo"); break;
  }
}
