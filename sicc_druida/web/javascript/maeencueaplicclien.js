...
/*
    INDRA/CAR/mmg
    $Id: maeencueaplicclien.js,v 1.1 2009/12/03 19:02:04 pecbazalar Exp $
    DESC
*/
...
var maeEncueAplicClienChoiceColumn = 2;
...
accionesFoco.cargar([[2,'focalizaComboDependence("maeEncueAplicClien","clieOidClie", false);','focalizaComboDependence("maeEncueAplicClien","clieOidClie", false);','focalizaComboDependence("maeEncueAplicClien","clieOidClie", false);','focalizaComboDependence("maeEncueAplicClien","clieOidClie", true);','focalizaComboDependence("maeEncueAplicClien","clieOidClie", true);','focalizaComboDependence("maeEncueAplicClien","clieOidClie", true);'],[4,'focalizaComboDependence("maeEncueAplicClien","reenOidResp", false);','focalizaComboDependence("maeEncueAplicClien","reenOidResp", false);','focalizaComboDependence("maeEncueAplicClien","reenOidResp", false);','focalizaComboDependence("maeEncueAplicClien","reenOidResp", true);','focalizaComboDependence("maeEncueAplicClien","reenOidResp", true);','focalizaComboDependence("maeEncueAplicClien","reenOidResp", true);']]);
...
accionesFocoModificacion.cargar([[4,'focalizaComboDependence("maeEncueAplicClien","reenOidResp", false);','focalizaComboDependence("maeEncueAplicClien","reenOidResp", false);','focalizaComboDependence("maeEncueAplicClien","reenOidResp", false);','focalizaComboDependence("maeEncueAplicClien","reenOidResp", true);','focalizaComboDependence("maeEncueAplicClien","reenOidResp", true);','focalizaComboDependence("maeEncueAplicClien","reenOidResp", true);']]);
...
padresTmp =  new Vector();
padresTmp.cargar([])
reenOidRespDependeceMap.agregar(['reenOidResp_prenOidPreg', padresTmp, 'reenOidResp', 'MaePreguEncue']);
padresTmp =  new Vector();
padresTmp.cargar(['reenOidResp_prenOidPreg'])
...
function maeEncueAplicClienInitComponents(){
	...
	//alert('accion :' + get('maeEncueAplicClienFrm.accion'));
...
function maeEncueAplicClienUpdateInitComponents(){
	...
	if(get('maeEncueAplicClienFrm.origen') == "pagina"){
		...
		setMV('maeEncueAplicClienFrm.reenOidResp','S', GestionarMensaje('MaeEncueAplicClien.reenOidResp.requiered.message'));
			...
			focusFirstFieldModify('maeEncueAplicClienFrm', true);
	}else{
		//Los campos de los atributos de tipo list los desactivamos
...
function maeEncueAplicClienPostQueryActions(datos){
	...
	maeEncueAplicClienLastQuery = generateQuery();
	...
	maeEncueAplicClienList.setDatos(datosTmp.filtrar([0,1,2],'*'));
	
	//La última fila de datos representa a los timestamps que debemos guardarlos
	maeEncueAplicClienTimeStamps = datosTmp.filtrar([3],'*');
...
function maeEncueAplicClienUpdateSelection(){
	...
	if(validacion){
		...
		var result = mostrarModalSICC('MaeEncueAplicClienLPStartUp', get('maeEncueAplicClienFrm.accion'), parametros, null, null);
...
function maeEncueAplicClienRemoveSelection(){
	...
	maeEncueAplicClienFrm.oculto='S';
...
function maeEncueAplicClienViewDetail(idRegistro){
	...
	mostrarModalSICC('MaeEncueAplicClienLPStartUp', 'view', parametros, null, null);
}
...
function Limpiar(){
	...
	if(get('maeEncueAplicClienFrm.clieOidClie').toString() == ''){
		set('maeEncueAplicClienFrm.clieOidClie', []);
		mmgResetCombosOnCascade('clieOidClie', 'clieOidClie', 'maeEncueAplicClien');
		
	}
	if(get('maeEncueAplicClienFrm.reenOidResp').toString() == ''){
		set('maeEncueAplicClienFrm.reenOidResp_prenOidPreg', []);
		mmgResetCombosOnCascade('reenOidResp_prenOidPreg', 'reenOidResp', 'maeEncueAplicClien');
...
function resetJsAttributeVars(){
	...
	jsMaeEncueAplicClienClieOidClie = '';
	jsMaeEncueAplicClienReenOidResp = '';
