    ...
    <tr>      
	  ...
	  <table width="582" border="1" cellspacing="1" cellpadding="0" bordercolor="#CCCCCC">
	    ...
	    <td class="tablaTitle">
          ...
          <tr>
	    <td class="tablaTitle">
	      <BOTON nombre="btnAniadirCond" tipo="html" accion="javascript:aniadirCondicion();"  ID="botonContenido"
...
<xsl:template match="ROWSET">
	...
	<xsl:sort select="CAMPO[@NOMBRE='NUM_COND']"/>
	  ...
	  <table width="98%" border="1" cellspacing="1" cellpadding="0" align="center" bordercolor="#CCCCCC">
	   ...
	   <tr>
	   <td class="tablaTitle">
		   <BOTON nombre="btnModificarCond_{CAMPO[@NOMBRE='NUM_COND']}" tipo="html" accion="javascript:modificarCondicion('{CAMPO[@NOMBRE='NUM_COND']}','{CAMPO[@NOMBRE='INDC_COD_CUAD']}|{CAMPO[@NOMBRE='COD_FACT_CUAD']}');"  ID="botonContenido"
                     estado="false"  cod="142"/>

	           <BOTON nombre="btnEliminarCond_{CAMPO[@NOMBRE='NUM_COND']}" tipo="html" accion="javascript:eliminarCondicion('{CAMPO[@NOMBRE='NUM_COND']}');"  ID="botonContenido"
...
<xsl:template match="ROW">
	...
	<LISTA seleccion="boton" nombre="lstCondicion_{CAMPO[@NOMBRE='NUM_COND']}"  
	  ...
	  <PRESENTACION ancho = "1150" filas = "1"	bloquesid = "['datosCamposCenterImpar',	'datosCamposCenterPar',
	  ...
	  <xsl:sort select="CAMPO[@NOMBRE='DES_CATA']" />
			...
			<xsl:value-of select="CAMPO[position()=5]"/>--<xsl:value-of select="CAMPO[position()=8]"/>--<xsl:value-of select="CAMPO[position()=7]"/>
		    </CAMPO>	  	    
      ...
      <tr>
      <td class="tablaTitle" colspan="3">
	<BOTON nombre="btnEliminaLineaCond" tipo="html" accion="javascript:eliminarLineaCondicion('{CAMPO[@NOMBRE='NUM_COND']}','lstCondicion_{CAMPO[@NOMBRE='NUM_COND']}');"  ID="botonContenido"
             estado="false"  cod="848"/>
