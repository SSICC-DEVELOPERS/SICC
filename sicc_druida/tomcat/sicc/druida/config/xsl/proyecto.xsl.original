...
#Cp</xsl:text><xsl:value-of select="@nombre"/>{position:absolute; width:<xsl:value-of select="@ancho"/>; height:<xsl:value-of select="@alto"/>; left: <xsl:value-of select="@x"/>; top: <xsl:value-of select="@y"/>; background-color: <xsl:value-of select="$colorFondo"/>; layer-background-color: <xsl:value-of select="$colorFondo"/>; <xsl:text>}
      ...
      <xsl:text>",</xsl:text><xsl:value-of select="$vOrdCol"/>,"<xsl:value-of select="$vOnSetDatos"/>","<xsl:value-of select="$vOnAfterSetDatos"/>",<xsl:value-of select="$vTxtMinim"/>,<xsl:value-of select="$vMsgDebugJS"/>,"<xsl:value-of select="$vTipEnvio"/>","<xsl:value-of select="$vFormaEnv"/>","<xsl:value-of select="$vOnLoad"/>",<xsl:value-of select="$vRepntCab"/>,"<xsl:value-of select="$vColFonScr"/>",<xsl:value-of select="$vGruposCab"/>,<xsl:value-of select="$vDeseleccSiMax"/>,<xsl:value-of select="$vAjustarAMitadInf"/>
