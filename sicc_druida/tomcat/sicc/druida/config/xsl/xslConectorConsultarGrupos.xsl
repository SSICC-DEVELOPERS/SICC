    ...
    <tr>      
	  ...
	  <table width="582" border="1" cellspacing="1" cellpadding="0" bordercolor="#CCCCCC">
	    ...
	    <td class="tablaTitle">
          ...
          <tr>
	    <td class="tablaTitle">
	      <BOTON nombre="btnAniadirGrupo" tipo="html" accion="javascript:aniadirGrupo();"  ID="botonContenido"
              estado="false"  cod="221"/>
	      <COMBO  nombre="cbTipoGrupo" size="1" multiple="N" req="N" id="estcombo4">
	      </COMBO>   
	    </td>
	  </tr>
	  </table>
...
<xsl:template match="ROWSET">
	...
	<xsl:sort select="CAMPO[@NOMBRE='GOFE_NUM_GRUPO']"/>
	  ...
	  <table width="98%" border="1" cellspacing="1" cellpadding="0" align="center" bordercolor="#CCCCCC">
	   ...
	   <tr>
	   <td class="tablaTitle">
		   <BOTON nombre="btnModificarGrupo_{CAMPO[@NOMBRE='GOFE_NUM_GRUPO']}" tipo="html" accion="javascript:modificarGrupo('{CAMPO[@NOMBRE='GOFE_NUM_GRUPO']}','{CAMPO[@NOMBRE='IND_COND']}','{CAMPO[@NOMBRE='IND_PAQUE']}','{CAMPO[@NOMBRE='COD_IND_CUAD']}','{CAMPO[@NOMBRE='COD_FACT_CUAD']}');"  ID="botonContenido"
                     estado="false"  cod="142"/>

	           <BOTON nombre="btnEliminarGrupo_{CAMPO[@NOMBRE='GOFE_NUM_GRUPO']}" tipo="html" accion="javascript:eliminarGrupo('{CAMPO[@NOMBRE='GOFE_NUM_GRUPO']}','{CAMPO[@NOMBRE='IND_COND']}','{CAMPO[@NOMBRE='IND_PAQUE']}');"  ID="botonContenido"
