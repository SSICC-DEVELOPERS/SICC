...
<!--
   INDRA/MAV/SICC
   $Id: XSLStatus1MAV.xsl,v 1.1 2009/12/03 19:02:33 pecbazalar Exp $
   InsertarActividades
-->
	...
	<xsl:template match="ROW">
		<xsl:copy>
			...
			<CAMPO NOBRE="concatenados" TIPO="STRING">
				<xsl:value-of select="./CAMPO[position()=1]"/>--<xsl:value-of select="./CAMPO[position()=2]"/>--<xsl:value-of select="./CAMPO[position()=3]"/>--<xsl:value-of select="./CAMPO[position()=4]"/>
			</CAMPO>
