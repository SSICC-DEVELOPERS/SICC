...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/">
	<ARBOL x="0" y="0" nombre="menu" id="menu" ancho="256" alto="" colorf="#999999" visibilidad="" incx="5" incy="5" altofila="19" indentado="10">
		...
		<xsl:choose>
			<xsl:when test="(CAMPO[@NOMBRE='nodofinal'])=0">
				...
				<RAMA>
					...
					<xsl:attribute name="icono"><xsl:text></xsl:text></xsl:attribute>
