...
<!--
	$Id: XSLFuncionesMenu_Elminar.xsl,v 1.1 2009/12/03 19:02:32 pecbazalar Exp $
-->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	<xsl:output method="xml" version="1.0" encoding="iso-8859-1" indent="no" omit-xml-declaration="no"/>
	<xsl:template match="/">
		<table style="table-layout:fixed; border-collapse:collapse" cellpadding="0" cellspacing="0" width="100%" id="menu">
			<colgroup>
            ...
            <xsl:for-each select="//ROW[CAMPO[@NOMBRE='idfuncion']!=2 and CAMPO[@NOMBRE='jerarquia']!=2]">
               ...
               <tr>
                  ...
                  <td colspan="{$jerarquia}">
                     <xsl:choose>
                        <xsl:when test="number(CAMPO[@NOMBRE='nodofinal'])=1">
