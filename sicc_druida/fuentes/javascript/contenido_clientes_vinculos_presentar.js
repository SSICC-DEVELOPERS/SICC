...
function onLoadPag(){
	...
	- idBusiness ("CALObtenerVinculos") 
	- "ConectorObtenerVinculos" 
	...
	*/
	...
	//alert(" oid del cliente = "+oidCliente);
	configurarPaginado(mipgndo, 'CALObtenerVinculos', 'ConectorObtenerVinculos', 
