	...
	function onLoadPag()   {
        ...
        if (get('frmGenerarCronograma.hEsZona') == '1') {
			//Fase 2
			listado3.datosTitulo[0]= "Actividades sin Actividad Origen";
			listado3.repintaTit();
		}
        ...
        if (get('frmGenerarCronograma.hEsZona') != '1') {
			...
			document.all.CpScrolllistado3.attachEvent ('onpropertychange', verificaResultadoListado3);
        }
        mostrarListaFuera();
  ...
  function verificaResultadoListado3() {
      if (event.propertyName == "innerHTML") {
          listado3.txtCab[0] = GestionarMensaje(1244);
          //alert(listado2.txtCab);
      }
  }
  ...
  function mostrarListaReferenciaPeridos() {
		...
		// El boton Cambiar fecha de la tercera lista se muestra
		// solo cuando se genera cronograma en fase 2
		if (get('frmGenerarCronograma.hEsZona') == '1') {
  ...
  function camFechRefeOtroPeri() {
      ...
      {		
          ...
          set('frmGenerarCronograma.hCanal', get('frmGenerarCronograma.hCanal'));
          set('frmGenerarCronograma.hCodPeriodo', get('frmGenerarCronograma.hCodPeriodo'));
          var idVistaRefeOtroPeri = listado3.datos[posicion][9];
