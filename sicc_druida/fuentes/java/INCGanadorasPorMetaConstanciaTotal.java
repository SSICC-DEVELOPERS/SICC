...
public class INCGanadorasPorMetaConstanciaTotal extends LPSICCBase {           
    public INCGanadorasPorMetaConstanciaTotal() {	 
        super();
    }
    ...
    public void ejecucion() throws Exception {		
        ...
        try {
            ...
            if (accion.equals("generar")){
                ...
                cargarPagina();
                getConfiguracionMenu("INCGanadorasPorMetaConstanciaTotal");
            }
    ...
    private void cargarPagina() throws Exception{
        pagina("contenido_informe_ganadoras_constancia_generar");   
    ...
    private void generarReporte() throws Exception{
        ...
        String rangoVenta  = conectorParametroLimpia("rangoVenta", "", true);
        datos.put(ConstantesREP.RANGOVENTAS, rangoVenta);
        
        
        datos.put(ConstantesREP.TITULO, "GANADORAS CUMPLIMIENTO META Y CONSTANCIA");
        ...
        if(region.equals("")){
           reporte = "RD_REP-072_02";    
        }else{
           if(zona.equals("")){
              reporte = "RD_REP-072_01";
           }else{
              reporte = "RD_REP-072";
           }
        }    
