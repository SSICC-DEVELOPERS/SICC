...
public class contenido_solicitudes_bloqueadas_aprobar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_solicitudes_bloqueadas_aprobar" );
      ((Element)v.get(0)).setAttribute("titulo","" );
      ((Element)v.get(0)).setAttribute("cod","0221" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","contenido_solicitudes_bloqueadas_aprobar.js" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(13)).setAttribute("nombre","oidSolicitudBloqueada" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(14)).setAttribute("nombre","varEjecutivoCuenta" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(39)).setAttribute("nombre","lblMotivoAprobacion" );
      ...
      ((Element)v.get(39)).setAttribute("cod","922" );
      ...
      ((Element)v.get(46)).setAttribute("nombre","cbMotivoAprobacion" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(46)).setAttribute("ontab","tab('cbMotivoAprobacion')" );
      ((Element)v.get(46)).setAttribute("onshtab","shtab('cbMotivoAprobacion')" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(58)).setAttribute("nombre","lblObservacionesAprob" );
      ...
      ((Element)v.get(58)).setAttribute("cod","950" );
      ...
      ((Element)v.get(65)).setAttribute("cols","50" );
      ((Element)v.get(65)).setAttribute("id","datosCampos" );
      ((Element)v.get(65)).setAttribute("msjreq","" );
      ((Element)v.get(65)).setAttribute("nombre","areaObservacionesAprob" );
      ((Element)v.get(65)).setAttribute("readonly","N" );
      ((Element)v.get(65)).setAttribute("req","N" );
      ((Element)v.get(65)).setAttribute("rows","3" );
      ((Element)v.get(65)).setAttribute("tabindex","2" );
      ((Element)v.get(65)).setAttribute("valor","" );
      ((Element)v.get(65)).setAttribute("ontab","tab('areaObservacionesAprob')" );
      ((Element)v.get(65)).setAttribute("onshtab","shtab('areaObservacionesAprob')" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(81)).setAttribute("accion","btnaceptar_click()" );
      ((Element)v.get(81)).setAttribute("estado","false" );
      ((Element)v.get(81)).setAttribute("cod","12" );
      ((Element)v.get(81)).setAttribute("ontab","tab('btnAceptar')" );
      ((Element)v.get(81)).setAttribute("onshtab","shtab('btnAceptar')" );
