...
public class INCPremiosElectivos extends LPSICCBase {
   
    public INCPremiosElectivos() {
        super();
    }
    ...
    public void ejecucion() throws Exception {		
        ...
        try {
            ...
            if (accion.equals("generar")){
                ...
                cargarPagina();
                getConfiguracionMenu("INCPremiosElectivos");
            }
    ...
    private void cargarPagina() throws Exception{
        pagina("contenido_reporte_premios_electivos_generar");   
    ...
    private void generarReporte() throws Exception{
        ...
        String seleccionoPremio = conectorParametroLimpia("seleccionoPremio", "", true);
        if(!seleccionoPremio.equals("")){
            datos.put(ConstantesREP.SELECCIONOPREMIO, seleccionoPremio);
        }
        ...
        datos.put(ConstantesREP.TITULO, "Reporte de Premios electivos");
        ...
        if(region.equals("")){
           reporte = "RD_REP-052_02";
        }else{
           if(zona.equals("")){
             reporte = "RD_REP-052_01";   
           }else{          
              reporte = "RD_REP-052";    
          }
       }
