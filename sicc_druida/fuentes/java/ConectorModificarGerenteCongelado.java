...
public class ConectorModificarGerenteCongelado  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la modificacion de un elemento Gerente Congelado" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","COMModificarGerenteCongelado" );
