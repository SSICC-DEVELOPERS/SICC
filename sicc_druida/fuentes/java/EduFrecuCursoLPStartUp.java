/*
    INDRA/CAR/mmg
    $Id: EduFrecuCursoLPStartUp.java,v 1.1 2009/12/03 18:39:58 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class EduFrecuCursoLPStartUp extends MMGDruidaBase{
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "EduFrecuCursoPage", "cod", "EduFrecuCurso." + accion + ".label");
			...
			limpiarBotoneraLista("eduFrecuCurso", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codFrec", "validacion", "mensaje = ValidaInt(cdos_trim(valor), 2, 0, 99);");
		...
		//asignarAtributo("CAPA", "eduFrecuCursoLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "EduFrecuCursoPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		EduFrecuCursoData eduFrecuCursoQuery= new EduFrecuCursoData();
		eduFrecuCursoQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		EduFrecuCursoData datosResult = (EduFrecuCursoData)getSingleObject(BUSINESSID_QUERY, eduFrecuCursoQuery, 
			eduFrecuCursoQuery.clone(), "eduFrecuCurso");
		...
		preservaHiddensI18n(new Integer(1), "EDU_FRECU_CURSO", "eduFrecuCursoFrm", "Descripcion", true);
		...
		EduFrecuCursoData eduFrecuCurso = datosResult;
		asignar("TEXT", "codFrec", FormatUtils.formatObject(eduFrecuCurso.getCodFrec(), 
		...
		loadLocalizationVars(eduFrecuCurso);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "codFrec", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "EDU_FRECU_CURSO", "eduFrecuCursoFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "codFrec", "req", "S");
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('eduFrecuCursoFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "eduFrecuCursoFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		EduFrecuCursoData eduFrecuCursoQuery= new EduFrecuCursoData();
		eduFrecuCursoQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(eduFrecuCurso.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"eduFrecuCursoFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"eduFrecuCursoFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codFrec", "ontab","ejecutarAccionFocoModificacion(\"eduFrecuCursoFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codFrec", "onshtab","ejecutarAccionFocoModificacion(\"eduFrecuCursoFrm\",2, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"eduFrecuCursoFrm\",3, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"eduFrecuCursoFrm\",3, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","eduFrecuCursoTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","eduFrecuCursoTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codFrec...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","eduFrecuCursoFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","eduFrecuCursoListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","eduFrecuCursoListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(EduFrecuCursoData eduFrecuCurso) throws Exception{
	...
	* @param eduFrecuCurso La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(EduFrecuCursoData eduFrecuCurso) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		EduFrecuCursoData eduFrecuCurso = 
			(EduFrecuCursoData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(eduFrecuCurso);
		loadLeafDependenceCombos(eduFrecuCurso);
	}
	...
	*/
	...
	protected void loadLocalizationVars(EduFrecuCursoData eduFrecuCurso) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("EDU_FRECU_CURSO");
		mmgLocalizationQuery.setEntiPk(eduFrecuCurso.getId());
