...
public class PedGrupoProcePageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","pedGrupoProceList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","PedGrupoProce.codGrupProc.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","PedGrupoProce.desGrupProc.label" );
