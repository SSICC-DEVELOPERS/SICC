...
/*
    INDRA/CAR/mmg
    $Id: MaeSubtiClienTransactionComboLoad.java,v 1.1 2009/12/03 18:34:38 pecbazalar Exp $
    DESC
*/
...
public class MaeSubtiClienTransactionComboLoad extends MMGDruidaTransaction {
	//Constantes usadas en la clase. Simplemente representan 
	//los nombre de conectore y de logicas de negocio
	public static final String BUSINESSID_QUERY = "MMGMaeSubtiClienQueryFromToUserStructuralSecurity";
	public static final String CONECTOR_QUERY_COMBO= "MaeSubtiClienConectorCombo";

	// Definicion del constructor
	public MaeSubtiClienTransactionComboLoad(){
		super();
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			dto.addProperty("maeSubtiClienFrom", maeSubtiClien);
			dto.addProperty("maeSubtiClienTo", maeSubtiClien.clone());
