...
public class MaeClaseTarjePageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","maeClaseTarjeList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","MaeClaseTarje.codClasTarj.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","MaeClaseTarje.desClasTarj.label" );
