...
public class PedTasaImpuePageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","PedTasaImpue.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","PedTasaImpue.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('pedTasaImpueFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('pedTasaImpueFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(50)).setAttribute("nombre","valIndiImpuTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lblValIndiImpu" );
      ((Element)v.get(54)).setAttribute("alto","13" );
      ((Element)v.get(54)).setAttribute("filas","1" );
      ((Element)v.get(54)).setAttribute("id","datosTitle" );
      ((Element)v.get(54)).setAttribute("cod","PedTasaImpue.valIndiImpu.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(55)).setAttribute("nombre","valIndiImpuWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(57)).setAttribute("nombre","valIndiImpu" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('pedTasaImpueFrm',2, true)" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('pedTasaImpueFrm', 2, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(58)).setAttribute("nombre","valIndiImpuGapTdId" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(64)).setAttribute("cod","PedTasaImpue.Descripcion.label" );
      ...
      ((Element)v.get(68)).setAttribute("ontab","ejecutarAccionFoco('pedTasaImpueFrm',3, true)" );
      ((Element)v.get(68)).setAttribute("onshtab","ejecutarAccionFoco('pedTasaImpueFrm', 3, false)" );
      ...
      ((Element)v.get(72)).setAttribute("href","javascript:openLocalizationDialog('pedTasaImpueFrm', 'Descripcion', 1);" );
      ((Element)v.get(72)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"pedTasaImpueFrm\",3, true)', 'ejecutarAccionFoco(\"pedTasaImpueFrm\",3, false)')" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(76)).setAttribute("nombre","valTasaImpuTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(81)).setAttribute("nombre","valTasaImpuWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(83)).setAttribute("nombre","valTasaImpu" );
      ...
      ((Element)v.get(83)).setAttribute("ontab","ejecutarAccionFoco('pedTasaImpueFrm',4, true)" );
      ((Element)v.get(83)).setAttribute("onshtab","ejecutarAccionFoco('pedTasaImpueFrm', 4, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(84)).setAttribute("nombre","valTasaImpuGapTdId" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(86)).setAttribute("nombre","paisOidPaisTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(91)).setAttribute("nombre","paisOidPaisWidgetTrId" );
      ...
      ((Element)v.get(93)).setAttribute("nombre","paisOidPais" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(93)).setAttribute("ontab","ejecutarAccionFoco('pedTasaImpueFrm',5, true);" );
      ((Element)v.get(93)).setAttribute("onshtab","ejecutarAccionFoco('pedTasaImpueFrm',5, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(95)).setAttribute("nombre","paisOidPaisGapTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(109)).setAttribute("nombre","pedTasaImpueTrButtons" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(116)).setAttribute("nombre","pedTasaImpueTdQueryButton" );
      ((Element)v.get(115)).appendChild((Element)v.get(116));

      /* Empieza nodo:117 / Elemento padre: 116   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(117)).setAttribute("nombre","pedTasaImpueQueryButton" );
      ((Element)v.get(117)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(117)).setAttribute("estado","false" );
      ((Element)v.get(117)).setAttribute("accion","pedTasaImpueFirstPage();" );
      ...
      ((Element)v.get(118)).setAttribute("nombre","pedTasaImpueTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(120)).setAttribute("nombre","pedTasaImpueLovNullButton" );
      ((Element)v.get(120)).setAttribute("ID","botonContenido" );
      ((Element)v.get(120)).setAttribute("tipo","html" );
      ((Element)v.get(120)).setAttribute("accion","pedTasaImpueLovNullSelectionAction();" );
