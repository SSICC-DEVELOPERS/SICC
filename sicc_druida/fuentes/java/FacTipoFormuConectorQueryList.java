...
public class FacTipoFormuConectorQueryList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad FacTipoFormu" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGFacTipoFormuQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGFacTipoFormuQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","FacTipoFormuListFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","codTipoForm" );
