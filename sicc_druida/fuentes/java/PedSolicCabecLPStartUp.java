/*
    INDRA/CAR/mmg
    $Id: PedSolicCabecLPStartUp.java,v 1.1 2009/12/03 18:40:22 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class PedSolicCabecLPStartUp extends MMGDruidaBase{
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "PedSolicCabecPage", "cod", "PedSolicCabec." + accion + ".label");
			...
			limpiarBotoneraLista("pedSolicCabec", accion);
	...
	protected void cmdLov() throws Exception{
		...
		//asignarAtributo("CAPA", "pedSolicCabecLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "PedSolicCabecPage", "onblur", "window.focus();");
	...
	protected void cmdView() throws Exception{
		...
		PedSolicCabecData pedSolicCabecQuery= new PedSolicCabecData();
		pedSolicCabecQuery.setId(new Integer(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		PedSolicCabecData datosResult = (PedSolicCabecData)getSingleObject(BUSINESSID_QUERY, pedSolicCabecQuery, 
			pedSolicCabecQuery.clone(), "pedSolicCabec");
		...
		PedSolicCabecData pedSolicCabec = datosResult;
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "pedSolicCabecFrm", "oculto", "N");
		...
		PedSolicCabecData pedSolicCabecQuery= new PedSolicCabecData();
		pedSolicCabecQuery.setId(new Integer(id));
		...
		//asignar("VAR","timestamp",Long.toString(pedSolicCabec.jdoGetTimeStamp()));
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","pedSolicCabecTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","pedSolicCabecTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","pedSolicCabecFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","pedSolicCabecPreListLayer", "y", String.valueOf(sizeForm + 24));
		asignarAtributo("CAPA","pedSolicCabecListLayer", "y", String.valueOf(sizeForm + 46));		
		asignarAtributo("CAPA","pedSolicCabecListButtonsLayer", "y", String.valueOf(sizeForm + 299));		
	}
	...
	* @param pedSolicCabec La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(PedSolicCabecData pedSolicCabec) 
		throws Exception{
	...
	*/
	protected void setDependenceComboLabels(PedSolicCabecData pedSolicCabec) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		PedSolicCabecData pedSolicCabec = 
			(PedSolicCabecData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(pedSolicCabec);
	}
