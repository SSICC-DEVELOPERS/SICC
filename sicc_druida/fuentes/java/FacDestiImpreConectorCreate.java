...
public class FacDestiImpreConectorCreate  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la inserción de un nuevo elemento sobre la entidad FacDestiImpre" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGFacDestiImpreCreateID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGFacDestiImpreCreateDTO" );
