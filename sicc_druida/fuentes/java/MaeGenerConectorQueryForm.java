...
public class MaeGenerConectorQueryForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad MaeGener" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGMaeGenerQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGMaeGenerQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","MaeGenerFormFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(8)).setAttribute("NOMBRE","codGene" );
