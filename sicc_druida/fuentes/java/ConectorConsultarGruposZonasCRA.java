...
public class ConectorConsultarGruposZonasCRA  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","DTOEntradaConsultarGruposZonas" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","CRAConsultarGruposZonas" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(6)).setAttribute("NOMBRE","COD_GRUP" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","DES_GRUP" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(8)).setAttribute("NOMBRE","COD_TIPO_FACT" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(9)).setAttribute("NOMBRE","OID_CABE_GRUP_ZONA" );
      ...
      ((Element)v.get(10)).setAttribute("ID","dtoSalida.resultado_ROWSET" );
      ((Element)v.get(0)).appendChild((Element)v.get(10));

      /* Empieza nodo:11 / Elemento padre: 10   */
      v.add(doc.createElement("CCAMPO"));
      ((Element)v.get(11)).setAttribute("NOMBRE","OID_CABE_GRUP_ZONA" );
      ...
      v.add(doc.createElement("CCAMPO"));
      ((Element)v.get(12)).setAttribute("NOMBRE","DES_GRUP" );
