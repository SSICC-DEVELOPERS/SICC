/*
    INDRA/CAR/mmg
    $Id: CalMotivTipoClienLPStartUp.java,v 1.1 2009/12/03 18:34:10 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class CalMotivTipoClienLPStartUp extends MMGDruidaBase{
	...
	public static final String BUSINESSID_QUERY = "MMGCalMotivTipoClienQueryFromToUserPage";
				...
				public static final String BUSINESSID_MOCOOIDMOTICONT_QUERY ="MMGCalMotivContaQueryFromToUser";
				public static final String MOCOOIDMOTICONT_COMBO_CONNECTOR = "CalMotivContaConectorCombo";
	...
	public CalMotivTipoClienLPStartUp(){
		super();
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			buildJsPageSize("CalMotivTipoClien");
			...
			asignarAtributo("PAGINA", "CalMotivTipoClienPage", "cod", "CalMotivTipoClien." + accion + ".label");
			...
			limpiarBotoneraLista("calMotivTipoClien", accion);
	...
	protected void cmdLov() throws Exception{
		...
		//asignarAtributo("CAPA", "calMotivTipoClienLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "CalMotivTipoClienPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		CalMotivTipoClienData calMotivTipoClienQuery= new CalMotivTipoClienData();
		calMotivTipoClienQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		CalMotivTipoClienData datosResult = (CalMotivTipoClienData)getSingleObject(BUSINESSID_QUERY, calMotivTipoClienQuery, 
			calMotivTipoClienQuery.clone(), "calMotivTipoClien");
		...
		CalMotivTipoClienData calMotivTipoClien = datosResult;
		es.indra.belcorp.mso.CalMotivContaData mocoOidMotiCont = calMotivTipoClien.getMocoOidMotiCont();
		if(mocoOidMotiCont != null && mocoOidMotiCont.getId() != null) checkCombo("mocoOidMotiCont" , mocoOidMotiCont.getId().toString());
		es.indra.belcorp.mso.MaeTipoClienData ticlOidTipoClie = calMotivTipoClien.getTiclOidTipoClie();
		...
		//Deshabilitamos todos los campos para que no se editen
					...
					asignarAtributo("COMBO", "mocoOidMotiCont", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		...
		asignarAtributo("COMBO", "mocoOidMotiCont", "req", "S");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "calMotivTipoClienFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		CalMotivTipoClienData calMotivTipoClienQuery= new CalMotivTipoClienData();
		calMotivTipoClienQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(calMotivTipoClien.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"calMotivTipoClienFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"calMotivTipoClienFrm\",1, false)");
					asignarAtributo("COMBO","mocoOidMotiCont", "ontab", "ejecutarAccionFocoModificacion(\"calMotivTipoClienFrm\",2, true)");
					asignarAtributo("COMBO","mocoOidMotiCont", "onshtab", "ejecutarAccionFocoModificacion(\"calMotivTipoClienFrm\",2, false)");
					asignarAtributo("COMBO","ticlOidTipoClie", "ontab", "ejecutarAccionFocoModificacion(\"calMotivTipoClienFrm\",3, true)");
					asignarAtributo("COMBO","ticlOidTipoClie", "onshtab", "ejecutarAccionFocoModificacion(\"calMotivTipoClienFrm\",3, false)");
					asignarAtributo("COMBO","paisOidPais", "ontab", "ejecutarAccionFocoModificacion(\"calMotivTipoClienFrm\",4, true)");
					asignarAtributo("COMBO","paisOidPais", "onshtab", "ejecutarAccionFocoModificacion(\"calMotivTipoClienFrm\",4, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","calMotivTipoClienTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","calMotivTipoClienTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es mocoOidMotiCont...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","calMotivTipoClienFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","calMotivTipoClienListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","calMotivTipoClienListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(CalMotivTipoClienData calMotivTipoClien) throws Exception{
		HashMap checkedCombos = new HashMap();
		CalMotivContaData mocoOidMotiCont = new CalMotivContaData();
		
						asignarComboResultados(BUSINESSID_MOCOOIDMOTICONT_QUERY,MOCOOIDMOTICONT_COMBO_CONNECTOR, 
			mocoOidMotiCont, mocoOidMotiCont.clone(), "calMotivConta", "mocoOidMotiCont", "result_ROWSET" );
		if(calMotivTipoClien != null && calMotivTipoClien.getMocoOidMotiCont() != null){
				checkCombo("mocoOidMotiCont" , calMotivTipoClien.getMocoOidMotiCont().getId().toString());
			}
		...
		if(calMotivTipoClien != null && calMotivTipoClien.getTiclOidTipoClie() != null){
				checkCombo("ticlOidTipoClie" , calMotivTipoClien.getTiclOidTipoClie().getId().toString());
			}
		...
		if(calMotivTipoClien != null && calMotivTipoClien.getPaisOidPais() != null){
				checkCombo("paisOidPais" , calMotivTipoClien.getPaisOidPais().getId().toString());
			}
	...
	* @param calMotivTipoClien La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(CalMotivTipoClienData calMotivTipoClien) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		CalMotivTipoClienData calMotivTipoClien = 
			(CalMotivTipoClienData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(calMotivTipoClien.getMocoOidMotiCont() != null){
			calMotivTipoClien.setMocoOidMotiCont((es.indra.belcorp.mso.CalMotivContaData)
			getSingleObject(BUSINESSID_MOCOOIDMOTICONT_QUERY, 
			calMotivTipoClien.getMocoOidMotiCont(),
			calMotivTipoClien.getMocoOidMotiCont().clone(),
			"calMotivConta"));
		}
		if(calMotivTipoClien.getTiclOidTipoClie() != null){
			calMotivTipoClien.setTiclOidTipoClie((es.indra.belcorp.mso.MaeTipoClienData)
			getSingleObject(BUSINESSID_TICLOIDTIPOCLIE_QUERY, 
			calMotivTipoClien.getTiclOidTipoClie(),
			calMotivTipoClien.getTiclOidTipoClie().clone(),
			"maeTipoClien"));
		}
		if(calMotivTipoClien.getPaisOidPais() != null){
			calMotivTipoClien.setPaisOidPais((es.indra.belcorp.mso.SegPaisViewData)
			getSingleObject(BUSINESSID_PAISOIDPAIS_QUERY, 
			calMotivTipoClien.getPaisOidPais(),
			calMotivTipoClien.getPaisOidPais().clone(),
			"segPaisView"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(calMotivTipoClien);
		loadLeafDependenceCombos(calMotivTipoClien);
	}
