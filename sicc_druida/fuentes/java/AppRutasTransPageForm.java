...
public class AppRutasTransPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","AppRutasTrans.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","AppRutasTrans.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('appRutasTransFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('appRutasTransFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(54)).setAttribute("cod","AppRutasTrans.paisOidPais.label" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('appRutasTransFrm',2, true);" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('appRutasTransFrm',2, false);" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(61)).setAttribute("nombre","codRutaTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(66)).setAttribute("nombre","codRutaWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(68)).setAttribute("nombre","codRuta" );
      ...
      ((Element)v.get(68)).setAttribute("size","6" );
      ...
      ((Element)v.get(68)).setAttribute("ontab","ejecutarAccionFoco('appRutasTransFrm',3, true)" );
      ((Element)v.get(68)).setAttribute("onshtab","ejecutarAccionFoco('appRutasTransFrm', 3, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(69)).setAttribute("nombre","codRutaGapTdId" );
      ...
      ((Element)v.get(75)).setAttribute("cod","AppRutasTrans.Descripcion.label" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(79)).setAttribute("max","40" );
      ((Element)v.get(79)).setAttribute("onchange","" );
      ((Element)v.get(79)).setAttribute("req","N" );
      ((Element)v.get(79)).setAttribute("size","40" );
      ...
      ((Element)v.get(79)).setAttribute("ontab","ejecutarAccionFoco('appRutasTransFrm',4, true)" );
      ((Element)v.get(79)).setAttribute("onshtab","ejecutarAccionFoco('appRutasTransFrm', 4, false)" );
      ...
      ((Element)v.get(83)).setAttribute("href","javascript:openLocalizationDialog('appRutasTransFrm', 'Descripcion', 1);" );
      ((Element)v.get(83)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"appRutasTransFrm\",4, true)', 'ejecutarAccionFoco(\"appRutasTransFrm\",4, false)')" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(87)).setAttribute("nombre","numSecuTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(91)).setAttribute("nombre","lblNumSecu" );
      ((Element)v.get(91)).setAttribute("alto","13" );
      ((Element)v.get(91)).setAttribute("filas","1" );
      ((Element)v.get(91)).setAttribute("id","datosTitle" );
      ((Element)v.get(91)).setAttribute("cod","AppRutasTrans.numSecu.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(92)).setAttribute("nombre","numSecuWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(94)).setAttribute("nombre","numSecu" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(94)).setAttribute("ontab","ejecutarAccionFoco('appRutasTransFrm',5, true)" );
      ((Element)v.get(94)).setAttribute("onshtab","ejecutarAccionFoco('appRutasTransFrm', 5, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(95)).setAttribute("nombre","numSecuGapTdId" );
      ...
      /* Empieza nodo:97 / Elemento padre: 49   */
      v.add(doc.createElement("TD"));
      ((Element)v.get(97)).setAttribute("width","100%" );
      ((Element)v.get(49)).appendChild((Element)v.get(97));
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(112)).setAttribute("nombre","valObseTdId" );
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(117)).setAttribute("nombre","valObseWidgetTrId" );
      ...
      ((Element)v.get(119)).setAttribute("nombre","valObse" );
      ((Element)v.get(119)).setAttribute("valor","" );
      ((Element)v.get(119)).setAttribute("rows","3" );
      ((Element)v.get(119)).setAttribute("cols","40" );
      ...
      ((Element)v.get(119)).setAttribute("ontab","ejecutarAccionFoco('appRutasTransFrm',6, true)" );
      ((Element)v.get(119)).setAttribute("onshtab","ejecutarAccionFoco('appRutasTransFrm',6, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(120)).setAttribute("nombre","valObseGapTdId" );
   ...
   private void getXML630(Document doc) {
      ...
      /* Empieza nodo:134 / Elemento padre: 0   */
      v.add(doc.createElement("TR"));
      ((Element)v.get(134)).setAttribute("nombre","appRutasTransTrButtons" );
      ((Element)v.get(0)).appendChild((Element)v.get(134));
      ...
      ((Element)v.get(141)).setAttribute("nombre","appRutasTransTdQueryButton" );
      ((Element)v.get(140)).appendChild((Element)v.get(141));

      /* Empieza nodo:142 / Elemento padre: 141   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(142)).setAttribute("nombre","appRutasTransQueryButton" );
      ((Element)v.get(142)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(142)).setAttribute("estado","false" );
      ((Element)v.get(142)).setAttribute("accion","appRutasTransFirstPage();" );
      ...
      ((Element)v.get(143)).setAttribute("nombre","appRutasTransTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(145)).setAttribute("nombre","appRutasTransLovNullButton" );
      ((Element)v.get(145)).setAttribute("ID","botonContenido" );
      ((Element)v.get(145)).setAttribute("tipo","html" );
      ((Element)v.get(145)).setAttribute("accion","appRutasTransLovNullSelectionAction();" );
