...
public class ConectorBuscarMontoMinimo  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Buscar Monto Minimo" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","DTOMontoMinimo" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","PEDconsultaMontoMinimo" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","DES_REGI" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(8)).setAttribute("NOMBRE","DES_ZONA" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(9)).setAttribute("NOMBRE","DESC_TIPO_SOLICITUD" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(10)).setAttribute("NOMBRE","DESC_TIPO_CLIENTE" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(11)).setAttribute("NOMBRE","DESC_SUBTIPO_CLIENTE" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(12)).setAttribute("NOMBRE","DESC_TIPO_CLASI" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(13)).setAttribute("NOMBRE","DES_CLASI" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(14)).setAttribute("NOMBRE","MONTONOMINAL" );
      ((Element)v.get(14)).setAttribute("TIPO","REAL" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(15)).setAttribute("NOMBRE","NIVEL1" );
      ((Element)v.get(15)).setAttribute("TIPO","REAL" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(16)).setAttribute("NOMBRE","NIVEL2" );
      ((Element)v.get(16)).setAttribute("TIPO","REAL" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(17)).setAttribute("NOMBRE","NIVEL3" );
      ((Element)v.get(17)).setAttribute("TIPO","REAL" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(18)).setAttribute("NOMBRE","RECARGO" );
      ((Element)v.get(18)).setAttribute("TIPO","REAL" );
