...
public class CalTipoEstadContaPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","calTipoEstadContaList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","CalTipoEstadConta.codEsta.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","CalTipoEstadConta.Descripcion.label" );
