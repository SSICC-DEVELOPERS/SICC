...
public class IncPartiConcuDetalConectorQueryForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad IncPartiConcuDetal" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGIncPartiConcuDetalQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGIncPartiConcuDetalQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","IncPartiConcuDetalFormFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","paciOidPartConcCabe" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(9)).setAttribute("NOMBRE","sbtiOidSubtClie" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(10)).setAttribute("NOMBRE","tcclOidTipoClas" );
