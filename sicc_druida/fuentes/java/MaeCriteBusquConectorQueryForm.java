...
public class MaeCriteBusquConectorQueryForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad MaeCriteBusqu" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGMaeCriteBusquQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGMaeCriteBusquQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","MaeCriteBusquFormFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(8)).setAttribute("NOMBRE","atreOidAtriEsp1" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(9)).setAttribute("NOMBRE","atreOidAtriEsp2" );
