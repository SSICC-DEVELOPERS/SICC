...
public class PedProceViewPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","pedProceViewList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","PedProceView.codProc.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","PedProceView.Descripcion.label" );
