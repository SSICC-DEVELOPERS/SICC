...
public class contenido_matriz_descuento_copiar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_matriz_descuento_copiar" );
      ((Element)v.get(0)).setAttribute("cod","0245" );
      ((Element)v.get(0)).setAttribute("titulo","Copiar Matriz de descuento" );
      ...
      v.add(doc.createTextNode("\r   \r\r	function onLoadPag()   {\r  \r    configurarMenuSecundario(\"formulario\");\r    DrdEnsanchaConMargenDcho('listado1',12);\r    document.all[\"Cplistado1\"].style.visibility='visible';\r    document.all[\"CpLin1listado1\"].style.visibility='visible';\r    document.all[\"CpLin2listado1\"].style.visibility='visible';\r    document.all[\"CpLin3listado1\"].style.visibility='visible';\r    document.all[\"CpLin4listado1\"].style.visibility='visible';\r    document.all[\"primera1Div\"].style.visibility='visible';\r    document.all[\"ret1Div\"].style.visibility='visible';\r    document.all[\"ava1Div\"].style.visibility='visible';\r    document.all[\"separaDiv\"].style.visibility='visible';\r    eval (ON_RSZ);  \r	 focaliza('formulario.txtDescripcionNuevaMatriz');\r	 if (get(\"formulario.noMat\")==\"S\")\r			GestionarMensaje(\"1230\",null,null,null);\r   }\r\r	function prueba(error, ultima, rowset){\r    var tamano = rowset.length;\r    \r		if (tamano > 0) {\r		 document.all[\"Cplistado1\"].style.visibility='';\r		 document.all[\"CpLin1listado1\"].style.visibility='';\r		 document.all[\"CpLin2listado1\"].style.visibility='';\r		 document.all[\"CpLin3listado1\"].style.visibility='';\r		 document.all[\"CpLin4listado1\"].style.visibility='';\r		 document.all[\"primera1Div\"].style.visibility='';\r		 document.all[\"ret1Div\"].style.visibility='';\r		 document.all[\"ava1Div\"].style.visibility='';\r		 document.all[\"separaDiv\"].style.visibility='';\r		 eval (ON_RSZ);\r				\r		  var i;\r		  var index = 3;\r		  var si = GestionarMensaje(84);\r		  var no = GestionarMensaje(86);\r		\r		  for( i = 0; i < rowset.length; i++ ){\r			 			 if(rowset[i][index] == '0')  rowset[i][index] = no;\r			    else	if(rowset[i][index] == '1')	rowset[i][index] = si;\r				          else  rowset[i][index] = '';\r		  }\r		  return true;\r		}  else {\r		 document.all[\"Cplistado1\"].style.visibility='hidden';\r		 document.all[\"CpLin1listado1\"].style.visibility='hidden';\r		 document.all[\"CpLin2listado1\"].style.visibility='hidden';\r		 document.all[\"CpLin3listado1\"].style.visibility='hidden';\r		 document.all[\"CpLin4listado1\"].style.visibility='hidden';\r		 document.all[\"primera1Div\"].style.visibility='hidden';\r		 document.all[\"ret1Div\"].style.visibility='hidden';\r		 document.all[\"ava1Div\"].style.visibility='hidden';\r		 document.all[\"separaDiv\"].style.visibility='hidden';\r						\r		  focaliza('formulario.txtDescripcionNuevaMatriz','');\r		  cdos_mostrarAlert(error);\r		  return false;\r		}\r  } \r\r		function copiar() {\r				if( ! sicc_validaciones_generales('grupoCopiar') ) {\r			   return false;\r		}		\r\r		var desc = get(\"formulario.txtDescripcionNuevaMatriz\");\r		set(\"formulario.Descripcion\",desc);\r		if (get(\"formulario.noMat\")==\"S\"){\r			GestionarMensaje(\"1230\",null,null,null);\r		}else{\r			var codigos = new Array();\r			codigos = listado1.codSeleccionados();\r			var cant = codigos.length;\r			var posicion = obtenerPosicionListaEditable(listado1.codSeleccionados(),listado1);\r			set(\"formulario.hidOidMatriz\", codigos[0]);\r\r			if (cant == 1){\r				set(\"formulario.accion\",\"guardarCopia\");\r				set(\"formulario.conectorAction\",\"LPMantenimientoMatrizDescuentos\");\r				enviaSICC(\"formulario\");\r			} else GestionarMensaje('50');\r		}\r	}\r   \r   \r"));
      ...
      ((Element)v.get(7)).setAttribute("name","txtDescripcionNuevaMatriz" );
      ((Element)v.get(7)).setAttribute("required","true" );
      ((Element)v.get(7)).setAttribute("cod","846" );
      ((Element)v.get(7)).setAttribute("group","grupoCopiar" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(15)).setAttribute("nombre","tipoAccion" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(16)).setAttribute("nombre","hidOidMatriz" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(20)).setAttribute("nombre","noMat" );
      ...
      ((Element)v.get(21)).setAttribute("ancho","423" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","0042" );
      ...
      ((Element)v.get(32)).setAttribute("ancho","15" );
      ...
      ((Element)v.get(36)).setAttribute("cod","2184" );
      ((Element)v.get(35)).appendChild((Element)v.get(36));

      /* Elemento padre:36 / Elemento actual: 37   */
      v.add(doc.createTextNode("Cód. matriz"));
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(38)).setAttribute("cod","9" );
      ...
      ((Element)v.get(40)).setAttribute("cod","912" );
      ...
      ((Element)v.get(47)).setAttribute("ancho","423" );
      ...
      ((Element)v.get(48)).setAttribute("y","294" );
      ...
      ((Element)v.get(49)).setAttribute("y","294" );
      ...
      ((Element)v.get(50)).setAttribute("y","294" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(51)).setAttribute("y","290" );
      ...
      ((Element)v.get(52)).setAttribute("nombre","capa1" );
      ((Element)v.get(52)).setAttribute("alto","111" );
      ...
      ((Element)v.get(52)).setAttribute("y","325" );
   ...
   private void getXML360(Document doc) {
      ((Element)v.get(71)).setAttribute("width","419" );
      ...
      ((Element)v.get(81)).setAttribute("width","73" );
      ...
      ((Element)v.get(86)).setAttribute("nombre","txtDescripcionNuevaMatriz" );
      ((Element)v.get(86)).setAttribute("id","datosCampos" );
      ((Element)v.get(86)).setAttribute("max","40" );
      ((Element)v.get(86)).setAttribute("tipo","" );
      ((Element)v.get(86)).setAttribute("onchange","" );
      ((Element)v.get(86)).setAttribute("req","S" );
      ((Element)v.get(86)).setAttribute("size","40" );
      ((Element)v.get(86)).setAttribute("onshtab","focalizaBotonHTML('botonContenido','btnCopiar');" );
      ...
      ((Element)v.get(88)).setAttribute("width","73" );
      ...
      /* Empieza nodo:89 / Elemento padre: 71   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(71)).appendChild((Element)v.get(89));
      ...
      /* Empieza nodo:94 / Elemento padre: 53   */
      v.add(doc.createElement("tr"));
   }

   private void getXML450(Document doc) {
      ((Element)v.get(53)).appendChild((Element)v.get(94));
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(102)).setAttribute("nombre","btnCopiar" );
      ((Element)v.get(102)).setAttribute("ID","botonContenido" );
      ((Element)v.get(102)).setAttribute("tipo","html" );
      ((Element)v.get(102)).setAttribute("accion","copiar();" );
      ((Element)v.get(102)).setAttribute("ontab","focaliza('formulario.txtDescripcionNuevaMatriz');" );
