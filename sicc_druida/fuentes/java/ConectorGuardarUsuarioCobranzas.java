...
public class ConectorGuardarUsuarioCobranzas  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","ConectorGuardarUsuarioCobranzas" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","DTOUsuarioCobranzas" );
