...
public class INCResultadosCierreCampana  extends LPSICCBase {           
    public INCResultadosCierreCampana() {	 
        super();
    }
     ...
     try {
        ...
        if (accion.equals("generar")){
          ...
          //cargarPagina();
           ...
           cargarPagina();
           getConfiguracionMenu("INCResultadosCierreCampana");
        }
  ...
  private DruidaConector generarConector(String rowsetID, RecordSet datos,
    ...
    private void cargarPagina() throws Exception{
        ...
        asignarAtributoPagina("cod", "0872");
        asignarAtributo("VAR", "lp", "valor", "INCResultadosCierreCampana");
    ...
    private void generarReporte() throws Exception{
         ...
         if(formato.equals("xls")){
          ...
          if(region.equals("")){
             reporte = "RD_REP-063_02";    
          }else{
             if(zona.equals("")){
                reporte = "RD_REP-063_01";
             }else{
                reporte = "RD_REP-063";
             }
          }   
