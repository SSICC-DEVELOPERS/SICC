...
public class MaeTipoProblPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","maeTipoProblList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","MaeTipoProbl.codTipoProb.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","MaeTipoProbl.Descripcion.label" );
