...
public class MaeEstatClienViewPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","MaeEstatClienView.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","MaeEstatClienView.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('maeEstatClienViewFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('maeEstatClienViewFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(54)).setAttribute("cod","MaeEstatClienView.Descripcion.label" );
      ...
      ((Element)v.get(58)).setAttribute("max","40" );
      ...
      ((Element)v.get(58)).setAttribute("ontab","ejecutarAccionFoco('maeEstatClienViewFrm',4, true)" );
      ((Element)v.get(58)).setAttribute("onshtab","ejecutarAccionFoco('maeEstatClienViewFrm', 4, false)" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(62)).setAttribute("href","javascript:openLocalizationDialog('maeEstatClienViewFrm', 'Descripcion', 1);" );
      ((Element)v.get(62)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"maeEstatClienViewFrm\",4, true)', 'ejecutarAccionFoco(\"maeEstatClienViewFrm\",4, false)')" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(78)).setAttribute("nombre","maeEstatClienViewTrButtons" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(85)).setAttribute("nombre","maeEstatClienViewTdQueryButton" );
      ((Element)v.get(84)).appendChild((Element)v.get(85));

      /* Empieza nodo:86 / Elemento padre: 85   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(86)).setAttribute("nombre","maeEstatClienViewQueryButton" );
      ((Element)v.get(86)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(86)).setAttribute("estado","false" );
      ((Element)v.get(86)).setAttribute("accion","maeEstatClienViewFirstPage();" );
      ...
      ((Element)v.get(87)).setAttribute("nombre","maeEstatClienViewTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(89)).setAttribute("nombre","maeEstatClienViewLovNullButton" );
      ((Element)v.get(89)).setAttribute("ID","botonContenido" );
      ((Element)v.get(89)).setAttribute("tipo","html" );
      ((Element)v.get(89)).setAttribute("accion","maeEstatClienViewLovNullSelectionAction();" );
