/*
    INDRA/CAR/mmg
    $Id: MaeCodigClienAnterLPStartUp.java,v 1.1 2009/12/03 18:32:25 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class MaeCodigClienAnterLPStartUp extends MMGDruidaBase{
	...
	public static final String BUSINESSID_QUERY = "MMGMaeCodigClienAnterQueryFromToUserPage";
				...
				public static final String BUSINESSID_CLIEOIDCLIENUEV_QUERY ="MMGMaeClienQueryFromToUser";
				public static final String CLIEOIDCLIENUEV_COMBO_CONNECTOR = "MaeClienConectorCombo";
	...
	public MaeCodigClienAnterLPStartUp(){
		super();
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			buildJsPageSize("MaeCodigClienAnter");
			...
			asignarAtributo("PAGINA", "MaeCodigClienAnterPage", "cod", "MaeCodigClienAnter." + accion + ".label");
			...
			limpiarBotoneraLista("maeCodigClienAnter", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codClieAnti", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 15);");
		
		asignarAtributo("TEXT", "valSistProc", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 0, 40);");
		
		//Primero determianmos el nombre del campo en la entidad de oriegen donde se van a cargar los datos
		asignar("VAR", "idAttributeLovOpener", conectorParametro(PARAMETRO_LOV_ATTRIBUTO));
		asignar("VAR", "idEntityLovOpener", conectorParametro(PARAMETRO_LOV_ENTIDAD));
		//asignarAtributo("CAPA", "maeCodigClienAnterLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "MaeCodigClienAnterPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		MaeCodigClienAnterData maeCodigClienAnterQuery= new MaeCodigClienAnterData();
		maeCodigClienAnterQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		MaeCodigClienAnterData datosResult = (MaeCodigClienAnterData)getSingleObject(BUSINESSID_QUERY, maeCodigClienAnterQuery, 
			maeCodigClienAnterQuery.clone(), "maeCodigClienAnter");
		...
		MaeCodigClienAnterData maeCodigClienAnter = datosResult;
		es.indra.belcorp.mso.MaeClienData clieOidClieNuev = maeCodigClienAnter.getClieOidClieNuev();
		if(clieOidClieNuev != null && clieOidClieNuev.getId() != null) checkCombo("clieOidClieNuev" , clieOidClieNuev.getId().toString());
		asignar("TEXT", "codClieAnti", FormatUtils.formatObject(maeCodigClienAnter.getCodClieAnti(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		es.indra.belcorp.mso.SegPaisViewData paisOidPais = maeCodigClienAnter.getPaisOidPais();
		if(paisOidPais != null && paisOidPais.getId() != null) checkCombo("paisOidPais" , paisOidPais.getId().toString());
		asignar("TEXT", "valSistProc", FormatUtils.formatObject(maeCodigClienAnter.getValSistProc(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		//Deshabilitamos todos los campos para que no se editen
					...
					asignarAtributo("COMBO", "clieOidClieNuev", "disabled", "S");asignarAtributo("TEXT", "codClieAnti", "disabled", "S");
		
					asignarAtributo("COMBO", "paisOidPais", "disabled", "S");asignarAtributo("TEXT", "valSistProc", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		...
		asignarAtributo("COMBO", "clieOidClieNuev", "req", "S");
		asignarAtributo("TEXT", "codClieAnti", "req", "S");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "maeCodigClienAnterFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		MaeCodigClienAnterData maeCodigClienAnterQuery= new MaeCodigClienAnterData();
		maeCodigClienAnterQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(maeCodigClienAnter.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"maeCodigClienAnterFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"maeCodigClienAnterFrm\",1, false)");
					asignarAtributo("COMBO","clieOidClieNuev", "ontab", "ejecutarAccionFocoModificacion(\"maeCodigClienAnterFrm\",2, true)");
					asignarAtributo("COMBO","clieOidClieNuev", "onshtab", "ejecutarAccionFocoModificacion(\"maeCodigClienAnterFrm\",2, false)");
				asignarAtributo("AREATEXTO", "codClieAnti", "ontab","ejecutarAccionFocoModificacion(\"maeCodigClienAnterFrm\",3, true)");
				asignarAtributo("AREATEXTO", "codClieAnti", "onshtab","ejecutarAccionFocoModificacion(\"maeCodigClienAnterFrm\",3, false)");
					asignarAtributo("COMBO","paisOidPais", "ontab", "ejecutarAccionFocoModificacion(\"maeCodigClienAnterFrm\",4, true)");
					asignarAtributo("COMBO","paisOidPais", "onshtab", "ejecutarAccionFocoModificacion(\"maeCodigClienAnterFrm\",4, false)");
				asignarAtributo("AREATEXTO", "valSistProc", "ontab","ejecutarAccionFocoModificacion(\"maeCodigClienAnterFrm\",5, true)");
				asignarAtributo("AREATEXTO", "valSistProc", "onshtab","ejecutarAccionFocoModificacion(\"maeCodigClienAnterFrm\",5, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","maeCodigClienAnterTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","maeCodigClienAnterTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es clieOidClieNuev...");		
				
					traza("MMG: en desactivateNonModifyFields encontrado atributo no editable...");
				
						asignarAtributo("COMBO", "clieOidClieNuev", "disabled", "S");
				traza("MMG: el atributo es codClieAnti...");		
				
				traza("MMG: el atributo es paisOidPais...");		
				
				traza("MMG: el atributo es valSistProc...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","maeCodigClienAnterFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","maeCodigClienAnterListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","maeCodigClienAnterListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(MaeCodigClienAnterData maeCodigClienAnter) throws Exception{
		HashMap checkedCombos = new HashMap();
		MaeClienData clieOidClieNuev = new MaeClienData();
		
						asignarComboResultados(BUSINESSID_CLIEOIDCLIENUEV_QUERY,CLIEOIDCLIENUEV_COMBO_CONNECTOR, 
			clieOidClieNuev, clieOidClieNuev.clone(), "maeClien", "clieOidClieNuev", "result_ROWSET" );
		if(maeCodigClienAnter != null && maeCodigClienAnter.getClieOidClieNuev() != null){
				checkCombo("clieOidClieNuev" , maeCodigClienAnter.getClieOidClieNuev().getId().toString());
			}
		...
		if(maeCodigClienAnter != null && maeCodigClienAnter.getPaisOidPais() != null){
				checkCombo("paisOidPais" , maeCodigClienAnter.getPaisOidPais().getId().toString());
			}
	...
	* @param maeCodigClienAnter La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(MaeCodigClienAnterData maeCodigClienAnter) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		MaeCodigClienAnterData maeCodigClienAnter = 
			(MaeCodigClienAnterData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(maeCodigClienAnter.getClieOidClieNuev() != null){
			maeCodigClienAnter.setClieOidClieNuev((es.indra.belcorp.mso.MaeClienData)
			getSingleObject(BUSINESSID_CLIEOIDCLIENUEV_QUERY, 
			maeCodigClienAnter.getClieOidClieNuev(),
			maeCodigClienAnter.getClieOidClieNuev().clone(),
			"maeClien"));
		}
		if(maeCodigClienAnter.getPaisOidPais() != null){
			maeCodigClienAnter.setPaisOidPais((es.indra.belcorp.mso.SegPaisViewData)
			getSingleObject(BUSINESSID_PAISOIDPAIS_QUERY, 
			maeCodigClienAnter.getPaisOidPais(),
			maeCodigClienAnter.getPaisOidPais().clone(),
			"segPaisView"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(maeCodigClienAnter);
		loadLeafDependenceCombos(maeCodigClienAnter);
	}
