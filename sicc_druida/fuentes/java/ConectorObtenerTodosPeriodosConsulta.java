...
public class ConectorObtenerTodosPeriodosConsulta  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(6)).setAttribute("LONGITUD","200" );
      ...
      ((Element)v.get(7)).setAttribute("LONGITUD","8" );
      ...
      ((Element)v.get(9)).setAttribute("LONGITUD","200" );
      ...
      ((Element)v.get(13)).setAttribute("LONGITUD","10" );
      ((Element)v.get(5)).appendChild((Element)v.get(13));
      /* Termina nodo:13   */

      /* Empieza nodo:14 / Elemento padre: 5   */
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(14)).setAttribute("NOMBRE","FEC_FIN" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(16)).setAttribute("NOMBRE","IND_PERI_CORT" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(17)).setAttribute("NOMBRE","IND_PERI_CRUC" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(18)).setAttribute("NOMBRE","OID_TIPO_PERI" );
      ((Element)v.get(18)).setAttribute("TIPO","LONG" );
      ((Element)v.get(18)).setAttribute("LONGITUD","3" );
   }
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(19)).setAttribute("ID","dtoSalida.resultado_ROWSET" );
      ...
      v.add(doc.createElement("CCAMPO"));
      ((Element)v.get(21)).setAttribute("NOMBRE","COD_TIPO_PERI" );
      ...
      v.add(doc.createElement("CCAMPO"));
      ((Element)v.get(22)).setAttribute("NOMBRE","COD_PERI" );
      ...
      v.add(doc.createElement("CCAMPO"));
      ((Element)v.get(23)).setAttribute("NOMBRE","VAL_NOMB_PERI" );
      ...
      v.add(doc.createElement("CCAMPO"));
      ((Element)v.get(24)).setAttribute("NOMBRE","DURA" );
      ((Element)v.get(24)).setAttribute("TIPO","LONG" );
      ((Element)v.get(24)).setAttribute("LONGITUD","8" );
      ((Element)v.get(19)).appendChild((Element)v.get(24));
      /* Termina nodo:24   */

      /* Empieza nodo:25 / Elemento padre: 19   */
      v.add(doc.createElement("CCAMPO"));
      ((Element)v.get(25)).setAttribute("NOMBRE","FEC_INIC" );
      ((Element)v.get(25)).setAttribute("TIPO","DATE" );
      ...
      v.add(doc.createElement("CCAMPO"));
      ((Element)v.get(26)).setAttribute("NOMBRE","FEC_FIN" );
      ...
      v.add(doc.createElement("CCAMPO"));
      ((Element)v.get(27)).setAttribute("NOMBRE","OID_TIPO_PERI" );
      ((Element)v.get(27)).setAttribute("TIPO","LONG" );
      ...
      v.add(doc.createElement("CCAMPO"));
      ((Element)v.get(28)).setAttribute("NOMBRE","IND_PERI_CORT" );
      ...
      v.add(doc.createElement("CCAMPO"));
      ((Element)v.get(29)).setAttribute("NOMBRE","IND_PERI_CRUC" );
