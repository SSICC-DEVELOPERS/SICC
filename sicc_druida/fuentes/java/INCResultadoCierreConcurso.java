...
public class INCResultadoCierreConcurso extends LPSICCBase {
   
  public INCResultadoCierreConcurso() {	 
    super();
  }
  ...
  public void ejecucion() throws Exception {
    ...
    try {
      ...
      if (accion.equals("generar")){
        ...
        cargarPagina();
        getConfiguracionMenu("INCResultadoCierreConcurso");
      }
      
      } catch (Exception ex) {
        
        //pagina("contenido_informe_resultado_cierre_concurso_generar");
        //getConfiguracionMenu("INCResultadoCierreConcurso");
  ...
  private void cargarPagina() throws Exception{
    ...
    asignar("COMBO", "cbMonedaAnalisis", monedas, "DTOSalida.moneda_ROWSET");

   //Cargo Moneda por defecto
    MareBusinessID idMD = new MareBusinessID("REPMonedaDefecto");
    Vector parametrosMD = new Vector();
    parametrosMD.add(dto);
    parametrosMD.add(idMD);
     
    DTOSalida dtoSalMD = (DTOSalida) conectar("ConectorNegocios",parametrosMD).objeto("dtoSalida"); 
    RecordSet monedaD = (RecordSet)dtoSalMD.getResultado();
    asignarAtributo("VAR", "monedaDefecto", "valor", monedaD.getValueAt(0,0).toString());
  ...
  private void generarReporte() throws Exception{
    ...
    String excepcionesTipoOferta = conectorParametroLimpia("excepcionesTipoOferta", "", true);
    if(!excepcionesTipoOferta.equals("")) {
      datos.put(ConstantesREP.EXCEPCIONESTIPOOFERTAS, excepcionesTipoOferta);
    }
    ...
    datos.put(ConstantesREP.TITULO, "Resultados al Cierre de Concurso de Ventas");     
