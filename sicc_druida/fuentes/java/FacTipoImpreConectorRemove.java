...
public class FacTipoImpreConectorRemove  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","onector para la eliminación de elementos de la entidad FacTipoImpre" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGFacTipoImpreRemoveID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGFacTipoImpreRemoveDTO" );
