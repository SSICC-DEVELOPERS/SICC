/*
    INDRA/CAR/mmg
    $Id: ZonDivisPolitLPStartUp.java,v 1.1 2009/12/03 18:33:21 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class ZonDivisPolitLPStartUp extends MMGDruidaBase{
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "ZonDivisPolitPage", "cod", "ZonDivisPolit." + accion + ".label");
			...
			limpiarBotoneraLista("zonDivisPolit", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codDiviPoli", "validacion", "ValidaLongitud(cdos_trim(valor), 1, 3)");
		asignarAtributo("TEXT", "orde", "validacion", "ValidaLongitud(cdos_trim(valor), 0, 3)");
		

		//Primero determianmos el nombre del campo en la entidad de oriegen donde se van a cargar los datos
		asignar("VAR", "idAttributeLovOpener", conectorParametro(PARAMETRO_LOV_ATTRIBUTO));
		asignar("VAR", "idEntityLovOpener", conectorParametro(PARAMETRO_LOV_ENTIDAD));
		//asignarAtributo("CAPA", "zonDivisPolitLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "ZonDivisPolitPage", "onblur", "window.focus();");
	...
	protected void cmdView() throws Exception{
		...
		ZonDivisPolitData zonDivisPolitQuery= new ZonDivisPolitData();
		zonDivisPolitQuery.setId(new Integer(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		ZonDivisPolitData datosResult = (ZonDivisPolitData)getSingleObject(BUSINESSID_QUERY, zonDivisPolitQuery, 
			zonDivisPolitQuery.clone(), "zonDivisPolit");
		...
		ZonDivisPolitData zonDivisPolit = datosResult;
		asignarAtributo("LABELC", "lblViewCodDiviPoli", "valor", 
				FormatUtils.formatObject(zonDivisPolit.getCodDiviPoli(), 
				 MMGDruidaHelper.getUserDecimalFormatPattern(this), MMGDruidaHelper.getUserDecimalFormatSymbols(this)));			
	
		asignarAtributo("LABELC", "lblViewOrde", "valor", 
				FormatUtils.formatObject(zonDivisPolit.getOrde(), 
				 MMGDruidaHelper.getUserDecimalFormatPattern(this), MMGDruidaHelper.getUserDecimalFormatSymbols(this)));			
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "zonDivisPolitFrm", "oculto", "N");
		...
		ZonDivisPolitData zonDivisPolitQuery= new ZonDivisPolitData();
		zonDivisPolitQuery.setId(new Integer(id));
		...
		asignar("TEXT", "codDiviPoli", FormatUtils.formatObject(zonDivisPolit.getCodDiviPoli(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), MMGDruidaHelper.getUserDecimalFormatSymbols(this)));
	
		asignar("TEXT", "orde", FormatUtils.formatObject(zonDivisPolit.getOrde(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), MMGDruidaHelper.getUserDecimalFormatSymbols(this)));
		...
		//asignar("VAR","timestamp",Long.toString(zonDivisPolit.jdoGetTimeStamp()));
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","zonDivisPolitTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","zonDivisPolitTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","zonDivisPolitFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","zonDivisPolitPreListLayer", "y", String.valueOf(sizeForm + 24));
		asignarAtributo("CAPA","zonDivisPolitListLayer", "y", String.valueOf(sizeForm + 46));		
		asignarAtributo("CAPA","zonDivisPolitListButtonsLayer", "y", String.valueOf(sizeForm + 299));		
	}
	...
	* @param zonDivisPolit La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(ZonDivisPolitData zonDivisPolit) 
		throws Exception{
	...
	*/
	protected void setDependenceComboLabels(ZonDivisPolitData zonDivisPolit) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		ZonDivisPolitData zonDivisPolit = 
			(ZonDivisPolitData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(zonDivisPolit);
	}
	...
	*/
	protected void removeViewLabels() throws Exception{
		...
		borrarNodo("TR", "nombre", "codDiviPoliViewLabelTrId");
		borrarNodo("TR", "nombre", "ordeViewLabelTrId");
	...
	*/
	protected void removeWidgets() throws Exception{
		...
		borrarNodo("TR", "nombre", "codDiviPoliWidgetTrId");
		borrarNodo("TR", "nombre", "ordeWidgetTrId");
