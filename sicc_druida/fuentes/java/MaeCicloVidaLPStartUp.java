/*
    INDRA/CAR/mmg
    $Id: MaeCicloVidaLPStartUp.java,v 1.1 2009/12/03 18:42:36 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class MaeCicloVidaLPStartUp extends MMGDruidaBase{
	...
	public MaeCicloVidaLPStartUp(){
		super();
	}

	public void inicio() throws Exception {
		pagina("MaeCicloVidaPage");
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "MaeCicloVidaPage", "cod", "MaeCicloVida." + accion + ".label");
			...
			limpiarBotoneraLista("maeCicloVida", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codCiclVida", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 3);");
		...
		//asignarAtributo("CAPA", "maeCicloVidaLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "MaeCicloVidaPage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("MaeCicloVidaLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		MaeCicloVidaData maeCicloVidaQuery= new MaeCicloVidaData();
		maeCicloVidaQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		MaeCicloVidaData datosResult = (MaeCicloVidaData)getSingleObject(BUSINESSID_QUERY, maeCicloVidaQuery, 
			maeCicloVidaQuery.clone(), "maeCicloVida");
		...
		preservaHiddensI18n(new Integer(1), "MAE_CICLO_VIDA", "maeCicloVidaFrm", "Descripcion", true);
		...
		MaeCicloVidaData maeCicloVida = datosResult;
		asignar("TEXT", "codCiclVida", FormatUtils.formatObject(maeCicloVida.getCodCiclVida(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "Descripcion", FormatUtils.formatObject(maeCicloVida.getDescripcion(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		loadLocalizationVars(maeCicloVida);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "codCiclVida", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "MAE_CICLO_VIDA", "maeCicloVidaFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "codCiclVida", "req", "S");
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('maeCicloVidaFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "maeCicloVidaFrm", "oculto", "N");
		...
		traza("MMG::Creando MaeCicloVida");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		MaeCicloVidaData maeCicloVidaQuery= new MaeCicloVidaData();
		maeCicloVidaQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(maeCicloVida.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"maeCicloVidaFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"maeCicloVidaFrm\",1, false)");
					asignarAtributo("COMBO","paisOidPais", "ontab", "ejecutarAccionFocoModificacion(\"maeCicloVidaFrm\",2, true)");
					asignarAtributo("COMBO","paisOidPais", "onshtab", "ejecutarAccionFocoModificacion(\"maeCicloVidaFrm\",2, false)");
				asignarAtributo("AREATEXTO", "codCiclVida", "ontab","ejecutarAccionFocoModificacion(\"maeCicloVidaFrm\",3, true)");
				asignarAtributo("AREATEXTO", "codCiclVida", "onshtab","ejecutarAccionFocoModificacion(\"maeCicloVidaFrm\",3, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"maeCicloVidaFrm\",4, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"maeCicloVidaFrm\",4, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","maeCicloVidaTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","maeCicloVidaTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codCiclVida...");		
				
					traza("MMG: en desactivateNonModifyFields encontrado atributo no editable...");
				
						// borrarCampo("codCiclVida");
						asignarAtributo ("TEXT", "codCiclVida", "disabled", "S");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","maeCicloVidaFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","maeCicloVidaListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","maeCicloVidaListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(MaeCicloVidaData maeCicloVida) throws Exception{
		...
		if(maeCicloVida != null && maeCicloVida.getPaisOidPais() != null){
				checkCombo("paisOidPais" , maeCicloVida.getPaisOidPais().getId().toString());
			}
	...
	* @param maeCicloVida La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(MaeCicloVidaData maeCicloVida) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		MaeCicloVidaData maeCicloVida = 
			(MaeCicloVidaData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(maeCicloVida.getPaisOidPais() != null){
			maeCicloVida.setPaisOidPais((es.indra.belcorp.mso.SegPaisViewData)
			getSingleObject(BUSINESSID_PAISOIDPAIS_QUERY, 
			maeCicloVida.getPaisOidPais(),
			maeCicloVida.getPaisOidPais().clone(),
			"segPaisView"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(maeCicloVida);
		loadLeafDependenceCombos(maeCicloVida);
	}
	...
	*/
	...
	protected void loadLocalizationVars(MaeCicloVidaData maeCicloVida) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("MAE_CICLO_VIDA");
		mmgLocalizationQuery.setEntiPk(maeCicloVida.getId());
