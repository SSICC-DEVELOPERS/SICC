...
public class CalGuiasPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","calGuiasList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(17)).setAttribute("cod","CalGuias.codGuia.label" );
      ...
      ((Element)v.get(18)).setAttribute("cod","CalGuias.dpteOidDepa.label" );
      ...
      ((Element)v.get(19)).setAttribute("cod","CalGuias.valTitu.label" );
      ...
      ((Element)v.get(20)).setAttribute("cod","CalGuias.fecInicVali.label" );
      ...
      ((Element)v.get(21)).setAttribute("cod","CalGuias.fecFinVali.label" );
      ...
      ((Element)v.get(22)).setAttribute("cod","CalGuias.valDescGuia.label" );
