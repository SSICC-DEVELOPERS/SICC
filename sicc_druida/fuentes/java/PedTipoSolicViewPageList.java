...
public class PedTipoSolicViewPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","pedTipoSolicViewList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(17)).setAttribute("cod","PedTipoSolicView.codTipoSoli.label" );
      ...
      ((Element)v.get(18)).setAttribute("cod","PedTipoSolicView.indCons.label" );
      ...
      ((Element)v.get(19)).setAttribute("cod","PedTipoSolicView.indSoliNega.label" );
      ...
      ((Element)v.get(20)).setAttribute("cod","PedTipoSolicView.indDevo.label" );
      ...
      ((Element)v.get(21)).setAttribute("cod","PedTipoSolicView.indAnul.label" );
      ...
      ((Element)v.get(22)).setAttribute("cod","PedTipoSolicView.codGrupSoli.label" );
