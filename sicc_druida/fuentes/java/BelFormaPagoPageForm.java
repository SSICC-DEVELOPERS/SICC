...
public class BelFormaPagoPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","BelFormaPago.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","BelFormaPago.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('belFormaPagoFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('belFormaPagoFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(50)).setAttribute("nombre","codFormPagoTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lblCodFormPago" );
      ((Element)v.get(54)).setAttribute("alto","13" );
      ((Element)v.get(54)).setAttribute("filas","1" );
      ((Element)v.get(54)).setAttribute("id","datosTitle" );
      ((Element)v.get(54)).setAttribute("cod","BelFormaPago.codFormPago.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(55)).setAttribute("nombre","codFormPagoWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(57)).setAttribute("nombre","codFormPago" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('belFormaPagoFrm',2, true)" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('belFormaPagoFrm', 2, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(58)).setAttribute("nombre","codFormPagoGapTdId" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(79)).setAttribute("cod","BelFormaPago.Descripcion.label" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(83)).setAttribute("cols","40" );
      ...
      ((Element)v.get(83)).setAttribute("ontab","ejecutarAccionFoco('belFormaPagoFrm',3, true)" );
      ((Element)v.get(83)).setAttribute("onshtab","ejecutarAccionFoco('belFormaPagoFrm',3, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(84)).setAttribute("nombre","DescripcionTdLocalizationButtonGap" );
      ...
      ((Element)v.get(87)).setAttribute("href","javascript:openLocalizationDialog('belFormaPagoFrm', 'Descripcion', 1);" );
      ((Element)v.get(87)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"belFormaPagoFrm\",3, true)', 'ejecutarAccionFoco(\"belFormaPagoFrm\",3, false)')" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(93)).setAttribute("nombre","formGapTr2" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(100)).setAttribute("nombre","formTr3" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(106)).setAttribute("nombre","paisOidPaisTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(110)).setAttribute("nombre","lblpaisOidPais" );
      ((Element)v.get(110)).setAttribute("id","datosTitle" );
      ((Element)v.get(110)).setAttribute("ancho","150" );
      ((Element)v.get(110)).setAttribute("alto","13" );
      ((Element)v.get(110)).setAttribute("cod","BelFormaPago.paisOidPais.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(111)).setAttribute("nombre","paisOidPaisWidgetTrId" );
      ...
      ((Element)v.get(113)).setAttribute("nombre","paisOidPais" );
      ...
      ((Element)v.get(113)).setAttribute("ontab","ejecutarAccionFoco('belFormaPagoFrm',4, true);" );
      ((Element)v.get(113)).setAttribute("onshtab","ejecutarAccionFoco('belFormaPagoFrm',4, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(115)).setAttribute("nombre","paisOidPaisGapTdId" );
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(120)).setAttribute("nombre","formGapTr3" );
      ...
      /* Empieza nodo:129 / Elemento padre: 0   */
      v.add(doc.createElement("TR"));
      ((Element)v.get(129)).setAttribute("nombre","belFormaPagoTrButtons" );
      ((Element)v.get(0)).appendChild((Element)v.get(129));
      ...
      ((Element)v.get(136)).setAttribute("nombre","belFormaPagoTdQueryButton" );
      ((Element)v.get(135)).appendChild((Element)v.get(136));

      /* Empieza nodo:137 / Elemento padre: 136   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(137)).setAttribute("nombre","belFormaPagoQueryButton" );
      ((Element)v.get(137)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(137)).setAttribute("estado","false" );
      ((Element)v.get(137)).setAttribute("accion","belFormaPagoFirstPage();" );
      ...
      ((Element)v.get(138)).setAttribute("nombre","belFormaPagoTdLovNullSelectionButton" );
   ...
   private void getXML630(Document doc) {
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(140)).setAttribute("nombre","belFormaPagoLovNullButton" );
      ((Element)v.get(140)).setAttribute("ID","botonContenido" );
      ((Element)v.get(140)).setAttribute("tipo","html" );
      ((Element)v.get(140)).setAttribute("accion","belFormaPagoLovNullSelectionAction();" );
