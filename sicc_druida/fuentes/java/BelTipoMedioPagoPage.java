...
public class BelTipoMedioPagoPage  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","BelTipoMedioPagoPage" );
      ((Element)v.get(0)).setAttribute("titulo","" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","" );
      ((Element)v.get(0)).setAttribute("onload","belTipoMedioPagoInitComponents()" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","beltipomediopago.js" );
      ((Element)v.get(0)).appendChild((Element)v.get(4));
      /* Termina nodo:4   */

      /* Empieza nodo:5 / Elemento padre: 0   */
      v.add(doc.createElement("FORMULARIO"));
      ((Element)v.get(5)).setAttribute("nombre","belTipoMedioPagoFrm" );
      ...
      ((Element)v.get(6)).setAttribute("valor","BelTipoMedioPagoLPExecution" );
      ...
      ((Element)v.get(7)).setAttribute("valor","BelTipoMedioPagoLPExecution" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(37)).setAttribute("nombre","belTipoMedioPagoFormLayer" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(52)).setAttribute("cod","BelTipoMedioPago.legend.label" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(67)).setAttribute("cod","BelTipoMedioPago.id.label" );
      ...
      ((Element)v.get(70)).setAttribute("ontab","ejecutarAccionFoco('belTipoMedioPagoFrm',1, true)" );
      ((Element)v.get(70)).setAttribute("onshtab","ejecutarAccionFoco('belTipoMedioPagoFrm', 1, false)" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(92)).setAttribute("cod","BelTipoMedioPago.Descripcion.label" );
      ...
      ((Element)v.get(96)).setAttribute("ontab","ejecutarAccionFoco('belTipoMedioPagoFrm',4, true)" );
      ((Element)v.get(96)).setAttribute("onshtab","ejecutarAccionFoco('belTipoMedioPagoFrm', 4, false)" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(100)).setAttribute("href","javascript:openLocalizationDialog('belTipoMedioPagoFrm', 'Descripcion', 1);" );
      ((Element)v.get(100)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"belTipoMedioPagoFrm\",4, true)', 'ejecutarAccionFoco(\"belTipoMedioPagoFrm\",4, false)')" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(116)).setAttribute("nombre","belTipoMedioPagoTrButtons" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(123)).setAttribute("nombre","belTipoMedioPagoTdQueryButton" );
      ((Element)v.get(122)).appendChild((Element)v.get(123));

      /* Empieza nodo:124 / Elemento padre: 123   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(124)).setAttribute("nombre","belTipoMedioPagoQueryButton" );
      ((Element)v.get(124)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(124)).setAttribute("estado","false" );
      ((Element)v.get(124)).setAttribute("accion","belTipoMedioPagoFirstPage();" );
      ...
      ((Element)v.get(125)).setAttribute("nombre","belTipoMedioPagoTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(127)).setAttribute("nombre","belTipoMedioPagoLovNullButton" );
      ((Element)v.get(127)).setAttribute("ID","botonContenido" );
      ((Element)v.get(127)).setAttribute("tipo","html" );
      ((Element)v.get(127)).setAttribute("accion","belTipoMedioPagoLovNullSelectionAction();" );
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(130)).setAttribute("nombre","belTipoMedioPagoListLayer" );
      ...
      ((Element)v.get(131)).setAttribute("nombre","belTipoMedioPagoList" );
   ...
   private void getXML630(Document doc) {
      ...
      ((Element)v.get(143)).setAttribute("cod","BelTipoMedioPago.Descripcion.label" );
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(147)).setAttribute("nombre","belTipoMedioPagoListButtonsLayer" );
   ...
   private void getXML720(Document doc) {
      ...
      ((Element)v.get(153)).setAttribute("nombre","belTipoMedioPagoPaginationButtonBar" );
      ...
      ((Element)v.get(154)).setAttribute("nombre","belTipoMedioPagoFirstPageButton" );
      ((Element)v.get(154)).setAttribute("funcion","belTipoMedioPagoFirstPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(155)).setAttribute("nombre","belTipoMedioPagoFirstPageButtonGapTd" );
      ...
      v.add(doc.createElement("BTN"));
      ((Element)v.get(157)).setAttribute("nombre","belTipoMedioPagoPreviousPageButton" );
      ((Element)v.get(157)).setAttribute("funcion","belTipoMedioPagoPreviousPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(158)).setAttribute("nombre","belTipoMedioPagoPreviousPageButtonGapTd" );
      ...
      v.add(doc.createElement("BTN"));
      ((Element)v.get(160)).setAttribute("nombre","belTipoMedioPagoNextPageButton" );
      ((Element)v.get(160)).setAttribute("funcion","belTipoMedioPagoNextPage();" );
      ...
      ((Element)v.get(163)).setAttribute("nombre","belTipoMedioPagoUpdateButtonTd" );
      ((Element)v.get(149)).appendChild((Element)v.get(163));

      /* Empieza nodo:164 / Elemento padre: 163   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(164)).setAttribute("nombre","belTipoMedioPagoUpdateButton" );
      ((Element)v.get(164)).setAttribute("ID","botonContenido" );
      ((Element)v.get(164)).setAttribute("tipo","html" );
      ((Element)v.get(164)).setAttribute("accion","belTipoMedioPagoUpdateSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(165)).setAttribute("nombre","belTipoMedioPagoUpdateButtonGapTd" );
   ...
   private void getXML810(Document doc) {
      ...
      ((Element)v.get(167)).setAttribute("nombre","belTipoMedioPagoViewForRemoveButtonTd" );
      ((Element)v.get(149)).appendChild((Element)v.get(167));

      /* Empieza nodo:168 / Elemento padre: 167   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(168)).setAttribute("nombre","belTipoMedioPagoViewForRemoveButton" );
      ((Element)v.get(168)).setAttribute("ID","botonContenido" );
      ((Element)v.get(168)).setAttribute("tipo","html" );
      ((Element)v.get(168)).setAttribute("accion","belTipoMedioPagoViewSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(169)).setAttribute("nombre","belTipoMedioPagoViewForRemoveButtonGapTd" );
      ...
      ((Element)v.get(171)).setAttribute("nombre","belTipoMedioPagoLovSelectButtonTd" );
      ((Element)v.get(149)).appendChild((Element)v.get(171));

      /* Empieza nodo:172 / Elemento padre: 171   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(172)).setAttribute("nombre","belTipoMedioPagoLovSelectButton" );
      ((Element)v.get(172)).setAttribute("ID","botonContenido" );
      ((Element)v.get(172)).setAttribute("tipo","html" );
      ((Element)v.get(172)).setAttribute("accion","belTipoMedioPagoLovSelectionAction();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(173)).setAttribute("nombre","belTipoMedioPagoLovSelectButtonGapTd" );
      ...
      ((Element)v.get(175)).setAttribute("nombre","belTipoMedioPagoViewButtonTd" );
      ((Element)v.get(149)).appendChild((Element)v.get(175));

      /* Empieza nodo:176 / Elemento padre: 175   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(176)).setAttribute("nombre","belTipoMedioPagoViewButton" );
      ((Element)v.get(176)).setAttribute("ID","botonContenido" );
      ((Element)v.get(176)).setAttribute("tipo","html" );
      ((Element)v.get(176)).setAttribute("accion","belTipoMedioPagoViewSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(177)).setAttribute("nombre","belTipoMedioPagoViewButtonGapTd" );
