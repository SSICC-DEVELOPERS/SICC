...
public class CobAccioCobraPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","cobAccioCobraList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","CobAccioCobra.codAcciCobr.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","CobAccioCobra.valDesc.label" );
