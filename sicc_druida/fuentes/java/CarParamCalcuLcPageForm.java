...
public class CarParamCalcuLcPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","CarParamCalcuLc.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","CarParamCalcuLc.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('carParamCalcuLcFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('carParamCalcuLcFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(50)).setAttribute("nombre","niriOidNiveRiesTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lblniriOidNiveRies" );
      ((Element)v.get(54)).setAttribute("id","datosTitle" );
      ((Element)v.get(54)).setAttribute("ancho","150" );
      ((Element)v.get(54)).setAttribute("alto","13" );
      ((Element)v.get(54)).setAttribute("cod","CarParamCalcuLc.niriOidNiveRies.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(55)).setAttribute("nombre","niriOidNiveRiesWidgetTrId" );
      ...
      ((Element)v.get(57)).setAttribute("nombre","niriOidNiveRies" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('carParamCalcuLcFrm',2, true);" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('carParamCalcuLcFrm',2, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(59)).setAttribute("nombre","niriOidNiveRiesGapTdId" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(61)).setAttribute("nombre","valTopeTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(66)).setAttribute("nombre","valTopeWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(68)).setAttribute("nombre","valTope" );
      ...
      ((Element)v.get(68)).setAttribute("ontab","ejecutarAccionFoco('carParamCalcuLcFrm',3, true)" );
      ((Element)v.get(68)).setAttribute("onshtab","ejecutarAccionFoco('carParamCalcuLcFrm', 3, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(69)).setAttribute("nombre","valTopeGapTdId" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(71)).setAttribute("nombre","valFactCalcTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(75)).setAttribute("nombre","lblValFactCalc" );
      ((Element)v.get(75)).setAttribute("alto","13" );
      ((Element)v.get(75)).setAttribute("filas","1" );
      ((Element)v.get(75)).setAttribute("id","datosTitle" );
      ((Element)v.get(75)).setAttribute("cod","CarParamCalcuLc.valFactCalc.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(76)).setAttribute("nombre","valFactCalcWidgetTrId" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(78)).setAttribute("ontab","ejecutarAccionFoco('carParamCalcuLcFrm',4, true)" );
      ((Element)v.get(78)).setAttribute("onshtab","ejecutarAccionFoco('carParamCalcuLcFrm', 4, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(79)).setAttribute("nombre","valFactCalcGapTdId" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(81)).setAttribute("nombre","indVariLineCredTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(85)).setAttribute("nombre","lblIndVariLineCred" );
      ...
      ((Element)v.get(85)).setAttribute("cod","CarParamCalcuLc.indVariLineCred.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(86)).setAttribute("nombre","indVariLineCredWidgetTrId" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(88)).setAttribute("nombre","indVariLineCred" );
      ...
      ((Element)v.get(88)).setAttribute("ontab","ejecutarAccionFoco('carParamCalcuLcFrm',5, true)" );
      ((Element)v.get(88)).setAttribute("onshtab","ejecutarAccionFoco('carParamCalcuLcFrm',5, false)" );
      ...
      ((Element)v.get(90)).setAttribute("ID","A" );
      ...
      ((Element)v.get(91)).setAttribute("VALOR","A" );
      ...
      ((Element)v.get(92)).setAttribute("VALOR","Aumentar LC" );
      ...
      v.add(doc.createElement("ROW"));
      ((Element)v.get(93)).setAttribute("ID","D" );
   }
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(94)).setAttribute("VALOR","D" );
      ...
      ((Element)v.get(95)).setAttribute("VALOR","Disminuir LC" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(96)).setAttribute("nombre","indVariLineCredGapTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(110)).setAttribute("nombre","carParamCalcuLcTrButtons" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(117)).setAttribute("nombre","carParamCalcuLcTdQueryButton" );
      ((Element)v.get(116)).appendChild((Element)v.get(117));

      /* Empieza nodo:118 / Elemento padre: 117   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(118)).setAttribute("nombre","carParamCalcuLcQueryButton" );
      ((Element)v.get(118)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(118)).setAttribute("estado","false" );
      ((Element)v.get(118)).setAttribute("accion","carParamCalcuLcFirstPage();" );
      ...
      ((Element)v.get(119)).setAttribute("nombre","carParamCalcuLcTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(121)).setAttribute("nombre","carParamCalcuLcLovNullButton" );
      ((Element)v.get(121)).setAttribute("ID","botonContenido" );
      ((Element)v.get(121)).setAttribute("tipo","html" );
      ((Element)v.get(121)).setAttribute("accion","carParamCalcuLcLovNullSelectionAction();" );
