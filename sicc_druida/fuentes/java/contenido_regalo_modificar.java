...
public class contenido_regalo_modificar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_regalo_modificar" );
      ...
      ((Element)v.get(1)).setAttribute("src","contenido_regalo_modificar.js" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(13)).setAttribute("nombre","hOids" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(41)).setAttribute("nombre","lblCodRegalo" );
      ...
      ((Element)v.get(41)).setAttribute("cod","717" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(45)).setAttribute("nombre","lblCodProducto" );
      ...
      ((Element)v.get(45)).setAttribute("cod","337" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(52)).setAttribute("onshtab","focalizaOnshtabCod();" );
      ...
      ((Element)v.get(56)).setAttribute("size","26" );
      ((Element)v.get(56)).setAttribute("valor","" );
      ((Element)v.get(56)).setAttribute("validacion","" );
      ((Element)v.get(56)).setAttribute("onblur","noFocoCodProd();" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(72)).setAttribute("accion","onClickBuscar();" );
      ((Element)v.get(72)).setAttribute("ontab","focalizaOntabBuscar();" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(94)).setAttribute("ancho","60" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(95)).setAttribute("ancho","130" );
      ...
      ((Element)v.get(97)).setAttribute("cod","717" );
      ((Element)v.get(96)).appendChild((Element)v.get(97));

      /* Elemento padre:97 / Elemento actual: 98   */
      v.add(doc.createTextNode("Cód. regalo"));
      ...
      ((Element)v.get(101)).setAttribute("tipoEnvio","edicion" );
      ((Element)v.get(101)).setAttribute("formaEnvio","xml" );
      ((Element)v.get(101)).setAttribute("maxSel","-1" );
      ((Element)v.get(101)).setAttribute("msgErrMaxSel","" );
      ((Element)v.get(101)).setAttribute("coloresScrollNativo","#D4D0C8,black,white,#D4D0C8,#D4D0C8,#ECE9E4,black" );
      ((Element)v.get(101)).setAttribute("colorROver","#D0D9E8" );
      ((Element)v.get(101)).setAttribute("onLoad","" );
      ((Element)v.get(101)).setAttribute("colorSelecc","#D0D9E8" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(105)).setAttribute("nombre","mipgndo" );
      ((Element)v.get(105)).setAttribute("onload","procesarPaginado(mipgndo,msgError, ultima, rowset, 'muestraLista(ultima, rowset)');" );
      ((Element)v.get(105)).setAttribute("ancho","404" );
      ((Element)v.get(105)).setAttribute("sep","$" );
      ((Element)v.get(105)).setAttribute("x","12" );
      ((Element)v.get(105)).setAttribute("class","botonera" );
      ((Element)v.get(105)).setAttribute("y","276" );
      ((Element)v.get(105)).setAttribute("control","|" );
      ((Element)v.get(105)).setAttribute("conector","ConectorConsultaRegalo" );
      ((Element)v.get(105)).setAttribute("rowset","" );
      ((Element)v.get(105)).setAttribute("cargainicial","N" );
      ...
      ((Element)v.get(106)).setAttribute("y","280" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(107)).setAttribute("nombre","ava1" );
      ((Element)v.get(107)).setAttribute("x","52" );
      ((Element)v.get(107)).setAttribute("y","280" );
      ((Element)v.get(107)).setAttribute("ID","botonContenido" );
      ((Element)v.get(107)).setAttribute("img","avanzar_on" );
      ...
      ((Element)v.get(107)).setAttribute("accion","mipgndo.avanzar();" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(108)).setAttribute("nombre","primera1" );
      ((Element)v.get(108)).setAttribute("x","20" );
      ((Element)v.get(108)).setAttribute("y","280" );
      ((Element)v.get(108)).setAttribute("ID","botonContenido" );
      ((Element)v.get(108)).setAttribute("img","primera_on" );
      ((Element)v.get(108)).setAttribute("tipo","-2" );
      ((Element)v.get(108)).setAttribute("estado","false" );
      ((Element)v.get(108)).setAttribute("alt","" );
      ((Element)v.get(108)).setAttribute("codigo","" );
      ((Element)v.get(108)).setAttribute("accion","mipgndo.retrocederPrimeraPagina();" );
      ((Element)v.get(82)).appendChild((Element)v.get(108));
      /* Termina nodo:108   */

      /* Empieza nodo:109 / Elemento padre: 82   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(109)).setAttribute("nombre","separa" );
      ((Element)v.get(109)).setAttribute("x","59" );
      ((Element)v.get(109)).setAttribute("y","276" );
      ((Element)v.get(109)).setAttribute("ID","botonContenido" );
      ((Element)v.get(109)).setAttribute("img","separa_base" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(110)).setAttribute("nombre","Modificar" );
      ((Element)v.get(110)).setAttribute("x","80" );
      ((Element)v.get(110)).setAttribute("y","277" );
      ...
      ((Element)v.get(110)).setAttribute("cod","2" );
      ((Element)v.get(110)).setAttribute("accion","onClickModificar();" );
      ((Element)v.get(110)).setAttribute("ontab","focalizaOntab();" );
      ((Element)v.get(110)).setAttribute("onshtab","focalizaOnshtab();" );
      ((Element)v.get(82)).appendChild((Element)v.get(110));
      /* Termina nodo:110   */

      /* Empieza nodo:111 / Elemento padre: 82   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(111)).setAttribute("nombre","Detalle" );
      ((Element)v.get(111)).setAttribute("x","80" );
      ((Element)v.get(111)).setAttribute("y","277" );
      ...
      ((Element)v.get(111)).setAttribute("cod","3" );
      ((Element)v.get(111)).setAttribute("accion","onClickDetealle();" );
      ((Element)v.get(111)).setAttribute("ontab","focalizaOntab();" );
      ((Element)v.get(111)).setAttribute("onshtab","focalizaOnshtab();" );
      ((Element)v.get(82)).appendChild((Element)v.get(111));
      /* Termina nodo:111   */
      /* Termina nodo:82   */

      /* Empieza nodo:112 / Elemento padre: 5   */
   }
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(112)).setAttribute("y","423" );
      ((Element)v.get(5)).appendChild((Element)v.get(112));
      /* Termina nodo:112   */
      /* Termina nodo:5   */
