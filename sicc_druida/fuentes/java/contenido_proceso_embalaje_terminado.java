...
public class contenido_proceso_embalaje_terminado  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_proceso_embalaje_terminado" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","contenido_proceso_embalaje_terminado.js" );
      ...
      ((Element)v.get(7)).setAttribute("name","txtCodigoBarraEtiqueta" );
      ...
      ((Element)v.get(7)).setAttribute("cod","3355" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(14)).setAttribute("nombre","varAnio" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(15)).setAttribute("nombre","numeroConsolidado" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(16)).setAttribute("nombre"," numeroCaja" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(19)).setAttribute("nombre","codigoBarraEtiqueta" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(35)).setAttribute("nombre","lblSeleccionOrdenAnaquel" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(44)).setAttribute("nombre","lblCodigoBarraEtiqueta" );
      ...
      ((Element)v.get(44)).setAttribute("cod","3355" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(53)).setAttribute("nombre","txtCodigoBarraEtiqueta" );
      ((Element)v.get(53)).setAttribute("id","datosCampos" );
      ((Element)v.get(53)).setAttribute("max","11" );
      ...
      ((Element)v.get(53)).setAttribute("onchange","onChangeTxtCodigoBarraEtiqueta();" );
      ((Element)v.get(53)).setAttribute("ontab","onTab('txtCodigoBarraEtiqueta');" );
      ((Element)v.get(53)).setAttribute("onshtab","onShiftTab('txtCodigoBarraEtiqueta');" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(57)).setAttribute("nombre","Mensajes" );
      ...
      /* Empieza nodo:63 / Elemento padre: 33   */
      v.add(doc.createElement("table"));
      ...
      ((Element)v.get(33)).appendChild((Element)v.get(63));
      ...
      ((Element)v.get(66)).setAttribute("nombre","btnProcesar" );
      ((Element)v.get(66)).setAttribute("ID","botonContenido" );
      ((Element)v.get(66)).setAttribute("tipo","html" );
      ((Element)v.get(66)).setAttribute("accion","onClickBtnProcesar();" );
      ((Element)v.get(66)).setAttribute("estado","false" );
      ((Element)v.get(66)).setAttribute("cod","3055" );
      ((Element)v.get(66)).setAttribute("ontab","onTab('btnProcesar');" );
      ((Element)v.get(66)).setAttribute("onshtab","onShiftTab('btnProcesar');" );
