...
public class MaeRespuEncueViewConectorQueryList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad MaeRespuEncueView" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGMaeRespuEncueViewQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGMaeRespuEncueViewQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","MaeRespuEncueViewListFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","codResp" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(8)).setAttribute("NOMBRE","valPeso" );
