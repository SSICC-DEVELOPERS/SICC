...
public class contenido_completa_IVR_enviar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_completa_IVR_enviar" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(3)).setAttribute("src","contenido_completa_IVR_enviar.js" );
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(9)).setAttribute("name","cbInterfaz" );
      ((Element)v.get(9)).setAttribute("required","true" );
      ((Element)v.get(9)).setAttribute("cod","908" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(17)).setAttribute("nombre","modoEnvio" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(59)).setAttribute("onchange","marcaOnChange();" );
      ...
      ((Element)v.get(59)).setAttribute("onshtab","document.all['btnEnviar'].focus();" );
      ...
      ((Element)v.get(64)).setAttribute("onchange","canalOnChange();" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(112)).setAttribute("cod","844" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(119)).setAttribute("nombre","lbldtLote" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(143)).setAttribute("msjreq","" );
      ((Element)v.get(143)).setAttribute("nombre","areatxtObservaciones" );
      ((Element)v.get(143)).setAttribute("readonly","N" );
      ((Element)v.get(143)).setAttribute("req","N" );
      ((Element)v.get(143)).setAttribute("rows","3" );
      ((Element)v.get(143)).setAttribute("tabindex","2" );
      ...
      /* Empieza nodo:151 / Elemento padre: 22   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(22)).appendChild((Element)v.get(151));
      ...
      ((Element)v.get(153)).setAttribute("height","15" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(160)).setAttribute("nombre","lblInterfacesEnviar" );
      ((Element)v.get(160)).setAttribute("alto","13" );
      ((Element)v.get(160)).setAttribute("filas","1" );
      ((Element)v.get(160)).setAttribute("cod","00635" );
   ...
   private void getXML630(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(179)).setAttribute("nombre","cbInterfaz" );
   ...
   private void getXML720(Document doc) {
      ...
      ((Element)v.get(196)).setAttribute("nombre","btnEnviar" );
      ((Element)v.get(196)).setAttribute("ID","botonContenido" );
      ((Element)v.get(196)).setAttribute("tipo","html" );
      ((Element)v.get(196)).setAttribute("accion","onClickEnviar();" );
      ((Element)v.get(196)).setAttribute("estado","false" );
      ((Element)v.get(196)).setAttribute("cod","1597" );
      ((Element)v.get(196)).setAttribute("ontab","focaliza('frmFormulario.cbMarca');" );
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(202)).setAttribute("width","756" );
      ...
      ((Element)v.get(205)).setAttribute("height","1" );
