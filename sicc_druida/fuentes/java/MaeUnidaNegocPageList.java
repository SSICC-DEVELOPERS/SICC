...
public class MaeUnidaNegocPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","maeUnidaNegocList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","MaeUnidaNegoc.codUnidNego.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","MaeUnidaNegoc.Descripcion.label" );
