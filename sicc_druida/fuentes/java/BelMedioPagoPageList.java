...
public class BelMedioPagoPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","belMedioPagoList" );
      ...
      ((Element)v.get(14)).setAttribute("cod","BelMedioPago.codMediPago.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","BelMedioPago.Descripcion.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","BelMedioPago.tmepOidTipoMediPago.label" );
