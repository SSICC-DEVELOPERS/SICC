...
public class ConectorEliminarAsociacionNiveles  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Elimina Asociacion Niveles Socioeconomicos" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","EliminarNivelesDTO" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","BuscarAsociaciones" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(5)).setAttribute("NOMBRE","SegEliminarNivelesDTO" );
