...
public class CarAsignEjecuCuentPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","carAsignEjecuCuentList" );
      ...
      ((Element)v.get(14)).setAttribute("height","20" );
      ((Element)v.get(14)).setAttribute("IDScroll","EstCab" );
      ((Element)v.get(14)).setAttribute("imgFondo","" );
      ((Element)v.get(14)).setAttribute("colFondo","#CCCCCC" );
      ...
      ((Element)v.get(15)).setAttribute("cod","CarAsignEjecuCuent.niriOidNiveRies.label" );
   }
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(16)).setAttribute("cod","CarAsignEjecuCuent.zsgvOidSubgVent.label" );
      ...
      ((Element)v.get(17)).setAttribute("cod","CarAsignEjecuCuent.zorgOidRegi.label" );
      ...
      ((Element)v.get(18)).setAttribute("cod","CarAsignEjecuCuent.zzonOidZona.label" );
      ...
      ((Element)v.get(19)).setAttribute("cod","CarAsignEjecuCuent.ejcuOidEjecCuen.label" );
      ...
      ((Element)v.get(20)).setAttribute("accion","" );
      ((Element)v.get(20)).setAttribute("tipoEnvio","seleccion" );
      ((Element)v.get(20)).setAttribute("formaEnvio","xml" );
      ((Element)v.get(20)).setAttribute("maxSel","1" );
      ((Element)v.get(20)).setAttribute("msgErrMaxSel","" );
      ((Element)v.get(20)).setAttribute("coloresScrollNativo","#D4D0C8,black,white,#D4D0C8,#D4D0C8,#ECE9E4,black" );
      ((Element)v.get(20)).setAttribute("colorROver","#D0D9E8" );
      ((Element)v.get(20)).setAttribute("onLoad","" );
      ((Element)v.get(20)).setAttribute("colorSelecc","#D0D9E8" );
      ((Element)v.get(0)).appendChild((Element)v.get(20));

      /* Empieza nodo:21 / Elemento padre: 20   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(21)).setAttribute("tipo","texto" );
      ((Element)v.get(21)).setAttribute("ID","EstDat" );
      ((Element)v.get(20)).appendChild((Element)v.get(21));
      /* Termina nodo:21   */

      /* Empieza nodo:22 / Elemento padre: 20   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(22)).setAttribute("tipo","texto" );
      ((Element)v.get(22)).setAttribute("ID","EstDat2" );
      ((Element)v.get(20)).appendChild((Element)v.get(22));
      /* Termina nodo:22   */

      /* Empieza nodo:23 / Elemento padre: 20   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(23)).setAttribute("tipo","texto" );
      ((Element)v.get(23)).setAttribute("ID","EstDat" );
      ...
      ((Element)v.get(24)).setAttribute("ID","EstDat2" );
