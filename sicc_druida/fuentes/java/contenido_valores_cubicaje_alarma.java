...
public class contenido_valores_cubicaje_alarma  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_valores_cubicaje_alarma" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","contenido_valores_cubicaje_alarma.js" );
      ...
      ((Element)v.get(7)).setAttribute("group","gAlarmaCub" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(19)).setAttribute("nombre","hDescLinea" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(35)).setAttribute("nombre","lblDatosDeAlta" );
      ((Element)v.get(35)).setAttribute("alto","13" );
      ((Element)v.get(35)).setAttribute("filas","1" );
      ((Element)v.get(35)).setAttribute("cod","ApeCajasCheq.datosProd.label" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(44)).setAttribute("nombre","lblCentroDistribucionl" );
      ...
      ((Element)v.get(44)).setAttribute("cod","ApeAlamaValoresCubic.centroDistrib.label" );
   ...
   private void getXML180(Document doc) {
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(48)).setAttribute("nombre","lblLineaArmado" );
      ...
      ((Element)v.get(48)).setAttribute("cod","ApeAlamaValoresCubic.lineaArmado.label" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(60)).setAttribute("nombre","cbLineas" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(78)).setAttribute("accion","onClickAceptar();" );
      ((Element)v.get(78)).setAttribute("estado","false" );
      ((Element)v.get(78)).setAttribute("cod","ApeCajasCheq.aceptar.label" );
      ((Element)v.get(78)).setAttribute("ontab","focalizaCD();" );
      ...
      /* Empieza nodo:81 / Elemento padre: 21   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(21)).appendChild((Element)v.get(81));
      ...
      ((Element)v.get(88)).setAttribute("x","6" );
      ((Element)v.get(88)).setAttribute("y","135" );
   ...
   private void getXML360(Document doc) {
      ((Element)v.get(89)).setAttribute("x","7" );
      ...
      ((Element)v.get(97)).setAttribute("cod","00133" );
      ...
      ((Element)v.get(104)).setAttribute("cod","ApeAlamaValoresCubic.lineaArmado.label" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(106)).setAttribute("cod","ApeAlamaValoresCubic.infoRegProblemas.label" );
      ((Element)v.get(103)).appendChild((Element)v.get(106));

      /* Elemento padre:106 / Elemento actual: 107   */
      v.add(doc.createTextNode("Informaciión registros problema"));
      ...
      ((Element)v.get(108)).setAttribute("cod","ApeAlamaValoresCubic.textoProblema.label" );
      ((Element)v.get(103)).appendChild((Element)v.get(108));

      /* Elemento padre:108 / Elemento actual: 109   */
      v.add(doc.createTextNode("Texto descriptivo del problema"));
      ...
      ((Element)v.get(115)).setAttribute("ancho","679" );
      ...
      ((Element)v.get(115)).setAttribute("conector","ConectorBuscarCargosAbonos" );
      ...
      ((Element)v.get(116)).setAttribute("y","282" );
      ...
      ((Element)v.get(117)).setAttribute("y","282" );
      ...
      ((Element)v.get(118)).setAttribute("y","282" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(119)).setAttribute("y","278" );
