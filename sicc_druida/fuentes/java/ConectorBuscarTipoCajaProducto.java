...
public class ConectorBuscarTipoCajaProducto  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","APE Conector Buscar Tipo Caja Producto" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","DTOTipoCajaProducto" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","COD_CAJA" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(9)).setAttribute("NOMBRE","SICC_ES_ULTIMA_PAGINA" );
