...
public class MaeEncueNseViewPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","maeEncueNseViewList" );
      ...
      ((Element)v.get(14)).setAttribute("cod","MaeEncueNseView.codTipoEncu.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","MaeEncueNseView.Descripcion.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","MaeEncueNseView.marcOidMarc.label" );
