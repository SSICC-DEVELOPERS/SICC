...
public class ConectorObtenerUsuariosCobComboPerfil  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Usuarios de cobranza " );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","DTOUsuarioPerfil" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","COBObtenerUsuariosCobComboPerfil" );
      ...
      ((Element)v.get(5)).setAttribute("NOMBRE","dtoSalida.usuarios" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(8)).setAttribute("NOMBRE","DTOUsuariosCobComboPerfil" );
      ((Element)v.get(8)).setAttribute("TIPO","OBJETO" );
