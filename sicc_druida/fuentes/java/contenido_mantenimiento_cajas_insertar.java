...
public class contenido_mantenimiento_cajas_insertar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_mantenimiento_cajas_insertar" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","contenido_mantenimiento_cajas_insertar.js" );
      ...
      ((Element)v.get(8)).setAttribute("cod","10" );
      ...
      ((Element)v.get(9)).setAttribute("cod","122" );
      ((Element)v.get(6)).appendChild((Element)v.get(9));
      /* Termina nodo:9   */

      /* Empieza nodo:10 / Elemento padre: 6   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(10)).setAttribute("name","txtCodigoCaja" );
      ((Element)v.get(10)).setAttribute("required","true" );
      ((Element)v.get(10)).setAttribute("cod","BelCaja.codCaja.label" );
      ((Element)v.get(10)).setAttribute("format","t" );
      ((Element)v.get(10)).setAttribute("chars","a-zA-Z0-9" );
      ((Element)v.get(10)).setAttribute("min","1" );
      ((Element)v.get(10)).setAttribute("max","3" );
      ((Element)v.get(6)).appendChild((Element)v.get(10));
      /* Termina nodo:10   */

      /* Empieza nodo:11 / Elemento padre: 6   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(11)).setAttribute("name","cbRespCierreCaja" );
      ((Element)v.get(11)).setAttribute("required","true" );
      ((Element)v.get(11)).setAttribute("cod","BelCaja.userOidUser.label" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(19)).setAttribute("nombre","oidCaja" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(23)).setAttribute("nombre","oidAcceso" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(24)).setAttribute("nombre","oidSubacceso" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(25)).setAttribute("nombre","oidTipoCaja" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(26)).setAttribute("nombre","oidRespCierreCaja" );
      ...
      ((Element)v.get(42)).setAttribute("cod","BelCaja.legend.label" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(58)).setAttribute("onshtab","focaliza('cbTipoCaja')" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(70)).setAttribute("nombre","lblAcceso" );
      ...
      ((Element)v.get(70)).setAttribute("cod","10" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(74)).setAttribute("nombre","lblSubacceso" );
      ...
      ((Element)v.get(74)).setAttribute("cod","122" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(81)).setAttribute("nombre","cbAcceso" );
      ...
      ((Element)v.get(81)).setAttribute("onchange","accesoOnChange();" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(86)).setAttribute("nombre","cbSubacceso" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(97)).setAttribute("nombre","lblCodigoCaja" );
      ...
      ((Element)v.get(97)).setAttribute("cod","BelCaja.codCaja.label" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(101)).setAttribute("nombre","lblRespCierreCaja" );
      ((Element)v.get(101)).setAttribute("alto","3" );
      ((Element)v.get(101)).setAttribute("filas","1" );
      ((Element)v.get(101)).setAttribute("valor","" );
      ((Element)v.get(101)).setAttribute("id","datosTitle" );
      ((Element)v.get(101)).setAttribute("cod","BelCaja.userOidUser.label" );
      ...
      /* Empieza nodo:104 / Elemento padre: 65   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(65)).appendChild((Element)v.get(104));
      ...
      ((Element)v.get(108)).setAttribute("nombre","txtCodigoCaja" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(112)).setAttribute("nombre","cbRespCierreCaja" );
   }
   ...
   private void getXML450(Document doc) {
      ...
      /* Empieza nodo:116 / Elemento padre: 65   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(65)).appendChild((Element)v.get(116));
      ...
      /* Empieza nodo:119 / Elemento padre: 40   */
      v.add(doc.createElement("table"));
      ...
      ((Element)v.get(40)).appendChild((Element)v.get(119));
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(124)).setAttribute("nombre","lblTipoCaja" );
      ((Element)v.get(124)).setAttribute("alto","3" );
      ((Element)v.get(124)).setAttribute("filas","1" );
      ((Element)v.get(124)).setAttribute("valor","" );
      ((Element)v.get(124)).setAttribute("id","datosTitle" );
      ((Element)v.get(124)).setAttribute("cod","BelCaja.ticjOidTipoCaja.label" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(131)).setAttribute("nombre","cbTipoCaja" );
      ...
      ((Element)v.get(131)).setAttribute("ontab","focaliza('formulario.cbCanal')" );
   ...
   private void getXML540(Document doc) {
      ...
      /* Empieza nodo:138 / Elemento padre: 36   */
      v.add(doc.createElement("td"));
      ((Element)v.get(36)).appendChild((Element)v.get(138));
      ...
      /* Empieza nodo:140 / Elemento padre: 28   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(28)).appendChild((Element)v.get(140));
