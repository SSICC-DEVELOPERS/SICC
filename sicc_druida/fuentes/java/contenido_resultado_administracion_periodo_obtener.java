...
public class contenido_resultado_administracion_periodo_obtener  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_resultado_administracion_periodo_obtener" );
      ((Element)v.get(0)).setAttribute("cod","0762" );
      ((Element)v.get(0)).setAttribute("titulo","Obtener resultados de administración de cartera por período" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(20)).setAttribute("nombre","tipoSolicitud" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(21)).setAttribute("nombre","nivelRiesgo" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(86)).setAttribute("nombre","cbSubgerenciaVenta" );
      ...
      ((Element)v.get(86)).setAttribute("onchange","onchangeSGV();" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(111)).setAttribute("nombre","cbRegion" );
      ...
      ((Element)v.get(111)).setAttribute("onchange","onchange_Region();" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(137)).setAttribute("nombre","cbTipoSolicitud" );
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(151)).setAttribute("nombre","lblPeriodo" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(162)).setAttribute("nombre","cbPeriodo" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(167)).setAttribute("nombre","cbNivelRiesgo" );
   ...
   private void getXML630(Document doc) {
      ...
      ((Element)v.get(184)).setAttribute("accion","generar();" );
      ((Element)v.get(184)).setAttribute("estado","false" );
      ((Element)v.get(184)).setAttribute("cod","2495" );
      ((Element)v.get(184)).setAttribute("ontab","focaliza('Formulario.cbMarca');" );
