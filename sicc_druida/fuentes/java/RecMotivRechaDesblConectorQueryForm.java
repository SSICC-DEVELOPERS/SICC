...
public class RecMotivRechaDesblConectorQueryForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad RecMotivRechaDesbl" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGRecMotivRechaDesblQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGRecMotivRechaDesblQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","RecMotivRechaDesblFormFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(8)).setAttribute("NOMBRE","codRechDesb" );
