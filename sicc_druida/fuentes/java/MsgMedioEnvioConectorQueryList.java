...
public class MsgMedioEnvioConectorQueryList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad MsgMedioEnvio" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGMsgMedioEnvioQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGMsgMedioEnvioQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","MsgMedioEnvioListFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","codMediEnvi" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(8)).setAttribute("NOMBRE","desMediEnvi" );
