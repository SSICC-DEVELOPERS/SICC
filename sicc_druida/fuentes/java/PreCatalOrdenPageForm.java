...
public class PreCatalOrdenPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","PreCatalOrden.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","PreCatalOrden.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('preCatalOrdenFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('preCatalOrdenFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(54)).setAttribute("cod","PreCatalOrden.marcOidMarc.label" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('preCatalOrdenFrm',2, true);" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('preCatalOrdenFrm',2, false);" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(61)).setAttribute("nombre","canaOidCanaTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(66)).setAttribute("nombre","canaOidCanaWidgetTrId" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(68)).setAttribute("nombre","canaOidCana" );
      ...
      ((Element)v.get(68)).setAttribute("ontab","ejecutarAccionFoco('preCatalOrdenFrm',3, true);" );
      ((Element)v.get(68)).setAttribute("onshtab","ejecutarAccionFoco('preCatalOrdenFrm',3, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(70)).setAttribute("nombre","canaOidCanaGapTdId" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(72)).setAttribute("nombre","ocatOidCataTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(77)).setAttribute("nombre","ocatOidCataWidgetTrId" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(79)).setAttribute("nombre","ocatOidCata" );
      ...
      ((Element)v.get(79)).setAttribute("ontab","ejecutarAccionFoco('preCatalOrdenFrm',4, true);" );
      ((Element)v.get(79)).setAttribute("onshtab","ejecutarAccionFoco('preCatalOrdenFrm',4, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(81)).setAttribute("nombre","ocatOidCataGapTdId" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(83)).setAttribute("nombre","numOrdeTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(88)).setAttribute("nombre","numOrdeWidgetTrId" );
      ...
      ((Element)v.get(90)).setAttribute("ontab","ejecutarAccionFoco('preCatalOrdenFrm',5, true)" );
      ((Element)v.get(90)).setAttribute("onshtab","ejecutarAccionFoco('preCatalOrdenFrm', 5, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(91)).setAttribute("nombre","numOrdeGapTdId" );
      ((Element)v.get(91)).setAttribute("nowrap","true" );
      ((Element)v.get(91)).setAttribute("class","datosCampos" );
      ...
      /* Empieza nodo:95 / Elemento padre: 44   */
   }

   private void getXML450(Document doc) {
      v.add(doc.createElement("TD"));
      ((Element)v.get(95)).setAttribute("width","100%" );
      ((Element)v.get(44)).appendChild((Element)v.get(95));
      /* Termina nodo:95   */
      /* Termina nodo:44   */
      ...
      /* Empieza nodo:105 / Elemento padre: 0   */
      v.add(doc.createElement("TR"));
      ((Element)v.get(105)).setAttribute("nombre","preCatalOrdenTrButtons" );
      ((Element)v.get(0)).appendChild((Element)v.get(105));
      ...
      ((Element)v.get(112)).setAttribute("nombre","preCatalOrdenTdQueryButton" );
      ((Element)v.get(111)).appendChild((Element)v.get(112));

      /* Empieza nodo:113 / Elemento padre: 112   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(113)).setAttribute("nombre","preCatalOrdenQueryButton" );
      ((Element)v.get(113)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(113)).setAttribute("estado","false" );
      ((Element)v.get(113)).setAttribute("accion","preCatalOrdenFirstPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(114)).setAttribute("class","tablaTitle" );
      ((Element)v.get(114)).setAttribute("nombre","preCatalOrdenTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(116)).setAttribute("nombre","preCatalOrdenLovNullButton" );
   }

   private void getXML540(Document doc) {
      ((Element)v.get(116)).setAttribute("ID","botonContenido" );
      ((Element)v.get(116)).setAttribute("tipo","html" );
      ((Element)v.get(116)).setAttribute("accion","preCatalOrdenLovNullSelectionAction();" );
      ((Element)v.get(116)).setAttribute("estado","true" );
      ((Element)v.get(116)).setAttribute("cod","MMGGlobal.lovNullButton.label" );
