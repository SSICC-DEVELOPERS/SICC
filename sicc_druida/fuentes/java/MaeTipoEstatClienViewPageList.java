...
public class MaeTipoEstatClienViewPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","maeTipoEstatClienViewList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","MaeTipoEstatClienView.codTipoEsta.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","MaeTipoEstatClienView.Descripcion.label" );
