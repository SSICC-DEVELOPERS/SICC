...
public class EduPlantCursoDetalPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","eduPlantCursoDetalList" );
      ...
      ((Element)v.get(15)).setAttribute("cod","EduPlantCursoDetal.cplcOidCabe.label" );
   }
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(16)).setAttribute("cod","EduPlantCursoDetal.valDeta.label" );
      ...
      ((Element)v.get(17)).setAttribute("cod","EduPlantCursoDetal.indVisi.label" );
      ...
      ((Element)v.get(18)).setAttribute("cod","EduPlantCursoDetal.indModi.label" );
      ...
      ((Element)v.get(19)).setAttribute("cod","EduPlantCursoDetal.indObli.label" );
