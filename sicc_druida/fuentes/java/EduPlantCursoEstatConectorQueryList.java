...
public class EduPlantCursoEstatConectorQueryList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad EduPlantCursoEstat" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGEduPlantCursoEstatQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGEduPlantCursoEstatQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","EduPlantCursoEstatListFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","mcurOidCurs" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(8)).setAttribute("NOMBRE","dpcuOidDetaPlanCurs" );
