...
public class contenido_pago_intercompanias_generar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_pago_intercompanias_generar" );
      ((Element)v.get(0)).setAttribute("cod","0412" );
      ((Element)v.get(0)).setAttribute("titulo","Generar pago intercompanias" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","Generar pago intercompanias" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","contenido_pago_intercompanias_generar.js" );
      ...
      ((Element)v.get(12)).setAttribute("valor","LPGenerarPagoIntercompanias" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(16)).setAttribute("nombre","hidIdioma" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(17)).setAttribute("nombre","hidPais" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(21)).setAttribute("nombre","hidMostarMensajeExito" );
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(41)).setAttribute("width","455" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(56)).setAttribute("nombre","lbldtPais" );
      ...
      /* Empieza nodo:62 / Elemento padre: 38   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(38)).appendChild((Element)v.get(62));
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(64)).setAttribute("width","455" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(80)).setAttribute("onchange","marcaOnChange();" );
      ...
      ((Element)v.get(85)).setAttribute("onchange","canalOnChange();" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(94)).setAttribute("width","455" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(114)).setAttribute("nombre","cbActividad" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(119)).setAttribute("nombre","txtFechaDesde" );
      ((Element)v.get(119)).setAttribute("id","datosCampos" );
      ((Element)v.get(119)).setAttribute("max","10" );
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(123)).setAttribute("nombre","txtFechaHasta" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(139)).setAttribute("nombre","btnGenerar" );
      ((Element)v.get(139)).setAttribute("ID","botonContenido" );
      ((Element)v.get(139)).setAttribute("tipo","html" );
      ((Element)v.get(139)).setAttribute("accion","accionGenerar();" );
      ((Element)v.get(139)).setAttribute("estado","false" );
      ((Element)v.get(139)).setAttribute("cod","190" );
      ((Element)v.get(139)).setAttribute("ontab","onBotonTab();" );
      ...
      /* Empieza nodo:149 / Elemento padre: 11   */
      v.add(doc.createElement("MATRIZJS"));
      ((Element)v.get(149)).setAttribute("nombre","lstActividades" );
      ((Element)v.get(11)).appendChild((Element)v.get(149));
