...
public class contenido_informe_estadistica_operaciones_generar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_informe_estadistica_operaciones_generar" );
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(11)).setAttribute("name","cbTipoReporte" );
      ((Element)v.get(11)).setAttribute("required","true" );
      ((Element)v.get(11)).setAttribute("cod","2534" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(24)).setAttribute("nombre","lp" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(63)).setAttribute("onshtab","focalizaBotonHTML('botonContenido','btnGenerarInforme');" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(96)).setAttribute("nombre","cbPeriodoInicial" );
      ...
      ((Element)v.get(100)).setAttribute("valign","bottom" );
      ((Element)v.get(92)).appendChild((Element)v.get(100));

      /* Empieza nodo:101 / Elemento padre: 100   */
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(101)).setAttribute("nombre","cbPeriodoFinal" );
      ...
      /* Empieza nodo:105 / Elemento padre: 77   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(77)).appendChild((Element)v.get(105));
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(122)).setAttribute("nombre","cbOperacion" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(140)).setAttribute("nombre","lblZona" );
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(151)).setAttribute("nombre","cbRegion" );
      ...
      ((Element)v.get(151)).setAttribute("onchange","cambioRegion();" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(156)).setAttribute("nombre","cbZona" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(161)).setAttribute("nombre","cbTipoReporte" );
      ...
      ((Element)v.get(161)).setAttribute("textoinicial","Detalle" );
   ...
   private void getXML630(Document doc) {
      ...
      ((Element)v.get(165)).setAttribute("VALOR","Resumen" );
      ...
      /* Empieza nodo:171 / Elemento padre: 34   */
      v.add(doc.createElement("td"));
      ((Element)v.get(34)).appendChild((Element)v.get(171));
      ...
      /* Empieza nodo:173 / Elemento padre: 26   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(26)).appendChild((Element)v.get(173));
      ...
      /* Empieza nodo:184 / Elemento padre: 26   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(26)).appendChild((Element)v.get(184));
