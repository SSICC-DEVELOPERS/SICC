...
/*
    INDRA/CAR/mmg
    $Id: CccMarcaTipoAbonoFormFormatter.java,v 1.1 2009/12/03 18:36:32 pecbazalar Exp $
    DESC
*/
 ...
 * @author Indra
 */
public class CccMarcaTipoAbonoFormFormatter extends MMGDruidaFormatoObjeto {
	
	public CccMarcaTipoAbonoFormFormatter() {
	}
	...
	public void formatea(String s, Object obj) throws Exception {
		...
		for (int i = 0; i < cccMarcaTipoAbonoList.size(); i++) {
			...
			row.add((cccMarcaTipoAbonoData.getMasiOidMarcSali() != null ? cccMarcaTipoAbonoData.getMasiOidMarcSali().getId() : null));
			row.add((cccMarcaTipoAbonoData.getTaspOidTipoAbonSubp() != null ? cccMarcaTipoAbonoData.getTaspOidTipoAbonSubp().getId() : null));
