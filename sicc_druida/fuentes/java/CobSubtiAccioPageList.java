...
public class CobSubtiAccioPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","cobSubtiAccioList" );
      ...
      ((Element)v.get(12)).setAttribute("cod","CobSubtiAccio.codSubtAcci.label" );
