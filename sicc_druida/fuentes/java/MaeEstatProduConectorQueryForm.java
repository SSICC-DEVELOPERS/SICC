...
public class MaeEstatProduConectorQueryForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad MaeEstatProdu" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGMaeEstatProduQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGMaeEstatProduQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","MaeEstatProduFormFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(8)).setAttribute("NOMBRE","codEstaProd" );
