...
public class BelFormaPagoTaponConectorQueryList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad BelFormaPagoTapon" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGBelFormaPagoTaponQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGBelFormaPagoTaponQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","BelFormaPagoTaponListFormatter" );
