...
public class ConectorCargaInicialDigitarReclamos  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","ConectorCargaInicialDigitarReclamos" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","DTOBelcor" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","RECCargaInicialDigitacion" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(5)).setAttribute("NOMBRE","DTOCargaInicialDigitarReclamos" );
