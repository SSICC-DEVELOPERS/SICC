...
public class FacTipoDocumPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","facTipoDocumList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","FacTipoDocum.codTipoDocu.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","FacTipoDocum.desTipoDocu.label" );
