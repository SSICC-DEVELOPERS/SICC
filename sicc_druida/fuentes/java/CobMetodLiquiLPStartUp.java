/*
    INDRA/CAR/mmg
    $Id: CobMetodLiquiLPStartUp.java,v 1.1 2009/12/03 18:41:11 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class CobMetodLiquiLPStartUp extends MMGDruidaBase{
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "CobMetodLiquiPage", "cod", "CobMetodLiqui." + accion + ".label");
			...
			limpiarBotoneraLista("cobMetodLiqui", accion);
	...
	protected void cmdLov() throws Exception{
		...
		//asignarAtributo("CAPA", "cobMetodLiquiLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "CobMetodLiquiPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		CobMetodLiquiData cobMetodLiquiQuery= new CobMetodLiquiData();
		cobMetodLiquiQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		CobMetodLiquiData datosResult = (CobMetodLiquiData)getSingleObject(BUSINESSID_QUERY, cobMetodLiquiQuery, 
			cobMetodLiquiQuery.clone(), "cobMetodLiqui");
		...
		CobMetodLiquiData cobMetodLiqui = datosResult;
		asignar("TEXT", "codMetoLiqu", FormatUtils.formatObject(cobMetodLiqui.getCodMetoLiqu(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "valDescMetoLiqu", FormatUtils.formatObject(cobMetodLiqui.getValDescMetoLiqu(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignarAtributo("RADIOB", "indLiqu" , "valor", FormatUtils.formatObject(
			cobMetodLiqui.getIndLiqu(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignarAtributo("RADIOB", "indLiquGrupUsua" , "valor", FormatUtils.formatObject(
			cobMetodLiqui.getIndLiquGrupUsua(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "cobMetodLiquiFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		CobMetodLiquiData cobMetodLiquiQuery= new CobMetodLiquiData();
		cobMetodLiquiQuery.setId(new Long(id));
		...
		asignarAtributo("RADIOB", "indLiquGrupUsua" , "valor", FormatUtils.formatObject(
			cobMetodLiqui.getIndLiquGrupUsua(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "valObse", FormatUtils.formatObject(cobMetodLiqui.getValObse(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		es.indra.belcorp.mso.CobBaseEscalData baesOidBaseEsca = cobMetodLiqui.getBaesOidBaseEsca();
		...
		//asignar("VAR","timestamp",Long.toString(cobMetodLiqui.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"cobMetodLiquiFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"cobMetodLiquiFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codMetoLiqu", "ontab","ejecutarAccionFocoModificacion(\"cobMetodLiquiFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codMetoLiqu", "onshtab","ejecutarAccionFocoModificacion(\"cobMetodLiquiFrm\",2, false)");
				asignarAtributo("AREATEXTO", "valDescMetoLiqu", "ontab","ejecutarAccionFocoModificacion(\"cobMetodLiquiFrm\",3, true)");
				asignarAtributo("AREATEXTO", "valDescMetoLiqu", "onshtab","ejecutarAccionFocoModificacion(\"cobMetodLiquiFrm\",3, false)");
				asignarAtributo("TEXT", "indLiqu", "ontab","ejecutarAccionFocoModificacion(\"cobMetodLiquiFrm\",4, true)");
				asignarAtributo("TEXT", "indLiqu", "onshtab","ejecutarAccionFocoModificacion(\"cobMetodLiquiFrm\",4, false)");
				asignarAtributo("TEXT", "indLiquGrupUsua", "ontab","ejecutarAccionFocoModificacion(\"cobMetodLiquiFrm\",5, true)");
				asignarAtributo("TEXT", "indLiquGrupUsua", "onshtab","ejecutarAccionFocoModificacion(\"cobMetodLiquiFrm\",5, false)");
				asignarAtributo("AREATEXTO", "valObse", "ontab","ejecutarAccionFocoModificacion(\"cobMetodLiquiFrm\",6, true)");
				asignarAtributo("AREATEXTO", "valObse", "onshtab","ejecutarAccionFocoModificacion(\"cobMetodLiquiFrm\",6, false)");
					asignarAtributo("COMBO","paisOidPais", "ontab", "ejecutarAccionFocoModificacion(\"cobMetodLiquiFrm\",7, true)");
					asignarAtributo("COMBO","paisOidPais", "onshtab", "ejecutarAccionFocoModificacion(\"cobMetodLiquiFrm\",7, false)");
					asignarAtributo("COMBO","baesOidBaseEsca", "ontab", "ejecutarAccionFocoModificacion(\"cobMetodLiquiFrm\",8, true)");
					asignarAtributo("COMBO","baesOidBaseEsca", "onshtab", "ejecutarAccionFocoModificacion(\"cobMetodLiquiFrm\",8, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","cobMetodLiquiTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","cobMetodLiquiTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","cobMetodLiquiFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","cobMetodLiquiListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","cobMetodLiquiListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(CobMetodLiquiData cobMetodLiqui) throws Exception{
		...
		if(cobMetodLiqui != null && cobMetodLiqui.getPaisOidPais() != null){
				checkCombo("paisOidPais" , cobMetodLiqui.getPaisOidPais().getId().toString());
			}
		...
		if(cobMetodLiqui != null && cobMetodLiqui.getBaesOidBaseEsca() != null){
				checkCombo("baesOidBaseEsca" , cobMetodLiqui.getBaesOidBaseEsca().getId().toString());
			}
	...
	* @param cobMetodLiqui La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(CobMetodLiquiData cobMetodLiqui) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		CobMetodLiquiData cobMetodLiqui = 
			(CobMetodLiquiData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(cobMetodLiqui.getPaisOidPais() != null){
			cobMetodLiqui.setPaisOidPais((es.indra.belcorp.mso.SegPaisViewData)
			getSingleObject(BUSINESSID_PAISOIDPAIS_QUERY, 
			cobMetodLiqui.getPaisOidPais(),
			cobMetodLiqui.getPaisOidPais().clone(),
			"segPaisView"));
		}
		if(cobMetodLiqui.getBaesOidBaseEsca() != null){
			cobMetodLiqui.setBaesOidBaseEsca((es.indra.belcorp.mso.CobBaseEscalData)
			getSingleObject(BUSINESSID_BAESOIDBASEESCA_QUERY, 
			cobMetodLiqui.getBaesOidBaseEsca(),
			cobMetodLiqui.getBaesOidBaseEsca().clone(),
			"cobBaseEscal"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(cobMetodLiqui);
		loadLeafDependenceCombos(cobMetodLiqui);
	}
