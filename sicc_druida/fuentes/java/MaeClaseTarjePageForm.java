...
public class MaeClaseTarjePageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","MaeClaseTarje.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","MaeClaseTarje.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('maeClaseTarjeFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('maeClaseTarjeFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(50)).setAttribute("nombre","codClasTarjTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lblCodClasTarj" );
      ((Element)v.get(54)).setAttribute("alto","13" );
      ((Element)v.get(54)).setAttribute("filas","1" );
      ((Element)v.get(54)).setAttribute("id","datosTitle" );
      ((Element)v.get(54)).setAttribute("cod","MaeClaseTarje.codClasTarj.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(55)).setAttribute("nombre","codClasTarjWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(57)).setAttribute("nombre","codClasTarj" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('maeClaseTarjeFrm',2, true)" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('maeClaseTarjeFrm', 2, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(58)).setAttribute("nombre","codClasTarjGapTdId" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(60)).setAttribute("nombre","desClasTarjTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(65)).setAttribute("nombre","desClasTarjWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(67)).setAttribute("nombre","desClasTarj" );
      ...
      ((Element)v.get(67)).setAttribute("ontab","ejecutarAccionFoco('maeClaseTarjeFrm',3, true)" );
      ((Element)v.get(67)).setAttribute("onshtab","ejecutarAccionFoco('maeClaseTarjeFrm', 3, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(68)).setAttribute("nombre","desClasTarjGapTdId" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(82)).setAttribute("nombre","maeClaseTarjeTrButtons" );
      ...
      ((Element)v.get(89)).setAttribute("nombre","maeClaseTarjeTdQueryButton" );
      ((Element)v.get(88)).appendChild((Element)v.get(89));

      /* Empieza nodo:90 / Elemento padre: 89   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(90)).setAttribute("nombre","maeClaseTarjeQueryButton" );
      ((Element)v.get(90)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(90)).setAttribute("estado","false" );
      ((Element)v.get(90)).setAttribute("accion","maeClaseTarjeFirstPage();" );
      ...
      ((Element)v.get(91)).setAttribute("nombre","maeClaseTarjeTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(93)).setAttribute("nombre","maeClaseTarjeLovNullButton" );
      ((Element)v.get(93)).setAttribute("ID","botonContenido" );
      ((Element)v.get(93)).setAttribute("tipo","html" );
      ((Element)v.get(93)).setAttribute("accion","maeClaseTarjeLovNullSelectionAction();" );
