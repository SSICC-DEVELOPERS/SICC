/*
    INDRA/CAR/mmg
    $Id: SegSocieViewLPStartUp.java,v 1.1 2009/12/03 18:37:47 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class SegSocieViewLPStartUp extends MMGDruidaBase{
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "SegSocieViewPage", "cod", "SegSocieView." + accion + ".label");
			...
			limpiarBotoneraLista("segSocieView", accion);
	...
	protected void cmdLov() throws Exception{
		...
		//asignarAtributo("CAPA", "segSocieViewLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "SegSocieViewPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		SegSocieViewData segSocieViewQuery= new SegSocieViewData();
		segSocieViewQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		SegSocieViewData datosResult = (SegSocieViewData)getSingleObject(BUSINESSID_QUERY, segSocieViewQuery, 
			segSocieViewQuery.clone(), "segSocieView");
		...
		SegSocieViewData segSocieView = datosResult;
		asignar("TEXT", "codSoci", FormatUtils.formatObject(segSocieView.getCodSoci(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "valDeno", FormatUtils.formatObject(segSocieView.getValDeno(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "valDire", FormatUtils.formatObject(segSocieView.getValDire(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "valTlfn", FormatUtils.formatObject(segSocieView.getValTlfn(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "valFax", FormatUtils.formatObject(segSocieView.getValFax(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "valIdenFisc", FormatUtils.formatObject(segSocieView.getValIdenFisc(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "segSocieViewFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		SegSocieViewData segSocieViewQuery= new SegSocieViewData();
		segSocieViewQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(segSocieView.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"segSocieViewFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"segSocieViewFrm\",1, false)");
					asignarAtributo("COMBO","paisOidPais", "ontab", "ejecutarAccionFocoModificacion(\"segSocieViewFrm\",2, true)");
					asignarAtributo("COMBO","paisOidPais", "onshtab", "ejecutarAccionFocoModificacion(\"segSocieViewFrm\",2, false)");
				asignarAtributo("AREATEXTO", "codSoci", "ontab","ejecutarAccionFocoModificacion(\"segSocieViewFrm\",3, true)");
				asignarAtributo("AREATEXTO", "codSoci", "onshtab","ejecutarAccionFocoModificacion(\"segSocieViewFrm\",3, false)");
				asignarAtributo("AREATEXTO", "valDeno", "ontab","ejecutarAccionFocoModificacion(\"segSocieViewFrm\",4, true)");
				asignarAtributo("AREATEXTO", "valDeno", "onshtab","ejecutarAccionFocoModificacion(\"segSocieViewFrm\",4, false)");
				asignarAtributo("AREATEXTO", "valDire", "ontab","ejecutarAccionFocoModificacion(\"segSocieViewFrm\",5, true)");
				asignarAtributo("AREATEXTO", "valDire", "onshtab","ejecutarAccionFocoModificacion(\"segSocieViewFrm\",5, false)");
				asignarAtributo("AREATEXTO", "valTlfn", "ontab","ejecutarAccionFocoModificacion(\"segSocieViewFrm\",6, true)");
				asignarAtributo("AREATEXTO", "valTlfn", "onshtab","ejecutarAccionFocoModificacion(\"segSocieViewFrm\",6, false)");
				asignarAtributo("AREATEXTO", "valFax", "ontab","ejecutarAccionFocoModificacion(\"segSocieViewFrm\",7, true)");
				asignarAtributo("AREATEXTO", "valFax", "onshtab","ejecutarAccionFocoModificacion(\"segSocieViewFrm\",7, false)");
				asignarAtributo("AREATEXTO", "valIdenFisc", "ontab","ejecutarAccionFocoModificacion(\"segSocieViewFrm\",8, true)");
				asignarAtributo("AREATEXTO", "valIdenFisc", "onshtab","ejecutarAccionFocoModificacion(\"segSocieViewFrm\",8, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","segSocieViewTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","segSocieViewTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","segSocieViewFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","segSocieViewListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","segSocieViewListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(SegSocieViewData segSocieView) throws Exception{
		...
		if(segSocieView != null && segSocieView.getPaisOidPais() != null){
				checkCombo("paisOidPais" , segSocieView.getPaisOidPais().getId().toString());
			}
	...
	* @param segSocieView La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(SegSocieViewData segSocieView) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		SegSocieViewData segSocieView = 
			(SegSocieViewData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(segSocieView.getPaisOidPais() != null){
			segSocieView.setPaisOidPais((es.indra.belcorp.mso.SegPaisViewData)
			getSingleObject(BUSINESSID_PAISOIDPAIS_QUERY, 
			segSocieView.getPaisOidPais(),
			segSocieView.getPaisOidPais().clone(),
			"segPaisView"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(segSocieView);
		loadLeafDependenceCombos(segSocieView);
	}
