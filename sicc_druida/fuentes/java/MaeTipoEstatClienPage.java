...
public class MaeTipoEstatClienPage  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","MaeTipoEstatClienPage" );
      ((Element)v.get(0)).setAttribute("titulo","" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","" );
      ((Element)v.get(0)).setAttribute("onload","maeTipoEstatClienInitComponents()" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","maetipoestatclien.js" );
      ((Element)v.get(0)).appendChild((Element)v.get(4));
      /* Termina nodo:4   */

      /* Empieza nodo:5 / Elemento padre: 0   */
      v.add(doc.createElement("FORMULARIO"));
      ((Element)v.get(5)).setAttribute("nombre","maeTipoEstatClienFrm" );
      ...
      ((Element)v.get(6)).setAttribute("valor","MaeTipoEstatClienLPExecution" );
      ...
      ((Element)v.get(7)).setAttribute("valor","MaeTipoEstatClienLPExecution" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(37)).setAttribute("nombre","maeTipoEstatClienFormLayer" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(52)).setAttribute("cod","MaeTipoEstatClien.legend.label" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(67)).setAttribute("cod","MaeTipoEstatClien.id.label" );
      ...
      ((Element)v.get(70)).setAttribute("ontab","ejecutarAccionFoco('maeTipoEstatClienFrm',1, true)" );
      ((Element)v.get(70)).setAttribute("onshtab","ejecutarAccionFoco('maeTipoEstatClienFrm', 1, false)" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(88)).setAttribute("nombre","codTipoEstaTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(92)).setAttribute("nombre","lblCodTipoEsta" );
      ((Element)v.get(92)).setAttribute("alto","13" );
      ((Element)v.get(92)).setAttribute("filas","1" );
      ((Element)v.get(92)).setAttribute("id","datosTitle" );
      ((Element)v.get(92)).setAttribute("cod","MaeTipoEstatClien.codTipoEsta.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(93)).setAttribute("nombre","codTipoEstaWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(95)).setAttribute("nombre","codTipoEsta" );
      ...
      ((Element)v.get(95)).setAttribute("ontab","ejecutarAccionFoco('maeTipoEstatClienFrm',2, true)" );
      ((Element)v.get(95)).setAttribute("onshtab","ejecutarAccionFoco('maeTipoEstatClienFrm', 2, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(96)).setAttribute("nombre","codTipoEstaGapTdId" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(102)).setAttribute("cod","MaeTipoEstatClien.marcOidMarc.label" );
      ...
      ((Element)v.get(105)).setAttribute("ontab","ejecutarAccionFoco('maeTipoEstatClienFrm',3, true);" );
      ((Element)v.get(105)).setAttribute("onshtab","ejecutarAccionFoco('maeTipoEstatClienFrm',3, false);" );
      ...
      ((Element)v.get(113)).setAttribute("cod","MaeTipoEstatClien.Descripcion.label" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(117)).setAttribute("ontab","ejecutarAccionFoco('maeTipoEstatClienFrm',4, true)" );
      ((Element)v.get(117)).setAttribute("onshtab","ejecutarAccionFoco('maeTipoEstatClienFrm', 4, false)" );
      ...
      ((Element)v.get(121)).setAttribute("href","javascript:openLocalizationDialog('maeTipoEstatClienFrm', 'Descripcion', 1);" );
      ((Element)v.get(121)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"maeTipoEstatClienFrm\",4, true)', 'ejecutarAccionFoco(\"maeTipoEstatClienFrm\",4, false)')" );
   ...
   private void getXML630(Document doc) {
      ((Element)v.get(137)).setAttribute("nombre","maeTipoEstatClienTrButtons" );
      ...
      ((Element)v.get(144)).setAttribute("nombre","maeTipoEstatClienTdQueryButton" );
      ((Element)v.get(143)).appendChild((Element)v.get(144));

      /* Empieza nodo:145 / Elemento padre: 144   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(145)).setAttribute("nombre","maeTipoEstatClienQueryButton" );
      ((Element)v.get(145)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(145)).setAttribute("estado","false" );
      ((Element)v.get(145)).setAttribute("accion","maeTipoEstatClienFirstPage();" );
      ...
      ((Element)v.get(146)).setAttribute("nombre","maeTipoEstatClienTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(148)).setAttribute("nombre","maeTipoEstatClienLovNullButton" );
      ((Element)v.get(148)).setAttribute("ID","botonContenido" );
      ((Element)v.get(148)).setAttribute("tipo","html" );
      ((Element)v.get(148)).setAttribute("accion","maeTipoEstatClienLovNullSelectionAction();" );
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(151)).setAttribute("nombre","maeTipoEstatClienListLayer" );
      ...
      ((Element)v.get(152)).setAttribute("nombre","maeTipoEstatClienList" );
   ...
   private void getXML720(Document doc) {
      ...
      ((Element)v.get(166)).setAttribute("cod","MaeTipoEstatClien.codTipoEsta.label" );
      ...
      ((Element)v.get(167)).setAttribute("cod","MaeTipoEstatClien.marcOidMarc.label" );
      ...
      ((Element)v.get(168)).setAttribute("cod","MaeTipoEstatClien.Descripcion.label" );
   ...
   private void getXML810(Document doc) {
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(174)).setAttribute("nombre","maeTipoEstatClienListButtonsLayer" );
      ...
      ((Element)v.get(180)).setAttribute("nombre","maeTipoEstatClienPaginationButtonBar" );
      ...
      ((Element)v.get(181)).setAttribute("nombre","maeTipoEstatClienFirstPageButton" );
      ((Element)v.get(181)).setAttribute("funcion","maeTipoEstatClienFirstPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(182)).setAttribute("nombre","maeTipoEstatClienFirstPageButtonGapTd" );
   ...
   private void getXML900(Document doc) {
      v.add(doc.createElement("BTN"));
      ((Element)v.get(184)).setAttribute("nombre","maeTipoEstatClienPreviousPageButton" );
      ((Element)v.get(184)).setAttribute("funcion","maeTipoEstatClienPreviousPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(185)).setAttribute("nombre","maeTipoEstatClienPreviousPageButtonGapTd" );
      ...
      v.add(doc.createElement("BTN"));
      ((Element)v.get(187)).setAttribute("nombre","maeTipoEstatClienNextPageButton" );
      ((Element)v.get(187)).setAttribute("funcion","maeTipoEstatClienNextPage();" );
      ...
      ((Element)v.get(190)).setAttribute("nombre","maeTipoEstatClienUpdateButtonTd" );
      ((Element)v.get(176)).appendChild((Element)v.get(190));

      /* Empieza nodo:191 / Elemento padre: 190   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(191)).setAttribute("nombre","maeTipoEstatClienUpdateButton" );
      ((Element)v.get(191)).setAttribute("ID","botonContenido" );
      ((Element)v.get(191)).setAttribute("tipo","html" );
      ((Element)v.get(191)).setAttribute("accion","maeTipoEstatClienUpdateSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(192)).setAttribute("nombre","maeTipoEstatClienUpdateButtonGapTd" );
      ...
      ((Element)v.get(194)).setAttribute("nombre","maeTipoEstatClienViewForRemoveButtonTd" );
      ((Element)v.get(176)).appendChild((Element)v.get(194));

      /* Empieza nodo:195 / Elemento padre: 194   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(195)).setAttribute("nombre","maeTipoEstatClienViewForRemoveButton" );
      ((Element)v.get(195)).setAttribute("ID","botonContenido" );
      ((Element)v.get(195)).setAttribute("tipo","html" );
      ((Element)v.get(195)).setAttribute("accion","maeTipoEstatClienViewSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(196)).setAttribute("nombre","maeTipoEstatClienViewForRemoveButtonGapTd" );
      ...
      ((Element)v.get(198)).setAttribute("nombre","maeTipoEstatClienLovSelectButtonTd" );
      ((Element)v.get(176)).appendChild((Element)v.get(198));

      /* Empieza nodo:199 / Elemento padre: 198   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(199)).setAttribute("nombre","maeTipoEstatClienLovSelectButton" );
      ((Element)v.get(199)).setAttribute("ID","botonContenido" );
      ((Element)v.get(199)).setAttribute("tipo","html" );
      ((Element)v.get(199)).setAttribute("accion","maeTipoEstatClienLovSelectionAction();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(200)).setAttribute("nombre","maeTipoEstatClienLovSelectButtonGapTd" );
   ...
   private void getXML990(Document doc) {
      ...
      ((Element)v.get(202)).setAttribute("nombre","maeTipoEstatClienViewButtonTd" );
      ((Element)v.get(176)).appendChild((Element)v.get(202));

      /* Empieza nodo:203 / Elemento padre: 202   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(203)).setAttribute("nombre","maeTipoEstatClienViewButton" );
      ((Element)v.get(203)).setAttribute("ID","botonContenido" );
      ((Element)v.get(203)).setAttribute("tipo","html" );
      ((Element)v.get(203)).setAttribute("accion","maeTipoEstatClienViewSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(204)).setAttribute("nombre","maeTipoEstatClienViewButtonGapTd" );
