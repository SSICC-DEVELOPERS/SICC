...
public class CccProcePageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","cccProceList" );
      ...
      ((Element)v.get(14)).setAttribute("cod","CccProce.codProc.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","CccProce.desProc.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","CccProce.valObse.label" );
