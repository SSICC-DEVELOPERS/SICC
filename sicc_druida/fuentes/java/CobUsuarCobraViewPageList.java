...
public class CobUsuarCobraViewPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","cobUsuarCobraViewList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(20)).setAttribute("cod","CobUsuarCobraView.fecUltiEsta.label" );
      ...
      ((Element)v.get(21)).setAttribute("cod","CobUsuarCobraView.indJefeCobr.label" );
      ...
      ((Element)v.get(22)).setAttribute("cod","CobUsuarCobraView.indUsuaSupe.label" );
      ...
      ((Element)v.get(23)).setAttribute("cod","CobUsuarCobraView.indUsuaExte.label" );
      ...
      ((Element)v.get(24)).setAttribute("cod","CobUsuarCobraView.valTurnHoraEntr.label" );
      ...
      ((Element)v.get(25)).setAttribute("cod","CobUsuarCobraView.valTurnHoraSali.label" );
      ...
      ((Element)v.get(26)).setAttribute("cod","CobUsuarCobraView.valObse.label" );
      ...
      ((Element)v.get(27)).setAttribute("cod","CobUsuarCobraView.userOidUsuaCobr.label" );
      ...
      ((Element)v.get(28)).setAttribute("cod","CobUsuarCobraView.paisOidPais.label" );
