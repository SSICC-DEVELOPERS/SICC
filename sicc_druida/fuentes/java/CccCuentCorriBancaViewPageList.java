...
public class CccCuentCorriBancaViewPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","cccCuentCorriBancaViewList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","CccCuentCorriBancaView.sociOidSoci.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","CccCuentCorriBancaView.desCc.label" );
