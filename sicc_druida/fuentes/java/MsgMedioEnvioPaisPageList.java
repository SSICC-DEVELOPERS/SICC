...
public class MsgMedioEnvioPaisPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","msgMedioEnvioPaisList" );
      ...
      ((Element)v.get(14)).setAttribute("cod","MsgMedioEnvioPais.paisOidPais.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","MsgMedioEnvioPais.meenOidMediEnvi.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","MsgMedioEnvioPais.codEsta.label" );
