...
public class SegMonedPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","SegMoned.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","SegMoned.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('segMonedFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('segMonedFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(50)).setAttribute("nombre","codMoneTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lblCodMone" );
      ((Element)v.get(54)).setAttribute("alto","13" );
      ((Element)v.get(54)).setAttribute("filas","1" );
      ((Element)v.get(54)).setAttribute("id","datosTitle" );
      ((Element)v.get(54)).setAttribute("cod","SegMoned.codMone.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(55)).setAttribute("nombre","codMoneWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(57)).setAttribute("nombre","codMone" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('segMonedFrm',2, true)" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('segMonedFrm', 2, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(58)).setAttribute("nombre","codMoneGapTdId" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(64)).setAttribute("cod","SegMoned.Descripcion.label" );
      ...
      ((Element)v.get(68)).setAttribute("max","30" );
      ((Element)v.get(68)).setAttribute("onchange","" );
      ((Element)v.get(68)).setAttribute("req","N" );
      ((Element)v.get(68)).setAttribute("size","30" );
      ...
      ((Element)v.get(68)).setAttribute("ontab","ejecutarAccionFoco('segMonedFrm',3, true)" );
      ((Element)v.get(68)).setAttribute("onshtab","ejecutarAccionFoco('segMonedFrm', 3, false)" );
      ...
      ((Element)v.get(72)).setAttribute("href","javascript:openLocalizationDialog('segMonedFrm', 'Descripcion', 1);" );
      ((Element)v.get(72)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"segMonedFrm\",3, true)', 'ejecutarAccionFoco(\"segMonedFrm\",3, false)')" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(76)).setAttribute("nombre","valNombCortMoneTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(80)).setAttribute("nombre","lblValNombCortMone" );
      ((Element)v.get(80)).setAttribute("alto","13" );
      ((Element)v.get(80)).setAttribute("filas","1" );
      ((Element)v.get(80)).setAttribute("id","datosTitle" );
      ((Element)v.get(80)).setAttribute("cod","SegMoned.valNombCortMone.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(81)).setAttribute("nombre","valNombCortMoneWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(83)).setAttribute("nombre","valNombCortMone" );
      ...
      ((Element)v.get(83)).setAttribute("ontab","ejecutarAccionFoco('segMonedFrm',4, true)" );
      ((Element)v.get(83)).setAttribute("onshtab","ejecutarAccionFoco('segMonedFrm', 4, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(84)).setAttribute("nombre","valNombCortMoneGapTdId" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(86)).setAttribute("nombre","valSimbMoneTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(91)).setAttribute("nombre","valSimbMoneWidgetTrId" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(93)).setAttribute("ontab","ejecutarAccionFoco('segMonedFrm',5, true)" );
      ((Element)v.get(93)).setAttribute("onshtab","ejecutarAccionFoco('segMonedFrm', 5, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(94)).setAttribute("nombre","valSimbMoneGapTdId" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(96)).setAttribute("nombre","numDeciTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(100)).setAttribute("nombre","lblNumDeci" );
      ((Element)v.get(100)).setAttribute("ancho","150" );
      ((Element)v.get(100)).setAttribute("alto","13" );
      ((Element)v.get(100)).setAttribute("filas","1" );
      ((Element)v.get(100)).setAttribute("id","datosTitle" );
      ((Element)v.get(100)).setAttribute("cod","SegMoned.numDeci.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(101)).setAttribute("nombre","numDeciWidgetTrId" );
      ...
      ((Element)v.get(103)).setAttribute("nombre","numDeci" );
      ...
      ((Element)v.get(103)).setAttribute("ontab","ejecutarAccionFoco('segMonedFrm',6, true)" );
      ((Element)v.get(103)).setAttribute("onshtab","ejecutarAccionFoco('segMonedFrm',6, false)" );
      ...
      ((Element)v.get(105)).setAttribute("ID","0" );
      ((Element)v.get(104)).appendChild((Element)v.get(105));

      /* Empieza nodo:106 / Elemento padre: 105   */
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(106)).setAttribute("NOMBRE","CODIGO" );
      ...
      ((Element)v.get(109)).setAttribute("VALOR","1" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(112)).setAttribute("VALOR","2" );
      ...
      ((Element)v.get(113)).setAttribute("VALOR","2" );
      ...
      /* Empieza nodo:114 / Elemento padre: 49   */
      v.add(doc.createElement("TD"));
      ((Element)v.get(114)).setAttribute("nombre","numDeciGapTdId" );
      ((Element)v.get(114)).setAttribute("nowrap","true" );
      ((Element)v.get(114)).setAttribute("class","datosCampos" );
      ((Element)v.get(49)).appendChild((Element)v.get(114));
      ...
      /* Empieza nodo:116 / Elemento padre: 49   */
      v.add(doc.createElement("TD"));
      ((Element)v.get(116)).setAttribute("width","100%" );
      ((Element)v.get(49)).appendChild((Element)v.get(116));
      ...
      /* Empieza nodo:118 / Elemento padre: 44   */
      v.add(doc.createElement("TD"));
      ((Element)v.get(118)).setAttribute("width","100%" );
      ((Element)v.get(44)).appendChild((Element)v.get(118));
      /* Termina nodo:118   */
      /* Termina nodo:44   */

      /* Empieza nodo:119 / Elemento padre: 15   */
      v.add(doc.createElement("TR"));
      ((Element)v.get(119)).setAttribute("nombre","formGapTr1" );
      ...
      /* Empieza nodo:128 / Elemento padre: 0   */
      v.add(doc.createElement("TR"));
      ((Element)v.get(128)).setAttribute("nombre","segMonedTrButtons" );
      ((Element)v.get(0)).appendChild((Element)v.get(128));
   ...
   private void getXML630(Document doc) {
      ...
      ((Element)v.get(135)).setAttribute("nombre","segMonedTdQueryButton" );
      ((Element)v.get(134)).appendChild((Element)v.get(135));

      /* Empieza nodo:136 / Elemento padre: 135   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(136)).setAttribute("nombre","segMonedQueryButton" );
      ((Element)v.get(136)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(136)).setAttribute("estado","false" );
      ((Element)v.get(136)).setAttribute("accion","segMonedFirstPage();" );
      ...
      ((Element)v.get(137)).setAttribute("nombre","segMonedTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(139)).setAttribute("nombre","segMonedLovNullButton" );
      ((Element)v.get(139)).setAttribute("ID","botonContenido" );
      ((Element)v.get(139)).setAttribute("tipo","html" );
      ((Element)v.get(139)).setAttribute("accion","segMonedLovNullSelectionAction();" );
      ((Element)v.get(139)).setAttribute("estado","true" );
      ((Element)v.get(139)).setAttribute("cod","MMGGlobal.lovNullButton.label" );
