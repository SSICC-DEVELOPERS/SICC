...
public class LPInsertaPeriodo extends LPSICCBase {
    ...
    private void cargarPaisMarcaCanal() throws Exception {
		...
		/*traza("7777carga de combo acceso7777");
			  ...
			  dto.setOid(new Long(this.canal)); 
              ComposerViewElement elem1 = new ComposerViewElement();
              elem1.setIDBusiness("SEGObtieneAccesosPorCanal");
              elem1.setDTOE(dto);
    ...
    private ArrayList armarListaPeriodosAInsertar(String listaPeriodosStr) throws Exception {
        ...
        while (str.hasMoreTokens()) {
			...
			dtoPeriodo.setCanal(new Long(this.canal));
            //cambio 20080822 
			String oidAcceso = 	conectorParametro("hAcceso");
			traza(" 777777Acceso: " + oidAcceso);
			if(oidAcceso != null){
				dtoPeriodo.setAcceso(new Long(oidAcceso));
			}
