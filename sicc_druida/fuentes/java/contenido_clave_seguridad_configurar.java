...
public class contenido_clave_seguridad_configurar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_clave_seguridad_configurar" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(2)).setAttribute("src","contenido_clave_seguridad_configurar.js" );
      ...
      ((Element)v.get(4)).setAttribute("name","txtDiasCambio" );
      ((Element)v.get(4)).setAttribute("required","true" );
      ((Element)v.get(4)).setAttribute("cod","51" );
      ((Element)v.get(4)).setAttribute("format","e" );
      ((Element)v.get(4)).setAttribute("min","1" );
      ((Element)v.get(4)).setAttribute("max","999" );
      ((Element)v.get(3)).appendChild((Element)v.get(4));
      /* Termina nodo:4   */

      /* Empieza nodo:5 / Elemento padre: 3   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(5)).setAttribute("name","txtNumRepeticiones" );
      ((Element)v.get(5)).setAttribute("required","true" );
      ((Element)v.get(5)).setAttribute("cod","88" );
      ((Element)v.get(5)).setAttribute("format","e" );
      ((Element)v.get(5)).setAttribute("min","0" );
      ((Element)v.get(5)).setAttribute("max","99" );
      ((Element)v.get(3)).appendChild((Element)v.get(5));
      /* Termina nodo:5   */

      /* Empieza nodo:6 / Elemento padre: 3   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(6)).setAttribute("name","txtLongMinima" );
      ((Element)v.get(6)).setAttribute("required","true" );
      ((Element)v.get(6)).setAttribute("cod","80" );
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(7)).setAttribute("name","txtNumMaxIntentos" );
      ((Element)v.get(7)).setAttribute("required","true" );
      ((Element)v.get(7)).setAttribute("cod","1330" );
      ((Element)v.get(7)).setAttribute("format","e" );
      ((Element)v.get(7)).setAttribute("min","0" );
      ((Element)v.get(7)).setAttribute("max","9" );
      ...
      v.add(doc.createTextNode("\r  \r \r          function onLoadPag() {\r            configurarMenuSecundario(\"frmConfigurarClaveSeguridad\");\r            focaliza('frmConfigurarClaveSeguridad.txtDiasCambio');\r          }\r\r    \r"));
      ...
      ((Element)v.get(10)).setAttribute("nombre","frmConfigurarClaveSeguridad" );
      ((Element)v.get(0)).appendChild((Element)v.get(10));

      /* Empieza nodo:11 / Elemento padre: 10   */
      v.add(doc.createElement("VAR"));
      ((Element)v.get(11)).setAttribute("nombre","conectorAction" );
      ((Element)v.get(11)).setAttribute("valor","LPModificacionParametrosClave" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(15)).setAttribute("nombre","hidDiasCambio" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(16)).setAttribute("nombre","hidNumRepeticiones" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(17)).setAttribute("nombre","hidLongMinima" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(18)).setAttribute("nombre","hidNumMaximoIntentos" );
   ...
   private void getXML90(Document doc) {
      ((Element)v.get(19)).setAttribute("nombre","camposBusqueda" );
      ...
      ((Element)v.get(34)).setAttribute("valor","Valores de configuración" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(43)).setAttribute("nombre","lblDiasCambio" );
      ...
      ((Element)v.get(43)).setAttribute("cod","51" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(47)).setAttribute("nombre","lblNumRepeticiones" );
      ...
      ((Element)v.get(47)).setAttribute("cod","88" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(51)).setAttribute("nombre","lblLongMinima" );
      ((Element)v.get(51)).setAttribute("alto","13" );
      ((Element)v.get(51)).setAttribute("filas","1" );
      ((Element)v.get(51)).setAttribute("valor","" );
      ((Element)v.get(51)).setAttribute("id","datosTitle" );
      ((Element)v.get(51)).setAttribute("cod","80" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(55)).setAttribute("nombre","lblNMaxIntentos" );
      ...
      ((Element)v.get(55)).setAttribute("cod","1330" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(74)).setAttribute("nombre","txtNumMaxIntentos" );
      ((Element)v.get(74)).setAttribute("id","datosCampos" );
      ((Element)v.get(74)).setAttribute("max","1" );
      ...
      ((Element)v.get(74)).setAttribute("ontab","focalizaComponente();" );
