...
public class contenido_informe_recuperacion_campana_generar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_informe_recuperacion_campana_generar" );
      ((Element)v.get(0)).setAttribute("cod","0823" );
      ((Element)v.get(0)).setAttribute("titulo","Generar informe recuperación por campaña" );
      ...
      ((Element)v.get(7)).setAttribute("name","cbTipoReporte" );
      ((Element)v.get(7)).setAttribute("required","true" );
      ((Element)v.get(7)).setAttribute("cod","2534" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(22)).setAttribute("nombre","tipoReporte" );
   ...
   private void getXML90(Document doc) {
      ((Element)v.get(23)).setAttribute("nombre","formato" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(92)).setAttribute("nombre","cbRegion" );
      ...
      ((Element)v.get(92)).setAttribute("onchange","onchange_Region();" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(97)).setAttribute("nombre","cbZona" );
      ...
      ((Element)v.get(97)).setAttribute("onchange","onchange_Zona();" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(122)).setAttribute("nombre","cbSeccion" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(141)).setAttribute("nombre","lblTipoReporte" );
   }
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(141)).setAttribute("cod","2534" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(148)).setAttribute("nombre","cbTipoReporte" );
      ((Element)v.get(148)).setAttribute("size","1" );
      ((Element)v.get(148)).setAttribute("multiple","N" );
      ((Element)v.get(148)).setAttribute("valorinicial","2" );
      ((Element)v.get(148)).setAttribute("textoinicial","Porcentajes" );
      ...
      ((Element)v.get(150)).setAttribute("ID","1" );
      ((Element)v.get(149)).appendChild((Element)v.get(150));

      /* Empieza nodo:151 / Elemento padre: 150   */
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(151)).setAttribute("NOMBRE","CODIGO" );
      ((Element)v.get(151)).setAttribute("TIPO","STRING" );
      ((Element)v.get(151)).setAttribute("VALOR","1" );
      ((Element)v.get(150)).appendChild((Element)v.get(151));
      /* Termina nodo:151   */

      /* Empieza nodo:152 / Elemento padre: 150   */
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(152)).setAttribute("NOMBRE","DESCRIPCION" );
      ((Element)v.get(152)).setAttribute("TIPO","STRING" );
      ((Element)v.get(152)).setAttribute("VALOR","Números" );
   ...
   private void getXML630(Document doc) {
      ...
      ((Element)v.get(168)).setAttribute("accion","generar();" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(169)).setAttribute("nombre","btnGenerarExcel" );
      ((Element)v.get(169)).setAttribute("ID","botonContenido" );
      ((Element)v.get(169)).setAttribute("tipo","html" );
      ((Element)v.get(169)).setAttribute("accion","generar('xls');" );
      ((Element)v.get(169)).setAttribute("estado","false" );
      ((Element)v.get(169)).setAttribute("cod","2526" );
      ((Element)v.get(169)).setAttribute("ontab","focaliza('Formulario.cbMarca');" );
      ...
      /* Empieza nodo:172 / Elemento padre: 25   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(25)).appendChild((Element)v.get(172));
