/*
    INDRA/CAR/mmg
    $Id: MaeEstatProduLPStartUp.java,v 1.1 2009/12/03 18:40:09 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class MaeEstatProduLPStartUp extends MMGDruidaBase{
	...
	public MaeEstatProduLPStartUp(){
		super();
	}

	public void inicio() throws Exception {
		pagina("MaeEstatProduPage");
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "MaeEstatProduPage", "cod", "MaeEstatProdu." + accion + ".label");
			...
			limpiarBotoneraLista("maeEstatProdu", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codEstaProd", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 2);");
		...
		//asignarAtributo("CAPA", "maeEstatProduLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "MaeEstatProduPage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("MaeEstatProduLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		MaeEstatProduData maeEstatProduQuery= new MaeEstatProduData();
		maeEstatProduQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		MaeEstatProduData datosResult = (MaeEstatProduData)getSingleObject(BUSINESSID_QUERY, maeEstatProduQuery, 
			maeEstatProduQuery.clone(), "maeEstatProdu");
		...
		preservaHiddensI18n(new Integer(1), "MAE_ESTAT_PRODU", "maeEstatProduFrm", "Descripcion", true);
		...
		MaeEstatProduData maeEstatProdu = datosResult;
		asignar("TEXT", "codEstaProd", FormatUtils.formatObject(maeEstatProdu.getCodEstaProd(), 
		...
		loadLocalizationVars(maeEstatProdu);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "codEstaProd", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "MAE_ESTAT_PRODU", "maeEstatProduFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "codEstaProd", "req", "S");
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('maeEstatProduFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "maeEstatProduFrm", "oculto", "N");
		...
		traza("MMG::Creando MaeEstatProdu");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		MaeEstatProduData maeEstatProduQuery= new MaeEstatProduData();
		maeEstatProduQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(maeEstatProdu.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"maeEstatProduFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"maeEstatProduFrm\",1, false)");
					asignarAtributo("COMBO","paisOidPais", "ontab", "ejecutarAccionFocoModificacion(\"maeEstatProduFrm\",2, true)");
					asignarAtributo("COMBO","paisOidPais", "onshtab", "ejecutarAccionFocoModificacion(\"maeEstatProduFrm\",2, false)");
				asignarAtributo("AREATEXTO", "codEstaProd", "ontab","ejecutarAccionFocoModificacion(\"maeEstatProduFrm\",3, true)");
				asignarAtributo("AREATEXTO", "codEstaProd", "onshtab","ejecutarAccionFocoModificacion(\"maeEstatProduFrm\",3, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"maeEstatProduFrm\",4, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"maeEstatProduFrm\",4, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","maeEstatProduTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","maeEstatProduTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codEstaProd...");		
				
					traza("MMG: en desactivateNonModifyFields encontrado atributo no editable...");
				
						// borrarCampo("codEstaProd");
						asignarAtributo ("TEXT", "codEstaProd", "disabled", "S");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","maeEstatProduFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","maeEstatProduListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","maeEstatProduListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(MaeEstatProduData maeEstatProdu) throws Exception{
		...
		if(maeEstatProdu != null && maeEstatProdu.getPaisOidPais() != null){
				checkCombo("paisOidPais" , maeEstatProdu.getPaisOidPais().getId().toString());
			}
	...
	* @param maeEstatProdu La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(MaeEstatProduData maeEstatProdu) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		MaeEstatProduData maeEstatProdu = 
			(MaeEstatProduData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(maeEstatProdu.getPaisOidPais() != null){
			maeEstatProdu.setPaisOidPais((es.indra.belcorp.mso.SegPaisViewData)
			getSingleObject(BUSINESSID_PAISOIDPAIS_QUERY, 
			maeEstatProdu.getPaisOidPais(),
			maeEstatProdu.getPaisOidPais().clone(),
			"segPaisView"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(maeEstatProdu);
		loadLeafDependenceCombos(maeEstatProdu);
	}
	...
	*/
	...
	protected void loadLocalizationVars(MaeEstatProduData maeEstatProdu) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("MAE_ESTAT_PRODU");
		mmgLocalizationQuery.setEntiPk(maeEstatProdu.getId());
