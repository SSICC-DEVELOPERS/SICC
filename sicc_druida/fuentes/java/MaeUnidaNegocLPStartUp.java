/*
    INDRA/CAR/mmg
    $Id: MaeUnidaNegocLPStartUp.java,v 1.1 2009/12/03 18:33:34 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class MaeUnidaNegocLPStartUp extends MMGDruidaBase{
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "MaeUnidaNegocPage", "cod", "MaeUnidaNegoc." + accion + ".label");
			...
			limpiarBotoneraLista("maeUnidaNegoc", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codUnidNego", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 3);");
		...
		//asignarAtributo("CAPA", "maeUnidaNegocLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "MaeUnidaNegocPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		MaeUnidaNegocData maeUnidaNegocQuery= new MaeUnidaNegocData();
		maeUnidaNegocQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		MaeUnidaNegocData datosResult = (MaeUnidaNegocData)getSingleObject(BUSINESSID_QUERY, maeUnidaNegocQuery, 
			maeUnidaNegocQuery.clone(), "maeUnidaNegoc");
		...
		preservaHiddensI18n(new Integer(1), "MAE_UNIDA_NEGOC", "maeUnidaNegocFrm", "Descripcion", true);
		...
		MaeUnidaNegocData maeUnidaNegoc = datosResult;
		asignar("TEXT", "codUnidNego", FormatUtils.formatObject(maeUnidaNegoc.getCodUnidNego(), 
		...
		loadLocalizationVars(maeUnidaNegoc);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "codUnidNego", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "MAE_UNIDA_NEGOC", "maeUnidaNegocFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "codUnidNego", "req", "S");
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('maeUnidaNegocFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "maeUnidaNegocFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		MaeUnidaNegocData maeUnidaNegocQuery= new MaeUnidaNegocData();
		maeUnidaNegocQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(maeUnidaNegoc.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"maeUnidaNegocFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"maeUnidaNegocFrm\",1, false)");
					asignarAtributo("COMBO","paisOidPais", "ontab", "ejecutarAccionFocoModificacion(\"maeUnidaNegocFrm\",2, true)");
					asignarAtributo("COMBO","paisOidPais", "onshtab", "ejecutarAccionFocoModificacion(\"maeUnidaNegocFrm\",2, false)");
				asignarAtributo("AREATEXTO", "codUnidNego", "ontab","ejecutarAccionFocoModificacion(\"maeUnidaNegocFrm\",3, true)");
				asignarAtributo("AREATEXTO", "codUnidNego", "onshtab","ejecutarAccionFocoModificacion(\"maeUnidaNegocFrm\",3, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"maeUnidaNegocFrm\",4, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"maeUnidaNegocFrm\",4, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","maeUnidaNegocTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","maeUnidaNegocTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codUnidNego...");		
				
					traza("MMG: en desactivateNonModifyFields encontrado atributo no editable...");
				
						// borrarCampo("codUnidNego");
						asignarAtributo ("TEXT", "codUnidNego", "disabled", "S");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","maeUnidaNegocFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","maeUnidaNegocListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","maeUnidaNegocListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(MaeUnidaNegocData maeUnidaNegoc) throws Exception{
		...
		if(maeUnidaNegoc != null && maeUnidaNegoc.getPaisOidPais() != null){
				checkCombo("paisOidPais" , maeUnidaNegoc.getPaisOidPais().getId().toString());
			}
	...
	* @param maeUnidaNegoc La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(MaeUnidaNegocData maeUnidaNegoc) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		MaeUnidaNegocData maeUnidaNegoc = 
			(MaeUnidaNegocData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(maeUnidaNegoc.getPaisOidPais() != null){
			maeUnidaNegoc.setPaisOidPais((es.indra.belcorp.mso.SegPaisViewData)
			getSingleObject(BUSINESSID_PAISOIDPAIS_QUERY, 
			maeUnidaNegoc.getPaisOidPais(),
			maeUnidaNegoc.getPaisOidPais().clone(),
			"segPaisView"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(maeUnidaNegoc);
		loadLeafDependenceCombos(maeUnidaNegoc);
	}
	...
	*/
	...
	protected void loadLocalizationVars(MaeUnidaNegocData maeUnidaNegoc) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("MAE_UNIDA_NEGOC");
		mmgLocalizationQuery.setEntiPk(maeUnidaNegoc.getId());
