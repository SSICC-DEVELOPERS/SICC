...
public class contenido_informe_consulta_reclamo_productos_generar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_informe_consulta_reclamo_productos_generar" );
      ((Element)v.get(0)).setAttribute("cod","0906" );
      ((Element)v.get(0)).setAttribute("titulo","Generar Informe consulta de reclamo por productos" );
      ...
      v.add(doc.createTextNode("\r   \r   \r   function onLoad(){\r      configurarMenuSecundario('Formulario');\r      fMostrarMensajeError();\r      focaliza('Formulario.cbMarca');\r   }\r\r     function quitarItemVacio(elemento){\r      var elementoADevolver = new Array();\r     \r      for(var k=0;k<elemento.length;k++) {\r          if (elemento[k] != ''){                            \r             elementoADevolver[elementoADevolver.length] = elemento[k];\r          }\r      }\r         \r      return elementoADevolver;\r      \r   }\r   function generar(formato){\r      \r      if(sicc_validaciones_generales()){\r      \r        if(validarOperaciones()){\r          \r          \r          /*recolectarParametros();\r          set('Formulario.conectorAction', 'RECRankingProdUNCRef');            \r          set('Formulario.accion', 'generar');\r          set('Formulario.formato', formato);\r          enviaSICC('Formulario');*/\r          \r          \r          var a = new Object();\r          a.accion = 'generar';\r          a.marca = get('Formulario.cbMarca');      \r          a.canal = get('Formulario.cbCanal'); \r          a.codigoProducto = quitarItemVacio(get('Formulario.cbProducto')); \r          a.tipoPeriodoCampana = get('Formulario.cbTipoPeriodoCampana'); \r          a.campanaInicial = get('Formulario.cbCampanaInicial');\r          a.campanaInicialDesc = get('Formulario.cbCampanaInicial','T');\r          a.campanaFinal = get('Formulario.cbCampanaFinal');\r          a.campanaFinalDesc = get('Formulario.cbCampanaFinal','T');\r          a.puntoIngreso = quitarItemVacio(get('Formulario.cbPuntoIngreso'));\r          \r          a.operaciones1 = get('Formulario.operacion1');\r          a.operaciones2 = get('Formulario.operacion2');\r          a.operaciones3 = get('Formulario.operacion3');\r          a.operaciones4 = get('Formulario.operacion4');\r          \r          a.formato = formato;  \r             \r          mostrarModalSICC('RECReclamosProductos','generar', a);\r        \r        }\r      }\r    }\r\r   function validarOperaciones(){     \r      var operaciones = get('Formulario.cbOperaciones');   \r            \r      if(operaciones.length <= 4){\r        for(var i=0; i<operaciones.length;i++){\r            set('Formulario.operacion' + (i + 1), operaciones[i]);                    \r         }\r      return true; \r      }else{\r         cdos_mostrarAlert('Solo puede seleccionar 4 operaciones');\r         focaliza('Formulario.cbOperaciones');\r         return false;  \r      }\r\r   } \r\r   function onchangeMarcaCanal(){\r        \r       marca  = get('Formulario.cbMarca');\r       canal  = get('Formulario.cbCanal');\r       pais   = get('Formulario.pais');\r       idioma = get('Formulario.idioma');\r       var aCombo = new Array(new Array(\"\",\"\"));\r\r       if(marca != '' && canal != ''){\r          var arr = new Array();\r          \r          arr[arr.length] = [\"oidIdioma\", idioma]; \r          arr[arr.length] = [\"oidPais\", pais]; \r          arr[arr.length] = [\"marca\", marca];\r          arr[arr.length] = [\"canal\", canal];\r          \r		  set_combo('Formulario.cbCampanaInicial', aCombo, []);\r          set_combo('Formulario.cbCampanaFinal', aCombo, []);\r          \r          recargaCombo(\"Formulario.cbCampanaInicial\",\"PRECargarPeriodos\",\"es.indra.sicc.dtos.cra.DTOPeriodo\",arr);\r          recargaCombo(\"Formulario.cbCampanaFinal\",\"PRECargarPeriodos\",\"es.indra.sicc.dtos.cra.DTOPeriodo\",arr);\r       }else{\r          set_combo('Formulario.cbCampanaInicial', aCombo, []);\r          set_combo('Formulario.cbCampanaFinal', aCombo, []);\r       }\r    } \r   \r\r\r\r   function fLimpiar(){\r     var aCombo = new Array(new Array(\"\",\"\"));\r     \r     set_combo('Formulario.cbCampanaInicial', aCombo, []); \r     set_combo('Formulario.cbCampanaFinal', aCombo, []); \r\r     \r     focaliza('Formulario.cbMarca');\r   }\r\r\r\r \r\r   \r"));
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(10)).setAttribute("name","cbProducto" );
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(11)).setAttribute("name","cbTipoPeriodoCampana" );
      ((Element)v.get(11)).setAttribute("required","true" );
      ((Element)v.get(11)).setAttribute("cod","2734" );
      ((Element)v.get(7)).appendChild((Element)v.get(11));
      /* Termina nodo:11   */

      /* Empieza nodo:12 / Elemento padre: 7   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(12)).setAttribute("name","cbCampanaInicial" );
      ((Element)v.get(12)).setAttribute("required","true" );
      ((Element)v.get(12)).setAttribute("cod","2726" );
      ((Element)v.get(7)).appendChild((Element)v.get(12));
      /* Termina nodo:12   */

      /* Empieza nodo:13 / Elemento padre: 7   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(13)).setAttribute("name","cbCampanaFinal" );
      ((Element)v.get(13)).setAttribute("required","true" );
      ((Element)v.get(13)).setAttribute("cod","2727" );
      ((Element)v.get(7)).appendChild((Element)v.get(13));
      /* Termina nodo:13   */

      /* Empieza nodo:14 / Elemento padre: 7   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(14)).setAttribute("name","cbOperaciones" );
      ((Element)v.get(14)).setAttribute("required","true" );
      ((Element)v.get(14)).setAttribute("cod","2730" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(23)).setAttribute("nombre","operacion1" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(24)).setAttribute("nombre","operacion2" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(25)).setAttribute("nombre","operacion3" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(26)).setAttribute("nombre","operacion4" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(93)).setAttribute("nombre","lblTipoPeriodoCampana" );
   ...
   private void getXML360(Document doc) {
      ((Element)v.get(93)).setAttribute("cod","2734" );
      ...
      /* Empieza nodo:96 / Elemento padre: 78   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(78)).appendChild((Element)v.get(96));
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(100)).setAttribute("nombre","cbProducto" );
      ...
      v.add(doc.createElement("IMG"));
      ((Element)v.get(103)).setAttribute("src","iconBuscar.gif" );
      ((Element)v.get(103)).setAttribute("onclick","buscarProducto();" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(107)).setAttribute("nombre","cbPuntoIngreso" );
      ((Element)v.get(107)).setAttribute("size","5" );
      ((Element)v.get(107)).setAttribute("multiple","S" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(112)).setAttribute("nombre","cbTipoPeriodoCampana" );
      ((Element)v.get(112)).setAttribute("size","1" );
      ((Element)v.get(112)).setAttribute("multiple","N" );
      ((Element)v.get(112)).setAttribute("valorinicial","1" );
      ((Element)v.get(112)).setAttribute("textoinicial","Campaña de referencia" );
      ...
      ((Element)v.get(114)).setAttribute("ID","1" );
   ...
   private void getXML450(Document doc) {
      ((Element)v.get(115)).setAttribute("VALOR","2" );
      ...
      ((Element)v.get(116)).setAttribute("VALOR","Campaña de registro" );
      ...
      /* Empieza nodo:119 / Elemento padre: 78   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(78)).appendChild((Element)v.get(119));
   ...
   private void getXML540(Document doc) {
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(140)).setAttribute("nombre","cbCampanaInicial" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(145)).setAttribute("nombre","cbCampanaFinal" );
      ...
      /* Empieza nodo:152 / Elemento padre: 43   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(43)).appendChild((Element)v.get(152));
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(163)).setAttribute("nombre","lblTipoSalida" );
   }
   ...
   private void getXML630(Document doc) {
      ...
      ((Element)v.get(163)).setAttribute("cod","2731" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(170)).setAttribute("nombre","cbOperaciones" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(175)).setAttribute("nombre","lbldtTipoSalida" );
      ...
      ((Element)v.get(175)).setAttribute("valor","PDF" );
      ...
      /* Empieza nodo:181 / Elemento padre: 36   */
      v.add(doc.createElement("td"));
      ((Element)v.get(36)).appendChild((Element)v.get(181));
   ...
   private void getXML720(Document doc) {
      ...
      /* Empieza nodo:195 / Elemento padre: 28   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(28)).appendChild((Element)v.get(195));
