...
public class RecTiposOperaViewPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","RecTiposOperaView.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","RecTiposOperaView.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('recTiposOperaViewFrm',0, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('recTiposOperaViewFrm', 0, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(54)).setAttribute("cod","RecTiposOperaView.ropeOidOper.label" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('recTiposOperaViewFrm',0, true);" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('recTiposOperaViewFrm',0, false);" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(76)).setAttribute("nombre","valTipoOperTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(80)).setAttribute("nombre","lblValTipoOper" );
      ((Element)v.get(80)).setAttribute("alto","13" );
      ((Element)v.get(80)).setAttribute("filas","1" );
      ((Element)v.get(80)).setAttribute("id","datosTitle" );
      ((Element)v.get(80)).setAttribute("cod","RecTiposOperaView.valTipoOper.label" );
   ...
   private void getXML360(Document doc) {
      ((Element)v.get(81)).setAttribute("nombre","valTipoOperWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(83)).setAttribute("nombre","valTipoOper" );
      ...
      ((Element)v.get(83)).setAttribute("ontab","ejecutarAccionFoco('recTiposOperaViewFrm',2, true)" );
      ((Element)v.get(83)).setAttribute("onshtab","ejecutarAccionFoco('recTiposOperaViewFrm', 2, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(84)).setAttribute("nombre","valTipoOperGapTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(98)).setAttribute("nombre","recTiposOperaViewTrButtons" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(105)).setAttribute("nombre","recTiposOperaViewTdQueryButton" );
      ((Element)v.get(104)).appendChild((Element)v.get(105));

      /* Empieza nodo:106 / Elemento padre: 105   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(106)).setAttribute("nombre","recTiposOperaViewQueryButton" );
      ((Element)v.get(106)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(106)).setAttribute("estado","false" );
      ((Element)v.get(106)).setAttribute("accion","recTiposOperaViewFirstPage();" );
      ...
      ((Element)v.get(107)).setAttribute("nombre","recTiposOperaViewTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(109)).setAttribute("nombre","recTiposOperaViewLovNullButton" );
      ((Element)v.get(109)).setAttribute("ID","botonContenido" );
      ((Element)v.get(109)).setAttribute("tipo","html" );
      ((Element)v.get(109)).setAttribute("accion","recTiposOperaViewLovNullSelectionAction();" );
