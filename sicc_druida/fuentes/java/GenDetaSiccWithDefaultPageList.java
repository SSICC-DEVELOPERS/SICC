...
public class GenDetaSiccWithDefaultPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","genDetaSiccWithDefaultList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(16)).setAttribute("cod","GenDetaSiccWithDefault.enti.label" );
      ...
      ((Element)v.get(17)).setAttribute("cod","GenDetaSiccWithDefault.entiPk.label" );
      ...
      ((Element)v.get(18)).setAttribute("cod","GenDetaSiccWithDefault.atri.label" );
      ...
      ((Element)v.get(19)).setAttribute("cod","GenDetaSiccWithDefault.deta.label" );
      ...
      ((Element)v.get(20)).setAttribute("cod","GenDetaSiccWithDefault.idioOidIdio.label" );
