...
public class contenido_fuente_venta_campana_1  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_venta_campana_1" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(50)).setAttribute("colspan","7" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(77)).setAttribute("colspan","7" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(95)).setAttribute("nombre","cbPeriodoDesde" );
      ...
      ((Element)v.get(95)).setAttribute("onchange","cambioPeriodoDesde();" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(100)).setAttribute("nombre","cbPeriodoHasta" );
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(105)).setAttribute("colspan","7" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(133)).setAttribute("colspan","7" );
      ...
      /* Empieza nodo:135 / Elemento padre: 41   */
      v.add(doc.createElement("td"));
      ((Element)v.get(41)).appendChild((Element)v.get(135));
      ...
      /* Empieza nodo:137 / Elemento padre: 33   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(33)).appendChild((Element)v.get(137));
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(145)).setAttribute("nombre","btnGenerarInforme" );
      ((Element)v.get(145)).setAttribute("ID","botonContenido" );
      ((Element)v.get(145)).setAttribute("tipo","html" );
      ((Element)v.get(145)).setAttribute("accion","validarPeriodos();" );
      ((Element)v.get(145)).setAttribute("estado","false" );
      ((Element)v.get(145)).setAttribute("cod","2495" );
      ((Element)v.get(145)).setAttribute("ontab","focaliza('Formulario.cbMarca')" );
      ...
      /* Empieza nodo:148 / Elemento padre: 33   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(33)).appendChild((Element)v.get(148));
