...
public class CobArgumObligVolunPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","CobArgumObligVolun.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","CobArgumObligVolun.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('cobArgumObligVolunFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('cobArgumObligVolunFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(50)).setAttribute("nombre","codArguObliVoluTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lblCodArguObliVolu" );
      ((Element)v.get(54)).setAttribute("alto","13" );
      ((Element)v.get(54)).setAttribute("filas","1" );
      ((Element)v.get(54)).setAttribute("id","datosTitle" );
      ((Element)v.get(54)).setAttribute("cod","CobArgumObligVolun.codArguObliVolu.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(55)).setAttribute("nombre","codArguObliVoluWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(57)).setAttribute("nombre","codArguObliVolu" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('cobArgumObligVolunFrm',2, true)" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('cobArgumObligVolunFrm', 2, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(58)).setAttribute("nombre","codArguObliVoluGapTdId" );
   ...
   private void getXML270(Document doc) {
      ...
      /* Empieza nodo:72 / Elemento padre: 0   */
      v.add(doc.createElement("TR"));
      ((Element)v.get(72)).setAttribute("nombre","cobArgumObligVolunTrButtons" );
      ((Element)v.get(0)).appendChild((Element)v.get(72));
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(79)).setAttribute("class","tablaTitle" );
      ((Element)v.get(79)).setAttribute("nombre","cobArgumObligVolunTdQueryButton" );
      ((Element)v.get(78)).appendChild((Element)v.get(79));

      /* Empieza nodo:80 / Elemento padre: 79   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(80)).setAttribute("nombre","cobArgumObligVolunQueryButton" );
      ((Element)v.get(80)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(80)).setAttribute("estado","false" );
      ((Element)v.get(80)).setAttribute("accion","cobArgumObligVolunFirstPage();" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(81)).setAttribute("nombre","cobArgumObligVolunTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(83)).setAttribute("nombre","cobArgumObligVolunLovNullButton" );
      ((Element)v.get(83)).setAttribute("ID","botonContenido" );
      ((Element)v.get(83)).setAttribute("tipo","html" );
      ((Element)v.get(83)).setAttribute("accion","cobArgumObligVolunLovNullSelectionAction();" );
      ((Element)v.get(83)).setAttribute("estado","true" );
      ((Element)v.get(83)).setAttribute("cod","MMGGlobal.lovNullButton.label" );
