...
public class CccParamContaPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","cccParamContaList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","CccParamConta.subpOidSubp.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","CccParamConta.valDebeHabe.label" );
      ...
      ((Element)v.get(17)).setAttribute("cod","CccParamConta.valObteCuen.label" );
      ...
      ((Element)v.get(18)).setAttribute("cod","CccParamConta.valTextApun.label" );
