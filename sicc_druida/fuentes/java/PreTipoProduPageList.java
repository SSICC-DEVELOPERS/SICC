...
public class PreTipoProduPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","preTipoProduList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","PreTipoProdu.codTipoProd.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","PreTipoProdu.desTipoProd.label" );
