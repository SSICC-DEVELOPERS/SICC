...
public class PedClaseSolicConectorQueryList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad PedClaseSolic" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGPedClaseSolicQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGPedClaseSolicQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","PedClaseSolicListFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","codClasSoli" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(9)).setAttribute("NOMBRE","indOrdeComp" );
