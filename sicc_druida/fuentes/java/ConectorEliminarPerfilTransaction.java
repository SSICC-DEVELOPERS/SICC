...
public class ConectorEliminarPerfilTransaction  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("NOMBRE","DTEliminarPerfiles" );
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","ConectorEliminarPerfilTransaction" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(5)).setAttribute("NOMBRE","resultado" );
