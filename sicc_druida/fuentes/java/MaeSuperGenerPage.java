...
public class MaeSuperGenerPage  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","MaeSuperGenerPage" );
      ((Element)v.get(0)).setAttribute("titulo","" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","" );
      ((Element)v.get(0)).setAttribute("onload","maeSuperGenerInitComponents()" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","maesupergener.js" );
      ((Element)v.get(0)).appendChild((Element)v.get(4));
      /* Termina nodo:4   */

      /* Empieza nodo:5 / Elemento padre: 0   */
      v.add(doc.createElement("FORMULARIO"));
      ((Element)v.get(5)).setAttribute("nombre","maeSuperGenerFrm" );
      ...
      ((Element)v.get(6)).setAttribute("valor","MaeSuperGenerLPExecution" );
      ...
      ((Element)v.get(7)).setAttribute("valor","MaeSuperGenerLPExecution" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(37)).setAttribute("nombre","maeSuperGenerFormLayer" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(52)).setAttribute("cod","MaeSuperGener.legend.label" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(67)).setAttribute("cod","MaeSuperGener.id.label" );
      ...
      ((Element)v.get(70)).setAttribute("ontab","ejecutarAccionFoco('maeSuperGenerFrm',1, true)" );
      ((Element)v.get(70)).setAttribute("onshtab","ejecutarAccionFoco('maeSuperGenerFrm', 1, false)" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(92)).setAttribute("cod","MaeSuperGener.paisOidPais.label" );
      ...
      ((Element)v.get(95)).setAttribute("ontab","ejecutarAccionFoco('maeSuperGenerFrm',2, true);" );
      ((Element)v.get(95)).setAttribute("onshtab","ejecutarAccionFoco('maeSuperGenerFrm',2, false);" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(114)).setAttribute("nombre","codSupeGeneTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(119)).setAttribute("nombre","codSupeGeneWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(121)).setAttribute("nombre","codSupeGene" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(121)).setAttribute("ontab","ejecutarAccionFoco('maeSuperGenerFrm',3, true)" );
      ((Element)v.get(121)).setAttribute("onshtab","ejecutarAccionFoco('maeSuperGenerFrm', 3, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(122)).setAttribute("nombre","codSupeGeneGapTdId" );
      ...
      ((Element)v.get(128)).setAttribute("cod","MaeSuperGener.Descripcion.label" );
      ...
      ((Element)v.get(132)).setAttribute("ontab","ejecutarAccionFoco('maeSuperGenerFrm',4, true)" );
      ((Element)v.get(132)).setAttribute("onshtab","ejecutarAccionFoco('maeSuperGenerFrm', 4, false)" );
      ...
      ((Element)v.get(136)).setAttribute("href","javascript:openLocalizationDialog('maeSuperGenerFrm', 'Descripcion', 1);" );
      ((Element)v.get(136)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"maeSuperGenerFrm\",4, true)', 'ejecutarAccionFoco(\"maeSuperGenerFrm\",4, false)')" );
   ...
   private void getXML630(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(152)).setAttribute("nombre","maeSuperGenerTrButtons" );
      ...
      ((Element)v.get(159)).setAttribute("nombre","maeSuperGenerTdQueryButton" );
      ((Element)v.get(158)).appendChild((Element)v.get(159));

      /* Empieza nodo:160 / Elemento padre: 159   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(160)).setAttribute("nombre","maeSuperGenerQueryButton" );
      ((Element)v.get(160)).setAttribute("cod","MMGGlobal.queryButton.label" );
   }

   private void getXML720(Document doc) {
      ((Element)v.get(160)).setAttribute("estado","false" );
      ((Element)v.get(160)).setAttribute("accion","maeSuperGenerFirstPage();" );
      ...
      ((Element)v.get(161)).setAttribute("nombre","maeSuperGenerTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(163)).setAttribute("nombre","maeSuperGenerLovNullButton" );
      ((Element)v.get(163)).setAttribute("ID","botonContenido" );
      ((Element)v.get(163)).setAttribute("tipo","html" );
      ((Element)v.get(163)).setAttribute("accion","maeSuperGenerLovNullSelectionAction();" );
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(166)).setAttribute("nombre","maeSuperGenerListLayer" );
      ...
      ((Element)v.get(167)).setAttribute("nombre","maeSuperGenerList" );
   ...
   private void getXML810(Document doc) {
      ...
      ((Element)v.get(180)).setAttribute("cod","MaeSuperGener.codSupeGene.label" );
      ...
      ((Element)v.get(181)).setAttribute("cod","MaeSuperGener.Descripcion.label" );
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(186)).setAttribute("nombre","maeSuperGenerListButtonsLayer" );
   ...
   private void getXML900(Document doc) {
      ...
      ((Element)v.get(192)).setAttribute("nombre","maeSuperGenerPaginationButtonBar" );
      ...
      ((Element)v.get(193)).setAttribute("nombre","maeSuperGenerFirstPageButton" );
      ((Element)v.get(193)).setAttribute("funcion","maeSuperGenerFirstPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(194)).setAttribute("nombre","maeSuperGenerFirstPageButtonGapTd" );
      ...
      v.add(doc.createElement("BTN"));
      ((Element)v.get(196)).setAttribute("nombre","maeSuperGenerPreviousPageButton" );
      ((Element)v.get(196)).setAttribute("funcion","maeSuperGenerPreviousPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(197)).setAttribute("nombre","maeSuperGenerPreviousPageButtonGapTd" );
      ...
      v.add(doc.createElement("BTN"));
      ((Element)v.get(199)).setAttribute("nombre","maeSuperGenerNextPageButton" );
      ((Element)v.get(199)).setAttribute("funcion","maeSuperGenerNextPage();" );
      ...
      ((Element)v.get(202)).setAttribute("nombre","maeSuperGenerUpdateButtonTd" );
      ((Element)v.get(188)).appendChild((Element)v.get(202));

      /* Empieza nodo:203 / Elemento padre: 202   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(203)).setAttribute("nombre","maeSuperGenerUpdateButton" );
      ((Element)v.get(203)).setAttribute("ID","botonContenido" );
      ((Element)v.get(203)).setAttribute("tipo","html" );
      ((Element)v.get(203)).setAttribute("accion","maeSuperGenerUpdateSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(204)).setAttribute("nombre","maeSuperGenerUpdateButtonGapTd" );
   }
   ...
   private void getXML990(Document doc) {
      ...
      ((Element)v.get(206)).setAttribute("nombre","maeSuperGenerViewForRemoveButtonTd" );
      ((Element)v.get(188)).appendChild((Element)v.get(206));

      /* Empieza nodo:207 / Elemento padre: 206   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(207)).setAttribute("nombre","maeSuperGenerViewForRemoveButton" );
      ((Element)v.get(207)).setAttribute("ID","botonContenido" );
      ((Element)v.get(207)).setAttribute("tipo","html" );
      ((Element)v.get(207)).setAttribute("accion","maeSuperGenerViewSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(208)).setAttribute("nombre","maeSuperGenerViewForRemoveButtonGapTd" );
      ...
      ((Element)v.get(210)).setAttribute("nombre","maeSuperGenerLovSelectButtonTd" );
      ((Element)v.get(188)).appendChild((Element)v.get(210));

      /* Empieza nodo:211 / Elemento padre: 210   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(211)).setAttribute("nombre","maeSuperGenerLovSelectButton" );
      ((Element)v.get(211)).setAttribute("ID","botonContenido" );
      ((Element)v.get(211)).setAttribute("tipo","html" );
      ((Element)v.get(211)).setAttribute("accion","maeSuperGenerLovSelectionAction();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(212)).setAttribute("nombre","maeSuperGenerLovSelectButtonGapTd" );
      ...
      ((Element)v.get(214)).setAttribute("nombre","maeSuperGenerViewButtonTd" );
      ((Element)v.get(188)).appendChild((Element)v.get(214));

      /* Empieza nodo:215 / Elemento padre: 214   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(215)).setAttribute("nombre","maeSuperGenerViewButton" );
      ((Element)v.get(215)).setAttribute("ID","botonContenido" );
      ((Element)v.get(215)).setAttribute("tipo","html" );
      ((Element)v.get(215)).setAttribute("accion","maeSuperGenerViewSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(216)).setAttribute("nombre","maeSuperGenerViewButtonGapTd" );
