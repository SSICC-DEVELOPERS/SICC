...
public class contenido_informe_cronograma_calendario_grupo_generar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_informe_cronograma_calendario_grupo_generar" );
      ((Element)v.get(0)).setAttribute("cod","0767" );
      ((Element)v.get(0)).setAttribute("titulo","Generar informe cronograma calendario por grupo" );
      ...
      v.add(doc.createTextNode("\r   \r   \r   function onLoad(){\r      configurarMenuSecundario('Formulario');\r      fMostrarMensajeError();\r      \r      focaliza('Formulario.cbCanal');\r   }\r   function generar(){\r      \r      if(sicc_validaciones_generales()){\r        \r            /*recolectarParametros();\r      \r            set('Formulario.conectorAction', 'CRACronoCalendarioGrupo');           \r            set('Formulario.accion', 'generar');\r      \r            enviaSICC('Formulario');*/\r\r            var a = new Object();\r            a.accion = 'generar';\r            a.marca = get('Formulario.cbMarca');  \r            a.canal = get('Formulario.cbCanal');\r            a.periodo = quitarItemVacio(get('Formulario.cbPeriodo'));\r            a.grupoFacturacion = get('Formulario.cbGrupoFacturacion');          \r\r			if(a.periodo.length > 3) {\r				GestionarMensaje('REPCRA001');\r				return;\r			}\r\r            mostrarModalSICC('CRACronoCalendarioGrupo','generar', a);  \r        \r      }\r\r   }\r\rfunction quitarItemVacio(elemento){\r      var elementoADevolver = new Array();\r     \r      for(var k=0;k<elemento.length;k++) {\r           if (elemento[k] != ''){                                \r              elementoADevolver[elementoADevolver.length] = elemento[k];\r           }\r      }\r          \r      return elementoADevolver;\r      \r   }   \r\r   function recolectarParametros(){\r      \r      \r     \r      set('Formulario.marca', get('Formulario.cbMarca') );  \r      set('Formulario.canal', get('Formulario.cbCanal'));\r      set('Formulario.periodo', get('Formulario.cbPeriodo') );\r      set('Formulario.grupoFacturacion', get('Formulario.cbGrupoFacturacion'));\r      \r          \r      \r  \r   }\r \r   \r\r   function fLimpiar(){\r      var aCombo = new Array(new Array(\"\",\"\"));\r      set_combo('Formulario.cbPeriodo', aCombo, []);\r      set_combo('Formulario.cbGrupoFacturacion', aCombo, []);\r      focaliza('Formulario.cbCanal');\r \r   }\r   \r    function onchangeMarcaCanal(){\r        \r       marca  = get('Formulario.cbMarca');\r       canal  = get('Formulario.cbCanal');\r       pais   = get('Formulario.pais');\r       idioma = get('Formulario.idioma');\r       \r       \r       if(marca != '' && canal != ''){\r       \r          var arr = new Array();\r          var arr2 = new Array();\r              \r          arr[arr.length] = [\"oidIdioma\", idioma]; \r          arr[arr.length] = [\"oidPais\", pais]; \r          arr[arr.length] = [\"marca\", marca];\r          arr[arr.length] = [\"canal\", canal];\r          \r          arr2[arr2.length] = ['oidMarca', marca];\r          arr2[arr2.length] = ['oidCanal', canal];\r          arr2[arr2.length] = ['oidPais', pais];\r          arr2[arr2.length] = ['oidIdioma', idioma];\r           \r          recargaCombo(\"Formulario.cbPeriodo\",\"REPCargarPeriodos\",\"es.indra.sicc.dtos.cra.DTOPeriodo\",arr);\r          recargaCombo(\"Formulario.cbGrupoFacturacion\",\"CRAObtieneGruposZonas\", \"es.indra.sicc.dtos.cra.DTOGrupoZonas\",arr2);\r         \r       }else{\r           var aCombo = new Array(new Array(\"\",\"\"));\r           set_combo('Formulario.cbPeriodo', aCombo, []);\r       \r       }\r   \r    }  \r\r\r   \r"));
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(10)).setAttribute("name","cbGrupoFacturacion" );
      ((Element)v.get(10)).setAttribute("required","true" );
      ((Element)v.get(10)).setAttribute("cod","2568" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(22)).setAttribute("nombre","grupoFacturacion" );
   }
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(75)).setAttribute("nombre","cbGrupoFacturacion" );
