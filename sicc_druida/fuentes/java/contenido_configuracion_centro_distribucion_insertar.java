...
public class contenido_configuracion_centro_distribucion_insertar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_configuracion_centro_distribucion_insertar" );
      ...
      ((Element)v.get(6)).setAttribute("cod","ApeConfCentroDistribucion.descripcion.label" );
      ((Element)v.get(5)).appendChild((Element)v.get(6));
      /* Termina nodo:6   */

      /* Empieza nodo:7 / Elemento padre: 5   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(7)).setAttribute("name","cbNivelOutsourcing" );
      ((Element)v.get(7)).setAttribute("required","true" );
      ((Element)v.get(7)).setAttribute("cod","ApeConfCentroDistribucion.nivelOutsorcing.label" );
      ...
      ((Element)v.get(24)).setAttribute("nombre","lblDatosPrincipales" );
      ((Element)v.get(24)).setAttribute("alto","13" );
      ((Element)v.get(24)).setAttribute("filas","1" );
      ((Element)v.get(24)).setAttribute("cod","ApeConfCentroDistribucion.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(33)).setAttribute("nombre","lblDescripcion" );
      ...
      ((Element)v.get(33)).setAttribute("cod","ApeConfCentroDistribucion.descripcion.label" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(37)).setAttribute("nombre","lblNivelOutsourcing" );
      ...
      ((Element)v.get(37)).setAttribute("cod","ApeConfCentroDistribucion.nivelOutsorcing.label" );
      ...
      ((Element)v.get(44)).setAttribute("nombre","txtDescripcion" );
      ((Element)v.get(44)).setAttribute("id","datosCampos" );
      ((Element)v.get(44)).setAttribute("max","60" );
      ((Element)v.get(44)).setAttribute("tipo","" );
      ((Element)v.get(44)).setAttribute("onchange","" );
      ((Element)v.get(44)).setAttribute("req","S" );
      ((Element)v.get(44)).setAttribute("size","60" );
      ((Element)v.get(44)).setAttribute("valor","" );
      ((Element)v.get(44)).setAttribute("validacion","" );
      ((Element)v.get(44)).setAttribute("ontab","" );
      ((Element)v.get(44)).setAttribute("onshtab","" );
      ((Element)v.get(43)).appendChild((Element)v.get(44));
      /* Termina nodo:44   */

      /* Empieza nodo:45 / Elemento padre: 43   */
      v.add(doc.createElement("IMG"));
      ((Element)v.get(45)).setAttribute("src","iconmultidioma.gif" );
      ((Element)v.get(45)).setAttribute("width","21" );
   }

   private void getXML180(Document doc) {
      ((Element)v.get(45)).setAttribute("height","15" );
      ((Element)v.get(45)).setAttribute("onclick","levantarI18N('formulario','1');" );
      ((Element)v.get(43)).appendChild((Element)v.get(45));
      /* Termina nodo:45   */
      /* Termina nodo:43   */

      /* Empieza nodo:46 / Elemento padre: 40   */
      v.add(doc.createElement("td"));
      ((Element)v.get(40)).appendChild((Element)v.get(46));
      ...
      ((Element)v.get(49)).setAttribute("ontab","" );
      ((Element)v.get(49)).setAttribute("onshtab","" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(60)).setAttribute("nombre","lblImprimirLista" );
      ...
      ((Element)v.get(60)).setAttribute("cod","ApeConfCentroDistribucion.imprimirLista.label" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(64)).setAttribute("nombre","lblCentroDistribDefault" );
      ((Element)v.get(64)).setAttribute("alto","3" );
      ((Element)v.get(64)).setAttribute("filas","1" );
      ((Element)v.get(64)).setAttribute("valor","" );
      ((Element)v.get(64)).setAttribute("id","datosTitle" );
      ((Element)v.get(64)).setAttribute("cod","ApeConfCentroDistribucion.centroDefault.label" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(71)).setAttribute("nombre","ChkImprimirLista" );
      ((Element)v.get(71)).setAttribute("id","datosCampos" );
      ((Element)v.get(71)).setAttribute("onclick","" );
      ((Element)v.get(71)).setAttribute("req","S" );
      ((Element)v.get(71)).setAttribute("check","N" );
      ...
      v.add(doc.createElement("CHECKBOX"));
      ((Element)v.get(75)).setAttribute("nombre","ChkCentroDistribDefault" );
      ((Element)v.get(75)).setAttribute("id","datosCampos" );
      ((Element)v.get(75)).setAttribute("onclick","" );
      ((Element)v.get(75)).setAttribute("req","S" );
      ((Element)v.get(75)).setAttribute("check","N" );
      ((Element)v.get(75)).setAttribute("ontab","" );
      ((Element)v.get(75)).setAttribute("onshtab","" );
      ...
      /* Empieza nodo:83 / Elemento padre: 10   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(10)).appendChild((Element)v.get(83));
