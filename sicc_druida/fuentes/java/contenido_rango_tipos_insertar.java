...
public class contenido_rango_tipos_insertar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_rango_tipos_insertar" );
      ((Element)v.get(0)).setAttribute("cod","0593" );
      ...
      v.add(doc.createTextNode("\r  \r    function fGuardar(){\r        var x_desde =get('frmContenido.txtNTipDesde');\r        var x_hasta=get('frmContenido.txtNTipHasta');\r        if(!sicc_validaciones_generales()){\r            return false;\r        }\r                       \r        if (parseInt(x_desde,10)> parseInt(x_hasta,10)){  \r            var wnd = GestionarMensaje(\"2522\", null, null, null);\r            return;\r        }\r\r        if (get ('frmContenido.casoDeUso')=='Insertar'){\r            set('frmContenido.accion','Guardar');\r        }else if (get ('frmContenido.casoDeUso')=='Modificar'){\r            set('frmContenido.accion','guardar_modif');\r        }\r        enviaSICC('frmContenido');\r    }\r\r    function fVolver(){\r        window.close();\r    }\r\r    function despuesDeGuardar(){        \r        fLimpiarGenericoSICC();\r        fLimpiar();\r        setearValoresPorDefecto();\r    }\r    \r    function init(){\r        configurarMenuSecundario(\"frmContenido\");\r        fMostrarMensajeError();\r        if (get('frmContenido.accion')=='modificar'){\r            btnProxy(3,0);\r            btnProxy(2,1);\r            focaliza('frmContenido.txtNTipHasta','');\r            accion('frmContenido.txtNTipDesde','.disabled=true');\r            accion('frmContenido.cbCanal','.disabled=true');\r            accion('frmContenido.cbEstrategia','.disabled=true');\r            accion('frmContenido.cbMarca','.disabled=true');\r            accion('frmContenido.txtNTipDesde','.disabled=true');\r            cargarDatos();\r        }else if (get('frmContenido.accion')=='Mostrar datos'){\r            btnProxy(4,0);\r            btnProxy(7,0);\r            btnProxy(8,0);                \r            btnProxy(9,0);\r            btnProxy(3,0);\r            btnProxy(2,1);\r            btnProxy(5,0);\r            accion('frmContenido.txtNTipDesde','.disabled=true');\r            accion('frmContenido.cbCanal','.disabled=true');      \r            accion('frmContenido.cbEstrategia','.disabled=true');\r            accion('frmContenido.cbMarca','.disabled=true');\r            accion('frmContenido.txtNTipDesde','.disabled=true');\r            accion('frmContenido.txtNTipHasta','.disabled=true');\r            cargarDatos();            \r        }\r        if (get ('frmContenido.casoDeUso')=='Insertar'){\r            setearValoresPorDefecto();\r        }\r        try{\r            focaliza('frmContenido.cbMarca','');\r        }catch(e){\r            try{\r                focaliza('frmContenido.txtNTipHasta','');\r            }catch(e){}\r        } \r    }\r\r    function fLimpiar(){\r        if (get('frmContenido.accion')=='modificar' || get('frmContenido.accion')=='Mostrar datos'){\r            focaliza('frmContenido.txtNTipHasta','');\r            set('frmContenido.txtNTipDesde',get('frmContenido.desde'));\r            set('frmContenido.txtNTipHasta',get('frmContenido.hasta'));\r        }else{\r            setearValoresPorDefecto();\r        }\r        try{\r            focaliza('frmContenido.cbMarca','');\r        }catch(e){\r            focaliza('frmContenido.txtNTipHasta','');\r        } \r    }\r\r    function cargarDatos(){\r        var array = new Array();\r        array[0]='1';\r        array[1]=get('frmContenido.marca');\r        set_combo('frmContenido.cbMarca',[array,[' ',' ']]);\r\r        array[0]='1';\r        array[1]=get('frmContenido.canal');\r        set_combo('frmContenido.cbCanal',[array,[' ',' ']]);\r\r        array[0]='1';\r        array[1]=get('frmContenido.estrategia');\r        set_combo('frmContenido.cbEstrategia',[array,[' ',' ']]);\r\r        set('frmContenido.txtNTipDesde',get('frmContenido.desde'));\r        set('frmContenido.txtNTipHasta',get('frmContenido.hasta'));\r    }\r    \r    function tabularTXTHasta(tipo){\r        if (!(get('frmContenido.accion')=='modificar' || get('frmContenido.accion')=='Mostrar datos')){\r            if (tipo=='tab'){\r                document.selection.empty();\r                focaliza('frmContenido.cbMarca','');\r            }else if (tipo=='shtab'){\r                focaliza('frmContenido.txtNTipDesde','');\r            }\r        }\r    }\r\r    function setearValoresPorDefecto(){\r        var array = new Array();\r        array[0] = get('frmContenido.marca');\r        set('frmContenido.cbMarca',array);\r        array[0] = get('frmContenido.canal');\r        set('frmContenido.cbCanal',array);\r    }\r    \r    function onErrorGuardar(){\r        focaliza('frmContenido.txtNTipHasta','');\r    }\r  \r"));
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(8)).setAttribute("name","txtNTipDesde" );
      ((Element)v.get(8)).setAttribute("required","true" );
      ((Element)v.get(8)).setAttribute("cod","2083" );
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(9)).setAttribute("name","txtNTipHasta" );
      ((Element)v.get(9)).setAttribute("required","true" );
      ((Element)v.get(9)).setAttribute("cod","2084" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(19)).setAttribute("nombre","estrategia" );
   ...
   private void getXML90(Document doc) {
      v.add(doc.createElement("VAR"));
      ((Element)v.get(20)).setAttribute("nombre","desde" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(21)).setAttribute("nombre","hasta" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(22)).setAttribute("nombre","oidRangoTipos" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(66)).setAttribute("onshtab","focaliza('frmContenido.txtNTipHasta','');" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(87)).setAttribute("nombre","lblNTipDesde" );
      ((Element)v.get(87)).setAttribute("alto","13" );
      ((Element)v.get(87)).setAttribute("filas","1" );
      ((Element)v.get(87)).setAttribute("valor","Nº tipo desde" );
      ((Element)v.get(87)).setAttribute("id","datosTitle" );
      ((Element)v.get(87)).setAttribute("cod","2083" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(91)).setAttribute("nombre","lblNTipHasta" );
      ((Element)v.get(91)).setAttribute("alto","13" );
      ((Element)v.get(91)).setAttribute("filas","1" );
      ((Element)v.get(91)).setAttribute("valor","Nº tipo hasta" );
      ((Element)v.get(91)).setAttribute("id","datosTitle" );
      ((Element)v.get(91)).setAttribute("cod","2084" );
      ...
      ((Element)v.get(103)).setAttribute("nombre","txtNTipDesde" );
   ...
   private void getXML450(Document doc) {
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(107)).setAttribute("nombre","txtNTipHasta" );
