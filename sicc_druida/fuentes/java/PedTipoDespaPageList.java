...
public class PedTipoDespaPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","pedTipoDespaList" );
      ...
      ((Element)v.get(14)).setAttribute("cod","PedTipoDespa.codTipoDesp.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","PedTipoDespa.Descripcion.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","PedTipoDespa.indCron.label" );
