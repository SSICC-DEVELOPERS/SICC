...
public class PedUmbraFaltaPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","PedUmbraFalta.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","PedUmbraFalta.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('pedUmbraFaltaFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('pedUmbraFaltaFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(54)).setAttribute("cod","PedUmbraFalta.paisOidPais.label" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('pedUmbraFaltaFrm',2, true);" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('pedUmbraFaltaFrm',2, false);" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(61)).setAttribute("nombre","negoOidNegoTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(66)).setAttribute("nombre","negoOidNegoWidgetTrId" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(68)).setAttribute("nombre","negoOidNego" );
      ...
      ((Element)v.get(68)).setAttribute("ontab","ejecutarAccionFoco('pedUmbraFaltaFrm',3, true);" );
      ((Element)v.get(68)).setAttribute("onshtab","ejecutarAccionFoco('pedUmbraFaltaFrm',3, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(70)).setAttribute("nombre","negoOidNegoGapTdId" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(72)).setAttribute("nombre","valUmbrFaltTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(77)).setAttribute("nombre","valUmbrFaltWidgetTrId" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(79)).setAttribute("ontab","ejecutarAccionFoco('pedUmbraFaltaFrm',4, true)" );
      ((Element)v.get(79)).setAttribute("onshtab","ejecutarAccionFoco('pedUmbraFaltaFrm', 4, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(80)).setAttribute("nombre","valUmbrFaltGapTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(94)).setAttribute("nombre","pedUmbraFaltaTrButtons" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(101)).setAttribute("nombre","pedUmbraFaltaTdQueryButton" );
      ((Element)v.get(100)).appendChild((Element)v.get(101));

      /* Empieza nodo:102 / Elemento padre: 101   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(102)).setAttribute("nombre","pedUmbraFaltaQueryButton" );
      ((Element)v.get(102)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(102)).setAttribute("estado","false" );
      ((Element)v.get(102)).setAttribute("accion","pedUmbraFaltaFirstPage();" );
      ...
      ((Element)v.get(103)).setAttribute("nombre","pedUmbraFaltaTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(105)).setAttribute("nombre","pedUmbraFaltaLovNullButton" );
      ((Element)v.get(105)).setAttribute("ID","botonContenido" );
      ((Element)v.get(105)).setAttribute("tipo","html" );
      ((Element)v.get(105)).setAttribute("accion","pedUmbraFaltaLovNullSelectionAction();" );
