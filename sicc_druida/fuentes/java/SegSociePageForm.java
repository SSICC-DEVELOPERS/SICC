...
public class SegSociePageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","SegSocie.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","SegSocie.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('segSocieFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('segSocieFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(54)).setAttribute("cod","SegSocie.paisOidPais.label" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('segSocieFrm',2, true);" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('segSocieFrm',2, false);" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(65)).setAttribute("cod","SegSocie.codSoci.label" );
      ...
      ((Element)v.get(68)).setAttribute("ontab","ejecutarAccionFoco('segSocieFrm',3, true)" );
      ((Element)v.get(68)).setAttribute("onshtab","ejecutarAccionFoco('segSocieFrm', 3, false)" );
      ...
      ((Element)v.get(75)).setAttribute("cod","SegSocie.valDeno.label" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(78)).setAttribute("ontab","ejecutarAccionFoco('segSocieFrm',4, true)" );
      ((Element)v.get(78)).setAttribute("onshtab","ejecutarAccionFoco('segSocieFrm', 4, false)" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(100)).setAttribute("cod","SegSocie.valDire.label" );
      ...
      ((Element)v.get(103)).setAttribute("ontab","ejecutarAccionFoco('segSocieFrm',5, true)" );
      ((Element)v.get(103)).setAttribute("onshtab","ejecutarAccionFoco('segSocieFrm', 5, false)" );
      ...
      ((Element)v.get(110)).setAttribute("cod","SegSocie.valTlfn.label" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(113)).setAttribute("ontab","ejecutarAccionFoco('segSocieFrm',6, true)" );
      ((Element)v.get(113)).setAttribute("onshtab","ejecutarAccionFoco('segSocieFrm', 6, false)" );
      ...
      ((Element)v.get(120)).setAttribute("cod","SegSocie.valFax.label" );
      ...
      ((Element)v.get(123)).setAttribute("ontab","ejecutarAccionFoco('segSocieFrm',7, true)" );
      ((Element)v.get(123)).setAttribute("onshtab","ejecutarAccionFoco('segSocieFrm', 7, false)" );
   ...
   private void getXML630(Document doc) {
      ...
      ((Element)v.get(145)).setAttribute("cod","SegSocie.valIdenFisc.label" );
      ...
      ((Element)v.get(148)).setAttribute("ontab","ejecutarAccionFoco('segSocieFrm',8, true)" );
      ((Element)v.get(148)).setAttribute("onshtab","ejecutarAccionFoco('segSocieFrm', 8, false)" );
   ...
   private void getXML720(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(163)).setAttribute("nombre","segSocieTrButtons" );
      ...
      ((Element)v.get(170)).setAttribute("nombre","segSocieTdQueryButton" );
      ((Element)v.get(169)).appendChild((Element)v.get(170));

      /* Empieza nodo:171 / Elemento padre: 170   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(171)).setAttribute("nombre","segSocieQueryButton" );
      ((Element)v.get(171)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(171)).setAttribute("estado","false" );
      ((Element)v.get(171)).setAttribute("accion","segSocieFirstPage();" );
   ...
   private void getXML810(Document doc) {
      ((Element)v.get(172)).setAttribute("nombre","segSocieTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(174)).setAttribute("nombre","segSocieLovNullButton" );
      ((Element)v.get(174)).setAttribute("ID","botonContenido" );
      ((Element)v.get(174)).setAttribute("tipo","html" );
      ((Element)v.get(174)).setAttribute("accion","segSocieLovNullSelectionAction();" );
