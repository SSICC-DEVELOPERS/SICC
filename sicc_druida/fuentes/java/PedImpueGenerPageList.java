...
public class PedImpueGenerPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","pedImpueGenerList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","PedImpueGener.sbacOidSbac.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","PedImpueGener.taimOidTasaImpu.label" );
      ...
      ((Element)v.get(17)).setAttribute("cod","PedImpueGener.taimOidTasaImpuFlet.label" );
      ...
      ((Element)v.get(18)).setAttribute("cod","PedImpueGener.indTasaUnic.label" );
