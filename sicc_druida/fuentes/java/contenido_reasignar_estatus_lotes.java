...
public class contenido_reasignar_estatus_lotes  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_reasignar_estatus_lotes" );
      ((Element)v.get(0)).setAttribute("cod","EstatusLotes.query.label" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(3)).setAttribute("src","contenido_reasignar_estatus_lotes.js" );
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(7)).setAttribute("name","cbPeriodoActual" );
      ((Element)v.get(7)).setAttribute("required","true" );
      ((Element)v.get(7)).setAttribute("cod","EstatusLotes.PeriodoActual.label" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(18)).setAttribute("nombre","oidMarcaDef" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(19)).setAttribute("nombre","oidCanalDef" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(20)).setAttribute("nombre","periodosSolapados" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(36)).setAttribute("nombre","lblDatosPrincipales" );
      ((Element)v.get(36)).setAttribute("alto","13" );
      ((Element)v.get(36)).setAttribute("filas","1" );
      ((Element)v.get(36)).setAttribute("cod","EstatusLotes.legend.label" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(52)).setAttribute("onshtab","focalizaBotonHTML('botonContenido','btnReasignar');" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(71)).setAttribute("onchange","onChangeCanal();" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(83)).setAttribute("nombre","lblPeriodoActual" );
      ...
      ((Element)v.get(83)).setAttribute("cod","EstatusLotes.PeriodoActual.label" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(90)).setAttribute("nombre","cbPeriodoActual" );
   ...
   private void getXML360(Document doc) {
      ...
      /* Empieza nodo:97 / Elemento padre: 33   */
      v.add(doc.createElement("fieldset"));
      ((Element)v.get(33)).appendChild((Element)v.get(97));
      ...
      ((Element)v.get(101)).setAttribute("nombre","btnReasignar" );
      ...
      ((Element)v.get(101)).setAttribute("cod","EstatusLotes.boton.label" );
      ((Element)v.get(101)).setAttribute("accion","accionReasignar();" );
      ((Element)v.get(101)).setAttribute("ontab","focaliza('formulario.cbMarca');" );
      ...
      /* Empieza nodo:104 / Elemento padre: 22   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(22)).appendChild((Element)v.get(104));
