...
public class FacTipoDocumConectorQueryList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad FacTipoDocum" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGFacTipoDocumQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGFacTipoDocumQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","FacTipoDocumListFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(8)).setAttribute("NOMBRE","desTipoDocu" );
