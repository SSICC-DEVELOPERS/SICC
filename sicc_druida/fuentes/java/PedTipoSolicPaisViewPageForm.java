...
public class PedTipoSolicPaisViewPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","PedTipoSolicPaisView.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","PedTipoSolicPaisView.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('pedTipoSolicPaisViewFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('pedTipoSolicPaisViewFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(54)).setAttribute("cod","PedTipoSolicPaisView.paisOidPais.label" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('pedTipoSolicPaisViewFrm',2, true);" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('pedTipoSolicPaisViewFrm',2, false);" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(65)).setAttribute("cod","PedTipoSolicPaisView.tsolOidTipoSoli.label" );
      ...
      ((Element)v.get(68)).setAttribute("ontab","ejecutarAccionFoco('pedTipoSolicPaisViewFrm',3, true);" );
      ((Element)v.get(68)).setAttribute("onshtab","ejecutarAccionFoco('pedTipoSolicPaisViewFrm',3, false);" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(75)).setAttribute("nombre","formGapTr1" );
   ...
   private void getXML360(Document doc) {
      ...
      /* Empieza nodo:84 / Elemento padre: 0   */
      v.add(doc.createElement("TR"));
      ((Element)v.get(84)).setAttribute("nombre","pedTipoSolicPaisViewTrButtons" );
      ((Element)v.get(0)).appendChild((Element)v.get(84));
      ...
      ((Element)v.get(91)).setAttribute("nombre","pedTipoSolicPaisViewTdQueryButton" );
      ((Element)v.get(90)).appendChild((Element)v.get(91));

      /* Empieza nodo:92 / Elemento padre: 91   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(92)).setAttribute("nombre","pedTipoSolicPaisViewQueryButton" );
      ((Element)v.get(92)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(92)).setAttribute("estado","false" );
      ((Element)v.get(92)).setAttribute("accion","pedTipoSolicPaisViewFirstPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(93)).setAttribute("class","tablaTitle" );
      ((Element)v.get(93)).setAttribute("nombre","pedTipoSolicPaisViewTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(95)).setAttribute("nombre","pedTipoSolicPaisViewLovNullButton" );
      ((Element)v.get(95)).setAttribute("ID","botonContenido" );
      ((Element)v.get(95)).setAttribute("tipo","html" );
      ((Element)v.get(95)).setAttribute("accion","pedTipoSolicPaisViewLovNullSelectionAction();" );
      ((Element)v.get(95)).setAttribute("estado","true" );
      ((Element)v.get(95)).setAttribute("cod","MMGGlobal.lovNullButton.label" );
