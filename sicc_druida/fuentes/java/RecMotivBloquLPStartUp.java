/*
    INDRA/CAR/mmg
    $Id: RecMotivBloquLPStartUp.java,v 1.1 2009/12/03 18:41:37 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class RecMotivBloquLPStartUp extends MMGDruidaBase{
	...
	public RecMotivBloquLPStartUp(){
		super();
	}

	public void inicio() throws Exception {
		pagina("RecMotivBloquPage");
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "RecMotivBloquPage", "cod", "RecMotivBloqu." + accion + ".label");
			...
			limpiarBotoneraLista("recMotivBloqu", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "valMotiBloq", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 2);");
		...
		//asignarAtributo("CAPA", "recMotivBloquLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "RecMotivBloquPage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("RecMotivBloquLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		RecMotivBloquData recMotivBloquQuery= new RecMotivBloquData();
		recMotivBloquQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		RecMotivBloquData datosResult = (RecMotivBloquData)getSingleObject(BUSINESSID_QUERY, recMotivBloquQuery, 
			recMotivBloquQuery.clone(), "recMotivBloqu");
		...
		preservaHiddensI18n(new Integer(1), "REC_MOTIV_BLOQU", "recMotivBloquFrm", "Descripcion", true);
		...
		RecMotivBloquData recMotivBloqu = datosResult;
		asignar("TEXT", "valMotiBloq", FormatUtils.formatObject(recMotivBloqu.getValMotiBloq(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "Descripcion", FormatUtils.formatObject(recMotivBloqu.getDescripcion(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		loadLocalizationVars(recMotivBloqu);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "valMotiBloq", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "REC_MOTIV_BLOQU", "recMotivBloquFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "valMotiBloq", "req", "S");
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('recMotivBloquFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "recMotivBloquFrm", "oculto", "N");
		...
		traza("MMG::Creando RecMotivBloqu");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		RecMotivBloquData recMotivBloquQuery= new RecMotivBloquData();
		recMotivBloquQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(recMotivBloqu.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"recMotivBloquFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"recMotivBloquFrm\",1, false)");
				asignarAtributo("AREATEXTO", "valMotiBloq", "ontab","ejecutarAccionFocoModificacion(\"recMotivBloquFrm\",2, true)");
				asignarAtributo("AREATEXTO", "valMotiBloq", "onshtab","ejecutarAccionFocoModificacion(\"recMotivBloquFrm\",2, false)");
					asignarAtributo("COMBO","paisOidPais", "ontab", "ejecutarAccionFocoModificacion(\"recMotivBloquFrm\",3, true)");
					asignarAtributo("COMBO","paisOidPais", "onshtab", "ejecutarAccionFocoModificacion(\"recMotivBloquFrm\",3, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"recMotivBloquFrm\",4, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"recMotivBloquFrm\",4, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","recMotivBloquTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","recMotivBloquTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","recMotivBloquFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","recMotivBloquListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","recMotivBloquListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(RecMotivBloquData recMotivBloqu) throws Exception{
		...
		if(recMotivBloqu != null && recMotivBloqu.getPaisOidPais() != null){
				checkCombo("paisOidPais" , recMotivBloqu.getPaisOidPais().getId().toString());
			}
	...
	* @param recMotivBloqu La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(RecMotivBloquData recMotivBloqu) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		RecMotivBloquData recMotivBloqu = 
			(RecMotivBloquData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(recMotivBloqu.getPaisOidPais() != null){
			recMotivBloqu.setPaisOidPais((es.indra.belcorp.mso.SegPaisViewData)
			getSingleObject(BUSINESSID_PAISOIDPAIS_QUERY, 
			recMotivBloqu.getPaisOidPais(),
			recMotivBloqu.getPaisOidPais().clone(),
			"segPaisView"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(recMotivBloqu);
		loadLeafDependenceCombos(recMotivBloqu);
	}
	...
	*/
	...
	protected void loadLocalizationVars(RecMotivBloquData recMotivBloqu) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("REC_MOTIV_BLOQU");
		mmgLocalizationQuery.setEntiPk(recMotivBloqu.getId());
