...
public class ConectorConsultarGruposZonas  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","DTOEntradaCalendario" );
      ...
      ((Element)v.get(6)).setAttribute("TIPO","INTEGER" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","NOM_GRUP" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(8)).setAttribute("NOMBRE","TIPO_FACT" );
      ...
      ((Element)v.get(9)).setAttribute("ID","dtoSalida.resultado_ROWSET" );
      ((Element)v.get(0)).appendChild((Element)v.get(9));

      /* Empieza nodo:10 / Elemento padre: 9   */
      v.add(doc.createElement("CCAMPO"));
      ((Element)v.get(10)).setAttribute("NOMBRE","COD_GRUP" );
      ((Element)v.get(9)).appendChild((Element)v.get(10));
      /* Termina nodo:10   */

      /* Empieza nodo:11 / Elemento padre: 9   */
      v.add(doc.createElement("CCAMPO"));
      ((Element)v.get(11)).setAttribute("NOMBRE","NOM_GRUP" );
