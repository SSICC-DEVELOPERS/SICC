...
public class MaeTipoProblTipoSolucPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","maeTipoProblTipoSolucList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","MaeTipoProblTipoSoluc.tipbOidTipoProb.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","MaeTipoProblTipoSoluc.tsocOidTipoSolu.label" );
