...
public class contenido_estado_unidades_geograficas_consultar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_estado_unidades_geograficas_consultar" );
      ((Element)v.get(0)).setAttribute("titulo","Consultar estado de unidades geográficas" );
      ((Element)v.get(0)).setAttribute("cod","0360" );
      ((Element)v.get(0)).setAttribute("estilos","estilos.css" );
      ((Element)v.get(0)).setAttribute("colorf","white" );
      ((Element)v.get(0)).setAttribute("msgle","Consultar estado de unidades geográficas" );
