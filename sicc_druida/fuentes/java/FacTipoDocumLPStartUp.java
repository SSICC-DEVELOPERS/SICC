/*
    INDRA/CAR/mmg
    $Id: FacTipoDocumLPStartUp.java,v 1.1 2009/12/03 18:32:54 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class FacTipoDocumLPStartUp extends MMGDruidaBase{
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "FacTipoDocumPage", "cod", "FacTipoDocum." + accion + ".label");
			...
			limpiarBotoneraLista("facTipoDocum", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codTipoDocu", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 3);");
		asignarAtributo("TEXT", "desTipoDocu", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 20);");
		
		//Primero determianmos el nombre del campo en la entidad de oriegen donde se van a cargar los datos
		asignar("VAR", "idAttributeLovOpener", conectorParametro(PARAMETRO_LOV_ATTRIBUTO));
		asignar("VAR", "idEntityLovOpener", conectorParametro(PARAMETRO_LOV_ENTIDAD));
		//asignarAtributo("CAPA", "facTipoDocumLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "FacTipoDocumPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		FacTipoDocumData facTipoDocumQuery= new FacTipoDocumData();
		facTipoDocumQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		FacTipoDocumData datosResult = (FacTipoDocumData)getSingleObject(BUSINESSID_QUERY, facTipoDocumQuery, 
			facTipoDocumQuery.clone(), "facTipoDocum");
		...
		FacTipoDocumData facTipoDocum = datosResult;
		asignar("TEXT", "codTipoDocu", FormatUtils.formatObject(facTipoDocum.getCodTipoDocu(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "desTipoDocu", FormatUtils.formatObject(facTipoDocum.getDesTipoDocu(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		asignarAtributo("TEXT", "desTipoDocu", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		...
		asignarAtributo("TEXT", "desTipoDocu", "req", "S");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "facTipoDocumFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		FacTipoDocumData facTipoDocumQuery= new FacTipoDocumData();
		facTipoDocumQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(facTipoDocum.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"facTipoDocumFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"facTipoDocumFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codTipoDocu", "ontab","ejecutarAccionFocoModificacion(\"facTipoDocumFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codTipoDocu", "onshtab","ejecutarAccionFocoModificacion(\"facTipoDocumFrm\",2, false)");
				asignarAtributo("AREATEXTO", "desTipoDocu", "ontab","ejecutarAccionFocoModificacion(\"facTipoDocumFrm\",3, true)");
				asignarAtributo("AREATEXTO", "desTipoDocu", "onshtab","ejecutarAccionFocoModificacion(\"facTipoDocumFrm\",3, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","facTipoDocumTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","facTipoDocumTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es desTipoDocu...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","facTipoDocumFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","facTipoDocumListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","facTipoDocumListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(FacTipoDocumData facTipoDocum) throws Exception{
	...
	* @param facTipoDocum La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(FacTipoDocumData facTipoDocum) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		FacTipoDocumData facTipoDocum = 
			(FacTipoDocumData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(facTipoDocum);
		loadLeafDependenceCombos(facTipoDocum);
	}
