...
public class PedSubtiPosicViewPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","PedSubtiPosicView.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","PedSubtiPosicView.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('pedSubtiPosicViewFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('pedSubtiPosicViewFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(50)).setAttribute("nombre","codSubtPosiTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lblCodSubtPosi" );
      ((Element)v.get(54)).setAttribute("alto","13" );
      ((Element)v.get(54)).setAttribute("filas","1" );
      ((Element)v.get(54)).setAttribute("id","datosTitle" );
      ((Element)v.get(54)).setAttribute("cod","PedSubtiPosicView.codSubtPosi.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(55)).setAttribute("nombre","codSubtPosiWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(57)).setAttribute("nombre","codSubtPosi" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('pedSubtiPosicViewFrm',2, true)" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('pedSubtiPosicViewFrm', 2, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(58)).setAttribute("nombre","codSubtPosiGapTdId" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(60)).setAttribute("nombre","tposOidTipoPosiTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(64)).setAttribute("nombre","lbltposOidTipoPosi" );
      ((Element)v.get(64)).setAttribute("id","datosTitle" );
      ((Element)v.get(64)).setAttribute("ancho","150" );
      ((Element)v.get(64)).setAttribute("alto","13" );
      ((Element)v.get(64)).setAttribute("cod","PedSubtiPosicView.tposOidTipoPosi.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(65)).setAttribute("nombre","tposOidTipoPosiWidgetTrId" );
      ...
      ((Element)v.get(67)).setAttribute("nombre","tposOidTipoPosi" );
      ...
      ((Element)v.get(67)).setAttribute("ontab","ejecutarAccionFoco('pedSubtiPosicViewFrm',3, true);" );
      ((Element)v.get(67)).setAttribute("onshtab","ejecutarAccionFoco('pedSubtiPosicViewFrm',3, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(69)).setAttribute("nombre","tposOidTipoPosiGapTdId" );
      ...
      ((Element)v.get(75)).setAttribute("cod","PedSubtiPosicView.Descripcion.label" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(79)).setAttribute("ontab","ejecutarAccionFoco('pedSubtiPosicViewFrm',4, true)" );
      ((Element)v.get(79)).setAttribute("onshtab","ejecutarAccionFoco('pedSubtiPosicViewFrm', 4, false)" );
      ...
      ((Element)v.get(83)).setAttribute("href","javascript:openLocalizationDialog('pedSubtiPosicViewFrm', 'Descripcion', 1);" );
      ((Element)v.get(83)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"pedSubtiPosicViewFrm\",4, true)', 'ejecutarAccionFoco(\"pedSubtiPosicViewFrm\",4, false)')" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(99)).setAttribute("nombre","pedSubtiPosicViewTrButtons" );
      ...
      ((Element)v.get(106)).setAttribute("nombre","pedSubtiPosicViewTdQueryButton" );
      ((Element)v.get(105)).appendChild((Element)v.get(106));

      /* Empieza nodo:107 / Elemento padre: 106   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(107)).setAttribute("nombre","pedSubtiPosicViewQueryButton" );
      ((Element)v.get(107)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(107)).setAttribute("estado","false" );
      ((Element)v.get(107)).setAttribute("accion","pedSubtiPosicViewFirstPage();" );
      ...
      ((Element)v.get(108)).setAttribute("nombre","pedSubtiPosicViewTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(110)).setAttribute("nombre","pedSubtiPosicViewLovNullButton" );
      ((Element)v.get(110)).setAttribute("ID","botonContenido" );
      ((Element)v.get(110)).setAttribute("tipo","html" );
      ((Element)v.get(110)).setAttribute("accion","pedSubtiPosicViewLovNullSelectionAction();" );
