...
import es.indra.sicc.cmn.cargaInicial.presentacion.ConectorComposerView;import es.indra.druida.DruidaConector;

import es.indra.sicc.util.UtilidadesSession; 
 
public class LPConsultarCargosAbonos extends LPSICCBase 
{
	public LPConsultarCargosAbonos() {
		super();
	}
	...
	public void ejecucion() throws Exception {
		rastreo();
		setTrazaFichero();
		traza("*** Entrada - LPConsultarCargosAbonos - ejecucion ***");
		...
		traza("*** Salida - LPConsultarCargosAbonos - ejecucion ***");
	}
	
	private void accionVacia() throws Exception {
		traza("*** Entrada - LPConsultarCargosAbonos - accionVacia ***");
		
		asignarAtributo("VAR","casoUso","valor","consultar");
		asignarAtributo("VAR","accion","valor","consultar");
		asignarAtributo("PAGINA","contenido_cargos_abonos_directos_buscar","cod","0174");
		...
		getConfiguracionMenu("LPConsultarCargosAbonos","");
		
		traza("*** Salida - LPConsultarCargosAbonos - accionVacia ***");
	}
