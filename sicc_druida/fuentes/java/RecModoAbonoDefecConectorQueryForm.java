...
public class RecModoAbonoDefecConectorQueryForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad RecModoAbonoDefec" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGRecModoAbonoDefecQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGRecModoAbonoDefecQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","RecModoAbonoDefecFormFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","codModoAbon" );
