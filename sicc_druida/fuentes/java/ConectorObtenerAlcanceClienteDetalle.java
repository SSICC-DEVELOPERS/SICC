...
public class ConectorObtenerAlcanceClienteDetalle  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","ConectorObtenerAlcanceClienteDetalle" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","DTOCodigoClienteDto" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(5)).setAttribute("NOMBRE","DTODescuentoCliente" );
