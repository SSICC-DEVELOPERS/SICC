...
public class LPInsertaCurso extends LPUtilidadesEDU {
	...
	private void guardaCurso() throws Exception {
		...
		Date fecha = null;
                           ...
                           //xxxx pasa a hacerse llamando a un nuevo método
                   			//sdf.setTimeZone(TimeZone.getTimeZone("GMT-03:00")); //cccc sin esto a negocio le llegan fechas restando un día a la fecha
