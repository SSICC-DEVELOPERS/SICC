...
public class ConectorObtenerVersionesAsignacionActiva  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Obtener las versiones de asignacion producto anaquel activa para facturacion" );
