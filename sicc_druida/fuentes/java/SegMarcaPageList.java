...
public class SegMarcaPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","segMarcaList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","SegMarca.codMarc.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","SegMarca.desMarc.label" );
