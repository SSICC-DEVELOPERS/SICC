...
public class MaeTipoProblTipoSolucPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","MaeTipoProblTipoSoluc.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","MaeTipoProblTipoSoluc.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('maeTipoProblTipoSolucFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('maeTipoProblTipoSolucFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(50)).setAttribute("nombre","tipbOidTipoProbTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lbltipbOidTipoProb" );
      ((Element)v.get(54)).setAttribute("id","datosTitle" );
      ((Element)v.get(54)).setAttribute("ancho","150" );
      ((Element)v.get(54)).setAttribute("alto","13" );
      ((Element)v.get(54)).setAttribute("cod","MaeTipoProblTipoSoluc.tipbOidTipoProb.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(55)).setAttribute("nombre","tipbOidTipoProbWidgetTrId" );
      ...
      ((Element)v.get(57)).setAttribute("nombre","tipbOidTipoProb" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('maeTipoProblTipoSolucFrm',2, true);" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('maeTipoProblTipoSolucFrm',2, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(59)).setAttribute("nombre","tipbOidTipoProbGapTdId" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(76)).setAttribute("nombre","tsocOidTipoSoluTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(80)).setAttribute("nombre","lbltsocOidTipoSolu" );
      ((Element)v.get(80)).setAttribute("id","datosTitle" );
      ((Element)v.get(80)).setAttribute("ancho","150" );
      ((Element)v.get(80)).setAttribute("alto","13" );
      ((Element)v.get(80)).setAttribute("cod","MaeTipoProblTipoSoluc.tsocOidTipoSolu.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(81)).setAttribute("nombre","tsocOidTipoSoluWidgetTrId" );
   }
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(83)).setAttribute("nombre","tsocOidTipoSolu" );
      ...
      ((Element)v.get(83)).setAttribute("ontab","ejecutarAccionFoco('maeTipoProblTipoSolucFrm',3, true);" );
      ((Element)v.get(83)).setAttribute("onshtab","ejecutarAccionFoco('maeTipoProblTipoSolucFrm',3, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(85)).setAttribute("nombre","tsocOidTipoSoluGapTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(90)).setAttribute("nombre","formGapTr2" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(99)).setAttribute("nombre","maeTipoProblTipoSolucTrButtons" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(106)).setAttribute("nombre","maeTipoProblTipoSolucTdQueryButton" );
      ((Element)v.get(105)).appendChild((Element)v.get(106));

      /* Empieza nodo:107 / Elemento padre: 106   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(107)).setAttribute("nombre","maeTipoProblTipoSolucQueryButton" );
      ((Element)v.get(107)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(107)).setAttribute("estado","false" );
      ((Element)v.get(107)).setAttribute("accion","maeTipoProblTipoSolucFirstPage();" );
      ...
      ((Element)v.get(108)).setAttribute("nombre","maeTipoProblTipoSolucTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(110)).setAttribute("nombre","maeTipoProblTipoSolucLovNullButton" );
      ((Element)v.get(110)).setAttribute("ID","botonContenido" );
      ((Element)v.get(110)).setAttribute("tipo","html" );
      ((Element)v.get(110)).setAttribute("accion","maeTipoProblTipoSolucLovNullSelectionAction();" );
