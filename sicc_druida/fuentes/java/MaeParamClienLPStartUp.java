/*
    INDRA/CAR/mmg
    $Id: MaeParamClienLPStartUp.java,v 1.1 2009/12/03 18:41:46 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class MaeParamClienLPStartUp extends MMGDruidaBase{
	//Constantes que definen la altura de los formularios según el modo
	public static final short QUERYFORM_SIZE = 63;
	...
	protected static Hashtable codTipoAsigValues = new Hashtable();
	static{
		codTipoAsigValues.put(new java.lang.String("M"), "Manual");
		codTipoAsigValues.put(new java.lang.String("A"), "Automático");
	}
	
	
	// Definicion del constructor
	public MaeParamClienLPStartUp(){
		super();
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "MaeParamClienPage", "cod", "MaeParamClien." + accion + ".label");
			...
			limpiarBotoneraLista("maeParamClien", accion);
	...
	protected void cmdLov() throws Exception{
		...
		//asignarAtributo("CAPA", "maeParamClienLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "MaeParamClienPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		MaeParamClienData maeParamClienQuery= new MaeParamClienData();
		maeParamClienQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		MaeParamClienData datosResult = (MaeParamClienData)getSingleObject(BUSINESSID_QUERY, maeParamClienQuery, 
			maeParamClienQuery.clone(), "maeParamClien");
		...
		MaeParamClienData maeParamClien = datosResult;
		if(maeParamClien.getCodTipoAsig() != null){	
			checkCombo("codTipoAsig", FormatUtils.formatObject(maeParamClien.getCodTipoAsig(), 
		...
		//Deshabilitamos todos los campos para que no se editen
					...
					asignarAtributo("COMBO", "codTipoAsig", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		...
		asignarAtributo("COMBO", "codTipoAsig", "req", "S");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "maeParamClienFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		MaeParamClienData maeParamClienQuery= new MaeParamClienData();
		maeParamClienQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(maeParamClien.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"maeParamClienFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"maeParamClienFrm\",1, false)");
					asignarAtributo("COMBO","paisOidPais", "ontab", "ejecutarAccionFocoModificacion(\"maeParamClienFrm\",2, true)");
					asignarAtributo("COMBO","paisOidPais", "onshtab", "ejecutarAccionFocoModificacion(\"maeParamClienFrm\",2, false)");
				asignarAtributo("TEXT", "codTipoAsig", "ontab","ejecutarAccionFocoModificacion(\"maeParamClienFrm\",3, true)");
				asignarAtributo("TEXT", "codTipoAsig", "onshtab","ejecutarAccionFocoModificacion(\"maeParamClienFrm\",3, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","maeParamClienTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","maeParamClienTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codTipoAsig...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","maeParamClienFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","maeParamClienListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","maeParamClienListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(MaeParamClienData maeParamClien) throws Exception{
		...
		if(maeParamClien != null && maeParamClien.getPaisOidPais() != null){
				checkCombo("paisOidPais" , maeParamClien.getPaisOidPais().getId().toString());
			}
	...
	* @param maeParamClien La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(MaeParamClienData maeParamClien) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		MaeParamClienData maeParamClien = 
			(MaeParamClienData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(maeParamClien.getPaisOidPais() != null){
			maeParamClien.setPaisOidPais((es.indra.belcorp.mso.SegPaisViewData)
			getSingleObject(BUSINESSID_PAISOIDPAIS_QUERY, 
			maeParamClien.getPaisOidPais(),
			maeParamClien.getPaisOidPais().clone(),
			"segPaisView"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(maeParamClien);
		loadLeafDependenceCombos(maeParamClien);
	}
