...
public class FacImpreVirtuViewConectorQueryList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad FacImpreVirtuView" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGFacImpreVirtuViewQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGFacImpreVirtuViewQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","FacImpreVirtuViewListFormatter" );
