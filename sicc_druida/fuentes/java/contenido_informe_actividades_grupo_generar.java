...
public class contenido_informe_actividades_grupo_generar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_informe_actividades_grupo_generar" );
      ((Element)v.get(0)).setAttribute("cod","0769" );
      ((Element)v.get(0)).setAttribute("titulo","Generar informe actividades de hoy por grupo" );
      ...
      v.add(doc.createTextNode("\r   \r   \r   function onLoad(){\r      configurarMenuSecundario('Formulario');\r      fMostrarMensajeError();\r      set('Formulario.txtFecha', get('Formulario.fechaDefault'));\r      focaliza('Formulario.cbCanal');\r   }\r   function generar(){\r      \r      if(sicc_validaciones_generales()){\r         if(validarFecha()){\r        \r            /*recolectarParametros();\r      \r            set('Formulario.conectorAction', 'CRAActividadesHoyGrupo');           \r            set('Formulario.accion', 'generar');\r      \r            enviaSICC('Formulario');*/\r            var a = new Object();\r            a.accion = 'generar';\r            a.marca = get('Formulario.cbMarca');  \r            a.canal = get('Formulario.cbCanal');\r            a.periodo = quitarItemVacio(get('Formulario.cbPeriodo'));\r            a.fecha = get('Formulario.txtFecha');\r            a.actividades = quitarItemVacio(get('Formulario.cbActividad'));         \r            mostrarModalSICC('CRAActividadesHoyGrupo','generar', a);  \r         }\r        \r      }\r\r   }\r\r   function recolectarParametros(){\r      \r      \r     \r      set('Formulario.marca', get('Formulario.cbMarca') );  \r      set('Formulario.canal', get('Formulario.cbCanal'));\r      set('Formulario.periodo', quitarItemVacio(get('Formulario.cbPeriodo') ));\r      set('Formulario.fecha', get('Formulario.txtFecha'));\r      set('Formulario.actividades', quitarItemVacio(get('Formulario.cbActividad')));\r      \r          \r      \r  \r   }\r \r   \r\r   function quitarItemVacio(elemento){\r      var elementoADevolver = new Array();\r     \r      for(var k=0;k<elemento.length;k++) {\r         if (elemento[k] != ''){ 			 \r            elementoADevolver[elementoADevolver.length] = elemento[k];\r         }\r      }\r        \r      return elementoADevolver;\r      \r   }\r\r\r\r\r   function fLimpiar(){\r      var aCombo = new Array(new Array(\"\",\"\"));\r      set_combo('Formulario.cbPeriodo', aCombo, []);\r      set_combo('Formulario.cbActividad', aCombo, []);\r      focaliza('Formulario.cbCanal');\r \r   }\r   \r    function onchangeMarcaCanal(){\r        \r       marca  = get('Formulario.cbMarca');\r       canal  = get('Formulario.cbCanal');\r       pais   = get('Formulario.pais');\r       idioma = get('Formulario.idioma');\r       \r       \r       if(marca != '' && canal != ''){\r       \r          var arr = new Array();\r          var arr2 = new Array();\r              \r          arr[arr.length] = [\"oidIdioma\", idioma]; \r          arr[arr.length] = [\"oidPais\", pais]; \r          arr[arr.length] = [\"marca\", marca];\r          arr[arr.length] = [\"canal\", canal];\r          \r          arr2[arr2.length] = ['oidMarca', marca];\r          arr2[arr2.length] = ['oidCanal', canal];\r          arr2[arr2.length] = ['oidPais', pais];\r          arr2[arr2.length] = ['oidIdioma', idioma];\r           \r          recargaCombo(\"Formulario.cbPeriodo\",\"PRECargarPeriodos\",\"es.indra.sicc.dtos.cra.DTOPeriodo\",arr);\r          recargaCombo(\"Formulario.cbActividad\",\"CRAObtieneActividad\", \"es.indra.sicc.dtos.cra.DTOActividad\", arr2); \r         \r       }else{\r          var aCombo = new Array(new Array(\"\",\"\"));\r          set_combo('Formulario.cbPeriodo', aCombo, []);\r          set_combo('Formulario.cbActividad', aCombo, []);\r       }\r   \r    } \r    \r\r    function validarFecha(){\r       var fecha = get('Formulario.txtFecha');\r       var formatoFecha = get('Formulario.hFormatoFechaPais');\r           \r       if (! EsFechaValida_SICC(fecha , \"Formulario\")){\r          GestionarMensaje(\"1006\", formatoFecha, null, null);\r          focaliza(\"Formulario.txtFecha\");\r          return false;\r       }\r       return true;\r    }\r \r\r\r   \r"));
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(11)).setAttribute("name","cbActividad" );
      ((Element)v.get(11)).setAttribute("required","true" );
      ((Element)v.get(11)).setAttribute("cod","173" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(23)).setAttribute("nombre","fecha" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(24)).setAttribute("nombre","fechaDefault" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(25)).setAttribute("nombre","actividades" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(68)).setAttribute("onshtab","focalizaBotonHTML('botonContenido','btnGenerarInforme')" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(107)).setAttribute("nombre","cbActividad" );
   ...
   private void getXML450(Document doc) {
      ...
      /* Empieza nodo:116 / Elemento padre: 27   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(27)).appendChild((Element)v.get(116));
      ...
      ((Element)v.get(124)).setAttribute("nombre","btnGenerarInforme" );
      ((Element)v.get(124)).setAttribute("ID","botonContenido" );
      ((Element)v.get(124)).setAttribute("tipo","html" );
      ((Element)v.get(124)).setAttribute("accion","generar();" );
      ((Element)v.get(124)).setAttribute("estado","false" );
      ((Element)v.get(124)).setAttribute("cod","2495" );
      ((Element)v.get(124)).setAttribute("ontab","focaliza('Formulario.cbCanal')" );
      ...
      /* Empieza nodo:127 / Elemento padre: 27   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(27)).appendChild((Element)v.get(127));
