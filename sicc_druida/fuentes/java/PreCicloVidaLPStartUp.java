/*
    INDRA/CAR/mmg
    $Id: PreCicloVidaLPStartUp.java,v 1.1 2009/12/03 18:33:04 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class PreCicloVidaLPStartUp extends MMGDruidaBase{
	...
	public PreCicloVidaLPStartUp(){
		super();
	}

	public void inicio() throws Exception {
		pagina("PreCicloVidaPage");
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "PreCicloVidaPage", "cod", "PreCicloVida." + accion + ".label");
			...
			limpiarBotoneraLista("preCicloVida", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codCiclVida", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 2);");
		...
		//asignarAtributo("CAPA", "preCicloVidaLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "PreCicloVidaPage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("PreCicloVidaLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		PreCicloVidaData preCicloVidaQuery= new PreCicloVidaData();
		preCicloVidaQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		PreCicloVidaData datosResult = (PreCicloVidaData)getSingleObject(BUSINESSID_QUERY, preCicloVidaQuery, 
			preCicloVidaQuery.clone(), "preCicloVida");
		...
		preservaHiddensI18n(new Integer(1), "PRE_CICLO_VIDA", "preCicloVidaFrm", "Descripcion", true);
		...
		PreCicloVidaData preCicloVida = datosResult;
		asignar("TEXT", "codCiclVida", FormatUtils.formatObject(preCicloVida.getCodCiclVida(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "Descripcion", FormatUtils.formatObject(preCicloVida.getDescripcion(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		loadLocalizationVars(preCicloVida);
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "PRE_CICLO_VIDA", "preCicloVidaFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('preCicloVidaFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "preCicloVidaFrm", "oculto", "N");
		...
		traza("MMG::Creando PreCicloVida");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		PreCicloVidaData preCicloVidaQuery= new PreCicloVidaData();
		preCicloVidaQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(preCicloVida.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"preCicloVidaFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"preCicloVidaFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codCiclVida", "ontab","ejecutarAccionFocoModificacion(\"preCicloVidaFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codCiclVida", "onshtab","ejecutarAccionFocoModificacion(\"preCicloVidaFrm\",2, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"preCicloVidaFrm\",3, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"preCicloVidaFrm\",3, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","preCicloVidaTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","preCicloVidaTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","preCicloVidaFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","preCicloVidaListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","preCicloVidaListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(PreCicloVidaData preCicloVida) throws Exception{
	...
	* @param preCicloVida La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(PreCicloVidaData preCicloVida) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		PreCicloVidaData preCicloVida = 
			(PreCicloVidaData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(preCicloVida);
		loadLeafDependenceCombos(preCicloVida);
	}
	...
	*/
	...
	protected void loadLocalizationVars(PreCicloVidaData preCicloVida) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("PRE_CICLO_VIDA");
		mmgLocalizationQuery.setEntiPk(preCicloVida.getId());
