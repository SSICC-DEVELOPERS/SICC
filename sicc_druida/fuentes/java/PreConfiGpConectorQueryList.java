...
public class PreConfiGpConectorQueryList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad PreConfiGp" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGPreConfiGpQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGPreConfiGpQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","PreConfiGpListFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(9)).setAttribute("NOMBRE","valIncr" );
