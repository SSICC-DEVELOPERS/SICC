...
public class contenido_clientes_direccion_presentar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_clientes_direccion_presentar" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(6)).setAttribute("src","contenido_clientes_direccion_presentar.js" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(35)).setAttribute("cod","00430" );
   ...
   private void getXML180(Document doc) {
      ((Element)v.get(39)).setAttribute("ancho","80" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(45)).setAttribute("ancho","80" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(47)).setAttribute("ancho","60" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(48)).setAttribute("ancho","60" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(49)).setAttribute("ancho","80" );
      ...
      ((Element)v.get(52)).setAttribute("alto","40" );
      ...
      ((Element)v.get(53)).setAttribute("cod","159" );
      ...
      ((Element)v.get(54)).setAttribute("cod","215" );
      ...
      ((Element)v.get(55)).setAttribute("cod","227" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(56)).setAttribute("cod","2023" );
      ...
      ((Element)v.get(57)).setAttribute("cod","216" );
      ...
      ((Element)v.get(58)).setAttribute("cod","939" );
      ...
      ((Element)v.get(59)).setAttribute("cod","1344" );
      ...
      ((Element)v.get(60)).setAttribute("cod","1345" );
      ...
      ((Element)v.get(61)).setAttribute("cod","1346" );
      ...
      ((Element)v.get(62)).setAttribute("cod","1347" );
      ...
      ((Element)v.get(63)).setAttribute("cod","1348" );
      ...
      ((Element)v.get(65)).setAttribute("cod","2024" );
      ...
      ((Element)v.get(66)).setAttribute("cod","905" );
   ...
   private void getXML360(Document doc) {
      ...
      /* Empieza nodo:82 / Elemento padre: 27   */
      v.add(doc.createElement("ROWSET"));
      ((Element)v.get(27)).appendChild((Element)v.get(82));
      /* Termina nodo:82   */

      /* Empieza nodo:83 / Elemento padre: 27   */
      v.add(doc.createElement("PAGINADO"));
      ((Element)v.get(83)).setAttribute("nombre","mipgndo" );
      ((Element)v.get(83)).setAttribute("ancho","400" );
      ...
      ((Element)v.get(83)).setAttribute("onload","procesarPaginado(mipgndo, msgError, ultima, rowset, 'muestraLista(ultima, rowset)')" );
      ...
      ((Element)v.get(84)).setAttribute("ontab","document.all['ava1I'].parentElement.focus();" );
      ((Element)v.get(84)).setAttribute("onshtab","document.all['primera1I'].parentElement.focus();" );
      ...
      ((Element)v.get(85)).setAttribute("y","310" );
      ...
      ((Element)v.get(85)).setAttribute("ontab","document.all['primera1I'].parentElement.focus();" );
      ((Element)v.get(85)).setAttribute("onshtab","document.all['ret1I'].parentElement.focus();" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(86)).setAttribute("ontab","document.all['ret1I'].parentElement.focus();" );
      ((Element)v.get(86)).setAttribute("onshtab","document.all['ava1I'].parentElement.focus();" );
      ...
      ((Element)v.get(87)).setAttribute("y","306" );
      ...
      ((Element)v.get(88)).setAttribute("y","329" );
