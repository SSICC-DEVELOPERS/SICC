...
public class FacFormuViewPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","FacFormuView.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","FacFormuView.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('facFormuViewFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('facFormuViewFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(54)).setAttribute("cod","FacFormuView.codForm.label" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('facFormuViewFrm',2, true)" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('facFormuViewFrm', 2, false)" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(60)).setAttribute("nombre","deimOidDestImprTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(64)).setAttribute("nombre","lbldeimOidDestImpr" );
      ((Element)v.get(64)).setAttribute("id","datosTitle" );
      ((Element)v.get(64)).setAttribute("ancho","150" );
      ((Element)v.get(64)).setAttribute("alto","13" );
      ((Element)v.get(64)).setAttribute("cod","FacFormuView.deimOidDestImpr.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(65)).setAttribute("nombre","deimOidDestImprWidgetTrId" );
      ...
      ((Element)v.get(67)).setAttribute("nombre","deimOidDestImpr" );
      ...
      ((Element)v.get(67)).setAttribute("ontab","ejecutarAccionFoco('facFormuViewFrm',15, true);" );
      ((Element)v.get(67)).setAttribute("onshtab","ejecutarAccionFoco('facFormuViewFrm',15, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(69)).setAttribute("nombre","deimOidDestImprGapTdId" );
   ...
   private void getXML360(Document doc) {
      ...
      /* Empieza nodo:83 / Elemento padre: 0   */
      v.add(doc.createElement("TR"));
      ((Element)v.get(83)).setAttribute("nombre","facFormuViewTrButtons" );
      ((Element)v.get(0)).appendChild((Element)v.get(83));
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(90)).setAttribute("class","tablaTitle" );
      ((Element)v.get(90)).setAttribute("nombre","facFormuViewTdQueryButton" );
      ((Element)v.get(89)).appendChild((Element)v.get(90));

      /* Empieza nodo:91 / Elemento padre: 90   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(91)).setAttribute("nombre","facFormuViewQueryButton" );
      ((Element)v.get(91)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(91)).setAttribute("estado","false" );
      ((Element)v.get(91)).setAttribute("accion","facFormuViewFirstPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(92)).setAttribute("class","tablaTitle" );
      ((Element)v.get(92)).setAttribute("nombre","facFormuViewTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(94)).setAttribute("nombre","facFormuViewLovNullButton" );
      ((Element)v.get(94)).setAttribute("ID","botonContenido" );
      ((Element)v.get(94)).setAttribute("tipo","html" );
      ((Element)v.get(94)).setAttribute("accion","facFormuViewLovNullSelectionAction();" );
      ((Element)v.get(94)).setAttribute("estado","true" );
      ((Element)v.get(94)).setAttribute("cod","MMGGlobal.lovNullButton.label" );
