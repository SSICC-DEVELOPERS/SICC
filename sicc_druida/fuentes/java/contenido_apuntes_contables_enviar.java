...
public class contenido_apuntes_contables_enviar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_apuntes_contables_enviar" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","contenido_apuntes_contables_enviar.js" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(18)).setAttribute("nombre","hFormatoFechaPais" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(61)).setAttribute("nombre","lblvalorLote" );
      ...
      ((Element)v.get(65)).setAttribute("onshtab","onShTab()" );
   ...
   private void getXML270(Document doc) {
      ((Element)v.get(69)).setAttribute("nombre","FechaHasta" );
      ...
      ((Element)v.get(89)).setAttribute("msjreq","" );
      ((Element)v.get(89)).setAttribute("nombre","areatxtObservaciones" );
      ...
      ((Element)v.get(89)).setAttribute("max","256" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(105)).setAttribute("nombre","btnEnviar" );
      ((Element)v.get(105)).setAttribute("ID","botonContenido" );
      ((Element)v.get(105)).setAttribute("tipo","html" );
      ((Element)v.get(105)).setAttribute("accion","enviarOnClick()" );
      ((Element)v.get(105)).setAttribute("ontab","onTab()" );
      ((Element)v.get(105)).setAttribute("cod","1597" );
