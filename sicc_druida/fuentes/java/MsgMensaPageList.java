...
public class MsgMensaPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","msgMensaList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(17)).setAttribute("cod","MsgMensa.codMens.label" );
      ...
      ((Element)v.get(18)).setAttribute("cod","MsgMensa.desMens.label" );
      ...
      ((Element)v.get(19)).setAttribute("cod","MsgMensa.valBloqGrupPerm.label" );
      ...
      ((Element)v.get(20)).setAttribute("cod","MsgMensa.fecPermDesd.label" );
      ...
      ((Element)v.get(21)).setAttribute("cod","MsgMensa.fecPermHast.label" );
      ...
      ((Element)v.get(22)).setAttribute("cod","MsgMensa.valText.label" );
