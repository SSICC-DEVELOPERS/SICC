/*
    INDRA/CAR/mmg
    $Id: CobSubtiAccioLPStartUp.java,v 1.1 2009/12/03 18:33:14 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class CobSubtiAccioLPStartUp extends MMGDruidaBase{
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "CobSubtiAccioPage", "cod", "CobSubtiAccio." + accion + ".label");
			...
			limpiarBotoneraLista("cobSubtiAccio", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codSubtAcci", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 1);");
		
		//Primero determianmos el nombre del campo en la entidad de oriegen donde se van a cargar los datos
		asignar("VAR", "idAttributeLovOpener", conectorParametro(PARAMETRO_LOV_ATTRIBUTO));
		asignar("VAR", "idEntityLovOpener", conectorParametro(PARAMETRO_LOV_ENTIDAD));
		//asignarAtributo("CAPA", "cobSubtiAccioLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "CobSubtiAccioPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		CobSubtiAccioData cobSubtiAccioQuery= new CobSubtiAccioData();
		cobSubtiAccioQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		CobSubtiAccioData datosResult = (CobSubtiAccioData)getSingleObject(BUSINESSID_QUERY, cobSubtiAccioQuery, 
			cobSubtiAccioQuery.clone(), "cobSubtiAccio");
		...
		CobSubtiAccioData cobSubtiAccio = datosResult;
		asignar("TEXT", "codSubtAcci", FormatUtils.formatObject(cobSubtiAccio.getCodSubtAcci(), 
		...
		asignarAtributo("TEXT", "codSubtAcci", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		...
		asignarAtributo("TEXT", "codSubtAcci", "req", "S");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "cobSubtiAccioFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		CobSubtiAccioData cobSubtiAccioQuery= new CobSubtiAccioData();
		cobSubtiAccioQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(cobSubtiAccio.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"cobSubtiAccioFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"cobSubtiAccioFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codSubtAcci", "ontab","ejecutarAccionFocoModificacion(\"cobSubtiAccioFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codSubtAcci", "onshtab","ejecutarAccionFocoModificacion(\"cobSubtiAccioFrm\",2, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","cobSubtiAccioTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","cobSubtiAccioTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codSubtAcci...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","cobSubtiAccioFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","cobSubtiAccioListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","cobSubtiAccioListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(CobSubtiAccioData cobSubtiAccio) throws Exception{
	...
	* @param cobSubtiAccio La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(CobSubtiAccioData cobSubtiAccio) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		CobSubtiAccioData cobSubtiAccio = 
			(CobSubtiAccioData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(cobSubtiAccio);
		loadLeafDependenceCombos(cobSubtiAccio);
	}
