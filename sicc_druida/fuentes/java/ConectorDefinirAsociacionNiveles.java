...
public class ConectorDefinirAsociacionNiveles  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Definir Niveles Socioeconomicos" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","AsociacionNivelesDTO" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","DefinirAsociacionNiveles" );
