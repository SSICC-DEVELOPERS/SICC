...
public class CalAtribEstadContaPage  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","CalAtribEstadContaPage" );
      ((Element)v.get(0)).setAttribute("titulo","" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","" );
      ((Element)v.get(0)).setAttribute("onload","calAtribEstadContaInitComponents()" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","calatribestadconta.js" );
      ((Element)v.get(0)).appendChild((Element)v.get(4));
      /* Termina nodo:4   */

      /* Empieza nodo:5 / Elemento padre: 0   */
      v.add(doc.createElement("FORMULARIO"));
      ((Element)v.get(5)).setAttribute("nombre","calAtribEstadContaFrm" );
      ...
      ((Element)v.get(6)).setAttribute("valor","CalAtribEstadContaLPExecution" );
      ...
      ((Element)v.get(7)).setAttribute("valor","CalAtribEstadContaLPExecution" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(37)).setAttribute("nombre","calAtribEstadContaFormLayer" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(52)).setAttribute("cod","CalAtribEstadConta.legend.label" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(67)).setAttribute("cod","CalAtribEstadConta.id.label" );
      ...
      ((Element)v.get(70)).setAttribute("ontab","ejecutarAccionFoco('calAtribEstadContaFrm',1, true)" );
      ((Element)v.get(70)).setAttribute("onshtab","ejecutarAccionFoco('calAtribEstadContaFrm', 1, false)" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(88)).setAttribute("nombre","tecoOidTipoEstaContTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(92)).setAttribute("nombre","lbltecoOidTipoEstaCont" );
      ((Element)v.get(92)).setAttribute("id","datosTitle" );
      ((Element)v.get(92)).setAttribute("ancho","150" );
      ((Element)v.get(92)).setAttribute("alto","13" );
      ((Element)v.get(92)).setAttribute("cod","CalAtribEstadConta.tecoOidTipoEstaCont.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(93)).setAttribute("nombre","tecoOidTipoEstaContWidgetTrId" );
      ...
      ((Element)v.get(95)).setAttribute("nombre","tecoOidTipoEstaCont" );
      ...
      ((Element)v.get(95)).setAttribute("ontab","ejecutarAccionFoco('calAtribEstadContaFrm',2, true);" );
      ((Element)v.get(95)).setAttribute("onshtab","ejecutarAccionFoco('calAtribEstadContaFrm',2, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(97)).setAttribute("nombre","tecoOidTipoEstaContGapTdId" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(99)).setAttribute("nombre","codAtriTdId" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(104)).setAttribute("nombre","codAtriWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(106)).setAttribute("nombre","codAtri" );
      ...
      ((Element)v.get(106)).setAttribute("ontab","ejecutarAccionFoco('calAtribEstadContaFrm',3, true)" );
      ((Element)v.get(106)).setAttribute("onshtab","ejecutarAccionFoco('calAtribEstadContaFrm', 3, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(107)).setAttribute("nombre","codAtriGapTdId" );
      ...
      ((Element)v.get(113)).setAttribute("cod","CalAtribEstadConta.Descripcion.label" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(117)).setAttribute("ontab","ejecutarAccionFoco('calAtribEstadContaFrm',4, true)" );
      ((Element)v.get(117)).setAttribute("onshtab","ejecutarAccionFoco('calAtribEstadContaFrm', 4, false)" );
      ...
      ((Element)v.get(121)).setAttribute("href","javascript:openLocalizationDialog('calAtribEstadContaFrm', 'Descripcion', 1);" );
      ((Element)v.get(121)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"calAtribEstadContaFrm\",4, true)', 'ejecutarAccionFoco(\"calAtribEstadContaFrm\",4, false)')" );
   ...
   private void getXML630(Document doc) {
      ((Element)v.get(137)).setAttribute("nombre","calAtribEstadContaTrButtons" );
      ...
      ((Element)v.get(144)).setAttribute("nombre","calAtribEstadContaTdQueryButton" );
      ((Element)v.get(143)).appendChild((Element)v.get(144));

      /* Empieza nodo:145 / Elemento padre: 144   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(145)).setAttribute("nombre","calAtribEstadContaQueryButton" );
      ((Element)v.get(145)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(145)).setAttribute("estado","false" );
      ((Element)v.get(145)).setAttribute("accion","calAtribEstadContaFirstPage();" );
      ...
      ((Element)v.get(146)).setAttribute("nombre","calAtribEstadContaTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(148)).setAttribute("nombre","calAtribEstadContaLovNullButton" );
      ((Element)v.get(148)).setAttribute("ID","botonContenido" );
      ((Element)v.get(148)).setAttribute("tipo","html" );
      ((Element)v.get(148)).setAttribute("accion","calAtribEstadContaLovNullSelectionAction();" );
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(151)).setAttribute("nombre","calAtribEstadContaListLayer" );
      ...
      ((Element)v.get(152)).setAttribute("nombre","calAtribEstadContaList" );
   ...
   private void getXML720(Document doc) {
      ...
      ((Element)v.get(166)).setAttribute("cod","CalAtribEstadConta.tecoOidTipoEstaCont.label" );
      ...
      ((Element)v.get(167)).setAttribute("cod","CalAtribEstadConta.codAtri.label" );
      ...
      ((Element)v.get(168)).setAttribute("cod","CalAtribEstadConta.Descripcion.label" );
   ...
   private void getXML810(Document doc) {
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(174)).setAttribute("nombre","calAtribEstadContaListButtonsLayer" );
      ...
      ((Element)v.get(180)).setAttribute("nombre","calAtribEstadContaPaginationButtonBar" );
      ...
      ((Element)v.get(181)).setAttribute("nombre","calAtribEstadContaFirstPageButton" );
      ((Element)v.get(181)).setAttribute("funcion","calAtribEstadContaFirstPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(182)).setAttribute("nombre","calAtribEstadContaFirstPageButtonGapTd" );
   ...
   private void getXML900(Document doc) {
      v.add(doc.createElement("BTN"));
      ((Element)v.get(184)).setAttribute("nombre","calAtribEstadContaPreviousPageButton" );
      ((Element)v.get(184)).setAttribute("funcion","calAtribEstadContaPreviousPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(185)).setAttribute("nombre","calAtribEstadContaPreviousPageButtonGapTd" );
      ...
      v.add(doc.createElement("BTN"));
      ((Element)v.get(187)).setAttribute("nombre","calAtribEstadContaNextPageButton" );
      ((Element)v.get(187)).setAttribute("funcion","calAtribEstadContaNextPage();" );
      ...
      ((Element)v.get(190)).setAttribute("nombre","calAtribEstadContaUpdateButtonTd" );
      ((Element)v.get(176)).appendChild((Element)v.get(190));

      /* Empieza nodo:191 / Elemento padre: 190   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(191)).setAttribute("nombre","calAtribEstadContaUpdateButton" );
      ((Element)v.get(191)).setAttribute("ID","botonContenido" );
      ((Element)v.get(191)).setAttribute("tipo","html" );
      ((Element)v.get(191)).setAttribute("accion","calAtribEstadContaUpdateSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(192)).setAttribute("nombre","calAtribEstadContaUpdateButtonGapTd" );
      ...
      ((Element)v.get(194)).setAttribute("nombre","calAtribEstadContaViewForRemoveButtonTd" );
      ((Element)v.get(176)).appendChild((Element)v.get(194));

      /* Empieza nodo:195 / Elemento padre: 194   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(195)).setAttribute("nombre","calAtribEstadContaViewForRemoveButton" );
      ((Element)v.get(195)).setAttribute("ID","botonContenido" );
      ((Element)v.get(195)).setAttribute("tipo","html" );
      ((Element)v.get(195)).setAttribute("accion","calAtribEstadContaViewSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(196)).setAttribute("nombre","calAtribEstadContaViewForRemoveButtonGapTd" );
      ...
      ((Element)v.get(198)).setAttribute("nombre","calAtribEstadContaLovSelectButtonTd" );
      ((Element)v.get(176)).appendChild((Element)v.get(198));

      /* Empieza nodo:199 / Elemento padre: 198   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(199)).setAttribute("nombre","calAtribEstadContaLovSelectButton" );
      ((Element)v.get(199)).setAttribute("ID","botonContenido" );
      ((Element)v.get(199)).setAttribute("tipo","html" );
      ((Element)v.get(199)).setAttribute("accion","calAtribEstadContaLovSelectionAction();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(200)).setAttribute("nombre","calAtribEstadContaLovSelectButtonGapTd" );
   ...
   private void getXML990(Document doc) {
      ...
      ((Element)v.get(202)).setAttribute("nombre","calAtribEstadContaViewButtonTd" );
      ((Element)v.get(176)).appendChild((Element)v.get(202));

      /* Empieza nodo:203 / Elemento padre: 202   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(203)).setAttribute("nombre","calAtribEstadContaViewButton" );
      ((Element)v.get(203)).setAttribute("ID","botonContenido" );
      ((Element)v.get(203)).setAttribute("tipo","html" );
      ((Element)v.get(203)).setAttribute("accion","calAtribEstadContaViewSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(204)).setAttribute("nombre","calAtribEstadContaViewButtonGapTd" );
