...
public class MaeEncueAplicClienPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","maeEncueAplicClienList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","MaeEncueAplicClien.clieOidClie.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","MaeEncueAplicClien.reenOidResp.label" );
