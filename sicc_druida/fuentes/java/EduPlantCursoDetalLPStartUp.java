/*
    INDRA/CAR/mmg
    $Id: EduPlantCursoDetalLPStartUp.java,v 1.1 2009/12/03 18:37:56 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class EduPlantCursoDetalLPStartUp extends MMGDruidaBase{
	...
	public static final String BUSINESSID_CPLCOIDCABE_QUERY ="MMGEduPlantCursoCabecQueryFromToUser";public static final String CPLCOIDCABE_COMBO_CONNECTOR = "EduPlantCursoCabecConectorCombo";
	...
	public EduPlantCursoDetalLPStartUp(){
		super();
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			buildJsPageSize("EduPlantCursoDetal");
			...
			asignarAtributo("PAGINA", "EduPlantCursoDetalPage", "cod", "EduPlantCursoDetal." + accion + ".label");
			...
			limpiarBotoneraLista("eduPlantCursoDetal", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "valDeta", "validacion", "ValidaLongitud(cdos_trim(valor), 0, 50)");
		asignarAtributo("TEXT", "indVisi", "validacion", "ValidaInt(cdos_trim(valor), 1, 0, 9)");
		...
		//asignarAtributo("CAPA", "eduPlantCursoDetalLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "EduPlantCursoDetalPage", "onblur", "window.focus();");
	...
	protected void cmdView() throws Exception{
		...
		EduPlantCursoDetalData eduPlantCursoDetalQuery= new EduPlantCursoDetalData();
		eduPlantCursoDetalQuery.setId(new Integer(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		EduPlantCursoDetalData datosResult = (EduPlantCursoDetalData)getSingleObject(BUSINESSID_QUERY, eduPlantCursoDetalQuery, 
			eduPlantCursoDetalQuery.clone(), "eduPlantCursoDetal");
		...
		EduPlantCursoDetalData eduPlantCursoDetal = datosResult;
	
		asignarAtributo("LABELC", "lblViewValDeta", "valor", 
				FormatUtils.formatObject(eduPlantCursoDetal.getValDeta(), 
				 MMGDruidaHelper.getUserDecimalFormatPattern(this), MMGDruidaHelper.getUserDecimalFormatSymbols(this)));			
	
		asignarAtributo("LABELC", "lblViewIndVisi", "valor", 
				FormatUtils.formatObject(eduPlantCursoDetal.getIndVisi(), 
				 MMGDruidaHelper.getUserDecimalFormatPattern(this), MMGDruidaHelper.getUserDecimalFormatSymbols(this)));			
	
		asignarAtributo("LABELC", "lblViewIndModi", "valor", 
				FormatUtils.formatObject(eduPlantCursoDetal.getIndModi(), 
				 MMGDruidaHelper.getUserDecimalFormatPattern(this), MMGDruidaHelper.getUserDecimalFormatSymbols(this)));			
	
		asignarAtributo("LABELC", "lblViewIndObli", "valor", 
				FormatUtils.formatObject(eduPlantCursoDetal.getIndObli(), 
				 MMGDruidaHelper.getUserDecimalFormatPattern(this), MMGDruidaHelper.getUserDecimalFormatSymbols(this)));			
	...
	protected void cmdCreate() throws Exception{
		...
		asignarAtributo("COMBO", "cplcOidCabe", "req", "S");
		asignarAtributo("TEXT", "indVisi", "req", "S");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "eduPlantCursoDetalFrm", "oculto", "N");
		...
		EduPlantCursoDetalData eduPlantCursoDetalQuery= new EduPlantCursoDetalData();
		eduPlantCursoDetalQuery.setId(new Integer(id));
		...
		es.indra.belcorp.mso.EduPlantCursoCabecData cplcOidCabe = eduPlantCursoDetal.getCplcOidCabe();
		if(cplcOidCabe != null && cplcOidCabe.getId() != null) checkCombo("cplcOidCabe" , cplcOidCabe.getId().toString());
	
		asignar("TEXT", "valDeta", FormatUtils.formatObject(eduPlantCursoDetal.getValDeta(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), MMGDruidaHelper.getUserDecimalFormatSymbols(this)));
	
		asignar("TEXT", "indVisi", FormatUtils.formatObject(eduPlantCursoDetal.getIndVisi(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), MMGDruidaHelper.getUserDecimalFormatSymbols(this)));
	
		asignar("TEXT", "indModi", FormatUtils.formatObject(eduPlantCursoDetal.getIndModi(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), MMGDruidaHelper.getUserDecimalFormatSymbols(this)));
	
		asignar("TEXT", "indObli", FormatUtils.formatObject(eduPlantCursoDetal.getIndObli(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), MMGDruidaHelper.getUserDecimalFormatSymbols(this)));
		...
		//asignar("VAR","timestamp",Long.toString(eduPlantCursoDetal.jdoGetTimeStamp()));
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","eduPlantCursoDetalTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","eduPlantCursoDetalTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","eduPlantCursoDetalFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","eduPlantCursoDetalPreListLayer", "y", String.valueOf(sizeForm + 24));
		asignarAtributo("CAPA","eduPlantCursoDetalListLayer", "y", String.valueOf(sizeForm + 46));		
		asignarAtributo("CAPA","eduPlantCursoDetalListButtonsLayer", "y", String.valueOf(sizeForm + 299));		
	}
	...
	*/
	protected void loadLeafDependenceCombos() throws Exception{
		asignarComboResultados(BUSINESSID_CPLCOIDCABE_QUERY,CPLCOIDCABE_COMBO_CONNECTOR, new EduPlantCursoCabecData(), new EduPlantCursoCabecData(), "eduPlantCursoCabec", "cplcOidCabe", "result_ROWSET" );
	...
	* @param eduPlantCursoDetal La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(EduPlantCursoDetalData eduPlantCursoDetal) 
		throws Exception{
		if(eduPlantCursoDetal.getCplcOidCabe() != null){
			checkCombo("cplcOidCabe" , eduPlantCursoDetal.getCplcOidCabe().getId().toString());
			}
	...
	*/
	protected void setDependenceComboLabels(EduPlantCursoDetalData eduPlantCursoDetal) 
		throws Exception{
		asignarAtributo("LABELC", "lblViewCplcOidCabe", "valor",FormatUtils.formatObject(eduPlantCursoDetal.getCplcOidCabe()));
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		EduPlantCursoDetalData eduPlantCursoDetal = 
			(EduPlantCursoDetalData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(eduPlantCursoDetal.getCplcOidCabe() != null){
			eduPlantCursoDetal.setCplcOidCabe((es.indra.belcorp.mso.EduPlantCursoCabecData)
			getSingleObject(BUSINESSID_CPLCOIDCABE_QUERY, 
			eduPlantCursoDetal.getCplcOidCabe(),
			eduPlantCursoDetal.getCplcOidCabe().clone(),
			"eduPlantCursoCabec"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(eduPlantCursoDetal);
	}
	...
	*/
	protected void removeViewLabels() throws Exception{
		...
		borrarNodo("TR", "nombre", "cplcOidCabeViewLabelTrId");
		borrarNodo("TR", "nombre", "valDetaViewLabelTrId");
		borrarNodo("TR", "nombre", "indVisiViewLabelTrId");
		borrarNodo("TR", "nombre", "indModiViewLabelTrId");
		borrarNodo("TR", "nombre", "indObliViewLabelTrId");
	...
	*/
	protected void removeWidgets() throws Exception{
		...
		borrarNodo("TR", "nombre", "cplcOidCabeWidgetTrId");
		borrarNodo("TR", "nombre", "valDetaWidgetTrId");
		borrarNodo("TR", "nombre", "indVisiWidgetTrId");
		borrarNodo("TR", "nombre", "indModiWidgetTrId");
		borrarNodo("TR", "nombre", "indObliWidgetTrId");
