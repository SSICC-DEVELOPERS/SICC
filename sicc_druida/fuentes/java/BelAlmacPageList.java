...
public class BelAlmacPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","belAlmacList" );
      ...
      ((Element)v.get(14)).setAttribute("cod","BelAlmac.codAlma.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","BelAlmac.Descripcion.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","BelAlmac.indInfoSap.label" );
