/*
    INDRA/CAR/mmg
    $Id: MaeTipoComunLPStartUp.java,v 1.1 2009/12/03 18:36:33 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class MaeTipoComunLPStartUp extends MMGDruidaBase{
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "MaeTipoComunPage", "cod", "MaeTipoComun." + accion + ".label");
			...
			limpiarBotoneraLista("maeTipoComun", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codTipoComu", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 2);");
		...
		//asignarAtributo("CAPA", "maeTipoComunLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "MaeTipoComunPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		MaeTipoComunData maeTipoComunQuery= new MaeTipoComunData();
		maeTipoComunQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		MaeTipoComunData datosResult = (MaeTipoComunData)getSingleObject(BUSINESSID_QUERY, maeTipoComunQuery, 
			maeTipoComunQuery.clone(), "maeTipoComun");
		...
		preservaHiddensI18n(new Integer(1), "MAE_TIPO_COMUN", "maeTipoComunFrm", "Descripcion", true);
		...
		MaeTipoComunData maeTipoComun = datosResult;
		asignar("TEXT", "codTipoComu", FormatUtils.formatObject(maeTipoComun.getCodTipoComu(), 
		...
		loadLocalizationVars(maeTipoComun);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "codTipoComu", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "MAE_TIPO_COMUN", "maeTipoComunFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "codTipoComu", "req", "S");
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('maeTipoComunFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "maeTipoComunFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		MaeTipoComunData maeTipoComunQuery= new MaeTipoComunData();
		maeTipoComunQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(maeTipoComun.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"maeTipoComunFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"maeTipoComunFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codTipoComu", "ontab","ejecutarAccionFocoModificacion(\"maeTipoComunFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codTipoComu", "onshtab","ejecutarAccionFocoModificacion(\"maeTipoComunFrm\",2, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"maeTipoComunFrm\",3, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"maeTipoComunFrm\",3, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","maeTipoComunTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","maeTipoComunTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","maeTipoComunFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","maeTipoComunListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","maeTipoComunListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(MaeTipoComunData maeTipoComun) throws Exception{
	...
	* @param maeTipoComun La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(MaeTipoComunData maeTipoComun) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		MaeTipoComunData maeTipoComun = 
			(MaeTipoComunData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(maeTipoComun);
		loadLeafDependenceCombos(maeTipoComun);
	}
	...
	*/
	...
	protected void loadLocalizationVars(MaeTipoComunData maeTipoComun) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("MAE_TIPO_COMUN");
		mmgLocalizationQuery.setEntiPk(maeTipoComun.getId());
