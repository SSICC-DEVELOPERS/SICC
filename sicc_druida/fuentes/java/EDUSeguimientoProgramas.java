...
public class EDUSeguimientoProgramas extends LPSICCBase {           
   public EDUSeguimientoProgramas() {	 
     super();
  }
     ...
     try {
        ...
        if (accion.equals("generar")){
          ...
          //cargarPagina();
           ...
           cargarPagina();
           getConfiguracionMenu("EDUSeguimientoProgramas");
        }
  ...
  private void cargarPagina() throws Exception{
     pagina("contenido_informe_seguimiento_programas_generar");   
 ...
 private void generarReporte() throws Exception{
     ...
     String codigoCurso        = conectorParametroLimpia("codigoCurso", "", true);
       traza("codigo curso " + codigoCurso);
     ...
     datos.put(ConstantesREP.TITULO, "Seguimiento de los Programas de Educacion");     
     traza("++++++Antes de enviar a reportes " + datos); 
     //ejecutarReporte(datos, "REPGenerarReporte", "RD_REP-011", null);
     ejecutarReporte2(datos, "REPGenerarReporteBatch", "RD_REP-011", "pdf");
