...
public class CalTipoGestiClienPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","calTipoGestiClienList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","CalTipoGestiClien.codGest.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","CalTipoGestiClien.Descripcion.label" );
