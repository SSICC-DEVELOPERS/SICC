...
public class contenido_usuarios_cronograma_cobranzas_detalle_asignar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_usuarios_cronograma_cobranzas_detalle_asignar" );
      ...
      v.add(doc.createTextNode("\r   \r   \r   function onLoad(){\r      configurarMenuSecundario('Formulario');\r      fMostrarMensajeError();\r             \r      if((get('Formulario.casoDeUso') == 'detalleUsuario') || (get('Formulario.casoDeUso') == 'modificarUsuario')){\r          setearCampos();\r          deshabilitarCampos();\r      }else{\r          focaliza('Formulario.cbUsuario');\r      }\r      \r   }\r\r   function setearCampos(){\r   \r       cargaUsuarioCodEtapa();\r       cargarUniAdm();\r       \r              iSeleccionado = new Array(); \r       iSeleccionado[0] = get('Formulario.tipoCargo');\r       set('Formulario.cbTipoCargo',iSeleccionado);\r       \r              iSeleccionado = new Array(); \r       iSeleccionado[0] = get('Formulario.metodoLiqui');\r       set('Formulario.cbMetodoLiquidacionDefecto',iSeleccionado);\r       \r              iSeleccionado = new Array(); \r       iSeleccionado[0] = get('Formulario.guionArgCabec');\r       set('Formulario.cbGuiaArgumentalDefecto',iSeleccionado);\r       \r              set('Formulario.txtObservaciones', get('Formulario.observaciones'));\r        \r   \r   }\r\r\r   function cargaUsuarioCodEtapa(){\r      var usuario = get('Formulario.usuario');\r      \r      iSeleccionado = new Array(); \r      iSeleccionado[0] = usuario;\r      set('Formulario.cbUsuario', iSeleccionado);\r      \r      asignar([['COMBO','Formulario.cbCodigoEtapaDeuda',\r                             'ConectorDruidaTransactionQuery',\r                             'dtoSalida.resultado_ROWSET',\r                             formarCadenaDT('COBRecargaEtapaDeuda', \r                                'es.indra.sicc.util.DTOOID', \r                                [['oid', usuario]]), \r                                'recargarEtapaDeuda(datos);']]);\r          \r   \r   }\r   function recargarEtapaDeuda(datos){\r   \r      var  arr = new Array();\r      var etapaDeuda = get('Formulario.etapaDeuda');\r\r      arr[arr.length] = new Array([''],['']);\r      for (var i=0 ;i< datos.length ; i++)  {\r          arr[arr.length] = datos[i];\r      }\r\r      set_combo('Formulario.cbCodigoEtapaDeuda',arr);\r         \r      var iSeleccionado = new Array(); \r      iSeleccionado[0] = etapaDeuda;\r      set('Formulario.cbCodigoEtapaDeuda',iSeleccionado); \r    \r   }\r\r   function cargarUniAdm(){\r      var marca =      get('Formulario.marca');\r      var canal =      get('Formulario.canal');\r\r      iSeleccionado = new Array(); \r      iSeleccionado[0] = marca;\r      set('Formulario.cbMarca',iSeleccionado);\r\r      iSeleccionado = new Array(); \r      iSeleccionado[0] = canal;\r      set('Formulario.cbCanal', iSeleccionado);\r                    \r      asignar([['COMBO','Formulario.cbSubgerenciaVentas',\r                             'ConectorDruidaTransactionQuery',\r                             'dtoSalida.resultado_ROWSET',\r                             formarCadenaDT('ZONRecargaSubgerenciaVentas', \r                                'es.indra.sicc.dtos.zon.DTOUnidadAdministrativa', \r                                MakeParametersSgv()), \r                                'recargarSgv(datos);']]);	\r             \r          \r      \r   } \r   \r\r  function recargarSgv(datos){\r\r         var  arr = new Array();\r         var sgv =     get('Formulario.sgv');\r\r         arr[arr.length] = new Array([''],['']);\r         for (var i=0 ;i< datos.length ; i++)  {\r             arr[arr.length] = datos[i];\r         }\r\r         set_combo('Formulario.cbSubgerenciaVentas',arr);\r\r\r         var iSeleccionado = new Array(); \r         var oidSgv = sgv;\r         iSeleccionado[0] = oidSgv ;\r         set('Formulario.cbSubgerenciaVentas',iSeleccionado);\r\r         asignar([['COMBO','Formulario.cbRegion',\r                             'ConectorDruidaTransactionQuery',\r                             'dtoSalida.resultado_ROWSET',\r                             formarCadenaDT('ZONRecargaRegiones', \r                                'es.indra.sicc.dtos.zon.DTOUnidadAdministrativa', \r                                [['oidSGV', oidSgv]]), \r                                'recargarRegion(datos);']]);	\r\r                             \r    }\r\r   \r   function MakeParametersSgv(){\r      var arr = new Array();\r      arr[arr.length] = new Array(\"oidPais\", get('Formulario.pais'));\r      arr[arr.length] = new Array(\"oidMarca\", get('Formulario.cbMarca'));\r      arr[arr.length] = new Array(\"oidCanal\", get('Formulario.cbCanal'));\r      return arr;\r  }\r\rfunction recargarRegion(datos){\r\r         var  arr = new Array();\r         var region =     get('Formulario.region');\r\r        \r         arr[arr.length] = new Array([''],['']);\r         for (var i=0 ;i< datos.length ; i++)  {\r             arr[arr.length] = datos[i];\r         }\r\r         set_combo('Formulario.cbRegion',arr);\r\r\r         var iSeleccionado = new Array(); \r         var oidRegion = region;\r         iSeleccionado[0] = oidRegion ;\r\r         set('Formulario.cbRegion',iSeleccionado);\r         \r         if(region != ''){\r              asignar([['COMBO','Formulario.cbZona',\r                                 'ConectorDruidaTransactionQuery',\r                                 'dtoSalida.resultado_ROWSET',\r                                 formarCadenaDT('ZONRecargaZonas', \r                                    'es.indra.sicc.dtos.zon.DTOUnidadAdministrativa', \r                                    [['oidRegion', region]]), \r                                    'recargarZona(datos);']]);	\r        }\r                             \r    }\r  function recargarZona(datos){\r\r         var  arr = new Array();\r         var zona =        get('Formulario.zona');\r         \r         \r         arr[arr.length] = new Array([''],['']);\r         for (var i=0 ;i< datos.length ; i++)  {\r             arr[arr.length] = datos[i];\r         }\r\r         set_combo('Formulario.cbZona',arr);\r         \r         var iSeleccionado = new Array(); \r         var oidZona = zona;\r\r         iSeleccionado[0] = oidZona;\r         set('Formulario.cbZona',iSeleccionado); \r             \r         if(zona != ''){\r             asignar([['COMBO','Formulario.cbSeccion',\r                                 'ConectorDruidaTransactionQuery',\r                                 'dtoSalida.resultado_ROWSET',\r                                 formarCadenaDT('ZONRecargaSecciones', \r                                    'es.indra.sicc.dtos.zon.DTOUnidadAdministrativa', \r                                    [['oidZona', zona]]), \r                                    'recargarSeccion(datos);']]);	\r        }     \r    }\r\r\r  function recargarSeccion(datos){\r\r         var  arr = new Array();\r         var seccion =        get('Formulario.seccion');\r         \r        \r         arr[arr.length] = new Array([''],['']);\r         for (var i=0 ;i< datos.length ; i++)  {\r             arr[arr.length] = datos[i];\r         }\r\r         set_combo('Formulario.cbSeccion',arr);\r         \r         var iSeleccionado = new Array(); \r         var oidSeccion = seccion;\r\r         iSeleccionado[0] = oidSeccion;\r         set('Formulario.cbSeccion',iSeleccionado); \r        \r        if(seccion != ''){\r             asignar([['COMBO','Formulario.cbTerritorio',\r                                 'ConectorDruidaTransactionQuery',\r                                 'dtoSalida.resultado_ROWSET',\r                                 formarCadenaDT('ZONRecargaTerritorios', \r                                    'es.indra.sicc.dtos.zon.DTOUnidadAdministrativa', \r                                    [['oidSeccion', seccion]]), \r                                 'recargarTerritorio(datos);']]);	\r        }\r         \r    }\r     function recargarTerritorio(datos){\r\r         var  arr = new Array();\r         var territorio =        get('Formulario.territorio');\r         if(territorio != ''){\r             arr[arr.length] = new Array([''],['']);\r             for (var i=0 ;i< datos.length ; i++)  {\r                 arr[arr.length] = datos[i];\r             }\r    \r             set_combo('Formulario.cbTerritorio',arr);\r             \r             var iSeleccionado = new Array(); \r             var oidTerritorio = territorio;\r    \r             iSeleccionado[0] = oidTerritorio;\r             set('Formulario.cbTerritorio',iSeleccionado); \r         }\r         if(get('Formulario.casoDeUso') == 'detalleUsuario'){\r            deshabilitarCampos();\r         }\r\r         \r    }\r\r\r   function deshabilitarCampos(){\r      if(get('Formulario.deshabilitarTodo') == 'true'){\r         accion('Formulario.cbUsuario','.disabled=true');\r         accion('Formulario.cbCodigoEtapaDeuda','.disabled=true');\r         accion('Formulario.cbTipoCargo','.disabled=true');\r         accion('Formulario.cbMarca','.disabled=true');\r         accion('Formulario.cbCanal','.disabled=true');\r         accion('Formulario.cbSubgerenciaVentas','.disabled=true');\r         \r         accion('Formulario.cbRegion','.disabled=true');\r         accion('Formulario.cbZona','.disabled=true');\r         accion('Formulario.cbSeccion','.disabled=true');\r         \r         accion('Formulario.cbTerritorio','.disabled=true');\r         accion('Formulario.cbMetodoLiquidacionDefecto','.disabled=true');\r         accion('Formulario.cbGuiaArgumentalDefecto','.disabled=true');\r         accion('Formulario.txtObservaciones','.disabled=true');\r            \r      \r      }\r    }\r\r   function fGuardar(){\r      \r      if(sicc_validaciones_generales()){\r          recolectarParametros();\r          set('Formulario.conectorAction', 'LPUsuariosCronogramaCobranzaDetalleMantenimiento');           \r          \r          if(get('Formulario.casoDeUso') == 'modificarUsuario'){\r             set('Formulario.accion', 'guardarModificacion');\r          }else{\r             set('Formulario.accion', 'guardar');\r          }\r          eval('Formulario').oculto = 'S';          \r          enviaSICC('Formulario');\r         \r\r    \r      }\r\r   }\r\r\r   function modificoConExito(){\r      this.close();\r   }\r\r   function recolectarParametros(){\r      \r      set('Formulario.usuario', get('Formulario.cbUsuario') );  \r      set('Formulario.etapaDeuda', get('Formulario.cbCodigoEtapaDeuda') );  \r      set('Formulario.tipoCargo', get('Formulario.cbTipoCargo') );  \r      set('Formulario.marca', get('Formulario.cbMarca') );  \r      set('Formulario.canal', get('Formulario.cbCanal'));\r      set('Formulario.sgv', get('Formulario.cbSubgerenciaVentas'));\r      set('Formulario.region', get('Formulario.cbRegion'));\r      set('Formulario.zona', get('Formulario.cbZona'));\r      set('Formulario.seccion', get('Formulario.cbSeccion'));\r      set('Formulario.territorio', get('Formulario.cbTerritorio'));\r      set('Formulario.metodoLiqui', get('Formulario.cbMetodoLiquidacionDefecto'));\r      set('Formulario.guionArgCabec', get('Formulario.cbGuiaArgumentalDefecto'));\r      set('Formulario.observaciones', get('Formulario.txtObservaciones'));\r          \r   \r   }\r \r   \r\r    function insertoConExito(){\r          fLimpiar();\r    \r    }\r\r   function fLimpiar(){\r      var aCombo = new Array(new Array(\"\",\"\"));\r      \r      set('Formulario.cbUsuario', '');\r      set('Formulario.cbTipoCargo', '');\r      set('Formulario.cbMarca', '');\r      set('Formulario.cbCanal', '');\r      set('Formulario.cbMetodoLiquidacionDefecto', '');\r      set('Formulario.cbGuiaArgumentalDefecto', '');\r      set('Formulario.txtObservaciones', '');\r      set_combo('Formulario.cbCodigoEtapaDeuda', aCombo, []);\r      set_combo('Formulario.cbSubgerenciaVentas', aCombo, []);\r      set_combo('Formulario.cbRegion', aCombo, []); \r      set_combo('Formulario.cbZona', aCombo, []); \r      set_combo('Formulario.cbSeccion', aCombo, []); \r      set_combo('Formulario.cbTerritorio', aCombo, []); \r      \r      focaliza('Formulario.cbUsuario');\r \r   }\r   \r    function onchangeMarcaCanal(){\r        \r       marca  = get('Formulario.cbMarca');\r       canal  = get('Formulario.cbCanal');\r       pais   = get('Formulario.pais');\r               \r       if(marca != '' && canal != ''){\r         \r          var arr = new Array();\r                \r          arr[arr.length] = [\"oidPais\", pais]; \r          arr[arr.length] = [\"oidMarca\", marca];\r          arr[arr.length] = [\"oidCanal\", canal];\r                \r          recargaCombo(\"Formulario.cbSubgerenciaVentas\",\"ZONRecargaSubgerenciaVentas\", \"es.indra.sicc.dtos.zon.DTOUnidadAdministrativa\",arr); \r         \r       }else{\r       \r          var aCombo = new Array(new Array(\"\",\"\"));\r          set_combo('Formulario.cbSubgerenciaVentas', aCombo, []);\r          set_combo('Formulario.cbRegion', aCombo, []); \r          set_combo('Formulario.cbZona', aCombo, []); \r          set_combo('Formulario.cbSeccion', aCombo, []); \r          set_combo('Formulario.cbTerritorio', aCombo, []); \r              \r       }\r   \r    }\r    \r\r   function onchangeSGV(){\r      var sgv = get('Formulario.cbSubgerenciaVentas');\r      \r      if(sgv != ''){\r         recargaCombo(\"Formulario.cbRegion\",\"ZONRecargaRegiones\", \"es.indra.sicc.dtos.zon.DTOUnidadAdministrativa\",[['oidSGV', sgv]]); \r      }\r   \r   }\r   \r\r   function onchangeRegion(){\r      var region = get('Formulario.cbRegion');\r      \r      if(region != ''){\r         recargaCombo(\"Formulario.cbZona\",\"ZONRecargaZonas\", \"es.indra.sicc.dtos.zon.DTOUnidadAdministrativa\",[['oidRegion', region]]); \r      }\r   \r   }   \r   \r\r   function onchangeZona(){\r      var zona = get('Formulario.cbZona');\r      \r      if(zona != ''){\r         recargaCombo(\"Formulario.cbSeccion\",\"ZONRecargaSecciones\", \"es.indra.sicc.dtos.zon.DTOUnidadAdministrativa\",[['oidZona', zona]]); \r      }\r   \r   }      \r   \r\r   function onchangeSeccion(){\r      var seccion = get('Formulario.cbSeccion');\r      \r      if(seccion != ''){\r         recargaCombo(\"Formulario.cbTerritorio\",\"ZONRecargaTerritorios\", \"es.indra.sicc.dtos.zon.DTOUnidadAdministrativa\",[['oidSeccion', seccion]]); \r      }\r   \r   } \r   \r\r   function onchangeUsuario(){\r      var usuario = get('Formulario.cbUsuario');\r      \r      if(usuario != ''){\r         recargaCombo(\"Formulario.cbCodigoEtapaDeuda\",\"COBRecargaEtapaDeuda\", \"es.indra.sicc.util.DTOOID\",[['oid', usuario]]); \r      }\r   \r   }   \r   \r\r	function onchangeCodEtapaDeuda(){\r      var codEtapaDeuda = get('Formulario.cbCodigoEtapaDeuda');\r      \r      if(codEtapaDeuda != ''){\r\r		  var arr = new Array();\r                \r          arr[arr.length] = [\"oidPais\", get('Formulario.pais')]; \r          arr[arr.length] = [\"oidIdioma\", get('Formulario.idioma')];\r          arr[arr.length] = [\"oid\", codEtapaDeuda];\r\r         recargaCombo(\"Formulario.cbTipoCargo\",\"COBRecupTiposCargoPorEtapa\", \"es.indra.sicc.util.DTOOID\",arr); \r      }\r   \r    }\r \r   \r  \r  "));
      ...
      ((Element)v.get(7)).setAttribute("name","cbUsuario" );
      ((Element)v.get(7)).setAttribute("required","true" );
      ((Element)v.get(7)).setAttribute("cod","1219" );
      ((Element)v.get(6)).appendChild((Element)v.get(7));
      /* Termina nodo:7   */

      /* Empieza nodo:8 / Elemento padre: 6   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(8)).setAttribute("name","cbCodigoEtapaDeuda" );
      ((Element)v.get(8)).setAttribute("required","true" );
      ((Element)v.get(8)).setAttribute("cod","818" );
      ((Element)v.get(6)).appendChild((Element)v.get(8));
      /* Termina nodo:8   */

      /* Empieza nodo:9 / Elemento padre: 6   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(9)).setAttribute("name","cbTipoCargo" );
      ((Element)v.get(9)).setAttribute("required","true" );
      ((Element)v.get(9)).setAttribute("cod","999" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(21)).setAttribute("nombre","usuario" );
   ...
   private void getXML90(Document doc) {
      v.add(doc.createElement("VAR"));
      ((Element)v.get(22)).setAttribute("nombre","etapaDeuda" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(24)).setAttribute("nombre","marca" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(26)).setAttribute("nombre","sgv" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(30)).setAttribute("nombre","territorio" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(31)).setAttribute("nombre","metodoLiqui" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(32)).setAttribute("nombre","guionArgCabec" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(33)).setAttribute("nombre","observaciones" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(34)).setAttribute("nombre","deshabilitarTodo" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(35)).setAttribute("nombre","oid" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(51)).setAttribute("nombre","lblDatosAlta" );
      ((Element)v.get(51)).setAttribute("alto","13" );
      ((Element)v.get(51)).setAttribute("filas","1" );
      ((Element)v.get(51)).setAttribute("valor","" );
      ((Element)v.get(51)).setAttribute("id","legend" );
      ((Element)v.get(51)).setAttribute("cod","00127" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(60)).setAttribute("nombre","lblUsuario" );
      ...
      ((Element)v.get(60)).setAttribute("cod","1219" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(64)).setAttribute("nombre","lblCodigoEtapaDeuda" );
      ...
      ((Element)v.get(64)).setAttribute("cod","818" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(68)).setAttribute("nombre","lblTipoCargo" );
   ...
   private void getXML270(Document doc) {
      ((Element)v.get(68)).setAttribute("cod","999" );
      ...
      ((Element)v.get(75)).setAttribute("nombre","cbUsuario" );
      ...
      ((Element)v.get(75)).setAttribute("onshtab","focaliza('Formulario.txtObservaciones');" );
      ((Element)v.get(75)).setAttribute("onchange","onchangeUsuario();" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(80)).setAttribute("nombre","cbCodigoEtapaDeuda" );
      ...
      ((Element)v.get(80)).setAttribute("onchange","onchangeCodEtapaDeuda();" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(85)).setAttribute("nombre","cbTipoCargo" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(91)).setAttribute("height","7" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(97)).setAttribute("nombre","lblMarca" );
      ...
      ((Element)v.get(97)).setAttribute("cod","6" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(101)).setAttribute("nombre","lblCanal" );
      ...
      ((Element)v.get(101)).setAttribute("cod","7" );
      ...
      /* Empieza nodo:104 / Elemento padre: 92   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(92)).appendChild((Element)v.get(104));
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(108)).setAttribute("nombre","cbMarca" );
      ...
      ((Element)v.get(108)).setAttribute("onchange","onchangeMarcaCanal();" );
   ...
   private void getXML450(Document doc) {
      ...
      /* Empieza nodo:117 / Elemento padre: 92   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(92)).appendChild((Element)v.get(117));
      ...
      ((Element)v.get(119)).setAttribute("height","7" );
      ...
      /* Empieza nodo:120 / Elemento padre: 49   */
      v.add(doc.createElement("table"));
      ...
      ((Element)v.get(49)).appendChild((Element)v.get(120));
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(125)).setAttribute("nombre","lblSubgerenciaVentas" );
      ...
      ((Element)v.get(125)).setAttribute("cod","124" );
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(136)).setAttribute("nombre","cbSubgerenciaVentas" );
      ...
      ((Element)v.get(136)).setAttribute("onchange","onchangeSGV();" );
      ...
      ((Element)v.get(141)).setAttribute("onchange","onchangeRegion();" );
      ...
      ((Element)v.get(147)).setAttribute("height","7" );
      ...
      /* Empieza nodo:148 / Elemento padre: 49   */
      v.add(doc.createElement("table"));
      ...
      ((Element)v.get(49)).appendChild((Element)v.get(148));
   ...
   private void getXML630(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(157)).setAttribute("nombre","lblSeccion" );
      ...
      ((Element)v.get(157)).setAttribute("cod","112" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(164)).setAttribute("nombre","cbZona" );
      ...
      ((Element)v.get(164)).setAttribute("onchange","onchangeZona();" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(169)).setAttribute("nombre","cbSeccion" );
      ...
      ((Element)v.get(169)).setAttribute("onchange","onchangeSeccion();" );
      ...
      ((Element)v.get(175)).setAttribute("height","7" );
      ...
      /* Empieza nodo:176 / Elemento padre: 49   */
      v.add(doc.createElement("table"));
      ...
      ((Element)v.get(49)).appendChild((Element)v.get(176));
   ...
   private void getXML720(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(181)).setAttribute("nombre","lblTerritorio" );
      ...
      ((Element)v.get(181)).setAttribute("cod","126" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(188)).setAttribute("nombre","cbTerritorio" );
      ...
      ((Element)v.get(194)).setAttribute("height","7" );
      ...
      /* Empieza nodo:195 / Elemento padre: 49   */
      v.add(doc.createElement("table"));
      ...
      ((Element)v.get(49)).appendChild((Element)v.get(195));
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(200)).setAttribute("nombre","lblMetodoLiquidacionDefecto" );
      ...
      ((Element)v.get(200)).setAttribute("cod","1196" );
   ...
   private void getXML810(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(204)).setAttribute("nombre","lblGuiaArgumentalDefecto" );
      ...
      ((Element)v.get(204)).setAttribute("cod","2269" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(211)).setAttribute("nombre","cbMetodoLiquidacionDefecto" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(216)).setAttribute("nombre","cbGuiaArgumentalDefecto" );
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(221)).setAttribute("colspan","3" );
      ...
      ((Element)v.get(222)).setAttribute("height","7" );
      ...
      /* Empieza nodo:223 / Elemento padre: 49   */
      v.add(doc.createElement("table"));
   ...
   private void getXML900(Document doc) {
      ((Element)v.get(49)).appendChild((Element)v.get(223));
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(228)).setAttribute("nombre","lblObservaciones" );
      ...
      ((Element)v.get(228)).setAttribute("cod","169" );
      ...
      ((Element)v.get(235)).setAttribute("cols","50" );
      ((Element)v.get(235)).setAttribute("id","datosCampos" );
      ((Element)v.get(235)).setAttribute("nombre","txtObservaciones" );
      ((Element)v.get(235)).setAttribute("req","N" );
      ((Element)v.get(235)).setAttribute("rows","3" );
      ((Element)v.get(235)).setAttribute("tabindex","2" );
      ((Element)v.get(235)).setAttribute("max","100" );
      ((Element)v.get(235)).setAttribute("ontab","focaliza('Formulario.cbUsuario');" );
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(239)).setAttribute("colspan","3" );
      ...
      ((Element)v.get(240)).setAttribute("height","7" );
      ...
      /* Empieza nodo:241 / Elemento padre: 45   */
      v.add(doc.createElement("td"));
      ((Element)v.get(45)).appendChild((Element)v.get(241));
      ...
      /* Empieza nodo:243 / Elemento padre: 37   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(37)).appendChild((Element)v.get(243));
