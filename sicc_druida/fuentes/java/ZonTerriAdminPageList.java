...
public class ZonTerriAdminPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","zonTerriAdminList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","ZonTerriAdmin.indBorr.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","ZonTerriAdmin.zsccOidSecc.label" );
      ...
      ((Element)v.get(17)).setAttribute("cod","ZonTerriAdmin.terrOidTerr.label" );
      ...
      ((Element)v.get(18)).setAttribute("cod","ZonTerriAdmin.fecRtz.label" );
