...
public class contenido_tipos_caja_modificar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","contenido_tipos_caja_embalaje.js" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(38)).setAttribute("nombre","lblCentroDistribucion" );
      ...
      ((Element)v.get(38)).setAttribute("cod","2054" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(42)).setAttribute("nombre","lblCodTipoCaja" );
      ...
      ((Element)v.get(42)).setAttribute("cod","3043" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(46)).setAttribute("cod","MMGGlobal.localization.description.label" );
      ...
      ((Element)v.get(53)).setAttribute("nombre","cbCentroDistribucion" );
      ...
      ((Element)v.get(53)).setAttribute("onchange","onChangeCbCentroDistribucion();" );
      ...
      ((Element)v.get(58)).setAttribute("nombre","txtCodTipoCaja" );
      ((Element)v.get(58)).setAttribute("id","datosCampos" );
      ((Element)v.get(58)).setAttribute("max","2" );
      ((Element)v.get(58)).setAttribute("tipo","" );
      ((Element)v.get(58)).setAttribute("req","N" );
      ((Element)v.get(58)).setAttribute("size","3" );
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(62)).setAttribute("nombre","txtDescripcion" );
      ((Element)v.get(62)).setAttribute("id","datosCampos" );
      ((Element)v.get(62)).setAttribute("max","30" );
      ((Element)v.get(62)).setAttribute("tipo","" );
      ((Element)v.get(62)).setAttribute("req","N" );
      ((Element)v.get(62)).setAttribute("size","30" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(76)).setAttribute("nombre","lblLineaArmado" );
      ...
      ((Element)v.get(76)).setAttribute("cod","2095" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(83)).setAttribute("nombre","cbLineaArmado" );
      ...
      /* Empieza nodo:90 / Elemento padre: 26   */
      v.add(doc.createElement("fieldset"));
      ((Element)v.get(26)).appendChild((Element)v.get(90));
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(94)).setAttribute("accion","onClickBuscar();" );
      ...
      ((Element)v.get(95)).setAttribute("y","180" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(109)).setAttribute("ancho","50" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(111)).setAttribute("ancho","50" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(114)).setAttribute("ancho","50" );
      ...
      ((Element)v.get(116)).setAttribute("cod","3043" );
      ((Element)v.get(115)).appendChild((Element)v.get(116));

      /* Elemento padre:116 / Elemento actual: 117   */
      v.add(doc.createTextNode("OID Tipo Caja"));
      ...
      ((Element)v.get(118)).setAttribute("cod","MMGGlobal.localization.description.label" );
      ...
      ((Element)v.get(122)).setAttribute("cod","MMGGlobal.localization.description.label" );
   ...
   private void getXML540(Document doc) {
      v.add(doc.createTextNode("Linea Armado"));
      ...
      ((Element)v.get(126)).setAttribute("cod","2955" );
      ...
      ((Element)v.get(128)).setAttribute("cod","MaeUnidaMedid.codUnidMedi.label" );
      ((Element)v.get(115)).appendChild((Element)v.get(128));

      /* Elemento padre:128 / Elemento actual: 129   */
      v.add(doc.createTextNode("Unidad Medida"));
      ...
      ((Element)v.get(142)).setAttribute("conector","ConectorBuscarCargosAbonos" );
   ...
   private void getXML630(Document doc) {
      ...
      ((Element)v.get(147)).setAttribute("accion","onClickDetalle();" );
