...
public class ConectorRecalcularDetalleCampaniaEstimadosBP  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","ConectorRecalcularDetalleCampaniaEstimadosBP" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","DTODetalleCampaniaEstimadosBP" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MAVRecalcularDetalleCampaniaEstimadosBP" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(5)).setAttribute("NOMBRE","DTODetalleCampaniaEstimadosBP" );
