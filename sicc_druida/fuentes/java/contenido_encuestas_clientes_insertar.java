...
public class contenido_encuestas_clientes_insertar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_encuestas_clientes_insertar" );
      ((Element)v.get(0)).setAttribute("cod","01041" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(3)).setAttribute("src","contenido_encuestas_clientes_insertar.js" );
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(6)).setAttribute("name","cbPregunta" );
      ((Element)v.get(6)).setAttribute("required","true" );
      ((Element)v.get(6)).setAttribute("cod","3062" );
      ((Element)v.get(4)).appendChild((Element)v.get(6));
      /* Termina nodo:6   */

      /* Empieza nodo:7 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(7)).setAttribute("name","cbRespuesta" );
      ((Element)v.get(7)).setAttribute("required","true" );
      ((Element)v.get(7)).setAttribute("cod","3063" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(12)).setAttribute("nombre","oidPregunta" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(13)).setAttribute("nombre","oidRespuesta" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(14)).setAttribute("nombre","oidEncuestaAplicadaCliente" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(15)).setAttribute("nombre","cerrar" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(16)).setAttribute("nombre","recupera" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(18)).setAttribute("nombre","habilitarEdicionCampos" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(19)).setAttribute("nombre","habilitarBtBuscarCliente" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(20)).setAttribute("nombre","habilitarBtGuardar" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(24)).setAttribute("nombre","hPregunta" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(25)).setAttribute("nombre","hRespuesta" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(62)).setAttribute("onshtab","txtCodClienteSTab();" );
      ...
      ((Element)v.get(64)).setAttribute("name","lupa" );
      ((Element)v.get(64)).setAttribute("onmouseover","poneManito('lupa');" );
      ((Element)v.get(64)).setAttribute("onclick","accionBuscarCliente();" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(77)).setAttribute("nombre","lblPregunta" );
      ...
      ((Element)v.get(77)).setAttribute("cod","3062" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(81)).setAttribute("nombre","lblRespuesta" );
      ...
      ((Element)v.get(81)).setAttribute("cod","3063" );
      ...
      ((Element)v.get(88)).setAttribute("nombre","cbPregunta" );
      ...
      ((Element)v.get(88)).setAttribute("onchange","onChangePregunta();" );
      ((Element)v.get(88)).setAttribute("onshtab","cbPreguntaSTab();" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(93)).setAttribute("nombre","cbRespuesta" );
      ...
      ((Element)v.get(93)).setAttribute("ontab","cbRespuestaTab();" );
      ...
      /* Empieza nodo:104 / Elemento padre: 29   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(29)).appendChild((Element)v.get(104));
