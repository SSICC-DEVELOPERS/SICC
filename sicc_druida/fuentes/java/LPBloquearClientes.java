...
public class LPBloquearClientes extends LPSICCBase {

	private String accion = null;
	private Long idioma;
	private Long pais;

	public LPBloquearClientes() {
		super();
	}
	...
	public void ejecucion() throws Exception {
		...
		try {
			setTrazaFichero();
            		traza("***Entrada - LPBloquearClientes - ejecucion***");
			...
			traza("***Salida - LPBloquearClientes - ejecucion***");
	...
	private void accionDesbloquear() throws Exception {
		traza("***Entrada -  LPBloquearClientes - accionDesbloquear");
		...
		traza("***Salida -  LPBloquearClientes - accionDesbloquear");
	}
