...
public class BelFormaPagoPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","belFormaPagoList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","BelFormaPago.codFormPago.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","BelFormaPago.Descripcion.label" );
