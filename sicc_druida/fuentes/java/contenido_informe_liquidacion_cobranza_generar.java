...
public class contenido_informe_liquidacion_cobranza_generar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_informe_liquidacion_cobranza_generar" );
      ((Element)v.get(0)).setAttribute("cod","0847" );
      ((Element)v.get(0)).setAttribute("titulo","Generar informe liquidación de cobranza" );
      ...
      v.add(doc.createTextNode("\r   \r \r   function onLoad(){\r      configurarMenuSecundario('Formulario');\r      fMostrarMensajeError();\r      focaliza('Formulario.cbBanco')\r           \r      \r   }\r\r     function quitarItemVacio(elemento){\r      var elementoADevolver = new Array();\r     \r      for(var k=0;k<elemento.length;k++) {\r          if (elemento[k] != ''){                            \r             elementoADevolver[elementoADevolver.length] = elemento[k];\r          }\r      }\r         \r      return elementoADevolver;\r      \r   }\r   function generar(){\r      if(sicc_validaciones_generales()){\r         if(validarFechas()){\r            if(validarComprobante()){\r               /*recolectarParametros();\r               set('Formulario.conectorAction', 'CCCLiquidacionCobranza');           \r               set('Formulario.accion', 'generar');\r               enviaSICC('Formulario');*/\r               var a = new Object();\r               a.accion = 'generar';\r               a.banco = quitarItemVacio(get('Formulario.cbBanco'));  \r               a.cuentaCorriente = quitarItemVacio(get('Formulario.cbCuentaCorriente'));  \r               a.fechaLiquidacion = get('Formulario.txtFechaLiquidacion');\r               a.comprobante = get('Formulario.txtComprobante');  \r               a.orden = get('Formulario.cbOrdenImpresion');         \r               mostrarModalSICC('CCCLiquidacionCobranza','generar', a);  \r            }\r         }      \r      }\r   }\r\r\r   function validarComprobante(){\r      var comprobante = new Array();\r      comprobante = get('Formulario.txtComprobante');\r      \r      if(comprobante != ''){\r         if(comprobante.length < 12){\r            cdos_mostrarAlert(\"Debe rellenar los 12 digitos del comprobante\");\r            return false;\r         }else{\r            return true;\r         }\r      }else{\r         return true;\r      }\r   }\r\r  function validarFechas(){\r      \r      var fechaDesde = get('Formulario.txtFechaLiquidacion');\r      var formatoFecha = get('Formulario.hFormatoFechaPais');\r            \r     \r      if (! EsFechaValida_SICC(fechaDesde, \"Formulario\")){\r          GestionarMensaje(\"1006\", formatoFecha, null, null);\r          focaliza(\"Formulario.txtFechaLiquidacion\");\r          return false;\r      }\r      return true;   \r   \r   }\r   function recolectarParametros(){\r           \r      set('Formulario.banco', get('Formulario.cbBanco'));  \r      set('Formulario.cuentaCorriente', get('Formulario.cbCuentaCorriente'));  \r      set('Formulario.fechaLiquidacion', get('Formulario.txtFechaLiquidacion'));\r      set('Formulario.comprobante', get('Formulario.txtComprobante'));  \r      set('Formulario.orden', get('Formulario.cbOrdenImpresion'));\r \r  \r   }\r\r   function onchangeBanco(){\r     opciones = new Array();\r     set_combo('Formulario.cbCuentaCorriente',opciones);                         \r     var banco = get('Formulario.cbBanco','V');\r     combo_add('Formulario.cbCuentaCorriente', '', '');\r     \r     for(var k=0;k<ListaCC.datos.longitud;k++) {\r        for(var y=0;y<banco.length;y++){\r           if (ListaCC.datos.ij(k,2) == banco[y]){                     \r                 combo_add('Formulario.cbCuentaCorriente',ListaCC.datos.ij(k,0),ListaCC.datos.ij(k,1));\r           }\r         }\r      }\r  \r   }\r   \r\r   function fLimpiar(){\r      var aCombo = new Array(new Array(\"\",\"\"));\r      set_combo('Formulario.cbCuentaCorriente', aCombo, []);\r\r   \r   }\r   \r   \r\r \r   \r  \r  "));
      ...
      ((Element)v.get(5)).setAttribute("name","cbBanco" );
      ((Element)v.get(5)).setAttribute("required","true" );
      ((Element)v.get(5)).setAttribute("cod","617" );
      ((Element)v.get(4)).appendChild((Element)v.get(5));
      /* Termina nodo:5   */

      /* Empieza nodo:6 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(6)).setAttribute("name","txtFechaLiquidacion" );
      ((Element)v.get(6)).setAttribute("required","true" );
      ((Element)v.get(6)).setAttribute("cod","1205" );
      ((Element)v.get(4)).appendChild((Element)v.get(6));
      /* Termina nodo:6   */

      /* Empieza nodo:7 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(7)).setAttribute("name","cbOrdenImpresion" );
      ((Element)v.get(7)).setAttribute("required","true" );
      ((Element)v.get(7)).setAttribute("cod","2673" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(16)).setAttribute("nombre","cuentaCorriente" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(17)).setAttribute("nombre","fechaLiquidacion" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(18)).setAttribute("nombre","comprobante" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(19)).setAttribute("nombre","ordenImpresion" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(20)).setAttribute("nombre","vista" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(52)).setAttribute("nombre","lblCuentaCorriente" );
      ((Element)v.get(52)).setAttribute("alto","13" );
      ((Element)v.get(52)).setAttribute("filas","1" );
      ((Element)v.get(52)).setAttribute("id","datosTitle" );
      ((Element)v.get(52)).setAttribute("cod","636" );
      ...
      ((Element)v.get(59)).setAttribute("nombre","cbBanco" );
      ...
      ((Element)v.get(59)).setAttribute("onchange","onchangeBanco();" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(64)).setAttribute("nombre","cbCuentaCorriente" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(93)).setAttribute("nombre","txtFechaLiquidacion" );
   }
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(93)).setAttribute("size","12" );
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(97)).setAttribute("nombre","txtComprobante" );
      ((Element)v.get(97)).setAttribute("id","datosCampos" );
      ((Element)v.get(97)).setAttribute("max","12" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(101)).setAttribute("nombre","cbOrdenImpresion" );
      ...
      ((Element)v.get(101)).setAttribute("textoinicial","Cabecera" );
      ...
      ((Element)v.get(105)).setAttribute("VALOR","Completo" );
      ...
      /* Empieza nodo:113 / Elemento padre: 22   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(22)).appendChild((Element)v.get(113));
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(121)).setAttribute("nombre","btnGenerarInforme" );
      ...
      ((Element)v.get(121)).setAttribute("cod","2495" );
      ((Element)v.get(121)).setAttribute("ontab","Focaliza('Formulario.cbBanco')" );
      ...
      /* Empieza nodo:124 / Elemento padre: 22   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(22)).appendChild((Element)v.get(124));
