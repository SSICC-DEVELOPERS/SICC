...
public class CobMetodLiquiPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","cobMetodLiquiList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","CobMetodLiqui.codMetoLiqu.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","CobMetodLiqui.valDescMetoLiqu.label" );
