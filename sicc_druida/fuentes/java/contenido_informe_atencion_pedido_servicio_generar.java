...
public class contenido_informe_atencion_pedido_servicio_generar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_informe_atencion_pedido_servicio_generar" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(87)).setAttribute("nombre","cbPeriodoInicial" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(92)).setAttribute("nombre","cbPeriodoFinal" );
   ...
   private void getXML360(Document doc) {
      ...
      /* Empieza nodo:99 / Elemento padre: 35   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(35)).appendChild((Element)v.get(99));
   ...
   private void getXML450(Document doc) {
      ...
      /* Empieza nodo:120 / Elemento padre: 28   */
      v.add(doc.createElement("td"));
      ((Element)v.get(28)).appendChild((Element)v.get(120));
      ...
      ((Element)v.get(130)).setAttribute("ontab","focaliza('Formulario.cbMarca')" );
      ...
      /* Empieza nodo:133 / Elemento padre: 20   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(20)).appendChild((Element)v.get(133));
