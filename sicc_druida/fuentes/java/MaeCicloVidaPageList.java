...
public class MaeCicloVidaPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","maeCicloVidaList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","MaeCicloVida.codCiclVida.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","MaeCicloVida.Descripcion.label" );
