...
public class ComCongePageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","comCongeList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(16)).setAttribute("cod","ComConge.fecDesd.label" );
      ...
      ((Element)v.get(17)).setAttribute("cod","ComConge.fecHast.label" );
      ...
      ((Element)v.get(18)).setAttribute("cod","ComConge.impCong.label" );
      ...
      ((Element)v.get(19)).setAttribute("cod","ComConge.indDescAuto.label" );
      ...
      ((Element)v.get(20)).setAttribute("cod","ComConge.clieOidClie.label" );
