/*
    INDRA/CAR/mmg
    $Id: ComTipoClienComisCabecLPStartUp.java,v 1.1 2009/12/03 18:32:46 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class ComTipoClienComisCabecLPStartUp extends MMGDruidaBase{
	...
	protected static Hashtable codClasValues = new Hashtable();
	static{
		codClasValues.put(new java.lang.String("G"), "Gerente");
	}
	
	
	// Definicion del constructor
	public ComTipoClienComisCabecLPStartUp(){
		super();
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			buildJsPageSize("ComTipoClienComisCabec");
			...
			asignarAtributo("PAGINA", "ComTipoClienComisCabecPage", "cod", "ComTipoClienComisCabec." + accion + ".label");
			...
			limpiarBotoneraLista("comTipoClienComisCabec", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codSubc", "validacion", "mensaje = ValidaInt(cdos_trim(valor), 2, 0, 99);");
		...
		//asignarAtributo("CAPA", "comTipoClienComisCabecLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "ComTipoClienComisCabecPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		ComTipoClienComisCabecData comTipoClienComisCabecQuery= new ComTipoClienComisCabecData();
		comTipoClienComisCabecQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		ComTipoClienComisCabecData datosResult = (ComTipoClienComisCabecData)getSingleObject(BUSINESSID_QUERY, comTipoClienComisCabecQuery, 
			comTipoClienComisCabecQuery.clone(), "comTipoClienComisCabec");
		...
		preservaHiddensI18n(new Integer(1), "COM_TIPO_CLIEN_COMIS_CABEC", "comTipoClienComisCabecFrm", "Descripcion", true);
		...
		ComTipoClienComisCabecData comTipoClienComisCabec = datosResult;
		if(comTipoClienComisCabec.getCodClas() != null){	
			checkCombo("codClas", FormatUtils.formatObject(comTipoClienComisCabec.getCodClas(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		}
		asignar("TEXT", "codSubc", FormatUtils.formatObject(comTipoClienComisCabec.getCodSubc(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "Descripcion", FormatUtils.formatObject(comTipoClienComisCabec.getDescripcion(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		loadLocalizationVars(comTipoClienComisCabec);
		
			
		//Deshabilitamos todos los campos para que no se editen
		
					asignarAtributo("COMBO", "codClas", "disabled", "S");asignarAtributo("TEXT", "codSubc", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "COM_TIPO_CLIEN_COMIS_CABEC", "comTipoClienComisCabecFrm", "Descripcion", false);
		...
		asignarAtributo("COMBO", "codClas", "req", "S");
		asignarAtributo("TEXT", "codSubc", "req", "S");
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('comTipoClienComisCabecFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "comTipoClienComisCabecFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		ComTipoClienComisCabecData comTipoClienComisCabecQuery= new ComTipoClienComisCabecData();
		comTipoClienComisCabecQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(comTipoClienComisCabec.jdoGetTimeStamp()));
		...
		// splatas - DBLG500000889 - 12/07/2006
        // Deshabilito el combo 'Id.Clasificacion' 
        asignarAtributo("COMBO", "codClas", "disabled", "S");
	}
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"comTipoClienComisCabecFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"comTipoClienComisCabecFrm\",1, false)");
				asignarAtributo("TEXT", "codClas", "ontab","ejecutarAccionFocoModificacion(\"comTipoClienComisCabecFrm\",2, true)");
				asignarAtributo("TEXT", "codClas", "onshtab","ejecutarAccionFocoModificacion(\"comTipoClienComisCabecFrm\",2, false)");
				asignarAtributo("AREATEXTO", "codSubc", "ontab","ejecutarAccionFocoModificacion(\"comTipoClienComisCabecFrm\",3, true)");
				asignarAtributo("AREATEXTO", "codSubc", "onshtab","ejecutarAccionFocoModificacion(\"comTipoClienComisCabecFrm\",3, false)");
					asignarAtributo("COMBO","paisOidPais", "ontab", "ejecutarAccionFocoModificacion(\"comTipoClienComisCabecFrm\",4, true)");
					asignarAtributo("COMBO","paisOidPais", "onshtab", "ejecutarAccionFocoModificacion(\"comTipoClienComisCabecFrm\",4, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"comTipoClienComisCabecFrm\",5, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"comTipoClienComisCabecFrm\",5, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","comTipoClienComisCabecTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","comTipoClienComisCabecTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codSubc...");		
				
					traza("MMG: en desactivateNonModifyFields encontrado atributo no editable...");
				
						// borrarCampo("codSubc");
						asignarAtributo ("TEXT", "codSubc", "disabled", "S");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","comTipoClienComisCabecFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","comTipoClienComisCabecListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","comTipoClienComisCabecListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(ComTipoClienComisCabecData comTipoClienComisCabec) throws Exception{
		...
		if(comTipoClienComisCabec != null && comTipoClienComisCabec.getPaisOidPais() != null){
				checkCombo("paisOidPais" , comTipoClienComisCabec.getPaisOidPais().getId().toString());
			}
	...
	* @param comTipoClienComisCabec La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(ComTipoClienComisCabecData comTipoClienComisCabec) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		ComTipoClienComisCabecData comTipoClienComisCabec = 
			(ComTipoClienComisCabecData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(comTipoClienComisCabec.getPaisOidPais() != null){
			comTipoClienComisCabec.setPaisOidPais((es.indra.belcorp.mso.SegPaisViewData)
			getSingleObject(BUSINESSID_PAISOIDPAIS_QUERY, 
			comTipoClienComisCabec.getPaisOidPais(),
			comTipoClienComisCabec.getPaisOidPais().clone(),
			"segPaisView"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(comTipoClienComisCabec);
		loadLeafDependenceCombos(comTipoClienComisCabec);
	}
	...
	*/
	...
	protected void loadLocalizationVars(ComTipoClienComisCabecData comTipoClienComisCabec) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("COM_TIPO_CLIEN_COMIS_CABEC");
		mmgLocalizationQuery.setEntiPk(comTipoClienComisCabec.getId());
