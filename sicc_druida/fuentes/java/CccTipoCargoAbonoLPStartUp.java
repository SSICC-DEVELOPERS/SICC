/*
    INDRA/CAR/mmg
    $Id: CccTipoCargoAbonoLPStartUp.java,v 1.1 2009/12/03 18:36:33 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class CccTipoCargoAbonoLPStartUp extends MMGDruidaBase{
	...
	public static final String BUSINESSID_QUERY = "MMGCccTipoCargoAbonoQueryFromToUserPage";
	...
	public CccTipoCargoAbonoLPStartUp(){
		super();
	}

	public void inicio() throws Exception {
		pagina("CccTipoCargoAbonoPage");
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			buildJsPageSize("CccTipoCargoAbono");
			...
			asignarAtributo("PAGINA", "CccTipoCargoAbonoPage", "cod", "CccTipoCargoAbono." + accion + ".label");
			...
			limpiarBotoneraLista("cccTipoCargoAbono", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codTipoCargAbon", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 3);");
		...
		//asignarAtributo("CAPA", "cccTipoCargoAbonoLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "CccTipoCargoAbonoPage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("CccTipoCargoAbonoLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		CccTipoCargoAbonoData cccTipoCargoAbonoQuery= new CccTipoCargoAbonoData();
		cccTipoCargoAbonoQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		CccTipoCargoAbonoData datosResult = (CccTipoCargoAbonoData)getSingleObject(BUSINESSID_QUERY, cccTipoCargoAbonoQuery, 
			cccTipoCargoAbonoQuery.clone(), "cccTipoCargoAbono");
		...
		preservaHiddensI18n(new Integer(1), "CCC_TIPO_CARGO_ABONO", "cccTipoCargoAbonoFrm", "Descripcion", true);
		...
		CccTipoCargoAbonoData cccTipoCargoAbono = datosResult;
		asignar("TEXT", "codTipoCargAbon", FormatUtils.formatObject(cccTipoCargoAbono.getCodTipoCargAbon(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "Descripcion", FormatUtils.formatObject(cccTipoCargoAbono.getDescripcion(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("AREATEXTO", "valObse", FormatUtils.formatObject(cccTipoCargoAbono.getValObse(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		loadLocalizationVars(cccTipoCargoAbono);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "codTipoCargAbon", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "CCC_TIPO_CARGO_ABONO", "cccTipoCargoAbonoFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "codTipoCargAbon", "req", "S");
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('cccTipoCargoAbonoFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "cccTipoCargoAbonoFrm", "oculto", "N");
		...
		traza("MMG::Creando CccTipoCargoAbono");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		CccTipoCargoAbonoData cccTipoCargoAbonoQuery= new CccTipoCargoAbonoData();
		cccTipoCargoAbonoQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(cccTipoCargoAbono.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"cccTipoCargoAbonoFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"cccTipoCargoAbonoFrm\",1, false)");
					asignarAtributo("COMBO","paisOidPais", "ontab", "ejecutarAccionFocoModificacion(\"cccTipoCargoAbonoFrm\",2, true)");
					asignarAtributo("COMBO","paisOidPais", "onshtab", "ejecutarAccionFocoModificacion(\"cccTipoCargoAbonoFrm\",2, false)");
				asignarAtributo("AREATEXTO", "codTipoCargAbon", "ontab","ejecutarAccionFocoModificacion(\"cccTipoCargoAbonoFrm\",3, true)");
				asignarAtributo("AREATEXTO", "codTipoCargAbon", "onshtab","ejecutarAccionFocoModificacion(\"cccTipoCargoAbonoFrm\",3, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"cccTipoCargoAbonoFrm\",4, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"cccTipoCargoAbonoFrm\",4, false)");
				asignarAtributo("AREATEXTO", "valObse", "ontab","ejecutarAccionFocoModificacion(\"cccTipoCargoAbonoFrm\",5, true)");
				asignarAtributo("AREATEXTO", "valObse", "onshtab","ejecutarAccionFocoModificacion(\"cccTipoCargoAbonoFrm\",5, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","cccTipoCargoAbonoTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","cccTipoCargoAbonoTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","cccTipoCargoAbonoFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","cccTipoCargoAbonoListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","cccTipoCargoAbonoListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(CccTipoCargoAbonoData cccTipoCargoAbono) throws Exception{
		...
		if(cccTipoCargoAbono != null && cccTipoCargoAbono.getPaisOidPais() != null){
				checkCombo("paisOidPais" , cccTipoCargoAbono.getPaisOidPais().getId().toString());
			}
	...
	* @param cccTipoCargoAbono La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(CccTipoCargoAbonoData cccTipoCargoAbono) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		CccTipoCargoAbonoData cccTipoCargoAbono = 
			(CccTipoCargoAbonoData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(cccTipoCargoAbono.getPaisOidPais() != null){
			cccTipoCargoAbono.setPaisOidPais((es.indra.belcorp.mso.SegPaisViewData)
			getSingleObject(BUSINESSID_PAISOIDPAIS_QUERY, 
			cccTipoCargoAbono.getPaisOidPais(),
			cccTipoCargoAbono.getPaisOidPais().clone(),
			"segPaisView"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(cccTipoCargoAbono);
		loadLeafDependenceCombos(cccTipoCargoAbono);
	}
	...
	*/
	...
	protected void loadLocalizationVars(CccTipoCargoAbonoData cccTipoCargoAbono) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("CCC_TIPO_CARGO_ABONO");
		mmgLocalizationQuery.setEntiPk(cccTipoCargoAbono.getId());
