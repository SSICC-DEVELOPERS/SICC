 ...
 * Componente:    LPEliminaCronograma 
 * Fecha:             14/06/2004
 * Observaciones:     
 * @version        1.0
 * @autor           Luis Ramos
...
public class LPEliminaCronograma extends LPSICCBase {

	public LPEliminaCronograma() {
		super();
	}
    ...
    setTrazaFichero();
      ...
      if (mAccion.equals("")) {
          ...
          conectorActionParametro("accion","muestraConsultaCronograma");
          conectorActionParametro("casoDeUso","eliminaCronograma");
      }
