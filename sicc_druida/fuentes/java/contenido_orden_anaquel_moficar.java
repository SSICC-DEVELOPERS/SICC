...
public class contenido_orden_anaquel_moficar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("nombre","lblSeleccionDeMapa" );
      ((Element)v.get(29)).setAttribute("alto","13" );
      ((Element)v.get(29)).setAttribute("filas","1" );
      ((Element)v.get(29)).setAttribute("cod","00664" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(42)).setAttribute("nombre","lblMapaCentroDistribucion" );
      ...
      ((Element)v.get(42)).setAttribute("cod","2925" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(49)).setAttribute("nombre","cbCentroDistribucion" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(54)).setAttribute("nombre","cbMapaCentroDistribucion" );
      ...
      ((Element)v.get(54)).setAttribute("onshtab","" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(69)).setAttribute("nombre","lblMapaZonas" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(69)).setAttribute("cod","2926" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(73)).setAttribute("nombre","lblOrdenAnaquel" );
      ...
      ((Element)v.get(73)).setAttribute("cod","2933" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(80)).setAttribute("nombre","cbMapaZonas" );
      ...
      ((Element)v.get(80)).setAttribute("onshtab","" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(85)).setAttribute("nombre","cbOrdenAnaquel" );
      ...
      ((Element)v.get(85)).setAttribute("onshtab","" );
      ...
      /* Empieza nodo:89 / Elemento padre: 61   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(61)).appendChild((Element)v.get(89));
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(100)).setAttribute("nombre","lblLineaArmado" );
      ...
      ((Element)v.get(100)).setAttribute("cod","2095" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(104)).setAttribute("nombre","lblSublineaArmado" );
      ...
      ((Element)v.get(104)).setAttribute("cod","2928" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(111)).setAttribute("nombre","cbLineaArmado" );
      ...
      ((Element)v.get(111)).setAttribute("onshtab","" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(116)).setAttribute("nombre","cbSublineaArmado" );
      ...
      /* Empieza nodo:123 / Elemento padre: 26   */
      v.add(doc.createElement("fieldset"));
      ((Element)v.get(26)).appendChild((Element)v.get(123));
      ...
      ((Element)v.get(127)).setAttribute("nombre","btnAceptar" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(128)).setAttribute("nombre","btnDetalle" );
      ...
      ((Element)v.get(128)).setAttribute("cod","MMGGlobal.viewButton.label" );
