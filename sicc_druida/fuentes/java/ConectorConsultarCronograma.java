...
public class ConectorConsultarCronograma  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para verificar la existencia de un cronograma" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","DTOEntradaConsultarCronograma" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","CRAConsultarCronograma" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(6)).setAttribute("NOMBRE","OID_CRON" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","PERD_OID_PERI" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(8)).setAttribute("NOMBRE","ZSCC_OID_SECC" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(9)).setAttribute("NOMBRE","CACT_TIPO_ACTI" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(10)).setAttribute("NOMBRE","COD_TIPO_FACT" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(11)).setAttribute("NOMBRE","COD_TIPO_DIAS" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(12)).setAttribute("NOMBRE","FEC_INIC" );
      ((Element)v.get(12)).setAttribute("TIPO","LONG" );
      ((Element)v.get(12)).setAttribute("LONGITUD","8" );
      ((Element)v.get(5)).appendChild((Element)v.get(12));
      /* Termina nodo:12   */

      /* Empieza nodo:13 / Elemento padre: 5   */
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(13)).setAttribute("NOMBRE","FEC_MEDI" );
      ((Element)v.get(13)).setAttribute("TIPO","LONG" );
      ...
      ((Element)v.get(14)).setAttribute("TIPO","LONG" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(15)).setAttribute("NOMBRE","IND_FIJA" );
      ((Element)v.get(15)).setAttribute("TIPO","LONG" );
      ((Element)v.get(15)).setAttribute("LONGITUD","8" );
      ((Element)v.get(5)).appendChild((Element)v.get(15));
      /* Termina nodo:15   */

      /* Empieza nodo:16 / Elemento padre: 5   */
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(16)).setAttribute("NOMBRE","IND_FIJA" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(17)).setAttribute("NOMBRE","ZZON_OID_ZONA" );
      ...
      ((Element)v.get(18)).setAttribute("ID","dtoSalida.resultado_ROWSET" );
      ((Element)v.get(0)).appendChild((Element)v.get(18));

      /* Empieza nodo:19 / Elemento padre: 18   */
      v.add(doc.createElement("CCAMPO"));
      ((Element)v.get(19)).setAttribute("NOMBRE","OID_CRON" );
   }
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("CCAMPO"));
      ((Element)v.get(20)).setAttribute("NOMBRE","ZZON_OID_ZONA" );
