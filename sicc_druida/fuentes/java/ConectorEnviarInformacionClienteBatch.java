...
public class ConectorEnviarInformacionClienteBatch  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Enviar Informacion Cliente Bach" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","DTOINTEnviarInformacionClienteBatch" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","INTEnviarInformacionClienteBatch " );
