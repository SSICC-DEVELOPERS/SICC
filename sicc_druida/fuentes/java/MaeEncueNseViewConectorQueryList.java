...
public class MaeEncueNseViewConectorQueryList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad MaeEncueNseView" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGMaeEncueNseViewQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGMaeEncueNseViewQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","MaeEncueNseViewListFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","codTipoEncu" );
