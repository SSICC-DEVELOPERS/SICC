/*
    INDRA/CAR/mmg
    $Id: CccBancoLPStartUp.java,v 1.1 2009/12/03 18:33:27 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class CccBancoLPStartUp extends MMGDruidaBase{
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "CccBancoPage", "cod", "CccBanco." + accion + ".label");
			...
			limpiarBotoneraLista("cccBanco", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codBanc", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 4);");
		asignarAtributo("TEXT", "desBanc", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 40);");
		asignarAtributo("TEXT", "codBrio", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 6);");
		asignarAtributo("TEXT", "codSwifInfo", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 0, 20);");
		
		//Primero determianmos el nombre del campo en la entidad de oriegen donde se van a cargar los datos
		asignar("VAR", "idAttributeLovOpener", conectorParametro(PARAMETRO_LOV_ATTRIBUTO));
		asignar("VAR", "idEntityLovOpener", conectorParametro(PARAMETRO_LOV_ENTIDAD));
		//asignarAtributo("CAPA", "cccBancoLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "CccBancoPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		CccBancoData cccBancoQuery= new CccBancoData();
		cccBancoQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		CccBancoData datosResult = (CccBancoData)getSingleObject(BUSINESSID_QUERY, cccBancoQuery, 
			cccBancoQuery.clone(), "cccBanco");
		...
		CccBancoData cccBanco = datosResult;
		asignar("TEXT", "codBanc", FormatUtils.formatObject(cccBanco.getCodBanc(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "desBanc", FormatUtils.formatObject(cccBanco.getDesBanc(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "codBrio", FormatUtils.formatObject(cccBanco.getCodBrio(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "codSwifInfo", FormatUtils.formatObject(cccBanco.getCodSwifInfo(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("AREATEXTO", "valObsBanc", FormatUtils.formatObject(cccBanco.getValObsBanc(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		asignarAtributo("TEXT", "codBanc", "disabled", "S");
		asignarAtributo("TEXT", "desBanc", "disabled", "S");
		asignarAtributo("TEXT", "codBrio", "disabled", "S");
		asignarAtributo("TEXT", "codSwifInfo", "disabled", "S");
		asignarAtributo("AREATEXTO", "valObsBanc", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		...
		asignarAtributo("TEXT", "codBanc", "req", "S");
		asignarAtributo("TEXT", "desBanc", "req", "S");
		asignarAtributo("TEXT", "codBrio", "req", "S");
		...
		asignarAtributo("TEXT", "codBrio", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 6);");
		asignarAtributo("TEXT", "codSwifInfo", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 0, 20);");
		asignarAtributo("AREATEXTO", "valObsBanc", "validacion", "ValidaLongitud(cdos_trim(valor), 0, 100)");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "cccBancoFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		CccBancoData cccBancoQuery= new CccBancoData();
		cccBancoQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(cccBanco.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"cccBancoFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"cccBancoFrm\",1, false)");
					asignarAtributo("COMBO","paisOidPais", "ontab", "ejecutarAccionFocoModificacion(\"cccBancoFrm\",2, true)");
					asignarAtributo("COMBO","paisOidPais", "onshtab", "ejecutarAccionFocoModificacion(\"cccBancoFrm\",2, false)");
				asignarAtributo("AREATEXTO", "codBanc", "ontab","ejecutarAccionFocoModificacion(\"cccBancoFrm\",3, true)");
				asignarAtributo("AREATEXTO", "codBanc", "onshtab","ejecutarAccionFocoModificacion(\"cccBancoFrm\",3, false)");
				asignarAtributo("AREATEXTO", "desBanc", "ontab","ejecutarAccionFocoModificacion(\"cccBancoFrm\",4, true)");
				asignarAtributo("AREATEXTO", "desBanc", "onshtab","ejecutarAccionFocoModificacion(\"cccBancoFrm\",4, false)");
				asignarAtributo("AREATEXTO", "codBrio", "ontab","ejecutarAccionFocoModificacion(\"cccBancoFrm\",5, true)");
				asignarAtributo("AREATEXTO", "codBrio", "onshtab","ejecutarAccionFocoModificacion(\"cccBancoFrm\",5, false)");
				asignarAtributo("AREATEXTO", "codSwifInfo", "ontab","ejecutarAccionFocoModificacion(\"cccBancoFrm\",6, true)");
				asignarAtributo("AREATEXTO", "codSwifInfo", "onshtab","ejecutarAccionFocoModificacion(\"cccBancoFrm\",6, false)");
				asignarAtributo("AREATEXTO", "valObsBanc", "ontab","ejecutarAccionFocoModificacion(\"cccBancoFrm\",7, true)");
				asignarAtributo("AREATEXTO", "valObsBanc", "onshtab","ejecutarAccionFocoModificacion(\"cccBancoFrm\",7, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","cccBancoTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","cccBancoTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codBanc...");		
				
					traza("MMG: en desactivateNonModifyFields encontrado atributo no editable...");
				
						// borrarCampo("codBanc");
						asignarAtributo ("TEXT", "codBanc", "disabled", "S");
				traza("MMG: el atributo es desBanc...");		
				
				traza("MMG: el atributo es codBrio...");		
				
				traza("MMG: el atributo es codSwifInfo...");		
				
				traza("MMG: el atributo es valObsBanc...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","cccBancoFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","cccBancoListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","cccBancoListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(CccBancoData cccBanco) throws Exception{
		...
		if(cccBanco != null && cccBanco.getPaisOidPais() != null){
				checkCombo("paisOidPais" , cccBanco.getPaisOidPais().getId().toString());
			}
	...
	* @param cccBanco La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(CccBancoData cccBanco) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		CccBancoData cccBanco = 
			(CccBancoData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(cccBanco.getPaisOidPais() != null){
			cccBanco.setPaisOidPais((es.indra.belcorp.mso.SegPaisViewData)
			getSingleObject(BUSINESSID_PAISOIDPAIS_QUERY, 
			cccBanco.getPaisOidPais(),
			cccBanco.getPaisOidPais().clone(),
			"segPaisView"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(cccBanco);
		loadLeafDependenceCombos(cccBanco);
	}
