...
public class CccTipoTransViewConectorQueryForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad CccTipoTransView" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGCccTipoTransViewQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGCccTipoTransViewQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","CccTipoTransViewFormFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(8)).setAttribute("NOMBRE","codTipoTranCheq" );
