...
public class IncPartiConcuCabecConectorQueryForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad IncPartiConcuCabec" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGIncPartiConcuCabecQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGIncPartiConcuCabecQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","IncPartiConcuCabecFormFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","valGrupClie" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(9)).setAttribute("NOMBRE","diriOidDiri" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(10)).setAttribute("NOMBRE","desDesc" );
