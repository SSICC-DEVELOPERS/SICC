...
public class contenido_no_asistentes_seleccionar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_no_asistentes_seleccionar" );
      ...
      ((Element)v.get(1)).setAttribute("src","contenido_no_asistentes_seleccionar.js" );
      ...
      ((Element)v.get(5)).setAttribute("valor","LPSegundaConvocatoria" );
      ((Element)v.get(4)).appendChild((Element)v.get(5));
      /* Termina nodo:5   */

      /* Empieza nodo:6 / Elemento padre: 4   */
      v.add(doc.createElement("VAR"));
      ((Element)v.get(6)).setAttribute("nombre","oidAsigna" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(8)).setAttribute("nombre","marca" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(9)).setAttribute("nombre","canal" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(36)).setAttribute("nombre","lblCodCurso" );
      ...
      ((Element)v.get(36)).setAttribute("cod","715" );
      ...
      ((Element)v.get(43)).setAttribute("nombre","txtCodCurso" );
      ((Element)v.get(43)).setAttribute("id","datosCampos" );
      ((Element)v.get(43)).setAttribute("max","3" );
      ((Element)v.get(43)).setAttribute("tipo","" );
      ((Element)v.get(43)).setAttribute("onchange","" );
      ((Element)v.get(43)).setAttribute("onblur","validarCodCurso();" );
      ((Element)v.get(43)).setAttribute("onshtab","document.all['btnAceptar'].focus();" );
      ((Element)v.get(43)).setAttribute("req","N" );
      ((Element)v.get(43)).setAttribute("size","3" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(59)).setAttribute("nombre","btnAceptar" );
      ((Element)v.get(59)).setAttribute("ID","botonContenido" );
      ((Element)v.get(59)).setAttribute("tipo","html" );
      ((Element)v.get(59)).setAttribute("accion","onClickAceptar()" );
      ((Element)v.get(59)).setAttribute("ontab","focaliza(FORMULARIO+'.txtCodCurso');" );
      ((Element)v.get(59)).setAttribute("estado","false" );
      ((Element)v.get(59)).setAttribute("cod","12" );
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(65)).setAttribute("width","756" );
