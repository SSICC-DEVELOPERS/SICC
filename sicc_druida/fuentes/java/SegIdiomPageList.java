...
public class SegIdiomPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","segIdiomList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","SegIdiom.codIdio.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","SegIdiom.Descripcion.label" );
      ...
      ((Element)v.get(17)).setAttribute("cod","SegIdiom.indIdioTrad.label" );
      ...
      ((Element)v.get(18)).setAttribute("cod","SegIdiom.codIsoIdio.label" );
