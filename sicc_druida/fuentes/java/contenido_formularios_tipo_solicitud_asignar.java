...
public class contenido_formularios_tipo_solicitud_asignar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_formularios_tipo_solicitud_asignar" );
      ((Element)v.get(0)).setAttribute("cod","0675" );
      ((Element)v.get(0)).setAttribute("titulo","" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","Asignar Formularios a Tipo de Solicitud" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","contenido_formularios_tipo_solicitud_asignar.js" );
      ...
      v.add(doc.createTextNode("\r\r   #alineadoderechaF {      text-align:right      }\r\r   "));
      ...
      ((Element)v.get(9)).setAttribute("nombre","frm" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(14)).setAttribute("nombre","cadena" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(31)).setAttribute("cod","00275" );
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(35)).setAttribute("width","620" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(50)).setAttribute("disabled","" );
      ((Element)v.get(50)).setAttribute("onshtab","document.all['btnAceptar'].focus();" );
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(55)).setAttribute("colspan","9" );
      ...
      ((Element)v.get(67)).setAttribute("nombre","btnAceptar" );
      ...
      ((Element)v.get(67)).setAttribute("cod","12" );
      ((Element)v.get(67)).setAttribute("disabled","" );
      ((Element)v.get(67)).setAttribute("ontab","focaliza('frm.cbTipoSolicitud');" );
      ((Element)v.get(67)).setAttribute("accion","aceptar();" );
      ...
      /* Empieza nodo:70 / Elemento padre: 17   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(17)).appendChild((Element)v.get(70));
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(77)).setAttribute("nombre","capaLista" );
      ((Element)v.get(77)).setAttribute("alto","350" );
      ...
      ((Element)v.get(77)).setAttribute("visibilidad","hidden" );
      ((Element)v.get(77)).setAttribute("contravsb","" );
      ((Element)v.get(77)).setAttribute("x","0" );
      ((Element)v.get(77)).setAttribute("y","123" );
      ...
      ((Element)v.get(78)).setAttribute("ancho","624" );
      ((Element)v.get(78)).setAttribute("alto","278" );
      ((Element)v.get(78)).setAttribute("x","12" );
      ((Element)v.get(78)).setAttribute("y","0" );
      ...
      ((Element)v.get(86)).setAttribute("cod","00388" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(89)).setAttribute("ancho","110" );
      ...
      ((Element)v.get(95)).setAttribute("ajustarAMitadInf","S" );
      ...
      ((Element)v.get(96)).setAttribute("cod","819" );
      ((Element)v.get(95)).appendChild((Element)v.get(96));

      /* Elemento padre:96 / Elemento actual: 97   */
      v.add(doc.createTextNode("Cód. formulario"));
      ...
      ((Element)v.get(102)).setAttribute("cod","1920" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createTextNode("Oid formulario"));
      ...
      ((Element)v.get(110)).setAttribute("maxSel","0" );
      ...
      ((Element)v.get(116)).setAttribute("nombre","Orden" );
      ...
      ((Element)v.get(116)).setAttribute("onBlur","ordenOnBlur(FILAEVENTO);" );
      ((Element)v.get(116)).setAttribute("onTab","focalizaSiguiente(FILAEVENTO,TECLAEVENTO)" );
      ((Element)v.get(116)).setAttribute("onShTab","focalizaAnterior(FILAEVENTO, TECLAEVENTO)" );
      ...
      ((Element)v.get(119)).setAttribute("nombre","mipgndo" );
      ((Element)v.get(119)).setAttribute("ancho","624" );
      ((Element)v.get(119)).setAttribute("sep","$" );
      ((Element)v.get(119)).setAttribute("x","12" );
      ((Element)v.get(119)).setAttribute("class","botonera" );
      ((Element)v.get(119)).setAttribute("y","277" );
      ((Element)v.get(119)).setAttribute("control","|" );
      ((Element)v.get(119)).setAttribute("conector","" );
      ((Element)v.get(119)).setAttribute("rowset","" );
      ((Element)v.get(119)).setAttribute("cargainicial","N" );
      ((Element)v.get(119)).setAttribute("onload","procesarPaginado(mipgndo,msgError, ultima, rowset, 'muestraLista(ultima, rowset)')" );
      ((Element)v.get(78)).appendChild((Element)v.get(119));

      /* Empieza nodo:120 / Elemento padre: 119   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(120)).setAttribute("nombre","ret1" );
      ((Element)v.get(120)).setAttribute("x","37" );
      ((Element)v.get(120)).setAttribute("y","281" );
      ((Element)v.get(120)).setAttribute("ID","botonContenido" );
      ((Element)v.get(120)).setAttribute("img","retroceder_on" );
      ...
      ((Element)v.get(120)).setAttribute("accion","mipgndo.retroceder();" );
      ((Element)v.get(119)).appendChild((Element)v.get(120));
      /* Termina nodo:120   */

      /* Empieza nodo:121 / Elemento padre: 119   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(121)).setAttribute("nombre","ava1" );
      ((Element)v.get(121)).setAttribute("x","52" );
      ((Element)v.get(121)).setAttribute("y","281" );
      ((Element)v.get(121)).setAttribute("ID","botonContenido" );
      ((Element)v.get(121)).setAttribute("img","avanzar_on" );
   ...
   private void getXML540(Document doc) {
      ((Element)v.get(121)).setAttribute("accion","mipgndo.avanzar();" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(122)).setAttribute("nombre","primera1" );
      ((Element)v.get(122)).setAttribute("x","20" );
      ((Element)v.get(122)).setAttribute("y","281" );
      ((Element)v.get(122)).setAttribute("ID","botonContenido" );
      ((Element)v.get(122)).setAttribute("img","primera_on" );
      ((Element)v.get(122)).setAttribute("tipo","-2" );
      ((Element)v.get(122)).setAttribute("estado","false" );
      ((Element)v.get(122)).setAttribute("alt","" );
      ((Element)v.get(122)).setAttribute("codigo","" );
      ((Element)v.get(122)).setAttribute("accion","mipgndo.retrocederPrimeraPagina();" );
      ((Element)v.get(77)).appendChild((Element)v.get(122));
      /* Termina nodo:122   */

      /* Empieza nodo:123 / Elemento padre: 77   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(123)).setAttribute("nombre","separa" );
      ((Element)v.get(123)).setAttribute("x","59" );
      ((Element)v.get(123)).setAttribute("y","281" );
      ((Element)v.get(123)).setAttribute("ID","botonContenido" );
      ((Element)v.get(123)).setAttribute("img","separa_base" );
      ...
      ((Element)v.get(77)).appendChild((Element)v.get(123));
      /* Termina nodo:123   */
      /* Termina nodo:77   */

      /* Empieza nodo:124 / Elemento padre: 9   */
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(124)).setAttribute("nombre","capaEspacio" );
      ((Element)v.get(124)).setAttribute("alto","12" );
      ...
      ((Element)v.get(124)).setAttribute("y","401" );
      ((Element)v.get(124)).setAttribute("zindex","" );
      ((Element)v.get(9)).appendChild((Element)v.get(124));
      /* Termina nodo:124   */
      /* Termina nodo:9   */
