...
public class MaeRespuEncueViewPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","maeRespuEncueViewList" );
      ...
      ((Element)v.get(14)).setAttribute("cod","MaeRespuEncueView.codResp.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","MaeRespuEncueView.valPeso.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","MaeRespuEncueView.Descripcion.label" );
