/*
    INDRA/CAR/mmg
    $Id: CalTipoEstadContaLPStartUp.java,v 1.1 2009/12/03 18:37:24 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class CalTipoEstadContaLPStartUp extends MMGDruidaBase{
	...
	public static final String BUSINESSID_QUERY = "MMGCalTipoEstadContaQueryFromToUserPage";
	...
	public CalTipoEstadContaLPStartUp(){
		super();
	}

	public void inicio() throws Exception {
		pagina("CalTipoEstadContaPage");
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			buildJsPageSize("CalTipoEstadConta");
			...
			asignarAtributo("PAGINA", "CalTipoEstadContaPage", "cod", "CalTipoEstadConta." + accion + ".label");
			...
			limpiarBotoneraLista("calTipoEstadConta", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codEsta", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 2);");
		...
		//asignarAtributo("CAPA", "calTipoEstadContaLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "CalTipoEstadContaPage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("CalTipoEstadContaLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		CalTipoEstadContaData calTipoEstadContaQuery= new CalTipoEstadContaData();
		calTipoEstadContaQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		CalTipoEstadContaData datosResult = (CalTipoEstadContaData)getSingleObject(BUSINESSID_QUERY, calTipoEstadContaQuery, 
			calTipoEstadContaQuery.clone(), "calTipoEstadConta");
		...
		preservaHiddensI18n(new Integer(1), "CAL_TIPO_ESTAD_CONTA", "calTipoEstadContaFrm", "Descripcion", true);
		...
		CalTipoEstadContaData calTipoEstadConta = datosResult;
		asignar("TEXT", "Descripcion", FormatUtils.formatObject(calTipoEstadConta.getDescripcion(), 
		...
		loadLocalizationVars(calTipoEstadConta);
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "CAL_TIPO_ESTAD_CONTA", "calTipoEstadContaFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('calTipoEstadContaFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "calTipoEstadContaFrm", "oculto", "N");
		...
		traza("MMG::Creando CalTipoEstadConta");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		CalTipoEstadContaData calTipoEstadContaQuery= new CalTipoEstadContaData();
		calTipoEstadContaQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(calTipoEstadConta.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"calTipoEstadContaFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"calTipoEstadContaFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codEsta", "ontab","ejecutarAccionFocoModificacion(\"calTipoEstadContaFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codEsta", "onshtab","ejecutarAccionFocoModificacion(\"calTipoEstadContaFrm\",2, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"calTipoEstadContaFrm\",3, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"calTipoEstadContaFrm\",3, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","calTipoEstadContaTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","calTipoEstadContaTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","calTipoEstadContaFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","calTipoEstadContaListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","calTipoEstadContaListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(CalTipoEstadContaData calTipoEstadConta) throws Exception{
	...
	* @param calTipoEstadConta La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(CalTipoEstadContaData calTipoEstadConta) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		CalTipoEstadContaData calTipoEstadConta = 
			(CalTipoEstadContaData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(calTipoEstadConta);
		loadLeafDependenceCombos(calTipoEstadConta);
	}
	...
	*/
	...
	protected void loadLocalizationVars(CalTipoEstadContaData calTipoEstadConta) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("CAL_TIPO_ESTAD_CONTA");
		mmgLocalizationQuery.setEntiPk(calTipoEstadConta.getId());
