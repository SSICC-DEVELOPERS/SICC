/*
    INDRA/CAR/mmg
    $Id: CalMotivContaLPStartUp.java,v 1.1 2009/12/03 18:40:46 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class CalMotivContaLPStartUp extends MMGDruidaBase{
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "CalMotivContaPage", "cod", "CalMotivConta." + accion + ".label");
			...
			limpiarBotoneraLista("calMotivConta", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codMoti", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 2);");
		asignarAtributo("TEXT", "Descripcion", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 40);");
		asignarAtributo("TEXT", "codProc", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 0, 40);");
		
		//Primero determianmos el nombre del campo en la entidad de oriegen donde se van a cargar los datos
		asignar("VAR", "idAttributeLovOpener", conectorParametro(PARAMETRO_LOV_ATTRIBUTO));
		asignar("VAR", "idEntityLovOpener", conectorParametro(PARAMETRO_LOV_ENTIDAD));
		//asignarAtributo("CAPA", "calMotivContaLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "CalMotivContaPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		CalMotivContaData calMotivContaQuery= new CalMotivContaData();
		calMotivContaQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		CalMotivContaData datosResult = (CalMotivContaData)getSingleObject(BUSINESSID_QUERY, calMotivContaQuery, 
			calMotivContaQuery.clone(), "calMotivConta");
		...
		preservaHiddensI18n(new Integer(1), "CAL_MOTIV_CONTA", "calMotivContaFrm", "Descripcion", true);
		...
		CalMotivContaData calMotivConta = datosResult;
		asignar("TEXT", "codMoti", FormatUtils.formatObject(calMotivConta.getCodMoti(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "Descripcion", FormatUtils.formatObject(calMotivConta.getDescripcion(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "codProc", FormatUtils.formatObject(calMotivConta.getCodProc(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		loadLocalizationVars(calMotivConta);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "codMoti", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "CAL_MOTIV_CONTA", "calMotivContaFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "codMoti", "req", "S");
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('calMotivContaFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "calMotivContaFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		CalMotivContaData calMotivContaQuery= new CalMotivContaData();
		calMotivContaQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(calMotivConta.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"calMotivContaFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"calMotivContaFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codMoti", "ontab","ejecutarAccionFocoModificacion(\"calMotivContaFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codMoti", "onshtab","ejecutarAccionFocoModificacion(\"calMotivContaFrm\",2, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"calMotivContaFrm\",3, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"calMotivContaFrm\",3, false)");
				asignarAtributo("AREATEXTO", "codProc", "ontab","ejecutarAccionFocoModificacion(\"calMotivContaFrm\",4, true)");
				asignarAtributo("AREATEXTO", "codProc", "onshtab","ejecutarAccionFocoModificacion(\"calMotivContaFrm\",4, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","calMotivContaTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","calMotivContaTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codMoti...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","calMotivContaFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","calMotivContaListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","calMotivContaListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(CalMotivContaData calMotivConta) throws Exception{
	...
	* @param calMotivConta La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(CalMotivContaData calMotivConta) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		CalMotivContaData calMotivConta = 
			(CalMotivContaData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(calMotivConta);
		loadLeafDependenceCombos(calMotivConta);
	}
	...
	*/
	...
	protected void loadLocalizationVars(CalMotivContaData calMotivConta) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("CAL_MOTIV_CONTA");
		mmgLocalizationQuery.setEntiPk(calMotivConta.getId());
