...
public class SegMarcaCorpoMarcaProduPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","segMarcaCorpoMarcaProduList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","SegMarcaCorpoMarcaProdu.marcOidMarc.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","SegMarcaCorpoMarcaProdu.maprOidMarcProd.label" );
