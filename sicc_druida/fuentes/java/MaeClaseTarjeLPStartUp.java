/*
    INDRA/CAR/mmg
    $Id: MaeClaseTarjeLPStartUp.java,v 1.1 2009/12/03 18:40:44 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class MaeClaseTarjeLPStartUp extends MMGDruidaBase{
	...
	public static final String BUSINESSID_QUERY = "MMGMaeClaseTarjeQueryFromToUserPage";
	...
	public MaeClaseTarjeLPStartUp(){
		super();
	}

	public void inicio() throws Exception {
		pagina("MaeClaseTarjePage");
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "MaeClaseTarjePage", "cod", "MaeClaseTarje." + accion + ".label");
			...
			limpiarBotoneraLista("maeClaseTarje", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codClasTarj", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 2);");
		asignarAtributo("TEXT", "desClasTarj", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 0, 40);");
		
		//Primero determianmos el nombre del campo en la entidad de oriegen donde se van a cargar los datos
		asignar("VAR", "idAttributeLovOpener", conectorParametro(PARAMETRO_LOV_ATTRIBUTO));
		asignar("VAR", "idEntityLovOpener", conectorParametro(PARAMETRO_LOV_ENTIDAD));
		//asignarAtributo("CAPA", "maeClaseTarjeLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "MaeClaseTarjePage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("MaeClaseTarjeLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		MaeClaseTarjeData maeClaseTarjeQuery= new MaeClaseTarjeData();
		maeClaseTarjeQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		MaeClaseTarjeData datosResult = (MaeClaseTarjeData)getSingleObject(BUSINESSID_QUERY, maeClaseTarjeQuery, 
			maeClaseTarjeQuery.clone(), "maeClaseTarje");
		...
		MaeClaseTarjeData maeClaseTarje = datosResult;
		asignar("TEXT", "codClasTarj", FormatUtils.formatObject(maeClaseTarje.getCodClasTarj(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "desClasTarj", FormatUtils.formatObject(maeClaseTarje.getDesClasTarj(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		asignarAtributo("TEXT", "codClasTarj", "disabled", "S");
		asignarAtributo("TEXT", "desClasTarj", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		...
		asignarAtributo("TEXT", "codClasTarj", "req", "S");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "maeClaseTarjeFrm", "oculto", "N");
		...
		traza("MMG::Creando MaeClaseTarje");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		MaeClaseTarjeData maeClaseTarjeQuery= new MaeClaseTarjeData();
		maeClaseTarjeQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(maeClaseTarje.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"maeClaseTarjeFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"maeClaseTarjeFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codClasTarj", "ontab","ejecutarAccionFocoModificacion(\"maeClaseTarjeFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codClasTarj", "onshtab","ejecutarAccionFocoModificacion(\"maeClaseTarjeFrm\",2, false)");
				asignarAtributo("AREATEXTO", "desClasTarj", "ontab","ejecutarAccionFocoModificacion(\"maeClaseTarjeFrm\",3, true)");
				asignarAtributo("AREATEXTO", "desClasTarj", "onshtab","ejecutarAccionFocoModificacion(\"maeClaseTarjeFrm\",3, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","maeClaseTarjeTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","maeClaseTarjeTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codClasTarj...");		
				
					traza("MMG: en desactivateNonModifyFields encontrado atributo no editable...");
				
						// borrarCampo("codClasTarj");
						asignarAtributo ("TEXT", "codClasTarj", "disabled", "S");
				traza("MMG: el atributo es desClasTarj...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","maeClaseTarjeFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","maeClaseTarjeListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","maeClaseTarjeListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(MaeClaseTarjeData maeClaseTarje) throws Exception{
	...
	* @param maeClaseTarje La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(MaeClaseTarjeData maeClaseTarje) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		MaeClaseTarjeData maeClaseTarje = 
			(MaeClaseTarjeData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(maeClaseTarje);
		loadLeafDependenceCombos(maeClaseTarje);
	}
