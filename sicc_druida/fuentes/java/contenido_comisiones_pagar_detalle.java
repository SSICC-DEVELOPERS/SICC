...
public class contenido_comisiones_pagar_detalle  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_comisiones_pagar_detalle" );
      ((Element)v.get(0)).setAttribute("cod","0522" );
      ((Element)v.get(0)).setAttribute("titulo","Pagar Comisiones" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","contenido_comisiones_pagar_detalle.js" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(9)).setAttribute("nombre","txtFechaCalculo" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(12)).setAttribute("nombre","accionCorrecta" );
      ((Element)v.get(12)).setAttribute("valor","accionCorrecta()" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(26)).setAttribute("vertical","0" );
      ...
      ((Element)v.get(28)).setAttribute("cod","00390" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(45)).setAttribute("cod","1869" );
      ...
      ((Element)v.get(47)).setAttribute("cod","16" );
      ...
      ((Element)v.get(48)).setAttribute("cod","17" );
      ...
      ((Element)v.get(50)).setAttribute("cod","94" );
      ...
      ((Element)v.get(51)).setAttribute("cod","276" );
      ...
      ((Element)v.get(53)).setAttribute("cod","573" );
      ...
      ((Element)v.get(54)).setAttribute("cod","790" );
   }
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(56)).setAttribute("cod","1857" );
      ...
      ((Element)v.get(57)).setAttribute("cod","1715" );
      ...
      ((Element)v.get(58)).setAttribute("maxSel","0" );
      ...
      ((Element)v.get(73)).setAttribute("nombre","mipgndo" );
      ((Element)v.get(73)).setAttribute("ancho","400" );
      ((Element)v.get(73)).setAttribute("sep","$" );
      ((Element)v.get(73)).setAttribute("x","12" );
      ((Element)v.get(73)).setAttribute("class","botonera" );
      ((Element)v.get(73)).setAttribute("y","306" );
      ((Element)v.get(73)).setAttribute("control","|" );
   }

   private void getXML360(Document doc) {
      ((Element)v.get(73)).setAttribute("conector","conectorSandra" );
      ((Element)v.get(73)).setAttribute("rowset","" );
      ((Element)v.get(73)).setAttribute("cargainicial","N" );
      ((Element)v.get(73)).setAttribute("onload","procesarPaginado(mipgndo,msgError, ultima, rowset, 'muestraLista(ultima, rowset)');" );
      ((Element)v.get(20)).appendChild((Element)v.get(73));

      /* Empieza nodo:74 / Elemento padre: 73   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(74)).setAttribute("nombre","ret1" );
      ((Element)v.get(74)).setAttribute("x","37" );
      ((Element)v.get(74)).setAttribute("y","310" );
      ((Element)v.get(74)).setAttribute("ID","botonContenido" );
      ((Element)v.get(74)).setAttribute("img","retroceder_on" );
      ...
      ((Element)v.get(74)).setAttribute("accion","mipgndo.retroceder();" );
      ((Element)v.get(73)).appendChild((Element)v.get(74));
      /* Termina nodo:74   */

      /* Empieza nodo:75 / Elemento padre: 73   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(75)).setAttribute("nombre","ava1" );
      ((Element)v.get(75)).setAttribute("x","52" );
      ((Element)v.get(75)).setAttribute("y","310" );
      ((Element)v.get(75)).setAttribute("ID","botonContenido" );
      ((Element)v.get(75)).setAttribute("img","avanzar_on" );
      ...
      ((Element)v.get(75)).setAttribute("accion","mipgndo.avanzar();" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(76)).setAttribute("nombre","primera1" );
      ((Element)v.get(76)).setAttribute("x","20" );
      ((Element)v.get(76)).setAttribute("y","310" );
      ((Element)v.get(76)).setAttribute("ID","botonContenido" );
      ((Element)v.get(76)).setAttribute("img","primera_on" );
      ((Element)v.get(76)).setAttribute("tipo","-2" );
      ((Element)v.get(76)).setAttribute("estado","false" );
      ((Element)v.get(76)).setAttribute("alt","" );
      ((Element)v.get(76)).setAttribute("codigo","" );
      ((Element)v.get(76)).setAttribute("accion","mipgndo.retrocederPrimeraPagina();" );
      ((Element)v.get(5)).appendChild((Element)v.get(76));
      /* Termina nodo:76   */

      /* Empieza nodo:77 / Elemento padre: 5   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(77)).setAttribute("nombre","separa" );
      ((Element)v.get(77)).setAttribute("x","59" );
      ((Element)v.get(77)).setAttribute("y","306" );
      ((Element)v.get(77)).setAttribute("ID","botonContenido" );
      ((Element)v.get(77)).setAttribute("img","separa_base" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(78)).setAttribute("nombre","btnPagarComision" );
      ((Element)v.get(78)).setAttribute("x","80" );
      ((Element)v.get(78)).setAttribute("y","307" );
      ...
      ((Element)v.get(78)).setAttribute("accion","onClickPagarComision();" );
      ((Element)v.get(78)).setAttribute("ontab","tabulador()" );
      ((Element)v.get(78)).setAttribute("onshtab","tabulador()" );
      ((Element)v.get(78)).setAttribute("cod","0522" );
      ...
      ((Element)v.get(79)).setAttribute("y","329" );
