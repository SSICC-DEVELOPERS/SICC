/*
    INDRA/CAR/mmg
    $Id: PreIndicCuadrLPStartUp.java,v 1.1 2009/12/03 18:43:36 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class PreIndicCuadrLPStartUp extends MMGDruidaBase{
	...
	public static final String BUSINESSID_QUERY = "MMGPreIndicCuadrQueryFromToUserPage";
	
	
		
	//Hashtables con los valores estáticos de radiobuttons y combos
	protected static Hashtable valFactCuadValues = new Hashtable();
	static{
		valFactCuadValues.put(new java.lang.String("U"), "Unidades");
		valFactCuadValues.put(new java.lang.String("M"), "Monto");
	}
	
	
	// Definicion del constructor
	public PreIndicCuadrLPStartUp(){
		super();
	}

	public void inicio() throws Exception {
		pagina("PreIndicCuadrPage");
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "PreIndicCuadrPage", "cod", "PreIndicCuadr." + accion + ".label");
			...
			limpiarBotoneraLista("preIndicCuadr", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codIndiCuad", "validacion", "mensaje = ValidaInt(cdos_trim(valor), 1, 0, 9);");
		...
		//asignarAtributo("CAPA", "preIndicCuadrLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "PreIndicCuadrPage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("PreIndicCuadrLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		PreIndicCuadrData preIndicCuadrQuery= new PreIndicCuadrData();
		preIndicCuadrQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		PreIndicCuadrData datosResult = (PreIndicCuadrData)getSingleObject(BUSINESSID_QUERY, preIndicCuadrQuery, 
			preIndicCuadrQuery.clone(), "preIndicCuadr");
		...
		preservaHiddensI18n(new Integer(1), "PRE_INDIC_CUADR", "preIndicCuadrFrm", "Descripcion", true);
		
		
		//Guardamos los valores de los radiobuttons
		if(datosResult.getValFactCuad() != null)
			asignar("VAR", "valFactCuadCheckValue", datosResult.getValFactCuad().toString());
		...
		PreIndicCuadrData preIndicCuadr = datosResult;
		asignar("TEXT", "codIndiCuad", FormatUtils.formatObject(preIndicCuadr.getCodIndiCuad(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "Descripcion", FormatUtils.formatObject(preIndicCuadr.getDescripcion(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignarAtributo("RADIOB", "valFactCuad" , "valor", FormatUtils.formatObject(
			preIndicCuadr.getValFactCuad(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		loadLocalizationVars(preIndicCuadr);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "codIndiCuad", "disabled", "S");
		asignarAtributo("TEXT", "Descripcion", "disabled", "S");
		
					asignarAtributo("RADIOB", "valFactCuad", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "PRE_INDIC_CUADR", "preIndicCuadrFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "codIndiCuad", "req", "S");
		asignarAtributo("TEXT", "Descripcion", "req", "S");
		asignarAtributo("RADIOB", "valFactCuad", "req", "S");
		
		
		//Asiganamos a los campos internacionalizables la función de onblur para actualizar el 
		//valor del idioma por defecto
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('preIndicCuadrFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "preIndicCuadrFrm", "oculto", "N");
		...
		traza("MMG::Creando PreIndicCuadr");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		PreIndicCuadrData preIndicCuadrQuery= new PreIndicCuadrData();
		preIndicCuadrQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(preIndicCuadr.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"preIndicCuadrFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"preIndicCuadrFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codIndiCuad", "ontab","ejecutarAccionFocoModificacion(\"preIndicCuadrFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codIndiCuad", "onshtab","ejecutarAccionFocoModificacion(\"preIndicCuadrFrm\",2, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"preIndicCuadrFrm\",3, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"preIndicCuadrFrm\",3, false)");
				asignarAtributo("TEXT", "valFactCuad", "ontab","ejecutarAccionFocoModificacion(\"preIndicCuadrFrm\",4, true)");
				asignarAtributo("TEXT", "valFactCuad", "onshtab","ejecutarAccionFocoModificacion(\"preIndicCuadrFrm\",4, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","preIndicCuadrTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","preIndicCuadrTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codIndiCuad...");		
				
				traza("MMG: el atributo es Descripcion...");		
				
				traza("MMG: el atributo es valFactCuad...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","preIndicCuadrFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","preIndicCuadrListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","preIndicCuadrListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(PreIndicCuadrData preIndicCuadr) throws Exception{
	...
	* @param preIndicCuadr La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(PreIndicCuadrData preIndicCuadr) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		PreIndicCuadrData preIndicCuadr = 
			(PreIndicCuadrData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(preIndicCuadr);
		loadLeafDependenceCombos(preIndicCuadr);
	}
	...
	*/
	...
	protected void loadLocalizationVars(PreIndicCuadrData preIndicCuadr) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("PRE_INDIC_CUADR");
		mmgLocalizationQuery.setEntiPk(preIndicCuadr.getId());
