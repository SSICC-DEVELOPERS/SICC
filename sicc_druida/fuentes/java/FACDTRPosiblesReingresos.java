...
public class FACDTRPosiblesReingresos extends LPSICCBase {           
   public FACDTRPosiblesReingresos() {	 
     super();
  }
     ...
     try {
        ...
        if (accion.equals("generar")){
          ...
          //cargarPagina();
                 ...
                 cargarPagina();
                 getConfiguracionMenu("FACDTRPosiblesReingresos");
        }
  ...
  private void cargarPagina() throws Exception{
     ...
     asignarAtributoPagina("cod","0813");     
     ...
     asignarAtributo("VAR", "lp", "valor", "FACDTRPosiblesReingresos");
 ...
 private void generarReporte() throws Exception{
     ...
     datos.put(ConstantesREP.TITULO, "Listado de Posibles Reingresos");     
     traza("++++++Antes de enviar a reportes " + datos); 
     
     String formato = conectorParametroLimpia("formato", "", true);
     
       
     //ejecutarReporte(datos, "REPGenerarReporte", "RFD-009", formato);
     ejecutarReporte2(datos, "REPGenerarReporteBatch", "RD_RFD-009", formato);
