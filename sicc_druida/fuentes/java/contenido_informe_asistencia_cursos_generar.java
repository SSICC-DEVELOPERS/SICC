...
public class contenido_informe_asistencia_cursos_generar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_informe_asistencia_cursos_generar" );
      ((Element)v.get(0)).setAttribute("cod","0797" );
      ((Element)v.get(0)).setAttribute("titulo","Generar Informe Relación de Asistencia a Cursos" );
      ...
      v.add(doc.createTextNode("\r   \r   \r   function onLoad(){\r      configurarMenuSecundario('Formulario');\r      fMostrarMensajeError();\r      setearPais();\r      focaliza('Formulario.cbPais');\r   }\r   function generar(formato){\r     /*recolectarParametros();\r     set('Formulario.conectorAction', 'EDURelacionAsistenciaCursos');           \r     set('Formulario.accion', 'generar');\r     enviaSICC('Formulario');*/\r     var a = new Object();\r     a.accion = 'generar';\r     a.paisSelec = get('Formulario.cbPais');  \r     a.marca = get('Formulario.cbMarca');\r     a.canal = get('Formulario.cbCanal');\r     a.codigoCurso = get('Formulario.cbCodCurso');\r     a.region = get('Formulario.cbRegion');\r     a.zona = get('Formulario.cbZona');         \r     mostrarModalSICC('EDURelacionAsistenciaCursos','generar', a);  \r   }\r\r   function recolectarParametros(){\r      \r           \r      set('Formulario.paisSelec', get('Formulario.cbPais') );  \r      set('Formulario.marca', get('Formulario.cbMarca'));\r      set('Formulario.canal', get('Formulario.cbCanal'));\r      set('Formulario.codigoCurso', get('Formulario.cbCodCurso'));\r      set('Formulario.region', get('Formulario.cbRegion'))\r      set('Formulario.zona', get('Formulario.cbZona'));\r      \r        \r   \r   }\r \r   \r\r   function fLimpiar(){\r      var aCombo = new Array(new Array(\"\",\"\"));\r      set_combo('Formulario.cbRegion', aCombo, []);\r      set_combo('Formulario.cbZona', aCombo, []);\r      set_combo('Formulario.cbCodCurso', aCombo, []);\r      \r      \r      focaliza('Formulario.cbPais');\r \r   }\r   \r    function onchangeMarcaCanal(){\r       \r       marca  = get('Formulario.cbMarca');\r       canal  = get('Formulario.cbCanal');\r       pais   = get('Formulario.cbPais');\r     \r       if(marca != '' && canal != '' && pais != ''){\r          \r          var arr = new Array();\r          \r          arr[arr.length] = [\"oidPais\", pais]; \r          arr[arr.length] = [\"oidMarca\", marca];\r          arr[arr.length] = [\"oidCanal\", canal];\r          \r          recargaCombo(\"Formulario.cbRegion\",\"ZONRecargaRegiones\", \"es.indra.sicc.dtos.zon.DTOUnidadAdministrativa\",arr); \r          recargaCombo(\"Formulario.cbCodCurso\",\"EDUObtieneCodigoCurso\", \"es.indra.sicc.dtos.edu.DTORelacionesCurso\",arr); \r          \r      }else{\r          \r          var aCombo = new Array(new Array(\"\",\"\"));\r          set_combo('Formulario.cbCodCurso', aCombo, []);\r         \r      }\r      \r    }\r \r\r   function setearPais(){\r      var pais = get('Formulario.pais');\r      \r      iSeleccionado = new Array(); \r      iSeleccionado[0] = pais;\r      set('Formulario.cbPais',iSeleccionado);\r   }\r   \r\r\r   function onchange_Region(){\r         if(get('Formulario.cbRegion') != ''){\r              recargaCombo('Formulario.cbZona', 'ZONRecargaZonas', 'es.indra.sicc.dtos.zon.DTOUnidadAdministrativa',[[ \"oidRegion\", get('Formulario.cbRegion') ]] );\r         }\r    }\r\r   \r"));
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(17)).setAttribute("nombre","codigoCurso" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(93)).setAttribute("nombre","cbCodCurso" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(111)).setAttribute("nombre","lblZona" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(118)).setAttribute("onchange","onchange_Region();" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(123)).setAttribute("nombre","cbZona" );
      ...
      /* Empieza nodo:132 / Elemento padre: 21   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(21)).appendChild((Element)v.get(132));
      ...
      ((Element)v.get(140)).setAttribute("ontab","focaliza('Formulario.cbPais')" );
