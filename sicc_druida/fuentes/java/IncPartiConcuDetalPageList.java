...
public class IncPartiConcuDetalPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","incPartiConcuDetalList" );
      ...
      ((Element)v.get(15)).setAttribute("height","20" );
      ((Element)v.get(15)).setAttribute("IDScroll","EstCab" );
   }

   private void getXML90(Document doc) {
      ((Element)v.get(15)).setAttribute("imgFondo","" );
      ((Element)v.get(15)).setAttribute("colFondo","#CCCCCC" );
      ...
      ((Element)v.get(16)).setAttribute("cod","IncPartiConcuDetal.paciOidPartConcCabe.label" );
      ...
      ((Element)v.get(17)).setAttribute("cod","IncPartiConcuDetal.ticlOidTipoClie.label" );
      ...
      ((Element)v.get(18)).setAttribute("cod","IncPartiConcuDetal.sbtiOidSubtClie.label" );
      ...
      ((Element)v.get(19)).setAttribute("cod","IncPartiConcuDetal.tcclOidTipoClas.label" );
      ...
      ((Element)v.get(20)).setAttribute("cod","IncPartiConcuDetal.clasOidClas.label" );
      ...
      ((Element)v.get(21)).setAttribute("accion","" );
      ((Element)v.get(21)).setAttribute("tipoEnvio","seleccion" );
      ((Element)v.get(21)).setAttribute("formaEnvio","xml" );
      ((Element)v.get(21)).setAttribute("maxSel","1" );
      ((Element)v.get(21)).setAttribute("msgErrMaxSel","" );
      ((Element)v.get(21)).setAttribute("coloresScrollNativo","#D4D0C8,black,white,#D4D0C8,#D4D0C8,#ECE9E4,black" );
      ((Element)v.get(21)).setAttribute("colorROver","#D0D9E8" );
      ((Element)v.get(21)).setAttribute("onLoad","" );
      ((Element)v.get(21)).setAttribute("colorSelecc","#D0D9E8" );
