...
public class CccTipoErrorPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","cccTipoErrorList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","CccTipoError.codErro.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","CccTipoError.Descripcion.label" );
