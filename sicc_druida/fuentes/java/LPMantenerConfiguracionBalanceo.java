...
public class LPMantenerConfiguracionBalanceo extends LPSICCBase {
    ...
    public void ejecucion() throws Exception {
        traza("*** Entrada - LPMantenerConfiguracionBalanceo - ejecucion ***");
        try    {
            ...
            if (accion.equals("")) {
                if (opcionMenu.equals("insertar")) {
					...
					getConfiguracionMenu("LPMantenerConfiguracionBalanceo", opcionMenu);
					getFormatosValidaciones();
					this.cargarCombos();

                } else if (opcionMenu.equals("consultar") || opcionMenu.equals("modificar") || opcionMenu.equals("eliminar")) { 

                    pagina("contenido_configuracion_balanceo_modificar");
                ...
                pagina("contenido_configuracion_balanceo_insertar");
                asignarAtributoPagina("cod", "ApeConfBalanceo.update.label");
				getConfiguracionMenu("LPMantenerConfiguracionBalanceo", "detalleModificar");
				getFormatosValidaciones();
				...
				getConfiguracionMenu("LPMantenerConfiguracionBalanceo", accion); // accion == "detalle"
            ...
            traza("Exception en LPMantenerConfiguracionBalanceo.ejecucion()");
            e.printStackTrace();
            lanzarPaginaError(e);
        }
        traza("*** Salida - LPMantenerConfiguracionBalanceo - ejecucion ***");
    }

    public void guardar() throws Exception {
        traza("*** Entrada - LPMantenerConfiguracionBalanceo - guardar ***");
        try {
			...
			String casoUso = conectorParametroLimpia("casoDeUso", "", true); // dmorello, 27/09/2007
			...
			// dmorello, 27/09/2007: Por error reportado via mail
			if (!strOidFuncion.equals("")) {
            ...
            traza("Exception en LPMantenerConfiguracionBalanceo.guardar()");
            e.printStackTrace();
            lanzarPaginaError(e);

        }
        traza("*** Salida - LPMantenerConfiguracionBalanceo - guardar ***");
    }

    public void cargarCombos() throws Exception {
        traza("*** Entrada - LPMantenerConfiguracionBalanceo - cargarCombos ***");
        try    {
        ...
        traza("*** Salida - LPMantenerConfiguracionBalanceo - cargarCombos ***");
    }
