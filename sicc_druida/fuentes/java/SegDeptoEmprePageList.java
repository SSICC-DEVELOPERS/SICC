...
public class SegDeptoEmprePageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","segDeptoEmpreList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","SegDeptoEmpre.codDpto.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","SegDeptoEmpre.desCortDpto.label" );
