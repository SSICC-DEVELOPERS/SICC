...
public class contenido_COR_interfaz  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_COR_interfaz" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(5)).setAttribute("src","contenido_COR_interfaz.js" );
      ...
      ((Element)v.get(7)).setAttribute("name","txtFechaGenerar" );
      ((Element)v.get(7)).setAttribute("required","true" );
      ((Element)v.get(7)).setAttribute("cod","870" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(60)).setAttribute("nombre","txtFechaGenerar" );
      ...
      ((Element)v.get(60)).setAttribute("onblur","fechaValida()" );
      ((Element)v.get(60)).setAttribute("onshtab","shFecha();" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(64)).setAttribute("nombre","lbldtLote" );
   ...
   private void getXML270(Document doc) {
      ...
      /* Empieza nodo:74 / Elemento padre: 34   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(34)).appendChild((Element)v.get(74));
      ...
      ((Element)v.get(88)).setAttribute("cols","50" );
      ((Element)v.get(88)).setAttribute("id","datosCampos" );
      ((Element)v.get(88)).setAttribute("msjreq","" );
      ((Element)v.get(88)).setAttribute("nombre","areatxtObservaciones" );
      ((Element)v.get(88)).setAttribute("readonly","N" );
      ((Element)v.get(88)).setAttribute("req","N" );
      ((Element)v.get(88)).setAttribute("rows","3" );
      ((Element)v.get(88)).setAttribute("tabindex","2" );
      ((Element)v.get(88)).setAttribute("valor","" );
      ((Element)v.get(88)).setAttribute("max","100" );
   ...
   private void getXML360(Document doc) {
      ...
      /* Empieza nodo:99 / Elemento padre: 19   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(19)).appendChild((Element)v.get(99));
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(105)).setAttribute("nombre","lblInterfacesEnviar" );
      ((Element)v.get(105)).setAttribute("alto","13" );
      ((Element)v.get(105)).setAttribute("filas","1" );
      ((Element)v.get(105)).setAttribute("cod","00635" );
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(116)).setAttribute("colspan","5" );
   }
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(124)).setAttribute("nombre","ckSeguimientoPedidos" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(126)).setAttribute("nombre","lblSeguimientoPedido" );
      ...
      ((Element)v.get(126)).setAttribute("cod","2803" );
      ...
      v.add(doc.createElement("CHECKBOX"));
      ((Element)v.get(130)).setAttribute("nombre","ckConfirmacionPedidos" );
      ((Element)v.get(130)).setAttribute("id","datosCampos" );
      ((Element)v.get(130)).setAttribute("onclick","" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(132)).setAttribute("nombre","lblConfirmacionPedidos" );
      ...
      ((Element)v.get(132)).setAttribute("cod","2804" );
   ...
   private void getXML540(Document doc) {
      ...
      /* Empieza nodo:140 / Elemento padre: 19   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(19)).appendChild((Element)v.get(140));
      ...
      ((Element)v.get(148)).setAttribute("nombre","btnRecibirInterfaz" );
      ((Element)v.get(148)).setAttribute("ID","botonContenido" );
      ((Element)v.get(148)).setAttribute("tipo","html" );
      ((Element)v.get(148)).setAttribute("accion","onClickRecibirInterfaz();" );
      ((Element)v.get(148)).setAttribute("ontab","tabConfirmacion();" );
      ((Element)v.get(148)).setAttribute("estado","false" );
      ((Element)v.get(148)).setAttribute("cod","2263" );
      ...
      /* Empieza nodo:151 / Elemento padre: 19   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(19)).appendChild((Element)v.get(151));
