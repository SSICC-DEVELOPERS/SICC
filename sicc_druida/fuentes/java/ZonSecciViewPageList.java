...
public class ZonSecciViewPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","zonSecciViewList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(19)).setAttribute("cod","ZonSecciView.codSecc.label" );
      ...
      ((Element)v.get(20)).setAttribute("cod","ZonSecciView.indActi.label" );
      ...
      ((Element)v.get(21)).setAttribute("cod","ZonSecciView.indBorr.label" );
      ...
      ((Element)v.get(22)).setAttribute("cod","ZonSecciView.codNse1.label" );
      ...
      ((Element)v.get(23)).setAttribute("cod","ZonSecciView.codNse2.label" );
      ...
      ((Element)v.get(24)).setAttribute("cod","ZonSecciView.codNse3.label" );
      ...
      ((Element)v.get(25)).setAttribute("cod","ZonSecciView.desSecci.label" );
      ...
      ((Element)v.get(26)).setAttribute("cod","ZonSecciView.zzonOidZona.label" );
