...
public class RecTiposOperaViewConectorQueryList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad RecTiposOperaView" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGRecTiposOperaViewQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGRecTiposOperaViewQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","RecTiposOperaViewListFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(8)).setAttribute("NOMBRE","valTipoOper" );
