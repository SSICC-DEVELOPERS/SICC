...
public class MaeClasiPage  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","MaeClasiPage" );
      ((Element)v.get(0)).setAttribute("titulo","" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","" );
      ((Element)v.get(0)).setAttribute("onload","maeClasiInitComponents()" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","maeclasi.js" );
      ((Element)v.get(0)).appendChild((Element)v.get(4));
      /* Termina nodo:4   */

      /* Empieza nodo:5 / Elemento padre: 0   */
      v.add(doc.createElement("FORMULARIO"));
      ((Element)v.get(5)).setAttribute("nombre","maeClasiFrm" );
      ...
      ((Element)v.get(6)).setAttribute("valor","MaeClasiLPExecution" );
      ...
      ((Element)v.get(7)).setAttribute("valor","MaeClasiLPExecution" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(37)).setAttribute("nombre","maeClasiFormLayer" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(52)).setAttribute("cod","MaeClasi.legend.label" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(67)).setAttribute("cod","MaeClasi.id.label" );
      ...
      ((Element)v.get(70)).setAttribute("ontab","ejecutarAccionFoco('maeClasiFrm',1, true)" );
      ((Element)v.get(70)).setAttribute("onshtab","ejecutarAccionFoco('maeClasiFrm', 1, false)" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(95)).setAttribute("onchange","mmgDependeneChange('tcclOidTipoClas_sbtiOidSubtClie_ticlOidTipoClie', 'tcclOidTipoClas' , 'maeClasi')" );
      ...
      ((Element)v.get(95)).setAttribute("ontab","focaliza('maeClasiFrm.tcclOidTipoClas_sbtiOidSubtClie');" );
      ((Element)v.get(95)).setAttribute("onshtab","ejecutarAccionFoco('maeClasiFrm',2, false);" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(106)).setAttribute("onchange","mmgDependeneChange('tcclOidTipoClas_sbtiOidSubtClie', 'tcclOidTipoClas' , 'maeClasi')" );
      ...
      ((Element)v.get(106)).setAttribute("ontab","focaliza('maeClasiFrm.tcclOidTipoClas');" );
      ((Element)v.get(106)).setAttribute("onshtab","focaliza('maeClasiFrm.tcclOidTipoClas_sbtiOidSubtClie_ticlOidTipoClie');" );
      ...
      ((Element)v.get(114)).setAttribute("cod","MaeClasi.tcclOidTipoClas.label" );
   ...
   private void getXML540(Document doc) {
      ((Element)v.get(117)).setAttribute("ontab","ejecutarAccionFoco('maeClasiFrm',2, true);" );
      ((Element)v.get(117)).setAttribute("onshtab","focaliza('maeClasiFrm.tcclOidTipoClas_sbtiOidSubtClie');" );
   ...
   private void getXML630(Document doc) {
      ...
      ((Element)v.get(140)).setAttribute("cod","MaeClasi.codClas.label" );
      ...
      ((Element)v.get(143)).setAttribute("ontab","ejecutarAccionFoco('maeClasiFrm',3, true)" );
      ((Element)v.get(143)).setAttribute("onshtab","ejecutarAccionFoco('maeClasiFrm', 3, false)" );
      ...
      ((Element)v.get(150)).setAttribute("cod","MaeClasi.Descripcion.label" );
      ...
      ((Element)v.get(154)).setAttribute("ontab","ejecutarAccionFoco('maeClasiFrm',4, true)" );
      ((Element)v.get(154)).setAttribute("onshtab","ejecutarAccionFoco('maeClasiFrm', 4, false)" );
   ...
   private void getXML720(Document doc) {
      ...
      ((Element)v.get(158)).setAttribute("href","javascript:openLocalizationDialog('maeClasiFrm', 'Descripcion', 1);" );
      ((Element)v.get(158)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"maeClasiFrm\",4, true)', 'ejecutarAccionFoco(\"maeClasiFrm\",4, false)')" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(174)).setAttribute("nombre","maeClasiTrButtons" );
   ...
   private void getXML810(Document doc) {
      ...
      ((Element)v.get(181)).setAttribute("nombre","maeClasiTdQueryButton" );
      ((Element)v.get(180)).appendChild((Element)v.get(181));

      /* Empieza nodo:182 / Elemento padre: 181   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(182)).setAttribute("nombre","maeClasiQueryButton" );
      ((Element)v.get(182)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(182)).setAttribute("estado","false" );
      ((Element)v.get(182)).setAttribute("accion","maeClasiFirstPage();" );
      ...
      ((Element)v.get(183)).setAttribute("nombre","maeClasiTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(185)).setAttribute("nombre","maeClasiLovNullButton" );
      ((Element)v.get(185)).setAttribute("ID","botonContenido" );
      ((Element)v.get(185)).setAttribute("tipo","html" );
      ((Element)v.get(185)).setAttribute("accion","maeClasiLovNullSelectionAction();" );
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(188)).setAttribute("nombre","maeClasiListLayer" );
      ...
      ((Element)v.get(189)).setAttribute("nombre","maeClasiList" );
   ...
   private void getXML900(Document doc) {
      ...
      ((Element)v.get(203)).setAttribute("cod","MaeClasi.tcclOidTipoClas.label" );
      ...
      ((Element)v.get(204)).setAttribute("cod","MaeClasi.codClas.label" );
      ...
      ((Element)v.get(205)).setAttribute("cod","MaeClasi.Descripcion.label" );
   ...
   private void getXML990(Document doc) {
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(211)).setAttribute("nombre","maeClasiListButtonsLayer" );
      ...
      ((Element)v.get(217)).setAttribute("nombre","maeClasiPaginationButtonBar" );
      ...
      ((Element)v.get(218)).setAttribute("nombre","maeClasiFirstPageButton" );
      ((Element)v.get(218)).setAttribute("funcion","maeClasiFirstPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(219)).setAttribute("nombre","maeClasiFirstPageButtonGapTd" );
      ...
      v.add(doc.createElement("BTN"));
      ((Element)v.get(221)).setAttribute("nombre","maeClasiPreviousPageButton" );
      ((Element)v.get(221)).setAttribute("funcion","maeClasiPreviousPage();" );
   ...
   private void getXML1080(Document doc) {
      ((Element)v.get(222)).setAttribute("nombre","maeClasiPreviousPageButtonGapTd" );
      ...
      v.add(doc.createElement("BTN"));
      ((Element)v.get(224)).setAttribute("nombre","maeClasiNextPageButton" );
      ((Element)v.get(224)).setAttribute("funcion","maeClasiNextPage();" );
      ...
      ((Element)v.get(227)).setAttribute("nombre","maeClasiUpdateButtonTd" );
      ((Element)v.get(213)).appendChild((Element)v.get(227));

      /* Empieza nodo:228 / Elemento padre: 227   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(228)).setAttribute("nombre","maeClasiUpdateButton" );
      ((Element)v.get(228)).setAttribute("ID","botonContenido" );
      ((Element)v.get(228)).setAttribute("tipo","html" );
      ((Element)v.get(228)).setAttribute("accion","maeClasiUpdateSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(229)).setAttribute("nombre","maeClasiUpdateButtonGapTd" );
      ...
      ((Element)v.get(231)).setAttribute("nombre","maeClasiViewForRemoveButtonTd" );
      ((Element)v.get(213)).appendChild((Element)v.get(231));

      /* Empieza nodo:232 / Elemento padre: 231   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(232)).setAttribute("nombre","maeClasiViewForRemoveButton" );
      ((Element)v.get(232)).setAttribute("ID","botonContenido" );
      ((Element)v.get(232)).setAttribute("tipo","html" );
      ((Element)v.get(232)).setAttribute("accion","maeClasiViewSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(233)).setAttribute("nombre","maeClasiViewForRemoveButtonGapTd" );
      ...
      ((Element)v.get(235)).setAttribute("nombre","maeClasiLovSelectButtonTd" );
      ((Element)v.get(213)).appendChild((Element)v.get(235));

      /* Empieza nodo:236 / Elemento padre: 235   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(236)).setAttribute("nombre","maeClasiLovSelectButton" );
      ((Element)v.get(236)).setAttribute("ID","botonContenido" );
      ((Element)v.get(236)).setAttribute("tipo","html" );
      ((Element)v.get(236)).setAttribute("accion","maeClasiLovSelectionAction();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(237)).setAttribute("nombre","maeClasiLovSelectButtonGapTd" );
      ...
      ((Element)v.get(239)).setAttribute("nombre","maeClasiViewButtonTd" );
      ((Element)v.get(213)).appendChild((Element)v.get(239));

      /* Empieza nodo:240 / Elemento padre: 239   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(240)).setAttribute("nombre","maeClasiViewButton" );
      ((Element)v.get(240)).setAttribute("ID","botonContenido" );
      ((Element)v.get(240)).setAttribute("tipo","html" );
   }

   private void getXML1170(Document doc) {
      ((Element)v.get(240)).setAttribute("accion","maeClasiViewSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(241)).setAttribute("nombre","maeClasiViewButtonGapTd" );
