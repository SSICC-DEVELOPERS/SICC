...
public class RECEstadisticaFaltanteDiaRegion extends LPSICCBase {           
   public RECEstadisticaFaltanteDiaRegion() {	 
     super();
  }
     ...
     try {
        ...
        if (accion.equals("generar")){
          ...
          //cargarPagina();
           ...
           cargarPagina();
           getConfiguracionMenu("RECEstadisticaFaltanteDiaRegion");
        }
  ...
  private void cargarPagina() throws Exception{
     ...
     asignarAtributoPagina("cod", "0916");
     asignarAtributo("VAR", "lp", "valor", "RECEstadisticaFaltanteDiaRegion");
 ...
 private void generarReporte() throws Exception{
     ...
     datos.put(ConstantesREP.PERIODODESDE, periodoInicial);
                 
     String periodoFinal        = conectorParametroLimpia("periodoFinal", "", true);
     if(!periodoFinal.equals("")){
         datos.put(ConstantesREP.PERIODOHASTA, periodoFinal);
     }else{
	     datos.put(ConstantesREP.PERIODOHASTA, periodoInicial);
	 }
     ...
     datos.put(ConstantesREP.TITULO, "Estadística de Faltantes por Día y Región");     
     traza("++++++Antes de enviar a reportes " + datos); 
        
     
     traza("el formato es  " + formato);
     //ejecutarReporte(datos, "REPGenerarReporte", "RD_REP-114", formato);
     ejecutarReporte2(datos, "REPGenerarReporteBatch", "RD_REP-114", formato);
