...
public class CccCuentContaConectorQueryForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad CccCuentConta" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGCccCuentContaQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGCccCuentContaQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","CccCuentContaFormFormatter" );
