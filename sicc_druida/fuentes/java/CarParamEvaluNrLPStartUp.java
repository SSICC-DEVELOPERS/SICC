/*
    INDRA/CAR/mmg
    $Id: CarParamEvaluNrLPStartUp.java,v 1.1 2009/12/03 18:38:45 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class CarParamEvaluNrLPStartUp extends MMGDruidaBase{
	...
	public CarParamEvaluNrLPStartUp(){
		super();
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			buildJsPageSize("CarParamEvaluNr");
			...
			asignarAtributo("PAGINA", "CarParamEvaluNrPage", "cod", "CarParamEvaluNr." + accion + ".label");
			...
			limpiarBotoneraLista("carParamEvaluNr", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codPara", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 1);");
		asignarAtributo("TEXT", "desPara", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 40);");
		asignarAtributo("TEXT", "valPeso", "validacion", "mensaje = ValidaNumeroMMG(cdos_trim(valor), " + (4 - MMGDruidaHelper.getUserDecimalPrecision(this)) + ", " + MMGDruidaHelper.getUserDecimalPrecision(this)+ ", 'CarParamEvaluNr.valPeso', 0, " + MMGDruidaHelper.getMaxValueForDruidaValidaFloat((4 - MMGDruidaHelper.getUserDecimalPrecision(this)), this) + ");");
		
		//Primero determianmos el nombre del campo en la entidad de oriegen donde se van a cargar los datos
		asignar("VAR", "idAttributeLovOpener", conectorParametro(PARAMETRO_LOV_ATTRIBUTO));
		asignar("VAR", "idEntityLovOpener", conectorParametro(PARAMETRO_LOV_ENTIDAD));
		//asignarAtributo("CAPA", "carParamEvaluNrLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "CarParamEvaluNrPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		CarParamEvaluNrData carParamEvaluNrQuery= new CarParamEvaluNrData();
		carParamEvaluNrQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		CarParamEvaluNrData datosResult = (CarParamEvaluNrData)getSingleObject(BUSINESSID_QUERY, carParamEvaluNrQuery, 
			carParamEvaluNrQuery.clone(), "carParamEvaluNr");
		...
		CarParamEvaluNrData carParamEvaluNr = datosResult;
		asignar("TEXT", "codPara", FormatUtils.formatObject(carParamEvaluNr.getCodPara(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "desPara", FormatUtils.formatObject(carParamEvaluNr.getDesPara(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "valPeso", FormatUtils.formatObject(carParamEvaluNr.getValPeso(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		asignarAtributo("TEXT", "codPara", "disabled", "S");
		asignarAtributo("TEXT", "desPara", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		...
		asignarAtributo("TEXT", "codPara", "req", "S");
		asignarAtributo("TEXT", "desPara", "req", "S");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "carParamEvaluNrFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		CarParamEvaluNrData carParamEvaluNrQuery= new CarParamEvaluNrData();
		carParamEvaluNrQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(carParamEvaluNr.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"carParamEvaluNrFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"carParamEvaluNrFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codPara", "ontab","ejecutarAccionFocoModificacion(\"carParamEvaluNrFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codPara", "onshtab","ejecutarAccionFocoModificacion(\"carParamEvaluNrFrm\",2, false)");
				asignarAtributo("AREATEXTO", "desPara", "ontab","ejecutarAccionFocoModificacion(\"carParamEvaluNrFrm\",3, true)");
				asignarAtributo("AREATEXTO", "desPara", "onshtab","ejecutarAccionFocoModificacion(\"carParamEvaluNrFrm\",3, false)");
				asignarAtributo("AREATEXTO", "valPeso", "ontab","ejecutarAccionFocoModificacion(\"carParamEvaluNrFrm\",4, true)");
				asignarAtributo("AREATEXTO", "valPeso", "onshtab","ejecutarAccionFocoModificacion(\"carParamEvaluNrFrm\",4, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","carParamEvaluNrTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","carParamEvaluNrTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","carParamEvaluNrFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","carParamEvaluNrListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","carParamEvaluNrListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(CarParamEvaluNrData carParamEvaluNr) throws Exception{
	...
	* @param carParamEvaluNr La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(CarParamEvaluNrData carParamEvaluNr) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		CarParamEvaluNrData carParamEvaluNr = 
			(CarParamEvaluNrData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(carParamEvaluNr);
		loadLeafDependenceCombos(carParamEvaluNr);
	}
