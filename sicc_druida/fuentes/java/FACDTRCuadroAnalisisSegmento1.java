...
public class FACDTRCuadroAnalisisSegmento1 extends LPSICCBase {           
   
   public FACDTRCuadroAnalisisSegmento1() {	 
     super();
  }
     ...
     try {
        ...
        if (accion.equals("generar")){
          ...
          //cargarPagina();
                 ...
                 cargarPagina();
                 getConfiguracionMenu("FACDTRCuadroAnalisisSegmento1");
        }
  ...
  private void cargarPagina() throws Exception{
     ...
     asignarAtributoPagina("cod","0810");
     ...
     asignarAtributo("VAR", "lp", "valor", "FACDTRCuadroAnalisisSegmento1");
  ...
  private void generarReporte() throws Exception{
     ...
     datos.put(ConstantesREP.TITULO, "Cuadro de Análisis por Segmento de Consultora");     
     traza("++++++Antes de enviar a reportes " + datos); 
     
     String formato = conectorParametroLimpia("formato", "", true);
     
       
//     ejecutarReporte(datos, "REPGenerarReporte", "RFD-005", formato);
     ejecutarReporte2(datos, "REPGenerarReporteBatch", "RD_RFD-005", "pdf");
