...
public class CobMetodLiquiViewPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","cobMetodLiquiViewList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","CobMetodLiquiView.codMetoLiqu.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","CobMetodLiquiView.valDescMetoLiqu.label" );
