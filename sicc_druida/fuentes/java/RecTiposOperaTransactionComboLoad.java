...
/*
    INDRA/CAR/mmg
    $Id: RecTiposOperaTransactionComboLoad.java,v 1.1 2009/12/03 18:42:49 pecbazalar Exp $
    DESC
*/
...
public class RecTiposOperaTransactionComboLoad extends MMGDruidaTransaction {
	//Constantes usadas en la clase. Simplemente representan 
	//los nombre de conectore y de logicas de negocio
	public static final String BUSINESSID_QUERY = "MMGRecTiposOperaQueryFromToUserStructuralSecurity";
	public static final String CONECTOR_QUERY_COMBO= "RecTiposOperaConectorCombo";

	// Definicion del constructor
	public RecTiposOperaTransactionComboLoad(){
		super();
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			dto.addProperty("recTiposOperaFrom", recTiposOpera);
			dto.addProperty("recTiposOperaTo", recTiposOpera.clone());
