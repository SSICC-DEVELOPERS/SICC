...
public class AppRutasTransPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","appRutasTransList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","AppRutasTrans.codRuta.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","AppRutasTrans.Descripcion.label" );
      ...
      ((Element)v.get(17)).setAttribute("cod","AppRutasTrans.numSecu.label" );
      ...
      ((Element)v.get(18)).setAttribute("cod","AppRutasTrans.valObse.label" );
