...
public class MaeTipoTarjePageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","maeTipoTarjeList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","MaeTipoTarje.codTipoTarj.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","MaeTipoTarje.Descripcion.label" );
