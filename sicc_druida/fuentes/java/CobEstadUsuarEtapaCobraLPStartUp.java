/*
    INDRA/CAR/mmg
    $Id: CobEstadUsuarEtapaCobraLPStartUp.java,v 1.1 2009/12/03 18:42:02 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class CobEstadUsuarEtapaCobraLPStartUp extends MMGDruidaBase{
	...
	public CobEstadUsuarEtapaCobraLPStartUp(){
		super();
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			buildJsPageSize("CobEstadUsuarEtapaCobra");
			...
			asignarAtributo("PAGINA", "CobEstadUsuarEtapaCobraPage", "cod", "CobEstadUsuarEtapaCobra." + accion + ".label");
			...
			limpiarBotoneraLista("cobEstadUsuarEtapaCobra", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codEstaUsuaEtapCobr", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 1);");
		
		//Primero determianmos el nombre del campo en la entidad de oriegen donde se van a cargar los datos
		asignar("VAR", "idAttributeLovOpener", conectorParametro(PARAMETRO_LOV_ATTRIBUTO));
		asignar("VAR", "idEntityLovOpener", conectorParametro(PARAMETRO_LOV_ENTIDAD));
		//asignarAtributo("CAPA", "cobEstadUsuarEtapaCobraLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "CobEstadUsuarEtapaCobraPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		CobEstadUsuarEtapaCobraData cobEstadUsuarEtapaCobraQuery= new CobEstadUsuarEtapaCobraData();
		cobEstadUsuarEtapaCobraQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		CobEstadUsuarEtapaCobraData datosResult = (CobEstadUsuarEtapaCobraData)getSingleObject(BUSINESSID_QUERY, cobEstadUsuarEtapaCobraQuery, 
			cobEstadUsuarEtapaCobraQuery.clone(), "cobEstadUsuarEtapaCobra");
		...
		preservaHiddensI18n(new Integer(1), "COB_ESTAD_USUAR_ETAPA_COBRA", "cobEstadUsuarEtapaCobraFrm", "Descripcion", true);
		...
		CobEstadUsuarEtapaCobraData cobEstadUsuarEtapaCobra = datosResult;
		asignar("TEXT", "codEstaUsuaEtapCobr", FormatUtils.formatObject(cobEstadUsuarEtapaCobra.getCodEstaUsuaEtapCobr(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "Descripcion", FormatUtils.formatObject(cobEstadUsuarEtapaCobra.getDescripcion(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		loadLocalizationVars(cobEstadUsuarEtapaCobra);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "codEstaUsuaEtapCobr", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "COB_ESTAD_USUAR_ETAPA_COBRA", "cobEstadUsuarEtapaCobraFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "codEstaUsuaEtapCobr", "req", "S");
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('cobEstadUsuarEtapaCobraFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "cobEstadUsuarEtapaCobraFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		CobEstadUsuarEtapaCobraData cobEstadUsuarEtapaCobraQuery= new CobEstadUsuarEtapaCobraData();
		cobEstadUsuarEtapaCobraQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(cobEstadUsuarEtapaCobra.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"cobEstadUsuarEtapaCobraFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"cobEstadUsuarEtapaCobraFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codEstaUsuaEtapCobr", "ontab","ejecutarAccionFocoModificacion(\"cobEstadUsuarEtapaCobraFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codEstaUsuaEtapCobr", "onshtab","ejecutarAccionFocoModificacion(\"cobEstadUsuarEtapaCobraFrm\",2, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"cobEstadUsuarEtapaCobraFrm\",3, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"cobEstadUsuarEtapaCobraFrm\",3, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","cobEstadUsuarEtapaCobraTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","cobEstadUsuarEtapaCobraTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codEstaUsuaEtapCobr...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","cobEstadUsuarEtapaCobraFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","cobEstadUsuarEtapaCobraListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","cobEstadUsuarEtapaCobraListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(CobEstadUsuarEtapaCobraData cobEstadUsuarEtapaCobra) throws Exception{
	...
	* @param cobEstadUsuarEtapaCobra La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(CobEstadUsuarEtapaCobraData cobEstadUsuarEtapaCobra) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		CobEstadUsuarEtapaCobraData cobEstadUsuarEtapaCobra = 
			(CobEstadUsuarEtapaCobraData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(cobEstadUsuarEtapaCobra);
		loadLeafDependenceCombos(cobEstadUsuarEtapaCobra);
	}
	...
	*/
	...
	protected void loadLocalizationVars(CobEstadUsuarEtapaCobraData cobEstadUsuarEtapaCobra) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("COB_ESTAD_USUAR_ETAPA_COBRA");
		mmgLocalizationQuery.setEntiPk(cobEstadUsuarEtapaCobra.getId());
