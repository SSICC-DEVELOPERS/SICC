...
public class PedSolicCabecPage  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","PedSolicCabecPage" );
      ((Element)v.get(0)).setAttribute("titulo","" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","" );
      ((Element)v.get(0)).setAttribute("onload","pedSolicCabecInitComponents()" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(3)).setAttribute("src","pedsoliccabec.js" );
      ((Element)v.get(0)).appendChild((Element)v.get(3));
      /* Termina nodo:3   */

      /* Empieza nodo:4 / Elemento padre: 0   */
      v.add(doc.createElement("FORMULARIO"));
      ((Element)v.get(4)).setAttribute("nombre","pedSolicCabecFrm" );
      ...
      ((Element)v.get(5)).setAttribute("valor","PedSolicCabecLPExecution" );
      ...
      ((Element)v.get(6)).setAttribute("valor","PedSolicCabecLPExecution" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(24)).setAttribute("nombre","pedSolicCabecFormLayer" );
      ...
      ((Element)v.get(39)).setAttribute("cod","PedSolicCabec.legend.label" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(54)).setAttribute("cod","PedSolicCabec.id.label" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('pedSolicCabecFrm',0, true)" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('pedSolicCabecFrm', 0, false)" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(75)).setAttribute("nombre","pedSolicCabecTrButtons" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(82)).setAttribute("nombre","pedSolicCabecTdQueryButton" );
      ((Element)v.get(81)).appendChild((Element)v.get(82));

      /* Empieza nodo:83 / Elemento padre: 82   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(83)).setAttribute("nombre","pedSolicCabecQueryButton" );
      ((Element)v.get(83)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(83)).setAttribute("estado","false" );
      ((Element)v.get(83)).setAttribute("accion","pedSolicCabecFirstPage();" );
      ...
      ((Element)v.get(84)).setAttribute("nombre","pedSolicCabecTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(86)).setAttribute("nombre","pedSolicCabecLovNullButton" );
      ((Element)v.get(86)).setAttribute("ID","botonContenido" );
      ((Element)v.get(86)).setAttribute("tipo","html" );
      ((Element)v.get(86)).setAttribute("accion","pedSolicCabecLovNullSelectionAction();" );
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(89)).setAttribute("nombre","pedSolicCabecPreListLayer" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(118)).setAttribute("nombre","pedSolicCabecListLayer" );
      ...
      ((Element)v.get(119)).setAttribute("nombre","pedSolicCabecList" );
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(131)).setAttribute("nombre","pedSolicCabecListButtonsLayer" );
   ...
   private void getXML630(Document doc) {
      ...
      ((Element)v.get(133)).setAttribute("nombre","pedSolicCabecUpdateButtonTd" );
      ((Element)v.get(132)).appendChild((Element)v.get(133));

      /* Empieza nodo:134 / Elemento padre: 133   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(134)).setAttribute("nombre","pedSolicCabecUpdateButton" );
      ((Element)v.get(134)).setAttribute("ID","botonContenido" );
      ((Element)v.get(134)).setAttribute("tipo","html" );
      ((Element)v.get(134)).setAttribute("accion","pedSolicCabecUpdateSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(135)).setAttribute("nombre","pedSolicCabecUpdateButtonGapTd" );
      ...
      ((Element)v.get(137)).setAttribute("nombre","pedSolicCabecRemoveButtonTd" );
      ((Element)v.get(132)).appendChild((Element)v.get(137));

      /* Empieza nodo:138 / Elemento padre: 137   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(138)).setAttribute("nombre","pedSolicCabecRemoveButton" );
      ((Element)v.get(138)).setAttribute("ID","botonContenido" );
      ((Element)v.get(138)).setAttribute("tipo","html" );
      ((Element)v.get(138)).setAttribute("accion","pedSolicCabecRemoveSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(139)).setAttribute("nombre","pedSolicCabecRemoveButtonGapTd" );
      ...
      ((Element)v.get(141)).setAttribute("nombre","pedSolicCabecViewForRemoveButtonTd" );
      ((Element)v.get(132)).appendChild((Element)v.get(141));

      /* Empieza nodo:142 / Elemento padre: 141   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(142)).setAttribute("nombre","pedSolicCabecViewForRemoveButton" );
      ((Element)v.get(142)).setAttribute("ID","botonContenido" );
      ((Element)v.get(142)).setAttribute("tipo","html" );
      ((Element)v.get(142)).setAttribute("accion","pedSolicCabecViewSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(143)).setAttribute("nombre","pedSolicCabecViewForRemoveButtonGapTd" );
      ...
      ((Element)v.get(145)).setAttribute("nombre","pedSolicCabecLovSelectButtonTd" );
      ((Element)v.get(132)).appendChild((Element)v.get(145));

      /* Empieza nodo:146 / Elemento padre: 145   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(146)).setAttribute("nombre","pedSolicCabecLovSelectButton" );
      ((Element)v.get(146)).setAttribute("ID","botonContenido" );
      ((Element)v.get(146)).setAttribute("tipo","html" );
      ((Element)v.get(146)).setAttribute("accion","pedSolicCabecLovSelectionAction();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(147)).setAttribute("nombre","pedSolicCabecLovSelectButtonGapTd" );
      ...
      ((Element)v.get(149)).setAttribute("nombre","pedSolicCabecViewButtonTd" );
      ((Element)v.get(132)).appendChild((Element)v.get(149));

      /* Empieza nodo:150 / Elemento padre: 149   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(150)).setAttribute("nombre","pedSolicCabecViewButton" );
      ((Element)v.get(150)).setAttribute("ID","botonContenido" );
      ((Element)v.get(150)).setAttribute("tipo","html" );
   }

   private void getXML720(Document doc) {
      ((Element)v.get(150)).setAttribute("accion","pedSolicCabecViewSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(151)).setAttribute("nombre","pedSolicCabecViewButtonGapTd" );
      ...
      ((Element)v.get(154)).setAttribute("nombre","pedSolicCabecPaginationButtonBar" );
      ...
      ((Element)v.get(155)).setAttribute("nombre","pedSolicCabecFirstPageButton" );
      ((Element)v.get(155)).setAttribute("funcion","pedSolicCabecFirstPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(156)).setAttribute("nombre","pedSolicCabecFirstPageButtonGapTd" );
      ...
      v.add(doc.createElement("BTN"));
      ((Element)v.get(158)).setAttribute("nombre","pedSolicCabecPreviousPageButton" );
      ((Element)v.get(158)).setAttribute("funcion","pedSolicCabecPreviousPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(159)).setAttribute("nombre","pedSolicCabecPreviousPageButtonGapTd" );
      ...
      v.add(doc.createElement("BTN"));
      ((Element)v.get(161)).setAttribute("nombre","pedSolicCabecNextPageButton" );
      ((Element)v.get(161)).setAttribute("funcion","pedSolicCabecNextPage();" );
