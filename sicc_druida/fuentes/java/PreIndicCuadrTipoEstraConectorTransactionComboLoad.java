...
public class PreIndicCuadrTipoEstraConectorTransactionComboLoad  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("NOMBRE","PreIndicCuadrTipoEstraTransactionComboLoad" );
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector transaccional para la ejección de la carga de combos de tipo PreIndicCuadrTipoEstra" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","indcOidIndiCuad" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","tiesOidTipoEstr" );
