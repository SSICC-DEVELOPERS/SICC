...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("titulo","Generar informe de configuracion de matriz de facturación" );
   ...
   private void getXML1530(Document doc) {
      ...
      ((Element)v.get(381)).setAttribute("VALOR","Vista con sumarización por compuesta fija " );
   ...
   private void getXML1620(Document doc) {
      ...
      ((Element)v.get(416)).setAttribute("VALOR","Catálogo" );
      ...
      ((Element)v.get(425)).setAttribute("VALOR","Página" );
   ...
   private void getXML1710(Document doc) {
      ...
      ((Element)v.get(436)).setAttribute("VALOR","Catálogo" );
      ...
      ((Element)v.get(442)).setAttribute("VALOR","Código venta" );
      ...
      ((Element)v.get(445)).setAttribute("VALOR","Página" );
   ...
   private void getXML1800(Document doc) {
      ...
      ((Element)v.get(456)).setAttribute("VALOR","Catálogo" );
      ...
      ((Element)v.get(462)).setAttribute("VALOR","Código venta" );
      ...
      ((Element)v.get(465)).setAttribute("VALOR","Página" );
