...
public class contenido_estatus_venta_mantener  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_estatus_venta_mantener" );
      ...
      ((Element)v.get(5)).setAttribute("name","cbEstatusVentaMAE" );
      ((Element)v.get(5)).setAttribute("required","true" );
      ((Element)v.get(5)).setAttribute("cod","1705" );
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(6)).setAttribute("name","cbPeriodoDesde" );
      ((Element)v.get(6)).setAttribute("required","true" );
      ((Element)v.get(6)).setAttribute("cod","1175" );
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(7)).setAttribute("name","cbPeriodoHasta" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(11)).setAttribute("nombre","hidLstEstatusVta" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(13)).setAttribute("nombre","hidUltimoElementoEnLaLista" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(28)).setAttribute("nombre","lblDatos" );
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(32)).setAttribute("width","426" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(40)).setAttribute("nombre","lblEstatusVentaMAE" );
      ...
      ((Element)v.get(40)).setAttribute("cod","1705" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(44)).setAttribute("nombre","lblPeriodoDesde" );
      ...
      ((Element)v.get(44)).setAttribute("cod","1175" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(48)).setAttribute("nombre","lblPeriodoHasta" );
      ...
      ((Element)v.get(48)).setAttribute("cod","1176" );
      ...
      ((Element)v.get(55)).setAttribute("nombre","cbEstatusVentaMAE" );
      ...
      ((Element)v.get(55)).setAttribute("onshtab","focalizaBotonHTML('botonContenido','btnAceptar1');" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(60)).setAttribute("nombre","cbPeriodoDesde" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(65)).setAttribute("nombre","cbPeriodoHasta" );
   ...
   private void getXML270(Document doc) {
      ...
      /* Empieza nodo:69 / Elemento padre: 32   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(32)).appendChild((Element)v.get(69));
      ...
      ((Element)v.get(82)).setAttribute("nombre","btnAnadir" );
      ((Element)v.get(82)).setAttribute("ID","botonContenido" );
      ((Element)v.get(82)).setAttribute("tipo","html" );
      ((Element)v.get(82)).setAttribute("accion","accionAniadir();" );
      ((Element)v.get(82)).setAttribute("estado","false" );
      ((Element)v.get(82)).setAttribute("cod","404" );
      ((Element)v.get(82)).setAttribute("ontab","focalizaBotonHTML('botonContenido','btnAceptar1');" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(100)).setAttribute("cod","00317" );
      ...
      ((Element)v.get(103)).setAttribute("ancho","30" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(104)).setAttribute("ancho","30" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(107)).setAttribute("ancho","10" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(108)).setAttribute("ancho","5" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(109)).setAttribute("ancho","5" );
      ...
      /* Empieza nodo:110 / Elemento padre: 92   */
      ...
      ((Element)v.get(92)).appendChild((Element)v.get(110));
      ...
      ((Element)v.get(119)).setAttribute("cod","1705" );
      ...
      ((Element)v.get(121)).setAttribute("cod","1175" );
      ...
      ((Element)v.get(123)).setAttribute("cod","1176" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(136)).setAttribute("y","408" );
      ...
      ((Element)v.get(138)).setAttribute("y","404" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(139)).setAttribute("nombre","btnAceptar1" );
      ((Element)v.get(139)).setAttribute("x","17" );
      ((Element)v.get(139)).setAttribute("y","405" );
      ((Element)v.get(139)).setAttribute("ID","botonContenido" );
      ((Element)v.get(139)).setAttribute("tipo","html" );
      ((Element)v.get(139)).setAttribute("accion","accionAceptar();" );
      ((Element)v.get(139)).setAttribute("estado","false" );
      ((Element)v.get(139)).setAttribute("cod","12" );
      ((Element)v.get(139)).setAttribute("ontab","focaliza('frmFormulario.cbEstatusVentaMAE');" );
      ((Element)v.get(139)).setAttribute("onshtab","focalizaBotonHTML('botonContenido','btnAnadir');" );
   ...
   private void getXML630(Document doc) {
      ...
      ((Element)v.get(140)).setAttribute("y","427" );
