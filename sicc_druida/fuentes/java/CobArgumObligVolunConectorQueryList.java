...
public class CobArgumObligVolunConectorQueryList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad CobArgumObligVolun" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGCobArgumObligVolunQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGCobArgumObligVolunQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","CobArgumObligVolunListFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","codArguObliVolu" );
