/*
    INDRA/CAR/mmg
    $Id: CarParamNrLPStartUp.java,v 1.1 2009/12/03 18:35:56 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class CarParamNrLPStartUp extends MMGDruidaBase{
	...
	public CarParamNrLPStartUp(){
		super();
	}

	public void inicio() throws Exception {
		pagina("CarParamNrPage");
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "CarParamNrPage", "cod", "CarParamNr." + accion + ".label");
			...
			limpiarBotoneraLista("carParamNr", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "valMini", "validacion", "mensaje = ValidaNumeroMMG(cdos_trim(valor), " + (12 - MMGDruidaHelper.getUserDecimalPrecision(this)) + ", " + MMGDruidaHelper.getUserDecimalPrecision(this)+ ", 'CarParamNr.valMini', 0, " + MMGDruidaHelper.getMaxValueForDruidaValidaFloat((12 - MMGDruidaHelper.getUserDecimalPrecision(this)), this) + ");");
		asignarAtributo("TEXT", "valMaxi", "validacion", "mensaje = ValidaNumeroMMG(cdos_trim(valor), " + (12 - MMGDruidaHelper.getUserDecimalPrecision(this)) + ", " + MMGDruidaHelper.getUserDecimalPrecision(this)+ ", 'CarParamNr.valMaxi', 0, " + MMGDruidaHelper.getMaxValueForDruidaValidaFloat((12 - MMGDruidaHelper.getUserDecimalPrecision(this)), this) + ");if (mensaje=='OK') validacionvalMaxivalMini(); else muestraMsgError(mensaje);");
		
		//Primero determianmos el nombre del campo en la entidad de oriegen donde se van a cargar los datos
		asignar("VAR", "idAttributeLovOpener", conectorParametro(PARAMETRO_LOV_ATTRIBUTO));
		asignar("VAR", "idEntityLovOpener", conectorParametro(PARAMETRO_LOV_ENTIDAD));
		//asignarAtributo("CAPA", "carParamNrLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "CarParamNrPage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("CarParamNrLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		CarParamNrData carParamNrQuery= new CarParamNrData();
		carParamNrQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		CarParamNrData datosResult = (CarParamNrData)getSingleObject(BUSINESSID_QUERY, carParamNrQuery, 
			carParamNrQuery.clone(), "carParamNr");
		...
		CarParamNrData carParamNr = datosResult;
		es.indra.belcorp.mso.CarNivelRiesgData niriOidNiveRies = carParamNr.getNiriOidNiveRies();
		if(niriOidNiveRies != null && niriOidNiveRies.getId() != null) checkCombo("niriOidNiveRies" , niriOidNiveRies.getId().toString());
		asignar("TEXT", "valMini", FormatUtils.formatObject(carParamNr.getValMini(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "valMaxi", FormatUtils.formatObject(carParamNr.getValMaxi(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		//Deshabilitamos todos los campos para que no se editen
					...
					asignarAtributo("COMBO", "niriOidNiveRies", "disabled", "S");asignarAtributo("TEXT", "valMini", "disabled", "S");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "carParamNrFrm", "oculto", "N");
		...
		traza("MMG::Creando CarParamNr");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		CarParamNrData carParamNrQuery= new CarParamNrData();
		carParamNrQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(carParamNr.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"carParamNrFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"carParamNrFrm\",1, false)");
					asignarAtributo("COMBO","niriOidNiveRies", "ontab", "ejecutarAccionFocoModificacion(\"carParamNrFrm\",2, true)");
					asignarAtributo("COMBO","niriOidNiveRies", "onshtab", "ejecutarAccionFocoModificacion(\"carParamNrFrm\",2, false)");
				asignarAtributo("AREATEXTO", "valMini", "ontab","ejecutarAccionFocoModificacion(\"carParamNrFrm\",3, true)");
				asignarAtributo("AREATEXTO", "valMini", "onshtab","ejecutarAccionFocoModificacion(\"carParamNrFrm\",3, false)");
				asignarAtributo("AREATEXTO", "valMaxi", "ontab","ejecutarAccionFocoModificacion(\"carParamNrFrm\",4, true)");
				asignarAtributo("AREATEXTO", "valMaxi", "onshtab","ejecutarAccionFocoModificacion(\"carParamNrFrm\",4, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","carParamNrTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","carParamNrTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","carParamNrFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","carParamNrListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","carParamNrListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(CarParamNrData carParamNr) throws Exception{
		...
		if(carParamNr != null && carParamNr.getNiriOidNiveRies() != null){
				checkCombo("niriOidNiveRies" , carParamNr.getNiriOidNiveRies().getId().toString());
			}
	...
	* @param carParamNr La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(CarParamNrData carParamNr) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		CarParamNrData carParamNr = 
			(CarParamNrData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(carParamNr.getNiriOidNiveRies() != null){
			carParamNr.setNiriOidNiveRies((es.indra.belcorp.mso.CarNivelRiesgData)
			getSingleObject(BUSINESSID_NIRIOIDNIVERIES_QUERY, 
			carParamNr.getNiriOidNiveRies(),
			carParamNr.getNiriOidNiveRies().clone(),
			"carNivelRiesg"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(carParamNr);
		loadLeafDependenceCombos(carParamNr);
	}
