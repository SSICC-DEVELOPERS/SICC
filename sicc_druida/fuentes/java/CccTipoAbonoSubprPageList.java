...
public class CccTipoAbonoSubprPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","cccTipoAbonoSubprList" );
      ...
      ((Element)v.get(14)).setAttribute("cod","CccTipoAbonoSubpr.subpOidSubp.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","CccTipoAbonoSubpr.tcabOidTcab.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","CccTipoAbonoSubpr.cucoOidCuenCont.label" );
