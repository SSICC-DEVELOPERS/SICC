...
public class MaeTipoPerfiPsicoPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","maeTipoPerfiPsicoList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","MaeTipoPerfiPsico.codTipoPerfPsic.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","MaeTipoPerfiPsico.Descripcion.label" );
