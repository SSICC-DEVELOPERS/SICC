/*
    INDRA/CAR/mmg
    $Id: CalAtribEstadContaLPStartUp.java,v 1.1 2009/12/03 18:32:22 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class CalAtribEstadContaLPStartUp extends MMGDruidaBase{
	...
	public static final String BUSINESSID_QUERY = "MMGCalAtribEstadContaQueryFromToUserPage";
				...
				public static final String BUSINESSID_TECOOIDTIPOESTACONT_QUERY ="MMGCalTipoEstadContaQueryFromToUser";
				public static final String TECOOIDTIPOESTACONT_COMBO_CONNECTOR = "CalTipoEstadContaConectorCombo";
	...
	public CalAtribEstadContaLPStartUp(){
		super();
	}

	public void inicio() throws Exception {
		pagina("CalAtribEstadContaPage");
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			buildJsPageSize("CalAtribEstadConta");
			...
			asignarAtributo("PAGINA", "CalAtribEstadContaPage", "cod", "CalAtribEstadConta." + accion + ".label");
			...
			limpiarBotoneraLista("calAtribEstadConta", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codAtri", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 2);");
		...
		//asignarAtributo("CAPA", "calAtribEstadContaLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "CalAtribEstadContaPage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("CalAtribEstadContaLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		CalAtribEstadContaData calAtribEstadContaQuery= new CalAtribEstadContaData();
		calAtribEstadContaQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		CalAtribEstadContaData datosResult = (CalAtribEstadContaData)getSingleObject(BUSINESSID_QUERY, calAtribEstadContaQuery, 
			calAtribEstadContaQuery.clone(), "calAtribEstadConta");
		...
		preservaHiddensI18n(new Integer(1), "CAL_ATRIB_ESTAD_CONTA", "calAtribEstadContaFrm", "Descripcion", true);
		...
		CalAtribEstadContaData calAtribEstadConta = datosResult;
		es.indra.belcorp.mso.CalTipoEstadContaData tecoOidTipoEstaCont = calAtribEstadConta.getTecoOidTipoEstaCont();
		if(tecoOidTipoEstaCont != null && tecoOidTipoEstaCont.getId() != null) checkCombo("tecoOidTipoEstaCont" , tecoOidTipoEstaCont.getId().toString());
		asignar("TEXT", "codAtri", FormatUtils.formatObject(calAtribEstadConta.getCodAtri(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "Descripcion", FormatUtils.formatObject(calAtribEstadConta.getDescripcion(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		loadLocalizationVars(calAtribEstadConta);
		
			
		//Deshabilitamos todos los campos para que no se editen
		
					asignarAtributo("COMBO", "tecoOidTipoEstaCont", "disabled", "S");asignarAtributo("TEXT", "codAtri", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "CAL_ATRIB_ESTAD_CONTA", "calAtribEstadContaFrm", "Descripcion", false);
		...
		asignarAtributo("COMBO", "tecoOidTipoEstaCont", "req", "S");
		asignarAtributo("TEXT", "codAtri", "req", "S");
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('calAtribEstadContaFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "calAtribEstadContaFrm", "oculto", "N");
		...
		traza("MMG::Creando CalAtribEstadConta");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		CalAtribEstadContaData calAtribEstadContaQuery= new CalAtribEstadContaData();
		calAtribEstadContaQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(calAtribEstadConta.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"calAtribEstadContaFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"calAtribEstadContaFrm\",1, false)");
					asignarAtributo("COMBO","tecoOidTipoEstaCont", "ontab", "ejecutarAccionFocoModificacion(\"calAtribEstadContaFrm\",2, true)");
					asignarAtributo("COMBO","tecoOidTipoEstaCont", "onshtab", "ejecutarAccionFocoModificacion(\"calAtribEstadContaFrm\",2, false)");
				asignarAtributo("AREATEXTO", "codAtri", "ontab","ejecutarAccionFocoModificacion(\"calAtribEstadContaFrm\",3, true)");
				asignarAtributo("AREATEXTO", "codAtri", "onshtab","ejecutarAccionFocoModificacion(\"calAtribEstadContaFrm\",3, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"calAtribEstadContaFrm\",4, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"calAtribEstadContaFrm\",4, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","calAtribEstadContaTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","calAtribEstadContaTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es tecoOidTipoEstaCont...");		
				
					traza("MMG: en desactivateNonModifyFields encontrado atributo no editable...");
				
						asignarAtributo("COMBO", "tecoOidTipoEstaCont", "disabled", "S");
				traza("MMG: el atributo es codAtri...");		
				
					traza("MMG: en desactivateNonModifyFields encontrado atributo no editable...");
				
						// borrarCampo("codAtri");
						asignarAtributo ("TEXT", "codAtri", "disabled", "S");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","calAtribEstadContaFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","calAtribEstadContaListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","calAtribEstadContaListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(CalAtribEstadContaData calAtribEstadConta) throws Exception{
		HashMap checkedCombos = new HashMap();
		CalTipoEstadContaData tecoOidTipoEstaCont = new CalTipoEstadContaData();
		
						asignarComboResultados(BUSINESSID_TECOOIDTIPOESTACONT_QUERY,TECOOIDTIPOESTACONT_COMBO_CONNECTOR, 
			tecoOidTipoEstaCont, tecoOidTipoEstaCont.clone(), "calTipoEstadConta", "tecoOidTipoEstaCont", "result_ROWSET" );
		if(calAtribEstadConta != null && calAtribEstadConta.getTecoOidTipoEstaCont() != null){
				checkCombo("tecoOidTipoEstaCont" , calAtribEstadConta.getTecoOidTipoEstaCont().getId().toString());
			}
	...
	* @param calAtribEstadConta La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(CalAtribEstadContaData calAtribEstadConta) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		CalAtribEstadContaData calAtribEstadConta = 
			(CalAtribEstadContaData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(calAtribEstadConta.getTecoOidTipoEstaCont() != null){
			calAtribEstadConta.setTecoOidTipoEstaCont((es.indra.belcorp.mso.CalTipoEstadContaData)
			getSingleObject(BUSINESSID_TECOOIDTIPOESTACONT_QUERY, 
			calAtribEstadConta.getTecoOidTipoEstaCont(),
			calAtribEstadConta.getTecoOidTipoEstaCont().clone(),
			"calTipoEstadConta"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(calAtribEstadConta);
		loadLeafDependenceCombos(calAtribEstadConta);
	}
	...
	*/
	...
	protected void loadLocalizationVars(CalAtribEstadContaData calAtribEstadConta) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("CAL_ATRIB_ESTAD_CONTA");
		mmgLocalizationQuery.setEntiPk(calAtribEstadConta.getId());
