...
public class contenido_seleccion_fichero  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_seleccion_fichero" );
      ((Element)v.get(0)).setAttribute("cod","0377" );
      ((Element)v.get(0)).setAttribute("titulo","Mantener unidades geográficas" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(2)).setAttribute("src","contenido_patalla_carga_seleccion_fichero.js" );
      ...
      ((Element)v.get(5)).setAttribute("valor","LPCargaFichero" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(9)).setAttribute("nombre","seleccion" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(10)).setAttribute("nombre","mensaje" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(11)).setAttribute("nombre","longMinima" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(12)).setAttribute("nombre","nombreFile" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(13)).setAttribute("nombre","procesarArchivoP0003" );
