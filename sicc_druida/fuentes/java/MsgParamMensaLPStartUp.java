/*
    INDRA/CAR/mmg
    $Id: MsgParamMensaLPStartUp.java,v 1.1 2009/12/03 18:42:58 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class MsgParamMensaLPStartUp extends MMGDruidaBase{
	//Constantes que definen la altura de los formularios según el modo
	public static final short QUERYFORM_SIZE = 105;
	public static final short CREATEFORM_SIZE = 103;
	public static final short UPDATEFORM_SIZE = 103;
	public static final short VIEWFORM_SIZE = 103;
	...
	public MsgParamMensaLPStartUp(){
		super();
	}

	public void inicio() throws Exception {
		pagina("MsgParamMensaPage");
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "MsgParamMensaPage", "cod", "MsgParamMensa." + accion + ".label");
			...
			limpiarBotoneraLista("msgParamMensa", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codDatoVari", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 7);");
		
		//Primero determianmos el nombre del campo en la entidad de oriegen donde se van a cargar los datos
		asignar("VAR", "idAttributeLovOpener", conectorParametro(PARAMETRO_LOV_ATTRIBUTO));
		asignar("VAR", "idEntityLovOpener", conectorParametro(PARAMETRO_LOV_ENTIDAD));
		//asignarAtributo("CAPA", "msgParamMensaLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "MsgParamMensaPage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("MsgParamMensaLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		MsgParamMensaData msgParamMensaQuery= new MsgParamMensaData();
		msgParamMensaQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		MsgParamMensaData datosResult = (MsgParamMensaData)getSingleObject(BUSINESSID_QUERY, msgParamMensaQuery, 
			msgParamMensaQuery.clone(), "msgParamMensa");
		...
		MsgParamMensaData msgParamMensa = datosResult;
		asignar("TEXT", "codDatoVari", FormatUtils.formatObject(msgParamMensa.getCodDatoVari(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("AREATEXTO", "desDatoVari", FormatUtils.formatObject(msgParamMensa.getDesDatoVari(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "fecSist", FormatUtils.formatObject(msgParamMensa.getFecSist(), 
		...
		asignarAtributo("TEXT", "codDatoVari", "disabled", "S");
		asignarAtributo("AREATEXTO", "desDatoVari", "disabled", "S");
		asignarAtributo("TEXT", "fecSist", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		...
		asignarAtributo("TEXT", "codDatoVari", "req", "S");
		asignarAtributo("AREATEXTO", "desDatoVari", "req", "S");
		asignarAtributo("TEXT", "fecSist", "req", "S");
		...
		String separadorMiles = decimalSeparator.equals(".") ? "," : ".";
		asignarAtributo("TEXT", "codDatoVari", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 7);");
		asignarAtributo("AREATEXTO", "desDatoVari", "validacion", "ValidaLongitud(cdos_trim(valor), 1, 80)");
		asignarAtributo("TEXT", "fecSist", "validacion", "mensaje = ValidaFechaMMG(cdos_trim(valor), '" + datePattern + "');");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "msgParamMensaFrm", "oculto", "N");
		...
		traza("MMG::Creando MsgParamMensa");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		MsgParamMensaData msgParamMensaQuery= new MsgParamMensaData();
		msgParamMensaQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(msgParamMensa.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"msgParamMensaFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"msgParamMensaFrm\",1, false)");
					asignarAtributo("COMBO","paisOidPais", "ontab", "ejecutarAccionFocoModificacion(\"msgParamMensaFrm\",2, true)");
					asignarAtributo("COMBO","paisOidPais", "onshtab", "ejecutarAccionFocoModificacion(\"msgParamMensaFrm\",2, false)");
				asignarAtributo("AREATEXTO", "codDatoVari", "ontab","ejecutarAccionFocoModificacion(\"msgParamMensaFrm\",3, true)");
				asignarAtributo("AREATEXTO", "codDatoVari", "onshtab","ejecutarAccionFocoModificacion(\"msgParamMensaFrm\",3, false)");
				asignarAtributo("AREATEXTO", "desDatoVari", "ontab","ejecutarAccionFocoModificacion(\"msgParamMensaFrm\",4, true)");
				asignarAtributo("AREATEXTO", "desDatoVari", "onshtab","ejecutarAccionFocoModificacion(\"msgParamMensaFrm\",4, false)");
				asignarAtributo("AREATEXTO", "fecSist", "ontab","ejecutarAccionFocoModificacion(\"msgParamMensaFrm\",5, true)");
				asignarAtributo("AREATEXTO", "fecSist", "onshtab","ejecutarAccionFocoModificacion(\"msgParamMensaFrm\",5, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","msgParamMensaTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","msgParamMensaTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codDatoVari...");		
				
					traza("MMG: en desactivateNonModifyFields encontrado atributo no editable...");
				
						// borrarCampo("codDatoVari");
						asignarAtributo ("TEXT", "codDatoVari", "disabled", "S");
				traza("MMG: el atributo es desDatoVari...");		
				
				traza("MMG: el atributo es fecSist...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","msgParamMensaFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","msgParamMensaListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","msgParamMensaListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(MsgParamMensaData msgParamMensa) throws Exception{
		...
		if(msgParamMensa != null && msgParamMensa.getPaisOidPais() != null){
				checkCombo("paisOidPais" , msgParamMensa.getPaisOidPais().getId().toString());
			}
	...
	* @param msgParamMensa La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(MsgParamMensaData msgParamMensa) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		MsgParamMensaData msgParamMensa = 
			(MsgParamMensaData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(msgParamMensa.getPaisOidPais() != null){
			msgParamMensa.setPaisOidPais((es.indra.belcorp.mso.SegPaisViewData)
			getSingleObject(BUSINESSID_PAISOIDPAIS_QUERY, 
			msgParamMensa.getPaisOidPais(),
			msgParamMensa.getPaisOidPais().clone(),
			"segPaisView"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(msgParamMensa);
		loadLeafDependenceCombos(msgParamMensa);
	}
