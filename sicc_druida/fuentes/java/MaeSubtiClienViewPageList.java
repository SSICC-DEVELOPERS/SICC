...
public class MaeSubtiClienViewPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","maeSubtiClienViewList" );
      ...
      ((Element)v.get(14)).setAttribute("cod","MaeSubtiClienView.ticlOidTipoClie.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","MaeSubtiClienView.codSubtClie.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","MaeSubtiClienView.Descripcion.label" );
