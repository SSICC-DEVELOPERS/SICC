/*
    INDRA/CAR/mmg
    $Id: BelFormaPagoTaponLPStartUp.java,v 1.1 2009/12/03 18:36:16 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class BelFormaPagoTaponLPStartUp extends MMGDruidaBase{
	...
	public BelFormaPagoTaponLPStartUp(){
		super();
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			buildJsPageSize("BelFormaPagoTapon");
			...
			asignarAtributo("PAGINA", "BelFormaPagoTaponPage", "cod", "BelFormaPagoTapon." + accion + ".label");
			...
			limpiarBotoneraLista("belFormaPagoTapon", accion);
	...
	protected void cmdLov() throws Exception{
		...
		//asignarAtributo("CAPA", "belFormaPagoTaponLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "BelFormaPagoTaponPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		BelFormaPagoTaponData belFormaPagoTaponQuery= new BelFormaPagoTaponData();
		belFormaPagoTaponQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		BelFormaPagoTaponData datosResult = (BelFormaPagoTaponData)getSingleObject(BUSINESSID_QUERY, belFormaPagoTaponQuery, 
			belFormaPagoTaponQuery.clone(), "belFormaPagoTapon");
		...
		preservaHiddensI18n(new Integer(1), "BEL_FORMA_PAGO", "belFormaPagoTaponFrm", "Descripcion", true);
		...
		BelFormaPagoTaponData belFormaPagoTapon = datosResult;
		asignar("TEXT", "codFormPago", FormatUtils.formatObject(belFormaPagoTapon.getCodFormPago(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("AREATEXTO", "Descripcion", FormatUtils.formatObject(belFormaPagoTapon.getDescripcion(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		loadLocalizationVars(belFormaPagoTapon);
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "BEL_FORMA_PAGO", "belFormaPagoTaponFrm", "Descripcion", false);
		...
		asignarAtributo("AREATEXTO", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('belFormaPagoTaponFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "belFormaPagoTaponFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		BelFormaPagoTaponData belFormaPagoTaponQuery= new BelFormaPagoTaponData();
		belFormaPagoTaponQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(belFormaPagoTapon.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"belFormaPagoTaponFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"belFormaPagoTaponFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codFormPago", "ontab","ejecutarAccionFocoModificacion(\"belFormaPagoTaponFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codFormPago", "onshtab","ejecutarAccionFocoModificacion(\"belFormaPagoTaponFrm\",2, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"belFormaPagoTaponFrm\",3, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"belFormaPagoTaponFrm\",3, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","belFormaPagoTaponTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","belFormaPagoTaponTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","belFormaPagoTaponFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","belFormaPagoTaponListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","belFormaPagoTaponListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(BelFormaPagoTaponData belFormaPagoTapon) throws Exception{
	...
	* @param belFormaPagoTapon La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(BelFormaPagoTaponData belFormaPagoTapon) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		BelFormaPagoTaponData belFormaPagoTapon = 
			(BelFormaPagoTaponData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(belFormaPagoTapon);
		loadLeafDependenceCombos(belFormaPagoTapon);
	}
	...
	*/
	...
	protected void loadLocalizationVars(BelFormaPagoTaponData belFormaPagoTapon) throws Exception{
		...
		mmgLocalizationQuery.setEntiPk(belFormaPagoTapon.getId());
