...
public class EduPlantCursoCabecPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","eduPlantCursoCabecList" );
      ...
      ((Element)v.get(9)).setAttribute("height","20" );
      ((Element)v.get(9)).setAttribute("IDScroll","EstCab" );
      ((Element)v.get(9)).setAttribute("imgFondo","" );
      ((Element)v.get(9)).setAttribute("colFondo","#CCCCCC" );
      ((Element)v.get(0)).appendChild((Element)v.get(9));
      /* Termina nodo:9   */

      /* Empieza nodo:10 / Elemento padre: 0   */
      v.add(doc.createElement("DATOS"));
      ((Element)v.get(10)).setAttribute("alto","22" );
      ((Element)v.get(10)).setAttribute("accion","" );
      ((Element)v.get(10)).setAttribute("tipoEnvio","seleccion" );
      ((Element)v.get(10)).setAttribute("formaEnvio","xml" );
      ((Element)v.get(10)).setAttribute("maxSel","1" );
      ((Element)v.get(10)).setAttribute("msgErrMaxSel","" );
      ((Element)v.get(10)).setAttribute("coloresScrollNativo","#D4D0C8,black,white,#D4D0C8,#D4D0C8,#ECE9E4,black" );
      ((Element)v.get(10)).setAttribute("colorROver","#D0D9E8" );
      ((Element)v.get(10)).setAttribute("onLoad","" );
      ((Element)v.get(10)).setAttribute("colorSelecc","#D0D9E8" );
