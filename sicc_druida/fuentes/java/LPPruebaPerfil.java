...
public class LPPruebaPerfil extends LPSICCBase {
  ...
  public void ejecucion() throws Exception {      
    try {
      setTrazaFichero();
      rastreo();
      traza("* * * Entre a LPPruebaPerfil * * *");
      traza("* * * LPPruebaPerfil * * *");
      ...
      if(accion.equals("")) {
        traza("****** Entre por accion vacio ********");
        pagina("prueba_perfil");
      ...
      if(accion.equals("modificar")) {
        traza("****** Entre por accion modificar ********");        
        pagina("contenido_perfil_usuario_insertar");
        cargarMenuSecundario();
      ...
      if(accion.equals("consultar")) {
        traza("****** Entre por accion consultar ********");
        pagina("contenido_perfil_usuario_insertar");
        cargarMenuSecundario();
        String conPerfil = conectorParametro("varPerfil");
      ...
      if(accion.equals("guardar")) {
        traza("****** Entre por accion guardar ********");
        pagina("contenido_perfil_usuario_insertar");
        ...
        traza("*************** strInicio: " + strInicio);        
        
        if(!strInicio.equals("null")) {
          traza("*************** Entre al if porque inicio no es null");
          Long inicio = new Long(strInicio);    
          dtoPerfil.setInicio(inicio);
        }

        traza("*************** nombre: " + nombre);
        traza("*************** strFunciones: " + strFunciones);             
    ...
    private void carga(String perfil, boolean eventosArbol) throws Exception {          
      ...
      traza("*********** rsFunciones " + rsFunciones);
      traza("*********** dtoElemen " + dtoElemen);   
    ...
    private void buildTree(DTOElementoMenu dtoElementoMenu) throws Exception {
      ...
      elementAux.setAttribute("texto", "MENU");      
      ...
      traza("******************** El tag ARBOL es: " + miObj.getXML());
