...
public class contenido_agrupacion_stock_modificar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_agrupacion_stock_modificar" );
      ((Element)v.get(0)).setAttribute("cod","0393" );
      ...
      ((Element)v.get(1)).setAttribute("src","contenido_agrupacion_stock_modificar.js" );
      ...
      ((Element)v.get(6)).setAttribute("valor","LPMantenimientoAgrupacionStock" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(8)).setAttribute("nombre","oidAgrupacionStock" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(32)).setAttribute("width","506" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(40)).setAttribute("nombre","lblCodAgrupacionStock" );
      ...
      ((Element)v.get(40)).setAttribute("cod","1324" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(51)).setAttribute("nombre","txtCodAgrupacionStock" );
      ((Element)v.get(51)).setAttribute("id","datosCampos" );
      ((Element)v.get(51)).setAttribute("max","2" );
      ((Element)v.get(51)).setAttribute("tipo","" );
      ((Element)v.get(51)).setAttribute("onchange","" );
      ((Element)v.get(51)).setAttribute("req","N" );
      ((Element)v.get(51)).setAttribute("size","2" );
      ((Element)v.get(51)).setAttribute("valor","" );
      ((Element)v.get(51)).setAttribute("validacion","" );
      ((Element)v.get(51)).setAttribute("onshtab","focoboton();" );
      ((Element)v.get(51)).setAttribute("onblur","mayusculas();" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(71)).setAttribute("accion","accionBuscar();" );
      ((Element)v.get(71)).setAttribute("estado","false" );
      ((Element)v.get(71)).setAttribute("cod","1" );
      ((Element)v.get(71)).setAttribute("ontab","focobotonBuscar();" );
      ...
      ((Element)v.get(81)).setAttribute("alto","315" );
      ...
      ((Element)v.get(82)).setAttribute("ancho","510" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(88)).setAttribute("vertical","0" );
      ...
      ((Element)v.get(96)).setAttribute("cod","1324" );
      ...
      ((Element)v.get(97)).setAttribute("cod","9" );
      ...
      ((Element)v.get(102)).setAttribute("nombre","mipgndo" );
      ((Element)v.get(102)).setAttribute("ancho","510" );
      ((Element)v.get(102)).setAttribute("sep","$" );
      ((Element)v.get(102)).setAttribute("x","12" );
   }

   private void getXML450(Document doc) {
      ((Element)v.get(102)).setAttribute("class","botonera" );
      ((Element)v.get(102)).setAttribute("y","278" );
      ((Element)v.get(102)).setAttribute("control","|" );
      ((Element)v.get(102)).setAttribute("conector","conectorSandra" );
      ((Element)v.get(102)).setAttribute("rowset","" );
      ((Element)v.get(102)).setAttribute("cargainicial","N" );
      ((Element)v.get(102)).setAttribute("onload","procesarPaginado(mipgndo,msgError,ultima,rowset,'muestraLista(ultima, rowset)')" );
      ((Element)v.get(82)).appendChild((Element)v.get(102));

      /* Empieza nodo:103 / Elemento padre: 102   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(103)).setAttribute("nombre","ret1" );
      ((Element)v.get(103)).setAttribute("x","37" );
      ((Element)v.get(103)).setAttribute("y","282" );
      ((Element)v.get(103)).setAttribute("ID","botonContenido" );
      ((Element)v.get(103)).setAttribute("img","retroceder_on" );
      ...
      ((Element)v.get(103)).setAttribute("accion","mipgndo.retroceder();" );
      ((Element)v.get(102)).appendChild((Element)v.get(103));
      /* Termina nodo:103   */

      /* Empieza nodo:104 / Elemento padre: 102   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(104)).setAttribute("nombre","ava1" );
      ((Element)v.get(104)).setAttribute("x","52" );
      ((Element)v.get(104)).setAttribute("y","282" );
      ((Element)v.get(104)).setAttribute("ID","botonContenido" );
      ((Element)v.get(104)).setAttribute("img","avanzar_on" );
      ...
      ((Element)v.get(104)).setAttribute("accion","mipgndo.avanzar();" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(105)).setAttribute("nombre","primera1" );
      ((Element)v.get(105)).setAttribute("x","20" );
      ((Element)v.get(105)).setAttribute("y","282" );
      ((Element)v.get(105)).setAttribute("ID","botonContenido" );
      ((Element)v.get(105)).setAttribute("img","primera_on" );
      ((Element)v.get(105)).setAttribute("tipo","-2" );
      ((Element)v.get(105)).setAttribute("estado","false" );
      ((Element)v.get(105)).setAttribute("alt","" );
      ((Element)v.get(105)).setAttribute("codigo","" );
      ((Element)v.get(105)).setAttribute("accion","mipgndo.retrocederPrimeraPagina();" );
      ((Element)v.get(81)).appendChild((Element)v.get(105));
      /* Termina nodo:105   */

      /* Empieza nodo:106 / Elemento padre: 81   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(106)).setAttribute("nombre","separa" );
      ((Element)v.get(106)).setAttribute("x","59" );
      ((Element)v.get(106)).setAttribute("y","278" );
      ((Element)v.get(106)).setAttribute("ID","botonContenido" );
      ((Element)v.get(106)).setAttribute("img","separa_base" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(107)).setAttribute("nombre","btnModificar" );
      ((Element)v.get(107)).setAttribute("x","80" );
      ((Element)v.get(107)).setAttribute("y","279" );
      ...
      ((Element)v.get(107)).setAttribute("cod","2" );
      ((Element)v.get(107)).setAttribute("accion","accionModificar();" );
      ((Element)v.get(107)).setAttribute("ontab","focaliza('formulario.txtCodAgrupacionStock');" );
      ((Element)v.get(107)).setAttribute("onshtab","focoBuscar();" );
      ((Element)v.get(81)).appendChild((Element)v.get(107));
      /* Termina nodo:107   */

      /* Empieza nodo:108 / Elemento padre: 81   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(108)).setAttribute("nombre","btnDetalle" );
      ((Element)v.get(108)).setAttribute("x","80" );
      ((Element)v.get(108)).setAttribute("y","279" );
      ...
      ((Element)v.get(108)).setAttribute("accion","accionDetalle()" );
      ((Element)v.get(108)).setAttribute("ontab","focaliza('formulario.txtCodAgrupacionStock');" );
      ((Element)v.get(108)).setAttribute("onshtab","focoBuscar();" );
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(109)).setAttribute("nombre","capaEspacio" );
      ((Element)v.get(109)).setAttribute("alto","12" );
      ...
      ((Element)v.get(109)).setAttribute("visibilidad","visible" );
   }

   private void getXML540(Document doc) {
      ((Element)v.get(109)).setAttribute("contravsb","" );
      ((Element)v.get(109)).setAttribute("x","0" );
      ((Element)v.get(109)).setAttribute("y","425" );
