...
public class EduFrecuCursoPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","eduFrecuCursoList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","EduFrecuCurso.codFrec.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","EduFrecuCurso.Descripcion.label" );
