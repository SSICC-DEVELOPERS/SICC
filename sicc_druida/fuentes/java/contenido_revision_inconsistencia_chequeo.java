...
public class contenido_revision_inconsistencia_chequeo  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_inconsistencia_chequeo" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","contenido_revision_inconsistencia_chequeo.js" );
      ...
      ((Element)v.get(7)).setAttribute("name","txtFecha" );
      ((Element)v.get(7)).setAttribute("required","true" );
      ((Element)v.get(7)).setAttribute("cod","MsgParamMensa.fecSist.label" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(15)).setAttribute("nombre","fechaSistema" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(16)).setAttribute("nombre","oidCabecera" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(17)).setAttribute("nombre","numeroCaja" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(18)).setAttribute("nombre","numeroEtiqueta" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(43)).setAttribute("nombre","lblFecha" );
      ...
      ((Element)v.get(43)).setAttribute("cod","MsgParamMensa.fecSist.label" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(50)).setAttribute("nombre","txtFecha" );
      ((Element)v.get(50)).setAttribute("id","datosCampos" );
      ((Element)v.get(50)).setAttribute("max","10" );
      ((Element)v.get(50)).setAttribute("tipo","" );
      ((Element)v.get(50)).setAttribute("onchange","" );
      ((Element)v.get(50)).setAttribute("req","S" );
      ((Element)v.get(50)).setAttribute("size","15" );
      ((Element)v.get(50)).setAttribute("valor","" );
      ((Element)v.get(50)).setAttribute("validacion","" );
      ((Element)v.get(50)).setAttribute("ontab","onTABtxtFecha();" );
      ((Element)v.get(50)).setAttribute("onshtab","onSHTABtxtFecha();" );
      ...
      /* Empieza nodo:56 / Elemento padre: 31   */
      v.add(doc.createElement("fieldset"));
      ((Element)v.get(31)).appendChild((Element)v.get(56));
      ...
      ((Element)v.get(60)).setAttribute("nombre","btnBuscar" );
      ((Element)v.get(60)).setAttribute("ID","botonContenido" );
      ((Element)v.get(60)).setAttribute("tipo","html" );
      ((Element)v.get(60)).setAttribute("accion","onClickBuscar();" );
      ((Element)v.get(60)).setAttribute("estado","false" );
      ((Element)v.get(60)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(60)).setAttribute("ontab","onTABbtnBuscar();" );
      ((Element)v.get(60)).setAttribute("onshtab","onSHTABbtnBuscar();" );
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(61)).setAttribute("nombre","capaLista" );
      ((Element)v.get(61)).setAttribute("ancho","100%" );
      ((Element)v.get(61)).setAttribute("alto","330" );
      ((Element)v.get(61)).setAttribute("x","5" );
      ((Element)v.get(61)).setAttribute("y","120" );
      ...
      ((Element)v.get(61)).setAttribute("visibilidad","" );
      ...
      ((Element)v.get(62)).setAttribute("nombre","listado1" );
      ((Element)v.get(62)).setAttribute("ancho","369" );
      ((Element)v.get(62)).setAttribute("alto","301" );
      ((Element)v.get(62)).setAttribute("x","12" );
      ((Element)v.get(62)).setAttribute("y","0" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(65)).setAttribute("aximROver","bot_despliega_columna_over.gif" );
      ...
      ((Element)v.get(68)).setAttribute("vertical","1" );
      ...
      ((Element)v.get(70)).setAttribute("cod","00135" );
      ...
      ((Element)v.get(73)).setAttribute("oculta","S" );
      ...
      ((Element)v.get(77)).setAttribute("oculta","S" );
      ...
      ((Element)v.get(78)).setAttribute("alto","25" );
      ((Element)v.get(78)).setAttribute("IDScroll","EstCab" );
      ((Element)v.get(78)).setAttribute("imgFondo","" );
      ((Element)v.get(78)).setAttribute("colFondo","#CCCCCC" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(79)).setAttribute("cod","2102" );
      ((Element)v.get(78)).appendChild((Element)v.get(79));

      /* Elemento padre:79 / Elemento actual: 80   */
      v.add(doc.createTextNode("Oid lista picado cabecera"));
      ...
      ((Element)v.get(83)).setAttribute("cod","ApeCajasCheq.nroCaja.label" );
      ...
      ((Element)v.get(87)).setAttribute("cod","2114" );
      ...
      /* Empieza nodo:96 / Elemento padre: 62   */
      v.add(doc.createElement("PAGINADO"));
      ((Element)v.get(96)).setAttribute("nombre","mipgndo" );
      ((Element)v.get(96)).setAttribute("ancho","679" );
      ((Element)v.get(96)).setAttribute("sep","$" );
      ((Element)v.get(96)).setAttribute("x","12" );
      ((Element)v.get(96)).setAttribute("class","botonera" );
      ((Element)v.get(96)).setAttribute("y","294" );
      ((Element)v.get(96)).setAttribute("control","|" );
      ((Element)v.get(96)).setAttribute("conector","" );
      ((Element)v.get(96)).setAttribute("rowset","" );
      ((Element)v.get(96)).setAttribute("cargainicial","N" );
      ((Element)v.get(96)).setAttribute("onload","procesarPaginado(mipgndo,msgError, ultima, rowset, 'muestraLista(ultima, rowset)')" );
      ((Element)v.get(62)).appendChild((Element)v.get(96));

      /* Empieza nodo:97 / Elemento padre: 96   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(97)).setAttribute("nombre","ret" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(98)).setAttribute("nombre","ava" );
      ((Element)v.get(98)).setAttribute("x","52" );
      ((Element)v.get(98)).setAttribute("y","282" );
      ...
      /* Empieza nodo:99 / Elemento padre: 61   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(99)).setAttribute("nombre","primera" );
      ((Element)v.get(99)).setAttribute("x","20" );
      ((Element)v.get(99)).setAttribute("y","282" );
      ...
      ((Element)v.get(61)).appendChild((Element)v.get(99));
      /* Termina nodo:99   */

      /* Empieza nodo:100 / Elemento padre: 61   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(100)).setAttribute("nombre","separa" );
      ((Element)v.get(100)).setAttribute("x","59" );
      ((Element)v.get(100)).setAttribute("y","278" );
      ...
      ((Element)v.get(61)).appendChild((Element)v.get(100));
      /* Termina nodo:100   */

      /* Empieza nodo:101 / Elemento padre: 61   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(101)).setAttribute("nombre","btnRevisar" );
      ((Element)v.get(101)).setAttribute("x","80" );
      ((Element)v.get(101)).setAttribute("y","279" );
      ...
      ((Element)v.get(101)).setAttribute("cod","3155" );
      ((Element)v.get(101)).setAttribute("accion","onClickRevisar();" );
      ((Element)v.get(101)).setAttribute("ontab","onTABBotonRevisar();" );
      ((Element)v.get(101)).setAttribute("onshtab","onSHTABBotonRevisar();" );
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(102)).setAttribute("nombre","capaEspacio" );
      ((Element)v.get(102)).setAttribute("alto","12" );
      ((Element)v.get(102)).setAttribute("ancho","100%" );
      ((Element)v.get(102)).setAttribute("colorf","" );
      ((Element)v.get(102)).setAttribute("borde","0" );
      ((Element)v.get(102)).setAttribute("imagenf","" );
      ((Element)v.get(102)).setAttribute("repeat","" );
      ((Element)v.get(102)).setAttribute("padding","" );
      ((Element)v.get(102)).setAttribute("visibilidad","visible" );
      ((Element)v.get(102)).setAttribute("contravsb","" );
      ((Element)v.get(102)).setAttribute("x","0" );
      ((Element)v.get(102)).setAttribute("y","428" );
      ((Element)v.get(102)).setAttribute("zindex","" );
