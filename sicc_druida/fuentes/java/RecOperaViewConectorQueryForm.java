...
public class RecOperaViewConectorQueryForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad RecOperaView" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGRecOperaViewQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGRecOperaViewQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","RecOperaViewFormFormatter" );
   ...
   private void getXML90(Document doc) {
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(19)).setAttribute("NOMBRE","indFaltMerc" );
