...
public class BelTipoMovimCajaPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","BelTipoMovimCaja.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","BelTipoMovimCaja.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('belTipoMovimCajaFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('belTipoMovimCajaFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(50)).setAttribute("nombre","codCajaTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lblCodCaja" );
      ((Element)v.get(54)).setAttribute("alto","13" );
      ((Element)v.get(54)).setAttribute("filas","1" );
      ((Element)v.get(54)).setAttribute("id","datosTitle" );
      ((Element)v.get(54)).setAttribute("cod","BelTipoMovimCaja.codCaja.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(55)).setAttribute("nombre","codCajaWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(57)).setAttribute("nombre","codCaja" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('belTipoMovimCajaFrm',2, true)" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('belTipoMovimCajaFrm', 2, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(58)).setAttribute("nombre","codCajaGapTdId" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(75)).setAttribute("nombre","desTipoMoviCajaTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(79)).setAttribute("nombre","lblDesTipoMoviCaja" );
      ((Element)v.get(79)).setAttribute("alto","13" );
      ((Element)v.get(79)).setAttribute("filas","1" );
      ((Element)v.get(79)).setAttribute("id","datosTitle" );
      ((Element)v.get(79)).setAttribute("cod","BelTipoMovimCaja.desTipoMoviCaja.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(80)).setAttribute("nombre","desTipoMoviCajaWidgetTrId" );
   }
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(82)).setAttribute("nombre","desTipoMoviCaja" );
      ...
      ((Element)v.get(82)).setAttribute("ontab","ejecutarAccionFoco('belTipoMovimCajaFrm',3, true)" );
      ((Element)v.get(82)).setAttribute("onshtab","ejecutarAccionFoco('belTipoMovimCajaFrm', 3, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(83)).setAttribute("nombre","desTipoMoviCajaGapTdId" );
   ...
   private void getXML450(Document doc) {
      ((Element)v.get(100)).setAttribute("nombre","valSignTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(104)).setAttribute("nombre","lblValSign" );
      ...
      ((Element)v.get(104)).setAttribute("cod","BelTipoMovimCaja.valSign.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(105)).setAttribute("nombre","valSignWidgetTrId" );
      ...
      ((Element)v.get(107)).setAttribute("nombre","valSign" );
      ...
      ((Element)v.get(107)).setAttribute("ontab","ejecutarAccionFoco('belTipoMovimCajaFrm',4, true)" );
      ((Element)v.get(107)).setAttribute("onshtab","ejecutarAccionFoco('belTipoMovimCajaFrm',4, false)" );
      ...
      v.add(doc.createElement("ROW"));
      ((Element)v.get(112)).setAttribute("ID","-" );
      ...
      v.add(doc.createElement("ROW"));
      ((Element)v.get(115)).setAttribute("ID","+-" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(118)).setAttribute("nombre","valSignGapTdId" );
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(122)).setAttribute("nombre","formGapTr3" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(129)).setAttribute("nombre","formTr4" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(135)).setAttribute("nombre","indAutoTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(139)).setAttribute("nombre","lblIndAuto" );
      ...
      ((Element)v.get(139)).setAttribute("cod","BelTipoMovimCaja.indAuto.label" );
   ...
   private void getXML630(Document doc) {
      ((Element)v.get(140)).setAttribute("nombre","indAutoWidgetTrId" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(142)).setAttribute("nombre","indAuto" );
      ...
      ((Element)v.get(142)).setAttribute("ontab","ejecutarAccionFoco('belTipoMovimCajaFrm',5, true)" );
      ((Element)v.get(142)).setAttribute("onshtab","ejecutarAccionFoco('belTipoMovimCajaFrm',5, false)" );
      ...
      v.add(doc.createElement("ROW"));
      ((Element)v.get(144)).setAttribute("ID","M" );
      ((Element)v.get(143)).appendChild((Element)v.get(144));

      /* Empieza nodo:145 / Elemento padre: 144   */
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(145)).setAttribute("NOMBRE","CODIGO" );
      ((Element)v.get(145)).setAttribute("TIPO","STRING" );
      ((Element)v.get(145)).setAttribute("VALOR","M" );
      ...
      ((Element)v.get(146)).setAttribute("VALOR","Manual" );
      ...
      v.add(doc.createElement("ROW"));
      ((Element)v.get(147)).setAttribute("ID","A" );
      ((Element)v.get(143)).appendChild((Element)v.get(147));

      /* Empieza nodo:148 / Elemento padre: 147   */
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(148)).setAttribute("NOMBRE","CODIGO" );
      ((Element)v.get(148)).setAttribute("TIPO","STRING" );
      ((Element)v.get(148)).setAttribute("VALOR","A" );
      ((Element)v.get(147)).appendChild((Element)v.get(148));
      /* Termina nodo:148   */

      /* Empieza nodo:149 / Elemento padre: 147   */
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(149)).setAttribute("NOMBRE","DESCRIPCION" );
      ((Element)v.get(149)).setAttribute("TIPO","STRING" );
      ((Element)v.get(149)).setAttribute("VALOR","Automatico" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(150)).setAttribute("nombre","indAutoGapTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(155)).setAttribute("nombre","formGapTr4" );
   ...
   private void getXML720(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(164)).setAttribute("nombre","belTipoMovimCajaTrButtons" );
      ...
      ((Element)v.get(171)).setAttribute("nombre","belTipoMovimCajaTdQueryButton" );
      ((Element)v.get(170)).appendChild((Element)v.get(171));

      /* Empieza nodo:172 / Elemento padre: 171   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(172)).setAttribute("nombre","belTipoMovimCajaQueryButton" );
      ((Element)v.get(172)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(172)).setAttribute("estado","false" );
      ((Element)v.get(172)).setAttribute("accion","belTipoMovimCajaFirstPage();" );
      ...
      ((Element)v.get(173)).setAttribute("nombre","belTipoMovimCajaTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(175)).setAttribute("nombre","belTipoMovimCajaLovNullButton" );
      ((Element)v.get(175)).setAttribute("ID","botonContenido" );
      ((Element)v.get(175)).setAttribute("tipo","html" );
      ((Element)v.get(175)).setAttribute("accion","belTipoMovimCajaLovNullSelectionAction();" );
