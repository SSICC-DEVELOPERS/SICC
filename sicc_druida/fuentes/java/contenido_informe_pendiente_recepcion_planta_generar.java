...
public class contenido_informe_pendiente_recepcion_planta_generar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_informe_pendiente_recepcion_planta_generar" );
      ((Element)v.get(0)).setAttribute("cod","0913" );
      ((Element)v.get(0)).setAttribute("titulo","Generar Informe pendiente recepción en planta" );
      ...
      v.add(doc.createTextNode("\r   \r   \r   function onLoad(){\r      configurarMenuSecundario('Formulario');\r      fMostrarMensajeError();\r      focaliza('Formulario.cbMarca');\r   }\r   function generar(formato){\r      if(sicc_validaciones_generales()){\r                 \r   \r          var a = new Object();\r          a.accion = 'generar';\r          a.marca = get('Formulario.cbMarca');      \r          a.canal = get('Formulario.cbCanal'); \r          a.campanaInicial = get('Formulario.cbCampanaInicial');      \r          a.campanaFinal = get('Formulario.cbCampanaFinal');  \r          a.tipoOperacion = get('Formulario.cbTipoOperacion');\r          a.tipoSalida = get('Formulario.cbTipoSalida');\r             \r          mostrarModalSICC('RECPendienteRecepcion','generar', a);  \r      }\r    }\r\r\r  \r  function onchangeMarcaCanal(){\r        \r       marca  = get('Formulario.cbMarca');\r       canal  = get('Formulario.cbCanal');\r       pais   = get('Formulario.pais');\r       idioma = get('Formulario.idioma');\r      \r       if(marca != '' && canal != ''){\r          var arr = new Array();\r                     \r          arr[arr.length] = [\"oidIdioma\", idioma]; \r          arr[arr.length] = [\"oidPais\", pais]; \r          arr[arr.length] = [\"marca\", marca];\r          arr[arr.length] = [\"canal\", canal];\r                  \r          recargaCombo(\"Formulario.cbCampanaInicial\",\"PRECargarPeriodos\",\"es.indra.sicc.dtos.cra.DTOPeriodo\",arr);\r          recargaCombo(\"Formulario.cbCampanaFinal\",\"PRECargarPeriodos\",\"es.indra.sicc.dtos.cra.DTOPeriodo\",arr);\r                \r       }\r    } \r\r\r\r   function fLimpiar(){\r     var aCombo = new Array(new Array(\"\",\"\"));\r     \r     set_combo('Formulario.cbCampanaInicial', aCombo, []); \r     set_combo('Formulario.cbCampanaFinal', aCombo, []); \r\r     \r     focaliza('Formulario.cbMarca');\r   }\r\r\r\r \r\r   \r"));
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(9)).setAttribute("name","cbCampanaInicial" );
      ((Element)v.get(9)).setAttribute("required","true" );
      ((Element)v.get(9)).setAttribute("cod","2726" );
      ((Element)v.get(6)).appendChild((Element)v.get(9));
      /* Termina nodo:9   */

      /* Empieza nodo:10 / Elemento padre: 6   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(10)).setAttribute("name","cbTipoOperacion" );
      ((Element)v.get(10)).setAttribute("required","true" );
      ((Element)v.get(10)).setAttribute("cod","375" );
      ((Element)v.get(6)).appendChild((Element)v.get(10));
      /* Termina nodo:10   */

      /* Empieza nodo:11 / Elemento padre: 6   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(11)).setAttribute("name","cbTipoSalida" );
      ((Element)v.get(11)).setAttribute("required","true" );
      ((Element)v.get(11)).setAttribute("cod","2731" );
   ...
   private void getXML360(Document doc) {
      ((Element)v.get(93)).setAttribute("nombre","cbCampanaInicial" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(98)).setAttribute("nombre","cbCampanaFinal" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(103)).setAttribute("nombre","cbTipoOperacion" );
      ((Element)v.get(103)).setAttribute("size","1" );
      ((Element)v.get(103)).setAttribute("multiple","N" );
      ((Element)v.get(103)).setAttribute("valorinicial","1" );
      ((Element)v.get(103)).setAttribute("textoinicial","Anulación" );
      ...
      ((Element)v.get(105)).setAttribute("ID","1" );
      ...
      ((Element)v.get(106)).setAttribute("VALOR","2" );
      ...
      ((Element)v.get(107)).setAttribute("VALOR","Resto" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(111)).setAttribute("nombre","cbTipoSalida" );
      ...
      ((Element)v.get(111)).setAttribute("textoinicial","Reporte" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(115)).setAttribute("VALOR","Excel" );
      ...
      /* Empieza nodo:118 / Elemento padre: 69   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(69)).appendChild((Element)v.get(118));
      ...
      /* Empieza nodo:123 / Elemento padre: 21   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(21)).appendChild((Element)v.get(123));
      ...
      ((Element)v.get(131)).setAttribute("accion","generar('pdf')" );
      ((Element)v.get(131)).setAttribute("estado","false" );
      ((Element)v.get(131)).setAttribute("cod","2495" );
      ((Element)v.get(131)).setAttribute("ontab","focaliza('Formulario.cbMarca')" );
      ...
      /* Empieza nodo:134 / Elemento padre: 21   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(21)).appendChild((Element)v.get(134));
