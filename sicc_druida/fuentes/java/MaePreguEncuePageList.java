...
public class MaePreguEncuePageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","maePreguEncueList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","MaePreguEncue.codPreg.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","MaePreguEncue.valPesoPreg.label" );
      ...
      ((Element)v.get(17)).setAttribute("cod","MaePreguEncue.enseOidEncu.label" );
      ...
      ((Element)v.get(18)).setAttribute("cod","MaePreguEncue.Descripcion.label" );
