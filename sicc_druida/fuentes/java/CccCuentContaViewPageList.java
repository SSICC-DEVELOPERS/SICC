...
public class CccCuentContaViewPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","cccCuentContaViewList" );
      ...
      ((Element)v.get(14)).setAttribute("cod","CccCuentContaView.codCuenCont.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","CccCuentContaView.Descripcion.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","CccCuentContaView.codCuenSap.label" );
