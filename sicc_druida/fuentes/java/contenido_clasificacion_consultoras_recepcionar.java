...
public class contenido_clasificacion_consultoras_recepcionar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_clasificacion_consultoras_recepcionar" );
      ((Element)v.get(0)).setAttribute("cod","01020" );
      ((Element)v.get(0)).setAttribute("titulo","Recepcionar clasificación consultoras Privilege" );
      ...
      v.add(doc.createTextNode("\r \r\rfunction onLoadPag() {\r  	configurarMenuSecundario(\"frmFormulario\");\r	set(\"frmFormulario.atxtObservaciones\", get(\"frmFormulario.observaciones\"));\r	focoDescripcion();\r}\r\rfunction fLimpiar() {\r	onLoadPag();\r}\r\rfunction focoDescripcion() {\r	focaliza(\"frmFormulario.txtDescripcion\");\r}\r\rfunction focoBotonRecepcionar() {\r	focalizaBotonHTML('botonContenido','btnRecepcionar');	\r}\r\rfunction enviarOnClick() {	\r	if(!sicc_validaciones_generales('obligatorios')) {\r		return;\r	}\r\r	var numeroLote = get(\"frmFormulario.numeroLote\");\r	var descripcionLote = get(\"frmFormulario.txtDescripcion\");\r	var observaciones = get(\"frmFormulario.atxtObservaciones\");\r	var modoEjecucion = get(\"frmFormulario.cbModEjecucion\");\r\r	set(\"frmFormulario.numeroLote\", numeroLote);\r	set(\"frmFormulario.descripcionLote\", descripcionLote);\r	set(\"frmFormulario.observaciones\", observaciones);\r	set(\"frmFormulario.modoEjecucion\", modoEjecucion);\r\r	eval(\"frmFormulario\").oculto= \"S\";\r	set(\"frmFormulario.accion\",'recepcionar');\r	set(\"frmFormulario.conectorAction\",'LPRecepcionarClasificacionConsultorasPrivilege');\r	enviaSICC(\"frmFormulario\", \"\", \"\", \"N\");\r}\r\rfunction reInicio() {\r\r	var formulario = getFormularioSICC();\r	set(formulario+\".conectorAction\",\"LPInicioBelcorp\");\r	set(formulario+\".accion\",\"\");\r	try{\r		parent.frames['menu'].location.reload();\r		parent.frames[\"iconos\"].mostrarCapa();\r	}catch(e){}\r	eval(formulario).oculto = 'N';\r	enviaSICC(formulario,'','','N');\r}\r\rfunction errorEnRecepcionar() {\r	focoDescripcion();\r}\r\r \r"));
      ...
      ((Element)v.get(7)).setAttribute("cod","MMGGlobal.localization.description.label" );
      ((Element)v.get(7)).setAttribute("group","obligatorios" );
      ((Element)v.get(6)).appendChild((Element)v.get(7));
      /* Termina nodo:7   */

      /* Empieza nodo:8 / Elemento padre: 6   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(8)).setAttribute("name","cbModEjecucion" );
      ((Element)v.get(8)).setAttribute("required","true" );
      ((Element)v.get(8)).setAttribute("cod","3056" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(16)).setAttribute("nombre","modoEjecucion" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(17)).setAttribute("nombre","numeroLote" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(18)).setAttribute("nombre","descripcionLote" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(19)).setAttribute("nombre","observaciones" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(47)).setAttribute("nombre","lblInterface" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(47)).setAttribute("cod","820" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(51)).setAttribute("nombre","lblLote" );
      ((Element)v.get(51)).setAttribute("alto","13" );
      ((Element)v.get(51)).setAttribute("filas","1" );
      ((Element)v.get(51)).setAttribute("id","datosTitle" );
      ((Element)v.get(51)).setAttribute("cod","680" );
      ...
      ((Element)v.get(55)).setAttribute("cod","MMGGlobal.localization.description.label" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(62)).setAttribute("nombre","lblvalorInterface" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(66)).setAttribute("nombre","lblvalorLote" );
   ...
   private void getXML270(Document doc) {
      ...
      /* Empieza nodo:90 / Elemento padre: 78   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(78)).appendChild((Element)v.get(90));
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(94)).setAttribute("cols","50" );
      ((Element)v.get(94)).setAttribute("id","datosCampos" );
      ((Element)v.get(94)).setAttribute("msjreq","" );
      ((Element)v.get(94)).setAttribute("nombre","atxtObservaciones" );
      ((Element)v.get(94)).setAttribute("readOnly","N" );
      ((Element)v.get(94)).setAttribute("req","N" );
      ((Element)v.get(94)).setAttribute("rows","3" );
      ((Element)v.get(94)).setAttribute("tabindex","2" );
      ((Element)v.get(94)).setAttribute("valor","" );
      ((Element)v.get(94)).setAttribute("max","256" );
      ...
      ((Element)v.get(98)).setAttribute("nombre","cbModEjecucion" );
      ...
      /* Empieza nodo:102 / Elemento padre: 78   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(78)).appendChild((Element)v.get(102));
      ...
      /* Empieza nodo:105 / Elemento padre: 29   */
      v.add(doc.createElement("td"));
      ((Element)v.get(29)).appendChild((Element)v.get(105));
      ...
      /* Empieza nodo:107 / Elemento padre: 21   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(21)).appendChild((Element)v.get(107));
      ...
      ((Element)v.get(115)).setAttribute("nombre","btnRecepcionar" );
      ((Element)v.get(115)).setAttribute("ID","botonContenido" );
   }

   private void getXML450(Document doc) {
      ((Element)v.get(115)).setAttribute("tipo","html" );
      ((Element)v.get(115)).setAttribute("accion","enviarOnClick();" );
      ((Element)v.get(115)).setAttribute("ontab","focoDescripcion();" );
      ((Element)v.get(115)).setAttribute("estado","false" );
      ((Element)v.get(115)).setAttribute("cod","2265" );
      ...
      /* Empieza nodo:118 / Elemento padre: 21   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(21)).appendChild((Element)v.get(118));
