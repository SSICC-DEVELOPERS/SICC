...
public class contenido_informe_ganancia_lideres_generar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_informe_ganancia_lideres_generar" );
      ((Element)v.get(0)).setAttribute("cod","0828" );
      ((Element)v.get(0)).setAttribute("titulo","Generar Informe Ganancia de Lideres Resumen y Detalle" );
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(11)).setAttribute("name","cbFechaVencimiento" );
      ((Element)v.get(11)).setAttribute("required","true" );
      ((Element)v.get(11)).setAttribute("cod","883" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(96)).setAttribute("nombre","lblNivelReporte" );
      ((Element)v.get(96)).setAttribute("filas","1" );
      ((Element)v.get(96)).setAttribute("id","datosTitle" );
      ((Element)v.get(96)).setAttribute("cod","2867" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(100)).setAttribute("nombre","lblFechaVencimiento" );
      ((Element)v.get(100)).setAttribute("filas","1" );
      ((Element)v.get(100)).setAttribute("id","datosTitle" );
      ((Element)v.get(100)).setAttribute("cod","883" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(107)).setAttribute("nombre","lblTipoComisiondt" );
      ((Element)v.get(107)).setAttribute("filas","1" );
      ((Element)v.get(107)).setAttribute("id","datosCampos" );
      ((Element)v.get(107)).setAttribute("valor","Cobranzas" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(111)).setAttribute("nombre","cbComision" );
      ...
      ((Element)v.get(111)).setAttribute("onchange","cambioComision();" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(116)).setAttribute("nombre","cbNivelReporte" );
      ((Element)v.get(116)).setAttribute("size","1" );
      ((Element)v.get(116)).setAttribute("multiple","N" );
      ((Element)v.get(116)).setAttribute("valorinicial","1" );
   }

   private void getXML450(Document doc) {
      ((Element)v.get(116)).setAttribute("textoinicial","Agrup. por región" );
      ((Element)v.get(116)).setAttribute("id","datosCampos" );
      ((Element)v.get(116)).setAttribute("req","S" );
      ((Element)v.get(116)).setAttribute("onchange","cambioNivel();" );
      ...
      ((Element)v.get(118)).setAttribute("ID","1" );
      ((Element)v.get(117)).appendChild((Element)v.get(118));

      /* Empieza nodo:119 / Elemento padre: 118   */
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(119)).setAttribute("NOMBRE","CODIGO" );
      ((Element)v.get(119)).setAttribute("TIPO","STRING" );
      ((Element)v.get(119)).setAttribute("VALOR","2" );
      ((Element)v.get(118)).appendChild((Element)v.get(119));
      /* Termina nodo:119   */

      /* Empieza nodo:120 / Elemento padre: 118   */
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(120)).setAttribute("NOMBRE","DESCRIPCION" );
      ((Element)v.get(120)).setAttribute("TIPO","STRING" );
      ((Element)v.get(120)).setAttribute("VALOR","Agrup. por zona" );
      ...
      v.add(doc.createElement("ROW"));
      ((Element)v.get(121)).setAttribute("ID","2" );
      ...
      ((Element)v.get(122)).setAttribute("VALOR","3" );
      ...
      ((Element)v.get(123)).setAttribute("VALOR","Líder resumen" );
      ...
      v.add(doc.createElement("ROW"));
      ((Element)v.get(124)).setAttribute("ID","2" );
      ...
      ((Element)v.get(125)).setAttribute("VALOR","4" );
      ...
      ((Element)v.get(126)).setAttribute("VALOR","Líder detalle" );
      ...
      /* Empieza nodo:127 / Elemento padre: 103   */
      v.add(doc.createElement("td"));
      ((Element)v.get(103)).appendChild((Element)v.get(127));
      ...
      /* Empieza nodo:129 / Elemento padre: 103   */
      v.add(doc.createElement("td"));
      ((Element)v.get(129)).setAttribute("nowrap","nowrap" );
      ((Element)v.get(103)).appendChild((Element)v.get(129));

      /* Empieza nodo:130 / Elemento padre: 129   */
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(130)).setAttribute("nombre","cbFechaVencimiento" );
      ...
      /* Empieza nodo:132 / Elemento padre: 103   */
      v.add(doc.createElement("td"));
      ((Element)v.get(132)).setAttribute("width","100%" );
      ((Element)v.get(103)).appendChild((Element)v.get(132));
      ...
      /* Empieza nodo:134 / Elemento padre: 83   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(83)).appendChild((Element)v.get(134));
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(144)).setAttribute("nombre","lblSubgerenciaVenta" );
      ((Element)v.get(144)).setAttribute("filas","1" );
      ((Element)v.get(144)).setAttribute("id","datosTitle" );
      ((Element)v.get(144)).setAttribute("cod","124" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(148)).setAttribute("nombre","lblRegion" );
      ((Element)v.get(148)).setAttribute("filas","1" );
      ((Element)v.get(148)).setAttribute("id","datosTitle" );
      ((Element)v.get(148)).setAttribute("cod","109" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(155)).setAttribute("nombre","cbSubgerenciaVentas" );
      ...
      ((Element)v.get(155)).setAttribute("onchange","cambioSubgerencia();" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(160)).setAttribute("nombre","cbRegion" );
      ...
      ((Element)v.get(160)).setAttribute("onchange","cambioRegion()" );
   ...
   private void getXML630(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(174)).setAttribute("nombre","lblZona" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(178)).setAttribute("nombre","lblSeccion" );
      ((Element)v.get(178)).setAttribute("filas","1" );
      ((Element)v.get(178)).setAttribute("id","datosTitle" );
      ((Element)v.get(178)).setAttribute("cod","112" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(185)).setAttribute("nombre","cbZona" );
      ...
      ((Element)v.get(185)).setAttribute("onchange","cambioZona();" );
   }
   ...
   private void getXML720(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(190)).setAttribute("nombre","cbSeccion" );
      ...
      /* Empieza nodo:197 / Elemento padre: 31   */
      v.add(doc.createElement("td"));
      ((Element)v.get(31)).appendChild((Element)v.get(197));
      ...
      /* Empieza nodo:199 / Elemento padre: 23   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(23)).appendChild((Element)v.get(199));
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(208)).setAttribute("nombre","btnGenerarExcel" );
      ((Element)v.get(208)).setAttribute("ID","botonContenido" );
      ((Element)v.get(208)).setAttribute("tipo","html" );
      ((Element)v.get(208)).setAttribute("accion","generar('xls')" );
      ((Element)v.get(208)).setAttribute("estado","false" );
      ((Element)v.get(208)).setAttribute("cod","2526" );
   ...
   private void getXML810(Document doc) {
      ...
      /* Empieza nodo:211 / Elemento padre: 23   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(23)).appendChild((Element)v.get(211));
