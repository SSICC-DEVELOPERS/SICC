...
public class PedGrupoProceConectorQueryForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad PedGrupoProce" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGPedGrupoProceQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGPedGrupoProceQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","PedGrupoProceFormFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","codGrupProc" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(8)).setAttribute("NOMBRE","desGrupProc" );
