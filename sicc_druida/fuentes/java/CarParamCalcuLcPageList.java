...
public class CarParamCalcuLcPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","carParamCalcuLcList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","CarParamCalcuLc.niriOidNiveRies.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","CarParamCalcuLc.valTope.label" );
      ...
      ((Element)v.get(17)).setAttribute("cod","CarParamCalcuLc.valFactCalc.label" );
      ...
      ((Element)v.get(18)).setAttribute("cod","CarParamCalcuLc.indVariLineCred.label" );
