...
public class ZonZonaView2PageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","zonZonaView2List" );
      ...
      ((Element)v.get(14)).setAttribute("cod","ZonZonaView2.marcOidMarc.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","ZonZonaView2.canaOidCana.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","ZonZonaView2.codZona.label" );
