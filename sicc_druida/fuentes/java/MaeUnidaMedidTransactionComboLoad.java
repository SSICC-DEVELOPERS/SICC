...
/*
    INDRA/CAR/mmg
    $Id: MaeUnidaMedidTransactionComboLoad.java,v 1.1 2009/12/03 18:34:06 pecbazalar Exp $
    DESC
*/
...
public class MaeUnidaMedidTransactionComboLoad extends MMGDruidaTransaction {
	//Constantes usadas en la clase. Simplemente representan 
	//los nombre de conectore y de logicas de negocio
	public static final String BUSINESSID_QUERY = "MMGMaeUnidaMedidQueryFromToUserStructuralSecurity";
	public static final String CONECTOR_QUERY_COMBO= "MaeUnidaMedidConectorCombo";

	// Definicion del constructor
	public MaeUnidaMedidTransactionComboLoad(){
		super();
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			dto.addProperty("maeUnidaMedidFrom", maeUnidaMedid);
			dto.addProperty("maeUnidaMedidTo", maeUnidaMedid.clone());
