...
public class LPActividadTipoClientePeriodo extends LPSICCBase {           
   public LPActividadTipoClientePeriodo() {	 
     super();
  }
     ...
     this.rastreo();
        if (accion.equals("generar")){
           generarReporte();         
			     ...
			     cargarPantalla();
           getConfiguracionMenu("LPActividadTipoClientePeriodo");
  ...
  private void cargarPantalla() throws Exception{
     ...
     asignarAtributoPagina("cod", "0740");
     asignarAtributo("VAR", "casoDeUso", "valor", "LPActividadTipoClientePeriodo");
  ...
  private void generarReporte() throws Exception{
       ...
       datos.put(ConstantesREP.TITULO, "Actividades por tipo de cliente por periodo");
                 
       //ejecutarReporte(datos, "REPGenerarReporte", "RD_REP-038", null);
       ejecutarReporte2(datos, "REPGenerarReporteBatch", "RD_REP-038", "pdf");
  }
