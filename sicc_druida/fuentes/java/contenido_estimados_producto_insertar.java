...
public class contenido_estimados_producto_insertar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_estimados_producto_insertar" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(5)).setAttribute("src","contenido_estimados_producto_insertar.js" );
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(12)).setAttribute("name","cbProcedencia" );
      ((Element)v.get(12)).setAttribute("required","true" );
      ((Element)v.get(12)).setAttribute("cod","ApeEstimadosProd.procedencia.label" );
      ((Element)v.get(6)).appendChild((Element)v.get(12));
      /* Termina nodo:12   */

      /* Empieza nodo:13 / Elemento padre: 6   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(13)).setAttribute("name","txtCodigoProducto" );
      ((Element)v.get(13)).setAttribute("required","true" );
      ((Element)v.get(13)).setAttribute("cod","ApeEstimadosProd.codProducto.label" );
      ((Element)v.get(6)).appendChild((Element)v.get(13));
      /* Termina nodo:13   */

      /* Empieza nodo:14 / Elemento padre: 6   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(14)).setAttribute("name","txtUnidadesEstimadas" );
      ((Element)v.get(14)).setAttribute("required","true" );
      ((Element)v.get(14)).setAttribute("cod","ApeEstimadosProd.unidadesEstimadas.label" );
      ((Element)v.get(14)).setAttribute("format","e" );
      ((Element)v.get(14)).setAttribute("min","1" );
      ((Element)v.get(14)).setAttribute("max","999999" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(23)).setAttribute("nombre","oidEstimado" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(25)).setAttribute("nombre","hOidCentroDistribucionDefecto" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(26)).setAttribute("nombre","hDescCentroDistribucion" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(27)).setAttribute("nombre","hCbLineaArmado" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(29)).setAttribute("nombre","hDescLineaArmado" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(30)).setAttribute("nombre","hCbMarca" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(31)).setAttribute("nombre","hDescMarca" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(32)).setAttribute("nombre","hCbCanal" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(33)).setAttribute("nombre","hDescCanal" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(34)).setAttribute("nombre","hCbPeriodo" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(35)).setAttribute("nombre","hDescPeriodo" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(36)).setAttribute("nombre","hCbProcedencia" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(37)).setAttribute("nombre","hDescProcedencia" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(38)).setAttribute("nombre","htxtCodigoProducto" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(39)).setAttribute("nombre","htxtUnidadesEstimadas" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(55)).setAttribute("nombre","lblDatosPrincipales" );
      ((Element)v.get(55)).setAttribute("alto","13" );
      ((Element)v.get(55)).setAttribute("filas","1" );
      ((Element)v.get(55)).setAttribute("cod","ApeEstimadosProd.legend.label" );
      ...
      ((Element)v.get(64)).setAttribute("cod","ApeEstimadosProd.centroDistrib.label" );
   ...
   private void getXML270(Document doc) {
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(68)).setAttribute("nombre","lblLineaArmado" );
      ...
      ((Element)v.get(68)).setAttribute("cod","ApeEstimadosProd.lineaArmado.label" );
      ...
      ((Element)v.get(75)).setAttribute("onchange","onChangeCbCentroDistribucion();" );
      ((Element)v.get(75)).setAttribute("ontab","tab('cbCentroDistribucion')" );
      ((Element)v.get(75)).setAttribute("onshtab","shtab('cbCentroDistribucion')" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(80)).setAttribute("nombre","cbLineaArmado" );
      ...
      ((Element)v.get(80)).setAttribute("ontab","tab('cbLineaArmado')" );
      ((Element)v.get(80)).setAttribute("onshtab","tab('cbLineaArmado')" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(92)).setAttribute("nombre","lblMarca" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(96)).setAttribute("nombre","lblCanal" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(100)).setAttribute("nombre","lblPeriodo" );
      ...
      ((Element)v.get(100)).setAttribute("cod","276" );
      ...
      ((Element)v.get(107)).setAttribute("onchange","onChangeCbMarca();" );
      ((Element)v.get(107)).setAttribute("ontab","tab('cbMarca')" );
      ((Element)v.get(107)).setAttribute("onshtab","shtab('cbMarca')" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(112)).setAttribute("onchange","onChangeCanal();" );
      ((Element)v.get(112)).setAttribute("ontab","tab('cbCanal')" );
      ((Element)v.get(112)).setAttribute("onshtab","shtab('cbCanal')" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(117)).setAttribute("nombre","cbPeriodo" );
      ...
      ((Element)v.get(117)).setAttribute("ontab","tab('cbPeriodo')" );
      ((Element)v.get(117)).setAttribute("onshtab","shtab('cbPeriodo')" );
      ...
      /* Empieza nodo:124 / Elemento padre: 53   */
      v.add(doc.createElement("table"));
      ...
      ((Element)v.get(53)).appendChild((Element)v.get(124));
      ...
      ((Element)v.get(129)).setAttribute("cod","ApeEstimadosProd.codProducto.label" );
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(137)).setAttribute("nombre","lblUnidadesEstimadas" );
      ...
      ((Element)v.get(137)).setAttribute("cod","ApeEstimadosProd.unidadesEstimadas.label" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(141)).setAttribute("nombre","lblProcedencia" );
      ...
      ((Element)v.get(141)).setAttribute("cod","ApeEstimadosProd.procedencia.label" );
      ...
      /* Empieza nodo:144 / Elemento padre: 124   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(124)).appendChild((Element)v.get(144));
      ...
      ((Element)v.get(148)).setAttribute("nombre","txtCodigoProducto" );
      ((Element)v.get(148)).setAttribute("id","datosCampos" );
      ((Element)v.get(148)).setAttribute("max","23" );
      ((Element)v.get(148)).setAttribute("tipo","" );
      ((Element)v.get(148)).setAttribute("onchange","descripcionProducto();" );
      ((Element)v.get(148)).setAttribute("req","S" );
      ((Element)v.get(148)).setAttribute("size","23" );
      ((Element)v.get(148)).setAttribute("valor","" );
      ((Element)v.get(148)).setAttribute("validacion","" );
      ((Element)v.get(148)).setAttribute("ontab","tab('txtUnidadesEstimadas')" );
      ((Element)v.get(148)).setAttribute("onshtab","shtab('txtUnidadesEstimadas')" );
   ...
   private void getXML630(Document doc) {
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(152)).setAttribute("nombre","txtDescripcionProducto" );
      ...
      ((Element)v.get(152)).setAttribute("size","40" );
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(156)).setAttribute("nombre","txtUnidadesEstimadas" );
      ((Element)v.get(156)).setAttribute("id","datosCampos" );
      ((Element)v.get(156)).setAttribute("max","8" );
      ((Element)v.get(156)).setAttribute("tipo","" );
      ((Element)v.get(156)).setAttribute("onchange","" );
      ((Element)v.get(156)).setAttribute("req","S" );
      ((Element)v.get(156)).setAttribute("size","9" );
      ((Element)v.get(156)).setAttribute("valor","" );
      ((Element)v.get(156)).setAttribute("validacion","" );
      ((Element)v.get(156)).setAttribute("ontab","tab('txtUnidadesEstimadas')" );
      ((Element)v.get(156)).setAttribute("onshtab","shtab('txtUnidadesEstimadas')" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(160)).setAttribute("nombre","cbProcedencia" );
      ...
      ((Element)v.get(160)).setAttribute("ontab","tab('cbProcedencia')" );
      ((Element)v.get(160)).setAttribute("onshtab","shtab('cbProcedencia')" );
      ...
      /* Empieza nodo:167 / Elemento padre: 49   */
      v.add(doc.createElement("td"));
      ((Element)v.get(49)).appendChild((Element)v.get(167));
