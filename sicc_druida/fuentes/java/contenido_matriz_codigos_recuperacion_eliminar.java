...
public class contenido_matriz_codigos_recuperacion_eliminar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_matriz_codigos_recuperacion_eliminar" );
      ((Element)v.get(0)).setAttribute("titulo","Consultar matriz de códigos de recuperación" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","Consultar matriz de códigos de recuperación" );
      ((Element)v.get(0)).setAttribute("cod","0178" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","contenido_matriz_codigos_recuperacion_eliminar.js" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(11)).setAttribute("nombre","hidOidFacturacion" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(12)).setAttribute("nombre","hidCodigoVenta" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(13)).setAttribute("nombre","hidDescripcion" );
      ...
      ((Element)v.get(17)).setAttribute("nombre","capaFormulario" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(32)).setAttribute("valor","Criterios de búsqueda" );
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(36)).setAttribute("width","600" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(44)).setAttribute("nombre","lblCodigoVentaProducto" );
      ...
      ((Element)v.get(44)).setAttribute("cod","602" );
   ...
   private void getXML180(Document doc) {
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(48)).setAttribute("nombre","lblDescripcionProducto" );
      ...
      ((Element)v.get(48)).setAttribute("cod","338" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(55)).setAttribute("nombre","lblCodigoVentaXX" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(59)).setAttribute("nombre","lblDescripcionXX" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(73)).setAttribute("nombre","btnBuscarProductoprincipal" );
      ((Element)v.get(73)).setAttribute("ID","botonContenido" );
      ((Element)v.get(73)).setAttribute("tipo","html" );
      ((Element)v.get(73)).setAttribute("ontab","focalizaTab(1);" );
      ((Element)v.get(73)).setAttribute("onshtab","focalizaTabShift(1);" );
      ((Element)v.get(73)).setAttribute("accion","cargarAccion('buscarProductoPrincipal');" );
      ((Element)v.get(73)).setAttribute("estado","false" );
      ((Element)v.get(73)).setAttribute("cod","431" );
      ((Element)v.get(72)).appendChild((Element)v.get(73));
      /* Termina nodo:73   */

      /* Empieza nodo:74 / Elemento padre: 72   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(74)).setAttribute("nombre","btnBuscarProductoRecuperacion" );
      ((Element)v.get(74)).setAttribute("ID","botonContenido" );
      ((Element)v.get(74)).setAttribute("tipo","html" );
      ((Element)v.get(74)).setAttribute("ontab","focalizaTab(2);" );
      ((Element)v.get(74)).setAttribute("onshtab","focalizaTabShift(2);" );
      ((Element)v.get(74)).setAttribute("accion","cargarAccion('buscarProductosReemplazo');" );
      ((Element)v.get(74)).setAttribute("estado","false" );
      ((Element)v.get(74)).setAttribute("cod","517" );
      ...
      ((Element)v.get(83)).setAttribute("height","24" );
      ...
      ((Element)v.get(84)).setAttribute("ancho","603" );
      ((Element)v.get(84)).setAttribute("alto","317" );
      ((Element)v.get(84)).setAttribute("x","12" );
      ((Element)v.get(84)).setAttribute("y","117" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(92)).setAttribute("cod","1304" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(98)).setAttribute("ancho","160" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(99)).setAttribute("ancho","160" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(100)).setAttribute("ancho","160" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(101)).setAttribute("ancho","160" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(102)).setAttribute("ancho","160" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(103)).setAttribute("ancho","160" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(104)).setAttribute("ancho","160" );
      ...
      ((Element)v.get(105)).setAttribute("orden","numerico" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(108)).setAttribute("cod","435" );
      ...
      ((Element)v.get(110)).setAttribute("cod","436" );
      ...
      ((Element)v.get(114)).setAttribute("cod","603" );
      ((Element)v.get(107)).appendChild((Element)v.get(114));

      /* Elemento padre:114 / Elemento actual: 115   */
      v.add(doc.createTextNode("Cód. venta recuperación"));
      ...
      ((Element)v.get(120)).setAttribute("cod","393" );
      ...
      ((Element)v.get(122)).setAttribute("cod","595" );
      ...
      ((Element)v.get(124)).setAttribute("cod","756" );
      ...
      ((Element)v.get(126)).setAttribute("cod","550" );
      ...
      ((Element)v.get(128)).setAttribute("cod","520" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(146)).setAttribute("onload","procesarPaginado(mipgndo,msgError, ultima, rowset, 'mostrarLista(ultima, rowset)')" );
      ...
      ((Element)v.get(147)).setAttribute("y","415" );
   ...
   private void getXML630(Document doc) {
      ...
      ((Element)v.get(150)).setAttribute("y","411" );
      ...
      ((Element)v.get(151)).setAttribute("y","434" );
