...
public class contenido_catalogo_seleccion  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_catalogo_seleccion" );
      ((Element)v.get(0)).setAttribute("cod","01019" );
      ((Element)v.get(0)).setAttribute("titulo","Crear matriz de facturación" );
      ...
      v.add(doc.createTextNode("\r   \r      function onLoadPag() {\r        configurarMenuSecundario(\"formulario\");\r        eval (ON_RSZ);  \r      }\r      \r      function aceptar() {      \r			lpOrigen = get('formulario.lpOrigen');\r            set('formulario.conectorAction',lpOrigen);\r	        set('formulario.accion','CatalogoSeleccionado');\r		    enviaSICC('formulario');\r      }  \r      \r      function fGuardar(){\r        aceptar();\r      }\r      \r      function fLimpiar(){\r          set('formulario.cbCatalogo','');\r      }      \r      \r   \r"));
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(9)).setAttribute("nombre","lpOrigen" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(10)).setAttribute("nombre","origen" );
   ...
   private void getXML90(Document doc) {
      ((Element)v.get(25)).setAttribute("nombre","lblDatosSeleccion" );
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(29)).setAttribute("width","530" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(37)).setAttribute("nombre","lblCatalogo" );
      ...
      ((Element)v.get(37)).setAttribute("cod","516" );
      ...
      ((Element)v.get(44)).setAttribute("nombre","cbCatalogo" );
   ...
   private void getXML180(Document doc) {
      ...
      /* Empieza nodo:53 / Elemento padre: 11   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(11)).appendChild((Element)v.get(53));
      ...
      ((Element)v.get(61)).setAttribute("accion","aceptar();" );
      ((Element)v.get(61)).setAttribute("estado","false" );
      ((Element)v.get(61)).setAttribute("cod","12" );
      ...
      /* Empieza nodo:64 / Elemento padre: 11   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(11)).appendChild((Element)v.get(64));
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(67)).setAttribute("width","756" );
