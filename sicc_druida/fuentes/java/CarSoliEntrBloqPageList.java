...
public class CarSoliEntrBloqPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","carSoliEntrBloqList" );
   ...
   private void getXML90(Document doc) {
      ...
      /* Empieza nodo:34 / Elemento padre: 0   */
   }

   private void getXML180(Document doc) {
      v.add(doc.createElement("CABECERA"));
      ((Element)v.get(34)).setAttribute("height","20" );
      ...
      ((Element)v.get(0)).appendChild((Element)v.get(34));

      /* Empieza nodo:35 / Elemento padre: 34   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(35)).setAttribute("colFondo","" );
      ((Element)v.get(35)).setAttribute("ID","EstCab" );
      ((Element)v.get(35)).setAttribute("cod","CarSoliEntrBloq.paisOidPais.label" );
      ...
      ((Element)v.get(36)).setAttribute("cod","CarSoliEntrBloq.sbacOidSbac.label" );
      ...
      ((Element)v.get(37)).setAttribute("cod","CarSoliEntrBloq.tsolOidTipoSoli.label" );
      ...
      ((Element)v.get(38)).setAttribute("cod","CarSoliEntrBloq.socaOidSoliCabe.label" );
      ...
      ((Element)v.get(39)).setAttribute("cod","CarSoliEntrBloq.fecDocu.label" );
      ...
      ((Element)v.get(40)).setAttribute("cod","CarSoliEntrBloq.indNoti.label" );
      ...
      ((Element)v.get(41)).setAttribute("cod","CarSoliEntrBloq.valMontOrde.label" );
      ...
      ((Element)v.get(42)).setAttribute("cod","CarSoliEntrBloq.valMontDeudVenc.label" );
      ...
      ((Element)v.get(43)).setAttribute("cod","CarSoliEntrBloq.indVali1.label" );
      ...
      ((Element)v.get(44)).setAttribute("cod","CarSoliEntrBloq.indVali2.label" );
      ...
      ((Element)v.get(45)).setAttribute("cod","CarSoliEntrBloq.indVali3.label" );
      ...
      ((Element)v.get(46)).setAttribute("cod","CarSoliEntrBloq.indVali4.label" );
      ...
      ((Element)v.get(47)).setAttribute("cod","CarSoliEntrBloq.fecHoraLibe.label" );
      ...
      ((Element)v.get(48)).setAttribute("cod","CarSoliEntrBloq.valObse.label" );
      ...
      ((Element)v.get(49)).setAttribute("cod","CarSoliEntrBloq.jeraOidJera.label" );
      ...
      ((Element)v.get(50)).setAttribute("cod","CarSoliEntrBloq.espeOidEstaPedi.label" );
      ...
      ((Element)v.get(51)).setAttribute("cod","CarSoliEntrBloq.perdOidPeri.label" );
   }
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(52)).setAttribute("cod","CarSoliEntrBloq.clieOidClie.label" );
      ...
      ((Element)v.get(53)).setAttribute("cod","CarSoliEntrBloq.clieOidGereZona.label" );
      ...
      ((Element)v.get(54)).setAttribute("cod","CarSoliEntrBloq.cuadOidClieUnidAdmi.label" );
      ...
      ((Element)v.get(55)).setAttribute("cod","CarSoliEntrBloq.coapOidCodiApro.label" );
      ...
      ((Element)v.get(56)).setAttribute("cod","CarSoliEntrBloq.ejcuOidEjecCuen.label" );
      ...
      ((Element)v.get(57)).setAttribute("cod","CarSoliEntrBloq.ejcuOidUsuaLibe.label" );
      ...
      ((Element)v.get(58)).setAttribute("cod","CarSoliEntrBloq.niriOidNiveRies.label" );
      ...
      ((Element)v.get(59)).setAttribute("cod","CarSoliEntrBloq.grsoOidGrupSoli.label" );
      ((Element)v.get(34)).appendChild((Element)v.get(59));
      /* Termina nodo:59   */
      /* Termina nodo:34   */

      /* Empieza nodo:60 / Elemento padre: 0   */
      v.add(doc.createElement("DATOS"));
      ((Element)v.get(60)).setAttribute("alto","22" );
      ((Element)v.get(60)).setAttribute("accion","" );
      ((Element)v.get(60)).setAttribute("tipoEnvio","seleccion" );
      ((Element)v.get(60)).setAttribute("formaEnvio","xml" );
      ((Element)v.get(60)).setAttribute("maxSel","1" );
      ((Element)v.get(60)).setAttribute("msgErrMaxSel","" );
      ((Element)v.get(60)).setAttribute("coloresScrollNativo","#D4D0C8,black,white,#D4D0C8,#D4D0C8,#ECE9E4,black" );
      ((Element)v.get(60)).setAttribute("colorROver","#D0D9E8" );
      ((Element)v.get(60)).setAttribute("onLoad","" );
      ((Element)v.get(60)).setAttribute("colorSelecc","#D0D9E8" );
      ((Element)v.get(0)).appendChild((Element)v.get(60));
   ...
   private void getXML360(Document doc) {
      ...
      /* Empieza nodo:86 / Elemento padre: 0   */
      v.add(doc.createElement("ROWSET"));
      ((Element)v.get(0)).appendChild((Element)v.get(86));
      /* Termina nodo:86   */
