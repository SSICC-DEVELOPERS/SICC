...
/*
    INDRA/CAR/mmg
    $Id: BelMedioPagoTransactionComboLoad.java,v 1.1 2009/12/03 18:32:42 pecbazalar Exp $
    DESC
*/
...
public class BelMedioPagoTransactionComboLoad extends MMGDruidaTransaction {
	//Constantes usadas en la clase. Simplemente representan 
	//los nombre de conectore y de logicas de negocio
	public static final String BUSINESSID_QUERY = "MMGBelMedioPagoQueryFromToUserStructuralSecurity";
	public static final String CONECTOR_QUERY_COMBO= "BelMedioPagoConectorCombo";

	// Definicion del constructor
	public BelMedioPagoTransactionComboLoad(){
		super();
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			String tmepOidTipoMediPago = (String)getEntrada("tmepOidTipoMediPago");
			...
			dto.addProperty("belMedioPagoFrom", belMedioPago);
			dto.addProperty("belMedioPagoTo", belMedioPago.clone());
