...
public class CalMotivTipoClienPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","CalMotivTipoClien.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","CalMotivTipoClien.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('calMotivTipoClienFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('calMotivTipoClienFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(50)).setAttribute("nombre","mocoOidMotiContTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lblmocoOidMotiCont" );
      ((Element)v.get(54)).setAttribute("id","datosTitle" );
      ((Element)v.get(54)).setAttribute("ancho","150" );
      ((Element)v.get(54)).setAttribute("alto","13" );
      ((Element)v.get(54)).setAttribute("cod","CalMotivTipoClien.mocoOidMotiCont.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(55)).setAttribute("nombre","mocoOidMotiContWidgetTrId" );
      ...
      ((Element)v.get(57)).setAttribute("nombre","mocoOidMotiCont" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('calMotivTipoClienFrm',2, true);" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('calMotivTipoClienFrm',2, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(59)).setAttribute("nombre","mocoOidMotiContGapTdId" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(65)).setAttribute("cod","CalMotivTipoClien.ticlOidTipoClie.label" );
      ...
      ((Element)v.get(68)).setAttribute("ontab","ejecutarAccionFoco('calMotivTipoClienFrm',3, true);" );
      ((Element)v.get(68)).setAttribute("onshtab","ejecutarAccionFoco('calMotivTipoClienFrm',3, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(72)).setAttribute("nombre","paisOidPaisTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(76)).setAttribute("nombre","lblpaisOidPais" );
      ((Element)v.get(76)).setAttribute("id","datosTitle" );
      ((Element)v.get(76)).setAttribute("ancho","150" );
      ((Element)v.get(76)).setAttribute("alto","13" );
      ((Element)v.get(76)).setAttribute("cod","CalMotivTipoClien.paisOidPais.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(77)).setAttribute("nombre","paisOidPaisWidgetTrId" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(79)).setAttribute("nombre","paisOidPais" );
      ...
      ((Element)v.get(79)).setAttribute("ontab","ejecutarAccionFoco('calMotivTipoClienFrm',4, true);" );
      ((Element)v.get(79)).setAttribute("onshtab","ejecutarAccionFoco('calMotivTipoClienFrm',4, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(81)).setAttribute("nombre","paisOidPaisGapTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(86)).setAttribute("nombre","formGapTr1" );
      ...
      /* Empieza nodo:95 / Elemento padre: 0   */
      v.add(doc.createElement("TR"));
      ((Element)v.get(95)).setAttribute("nombre","calMotivTipoClienTrButtons" );
      ((Element)v.get(0)).appendChild((Element)v.get(95));
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(102)).setAttribute("class","tablaTitle" );
      ((Element)v.get(102)).setAttribute("nombre","calMotivTipoClienTdQueryButton" );
      ((Element)v.get(101)).appendChild((Element)v.get(102));

      /* Empieza nodo:103 / Elemento padre: 102   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(103)).setAttribute("nombre","calMotivTipoClienQueryButton" );
      ((Element)v.get(103)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(103)).setAttribute("estado","false" );
      ((Element)v.get(103)).setAttribute("accion","calMotivTipoClienFirstPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(104)).setAttribute("class","tablaTitle" );
      ((Element)v.get(104)).setAttribute("nombre","calMotivTipoClienTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(106)).setAttribute("nombre","calMotivTipoClienLovNullButton" );
      ((Element)v.get(106)).setAttribute("ID","botonContenido" );
      ((Element)v.get(106)).setAttribute("tipo","html" );
      ((Element)v.get(106)).setAttribute("accion","calMotivTipoClienLovNullSelectionAction();" );
      ((Element)v.get(106)).setAttribute("estado","true" );
      ((Element)v.get(106)).setAttribute("cod","MMGGlobal.lovNullButton.label" );
