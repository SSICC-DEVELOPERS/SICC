...
public class ComEstadComisPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","comEstadComisList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","ComEstadComis.codEstaComi.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","ComEstadComis.Descripcion.label" );
