...
public class contenido_informe_consolidado_cobranza_generar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_informe_consolidado_cobranza_generar" );
      ((Element)v.get(0)).setAttribute("cod","0846" );
      ((Element)v.get(0)).setAttribute("titulo","Generar informe consolidado de cobranza" );
      ...
      v.add(doc.createTextNode("\r   \r \r   function onLoad(){\r      configurarMenuSecundario('Formulario');\r      fMostrarMensajeError();\r      focaliza('Formulario.txtFechaDesde')\r           \r      \r   }\r\r      function quitarItemVacio(elemento){\r      var elementoADevolver = new Array();\r     \r      for(var k=0;k<elemento.length;k++) {\r          if (elemento[k] != ''){                            \r             elementoADevolver[elementoADevolver.length] = elemento[k];\r          }\r      }\r         \r      return elementoADevolver;\r      \r   }\r   function generar(){\r      if(sicc_validaciones_generales()){\r         if(validarFechas()){\r            /*recolectarParametros();\r            set('Formulario.conectorAction', 'CCCConsolidadoCobranza');           \r            set('Formulario.accion', 'generar');\r            enviaSICC('Formulario');*/\r            var a = new Object();\r            a.accion = 'generar';\r            a.fechaDesde = get('Formulario.txtFechaDesde');  \r            a.fechaHasta = get('Formulario.txtFechaHasta');  \r            a.banco = quitarItemVacio(get('Formulario.cbBanco'));\r            a.cuentaCorriente = quitarItemVacio(get('Formulario.cbCuentaCorriente'));  \r            a.vista = get('Formulario.cbVista');         \r            mostrarModalSICC('CCCConsolidadoCobranza','generar', a);  \r        }     \r      }\r   }\r\r\r  function validarFechas(){\r      \r      var fechaDesde = get('Formulario.txtFechaDesde');\r      var fechaHasta = get('Formulario.txtFechaHasta');\r      var formatoFecha = get('Formulario.hFormatoFechaPais');\r            \r     \r      if (! EsFechaValida_SICC(fechaDesde, \"Formulario\")){\r          GestionarMensaje(\"1006\", formatoFecha, null, null);\r          focaliza(\"Formulario.txtFechaDesde\");\r          return false;\r      }\r     \r      if(! EsFechaValida_SICC(fechaHasta, \"Formulario\")){\r          GestionarMensaje(\"1006\", formatoFecha, null, null);\r          focaliza(\"Formulario.txtFechaHasta\");\r          return false;\r      }\r                 \r      var errorLevel = EsFechaValida( fechaDesde, fechaHasta, \"Formulario\", \"S\");\r      if ( errorLevel == 3){\r          GestionarMensaje(\"1191\");\r          focaliza('Formulario.txtFechaDesde');\r          return false;\r      }\r     \r      return true;   \r   \r   }\r   function recolectarParametros(){\r           \r      set('Formulario.fechaDesde', get('Formulario.txtFechaDesde'));  \r      set('Formulario.fechaHasta', get('Formulario.txtFechaHasta'));  \r      set('Formulario.banco', get('Formulario.cbBanco'));\r      set('Formulario.cuentaCorriente', get('Formulario.cbCuentaCorriente'));  \r      set('Formulario.vista', get('Formulario.cbVista'));\r \r  \r   }\r\r   function onchangeBanco(){\r     opciones = new Array();\r     set_combo('Formulario.cbCuentaCorriente',opciones);                         \r     var banco = get('Formulario.cbBanco','V');\r     combo_add('Formulario.cbCuentaCorriente', '', '');\r     \r     for(var k=0;k<ListaCC.datos.longitud;k++) {\r        for(var y=0;y<banco.length;y++){\r           if (ListaCC.datos.ij(k,2) == banco[y]){                     \r                 combo_add('Formulario.cbCuentaCorriente',ListaCC.datos.ij(k,0),ListaCC.datos.ij(k,1));\r           }\r         }\r      }\r  \r   }\r   \r\r   function fLimpiar(){\r      var aCombo = new Array(new Array(\"\",\"\"));\r      set_combo('Formulario.cbCuentaCorriente', aCombo, []);\r\r   \r   }\r\r\r \r   \r  \r  "));
      ...
      ((Element)v.get(5)).setAttribute("name","txtFechaDesde" );
      ((Element)v.get(5)).setAttribute("required","true" );
      ((Element)v.get(5)).setAttribute("cod","59" );
      ((Element)v.get(4)).appendChild((Element)v.get(5));
      /* Termina nodo:5   */

      /* Empieza nodo:6 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(6)).setAttribute("name","txtFechaHasta" );
      ((Element)v.get(6)).setAttribute("required","true" );
      ((Element)v.get(6)).setAttribute("cod","1339" );
      ((Element)v.get(4)).appendChild((Element)v.get(6));
      /* Termina nodo:6   */

      /* Empieza nodo:7 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(7)).setAttribute("name","cbVista" );
      ((Element)v.get(7)).setAttribute("required","true" );
      ((Element)v.get(7)).setAttribute("cod","2647" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(15)).setAttribute("nombre","fechaDesde" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(16)).setAttribute("nombre","fechaHasta" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(17)).setAttribute("nombre","banco" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(18)).setAttribute("nombre","cuentaCorriente" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(47)).setAttribute("nombre","lblFechaDesde" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(47)).setAttribute("cod","59" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(51)).setAttribute("nombre","lblFechaHasta" );
      ((Element)v.get(51)).setAttribute("alto","13" );
      ((Element)v.get(51)).setAttribute("filas","1" );
      ((Element)v.get(51)).setAttribute("id","datosTitle" );
      ((Element)v.get(51)).setAttribute("cod","1339" );
      ...
      ((Element)v.get(58)).setAttribute("nombre","txtFechaDesde" );
      ...
      ((Element)v.get(58)).setAttribute("size","12" );
      ((Element)v.get(58)).setAttribute("valor","" );
      ((Element)v.get(58)).setAttribute("validacion","" );
      ((Element)v.get(58)).setAttribute("onshtab","focalizaBotonHTML('botonContenido','btnGenerarInforme');" );
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(62)).setAttribute("nombre","txtFechaHasta" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(86)).setAttribute("nombre","cbBanco" );
      ...
      ((Element)v.get(86)).setAttribute("onchange","onchangeBanco();" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(91)).setAttribute("nombre","cbCuentaCorriente" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(112)).setAttribute("nombre","cbVista" );
      ...
      ((Element)v.get(112)).setAttribute("textoinicial","Por banco Detalle" );
      ...
      ((Element)v.get(114)).setAttribute("ID","2" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(116)).setAttribute("VALOR","Por cuenta corriente Detalle" );
      ...
      v.add(doc.createElement("ROW"));
      ((Element)v.get(117)).setAttribute("ID","3" );
      ...
      ((Element)v.get(118)).setAttribute("VALOR","3" );
      ...
      ((Element)v.get(119)).setAttribute("VALOR","Por banco Resumen" );
      ...
      v.add(doc.createElement("ROW"));
      ((Element)v.get(120)).setAttribute("ID","4" );
      ((Element)v.get(113)).appendChild((Element)v.get(120));

      /* Empieza nodo:121 / Elemento padre: 120   */
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(121)).setAttribute("NOMBRE","CODIGO" );
      ((Element)v.get(121)).setAttribute("TIPO","STRING" );
      ((Element)v.get(121)).setAttribute("VALOR","4" );
      ((Element)v.get(120)).appendChild((Element)v.get(121));
      /* Termina nodo:121   */

      /* Empieza nodo:122 / Elemento padre: 120   */
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(122)).setAttribute("NOMBRE","DESCRIPCION" );
      ((Element)v.get(122)).setAttribute("TIPO","STRING" );
      ((Element)v.get(122)).setAttribute("VALOR","Por cuenta corriente Resumen" );
      ...
      /* Empieza nodo:128 / Elemento padre: 29   */
      v.add(doc.createElement("td"));
      ((Element)v.get(29)).appendChild((Element)v.get(128));
      ...
      /* Empieza nodo:130 / Elemento padre: 21   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(21)).appendChild((Element)v.get(130));
      ...
      ((Element)v.get(138)).setAttribute("ontab","focaliza('Formulario.txtFechaDesde')" );
   ...
   private void getXML540(Document doc) {
      ...
      /* Empieza nodo:141 / Elemento padre: 21   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(21)).appendChild((Element)v.get(141));
