...
public class LPModificaMatrizDiasGrafica extends LPSICCBase {
    ...
    public LPModificaMatrizDiasGrafica() {
        super();
    }
    ...
    public void ejecucion() throws Exception {
        ...
        try {
            rastreo();
            if (accion.equals("")) {
                asignarAtributo("VAR","accion","valor","modificaGrafica");
                asignarAtributo("VAR","varModo","valor",MODO_MODIFICAR);
                asignarAtributo("VAR","varTipo","valor",TIPO_GRAFICA);
                // Invoca a LPMantieneMatrizDias cambiando la accion = "modificaGrafica" 
                conectorAction("LPMantieneMatrizDias");
                conectorActionParametro("accion","modificaGrafica");
