...
public class FACResultadosFacDiariaAcumulacion extends LPSICCBase {   
  
   Long pais = null;
   Long idioma = null;

   public FACResultadosFacDiariaAcumulacion() {	 
     super();
   }
   ...
   public void ejecucion() throws Exception {		
      ...
      try {
         ...
         if (accion.equals("generar")){
            ...
            cargarPagina();
			//cargarPeriodos();
            getConfiguracionMenu("FACResultadosFacDiariaAcumulacion");
         }
   ...
   private void cargarPagina() throws Exception{
      traza("seteo pagina");
      pagina("contenido_resultados_facturacion_diaria_acumulado");   
	  traza("setie pagina");
 ...
 private void generarReporte() throws Exception{
     ...
     datos.put(ConstantesREP.TITULO, "Resultados Facturacion Diaria y Acumulado");
        
     traza("++++++Antes de enviar a reportes " + datos); 
     //ejecutarReporte(datos, "REPGenerarReporte", "RD_REP-159", null);
     ejecutarReporte2(datos, "REPGenerarReporteBatch", "RD_REP-159", "pdf");
