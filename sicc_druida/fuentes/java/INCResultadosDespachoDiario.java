...
public class INCResultadosDespachoDiario extends LPSICCBase {           
    public INCResultadosDespachoDiario() {	 
        super();
    }
    ...
    public void ejecucion() throws Exception {		
        ...
        try {
            ...
            if (accion.equals("generar")){
                ...
                cargarPagina();
                getConfiguracionMenu("INCResultadosDespachoDiario");
            }
    ...
    private void cargarPagina() throws Exception{
        pagina("contenido_informe_resultados_despacho_generar");
 ...
 private void generarReporte() throws Exception{
     ...
     datos.put(ConstantesREP.TITULO, "RESULTADOS DE DESPACHOS DIARIO x CONCURSO");
     ...
     if(region.equals("")){
        reporte = "RD_REP-053_02";
     }else{
        if(zona.equals("")){
           reporte = "RD_REP-053_01";
        }else{
           reporte = "RD_REP-053";
        }
     }
