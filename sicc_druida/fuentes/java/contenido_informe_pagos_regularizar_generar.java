...
public class contenido_informe_pagos_regularizar_generar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_informe_pagos_regularizar_generar" );
      ((Element)v.get(0)).setAttribute("cod","0851" );
      ((Element)v.get(0)).setAttribute("titulo","Generar informe pagos por regularizar" );
      ...
      v.add(doc.createTextNode("\r   \r \r   function onLoad(){\r      configurarMenuSecundario('Formulario');\r      fMostrarMensajeError();\r      set('Formulario.txtFechaProcesoHasta', '31/12/2999');\r      set('Formulario.txtFechaProcesoDesde', get('Formulario.fechaActual'));\r      focaliza('Formulario.txtFechaProcesoDesde');\r                 \r   }\r\r     function quitarItemVacio(elemento){\r      var elementoADevolver = new Array();\r     \r      for(var k=0;k<elemento.length;k++) {\r          if (elemento[k] != ''){                            \r             elementoADevolver[elementoADevolver.length] = elemento[k];\r          }\r      }\r         \r      return elementoADevolver;\r      \r   }\r   function generar(formato){\r      if(sicc_validaciones_generales()){\r         if(validarFechasValor()){            \r               /*recolectarParametros();\r               set('Formulario.conectorAction', 'CCCPagosRegularizar');           \r               set('Formulario.accion', 'generar');\r               set('Formulario.formatoSalida', formato);\r               enviaSICC('Formulario');*/\r               var a = new Object();\r               a.accion = 'generar';\r               a.fechaProcesoDesde = get('Formulario.txtFechaProcesoDesde');\r               a.fechaProcesoHasta = get('Formulario.txtFechaProcesoHasta');  \r               a.banco = quitarItemVacio(get('Formulario.cbBanco'));\r               a.cuentaCorriente = quitarItemVacio(get('Formulario.cbCuentaCorriente'));               \r               a.orden = get('Formulario.cbOrden');\r               a.ordenDesc = get('Formulario.cbOrden','T');\r               a.formatoSalida = formato;\r               mostrarModalSICC('CCCPagosRegularizar','generar', a);              \r         }      \r      }\r   }\r\r\r\r   function validarFechasValor(){\r      \r      var fechaDesde = get('Formulario.txtFechaProcesoDesde');\r      var fechaHasta = get('Formulario.txtFechaProcesoHasta');\r      var formatoFecha = get('Formulario.hFormatoFechaPais');\r            \r     \r      if (! EsFechaValida_SICC(fechaDesde, \"Formulario\")){\r          GestionarMensaje(\"1006\", formatoFecha, null, null);\r          focaliza(\"Formulario.txtFechaProcesoDesde\");\r          return false;\r      }\r     \r      if(! EsFechaValida_SICC(fechaHasta, \"Formulario\")){\r          GestionarMensaje(\"1006\", formatoFecha, null, null);\r          focaliza(\"Formulario.txtFechaProcesoHasta\");\r          return false;\r      }\r                 \r      var errorLevel = EsFechaValida( fechaDesde, fechaHasta, \"Formulario\", \"S\");\r      if ( errorLevel == 3){\r          GestionarMensaje(\"1191\");\r          focaliza('Formulario.txtFechaProcesoDesde');\r          return false;\r      }\r     \r      return true;   \r   \r   }\r   \r\r   function onchangeBanco(){\r     opciones = new Array();\r     set_combo('Formulario.cbCuentaCorriente',opciones);                         \r     var banco = get('Formulario.cbBanco','V');\r     combo_add('Formulario.cbCuentaCorriente', '', '');\r     \r     for(var k=0;k<ListaCC.datos.longitud;k++) {\r        for(var y=0;y<banco.length;y++){\r           if (ListaCC.datos.ij(k,2) == banco[y]){                     \r                 combo_add('Formulario.cbCuentaCorriente',ListaCC.datos.ij(k,0),ListaCC.datos.ij(k,1));\r           }\r         }\r      }\r  \r   }\r\r   function recolectarParametros(){\r           \r      set('Formulario.fechaProcesoDesde', get('Formulario.txtFechaProcesoDesde'));\r      set('Formulario.fechaProcesoHasta', get('Formulario.txtFechaProcesoHasta'));  \r      set('Formulario.banco', get('Formulario.cbBanco'));\r      set('Formulario.cuentaCorriente', get('Formulario.cbCuentaCorriente'));\r      \r      set('Formulario.orden', get('Formulario.cbOrden'));\r      \r  \r   }\r\r   \r\r   function fLimpiar(){\r     \r     var aCombo = new Array(new Array(\"\",\"\"));\r     \r     set_combo('Formulario.cbCuentaCorriente', aCombo, []);\r     set('Formulario.txtFechaProcesoDesde', get('Formulario.fechaActual'));\r     set('Formulario.txtFechaProcesoHasta', '31/12/2999');\r     \r     focaliza('Formulario.txtFechaProcesoDesde');\r   \r   }\r  \r   \r  \r  "));
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(7)).setAttribute("name","cbBanco" );
      ((Element)v.get(7)).setAttribute("required","true" );
      ((Element)v.get(7)).setAttribute("cod","617" );
      ...
      ((Element)v.get(8)).setAttribute("cod","201" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(16)).setAttribute("nombre","fechaProcesoDesde" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(17)).setAttribute("nombre","fechaProcesoHasta" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(18)).setAttribute("nombre","banco" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(19)).setAttribute("nombre","cuentaCorriente" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(20)).setAttribute("nombre","orden" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(21)).setAttribute("nombre","fechaActual" );
   ...
   private void getXML90(Document doc) {
      v.add(doc.createElement("VAR"));
      ((Element)v.get(22)).setAttribute("nombre","formato" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lblFechaProcesoHasta" );
      ((Element)v.get(54)).setAttribute("alto","13" );
      ((Element)v.get(54)).setAttribute("filas","1" );
      ((Element)v.get(54)).setAttribute("id","datosTitle" );
      ((Element)v.get(54)).setAttribute("cod","1916" );
      ...
      ((Element)v.get(61)).setAttribute("nombre","txtFechaProcesoDesde" );
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(65)).setAttribute("nombre","txtFechaProcesoHasta" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(89)).setAttribute("nombre","cbBanco" );
      ...
      ((Element)v.get(89)).setAttribute("onchange","onchangeBanco();" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(94)).setAttribute("nombre","cbCuentaCorriente" );
   ...
   private void getXML450(Document doc) {
      ((Element)v.get(115)).setAttribute("nombre","cbOrden" );
      ...
      ((Element)v.get(115)).setAttribute("textoinicial","Por consultora" );
      ...
      ((Element)v.get(119)).setAttribute("VALOR","Por fecha valor" );
      ...
      /* Empieza nodo:125 / Elemento padre: 32   */
      v.add(doc.createElement("td"));
      ((Element)v.get(32)).appendChild((Element)v.get(125));
      ...
      /* Empieza nodo:127 / Elemento padre: 24   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(24)).appendChild((Element)v.get(127));
      ...
      ((Element)v.get(135)).setAttribute("accion","generar();" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(136)).setAttribute("nombre","btnGenerarExcel" );
      ((Element)v.get(136)).setAttribute("ID","botonContenido" );
      ((Element)v.get(136)).setAttribute("tipo","html" );
      ((Element)v.get(136)).setAttribute("accion","generar('xls')" );
      ((Element)v.get(136)).setAttribute("estado","false" );
      ((Element)v.get(136)).setAttribute("cod","2526" );
      ((Element)v.get(136)).setAttribute("ontab","focaliza('Formulario.txtFechaProcesoDesde')" );
   ...
   private void getXML540(Document doc) {
      ...
      /* Empieza nodo:139 / Elemento padre: 24   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(24)).appendChild((Element)v.get(139));
