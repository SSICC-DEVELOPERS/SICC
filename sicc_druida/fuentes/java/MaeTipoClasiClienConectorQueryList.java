...
public class MaeTipoClasiClienConectorQueryList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad MaeTipoClasiClien" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGMaeTipoClasiClienQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGMaeTipoClasiClienQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","MaeTipoClasiClienListFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","sbtiOidSubtClie" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(8)).setAttribute("NOMBRE","codTipoClas" );
