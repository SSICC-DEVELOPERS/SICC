...
public class CobGuionArgumDetalPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","cobGuionArgumDetalList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","CobGuionArgumDetal.gacaOidGuioArguCabe.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","CobGuionArgumDetal.arguOidArgu.label" );
