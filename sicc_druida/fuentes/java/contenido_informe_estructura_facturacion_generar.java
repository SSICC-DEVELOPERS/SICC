...
public class contenido_informe_estructura_facturacion_generar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_informe_estructura_facturacion_generar" );
      ((Element)v.get(0)).setAttribute("cod","0765" );
      ((Element)v.get(0)).setAttribute("titulo","Generar informe estructura de facturacion" );
      ...
      v.add(doc.createTextNode("\r   \r   \r   function onLoad(){\r      configurarMenuSecundario('Formulario');\r      fMostrarMensajeError();\r      set('Formulario.txtAno', get('Formulario.anioDefault'));\r      focaliza('Formulario.txtAno');\r   }\r   function generar(){\r      \r      if(sicc_validaciones_generales()){\r         if(validarAnio()){\r            /*recolectarParametros();\r      \r            set('Formulario.conectorAction', 'CRAEstructuraFacturacion');           \r            set('Formulario.accion', 'generar');\r      \r            enviaSICC('Formulario');*/\r            var a = new Object();\r            a.accion = 'generar';\r            a.anio = get('Formulario.txtAno');\r            a.marca = get('Formulario.cbMarca');  \r            a.canal = quitarItemVacio(get('Formulario.cbCanal'));\r            a.acceso = quitarItemVacio(get('Formulario.cbAcceso'));\r            a.periodo = quitarItemVacio(get('Formulario.cbPeriodo'));\r            a.zona = quitarItemVacio(get('Formulario.cbZona'));          \r            mostrarModalSICC('CRAEstructuraFacturacion','generar', a);  \r         }\r      }\r\r   }\r\r   function recolectarParametros(){\r      \r      \r      set('Formulario.anio', get('Formulario.txtAno'));\r      set('Formulario.marca', get('Formulario.cbMarca') );  \r      set('Formulario.canal', quitarItemVacio(get('Formulario.cbCanal')));\r      set('Formulario.acceso', quitarItemVacio(get('Formulario.cbAcceso') ));\r      set('Formulario.periodo', quitarItemVacio(get('Formulario.cbPeriodo')));\r      set('Formulario.zona', quitarItemVacio(get('Formulario.cbZona')));\r          \r      \r  \r   }\r    \r   function onchangeCanal(){\r      \r      var aCombo = new Array(new Array(\"\",\"\"));\r      set_combo('Formulario.cbAcceso', aCombo, []);    \r      \r      canal = get('Formulario.cbCanal','V');\r      \r      for(var k=0;k<Lista1.datos.longitud;k++) {\r          for(var y=0;y<canal.length;y++){\r             if (Lista1.datos.ij(k,2) == canal[y]){ 			 \r                combo_add('Formulario.cbAcceso',Lista1.datos.ij(k,0),Lista1.datos.ij(k,1));\r             }\r          }\r       }\r   \r   \r   }\r\r\r   function onChangeMarcaCanalAnio(){\r       var pais   = get('Formulario.pais');\r       var marca  = get('Formulario.cbMarca');\r       var canal  = get('Formulario.cbCanal');\r	   var anio   = get('Formulario.txtAno');\r\r	   if(marca != '' && canal != '' && anio != ''){\r         var arr = new Array();\r	     arr[arr.length] = [\"marca\", marca];\r         arr[arr.length] = [\"canales\", canal];       \r         arr[arr.length] = [\"oidPais\", pais];\r         arr[arr.length] = [\"anio\", anio];\r\r		 recargaCombo('Formulario.cbPeriodo', 'REPPeriodosEstructura', 'es.indra.sicc.rep.dtos.DTOEstructuraFacturacion',arr);\r   \r	   }else{\r	        var aCombo = new Array(new Array(\"\",\"\"));\r	       set_combo('Formulario.cbPeriodo', aCombo, []);	   \r	   }\r   \r   \r   }\r   \r\r   function onChangeMarcaCanal(){\r       var pais   = get('Formulario.pais');\r       var marca  = get('Formulario.cbMarca');\r       var canal  = get('Formulario.cbCanal');\r\r	   if(marca != '' && canal != ''){\r         var arr = new Array();\r	            \r	     arr[arr.length] = [\"marca\", marca];\r         arr[arr.length] = [\"canales\", canal];       \r         arr[arr.length] = [\"oidPais\", pais];\r\r		 recargaCombo('Formulario.cbZona', 'REPZonasEstructura', 'es.indra.sicc.rep.dtos.DTOEstructuraFacturacion',arr);\r   \r	   }else{\r	        var aCombo = new Array(new Array(\"\",\"\"));\r	       set_combo('Formulario.cbZona', aCombo, []);	   \r	   }\r   \r   \r   }\r   \r\r   function fLimpiar(){\r      var aCombo = new Array(new Array(\"\",\"\"));\r      set_combo('Formulario.cbAcceso', aCombo, []);\r      set_combo('Formulario.cbPeriodo', aCombo, []);\r      set_combo('Formulario.cbZona', aCombo, []);\r      focaliza('Formulario.txtAno');\r \r   }\r \r\r\r    function validarAnio(){\r    \r       var anio = get('Formulario.txtAno') ;\r       \r       if(fValidarNumero(anio, 200, 0, 9999999)!='OK'){\r          GestionarMensaje('405'); \r          focaliza('Formulario.txtAno');\r          return  false;\r       }else{\r          return true;\r       }\r  \r    }\r    \r\r   function quitarItemVacio(elemento){\r      var elementoADevolver = new Array();\r     \r      for(var k=0;k<elemento.length;k++) {\r         if (elemento[k] != ''){ 			 \r            elementoADevolver[elementoADevolver.length] = elemento[k];\r         }\r      }\r        \r      return elementoADevolver;\r      \r   }\r\r   \r"));
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(25)).setAttribute("nombre","zona" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(26)).setAttribute("nombre","anioDefault" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lblAno" );
      ((Element)v.get(54)).setAttribute("alto","13" );
      ((Element)v.get(54)).setAttribute("filas","1" );
      ((Element)v.get(54)).setAttribute("id","datosTitle" );
      ((Element)v.get(54)).setAttribute("cod","171" );
      ...
      ((Element)v.get(65)).setAttribute("nombre","txtAno" );
      ((Element)v.get(65)).setAttribute("id","datosCampos" );
      ((Element)v.get(65)).setAttribute("max","4" );
      ((Element)v.get(65)).setAttribute("tipo","" );
      ((Element)v.get(65)).setAttribute("onchange","onChangeMarcaCanalAnio();" );
      ((Element)v.get(65)).setAttribute("req","S" );
      ((Element)v.get(65)).setAttribute("size","4" );
      ((Element)v.get(65)).setAttribute("valor","" );
      ((Element)v.get(65)).setAttribute("validacion","" );
      ((Element)v.get(65)).setAttribute("onshtab","focalizaBotonHTML('botonContenido','btnGenerarInforme')" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(69)).setAttribute("onchange","onChangeMarcaCanalAnio();onChangeMarcaCanal();" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(98)).setAttribute("onchange","onchangeCanal();onChangeMarcaCanalAnio();onChangeMarcaCanal();" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(103)).setAttribute("nombre","cbAcceso" );
   ...
   private void getXML450(Document doc) {
      ...
      /* Empieza nodo:138 / Elemento padre: 28   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(28)).appendChild((Element)v.get(138));
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(146)).setAttribute("ontab","focaliza('Formulario.txtAno')" );
      ...
      /* Empieza nodo:149 / Elemento padre: 28   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(28)).appendChild((Element)v.get(149));
