...
public class contenido_centro_distribcion_insertar_temp  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_centro_distribcion_insertar" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(30)).setAttribute("nombre","lblDescripcion" );
      ...
      ((Element)v.get(30)).setAttribute("cod","MMGGlobal.localization.description.label" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(34)).setAttribute("nombre","lblNivelOursourcing" );
      ...
      ((Element)v.get(34)).setAttribute("cod","3098" );
      ...
      ((Element)v.get(41)).setAttribute("nombre","txtDescripcion" );
      ((Element)v.get(41)).setAttribute("id","datosCampos" );
      ((Element)v.get(41)).setAttribute("max","30" );
      ((Element)v.get(41)).setAttribute("tipo","" );
      ((Element)v.get(41)).setAttribute("onchange","" );
      ((Element)v.get(41)).setAttribute("onshtab","" );
      ((Element)v.get(41)).setAttribute("req","S" );
      ((Element)v.get(41)).setAttribute("size","30" );
      ((Element)v.get(41)).setAttribute("valor","" );
      ((Element)v.get(41)).setAttribute("validacion","" );
      ...
      ((Element)v.get(45)).setAttribute("nombre","cbNivelOursourcing" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(45)).setAttribute("onshtab","" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(60)).setAttribute("nombre","lblCentroDefault" );
      ...
      ((Element)v.get(60)).setAttribute("cod","CobGuionArgumDetal.indValoDefe.label" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(64)).setAttribute("nombre","lblImprimirListasPicado" );
      ...
      ((Element)v.get(64)).setAttribute("cod","2918" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(71)).setAttribute("nombre","chkCentroDefault" );
      ...
      v.add(doc.createElement("CHECKBOX"));
      ((Element)v.get(75)).setAttribute("nombre","chkImprimirListasPicado" );
