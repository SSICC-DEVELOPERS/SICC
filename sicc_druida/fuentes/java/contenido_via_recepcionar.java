...
public class contenido_via_recepcionar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_via_recepcionar" );
      ((Element)v.get(0)).setAttribute("cod","0294" );
      ((Element)v.get(0)).setAttribute("titulo","Recepcionar vía" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","Recepcionar vía" );
      ...
      v.add(doc.createTextNode("\r   \r    var varNoLimpiarSICC = true;\r		\r		function load()\r		{\r			configurarMenuSecundario(\"frmFormulario\");\r            fMostrarMensajeError();\r			focaliza(\"frmFormulario.Descripcion\");\r		}\r\r		function fLimpiar()\r		{\r            set(\"frmFormulario.Descripcion\", \"\");\r            set(\"frmFormulario.areatxtObservaciones\",\"\");\r			focaliza(\"frmFormulario.Descripcion\");\r		}\r\r		function accionRecibirInterfaz()\r		{\r			set(\"frmFormulario.accion\", \"recepcionar\");\r			enviaSICC(\"frmFormulario\");\r		}\r\r     \r"));
      ...
      ((Element)v.get(6)).setAttribute("valor","LPRecepcionarVias" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(9)).setAttribute("nombre","hiddenNumLote" );
      ...
      ((Element)v.get(25)).setAttribute("nombre","lblDatos" );
   }
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(25)).setAttribute("cod","00263" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(48)).setAttribute("nombre","lblvalorLote" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(52)).setAttribute("max","40" );
      ((Element)v.get(52)).setAttribute("tipo","" );
      ((Element)v.get(52)).setAttribute("onchange","" );
      ((Element)v.get(52)).setAttribute("req","N" );
      ((Element)v.get(52)).setAttribute("size","40" );
      ((Element)v.get(52)).setAttribute("valor","" );
      ((Element)v.get(52)).setAttribute("validacion","" );
      ((Element)v.get(52)).setAttribute("onshtab","document.all.btnRecibir.focus();" );
      ((Element)v.get(52)).setAttribute("onblur","document.selection.empty();" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(72)).setAttribute("cols","50" );
      ((Element)v.get(72)).setAttribute("id","datosCampos" );
      ((Element)v.get(72)).setAttribute("msjreq","" );
      ((Element)v.get(72)).setAttribute("nombre","areatxtObservaciones" );
      ((Element)v.get(72)).setAttribute("readonly","N" );
      ((Element)v.get(72)).setAttribute("req","N" );
      ((Element)v.get(72)).setAttribute("rows","3" );
      ((Element)v.get(72)).setAttribute("tabindex","2" );
      ((Element)v.get(72)).setAttribute("valor","" );
      ((Element)v.get(72)).setAttribute("max","100" );
      ...
      /* Empieza nodo:80 / Elemento padre: 11   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(11)).appendChild((Element)v.get(80));
      ...
      ((Element)v.get(88)).setAttribute("nombre","btnRecibir" );
      ((Element)v.get(88)).setAttribute("ID","botonContenido" );
      ((Element)v.get(88)).setAttribute("tipo","html" );
      ((Element)v.get(88)).setAttribute("accion","accionRecibirInterfaz();" );
      ((Element)v.get(88)).setAttribute("estado","false" );
      ((Element)v.get(88)).setAttribute("cod","2263" );
      ((Element)v.get(88)).setAttribute("ontab","focaliza('frmFormulario.Descripcion');" );
      ...
      /* Empieza nodo:91 / Elemento padre: 11   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(11)).appendChild((Element)v.get(91));
