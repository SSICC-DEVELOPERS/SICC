...
public class ZonEstruGeopoPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","zonEstruGeopoList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(16)).setAttribute("cod","ZonEstruGeopo.codOrde.label" );
      ...
      ((Element)v.get(17)).setAttribute("cod","ZonEstruGeopo.indBorr.label" );
      ...
      ((Element)v.get(18)).setAttribute("cod","ZonEstruGeopo.paisOidPais.label" );
      ...
      ((Element)v.get(19)).setAttribute("cod","ZonEstruGeopo.dipoOidDiviPoli.label" );
      ...
      ((Element)v.get(20)).setAttribute("cod","ZonEstruGeopo.fecActu.label" );
