...
public class PreCatalOrdenConectorQueryForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad PreCatalOrden" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGPreCatalOrdenQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGPreCatalOrdenQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","PreCatalOrdenFormFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(9)).setAttribute("NOMBRE","ocatOidCata" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(10)).setAttribute("NOMBRE","numOrde" );
