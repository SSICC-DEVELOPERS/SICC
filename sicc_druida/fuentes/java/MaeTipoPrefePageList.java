...
public class MaeTipoPrefePageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","maeTipoPrefeList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","MaeTipoPrefe.codTipoPref.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","MaeTipoPrefe.Descripcion.label" );
