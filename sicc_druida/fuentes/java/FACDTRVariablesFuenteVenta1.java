...
public class FACDTRVariablesFuenteVenta1 extends LPSICCBase {           
   
   public FACDTRVariablesFuenteVenta1() {
     super();
  }
  ...
  private void cargarPagina() throws Exception{
     ...
     asignarAtributoPagina("cod","0806");   
     ...
     asignarAtributo("VAR", "lp", "valor", "FACDTRVariablesFuenteVenta1");
  ...
  private void generarReporte() throws Exception{
     ...
     datos.put(ConstantesREP.TITULO, "Resultados de variables de fuente de ventas por campaña I");     
     traza("++++++Antes de enviar a reportes " + datos); 
     
     String formato = conectorParametroLimpia("formato", "", true);
     
       
     //ejecutarReporte(datos, "REPGenerarReporte", "RFD-001", formato);
     ejecutarReporte2(datos, "REPGenerarReporteBatch", "RD_RFD-001", formato);
