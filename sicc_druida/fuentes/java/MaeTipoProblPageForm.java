...
public class MaeTipoProblPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","MaeTipoProbl.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","MaeTipoProbl.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('maeTipoProblFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('maeTipoProblFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(54)).setAttribute("cod","MaeTipoProbl.paisOidPais.label" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('maeTipoProblFrm',2, true);" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('maeTipoProblFrm',2, false);" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(76)).setAttribute("nombre","codTipoProbTdId" );
   ...
   private void getXML360(Document doc) {
      ((Element)v.get(81)).setAttribute("nombre","codTipoProbWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(83)).setAttribute("nombre","codTipoProb" );
      ...
      ((Element)v.get(83)).setAttribute("ontab","ejecutarAccionFoco('maeTipoProblFrm',3, true)" );
      ((Element)v.get(83)).setAttribute("onshtab","ejecutarAccionFoco('maeTipoProblFrm', 3, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(84)).setAttribute("nombre","codTipoProbGapTdId" );
   ...
   private void getXML450(Document doc) {
      v.add(doc.createElement("TD"));
      ((Element)v.get(101)).setAttribute("nombre","DescripcionTdId" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(106)).setAttribute("nombre","DescripcionTdLocalizationButtonGapHeader" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(107)).setAttribute("nombre","DescripcionWidgetTrId" );
      ...
      ((Element)v.get(109)).setAttribute("rows","3" );
      ((Element)v.get(109)).setAttribute("cols","40" );
      ...
      ((Element)v.get(109)).setAttribute("ontab","ejecutarAccionFoco('maeTipoProblFrm',5, true)" );
      ((Element)v.get(109)).setAttribute("onshtab","ejecutarAccionFoco('maeTipoProblFrm',5, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(110)).setAttribute("nombre","DescripcionTdLocalizationButtonGap" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(112)).setAttribute("nombre","DescripcionTdLocalizationButton" );
      ...
      ((Element)v.get(113)).setAttribute("id","DescripcionLocalizationButton" );
      ((Element)v.get(113)).setAttribute("href","javascript:openLocalizationDialog('maeTipoProblFrm', 'Descripcion', 1);" );
      ((Element)v.get(113)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"maeTipoProblFrm\",5, true)', 'ejecutarAccionFoco(\"maeTipoProblFrm\",5, false)')" );
      ((Element)v.get(112)).appendChild((Element)v.get(113));

      /* Empieza nodo:114 / Elemento padre: 113   */
      v.add(doc.createElement("IMG"));
      ((Element)v.get(114)).setAttribute("nombre","DescripcionLocalizationButton" );
      ((Element)v.get(114)).setAttribute("src","iconmultidioma.gif" );
      ((Element)v.get(114)).setAttribute("border","0" );
      ((Element)v.get(114)).setAttribute("width","21" );
      ((Element)v.get(114)).setAttribute("height","15" );
      ((Element)v.get(114)).setAttribute("class","main" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(115)).setAttribute("nombre","DescripcionGapTdId" );
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(129)).setAttribute("nombre","maeTipoProblTrButtons" );
      ...
      ((Element)v.get(136)).setAttribute("nombre","maeTipoProblTdQueryButton" );
      ((Element)v.get(135)).appendChild((Element)v.get(136));

      /* Empieza nodo:137 / Elemento padre: 136   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(137)).setAttribute("nombre","maeTipoProblQueryButton" );
      ((Element)v.get(137)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(137)).setAttribute("estado","false" );
      ((Element)v.get(137)).setAttribute("accion","maeTipoProblFirstPage();" );
      ...
      ((Element)v.get(138)).setAttribute("nombre","maeTipoProblTdLovNullSelectionButton" );
   ...
   private void getXML630(Document doc) {
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(140)).setAttribute("nombre","maeTipoProblLovNullButton" );
      ((Element)v.get(140)).setAttribute("ID","botonContenido" );
      ((Element)v.get(140)).setAttribute("tipo","html" );
      ((Element)v.get(140)).setAttribute("accion","maeTipoProblLovNullSelectionAction();" );
