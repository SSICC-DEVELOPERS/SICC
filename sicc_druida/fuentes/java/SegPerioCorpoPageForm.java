...
public class SegPerioCorpoPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","SegPerioCorpo.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","SegPerioCorpo.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('segPerioCorpoFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('segPerioCorpoFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(50)).setAttribute("nombre","tipeOidTipoPeriTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lbltipeOidTipoPeri" );
      ((Element)v.get(54)).setAttribute("id","datosTitle" );
      ((Element)v.get(54)).setAttribute("ancho","150" );
      ((Element)v.get(54)).setAttribute("alto","13" );
      ((Element)v.get(54)).setAttribute("cod","SegPerioCorpo.tipeOidTipoPeri.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(55)).setAttribute("nombre","tipeOidTipoPeriWidgetTrId" );
      ...
      ((Element)v.get(57)).setAttribute("nombre","tipeOidTipoPeri" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('segPerioCorpoFrm',2, true);" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('segPerioCorpoFrm',2, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(59)).setAttribute("nombre","tipeOidTipoPeriGapTdId" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(61)).setAttribute("nombre","codPeriTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(66)).setAttribute("nombre","codPeriWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(68)).setAttribute("nombre","codPeri" );
      ...
      ((Element)v.get(68)).setAttribute("ontab","ejecutarAccionFoco('segPerioCorpoFrm',3, true)" );
      ((Element)v.get(68)).setAttribute("onshtab","ejecutarAccionFoco('segPerioCorpoFrm', 3, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(69)).setAttribute("nombre","codPeriGapTdId" );
      ...
      ((Element)v.get(75)).setAttribute("cod","SegPerioCorpo.Descripcion.label" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(79)).setAttribute("ontab","ejecutarAccionFoco('segPerioCorpoFrm',4, true)" );
      ((Element)v.get(79)).setAttribute("onshtab","ejecutarAccionFoco('segPerioCorpoFrm', 4, false)" );
      ...
      ((Element)v.get(83)).setAttribute("href","javascript:openLocalizationDialog('segPerioCorpoFrm', 'Descripcion', 1);" );
      ((Element)v.get(83)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"segPerioCorpoFrm\",4, true)', 'ejecutarAccionFoco(\"segPerioCorpoFrm\",4, false)')" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(87)).setAttribute("nombre","valAnioTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(91)).setAttribute("nombre","lblValAnio" );
      ((Element)v.get(91)).setAttribute("alto","13" );
      ((Element)v.get(91)).setAttribute("filas","1" );
      ((Element)v.get(91)).setAttribute("id","datosTitle" );
      ((Element)v.get(91)).setAttribute("cod","SegPerioCorpo.valAnio.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(92)).setAttribute("nombre","valAnioWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(94)).setAttribute("nombre","valAnio" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(94)).setAttribute("ontab","ejecutarAccionFoco('segPerioCorpoFrm',5, true)" );
      ((Element)v.get(94)).setAttribute("onshtab","ejecutarAccionFoco('segPerioCorpoFrm', 5, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(95)).setAttribute("nombre","valAnioGapTdId" );
      ...
      /* Empieza nodo:109 / Elemento padre: 0   */
      v.add(doc.createElement("TR"));
      ((Element)v.get(109)).setAttribute("nombre","segPerioCorpoTrButtons" );
      ((Element)v.get(0)).appendChild((Element)v.get(109));
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(116)).setAttribute("nombre","segPerioCorpoTdQueryButton" );
      ((Element)v.get(115)).appendChild((Element)v.get(116));

      /* Empieza nodo:117 / Elemento padre: 116   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(117)).setAttribute("nombre","segPerioCorpoQueryButton" );
      ((Element)v.get(117)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(117)).setAttribute("estado","false" );
      ((Element)v.get(117)).setAttribute("accion","segPerioCorpoFirstPage();" );
      ...
      ((Element)v.get(118)).setAttribute("nombre","segPerioCorpoTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(120)).setAttribute("nombre","segPerioCorpoLovNullButton" );
      ((Element)v.get(120)).setAttribute("ID","botonContenido" );
      ((Element)v.get(120)).setAttribute("tipo","html" );
      ((Element)v.get(120)).setAttribute("accion","segPerioCorpoLovNullSelectionAction();" );
