...
public class ConectorBusquedaMaterialesPaginado  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","DTOEntradaTipoSolicitud" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MLNF" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(8)).setAttribute("NOMBRE","CODI_ANTI" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(9)).setAttribute("NOMBRE","DES_CORT" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(10)).setAttribute("NOMBRE","IND_LOTE" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(11)).setAttribute("NOMBRE","IND_PROD_SERV" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(12)).setAttribute("NOMBRE","OID_MARC" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(13)).setAttribute("NOMBRE","DES_MARC" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(14)).setAttribute("NOMBRE","OID2" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(15)).setAttribute("NOMBRE","UNEG_OID_UNID_NEGO" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(16)).setAttribute("NOMBRE","NEGO_OID_NEGO" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(17)).setAttribute("NOMBRE","GENE_OID_GENE" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(18)).setAttribute("NOMBRE","SGEN_OID_SUPE_GENE" );
   ...
   private void getXML90(Document doc) {
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(19)).setAttribute("NOMBRE","DESC_SAP" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(20)).setAttribute("NOMBRE","DES_MAE_UNIDA_NEGOC" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(21)).setAttribute("NOMBRE","DES_MAE_NEGOC" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(22)).setAttribute("NOMBRE","DES_MAE_GENER" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(23)).setAttribute("NOMBRE","DES_MAE_SUPER_GENER" );
      ...
      ((Element)v.get(24)).setAttribute("ID","dtoSalida.resultado_ROWSET" );
      ...
      v.add(doc.createElement("CCAMPO"));
      ((Element)v.get(26)).setAttribute("NOMBRE","COD_SAP" );
      ...
      v.add(doc.createElement("CCAMPO"));
      ((Element)v.get(27)).setAttribute("NOMBRE","CODI_ANTI" );
      ...
      v.add(doc.createElement("CCAMPO"));
      ((Element)v.get(28)).setAttribute("NOMBRE","DESC_SAP" );
      ...
      v.add(doc.createElement("CCAMPO"));
      ((Element)v.get(29)).setAttribute("NOMBRE","DES_CORT" );
      ...
      v.add(doc.createElement("CCAMPO"));
      ((Element)v.get(30)).setAttribute("NOMBRE","IND_LOTE" );
      ...
      v.add(doc.createElement("CCAMPO"));
      ((Element)v.get(31)).setAttribute("NOMBRE","IND_PROD_SERV" );
      ...
      v.add(doc.createElement("CCAMPO"));
      ((Element)v.get(32)).setAttribute("NOMBRE","DES_MARC" );
      ...
      v.add(doc.createElement("CCAMPO"));
      ((Element)v.get(33)).setAttribute("NOMBRE","DES_MAE_UNIDA_NEGOC" );
      ...
      v.add(doc.createElement("CCAMPO"));
      ((Element)v.get(34)).setAttribute("NOMBRE","DES_MAE_NEGOC" );
      ...
      v.add(doc.createElement("CCAMPO"));
      ((Element)v.get(35)).setAttribute("NOMBRE","DES_MAE_GENER" );
      ...
      v.add(doc.createElement("CCAMPO"));
      ((Element)v.get(36)).setAttribute("NOMBRE","DES_MAE_SUPER_GENER" );
