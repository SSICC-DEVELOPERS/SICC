...
public class ComEstadComisConectorQueryForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad ComEstadComis" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGComEstadComisQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGComEstadComisQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","ComEstadComisFormFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","codEstaComi" );
