...
public class ConectorGuardarTiposSolicitudProceso  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","ConectorGuardarTiposSolicitudProceso" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","PEDguardaTipoSolicitudProceso" );
      ...
      ((Element)v.get(5)).setAttribute("LONGITUD","0" );
