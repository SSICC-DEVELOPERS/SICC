...
public class ConectorProcesarSolicitudes  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","ConectorProcesarSolicitudes" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","DTOInfoMonitor" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","PEDProcesarSolicitudes" );
