...
public class IncPartiConcuCabecPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","IncPartiConcuCabec.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","IncPartiConcuCabec.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('incPartiConcuCabecFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('incPartiConcuCabecFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(50)).setAttribute("nombre","valGrupClieTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lblValGrupClie" );
      ((Element)v.get(54)).setAttribute("alto","13" );
      ((Element)v.get(54)).setAttribute("filas","1" );
      ((Element)v.get(54)).setAttribute("id","datosTitle" );
      ((Element)v.get(54)).setAttribute("cod","IncPartiConcuCabec.valGrupClie.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(55)).setAttribute("nombre","valGrupClieWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(57)).setAttribute("nombre","valGrupClie" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('incPartiConcuCabecFrm',2, true)" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('incPartiConcuCabecFrm', 2, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(58)).setAttribute("nombre","valGrupClieGapTdId" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(79)).setAttribute("cod","IncPartiConcuCabec.paisOidPais.label" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(82)).setAttribute("ontab","ejecutarAccionFoco('incPartiConcuCabecFrm',3, true);" );
      ((Element)v.get(82)).setAttribute("onshtab","ejecutarAccionFoco('incPartiConcuCabecFrm',3, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(86)).setAttribute("nombre","diriOidDiriTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(90)).setAttribute("nombre","lbldiriOidDiri" );
      ((Element)v.get(90)).setAttribute("id","datosTitle" );
      ((Element)v.get(90)).setAttribute("ancho","150" );
      ((Element)v.get(90)).setAttribute("alto","13" );
      ((Element)v.get(90)).setAttribute("cod","IncPartiConcuCabec.diriOidDiri.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(91)).setAttribute("nombre","diriOidDiriWidgetTrId" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(93)).setAttribute("nombre","diriOidDiri" );
      ...
      ((Element)v.get(93)).setAttribute("ontab","ejecutarAccionFoco('incPartiConcuCabecFrm',4, true);" );
      ((Element)v.get(93)).setAttribute("onshtab","ejecutarAccionFoco('incPartiConcuCabecFrm',4, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(95)).setAttribute("nombre","diriOidDiriGapTdId" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(112)).setAttribute("nombre","desDescTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(117)).setAttribute("nombre","desDescWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(119)).setAttribute("nombre","desDesc" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(119)).setAttribute("ontab","ejecutarAccionFoco('incPartiConcuCabecFrm',5, true)" );
      ((Element)v.get(119)).setAttribute("onshtab","ejecutarAccionFoco('incPartiConcuCabecFrm', 5, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(120)).setAttribute("nombre","desDescGapTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(134)).setAttribute("nombre","incPartiConcuCabecTrButtons" );
   ...
   private void getXML630(Document doc) {
      ...
      ((Element)v.get(141)).setAttribute("nombre","incPartiConcuCabecTdQueryButton" );
      ((Element)v.get(140)).appendChild((Element)v.get(141));

      /* Empieza nodo:142 / Elemento padre: 141   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(142)).setAttribute("nombre","incPartiConcuCabecQueryButton" );
      ((Element)v.get(142)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(142)).setAttribute("estado","false" );
      ((Element)v.get(142)).setAttribute("accion","incPartiConcuCabecFirstPage();" );
      ...
      ((Element)v.get(143)).setAttribute("nombre","incPartiConcuCabecTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(145)).setAttribute("nombre","incPartiConcuCabecLovNullButton" );
      ((Element)v.get(145)).setAttribute("ID","botonContenido" );
      ((Element)v.get(145)).setAttribute("tipo","html" );
      ((Element)v.get(145)).setAttribute("accion","incPartiConcuCabecLovNullSelectionAction();" );
