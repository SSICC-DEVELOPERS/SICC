/*
    INDRA/CAR/mmg
    $Id: CccTipoTransLPStartUp.java,v 1.1 2009/12/03 18:43:28 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class CccTipoTransLPStartUp extends MMGDruidaBase{
	...
	protected static Hashtable codTipoTranCheqValues = new Hashtable();
	static{
		codTipoTranCheqValues.put(new java.lang.String("S"), "Si");
		codTipoTranCheqValues.put(new java.lang.String("N"), "No");
	}
	
	
	// Definicion del constructor
	public CccTipoTransLPStartUp(){
		super();
	}

	public void inicio() throws Exception {
		pagina("CccTipoTransPage");
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "CccTipoTransPage", "cod", "CccTipoTrans." + accion + ".label");
			...
			limpiarBotoneraLista("cccTipoTrans", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codTipoTran", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 5);");
		...
		//asignarAtributo("CAPA", "cccTipoTransLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "CccTipoTransPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		CccTipoTransData cccTipoTransQuery= new CccTipoTransData();
		cccTipoTransQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		CccTipoTransData datosResult = (CccTipoTransData)getSingleObject(BUSINESSID_QUERY, cccTipoTransQuery, 
			cccTipoTransQuery.clone(), "cccTipoTrans");
		...
		preservaHiddensI18n(new Integer(1), "CCC_TIPO_TRANS", "cccTipoTransFrm", "Descripcion", true);
		
		
		//Guardamos los valores de los radiobuttons
		if(datosResult.getCodTipoTranCheq() != null)
			asignar("VAR", "codTipoTranCheqCheckValue", datosResult.getCodTipoTranCheq().toString());
		...
		CccTipoTransData cccTipoTrans = datosResult;
		asignar("TEXT", "codTipoTran", FormatUtils.formatObject(cccTipoTrans.getCodTipoTran(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "Descripcion", FormatUtils.formatObject(cccTipoTrans.getDescripcion(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignarAtributo("RADIOB", "codTipoTranCheq" , "valor", FormatUtils.formatObject(
			cccTipoTrans.getCodTipoTranCheq(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		loadLocalizationVars(cccTipoTrans);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "codTipoTran", "disabled", "S");
		asignarAtributo("TEXT", "Descripcion", "disabled", "S");
		
					asignarAtributo("RADIOB", "codTipoTranCheq", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "CCC_TIPO_TRANS", "cccTipoTransFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "codTipoTran", "req", "S");
		asignarAtributo("TEXT", "Descripcion", "req", "S");
		asignarAtributo("RADIOB", "codTipoTranCheq", "req", "S");
		
		
		//Asiganamos a los campos internacionalizables la función de onblur para actualizar el 
		//valor del idioma por defecto
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('cccTipoTransFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "cccTipoTransFrm", "oculto", "N");
		...
		traza("MMG::Creando CccTipoTrans");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		CccTipoTransData cccTipoTransQuery= new CccTipoTransData();
		cccTipoTransQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(cccTipoTrans.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"cccTipoTransFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"cccTipoTransFrm\",1, false)");
					asignarAtributo("COMBO","paisOidPais", "ontab", "ejecutarAccionFocoModificacion(\"cccTipoTransFrm\",2, true)");
					asignarAtributo("COMBO","paisOidPais", "onshtab", "ejecutarAccionFocoModificacion(\"cccTipoTransFrm\",2, false)");
				asignarAtributo("AREATEXTO", "codTipoTran", "ontab","ejecutarAccionFocoModificacion(\"cccTipoTransFrm\",3, true)");
				asignarAtributo("AREATEXTO", "codTipoTran", "onshtab","ejecutarAccionFocoModificacion(\"cccTipoTransFrm\",3, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"cccTipoTransFrm\",4, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"cccTipoTransFrm\",4, false)");
				asignarAtributo("TEXT", "codTipoTranCheq", "ontab","ejecutarAccionFocoModificacion(\"cccTipoTransFrm\",5, true)");
				asignarAtributo("TEXT", "codTipoTranCheq", "onshtab","ejecutarAccionFocoModificacion(\"cccTipoTransFrm\",5, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","cccTipoTransTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","cccTipoTransTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","cccTipoTransFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","cccTipoTransListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","cccTipoTransListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(CccTipoTransData cccTipoTrans) throws Exception{
		...
		if(cccTipoTrans != null && cccTipoTrans.getPaisOidPais() != null){
				checkCombo("paisOidPais" , cccTipoTrans.getPaisOidPais().getId().toString());
			}
	...
	* @param cccTipoTrans La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(CccTipoTransData cccTipoTrans) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		CccTipoTransData cccTipoTrans = 
			(CccTipoTransData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(cccTipoTrans.getPaisOidPais() != null){
			cccTipoTrans.setPaisOidPais((es.indra.belcorp.mso.SegPaisViewData)
			getSingleObject(BUSINESSID_PAISOIDPAIS_QUERY, 
			cccTipoTrans.getPaisOidPais(),
			cccTipoTrans.getPaisOidPais().clone(),
			"segPaisView"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(cccTipoTrans);
		loadLeafDependenceCombos(cccTipoTrans);
	}
	...
	*/
	...
	protected void loadLocalizationVars(CccTipoTransData cccTipoTrans) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("CCC_TIPO_TRANS");
		mmgLocalizationQuery.setEntiPk(cccTipoTrans.getId());
