...
public class BelTipoMovimAlmacViewPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","belTipoMovimAlmacViewList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(19)).setAttribute("cod","BelTipoMovimAlmacView.paisOidPais.label" );
      ...
      ((Element)v.get(20)).setAttribute("cod","BelTipoMovimAlmacView.codTipoMovi.label" );
      ...
      ((Element)v.get(21)).setAttribute("cod","BelTipoMovimAlmacView.codMoviSap.label" );
      ...
      ((Element)v.get(22)).setAttribute("cod","BelTipoMovimAlmacView.indMoviEntrAlma.label" );
      ...
      ((Element)v.get(23)).setAttribute("cod","BelTipoMovimAlmacView.indMantMovi.label" );
      ...
      ((Element)v.get(24)).setAttribute("cod","BelTipoMovimAlmacView.indSap.label" );
      ...
      ((Element)v.get(25)).setAttribute("cod","BelTipoMovimAlmacView.codOper1.label" );
      ...
      ((Element)v.get(26)).setAttribute("cod","BelTipoMovimAlmacView.codOper2.label" );
