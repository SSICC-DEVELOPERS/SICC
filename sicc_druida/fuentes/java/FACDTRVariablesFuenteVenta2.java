...
public class FACDTRVariablesFuenteVenta2 extends LPSICCBase {           
   public FACDTRVariablesFuenteVenta2() {	 
     super();
  }
     ...
     try {
        ...
        if (accion.equals("generar")){
          ...
          //cargarPagina();
                 ...
                 cargarPagina();
                 getConfiguracionMenu("FACDTRVariablesFuenteVenta2");
        }
  ...
  private void cargarPagina() throws Exception{
     ...
     asignarAtributoPagina("cod","0807");      
     ...
     asignarAtributo("VAR", "lp", "valor", "FACDTRVariablesFuenteVenta2");
  ...
  private void generarReporte() throws Exception{
     ...
     datos.put(ConstantesREP.TITULO, "Resultados de variables de fuente de ventas por campaña II");     
     traza("++++++Antes de enviar a reportes " + datos); 
     
     String formato = conectorParametroLimpia("formato", "", true);
     
       
     //ejecutarReporte(datos, "REPGenerarReporte", "RFD-002", formato);
     ejecutarReporte2(datos, "REPGenerarReporteBatch", "RD_RFD-002", formato);
