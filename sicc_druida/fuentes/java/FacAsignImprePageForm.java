...
public class FacAsignImprePageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","FacAsignImpre.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","FacAsignImpre.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('facAsignImpreFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('facAsignImpreFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(50)).setAttribute("nombre","imviOidImprTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lblimviOidImpr" );
      ((Element)v.get(54)).setAttribute("id","datosTitle" );
      ((Element)v.get(54)).setAttribute("ancho","150" );
      ((Element)v.get(54)).setAttribute("alto","13" );
      ((Element)v.get(54)).setAttribute("cod","FacAsignImpre.imviOidImpr.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(55)).setAttribute("nombre","imviOidImprWidgetTrId" );
      ...
      ((Element)v.get(57)).setAttribute("nombre","imviOidImpr" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('facAsignImpreFrm',2, true);" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('facAsignImpreFrm',2, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(59)).setAttribute("nombre","imviOidImprGapTdId" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(83)).setAttribute("onchange","mmgDependeneChangeNivel2('sbacOidSbac_acceOidAcce_canaOidCana', 'sbacOidSbac' , 'facAsignImpre', 'sbacOidSbac_acceOidAcce', 'sbacOidSbac')" );
      ...
      ((Element)v.get(83)).setAttribute("ontab","focaliza('facAsignImpreFrm.sbacOidSbac_acceOidAcce');" );
      ((Element)v.get(83)).setAttribute("onshtab","ejecutarAccionFoco('facAsignImpreFrm',3, false);" );
      ...
      ((Element)v.get(94)).setAttribute("onchange","mmgDependeneChange('sbacOidSbac_acceOidAcce', 'sbacOidSbac' , 'facAsignImpre')" );
      ...
      ((Element)v.get(94)).setAttribute("ontab","focaliza('facAsignImpreFrm.sbacOidSbac');" );
      ((Element)v.get(94)).setAttribute("onshtab","focaliza('facAsignImpreFrm.sbacOidSbac_acceOidAcce_canaOidCana');" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(102)).setAttribute("cod","FacAsignImpre.sbacOidSbac.label" );
      ...
      ((Element)v.get(105)).setAttribute("ontab","ejecutarAccionFoco('facAsignImpreFrm',3, true);" );
      ((Element)v.get(105)).setAttribute("onshtab","focaliza('facAsignImpreFrm.sbacOidSbac_acceOidAcce');" );
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(124)).setAttribute("nombre","forsOidFormTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(128)).setAttribute("nombre","lblforsOidForm" );
      ...
      ((Element)v.get(128)).setAttribute("cod","FacAsignImpre.forsOidForm.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(129)).setAttribute("nombre","forsOidFormWidgetTrId" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(131)).setAttribute("nombre","forsOidForm" );
      ...
      ((Element)v.get(131)).setAttribute("ontab","ejecutarAccionFoco('facAsignImpreFrm',4, true);" );
      ((Element)v.get(131)).setAttribute("onshtab","ejecutarAccionFoco('facAsignImpreFrm',4, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(133)).setAttribute("nombre","forsOidFormGapTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(138)).setAttribute("nombre","formGapTr3" );
   }
   ...
   private void getXML630(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(147)).setAttribute("nombre","facAsignImpreTrButtons" );
      ...
      ((Element)v.get(154)).setAttribute("nombre","facAsignImpreTdQueryButton" );
      ((Element)v.get(153)).appendChild((Element)v.get(154));

      /* Empieza nodo:155 / Elemento padre: 154   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(155)).setAttribute("nombre","facAsignImpreQueryButton" );
      ((Element)v.get(155)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(155)).setAttribute("estado","false" );
      ((Element)v.get(155)).setAttribute("accion","facAsignImpreFirstPage();" );
      ...
      ((Element)v.get(156)).setAttribute("nombre","facAsignImpreTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(158)).setAttribute("nombre","facAsignImpreLovNullButton" );
      ((Element)v.get(158)).setAttribute("ID","botonContenido" );
      ((Element)v.get(158)).setAttribute("tipo","html" );
      ((Element)v.get(158)).setAttribute("accion","facAsignImpreLovNullSelectionAction();" );
