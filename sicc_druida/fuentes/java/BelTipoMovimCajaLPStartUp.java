/*
    INDRA/CAR/mmg
    $Id: BelTipoMovimCajaLPStartUp.java,v 1.1 2009/12/03 18:32:17 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class BelTipoMovimCajaLPStartUp extends MMGDruidaBase{
	...
	protected static Hashtable valSignValues = new Hashtable();
	static{
		valSignValues.put(new java.lang.String("+"), "+");
		valSignValues.put(new java.lang.String("-"), "-");
		valSignValues.put(new java.lang.String("+-"), "+-");
	}
	protected static Hashtable indAutoValues = new Hashtable();
	static{
		indAutoValues.put(new java.lang.String("M"), "Manual");
		indAutoValues.put(new java.lang.String("A"), "Automatico");
	}
	
	
	// Definicion del constructor
	public BelTipoMovimCajaLPStartUp(){
		super();
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			buildJsPageSize("BelTipoMovimCaja");
			...
			asignarAtributo("PAGINA", "BelTipoMovimCajaPage", "cod", "BelTipoMovimCaja." + accion + ".label");
			...
			limpiarBotoneraLista("belTipoMovimCaja", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codCaja", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 2);");
		asignarAtributo("TEXT", "desTipoMoviCaja", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 30);");
		...
		//asignarAtributo("CAPA", "belTipoMovimCajaLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "BelTipoMovimCajaPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		BelTipoMovimCajaData belTipoMovimCajaQuery= new BelTipoMovimCajaData();
		belTipoMovimCajaQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		BelTipoMovimCajaData datosResult = (BelTipoMovimCajaData)getSingleObject(BUSINESSID_QUERY, belTipoMovimCajaQuery, 
			belTipoMovimCajaQuery.clone(), "belTipoMovimCaja");
		...
		BelTipoMovimCajaData belTipoMovimCaja = datosResult;
		asignar("TEXT", "codCaja", FormatUtils.formatObject(belTipoMovimCaja.getCodCaja(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "desTipoMoviCaja", FormatUtils.formatObject(belTipoMovimCaja.getDesTipoMoviCaja(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		if(belTipoMovimCaja.getValSign() != null){	
			checkCombo("valSign", FormatUtils.formatObject(belTipoMovimCaja.getValSign(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		}
		if(belTipoMovimCaja.getIndAuto() != null){	
			checkCombo("indAuto", FormatUtils.formatObject(belTipoMovimCaja.getIndAuto(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		}
		...
		asignarAtributo("TEXT", "desTipoMoviCaja", "disabled", "S");
		
					asignarAtributo("COMBO", "valSign", "disabled", "S");
					asignarAtributo("COMBO", "indAuto", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		...
		asignarAtributo("TEXT", "desTipoMoviCaja", "req", "S");
		asignarAtributo("COMBO", "valSign", "req", "S");
		asignarAtributo("COMBO", "indAuto", "req", "S");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "belTipoMovimCajaFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		BelTipoMovimCajaData belTipoMovimCajaQuery= new BelTipoMovimCajaData();
		belTipoMovimCajaQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(belTipoMovimCaja.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"belTipoMovimCajaFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"belTipoMovimCajaFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codCaja", "ontab","ejecutarAccionFocoModificacion(\"belTipoMovimCajaFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codCaja", "onshtab","ejecutarAccionFocoModificacion(\"belTipoMovimCajaFrm\",2, false)");
				asignarAtributo("AREATEXTO", "desTipoMoviCaja", "ontab","ejecutarAccionFocoModificacion(\"belTipoMovimCajaFrm\",3, true)");
				asignarAtributo("AREATEXTO", "desTipoMoviCaja", "onshtab","ejecutarAccionFocoModificacion(\"belTipoMovimCajaFrm\",3, false)");
				asignarAtributo("TEXT", "valSign", "ontab","ejecutarAccionFocoModificacion(\"belTipoMovimCajaFrm\",4, true)");
				asignarAtributo("TEXT", "valSign", "onshtab","ejecutarAccionFocoModificacion(\"belTipoMovimCajaFrm\",4, false)");
				asignarAtributo("TEXT", "indAuto", "ontab","ejecutarAccionFocoModificacion(\"belTipoMovimCajaFrm\",5, true)");
				asignarAtributo("TEXT", "indAuto", "onshtab","ejecutarAccionFocoModificacion(\"belTipoMovimCajaFrm\",5, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","belTipoMovimCajaTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","belTipoMovimCajaTrButtons");
			...
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codCaja...");		
					...
					traza("MMG: en desactivateNonModifyFields encontrado atributo no editable...");
						...
						// borrarCampo("codCaja");
						asignarAtributo ("TEXT", "codCaja", "disabled", "S");
				traza("MMG: el atributo es desTipoMoviCaja...");		
				
				traza("MMG: el atributo es valSign...");		
				
				traza("MMG: el atributo es indAuto...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","belTipoMovimCajaFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","belTipoMovimCajaListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","belTipoMovimCajaListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(BelTipoMovimCajaData belTipoMovimCaja) throws Exception{
	...
	* @param belTipoMovimCaja La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(BelTipoMovimCajaData belTipoMovimCaja) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		BelTipoMovimCajaData belTipoMovimCaja = 
			(BelTipoMovimCajaData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(belTipoMovimCaja);
		loadLeafDependenceCombos(belTipoMovimCaja);
	}
