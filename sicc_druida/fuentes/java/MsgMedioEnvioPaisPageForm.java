...
public class MsgMedioEnvioPaisPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","MsgMedioEnvioPais.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","MsgMedioEnvioPais.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('msgMedioEnvioPaisFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('msgMedioEnvioPaisFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(54)).setAttribute("cod","MsgMedioEnvioPais.paisOidPais.label" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('msgMedioEnvioPaisFrm',2, true);" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('msgMedioEnvioPaisFrm',2, false);" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(61)).setAttribute("nombre","meenOidMediEnviTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(65)).setAttribute("nombre","lblmeenOidMediEnvi" );
      ((Element)v.get(65)).setAttribute("id","datosTitle" );
      ((Element)v.get(65)).setAttribute("ancho","150" );
      ((Element)v.get(65)).setAttribute("alto","13" );
      ((Element)v.get(65)).setAttribute("cod","MsgMedioEnvioPais.meenOidMediEnvi.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(66)).setAttribute("nombre","meenOidMediEnviWidgetTrId" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(68)).setAttribute("nombre","meenOidMediEnvi" );
      ...
      ((Element)v.get(68)).setAttribute("ontab","ejecutarAccionFoco('msgMedioEnvioPaisFrm',3, true);" );
      ((Element)v.get(68)).setAttribute("onshtab","ejecutarAccionFoco('msgMedioEnvioPaisFrm',3, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(70)).setAttribute("nombre","meenOidMediEnviGapTdId" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(72)).setAttribute("nombre","codEstaTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(77)).setAttribute("nombre","codEstaWidgetTrId" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(79)).setAttribute("nombre","codEsta" );
      ...
      ((Element)v.get(79)).setAttribute("ontab","ejecutarAccionFoco('msgMedioEnvioPaisFrm',4, true)" );
      ((Element)v.get(79)).setAttribute("onshtab","ejecutarAccionFoco('msgMedioEnvioPaisFrm',4, false)" );
      ((Element)v.get(78)).appendChild((Element)v.get(79));

      /* Empieza nodo:80 / Elemento padre: 79   */
      v.add(doc.createElement("RBINPUT"));
      ((Element)v.get(80)).setAttribute("id","datosCampos" );
      ((Element)v.get(80)).setAttribute("valor","A" );
      ((Element)v.get(80)).setAttribute("cod","MsgMedioEnvioPais.codEsta.A.label" );
      ...
      ((Element)v.get(82)).setAttribute("valor","D" );
      ((Element)v.get(82)).setAttribute("cod","MsgMedioEnvioPais.codEsta.D.label" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(84)).setAttribute("nombre","codEstaGapTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(98)).setAttribute("nombre","msgMedioEnvioPaisTrButtons" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(105)).setAttribute("nombre","msgMedioEnvioPaisTdQueryButton" );
      ((Element)v.get(104)).appendChild((Element)v.get(105));

      /* Empieza nodo:106 / Elemento padre: 105   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(106)).setAttribute("nombre","msgMedioEnvioPaisQueryButton" );
      ((Element)v.get(106)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(106)).setAttribute("estado","false" );
      ((Element)v.get(106)).setAttribute("accion","msgMedioEnvioPaisFirstPage();" );
      ...
      ((Element)v.get(107)).setAttribute("nombre","msgMedioEnvioPaisTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(109)).setAttribute("nombre","msgMedioEnvioPaisLovNullButton" );
      ((Element)v.get(109)).setAttribute("ID","botonContenido" );
      ((Element)v.get(109)).setAttribute("tipo","html" );
      ((Element)v.get(109)).setAttribute("accion","msgMedioEnvioPaisLovNullSelectionAction();" );
