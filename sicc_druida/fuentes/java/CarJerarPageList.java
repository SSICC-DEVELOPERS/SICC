...
public class CarJerarPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","carJerarList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","CarJerar.codJera.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","CarJerar.numDias.label" );
      ...
      ((Element)v.get(17)).setAttribute("cod","CarJerar.valPorcLineCred.label" );
      ...
      ((Element)v.get(18)).setAttribute("cod","CarJerar.valPorcMontMaxi.label" );
