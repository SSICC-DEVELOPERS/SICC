/*
    INDRA/CAR/mmg
    $Id: BelTipoMedioPagoLPStartUp.java,v 1.1 2009/12/03 18:33:00 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class BelTipoMedioPagoLPStartUp extends MMGDruidaBase{
	...
	public static final String BUSINESSID_QUERY = "MMGBelTipoMedioPagoQueryFromToUserPage";
	...
	public BelTipoMedioPagoLPStartUp(){
		super();
	}

	public void inicio() throws Exception {
		pagina("BelTipoMedioPagoPage");
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			buildJsPageSize("BelTipoMedioPago");
			...
			asignarAtributo("PAGINA", "BelTipoMedioPagoPage", "cod", "BelTipoMedioPago." + accion + ".label");
			...
			limpiarBotoneraLista("belTipoMedioPago", accion);
	...
	protected void cmdLov() throws Exception{
		...
		//asignarAtributo("CAPA", "belTipoMedioPagoLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "BelTipoMedioPagoPage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("BelTipoMedioPagoLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		BelTipoMedioPagoData belTipoMedioPagoQuery= new BelTipoMedioPagoData();
		belTipoMedioPagoQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		BelTipoMedioPagoData datosResult = (BelTipoMedioPagoData)getSingleObject(BUSINESSID_QUERY, belTipoMedioPagoQuery, 
			belTipoMedioPagoQuery.clone(), "belTipoMedioPago");
		...
		preservaHiddensI18n(new Integer(1), "BEL_TIPO_MEDIO_PAGO", "belTipoMedioPagoFrm", "Descripcion", true);
		...
		BelTipoMedioPagoData belTipoMedioPago = datosResult;
		asignar("TEXT", "Descripcion", FormatUtils.formatObject(belTipoMedioPago.getDescripcion(), 
		...
		loadLocalizationVars(belTipoMedioPago);
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "BEL_TIPO_MEDIO_PAGO", "belTipoMedioPagoFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('belTipoMedioPagoFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "belTipoMedioPagoFrm", "oculto", "N");
		...
		traza("MMG::Creando BelTipoMedioPago");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		BelTipoMedioPagoData belTipoMedioPagoQuery= new BelTipoMedioPagoData();
		belTipoMedioPagoQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(belTipoMedioPago.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"belTipoMedioPagoFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"belTipoMedioPagoFrm\",1, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"belTipoMedioPagoFrm\",4, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"belTipoMedioPagoFrm\",4, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","belTipoMedioPagoTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","belTipoMedioPagoTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","belTipoMedioPagoFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","belTipoMedioPagoListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","belTipoMedioPagoListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(BelTipoMedioPagoData belTipoMedioPago) throws Exception{
	...
	* @param belTipoMedioPago La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(BelTipoMedioPagoData belTipoMedioPago) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		BelTipoMedioPagoData belTipoMedioPago = 
			(BelTipoMedioPagoData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(belTipoMedioPago);
		loadLeafDependenceCombos(belTipoMedioPago);
	}
	...
	*/
	...
	protected void loadLocalizationVars(BelTipoMedioPagoData belTipoMedioPago) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("BEL_TIPO_MEDIO_PAGO");
		mmgLocalizationQuery.setEntiPk(belTipoMedioPago.getId());
