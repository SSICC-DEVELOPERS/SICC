...
public class CarAsignCodigConfiPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","carAsignCodigConfiList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(17)).setAttribute("height","20" );
      ((Element)v.get(17)).setAttribute("IDScroll","EstCab" );
      ((Element)v.get(17)).setAttribute("imgFondo","" );
      ((Element)v.get(17)).setAttribute("colFondo","#CCCCCC" );
      ...
      ((Element)v.get(18)).setAttribute("cod","CarAsignCodigConfi.zsgvOidSubgVent.label" );
      ...
      ((Element)v.get(19)).setAttribute("cod","CarAsignCodigConfi.zorgOidRegi.label" );
      ...
      ((Element)v.get(20)).setAttribute("cod","CarAsignCodigConfi.zzonOidZona.label" );
      ...
      ((Element)v.get(21)).setAttribute("cod","CarAsignCodigConfi.grsoOidGrupSoli.label" );
      ...
      ((Element)v.get(22)).setAttribute("cod","CarAsignCodigConfi.niriOidNiveRies.label" );
      ...
      ((Element)v.get(23)).setAttribute("cod","CarAsignCodigConfi.niriOidNiveRiesInici.label" );
      ...
      ((Element)v.get(24)).setAttribute("cod","CarAsignCodigConfi.pacaOidParaCart.label" );
      ...
      ((Element)v.get(25)).setAttribute("cod","CarAsignCodigConfi.valLineCredInic.label" );
      ...
      ((Element)v.get(26)).setAttribute("accion","" );
      ((Element)v.get(26)).setAttribute("tipoEnvio","seleccion" );
      ((Element)v.get(26)).setAttribute("formaEnvio","xml" );
      ((Element)v.get(26)).setAttribute("maxSel","1" );
      ((Element)v.get(26)).setAttribute("msgErrMaxSel","" );
      ((Element)v.get(26)).setAttribute("coloresScrollNativo","#D4D0C8,black,white,#D4D0C8,#D4D0C8,#ECE9E4,black" );
      ((Element)v.get(26)).setAttribute("colorROver","#D0D9E8" );
      ((Element)v.get(26)).setAttribute("onLoad","" );
      ((Element)v.get(26)).setAttribute("colorSelecc","#D0D9E8" );
      ...
      ((Element)v.get(28)).setAttribute("ID","EstDat2" );
      ...
      ((Element)v.get(29)).setAttribute("ID","EstDat" );
      ...
      ((Element)v.get(30)).setAttribute("ID","EstDat2" );
