...
public class EduRegalPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","eduRegalList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","EduRegal.codRega.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","EduRegal.prodOidProd.label" );
