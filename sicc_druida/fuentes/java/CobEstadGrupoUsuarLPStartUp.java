/*
    INDRA/CAR/mmg
    $Id: CobEstadGrupoUsuarLPStartUp.java,v 1.1 2009/12/03 18:39:57 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class CobEstadGrupoUsuarLPStartUp extends MMGDruidaBase{
	...
	public CobEstadGrupoUsuarLPStartUp(){
		super();
	}

	public void inicio() throws Exception {
		pagina("CobEstadGrupoUsuarPage");
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			buildJsPageSize("CobEstadGrupoUsuar");
			...
			asignarAtributo("PAGINA", "CobEstadGrupoUsuarPage", "cod", "CobEstadGrupoUsuar." + accion + ".label");
			...
			limpiarBotoneraLista("cobEstadGrupoUsuar", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codEstaGrupUsua", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 1);");
		
		//Primero determianmos el nombre del campo en la entidad de oriegen donde se van a cargar los datos
		asignar("VAR", "idAttributeLovOpener", conectorParametro(PARAMETRO_LOV_ATTRIBUTO));
		asignar("VAR", "idEntityLovOpener", conectorParametro(PARAMETRO_LOV_ENTIDAD));
		//asignarAtributo("CAPA", "cobEstadGrupoUsuarLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "CobEstadGrupoUsuarPage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("CobEstadGrupoUsuarLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		CobEstadGrupoUsuarData cobEstadGrupoUsuarQuery= new CobEstadGrupoUsuarData();
		cobEstadGrupoUsuarQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		CobEstadGrupoUsuarData datosResult = (CobEstadGrupoUsuarData)getSingleObject(BUSINESSID_QUERY, cobEstadGrupoUsuarQuery, 
			cobEstadGrupoUsuarQuery.clone(), "cobEstadGrupoUsuar");
		...
		preservaHiddensI18n(new Integer(1), "COB_ESTAD_GRUPO_USUAR", "cobEstadGrupoUsuarFrm", "Descripcion", true);
		...
		CobEstadGrupoUsuarData cobEstadGrupoUsuar = datosResult;
		asignar("TEXT", "codEstaGrupUsua", FormatUtils.formatObject(cobEstadGrupoUsuar.getCodEstaGrupUsua(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "Descripcion", FormatUtils.formatObject(cobEstadGrupoUsuar.getDescripcion(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		loadLocalizationVars(cobEstadGrupoUsuar);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "codEstaGrupUsua", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "COB_ESTAD_GRUPO_USUAR", "cobEstadGrupoUsuarFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "codEstaGrupUsua", "req", "S");
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('cobEstadGrupoUsuarFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "cobEstadGrupoUsuarFrm", "oculto", "N");
		...
		traza("MMG::Creando CobEstadGrupoUsuar");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		CobEstadGrupoUsuarData cobEstadGrupoUsuarQuery= new CobEstadGrupoUsuarData();
		cobEstadGrupoUsuarQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(cobEstadGrupoUsuar.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"cobEstadGrupoUsuarFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"cobEstadGrupoUsuarFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codEstaGrupUsua", "ontab","ejecutarAccionFocoModificacion(\"cobEstadGrupoUsuarFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codEstaGrupUsua", "onshtab","ejecutarAccionFocoModificacion(\"cobEstadGrupoUsuarFrm\",2, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"cobEstadGrupoUsuarFrm\",3, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"cobEstadGrupoUsuarFrm\",3, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","cobEstadGrupoUsuarTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","cobEstadGrupoUsuarTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codEstaGrupUsua...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","cobEstadGrupoUsuarFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","cobEstadGrupoUsuarListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","cobEstadGrupoUsuarListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(CobEstadGrupoUsuarData cobEstadGrupoUsuar) throws Exception{
	...
	* @param cobEstadGrupoUsuar La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(CobEstadGrupoUsuarData cobEstadGrupoUsuar) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		CobEstadGrupoUsuarData cobEstadGrupoUsuar = 
			(CobEstadGrupoUsuarData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(cobEstadGrupoUsuar);
		loadLeafDependenceCombos(cobEstadGrupoUsuar);
	}
	...
	*/
	...
	protected void loadLocalizationVars(CobEstadGrupoUsuarData cobEstadGrupoUsuar) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("COB_ESTAD_GRUPO_USUAR");
		mmgLocalizationQuery.setEntiPk(cobEstadGrupoUsuar.getId());
