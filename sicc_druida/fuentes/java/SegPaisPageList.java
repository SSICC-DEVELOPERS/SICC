...
public class SegPaisPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","segPaisList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","SegPais.codPais.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","SegPais.moneOidMone.label" );
