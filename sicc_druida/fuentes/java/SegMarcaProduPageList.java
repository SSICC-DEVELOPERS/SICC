...
public class SegMarcaProduPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","segMarcaProduList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","SegMarcaProdu.codMarcProd.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","SegMarcaProdu.desMarcProd.label" );
