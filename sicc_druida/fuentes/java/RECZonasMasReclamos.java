...
public class RECZonasMasReclamos extends LPSICCBase {            
   public RECZonasMasReclamos() {        
     super();
  }
     ...
     try {
         ...
         if (accion.equals("generar")){
           ...
           //cargarPagina();
            ...
            cargarPagina();
            getConfiguracionMenu("RECZonasMasReclamos");
         }
  ...
  private void cargarPagina() throws Exception{
     pagina("contenido_informe_mayor_porcentaje_reclamos_generar");
...
////////////////////////////////////////////////////////////////////////////////////////
 ...
 private void generarReporte() throws Exception{
     ...
     if(!tipoOperacion.equals("")){
         datos.put(ConstantesREP.TIPOOPERACION, tipoOperacion);  
         datos.put(ConstantesREP.OPERACIONESDESC, tipoOperacionDesc);  
     }
     
     String cantidadZonas         = conectorParametroLimpia("cantidadZonas", "", true);
     if(!cantidadZonas.equals("")){
         datos.put(ConstantesREP.CANTIDADZONAS, cantidadZonas);  
     }
     ...
     datos.put(ConstantesREP.TITULO, "Zonas con mayor porcentaje de reclamos");     
     traza("++++++Antes de enviar a reportes " + datos); 
         
     
     traza("el formaro es  " + formato);
//     ejecutarReporte(datos, "REPGenerarReporte", "RD_REP-104", formato);
     ejecutarReporte2(datos, "REPGenerarReporteBatch", "RD_REP-115", formato);
