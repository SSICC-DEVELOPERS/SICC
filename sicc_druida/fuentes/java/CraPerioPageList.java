...
public class CraPerioPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","craPerioList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(22)).setAttribute("cod","CraPerio.marcOidMarc.label" );
      ...
      ((Element)v.get(23)).setAttribute("cod","CraPerio.canaOidCana.label" );
      ...
      ((Element)v.get(24)).setAttribute("cod","CraPerio.paisOidPais.label" );
      ...
      ((Element)v.get(25)).setAttribute("cod","CraPerio.acceOidAcce.label" );
      ...
      ((Element)v.get(26)).setAttribute("cod","CraPerio.periOidPeri.label" );
      ...
      ((Element)v.get(27)).setAttribute("cod","CraPerio.fecInic.label" );
      ...
      ((Element)v.get(28)).setAttribute("cod","CraPerio.fecFina.label" );
      ...
      ((Element)v.get(29)).setAttribute("cod","CraPerio.valEsta.label" );
      ...
      ((Element)v.get(30)).setAttribute("cod","CraPerio.valNombPeri.label" );
      ...
      ((Element)v.get(31)).setAttribute("cod","CraPerio.indPeriCort.label" );
      ...
      ((Element)v.get(32)).setAttribute("cod","CraPerio.indPeriCruc.label" );
