...
public class contenido_version_asignar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_version_asignar" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","contenido_version_asignar.js" );
      ...
      ((Element)v.get(6)).setAttribute("name","cbMapaZonas" );
      ((Element)v.get(6)).setAttribute("required","true" );
      ((Element)v.get(6)).setAttribute("cod","ApeProdAnaquelesAsignar.mapaZonas.label" );
      ((Element)v.get(5)).appendChild((Element)v.get(6));
      /* Termina nodo:6   */

      /* Empieza nodo:7 / Elemento padre: 5   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(7)).setAttribute("name","txtVersion" );
      ((Element)v.get(7)).setAttribute("required","true" );
      ((Element)v.get(7)).setAttribute("cod","1607" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(17)).setAttribute("nombre","hOidMapaCentroDistribucion" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(18)).setAttribute("nombre","hOidMapaZona" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(19)).setAttribute("nombre","hOidPeriodo" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(20)).setAttribute("nombre","hOidNuevaVersion" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(45)).setAttribute("nombre","lblMapaZonas" );
      ...
      ((Element)v.get(45)).setAttribute("cod","ApeProdAnaquelesAsignar.mapaZonas.label" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(52)).setAttribute("nombre","cbMapaZonas" );
      ...
      ((Element)v.get(52)).setAttribute("onshtab","focalizaBotonHTML('botonContenido', 'btnAceptar');" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(64)).setAttribute("nombre","lblVersion" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(71)).setAttribute("nombre","txtVersion" );
      ...
      ((Element)v.get(71)).setAttribute("size","14" );
      ...
      /* Empieza nodo:77 / Elemento padre: 33   */
      v.add(doc.createElement("fieldset"));
      ((Element)v.get(33)).appendChild((Element)v.get(77));
      ...
      ((Element)v.get(81)).setAttribute("ontab","focaliza('formulario.cbMapaZonas');" );
