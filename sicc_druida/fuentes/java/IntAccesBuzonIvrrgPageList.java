...
public class IntAccesBuzonIvrrgPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","intAccesBuzonIvrrgList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","IntAccesBuzonIvrrg.codAcceBuzoIvrr.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","IntAccesBuzonIvrrg.zorgOidRegi.label" );
