/*
    INDRA/CAR/mmg
    $Id: CarIndicNivelJerarLPStartUp.java,v 1.1 2009/12/03 18:37:00 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class CarIndicNivelJerarLPStartUp extends MMGDruidaBase{
	...
	public static final String BUSINESSID_QUERY = "MMGCarIndicNivelJerarQueryFromToUserPage";
	
	
		
	//Hashtables con los valores estáticos de radiobuttons y combos
	protected static Hashtable codIndiNiveJeraValues = new Hashtable();
	static{
		codIndiNiveJeraValues.put(new java.lang.String("A"), "Activo");
		codIndiNiveJeraValues.put(new java.lang.String("I"), "Inactivo");
	}
	
	
	// Definicion del constructor
	public CarIndicNivelJerarLPStartUp(){
		super();
	}

	public void inicio() throws Exception {
		pagina("CarIndicNivelJerarPage");
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			buildJsPageSize("CarIndicNivelJerar");
			...
			asignarAtributo("PAGINA", "CarIndicNivelJerarPage", "cod", "CarIndicNivelJerar." + accion + ".label");
			...
			limpiarBotoneraLista("carIndicNivelJerar", accion);
	...
	protected void cmdLov() throws Exception{
		...
		//asignarAtributo("CAPA", "carIndicNivelJerarLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "CarIndicNivelJerarPage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("CarIndicNivelJerarLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		CarIndicNivelJerarData carIndicNivelJerarQuery= new CarIndicNivelJerarData();
		carIndicNivelJerarQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		CarIndicNivelJerarData datosResult = (CarIndicNivelJerarData)getSingleObject(BUSINESSID_QUERY, carIndicNivelJerarQuery, 
			carIndicNivelJerarQuery.clone(), "carIndicNivelJerar");
		...
		if(datosResult.getCodIndiNiveJera() != null)
			asignar("VAR", "codIndiNiveJeraCheckValue", datosResult.getCodIndiNiveJera().toString());
		...
		CarIndicNivelJerarData carIndicNivelJerar = datosResult;
		asignarAtributo("RADIOB", "codIndiNiveJera" , "valor", FormatUtils.formatObject(
			carIndicNivelJerar.getCodIndiNiveJera(), 
		...
		//Deshabilitamos todos los campos para que no se editen
					...
					asignarAtributo("RADIOB", "codIndiNiveJera", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		...
		asignarAtributo("RADIOB", "codIndiNiveJera", "req", "S");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "carIndicNivelJerarFrm", "oculto", "N");
		...
		traza("MMG::Creando CarIndicNivelJerar");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		CarIndicNivelJerarData carIndicNivelJerarQuery= new CarIndicNivelJerarData();
		carIndicNivelJerarQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(carIndicNivelJerar.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"carIndicNivelJerarFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"carIndicNivelJerarFrm\",1, false)");
				asignarAtributo("TEXT", "codIndiNiveJera", "ontab","ejecutarAccionFocoModificacion(\"carIndicNivelJerarFrm\",2, true)");
				asignarAtributo("TEXT", "codIndiNiveJera", "onshtab","ejecutarAccionFocoModificacion(\"carIndicNivelJerarFrm\",2, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","carIndicNivelJerarTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","carIndicNivelJerarTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codIndiNiveJera...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","carIndicNivelJerarFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","carIndicNivelJerarListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","carIndicNivelJerarListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(CarIndicNivelJerarData carIndicNivelJerar) throws Exception{
	...
	* @param carIndicNivelJerar La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(CarIndicNivelJerarData carIndicNivelJerar) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		CarIndicNivelJerarData carIndicNivelJerar = 
			(CarIndicNivelJerarData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(carIndicNivelJerar);
		loadLeafDependenceCombos(carIndicNivelJerar);
	}
