/*
    INDRA/CAR/mmg
    $Id: SegModulLPStartUp.java,v 1.1 2009/12/03 18:42:54 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class SegModulLPStartUp extends MMGDruidaBase{
	...
	public static final String BUSINESSID_QUERY = "MMGSegModulQueryFromToUserPage";
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "SegModulPage", "cod", "SegModul." + accion + ".label");
			...
			limpiarBotoneraLista("segModul", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codModu", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 2);");
		...
		//asignarAtributo("CAPA", "segModulLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "SegModulPage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("SegModulLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		SegModulData segModulQuery= new SegModulData();
		segModulQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		SegModulData datosResult = (SegModulData)getSingleObject(BUSINESSID_QUERY, segModulQuery, 
			segModulQuery.clone(), "segModul");
		...
		preservaHiddensI18n(new Integer(1), "SEG_MODUL", "segModulFrm", "Descripcion", true);
		...
		SegModulData segModul = datosResult;
		asignar("TEXT", "codModu", FormatUtils.formatObject(segModul.getCodModu(), 
		...
		loadLocalizationVars(segModul);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "codModu", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "SEG_MODUL", "segModulFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "codModu", "req", "S");
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('segModulFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "segModulFrm", "oculto", "N");
		...
		traza("MMG::Creando SegModul");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		SegModulData segModulQuery= new SegModulData();
		segModulQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(segModul.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"segModulFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"segModulFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codModu", "ontab","ejecutarAccionFocoModificacion(\"segModulFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codModu", "onshtab","ejecutarAccionFocoModificacion(\"segModulFrm\",2, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"segModulFrm\",3, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"segModulFrm\",3, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","segModulTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","segModulTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codModu...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","segModulFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","segModulListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","segModulListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(SegModulData segModul) throws Exception{
	...
	* @param segModul La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(SegModulData segModul) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		SegModulData segModul = 
			(SegModulData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(segModul);
		loadLeafDependenceCombos(segModul);
	}
	...
	*/
	...
	protected void loadLocalizationVars(SegModulData segModul) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("SEG_MODUL");
		mmgLocalizationQuery.setEntiPk(segModul.getId());
