...
public class PedImpueNegocConectorQueryForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad PedImpueNegoc" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGPedImpueNegocQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGPedImpueNegocQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","PedImpueNegocFormFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(9)).setAttribute("NOMBRE","negoOidNego" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(10)).setAttribute("NOMBRE","taimOidTasaImpu" );
