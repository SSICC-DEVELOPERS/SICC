...
public class RECZonasEleveadosAbonos extends LPSICCBase {           
   public RECZonasEleveadosAbonos() {	 
     super();
  }
     ...
     try {
        ...
        if (accion.equals("generar")){
          ...
          //cargarPagina();
           ...
           cargarPagina();
           getConfiguracionMenu("RECZonasEleveadosAbonos");
        }
  ...
  private void cargarPagina() throws Exception{
     pagina("contenido_informe_porcentaje_elevado_abonos_generar");   
 ...
 private void generarReporte() throws Exception{
     ...
     datos.put(ConstantesREP.TITULO, "Zonas con porcentaje elevado de abonos");     
...
//     ejecutarReporte(datos, "REPGenerarReporte", "RD_REP-116", formato);
     ejecutarReporte2(datos, "REPGenerarReporteBatch", "RD_REP-116", formato);
