...
public class contenido_informe_consultoras_reclamos_generar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_informe_consultoras_reclamos_generar" );
      ((Element)v.get(0)).setAttribute("cod","0919" );
      ((Element)v.get(0)).setAttribute("titulo","Generar informe consultoras con más reclamos" );
      ...
      v.add(doc.createTextNode("\r   \r   \r   function onLoad(){\r      configurarMenuSecundario('Formulario');\r      fMostrarMensajeError();\r      focaliza('Formulario.cbMarca');\r            \r   }\r\r function quitarItemVacio(elemento){\r      var elementoADevolver = new Array();\r     \r      for(var k=0;k<elemento.length;k++) {\r          if (elemento[k] != ''){                            \r             elementoADevolver[elementoADevolver.length] = elemento[k];\r          }\r      }\r         \r      return elementoADevolver;\r      \r   }\r   function generar(formato){\r      \r      if(sicc_validaciones_generales()){\r         \r           var a = new Object();\r           a.accion = 'generar';\r           a.marca = get('Formulario.cbMarca');\r           a.canal = get('Formulario.cbCanal');\r           a.periodoDesde = get('Formulario.cbPeriodoInicial');\r           a.periodoHasta = get('Formulario.cbPeriodoFinal');\r           a.periodoDesdeDesc = get('Formulario.cbPeriodoInicial', 'T');\r           a.periodoHastaDesc = get('Formulario.cbPeriodoFinal', 'T');\r           a.operacion = get('Formulario.cbOperacion');    \r           a.operacionDesc = get('Formulario.cbOperacion', 'T');    \r           a.tipoOperacion = quitarItemVacio(get('Formulario.cbTipoOperacion'));\r           a.tipoOperacionDesc = quitarItemVacio(get('Formulario.cbTipoOperacion','T'));\r           a.cantidad = get('Formulario.txtCantidadConsultoras');           \r           \r           a.formato = formato;    \r           mostrarModalSICC('RECConsultorasReclamos','generar', a);\r    \r      }\r\r   }\r\r\r function onchangeMarcaCanal(){\r         \r        marca  = get('Formulario.cbMarca');\r        canal  = get('Formulario.cbCanal');\r        pais   = get('Formulario.pais');\r        idioma = get('Formulario.idioma');\r      \r        if(marca != '' && canal != ''){\r           var arr = new Array();\r           \r           arr[arr.length] = [\"oidIdioma\", idioma]; \r           arr[arr.length] = [\"oidPais\", pais]; \r           arr[arr.length] = [\"marca\", marca];\r           arr[arr.length] = [\"canal\", canal];\r              \r           recargaCombo(\"Formulario.cbPeriodoInicial\",\"PRECargarPeriodos\",\"es.indra.sicc.dtos.cra.DTOPeriodo\",arr);\r           recargaCombo(\"Formulario.cbPeriodoFinal\",\"PRECargarPeriodos\",\"es.indra.sicc.dtos.cra.DTOPeriodo\",arr);\r                      \r                           \r      }else{\r           var aCombo = new Array(new Array(\"\",\"\"));\r           set_combo('Formulario.cbPeriodoInicial', aCombo, []);\r           set_combo('Formulario.cbPeriodoFinal', aCombo, []);\r          \r        }\r      \r    } \r\r\r   function fLimpiar(){\r     var aCombo = new Array(new Array(\"\",\"\"));\r     set_combo('Formulario.cbPeriodoInicial', aCombo, []); \r     set_combo('Formulario.cbPeriodoFinal', aCombo, []); \r     focaliza('Formulario.cbMarca');\r \r   }\r   \r\r\r   \r  \r  "));
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(11)).setAttribute("name","txtCantidadConsultoras" );
      ((Element)v.get(11)).setAttribute("required","true" );
      ((Element)v.get(11)).setAttribute("cod","2740" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(85)).setAttribute("nombre","cbPeriodoInicial" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(90)).setAttribute("nombre","cbPeriodoFinal" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(111)).setAttribute("nombre","cbOperacion" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(132)).setAttribute("nombre","cbTipoOperacion" );
      ...
      /* Empieza nodo:139 / Elemento padre: 36   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(36)).appendChild((Element)v.get(139));
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(161)).setAttribute("nombre","lbldtTipoSalida" );
      ...
      ((Element)v.get(161)).setAttribute("valor","Reporte" );
   ...
   private void getXML630(Document doc) {
      ...
      /* Empieza nodo:169 / Elemento padre: 21   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(21)).appendChild((Element)v.get(169));
      ...
      ((Element)v.get(177)).setAttribute("ontab","focaliza('Formulario.cbMarca')" );
