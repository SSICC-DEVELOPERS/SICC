...
public class LPDesgloseEstados extends LPSICCBase{
	private String accion;

	public LPDesgloseEstados(){
		super();
	}
	...
	public void ejecucion() throws Exception{
		...
		// Fin Si 
		setTrazaFichero();
        traza("> Entrando a LPDesgloseEstados.ejecucion");
	...
	private void cargarPagina() throws Exception{
		// -> Asignar página "contenido_desglose_estados_consultar" 
		pagina("contenido_desglose_estados_consultar");
		...
		// -> datosDesglose.tipoDesglose = ConstantesDesglosesPED.DESGLOSE_ESTADOS 
		...
		datosDesglose.setTipoDesglose(ConstantesDesglosesPED.DESGLOSE_ESTADOS);
...
/*		// -> datosDesglose.tipoCliente = oidTipoCliente de la línea seleccionada en la lista "detalle" 
		...
		conectorActionParametro("accion", "estados");
	}
}
