/*
    INDRA/CAR/mmg
    $Id: MaeTipoTarjeLPStartUp.java,v 1.1 2009/12/03 18:40:10 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class MaeTipoTarjeLPStartUp extends MMGDruidaBase{
	...
	public MaeTipoTarjeLPStartUp(){
		super();
	}

	public void inicio() throws Exception {
		pagina("MaeTipoTarjePage");
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "MaeTipoTarjePage", "cod", "MaeTipoTarje." + accion + ".label");
			...
			limpiarBotoneraLista("maeTipoTarje", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codTipoTarj", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 2);");
		...
		//asignarAtributo("CAPA", "maeTipoTarjeLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "MaeTipoTarjePage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("MaeTipoTarjeLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		MaeTipoTarjeData maeTipoTarjeQuery= new MaeTipoTarjeData();
		maeTipoTarjeQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		MaeTipoTarjeData datosResult = (MaeTipoTarjeData)getSingleObject(BUSINESSID_QUERY, maeTipoTarjeQuery, 
			maeTipoTarjeQuery.clone(), "maeTipoTarje");
		...
		preservaHiddensI18n(new Integer(1), "MAE_TIPO_TARJE", "maeTipoTarjeFrm", "Descripcion", true);
		...
		MaeTipoTarjeData maeTipoTarje = datosResult;
		asignar("TEXT", "codTipoTarj", FormatUtils.formatObject(maeTipoTarje.getCodTipoTarj(), 
		...
		loadLocalizationVars(maeTipoTarje);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "codTipoTarj", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "MAE_TIPO_TARJE", "maeTipoTarjeFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "codTipoTarj", "req", "S");
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('maeTipoTarjeFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "maeTipoTarjeFrm", "oculto", "N");
		...
		traza("MMG::Creando MaeTipoTarje");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		MaeTipoTarjeData maeTipoTarjeQuery= new MaeTipoTarjeData();
		maeTipoTarjeQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(maeTipoTarje.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"maeTipoTarjeFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"maeTipoTarjeFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codTipoTarj", "ontab","ejecutarAccionFocoModificacion(\"maeTipoTarjeFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codTipoTarj", "onshtab","ejecutarAccionFocoModificacion(\"maeTipoTarjeFrm\",2, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"maeTipoTarjeFrm\",3, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"maeTipoTarjeFrm\",3, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","maeTipoTarjeTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","maeTipoTarjeTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","maeTipoTarjeFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","maeTipoTarjeListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","maeTipoTarjeListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(MaeTipoTarjeData maeTipoTarje) throws Exception{
	...
	* @param maeTipoTarje La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(MaeTipoTarjeData maeTipoTarje) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		MaeTipoTarjeData maeTipoTarje = 
			(MaeTipoTarjeData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(maeTipoTarje);
		loadLeafDependenceCombos(maeTipoTarje);
	}
	...
	*/
	...
	protected void loadLocalizationVars(MaeTipoTarjeData maeTipoTarje) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("MAE_TIPO_TARJE");
		mmgLocalizationQuery.setEntiPk(maeTipoTarje.getId());
