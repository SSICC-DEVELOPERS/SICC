...
public class PedSubtiPosicPage  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","PedSubtiPosicPage" );
      ((Element)v.get(0)).setAttribute("titulo","" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","" );
      ((Element)v.get(0)).setAttribute("onload","pedSubtiPosicInitComponents()" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","pedsubtiposic.js" );
      ((Element)v.get(0)).appendChild((Element)v.get(4));
      /* Termina nodo:4   */

      /* Empieza nodo:5 / Elemento padre: 0   */
      v.add(doc.createElement("FORMULARIO"));
      ((Element)v.get(5)).setAttribute("nombre","pedSubtiPosicFrm" );
      ...
      ((Element)v.get(6)).setAttribute("valor","PedSubtiPosicLPExecution" );
      ...
      ((Element)v.get(7)).setAttribute("valor","PedSubtiPosicLPExecution" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(37)).setAttribute("nombre","pedSubtiPosicFormLayer" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(52)).setAttribute("cod","PedSubtiPosic.legend.label" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(67)).setAttribute("cod","PedSubtiPosic.id.label" );
      ...
      ((Element)v.get(70)).setAttribute("ontab","ejecutarAccionFoco('pedSubtiPosicFrm',1, true)" );
      ((Element)v.get(70)).setAttribute("onshtab","ejecutarAccionFoco('pedSubtiPosicFrm', 1, false)" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(92)).setAttribute("cod","PedSubtiPosic.codSubtPosi.label" );
      ...
      ((Element)v.get(95)).setAttribute("ontab","ejecutarAccionFoco('pedSubtiPosicFrm',2, true)" );
      ((Element)v.get(95)).setAttribute("onshtab","ejecutarAccionFoco('pedSubtiPosicFrm', 2, false)" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(102)).setAttribute("cod","PedSubtiPosic.tposOidTipoPosi.label" );
      ...
      ((Element)v.get(105)).setAttribute("ontab","ejecutarAccionFoco('pedSubtiPosicFrm',3, true);" );
      ((Element)v.get(105)).setAttribute("onshtab","ejecutarAccionFoco('pedSubtiPosicFrm',3, false);" );
      ...
      ((Element)v.get(113)).setAttribute("cod","PedSubtiPosic.Descripcion.label" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(117)).setAttribute("ontab","ejecutarAccionFoco('pedSubtiPosicFrm',4, true)" );
      ((Element)v.get(117)).setAttribute("onshtab","ejecutarAccionFoco('pedSubtiPosicFrm', 4, false)" );
      ...
      ((Element)v.get(121)).setAttribute("href","javascript:openLocalizationDialog('pedSubtiPosicFrm', 'Descripcion', 1);" );
      ((Element)v.get(121)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"pedSubtiPosicFrm\",4, true)', 'ejecutarAccionFoco(\"pedSubtiPosicFrm\",4, false)')" );
   ...
   private void getXML630(Document doc) {
      ((Element)v.get(137)).setAttribute("nombre","pedSubtiPosicTrButtons" );
      ...
      ((Element)v.get(144)).setAttribute("nombre","pedSubtiPosicTdQueryButton" );
      ((Element)v.get(143)).appendChild((Element)v.get(144));

      /* Empieza nodo:145 / Elemento padre: 144   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(145)).setAttribute("nombre","pedSubtiPosicQueryButton" );
      ((Element)v.get(145)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(145)).setAttribute("estado","false" );
      ((Element)v.get(145)).setAttribute("accion","pedSubtiPosicFirstPage();" );
      ...
      ((Element)v.get(146)).setAttribute("nombre","pedSubtiPosicTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(148)).setAttribute("nombre","pedSubtiPosicLovNullButton" );
      ((Element)v.get(148)).setAttribute("ID","botonContenido" );
      ((Element)v.get(148)).setAttribute("tipo","html" );
      ((Element)v.get(148)).setAttribute("accion","pedSubtiPosicLovNullSelectionAction();" );
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(151)).setAttribute("nombre","pedSubtiPosicListLayer" );
      ...
      ((Element)v.get(152)).setAttribute("nombre","pedSubtiPosicList" );
   ...
   private void getXML720(Document doc) {
      ...
      ((Element)v.get(166)).setAttribute("cod","PedSubtiPosic.codSubtPosi.label" );
      ...
      ((Element)v.get(167)).setAttribute("cod","PedSubtiPosic.tposOidTipoPosi.label" );
      ...
      ((Element)v.get(168)).setAttribute("cod","PedSubtiPosic.Descripcion.label" );
   ...
   private void getXML810(Document doc) {
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(174)).setAttribute("nombre","pedSubtiPosicListButtonsLayer" );
      ...
      ((Element)v.get(180)).setAttribute("nombre","pedSubtiPosicPaginationButtonBar" );
      ...
      ((Element)v.get(181)).setAttribute("nombre","pedSubtiPosicFirstPageButton" );
      ((Element)v.get(181)).setAttribute("funcion","pedSubtiPosicFirstPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(182)).setAttribute("nombre","pedSubtiPosicFirstPageButtonGapTd" );
   ...
   private void getXML900(Document doc) {
      v.add(doc.createElement("BTN"));
      ((Element)v.get(184)).setAttribute("nombre","pedSubtiPosicPreviousPageButton" );
      ((Element)v.get(184)).setAttribute("funcion","pedSubtiPosicPreviousPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(185)).setAttribute("nombre","pedSubtiPosicPreviousPageButtonGapTd" );
      ...
      v.add(doc.createElement("BTN"));
      ((Element)v.get(187)).setAttribute("nombre","pedSubtiPosicNextPageButton" );
      ((Element)v.get(187)).setAttribute("funcion","pedSubtiPosicNextPage();" );
      ...
      ((Element)v.get(190)).setAttribute("nombre","pedSubtiPosicUpdateButtonTd" );
      ((Element)v.get(176)).appendChild((Element)v.get(190));

      /* Empieza nodo:191 / Elemento padre: 190   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(191)).setAttribute("nombre","pedSubtiPosicUpdateButton" );
      ((Element)v.get(191)).setAttribute("ID","botonContenido" );
      ((Element)v.get(191)).setAttribute("tipo","html" );
      ((Element)v.get(191)).setAttribute("accion","pedSubtiPosicUpdateSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(192)).setAttribute("nombre","pedSubtiPosicUpdateButtonGapTd" );
      ...
      ((Element)v.get(194)).setAttribute("nombre","pedSubtiPosicViewForRemoveButtonTd" );
      ((Element)v.get(176)).appendChild((Element)v.get(194));

      /* Empieza nodo:195 / Elemento padre: 194   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(195)).setAttribute("nombre","pedSubtiPosicViewForRemoveButton" );
      ((Element)v.get(195)).setAttribute("ID","botonContenido" );
      ((Element)v.get(195)).setAttribute("tipo","html" );
      ((Element)v.get(195)).setAttribute("accion","pedSubtiPosicViewSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(196)).setAttribute("nombre","pedSubtiPosicViewForRemoveButtonGapTd" );
      ...
      ((Element)v.get(198)).setAttribute("nombre","pedSubtiPosicLovSelectButtonTd" );
      ((Element)v.get(176)).appendChild((Element)v.get(198));

      /* Empieza nodo:199 / Elemento padre: 198   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(199)).setAttribute("nombre","pedSubtiPosicLovSelectButton" );
      ((Element)v.get(199)).setAttribute("ID","botonContenido" );
      ((Element)v.get(199)).setAttribute("tipo","html" );
      ((Element)v.get(199)).setAttribute("accion","pedSubtiPosicLovSelectionAction();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(200)).setAttribute("nombre","pedSubtiPosicLovSelectButtonGapTd" );
   ...
   private void getXML990(Document doc) {
      ...
      ((Element)v.get(202)).setAttribute("nombre","pedSubtiPosicViewButtonTd" );
      ((Element)v.get(176)).appendChild((Element)v.get(202));

      /* Empieza nodo:203 / Elemento padre: 202   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(203)).setAttribute("nombre","pedSubtiPosicViewButton" );
      ((Element)v.get(203)).setAttribute("ID","botonContenido" );
      ((Element)v.get(203)).setAttribute("tipo","html" );
      ((Element)v.get(203)).setAttribute("accion","pedSubtiPosicViewSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(204)).setAttribute("nombre","pedSubtiPosicViewButtonGapTd" );
