...
public class MaeGenerPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","maeGenerList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","MaeGener.codGene.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","MaeGener.Descripcion.label" );
