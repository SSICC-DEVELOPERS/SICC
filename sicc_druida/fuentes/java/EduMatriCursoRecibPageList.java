...
public class EduMatriCursoRecibPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","eduMatriCursoRecibList" );
      ...
      ((Element)v.get(12)).setAttribute("cod","EduMatriCursoRecib.mcurOidCurs.label" );
      ...
      ((Element)v.get(13)).setAttribute("cod","EduMatriCursoRecib.mcurOidCursRequ.label" );
