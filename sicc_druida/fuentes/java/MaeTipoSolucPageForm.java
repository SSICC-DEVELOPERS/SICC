...
public class MaeTipoSolucPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","MaeTipoSoluc.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","MaeTipoSoluc.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('maeTipoSolucFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('maeTipoSolucFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(54)).setAttribute("cod","MaeTipoSoluc.paisOidPais.label" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('maeTipoSolucFrm',2, true);" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('maeTipoSolucFrm',2, false);" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(76)).setAttribute("nombre","codTipoSoluTdId" );
   ...
   private void getXML360(Document doc) {
      ((Element)v.get(81)).setAttribute("nombre","codTipoSoluWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(83)).setAttribute("nombre","codTipoSolu" );
      ...
      ((Element)v.get(83)).setAttribute("ontab","ejecutarAccionFoco('maeTipoSolucFrm',3, true)" );
      ((Element)v.get(83)).setAttribute("onshtab","ejecutarAccionFoco('maeTipoSolucFrm', 3, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(84)).setAttribute("nombre","codTipoSoluGapTdId" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(105)).setAttribute("cod","MaeTipoSoluc.Descripcion.label" );
      ...
      ((Element)v.get(109)).setAttribute("ontab","ejecutarAccionFoco('maeTipoSolucFrm',5, true)" );
      ((Element)v.get(109)).setAttribute("onshtab","ejecutarAccionFoco('maeTipoSolucFrm',5, false)" );
      ...
      ((Element)v.get(113)).setAttribute("href","javascript:openLocalizationDialog('maeTipoSolucFrm', 'Descripcion', 1);" );
      ((Element)v.get(113)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"maeTipoSolucFrm\",5, true)', 'ejecutarAccionFoco(\"maeTipoSolucFrm\",5, false)')" );
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(129)).setAttribute("nombre","maeTipoSolucTrButtons" );
      ...
      ((Element)v.get(136)).setAttribute("nombre","maeTipoSolucTdQueryButton" );
      ((Element)v.get(135)).appendChild((Element)v.get(136));

      /* Empieza nodo:137 / Elemento padre: 136   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(137)).setAttribute("nombre","maeTipoSolucQueryButton" );
      ((Element)v.get(137)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(137)).setAttribute("estado","false" );
      ((Element)v.get(137)).setAttribute("accion","maeTipoSolucFirstPage();" );
      ...
      ((Element)v.get(138)).setAttribute("nombre","maeTipoSolucTdLovNullSelectionButton" );
   ...
   private void getXML630(Document doc) {
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(140)).setAttribute("nombre","maeTipoSolucLovNullButton" );
      ((Element)v.get(140)).setAttribute("ID","botonContenido" );
      ((Element)v.get(140)).setAttribute("tipo","html" );
      ((Element)v.get(140)).setAttribute("accion","maeTipoSolucLovNullSelectionAction();" );
