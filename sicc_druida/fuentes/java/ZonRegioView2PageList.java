...
public class ZonRegioView2PageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","zonRegioView2List" );
      ...
      ((Element)v.get(14)).setAttribute("cod","ZonRegioView2.codRegi.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","ZonRegioView2.canaOidCana.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","ZonRegioView2.marcOidMarc.label" );
