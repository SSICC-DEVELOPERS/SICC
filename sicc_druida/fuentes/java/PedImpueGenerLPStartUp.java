/*
    INDRA/CAR/mmg
    $Id: PedImpueGenerLPStartUp.java,v 1.1 2009/12/03 18:36:49 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class PedImpueGenerLPStartUp extends MMGDruidaBase{
	...
	public static final String BUSINESSID_QUERY = "MMGPedImpueGenerQueryFromToUserPage";
				...
				public static final String BUSINESSID_TAIMOIDTASAIMPUFLET_QUERY ="MMGPedTasaImpueQueryFromToUser";
				public static final String TAIMOIDTASAIMPUFLET_COMBO_CONNECTOR = "PedTasaImpueConectorCombo";
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "PedImpueGenerPage", "cod", "PedImpueGener." + accion + ".label");
			...
			limpiarBotoneraLista("pedImpueGener", accion);
	...
	protected void cmdLov() throws Exception{
		...
		//asignarAtributo("CAPA", "pedImpueGenerLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "PedImpueGenerPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		PedImpueGenerData pedImpueGenerQuery= new PedImpueGenerData();
		pedImpueGenerQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		PedImpueGenerData datosResult = (PedImpueGenerData)getSingleObject(BUSINESSID_QUERY, pedImpueGenerQuery, 
			pedImpueGenerQuery.clone(), "pedImpueGener");
		...
		PedImpueGenerData pedImpueGener = datosResult;
		es.indra.belcorp.mso.SegSubacData sbacOidSbac = pedImpueGener.getSbacOidSbac();
		if(sbacOidSbac != null && sbacOidSbac.getId() != null) checkCombo("sbacOidSbac" , sbacOidSbac.getId().toString());
		es.indra.belcorp.mso.PedTasaImpueData taimOidTasaImpu = pedImpueGener.getTaimOidTasaImpu();
		if(taimOidTasaImpu != null && taimOidTasaImpu.getId() != null) checkCombo("taimOidTasaImpu" , taimOidTasaImpu.getId().toString());
		es.indra.belcorp.mso.PedTasaImpueData taimOidTasaImpuFlet = pedImpueGener.getTaimOidTasaImpuFlet();
		if(taimOidTasaImpuFlet != null && taimOidTasaImpuFlet.getId() != null) checkCombo("taimOidTasaImpuFlet" , taimOidTasaImpuFlet.getId().toString());
		asignarAtributo("CHECKBOX", "indTasaUnic" , "check", FormatUtils.formatObject(
			pedImpueGener.getIndTasaUnic(), 
		...
		//Deshabilitamos todos los campos para que no se editen
					...
					asignarAtributo("COMBO", "taimOidTasaImpuFlet", "disabled", "S");
					asignarAtributo("CHECKBOX", "indTasaUnic", "disabled", "S");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "pedImpueGenerFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		PedImpueGenerData pedImpueGenerQuery= new PedImpueGenerData();
		pedImpueGenerQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(pedImpueGener.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"pedImpueGenerFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"pedImpueGenerFrm\",1, false)");
					asignarAtributo("COMBO","paisOidPais", "ontab", "ejecutarAccionFocoModificacion(\"pedImpueGenerFrm\",2, true)");
					asignarAtributo("COMBO","paisOidPais", "onshtab", "ejecutarAccionFocoModificacion(\"pedImpueGenerFrm\",2, false)");
					asignarAtributo("COMBO","sbacOidSbac_acceOidAcce_canaOidCana", "ontab", "ejecutarAccionFocoModificacion(\"pedImpueGenerFrm\",5, true)");
					asignarAtributo("COMBO","sbacOidSbac_acceOidAcce_canaOidCana", "onshtab", "ejecutarAccionFocoModificacion(\"pedImpueGenerFrm\",5, false)");
					asignarAtributo("COMBO","sbacOidSbac_acceOidAcce", "ontab", "ejecutarAccionFocoModificacion(\"pedImpueGenerFrm\",5, true)");
					asignarAtributo("COMBO","sbacOidSbac_acceOidAcce", "onshtab", "ejecutarAccionFocoModificacion(\"pedImpueGenerFrm\",5, false)");
					asignarAtributo("COMBO","sbacOidSbac", "ontab", "ejecutarAccionFocoModificacion(\"pedImpueGenerFrm\",5, true)");
					asignarAtributo("COMBO","sbacOidSbac", "onshtab", "ejecutarAccionFocoModificacion(\"pedImpueGenerFrm\",5, false)");
					asignarAtributo("COMBO","taimOidTasaImpu", "ontab", "ejecutarAccionFocoModificacion(\"pedImpueGenerFrm\",6, true)");
					asignarAtributo("COMBO","taimOidTasaImpu", "onshtab", "ejecutarAccionFocoModificacion(\"pedImpueGenerFrm\",6, false)");
					asignarAtributo("COMBO","taimOidTasaImpuFlet", "ontab", "ejecutarAccionFocoModificacion(\"pedImpueGenerFrm\",7, true)");
					asignarAtributo("COMBO","taimOidTasaImpuFlet", "onshtab", "ejecutarAccionFocoModificacion(\"pedImpueGenerFrm\",7, false)");
				asignarAtributo("TEXT", "indTasaUnic", "ontab","ejecutarAccionFocoModificacion(\"pedImpueGenerFrm\",8, true)");
				asignarAtributo("TEXT", "indTasaUnic", "onshtab","ejecutarAccionFocoModificacion(\"pedImpueGenerFrm\",8, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","pedImpueGenerTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","pedImpueGenerTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es taimOidTasaImpuFlet...");		
				
				traza("MMG: el atributo es indTasaUnic...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","pedImpueGenerFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","pedImpueGenerListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","pedImpueGenerListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(PedImpueGenerData pedImpueGener) throws Exception{
		...
		if(pedImpueGener != null && pedImpueGener.getPaisOidPais() != null){
				checkCombo("paisOidPais" , pedImpueGener.getPaisOidPais().getId().toString());
		}
		...
		/*
         * CONST. - SPLATAS - DBLG300000584 - 06/06/2006
         * if(pedImpueGener != null && pedImpueGener.getSbacOidSbac().getAcceOidAcce().getCanaOidCana() != null){ 
		 */
        if(pedImpueGener != null && pedImpueGener.getSbacOidSbac() != null
                && pedImpueGener.getSbacOidSbac().getAcceOidAcce() != null
                && pedImpueGener.getSbacOidSbac().getAcceOidAcce().getCanaOidCana() != null){
            checkCombo("sbacOidSbac_acceOidAcce_canaOidCana" , pedImpueGener.getSbacOidSbac().getAcceOidAcce().getCanaOidCana().getId().toString());
		}
        ...
        if(pedImpueGener != null && pedImpueGener.getTaimOidTasaImpu() != null){
				checkCombo("taimOidTasaImpu" , pedImpueGener.getTaimOidTasaImpu().getId().toString());
		}
		
        PedTasaImpueData taimOidTasaImpuFlet = new PedTasaImpueData();
		
		asignarComboResultados(BUSINESSID_TAIMOIDTASAIMPUFLET_QUERY,TAIMOIDTASAIMPUFLET_COMBO_CONNECTOR, 
			taimOidTasaImpuFlet, taimOidTasaImpuFlet.clone(), "pedTasaImpue", "taimOidTasaImpuFlet", 
            "result_ROWSET" );
		
        if(pedImpueGener != null && pedImpueGener.getTaimOidTasaImpuFlet() != null){
				checkCombo("taimOidTasaImpuFlet" , pedImpueGener.getTaimOidTasaImpuFlet().getId().toString());
		}
	...
	* @param pedImpueGener La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(PedImpueGenerData pedImpueGener) 
		throws Exception{
		
						if(pedImpueGener.getSbacOidSbac() != null){
			
						SegSubacData sbacOidSbac = new SegSubacData();
			sbacOidSbac.setAcceOidAcce(pedImpueGener.getSbacOidSbac().getAcceOidAcce());
			...
			checkCombo("sbacOidSbac" , pedImpueGener.getSbacOidSbac().getId().toString());
			
						SegAccesData sbacOidSbac_acceOidAcce = new SegAccesData();
			sbacOidSbac_acceOidAcce.setCanaOidCana(pedImpueGener.getSbacOidSbac().getAcceOidAcce().getCanaOidCana());
			...
			checkCombo("sbacOidSbac_acceOidAcce" , pedImpueGener.getSbacOidSbac().getAcceOidAcce().getId().toString());
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		PedImpueGenerData pedImpueGener = 
			(PedImpueGenerData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(pedImpueGener.getPaisOidPais() != null){
			pedImpueGener.setPaisOidPais((es.indra.belcorp.mso.SegPaisViewData)
			getSingleObject(BUSINESSID_PAISOIDPAIS_QUERY, 
			pedImpueGener.getPaisOidPais(),
			pedImpueGener.getPaisOidPais().clone(),
			"segPaisView"));
		}
		if(pedImpueGener.getSbacOidSbac() != null){
			pedImpueGener.setSbacOidSbac((es.indra.belcorp.mso.SegSubacData)
			getSingleObject(BUSINESSID_SBACOIDSBAC_QUERY, 
			pedImpueGener.getSbacOidSbac(),
			pedImpueGener.getSbacOidSbac().clone(),
			"segSubac"));
		}
		if(pedImpueGener.getTaimOidTasaImpu() != null){
			pedImpueGener.setTaimOidTasaImpu((es.indra.belcorp.mso.PedTasaImpueData)
			getSingleObject(BUSINESSID_TAIMOIDTASAIMPU_QUERY, 
			pedImpueGener.getTaimOidTasaImpu(),
			pedImpueGener.getTaimOidTasaImpu().clone(),
			"pedTasaImpue"));
		}
		if(pedImpueGener.getTaimOidTasaImpuFlet() != null){
			pedImpueGener.setTaimOidTasaImpuFlet((es.indra.belcorp.mso.PedTasaImpueData)
			getSingleObject(BUSINESSID_TAIMOIDTASAIMPUFLET_QUERY, 
			pedImpueGener.getTaimOidTasaImpuFlet(),
			pedImpueGener.getTaimOidTasaImpuFlet().clone(),
			"pedTasaImpue"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(pedImpueGener);
		loadLeafDependenceCombos(pedImpueGener);
	}
