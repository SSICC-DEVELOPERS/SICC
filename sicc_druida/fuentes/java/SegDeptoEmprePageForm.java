...
public class SegDeptoEmprePageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","SegDeptoEmpre.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","SegDeptoEmpre.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('segDeptoEmpreFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('segDeptoEmpreFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(50)).setAttribute("nombre","codDptoTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lblCodDpto" );
      ((Element)v.get(54)).setAttribute("alto","13" );
      ((Element)v.get(54)).setAttribute("filas","1" );
      ((Element)v.get(54)).setAttribute("id","datosTitle" );
      ((Element)v.get(54)).setAttribute("cod","SegDeptoEmpre.codDpto.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(55)).setAttribute("nombre","codDptoWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(57)).setAttribute("nombre","codDpto" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('segDeptoEmpreFrm',2, true)" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('segDeptoEmpreFrm', 2, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(58)).setAttribute("nombre","codDptoGapTdId" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(60)).setAttribute("nombre","desCortDptoTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(65)).setAttribute("nombre","desCortDptoWidgetTrId" );
      ...
      ((Element)v.get(67)).setAttribute("ontab","ejecutarAccionFoco('segDeptoEmpreFrm',3, true)" );
      ((Element)v.get(67)).setAttribute("onshtab","ejecutarAccionFoco('segDeptoEmpreFrm', 3, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(68)).setAttribute("nombre","desCortDptoGapTdId" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(70)).setAttribute("nombre","DescripcionTdId" );
      ...
      ((Element)v.get(74)).setAttribute("cod","SegDeptoEmpre.Descripcion.label" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(75)).setAttribute("nombre","DescripcionTdLocalizationButtonGapHeader" );
      ((Element)v.get(75)).setAttribute("colspan","2" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(76)).setAttribute("nombre","DescripcionWidgetTrId" );
   }
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(78)).setAttribute("max","50" );
      ((Element)v.get(78)).setAttribute("onchange","" );
      ((Element)v.get(78)).setAttribute("req","N" );
      ((Element)v.get(78)).setAttribute("size","50" );
      ...
      ((Element)v.get(78)).setAttribute("ontab","ejecutarAccionFoco('segDeptoEmpreFrm',4, true)" );
      ((Element)v.get(78)).setAttribute("onshtab","ejecutarAccionFoco('segDeptoEmpreFrm', 4, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(81)).setAttribute("nombre","DescripcionTdLocalizationButton" );
      ...
      ((Element)v.get(82)).setAttribute("id","DescripcionLocalizationButton" );
      ((Element)v.get(82)).setAttribute("href","javascript:openLocalizationDialog('segDeptoEmpreFrm', 'Descripcion', 1);" );
      ((Element)v.get(82)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"segDeptoEmpreFrm\",4, true)', 'ejecutarAccionFoco(\"segDeptoEmpreFrm\",4, false)')" );
      ((Element)v.get(81)).appendChild((Element)v.get(82));

      /* Empieza nodo:83 / Elemento padre: 82   */
      v.add(doc.createElement("IMG"));
      ((Element)v.get(83)).setAttribute("nombre","DescripcionLocalizationButton" );
      ((Element)v.get(83)).setAttribute("src","iconmultidioma.gif" );
      ((Element)v.get(83)).setAttribute("border","0" );
      ((Element)v.get(83)).setAttribute("width","21" );
      ((Element)v.get(83)).setAttribute("height","15" );
      ((Element)v.get(83)).setAttribute("class","main" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(84)).setAttribute("nombre","DescripcionGapTdId" );
      ...
      /* Empieza nodo:88 / Elemento padre: 44   */
      v.add(doc.createElement("TD"));
      ((Element)v.get(88)).setAttribute("width","100%" );
      ((Element)v.get(44)).appendChild((Element)v.get(88));
      /* Termina nodo:88   */
      /* Termina nodo:44   */
   ...
   private void getXML450(Document doc) {
      ...
      /* Empieza nodo:98 / Elemento padre: 0   */
      v.add(doc.createElement("TR"));
      ((Element)v.get(98)).setAttribute("nombre","segDeptoEmpreTrButtons" );
      ((Element)v.get(0)).appendChild((Element)v.get(98));
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(105)).setAttribute("class","tablaTitle" );
      ((Element)v.get(105)).setAttribute("nombre","segDeptoEmpreTdQueryButton" );
      ((Element)v.get(104)).appendChild((Element)v.get(105));

      /* Empieza nodo:106 / Elemento padre: 105   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(106)).setAttribute("nombre","segDeptoEmpreQueryButton" );
      ((Element)v.get(106)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(106)).setAttribute("estado","false" );
      ((Element)v.get(106)).setAttribute("accion","segDeptoEmpreFirstPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(107)).setAttribute("class","tablaTitle" );
      ((Element)v.get(107)).setAttribute("nombre","segDeptoEmpreTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(109)).setAttribute("nombre","segDeptoEmpreLovNullButton" );
      ((Element)v.get(109)).setAttribute("ID","botonContenido" );
      ((Element)v.get(109)).setAttribute("tipo","html" );
      ((Element)v.get(109)).setAttribute("accion","segDeptoEmpreLovNullSelectionAction();" );
      ((Element)v.get(109)).setAttribute("estado","true" );
      ((Element)v.get(109)).setAttribute("cod","MMGGlobal.lovNullButton.label" );
