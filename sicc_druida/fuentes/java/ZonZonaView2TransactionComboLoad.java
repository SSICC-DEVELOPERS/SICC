...
/*
    INDRA/CAR/mmg
    $Id: ZonZonaView2TransactionComboLoad.java,v 1.1 2009/12/03 18:41:44 pecbazalar Exp $
    DESC
*/
...
public class ZonZonaView2TransactionComboLoad extends MMGDruidaTransaction {
	//Constantes usadas en la clase. Simplemente representan 
	//los nombre de conectore y de logicas de negocio
	public static final String BUSINESSID_QUERY = "MMGZonZonaView2QueryFromToUserStructuralSecurity";
	public static final String CONECTOR_QUERY_COMBO= "ZonZonaView2ConectorCombo";

	// Definicion del constructor
	public ZonZonaView2TransactionComboLoad(){
		super();
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			dto.addProperty("zonZonaView2From", zonZonaView2);
			dto.addProperty("zonZonaView2To", zonZonaView2.clone());
