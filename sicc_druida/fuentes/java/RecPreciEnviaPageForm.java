...
public class RecPreciEnviaPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","RecPreciEnvia.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","RecPreciEnvia.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('recPreciEnviaFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('recPreciEnviaFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(50)).setAttribute("nombre","codPrecEnviTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lblCodPrecEnvi" );
      ((Element)v.get(54)).setAttribute("alto","13" );
      ((Element)v.get(54)).setAttribute("filas","1" );
      ((Element)v.get(54)).setAttribute("id","datosTitle" );
      ((Element)v.get(54)).setAttribute("cod","RecPreciEnvia.codPrecEnvi.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(55)).setAttribute("nombre","codPrecEnviWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(57)).setAttribute("nombre","codPrecEnvi" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('recPreciEnviaFrm',2, true)" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('recPreciEnviaFrm', 2, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(58)).setAttribute("nombre","codPrecEnviGapTdId" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(72)).setAttribute("nombre","recPreciEnviaTrButtons" );
      ...
      ((Element)v.get(79)).setAttribute("nombre","recPreciEnviaTdQueryButton" );
      ((Element)v.get(78)).appendChild((Element)v.get(79));

      /* Empieza nodo:80 / Elemento padre: 79   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(80)).setAttribute("nombre","recPreciEnviaQueryButton" );
      ((Element)v.get(80)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(80)).setAttribute("estado","false" );
      ((Element)v.get(80)).setAttribute("accion","recPreciEnviaFirstPage();" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(81)).setAttribute("nombre","recPreciEnviaTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(83)).setAttribute("nombre","recPreciEnviaLovNullButton" );
      ((Element)v.get(83)).setAttribute("ID","botonContenido" );
      ((Element)v.get(83)).setAttribute("tipo","html" );
      ((Element)v.get(83)).setAttribute("accion","recPreciEnviaLovNullSelectionAction();" );
