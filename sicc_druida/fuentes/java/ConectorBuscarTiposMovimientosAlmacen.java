...
public class ConectorBuscarTiposMovimientosAlmacen  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","DTOEBuscarTiposMovimientosAlmacen" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(6)).setAttribute("NOMBRE","OID_TIPO_MOVIMIENTO_ALMACEN" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","CODIGO_TIPO_MOVIMIENTO_ALMACEN" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(8)).setAttribute("NOMBRE","DESCRIPCION_TIPO_MOVIMIENTO_ALMACEN" );
