...
public class RecModoAbonoDefecPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","RecModoAbonoDefec.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","RecModoAbonoDefec.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('recModoAbonoDefecFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('recModoAbonoDefecFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(50)).setAttribute("nombre","codModoAbonTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lblCodModoAbon" );
      ((Element)v.get(54)).setAttribute("alto","13" );
      ((Element)v.get(54)).setAttribute("filas","1" );
      ((Element)v.get(54)).setAttribute("id","datosTitle" );
      ((Element)v.get(54)).setAttribute("cod","RecModoAbonoDefec.codModoAbon.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(55)).setAttribute("nombre","codModoAbonWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(57)).setAttribute("nombre","codModoAbon" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('recModoAbonoDefecFrm',2, true)" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('recModoAbonoDefecFrm', 2, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(58)).setAttribute("nombre","codModoAbonGapTdId" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(72)).setAttribute("nombre","recModoAbonoDefecTrButtons" );
      ...
      ((Element)v.get(79)).setAttribute("nombre","recModoAbonoDefecTdQueryButton" );
      ((Element)v.get(78)).appendChild((Element)v.get(79));

      /* Empieza nodo:80 / Elemento padre: 79   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(80)).setAttribute("nombre","recModoAbonoDefecQueryButton" );
      ((Element)v.get(80)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(80)).setAttribute("estado","false" );
      ((Element)v.get(80)).setAttribute("accion","recModoAbonoDefecFirstPage();" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(81)).setAttribute("nombre","recModoAbonoDefecTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(83)).setAttribute("nombre","recModoAbonoDefecLovNullButton" );
      ((Element)v.get(83)).setAttribute("ID","botonContenido" );
      ((Element)v.get(83)).setAttribute("tipo","html" );
      ((Element)v.get(83)).setAttribute("accion","recModoAbonoDefecLovNullSelectionAction();" );
