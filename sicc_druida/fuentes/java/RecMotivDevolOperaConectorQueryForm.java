...
public class RecMotivDevolOperaConectorQueryForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad RecMotivDevolOpera" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGRecMotivDevolOperaQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGRecMotivDevolOperaQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","RecMotivDevolOperaFormFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","ropeOidOper" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(8)).setAttribute("NOMBRE","modvOidMotiDevo" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(9)).setAttribute("NOMBRE","valMarcDefe" );
