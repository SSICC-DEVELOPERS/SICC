/*
    INDRA/CAR/mmg
    $Id: CarGrupoSolicLPStartUp.java,v 1.1 2009/12/03 18:40:37 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class CarGrupoSolicLPStartUp extends MMGDruidaBase{
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "CarGrupoSolicPage", "cod", "CarGrupoSolic." + accion + ".label");
			...
			limpiarBotoneraLista("carGrupoSolic", accion);
	...
	protected void cmdLov() throws Exception{
		...
		//asignarAtributo("CAPA", "carGrupoSolicLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "CarGrupoSolicPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		CarGrupoSolicData carGrupoSolicQuery= new CarGrupoSolicData();
		carGrupoSolicQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		CarGrupoSolicData datosResult = (CarGrupoSolicData)getSingleObject(BUSINESSID_QUERY, carGrupoSolicQuery, 
			carGrupoSolicQuery.clone(), "carGrupoSolic");
		...
		CarGrupoSolicData carGrupoSolic = datosResult;
		asignar("TEXT", "codGrupSoli", FormatUtils.formatObject(carGrupoSolic.getCodGrupSoli(), 
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "carGrupoSolicFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		CarGrupoSolicData carGrupoSolicQuery= new CarGrupoSolicData();
		carGrupoSolicQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(carGrupoSolic.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"carGrupoSolicFrm\",0, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"carGrupoSolicFrm\",0, false)");
				asignarAtributo("AREATEXTO", "codGrupSoli", "ontab","ejecutarAccionFocoModificacion(\"carGrupoSolicFrm\",0, true)");
				asignarAtributo("AREATEXTO", "codGrupSoli", "onshtab","ejecutarAccionFocoModificacion(\"carGrupoSolicFrm\",0, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","carGrupoSolicTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","carGrupoSolicTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","carGrupoSolicFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","carGrupoSolicListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","carGrupoSolicListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(CarGrupoSolicData carGrupoSolic) throws Exception{
	...
	* @param carGrupoSolic La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(CarGrupoSolicData carGrupoSolic) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		CarGrupoSolicData carGrupoSolic = 
			(CarGrupoSolicData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(carGrupoSolic);
		loadLeafDependenceCombos(carGrupoSolic);
	}
