...
public class contenido_estimados_producto_generar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_estimados_producto_generar" );
      ((Element)v.get(0)).setAttribute("cod","ApeEstimadosProd.generar.label" );
      ((Element)v.get(0)).setAttribute("titulo","Generar estimados de producto" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","Generar estimados de producto" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","contenido_estimados_producto_generar.js" );
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(10)).setAttribute("name","cbCentroDistribucion" );
      ((Element)v.get(10)).setAttribute("required","true" );
      ((Element)v.get(10)).setAttribute("cod","2054" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(24)).setAttribute("nombre","oidCentro" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(25)).setAttribute("nombre","oidLineaVenta" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(26)).setAttribute("nombre","oidLineaMav" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(27)).setAttribute("nombre","oidEstimado" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(28)).setAttribute("nombre","mantenerEstimadosManuales" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(61)).setAttribute("cod","447" );
   ...
   private void getXML270(Document doc) {
      ((Element)v.get(68)).setAttribute("onchange","onChangeCbMarca();" );
      ((Element)v.get(68)).setAttribute("onshtab","onShTabComboMarca();" );
      ((Element)v.get(68)).setAttribute("ontab","onTabComboMarca();" );
      ...
      ((Element)v.get(73)).setAttribute("onchange","onChangeCbCanal();" );
      ((Element)v.get(73)).setAttribute("onshtab","onShTabComboCanal();" );
      ((Element)v.get(73)).setAttribute("ontab","onTabComboCanal();" );
      ...
      ((Element)v.get(78)).setAttribute("onshtab","onShTabComboPeriodo();" );
      ((Element)v.get(78)).setAttribute("ontab","onTabComboPeriodo();" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(90)).setAttribute("nombre","lblCentroDistribucion" );
      ...
      ((Element)v.get(90)).setAttribute("cod","2054" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(94)).setAttribute("nombre","lblLineaestimadosVenta" );
      ...
      ((Element)v.get(94)).setAttribute("cod","2969" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(98)).setAttribute("nombre","lblLineaEstimadosmav" );
      ...
      ((Element)v.get(98)).setAttribute("cod","2970" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(105)).setAttribute("nombre","cbCentroDistribucion" );
      ...
      ((Element)v.get(105)).setAttribute("onchange","onChangeCbCentroDistribucion();" );
      ((Element)v.get(105)).setAttribute("onshtab","onShTabComboCentro();" );
      ((Element)v.get(105)).setAttribute("ontab","onTabComboCentro();" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(110)).setAttribute("nombre","cbLineasEstimadosVenta" );
   }
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(110)).setAttribute("onshtab","onShTabComboLinea();" );
      ((Element)v.get(110)).setAttribute("ontab","onTabComboLinea();" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(115)).setAttribute("nombre","cbLineasEstimadosMav" );
      ...
      ((Element)v.get(115)).setAttribute("onshtab","onShTabComboLineaMav();" );
      ((Element)v.get(115)).setAttribute("ontab","onTabComboLineaMav();" );
      ...
      /* Empieza nodo:122 / Elemento padre: 41   */
      v.add(doc.createElement("fieldset"));
      ((Element)v.get(41)).appendChild((Element)v.get(122));
      ...
      ((Element)v.get(126)).setAttribute("nombre","btnGenerar" );
      ((Element)v.get(126)).setAttribute("ID","botonContenido" );
      ((Element)v.get(126)).setAttribute("tipo","html" );
      ((Element)v.get(126)).setAttribute("accion","onClickGenerar();" );
      ((Element)v.get(126)).setAttribute("estado","false" );
      ((Element)v.get(126)).setAttribute("cod","190" );
      ((Element)v.get(126)).setAttribute("ontab","onTabBotonGenerar();" );
      ((Element)v.get(126)).setAttribute("onshtab","onShTabBotonGenerar();" );
