...
public class CobOrdenEtapaDeudaPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","CobOrdenEtapaDeuda.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","CobOrdenEtapaDeuda.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('cobOrdenEtapaDeudaFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('cobOrdenEtapaDeudaFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(50)).setAttribute("nombre","codOrdeEtapDeudTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lblCodOrdeEtapDeud" );
      ((Element)v.get(54)).setAttribute("alto","13" );
      ((Element)v.get(54)).setAttribute("filas","1" );
      ((Element)v.get(54)).setAttribute("id","datosTitle" );
      ((Element)v.get(54)).setAttribute("cod","CobOrdenEtapaDeuda.codOrdeEtapDeud.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(55)).setAttribute("nombre","codOrdeEtapDeudWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(57)).setAttribute("nombre","codOrdeEtapDeud" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('cobOrdenEtapaDeudaFrm',2, true)" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('cobOrdenEtapaDeudaFrm', 2, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(58)).setAttribute("nombre","codOrdeEtapDeudGapTdId" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(79)).setAttribute("cod","CobOrdenEtapaDeuda.Descripcion.label" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(83)).setAttribute("ontab","ejecutarAccionFoco('cobOrdenEtapaDeudaFrm',3, true)" );
      ((Element)v.get(83)).setAttribute("onshtab","ejecutarAccionFoco('cobOrdenEtapaDeudaFrm', 3, false)" );
      ...
      ((Element)v.get(87)).setAttribute("href","javascript:openLocalizationDialog('cobOrdenEtapaDeudaFrm', 'Descripcion', 1);" );
      ((Element)v.get(87)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"cobOrdenEtapaDeudaFrm\",3, true)', 'ejecutarAccionFoco(\"cobOrdenEtapaDeudaFrm\",3, false)')" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(103)).setAttribute("nombre","cobOrdenEtapaDeudaTrButtons" );
      ...
      ((Element)v.get(110)).setAttribute("nombre","cobOrdenEtapaDeudaTdQueryButton" );
      ((Element)v.get(109)).appendChild((Element)v.get(110));

      /* Empieza nodo:111 / Elemento padre: 110   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(111)).setAttribute("nombre","cobOrdenEtapaDeudaQueryButton" );
      ((Element)v.get(111)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(111)).setAttribute("estado","false" );
      ((Element)v.get(111)).setAttribute("accion","cobOrdenEtapaDeudaFirstPage();" );
      ...
      ((Element)v.get(112)).setAttribute("nombre","cobOrdenEtapaDeudaTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(114)).setAttribute("nombre","cobOrdenEtapaDeudaLovNullButton" );
      ((Element)v.get(114)).setAttribute("ID","botonContenido" );
      ((Element)v.get(114)).setAttribute("tipo","html" );
      ((Element)v.get(114)).setAttribute("accion","cobOrdenEtapaDeudaLovNullSelectionAction();" );
