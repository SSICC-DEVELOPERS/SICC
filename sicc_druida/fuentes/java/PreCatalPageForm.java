...
public class PreCatalPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","PreCatal.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","PreCatal.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('preCatalFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('preCatalFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(50)).setAttribute("nombre","codCataTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lblCodCata" );
      ((Element)v.get(54)).setAttribute("alto","13" );
      ((Element)v.get(54)).setAttribute("filas","1" );
      ((Element)v.get(54)).setAttribute("id","datosTitle" );
      ((Element)v.get(54)).setAttribute("cod","PreCatal.codCata.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(55)).setAttribute("nombre","codCataWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(57)).setAttribute("nombre","codCata" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('preCatalFrm',2, true)" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('preCatalFrm', 2, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(58)).setAttribute("nombre","codCataGapTdId" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(60)).setAttribute("nombre","desCataTdId" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(65)).setAttribute("nombre","desCataTdLocalizationButtonGapHeader" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(66)).setAttribute("nombre","desCataWidgetTrId" );
      ...
      ((Element)v.get(68)).setAttribute("ontab","ejecutarAccionFoco('preCatalFrm',3, true)" );
      ((Element)v.get(68)).setAttribute("onshtab","ejecutarAccionFoco('preCatalFrm', 3, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(71)).setAttribute("nombre","desCataTdLocalizationButton" );
      ...
      ((Element)v.get(72)).setAttribute("id","desCataLocalizationButton" );
      ((Element)v.get(72)).setAttribute("href","javascript:openLocalizationDialog('preCatalFrm', 'desCata', 1);" );
      ((Element)v.get(72)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"preCatalFrm\",3, true)', 'ejecutarAccionFoco(\"preCatalFrm\",3, false)')" );
      ((Element)v.get(71)).appendChild((Element)v.get(72));

      /* Empieza nodo:73 / Elemento padre: 72   */
      v.add(doc.createElement("IMG"));
      ((Element)v.get(73)).setAttribute("nombre","desCataLocalizationButton" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(74)).setAttribute("nombre","desCataGapTdId" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(80)).setAttribute("cod","PreCatal.paisOidPais.label" );
      ...
      ((Element)v.get(83)).setAttribute("ontab","ejecutarAccionFoco('preCatalFrm',4, true);" );
      ((Element)v.get(83)).setAttribute("onshtab","ejecutarAccionFoco('preCatalFrm',4, false);" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(99)).setAttribute("nombre","preCatalTrButtons" );
      ...
      ((Element)v.get(106)).setAttribute("nombre","preCatalTdQueryButton" );
      ((Element)v.get(105)).appendChild((Element)v.get(106));

      /* Empieza nodo:107 / Elemento padre: 106   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(107)).setAttribute("nombre","preCatalQueryButton" );
      ((Element)v.get(107)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(107)).setAttribute("estado","false" );
      ((Element)v.get(107)).setAttribute("accion","preCatalFirstPage();" );
      ...
      ((Element)v.get(108)).setAttribute("nombre","preCatalTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(110)).setAttribute("nombre","preCatalLovNullButton" );
      ((Element)v.get(110)).setAttribute("ID","botonContenido" );
      ((Element)v.get(110)).setAttribute("tipo","html" );
      ((Element)v.get(110)).setAttribute("accion","preCatalLovNullSelectionAction();" );
