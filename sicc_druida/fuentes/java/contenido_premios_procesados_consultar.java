...
public class contenido_premios_procesados_consultar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_premios_procesados_consultar" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(78)).setAttribute("alto","557" );
   ...
   private void getXML360(Document doc) {
      ...
      /* Empieza nodo:103 / Elemento padre: 78   */
      ...
      ((Element)v.get(78)).appendChild((Element)v.get(103));
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(106)).setAttribute("cod","2876" );
      ...
      ((Element)v.get(107)).setAttribute("cod","422" );
      ...
      ((Element)v.get(108)).setAttribute("cod","1920" );
      ...
      ((Element)v.get(109)).setAttribute("cod","1604" );
      ...
      ((Element)v.get(111)).setAttribute("cod","357" );
      ...
      ((Element)v.get(112)).setAttribute("cod","1691" );
      ...
      ((Element)v.get(113)).setAttribute("cod","1696" );
      ...
      ((Element)v.get(114)).setAttribute("cod","2878" );
      ...
      ((Element)v.get(115)).setAttribute("cod","695" );
      ...
      ((Element)v.get(116)).setAttribute("cod","2888" );
      ...
      ((Element)v.get(117)).setAttribute("cod","2889" );
      ...
      ((Element)v.get(118)).setAttribute("maxSel","0" );
   ...
   private void getXML540(Document doc) {
      ...
      /* Empieza nodo:133 / Elemento padre: 78   */
      v.add(doc.createElement("ROWSET"));
      ((Element)v.get(78)).appendChild((Element)v.get(133));
      /* Termina nodo:133   */

      /* Empieza nodo:134 / Elemento padre: 78   */
      v.add(doc.createElement("PAGINADO"));
      ((Element)v.get(134)).setAttribute("nombre","mipgndo" );
      ((Element)v.get(134)).setAttribute("ancho","578" );
      ((Element)v.get(134)).setAttribute("sep","$" );
      ((Element)v.get(134)).setAttribute("x","12" );
      ((Element)v.get(134)).setAttribute("class","botonera" );
      ((Element)v.get(134)).setAttribute("y","625" );
      ...
      ((Element)v.get(136)).setAttribute("y","629" );
      ...
      ((Element)v.get(137)).setAttribute("y","629" );
   ...
   private void getXML630(Document doc) {
      ((Element)v.get(138)).setAttribute("y","625" );
      ...
      ((Element)v.get(139)).setAttribute("y","648" );
