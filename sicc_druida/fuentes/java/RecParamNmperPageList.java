...
public class RecParamNmperPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","recParamNmperList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","RecParamNmper.ticlOidTipoClie.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","RecParamNmper.pperOidPrecPerd.label" );
      ...
      ((Element)v.get(17)).setAttribute("cod","RecParamNmper.valPorcReca.label" );
      ...
      ((Element)v.get(18)).setAttribute("cod","RecParamNmper.indParaModi.label" );
