...
public class CarIndicNivelJerarConectorQueryList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad CarIndicNivelJerar" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGCarIndicNivelJerarQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGCarIndicNivelJerarQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","CarIndicNivelJerarListFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","codIndiNiveJera" );
