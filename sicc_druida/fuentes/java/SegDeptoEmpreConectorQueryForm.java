...
public class SegDeptoEmpreConectorQueryForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad SegDeptoEmpre" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGSegDeptoEmpreQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGSegDeptoEmpreQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","SegDeptoEmpreFormFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","codDpto" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(8)).setAttribute("NOMBRE","desCortDpto" );
