...
public class PedAtribEspecPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","pedAtribEspecList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","PedAtribEspec.codAtri.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","PedAtribEspec.desAtri.label" );
      ...
      ((Element)v.get(17)).setAttribute("cod","PedAtribEspec.valForm.label" );
      ...
      ((Element)v.get(18)).setAttribute("cod","PedAtribEspec.moduOidModu.label" );
