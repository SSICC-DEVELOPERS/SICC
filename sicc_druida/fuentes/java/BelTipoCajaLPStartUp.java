/*
    INDRA/CAR/mmg
    $Id: BelTipoCajaLPStartUp.java,v 1.1 2009/12/03 18:41:31 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class BelTipoCajaLPStartUp extends MMGDruidaBase{
	...
	public BelTipoCajaLPStartUp(){
		super();
	}

	public void inicio() throws Exception {
		pagina("BelTipoCajaPage");
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "BelTipoCajaPage", "cod", "BelTipoCaja." + accion + ".label");
			...
			limpiarBotoneraLista("belTipoCaja", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codTipoCaja", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 1);");
		
		//Primero determianmos el nombre del campo en la entidad de oriegen donde se van a cargar los datos
		asignar("VAR", "idAttributeLovOpener", conectorParametro(PARAMETRO_LOV_ATTRIBUTO));
		asignar("VAR", "idEntityLovOpener", conectorParametro(PARAMETRO_LOV_ENTIDAD));
		//asignarAtributo("CAPA", "belTipoCajaLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "BelTipoCajaPage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("BelTipoCajaLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		BelTipoCajaData belTipoCajaQuery= new BelTipoCajaData();
		belTipoCajaQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		BelTipoCajaData datosResult = (BelTipoCajaData)getSingleObject(BUSINESSID_QUERY, belTipoCajaQuery, 
			belTipoCajaQuery.clone(), "belTipoCaja");
		...
		BelTipoCajaData belTipoCaja = datosResult;
		asignar("TEXT", "codTipoCaja", FormatUtils.formatObject(belTipoCaja.getCodTipoCaja(), 
		...
		asignarAtributo("TEXT", "codTipoCaja", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		...
		asignarAtributo("TEXT", "codTipoCaja", "req", "S");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "belTipoCajaFrm", "oculto", "N");
		...
		traza("MMG::Creando BelTipoCaja");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		BelTipoCajaData belTipoCajaQuery= new BelTipoCajaData();
		belTipoCajaQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(belTipoCaja.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"belTipoCajaFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"belTipoCajaFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codTipoCaja", "ontab","ejecutarAccionFocoModificacion(\"belTipoCajaFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codTipoCaja", "onshtab","ejecutarAccionFocoModificacion(\"belTipoCajaFrm\",2, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","belTipoCajaTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","belTipoCajaTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codTipoCaja...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","belTipoCajaFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","belTipoCajaListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","belTipoCajaListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(BelTipoCajaData belTipoCaja) throws Exception{
	...
	* @param belTipoCaja La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(BelTipoCajaData belTipoCaja) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		BelTipoCajaData belTipoCaja = 
			(BelTipoCajaData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(belTipoCaja);
		loadLeafDependenceCombos(belTipoCaja);
	}
