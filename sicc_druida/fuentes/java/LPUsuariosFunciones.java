...
public class LPUsuariosFunciones extends LPSICCBase {           
   public LPUsuariosFunciones() {	 
     super();
  }
  ...
  public void ejecucion() throws Exception {		
     ...
     try {
        ...
        cargarPagina();
				getConfiguracionMenu("LPUsuariosFunciones");
  ...
  private void cargarPagina() throws Exception{
      ...
      asignarAtributoPagina("cod", "0734");
      ...
      asignarAtributo("VAR", "casoDeUso", "valor","LPUsuariosFunciones");
  ...
  private void generarReporte() throws Exception{
     ...
     datos.put(ConstantesREP.TITULO, "Usuarios y funciones");
     traza("++++++Antes de enviar a reportes " + datos); 
     //ejecutarReporte(datos, "REPGenerarReporte", "RD_REP-029", null);
     ejecutarReporte2(datos, "REPGenerarReporteBatch", "RD_REP-029", "pdf");     
  } 
