/*
    INDRA/CAR/mmg
    $Id: PedAsignAlmacLPStartUp.java,v 1.1 2009/12/03 18:42:24 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class PedAsignAlmacLPStartUp extends MMGDruidaBase{
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "PedAsignAlmacPage", "cod", "PedAsignAlmac." + accion + ".label");
			...
			limpiarBotoneraLista("pedAsignAlmac", accion);
	...
	protected void cmdLov() throws Exception{
		...
		//asignarAtributo("CAPA", "pedAsignAlmacLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "PedAsignAlmacPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		PedAsignAlmacData pedAsignAlmacQuery= new PedAsignAlmacData();
		pedAsignAlmacQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		PedAsignAlmacData datosResult = (PedAsignAlmacData)getSingleObject(BUSINESSID_QUERY, pedAsignAlmacQuery, 
			pedAsignAlmacQuery.clone(), "pedAsignAlmac");
		...
		PedAsignAlmacData pedAsignAlmac = datosResult;
		es.indra.belcorp.mso.SegMarcaData marcOidMarc = pedAsignAlmac.getMarcOidMarc();
		if(marcOidMarc != null && marcOidMarc.getId() != null) checkCombo("marcOidMarc" , marcOidMarc.getId().toString());
		es.indra.belcorp.mso.SegSubacData sbacOidSbac = pedAsignAlmac.getSbacOidSbac();
		if(sbacOidSbac != null && sbacOidSbac.getId() != null) checkCombo("sbacOidSbac" , sbacOidSbac.getId().toString());
		es.indra.belcorp.mso.BelAlmacData almcOidAlma = pedAsignAlmac.getAlmcOidAlma();
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "pedAsignAlmacFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		PedAsignAlmacData pedAsignAlmacQuery= new PedAsignAlmacData();
		pedAsignAlmacQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(pedAsignAlmac.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"pedAsignAlmacFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"pedAsignAlmacFrm\",1, false)");
					asignarAtributo("COMBO","paisOidPais", "ontab", "ejecutarAccionFocoModificacion(\"pedAsignAlmacFrm\",2, true)");
					asignarAtributo("COMBO","paisOidPais", "onshtab", "ejecutarAccionFocoModificacion(\"pedAsignAlmacFrm\",2, false)");
					asignarAtributo("COMBO","marcOidMarc", "ontab", "ejecutarAccionFocoModificacion(\"pedAsignAlmacFrm\",3, true)");
					asignarAtributo("COMBO","marcOidMarc", "onshtab", "ejecutarAccionFocoModificacion(\"pedAsignAlmacFrm\",3, false)");
					asignarAtributo("COMBO","sbacOidSbac_acceOidAcce_canaOidCana", "ontab", "ejecutarAccionFocoModificacion(\"pedAsignAlmacFrm\",6, true)");
					asignarAtributo("COMBO","sbacOidSbac_acceOidAcce_canaOidCana", "onshtab", "ejecutarAccionFocoModificacion(\"pedAsignAlmacFrm\",6, false)");
					asignarAtributo("COMBO","sbacOidSbac_acceOidAcce", "ontab", "ejecutarAccionFocoModificacion(\"pedAsignAlmacFrm\",6, true)");
					asignarAtributo("COMBO","sbacOidSbac_acceOidAcce", "onshtab", "ejecutarAccionFocoModificacion(\"pedAsignAlmacFrm\",6, false)");
					asignarAtributo("COMBO","sbacOidSbac", "ontab", "ejecutarAccionFocoModificacion(\"pedAsignAlmacFrm\",6, true)");
					asignarAtributo("COMBO","sbacOidSbac", "onshtab", "ejecutarAccionFocoModificacion(\"pedAsignAlmacFrm\",6, false)");
					asignarAtributo("COMBO","almcOidAlma", "ontab", "ejecutarAccionFocoModificacion(\"pedAsignAlmacFrm\",7, true)");
					asignarAtributo("COMBO","almcOidAlma", "onshtab", "ejecutarAccionFocoModificacion(\"pedAsignAlmacFrm\",7, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","pedAsignAlmacTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","pedAsignAlmacTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","pedAsignAlmacFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","pedAsignAlmacListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","pedAsignAlmacListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(PedAsignAlmacData pedAsignAlmac) throws Exception{
		...
		if(pedAsignAlmac != null && pedAsignAlmac.getPaisOidPais() != null){
				checkCombo("paisOidPais" , pedAsignAlmac.getPaisOidPais().getId().toString());
		}
        ...
        if(pedAsignAlmac != null && pedAsignAlmac.getMarcOidMarc() != null){
				checkCombo("marcOidMarc" , pedAsignAlmac.getMarcOidMarc().getId().toString());
		}
        ...
        /* 
         * CONST. - SPLATAS - DBLG300000581 - 06/01/2006
         * if(pedAsignAlmac != null && pedAsignAlmac.getSbacOidSbac().getAcceOidAcce().getCanaOidCana() != null){ 
         */
		if(pedAsignAlmac != null && pedAsignAlmac.getSbacOidSbac() != null
                && pedAsignAlmac.getSbacOidSbac().getAcceOidAcce() != null
                && pedAsignAlmac.getSbacOidSbac().getAcceOidAcce().getCanaOidCana() != null){
			checkCombo("sbacOidSbac_acceOidAcce_canaOidCana" ,
			        pedAsignAlmac.getSbacOidSbac().getAcceOidAcce().getCanaOidCana().getId().toString());
		}
        ...
        if(pedAsignAlmac != null && pedAsignAlmac.getAlmcOidAlma() != null){
				checkCombo("almcOidAlma" , pedAsignAlmac.getAlmcOidAlma().getId().toString());
		}
	...
	* @param pedAsignAlmac La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(PedAsignAlmacData pedAsignAlmac) 
		throws Exception{
		
						if(pedAsignAlmac.getSbacOidSbac() != null){
			
						SegSubacData sbacOidSbac = new SegSubacData();
			sbacOidSbac.setAcceOidAcce(pedAsignAlmac.getSbacOidSbac().getAcceOidAcce());
			...
			checkCombo("sbacOidSbac" , pedAsignAlmac.getSbacOidSbac().getId().toString());
			
						SegAccesData sbacOidSbac_acceOidAcce = new SegAccesData();
			sbacOidSbac_acceOidAcce.setCanaOidCana(pedAsignAlmac.getSbacOidSbac().getAcceOidAcce().getCanaOidCana());
			...
			checkCombo("sbacOidSbac_acceOidAcce" , pedAsignAlmac.getSbacOidSbac().getAcceOidAcce().getId().toString());
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		PedAsignAlmacData pedAsignAlmac = 
			(PedAsignAlmacData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(pedAsignAlmac.getPaisOidPais() != null){
			pedAsignAlmac.setPaisOidPais((es.indra.belcorp.mso.SegPaisViewData)
			getSingleObject(BUSINESSID_PAISOIDPAIS_QUERY, 
			pedAsignAlmac.getPaisOidPais(),
			pedAsignAlmac.getPaisOidPais().clone(),
			"segPaisView"));
		}
		if(pedAsignAlmac.getMarcOidMarc() != null){
			pedAsignAlmac.setMarcOidMarc((es.indra.belcorp.mso.SegMarcaData)
			getSingleObject(BUSINESSID_MARCOIDMARC_QUERY, 
			pedAsignAlmac.getMarcOidMarc(),
			pedAsignAlmac.getMarcOidMarc().clone(),
			"segMarca"));
		}
		if(pedAsignAlmac.getSbacOidSbac() != null){
			pedAsignAlmac.setSbacOidSbac((es.indra.belcorp.mso.SegSubacData)
			getSingleObject(BUSINESSID_SBACOIDSBAC_QUERY, 
			pedAsignAlmac.getSbacOidSbac(),
			pedAsignAlmac.getSbacOidSbac().clone(),
			"segSubac"));
		}
		if(pedAsignAlmac.getAlmcOidAlma() != null){
			pedAsignAlmac.setAlmcOidAlma((es.indra.belcorp.mso.BelAlmacData)
			getSingleObject(BUSINESSID_ALMCOIDALMA_QUERY, 
			pedAsignAlmac.getAlmcOidAlma(),
			pedAsignAlmac.getAlmcOidAlma().clone(),
			"belAlmac"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(pedAsignAlmac);
		loadLeafDependenceCombos(pedAsignAlmac);
	}
