...
public class MaeNivelEstudConectorQueryForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad MaeNivelEstud" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGMaeNivelEstudQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGMaeNivelEstudQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","MaeNivelEstudFormFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(8)).setAttribute("NOMBRE","codNiveEstu" );
