...
public class ConectorCargarPaginaDefinirNiveles  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Cargar Pagina Definir Niveles" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","CargarPaginaDefinirNiveles" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","DESC_PAIS_I18N" );
      ...
      v.add(doc.createElement("ROWSET"));
      ((Element)v.get(8)).setAttribute("NOMBRE","dtoSalida.nivelesSocioeconomicosBelcorp" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(9)).setAttribute("NOMBRE","OID_NIVE_SOEC_BELC" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(10)).setAttribute("NOMBRE","DES_NIVE_SOCI_ECON_BELC" );
      ...
      v.add(doc.createElement("ROWSET"));
      ((Element)v.get(11)).setAttribute("NOMBRE","dtoSalida.tiposNivelesSocioeconomicosPersonal" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(12)).setAttribute("NOMBRE","OID_NSEP" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(13)).setAttribute("NOMBRE","DESC_NSEP_I18N" );
