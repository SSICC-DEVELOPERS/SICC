/*
    INDRA/CAR/mmg
    $Id: CarEstatPedidLPStartUp.java,v 1.1 2009/12/03 18:40:45 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class CarEstatPedidLPStartUp extends MMGDruidaBase{
	...
	public static final String BUSINESSID_QUERY = "MMGCarEstatPedidQueryFromToUserPage";
	...
	public CarEstatPedidLPStartUp(){
		super();
	}

	public void inicio() throws Exception {
		pagina("CarEstatPedidPage");
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "CarEstatPedidPage", "cod", "CarEstatPedid." + accion + ".label");
			...
			limpiarBotoneraLista("carEstatPedid", accion);
	...
	protected void cmdLov() throws Exception{
		...
		//asignarAtributo("CAPA", "carEstatPedidLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "CarEstatPedidPage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("CarEstatPedidLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		CarEstatPedidData carEstatPedidQuery= new CarEstatPedidData();
		carEstatPedidQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		CarEstatPedidData datosResult = (CarEstatPedidData)getSingleObject(BUSINESSID_QUERY, carEstatPedidQuery, 
			carEstatPedidQuery.clone(), "carEstatPedid");
		...
		preservaHiddensI18n(new Integer(1), "CAR_ESTAT_PEDID", "carEstatPedidFrm", "Descripcion", true);
		...
		CarEstatPedidData carEstatPedid = datosResult;
		asignar("TEXT", "codEsta", FormatUtils.formatObject(carEstatPedid.getCodEsta(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "Descripcion", FormatUtils.formatObject(carEstatPedid.getDescripcion(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		loadLocalizationVars(carEstatPedid);
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "CAR_ESTAT_PEDID", "carEstatPedidFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('carEstatPedidFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "carEstatPedidFrm", "oculto", "N");
		...
		traza("MMG::Creando CarEstatPedid");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		CarEstatPedidData carEstatPedidQuery= new CarEstatPedidData();
		carEstatPedidQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(carEstatPedid.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"carEstatPedidFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"carEstatPedidFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codEsta", "ontab","ejecutarAccionFocoModificacion(\"carEstatPedidFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codEsta", "onshtab","ejecutarAccionFocoModificacion(\"carEstatPedidFrm\",2, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"carEstatPedidFrm\",3, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"carEstatPedidFrm\",3, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","carEstatPedidTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","carEstatPedidTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","carEstatPedidFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","carEstatPedidListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","carEstatPedidListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(CarEstatPedidData carEstatPedid) throws Exception{
	...
	* @param carEstatPedid La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(CarEstatPedidData carEstatPedid) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		CarEstatPedidData carEstatPedid = 
			(CarEstatPedidData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(carEstatPedid);
		loadLeafDependenceCombos(carEstatPedid);
	}
	...
	*/
	...
	protected void loadLocalizationVars(CarEstatPedidData carEstatPedid) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("CAR_ESTAT_PEDID");
		mmgLocalizationQuery.setEntiPk(carEstatPedid.getId());
