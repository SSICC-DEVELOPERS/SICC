...
public class MaeNegocViewPage  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","MaeNegocViewPage" );
      ((Element)v.get(0)).setAttribute("titulo","" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","" );
      ((Element)v.get(0)).setAttribute("onload","maeNegocViewInitComponents()" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","maenegocview.js" );
      ((Element)v.get(0)).appendChild((Element)v.get(4));
      /* Termina nodo:4   */

      /* Empieza nodo:5 / Elemento padre: 0   */
      v.add(doc.createElement("FORMULARIO"));
      ((Element)v.get(5)).setAttribute("nombre","maeNegocViewFrm" );
      ...
      ((Element)v.get(6)).setAttribute("valor","MaeNegocViewLPExecution" );
      ...
      ((Element)v.get(7)).setAttribute("valor","MaeNegocViewLPExecution" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(37)).setAttribute("nombre","maeNegocViewFormLayer" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(52)).setAttribute("cod","MaeNegocView.legend.label" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(67)).setAttribute("cod","MaeNegocView.id.label" );
      ...
      ((Element)v.get(70)).setAttribute("ontab","ejecutarAccionFoco('maeNegocViewFrm',1, true)" );
      ((Element)v.get(70)).setAttribute("onshtab","ejecutarAccionFoco('maeNegocViewFrm', 1, false)" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(92)).setAttribute("cod","MaeNegocView.paisOidPais.label" );
      ...
      ((Element)v.get(95)).setAttribute("ontab","ejecutarAccionFoco('maeNegocViewFrm',2, true);" );
      ((Element)v.get(95)).setAttribute("onshtab","ejecutarAccionFoco('maeNegocViewFrm',2, false);" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(114)).setAttribute("nombre","codNegoTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(119)).setAttribute("nombre","codNegoWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(121)).setAttribute("nombre","codNego" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(121)).setAttribute("ontab","ejecutarAccionFoco('maeNegocViewFrm',3, true)" );
      ((Element)v.get(121)).setAttribute("onshtab","ejecutarAccionFoco('maeNegocViewFrm', 3, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(122)).setAttribute("nombre","codNegoGapTdId" );
      ...
      ((Element)v.get(128)).setAttribute("cod","MaeNegocView.Descripcion.label" );
      ...
      ((Element)v.get(132)).setAttribute("ontab","ejecutarAccionFoco('maeNegocViewFrm',4, true)" );
      ((Element)v.get(132)).setAttribute("onshtab","ejecutarAccionFoco('maeNegocViewFrm', 4, false)" );
      ...
      ((Element)v.get(136)).setAttribute("href","javascript:openLocalizationDialog('maeNegocViewFrm', 'Descripcion', 1);" );
      ((Element)v.get(136)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"maeNegocViewFrm\",4, true)', 'ejecutarAccionFoco(\"maeNegocViewFrm\",4, false)')" );
   ...
   private void getXML630(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(152)).setAttribute("nombre","maeNegocViewTrButtons" );
      ...
      ((Element)v.get(159)).setAttribute("nombre","maeNegocViewTdQueryButton" );
      ((Element)v.get(158)).appendChild((Element)v.get(159));

      /* Empieza nodo:160 / Elemento padre: 159   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(160)).setAttribute("nombre","maeNegocViewQueryButton" );
      ((Element)v.get(160)).setAttribute("cod","MMGGlobal.queryButton.label" );
   }

   private void getXML720(Document doc) {
      ((Element)v.get(160)).setAttribute("estado","false" );
      ((Element)v.get(160)).setAttribute("accion","maeNegocViewFirstPage();" );
      ...
      ((Element)v.get(161)).setAttribute("nombre","maeNegocViewTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(163)).setAttribute("nombre","maeNegocViewLovNullButton" );
      ((Element)v.get(163)).setAttribute("ID","botonContenido" );
      ((Element)v.get(163)).setAttribute("tipo","html" );
      ((Element)v.get(163)).setAttribute("accion","maeNegocViewLovNullSelectionAction();" );
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(166)).setAttribute("nombre","maeNegocViewListLayer" );
      ...
      ((Element)v.get(167)).setAttribute("nombre","maeNegocViewList" );
   ...
   private void getXML810(Document doc) {
      ...
      ((Element)v.get(180)).setAttribute("cod","MaeNegocView.codNego.label" );
      ...
      ((Element)v.get(181)).setAttribute("cod","MaeNegocView.Descripcion.label" );
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(186)).setAttribute("nombre","maeNegocViewListButtonsLayer" );
   ...
   private void getXML900(Document doc) {
      ...
      ((Element)v.get(192)).setAttribute("nombre","maeNegocViewPaginationButtonBar" );
      ...
      ((Element)v.get(193)).setAttribute("nombre","maeNegocViewFirstPageButton" );
      ((Element)v.get(193)).setAttribute("funcion","maeNegocViewFirstPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(194)).setAttribute("nombre","maeNegocViewFirstPageButtonGapTd" );
      ...
      v.add(doc.createElement("BTN"));
      ((Element)v.get(196)).setAttribute("nombre","maeNegocViewPreviousPageButton" );
      ((Element)v.get(196)).setAttribute("funcion","maeNegocViewPreviousPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(197)).setAttribute("nombre","maeNegocViewPreviousPageButtonGapTd" );
      ...
      v.add(doc.createElement("BTN"));
      ((Element)v.get(199)).setAttribute("nombre","maeNegocViewNextPageButton" );
      ((Element)v.get(199)).setAttribute("funcion","maeNegocViewNextPage();" );
      ...
      ((Element)v.get(202)).setAttribute("nombre","maeNegocViewUpdateButtonTd" );
      ((Element)v.get(188)).appendChild((Element)v.get(202));

      /* Empieza nodo:203 / Elemento padre: 202   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(203)).setAttribute("nombre","maeNegocViewUpdateButton" );
      ((Element)v.get(203)).setAttribute("ID","botonContenido" );
      ((Element)v.get(203)).setAttribute("tipo","html" );
      ((Element)v.get(203)).setAttribute("accion","maeNegocViewUpdateSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(204)).setAttribute("nombre","maeNegocViewUpdateButtonGapTd" );
   }
   ...
   private void getXML990(Document doc) {
      ...
      ((Element)v.get(206)).setAttribute("nombre","maeNegocViewViewForRemoveButtonTd" );
      ((Element)v.get(188)).appendChild((Element)v.get(206));

      /* Empieza nodo:207 / Elemento padre: 206   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(207)).setAttribute("nombre","maeNegocViewViewForRemoveButton" );
      ((Element)v.get(207)).setAttribute("ID","botonContenido" );
      ((Element)v.get(207)).setAttribute("tipo","html" );
      ((Element)v.get(207)).setAttribute("accion","maeNegocViewViewSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(208)).setAttribute("nombre","maeNegocViewViewForRemoveButtonGapTd" );
      ...
      ((Element)v.get(210)).setAttribute("nombre","maeNegocViewLovSelectButtonTd" );
      ((Element)v.get(188)).appendChild((Element)v.get(210));

      /* Empieza nodo:211 / Elemento padre: 210   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(211)).setAttribute("nombre","maeNegocViewLovSelectButton" );
      ((Element)v.get(211)).setAttribute("ID","botonContenido" );
      ((Element)v.get(211)).setAttribute("tipo","html" );
      ((Element)v.get(211)).setAttribute("accion","maeNegocViewLovSelectionAction();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(212)).setAttribute("nombre","maeNegocViewLovSelectButtonGapTd" );
      ...
      ((Element)v.get(214)).setAttribute("nombre","maeNegocViewViewButtonTd" );
      ((Element)v.get(188)).appendChild((Element)v.get(214));

      /* Empieza nodo:215 / Elemento padre: 214   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(215)).setAttribute("nombre","maeNegocViewViewButton" );
      ((Element)v.get(215)).setAttribute("ID","botonContenido" );
      ((Element)v.get(215)).setAttribute("tipo","html" );
      ((Element)v.get(215)).setAttribute("accion","maeNegocViewViewSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(216)).setAttribute("nombre","maeNegocViewViewButtonGapTd" );
