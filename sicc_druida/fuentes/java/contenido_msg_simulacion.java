...
public class contenido_msg_simulacion  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_msg_simulacion" );
      ((Element)v.get(0)).setAttribute("cod","" );
      ((Element)v.get(0)).setAttribute("titulo","Simulación de mensajes" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","Simulación de mensajes" );
      ...
      v.add(doc.createTextNode("\r \r\rfunction onLoadPag(){\r		configurarMenuSecundario(\"frmMsgImprimir\");\r		focaliza(\"frmMsgImprimir.comboPatron\");\r		accion(\"frmMsgImprimir.comboPeriodo\",\".disabled=true\");\r		if (window.dialogArguments) {             btnProxy(2,1);              btnProxy(3,0);       }\r   	if (get('frmMsgImprimir.errDescripcion')!='') {\r		     var wnd = fMostrarMensajeError(get('frmMsgImprimir.errCodigo'), get('frmMsgImprimir.errDescripcion'));\r	    }\r    var acc = get(\"frmMsgImprimir.accion\");  \r    \r      \r}\r\r\rfunction errorAlGuardar(){\r		if (get(\"frmMsgImprimir.errCodigo\") == \"60019\")\r				focaliza(\"frmMsgImprimir.comboPatron\");					\r}\r\r\rfunction fLimpiar(){\r	focaliza(\"frmMsgImprimir.comboPatron\");\r}\r\rfunction tipoPeriodoOnChange(){\r\r	var pais = get(\"frmMsgImprimir.hPais\");\r	var idioma = get(\"frmMsgImprimir.hIdioma\");\r\r	var arr = new Array();\r	accion(\"frmMsgImprimir.comboPeriodo\",\".disabled=false\");\r	arr[arr.length] = new Array(\"oidPais\", pais );\r	arr[arr.length] = new Array(\"oidIdioma\", idioma );\r	arr[arr.length] = new Array(\"oidTipoPeriodo\", get(\"frmMsgImprimir.comboTipoPeriodo\")+\"\");\r\r    recargaCombo('frmMsgImprimir.comboPeriodo', 'SEGObtenerPeriodosPorTipoPeriodo', 'es.indra.sicc.dtos.seg.DTOPeriodosPorTipoPeriodo',arr);\r\r}\r\r\rfunction accionAceptar(){\r\r	if (sicc_validaciones_generales()){\r  \r    set(\"frmMsgImprimir.oidPatronH\", patron);\r    set(\"frmMsgImprimir.codigoClienteH\", cliente);\r    set(\"frmMsgImprimir.oidPeridodH\", periodo);\r    \r    var obj = new Object();\r    obj.casoDeUso = 'Simular mensajes';\r    var patron = get(\"frmMsgImprimir.comboPatron\");\r    \r    var cliente =get(\"frmMsgImprimir.txtCliente\");\r    var periodo =  get(\"frmMsgImprimir.comboPeriodo\");\r    \r    set(\"frmMsgImprimir.oidPatronH\", patron);\r    set(\"frmMsgImprimir.codigoClienteH\", cliente);\r    set(\"frmMsgImprimir.oidPeriodoH\", periodo); \r    \r    obj.oidPatron = patron;\r    obj.codigoCliente = cliente;\r    obj.oidPeriodo = periodo;    \r     \r	  var whnd = mostrarModalSICC('LPConsultarMensajes','Simular mensajes', obj,null, null);\r	\r   \r	}\r}\r\r\r\rfunction buscarCliente(){ 	\r\r    var obj = new Object();\r    var whnd = mostrarModalSICC('LPBusquedaRapidaCliente','',obj);\r\r    if(whnd==null){\r         }else{\r				var oid = whnd[0];\r                var cod = whnd[1];\r                set(\"frmMsgImprimir.txtCliente\", cod);\r				set(\"frmMsgImprimir.oids\", oid);\r         }\r}\r\rfunction focalizaTab(){\r	focaliza(\"frmMsgImprimir.comboPatron\");	\r}\r\rfunction focalizaShTab(){  \r	focalizaBotonHTML('botonContenido','btnAceptar');	\r}\r\r\rfunction fLimpiar(){    \r	set(\"frmMsgImprimir.txtCliente\", \"\");\r	set(\"frmMsgImprimir.comboPatron\", \"\");\r	set(\"frmMsgImprimir.comboTipoPeriodo\", \"\");\r	var aCombo = new Array(new Array(\"\",\"\"));\r	set_combo(\"frmMsgImprimir.comboPeriodo\",aCombo,[]);\r	accion(\"frmMsgImprimir.comboPeriodo\",\".disabled=true\");	\r	  	\r    focaliza(\"frmMsgImprimir.comboPatron\");	\r}\r\r\rfunction clienteOnBlur() {\r\r	 var longiCod = get('frmMsgImprimir.hLongCliente');\r	 var elTexto  = get('frmMsgImprimir.txtCliente');\r\r	 if(elTexto.length!=0){\r		var faltantes = longiCod -  elTexto.length;\r		var resultCod = new String(\"\");\r		if(faltantes > 0){\r			for(var t = 0 ; t<faltantes; t++){\r				resultCod = resultCod + \"0\";\r			}\r	  }\r	  resultCod = resultCod + elTexto;\r	  set('frmMsgImprimir.txtCliente', resultCod);\r	 }\r              \r}\r\r       \r     \r   \r \r\r\r"));
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(9)).setAttribute("name","txtCliente" );
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(10)).setAttribute("name","comboTipoPeriodo" );
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(11)).setAttribute("name","comboPeriodo" );
      ...
      ((Element)v.get(12)).setAttribute("nombre","frmMsgImprimir" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(17)).setAttribute("nombre","LP" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(20)).setAttribute("nombre","oidPatronH" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(21)).setAttribute("nombre","codigoClienteH" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(22)).setAttribute("nombre","oidPeriodoH" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(23)).setAttribute("nombre","hLongCliente" );
      ...
      ((Element)v.get(24)).setAttribute("nombre","capaUnica" );
      ((Element)v.get(24)).setAttribute("alto","200" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(48)).setAttribute("nombre","codPatron" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(52)).setAttribute("nombre","codCliente" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(56)).setAttribute("nombre","TipoPeriodo" );
      ...
      ((Element)v.get(56)).setAttribute("cod","132" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(60)).setAttribute("nombre","Periodo" );
      ...
      ((Element)v.get(60)).setAttribute("cod","276" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(67)).setAttribute("nombre","comboPatron" );
      ...
      ((Element)v.get(67)).setAttribute("onshtab","focalizaShTab();" );
      ...
      v.add(doc.createElement("IMG"));
      ((Element)v.get(74)).setAttribute("src","iconBuscar.gif" );
      ((Element)v.get(74)).setAttribute("onclick","buscarCliente();" );
      ...
      /* Empieza nodo:77 / Elemento padre: 63   */
      v.add(doc.createElement("td"));
      ((Element)v.get(77)).setAttribute("nowrap","nowrap" );
      ((Element)v.get(63)).appendChild((Element)v.get(77));

      /* Empieza nodo:78 / Elemento padre: 77   */
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(78)).setAttribute("nombre","comboTipoPeriodo" );
      ...
      ((Element)v.get(78)).setAttribute("onchange","tipoPeriodoOnChange();" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(83)).setAttribute("nombre","comboPeriodo" );
      ...
      /* Empieza nodo:85 / Elemento padre: 63   */
      v.add(doc.createElement("td"));
      ((Element)v.get(85)).setAttribute("width","100%" );
      ((Element)v.get(63)).appendChild((Element)v.get(85));
      ...
      /* Empieza nodo:87 / Elemento padre: 40   */
   }

   private void getXML360(Document doc) {
      v.add(doc.createElement("tr"));
      ((Element)v.get(40)).appendChild((Element)v.get(87));

      /* Empieza nodo:88 / Elemento padre: 87   */
      v.add(doc.createElement("td"));
      ((Element)v.get(88)).setAttribute("colspan","9" );
      ...
      /* Empieza nodo:92 / Elemento padre: 25   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(25)).appendChild((Element)v.get(92));
      ...
      ((Element)v.get(100)).setAttribute("ontab","focalizaTab();" );
