...
public class contenido_informe_comisiones_lideres_generar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_informe_comisiones_lideres_generar" );
      ((Element)v.get(0)).setAttribute("cod","0867" );
      ((Element)v.get(0)).setAttribute("titulo","Generar Informe Comisiones de Líderes por Sección - Cartera de Ingresos" );
      ...
      v.add(doc.createTextNode("\r   \r   \r	function onLoad(){\r		configurarMenuSecundario('Formulario');\r		fMostrarMensajeError();\r		focaliza('Formulario.cbMarca');\r	}\r\r	function quitarItemVacio(elemento){\r		var elementoADevolver = new Array();\r\r		for(var k=0;k<elemento.length;k++) {\r			if (elemento[k] != ''){                            \r				elementoADevolver[elementoADevolver.length] = elemento[k];\r			}\r		}\r\r		return elementoADevolver;\r	}\r   function generar(formato){\r      \r      if(sicc_validaciones_generales()){\r        \r          var a = new Object();\r          a.accion = 'generar';\r          a.marca = get('Formulario.cbMarca');  \r          a.canal = get('Formulario.cbCanal');\r          a.periodoDesde = get('Formulario.cbPeriodoInicio');\r          a.periodoHasta = get('Formulario.cbPeriodoFin');\r          a.periodoDesdeDesc = get('Formulario.cbPeriodoInicio', 'T');\r          a.periodoHastaDesc = get('Formulario.cbPeriodoFin', 'T');\r          \r          a.sgv = quitarItemVacio(get('Formulario.cbSubgerenciaVentas'));\r        \r          a.zona = quitarItemVacio(get('Formulario.cbZona'));\r          a.region = quitarItemVacio(get('Formulario.cbRegion'));         \r          a.seccion = quitarItemVacio(get('Formulario.cbSeccion'));         \r          a.territorio = quitarItemVacio(get('Formulario.cbTerritorio'));         \r        \r          a.formato = formato;    \r          mostrarModalSICC('COMComisionesLideres','generar', a);  \r    \r      }\r\r   }\r\r\r \r   \r\r   function fLimpiar(){\r		var aCombo = new Array(new Array(\"\",\"\"));\r		set_combo('Formulario.cbSubgerenciaVentas', aCombo, []); \r		set_combo('Formulario.cbRegion', aCombo, []); \r		set_combo('Formulario.cbZona', aCombo, []); \r		set_combo('Formulario.cbPeriodoInicio', aCombo, []); \r		set_combo('Formulario.cbPeriodoFin', aCombo, []); \r		set_combo('Formulario.cbTerritorio', aCombo, []); \r\r		focaliza('Formulario.cbMarca');\r \r   }\r   \r   function onchangeMarcaCanal(){\r        \r       marca  = get('Formulario.cbMarca');\r       canal  = get('Formulario.cbCanal');\r       pais   = get('Formulario.pais');\r       idioma = get('Formulario.idioma');\r      \r       if(marca != '' && canal != ''){\r          var arr = new Array();\r          var arr2 = new Array();\r                      \r          arr[arr.length] = [\"oidIdioma\", idioma]; \r          arr[arr.length] = [\"oidPais\", pais]; \r          arr[arr.length] = [\"marca\", marca];\r          arr[arr.length] = [\"canal\", canal];\r          \r          arr2[arr2.length] = [\"oidPais\", pais]; \r          arr2[arr2.length] = [\"oidMarca\", marca];\r          arr2[arr2.length] = [\"oidCanal\", canal];\r                    \r			recargaCombo(\"Formulario.cbPeriodoInicio\",\"PRECargarPeriodos\",\"es.indra.sicc.dtos.cra.DTOPeriodo\",arr);\r\r			recargaCombo(\"Formulario.cbSubgerenciaVentas\",\"ZONRecargaSubgerenciaVentas\", \"es.indra.sicc.dtos.zon.DTOUnidadAdministrativa\",arr2); \r\r			var aCombo = new Array(new Array(\"\",\"\"));\r			set_combo('Formulario.cbPeriodoFin', aCombo, []); \r			set_combo('Formulario.cbRegion', aCombo, []); \r			set_combo('Formulario.cbZona', aCombo, []); \r			set_combo('Formulario.cbSeccion', aCombo, []); \r			set_combo('Formulario.cbTerritorio', aCombo, []); \r\r       }else{\r           var aCombo = new Array(new Array(\"\",\"\"));\r           set_combo('Formulario.cbPeriodoInicio', aCombo, []); \r           set_combo('Formulario.cbPeriodoFin', aCombo, []); \r           set_combo('Formulario.cbSubgerenciaVentas', aCombo, []); \r           set_combo('Formulario.cbRegion', aCombo, []); \r           set_combo('Formulario.cbZona', aCombo, []); \r           set_combo('Formulario.cbSeccion', aCombo, []); \r           set_combo('Formulario.cbTerritorio', aCombo, []); \r       }\r    } \r\r\r\r	function cambioSubgerencia(){\r\r		opciones = new Array();\r		set_combo('Formulario.cbRegion',opciones);\r		set_combo('Formulario.cbZona',opciones);\r		set_combo('Formulario.cbSeccion',opciones);\r		set_combo('Formulario.cbTerritorio',opciones);\r   \r		combo_add('Formulario.cbRegion', '', '');\r		combo_add('Formulario.cbZona', '', '');\r		combo_add('Formulario.cbSeccion', '', '');\r		combo_add('Formulario.cbTerritorio', '', '');\r		\r		var sgvs = quitarItemVacio(get('Formulario.cbSubgerenciaVentas'));\r		var pais = get('Formulario.pais');\r		var sgvsConc = new String();\r\r		if(sgvs.length > 1){\r			accion('Formulario.cbRegion', '.disabled = true')\r			accion('Formulario.cbZona', '.disabled = true')\r			accion('Formulario.cbSeccion', '.disabled = true')\r			accion('Formulario.cbTerritorio', '.disabled = true')\r		}else{\r			accion('Formulario.cbRegion', '.disabled = false')\r			for(i=0;i<sgvs.length;i++){\r				sgvsConc += sgvs[i] + \"x\";\r			}\r			  \r			sgvsConc = sgvsConc.substring(0, sgvsConc.length-1);\r		\r			var arr = new Array();\r			arr[arr.length] = ['cadena', sgvsConc];\r			arr[arr.length] = ['oidPais', pais];\r		\r			if(sgvsConc != ''){\r				recargaCombo(\"Formulario.cbRegion\", \"REPRecargaRegiones\", \"es.indra.sicc.util.DTOString\",arr);\r			}\r		}\r\r	}\r\r\r	function cambioRegion(){\r		opciones = new Array();\r		\r		set_combo('Formulario.cbZona',opciones);\r		set_combo('Formulario.cbSeccion',opciones);\r		set_combo('Formulario.cbTerritorio',opciones);\r\r		combo_add('Formulario.cbZona', '', '');\r		combo_add('Formulario.cbSeccion', '', '');\r		combo_add('Formulario.cbTerritorio', '', '');\r		\r		var regiones = quitarItemVacio(get('Formulario.cbRegion'));\r		var pais = get('Formulario.pais');\r		var regionConc = new String();\r		\r		if(regiones.length > 1){\r			accion('Formulario.cbZona', '.disabled = true')\r			accion('Formulario.cbSeccion', '.disabled = true')\r			accion('Formulario.cbTerritorio', '.disabled = true')\r		}else{\r			accion('Formulario.cbZona', '.disabled = false')\r			for(i=0;i<regiones.length;i++){\r				 regionConc += regiones[i] + \"x\";\r			}\r				  \r			regionConc = regionConc.substring(0, regionConc.length-1);\r			\r			var arr = new Array();\r			arr[arr.length] = ['cadena', regionConc];\r			arr[arr.length] = ['oidPais', pais];\r			\r			if(regionConc != ''){\r				 recargaCombo(\"Formulario.cbZona\", \"REPRecargaZonas\", \"es.indra.sicc.util.DTOString\",arr);\r			}\r		}\r\r	}\r\r\r	function cambioZona(){\r		opciones = new Array();\r		set_combo('Formulario.cbSeccion',opciones);\r		set_combo('Formulario.cbTerritorio',opciones);\r         \r		combo_add('Formulario.cbSeccion', '', '');\r		combo_add('Formulario.cbTerritorio', '', '');\r\r		var zonas = quitarItemVacio(get('Formulario.cbZona'));\r		var pais = get('Formulario.pais');\r		var zonaConc = new String();\r\r		if(zonas.length > 1){\r			accion('Formulario.cbSeccion', '.disabled = true')\r			accion('Formulario.cbTerritorio', '.disabled = true')\r		}else{\r			accion('Formulario.cbSeccion', '.disabled = false')\r			for(i=0;i<zonas.length;i++){\r				zonaConc += zonas[i] + \"x\";\r			}\r			  \r			zonaConc = zonaConc.substring(0, zonaConc.length-1);\r\r			var arr = new Array();\r			arr[arr.length] = ['cadena', zonaConc];\r			arr[arr.length] = ['oidPais', pais];\r\r			if(zonaConc != ''){\r				recargaCombo(\"Formulario.cbSeccion\", \"REPRecargaSecciones\", \"es.indra.sicc.util.DTOString\",arr);\r			}  \r		}\r	}\r   \r\r	function cambioSeccion(){\r		opciones = new Array();\r		set_combo('Formulario.cbTerritorio',opciones);\r		combo_add('Formulario.cbTerritorio', '', '');\r\r		var secciones = quitarItemVacio(get('Formulario.cbSeccion'));\r		var pais = get('Formulario.pais');\r		var seccConc = new String();\r    \r		if(secciones.length > 1){\r			accion('Formulario.cbTerritorio', '.disabled = true')\r		}else{\r			accion('Formulario.cbTerritorio', '.disabled = false')\r			for(i=0;i<secciones.length;i++){\r				seccConc += secciones[i] + \"x\";\r			}\r			  \r			seccConc = seccConc.substring(0, seccConc.length-1);\r\r			var arr = new Array();\r			arr[arr.length] = ['cadena', seccConc];\r			arr[arr.length] = ['oidPais', pais];\r\r			if(seccConc != ''){\r				recargaCombo(\"Formulario.cbTerritorio\", \"REPRecargaTerrPorSecciones\", \"es.indra.sicc.util.DTOString\",arr);\r			}\r		}\r	}   \r\r\r   function recargaPeriodoHasta(){\r      var marca  = get('Formulario.cbMarca');\r      var canal  = get('Formulario.cbCanal');\r      var pais   = get('Formulario.pais');\r      var periodoDesde = get('Formulario.cbPeriodoInicio');\r\r	  if(marca != '' && canal != '' && periodoDesde != ''){\r 	     var arr = new Array();\r	     \r         arr[arr.length] = [\"pais\", pais]; \r         arr[arr.length] = [\"marca\", marca];\r         arr[arr.length] = [\"canal\", canal];\r         arr[arr.length] = [\"oid\", periodoDesde];\r\r         recargaCombo(\"Formulario.cbPeriodoFin\",\"REPObtenerPeriodosAnteriores\",\"es.indra.sicc.dtos.cra.DTOPeriodo\",arr);\r	  \r	  }else{\r	      var aCombo = new Array(new Array(\"\",\"\"));\r          set_combo('Formulario.cbPeriodoFin', aCombo, []); \r	  }\r   }\r\r\r\r\r   \r  \r  "));
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(9)).setAttribute("name","cbPeriodoInicio" );
      ((Element)v.get(9)).setAttribute("required","true" );
      ((Element)v.get(9)).setAttribute("cod","1241" );
      ((Element)v.get(6)).appendChild((Element)v.get(9));
      /* Termina nodo:9   */

      /* Empieza nodo:10 / Elemento padre: 6   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(10)).setAttribute("name","cbPeriodoFin" );
      ((Element)v.get(10)).setAttribute("required","true" );
      ((Element)v.get(10)).setAttribute("cod","967" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(63)).setAttribute("onchange","onchangeMarcaCanal();" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(77)).setAttribute("nombre","lblPeriodoInicio" );
      ((Element)v.get(77)).setAttribute("filas","1" );
      ((Element)v.get(77)).setAttribute("id","datosTitle" );
      ((Element)v.get(77)).setAttribute("cod","1241" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(81)).setAttribute("nombre","lblPeriodoFin" );
      ((Element)v.get(81)).setAttribute("filas","1" );
      ((Element)v.get(81)).setAttribute("id","datosTitle" );
      ((Element)v.get(81)).setAttribute("cod","967" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(88)).setAttribute("nombre","cbPeriodoInicio" );
      ...
      ((Element)v.get(88)).setAttribute("onchange","recargaPeriodoHasta();" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(93)).setAttribute("nombre","cbPeriodoFin" );
   ...
   private void getXML360(Document doc) {
      ...
      /* Empieza nodo:100 / Elemento padre: 36   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(36)).appendChild((Element)v.get(100));
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(118)).setAttribute("nombre","cbSubgerenciaVentas" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(118)).setAttribute("onchange","cambioSubgerencia();" );
      ...
      ((Element)v.get(123)).setAttribute("onchange","cambioRegion();" );
      ...
      /* Empieza nodo:130 / Elemento padre: 36   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(36)).appendChild((Element)v.get(130));
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(148)).setAttribute("onchange","cambioZona();" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(153)).setAttribute("nombre","cbSeccion" );
      ...
      ((Element)v.get(153)).setAttribute("onchange","cambioSeccion();" );
      ...
      /* Empieza nodo:160 / Elemento padre: 36   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(36)).appendChild((Element)v.get(160));
   ...
   private void getXML630(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(167)).setAttribute("nombre","lblTerritorio" );
      ((Element)v.get(167)).setAttribute("filas","1" );
      ((Element)v.get(167)).setAttribute("id","datosTitle" );
      ((Element)v.get(167)).setAttribute("cod","126" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(174)).setAttribute("nombre","cbTerritorio" );
      ((Element)v.get(174)).setAttribute("size","5" );
      ((Element)v.get(174)).setAttribute("multiple","S" );
      ...
      /* Empieza nodo:181 / Elemento padre: 29   */
      v.add(doc.createElement("td"));
      ((Element)v.get(29)).appendChild((Element)v.get(181));
      ...
      /* Empieza nodo:183 / Elemento padre: 21   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(21)).appendChild((Element)v.get(183));
      ...
      ((Element)v.get(191)).setAttribute("nombre","btnGenerarInforme" );
      ((Element)v.get(191)).setAttribute("ID","botonContenido" );
      ((Element)v.get(191)).setAttribute("tipo","html" );
      ((Element)v.get(191)).setAttribute("accion","generar('pdf')" );
      ((Element)v.get(191)).setAttribute("estado","false" );
      ((Element)v.get(191)).setAttribute("cod","2495" );
   }
   ...
   private void getXML720(Document doc) {
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(192)).setAttribute("nombre","btnGenerarExcel" );
      ((Element)v.get(192)).setAttribute("ID","botonContenido" );
      ((Element)v.get(192)).setAttribute("tipo","html" );
      ((Element)v.get(192)).setAttribute("accion","generar('xls')" );
      ((Element)v.get(192)).setAttribute("estado","false" );
      ((Element)v.get(192)).setAttribute("cod","2526" );
      ((Element)v.get(192)).setAttribute("ontab","focaliza('Formulario.cbMarca')" );
