...
public class EduAptasCursoPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","eduAptasCursoList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(18)).setAttribute("cod","EduAptasCurso.ctsuOidClieTipoSubt.label" );
      ...
      ((Element)v.get(19)).setAttribute("cod","EduAptasCurso.mcurOidCurs.label" );
      ...
      ((Element)v.get(20)).setAttribute("cod","EduAptasCurso.fecAsis.label" );
      ...
      ((Element)v.get(21)).setAttribute("cod","EduAptasCurso.indAcceDmrt.label" );
      ...
      ((Element)v.get(22)).setAttribute("cod","EduAptasCurso.indAptaCurs.label" );
      ...
      ((Element)v.get(23)).setAttribute("cod","EduAptasCurso.indInvi.label" );
      ...
      ((Element)v.get(24)).setAttribute("cod","EduAptasCurso.indAsis.label" );
      ...
      ((Element)v.get(25)).setAttribute("cod","EduAptasCurso.indPrue.label" );
