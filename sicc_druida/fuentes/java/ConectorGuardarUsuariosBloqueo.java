...
public class ConectorGuardarUsuariosBloqueo  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","MAE Guardar usuarios bloqueo" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","DTOUsuariosBloqueo" );
