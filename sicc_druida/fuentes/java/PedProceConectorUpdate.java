...
public class PedProceConectorUpdate  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la modificacion de un  elemento de la entidad PedProce" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGPedProceUpdateID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGPedProceUpdateDTO" );
