...
public class MaeTipoDirecPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","maeTipoDirecList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","MaeTipoDirec.codTipoDire.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","MaeTipoDirec.Descripcion.label" );
