...
public class SegSubacViewPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","SegSubacView.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","SegSubacView.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('segSubacViewFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('segSubacViewFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(54)).setAttribute("cod","SegSubacView.Descripcion.label" );
      ...
      ((Element)v.get(58)).setAttribute("max","30" );
      ((Element)v.get(58)).setAttribute("onchange","" );
      ((Element)v.get(58)).setAttribute("req","N" );
      ((Element)v.get(58)).setAttribute("size","30" );
      ...
      ((Element)v.get(58)).setAttribute("ontab","ejecutarAccionFoco('segSubacViewFrm',2, true)" );
      ((Element)v.get(58)).setAttribute("onshtab","ejecutarAccionFoco('segSubacViewFrm', 2, false)" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(62)).setAttribute("href","javascript:openLocalizationDialog('segSubacViewFrm', 'Descripcion', 1);" );
      ((Element)v.get(62)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"segSubacViewFrm\",2, true)', 'ejecutarAccionFoco(\"segSubacViewFrm\",2, false)')" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(78)).setAttribute("nombre","segSubacViewTrButtons" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(85)).setAttribute("nombre","segSubacViewTdQueryButton" );
      ((Element)v.get(84)).appendChild((Element)v.get(85));

      /* Empieza nodo:86 / Elemento padre: 85   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(86)).setAttribute("nombre","segSubacViewQueryButton" );
      ((Element)v.get(86)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(86)).setAttribute("estado","false" );
      ((Element)v.get(86)).setAttribute("accion","segSubacViewFirstPage();" );
      ...
      ((Element)v.get(87)).setAttribute("nombre","segSubacViewTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(89)).setAttribute("nombre","segSubacViewLovNullButton" );
      ((Element)v.get(89)).setAttribute("ID","botonContenido" );
      ((Element)v.get(89)).setAttribute("tipo","html" );
      ((Element)v.get(89)).setAttribute("accion","segSubacViewLovNullSelectionAction();" );
