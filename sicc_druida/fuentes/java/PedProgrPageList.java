...
public class PedProgrPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","pedProgrList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","PedProgr.valNomb.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","PedProgr.valClasEjec.label" );
