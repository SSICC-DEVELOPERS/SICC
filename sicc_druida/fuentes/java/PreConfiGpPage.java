...
public class PreConfiGpPage  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","PreConfiGpPage" );
      ((Element)v.get(0)).setAttribute("titulo","" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","" );
      ((Element)v.get(0)).setAttribute("onload","preConfiGpInitComponents()" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(3)).setAttribute("src","preconfigp.js" );
      ((Element)v.get(0)).appendChild((Element)v.get(3));
      /* Termina nodo:3   */

      /* Empieza nodo:4 / Elemento padre: 0   */
      v.add(doc.createElement("FORMULARIO"));
      ((Element)v.get(4)).setAttribute("nombre","preConfiGpFrm" );
      ...
      ((Element)v.get(5)).setAttribute("valor","PreConfiGpLPExecution" );
      ...
      ((Element)v.get(6)).setAttribute("valor","PreConfiGpLPExecution" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(36)).setAttribute("nombre","preConfiGpFormLayer" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(51)).setAttribute("cod","PreConfiGp.legend.label" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(66)).setAttribute("cod","PreConfiGp.id.label" );
      ...
      ((Element)v.get(69)).setAttribute("ontab","ejecutarAccionFoco('preConfiGpFrm',1, true)" );
      ((Element)v.get(69)).setAttribute("onshtab","ejecutarAccionFoco('preConfiGpFrm', 1, false)" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(91)).setAttribute("cod","PreConfiGp.paisOidPais.label" );
      ...
      ((Element)v.get(94)).setAttribute("ontab","ejecutarAccionFoco('preConfiGpFrm',2, true);" );
      ((Element)v.get(94)).setAttribute("onshtab","ejecutarAccionFoco('preConfiGpFrm',2, false);" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(102)).setAttribute("cod","PreConfiGp.marcOidMarc.label" );
      ...
      ((Element)v.get(105)).setAttribute("ontab","ejecutarAccionFoco('preConfiGpFrm',3, true);" );
      ((Element)v.get(105)).setAttribute("onshtab","ejecutarAccionFoco('preConfiGpFrm',3, false);" );
      ...
      ((Element)v.get(113)).setAttribute("cod","PreConfiGp.canaOidCana.label" );
      ...
      ((Element)v.get(116)).setAttribute("ontab","ejecutarAccionFoco('preConfiGpFrm',4, true);" );
      ((Element)v.get(116)).setAttribute("onshtab","ejecutarAccionFoco('preConfiGpFrm',4, false);" );
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(120)).setAttribute("nombre","valIncrTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(125)).setAttribute("nombre","valIncrWidgetTrId" );
      ...
      ((Element)v.get(127)).setAttribute("ontab","ejecutarAccionFoco('preConfiGpFrm',5, true)" );
      ((Element)v.get(127)).setAttribute("onshtab","ejecutarAccionFoco('preConfiGpFrm', 5, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(128)).setAttribute("nombre","valIncrGapTdId" );
   ...
   private void getXML630(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(142)).setAttribute("nombre","preConfiGpTrButtons" );
      ...
      ((Element)v.get(149)).setAttribute("nombre","preConfiGpTdQueryButton" );
      ((Element)v.get(148)).appendChild((Element)v.get(149));

      /* Empieza nodo:150 / Elemento padre: 149   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(150)).setAttribute("nombre","preConfiGpQueryButton" );
      ((Element)v.get(150)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(150)).setAttribute("estado","false" );
      ((Element)v.get(150)).setAttribute("accion","preConfiGpFirstPage();" );
      ...
      ((Element)v.get(151)).setAttribute("nombre","preConfiGpTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(153)).setAttribute("nombre","preConfiGpLovNullButton" );
      ((Element)v.get(153)).setAttribute("ID","botonContenido" );
      ((Element)v.get(153)).setAttribute("tipo","html" );
      ((Element)v.get(153)).setAttribute("accion","preConfiGpLovNullSelectionAction();" );
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(156)).setAttribute("nombre","preConfiGpListLayer" );
   }
   ...
   private void getXML720(Document doc) {
      ...
      ((Element)v.get(157)).setAttribute("nombre","preConfiGpList" );
   ...
   private void getXML810(Document doc) {
      ...
      ((Element)v.get(171)).setAttribute("cod","PreConfiGp.marcOidMarc.label" );
      ...
      ((Element)v.get(172)).setAttribute("cod","PreConfiGp.canaOidCana.label" );
      ...
      ((Element)v.get(173)).setAttribute("cod","PreConfiGp.valIncr.label" );
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(179)).setAttribute("nombre","preConfiGpListButtonsLayer" );
   ...
   private void getXML900(Document doc) {
      ...
      ((Element)v.get(185)).setAttribute("nombre","preConfiGpPaginationButtonBar" );
      ...
      ((Element)v.get(186)).setAttribute("nombre","preConfiGpFirstPageButton" );
      ((Element)v.get(186)).setAttribute("funcion","preConfiGpFirstPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(187)).setAttribute("nombre","preConfiGpFirstPageButtonGapTd" );
      ...
      v.add(doc.createElement("BTN"));
      ((Element)v.get(189)).setAttribute("nombre","preConfiGpPreviousPageButton" );
      ((Element)v.get(189)).setAttribute("funcion","preConfiGpPreviousPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(190)).setAttribute("nombre","preConfiGpPreviousPageButtonGapTd" );
      ...
      v.add(doc.createElement("BTN"));
      ((Element)v.get(192)).setAttribute("nombre","preConfiGpNextPageButton" );
      ((Element)v.get(192)).setAttribute("funcion","preConfiGpNextPage();" );
      ...
      ((Element)v.get(195)).setAttribute("nombre","preConfiGpUpdateButtonTd" );
      ((Element)v.get(181)).appendChild((Element)v.get(195));

      /* Empieza nodo:196 / Elemento padre: 195   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(196)).setAttribute("nombre","preConfiGpUpdateButton" );
      ((Element)v.get(196)).setAttribute("ID","botonContenido" );
      ((Element)v.get(196)).setAttribute("tipo","html" );
      ((Element)v.get(196)).setAttribute("accion","preConfiGpUpdateSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(197)).setAttribute("nombre","preConfiGpUpdateButtonGapTd" );
      ...
      ((Element)v.get(199)).setAttribute("nombre","preConfiGpViewForRemoveButtonTd" );
      ((Element)v.get(181)).appendChild((Element)v.get(199));

      /* Empieza nodo:200 / Elemento padre: 199   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(200)).setAttribute("nombre","preConfiGpViewForRemoveButton" );
      ((Element)v.get(200)).setAttribute("ID","botonContenido" );
      ((Element)v.get(200)).setAttribute("tipo","html" );
      ((Element)v.get(200)).setAttribute("accion","preConfiGpViewSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(201)).setAttribute("nombre","preConfiGpViewForRemoveButtonGapTd" );
   ...
   private void getXML990(Document doc) {
      ...
      ((Element)v.get(203)).setAttribute("nombre","preConfiGpLovSelectButtonTd" );
      ((Element)v.get(181)).appendChild((Element)v.get(203));

      /* Empieza nodo:204 / Elemento padre: 203   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(204)).setAttribute("nombre","preConfiGpLovSelectButton" );
      ((Element)v.get(204)).setAttribute("ID","botonContenido" );
      ((Element)v.get(204)).setAttribute("tipo","html" );
      ((Element)v.get(204)).setAttribute("accion","preConfiGpLovSelectionAction();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(205)).setAttribute("nombre","preConfiGpLovSelectButtonGapTd" );
      ...
      ((Element)v.get(207)).setAttribute("nombre","preConfiGpViewButtonTd" );
      ((Element)v.get(181)).appendChild((Element)v.get(207));

      /* Empieza nodo:208 / Elemento padre: 207   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(208)).setAttribute("nombre","preConfiGpViewButton" );
      ((Element)v.get(208)).setAttribute("ID","botonContenido" );
      ((Element)v.get(208)).setAttribute("tipo","html" );
      ((Element)v.get(208)).setAttribute("accion","preConfiGpViewSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(209)).setAttribute("nombre","preConfiGpViewButtonGapTd" );
