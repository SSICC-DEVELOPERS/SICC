...
public class MaeMagniPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","maeMagniList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","MaeMagni.codMagn.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","MaeMagni.Descripcion.label" );
