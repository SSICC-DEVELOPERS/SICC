...
public class contenido_matriz_facturacion_nueva_seleccionar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_matriz_facturacion_nueva_seleccionar" );
      ((Element)v.get(0)).setAttribute("titulo","" );
      ((Element)v.get(0)).setAttribute("cod","0198" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(3)).setAttribute("src","contenido_matriz_facturacion_nueva_seleccionar.js" );
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(9)).setAttribute("name","txtPedEstimados" );
      ((Element)v.get(9)).setAttribute("required","true" );
      ((Element)v.get(9)).setAttribute("cod","448" );
      ((Element)v.get(9)).setAttribute("format","e" );
      ((Element)v.get(9)).setAttribute("min","0" );
      ((Element)v.get(9)).setAttribute("max","99999999999" );
      ((Element)v.get(5)).appendChild((Element)v.get(9));
      /* Termina nodo:9   */

      /* Empieza nodo:10 / Elemento padre: 5   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(10)).setAttribute("name","txtUniEstimadas" );
      ((Element)v.get(10)).setAttribute("required","true" );
      ((Element)v.get(10)).setAttribute("cod","449" );
      ((Element)v.get(10)).setAttribute("format","e" );
      ((Element)v.get(10)).setAttribute("min","0" );
      ((Element)v.get(10)).setAttribute("max","99999999999" );
      ((Element)v.get(5)).appendChild((Element)v.get(10));
      /* Termina nodo:10   */

      /* Empieza nodo:11 / Elemento padre: 5   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(11)).setAttribute("name","txtCliEstimados" );
      ((Element)v.get(11)).setAttribute("required","true" );
      ((Element)v.get(11)).setAttribute("cod","450" );
      ((Element)v.get(11)).setAttribute("format","e" );
      ((Element)v.get(11)).setAttribute("min","0" );
      ((Element)v.get(11)).setAttribute("max","99999999999" );
      ((Element)v.get(5)).appendChild((Element)v.get(11));
      /* Termina nodo:11   */

      /* Empieza nodo:12 / Elemento padre: 5   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(12)).setAttribute("name","txtValorEstimado" );
      ((Element)v.get(12)).setAttribute("required","true" );
      ((Element)v.get(12)).setAttribute("cod","2465" );
      ((Element)v.get(12)).setAttribute("format","e" );
      ((Element)v.get(12)).setAttribute("min","0" );
      ((Element)v.get(12)).setAttribute("max","99999999999" );
      ((Element)v.get(5)).appendChild((Element)v.get(12));
      /* Termina nodo:12   */

      /* Empieza nodo:13 / Elemento padre: 5   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(13)).setAttribute("name","txtTipoCambio" );
      ((Element)v.get(13)).setAttribute("required","false" );
      ((Element)v.get(13)).setAttribute("cod","477" );
      ((Element)v.get(13)).setAttribute("format","n" );
      ((Element)v.get(13)).setAttribute("min","0" );
      ((Element)v.get(13)).setAttribute("max","9999999.99999" );
      ...
      ((Element)v.get(15)).setAttribute("valor","LPSeleccionarNuevaMF" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(20)).setAttribute("nombre","hidPais" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(21)).setAttribute("nombre","hidMarca" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(22)).setAttribute("nombre","hidCanal" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(23)).setAttribute("nombre","hidDescMarca" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(24)).setAttribute("nombre","hidDescCanal" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(25)).setAttribute("nombre","hidDescPeriodo" );
      ...
      ((Element)v.get(41)).setAttribute("nombre","lblTitulo" );
      ((Element)v.get(41)).setAttribute("alto","13" );
      ((Element)v.get(41)).setAttribute("filas","1" );
      ((Element)v.get(41)).setAttribute("valor","Matriz facturación" );
      ((Element)v.get(41)).setAttribute("id","legend" );
   }

   private void getXML180(Document doc) {
      ((Element)v.get(41)).setAttribute("cod","00104" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(65)).setAttribute("nombre","lblPaisX" );
      ...
      ((Element)v.get(65)).setAttribute("codi","5" );
      ...
      ((Element)v.get(69)).setAttribute("onchange","cambioMarcaCanal('false');" );
      ((Element)v.get(69)).setAttribute("textoinicial","" );
      ((Element)v.get(69)).setAttribute("onshtab","focaliza('frmContenido.txtTipoCambio','');" );
      ...
      ((Element)v.get(74)).setAttribute("onchange","cambioMarcaCanal('true');" );
   ...
   private void getXML360(Document doc) {
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(86)).setAttribute("nombre","lblPeriodo" );
      ...
      ((Element)v.get(86)).setAttribute("cod","276" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(90)).setAttribute("nombre","lblPedEstimados" );
      ...
      ((Element)v.get(90)).setAttribute("cod","448" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(94)).setAttribute("nombre","lblUniEstimadas" );
      ...
      ((Element)v.get(94)).setAttribute("cod","449" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(98)).setAttribute("nombre","lblCliEstimados" );
      ...
      ((Element)v.get(98)).setAttribute("cod","450" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(110)).setAttribute("nombre","txtPedEstimados" );
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(114)).setAttribute("nombre","txtUniEstimadas" );
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(118)).setAttribute("nombre","txtCliEstimados" );
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(129)).setAttribute("nombre","lblValorEstimado" );
      ...
      ((Element)v.get(129)).setAttribute("cod","2465" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(133)).setAttribute("nombre","lblTipoCambio" );
      ...
      ((Element)v.get(133)).setAttribute("cod","477" );
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(140)).setAttribute("nombre","txtValorEstimado" );
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(144)).setAttribute("nombre","txtTipoCambio" );
      ...
      ((Element)v.get(144)).setAttribute("size","14" );
      ((Element)v.get(144)).setAttribute("valor","" );
      ((Element)v.get(144)).setAttribute("validacion","" );
      ((Element)v.get(144)).setAttribute("ontab","document.selection.empty();focaliza('frmContenido.cbMarca','');" );
   ...
   private void getXML630(Document doc) {
      ...
      /* Empieza nodo:150 / Elemento padre: 35   */
      v.add(doc.createElement("td"));
      ((Element)v.get(35)).appendChild((Element)v.get(150));
      ...
      /* Empieza nodo:152 / Elemento padre: 27   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(27)).appendChild((Element)v.get(152));
