...
public class contenido_informe_validacion_estimados_generar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_informe_validacion_estimados_generar" );
      ((Element)v.get(0)).setAttribute("cod","0799" );
      ((Element)v.get(0)).setAttribute("titulo","Generar informe de validación de estimados" );
      ...
      v.add(doc.createTextNode("\r   \r   \r   function onLoad(){\r      configurarMenuSecundario('Formulario');\r      fMostrarMensajeError();\r      focaliza('Formulario.cbMarca');\r   }\r   function generar(formato){\r      \r      if(sicc_validaciones_generales()){\r          /*recolectarParametros();\r          set('Formulario.conectorAction', 'PREValidacionEstimados');           \r          set('Formulario.accion', 'generar');\r          enviaSICC('Formulario');*/\r          var a = new Object();\r          a.accion = 'generar';\r          a.marca = get('Formulario.cbMarca');  \r          a.canal = get('Formulario.cbCanal');\r          a.marcaDesc = get('Formulario.cbMarca', 'T');  \r          a.canalDesc = get('Formulario.cbCanal', 'T');\r          a.periodo = get('Formulario.cbPeriodo');\r          a.periodoDesc = get('Formulario.cbPeriodo', 'T');\r          a.diferenciaEstimado = get('Formulario.ckRegistrosDiferenciaEstimados');\r          a.diferenciaPrecio = get('Formulario.ckRegistrosDiferenciaPrecio');       \r          mostrarModalSICC('PREValidacionEstimados','generar', a);  \r    \r      }\r\r   }\r\r   function recolectarParametros(){\r      \r           \r      set('Formulario.marca', get('Formulario.cbMarca') );  \r      set('Formulario.canal', get('Formulario.cbCanal'));\r      set('Formulario.periodo', get('Formulario.cbPeriodo'));\r      set('Formulario.diferenciaEstimado',get('Formulario.ckRegistrosDiferenciaEstimados'));\r      set('Formulario.diferenciaPrecio',get('Formulario.ckRegistrosDiferenciaPrecio'));\r      \r   \r   }\r \r   \r\r   function fLimpiar(){\r      var aCombo = new Array(new Array(\"\",\"\"));\r      set_combo('Formulario.cbPeriodo', aCombo, []);\r      set('Formulario.ckRegistrosDiferenciaEstimados', 'N');\r      set('Formulario.ckRegistrosDiferenciaPrecio', 'N');\r      focaliza('Formulario.cbMarca');\r \r   }\r   \r    function onchangeMarcaCanal(){\r        \r       marca  = get('Formulario.cbMarca');\r       canal  = get('Formulario.cbCanal');\r       pais   = get('Formulario.pais');\r       idioma = get('Formulario.idioma');\r        \r       if(marca != '' && canal != ''){\r       \r          var arr = new Array();\r               \r          arr[arr.length] = [\"oidIdioma\", idioma]; \r          arr[arr.length] = [\"oidPais\", pais]; \r          arr[arr.length] = [\"marca\", marca];\r          arr[arr.length] = [\"canal\", canal];\r             \r          recargaCombo(\"Formulario.cbPeriodo\",\"PRECargarPeriodos\",\"es.indra.sicc.dtos.cra.DTOPeriodo\",arr);\r         \r       }else{\r         var aCombo = new Array(new Array(\"\",\"\"));\r         set_combo('Formulario.cbPeriodo', aCombo, []);\r             \r       }\r   \r    } \r \r\r\r   \r"));
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(21)).setAttribute("nombre","diferenciaEstimado" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(22)).setAttribute("nombre","diferenciaPrecio" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(61)).setAttribute("nombre","lbldtPais" );
      ...
      /* Empieza nodo:69 / Elemento padre: 42   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(42)).appendChild((Element)v.get(69));
   ...
   private void getXML270(Document doc) {
      ...
      /* Empieza nodo:72 / Elemento padre: 39   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(39)).appendChild((Element)v.get(72));
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(90)).setAttribute("nombre","cbCanal" );
      ...
      ((Element)v.get(90)).setAttribute("onchange","onchangeMarcaCanal();" );
   ...
   private void getXML360(Document doc) {
      ...
      /* Empieza nodo:102 / Elemento padre: 39   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(39)).appendChild((Element)v.get(102));
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(120)).setAttribute("nombre","ckRegistrosDiferenciaEstimados" );
      ((Element)v.get(120)).setAttribute("id","datosCampos" );
      ((Element)v.get(120)).setAttribute("onclick","" );
      ...
      v.add(doc.createElement("CHECKBOX"));
      ((Element)v.get(124)).setAttribute("nombre","ckRegistrosDiferenciaPrecios" );
      ...
      /* Empieza nodo:130 / Elemento padre: 32   */
      v.add(doc.createElement("td"));
      ((Element)v.get(32)).appendChild((Element)v.get(130));
      ...
      /* Empieza nodo:132 / Elemento padre: 24   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(24)).appendChild((Element)v.get(132));
      ...
      ((Element)v.get(140)).setAttribute("ontab","focaliza('Formulario.cbMarca')" );
      ...
      /* Empieza nodo:143 / Elemento padre: 24   */
      v.add(doc.createElement("tr"));
   }

   private void getXML540(Document doc) {
      ((Element)v.get(24)).appendChild((Element)v.get(143));
