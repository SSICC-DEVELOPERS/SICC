/*
    INDRA/CAR/mmg
    $Id: SegTipoPerioLPStartUp.java,v 1.1 2009/12/03 18:37:33 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class SegTipoPerioLPStartUp extends MMGDruidaBase{
	...
	public static final String BUSINESSID_QUERY = "MMGSegTipoPerioQueryFromToUserPage";
	...
	public SegTipoPerioLPStartUp(){
		super();
	}

	public void inicio() throws Exception {
		pagina("SegTipoPerioPage");
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "SegTipoPerioPage", "cod", "SegTipoPerio." + accion + ".label");
			...
			limpiarBotoneraLista("segTipoPerio", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codTipoPeri", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 2);");
		...
		//asignarAtributo("CAPA", "segTipoPerioLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "SegTipoPerioPage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("SegTipoPerioLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		SegTipoPerioData segTipoPerioQuery= new SegTipoPerioData();
		segTipoPerioQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		SegTipoPerioData datosResult = (SegTipoPerioData)getSingleObject(BUSINESSID_QUERY, segTipoPerioQuery, 
			segTipoPerioQuery.clone(), "segTipoPerio");
		...
		preservaHiddensI18n(new Integer(1), "SEG_TIPO_PERIO", "segTipoPerioFrm", "Descripcion", true);
		...
		SegTipoPerioData segTipoPerio = datosResult;
		asignar("TEXT", "codTipoPeri", FormatUtils.formatObject(segTipoPerio.getCodTipoPeri(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "numDias", FormatUtils.formatObject(segTipoPerio.getNumDias(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "numPeriAnio", FormatUtils.formatObject(segTipoPerio.getNumPeriAnio(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		loadLocalizationVars(segTipoPerio);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "codTipoPeri", "disabled", "S");
		asignarAtributo("TEXT", "Descripcion", "disabled", "S");
		asignarAtributo("TEXT", "numDias", "disabled", "S");
		asignarAtributo("TEXT", "numPeriAnio", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "SEG_TIPO_PERIO", "segTipoPerioFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "codTipoPeri", "req", "S");
		asignarAtributo("TEXT", "Descripcion", "req", "S");
		asignarAtributo("TEXT", "numDias", "req", "S");
		asignarAtributo("TEXT", "numPeriAnio", "req", "S");
		
		
		//Asiganamos a los campos internacionalizables la función de onblur para actualizar el 
		//valor del idioma por defecto
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('segTipoPerioFrm.Descripcion'))");
		...
		asignarAtributo("TEXT", "codTipoPeri", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 2);");
		asignarAtributo("TEXT", "Descripcion", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 40);");
		asignarAtributo("TEXT", "numDias", "validacion", "mensaje = ValidaInt(cdos_trim(valor), 3, 0, 999);");
		asignarAtributo("TEXT", "numPeriAnio", "validacion", "mensaje = ValidaInt(cdos_trim(valor), 2, 0, 99);");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "segTipoPerioFrm", "oculto", "N");
		...
		traza("MMG::Creando SegTipoPerio");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		SegTipoPerioData segTipoPerioQuery= new SegTipoPerioData();
		segTipoPerioQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(segTipoPerio.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"segTipoPerioFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"segTipoPerioFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codTipoPeri", "ontab","ejecutarAccionFocoModificacion(\"segTipoPerioFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codTipoPeri", "onshtab","ejecutarAccionFocoModificacion(\"segTipoPerioFrm\",2, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"segTipoPerioFrm\",3, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"segTipoPerioFrm\",3, false)");
				asignarAtributo("AREATEXTO", "numDias", "ontab","ejecutarAccionFocoModificacion(\"segTipoPerioFrm\",4, true)");
				asignarAtributo("AREATEXTO", "numDias", "onshtab","ejecutarAccionFocoModificacion(\"segTipoPerioFrm\",4, false)");
				asignarAtributo("AREATEXTO", "numPeriAnio", "ontab","ejecutarAccionFocoModificacion(\"segTipoPerioFrm\",5, true)");
				asignarAtributo("AREATEXTO", "numPeriAnio", "onshtab","ejecutarAccionFocoModificacion(\"segTipoPerioFrm\",5, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","segTipoPerioTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","segTipoPerioTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","segTipoPerioFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","segTipoPerioListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","segTipoPerioListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(SegTipoPerioData segTipoPerio) throws Exception{
	...
	* @param segTipoPerio La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(SegTipoPerioData segTipoPerio) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		SegTipoPerioData segTipoPerio = 
			(SegTipoPerioData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(segTipoPerio);
		loadLeafDependenceCombos(segTipoPerio);
	}
	...
	*/
	...
	protected void loadLocalizationVars(SegTipoPerioData segTipoPerio) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("SEG_TIPO_PERIO");
		mmgLocalizationQuery.setEntiPk(segTipoPerio.getId());
