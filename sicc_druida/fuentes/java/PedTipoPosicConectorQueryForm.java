...
public class PedTipoPosicConectorQueryForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad PedTipoPosic" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGPedTipoPosicQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGPedTipoPosicQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","PedTipoPosicFormFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","codTipoPosi" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(9)).setAttribute("NOMBRE","indDemaNorm" );
