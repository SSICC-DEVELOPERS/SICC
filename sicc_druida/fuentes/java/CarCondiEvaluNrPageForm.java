...
public class CarCondiEvaluNrPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","CarCondiEvaluNr.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","CarCondiEvaluNr.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('carCondiEvaluNrFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('carCondiEvaluNrFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(50)).setAttribute("nombre","penrOidParaEvalNrTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lblpenrOidParaEvalNr" );
      ((Element)v.get(54)).setAttribute("id","datosTitle" );
      ((Element)v.get(54)).setAttribute("ancho","150" );
      ((Element)v.get(54)).setAttribute("alto","13" );
      ((Element)v.get(54)).setAttribute("cod","CarCondiEvaluNr.penrOidParaEvalNr.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(55)).setAttribute("nombre","penrOidParaEvalNrWidgetTrId" );
      ...
      ((Element)v.get(57)).setAttribute("nombre","penrOidParaEvalNr" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('carCondiEvaluNrFrm',2, true);" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('carCondiEvaluNrFrm',2, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(59)).setAttribute("nombre","penrOidParaEvalNrGapTdId" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(61)).setAttribute("nombre","valMiniTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(66)).setAttribute("nombre","valMiniWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(68)).setAttribute("nombre","valMini" );
      ((Element)v.get(68)).setAttribute("id","datosCampos" );
      ((Element)v.get(68)).setAttribute("trim","S" );
      ((Element)v.get(68)).setAttribute("max","12" );
      ...
      ((Element)v.get(68)).setAttribute("ontab","ejecutarAccionFoco('carCondiEvaluNrFrm',3, true)" );
      ((Element)v.get(68)).setAttribute("onshtab","ejecutarAccionFoco('carCondiEvaluNrFrm', 3, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(69)).setAttribute("nombre","valMiniGapTdId" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(71)).setAttribute("nombre","valMaxiTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(76)).setAttribute("nombre","valMaxiWidgetTrId" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(78)).setAttribute("nombre","valMaxi" );
      ((Element)v.get(78)).setAttribute("id","datosCampos" );
      ((Element)v.get(78)).setAttribute("trim","S" );
      ((Element)v.get(78)).setAttribute("max","12" );
      ...
      ((Element)v.get(78)).setAttribute("ontab","ejecutarAccionFoco('carCondiEvaluNrFrm',4, true)" );
      ((Element)v.get(78)).setAttribute("onshtab","ejecutarAccionFoco('carCondiEvaluNrFrm', 4, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(79)).setAttribute("nombre","valMaxiGapTdId" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(81)).setAttribute("nombre","valEscaMiniTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(85)).setAttribute("nombre","lblValEscaMini" );
      ((Element)v.get(85)).setAttribute("alto","13" );
      ((Element)v.get(85)).setAttribute("filas","1" );
      ((Element)v.get(85)).setAttribute("id","datosTitle" );
      ((Element)v.get(85)).setAttribute("cod","CarCondiEvaluNr.valEscaMini.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(86)).setAttribute("nombre","valEscaMiniWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(88)).setAttribute("nombre","valEscaMini" );
      ((Element)v.get(88)).setAttribute("id","datosCampos" );
      ((Element)v.get(88)).setAttribute("trim","S" );
      ((Element)v.get(88)).setAttribute("max","12" );
      ((Element)v.get(88)).setAttribute("onchange","" );
      ((Element)v.get(88)).setAttribute("req","N" );
      ((Element)v.get(88)).setAttribute("size","12" );
      ((Element)v.get(88)).setAttribute("valor","" );
      ((Element)v.get(88)).setAttribute("validacion","" );
      ((Element)v.get(88)).setAttribute("disabled","" );
      ((Element)v.get(88)).setAttribute("onblur","" );
      ((Element)v.get(88)).setAttribute("ontab","ejecutarAccionFoco('carCondiEvaluNrFrm',5, true)" );
      ((Element)v.get(88)).setAttribute("onshtab","ejecutarAccionFoco('carCondiEvaluNrFrm', 5, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(89)).setAttribute("nombre","valEscaMiniGapTdId" );
      ...
      /* Empieza nodo:93 / Elemento padre: 44   */
      v.add(doc.createElement("TD"));
      ((Element)v.get(93)).setAttribute("width","100%" );
   }

   private void getXML450(Document doc) {
      ((Element)v.get(44)).appendChild((Element)v.get(93));
      /* Termina nodo:93   */
      /* Termina nodo:44   */
      ...
      /* Empieza nodo:103 / Elemento padre: 0   */
      v.add(doc.createElement("TR"));
      ((Element)v.get(103)).setAttribute("nombre","carCondiEvaluNrTrButtons" );
      ((Element)v.get(0)).appendChild((Element)v.get(103));
      ...
      ((Element)v.get(110)).setAttribute("nombre","carCondiEvaluNrTdQueryButton" );
      ((Element)v.get(109)).appendChild((Element)v.get(110));

      /* Empieza nodo:111 / Elemento padre: 110   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(111)).setAttribute("nombre","carCondiEvaluNrQueryButton" );
      ((Element)v.get(111)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(111)).setAttribute("estado","false" );
      ((Element)v.get(111)).setAttribute("accion","carCondiEvaluNrFirstPage();" );
      ...
      ((Element)v.get(112)).setAttribute("nombre","carCondiEvaluNrTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(114)).setAttribute("nombre","carCondiEvaluNrLovNullButton" );
      ((Element)v.get(114)).setAttribute("ID","botonContenido" );
      ((Element)v.get(114)).setAttribute("tipo","html" );
   }

   private void getXML540(Document doc) {
      ((Element)v.get(114)).setAttribute("accion","carCondiEvaluNrLovNullSelectionAction();" );
