...
public class contenido_factores_conversion_modificar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_factores_conversion_modificar" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","contenido_factores_conversion_modificar.js" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(13)).setAttribute("nombre","oidFactoresConversion" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(31)).setAttribute("nombre","lblSeleccionOrdenAnaquel" );
      ((Element)v.get(31)).setAttribute("alto","13" );
      ((Element)v.get(31)).setAttribute("filas","1" );
      ((Element)v.get(31)).setAttribute("cod","MMGGlobal.legend.searchcriteria.label" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(40)).setAttribute("nombre","lblMagnitud" );
      ...
      ((Element)v.get(40)).setAttribute("cod","MaeMagni.codMagn.label" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(44)).setAttribute("nombre","lblUnidMedOrigen" );
      ...
      ((Element)v.get(44)).setAttribute("cod","3099" );
   ...
   private void getXML180(Document doc) {
      ((Element)v.get(48)).setAttribute("nombre","lblUnidMedDestino" );
      ...
      ((Element)v.get(48)).setAttribute("cod","3100" );
      ...
      ((Element)v.get(55)).setAttribute("nombre","cbMagnitud" );
      ...
      ((Element)v.get(55)).setAttribute("onchange","onChangeMagnitud();" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(60)).setAttribute("nombre","cbUnidMedOrigen" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(65)).setAttribute("nombre","cbUnidMedDestino" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(76)).setAttribute("accion","accionBuscar();" );
      ((Element)v.get(76)).setAttribute("estado","false" );
      ((Element)v.get(76)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ...
      ((Element)v.get(77)).setAttribute("alto","330" );
      ((Element)v.get(77)).setAttribute("x","5" );
      ((Element)v.get(77)).setAttribute("y","120" );
      ...
      ((Element)v.get(77)).setAttribute("visibilidad","" );
      ...
      ((Element)v.get(78)).setAttribute("ancho","369" );
      ((Element)v.get(78)).setAttribute("alto","301" );
      ...
      ((Element)v.get(81)).setAttribute("aximROver","bot_despliega_columna_over.gif" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(96)).setAttribute("alto","25" );
      ...
      ((Element)v.get(97)).setAttribute("cod","MaeMagni.codMagn.label" );
      ((Element)v.get(96)).appendChild((Element)v.get(97));

      /* Elemento padre:97 / Elemento actual: 98   */
      v.add(doc.createTextNode("Magnitud"));
      ...
      ((Element)v.get(99)).setAttribute("cod","3099" );
      ((Element)v.get(96)).appendChild((Element)v.get(99));

      /* Elemento padre:99 / Elemento actual: 100   */
      v.add(doc.createTextNode("Unidad de medida origen"));
      ...
      ((Element)v.get(101)).setAttribute("cod","3100" );
      ((Element)v.get(96)).appendChild((Element)v.get(101));

      /* Elemento padre:101 / Elemento actual: 102   */
      v.add(doc.createTextNode("Unidad de medida destino"));
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(105)).setAttribute("cod","MaeMagni.codMagn.label" );
      ((Element)v.get(96)).appendChild((Element)v.get(105));

      /* Elemento padre:105 / Elemento actual: 106   */
      v.add(doc.createTextNode("OID Magnitud"));
      ...
      ((Element)v.get(107)).setAttribute("cod","3099" );
      ((Element)v.get(96)).appendChild((Element)v.get(107));

      /* Elemento padre:107 / Elemento actual: 108   */
      v.add(doc.createTextNode("OID Unidad de medida origen"));
      ...
      ((Element)v.get(109)).setAttribute("cod","3100" );
      ((Element)v.get(96)).appendChild((Element)v.get(109));

      /* Elemento padre:109 / Elemento actual: 110   */
      v.add(doc.createTextNode("OID Unidad de medida destino"));
      ...
      /* Empieza nodo:120 / Elemento padre: 78   */
      v.add(doc.createElement("PAGINADO"));
      ((Element)v.get(120)).setAttribute("nombre","mipgndo" );
      ((Element)v.get(120)).setAttribute("ancho","679" );
      ((Element)v.get(120)).setAttribute("sep","$" );
      ((Element)v.get(120)).setAttribute("x","12" );
      ((Element)v.get(120)).setAttribute("class","botonera" );
      ((Element)v.get(120)).setAttribute("y","294" );
      ((Element)v.get(120)).setAttribute("control","|" );
      ((Element)v.get(120)).setAttribute("conector","ConectorBuscarCargosAbonos" );
      ((Element)v.get(120)).setAttribute("rowset","" );
      ((Element)v.get(120)).setAttribute("cargainicial","N" );
      ((Element)v.get(120)).setAttribute("onload","procesarPaginado(mipgndo,msgError, ultima, rowset, 'muestraLista(ultima, rowset)')" );
      ((Element)v.get(78)).appendChild((Element)v.get(120));
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(122)).setAttribute("y","282" );
      ...
      ((Element)v.get(123)).setAttribute("y","282" );
      ...
      ((Element)v.get(77)).appendChild((Element)v.get(124));
      /* Termina nodo:124   */

      /* Empieza nodo:125 / Elemento padre: 77   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(125)).setAttribute("nombre","btnModificar" );
      ((Element)v.get(125)).setAttribute("x","80" );
      ((Element)v.get(125)).setAttribute("y","279" );
      ...
      ((Element)v.get(125)).setAttribute("cod","MMGGlobal.updateButton.label" );
      ((Element)v.get(125)).setAttribute("accion","accionModificar();" );
      ((Element)v.get(77)).appendChild((Element)v.get(125));
      /* Termina nodo:125   */

      /* Empieza nodo:126 / Elemento padre: 77   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(126)).setAttribute("nombre","btnDetalle" );
      ((Element)v.get(126)).setAttribute("x","80" );
      ((Element)v.get(126)).setAttribute("y","279" );
      ...
      ((Element)v.get(126)).setAttribute("cod","MMGGlobal.viewButton.label" );
      ((Element)v.get(126)).setAttribute("accion","accionDetalle();" );
      ((Element)v.get(77)).appendChild((Element)v.get(126));
      /* Termina nodo:126   */
      /* Termina nodo:77   */
      /* Termina nodo:7   */
