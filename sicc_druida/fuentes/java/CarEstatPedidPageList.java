...
public class CarEstatPedidPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","carEstatPedidList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","CarEstatPedid.codEsta.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","CarEstatPedid.Descripcion.label" );
