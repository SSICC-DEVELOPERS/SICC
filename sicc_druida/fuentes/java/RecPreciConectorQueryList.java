...
public class RecPreciConectorQueryList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad RecPreci" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGRecPreciQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGRecPreciQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","RecPreciListFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","codPrec" );
