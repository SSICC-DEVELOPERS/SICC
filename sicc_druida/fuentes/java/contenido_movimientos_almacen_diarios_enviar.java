...
public class contenido_movimientos_almacen_diarios_enviar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_movimientos_almacen_diarios_enviar" );
      ((Element)v.get(0)).setAttribute("cod","0258" );
      ((Element)v.get(0)).setAttribute("titulo","Enviar movimientos de almacén diarios" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(3)).setAttribute("src","contenido_movimientos_almacen_diarios_enviar.js" );
      ...
      ((Element)v.get(5)).setAttribute("name","cbTipoMovimiento" );
      ((Element)v.get(5)).setAttribute("required","true" );
      ((Element)v.get(5)).setAttribute("cod","304" );
      ((Element)v.get(5)).setAttribute("group","tipoMovimiento" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(11)).setAttribute("nombre","hcanal" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(12)).setAttribute("nombre","hacceso" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(13)).setAttribute("nombre","hsubacceso" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(15)).setAttribute("nombre","tiposMovimiento" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(16)).setAttribute("nombre","subaccesos" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(47)).setAttribute("nombre","lblLote" );
   }
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(47)).setAttribute("cod","680" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(51)).setAttribute("nombre","lblObservaciones" );
      ((Element)v.get(51)).setAttribute("alto","13" );
      ((Element)v.get(51)).setAttribute("filas","1" );
      ((Element)v.get(51)).setAttribute("id","datosTitle" );
      ((Element)v.get(51)).setAttribute("cod","169" );
      ...
      ((Element)v.get(62)).setAttribute("cols","50" );
      ((Element)v.get(62)).setAttribute("id","datosCampos" );
      ((Element)v.get(62)).setAttribute("msjreq","" );
      ((Element)v.get(62)).setAttribute("nombre","areatxtObservaciones" );
      ((Element)v.get(62)).setAttribute("readonly","N" );
      ((Element)v.get(62)).setAttribute("req","N" );
      ((Element)v.get(62)).setAttribute("rows","3" );
      ((Element)v.get(62)).setAttribute("tabindex","2" );
      ((Element)v.get(62)).setAttribute("onshtab","onShTab();" );
      ((Element)v.get(62)).setAttribute("valor","" );
      ((Element)v.get(62)).setAttribute("max","256" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(86)).setAttribute("onchange","canalOnChange();" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(91)).setAttribute("onchange","accesoOnChange();" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(121)).setAttribute("nombre","cbTipoMovimiento" );
