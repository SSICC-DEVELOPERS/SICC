...
public class ZonRegioPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","zonRegioList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(21)).setAttribute("cod","ZonRegio.codRegi.label" );
      ...
      ((Element)v.get(22)).setAttribute("cod","ZonRegio.indActi.label" );
      ...
      ((Element)v.get(23)).setAttribute("cod","ZonRegio.indBorr.label" );
      ...
      ((Element)v.get(24)).setAttribute("cod","ZonRegio.codNse1.label" );
      ...
      ((Element)v.get(25)).setAttribute("cod","ZonRegio.codNse2.label" );
      ...
      ((Element)v.get(26)).setAttribute("cod","ZonRegio.codNse3.label" );
      ...
      ((Element)v.get(27)).setAttribute("cod","ZonRegio.zsgvOidSubgVent.label" );
      ...
      ((Element)v.get(28)).setAttribute("cod","ZonRegio.desRegi.label" );
      ...
      ((Element)v.get(29)).setAttribute("cod","ZonRegio.clieOidClie.label" );
      ...
      ((Element)v.get(30)).setAttribute("cod","ZonRegio.fecRezo.label" );
