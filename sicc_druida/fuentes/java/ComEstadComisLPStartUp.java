/*
    INDRA/CAR/mmg
    $Id: ComEstadComisLPStartUp.java,v 1.1 2009/12/03 18:42:36 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class ComEstadComisLPStartUp extends MMGDruidaBase{
	...
	public static final String BUSINESSID_QUERY = "MMGComEstadComisQueryFromToUserPage";
	...
	public ComEstadComisLPStartUp(){
		super();
	}

	public void inicio() throws Exception {
		pagina("ComEstadComisPage");
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "ComEstadComisPage", "cod", "ComEstadComis." + accion + ".label");
			...
			limpiarBotoneraLista("comEstadComis", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codEstaComi", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 2);");
		...
		//asignarAtributo("CAPA", "comEstadComisLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "ComEstadComisPage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("ComEstadComisLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		ComEstadComisData comEstadComisQuery= new ComEstadComisData();
		comEstadComisQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		ComEstadComisData datosResult = (ComEstadComisData)getSingleObject(BUSINESSID_QUERY, comEstadComisQuery, 
			comEstadComisQuery.clone(), "comEstadComis");
		...
		preservaHiddensI18n(new Integer(1), "COM_ESTAD_COMIS", "comEstadComisFrm", "Descripcion", true);
		...
		ComEstadComisData comEstadComis = datosResult;
		asignar("TEXT", "codEstaComi", FormatUtils.formatObject(comEstadComis.getCodEstaComi(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "Descripcion", FormatUtils.formatObject(comEstadComis.getDescripcion(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		loadLocalizationVars(comEstadComis);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "codEstaComi", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "COM_ESTAD_COMIS", "comEstadComisFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "codEstaComi", "req", "S");
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('comEstadComisFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "comEstadComisFrm", "oculto", "N");
		...
		traza("MMG::Creando ComEstadComis");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		ComEstadComisData comEstadComisQuery= new ComEstadComisData();
		comEstadComisQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(comEstadComis.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"comEstadComisFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"comEstadComisFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codEstaComi", "ontab","ejecutarAccionFocoModificacion(\"comEstadComisFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codEstaComi", "onshtab","ejecutarAccionFocoModificacion(\"comEstadComisFrm\",2, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"comEstadComisFrm\",3, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"comEstadComisFrm\",3, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","comEstadComisTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","comEstadComisTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","comEstadComisFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","comEstadComisListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","comEstadComisListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(ComEstadComisData comEstadComis) throws Exception{
	...
	* @param comEstadComis La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(ComEstadComisData comEstadComis) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		ComEstadComisData comEstadComis = 
			(ComEstadComisData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(comEstadComis);
		loadLeafDependenceCombos(comEstadComis);
	}
	...
	*/
	...
	protected void loadLocalizationVars(ComEstadComisData comEstadComis) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("COM_ESTAD_COMIS");
		mmgLocalizationQuery.setEntiPk(comEstadComis.getId());
