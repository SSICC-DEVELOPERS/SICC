...
public class contenido_grupo_crear_cambio  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_grupo_crear" );
      ((Element)v.get(0)).setAttribute("titulo","" );
      ((Element)v.get(0)).setAttribute("cod","0186" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(2)).setAttribute("src","contenido_grupo_crear.js" );
      ...
      v.add(doc.createTextNode("\r  \r   /*function onLoadPag(){\r    DrdEnsanchaConMargenDcho('listado1',12); \r    eval (ON_RSZ);\r   }*/\r	var arrLimpia = new Array();\r\r   function fGuardar(){ \r    if (get('frmContenido.hDeshabilitarCombo')!='S'){\r      if(!sicc_validaciones_generales(\"indCuadre\")){\r         return false;\r      }\r  }\r    if (listado1.datos.length<1){\r        GestionarMensaje('194');\r    \r    return;\r  }\r	if(sicc_validaciones_generales(\"factCuadre\")){  \r    set( 'frmContenido.textoCombo', get('frmContenido.cbIndicadorCuadre','T' ));\r	  set( 'frmContenido.valorCombo', get('frmContenido.cbIndicadorCuadre' ));\r	  set('frmContenido.hFactorCuadre', get('frmContenido.txtFactorCuadre' ));\r  set('frmContenido.accion', 'Guardar');\r    if(get('frmContenido.casoDeUso')=='modificar'){\r		set('frmContenido.conectorAction', 'LPModificarGrupo');\r  }else{\r		set('frmContenido.conectorAction', 'LPCrearGrupo');\r  }\r\r  enviaSICC('frmContenido');\r  }\r}\r\rfunction tabBoton(){\r    if( get('frmContenido.hDeshabilitarCombo') == 'S' ){\r      focaliza('frmContenido.txtFactorCuadre','');\r    }\r    else{\r      focaliza('frmContenido.cbIndicadorCuadre','');\r    }\r}\r\rfunction shTabBoton(){\r    if( get('frmContenido.hDeshabilitarFactorCuadre') == 'S' ){\r      focaliza('frmContenido.cbIndicadorCuadre','');\r    }\r    else{\r      focaliza('frmContenido.txtFactorCuadre','');\r    }\r}\r\rfunction shTabFactor(){\r    if( get('frmContenido.hDeshabilitarCombo') == 'S' ){\r      document.all.BuscarDiv.focus();\r    }\r    else{\r      focaliza('frmContenido.cbIndicadorCuadre','');\r    }\r}\r\rfunction tabCombo(){\r    if( get('frmContenido.hDeshabilitarFactorCuadre') == 'S' ){\r      document.all.BuscarDiv.focus();\r    }\r    else{\r      focaliza('frmContenido.txtFactorCuadre','');\r    }\r}\r\r\rfunction fLimpiar(){\r    if( get('frmContenido.hDeshabilitarFactorCuadre') != 'S' ){\r      		set('frmContenido.txtFactorCuadre',arrLimpia[1]);\r	 }\r    if( get('frmContenido.hDeshabilitarCombo') == 'S' ){\r      focaliza('frmContenido.txtFactorCuadre','');\r    }\r    else{\r      		set('frmContenido.cbIndicadorCuadre',arrLimpia[0]);\r		focaliza('frmContenido.cbIndicadorCuadre','');\r    }\r}\r\rfunction fBorrar(){\r  var codigo = \"\";\r  var sCodigo = \"\";\r  codigo = listado1.codSeleccionados();\r  var i = 0;\r\r  if (listado1.numSelecc() < 1){\r    GestionarMensaje('4');\r    return;\r  }\r\r  if(listado1.numSelecc() > 0){\r    if(GestionarMensaje('5')){\r      for( i = 0; i < codigo.length; i++ ){\r        sCodigo += codigo[i];\r        sCodigo += '|';\r      }\r\r      set('frmContenido.elementosSeleccionadosProductosAsociados', sCodigo);\r      set('frmContenido.accion', 'Eliminar productos');\r	    if(get('frmContenido.casoDeUso')=='modificar'){\r		set('frmContenido.conectorAction', 'LPModificarGrupo');\r		}else{\r			set('frmContenido.conectorAction', 'LPCrearGrupo');\r  	     }\r      enviaSICC('frmContenido');\r    }\r  }\r}\r\rfunction onLoadPag()   {\r  varNoLimpiarSICC=true;\r  configurarMenuSecundario('frmContenido');\r  if(get('frmContenido.casoDeUso')=='modificar'){\r		btnProxy(2,\"0\");\r		btnProxy(7,\"0\");\r		btnProxy(8,\"0\");\r  }\r  DrdEnsanchaConMargenDcho('listado1',12);\r  eval (ON_RSZ);  \r\r  asignarCombo();\r  \r  if( get('frmContenido.hDeshabilitarCombo') == 'S' ){\r    accion('frmContenido.cbIndicadorCuadre', '.disabled=\"true\"');\r	 focaliza('frmContenido.txtFactorCuadre');\r  }\r  if( get('frmContenido.hDeshabilitarFactorCuadre') == 'S' ){\r    accion('frmContenido.txtFactorCuadre', '.disabled=\"true\"');\r	   if( get('frmContenido.hDeshabilitarCombo') != 'S' )\r			 focaliza('frmContenido.cbIndicadorCuadre');\r  }  \r  if (listado1.datos.length > 0) {\r    btnProxy(4, '1');\r  } else {\r    btnProxy(4, '0');\r  }\r	arrLimpia[0]= get('frmContenido.cbIndicadorCuadre');\r	arrLimpia[1]= get('frmContenido.txtFactorCuadre');\r  }\r\rfunction asignarCombo(){\r  var seleccionados = new Array();\r  \r  seleccionados[0] = get('frmContenido.valorCombo');\r  set('frmContenido.cbIndicadorCuadre', seleccionados);\r}\r\rfunction buscar(){\r\r  set('frmContenido.accion', 'Buscar producto');\r\r  if(get('frmContenido.casoDeUso')=='modificar'){\r		set('frmContenido.conectorAction', 'LPModificarGrupo');\r  }else{\r		set('frmContenido.conectorAction', 'LPCrearGrupo');\r  }\r  enviarFormulario();\r}\r\rfunction enviarFormulario(){\r  set( 'frmContenido.valorCombo', get( 'frmContenido.cbIndicadorCuadre' ) );\r  set('frmContenido.hFactorCuadre', get( 'frmContenido.txtFactorCuadre' ));\r  if(get('frmContenido.casoDeUso')=='modificar'){\r		set('frmContenido.conectorAction', 'LPModificarGrupo');\r  }else{\r		set('frmContenido.conectorAction', 'LPCrearGrupo');\r  }\r  enviaSICC('frmContenido');\r}\r              function arrayComponentes(){\r              var arr = new Array();\r              arr[arr.length]= new Array(\"cbIndicadorCuadre\",\"\");\r              arr[arr.length]= new Array(\"txtFactorCuadre\",\"\");      \r              arr[arr.length]= new Array(\"Buscar\",\"BOTONXY\");\r                                 \r              return arr;\r          }\r          function tabGenerico(nombreComp, tipotab){       \r            var arr = arrayComponentes();\r            var tabular = false;\r            var nombreFormulario = getFormularioSICC();\r            var j = 0;\r            var k = arr.length;\r            if (tipotab != \"sh\") {\r                j = j-1;                \r                k = k-1;\r            }\r\r            while(j<k){\r                var t;\r                if(tipotab == \"sh\"){\r                  k--;\r                  t = k;\r                } else{\r                  j++;\r                  t = j;                  \r                }\r                  \r                var nombre = arr[t][0];\r                var tipo = arr[t][1];\r                if (tabular==false){\r                  if (nombreComp==nombre){\r                      tabular=true;\r                      if (tipotab == \"sh\"){\r                        if (k==0) k= arr.length;\r                      } else {\r                        if ((j+1)==arr.length)  j = -1;\r                      }\r                  }                \r                } else {\r                  try {\r                    var name = nombreFormulario+\".\"+nombre;\r                    if (tipo==\"BOTONXY\"){\r                       focalizaBotonHTML_XY(nombre);\r                    } else if (tipo==\"BOTON\") {\r                       focalizaBotonHTML(\"botonContenido\",nombre)\r                    } else {\r                       focaliza(name);\r                    }\r                    return;\r                  } catch (e) {\r                    if (tipotab == \"sh\") {if (k==0) k= arr.length;} else \r                    {if ((j+1)==arr.length)  j = -1;}                    \r                  }\r                }\r            }\r          }\r    \r  "));
      ...
      ((Element)v.get(6)).setAttribute("name","cbIndicadorCuadre" );
      ((Element)v.get(6)).setAttribute("required","true" );
      ((Element)v.get(6)).setAttribute("cod","461" );
      ((Element)v.get(6)).setAttribute("group","indCuadre" );
      ((Element)v.get(5)).appendChild((Element)v.get(6));
      /* Termina nodo:6   */

      /* Empieza nodo:7 / Elemento padre: 5   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(7)).setAttribute("name","txtFactorCuadre" );
      ((Element)v.get(7)).setAttribute("required","false" );
      ((Element)v.get(7)).setAttribute("cod","459" );
      ((Element)v.get(7)).setAttribute("format","e" );
      ((Element)v.get(7)).setAttribute("min","0" );
      ((Element)v.get(7)).setAttribute("max","9999999999" );
      ((Element)v.get(7)).setAttribute("group","factCuadre" );
      ...
      ((Element)v.get(9)).setAttribute("valor","LPCrearGrupo" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(12)).setAttribute("nombre","hidNroGrupo" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(13)).setAttribute("nombre","elementosSeleccionadosProductosAsociados" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(14)).setAttribute("nombre","hDeshabilitarCombo" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(15)).setAttribute("nombre","hDeshabilitarFactorCuadre" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(16)).setAttribute("nombre","hFactorCuadre" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(17)).setAttribute("nombre","valorCombo" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(18)).setAttribute("nombre","textoCombo" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(19)).setAttribute("nombre","varIndCuadre" );
      ...
      ((Element)v.get(20)).setAttribute("colorf","#F0F0F0" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(20)).setAttribute("visibilidad","" );
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(39)).setAttribute("width","472" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(47)).setAttribute("nombre","lblNGrupo" );
      ...
      ((Element)v.get(47)).setAttribute("cod","533" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(51)).setAttribute("nombre","lblTipoGrupo" );
      ((Element)v.get(51)).setAttribute("alto","13" );
      ((Element)v.get(51)).setAttribute("filas","1" );
      ((Element)v.get(51)).setAttribute("valor","" );
      ((Element)v.get(51)).setAttribute("id","datosTitle" );
      ((Element)v.get(51)).setAttribute("cod","479" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(55)).setAttribute("nombre","lblIndicadorCuadre" );
      ...
      ((Element)v.get(55)).setAttribute("cod","461" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(59)).setAttribute("nombre","lblFactorCuadre" );
      ...
      ((Element)v.get(59)).setAttribute("cod","459" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(66)).setAttribute("nombre","lblNGrupoX" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(70)).setAttribute("nombre","lblTipoGrupoX" );
      ...
      ((Element)v.get(74)).setAttribute("nombre","cbIndicadorCuadre" );
      ...
      ((Element)v.get(74)).setAttribute("ontab","tabGenerico('cbIndicadorCuadre');" );
      ((Element)v.get(74)).setAttribute("onshtab","tabGenerico('cbIndicadorCuadre','sh');" );
      ...
      ((Element)v.get(79)).setAttribute("nombre","txtFactorCuadre" );
      ...
      ((Element)v.get(79)).setAttribute("ontab","tabGenerico('txtFactorCuadre');" );
      ((Element)v.get(79)).setAttribute("onshtab","tabGenerico('txtFactorCuadre','sh');" );
      ((Element)v.get(78)).appendChild((Element)v.get(79));
      /* Termina nodo:79   */
      /* Termina nodo:78   */

      /* Empieza nodo:80 / Elemento padre: 62   */
      v.add(doc.createElement("td"));
      ((Element)v.get(80)).setAttribute("width","100%" );
      ((Element)v.get(62)).appendChild((Element)v.get(80));
      ...
      /* Empieza nodo:85 / Elemento padre: 29   */
      v.add(doc.createElement("td"));
      ((Element)v.get(29)).appendChild((Element)v.get(85));
      ...
      /* Empieza nodo:87 / Elemento padre: 21   */
      v.add(doc.createElement("tr"));
   }

   private void getXML360(Document doc) {
      ((Element)v.get(21)).appendChild((Element)v.get(87));
      ...
      ((Element)v.get(94)).setAttribute("ancho","475" );
      ((Element)v.get(94)).setAttribute("alto","317" );
      ((Element)v.get(94)).setAttribute("x","12" );
      ((Element)v.get(94)).setAttribute("y","99" );
      ...
      ((Element)v.get(102)).setAttribute("cod","0067" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(115)).setAttribute("cod","8" );
      ...
      ((Element)v.get(119)).setAttribute("cod","608" );
      ...
      ((Element)v.get(121)).setAttribute("cod","581" );
      ...
      ((Element)v.get(123)).setAttribute("cod","529" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(125)).setAttribute("cod","530" );
      ...
      ((Element)v.get(127)).setAttribute("cod","481" );
      ...
      ((Element)v.get(129)).setAttribute("cod","482" );
      ...
      ((Element)v.get(131)).setAttribute("cod","483" );
      ...
      /* Empieza nodo:133 / Elemento padre: 94   */
      v.add(doc.createElement("DATOS"));
      ((Element)v.get(133)).setAttribute("alto","22" );
      ((Element)v.get(133)).setAttribute("accion","" );
      ((Element)v.get(133)).setAttribute("tipoEnvio","edicion" );
      ((Element)v.get(133)).setAttribute("formaEnvio","xml" );
      ((Element)v.get(133)).setAttribute("maxSel","-1" );
      ((Element)v.get(133)).setAttribute("msgErrMaxSel","" );
      ((Element)v.get(133)).setAttribute("coloresScrollNativo","#D4D0C8,black,white,#D4D0C8,#D4D0C8,#ECE9E4,black" );
      ((Element)v.get(133)).setAttribute("colorROver","#D0D9E8" );
      ((Element)v.get(133)).setAttribute("onLoad","" );
      ((Element)v.get(133)).setAttribute("colorSelecc","#D0D9E8" );
      ((Element)v.get(94)).appendChild((Element)v.get(133));
      ...
      /* Empieza nodo:143 / Elemento padre: 94   */
      v.add(doc.createElement("ROWSET"));
      ((Element)v.get(94)).appendChild((Element)v.get(143));
      /* Termina nodo:143   */

      /* Empieza nodo:144 / Elemento padre: 94   */
      v.add(doc.createElement("PAGINADO"));
      ((Element)v.get(144)).setAttribute("nombre","mipgndo" );
      ((Element)v.get(144)).setAttribute("ancho","475" );
      ((Element)v.get(144)).setAttribute("sep","$" );
      ((Element)v.get(144)).setAttribute("x","12" );
      ((Element)v.get(144)).setAttribute("class","botonera" );
      ((Element)v.get(144)).setAttribute("y","393" );
      ...
      ((Element)v.get(94)).appendChild((Element)v.get(144));
      /* Termina nodo:144   */
      /* Termina nodo:94   */

      /* Empieza nodo:145 / Elemento padre: 8   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(145)).setAttribute("nombre","Buscar" );
   }

   private void getXML630(Document doc) {
      ((Element)v.get(145)).setAttribute("x","13" );
      ...
      ((Element)v.get(145)).setAttribute("accion","buscar();" );
      ((Element)v.get(145)).setAttribute("ontab","tabGenerico('Buscar');" );
      ((Element)v.get(145)).setAttribute("onshtab","tabGenerico('Buscar','sh');" );
      ((Element)v.get(8)).appendChild((Element)v.get(145));
      /* Termina nodo:145   */

      /* Empieza nodo:146 / Elemento padre: 8   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(146)).setAttribute("nombre","Modificar" );
      ((Element)v.get(146)).setAttribute("x","65" );
      ...
      ((Element)v.get(146)).setAttribute("cod","2" );
      ((Element)v.get(146)).setAttribute("accion","" );
      ((Element)v.get(146)).setAttribute("ontab","tabGenerico('Modificar');" );
      ((Element)v.get(146)).setAttribute("onshtab","tabGenerico('Modificar','sh');" );
      ...
      ((Element)v.get(147)).setAttribute("alto","12" );
      ...
      ((Element)v.get(147)).setAttribute("y","416" );
