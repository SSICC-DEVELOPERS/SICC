...
public class ConectorBuscarProductosDTO  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","ConectorBuscarProductosDTO" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","DTOEBuscarProductosDTO" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(6)).setAttribute("NOMBRE","OID_PROD" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(9)).setAttribute("NOMBRE","IDIO_OID_IDIO" );
