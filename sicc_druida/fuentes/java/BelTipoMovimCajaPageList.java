...
public class BelTipoMovimCajaPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","belTipoMovimCajaList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","BelTipoMovimCaja.codCaja.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","BelTipoMovimCaja.desTipoMoviCaja.label" );
      ...
      ((Element)v.get(17)).setAttribute("cod","BelTipoMovimCaja.valSign.label" );
      ...
      ((Element)v.get(18)).setAttribute("cod","BelTipoMovimCaja.indAuto.label" );
