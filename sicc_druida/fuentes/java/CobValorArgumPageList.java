...
public class CobValorArgumPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","cobValorArgumList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","CobValorArgum.valArgu.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","CobValorArgum.arguOidArgu.label" );
