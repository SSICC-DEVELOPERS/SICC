/*
    INDRA/CAR/mmg
    $Id: MaeTipoNivelSocecPersoLPStartUp.java,v 1.1 2009/12/03 18:39:00 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class MaeTipoNivelSocecPersoLPStartUp extends MMGDruidaBase{
	...
	public static final String BUSINESSID_QUERY = "MMGMaeTipoNivelSocecPersoQueryFromToUserPage";
	...
	public MaeTipoNivelSocecPersoLPStartUp(){
		super();
	}

	public void inicio() throws Exception {
		pagina("MaeTipoNivelSocecPersoPage");
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			buildJsPageSize("MaeTipoNivelSocecPerso");
			...
			asignarAtributo("PAGINA", "MaeTipoNivelSocecPersoPage", "cod", "MaeTipoNivelSocecPerso." + accion + ".label");
			...
			limpiarBotoneraLista("maeTipoNivelSocecPerso", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codNsep", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 3);");
		...
		//asignarAtributo("CAPA", "maeTipoNivelSocecPersoLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "MaeTipoNivelSocecPersoPage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("MaeTipoNivelSocecPersoLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		MaeTipoNivelSocecPersoData maeTipoNivelSocecPersoQuery= new MaeTipoNivelSocecPersoData();
		maeTipoNivelSocecPersoQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		MaeTipoNivelSocecPersoData datosResult = (MaeTipoNivelSocecPersoData)getSingleObject(BUSINESSID_QUERY, maeTipoNivelSocecPersoQuery, 
			maeTipoNivelSocecPersoQuery.clone(), "maeTipoNivelSocecPerso");
		...
		preservaHiddensI18n(new Integer(1), "MAE_TIPO_NIVEL_SOCEC_PERSO", "maeTipoNivelSocecPersoFrm", "Descripcion", true);
		...
		MaeTipoNivelSocecPersoData maeTipoNivelSocecPerso = datosResult;
		asignar("TEXT", "codNsep", FormatUtils.formatObject(maeTipoNivelSocecPerso.getCodNsep(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "Descripcion", FormatUtils.formatObject(maeTipoNivelSocecPerso.getDescripcion(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		loadLocalizationVars(maeTipoNivelSocecPerso);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "codNsep", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "MAE_TIPO_NIVEL_SOCEC_PERSO", "maeTipoNivelSocecPersoFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "codNsep", "req", "S");
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('maeTipoNivelSocecPersoFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "maeTipoNivelSocecPersoFrm", "oculto", "N");
		...
		traza("MMG::Creando MaeTipoNivelSocecPerso");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		MaeTipoNivelSocecPersoData maeTipoNivelSocecPersoQuery= new MaeTipoNivelSocecPersoData();
		maeTipoNivelSocecPersoQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(maeTipoNivelSocecPerso.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"maeTipoNivelSocecPersoFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"maeTipoNivelSocecPersoFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codNsep", "ontab","ejecutarAccionFocoModificacion(\"maeTipoNivelSocecPersoFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codNsep", "onshtab","ejecutarAccionFocoModificacion(\"maeTipoNivelSocecPersoFrm\",2, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"maeTipoNivelSocecPersoFrm\",3, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"maeTipoNivelSocecPersoFrm\",3, false)");
					asignarAtributo("COMBO","paisOidPais", "ontab", "ejecutarAccionFocoModificacion(\"maeTipoNivelSocecPersoFrm\",4, true)");
					asignarAtributo("COMBO","paisOidPais", "onshtab", "ejecutarAccionFocoModificacion(\"maeTipoNivelSocecPersoFrm\",4, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","maeTipoNivelSocecPersoTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","maeTipoNivelSocecPersoTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codNsep...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","maeTipoNivelSocecPersoFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","maeTipoNivelSocecPersoListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","maeTipoNivelSocecPersoListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(MaeTipoNivelSocecPersoData maeTipoNivelSocecPerso) throws Exception{
		...
		if(maeTipoNivelSocecPerso != null && maeTipoNivelSocecPerso.getPaisOidPais() != null){
				checkCombo("paisOidPais" , maeTipoNivelSocecPerso.getPaisOidPais().getId().toString());
			}
	...
	* @param maeTipoNivelSocecPerso La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(MaeTipoNivelSocecPersoData maeTipoNivelSocecPerso) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		MaeTipoNivelSocecPersoData maeTipoNivelSocecPerso = 
			(MaeTipoNivelSocecPersoData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(maeTipoNivelSocecPerso.getPaisOidPais() != null){
			maeTipoNivelSocecPerso.setPaisOidPais((es.indra.belcorp.mso.SegPaisViewData)
			getSingleObject(BUSINESSID_PAISOIDPAIS_QUERY, 
			maeTipoNivelSocecPerso.getPaisOidPais(),
			maeTipoNivelSocecPerso.getPaisOidPais().clone(),
			"segPaisView"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(maeTipoNivelSocecPerso);
		loadLeafDependenceCombos(maeTipoNivelSocecPerso);
	}
	...
	*/
	...
	protected void loadLocalizationVars(MaeTipoNivelSocecPersoData maeTipoNivelSocecPerso) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("MAE_TIPO_NIVEL_SOCEC_PERSO");
		mmgLocalizationQuery.setEntiPk(maeTipoNivelSocecPerso.getId());
