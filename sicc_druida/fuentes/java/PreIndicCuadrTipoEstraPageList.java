...
public class PreIndicCuadrTipoEstraPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","preIndicCuadrTipoEstraList" );
      ...
      ((Element)v.get(14)).setAttribute("cod","PreIndicCuadrTipoEstra.indcOidIndiCuad.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","PreIndicCuadrTipoEstra.tiesOidTipoEstr.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","PreIndicCuadrTipoEstra.indOferMonoGrup.label" );
