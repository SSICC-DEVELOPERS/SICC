...
public class contenido_registro_postulaciones_consultoras_obtener  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_registro_postulaciones_consultoras_obtener" );
      ((Element)v.get(0)).setAttribute("cod","0758" );
      ((Element)v.get(0)).setAttribute("titulo","Obtener registro de postulaciones a consultoras" );
      ...
      v.add(doc.createTextNode("\r   \r   \r   function onLoad(){\r      configurarMenuSecundario('Formulario');\r      fMostrarMensajeError();\r      focaliza('Formulario.cbMarca');\r   }\r   function generar(formato){\r     if(sicc_validaciones_generales()){\r        \r           /*recolectarParametros();\r           set('Formulario.conectorAction', 'CALPostulacionesConsultoras');           \r           set('Formulario.accion', 'generar');\r           \r           set('Formulario.reporte', formato);\r           \r           enviaSICC('Formulario');*/\r           var a = new Object();\r           a.accion = 'generar';\r           a.marca = get('Formulario.cbMarca');\r           a.canal = get('Formulario.cbCanal');\r           a.periodo = get('Formulario.cbPeriodo');\r           a.periodoDesc = get('Formulario.cbPeriodo', 'T');\r           a.sgv = get('Formulario.cbSubgerenciaVenta');\r           a.region = get('Formulario.cbRegion');\r           a.zona = get('Formulario.cbZona');  \r           a.reporte = formato;\r           mostrarModalSICC('CALPostulacionesConsultoras','generar', a);  \r        \r     }\r   }\r\r   function recolectarParametros(){\r           \r      set('Formulario.marca', get('Formulario.cbMarca'));\r      set('Formulario.canal', get('Formulario.cbCanal'));\r      set('Formulario.periodo', get('Formulario.cbPeriodo'));\r      set('Formulario.sgv', get('Formulario.cbSubgerenciaVenta'));\r      set('Formulario.region', get('Formulario.cbRegion'));\r      set('Formulario.zona', get('Formulario.cbZona'));\r            \r   }\r \r   \r\r   function fLimpiar(){\r     \r      var aCombo = new Array(new Array(\"\",\"\"));\r      set_combo('Formulario.cbSubgerenciaVenta', aCombo, []);\r      set_combo('Formulario.cbRegion', aCombo, []);\r      set_combo('Formulario.cbZona', aCombo, []);\r      set_combo('Formulario.cbPeriodo', aCombo, []);\r      focaliza('Formulario.cbMarca');\r   }\r   \r   \r   function onChangeMarcaCanal(){\r      \r      var pais = get('Formulario.pais');\r      var marca = get('Formulario.cbMarca');\r      var canal = get('Formulario.cbCanal');\r      var idioma = get('Formulario.idioma');\r      \r      if(marca != '' && canal != ''){\r          \r                    var arr2 = new Array();\r          arr2[arr2.length] = [\"oidMarca\", marca]; \r          arr2[arr2.length] = [\"oidCanal\", canal]; \r          recargaCombo(\"Formulario.cbSubgerenciaVenta\",\"ZONRecargaSubgerenciaVentas\", \"es.indra.sicc.dtos.zon.DTOUnidadAdministrativa\",arr2);\r          \r                    var arr = new Array();\r          arr[arr.length] = [\"oidIdioma\", idioma]; \r          arr[arr.length] = [\"oidPais\", pais]; \r          arr[arr.length] = [\"marca\", marca];\r          arr[arr.length] = [\"canal\", canal];\r          recargaCombo(\"Formulario.cbPeriodo\",\"PRECargarPeriodos\",\"es.indra.sicc.dtos.cra.DTOPeriodo\",arr);\r      }else{\r          var aCombo = new Array(new Array(\"\",\"\"));\r          set_combo('Formulario.cbSubgerenciaVenta', aCombo, []);\r          set_combo('Formulario.cbRegion', aCombo, []);\r          set_combo('Formulario.cbZona', aCombo, []);\r          set_combo('Formulario.cbPeriodo', aCombo, []);\r       \r      }\r      \r   \r   }\r   \r\r   function onchangeSGV(){\r      var sgv = get('Formulario.cbSubgerenciaVenta');\r\r      if(sgv != ''){\r        recargaCombo('Formulario.cbRegion', 'ZONRecargaRegiones', 'es.indra.sicc.dtos.zon.DTOUnidadAdministrativa',[[ \"oidSGV\", get('Formulario.cbSubgerenciaVenta') ]] ); \r      }else{\r         var aCombo = new Array(new Array(\"\",\"\"));\r         set_combo('Formulario.cbRegion', aCombo, []);\r         set_combo('Formulario.cbZona', aCombo, []);\r      }\r   \r   }\r\r \r   function onchange_Region(){\r   \r      var region = get('Formulario.cbRegion');\r\r      if(region != ''){\r        recargaCombo('Formulario.cbZona', 'ZONRecargaZonas', 'es.indra.sicc.dtos.zon.DTOUnidadAdministrativa',[[ \"oidRegion\", get('Formulario.cbRegion') ]] ); \r      }else{\r         var aCombo = new Array(new Array(\"\",\"\"));\r         set_combo('Formulario.cbZona', aCombo, []);\r      }\r    }         \r\r      \r\r\r   \r"));
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(22)).setAttribute("nombre","regionDesc" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(24)).setAttribute("nombre","reporte" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(60)).setAttribute("nombre","lblPeriodo" );
      ...
      ((Element)v.get(67)).setAttribute("onshtab","focalizaBotonHTML('botonContenido','btnGenerarExcelRegiones');" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(77)).setAttribute("nombre","cbPeriodo" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(91)).setAttribute("nombre","lblSubgerenciaVenta" );
      ((Element)v.get(91)).setAttribute("alto","13" );
      ((Element)v.get(91)).setAttribute("filas","1" );
      ((Element)v.get(91)).setAttribute("id","datosTitle" );
      ((Element)v.get(91)).setAttribute("cod","124" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(102)).setAttribute("nombre","cbSubgerenciaVenta" );
      ...
      ((Element)v.get(102)).setAttribute("onchange","onchangeSGV();" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(107)).setAttribute("nombre","cbRegion" );
      ...
      ((Element)v.get(107)).setAttribute("onchange","onchange_Region();" );
      ...
      /* Empieza nodo:114 / Elemento padre: 41   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(41)).appendChild((Element)v.get(114));
   ...
   private void getXML450(Document doc) {
      ...
      /* Empieza nodo:135 / Elemento padre: 34   */
      v.add(doc.createElement("td"));
      ((Element)v.get(34)).appendChild((Element)v.get(135));
      ...
      /* Empieza nodo:137 / Elemento padre: 26   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(26)).appendChild((Element)v.get(137));
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(145)).setAttribute("nombre","btnGenerarInformeZonasRegiones" );
      ((Element)v.get(145)).setAttribute("ID","botonContenido" );
      ((Element)v.get(145)).setAttribute("tipo","html" );
      ((Element)v.get(145)).setAttribute("accion","generar('RD_REP-089_01')" );
      ((Element)v.get(145)).setAttribute("estado","false" );
      ((Element)v.get(145)).setAttribute("cod","2545" );
      ((Element)v.get(144)).appendChild((Element)v.get(145));
      /* Termina nodo:145   */

      /* Empieza nodo:146 / Elemento padre: 144   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(146)).setAttribute("nombre","btnGenerarExcelRegiones" );
      ((Element)v.get(146)).setAttribute("ID","botonContenido" );
      ((Element)v.get(146)).setAttribute("tipo","html" );
      ((Element)v.get(146)).setAttribute("accion","generar('RD_REP-089_02')" );
      ((Element)v.get(146)).setAttribute("estado","false" );
      ((Element)v.get(146)).setAttribute("cod","2546" );
      ...
      /* Empieza nodo:149 / Elemento padre: 26   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(26)).appendChild((Element)v.get(149));
