...
public class contenido_aptas_cursos  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_aptas_cursos" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(5)).setAttribute("src","contenido_aptas_cursos.js" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(10)).setAttribute("nombre","oidCurso" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(11)).setAttribute("nombre","oidCursoSeleccionado" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(12)).setAttribute("nombre","path" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(13)).setAttribute("nombre","oidAsigna" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(14)).setAttribute("nombre","valoresLista" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(22)).setAttribute("y","325" );
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(38)).setAttribute("colspan","5" );
      ...
      ((Element)v.get(39)).setAttribute("height","4" );
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(41)).setAttribute("class","datosTitle" );
      ...
      ((Element)v.get(42)).setAttribute("width","248" );
      ...
      ((Element)v.get(44)).setAttribute("nombre","lblNOptimoParticipantes" );
      ...
      ((Element)v.get(44)).setAttribute("cod","739" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(48)).setAttribute("nombre","lblNOptimoParticipantesXX" );
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(52)).setAttribute("colspan","5" );
      ...
      ((Element)v.get(53)).setAttribute("height","4" );
      ...
      /* Empieza nodo:56 / Elemento padre: 23   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(23)).appendChild((Element)v.get(56));
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(59)).setAttribute("width","756" );
      ...
      ((Element)v.get(63)).setAttribute("ancho","400" );
      ((Element)v.get(63)).setAttribute("alto","317" );
      ((Element)v.get(63)).setAttribute("x","12" );
      ((Element)v.get(63)).setAttribute("y","12" );
      ...
      ((Element)v.get(66)).setAttribute("maximROver","bot_despliega_columna_over.gif" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(71)).setAttribute("cod","0022" );
      ...
      ((Element)v.get(74)).setAttribute("ancho","100" );
      ...
      ((Element)v.get(80)).setAttribute("alto","20" );
      ...
      ((Element)v.get(82)).setAttribute("cod","1869" );
      ...
      ((Element)v.get(83)).setAttribute("cod","595" );
   ...
   private void getXML360(Document doc) {
      ((Element)v.get(84)).setAttribute("cod","1039" );
      ...
      ((Element)v.get(85)).setAttribute("cod","1141" );
      ...
      ((Element)v.get(86)).setAttribute("cod","2460" );
      ...
      ((Element)v.get(87)).setAttribute("maxSel","-1" );
      ...
      /* Empieza nodo:94 / Elemento padre: 63   */
      ...
      ((Element)v.get(94)).setAttribute("y","306" );
      ...
      ((Element)v.get(96)).setAttribute("y","310" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(99)).setAttribute("nombre","SeleccionarNoAsistentes" );
      ((Element)v.get(99)).setAttribute("x","80" );
      ((Element)v.get(99)).setAttribute("y","307" );
      ((Element)v.get(99)).setAttribute("ID","botonContenido" );
      ((Element)v.get(99)).setAttribute("accion","onClickConvocatoria()" );
      ((Element)v.get(99)).setAttribute("onshtab","document.all['Eliminar'].focus();" );
      ...
      ((Element)v.get(99)).setAttribute("cod","2461" );
      ((Element)v.get(6)).appendChild((Element)v.get(99));
      /* Termina nodo:99   */

      /* Empieza nodo:100 / Elemento padre: 6   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(100)).setAttribute("nombre","Eliminar" );
      ((Element)v.get(100)).setAttribute("x","386" );
      ((Element)v.get(100)).setAttribute("y","307" );
      ((Element)v.get(100)).setAttribute("ID","botonContenido" );
      ((Element)v.get(100)).setAttribute("accion","onClickEliminar()" );
      ((Element)v.get(100)).setAttribute("ontab","document.all['SeleccionarNoAsistentes'].focus();" );
      ...
      ((Element)v.get(100)).setAttribute("cod","1254" );
