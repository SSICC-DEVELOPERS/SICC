...
public class FacImpreVirtuPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","facImpreVirtuList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(16)).setAttribute("cod","FacImpreVirtu.codImpr.label" );
      ...
      ((Element)v.get(17)).setAttribute("cod","FacImpreVirtu.desImpr.label" );
      ...
      ((Element)v.get(18)).setAttribute("cod","FacImpreVirtu.tiimOidTipo.label" );
      ...
      ((Element)v.get(19)).setAttribute("cod","FacImpreVirtu.indEstaActi.label" );
      ...
      ((Element)v.get(20)).setAttribute("cod","FacImpreVirtu.valAtr1.label" );
