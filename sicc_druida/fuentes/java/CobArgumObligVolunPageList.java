...
public class CobArgumObligVolunPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","cobArgumObligVolunList" );
      ...
      ((Element)v.get(12)).setAttribute("cod","CobArgumObligVolun.codArguObliVolu.label" );
