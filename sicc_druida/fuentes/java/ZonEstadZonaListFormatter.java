...
/*
    INDRA/CAR/mmg
    $Id: ZonEstadZonaListFormatter.java,v 1.1 2009/12/03 18:41:53 pecbazalar Exp $
    DESC
*/
 ...
 * @author Indra
 */
public class ZonEstadZonaListFormatter extends MMGDruidaFormatoObjeto {
	
	public ZonEstadZonaListFormatter() {
	}
	...
	public void formatea(String s, Object obj) throws Exception {
		...
		for (int i = 0; i < zonEstadZonaList.size(); i++) {
			...
			row.add((zonEstadZonaData.getCodEstaZona() != null ? 
				...
				symbols) : ""));
			row.add((zonEstadZonaData.getMarcOidMarc() != null ? 
				FormatUtils.formatObject(zonEstadZonaData.getMarcOidMarc(), 
				 MMGDruidaHelper.getUserDecimalFormatPattern(this), 
				symbols) : ""));
