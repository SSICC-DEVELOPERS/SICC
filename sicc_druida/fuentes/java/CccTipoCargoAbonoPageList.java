...
public class CccTipoCargoAbonoPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","cccTipoCargoAbonoList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","CccTipoCargoAbono.codTipoCargAbon.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","CccTipoCargoAbono.Descripcion.label" );
