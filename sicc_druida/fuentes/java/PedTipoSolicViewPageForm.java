...
public class PedTipoSolicViewPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","PedTipoSolicView.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","PedTipoSolicView.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('pedTipoSolicViewFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('pedTipoSolicViewFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(54)).setAttribute("cod","PedTipoSolicView.codTipoSoli.label" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('pedTipoSolicViewFrm',2, true)" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('pedTipoSolicViewFrm', 2, false)" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(75)).setAttribute("nombre","indConsTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(80)).setAttribute("nombre","indConsWidgetTrId" );
   }
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(82)).setAttribute("nombre","indCons" );
      ...
      ((Element)v.get(82)).setAttribute("ontab","ejecutarAccionFoco('pedTipoSolicViewFrm',7, true)" );
      ((Element)v.get(82)).setAttribute("onshtab","ejecutarAccionFoco('pedTipoSolicViewFrm', 7, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(83)).setAttribute("nombre","indConsGapTdId" );
   ...
   private void getXML450(Document doc) {
      ((Element)v.get(100)).setAttribute("nombre","indSoliNegaTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(104)).setAttribute("nombre","lblIndSoliNega" );
      ((Element)v.get(104)).setAttribute("alto","13" );
      ((Element)v.get(104)).setAttribute("filas","1" );
      ((Element)v.get(104)).setAttribute("id","datosTitle" );
      ((Element)v.get(104)).setAttribute("cod","PedTipoSolicView.indSoliNega.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(105)).setAttribute("nombre","indSoliNegaWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(107)).setAttribute("nombre","indSoliNega" );
      ...
      ((Element)v.get(107)).setAttribute("ontab","ejecutarAccionFoco('pedTipoSolicViewFrm',8, true)" );
      ((Element)v.get(107)).setAttribute("onshtab","ejecutarAccionFoco('pedTipoSolicViewFrm', 8, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(108)).setAttribute("nombre","indSoliNegaGapTdId" );
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(125)).setAttribute("nombre","indDevoTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(130)).setAttribute("nombre","indDevoWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(132)).setAttribute("nombre","indDevo" );
      ...
      ((Element)v.get(132)).setAttribute("ontab","ejecutarAccionFoco('pedTipoSolicViewFrm',10, true)" );
      ((Element)v.get(132)).setAttribute("onshtab","ejecutarAccionFoco('pedTipoSolicViewFrm', 10, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(133)).setAttribute("nombre","indDevoGapTdId" );
   ...
   private void getXML630(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(150)).setAttribute("nombre","indAnulTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(155)).setAttribute("nombre","indAnulWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(157)).setAttribute("nombre","indAnul" );
      ...
      ((Element)v.get(157)).setAttribute("ontab","ejecutarAccionFoco('pedTipoSolicViewFrm',11, true)" );
   }

   private void getXML720(Document doc) {
      ((Element)v.get(157)).setAttribute("onshtab","ejecutarAccionFoco('pedTipoSolicViewFrm', 11, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(158)).setAttribute("nombre","indAnulGapTdId" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(175)).setAttribute("nombre","codGrupSoliTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(179)).setAttribute("nombre","lblCodGrupSoli" );
   ...
   private void getXML810(Document doc) {
      ...
      ((Element)v.get(179)).setAttribute("cod","PedTipoSolicView.codGrupSoli.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(180)).setAttribute("nombre","codGrupSoliWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(182)).setAttribute("nombre","codGrupSoli" );
      ...
      ((Element)v.get(182)).setAttribute("ontab","ejecutarAccionFoco('pedTipoSolicViewFrm',13, true)" );
      ((Element)v.get(182)).setAttribute("onshtab","ejecutarAccionFoco('pedTipoSolicViewFrm', 13, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(183)).setAttribute("nombre","codGrupSoliGapTdId" );
   ...
   private void getXML900(Document doc) {
      ...
      ((Element)v.get(204)).setAttribute("cod","PedTipoSolicView.Descripcion.label" );
      ...
      ((Element)v.get(208)).setAttribute("ontab","ejecutarAccionFoco('pedTipoSolicViewFrm',14, true)" );
      ((Element)v.get(208)).setAttribute("onshtab","ejecutarAccionFoco('pedTipoSolicViewFrm', 14, false)" );
      ...
      ((Element)v.get(212)).setAttribute("href","javascript:openLocalizationDialog('pedTipoSolicViewFrm', 'Descripcion', 1);" );
      ((Element)v.get(212)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"pedTipoSolicViewFrm\",14, true)', 'ejecutarAccionFoco(\"pedTipoSolicViewFrm\",14, false)')" );
   ...
   private void getXML990(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(228)).setAttribute("nombre","pedTipoSolicViewTrButtons" );
      ...
      ((Element)v.get(235)).setAttribute("nombre","pedTipoSolicViewTdQueryButton" );
      ((Element)v.get(234)).appendChild((Element)v.get(235));

      /* Empieza nodo:236 / Elemento padre: 235   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(236)).setAttribute("nombre","pedTipoSolicViewQueryButton" );
      ((Element)v.get(236)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(236)).setAttribute("estado","false" );
      ((Element)v.get(236)).setAttribute("accion","pedTipoSolicViewFirstPage();" );
      ...
      ((Element)v.get(237)).setAttribute("nombre","pedTipoSolicViewTdLovNullSelectionButton" );
   ...
   private void getXML1080(Document doc) {
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(239)).setAttribute("nombre","pedTipoSolicViewLovNullButton" );
      ((Element)v.get(239)).setAttribute("ID","botonContenido" );
      ((Element)v.get(239)).setAttribute("tipo","html" );
      ((Element)v.get(239)).setAttribute("accion","pedTipoSolicViewLovNullSelectionAction();" );
