...
public class contenido_encuestas_clientes_consultar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_encuestas_clientes_consultar" );
      ((Element)v.get(0)).setAttribute("cod","01042" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","contenido_encuestas_clientes_consultar.js" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(7)).setAttribute("nombre","opcionMenu" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(8)).setAttribute("nombre","cbPregunta" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(9)).setAttribute("nombre","cbRespuesta" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(11)).setAttribute("nombre","txtCodigoCliente" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(12)).setAttribute("nombre","btBuscarCliente" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(14)).setAttribute("nombre","btBuscar" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(15)).setAttribute("nombre","lstResultado" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(16)).setAttribute("nombre","btModificar" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(17)).setAttribute("nombre","btEliminar" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(18)).setAttribute("nombre","btDetalle" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(19)).setAttribute("nombre","habilitaTxtCodCliente" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(43)).setAttribute("width","499" );
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(45)).setAttribute("colspan","2" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(58)).setAttribute("onchange","onChangeCodigoCliente();" );
      ((Element)v.get(58)).setAttribute("req","N" );
      ((Element)v.get(58)).setAttribute("size","22" );
      ...
      ((Element)v.get(60)).setAttribute("onclick","accionBuscarCliente()" );
      ((Element)v.get(60)).setAttribute("onmouseover","this.style.cursor='hand';" );
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(64)).setAttribute("colspan","2" );
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(68)).setAttribute("width","499" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(73)).setAttribute("nombre","lblPregunta" );
      ...
      ((Element)v.get(73)).setAttribute("cod","3062" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(77)).setAttribute("nombre","lblRespuesta" );
      ...
      ((Element)v.get(77)).setAttribute("cod","3063" );
      ...
      ((Element)v.get(84)).setAttribute("nombre","cbPregunta" );
      ((Element)v.get(84)).setAttribute("id","datosCampos" );
      ((Element)v.get(84)).setAttribute("size","1" );
      ((Element)v.get(84)).setAttribute("onchange","onChangePregunta();" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(89)).setAttribute("nombre","cbRespuesta" );
   ...
   private void getXML360(Document doc) {
      v.add(doc.createElement("td"));
      ((Element)v.get(92)).setAttribute("colspan","2" );
      ...
      /* Empieza nodo:96 / Elemento padre: 25   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(25)).appendChild((Element)v.get(96));
      ...
      ((Element)v.get(104)).setAttribute("ontab","focaliza('formulario.txtCodCliente');" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(130)).setAttribute("cod","3062" );
      ...
      ((Element)v.get(131)).setAttribute("cod","3063" );
   }
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(132)).setAttribute("primerRefresco","N" );
      ...
      ((Element)v.get(137)).setAttribute("onload","msgError = administraMensajeNoExistenDatos(msgError); procesarPaginado(mipgndo,msgError,ultima,rowset,'muestraLista(ultima,rowset)');" );
      ...
      ((Element)v.get(138)).setAttribute("y","468" );
      ...
      ((Element)v.get(139)).setAttribute("y","468" );
      ...
      ((Element)v.get(140)).setAttribute("y","468" );
      ...
      ((Element)v.get(141)).setAttribute("y","464" );
   ...
   private void getXML630(Document doc) {
      ((Element)v.get(142)).setAttribute("nombre","btnModificar" );
      ((Element)v.get(142)).setAttribute("x","80" );
      ((Element)v.get(142)).setAttribute("y","465" );
      ...
      ((Element)v.get(142)).setAttribute("cod","2" );
      ((Element)v.get(142)).setAttribute("accion","accionModificar()" );
      ((Element)v.get(5)).appendChild((Element)v.get(142));
      /* Termina nodo:142   */

      /* Empieza nodo:143 / Elemento padre: 5   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(143)).setAttribute("nombre","btnDetalle" );
      ((Element)v.get(143)).setAttribute("x","80" );
      ((Element)v.get(143)).setAttribute("y","465" );
      ...
      ((Element)v.get(143)).setAttribute("cod","3" );
      ((Element)v.get(143)).setAttribute("accion","accionDetalle()" );
      ((Element)v.get(5)).appendChild((Element)v.get(143));
      /* Termina nodo:143   */

      /* Empieza nodo:144 / Elemento padre: 5   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(144)).setAttribute("nombre","btnEliminar" );
      ((Element)v.get(144)).setAttribute("x","80" );
      ((Element)v.get(144)).setAttribute("y","465" );
      ...
      ((Element)v.get(144)).setAttribute("cod","1254" );
      ((Element)v.get(144)).setAttribute("accion","accionEliminar()" );
      ((Element)v.get(5)).appendChild((Element)v.get(144));
      /* Termina nodo:144   */

      /* Empieza nodo:145 / Elemento padre: 5   */
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(145)).setAttribute("nombre","capaEspacio" );
      ((Element)v.get(145)).setAttribute("alto","12" );
      ...
      ((Element)v.get(145)).setAttribute("visibilidad","visible" );
      ((Element)v.get(145)).setAttribute("contravsb","" );
      ((Element)v.get(145)).setAttribute("x","0" );
      ((Element)v.get(145)).setAttribute("y","519" );
