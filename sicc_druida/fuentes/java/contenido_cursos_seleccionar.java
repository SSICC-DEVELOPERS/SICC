...
public class contenido_cursos_seleccionar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_cursos_seleccionar" );
      ((Element)v.get(0)).setAttribute("titulo","" );
      ((Element)v.get(0)).setAttribute("cod","0202" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","Insertar Cursos" );
      ...
      ((Element)v.get(1)).setAttribute("src","contenido_cursos_seleccionar.js" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(9)).setAttribute("nombre","oidSeleccionado" );
      ...
      ((Element)v.get(10)).setAttribute("valor","LPInsertaCurso" );
      ...
      ((Element)v.get(13)).setAttribute("ancho","400" );
      ((Element)v.get(13)).setAttribute("alto","300" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(21)).setAttribute("cod","00150" );
      ...
      ((Element)v.get(24)).setAttribute("ancho","5" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(25)).setAttribute("ancho","50" );
      ...
      ((Element)v.get(27)).setAttribute("cod","8" );
      ...
      ((Element)v.get(29)).setAttribute("cod","743" );
      ...
      ((Element)v.get(31)).setAttribute("tipoEnvio","seleccion" );
      ((Element)v.get(31)).setAttribute("formaEnvio","xml" );
      ((Element)v.get(31)).setAttribute("maxSel","1" );
      ((Element)v.get(31)).setAttribute("deseleccionaSiMaxSel","S" );
      ...
      ((Element)v.get(35)).setAttribute("nombre","mipgndo" );
      ((Element)v.get(35)).setAttribute("onload","procesarPaginado(mipgndo,msgError, ultima, rowset, 'muestraLista(ultima, rowset)')" );
      ((Element)v.get(35)).setAttribute("ancho","400" );
      ((Element)v.get(35)).setAttribute("sep","$" );
      ((Element)v.get(35)).setAttribute("x","12" );
   }

   private void getXML180(Document doc) {
      ((Element)v.get(35)).setAttribute("class","botonera" );
      ((Element)v.get(35)).setAttribute("y","289" );
      ((Element)v.get(35)).setAttribute("control","|" );
      ((Element)v.get(35)).setAttribute("conector","ConectorObtienePlantilla" );
      ((Element)v.get(35)).setAttribute("rowset","" );
      ((Element)v.get(35)).setAttribute("cargainicial","N" );
      ((Element)v.get(13)).appendChild((Element)v.get(35));

      /* Empieza nodo:36 / Elemento padre: 35   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(36)).setAttribute("nombre","ret1" );
      ((Element)v.get(36)).setAttribute("x","37" );
      ((Element)v.get(36)).setAttribute("y","293" );
      ((Element)v.get(36)).setAttribute("ID","botonContenido" );
      ((Element)v.get(36)).setAttribute("img","retroceder_on" );
      ...
      ((Element)v.get(36)).setAttribute("accion","mipgndo.retroceder();" );
      ((Element)v.get(35)).appendChild((Element)v.get(36));
      /* Termina nodo:36   */

      /* Empieza nodo:37 / Elemento padre: 35   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(37)).setAttribute("nombre","ava1" );
      ((Element)v.get(37)).setAttribute("x","52" );
      ((Element)v.get(37)).setAttribute("y","293" );
      ((Element)v.get(37)).setAttribute("ID","botonContenido" );
      ((Element)v.get(37)).setAttribute("img","avanzar_on" );
      ...
      ((Element)v.get(37)).setAttribute("accion","mipgndo.avanzar();" );
      ...
      ((Element)v.get(38)).setAttribute("y","289" );
      ...
      ((Element)v.get(39)).setAttribute("y","293" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(40)).setAttribute("nombre","btnAceptar" );
      ((Element)v.get(40)).setAttribute("x","80" );
      ((Element)v.get(40)).setAttribute("y","290" );
      ((Element)v.get(40)).setAttribute("ID","botonContenido" );
      ((Element)v.get(40)).setAttribute("accion","fGuardar();" );
      ((Element)v.get(40)).setAttribute("tipo","html" );
      ((Element)v.get(40)).setAttribute("estado","false" );
      ((Element)v.get(40)).setAttribute("cod","12" );
      ((Element)v.get(5)).appendChild((Element)v.get(40));
      /* Termina nodo:40   */

      /* Empieza nodo:41 / Elemento padre: 5   */
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(41)).setAttribute("nombre","capaEspacio" );
      ((Element)v.get(41)).setAttribute("alto","12" );
      ...
      ((Element)v.get(41)).setAttribute("y","293" );
