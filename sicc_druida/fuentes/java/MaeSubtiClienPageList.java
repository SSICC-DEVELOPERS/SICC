...
public class MaeSubtiClienPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","maeSubtiClienList" );
      ...
      ((Element)v.get(14)).setAttribute("cod","MaeSubtiClien.ticlOidTipoClie.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","MaeSubtiClien.codSubtClie.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","MaeSubtiClien.Descripcion.label" );
