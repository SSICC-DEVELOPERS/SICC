...
public class MaePreguEncueConectorQueryList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad MaePreguEncue" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGMaePreguEncueQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGMaePreguEncueQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","MaePreguEncueListFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","codPreg" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(8)).setAttribute("NOMBRE","valPesoPreg" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(9)).setAttribute("NOMBRE","enseOidEncu" );
