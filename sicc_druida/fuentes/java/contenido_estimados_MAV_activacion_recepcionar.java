...
public class contenido_estimados_MAV_activacion_recepcionar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_estimados_MAV_activacion_recepcionar" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","contenido_estimados_MAV_activacion_recepcionar.js" );
      ...
      ((Element)v.get(6)).setAttribute("name","Descripcion" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(13)).setAttribute("nombre","hNumeroLote" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(32)).setAttribute("nombre","lblDatos" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(48)).setAttribute("cod","844" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(55)).setAttribute("nombre","lblvalorLote" );
      ...
      ((Element)v.get(59)).setAttribute("nombre","Descripcion" );
      ...
      ((Element)v.get(59)).setAttribute("onshtab","onShTab();" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(79)).setAttribute("cols","50" );
      ((Element)v.get(79)).setAttribute("id","datosCampos" );
      ((Element)v.get(79)).setAttribute("msjreq","" );
      ((Element)v.get(79)).setAttribute("nombre","areatxtObservaciones" );
      ((Element)v.get(79)).setAttribute("readonly","N" );
      ((Element)v.get(79)).setAttribute("req","N" );
      ((Element)v.get(79)).setAttribute("rows","3" );
      ((Element)v.get(79)).setAttribute("tabindex","2" );
      ((Element)v.get(79)).setAttribute("valor","" );
      ((Element)v.get(79)).setAttribute("max","240" );
      ...
      /* Empieza nodo:85 / Elemento padre: 26   */
      v.add(doc.createElement("td"));
      ((Element)v.get(26)).appendChild((Element)v.get(85));
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(95)).setAttribute("nombre","btnRecepcionar" );
      ((Element)v.get(95)).setAttribute("ID","botonContenido" );
      ((Element)v.get(95)).setAttribute("tipo","html" );
      ((Element)v.get(95)).setAttribute("ontab","onTab();" );
      ((Element)v.get(95)).setAttribute("accion","onClickRecepcionar();" );
      ((Element)v.get(95)).setAttribute("estado","false" );
      ((Element)v.get(95)).setAttribute("cod","2265" );
      ...
      /* Empieza nodo:98 / Elemento padre: 18   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(18)).appendChild((Element)v.get(98));
