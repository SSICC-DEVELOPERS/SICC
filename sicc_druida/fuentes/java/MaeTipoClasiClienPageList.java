...
public class MaeTipoClasiClienPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","maeTipoClasiClienList" );
      ...
      ((Element)v.get(14)).setAttribute("cod","MaeTipoClasiClien.sbtiOidSubtClie.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","MaeTipoClasiClien.codTipoClas.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","MaeTipoClasiClien.Descripcion.label" );
