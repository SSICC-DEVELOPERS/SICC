/*
    INDRA/CAR/mmg
    $Id: MaeMagniLPStartUp.java,v 1.1 2009/12/03 18:43:15 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class MaeMagniLPStartUp extends MMGDruidaBase{
	...
	public static final String BUSINESSID_QUERY = "MMGMaeMagniQueryFromToUserPage";
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "MaeMagniPage", "cod", "MaeMagni." + accion + ".label");
			...
			limpiarBotoneraLista("maeMagni", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codMagn", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 2);");
		...
		//asignarAtributo("CAPA", "maeMagniLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "MaeMagniPage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("MaeMagniLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		MaeMagniData maeMagniQuery= new MaeMagniData();
		maeMagniQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		MaeMagniData datosResult = (MaeMagniData)getSingleObject(BUSINESSID_QUERY, maeMagniQuery, 
			maeMagniQuery.clone(), "maeMagni");
		...
		preservaHiddensI18n(new Integer(1), "MAE_MAGNI", "maeMagniFrm", "Descripcion", true);
		...
		MaeMagniData maeMagni = datosResult;
		asignar("TEXT", "codMagn", FormatUtils.formatObject(maeMagni.getCodMagn(), 
		...
		loadLocalizationVars(maeMagni);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "codMagn", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "MAE_MAGNI", "maeMagniFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "codMagn", "req", "S");
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('maeMagniFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "maeMagniFrm", "oculto", "N");
		...
		traza("MMG::Creando MaeMagni");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		MaeMagniData maeMagniQuery= new MaeMagniData();
		maeMagniQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(maeMagni.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"maeMagniFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"maeMagniFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codMagn", "ontab","ejecutarAccionFocoModificacion(\"maeMagniFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codMagn", "onshtab","ejecutarAccionFocoModificacion(\"maeMagniFrm\",2, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"maeMagniFrm\",3, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"maeMagniFrm\",3, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","maeMagniTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","maeMagniTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codMagn...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","maeMagniFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","maeMagniListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","maeMagniListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(MaeMagniData maeMagni) throws Exception{
	...
	* @param maeMagni La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(MaeMagniData maeMagni) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		MaeMagniData maeMagni = 
			(MaeMagniData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(maeMagni);
		loadLeafDependenceCombos(maeMagni);
	}
	...
	*/
	...
	protected void loadLocalizationVars(MaeMagniData maeMagni) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("MAE_MAGNI");
		mmgLocalizationQuery.setEntiPk(maeMagni.getId());
