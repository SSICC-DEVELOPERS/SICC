/*
    INDRA/CAR/mmg
    $Id: MsgTipoMensaLPStartUp.java,v 1.1 2009/12/03 18:33:01 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class MsgTipoMensaLPStartUp extends MMGDruidaBase{
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "MsgTipoMensaPage", "cod", "MsgTipoMensa." + accion + ".label");
			...
			limpiarBotoneraLista("msgTipoMensa", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codTipoMens", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 2);");
		
		//Primero determianmos el nombre del campo en la entidad de oriegen donde se van a cargar los datos
		asignar("VAR", "idAttributeLovOpener", conectorParametro(PARAMETRO_LOV_ATTRIBUTO));
		asignar("VAR", "idEntityLovOpener", conectorParametro(PARAMETRO_LOV_ENTIDAD));
		//asignarAtributo("CAPA", "msgTipoMensaLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "MsgTipoMensaPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		MsgTipoMensaData msgTipoMensaQuery= new MsgTipoMensaData();
		msgTipoMensaQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		MsgTipoMensaData datosResult = (MsgTipoMensaData)getSingleObject(BUSINESSID_QUERY, msgTipoMensaQuery, 
			msgTipoMensaQuery.clone(), "msgTipoMensa");
		...
		MsgTipoMensaData msgTipoMensa = datosResult;
		asignar("TEXT", "codTipoMens", FormatUtils.formatObject(msgTipoMensa.getCodTipoMens(), 
		...
		asignarAtributo("TEXT", "codTipoMens", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		...
		asignarAtributo("TEXT", "codTipoMens", "req", "S");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "msgTipoMensaFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		MsgTipoMensaData msgTipoMensaQuery= new MsgTipoMensaData();
		msgTipoMensaQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(msgTipoMensa.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"msgTipoMensaFrm\",0, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"msgTipoMensaFrm\",0, false)");
				asignarAtributo("AREATEXTO", "codTipoMens", "ontab","ejecutarAccionFocoModificacion(\"msgTipoMensaFrm\",0, true)");
				asignarAtributo("AREATEXTO", "codTipoMens", "onshtab","ejecutarAccionFocoModificacion(\"msgTipoMensaFrm\",0, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","msgTipoMensaTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","msgTipoMensaTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codTipoMens...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","msgTipoMensaFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","msgTipoMensaListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","msgTipoMensaListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(MsgTipoMensaData msgTipoMensa) throws Exception{
	...
	* @param msgTipoMensa La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(MsgTipoMensaData msgTipoMensa) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		MsgTipoMensaData msgTipoMensa = 
			(MsgTipoMensaData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(msgTipoMensa);
		loadLeafDependenceCombos(msgTipoMensa);
	}
