...
public class contenido_datos_grupo_modificar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_datos_grupo_modificar" );
      ...
      v.add(doc.createTextNode("   \r         \r    \r            function inicia(){             \r              if (get('frmModificarDatosGrupo.hcerrar')=='false'){              \r                   configurarMenuSecundario(\"frmModificarDatosGrupo\");   \r                   posicionarCombo();   \r                   mostrarCodigoError();   \r                 } else {   \r                   returnValue = 'guardo';   \r                   window.close();   \r                 }         \r            }   \r    \r             function mostrarCodigoError() {     \r                                \r                 var vErrCodigo = get('frmModificarDatosGrupo.errCodigo');   \r                 var vErrDescrip = get('frmModificarDatosGrupo.errDescripcion');   \r    \r                 if (get('frmModificarDatosGrupo.errDescripcion')!='') {   \r                       var wnd = fMostrarMensajeError( vErrCodigo,vErrDescrip);   \r                       /*if (get('frmModificarDatosGrupo.errCodigo')=='260020002')   \r                              focaliza('frmModificarDatosGrupo.');*/   \r                 }   \r             \r              }                \r    \r            function posicionarCombo(){   \r              if (get('frmModificarDatosGrupo.hFactPreserva')!=''){   \r                 iSeleccionadob = new Array();             \r                 iSeleccionadob[0] = get('frmModificarDatosGrupo.hFactPreserva');         \r                 set('frmModificarDatosGrupo.cbTipoFacturacion',iSeleccionadob);                \r              } else {   \r                 iSeleccionadob = new Array();             \r                 iSeleccionadob[0] = get('frmModificarDatosGrupo.hFacturacion');         \r                 set('frmModificarDatosGrupo.cbTipoFacturacion',iSeleccionadob);   \r              }   \r              focaliza('frmModificarDatosGrupo.txtNombreDeGrupo');   \r            }             \r    \r            function fGuardar(){   \r              accionAceptarDatosGrupo();   \r                 \r            }   \r    \r            function fVolver(){   \r              window.close();   \r            }   \r    \r            function fLimpiar(){   \r               set('frmModificarDatosGrupo.txtNombreDeGrupo',get('frmModificarDatosGrupo.hNombreGrupo'));    \r               posicionarCombo();   \r               limpiaI18N('frmModificarDatosGrupo','1');   \r            }   \r               \r            function accionAceptarDatosGrupo(){   \r               setMV('frmModificarDatosGrupo.txtNombreDeGrupo','S', GestionarMensaje('2553'));   \r               set('frmModificarDatosGrupo.accion','aceptarDatosGrupo');             \r               set('frmModificarDatosGrupo.conectorAction','LPMantieneGruposZonas');   \r               envia('frmModificarDatosGrupo');    \r            }   \r                          \r           \r     "));
      ...
      ((Element)v.get(5)).setAttribute("nombre","frmModificarDatosGrupo" );
      ...
      ((Element)v.get(7)).setAttribute("valor","LPMantieneGruposZonas" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(11)).setAttribute("nombre","hcerrar" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(12)).setAttribute("nombre","hNombreGrupo" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(13)).setAttribute("nombre","hFacturacion" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(14)).setAttribute("nombre","hCodigoDeGrupo" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(15)).setAttribute("nombre","hFactPreserva" );
      ...
      ((Element)v.get(16)).setAttribute("nombre","capaBusqueda" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(34)).setAttribute("colspan","9" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(40)).setAttribute("nombre","lblCodigo" );
      ...
      ((Element)v.get(40)).setAttribute("cod","196" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(44)).setAttribute("nombre","lblNombre" );
      ...
      ((Element)v.get(44)).setAttribute("cod","197" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(48)).setAttribute("nombre","lblTipoFc" );
      ...
      ((Element)v.get(48)).setAttribute("cod","198" );
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(54)).setAttribute("valign","middle" );
      ((Element)v.get(51)).appendChild((Element)v.get(54));

      /* Empieza nodo:55 / Elemento padre: 54   */
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(55)).setAttribute("nombre","lblCodigoDeGrupo" );
      ...
      ((Element)v.get(59)).setAttribute("nombre","txtNombreDeGrupo" );
      ((Element)v.get(59)).setAttribute("id","datosCampos" );
      ((Element)v.get(59)).setAttribute("max","40" );
      ((Element)v.get(59)).setAttribute("tipo","" );
      ((Element)v.get(59)).setAttribute("onchange","" );
      ((Element)v.get(59)).setAttribute("req","S" );
      ((Element)v.get(59)).setAttribute("size","40" );
      ((Element)v.get(59)).setAttribute("valor","" );
      ((Element)v.get(59)).setAttribute("validacion","" );
      ((Element)v.get(59)).setAttribute("onshtab","focaliza('frmModificarDatosGrupo.cbTipoFacturacion');" );
      ...
      v.add(doc.createElement("IMG"));
      ((Element)v.get(63)).setAttribute("src","iconmultidioma.gif" );
      ((Element)v.get(63)).setAttribute("onclick","levantarI18N('frmModificarDatosGrupo','1');" );
      ...
      ((Element)v.get(67)).setAttribute("nombre","cbTipoFacturacion" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(67)).setAttribute("ontab","focaliza('frmModificarDatosGrupo.txtNombreDeGrupo');" );
      ...
      /* Empieza nodo:74 / Elemento padre: 25   */
      v.add(doc.createElement("td"));
      ((Element)v.get(25)).appendChild((Element)v.get(74));
      ...
      /* Empieza nodo:76 / Elemento padre: 17   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(17)).appendChild((Element)v.get(76));
