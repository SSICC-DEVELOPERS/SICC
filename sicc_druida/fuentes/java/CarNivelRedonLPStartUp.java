/*
    INDRA/CAR/mmg
    $Id: CarNivelRedonLPStartUp.java,v 1.1 2009/12/03 18:39:07 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class CarNivelRedonLPStartUp extends MMGDruidaBase{
	...
	public static final short VIEWFORM_SIZE = 37;

	//Cosntantes que definen elementos de la logica de negocio de las entidades
	//y de los elementos asociados a la entidad
	public static final String BUSINESSID_QUERY = "MMGCarNivelRedonQueryFromToUserPage";
	...
	public CarNivelRedonLPStartUp(){
		super();
	}

	public void inicio() throws Exception {
		pagina("CarNivelRedonPage");
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "CarNivelRedonPage", "cod", "CarNivelRedon." + accion + ".label");
			...
			limpiarBotoneraLista("carNivelRedon", accion);
	...
	protected void cmdLov() throws Exception{
		...
		//asignarAtributo("CAPA", "carNivelRedonLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "CarNivelRedonPage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("CarNivelRedonLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		CarNivelRedonData carNivelRedonQuery= new CarNivelRedonData();
		carNivelRedonQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		CarNivelRedonData datosResult = (CarNivelRedonData)getSingleObject(BUSINESSID_QUERY, carNivelRedonQuery, 
			carNivelRedonQuery.clone(), "carNivelRedon");
		...
		preservaHiddensI18n(new Integer(1), "CAR_NIVEL_REDON", "carNivelRedonFrm", "Descripcion", true);
		...
		CarNivelRedonData carNivelRedon = datosResult;
		...
		loadLocalizationVars(carNivelRedon);
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "CAR_NIVEL_REDON", "carNivelRedonFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('carNivelRedonFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "carNivelRedonFrm", "oculto", "N");
		...
		traza("MMG::Creando CarNivelRedon");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		CarNivelRedonData carNivelRedonQuery= new CarNivelRedonData();
		carNivelRedonQuery.setId(new Long(id));
		...
		decimalFormatSymbols.setDecimalSeparator(UtilidadesSession.getSeparadorDecimales(this).charAt(0));
		decimalFormatSymbols.setGroupingSeparator(UtilidadesSession.getSeparadorDecimales(this).equals(".") ? ",".charAt(0) : ".".charAt(0));
		asignar("TEXT", "Descripcion", FormatUtils.formatObject(carNivelRedon.getDescripcion(), 
		...
		//asignar("VAR","timestamp",Long.toString(carNivelRedon.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"carNivelRedonFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"carNivelRedonFrm\",1, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"carNivelRedonFrm\",2, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"carNivelRedonFrm\",2, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","carNivelRedonTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","carNivelRedonTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","carNivelRedonFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","carNivelRedonListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","carNivelRedonListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(CarNivelRedonData carNivelRedon) throws Exception{
	...
	* @param carNivelRedon La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(CarNivelRedonData carNivelRedon) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		CarNivelRedonData carNivelRedon = 
			(CarNivelRedonData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(carNivelRedon);
		loadLeafDependenceCombos(carNivelRedon);
	}
	...
	*/
	...
	protected void loadLocalizationVars(CarNivelRedonData carNivelRedon) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("CAR_NIVEL_REDON");
		mmgLocalizationQuery.setEntiPk(carNivelRedon.getId());
