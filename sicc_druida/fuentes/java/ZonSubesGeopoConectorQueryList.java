...
public class ZonSubesGeopoConectorQueryList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad ZonSubesGeopo" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGZonSubesGeopoQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGZonSubesGeopoQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","ZonSubesGeopoListFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","egeoOidEstrGeop" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(8)).setAttribute("NOMBRE","codSube" );
