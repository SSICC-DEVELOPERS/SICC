...
public class Contenido_calendario_insertar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_calendario_insertar" );
      ((Element)v.get(0)).setAttribute("titulo","Insertar Calendario" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","Insertar Calendario" );
      ((Element)v.get(0)).setAttribute("onload","onLoadCargarBarra();" );
      ((Element)v.get(0)).setAttribute("xml:lang","es" );
      ((Element)v.get(0)).setAttribute("cod","086" );
      ...
      v.add(doc.createTextNode("    \r          \r          \r          function onLoadCargarBarra(){\r          \r              configurarMenuSecundario('frmContenido');   \r              fMostrarMensajeError();   \r              cargarMarcaCanalDefecto();   \r              focaliza( 'frmContenido.txtAnio' );   \r			  			  iSeleccionado = new Array(); \r			  iSeleccionado[0] = '';\r			  set('frmContenido.cmbGruposZonas', iSeleccionado);\r		  }   \r\r          function cargarMarcaCanalDefecto(){   \r            var marcaDefecto = get( 'frmContenido.hMarcaDefecto' );   \r            var canalDefecto = get( 'frmContenido.hCanalDefecto' );   \r            var aMarca = new Array( marcaDefecto );   \r            var aCanal = new Array( canalDefecto );   \r    \r            if( get( 'frmContenido.accion' ) == 'muestraInsercion' ){   \r              set( 'frmContenido.cmbMarca', aMarca );   \r              set( 'frmContenido.cmbCanal', aCanal );   \r              changeComboMarcaCanal();   \r            }   \r          }   \r        \r          function changeComboMarcaCanal(){   \r            var marca = (( get( 'frmContenido.cmbMarca' ) != null ) ? get( 'frmContenido.cmbMarca' ) : null);   \r            var canal = (( get( 'frmContenido.cmbCanal' ) != null ) ? get( 'frmContenido.cmbCanal' ) : null);   \r                      \r                          recargaCombo('frmContenido.cmbGruposZonas', 'CRAObtieneGruposZonas', 'es.indra.sicc.dtos.cra.DTOGrupoZonas', makeParameter() );   \r                      }           \r            \r          function makeParameter(){   \r    \r            var marca = get( 'frmContenido.cmbMarca' );   \r            var canal = get( 'frmContenido.cmbCanal' );   \r            var pais = get( 'frmContenido.hPais' );   \r            var idioma = get( 'frmContenido.hIdioma' );   \r            var programa = get( 'frmContenido.hPrograma' );   \r            var IPCliente = get( 'frmContenido.hIPCliente' );   \r    \r            var array = new Array();   \r            var i=0;   \r    \r            array[i] = new Array('oidMarca', marca);   \r            i++;   \r               \r            array[i] = new Array('oidCanal', canal);   \r            i++;   \r    \r            array[i] = new Array('oidPais', pais);   \r            i++;   \r               \r            array[i] = new Array('oidIdioma', idioma);   \r            i++;   \r    \r            array[i] = new Array('programa', programa);   \r            i++;   \r    \r            array[i] = new Array('ipCliente', IPCliente);   \r               \r            return array;   \r          }   \r    \r          function fGuardar(){   \r               \r            if(!sicc_validaciones_generales()){   \r                   return false;   \r            }   \r            if (!validaAnio()){   \r                   return false;   \r            }   \r                        if(fValidarCTEXT( 'frmContenido.txtAnio' )  && fValidarCOMBO( 'frmContenido.cmbMarca' ) &&   \r               fValidarCOMBO( 'frmContenido.cmbCanal' ) && fValidarCOMBO( 'frmContenido.cmbGruposZonas' )){   \r                            if( esNumero( get( 'frmContenido.txtAnio' ) )=='OK' ){   \r                 set( 'frmContenido.conectorAction', 'LPMantieneCalendario' );   \r                 set( 'frmContenido.accion', 'guardar' );   \r					  eval(\"frmContenido.oculto = 'N'\");\r                 enviaSICC( 'frmContenido' );   \r              }   \r              else{   \r                 GestionarMensaje( '2555' );   \r              }   \r            }   \r          }   \r    \r          function fLimpiar(){   \r            set( 'frmContenido.txtAnio', '' );   \r            document.all.tags(\"INPUT\").txtSabados[0].checked=true;   \r            document.all.tags(\"INPUT\").txtDomingos[0].checked=true;   \r            cargarMarcaCanalDefecto();   \r            focaliza( 'frmContenido.txtAnio' );   \r            iSeleccionado = new Array(); \r            iSeleccionado[0] = '';\r            set('frmContenido.cmbGruposZonas', iSeleccionado);\r          }   \r    \r          function validaAnio(){   \r              var anio = get('frmContenido.txtAnio');   \r              var today = new Date();   \r              if (today.getYear()>anio){   \r                   GestionarMensaje( '2566' );   \r                   focaliza( 'frmContenido.txtAnio' );   \r                   return false;   \r              }   \r              return true;   \r          }   \r    \r    \r        \r\r  "));
      ...
      ((Element)v.get(6)).setAttribute("name","txtAnio" );
      ((Element)v.get(6)).setAttribute("required","true" );
      ((Element)v.get(6)).setAttribute("cod","171" );
      ((Element)v.get(5)).appendChild((Element)v.get(6));
      /* Termina nodo:6   */

      /* Empieza nodo:7 / Elemento padre: 5   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(7)).setAttribute("name","cmbMarca" );
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(8)).setAttribute("name","cmbCanal" );
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(9)).setAttribute("name","cmbGruposZonas" );
      ((Element)v.get(9)).setAttribute("required","true" );
      ((Element)v.get(9)).setAttribute("cod","180" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(17)).setAttribute("nombre","hPrograma" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(18)).setAttribute("nombre","hIPCliente" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(19)).setAttribute("nombre","hMarcaDefecto" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(20)).setAttribute("nombre","hCanalDefecto" );
   ...
   private void getXML90(Document doc) {
      v.add(doc.createElement("VAR"));
      ((Element)v.get(22)).setAttribute("nombre","hCasoDeUso" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(47)).setAttribute("nombre","etiqueta1" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(51)).setAttribute("nombre","etiqueta2" );
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(54)).setAttribute("colspan","7" );
      ((Element)v.get(43)).appendChild((Element)v.get(54));

      /* Empieza nodo:55 / Elemento padre: 54   */
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(55)).setAttribute("nombre","etiqueta3" );
      ...
      ((Element)v.get(55)).setAttribute("cod","177" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(62)).setAttribute("nombre","lblContenidoPais" );
      ...
      ((Element)v.get(62)).setAttribute("codi","5" );
   ...
   private void getXML270(Document doc) {
      ((Element)v.get(66)).setAttribute("nombre","txtAnio" );
      ((Element)v.get(66)).setAttribute("id","datosCampos" );
      ((Element)v.get(66)).setAttribute("max","4" );
      ((Element)v.get(66)).setAttribute("tipo","" );
      ((Element)v.get(66)).setAttribute("onchange","validaAnio();" );
      ((Element)v.get(66)).setAttribute("size","5" );
      ((Element)v.get(66)).setAttribute("valor","" );
      ((Element)v.get(66)).setAttribute("req","S" );
      ((Element)v.get(66)).setAttribute("onshtab","focaliza('frmContenido.cmbGruposZonas');" );
      ...
      ((Element)v.get(70)).setAttribute("nombre","txtSabados" );
      ((Element)v.get(70)).setAttribute("class","" );
      ((Element)v.get(70)).setAttribute("id","txtSabados" );
      ((Element)v.get(70)).setAttribute("max","1" );
      ...
      ((Element)v.get(70)).setAttribute("check","S" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(74)).setAttribute("nombre","etiqueta33" );
      ...
      ((Element)v.get(74)).setAttribute("cod","178" );
      ...
      v.add(doc.createElement("CHECKBOX"));
      ((Element)v.get(78)).setAttribute("nombre","txtDomingos" );
      ((Element)v.get(78)).setAttribute("class","datosCampos" );
      ((Element)v.get(78)).setAttribute("id","txtDomingos" );
      ((Element)v.get(78)).setAttribute("max","1" );
      ...
      ((Element)v.get(78)).setAttribute("check","S" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(80)).setAttribute("nombre","etiqueta32" );
      ...
      ((Element)v.get(80)).setAttribute("cod","179" );
      ((Element)v.get(79)).appendChild((Element)v.get(80));
      /* Termina nodo:80   */
      /* Termina nodo:79   */

      /* Empieza nodo:81 / Elemento padre: 58   */
      v.add(doc.createElement("td"));
      ((Element)v.get(58)).appendChild((Element)v.get(81));
   ...
   private void getXML360(Document doc) {
      ...
      /* Empieza nodo:83 / Elemento padre: 58   */
      v.add(doc.createElement("td"));
      ((Element)v.get(83)).setAttribute("width","100%" );
      ((Element)v.get(58)).appendChild((Element)v.get(83));
      ...
      /* Empieza nodo:85 / Elemento padre: 39   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(39)).appendChild((Element)v.get(85));
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(97)).setAttribute("nombre","lblCanales" );
      ...
      ((Element)v.get(104)).setAttribute("nombre","cmbMarca" );
   ...
   private void getXML450(Document doc) {
      ((Element)v.get(104)).setAttribute("onchange","changeComboMarcaCanal();" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(109)).setAttribute("nombre","cmbCanal" );
      ...
      ((Element)v.get(109)).setAttribute("onchange","changeComboMarcaCanal();" );
      ...
      /* Empieza nodo:116 / Elemento padre: 36   */
      v.add(doc.createElement("table"));
      ...
      ((Element)v.get(36)).appendChild((Element)v.get(116));
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(121)).setAttribute("nombre","lblGrupoZonas" );
      ...
      ((Element)v.get(121)).setAttribute("cod","180" );
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(128)).setAttribute("nombre","cmbGruposZonas" );
      ...
      ((Element)v.get(128)).setAttribute("ontab","focaliza('frmContenido.txtAnio');" );
      ...
      /* Empieza nodo:135 / Elemento padre: 32   */
      v.add(doc.createElement("td"));
      ((Element)v.get(32)).appendChild((Element)v.get(135));
      ...
      /* Empieza nodo:137 / Elemento padre: 24   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(24)).appendChild((Element)v.get(137));
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(140)).setAttribute("width","750" );
