...
public class ZonEstruGeopoPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","ZonEstruGeopo.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","ZonEstruGeopo.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('zonEstruGeopoFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('zonEstruGeopoFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(50)).setAttribute("nombre","codOrdeTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lblCodOrde" );
      ((Element)v.get(54)).setAttribute("alto","13" );
      ((Element)v.get(54)).setAttribute("filas","1" );
      ((Element)v.get(54)).setAttribute("id","datosTitle" );
      ((Element)v.get(54)).setAttribute("cod","ZonEstruGeopo.codOrde.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(55)).setAttribute("nombre","codOrdeWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(57)).setAttribute("nombre","codOrde" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('zonEstruGeopoFrm',2, true)" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('zonEstruGeopoFrm', 2, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(58)).setAttribute("nombre","codOrdeGapTdId" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(75)).setAttribute("nombre","indBorrTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(80)).setAttribute("nombre","indBorrWidgetTrId" );
   }
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(82)).setAttribute("nombre","indBorr" );
      ...
      ((Element)v.get(82)).setAttribute("ontab","ejecutarAccionFoco('zonEstruGeopoFrm',3, true)" );
      ((Element)v.get(82)).setAttribute("onshtab","ejecutarAccionFoco('zonEstruGeopoFrm', 3, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(83)).setAttribute("nombre","indBorrGapTdId" );
   ...
   private void getXML450(Document doc) {
      ((Element)v.get(100)).setAttribute("nombre","paisOidPaisTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(104)).setAttribute("nombre","lblpaisOidPais" );
      ...
      ((Element)v.get(104)).setAttribute("cod","ZonEstruGeopo.paisOidPais.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(105)).setAttribute("nombre","paisOidPaisWidgetTrId" );
      ...
      ((Element)v.get(107)).setAttribute("nombre","paisOidPais" );
      ...
      ((Element)v.get(107)).setAttribute("ontab","ejecutarAccionFoco('zonEstruGeopoFrm',4, true);" );
      ((Element)v.get(107)).setAttribute("onshtab","ejecutarAccionFoco('zonEstruGeopoFrm',4, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(109)).setAttribute("nombre","paisOidPaisGapTdId" );
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(126)).setAttribute("nombre","dipoOidDiviPoliTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(130)).setAttribute("nombre","lbldipoOidDiviPoli" );
      ...
      ((Element)v.get(130)).setAttribute("cod","ZonEstruGeopo.dipoOidDiviPoli.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(131)).setAttribute("nombre","dipoOidDiviPoliWidgetTrId" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(133)).setAttribute("nombre","dipoOidDiviPoli" );
      ...
      ((Element)v.get(133)).setAttribute("ontab","ejecutarAccionFoco('zonEstruGeopoFrm',5, true);" );
      ((Element)v.get(133)).setAttribute("onshtab","ejecutarAccionFoco('zonEstruGeopoFrm',5, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(135)).setAttribute("nombre","dipoOidDiviPoliGapTdId" );
   ...
   private void getXML630(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(152)).setAttribute("nombre","fecActuTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(157)).setAttribute("nombre","fecActuWidgetTrId" );
   ...
   private void getXML720(Document doc) {
      ...
      ((Element)v.get(159)).setAttribute("ontab","ejecutarAccionFoco('zonEstruGeopoFrm',6, true)" );
      ((Element)v.get(159)).setAttribute("onshtab","ejecutarAccionFoco('zonEstruGeopoFrm', 6, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(160)).setAttribute("nombre","fecActuGapTdId" );
      ...
      /* Empieza nodo:165 / Elemento padre: 15   */
      v.add(doc.createElement("TR"));
      ((Element)v.get(165)).setAttribute("nombre","formGapTr5" );
      ((Element)v.get(15)).appendChild((Element)v.get(165));
      ...
      /* Empieza nodo:174 / Elemento padre: 0   */
      v.add(doc.createElement("TR"));
      ((Element)v.get(174)).setAttribute("nombre","zonEstruGeopoTrButtons" );
      ((Element)v.get(0)).appendChild((Element)v.get(174));
      ...
      ((Element)v.get(181)).setAttribute("nombre","zonEstruGeopoTdQueryButton" );
   ...
   private void getXML810(Document doc) {
      ((Element)v.get(182)).setAttribute("nombre","zonEstruGeopoQueryButton" );
      ((Element)v.get(182)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(182)).setAttribute("estado","false" );
      ((Element)v.get(182)).setAttribute("accion","zonEstruGeopoFirstPage();" );
      ...
      ((Element)v.get(183)).setAttribute("nombre","zonEstruGeopoTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(185)).setAttribute("nombre","zonEstruGeopoLovNullButton" );
      ((Element)v.get(185)).setAttribute("ID","botonContenido" );
      ((Element)v.get(185)).setAttribute("tipo","html" );
      ((Element)v.get(185)).setAttribute("accion","zonEstruGeopoLovNullSelectionAction();" );
