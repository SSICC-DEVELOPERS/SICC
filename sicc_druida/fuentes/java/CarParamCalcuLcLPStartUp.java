/*
    INDRA/CAR/mmg
    $Id: CarParamCalcuLcLPStartUp.java,v 1.1 2009/12/03 18:39:36 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class CarParamCalcuLcLPStartUp extends MMGDruidaBase{
	...
	public static final String BUSINESSID_QUERY = "MMGCarParamCalcuLcQueryFromToUserPage";
				...
				public static final String BUSINESSID_NIRIOIDNIVERIES_QUERY ="MMGCarNivelRiesgQueryFromToUser";
				public static final String NIRIOIDNIVERIES_COMBO_CONNECTOR = "CarNivelRiesgConectorCombo";
	
		
	//Hashtables con los valores estáticos de radiobuttons y combos
	protected static Hashtable indVariLineCredValues = new Hashtable();
	static{
		indVariLineCredValues.put(new java.lang.String("A"), "Aumentar LC");
		indVariLineCredValues.put(new java.lang.String("D"), "Disminuir LC");
	}
	
	
	// Definicion del constructor
	public CarParamCalcuLcLPStartUp(){
		super();
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			buildJsPageSize("CarParamCalcuLc");
			...
			asignarAtributo("PAGINA", "CarParamCalcuLcPage", "cod", "CarParamCalcuLc." + accion + ".label");
			...
			limpiarBotoneraLista("carParamCalcuLc", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "valTope", "validacion", "mensaje = ValidaNumeroMMG(cdos_trim(valor), " + (12 - MMGDruidaHelper.getUserDecimalPrecision(this)) + ", " + MMGDruidaHelper.getUserDecimalPrecision(this)+ ", 'CarParamCalcuLc.valTope', 0, " + MMGDruidaHelper.getMaxValueForDruidaValidaFloat((12 - MMGDruidaHelper.getUserDecimalPrecision(this)), this) + ");");
		asignarAtributo("TEXT", "valFactCalc", "validacion", "mensaje = ValidaNumeroMMG(cdos_trim(valor), " + (4 - MMGDruidaHelper.getUserDecimalPrecision(this)) + ", " + MMGDruidaHelper.getUserDecimalPrecision(this)+ ", 'CarParamCalcuLc.valFactCalc', 0, " + MMGDruidaHelper.getMaxValueForDruidaValidaFloat((4 - MMGDruidaHelper.getUserDecimalPrecision(this)), this) + ");");
		
		
		//Primero determianmos el nombre del campo en la entidad de oriegen donde se van a cargar los datos
		asignar("VAR", "idAttributeLovOpener", conectorParametro(PARAMETRO_LOV_ATTRIBUTO));
		asignar("VAR", "idEntityLovOpener", conectorParametro(PARAMETRO_LOV_ENTIDAD));
		//asignarAtributo("CAPA", "carParamCalcuLcLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "CarParamCalcuLcPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		CarParamCalcuLcData carParamCalcuLcQuery= new CarParamCalcuLcData();
		carParamCalcuLcQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		CarParamCalcuLcData datosResult = (CarParamCalcuLcData)getSingleObject(BUSINESSID_QUERY, carParamCalcuLcQuery, 
			carParamCalcuLcQuery.clone(), "carParamCalcuLc");
		...
		CarParamCalcuLcData carParamCalcuLc = datosResult;
		es.indra.belcorp.mso.CarNivelRiesgData niriOidNiveRies = carParamCalcuLc.getNiriOidNiveRies();
		if(niriOidNiveRies != null && niriOidNiveRies.getId() != null) checkCombo("niriOidNiveRies" , niriOidNiveRies.getId().toString());
		asignar("TEXT", "valTope", FormatUtils.formatObject(carParamCalcuLc.getValTope(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "valFactCalc", FormatUtils.formatObject(carParamCalcuLc.getValFactCalc(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		if(carParamCalcuLc.getIndVariLineCred() != null){	
			checkCombo("indVariLineCred", FormatUtils.formatObject(carParamCalcuLc.getIndVariLineCred(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		}
		...
		//Deshabilitamos todos los campos para que no se editen
					...
					asignarAtributo("COMBO", "niriOidNiveRies", "disabled", "S");asignarAtributo("TEXT", "valTope", "disabled", "S");
		asignarAtributo("TEXT", "valFactCalc", "disabled", "S");
		
					asignarAtributo("COMBO", "indVariLineCred", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		...
		asignarAtributo("TEXT", "valTope", "req", "S");
		asignarAtributo("TEXT", "valFactCalc", "req", "S");
		asignarAtributo("COMBO", "indVariLineCred", "req", "S");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "carParamCalcuLcFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		CarParamCalcuLcData carParamCalcuLcQuery= new CarParamCalcuLcData();
		carParamCalcuLcQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(carParamCalcuLc.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"carParamCalcuLcFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"carParamCalcuLcFrm\",1, false)");
					asignarAtributo("COMBO","niriOidNiveRies", "ontab", "ejecutarAccionFocoModificacion(\"carParamCalcuLcFrm\",2, true)");
					asignarAtributo("COMBO","niriOidNiveRies", "onshtab", "ejecutarAccionFocoModificacion(\"carParamCalcuLcFrm\",2, false)");
				asignarAtributo("AREATEXTO", "valTope", "ontab","ejecutarAccionFocoModificacion(\"carParamCalcuLcFrm\",3, true)");
				asignarAtributo("AREATEXTO", "valTope", "onshtab","ejecutarAccionFocoModificacion(\"carParamCalcuLcFrm\",3, false)");
				asignarAtributo("AREATEXTO", "valFactCalc", "ontab","ejecutarAccionFocoModificacion(\"carParamCalcuLcFrm\",4, true)");
				asignarAtributo("AREATEXTO", "valFactCalc", "onshtab","ejecutarAccionFocoModificacion(\"carParamCalcuLcFrm\",4, false)");
				asignarAtributo("TEXT", "indVariLineCred", "ontab","ejecutarAccionFocoModificacion(\"carParamCalcuLcFrm\",5, true)");
				asignarAtributo("TEXT", "indVariLineCred", "onshtab","ejecutarAccionFocoModificacion(\"carParamCalcuLcFrm\",5, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","carParamCalcuLcTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","carParamCalcuLcTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es niriOidNiveRies...");		
				
					traza("MMG: en desactivateNonModifyFields encontrado atributo no editable...");
				
						asignarAtributo("COMBO", "niriOidNiveRies", "disabled", "S");
				traza("MMG: el atributo es valTope...");		
				
				traza("MMG: el atributo es valFactCalc...");		
				
				traza("MMG: el atributo es indVariLineCred...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","carParamCalcuLcFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","carParamCalcuLcListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","carParamCalcuLcListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(CarParamCalcuLcData carParamCalcuLc) throws Exception{
		HashMap checkedCombos = new HashMap();
		CarNivelRiesgData niriOidNiveRies = new CarNivelRiesgData();
		
						asignarComboResultados(BUSINESSID_NIRIOIDNIVERIES_QUERY,NIRIOIDNIVERIES_COMBO_CONNECTOR, 
			niriOidNiveRies, niriOidNiveRies.clone(), "carNivelRiesg", "niriOidNiveRies", "result_ROWSET" );
		if(carParamCalcuLc != null && carParamCalcuLc.getNiriOidNiveRies() != null){
				checkCombo("niriOidNiveRies" , carParamCalcuLc.getNiriOidNiveRies().getId().toString());
			}
	...
	* @param carParamCalcuLc La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(CarParamCalcuLcData carParamCalcuLc) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		CarParamCalcuLcData carParamCalcuLc = 
			(CarParamCalcuLcData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(carParamCalcuLc.getNiriOidNiveRies() != null){
			carParamCalcuLc.setNiriOidNiveRies((es.indra.belcorp.mso.CarNivelRiesgData)
			getSingleObject(BUSINESSID_NIRIOIDNIVERIES_QUERY, 
			carParamCalcuLc.getNiriOidNiveRies(),
			carParamCalcuLc.getNiriOidNiveRies().clone(),
			"carNivelRiesg"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(carParamCalcuLc);
		loadLeafDependenceCombos(carParamCalcuLc);
	}
