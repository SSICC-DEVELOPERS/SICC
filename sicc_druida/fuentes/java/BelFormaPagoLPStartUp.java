/*
    INDRA/CAR/mmg
    $Id: BelFormaPagoLPStartUp.java,v 1.1 2009/12/03 18:33:13 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class BelFormaPagoLPStartUp extends MMGDruidaBase{
	...
	public BelFormaPagoLPStartUp(){
		super();
	}

	public void inicio() throws Exception {
		pagina("BelFormaPagoPage");
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "BelFormaPagoPage", "cod", "BelFormaPago." + accion + ".label");
			...
			limpiarBotoneraLista("belFormaPago", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codFormPago", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 3);");
		asignarAtributo("AREATEXTO", "Descripcion", "validacion", "ValidaLongitud(cdos_trim(valor), 1, 60)");
		
		//Primero determianmos el nombre del campo en la entidad de oriegen donde se van a cargar los datos
		asignar("VAR", "idAttributeLovOpener", conectorParametro(PARAMETRO_LOV_ATTRIBUTO));
		asignar("VAR", "idEntityLovOpener", conectorParametro(PARAMETRO_LOV_ENTIDAD));
		//asignarAtributo("CAPA", "belFormaPagoLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "BelFormaPagoPage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("BelFormaPagoLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		BelFormaPagoData belFormaPagoQuery= new BelFormaPagoData();
		belFormaPagoQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		BelFormaPagoData datosResult = (BelFormaPagoData)getSingleObject(BUSINESSID_QUERY, belFormaPagoQuery, 
			belFormaPagoQuery.clone(), "belFormaPago");
		...
		preservaHiddensI18n(new Integer(1), "BEL_FORMA_PAGO", "belFormaPagoFrm", "Descripcion", true);
		...
		BelFormaPagoData belFormaPago = datosResult;
		asignar("TEXT", "codFormPago", FormatUtils.formatObject(belFormaPago.getCodFormPago(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("AREATEXTO", "Descripcion", FormatUtils.formatObject(belFormaPago.getDescripcion(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		loadLocalizationVars(belFormaPago);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "codFormPago", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "BEL_FORMA_PAGO", "belFormaPagoFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "codFormPago", "req", "S");
		...
		asignarAtributo("AREATEXTO", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('belFormaPagoFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "belFormaPagoFrm", "oculto", "N");
		...
		traza("MMG::Creando BelFormaPago");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		BelFormaPagoData belFormaPagoQuery= new BelFormaPagoData();
		belFormaPagoQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(belFormaPago.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"belFormaPagoFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"belFormaPagoFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codFormPago", "ontab","ejecutarAccionFocoModificacion(\"belFormaPagoFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codFormPago", "onshtab","ejecutarAccionFocoModificacion(\"belFormaPagoFrm\",2, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"belFormaPagoFrm\",3, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"belFormaPagoFrm\",3, false)");
					asignarAtributo("COMBO","paisOidPais", "ontab", "ejecutarAccionFocoModificacion(\"belFormaPagoFrm\",4, true)");
					asignarAtributo("COMBO","paisOidPais", "onshtab", "ejecutarAccionFocoModificacion(\"belFormaPagoFrm\",4, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","belFormaPagoTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","belFormaPagoTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","belFormaPagoFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","belFormaPagoListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","belFormaPagoListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(BelFormaPagoData belFormaPago) throws Exception{
		...
		if(belFormaPago != null && belFormaPago.getPaisOidPais() != null){
				checkCombo("paisOidPais" , belFormaPago.getPaisOidPais().getId().toString());
			}
	...
	* @param belFormaPago La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(BelFormaPagoData belFormaPago) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		BelFormaPagoData belFormaPago = 
			(BelFormaPagoData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(belFormaPago.getPaisOidPais() != null){
			belFormaPago.setPaisOidPais((es.indra.belcorp.mso.SegPaisViewData)
			getSingleObject(BUSINESSID_PAISOIDPAIS_QUERY, 
			belFormaPago.getPaisOidPais(),
			belFormaPago.getPaisOidPais().clone(),
			"segPaisView"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(belFormaPago);
		loadLeafDependenceCombos(belFormaPago);
	}
	...
	*/
	...
	protected void loadLocalizationVars(BelFormaPagoData belFormaPago) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("BEL_FORMA_PAGO");
		mmgLocalizationQuery.setEntiPk(belFormaPago.getId());
