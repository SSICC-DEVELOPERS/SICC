...
public class LPConsultaTiposSolicitudPais extends LPSICCBase{
         public LPConsultaTiposSolicitudPais(){
                  super();
         }
         ...
         public void ejecucion() throws Exception{
                  ...
                  try{
                           this.rastreo();
                           setTrazaFichero();
                           traza("> Entrando a LPConsultaTiposSolicitudPais.ejecucion");
