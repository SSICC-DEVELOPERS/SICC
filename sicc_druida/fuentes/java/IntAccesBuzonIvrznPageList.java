...
public class IntAccesBuzonIvrznPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","intAccesBuzonIvrznList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","IntAccesBuzonIvrzn.codAcceBuzoIvrz.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","IntAccesBuzonIvrzn.zzonOidZona.label" );
