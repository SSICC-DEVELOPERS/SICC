/*
    INDRA/CAR/mmg
    $Id: MaeProgrFidelLPStartUp.java,v 1.1 2009/12/03 18:33:15 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class MaeProgrFidelLPStartUp extends MMGDruidaBase{
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "MaeProgrFidelPage", "cod", "MaeProgrFidel." + accion + ".label");
			...
			limpiarBotoneraLista("maeProgrFidel", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codProgFide", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 2);");
		asignarAtributo("TEXT", "desProgFide", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 40);");
		asignarAtributo("TEXT", "factConv", "validacion", "mensaje = ValidaNumeroMMG(cdos_trim(valor), " + (12 - MMGDruidaHelper.getUserDecimalPrecision(this)) + ", " + MMGDruidaHelper.getUserDecimalPrecision(this)+ ", 'MaeProgrFidel.factConv', 0, " + MMGDruidaHelper.getMaxValueForDruidaValidaFloat((12 - MMGDruidaHelper.getUserDecimalPrecision(this)), this) + ");");
		
		
		//Primero determianmos el nombre del campo en la entidad de oriegen donde se van a cargar los datos
		asignar("VAR", "idAttributeLovOpener", conectorParametro(PARAMETRO_LOV_ATTRIBUTO));
		asignar("VAR", "idEntityLovOpener", conectorParametro(PARAMETRO_LOV_ENTIDAD));
		//asignarAtributo("CAPA", "maeProgrFidelLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "MaeProgrFidelPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		MaeProgrFidelData maeProgrFidelQuery= new MaeProgrFidelData();
		maeProgrFidelQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		MaeProgrFidelData datosResult = (MaeProgrFidelData)getSingleObject(BUSINESSID_QUERY, maeProgrFidelQuery, 
			maeProgrFidelQuery.clone(), "maeProgrFidel");
		...
		MaeProgrFidelData maeProgrFidel = datosResult;
		asignar("TEXT", "codProgFide", FormatUtils.formatObject(maeProgrFidel.getCodProgFide(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "desProgFide", FormatUtils.formatObject(maeProgrFidel.getDesProgFide(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "factConv", FormatUtils.formatObject(maeProgrFidel.getFactConv(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		es.indra.belcorp.mso.SegPaisViewData paisOidPais = maeProgrFidel.getPaisOidPais();
		...
		asignarAtributo("TEXT", "codProgFide", "disabled", "S");
		asignarAtributo("TEXT", "desProgFide", "disabled", "S");
		asignarAtributo("TEXT", "factConv", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		...
		asignarAtributo("TEXT", "codProgFide", "req", "S");
		asignarAtributo("TEXT", "desProgFide", "req", "S");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "maeProgrFidelFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		MaeProgrFidelData maeProgrFidelQuery= new MaeProgrFidelData();
		maeProgrFidelQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(maeProgrFidel.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"maeProgrFidelFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"maeProgrFidelFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codProgFide", "ontab","ejecutarAccionFocoModificacion(\"maeProgrFidelFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codProgFide", "onshtab","ejecutarAccionFocoModificacion(\"maeProgrFidelFrm\",2, false)");
				asignarAtributo("AREATEXTO", "desProgFide", "ontab","ejecutarAccionFocoModificacion(\"maeProgrFidelFrm\",3, true)");
				asignarAtributo("AREATEXTO", "desProgFide", "onshtab","ejecutarAccionFocoModificacion(\"maeProgrFidelFrm\",3, false)");
				asignarAtributo("AREATEXTO", "factConv", "ontab","ejecutarAccionFocoModificacion(\"maeProgrFidelFrm\",4, true)");
				asignarAtributo("AREATEXTO", "factConv", "onshtab","ejecutarAccionFocoModificacion(\"maeProgrFidelFrm\",4, false)");
					asignarAtributo("COMBO","paisOidPais", "ontab", "ejecutarAccionFocoModificacion(\"maeProgrFidelFrm\",5, true)");
					asignarAtributo("COMBO","paisOidPais", "onshtab", "ejecutarAccionFocoModificacion(\"maeProgrFidelFrm\",5, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","maeProgrFidelTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","maeProgrFidelTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codProgFide...");		
				
				traza("MMG: el atributo es desProgFide...");		
				
				traza("MMG: el atributo es factConv...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","maeProgrFidelFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","maeProgrFidelListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","maeProgrFidelListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(MaeProgrFidelData maeProgrFidel) throws Exception{
		...
		if(maeProgrFidel != null && maeProgrFidel.getPaisOidPais() != null){
				checkCombo("paisOidPais" , maeProgrFidel.getPaisOidPais().getId().toString());
			}
	...
	* @param maeProgrFidel La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(MaeProgrFidelData maeProgrFidel) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		MaeProgrFidelData maeProgrFidel = 
			(MaeProgrFidelData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(maeProgrFidel.getPaisOidPais() != null){
			maeProgrFidel.setPaisOidPais((es.indra.belcorp.mso.SegPaisViewData)
			getSingleObject(BUSINESSID_PAISOIDPAIS_QUERY, 
			maeProgrFidel.getPaisOidPais(),
			maeProgrFidel.getPaisOidPais().clone(),
			"segPaisView"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(maeProgrFidel);
		loadLeafDependenceCombos(maeProgrFidel);
	}
