...
public class ConectorBuscarTiposSolicitudPais  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","ConectorBuscarTiposSolicitudPais" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","DTOTipoSolicitudPais" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","PEDconsultaTiposSolicitudPais" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","TIPOSOLICITUD" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(8)).setAttribute("NOMBRE","NUMPORLOTE" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(9)).setAttribute("NOMBRE","ALARMANUMUNIDADES" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(10)).setAttribute("NOMBRE","SUJETOFLETE" );
      ((Element)v.get(10)).setAttribute("TIPO","BOOLEAN" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(11)).setAttribute("NOMBRE","PERMITEUNIONSOLICITUDES" );
      ((Element)v.get(11)).setAttribute("TIPO","BOOLEAN" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(12)).setAttribute("NOMBRE","TIPOCONSOLIDADO" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(13)).setAttribute("NOMBRE","TIPODOCUMENTOLEGAL" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(14)).setAttribute("NOMBRE","PERMITEREVERSION" );
      ((Element)v.get(14)).setAttribute("TIPO","BOOLEAN" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(15)).setAttribute("NOMBRE","INDPEDIDOPRUEBA" );
      ((Element)v.get(15)).setAttribute("TIPO","BOOLEAN" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(16)).setAttribute("NOMBRE","INDCOMISIONABLE" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(17)).setAttribute("NOMBRE","INDPEDGTZONA" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(18)).setAttribute("NOMBRE","INDCAMBIOVENTABEL" );
      ((Element)v.get(18)).setAttribute("TIPO","BOOLEAN" );
   ...
   private void getXML90(Document doc) {
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(19)).setAttribute("NOMBRE","INDVENTASAB14" );
      ((Element)v.get(19)).setAttribute("TIPO","BOOLEAN" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(20)).setAttribute("NOMBRE","FORMAPAGO" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(22)).setAttribute("NOMBRE","TIPOMOVASIGNA" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(23)).setAttribute("NOMBRE","RESERVASTOCK" );
      ((Element)v.get(23)).setAttribute("TIPO","BOOLEAN" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(24)).setAttribute("NOMBRE","TIPOMOVRESERVA" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(25)).setAttribute("NOMBRE","TIPOMOVFACTURACION" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(26)).setAttribute("NOMBRE","ACTIVIDAD" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(27)).setAttribute("NOMBRE","SOCIEDAD" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(28)).setAttribute("NOMBRE","MONEDA" );
