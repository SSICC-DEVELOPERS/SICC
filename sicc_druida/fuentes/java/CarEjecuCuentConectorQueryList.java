...
public class CarEjecuCuentConectorQueryList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad CarEjecuCuent" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGCarEjecuCuentQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGCarEjecuCuentQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","CarEjecuCuentListFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(8)).setAttribute("NOMBRE","codEjecCuen" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(9)).setAttribute("NOMBRE","jeraOidJera" );
