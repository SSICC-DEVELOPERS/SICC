...
/*
    INDRA/CAR/mmg
    $Id: PedUmbraFaltaListFormatter.java,v 1.1 2009/12/03 18:38:14 pecbazalar Exp $
    DESC
*/
 ...
 * @author Indra
 */
public class PedUmbraFaltaListFormatter extends MMGDruidaFormatoObjeto {
	
	public PedUmbraFaltaListFormatter() {
	}
	...
	public void formatea(String s, Object obj) throws Exception {
		...
		for (int i = 0; i < pedUmbraFaltaList.size(); i++) {
			...
			row.add((pedUmbraFaltaData.getNegoOidNego() != null ? 
				FormatUtils.formatObject(pedUmbraFaltaData.getNegoOidNego(), 
