...
public class RecMotivDevolPage  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","RecMotivDevolPage" );
      ((Element)v.get(0)).setAttribute("titulo","" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","" );
      ((Element)v.get(0)).setAttribute("onload","recMotivDevolInitComponents()" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","recmotivdevol.js" );
      ((Element)v.get(0)).appendChild((Element)v.get(4));
      /* Termina nodo:4   */

      /* Empieza nodo:5 / Elemento padre: 0   */
      v.add(doc.createElement("FORMULARIO"));
      ((Element)v.get(5)).setAttribute("nombre","recMotivDevolFrm" );
      ...
      ((Element)v.get(6)).setAttribute("valor","RecMotivDevolLPExecution" );
      ...
      ((Element)v.get(7)).setAttribute("valor","RecMotivDevolLPExecution" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(37)).setAttribute("nombre","recMotivDevolFormLayer" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(52)).setAttribute("cod","RecMotivDevol.legend.label" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(67)).setAttribute("cod","RecMotivDevol.id.label" );
      ...
      ((Element)v.get(70)).setAttribute("ontab","ejecutarAccionFoco('recMotivDevolFrm',1, true)" );
      ((Element)v.get(70)).setAttribute("onshtab","ejecutarAccionFoco('recMotivDevolFrm', 1, false)" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(88)).setAttribute("nombre","codMotiDevoTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(93)).setAttribute("nombre","codMotiDevoWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(95)).setAttribute("nombre","codMotiDevo" );
      ...
      ((Element)v.get(95)).setAttribute("ontab","ejecutarAccionFoco('recMotivDevolFrm',2, true)" );
      ((Element)v.get(95)).setAttribute("onshtab","ejecutarAccionFoco('recMotivDevolFrm', 2, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(96)).setAttribute("nombre","codMotiDevoGapTdId" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(113)).setAttribute("nombre","paisOidPaisTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(117)).setAttribute("nombre","lblpaisOidPais" );
      ...
      ((Element)v.get(117)).setAttribute("cod","RecMotivDevol.paisOidPais.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(118)).setAttribute("nombre","paisOidPaisWidgetTrId" );
      ...
      ((Element)v.get(120)).setAttribute("nombre","paisOidPais" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(120)).setAttribute("ontab","ejecutarAccionFoco('recMotivDevolFrm',3, true);" );
      ((Element)v.get(120)).setAttribute("onshtab","ejecutarAccionFoco('recMotivDevolFrm',3, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(122)).setAttribute("nombre","paisOidPaisGapTdId" );
      ...
      ((Element)v.get(128)).setAttribute("cod","RecMotivDevol.Descripcion.label" );
      ...
      ((Element)v.get(132)).setAttribute("ontab","ejecutarAccionFoco('recMotivDevolFrm',4, true)" );
      ((Element)v.get(132)).setAttribute("onshtab","ejecutarAccionFoco('recMotivDevolFrm', 4, false)" );
      ...
      ((Element)v.get(136)).setAttribute("href","javascript:openLocalizationDialog('recMotivDevolFrm', 'Descripcion', 1);" );
      ((Element)v.get(136)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"recMotivDevolFrm\",4, true)', 'ejecutarAccionFoco(\"recMotivDevolFrm\",4, false)')" );
   ...
   private void getXML630(Document doc) {
      ...
      /* Empieza nodo:142 / Elemento padre: 107   */
      v.add(doc.createElement("TD"));
      ((Element)v.get(142)).setAttribute("width","100%" );
      ((Element)v.get(107)).appendChild((Element)v.get(142));
      /* Termina nodo:142   */
      /* Termina nodo:107   */
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(152)).setAttribute("nombre","recMotivDevolTrButtons" );
      ...
      ((Element)v.get(159)).setAttribute("nombre","recMotivDevolTdQueryButton" );
      ((Element)v.get(158)).appendChild((Element)v.get(159));

      /* Empieza nodo:160 / Elemento padre: 159   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(160)).setAttribute("nombre","recMotivDevolQueryButton" );
      ((Element)v.get(160)).setAttribute("cod","MMGGlobal.queryButton.label" );
   }

   private void getXML720(Document doc) {
      ((Element)v.get(160)).setAttribute("estado","false" );
      ((Element)v.get(160)).setAttribute("accion","recMotivDevolFirstPage();" );
      ...
      ((Element)v.get(161)).setAttribute("nombre","recMotivDevolTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(163)).setAttribute("nombre","recMotivDevolLovNullButton" );
      ((Element)v.get(163)).setAttribute("ID","botonContenido" );
      ((Element)v.get(163)).setAttribute("tipo","html" );
      ((Element)v.get(163)).setAttribute("accion","recMotivDevolLovNullSelectionAction();" );
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(166)).setAttribute("nombre","recMotivDevolListLayer" );
      ...
      ((Element)v.get(167)).setAttribute("nombre","recMotivDevolList" );
   ...
   private void getXML810(Document doc) {
      ...
      ((Element)v.get(180)).setAttribute("cod","RecMotivDevol.codMotiDevo.label" );
      ...
      ((Element)v.get(181)).setAttribute("cod","RecMotivDevol.Descripcion.label" );
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(186)).setAttribute("nombre","recMotivDevolListButtonsLayer" );
   ...
   private void getXML900(Document doc) {
      ...
      ((Element)v.get(192)).setAttribute("nombre","recMotivDevolPaginationButtonBar" );
      ...
      ((Element)v.get(193)).setAttribute("nombre","recMotivDevolFirstPageButton" );
      ((Element)v.get(193)).setAttribute("funcion","recMotivDevolFirstPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(194)).setAttribute("nombre","recMotivDevolFirstPageButtonGapTd" );
      ...
      v.add(doc.createElement("BTN"));
      ((Element)v.get(196)).setAttribute("nombre","recMotivDevolPreviousPageButton" );
      ((Element)v.get(196)).setAttribute("funcion","recMotivDevolPreviousPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(197)).setAttribute("nombre","recMotivDevolPreviousPageButtonGapTd" );
      ...
      v.add(doc.createElement("BTN"));
      ((Element)v.get(199)).setAttribute("nombre","recMotivDevolNextPageButton" );
      ((Element)v.get(199)).setAttribute("funcion","recMotivDevolNextPage();" );
      ...
      ((Element)v.get(202)).setAttribute("nombre","recMotivDevolUpdateButtonTd" );
      ((Element)v.get(188)).appendChild((Element)v.get(202));

      /* Empieza nodo:203 / Elemento padre: 202   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(203)).setAttribute("nombre","recMotivDevolUpdateButton" );
      ((Element)v.get(203)).setAttribute("ID","botonContenido" );
      ((Element)v.get(203)).setAttribute("tipo","html" );
      ((Element)v.get(203)).setAttribute("accion","recMotivDevolUpdateSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(204)).setAttribute("nombre","recMotivDevolUpdateButtonGapTd" );
   }
   ...
   private void getXML990(Document doc) {
      ...
      ((Element)v.get(206)).setAttribute("nombre","recMotivDevolViewForRemoveButtonTd" );
      ((Element)v.get(188)).appendChild((Element)v.get(206));

      /* Empieza nodo:207 / Elemento padre: 206   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(207)).setAttribute("nombre","recMotivDevolViewForRemoveButton" );
      ((Element)v.get(207)).setAttribute("ID","botonContenido" );
      ((Element)v.get(207)).setAttribute("tipo","html" );
      ((Element)v.get(207)).setAttribute("accion","recMotivDevolViewSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(208)).setAttribute("nombre","recMotivDevolViewForRemoveButtonGapTd" );
      ...
      ((Element)v.get(210)).setAttribute("nombre","recMotivDevolLovSelectButtonTd" );
      ((Element)v.get(188)).appendChild((Element)v.get(210));

      /* Empieza nodo:211 / Elemento padre: 210   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(211)).setAttribute("nombre","recMotivDevolLovSelectButton" );
      ((Element)v.get(211)).setAttribute("ID","botonContenido" );
      ((Element)v.get(211)).setAttribute("tipo","html" );
      ((Element)v.get(211)).setAttribute("accion","recMotivDevolLovSelectionAction();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(212)).setAttribute("nombre","recMotivDevolLovSelectButtonGapTd" );
      ...
      ((Element)v.get(214)).setAttribute("nombre","recMotivDevolViewButtonTd" );
      ((Element)v.get(188)).appendChild((Element)v.get(214));

      /* Empieza nodo:215 / Elemento padre: 214   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(215)).setAttribute("nombre","recMotivDevolViewButton" );
      ((Element)v.get(215)).setAttribute("ID","botonContenido" );
      ((Element)v.get(215)).setAttribute("tipo","html" );
      ((Element)v.get(215)).setAttribute("accion","recMotivDevolViewSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(216)).setAttribute("nombre","recMotivDevolViewButtonGapTd" );
