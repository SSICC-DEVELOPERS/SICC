...
public class GenUsersPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","genUsersList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(16)).setAttribute("cod","GenUsers.myid.label" );
      ...
      ((Element)v.get(17)).setAttribute("cod","GenUsers.credential.label" );
      ...
      ((Element)v.get(18)).setAttribute("cod","GenUsers.setdate.label" );
      ...
      ((Element)v.get(19)).setAttribute("cod","GenUsers.retries.label" );
      ...
      ((Element)v.get(20)).setAttribute("cod","GenUsers.blocked.label" );
