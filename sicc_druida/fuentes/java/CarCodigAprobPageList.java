...
public class CarCodigAprobPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","carCodigAprobList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","CarCodigAprob.codApro.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","CarCodigAprob.Descripcion.label" );
