...
public class CarNivelRiesgConectorQueryForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad CarNivelRiesg" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGCarNivelRiesgQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGCarNivelRiesgQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","CarNivelRiesgFormFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","codNiveRies" );
