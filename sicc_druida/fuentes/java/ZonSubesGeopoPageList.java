...
public class ZonSubesGeopoPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","zonSubesGeopoList" );
      ...
      ((Element)v.get(14)).setAttribute("cod","ZonSubesGeopo.egeoOidEstrGeop.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","ZonSubesGeopo.codSube.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","ZonSubesGeopo.Descripcion.label" );
