...
public class CarParamNrPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","CarParamNr.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","CarParamNr.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('carParamNrFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('carParamNrFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(54)).setAttribute("cod","CarParamNr.niriOidNiveRies.label" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('carParamNrFrm',2, true);" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('carParamNrFrm',2, false);" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(65)).setAttribute("cod","CarParamNr.valMini.label" );
      ...
      ((Element)v.get(68)).setAttribute("ontab","ejecutarAccionFoco('carParamNrFrm',3, true)" );
      ((Element)v.get(68)).setAttribute("onshtab","ejecutarAccionFoco('carParamNrFrm', 3, false)" );
      ...
      ((Element)v.get(75)).setAttribute("cod","CarParamNr.valMaxi.label" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(78)).setAttribute("ontab","ejecutarAccionFoco('carParamNrFrm',4, true)" );
      ((Element)v.get(78)).setAttribute("onshtab","ejecutarAccionFoco('carParamNrFrm', 4, false)" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(84)).setAttribute("nombre","formGapTr1" );
      ...
      /* Empieza nodo:93 / Elemento padre: 0   */
      v.add(doc.createElement("TR"));
      ((Element)v.get(93)).setAttribute("nombre","carParamNrTrButtons" );
      ((Element)v.get(0)).appendChild((Element)v.get(93));
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(100)).setAttribute("class","tablaTitle" );
      ((Element)v.get(100)).setAttribute("nombre","carParamNrTdQueryButton" );
      ((Element)v.get(99)).appendChild((Element)v.get(100));

      /* Empieza nodo:101 / Elemento padre: 100   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(101)).setAttribute("nombre","carParamNrQueryButton" );
      ((Element)v.get(101)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(101)).setAttribute("estado","false" );
      ((Element)v.get(101)).setAttribute("accion","carParamNrFirstPage();" );
      ...
      ((Element)v.get(102)).setAttribute("nombre","carParamNrTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(104)).setAttribute("nombre","carParamNrLovNullButton" );
      ((Element)v.get(104)).setAttribute("ID","botonContenido" );
      ((Element)v.get(104)).setAttribute("tipo","html" );
      ((Element)v.get(104)).setAttribute("accion","carParamNrLovNullSelectionAction();" );
      ((Element)v.get(104)).setAttribute("estado","true" );
      ((Element)v.get(104)).setAttribute("cod","MMGGlobal.lovNullButton.label" );
