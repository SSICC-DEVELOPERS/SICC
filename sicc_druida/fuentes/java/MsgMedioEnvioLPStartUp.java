/*
    INDRA/CAR/mmg
    $Id: MsgMedioEnvioLPStartUp.java,v 1.1 2009/12/03 18:40:58 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class MsgMedioEnvioLPStartUp extends MMGDruidaBase{
	...
	public MsgMedioEnvioLPStartUp(){
		super();
	}

	public void inicio() throws Exception {
		pagina("MsgMedioEnvioPage");
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "MsgMedioEnvioPage", "cod", "MsgMedioEnvio." + accion + ".label");
			...
			limpiarBotoneraLista("msgMedioEnvio", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codMediEnvi", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 1);");
		asignarAtributo("TEXT", "desMediEnvi", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 40);");
		
		//Primero determianmos el nombre del campo en la entidad de oriegen donde se van a cargar los datos
		asignar("VAR", "idAttributeLovOpener", conectorParametro(PARAMETRO_LOV_ATTRIBUTO));
		asignar("VAR", "idEntityLovOpener", conectorParametro(PARAMETRO_LOV_ENTIDAD));
		//asignarAtributo("CAPA", "msgMedioEnvioLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "MsgMedioEnvioPage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("MsgMedioEnvioLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		MsgMedioEnvioData msgMedioEnvioQuery= new MsgMedioEnvioData();
		msgMedioEnvioQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		MsgMedioEnvioData datosResult = (MsgMedioEnvioData)getSingleObject(BUSINESSID_QUERY, msgMedioEnvioQuery, 
			msgMedioEnvioQuery.clone(), "msgMedioEnvio");
		...
		MsgMedioEnvioData msgMedioEnvio = datosResult;
		asignar("TEXT", "codMediEnvi", FormatUtils.formatObject(msgMedioEnvio.getCodMediEnvi(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "desMediEnvi", FormatUtils.formatObject(msgMedioEnvio.getDesMediEnvi(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		asignarAtributo("TEXT", "codMediEnvi", "disabled", "S");
		asignarAtributo("TEXT", "desMediEnvi", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		...
		asignarAtributo("TEXT", "codMediEnvi", "req", "S");
		asignarAtributo("TEXT", "desMediEnvi", "req", "S");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "msgMedioEnvioFrm", "oculto", "N");
		...
		traza("MMG::Creando MsgMedioEnvio");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		MsgMedioEnvioData msgMedioEnvioQuery= new MsgMedioEnvioData();
		msgMedioEnvioQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(msgMedioEnvio.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"msgMedioEnvioFrm\",0, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"msgMedioEnvioFrm\",0, false)");
				asignarAtributo("AREATEXTO", "codMediEnvi", "ontab","ejecutarAccionFocoModificacion(\"msgMedioEnvioFrm\",0, true)");
				asignarAtributo("AREATEXTO", "codMediEnvi", "onshtab","ejecutarAccionFocoModificacion(\"msgMedioEnvioFrm\",0, false)");
				asignarAtributo("AREATEXTO", "desMediEnvi", "ontab","ejecutarAccionFocoModificacion(\"msgMedioEnvioFrm\",0, true)");
				asignarAtributo("AREATEXTO", "desMediEnvi", "onshtab","ejecutarAccionFocoModificacion(\"msgMedioEnvioFrm\",0, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","msgMedioEnvioTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","msgMedioEnvioTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codMediEnvi...");		
				
				traza("MMG: el atributo es desMediEnvi...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","msgMedioEnvioFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","msgMedioEnvioListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","msgMedioEnvioListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(MsgMedioEnvioData msgMedioEnvio) throws Exception{
	...
	* @param msgMedioEnvio La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(MsgMedioEnvioData msgMedioEnvio) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		MsgMedioEnvioData msgMedioEnvio = 
			(MsgMedioEnvioData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(msgMedioEnvio);
		loadLeafDependenceCombos(msgMedioEnvio);
	}
