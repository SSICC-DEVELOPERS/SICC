...
public class SegSubacViewPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","segSubacViewList" );
      ...
      ((Element)v.get(12)).setAttribute("cod","SegSubacView.Descripcion.label" );
