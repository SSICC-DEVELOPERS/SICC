...
public class FacTipoOfertExcluPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","FacTipoOfertExclu.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","FacTipoOfertExclu.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('facTipoOfertExcluFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('facTipoOfertExcluFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(54)).setAttribute("cod","FacTipoOfertExclu.paisOidPais.label" );
      ...
      ((Element)v.get(57)).setAttribute("disabled","S" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('facTipoOfertExcluFrm',2, true);" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('facTipoOfertExcluFrm',2, false);" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(76)).setAttribute("nombre","fecDesdTdId" );
   ...
   private void getXML360(Document doc) {
      ((Element)v.get(81)).setAttribute("nombre","fecDesdWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(83)).setAttribute("nombre","fecDesd" );
      ...
      ((Element)v.get(83)).setAttribute("size","10" );
      ...
      ((Element)v.get(83)).setAttribute("ontab","ejecutarAccionFoco('facTipoOfertExcluFrm',3, true)" );
      ((Element)v.get(83)).setAttribute("onshtab","ejecutarAccionFoco('facTipoOfertExcluFrm', 3, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(84)).setAttribute("nombre","fecDesdGapTdId" );
   ...
   private void getXML450(Document doc) {
      v.add(doc.createElement("TD"));
      ((Element)v.get(101)).setAttribute("nombre","fecHastTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(106)).setAttribute("nombre","fecHastWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(108)).setAttribute("nombre","fecHast" );
      ...
      ((Element)v.get(108)).setAttribute("ontab","ejecutarAccionFoco('facTipoOfertExcluFrm',4, true)" );
      ((Element)v.get(108)).setAttribute("onshtab","ejecutarAccionFoco('facTipoOfertExcluFrm', 4, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(109)).setAttribute("nombre","fecHastGapTdId" );
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(126)).setAttribute("nombre","tofeOidTipoOfer_canaOidCanaTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(130)).setAttribute("nombre","lbltofeOidTipoOfer_canaOidCana" );
      ...
      ((Element)v.get(130)).setAttribute("cod","PreTipoOfert.canaOidCana.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(131)).setAttribute("nombre","tofeOidTipoOfer_canaOidCanaWidgetTrId" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(133)).setAttribute("nombre","tofeOidTipoOfer_canaOidCana" );
      ...
      ((Element)v.get(133)).setAttribute("onchange","mmgDependeneChange('tofeOidTipoOfer_canaOidCana', 'tofeOidTipoOfer' , 'facTipoOfertExclu')" );
      ...
      ((Element)v.get(133)).setAttribute("ontab","focaliza('facTipoOfertExcluFrm.tofeOidTipoOfer');" );
      ((Element)v.get(133)).setAttribute("onshtab","ejecutarAccionFoco('facTipoOfertExcluFrm',5, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(135)).setAttribute("nombre","tofeOidTipoOfer_canaOidCanaGapTdId" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(137)).setAttribute("nombre","tofeOidTipoOferTdId" );
   ...
   private void getXML630(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(141)).setAttribute("nombre","lbltofeOidTipoOfer" );
      ...
      ((Element)v.get(141)).setAttribute("cod","FacTipoOfertExclu.tofeOidTipoOfer.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(142)).setAttribute("nombre","tofeOidTipoOferWidgetTrId" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(144)).setAttribute("nombre","tofeOidTipoOfer" );
      ...
      ((Element)v.get(144)).setAttribute("ontab","ejecutarAccionFoco('facTipoOfertExcluFrm',5, true);" );
      ((Element)v.get(144)).setAttribute("onshtab","focaliza('facTipoOfertExcluFrm.tofeOidTipoOfer_canaOidCana');" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(146)).setAttribute("nombre","tofeOidTipoOferGapTdId" );
      ...
      /* Empieza nodo:150 / Elemento padre: 120   */
      v.add(doc.createElement("TD"));
      ((Element)v.get(150)).setAttribute("width","100%" );
      ((Element)v.get(120)).appendChild((Element)v.get(150));
      /* Termina nodo:150   */
      /* Termina nodo:120   */
   ...
   private void getXML720(Document doc) {
      ...
      /* Empieza nodo:160 / Elemento padre: 0   */
      v.add(doc.createElement("TR"));
      ((Element)v.get(160)).setAttribute("nombre","facTipoOfertExcluTrButtons" );
      ((Element)v.get(0)).appendChild((Element)v.get(160));
      ...
      ((Element)v.get(167)).setAttribute("nombre","facTipoOfertExcluTdQueryButton" );
      ((Element)v.get(166)).appendChild((Element)v.get(167));

      /* Empieza nodo:168 / Elemento padre: 167   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(168)).setAttribute("nombre","facTipoOfertExcluQueryButton" );
      ((Element)v.get(168)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(168)).setAttribute("estado","false" );
      ((Element)v.get(168)).setAttribute("accion","facTipoOfertExcluFirstPage();" );
      ...
      ((Element)v.get(169)).setAttribute("nombre","facTipoOfertExcluTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(171)).setAttribute("nombre","facTipoOfertExcluLovNullButton" );
      ((Element)v.get(171)).setAttribute("ID","botonContenido" );
      ((Element)v.get(171)).setAttribute("tipo","html" );
      ((Element)v.get(171)).setAttribute("accion","facTipoOfertExcluLovNullSelectionAction();" );
