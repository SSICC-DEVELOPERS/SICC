...
public class ZonRegioView2PageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","ZonRegioView2.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","ZonRegioView2.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('zonRegioView2Frm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('zonRegioView2Frm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(54)).setAttribute("cod","ZonRegioView2.codRegi.label" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('zonRegioView2Frm',2, true)" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('zonRegioView2Frm', 2, false)" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(75)).setAttribute("nombre","canaOidCanaTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(80)).setAttribute("nombre","canaOidCanaWidgetTrId" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(82)).setAttribute("nombre","canaOidCana" );
      ...
      ((Element)v.get(82)).setAttribute("ontab","ejecutarAccionFoco('zonRegioView2Frm',3, true);" );
      ((Element)v.get(82)).setAttribute("onshtab","ejecutarAccionFoco('zonRegioView2Frm',3, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(84)).setAttribute("nombre","canaOidCanaGapTdId" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(105)).setAttribute("cod","ZonRegioView2.marcOidMarc.label" );
      ...
      ((Element)v.get(108)).setAttribute("ontab","ejecutarAccionFoco('zonRegioView2Frm',4, true);" );
      ((Element)v.get(108)).setAttribute("onshtab","ejecutarAccionFoco('zonRegioView2Frm',4, false);" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(131)).setAttribute("cod","ZonRegioView2.paisOidPais.label" );
      ...
      ((Element)v.get(134)).setAttribute("ontab","ejecutarAccionFoco('zonRegioView2Frm',5, true);" );
      ((Element)v.get(134)).setAttribute("onshtab","ejecutarAccionFoco('zonRegioView2Frm',5, false);" );
   ...
   private void getXML630(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(150)).setAttribute("nombre","zonRegioView2TrButtons" );
      ...
      ((Element)v.get(157)).setAttribute("nombre","zonRegioView2TdQueryButton" );
      ((Element)v.get(156)).appendChild((Element)v.get(157));

      /* Empieza nodo:158 / Elemento padre: 157   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(158)).setAttribute("nombre","zonRegioView2QueryButton" );
      ((Element)v.get(158)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(158)).setAttribute("estado","false" );
      ((Element)v.get(158)).setAttribute("accion","zonRegioView2FirstPage();" );
      ...
      ((Element)v.get(159)).setAttribute("nombre","zonRegioView2TdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(161)).setAttribute("nombre","zonRegioView2LovNullButton" );
      ((Element)v.get(161)).setAttribute("ID","botonContenido" );
      ((Element)v.get(161)).setAttribute("tipo","html" );
      ((Element)v.get(161)).setAttribute("accion","zonRegioView2LovNullSelectionAction();" );
   }
