...
public class MaeNegocViewConectorQueryForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad MaeNegocView" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGMaeNegocViewQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGMaeNegocViewQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","MaeNegocViewFormFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(8)).setAttribute("NOMBRE","codNego" );
