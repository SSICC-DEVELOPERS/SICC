...
public class ConectorObtienePeriodosActuales  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Permite obtener la lista de periodos actuales para el seteo default por marca y canal" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","DTOBuscarPeriodos" );
