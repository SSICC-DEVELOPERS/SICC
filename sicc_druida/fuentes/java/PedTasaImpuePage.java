...
public class PedTasaImpuePage  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","PedTasaImpuePage" );
      ((Element)v.get(0)).setAttribute("titulo","" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","" );
      ((Element)v.get(0)).setAttribute("onload","pedTasaImpueInitComponents()" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","pedtasaimpue.js" );
      ((Element)v.get(0)).appendChild((Element)v.get(4));
      /* Termina nodo:4   */

      /* Empieza nodo:5 / Elemento padre: 0   */
      v.add(doc.createElement("FORMULARIO"));
      ((Element)v.get(5)).setAttribute("nombre","pedTasaImpueFrm" );
      ...
      ((Element)v.get(6)).setAttribute("valor","PedTasaImpueLPExecution" );
      ...
      ((Element)v.get(7)).setAttribute("valor","PedTasaImpueLPExecution" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(37)).setAttribute("nombre","pedTasaImpueFormLayer" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(52)).setAttribute("cod","PedTasaImpue.legend.label" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(67)).setAttribute("cod","PedTasaImpue.id.label" );
      ...
      ((Element)v.get(70)).setAttribute("ontab","ejecutarAccionFoco('pedTasaImpueFrm',1, true)" );
      ((Element)v.get(70)).setAttribute("onshtab","ejecutarAccionFoco('pedTasaImpueFrm', 1, false)" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(88)).setAttribute("nombre","valIndiImpuTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(93)).setAttribute("nombre","valIndiImpuWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(95)).setAttribute("nombre","valIndiImpu" );
      ...
      ((Element)v.get(95)).setAttribute("ontab","ejecutarAccionFoco('pedTasaImpueFrm',2, true)" );
      ((Element)v.get(95)).setAttribute("onshtab","ejecutarAccionFoco('pedTasaImpueFrm', 2, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(96)).setAttribute("nombre","valIndiImpuGapTdId" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(102)).setAttribute("cod","PedTasaImpue.Descripcion.label" );
      ...
      ((Element)v.get(106)).setAttribute("ontab","ejecutarAccionFoco('pedTasaImpueFrm',3, true)" );
      ((Element)v.get(106)).setAttribute("onshtab","ejecutarAccionFoco('pedTasaImpueFrm', 3, false)" );
      ...
      ((Element)v.get(110)).setAttribute("href","javascript:openLocalizationDialog('pedTasaImpueFrm', 'Descripcion', 1);" );
      ((Element)v.get(110)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"pedTasaImpueFrm\",3, true)', 'ejecutarAccionFoco(\"pedTasaImpueFrm\",3, false)')" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(114)).setAttribute("nombre","valTasaImpuTdId" );
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(119)).setAttribute("nombre","valTasaImpuWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(121)).setAttribute("nombre","valTasaImpu" );
      ...
      ((Element)v.get(121)).setAttribute("size","6" );
      ...
      ((Element)v.get(121)).setAttribute("ontab","ejecutarAccionFoco('pedTasaImpueFrm',4, true)" );
      ((Element)v.get(121)).setAttribute("onshtab","ejecutarAccionFoco('pedTasaImpueFrm', 4, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(122)).setAttribute("nombre","valTasaImpuGapTdId" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(124)).setAttribute("nombre","paisOidPaisTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(128)).setAttribute("nombre","lblpaisOidPais" );
      ...
      ((Element)v.get(128)).setAttribute("cod","PedTasaImpue.paisOidPais.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(129)).setAttribute("nombre","paisOidPaisWidgetTrId" );
      ...
      ((Element)v.get(131)).setAttribute("nombre","paisOidPais" );
      ...
      ((Element)v.get(131)).setAttribute("ontab","ejecutarAccionFoco('pedTasaImpueFrm',5, true);" );
      ((Element)v.get(131)).setAttribute("onshtab","ejecutarAccionFoco('pedTasaImpueFrm',5, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(133)).setAttribute("nombre","paisOidPaisGapTdId" );
   }
   ...
   private void getXML630(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(147)).setAttribute("nombre","pedTasaImpueTrButtons" );
      ...
      ((Element)v.get(154)).setAttribute("nombre","pedTasaImpueTdQueryButton" );
      ((Element)v.get(153)).appendChild((Element)v.get(154));

      /* Empieza nodo:155 / Elemento padre: 154   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(155)).setAttribute("nombre","pedTasaImpueQueryButton" );
      ((Element)v.get(155)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(155)).setAttribute("estado","false" );
      ((Element)v.get(155)).setAttribute("accion","pedTasaImpueFirstPage();" );
   ...
   private void getXML720(Document doc) {
      ...
      ((Element)v.get(156)).setAttribute("nombre","pedTasaImpueTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(158)).setAttribute("nombre","pedTasaImpueLovNullButton" );
      ((Element)v.get(158)).setAttribute("ID","botonContenido" );
      ((Element)v.get(158)).setAttribute("tipo","html" );
      ((Element)v.get(158)).setAttribute("accion","pedTasaImpueLovNullSelectionAction();" );
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(161)).setAttribute("nombre","pedTasaImpueListLayer" );
      ...
      ((Element)v.get(162)).setAttribute("nombre","pedTasaImpueList" );
   ...
   private void getXML810(Document doc) {
      ...
      ((Element)v.get(175)).setAttribute("IDScroll","EstCab" );
      ((Element)v.get(175)).setAttribute("imgFondo","" );
      ((Element)v.get(175)).setAttribute("colFondo","#CCCCCC" );
      ...
      ((Element)v.get(176)).setAttribute("cod","PedTasaImpue.valIndiImpu.label" );
      ...
      ((Element)v.get(177)).setAttribute("cod","PedTasaImpue.Descripcion.label" );
      ...
      ((Element)v.get(178)).setAttribute("cod","PedTasaImpue.valTasaImpu.label" );
      ...
      ((Element)v.get(179)).setAttribute("tipoEnvio","seleccion" );
      ...
      /* Empieza nodo:184 / Elemento padre: 5   */
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(184)).setAttribute("nombre","pedTasaImpueListButtonsLayer" );
      ((Element)v.get(184)).setAttribute("visibilidad","hidden" );
      ((Element)v.get(184)).setAttribute("alto","30" );
      ((Element)v.get(184)).setAttribute("ancho","98%" );
      ((Element)v.get(184)).setAttribute("borde","n" );
      ((Element)v.get(184)).setAttribute("imagenf","" );
      ((Element)v.get(184)).setAttribute("repeat","" );
      ((Element)v.get(184)).setAttribute("padding","0" );
      ((Element)v.get(184)).setAttribute("contravsb","" );
      ((Element)v.get(184)).setAttribute("x","16" );
   }

   private void getXML900(Document doc) {
      ((Element)v.get(184)).setAttribute("y","" );
      ((Element)v.get(184)).setAttribute("zindex","" );
      ((Element)v.get(5)).appendChild((Element)v.get(184));

      /* Empieza nodo:185 / Elemento padre: 184   */
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(185)).setAttribute("nombre","toolbarSeparatorLayer" );
      ((Element)v.get(185)).setAttribute("visibilidad","inherit" );
      ((Element)v.get(185)).setAttribute("alto","23" );
      ((Element)v.get(185)).setAttribute("ancho","1" );
      ...
      ((Element)v.get(185)).setAttribute("x","56" );
      ((Element)v.get(185)).setAttribute("y","0" );
      ((Element)v.get(185)).setAttribute("zindex","" );
      ((Element)v.get(185)).setAttribute("colborde","#999999" );
      ...
      ((Element)v.get(186)).setAttribute("cellspacing","1" );
      ...
      ((Element)v.get(190)).setAttribute("nombre","pedTasaImpuePaginationButtonBar" );
      ...
      ((Element)v.get(191)).setAttribute("nombre","pedTasaImpueFirstPageButton" );
      ((Element)v.get(191)).setAttribute("funcion","pedTasaImpueFirstPage();" );
      ((Element)v.get(191)).setAttribute("off","primera_over0.gif" );
      ((Element)v.get(191)).setAttribute("on","primera_over0.gif" );
      ((Element)v.get(191)).setAttribute("disable","primera_on0.gif" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(192)).setAttribute("nombre","pedTasaImpueFirstPageButtonGapTd" );
      ...
      ((Element)v.get(193)).setAttribute("width","5" );
      ...
      v.add(doc.createElement("BTN"));
      ((Element)v.get(194)).setAttribute("nombre","pedTasaImpuePreviousPageButton" );
      ((Element)v.get(194)).setAttribute("funcion","pedTasaImpuePreviousPage();" );
      ((Element)v.get(194)).setAttribute("off","retroceder_over0.gif" );
      ((Element)v.get(194)).setAttribute("on","retroceder_over0.gif" );
      ((Element)v.get(194)).setAttribute("disable","retroceder_on0.gif" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(195)).setAttribute("nombre","pedTasaImpuePreviousPageButtonGapTd" );
      ...
      v.add(doc.createElement("BTN"));
      ((Element)v.get(197)).setAttribute("nombre","pedTasaImpueNextPageButton" );
      ((Element)v.get(197)).setAttribute("funcion","pedTasaImpueNextPage();" );
      ((Element)v.get(197)).setAttribute("off","avanzar_over0.gif" );
      ((Element)v.get(197)).setAttribute("on","avanzar_over0.gif" );
      ((Element)v.get(197)).setAttribute("disable","avanzar_on0.gif" );
      ...
      ((Element)v.get(199)).setAttribute("width","19" );
      ((Element)v.get(198)).appendChild((Element)v.get(199));
      /* Termina nodo:199   */
      /* Termina nodo:198   */

      /* Empieza nodo:200 / Elemento padre: 186   */
      v.add(doc.createElement("TD"));
      ((Element)v.get(200)).setAttribute("class","tablaTitle" );
      ((Element)v.get(200)).setAttribute("nombre","pedTasaImpueUpdateButtonTd" );
      ((Element)v.get(186)).appendChild((Element)v.get(200));
   ...
   private void getXML990(Document doc) {
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(201)).setAttribute("nombre","pedTasaImpueUpdateButton" );
      ((Element)v.get(201)).setAttribute("ID","botonContenido" );
      ((Element)v.get(201)).setAttribute("tipo","html" );
      ((Element)v.get(201)).setAttribute("accion","pedTasaImpueUpdateSelection();" );
      ((Element)v.get(201)).setAttribute("estado","false" );
      ((Element)v.get(201)).setAttribute("cod","MMGGlobal.updateButton.label" );
      ((Element)v.get(200)).appendChild((Element)v.get(201));
      /* Termina nodo:201   */
      /* Termina nodo:200   */

      /* Empieza nodo:202 / Elemento padre: 186   */
      v.add(doc.createElement("TD"));
      ((Element)v.get(202)).setAttribute("nombre","pedTasaImpueUpdateButtonGapTd" );
      ((Element)v.get(186)).appendChild((Element)v.get(202));

      /* Empieza nodo:203 / Elemento padre: 202   */
      v.add(doc.createElement("IMG"));
      ((Element)v.get(203)).setAttribute("src","b.gif" );
      ((Element)v.get(203)).setAttribute("height","8" );
      ((Element)v.get(203)).setAttribute("width","10" );
      ((Element)v.get(202)).appendChild((Element)v.get(203));
      /* Termina nodo:203   */
      /* Termina nodo:202   */

      /* Empieza nodo:204 / Elemento padre: 186   */
      v.add(doc.createElement("TD"));
      ((Element)v.get(204)).setAttribute("class","tablaTitle" );
      ((Element)v.get(204)).setAttribute("nombre","pedTasaImpueViewForRemoveButtonTd" );
      ((Element)v.get(186)).appendChild((Element)v.get(204));

      /* Empieza nodo:205 / Elemento padre: 204   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(205)).setAttribute("nombre","pedTasaImpueViewForRemoveButton" );
      ((Element)v.get(205)).setAttribute("ID","botonContenido" );
      ((Element)v.get(205)).setAttribute("tipo","html" );
      ((Element)v.get(205)).setAttribute("accion","pedTasaImpueViewSelection();" );
      ((Element)v.get(205)).setAttribute("estado","false" );
      ((Element)v.get(205)).setAttribute("cod","MMGGlobal.viewButton.label" );
      ((Element)v.get(204)).appendChild((Element)v.get(205));
      /* Termina nodo:205   */
      /* Termina nodo:204   */

      /* Empieza nodo:206 / Elemento padre: 186   */
      v.add(doc.createElement("TD"));
      ((Element)v.get(206)).setAttribute("nombre","pedTasaImpueViewForRemoveButtonGapTd" );
      ((Element)v.get(186)).appendChild((Element)v.get(206));
      ...
      /* Empieza nodo:208 / Elemento padre: 186   */
      v.add(doc.createElement("TD"));
      ((Element)v.get(208)).setAttribute("class","tablaTitle" );
      ((Element)v.get(208)).setAttribute("nombre","pedTasaImpueLovSelectButtonTd" );
      ((Element)v.get(186)).appendChild((Element)v.get(208));

      /* Empieza nodo:209 / Elemento padre: 208   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(209)).setAttribute("nombre","pedTasaImpueLovSelectButton" );
      ((Element)v.get(209)).setAttribute("ID","botonContenido" );
      ((Element)v.get(209)).setAttribute("tipo","html" );
      ((Element)v.get(209)).setAttribute("accion","pedTasaImpueLovSelectionAction();" );
      ((Element)v.get(209)).setAttribute("estado","true" );
      ((Element)v.get(209)).setAttribute("cod","MMGGlobal.lovSelectButton.label" );
      ((Element)v.get(208)).appendChild((Element)v.get(209));
      /* Termina nodo:209   */
      /* Termina nodo:208   */

      /* Empieza nodo:210 / Elemento padre: 186   */
      v.add(doc.createElement("TD"));
      ((Element)v.get(210)).setAttribute("nombre","pedTasaImpueLovSelectButtonGapTd" );
      ((Element)v.get(186)).appendChild((Element)v.get(210));
      ...
      /* Empieza nodo:212 / Elemento padre: 186   */
      v.add(doc.createElement("TD"));
      ((Element)v.get(212)).setAttribute("class","tablaTitle" );
      ((Element)v.get(212)).setAttribute("nombre","pedTasaImpueViewButtonTd" );
      ((Element)v.get(186)).appendChild((Element)v.get(212));

      /* Empieza nodo:213 / Elemento padre: 212   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(213)).setAttribute("nombre","pedTasaImpueViewButton" );
      ((Element)v.get(213)).setAttribute("ID","botonContenido" );
      ((Element)v.get(213)).setAttribute("tipo","html" );
      ((Element)v.get(213)).setAttribute("accion","pedTasaImpueViewSelection();" );
      ((Element)v.get(213)).setAttribute("estado","false" );
      ((Element)v.get(213)).setAttribute("cod","MMGGlobal.viewButton.label" );
      ((Element)v.get(212)).appendChild((Element)v.get(213));
      /* Termina nodo:213   */
      /* Termina nodo:212   */

      /* Empieza nodo:214 / Elemento padre: 186   */
      v.add(doc.createElement("TD"));
      ((Element)v.get(214)).setAttribute("nombre","pedTasaImpueViewButtonGapTd" );
      ((Element)v.get(186)).appendChild((Element)v.get(214));
      ...
      /* Empieza nodo:216 / Elemento padre: 186   */
      v.add(doc.createElement("TD"));
      ((Element)v.get(216)).setAttribute("width","100%" );
      ((Element)v.get(186)).appendChild((Element)v.get(216));
      /* Termina nodo:216   */
      /* Termina nodo:186   */
      /* Termina nodo:184   */
      /* Termina nodo:5   */
