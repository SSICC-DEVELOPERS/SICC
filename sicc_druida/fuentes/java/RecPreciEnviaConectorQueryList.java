...
public class RecPreciEnviaConectorQueryList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad RecPreciEnvia" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGRecPreciEnviaQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGRecPreciEnviaQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","RecPreciEnviaListFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","codPrecEnvi" );
