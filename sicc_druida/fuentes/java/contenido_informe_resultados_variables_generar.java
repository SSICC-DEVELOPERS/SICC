...
public class contenido_informe_resultados_variables_generar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_informe_resultados_variables_generar" );
      ((Element)v.get(0)).setAttribute("cod","0877" );
      ((Element)v.get(0)).setAttribute("titulo","Generar Informe Resultados de variables por período por Región por Zona - Detalle" );
      ...
      v.add(doc.createTextNode("\r\r\r  \r  function onLoad(){\r    \r    configurarMenuSecundario('Formulario');\r    fMostrarMensajeError();\r    set('Formulario.txtAno', get('Formulario.anioDefault'));\r    setearPais();\r    focaliza('Formulario.txtAno');\r    \r  }\r\r    function quitarItemVacio(elemento){\r      var elementoADevolver = new Array();\r     \r      for(var k=0;k<elemento.length;k++) {\r          if (elemento[k] != ''){                            \r             elementoADevolver[elementoADevolver.length] = elemento[k];\r          }\r      }\r         \r      return elementoADevolver;\r      \r   }\r\r  \r  \r  function setearPais(){\r  \r    var pais = get('Formulario.pais');\r    \r    iSeleccionado = new Array();\r    iSeleccionado[0] = pais;\r    set('Formulario.cbPais',iSeleccionado);\r  \r  }\r \r  \r  \r  function fLimpiar(){\r    \r    var aCombo = new Array(new Array(\"\",\"\"));\r    \r    set('Formulario.txtAno',get('Formulario.anioDefault'));\r    set_combo('Formulario.cbSubgerenciaVentas', aCombo, []);\r    set_combo('Formulario.cbRegion', aCombo, []);\r    set_combo('Formulario.cbZona', aCombo, []);\r    \r    focaliza('Formulario.txtAno');\r    \r  }\r   \r  \r  \r  function onChangePaisMarcaCanal(){\r    \r    opciones = new Array();\r    \r    pais = get('Formulario.cbPais');\r    marca = get('Formulario.cbMarca');\r    canal = get('Formulario.cbCanal');\r    sgv = get('Formulario.cbSubgerenciaVentas');\r    \r    if(pais != '' && marca != '' && canal != ''){\r      \r      var arr = new Array();\r      \r      arr[arr.length] = [\"oidPais\", pais];\r      arr[arr.length] = [\"oidMarca\", marca];\r      arr[arr.length] = [\"oidCanal\", canal];\r      \r      recargaCombo(\"Formulario.cbSubgerenciaVentas\", \"ZONRecargaSubgerenciaVentas\", \"es.indra.sicc.dtos.zon.DTOUnidadAdministrativa\",arr);\r      recargaCombo(\"Formulario.cbRegion\", \"ZONRecargaRegiones\", \"es.indra.sicc.dtos.zon.DTOUnidadAdministrativa\",arr);\r      recargaCombo(\"Formulario.cbZona\", \"ZONRecargaZonas\", \"es.indra.sicc.dtos.zon.DTOUnidadAdministrativa\",arr);\r      \r      accion(\"Formulario.cbRegion\",\".disabled=false\");\r      accion(\"Formulario.cbZona\",\".disabled=false\");\r    \r    }else{\r    \r      var aCombo = new Array(new Array(\"\",\"\"));\r      \r      set_combo('Formulario.cbSubgerenciaVentas',aCombo, []);\r      set_combo('Formulario.cbRegion',aCombo, []);\r      set_combo('Formulario.cbZona',aCombo, []);\r    \r    }\r    \r  }\r  \r  \r  function cambioSGV(){\r    \r    pais = get('Formulario.cbPais');\r    marca = get('Formulario.cbMarca');\r    canal = get('Formulario.cbCanal');\r    sgv = get('Formulario.cbSubgerenciaVentas','V');\r    \r    if (sgv.length == 1 ){\r      \r      var arr = new Array();\r      \r      arr[arr.length] = [\"oidPais\", pais];\r      arr[arr.length] = [\"oidMarca\", marca];\r      arr[arr.length] = [\"oidCanal\", canal];\r      arr[arr.length] = [\"oidSGV\", sgv];\r      \r      recargaCombo(\"Formulario.cbRegion\", \"ZONRecargaRegiones\", \"es.indra.sicc.dtos.zon.DTOUnidadAdministrativa\",arr);\r      recargaCombo(\"Formulario.cbZona\", \"ZONRecargaZonas\", \"es.indra.sicc.dtos.zon.DTOUnidadAdministrativa\",arr);\r      \r      accion(\"Formulario.cbRegion\",\".disabled=false\");\r      accion(\"Formulario.cbZona\",\".disabled=false\");\r    \r    }else{\r    \r      var aCombo = new Array(new Array(\"\",\"\"));\r      \r      set_combo('Formulario.cbRegion',aCombo, []);\r      set_combo('Formulario.cbZona',aCombo, []);\r      \r      accion(\"Formulario.cbRegion\",\".disabled=true\");\r      accion(\"Formulario.cbZona\",\".disabled=true\");\r    \r    }\r  \r  }\r\r\r\r  function cambioRegion(){\r    \r    pais = get('Formulario.cbPais');\r    marca = get('Formulario.cbMarca');\r    canal = get('Formulario.cbCanal');\r    sgv = get('Formulario.cbSubgerenciaVentas');\r    region = get('Formulario.cbRegion','V');\r    \r    if (region.length == 1){\r      \r      var arr = new Array();\r      \r      arr[arr.length] = [\"oidPais\", pais];\r      arr[arr.length] = [\"oidMarca\", marca];\r      arr[arr.length] = [\"oidCanal\", canal];\r      arr[arr.length] = [\"oidSGV\", sgv];\r      arr[arr.length] = [\"oidRegion\", region];\r      \r      recargaCombo(\"Formulario.cbZona\", \"ZONRecargaZonas\", \"es.indra.sicc.dtos.zon.DTOUnidadAdministrativa\",arr);\r      \r      accion(\"Formulario.cbZona\",\".disabled=false\");\r    \r    }else{\r    \r      var aCombo = new Array(new Array(\"\",\"\"));\r      \r      set_combo('Formulario.cbZona',aCombo, []);\r      \r      accion(\"Formulario.cbZona\",\".disabled=true\");\r      \r    }\r  \r  }\r  \r  \r  function cargarPeriodos(){\r    \r    \r    pais = get('Formulario.cbPais');\r    marca = get('Formulario.cbMarca');\r    canal = get('Formulario.cbCanal');\r    anio = get('Formulario.anioDefault');\r    \r    var arr = new Array();\r    \r    fechaDesde = '01/01/'+anio;\r    fechaHasta = '31/12/'+anio;\r       \r    if(pais != '' && marca !='' && canal != '' ){\r       arr[arr.length] = [\"pais\", pais];\r       arr[arr.length] = [\"marca\", marca];\r       arr[arr.length] = [\"canal\", canal];\r       arr[arr.length] = [\"fechaInicio\", fechaDesde];\r       arr[arr.length] = [\"fechaFin\", fechaHasta];\r      \r       recargaCombo(\"Formulario.cbPeriodo\", \"REPObtenerPeriodosAnioAcceso\", \"es.indra.sicc.dtos.cra.DTOPeriodo\",arr);\r    }\r                                                                              \r    \r  }\r\r\r  function generar(formato){\r      \r    if(sicc_validaciones_generales()){\r         \r      var a = new Object();\r      a.accion = 'generar';\r      \r      a.anio = get('Formulario.txtAno');\r      a.pais = get('Formulario.cbPais');\r      a.marca = get('Formulario.cbMarca');\r      a.canal = get('Formulario.cbCanal');\r      a.subgerenciaVentas = quitarItemVacio(get('Formulario.cbSubgerenciaVentas'));\r      a.region = quitarItemVacio(get('Formulario.cbRegion'));\r      a.zona = quitarItemVacio(get('Formulario.cbZona'));\r      a.periodo = quitarItemVacio(get('Formulario.cbPeriodo'));\r      a.periodoDesc = quitarItemVacio(get('Formulario.cbPeriodo','T'));\r\r      \r      a.formato = formato;\r      \r      mostrarModalSICC('INCVariablesPeriodoRegionZonaDetalle','generar', a);\r      \r    }\r    \r  }\r\r\r\r  \r  "));
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(19)).setAttribute("nombre","anioDefault" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(47)).setAttribute("nombre","lblAno" );
   }
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(47)).setAttribute("cod","171" );
      ...
      ((Element)v.get(58)).setAttribute("nombre","txtAno" );
      ((Element)v.get(58)).setAttribute("id","datosCampos" );
      ((Element)v.get(58)).setAttribute("max","4" );
      ((Element)v.get(58)).setAttribute("tipo","" );
      ((Element)v.get(58)).setAttribute("req","S" );
      ((Element)v.get(58)).setAttribute("size","4" );
      ...
      ((Element)v.get(62)).setAttribute("nombre","cbPais" );
      ...
      ((Element)v.get(62)).setAttribute("onchange","onChangePaisMarcaCanal();cargarPeriodos();" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(87)).setAttribute("onchange","onChangePaisMarcaCanal();cargarPeriodos();" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(92)).setAttribute("onchange","onChangePaisMarcaCanal();cargarPeriodos();" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(117)).setAttribute("onchange","cambioSGV()" );
      ...
      /* Empieza nodo:129 / Elemento padre: 36   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(36)).appendChild((Element)v.get(129));
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(152)).setAttribute("nombre","cbPeriodo" );
      ...
      /* Empieza nodo:159 / Elemento padre: 29   */
      v.add(doc.createElement("td"));
      ((Element)v.get(29)).appendChild((Element)v.get(159));
      ...
      /* Empieza nodo:161 / Elemento padre: 21   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(21)).appendChild((Element)v.get(161));
   ...
   private void getXML630(Document doc) {
      ...
      ((Element)v.get(169)).setAttribute("accion","generar('pdf')" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(170)).setAttribute("nombre","btnGenerarExcel" );
      ((Element)v.get(170)).setAttribute("ID","botonContenido" );
      ((Element)v.get(170)).setAttribute("tipo","html" );
      ((Element)v.get(170)).setAttribute("accion","generar('excel')" );
      ((Element)v.get(170)).setAttribute("estado","false" );
      ((Element)v.get(170)).setAttribute("cod","2526" );
      ((Element)v.get(170)).setAttribute("ontab","focaliza('Formulario.txtAno')" );
      ...
      /* Empieza nodo:173 / Elemento padre: 21   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(21)).appendChild((Element)v.get(173));
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(176)).setAttribute("width","756" );
