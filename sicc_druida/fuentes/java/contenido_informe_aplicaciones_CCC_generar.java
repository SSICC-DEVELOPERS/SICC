...
public class contenido_informe_aplicaciones_CCC_generar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_informe_aplicaciones_CCC_generar" );
      ((Element)v.get(0)).setAttribute("cod","0848" );
      ((Element)v.get(0)).setAttribute("titulo","Generar informe Aplicaciones en cuenta corriente" );
      ...
      v.add(doc.createTextNode("\r   \r \r   function onLoad(){\r      configurarMenuSecundario('Formulario');\r      fMostrarMensajeError();\r      focaliza('Formulario.cbProceso')\r           \r      \r   }\r\r    function quitarItemVacio(elemento){\r      var elementoADevolver = new Array();\r     \r      for(var k=0;k<elemento.length;k++) {\r          if (elemento[k] != ''){                            \r             elementoADevolver[elementoADevolver.length] = elemento[k];\r          }\r      }\r         \r      return elementoADevolver;\r      \r   }\r   function generar(){\r      if(sicc_validaciones_generales()){\r         if(validarFechas()){\r            if(validarComprobante()){\r               /*recolectarParametros();\r               set('Formulario.conectorAction', 'CCCAplicacionesCC');           \r               set('Formulario.accion', 'generar');\r               enviaSICC('Formulario');*/\r               var a = new Object();\r               a.accion = 'generar';\r               a.procesos = quitarItemVacio(get('Formulario.cbProceso'));  \r               a.tipoCargo = quitarItemVacio(get('Formulario.cbTipoCargoAbono'));\r			   a.tipoCargoDesc = quitarItemVacio(get('Formulario.cbTipoCargoAbono','T'));\r               a.fechaProcesoDesde = get('Formulario.txtFechaProcesoDesde');  \r               a.fechaProcesoHasta = get('Formulario.txtFechaProcesoHasta');\r               a.numeroComprobante = get('Formulario.txtNumeroComprobante');\r               mostrarModalSICC('CCCAplicacionesCC','generar', a);  \r            }\r         }      \r      }\r   }\r\r\r   function validarComprobante(){\r      var comprobante = new Array();\r      comprobante = get('Formulario.txtComprobante');\r      \r      if(comprobante != ''){\r         if(comprobante.length < 12){\r            cdos_mostrarAlert(\"Debe rellenar los 12 digitos del comprobante\");\r            return false;\r         }else{\r            return true;\r         }\r      }else{\r         return true;\r      }\r   }\r\r   function validarFechas(){\r      \r      var fechaDesde = get('Formulario.txtFechaProcesoDesde');\r      var fechaHasta = get('Formulario.txtFechaProcesoHasta');\r      var formatoFecha = get('Formulario.hFormatoFechaPais');\r            \r     \r      if (! EsFechaValida_SICC(fechaDesde, \"Formulario\")){\r          GestionarMensaje(\"1006\", formatoFecha, null, null);\r          focaliza(\"Formulario.txtFechaProcesoDesde\");\r          return false;\r      }\r     \r      if(! EsFechaValida_SICC(fechaHasta, \"Formulario\")){\r          GestionarMensaje(\"1006\", formatoFecha, null, null);\r          focaliza(\"Formulario.txtFechaProcesoHasta\");\r          return false;\r      }\r                 \r      var errorLevel = EsFechaValida( fechaDesde, fechaHasta, \"Formulario\", \"S\");\r      if ( errorLevel == 3){\r          GestionarMensaje(\"1191\");\r          focaliza('Formulario.txtFechaProcesoDesde');\r          return false;\r      }\r     \r      return true;   \r   \r   }\r   function recolectarParametros(){\r           \r      set('Formulario.procesos', get('Formulario.cbProceso'));  \r      set('Formulario.tipoCargo', get('Formulario.cbTipoCargoAbono'));  \r      set('Formulario.fechaProcesoDesde', get('Formulario.txtFechaProcesoDesde'));  \r      set('Formulario.fechaProcesoHasta', get('Formulario.txtFechaProcesoHasta'));\r      set('Formulario.numeroComprobante', get('Formulario.txtNumeroComprobante'));\r \r  \r   }\r\r   function onchangeProceso(){\r     opciones = new Array();\r     set_combo('Formulario.cbTipoCargoAbono',opciones);                         \r     var proceso = get('Formulario.cbProceso','V');\r     combo_add('Formulario.cbTipoCargoAbono', '', '');\r     \r     for(var k=0;k<ListaTC.datos.longitud;k++) {\r        for(var y=0;y<proceso.length;y++){\r           if (ListaTC.datos.ij(k,0) == proceso[y]){                     \r                 combo_add('Formulario.cbTipoCargoAbono',ListaTC.datos.ij(k,1),ListaTC.datos.ij(k,2));\r           }\r         }\r      }\r  \r   }\r   \r\r   function fLimpiar(){\r      var aCombo = new Array(new Array(\"\",\"\"));\r      set_combo('Formulario.cbTipoCargoAbono', aCombo, []);\r      focaliza('Formulario.cbProceso');\r\r   \r   }\r   \r   \r\r \r   \r  \r  "));
      ...
      ((Element)v.get(5)).setAttribute("name","txtFechaProcesoDesde" );
      ((Element)v.get(5)).setAttribute("required","true" );
      ((Element)v.get(5)).setAttribute("cod","1915" );
      ((Element)v.get(4)).appendChild((Element)v.get(5));
      /* Termina nodo:5   */

      /* Empieza nodo:6 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(6)).setAttribute("name","txtFechaProcesoHasta" );
      ((Element)v.get(6)).setAttribute("required","true" );
      ((Element)v.get(6)).setAttribute("cod","1916" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(14)).setAttribute("nombre","banco" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(15)).setAttribute("nombre","cuentaCorriente" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(16)).setAttribute("nombre","fechaLiquidacion" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(17)).setAttribute("nombre","comprobante" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(18)).setAttribute("nombre","ordenImpresion" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(57)).setAttribute("nombre","cbProceso" );
      ((Element)v.get(57)).setAttribute("size","5" );
      ((Element)v.get(57)).setAttribute("multiple","S" );
      ...
      ((Element)v.get(57)).setAttribute("onchange","onchangeProceso();" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(62)).setAttribute("nombre","cbTipoCargoAbono" );
      ((Element)v.get(62)).setAttribute("size","5" );
      ((Element)v.get(62)).setAttribute("multiple","S" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(91)).setAttribute("nombre","txtFechaProcesoDesde" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(95)).setAttribute("nombre","txtFechaProcesoHasta" );
      ...
      /* Empieza nodo:102 / Elemento padre: 71   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(71)).appendChild((Element)v.get(102));
      ...
      /* Empieza nodo:105 / Elemento padre: 28   */
      v.add(doc.createElement("td"));
      ((Element)v.get(28)).appendChild((Element)v.get(105));
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(114)).setAttribute("class","botonera" );
   ...
   private void getXML450(Document doc) {
      ((Element)v.get(115)).setAttribute("nombre","btnGenerarInforme" );
      ((Element)v.get(115)).setAttribute("ID","botonContenido" );
      ((Element)v.get(115)).setAttribute("tipo","html" );
      ((Element)v.get(115)).setAttribute("accion","generar()" );
      ((Element)v.get(115)).setAttribute("estado","false" );
      ((Element)v.get(115)).setAttribute("cod","2495" );
      ((Element)v.get(115)).setAttribute("ontab","focaliza('Formulario.cbProceso')" );
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(121)).setAttribute("width","756" );
