...
public class CccTipoCargoAbonoConectorQueryForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad CccTipoCargoAbono" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGCccTipoCargoAbonoQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGCccTipoCargoAbonoQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","CccTipoCargoAbonoFormFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(8)).setAttribute("NOMBRE","codTipoCargAbon" );
