...
public class MaeUnidaMedidPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","maeUnidaMedidList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(16)).setAttribute("cod","MaeUnidaMedid.codUnidMedi.label" );
      ...
      ((Element)v.get(17)).setAttribute("cod","MaeUnidaMedid.Descripcion.label" );
      ...
      ((Element)v.get(18)).setAttribute("cod","MaeUnidaMedid.desAbre.label" );
      ...
      ((Element)v.get(19)).setAttribute("cod","MaeUnidaMedid.magnOidMagn.label" );
      ...
      ((Element)v.get(20)).setAttribute("cod","MaeUnidaMedid.indUmStnd.label" );
