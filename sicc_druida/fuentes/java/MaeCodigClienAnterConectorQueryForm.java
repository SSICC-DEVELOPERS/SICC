...
public class MaeCodigClienAnterConectorQueryForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad MaeCodigClienAnter" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGMaeCodigClienAnterQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGMaeCodigClienAnterQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","MaeCodigClienAnterFormFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","clieOidClieNuev" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(8)).setAttribute("NOMBRE","codClieAnti" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(10)).setAttribute("NOMBRE","valSistProc" );
