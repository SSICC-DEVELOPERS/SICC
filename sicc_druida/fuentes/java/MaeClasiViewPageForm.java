...
public class MaeClasiViewPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","MaeClasiView.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","MaeClasiView.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('maeClasiViewFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('maeClasiViewFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(50)).setAttribute("nombre","tcclOidTipoClas_sbtiOidSubtClie_ticlOidTipoClieTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lbltcclOidTipoClas_sbtiOidSubtClie_ticlOidTipoClie" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(55)).setAttribute("nombre","tcclOidTipoClas_sbtiOidSubtClie_ticlOidTipoClieWidgetTrId" );
      ...
      ((Element)v.get(57)).setAttribute("nombre","tcclOidTipoClas_sbtiOidSubtClie_ticlOidTipoClie" );
      ...
      ((Element)v.get(57)).setAttribute("onchange","mmgDependeneChange('tcclOidTipoClas_sbtiOidSubtClie_ticlOidTipoClie', 'tcclOidTipoClas' , 'maeClasiView')" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","focaliza('maeClasiViewFrm.tcclOidTipoClas_sbtiOidSubtClie');" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('maeClasiViewFrm',2, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(59)).setAttribute("nombre","tcclOidTipoClas_sbtiOidSubtClie_ticlOidTipoClieGapTdId" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(61)).setAttribute("nombre","tcclOidTipoClas_sbtiOidSubtClieTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(65)).setAttribute("nombre","lbltcclOidTipoClas_sbtiOidSubtClie" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(66)).setAttribute("nombre","tcclOidTipoClas_sbtiOidSubtClieWidgetTrId" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(68)).setAttribute("nombre","tcclOidTipoClas_sbtiOidSubtClie" );
      ...
      ((Element)v.get(68)).setAttribute("onchange","mmgDependeneChange('tcclOidTipoClas_sbtiOidSubtClie', 'tcclOidTipoClas' , 'maeClasiView')" );
      ...
      ((Element)v.get(68)).setAttribute("ontab","focaliza('maeClasiViewFrm.tcclOidTipoClas');" );
      ((Element)v.get(68)).setAttribute("onshtab","focaliza('maeClasiViewFrm.tcclOidTipoClas_sbtiOidSubtClie_ticlOidTipoClie');" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(70)).setAttribute("nombre","tcclOidTipoClas_sbtiOidSubtClieGapTdId" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(72)).setAttribute("nombre","tcclOidTipoClasTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(76)).setAttribute("nombre","lbltcclOidTipoClas" );
      ((Element)v.get(76)).setAttribute("id","datosTitle" );
      ((Element)v.get(76)).setAttribute("ancho","150" );
      ((Element)v.get(76)).setAttribute("alto","13" );
      ((Element)v.get(76)).setAttribute("cod","MaeClasiView.tcclOidTipoClas.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(77)).setAttribute("nombre","tcclOidTipoClasWidgetTrId" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(79)).setAttribute("nombre","tcclOidTipoClas" );
      ...
      ((Element)v.get(79)).setAttribute("ontab","ejecutarAccionFoco('maeClasiViewFrm',2, true);" );
      ((Element)v.get(79)).setAttribute("onshtab","focaliza('maeClasiViewFrm.tcclOidTipoClas_sbtiOidSubtClie');" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(81)).setAttribute("nombre","tcclOidTipoClasGapTdId" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(98)).setAttribute("nombre","codClasTdId" );
   }
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(103)).setAttribute("nombre","codClasWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(105)).setAttribute("nombre","codClas" );
      ...
      ((Element)v.get(105)).setAttribute("ontab","ejecutarAccionFoco('maeClasiViewFrm',3, true)" );
      ((Element)v.get(105)).setAttribute("onshtab","ejecutarAccionFoco('maeClasiViewFrm', 3, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(106)).setAttribute("nombre","codClasGapTdId" );
      ...
      ((Element)v.get(112)).setAttribute("cod","MaeClasiView.Descripcion.label" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(116)).setAttribute("ontab","ejecutarAccionFoco('maeClasiViewFrm',4, true)" );
      ((Element)v.get(116)).setAttribute("onshtab","ejecutarAccionFoco('maeClasiViewFrm', 4, false)" );
      ...
      ((Element)v.get(120)).setAttribute("href","javascript:openLocalizationDialog('maeClasiViewFrm', 'Descripcion', 1);" );
      ((Element)v.get(120)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"maeClasiViewFrm\",4, true)', 'ejecutarAccionFoco(\"maeClasiViewFrm\",4, false)')" );
      ...
      /* Empieza nodo:124 / Elemento padre: 97   */
      v.add(doc.createElement("TD"));
      ((Element)v.get(124)).setAttribute("width","100%" );
      ((Element)v.get(97)).appendChild((Element)v.get(124));
   ...
   private void getXML630(Document doc) {
      ...
      /* Empieza nodo:136 / Elemento padre: 0   */
      v.add(doc.createElement("TR"));
      ((Element)v.get(136)).setAttribute("nombre","maeClasiViewTrButtons" );
      ((Element)v.get(0)).appendChild((Element)v.get(136));
      ...
      ((Element)v.get(143)).setAttribute("nombre","maeClasiViewTdQueryButton" );
      ((Element)v.get(142)).appendChild((Element)v.get(143));

      /* Empieza nodo:144 / Elemento padre: 143   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(144)).setAttribute("nombre","maeClasiViewQueryButton" );
      ((Element)v.get(144)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(144)).setAttribute("estado","false" );
      ((Element)v.get(144)).setAttribute("accion","maeClasiViewFirstPage();" );
      ...
      ((Element)v.get(145)).setAttribute("nombre","maeClasiViewTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(147)).setAttribute("nombre","maeClasiViewLovNullButton" );
      ((Element)v.get(147)).setAttribute("ID","botonContenido" );
      ((Element)v.get(147)).setAttribute("tipo","html" );
      ((Element)v.get(147)).setAttribute("accion","maeClasiViewLovNullSelectionAction();" );
