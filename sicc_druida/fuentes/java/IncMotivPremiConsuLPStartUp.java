/*
    INDRA/CAR/mmg
    $Id: IncMotivPremiConsuLPStartUp.java,v 1.1 2009/12/03 18:39:43 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class IncMotivPremiConsuLPStartUp extends MMGDruidaBase{
	...
	public IncMotivPremiConsuLPStartUp(){
		super();
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			buildJsPageSize("IncMotivPremiConsu");
			...
			asignarAtributo("PAGINA", "IncMotivPremiConsuPage", "cod", "IncMotivPremiConsu." + accion + ".label");
			...
			limpiarBotoneraLista("incMotivPremiConsu", accion);
	...
	protected void cmdLov() throws Exception{
		...
		//asignarAtributo("CAPA", "incMotivPremiConsuLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "IncMotivPremiConsuPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		IncMotivPremiConsuData incMotivPremiConsuQuery= new IncMotivPremiConsuData();
		incMotivPremiConsuQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		IncMotivPremiConsuData datosResult = (IncMotivPremiConsuData)getSingleObject(BUSINESSID_QUERY, incMotivPremiConsuQuery, 
			incMotivPremiConsuQuery.clone(), "incMotivPremiConsu");
		...
		preservaHiddensI18n(new Integer(1), "INC_MOTIV_PREMI_CONSU", "incMotivPremiConsuFrm", "Descripcion", true);
		...
		IncMotivPremiConsuData incMotivPremiConsu = datosResult;
		asignar("TEXT", "Descripcion", FormatUtils.formatObject(incMotivPremiConsu.getDescripcion(), 
		...
		loadLocalizationVars(incMotivPremiConsu);
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "INC_MOTIV_PREMI_CONSU", "incMotivPremiConsuFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('incMotivPremiConsuFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "incMotivPremiConsuFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		IncMotivPremiConsuData incMotivPremiConsuQuery= new IncMotivPremiConsuData();
		incMotivPremiConsuQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(incMotivPremiConsu.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"incMotivPremiConsuFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"incMotivPremiConsuFrm\",1, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"incMotivPremiConsuFrm\",2, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"incMotivPremiConsuFrm\",2, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","incMotivPremiConsuTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","incMotivPremiConsuTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","incMotivPremiConsuFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","incMotivPremiConsuListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","incMotivPremiConsuListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(IncMotivPremiConsuData incMotivPremiConsu) throws Exception{
	...
	* @param incMotivPremiConsu La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(IncMotivPremiConsuData incMotivPremiConsu) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		IncMotivPremiConsuData incMotivPremiConsu = 
			(IncMotivPremiConsuData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(incMotivPremiConsu);
		loadLeafDependenceCombos(incMotivPremiConsu);
	}
	...
	*/
	...
	protected void loadLocalizationVars(IncMotivPremiConsuData incMotivPremiConsu) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("INC_MOTIV_PREMI_CONSU");
		mmgLocalizationQuery.setEntiPk(incMotivPremiConsu.getId());
