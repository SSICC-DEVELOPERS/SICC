...
public class ConectorDefinirEGPais  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Definir Estructura Geopolítica de País" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","DTOEstructuraGeopoliticaPais " );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","ZONConsultarTipoEstructuraGeopolitica" );
