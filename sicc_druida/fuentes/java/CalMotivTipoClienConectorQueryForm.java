...
public class CalMotivTipoClienConectorQueryForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad CalMotivTipoClien" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGCalMotivTipoClienQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGCalMotivTipoClienQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","CalMotivTipoClienFormFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","mocoOidMotiCont" );
