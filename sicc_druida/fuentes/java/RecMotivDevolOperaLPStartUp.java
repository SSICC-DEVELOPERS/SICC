/*
    INDRA/CAR/mmg
    $Id: RecMotivDevolOperaLPStartUp.java,v 1.1 2009/12/03 18:42:40 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class RecMotivDevolOperaLPStartUp extends MMGDruidaBase{
	...
	public static final String BUSINESSID_QUERY = "MMGRecMotivDevolOperaQueryFromToUserPage";
				...
				public static final String BUSINESSID_ROPEOIDOPER_QUERY ="MMGRecOperaViewQueryFromToUser";
				public static final String ROPEOIDOPER_COMBO_CONNECTOR = "RecOperaViewConectorCombo";
	
				public static final String BUSINESSID_MODVOIDMOTIDEVO_QUERY ="MMGRecMotivDevolQueryFromToUser";
				public static final String MODVOIDMOTIDEVO_COMBO_CONNECTOR = "RecMotivDevolConectorCombo";
	...
	public RecMotivDevolOperaLPStartUp(){
		super();
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			buildJsPageSize("RecMotivDevolOpera");
			...
			asignarAtributo("PAGINA", "RecMotivDevolOperaPage", "cod", "RecMotivDevolOpera." + accion + ".label");
			...
			limpiarBotoneraLista("recMotivDevolOpera", accion);
	...
	protected void cmdLov() throws Exception{
		...
		//asignarAtributo("CAPA", "recMotivDevolOperaLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "RecMotivDevolOperaPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		RecMotivDevolOperaData recMotivDevolOperaQuery= new RecMotivDevolOperaData();
		recMotivDevolOperaQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		RecMotivDevolOperaData datosResult = (RecMotivDevolOperaData)getSingleObject(BUSINESSID_QUERY, recMotivDevolOperaQuery, 
			recMotivDevolOperaQuery.clone(), "recMotivDevolOpera");
		...
		RecMotivDevolOperaData recMotivDevolOpera = datosResult;
		es.indra.belcorp.mso.RecOperaViewData ropeOidOper = recMotivDevolOpera.getRopeOidOper();
		if(ropeOidOper != null && ropeOidOper.getId() != null) checkCombo("ropeOidOper" , ropeOidOper.getId().toString());
		es.indra.belcorp.mso.RecMotivDevolData modvOidMotiDevo = recMotivDevolOpera.getModvOidMotiDevo();
		if(modvOidMotiDevo != null && modvOidMotiDevo.getId() != null) checkCombo("modvOidMotiDevo" , modvOidMotiDevo.getId().toString());
		asignarAtributo("CHECKBOX", "valMarcDefe" , "check", FormatUtils.formatObject(
			recMotivDevolOpera.getValMarcDefe(), 
		...
		//Deshabilitamos todos los campos para que no se editen
					...
					asignarAtributo("COMBO", "modvOidMotiDevo", "disabled", "S");
					asignarAtributo("CHECKBOX", "valMarcDefe", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		...
		asignarAtributo("COMBO", "modvOidMotiDevo", "req", "S");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "recMotivDevolOperaFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		RecMotivDevolOperaData recMotivDevolOperaQuery= new RecMotivDevolOperaData();
		recMotivDevolOperaQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(recMotivDevolOpera.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"recMotivDevolOperaFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"recMotivDevolOperaFrm\",1, false)");
					asignarAtributo("COMBO","ropeOidOper", "ontab", "ejecutarAccionFocoModificacion(\"recMotivDevolOperaFrm\",2, true)");
					asignarAtributo("COMBO","ropeOidOper", "onshtab", "ejecutarAccionFocoModificacion(\"recMotivDevolOperaFrm\",2, false)");
					asignarAtributo("COMBO","modvOidMotiDevo", "ontab", "ejecutarAccionFocoModificacion(\"recMotivDevolOperaFrm\",3, true)");
					asignarAtributo("COMBO","modvOidMotiDevo", "onshtab", "ejecutarAccionFocoModificacion(\"recMotivDevolOperaFrm\",3, false)");
				asignarAtributo("TEXT", "valMarcDefe", "ontab","ejecutarAccionFocoModificacion(\"recMotivDevolOperaFrm\",4, true)");
				asignarAtributo("TEXT", "valMarcDefe", "onshtab","ejecutarAccionFocoModificacion(\"recMotivDevolOperaFrm\",4, false)");
					asignarAtributo("COMBO","paisOidPais", "ontab", "ejecutarAccionFocoModificacion(\"recMotivDevolOperaFrm\",5, true)");
					asignarAtributo("COMBO","paisOidPais", "onshtab", "ejecutarAccionFocoModificacion(\"recMotivDevolOperaFrm\",5, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","recMotivDevolOperaTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","recMotivDevolOperaTrButtons");
			...
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es ropeOidOper...");		
					...
					traza("MMG: en desactivateNonModifyFields encontrado atributo no editable...");
						...
						asignarAtributo("COMBO", "ropeOidOper", "disabled", "S");
				traza("MMG: el atributo es modvOidMotiDevo...");		
				
					traza("MMG: en desactivateNonModifyFields encontrado atributo no editable...");
				
						asignarAtributo("COMBO", "modvOidMotiDevo", "disabled", "S");
				traza("MMG: el atributo es valMarcDefe...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","recMotivDevolOperaFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","recMotivDevolOperaListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","recMotivDevolOperaListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(RecMotivDevolOperaData recMotivDevolOpera) throws Exception{
		HashMap checkedCombos = new HashMap();
		RecOperaViewData ropeOidOper = new RecOperaViewData();
		
						asignarComboResultados(BUSINESSID_ROPEOIDOPER_QUERY,ROPEOIDOPER_COMBO_CONNECTOR, 
			ropeOidOper, ropeOidOper.clone(), "recOperaView", "ropeOidOper", "result_ROWSET" );
		if(recMotivDevolOpera != null && recMotivDevolOpera.getRopeOidOper() != null){
				checkCombo("ropeOidOper" , recMotivDevolOpera.getRopeOidOper().getId().toString());
			}
		RecMotivDevolData modvOidMotiDevo = new RecMotivDevolData();
		
						asignarComboResultados(BUSINESSID_MODVOIDMOTIDEVO_QUERY,MODVOIDMOTIDEVO_COMBO_CONNECTOR, 
			modvOidMotiDevo, modvOidMotiDevo.clone(), "recMotivDevol", "modvOidMotiDevo", "result_ROWSET" );
		if(recMotivDevolOpera != null && recMotivDevolOpera.getModvOidMotiDevo() != null){
				checkCombo("modvOidMotiDevo" , recMotivDevolOpera.getModvOidMotiDevo().getId().toString());
			}
		...
		if(recMotivDevolOpera != null && recMotivDevolOpera.getPaisOidPais() != null){
				checkCombo("paisOidPais" , recMotivDevolOpera.getPaisOidPais().getId().toString());
			}
	...
	* @param recMotivDevolOpera La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(RecMotivDevolOperaData recMotivDevolOpera) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		RecMotivDevolOperaData recMotivDevolOpera = 
			(RecMotivDevolOperaData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(recMotivDevolOpera.getRopeOidOper() != null){
			recMotivDevolOpera.setRopeOidOper((es.indra.belcorp.mso.RecOperaViewData)
			getSingleObject(BUSINESSID_ROPEOIDOPER_QUERY, 
			recMotivDevolOpera.getRopeOidOper(),
			recMotivDevolOpera.getRopeOidOper().clone(),
			"recOperaView"));
		}
		if(recMotivDevolOpera.getModvOidMotiDevo() != null){
			recMotivDevolOpera.setModvOidMotiDevo((es.indra.belcorp.mso.RecMotivDevolData)
			getSingleObject(BUSINESSID_MODVOIDMOTIDEVO_QUERY, 
			recMotivDevolOpera.getModvOidMotiDevo(),
			recMotivDevolOpera.getModvOidMotiDevo().clone(),
			"recMotivDevol"));
		}
		if(recMotivDevolOpera.getPaisOidPais() != null){
			recMotivDevolOpera.setPaisOidPais((es.indra.belcorp.mso.SegPaisViewData)
			getSingleObject(BUSINESSID_PAISOIDPAIS_QUERY, 
			recMotivDevolOpera.getPaisOidPais(),
			recMotivDevolOpera.getPaisOidPais().clone(),
			"segPaisView"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(recMotivDevolOpera);
		loadLeafDependenceCombos(recMotivDevolOpera);
	}
