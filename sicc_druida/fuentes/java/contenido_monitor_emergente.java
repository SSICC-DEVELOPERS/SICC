...
public class contenido_monitor_emergente  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_monitor_emergente" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(2)).setAttribute("src","contenido_monitor_emergente.js" );
      ...
      ((Element)v.get(5)).setAttribute("name","cbSeleccioneOpcion" );
      ((Element)v.get(5)).setAttribute("required","true" );
      ((Element)v.get(5)).setAttribute("cod","987" );
      ...
      ((Element)v.get(7)).setAttribute("valor","LPValidaFaltantes" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(12)).setAttribute("nombre","fechaIni" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(14)).setAttribute("nombre","cartel" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(15)).setAttribute("nombre","varOidLoteReporteFaltantes" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(35)).setAttribute("width","660" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(43)).setAttribute("nombre","lblSeleccioneOpcion" );
      ...
      ((Element)v.get(43)).setAttribute("cod","987" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(50)).setAttribute("nombre","cbSeleccioneOpcion" );
      ...
      ((Element)v.get(50)).setAttribute("ontab","focalizaBotonHTML('botonContenido','btnAceptar');" );
      ((Element)v.get(50)).setAttribute("onshtab","focalizaBotonHTML('botonContenido','btnAceptar');" );
      ...
      ((Element)v.get(52)).setAttribute("ID","0" );
      ...
      ((Element)v.get(53)).setAttribute("VALOR","ver" );
      ...
      ((Element)v.get(54)).setAttribute("VALOR","Ver Informe Actual" );
      ...
      v.add(doc.createElement("ROW"));
      ((Element)v.get(55)).setAttribute("ID","1" );
      ...
      ((Element)v.get(56)).setAttribute("VALOR","aprobar" );
      ...
      ((Element)v.get(57)).setAttribute("VALOR","Aprobar Informe Actual" );
      ...
      v.add(doc.createElement("ROW"));
      ((Element)v.get(58)).setAttribute("ID","2" );
      ...
      ((Element)v.get(59)).setAttribute("VALOR","generar" );
      ...
      ((Element)v.get(60)).setAttribute("VALOR","Generar Informe Nuevo" );
      ...
      /* Empieza nodo:68 / Elemento padre: 17   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(17)).appendChild((Element)v.get(68));
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(76)).setAttribute("accion","aceptar();" );
      ((Element)v.get(76)).setAttribute("estado","false" );
      ((Element)v.get(76)).setAttribute("cod","12" );
      ((Element)v.get(76)).setAttribute("ontab","focaliza('frmContenido.cbSeleccioneOpcion','');" );
      ((Element)v.get(76)).setAttribute("onshtab","focaliza('frmContenido.cbSeleccioneOpcion','');" );
      ...
      /* Empieza nodo:79 / Elemento padre: 17   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(17)).appendChild((Element)v.get(79));
