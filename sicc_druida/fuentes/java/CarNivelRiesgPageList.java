...
public class CarNivelRiesgPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","carNivelRiesgList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","CarNivelRiesg.codNiveRies.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","CarNivelRiesg.Descripcion.label" );
