/*
    INDRA/CAR/mmg
    $Id: FacDestiImpreLPStartUp.java,v 1.1 2009/12/03 18:38:52 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class FacDestiImpreLPStartUp extends MMGDruidaBase{
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "FacDestiImprePage", "cod", "FacDestiImpre." + accion + ".label");
			...
			limpiarBotoneraLista("facDestiImpre", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "desDest", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 0, 50);");
		
		//Primero determianmos el nombre del campo en la entidad de oriegen donde se van a cargar los datos
		asignar("VAR", "idAttributeLovOpener", conectorParametro(PARAMETRO_LOV_ATTRIBUTO));
		asignar("VAR", "idEntityLovOpener", conectorParametro(PARAMETRO_LOV_ENTIDAD));
		//asignarAtributo("CAPA", "facDestiImpreLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "FacDestiImprePage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		FacDestiImpreData facDestiImpreQuery= new FacDestiImpreData();
		facDestiImpreQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		FacDestiImpreData datosResult = (FacDestiImpreData)getSingleObject(BUSINESSID_QUERY, facDestiImpreQuery, 
			facDestiImpreQuery.clone(), "facDestiImpre");
		...
		FacDestiImpreData facDestiImpre = datosResult;
		asignar("TEXT", "desDest", FormatUtils.formatObject(facDestiImpre.getDesDest(), 
		...
		asignarAtributo("TEXT", "desDest", "disabled", "S");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "facDestiImpreFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		FacDestiImpreData facDestiImpreQuery= new FacDestiImpreData();
		facDestiImpreQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(facDestiImpre.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"facDestiImpreFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"facDestiImpreFrm\",1, false)");
				asignarAtributo("AREATEXTO", "desDest", "ontab","ejecutarAccionFocoModificacion(\"facDestiImpreFrm\",2, true)");
				asignarAtributo("AREATEXTO", "desDest", "onshtab","ejecutarAccionFocoModificacion(\"facDestiImpreFrm\",2, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","facDestiImpreTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","facDestiImpreTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es desDest...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","facDestiImpreFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","facDestiImpreListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","facDestiImpreListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(FacDestiImpreData facDestiImpre) throws Exception{
	...
	* @param facDestiImpre La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(FacDestiImpreData facDestiImpre) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		FacDestiImpreData facDestiImpre = 
			(FacDestiImpreData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(facDestiImpre);
		loadLeafDependenceCombos(facDestiImpre);
	}
