...
public class MaeClaseTarjeConectorRemove  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","onector para la eliminación de elementos de la entidad MaeClaseTarje" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGMaeClaseTarjeRemoveID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGMaeClaseTarjeRemoveDTO" );
