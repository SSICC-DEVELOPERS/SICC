...
public class ConectorCARLiberarSolicitud  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector Generico que devuelve objeto" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","DTODatosLiberacion" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","CARLiberarSolicitud" );
