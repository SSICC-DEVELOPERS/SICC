/*
    INDRA/CAR/mmg
    $Id: CobBaseEscalLPStartUp.java,v 1.1 2009/12/03 18:36:55 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class CobBaseEscalLPStartUp extends MMGDruidaBase{
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "CobBaseEscalPage", "cod", "CobBaseEscal." + accion + ".label");
			...
			limpiarBotoneraLista("cobBaseEscal", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codBaseEsca", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 1);");
		
		//Primero determianmos el nombre del campo en la entidad de oriegen donde se van a cargar los datos
		asignar("VAR", "idAttributeLovOpener", conectorParametro(PARAMETRO_LOV_ATTRIBUTO));
		asignar("VAR", "idEntityLovOpener", conectorParametro(PARAMETRO_LOV_ENTIDAD));
		//asignarAtributo("CAPA", "cobBaseEscalLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "CobBaseEscalPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		CobBaseEscalData cobBaseEscalQuery= new CobBaseEscalData();
		cobBaseEscalQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		CobBaseEscalData datosResult = (CobBaseEscalData)getSingleObject(BUSINESSID_QUERY, cobBaseEscalQuery, 
			cobBaseEscalQuery.clone(), "cobBaseEscal");
		...
		preservaHiddensI18n(new Integer(1), "COB_BASE_ESCAL", "cobBaseEscalFrm", "Descripcion", true);
		...
		CobBaseEscalData cobBaseEscal = datosResult;
		asignar("TEXT", "codBaseEsca", FormatUtils.formatObject(cobBaseEscal.getCodBaseEsca(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "Descripcion", FormatUtils.formatObject(cobBaseEscal.getDescripcion(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		loadLocalizationVars(cobBaseEscal);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "codBaseEsca", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "COB_BASE_ESCAL", "cobBaseEscalFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "codBaseEsca", "req", "S");
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('cobBaseEscalFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "cobBaseEscalFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		CobBaseEscalData cobBaseEscalQuery= new CobBaseEscalData();
		cobBaseEscalQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(cobBaseEscal.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"cobBaseEscalFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"cobBaseEscalFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codBaseEsca", "ontab","ejecutarAccionFocoModificacion(\"cobBaseEscalFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codBaseEsca", "onshtab","ejecutarAccionFocoModificacion(\"cobBaseEscalFrm\",2, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"cobBaseEscalFrm\",3, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"cobBaseEscalFrm\",3, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","cobBaseEscalTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","cobBaseEscalTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codBaseEsca...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","cobBaseEscalFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","cobBaseEscalListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","cobBaseEscalListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(CobBaseEscalData cobBaseEscal) throws Exception{
	...
	* @param cobBaseEscal La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(CobBaseEscalData cobBaseEscal) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		CobBaseEscalData cobBaseEscal = 
			(CobBaseEscalData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(cobBaseEscal);
		loadLeafDependenceCombos(cobBaseEscal);
	}
	...
	*/
	...
	protected void loadLocalizationVars(CobBaseEscalData cobBaseEscal) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("COB_BASE_ESCAL");
		mmgLocalizationQuery.setEntiPk(cobBaseEscal.getId());
