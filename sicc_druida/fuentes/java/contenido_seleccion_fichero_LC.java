...
public class contenido_seleccion_fichero_LC  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_seleccion_fichero_LC" );
      ((Element)v.get(0)).setAttribute("cod","0377" );
      ((Element)v.get(0)).setAttribute("titulo","Mantener unidades geograficas" );
      ...
      v.add(doc.createTextNode("\r   \r\r   function fmCargarBarra() {\r\r      configurarMenuSecundario(\"frmFichero\");\r      fMostrarMensajeError();\r      fichero1.focaliza();\r	\r   }\r\r \r   function processFile(file) {	\r	   if (get(\"frmFichero.conectorAction\")==''){\r		   set(\"frmFichero.conectorAction\",\"LPCargaFicheroConsultoras\");\r	   }	\r\r     eval('frmFichero').oculto = 'S'; \r	   set(\"frmFichero.seleccion\",file);\r	   set(\"frmFichero.accion\",\"procesar\");\r	   enviaSICC(\"frmFichero\");\r   }\r\r/*-------------------------------------------------------*/\r\r   function aceptar() {\r      debug;\r	  alert('en funcion aceptar...');\r      set('frmFichero.accion','');\r      eval('frmFichero').oculto = 'S';\r      set('frmFichero.conectorAction','LPCargaFicheroConsultoras');\r	  alert('antes del envia sicc oculto....');\r      enviaSICC('frmFichero');\r   }\r\r/*------------------------------------------------------------------------------*/\r\r   function retornaConExito(){\r      GestionarMensaje('1403');\r      this.close();\r   }\r\r\r\r   function retornaConError(){\r      this.close();  \r\r   }\r\r\r  function fLimpiar() {              \r\r     set('frmFichero.accion','');\r     set('frmFichero.conectorAction','LPCargaFicheroConsultoras');\r     enviaSICC('frmFichero');\r}\r\r\r   function fVolver(){\r      this.close();\r   }\r  \r"));
      ...
      ((Element)v.get(4)).setAttribute("nombre","frmFichero" );
      ...
      ((Element)v.get(6)).setAttribute("valor","LPCargaFichero" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(11)).setAttribute("nombre","mensaje" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(12)).setAttribute("nombre","longMinima" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(13)).setAttribute("nombre","nombreFile" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(14)).setAttribute("nombre","hidIdFuncion" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(45)).setAttribute("nombre","fichero1" );
      ((Element)v.get(45)).setAttribute("campo","f1.ruta" );
      ((Element)v.get(45)).setAttribute("comprimir","NO" );
      ((Element)v.get(45)).setAttribute("descomprimir","NO" );
      ((Element)v.get(45)).setAttribute("id","datosCampos" );
      ((Element)v.get(45)).setAttribute("idenviar","datosCampos" );
      ((Element)v.get(45)).setAttribute("max","100" );
      ((Element)v.get(45)).setAttribute("ON","LPObjetoFicheroUpload" );
      ((Element)v.get(45)).setAttribute("funcion","processFile(file)" );
      ((Element)v.get(45)).setAttribute("readonly","N" );
      ((Element)v.get(45)).setAttribute("cod","12" );
      ((Element)v.get(45)).setAttribute("size","100" );
      ((Element)v.get(45)).setAttribute("ontab","fichero1.focaliza()" );
   }

   private void getXML180(Document doc) {
      ((Element)v.get(45)).setAttribute("onshtab","fichero1.focalizaFinal()" );
      ...
      /* Empieza nodo:48 / Elemento padre: 23   */
      v.add(doc.createElement("td"));
      ((Element)v.get(23)).appendChild((Element)v.get(48));
