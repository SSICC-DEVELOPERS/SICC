...
public class MsgMedioEnvioPaisConectorQueryForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad MsgMedioEnvioPais" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGMsgMedioEnvioPaisQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGMsgMedioEnvioPaisQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","MsgMedioEnvioPaisFormFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(8)).setAttribute("NOMBRE","meenOidMediEnvi" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(9)).setAttribute("NOMBRE","codEsta" );
