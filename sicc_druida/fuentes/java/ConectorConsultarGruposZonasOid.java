...
public class ConectorConsultarGruposZonasOid  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(11)).setAttribute("NOMBRE","OID" );
      ((Element)v.get(10)).appendChild((Element)v.get(11));
      /* Termina nodo:11   */

      /* Empieza nodo:12 / Elemento padre: 10   */
      v.add(doc.createElement("CCAMPO"));
      ((Element)v.get(12)).setAttribute("NOMBRE","NOM_GRUP" );
