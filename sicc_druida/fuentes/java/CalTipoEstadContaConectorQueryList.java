...
public class CalTipoEstadContaConectorQueryList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad CalTipoEstadConta" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGCalTipoEstadContaQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGCalTipoEstadContaQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","CalTipoEstadContaListFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","codEsta" );
