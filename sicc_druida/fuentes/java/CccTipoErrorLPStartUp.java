/*
    INDRA/CAR/mmg
    $Id: CccTipoErrorLPStartUp.java,v 1.1 2009/12/03 18:41:34 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class CccTipoErrorLPStartUp extends MMGDruidaBase{
	...
	public CccTipoErrorLPStartUp(){
		super();
	}

	public void inicio() throws Exception {
		pagina("CccTipoErrorPage");
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "CccTipoErrorPage", "cod", "CccTipoError." + accion + ".label");
			...
			limpiarBotoneraLista("cccTipoError", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codErro", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 2);");
		...
		//asignarAtributo("CAPA", "cccTipoErrorLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "CccTipoErrorPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		CccTipoErrorData cccTipoErrorQuery= new CccTipoErrorData();
		cccTipoErrorQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		CccTipoErrorData datosResult = (CccTipoErrorData)getSingleObject(BUSINESSID_QUERY, cccTipoErrorQuery, 
			cccTipoErrorQuery.clone(), "cccTipoError");
		...
		preservaHiddensI18n(new Integer(1), "CCC_TIPO_ERROR", "cccTipoErrorFrm", "Descripcion", true);
		...
		CccTipoErrorData cccTipoError = datosResult;
		asignar("TEXT", "codErro", FormatUtils.formatObject(cccTipoError.getCodErro(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "Descripcion", FormatUtils.formatObject(cccTipoError.getDescripcion(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		loadLocalizationVars(cccTipoError);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "codErro", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "CCC_TIPO_ERROR", "cccTipoErrorFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "codErro", "req", "S");
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('cccTipoErrorFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "cccTipoErrorFrm", "oculto", "N");
		...
		traza("MMG::Creando CccTipoError");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		CccTipoErrorData cccTipoErrorQuery= new CccTipoErrorData();
		cccTipoErrorQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(cccTipoError.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"cccTipoErrorFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"cccTipoErrorFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codErro", "ontab","ejecutarAccionFocoModificacion(\"cccTipoErrorFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codErro", "onshtab","ejecutarAccionFocoModificacion(\"cccTipoErrorFrm\",2, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"cccTipoErrorFrm\",3, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"cccTipoErrorFrm\",3, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","cccTipoErrorTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","cccTipoErrorTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codErro...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","cccTipoErrorFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","cccTipoErrorListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","cccTipoErrorListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(CccTipoErrorData cccTipoError) throws Exception{
	...
	* @param cccTipoError La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(CccTipoErrorData cccTipoError) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		CccTipoErrorData cccTipoError = 
			(CccTipoErrorData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(cccTipoError);
		loadLeafDependenceCombos(cccTipoError);
	}
	...
	*/
	...
	protected void loadLocalizationVars(CccTipoErrorData cccTipoError) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("CCC_TIPO_ERROR");
		mmgLocalizationQuery.setEntiPk(cccTipoError.getId());
