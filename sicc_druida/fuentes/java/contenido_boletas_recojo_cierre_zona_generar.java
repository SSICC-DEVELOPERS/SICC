...
public class contenido_boletas_recojo_cierre_zona_generar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_boletas_recojo_cierre_zona_generar" );
      ((Element)v.get(0)).setAttribute("cod","3445" );
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(4)).setAttribute("name","cbPeriodo" );
      ((Element)v.get(4)).setAttribute("required","true" );
      ((Element)v.get(4)).setAttribute("cod","276" );
      ...
      ((Element)v.get(6)).setAttribute("cod","109" );
      ((Element)v.get(1)).appendChild((Element)v.get(6));
      /* Termina nodo:6   */

      /* Empieza nodo:7 / Elemento padre: 1   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(7)).setAttribute("name","cbZona" );
      ((Element)v.get(7)).setAttribute("required","true" );
      ((Element)v.get(7)).setAttribute("cod","143" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(9)).setAttribute("src","DruidaTransactionMare.js" );
      ((Element)v.get(0)).appendChild((Element)v.get(9));
      /* Termina nodo:9   */

      /* Empieza nodo:10 / Elemento padre: 0   */
      v.add(doc.createElement("JS"));
      ((Element)v.get(10)).setAttribute("src","contenido_boletas_recojo_cierre_zona_generar.js" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(17)).setAttribute("nombre","hOidPeriodo" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(18)).setAttribute("nombre","hOidZona" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(64)).setAttribute("ontab","onTab('cbMarca')" );
      ((Element)v.get(64)).setAttribute("onshtab","onShiftTab('cbMarca')" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(69)).setAttribute("ontab","onTab('cbCanal')" );
      ((Element)v.get(69)).setAttribute("onshtab","onShiftTab('cbCanal')" );
      ...
      ((Element)v.get(74)).setAttribute("ontab","onTab('cbPeriodo')" );
      ((Element)v.get(74)).setAttribute("onshtab","onShiftTab('cbPeriodo')" );
   ...
   private void getXML360(Document doc) {
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(91)).setAttribute("nombre","lblSubgerenciaVentas" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(106)).setAttribute("nombre","cbSubgerenciaVentas" );
      ...
      ((Element)v.get(106)).setAttribute("ontab","onTab('cbSubgerenciaVentas')" );
      ((Element)v.get(106)).setAttribute("onshtab","onShiftTab('cbSubgerenciaVentas')" );
      ((Element)v.get(106)).setAttribute("onchange","onChangeSubgerenciaVentas();" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(111)).setAttribute("ontab","onTab('cbRegion')" );
      ((Element)v.get(111)).setAttribute("onshtab","onShiftTab('cbRegion')" );
      ((Element)v.get(111)).setAttribute("onchange","onChangeRegion();" );
      ...
      ((Element)v.get(116)).setAttribute("ontab","onTab('cbZona')" );
      ((Element)v.get(116)).setAttribute("onshtab","onShiftTab('cbZona')" );
      ...
      /* Empieza nodo:120 / Elemento padre: 83   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(83)).appendChild((Element)v.get(120));
      ...
      ((Element)v.get(133)).setAttribute("nombre","btnGenerar" );
      ((Element)v.get(133)).setAttribute("ID","botonContenido" );
      ((Element)v.get(133)).setAttribute("tipo","html" );
      ((Element)v.get(133)).setAttribute("accion","onClickGenerar();" );
      ((Element)v.get(133)).setAttribute("estado","false" );
      ((Element)v.get(133)).setAttribute("cod","190" );
      ((Element)v.get(133)).setAttribute("ontab","onTab('btnGenerar')" );
      ((Element)v.get(133)).setAttribute("onshtab","onShiftTab('btnGenerar')" );
