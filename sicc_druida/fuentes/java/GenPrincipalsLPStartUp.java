/*
    INDRA/CAR/mmg
    $Id: GenPrincipalsLPStartUp.java,v 1.1 2009/12/03 18:38:33 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class GenPrincipalsLPStartUp extends MMGDruidaBase{
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "GenPrincipalsPage", "cod", "GenPrincipals." + accion + ".label");
			...
			limpiarBotoneraLista("genPrincipals", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "name", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 50);");
		asignarAtributo("TEXT", "type", "validacion", "mensaje = ValidaInt(cdos_trim(valor), 2, 0, 99);");
		asignarAtributo("TEXT", "description", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 0, 256);");
		
		//Primero determianmos el nombre del campo en la entidad de oriegen donde se van a cargar los datos
		asignar("VAR", "idAttributeLovOpener", conectorParametro(PARAMETRO_LOV_ATTRIBUTO));
		asignar("VAR", "idEntityLovOpener", conectorParametro(PARAMETRO_LOV_ENTIDAD));
		//asignarAtributo("CAPA", "genPrincipalsLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "GenPrincipalsPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		GenPrincipalsData genPrincipalsQuery= new GenPrincipalsData();
		genPrincipalsQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		GenPrincipalsData datosResult = (GenPrincipalsData)getSingleObject(BUSINESSID_QUERY, genPrincipalsQuery, 
			genPrincipalsQuery.clone(), "genPrincipals");
		...
		GenPrincipalsData genPrincipals = datosResult;
		asignar("TEXT", "name", FormatUtils.formatObject(genPrincipals.getName(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "type", FormatUtils.formatObject(genPrincipals.getType(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "description", FormatUtils.formatObject(genPrincipals.getDescription(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		asignarAtributo("TEXT", "name", "disabled", "S");
		asignarAtributo("TEXT", "type", "disabled", "S");
		asignarAtributo("TEXT", "description", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		...
		asignarAtributo("TEXT", "name", "req", "S");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "genPrincipalsFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		GenPrincipalsData genPrincipalsQuery= new GenPrincipalsData();
		genPrincipalsQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(genPrincipals.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"genPrincipalsFrm\",0, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"genPrincipalsFrm\",0, false)");
				asignarAtributo("AREATEXTO", "name", "ontab","ejecutarAccionFocoModificacion(\"genPrincipalsFrm\",0, true)");
				asignarAtributo("AREATEXTO", "name", "onshtab","ejecutarAccionFocoModificacion(\"genPrincipalsFrm\",0, false)");
				asignarAtributo("AREATEXTO", "type", "ontab","ejecutarAccionFocoModificacion(\"genPrincipalsFrm\",0, true)");
				asignarAtributo("AREATEXTO", "type", "onshtab","ejecutarAccionFocoModificacion(\"genPrincipalsFrm\",0, false)");
				asignarAtributo("AREATEXTO", "description", "ontab","ejecutarAccionFocoModificacion(\"genPrincipalsFrm\",0, true)");
				asignarAtributo("AREATEXTO", "description", "onshtab","ejecutarAccionFocoModificacion(\"genPrincipalsFrm\",0, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","genPrincipalsTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","genPrincipalsTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es name...");		
				
				traza("MMG: el atributo es type...");		
				
				traza("MMG: el atributo es description...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","genPrincipalsFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","genPrincipalsListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","genPrincipalsListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(GenPrincipalsData genPrincipals) throws Exception{
	...
	* @param genPrincipals La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(GenPrincipalsData genPrincipals) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		GenPrincipalsData genPrincipals = 
			(GenPrincipalsData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(genPrincipals);
		loadLeafDependenceCombos(genPrincipals);
	}
