...
/*
    INDRA/CAR/mmg
    $Id: ZonEstadZonaTransactionComboLoad.java,v 1.1 2009/12/03 18:37:28 pecbazalar Exp $
    DESC
*/
...
public class ZonEstadZonaTransactionComboLoad extends MMGDruidaTransaction {
	//Constantes usadas en la clase. Simplemente representan 
	//los nombre de conectore y de logicas de negocio
	public static final String BUSINESSID_QUERY = "MMGZonEstadZonaQueryFromToUserStructuralSecurity";
	public static final String CONECTOR_QUERY_COMBO= "ZonEstadZonaConectorCombo";

	// Definicion del constructor
	public ZonEstadZonaTransactionComboLoad(){
		super();
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			dto.addProperty("zonEstadZonaFrom", zonEstadZona);
			dto.addProperty("zonEstadZonaTo", zonEstadZona.clone());
