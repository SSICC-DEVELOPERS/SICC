...
public class ConectorBuscarMatricesDTOActivas  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","ConectorBuscarMatricesDTOActivas" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(6)).setAttribute("NOMBRE","oidCabeceraMatrizDTO" );
      ((Element)v.get(6)).setAttribute("TIPO","OBJETO" );
      ...
      ((Element)v.get(7)).setAttribute("TIPO","OBJETO" );
