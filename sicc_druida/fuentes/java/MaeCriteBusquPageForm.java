...
public class MaeCriteBusquPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","MaeCriteBusqu.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","MaeCriteBusqu.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('maeCriteBusquFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('maeCriteBusquFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(54)).setAttribute("cod","MaeCriteBusqu.paisOidPais.label" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('maeCriteBusquFrm',2, true);" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('maeCriteBusquFrm',2, false);" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(76)).setAttribute("nombre","atreOidAtriEsp1TdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(80)).setAttribute("nombre","lblatreOidAtriEsp1" );
      ((Element)v.get(80)).setAttribute("id","datosTitle" );
      ((Element)v.get(80)).setAttribute("ancho","150" );
      ((Element)v.get(80)).setAttribute("alto","13" );
      ((Element)v.get(80)).setAttribute("cod","MaeCriteBusqu.atreOidAtriEsp1.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(81)).setAttribute("nombre","atreOidAtriEsp1WidgetTrId" );
   }
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(83)).setAttribute("nombre","atreOidAtriEsp1" );
      ...
      ((Element)v.get(83)).setAttribute("ontab","ejecutarAccionFoco('maeCriteBusquFrm',3, true);" );
      ((Element)v.get(83)).setAttribute("onshtab","ejecutarAccionFoco('maeCriteBusquFrm',3, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(85)).setAttribute("nombre","atreOidAtriEsp1GapTdId" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(87)).setAttribute("nombre","atreOidAtriEsp2TdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(91)).setAttribute("nombre","lblatreOidAtriEsp2" );
      ((Element)v.get(91)).setAttribute("id","datosTitle" );
      ((Element)v.get(91)).setAttribute("ancho","150" );
      ((Element)v.get(91)).setAttribute("alto","13" );
      ((Element)v.get(91)).setAttribute("cod","MaeCriteBusqu.atreOidAtriEsp2.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(92)).setAttribute("nombre","atreOidAtriEsp2WidgetTrId" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(94)).setAttribute("nombre","atreOidAtriEsp2" );
      ...
      ((Element)v.get(94)).setAttribute("ontab","ejecutarAccionFoco('maeCriteBusquFrm',4, true);" );
      ((Element)v.get(94)).setAttribute("onshtab","ejecutarAccionFoco('maeCriteBusquFrm',4, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(96)).setAttribute("nombre","atreOidAtriEsp2GapTdId" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(101)).setAttribute("nombre","formGapTr2" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(110)).setAttribute("nombre","maeCriteBusquTrButtons" );
      ...
      ((Element)v.get(117)).setAttribute("nombre","maeCriteBusquTdQueryButton" );
      ((Element)v.get(116)).appendChild((Element)v.get(117));

      /* Empieza nodo:118 / Elemento padre: 117   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(118)).setAttribute("nombre","maeCriteBusquQueryButton" );
      ((Element)v.get(118)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(118)).setAttribute("estado","false" );
      ((Element)v.get(118)).setAttribute("accion","maeCriteBusquFirstPage();" );
      ...
      ((Element)v.get(119)).setAttribute("nombre","maeCriteBusquTdLovNullSelectionButton" );
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(121)).setAttribute("nombre","maeCriteBusquLovNullButton" );
      ((Element)v.get(121)).setAttribute("ID","botonContenido" );
      ((Element)v.get(121)).setAttribute("tipo","html" );
      ((Element)v.get(121)).setAttribute("accion","maeCriteBusquLovNullSelectionAction();" );
