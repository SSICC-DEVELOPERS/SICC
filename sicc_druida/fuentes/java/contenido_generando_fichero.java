...
public class contenido_generando_fichero  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_generando_fichero" );
      ((Element)v.get(0)).setAttribute("cod","" );
      ((Element)v.get(0)).setAttribute("titulo","" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","" );
      ((Element)v.get(0)).setAttribute("onload","ver();" );
      ((Element)v.get(0)).setAttribute("onunload","killTimeOut();" );
      ...
      v.add(doc.createTextNode("\r.msg {  font-family: Arial, Helvetica, sans-serif; font-size: 10pt; font-style: italic; font-weight: bold; color: #777C7C; text-align: center;}\r#msg {  font-family: Arial, Helvetica, sans-serif; font-size: 10pt; font-style: italic; font-weight: bold; color: #777C7C; text-align: center;}\r#msgF {  font-family: Arial, Helvetica, sans-serif; font-size: 10pt; font-style: italic; font-weight: bold; color: #777C7C; text-align: center;}\r"));
      ...
      v.add(doc.createTextNode("\r   \r     \r        \r     var idTimer ;\r	 var idTimer2 ;\r\r     function ver(){\r		if(!opener){\r			idTimer = setInterval(\"checkReport()\", 15000);\r		}\r     }\r\r     function checkReport() {\r        set( 'Formulario.conectorAction', 'REPBatch');\r        set('Formulario.accion', 'consultarEjecucion');\r		eval('Formulario').oculto = 'S';\r		enviaSICC('Formulario');\r     }\r\r     function killTimeOut() {\r		try{\r			clearInterval(idTimer);\r			clearTimeout(idTimer2);\r		}catch(e){\r			;\r		}\r     }\r\r     function cerrar() {\r        killTimeOut();\r        window.close();\r     }\r\r     function muestroReporte() {\r		killTimeOut();\r		eval('Formulario').oculto = 'N';\r		set('Formulario.accion', 'mostrar');\r		set( 'Formulario.conectorAction', 'REPBatch');\r		enviaSICC('Formulario');\r		var timeoutVentanaSICC = get(\"Formulario.timeoutVentana\")\r		window.setTimeout(\"window.close()\", parseInt(timeoutVentanaSICC,10));\r     }\r\r     \r"));
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(14)).setAttribute("nombre","idProceso" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(15)).setAttribute("nombre","timeoutVentana" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(16)).setAttribute("nombre","extension" );
      ((Element)v.get(16)).setAttribute("valor","pdf" );
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(22)).setAttribute("width","500" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(34)).setAttribute("height","24" );
      ...
      ((Element)v.get(37)).setAttribute("width","50" );
      ((Element)v.get(37)).setAttribute("height","30" );
      ...
      v.add(doc.createElement("IMG"));
      ((Element)v.get(39)).setAttribute("src","GenerandoInforme.gif" );
      ...
      ((Element)v.get(41)).setAttribute("width","50" );
      ((Element)v.get(41)).setAttribute("height","30" );
      ...
      ((Element)v.get(44)).setAttribute("nombre","btnCerrar" );
      ((Element)v.get(44)).setAttribute("ID","botonContenido" );
      ((Element)v.get(44)).setAttribute("tipo","html" );
      ((Element)v.get(44)).setAttribute("accion","cerrar()" );
      ((Element)v.get(44)).setAttribute("estado","false" );
      ((Element)v.get(44)).setAttribute("alt","Cerrar" );
      ...
      ((Element)v.get(47)).setAttribute("height","24" );
      ...
      /* Empieza nodo:48 / Elemento padre: 26   */
      v.add(doc.createElement("td"));
      ((Element)v.get(26)).appendChild((Element)v.get(48));

      /* Empieza nodo:49 / Elemento padre: 48   */
      v.add(doc.createElement("IMG"));
      ((Element)v.get(49)).setAttribute("src","b.gif" );
      ((Element)v.get(49)).setAttribute("width","8" );
      ((Element)v.get(49)).setAttribute("height","24" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("tr"));
      ((Element)v.get(56)).setAttribute("bgcolor","#D6E1E1" );
      ...
      ((Element)v.get(58)).setAttribute("nombre","lbldtMensaje" );
      ((Element)v.get(58)).setAttribute("ancho","475" );
      ((Element)v.get(58)).setAttribute("alto","30" );
      ((Element)v.get(58)).setAttribute("filas","2" );
      ((Element)v.get(58)).setAttribute("valor","" );
      ((Element)v.get(58)).setAttribute("id","msg" );
      ((Element)v.get(58)).setAttribute("cod","2814" );
