...
public class IntAccesBuzonIvrrgPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","IntAccesBuzonIvrrg.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","IntAccesBuzonIvrrg.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('intAccesBuzonIvrrgFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('intAccesBuzonIvrrgFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(50)).setAttribute("nombre","codAcceBuzoIvrrTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lblCodAcceBuzoIvrr" );
      ((Element)v.get(54)).setAttribute("alto","13" );
      ((Element)v.get(54)).setAttribute("filas","1" );
      ((Element)v.get(54)).setAttribute("id","datosTitle" );
      ((Element)v.get(54)).setAttribute("cod","IntAccesBuzonIvrrg.codAcceBuzoIvrr.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(55)).setAttribute("nombre","codAcceBuzoIvrrWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(57)).setAttribute("nombre","codAcceBuzoIvrr" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('intAccesBuzonIvrrgFrm',2, true)" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('intAccesBuzonIvrrgFrm', 2, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(58)).setAttribute("nombre","codAcceBuzoIvrrGapTdId" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(75)).setAttribute("nombre","zorgOidRegi_marcOidMarcTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(79)).setAttribute("nombre","lblzorgOidRegi_marcOidMarc" );
      ((Element)v.get(79)).setAttribute("id","datosTitle" );
      ((Element)v.get(79)).setAttribute("ancho","150" );
      ((Element)v.get(79)).setAttribute("alto","13" );
      ((Element)v.get(79)).setAttribute("cod","ZonRegioView2.marcOidMarc.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(80)).setAttribute("nombre","zorgOidRegi_marcOidMarcWidgetTrId" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(82)).setAttribute("nombre","zorgOidRegi_marcOidMarc" );
      ...
      ((Element)v.get(82)).setAttribute("onchange","mmgDependeneChange('zorgOidRegi_marcOidMarc', 'zorgOidRegi' , 'intAccesBuzonIvrrg')" );
      ...
      ((Element)v.get(82)).setAttribute("ontab","focaliza('intAccesBuzonIvrrgFrm.zorgOidRegi_canaOidCana');" );
      ((Element)v.get(82)).setAttribute("onshtab","ejecutarAccionFoco('intAccesBuzonIvrrgFrm',3, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(84)).setAttribute("nombre","zorgOidRegi_marcOidMarcGapTdId" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(86)).setAttribute("nombre","zorgOidRegi_canaOidCanaTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(90)).setAttribute("nombre","lblzorgOidRegi_canaOidCana" );
      ((Element)v.get(90)).setAttribute("id","datosTitle" );
      ((Element)v.get(90)).setAttribute("ancho","150" );
      ((Element)v.get(90)).setAttribute("alto","13" );
      ((Element)v.get(90)).setAttribute("cod","ZonRegioView2.canaOidCana.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(91)).setAttribute("nombre","zorgOidRegi_canaOidCanaWidgetTrId" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(93)).setAttribute("nombre","zorgOidRegi_canaOidCana" );
      ...
      ((Element)v.get(93)).setAttribute("onchange","mmgDependeneChange('zorgOidRegi_canaOidCana', 'zorgOidRegi' , 'intAccesBuzonIvrrg')" );
      ...
      ((Element)v.get(93)).setAttribute("ontab","focaliza('intAccesBuzonIvrrgFrm.zorgOidRegi');" );
      ((Element)v.get(93)).setAttribute("onshtab","ejecutarAccionFoco('intAccesBuzonIvrrgFrm',3, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(95)).setAttribute("nombre","zorgOidRegi_canaOidCanaGapTdId" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(97)).setAttribute("nombre","zorgOidRegiTdId" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(101)).setAttribute("nombre","lblzorgOidRegi" );
      ...
      ((Element)v.get(101)).setAttribute("cod","IntAccesBuzonIvrrg.zorgOidRegi.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(102)).setAttribute("nombre","zorgOidRegiWidgetTrId" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(104)).setAttribute("nombre","zorgOidRegi" );
      ...
      ((Element)v.get(104)).setAttribute("ontab","ejecutarAccionFoco('intAccesBuzonIvrrgFrm',3, true);" );
      ((Element)v.get(104)).setAttribute("onshtab","focaliza('intAccesBuzonIvrrgFrm.zorgOidRegi_canaOidCana');" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(106)).setAttribute("nombre","zorgOidRegiGapTdId" );
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(120)).setAttribute("nombre","intAccesBuzonIvrrgTrButtons" );
      ...
      ((Element)v.get(127)).setAttribute("nombre","intAccesBuzonIvrrgTdQueryButton" );
      ((Element)v.get(126)).appendChild((Element)v.get(127));

      /* Empieza nodo:128 / Elemento padre: 127   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(128)).setAttribute("nombre","intAccesBuzonIvrrgQueryButton" );
      ((Element)v.get(128)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(128)).setAttribute("estado","false" );
      ((Element)v.get(128)).setAttribute("accion","intAccesBuzonIvrrgFirstPage();" );
      ...
      ((Element)v.get(129)).setAttribute("nombre","intAccesBuzonIvrrgTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(131)).setAttribute("nombre","intAccesBuzonIvrrgLovNullButton" );
      ((Element)v.get(131)).setAttribute("ID","botonContenido" );
      ((Element)v.get(131)).setAttribute("tipo","html" );
      ((Element)v.get(131)).setAttribute("accion","intAccesBuzonIvrrgLovNullSelectionAction();" );
