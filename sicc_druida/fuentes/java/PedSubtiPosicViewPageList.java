...
public class PedSubtiPosicViewPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","pedSubtiPosicViewList" );
      ...
      ((Element)v.get(14)).setAttribute("cod","PedSubtiPosicView.codSubtPosi.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","PedSubtiPosicView.tposOidTipoPosi.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","PedSubtiPosicView.Descripcion.label" );
