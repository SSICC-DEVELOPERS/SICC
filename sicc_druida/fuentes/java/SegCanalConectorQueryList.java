...
public class SegCanalConectorQueryList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad SegCanal" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGSegCanalQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGSegCanalQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","SegCanalListFormatter" );
