...
public class CALLlamadasMotivosProcesos extends LPSICCBase {           
   public CALLlamadasMotivosProcesos() {	 
     super();
  }
     ...
     try {
        ...
        if (accion.equals("generar")){
          ...
          //cargarPagina();
           ...
           cargarPagina();
           getConfiguracionMenu("CALLlamadasMotivosProcesos");
        }
  ...
  private void cargarPagina() throws Exception{
     pagina("contenido_llamadas_registradas_motivos_procesos_obtener");   
     ...
     MareBusinessID idMC = new MareBusinessID("CALObtenerMotivoContacto");
     ...
     asignar("COMBO", "cbMotivo", mcs, "DTOSalida.mc_ROWSET");  
 ...
 private void generarReporte() throws Exception{
     ...
     String motivo        = conectorParametroLimpia("motivo", "", true);
     if(!motivo.equals("")){
        datos.put(ConstantesREP.MOTIVOS, motivo);     
     }
     ...
     datos.put(ConstantesREP.TITULO, "Cantidad de Llamadas Registradas por Motivo y Procesos Asociados");     
     traza("++++++Antes de enviar a reportes " + datos); 
         
     ejecutarReporte2(datos, "REPGenerarReporteBatch", "RD_REP-085", "pdf");
