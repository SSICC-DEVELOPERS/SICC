...
public class PedProcePageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","pedProceList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(18)).setAttribute("cod","PedProce.codProc.label" );
      ...
      ((Element)v.get(19)).setAttribute("cod","PedProce.Descripcion.label" );
      ...
      ((Element)v.get(20)).setAttribute("cod","PedProce.grprOidGrupProc.label" );
      ...
      ((Element)v.get(21)).setAttribute("cod","PedProce.progOidProg.label" );
      ...
      ((Element)v.get(22)).setAttribute("cod","PedProce.procOidProc.label" );
      ...
      ((Element)v.get(23)).setAttribute("cod","PedProce.tposOidTipoPosi.label" );
      ...
      ((Element)v.get(24)).setAttribute("cod","PedProce.stpoOidSubtPosi.label" );
