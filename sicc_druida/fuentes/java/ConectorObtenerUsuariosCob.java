...
public class ConectorObtenerUsuariosCob  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","ConectorObtenerUsuariosCob" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","DTOBuscarUsuariosCob" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(9)).setAttribute("NOMBRE","ID_USUARIO" );
