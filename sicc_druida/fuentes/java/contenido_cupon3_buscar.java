...
public class contenido_cupon3_buscar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_cupon3_buscar" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(5)).setAttribute("src","CancelarCupon3.js" );
      ...
      ((Element)v.get(7)).setAttribute("nombre","frmCapturarCupon" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(13)).setAttribute("nombre","codSeleccion" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(32)).setAttribute("nombre","lblTitCritBusc" );
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(36)).setAttribute("width","690" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(44)).setAttribute("nombre","lblAno" );
      ...
      ((Element)v.get(44)).setAttribute("cod","171" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(48)).setAttribute("nombre","lblMes" );
      ...
      ((Element)v.get(48)).setAttribute("cod","674" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(52)).setAttribute("nombre","lblNumero" );
      ((Element)v.get(52)).setAttribute("alto","13" );
      ((Element)v.get(52)).setAttribute("filas","1" );
      ((Element)v.get(52)).setAttribute("valor","" );
      ((Element)v.get(52)).setAttribute("id","datosTitle" );
      ((Element)v.get(52)).setAttribute("cod","226" );
      ...
      ((Element)v.get(59)).setAttribute("nombre","textAno" );
      ...
      ((Element)v.get(59)).setAttribute("onblur","validarAnio('textAno');" );
      ((Element)v.get(59)).setAttribute("onshtab","onshtabTextAno();" );
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(63)).setAttribute("nombre","textMes" );
      ...
      ((Element)v.get(63)).setAttribute("onblur","validarMes('textMes');" );
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(67)).setAttribute("nombre","textNumero" );
   }

   private void getXML270(Document doc) {
      ((Element)v.get(67)).setAttribute("id","datosCampos" );
      ((Element)v.get(67)).setAttribute("max","8" );
      ...
      ((Element)v.get(67)).setAttribute("onblur","validarNumero('textNumero');" );
   ...
   private void getXML360(Document doc) {
      ((Element)v.get(88)).setAttribute("cod","447" );
      ...
      ((Element)v.get(95)).setAttribute("nombre","cbMarca" );
      ((Element)v.get(95)).setAttribute("id","datosCampos" );
      ((Element)v.get(95)).setAttribute("onchange","cambioMarcaCanal();" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(100)).setAttribute("nombre","cbCanal" );
      ...
      ((Element)v.get(100)).setAttribute("onchange","cambioMarcaCanal();" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(105)).setAttribute("nombre","cbPeriodo" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(114)).setAttribute("width","690" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(119)).setAttribute("nombre","lblCodCliente" );
      ...
      ((Element)v.get(119)).setAttribute("cod","263" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(123)).setAttribute("nombre","lblFechaDoc" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(127)).setAttribute("nombre","lblFechaMov" );
      ...
      ((Element)v.get(127)).setAttribute("cod","651" );
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(134)).setAttribute("nombre","textCodCliente" );
      ((Element)v.get(134)).setAttribute("id","datosCampos" );
      ((Element)v.get(134)).setAttribute("max","15" );
   }
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(134)).setAttribute("size","19" );
      ((Element)v.get(134)).setAttribute("valor","" );
      ((Element)v.get(134)).setAttribute("validacion","" );
      ((Element)v.get(134)).setAttribute("onblur","textCodClienteOnBlur()" );
      ...
      /* Empieza nodo:148 / Elemento padre: 114   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(114)).appendChild((Element)v.get(148));
      ...
      /* Empieza nodo:151 / Elemento padre: 33   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(33)).appendChild((Element)v.get(151));
   ...
   private void getXML720(Document doc) {
      ...
      /* Empieza nodo:181 / Elemento padre: 26   */
      v.add(doc.createElement("td"));
      ((Element)v.get(26)).appendChild((Element)v.get(181));
      ...
      /* Empieza nodo:183 / Elemento padre: 18   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(18)).appendChild((Element)v.get(183));
      ...
      ((Element)v.get(191)).setAttribute("ontab","focalizaBuscar();" );
   ...
   private void getXML900(Document doc) {
      ...
      ((Element)v.get(222)).setAttribute("cod","680" );
      ...
      ((Element)v.get(223)).setAttribute("cod","171" );
      ...
      ((Element)v.get(224)).setAttribute("cod","674" );
      ...
      ((Element)v.get(225)).setAttribute("cod","263" );
      ...
      ((Element)v.get(226)).setAttribute("cod","383" );
      ...
      ((Element)v.get(227)).setAttribute("cod","651" );
      ...
      ((Element)v.get(228)).setAttribute("cod","637" );
      ...
      ((Element)v.get(229)).setAttribute("cod","573" );
   ...
   private void getXML990(Document doc) {
      ...
      /* Empieza nodo:239 / Elemento padre: 202   */
      v.add(doc.createElement("ROWSET"));
      ((Element)v.get(202)).appendChild((Element)v.get(239));
      /* Termina nodo:239   */

      /* Empieza nodo:240 / Elemento padre: 202   */
      v.add(doc.createElement("PAGINADO"));
      ((Element)v.get(240)).setAttribute("nombre","mipgndo" );
      ((Element)v.get(240)).setAttribute("ancho","694" );
      ...
      ((Element)v.get(240)).setAttribute("conector","conectorSandra" );
      ...
      ((Element)v.get(202)).appendChild((Element)v.get(240));
      ...
      /* Empieza nodo:244 / Elemento padre: 201   */
      v.add(doc.createElement("BOTON"));
   ...
   private void getXML1080(Document doc) {
      ...
      ((Element)v.get(201)).appendChild((Element)v.get(244));
      /* Termina nodo:244   */

      /* Empieza nodo:245 / Elemento padre: 201   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(245)).setAttribute("nombre","cancelar" );
      ((Element)v.get(245)).setAttribute("x","80" );
      ((Element)v.get(245)).setAttribute("y","295" );
      ((Element)v.get(245)).setAttribute("ID","botonContenido" );
      ((Element)v.get(245)).setAttribute("accion","accionBTN_Cancelar();" );
      ((Element)v.get(245)).setAttribute("tipo","html" );
      ((Element)v.get(245)).setAttribute("estado","false" );
      ((Element)v.get(245)).setAttribute("cod","1291" );
      ((Element)v.get(245)).setAttribute("ontab","ontabCancelar();" );
      ((Element)v.get(245)).setAttribute("onshtab","onshtabCancelar();" );
      ((Element)v.get(201)).appendChild((Element)v.get(245));
      /* Termina nodo:245   */
      /* Termina nodo:201   */

      /* Empieza nodo:246 / Elemento padre: 7   */
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(246)).setAttribute("nombre","capaEspacio" );
      ((Element)v.get(246)).setAttribute("alto","12" );
      ...
      ((Element)v.get(246)).setAttribute("y","559" );
      ((Element)v.get(246)).setAttribute("zindex","" );
      ((Element)v.get(7)).appendChild((Element)v.get(246));
      /* Termina nodo:246   */
      /* Termina nodo:7   */
