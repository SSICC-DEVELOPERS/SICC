...
public class ConectorCAREjecutivosNuevos  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","CAREjecutivosNuevos" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","DTOPaginado" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","CAREjecutivosNuevos" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","NUEVO_EJEC" );
