...
public class MaeLineaProduPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","maeLineaProduList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","MaeLineaProdu.codLineProd.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","MaeLineaProdu.Descripcion.label" );
