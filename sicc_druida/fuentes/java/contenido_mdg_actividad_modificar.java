...
public class contenido_mdg_actividad_modificar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_mdg_actividad_modificar" );
      ...
      v.add(doc.createTextNode("\r   \r\r\r	/*\r	* Inicializa la pagina\r	*/\r	function onLoadPag() {\r		configurarMenuSecundario(\"frmModificarActividad\");\r				actualizaRelacionCombos();\r				onChangeTipoActividad();\r		focaliza('frmModificarActividad.cbTipoActividad');\r				txt_to('lblActividad1', get('frmModificarActividad.hTextoActividad'));\r				setMV('frmModificarActividad.cbTipoActividad','N');\r		setMV('frmModificarActividad.txtDiasDeDesplazamiento','N');\r				varNoLimpiarSICC = 'S';\r				asignarValoresIniciales();\r		if (!validaReferenciaOtraCampana()){\r			accion('frmModificarActividad.txtCampDesp', '.disabled=true');\r		} else {\r			accion('frmModificarActividad.txtCampDesp', '.disabled=false');\r		}\r	        inicializarEstadoCampos();\r	}\r\r    /**\r     * Habilita o deshabilita algunos campos de acuerdo al estado que se le haya\r     * asignado desde la LP.\r     *\r	 * Sistema:     Belcorp\r	 * Modulo:      CRA\r	 * Fecha:       04/08/2005\r	 * @version     \r	 * @autor       mmaidana\r	 */\r    function inicializarEstadoCampos(){\r        var estadoChkRepetitivaEnabled = get('frmModificarActividad.hEstadoChkRepetitivaEnabled');\r        var estadoTxtCadaDia = get('frmModificarActividad.hEstadoTxtCadaDia');\r\r        if (estadoChkRepetitivaEnabled == 'S'){\r            accion('frmModificarActividad.chkRepetitiva', '.disabled=false');\r        } else {\r            accion('frmModificarActividad.chkRepetitiva', '.disabled=true');\r        }\r    \r        if (estadoTxtCadaDia == 'S'){\r            accion('frmModificarActividad.txtCadaCuantosDias', '.disabled=false');\r        } else {\r            accion('frmModificarActividad.txtCadaCuantosDias', '.disabled=true');\r        }\r\r		accion('frmModificarActividad.cbTipoActividad', '.disabled=true');\r    }\r\r	/*\r	* 	\r	* Al pulsar sobre \"Guardar\" del menú.\r	* Validaciones generales y valida que la actividad facturacion sea no repetitiva.\r	* Llama a LPMantieneMatrizDias con accion = \"guardaModificacion\"\r	* function accionGuardar()\r	*/\r	function fGuardar() {\r				if ( validaConActividadOrigen() ) {\r						if( ! sicc_validaciones_generales('grupoConOrigen') ) {\r				return false;\r			}\r				} else if ( validaReferenciaOtraCampana() ) {\r						if( ! sicc_validaciones_generales('grupoRefOtrCamp') ) {\r				return false;\r			}		\r				} else {\r						if( ! sicc_validaciones_generales('grupoSinOrigen') ) {\r				return false;\r			}		\r		}\r\r																\r				set('frmModificarActividad.hTextoActOrigen', get('frmModificarActividad.cbActividadDeOrigen','T'));\r		set('frmModificarActividad.accion', 'guardaModificacion');\r		enviaSICC('frmModificarActividad');\r	}\r\r\r    /*\r    * Ejecuta el cierre de la ventana modal luedo de guardar la modificacion.\r    */\r    function vueltaGuardaModificacion() {\r				window.close();\r    }\r\r\r	/*\r	* Actualiza la relacion y valores de los combos cbTipoActividad y cbActividadDeOrigen.\r	* Equivalencias: sinActividadOrigen es lo mismo que Fija y referenciada es lo mismo que conActividadOrigen.\r	*/\r	function actualizaRelacionCombos() {\r		var sinActividadOrigen = GestionarMensaje(513);\r		var referenciada = GestionarMensaje(512);\r		var otracampana = GestionarMensaje(3380);\r		\r		var actividadOrigen = new Array();\r		actividadOrigen[0] = get('frmModificarActividad.hOrigen');\r				var tipoActividad = new Array();\r		tipoActividad[0] = get('frmModificarActividad.hCmbTipoActividad');\r		\r		if ( (tipoActividad[0] != null) && (tipoActividad[0] == 'con Origen') ) {\r						set_combo('frmModificarActividad.cbTipoActividad',[['0',sinActividadOrigen],['1',referenciada],['2',otracampana]] ,['1']);\r						set('frmModificarActividad.cbActividadDeOrigen',actividadOrigen);\r		} else if ( (tipoActividad[0] != null) && (tipoActividad[0] == 'Fija') ) {\r						set_combo('frmModificarActividad.cbTipoActividad',[['0',sinActividadOrigen],['1',referenciada],['2',otracampana]],['0']);\r		} else if ( (tipoActividad[0] != null) && (tipoActividad[0] == 'Ref. Otra Camp.') ) {\r						set_combo('frmModificarActividad.cbTipoActividad',[['0',sinActividadOrigen],['1',referenciada],['2',otracampana]] ,['2']);\r						set('frmModificarActividad.cbActividadDeOrigen',actividadOrigen);\r		}\r			}\r\r\r	/*\r	* Este método se activa al seleccionar un valor en cbTipoActividad \r	*/\r	function onChangeTipoActividad() {\r				if (get('frmModificarActividad.cbTipoActividad') == '0') {\r						set('frmModificarActividad.cbActividadDeOrigen','0');\r						accion( 'frmModificarActividad.cbActividadDeOrigen', '.disabled=true');\r		}\r	\r				if (get('frmModificarActividad.cbTipoActividad') == '1'||get('frmModificarActividad.cbTipoActividad') == '2') {\r						accion( 'frmModificarActividad.cbActividadDeOrigen', '.disabled=false');\r		}\r	}\r\r\r	function fVolver() {\r		window.close();\r	}\r\r\r		function fLimpiar() { \r				actualizaRelacionCombos();\r		onChangeTipoActividad();\r		set('frmModificarActividad.txtDiasDeDesplazamiento', get('frmModificarActividad.hDiasDesplazamiento')); \r		set('frmModificarActividad.chkRepetitiva', get('frmModificarActividad.hRepetitiva')); \r		set('frmModificarActividad.txtCadaCuantosDias', get('frmModificarActividad.hCadaDias')); \r		set('frmModificarActividad.txtFechaFinal', get('frmModificarActividad.hDiasFinal')); \r		set('frmModificarActividad.rbMoverActividadesOrigen', get('frmModificarActividad.hMover')); \r		set('frmModificarActividad.txtCampDesp', get('frmModificarActividad.hCampDesp')); \r		focaliza('frmModificarActividad.cbTipoActividad');\r	} \r\r\r	/*\r	* Retorna true si es correcta hay que validar el combo de la actividad origen.\r	*/\r	function validaReferenciaOtraCampana() {\r				if (get('frmModificarActividad.cbTipoActividad') == '2') {\r						return true;\r		}\r		return false;\r	}\r\r	/*\r	* Retorna true si es correcta referencia otra campaña\r	* enozigli 06/12/2007 cra1\r	*/\r	function validaConActividadOrigen() {\r				if (get('frmModificarActividad.cbTipoActividad') == '1') {\r						return true;\r		}\r		return false;\r	}\r\r\r		function focalizaTab() {\r		document.selection.empty();\r		focaliza('frmModificarActividad.cbTipoActividad');\r	}\r\r\r		function focalizaShiftTab() {\r		document.selection.empty();\r		focaliza('frmModificarActividad.rbMoverActividadesOrigen');\r	}\r\r\r		function mostrarMensajeNumerico(campo) {\r		var msg = sicc_obtenerDescripcion(campo);                \r		focaliza(\"frmModificarActividad.\"+campo);\r		cdos_mostrarAlert(GestionarMensaje(\"000000000000100\" ,  \"\\\"\"+msg+\"\\\"\"));                \r	}\r\r\r		function saleDe(nombre) {\r		var validar = esNumeroVip(get('frmModificarActividad.'+nombre));\r		if( validar != 'OK'){\r			mostrarMensajeNumerico(nombre);\r			return false;\r		}            \r	}\r\r\r		function esNumeroVip(orden){\r		var str=orden;\r		var s;\r		for(var i=0;i<str.length;i++){\r			s=str.charAt(i);\r			if (isNaN(parseInt(s))) {\r				if (!((i==0) && (s=='-'))) {\r					return '-1';\r				}\r			}\r		}\r		return 'OK';\r	}\r\r\r		function asignarValoresIniciales() {\r		set('frmModificarActividad.hOrigen', get('frmModificarActividad.cbActividadDeOrigen'));\r		set('frmModificarActividad.hTipoActividad', get('frmModificarActividad.cbTipoActividad'));\r		set('frmModificarActividad.hDiasDesplazamiento', get('frmModificarActividad.txtDiasDeDesplazamiento'));\r		set('frmModificarActividad.hRepetitiva', get('frmModificarActividad.chkRepetitiva'));\r		set('frmModificarActividad.hCadaDias', get('frmModificarActividad.txtCadaCuantosDias'));\r		set('frmModificarActividad.hDiasFinal', get('frmModificarActividad.txtFechaFinal'));\r		set('frmModificarActividad.hMover', get('frmModificarActividad.rbMoverActividadesOrigen'));\r		set('frmModificarActividad.hCampDesp', get('frmModificarActividad.txtCampDesp'));		\r	}\r\r\r\r   \r"));
      ...
      ((Element)v.get(5)).setAttribute("name","cbTipoActividad" );
      ((Element)v.get(5)).setAttribute("required","true" );
      ((Element)v.get(5)).setAttribute("cod","152" );
      ((Element)v.get(5)).setAttribute("group","grupoSinOrigen" );
      ((Element)v.get(4)).appendChild((Element)v.get(5));
      /* Termina nodo:5   */

      /* Empieza nodo:6 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(6)).setAttribute("name","txtDiasDeDesplazamiento" );
      ((Element)v.get(6)).setAttribute("required","true" );
      ((Element)v.get(6)).setAttribute("cod","250" );
      ((Element)v.get(6)).setAttribute("group","grupoSinOrigen" );
      ((Element)v.get(4)).appendChild((Element)v.get(6));
      /* Termina nodo:6   */

      /* Empieza nodo:7 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(7)).setAttribute("name","cbTipoActividad" );
      ((Element)v.get(7)).setAttribute("required","true" );
      ((Element)v.get(7)).setAttribute("cod","152" );
      ((Element)v.get(7)).setAttribute("group","grupoConOrigen" );
      ((Element)v.get(4)).appendChild((Element)v.get(7));
      /* Termina nodo:7   */

      /* Empieza nodo:8 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(8)).setAttribute("name","cbActividadDeOrigen" );
      ((Element)v.get(8)).setAttribute("required","true" );
      ((Element)v.get(8)).setAttribute("cod","155" );
      ((Element)v.get(8)).setAttribute("group","grupoConOrigen" );
      ((Element)v.get(4)).appendChild((Element)v.get(8));
      /* Termina nodo:8   */

      /* Empieza nodo:9 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(9)).setAttribute("name","txtDiasDeDesplazamiento" );
      ((Element)v.get(9)).setAttribute("required","true" );
      ((Element)v.get(9)).setAttribute("cod","250" );
      ((Element)v.get(9)).setAttribute("group","grupoConOrigen" );
      ((Element)v.get(4)).appendChild((Element)v.get(9));
      /* Termina nodo:9   */

      /* Empieza nodo:10 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(10)).setAttribute("name","cbTipoActividad" );
      ((Element)v.get(10)).setAttribute("required","true" );
      ((Element)v.get(10)).setAttribute("cod","152" );
      ((Element)v.get(10)).setAttribute("group","grupoRefOtrCamp" );
      ((Element)v.get(4)).appendChild((Element)v.get(10));
      /* Termina nodo:10   */

      /* Empieza nodo:11 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(11)).setAttribute("name","cbActividadDeOrigen" );
      ((Element)v.get(11)).setAttribute("required","true" );
      ((Element)v.get(11)).setAttribute("cod","155" );
      ((Element)v.get(11)).setAttribute("group","grupoRefOtrCamp" );
      ((Element)v.get(4)).appendChild((Element)v.get(11));
      /* Termina nodo:11   */

      /* Empieza nodo:12 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(12)).setAttribute("name","txtDiasDeDesplazamiento" );
      ((Element)v.get(12)).setAttribute("required","true" );
      ((Element)v.get(12)).setAttribute("cod","250" );
      ((Element)v.get(12)).setAttribute("group","grupoRefOtrCamp" );
      ((Element)v.get(4)).appendChild((Element)v.get(12));
      /* Termina nodo:12   */

      /* Empieza nodo:13 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(13)).setAttribute("name","txtCampDesp" );
      ((Element)v.get(13)).setAttribute("required","true" );
      ((Element)v.get(13)).setAttribute("cod","3206" );
      ((Element)v.get(13)).setAttribute("group","grupoRefOtrCamp" );
      ((Element)v.get(4)).appendChild((Element)v.get(13));
      /* Termina nodo:13   */

      /* Empieza nodo:14 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(14)).setAttribute("name","txtCampDesp" );
      ((Element)v.get(14)).setAttribute("required","false" );
      ((Element)v.get(14)).setAttribute("cod","3206" );
      ((Element)v.get(14)).setAttribute("format","t" );
      ((Element)v.get(14)).setAttribute("chars","1-9\\-" );
      ((Element)v.get(14)).setAttribute("min","0" );
      ((Element)v.get(14)).setAttribute("max","3" );
      ((Element)v.get(14)).setAttribute("group","grupoRefOtrCamp" );
      ((Element)v.get(4)).appendChild((Element)v.get(14));
      /* Termina nodo:14   */

      /* Empieza nodo:15 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(15)).setAttribute("name","txtCadaCuantosDias" );
      ((Element)v.get(15)).setAttribute("required","false" );
      ((Element)v.get(15)).setAttribute("cod","1047" );
      ((Element)v.get(4)).appendChild((Element)v.get(15));
      /* Termina nodo:15   */

      /* Empieza nodo:16 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(16)).setAttribute("name","txtFechaFinal" );
   }

   private void getXML90(Document doc) {
      ((Element)v.get(16)).setAttribute("required","false" );
      ((Element)v.get(16)).setAttribute("cod","193" );
      ...
      ((Element)v.get(17)).setAttribute("nombre","frmModificarActividad" );
      ((Element)v.get(17)).setAttribute("oculto","S" );
      ((Element)v.get(0)).appendChild((Element)v.get(17));

      /* Empieza nodo:18 / Elemento padre: 17   */
      v.add(doc.createElement("VAR"));
      ((Element)v.get(18)).setAttribute("nombre","varModo" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(19)).setAttribute("nombre","varTipo" );
      ...
      ((Element)v.get(21)).setAttribute("valor","LPMantieneMatrizDias" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(24)).setAttribute("nombre","hIdioma" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(25)).setAttribute("nombre","hPais" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(26)).setAttribute("nombre","hPaisDescripcion" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(27)).setAttribute("nombre","hMarca" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(28)).setAttribute("nombre","hCanal" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(29)).setAttribute("nombre","hVarActividad" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(30)).setAttribute("nombre","hVarGrupo" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(31)).setAttribute("nombre","hIdVistaActividad" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(32)).setAttribute("nombre","hTextoActividad" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(33)).setAttribute("nombre","hOrigen" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(34)).setAttribute("nombre","hTipoActividad" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(35)).setAttribute("nombre","hDiasDesplazamiento" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(36)).setAttribute("nombre","hRepetitiva" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(37)).setAttribute("nombre","hCadaDias" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(38)).setAttribute("nombre","hDiasFinal" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(39)).setAttribute("nombre","hMover" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(40)).setAttribute("nombre","hVarClaseActividad" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(41)).setAttribute("nombre","hVarCteActividadFacturacion" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(42)).setAttribute("nombre","hCmbTipoActividad" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(43)).setAttribute("nombre","hCampDesp" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(44)).setAttribute("nombre","hTextoActOrigen" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(45)).setAttribute("nombre","hEstadoChkRepetitivaEnabled" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(46)).setAttribute("nombre","hEstadoTxtCadaDia" );
      ...
      ((Element)v.get(47)).setAttribute("nombre","capaBusqueda" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(71)).setAttribute("nombre","lblGruposDeZonas" );
      ...
      ((Element)v.get(71)).setAttribute("cod","180" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(78)).setAttribute("nombre","lblValorGrupoDeZonas" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(89)).setAttribute("nombre","lblTipoActividad" );
      ...
      ((Element)v.get(89)).setAttribute("cod","152" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(93)).setAttribute("nombre","lblActividadDeOrigen" );
      ...
      ((Element)v.get(93)).setAttribute("cod","155" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(97)).setAttribute("nombre","lblDiasDeDesplazamiento" );
      ...
      ((Element)v.get(97)).setAttribute("cod","250" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(101)).setAttribute("nombre","lbl_campDesp" );
      ...
      ((Element)v.get(101)).setAttribute("cod","3206" );
   ...
   private void getXML450(Document doc) {
      ((Element)v.get(108)).setAttribute("nombre","cbTipoActividad" );
      ...
      ((Element)v.get(108)).setAttribute("onchange","onChangeTipoActividad();" );
      ((Element)v.get(108)).setAttribute("onshtab","focalizaShiftTab();" );
      ...
      ((Element)v.get(110)).setAttribute("ID","1" );
      ...
      ((Element)v.get(112)).setAttribute("VALOR","Fija" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(116)).setAttribute("nombre","cbActividadDeOrigen" );
      ...
      ((Element)v.get(121)).setAttribute("nombre","txtDiasDeDesplazamiento" );
      ...
      ((Element)v.get(121)).setAttribute("onblur","saleDe('txtDiasDeDesplazamiento');" );
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(125)).setAttribute("nombre","txtCampDesp" );
   ...
   private void getXML540(Document doc) {
      ((Element)v.get(125)).setAttribute("onblur","saleDe('txtCampDesp');" );
      ...
      /* Empieza nodo:128 / Elemento padre: 60   */
      v.add(doc.createElement("table"));
      ...
      ((Element)v.get(60)).appendChild((Element)v.get(128));
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(136)).setAttribute("nombre","lblRepetitiva" );
      ...
      ((Element)v.get(136)).setAttribute("cod","330" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(140)).setAttribute("nombre","lblCadaCuantosDias" );
      ...
      ((Element)v.get(140)).setAttribute("cod","1047" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(144)).setAttribute("nombre","lblFechaFinal" );
      ...
      ((Element)v.get(144)).setAttribute("cod","193" );
   ...
   private void getXML630(Document doc) {
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(148)).setAttribute("nombre","lblMoverActividadesOrigen" );
      ...
      ((Element)v.get(148)).setAttribute("cod","1046" );
      ...
      ((Element)v.get(155)).setAttribute("nombre","chkRepetitiva" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(163)).setAttribute("nombre","lblDias" );
      ...
      ((Element)v.get(163)).setAttribute("cod","163" );
   ...
   private void getXML720(Document doc) {
      ...
      ((Element)v.get(171)).setAttribute("nombre","rbMoverActividadesOrigen" );
      ((Element)v.get(171)).setAttribute("tipo","H" );
      ((Element)v.get(171)).setAttribute("req","N" );
      ((Element)v.get(171)).setAttribute("ontab","focalizaTab();" );
      ((Element)v.get(170)).appendChild((Element)v.get(171));

      /* Empieza nodo:172 / Elemento padre: 171   */
      v.add(doc.createElement("RBINPUT"));
      ((Element)v.get(172)).setAttribute("valor","S" );
      ((Element)v.get(172)).setAttribute("check","S" );
      ((Element)v.get(172)).setAttribute("class","datosCampos" );
      ((Element)v.get(172)).setAttribute("onfocus","" );
      ((Element)v.get(172)).setAttribute("cod","117" );
      ...
      /* Empieza nodo:178 / Elemento padre: 128   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(128)).appendChild((Element)v.get(178));
      ...
      /* Empieza nodo:181 / Elemento padre: 56   */
      v.add(doc.createElement("td"));
      ((Element)v.get(56)).appendChild((Element)v.get(181));
