...
/*
    INDRA/CAR/mmg
    $Id: PedSubtiPosicViewListFormatter.java,v 1.1 2009/12/03 18:43:04 pecbazalar Exp $
    DESC
*/
 ...
 * @author Indra
 */
public class PedSubtiPosicViewListFormatter extends MMGDruidaFormatoObjeto {
	
	public PedSubtiPosicViewListFormatter() {
	}
	...
	public void formatea(String s, Object obj) throws Exception {
		...
		for (int i = 0; i < pedSubtiPosicViewList.size(); i++) {
			...
			row.add((pedSubtiPosicViewData.getCodSubtPosi() != null ? 
				...
				symbols) : ""));
			row.add((pedSubtiPosicViewData.getTposOidTipoPosi() != null ? 
				FormatUtils.formatObject(pedSubtiPosicViewData.getTposOidTipoPosi(), 
				 MMGDruidaHelper.getUserDecimalFormatPattern(this), 
				symbols) : ""));
