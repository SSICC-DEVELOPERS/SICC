/*
    INDRA/CAR/mmg
    $Id: RecModoAbonoDefecLPStartUp.java,v 1.1 2009/12/03 18:33:46 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class RecModoAbonoDefecLPStartUp extends MMGDruidaBase{
	...
	public RecModoAbonoDefecLPStartUp(){
		super();
	}

	public void inicio() throws Exception {
		pagina("RecModoAbonoDefecPage");
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			buildJsPageSize("RecModoAbonoDefec");
			...
			asignarAtributo("PAGINA", "RecModoAbonoDefecPage", "cod", "RecModoAbonoDefec." + accion + ".label");
			...
			limpiarBotoneraLista("recModoAbonoDefec", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codModoAbon", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 1);");
		
		//Primero determianmos el nombre del campo en la entidad de oriegen donde se van a cargar los datos
		asignar("VAR", "idAttributeLovOpener", conectorParametro(PARAMETRO_LOV_ATTRIBUTO));
		asignar("VAR", "idEntityLovOpener", conectorParametro(PARAMETRO_LOV_ENTIDAD));
		//asignarAtributo("CAPA", "recModoAbonoDefecLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "RecModoAbonoDefecPage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("RecModoAbonoDefecLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		RecModoAbonoDefecData recModoAbonoDefecQuery= new RecModoAbonoDefecData();
		recModoAbonoDefecQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		RecModoAbonoDefecData datosResult = (RecModoAbonoDefecData)getSingleObject(BUSINESSID_QUERY, recModoAbonoDefecQuery, 
			recModoAbonoDefecQuery.clone(), "recModoAbonoDefec");
		...
		RecModoAbonoDefecData recModoAbonoDefec = datosResult;
		asignar("TEXT", "codModoAbon", FormatUtils.formatObject(recModoAbonoDefec.getCodModoAbon(), 
		...
		asignarAtributo("TEXT", "codModoAbon", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		...
		asignarAtributo("TEXT", "codModoAbon", "req", "S");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "recModoAbonoDefecFrm", "oculto", "N");
		...
		traza("MMG::Creando RecModoAbonoDefec");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		RecModoAbonoDefecData recModoAbonoDefecQuery= new RecModoAbonoDefecData();
		recModoAbonoDefecQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(recModoAbonoDefec.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"recModoAbonoDefecFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"recModoAbonoDefecFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codModoAbon", "ontab","ejecutarAccionFocoModificacion(\"recModoAbonoDefecFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codModoAbon", "onshtab","ejecutarAccionFocoModificacion(\"recModoAbonoDefecFrm\",2, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","recModoAbonoDefecTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","recModoAbonoDefecTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codModoAbon...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","recModoAbonoDefecFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","recModoAbonoDefecListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","recModoAbonoDefecListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(RecModoAbonoDefecData recModoAbonoDefec) throws Exception{
	...
	* @param recModoAbonoDefec La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(RecModoAbonoDefecData recModoAbonoDefec) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		RecModoAbonoDefecData recModoAbonoDefec = 
			(RecModoAbonoDefecData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(recModoAbonoDefec);
		loadLeafDependenceCombos(recModoAbonoDefec);
	}
