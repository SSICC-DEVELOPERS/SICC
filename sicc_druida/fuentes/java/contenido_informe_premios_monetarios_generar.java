...
public class contenido_informe_premios_monetarios_generar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_informe_premios_monetarios_generar" );
      ((Element)v.get(0)).setAttribute("cod","0889" );
      ((Element)v.get(0)).setAttribute("titulo","Generar Informe Relación de Consultoras con premios Monetarios" );
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(10)).setAttribute("name","cbZona" );
      ((Element)v.get(10)).setAttribute("required","true" );
      ((Element)v.get(10)).setAttribute("cod","143" );
      ((Element)v.get(6)).appendChild((Element)v.get(10));
      /* Termina nodo:10   */

      /* Empieza nodo:11 / Elemento padre: 6   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(11)).setAttribute("name","cbMoneda" );
      ((Element)v.get(11)).setAttribute("required","true" );
      ((Element)v.get(11)).setAttribute("cod","1216" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(55)).setAttribute("onchange","onchangeMarcaCanalPais();" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(106)).setAttribute("nombre","cbSubgerenciaVenta" );
      ...
      ((Element)v.get(106)).setAttribute("onchange","cambioSubgerencia();" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(131)).setAttribute("onchange","cambioRegion();" );
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(154)).setAttribute("nombre","lblNumConcurso" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(161)).setAttribute("nombre","cbMoneda" );
   ...
   private void getXML630(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(166)).setAttribute("nombre","cbNumConcurso" );
      ...
      /* Empieza nodo:173 / Elemento padre: 30   */
      v.add(doc.createElement("td"));
      ((Element)v.get(30)).appendChild((Element)v.get(173));
      ...
      /* Empieza nodo:175 / Elemento padre: 22   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(22)).appendChild((Element)v.get(175));
      ...
      ((Element)v.get(183)).setAttribute("nombre","btnGenerarInforme" );
      ((Element)v.get(183)).setAttribute("ID","botonContenido" );
      ((Element)v.get(183)).setAttribute("tipo","html" );
      ((Element)v.get(183)).setAttribute("accion","generar('pdf')" );
      ((Element)v.get(183)).setAttribute("estado","false" );
      ((Element)v.get(183)).setAttribute("cod","2495" );
      ((Element)v.get(182)).appendChild((Element)v.get(183));
      /* Termina nodo:183   */

      /* Empieza nodo:184 / Elemento padre: 182   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(184)).setAttribute("nombre","btnGenerarExcel" );
      ((Element)v.get(184)).setAttribute("ID","botonContenido" );
      ((Element)v.get(184)).setAttribute("tipo","html" );
      ((Element)v.get(184)).setAttribute("accion","generar('xls')" );
      ((Element)v.get(184)).setAttribute("estado","false" );
      ((Element)v.get(184)).setAttribute("cod","2526" );
      ((Element)v.get(184)).setAttribute("ontab","focaliza('Formulario.cbPais')" );
   ...
   private void getXML720(Document doc) {
      ...
      /* Empieza nodo:187 / Elemento padre: 22   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(22)).appendChild((Element)v.get(187));
