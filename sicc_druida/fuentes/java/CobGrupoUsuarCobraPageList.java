...
public class CobGrupoUsuarCobraPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","cobGrupoUsuarCobraList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","CobGrupoUsuarCobra.codGrupUsua.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","CobGrupoUsuarCobra.valDesc.label" );
