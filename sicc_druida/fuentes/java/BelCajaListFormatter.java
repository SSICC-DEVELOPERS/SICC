...
/*
    INDRA/CAR/mmg
    $Id: BelCajaListFormatter.java,v 1.1 2009/12/03 18:34:12 pecbazalar Exp $
    DESC
*/
 ...
 * @author Indra
 */
public class BelCajaListFormatter extends MMGDruidaFormatoObjeto {
	
	public BelCajaListFormatter() {
	}
	...
	public void formatea(String s, Object obj) throws Exception {
		...
		for (int i = 0; i < belCajaList.size(); i++) {
			...
			row.add((belCajaData.getSbacOidSbac() != null ? 
				FormatUtils.formatObject(belCajaData.getSbacOidSbac(), 
			...
			row.add((belCajaData.getCodCaja() != null ? 
				FormatUtils.formatObject(belCajaData.getCodCaja(), 
				 MMGDruidaHelper.getUserDecimalFormatPattern(this), 
				symbols) : ""));
			row.add((belCajaData.getUserOidUser() != null ? 
				FormatUtils.formatObject(belCajaData.getUserOidUser(), 
				 MMGDruidaHelper.getUserDecimalFormatPattern(this), 
				symbols) : ""));
