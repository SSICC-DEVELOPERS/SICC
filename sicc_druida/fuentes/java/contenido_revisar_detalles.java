...
public class contenido_revisar_detalles  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_revisar_detalles" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","contenido_revisar_detalles.js" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(15)).setAttribute("nombre","datosLista" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(31)).setAttribute("nombre","lblRevisarDetalles" );
      ((Element)v.get(31)).setAttribute("alto","13" );
      ((Element)v.get(31)).setAttribute("filas","1" );
      ((Element)v.get(31)).setAttribute("cod","3157" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(40)).setAttribute("nombre","lblDescripcionProducto" );
      ...
      ((Element)v.get(40)).setAttribute("cod","3147" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(58)).setAttribute("nombre","lblUnidSolicitadas" );
      ...
      ((Element)v.get(58)).setAttribute("cod","1014" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(62)).setAttribute("nombre","UnidSolicitadas" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(76)).setAttribute("nombre","lblUnidEnCaja" );
      ...
      ((Element)v.get(76)).setAttribute("cod","3148" );
      ...
      ((Element)v.get(80)).setAttribute("nombre","txtUnidEnCaja" );
      ((Element)v.get(80)).setAttribute("id","datosCampos" );
      ((Element)v.get(80)).setAttribute("max","5" );
      ...
      ((Element)v.get(80)).setAttribute("ontab","onTABUnidadesCaja();" );
      ((Element)v.get(80)).setAttribute("onshtab","onSHTABUnidadesCaja();" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(94)).setAttribute("nombre","lblObservaciones" );
      ...
      ((Element)v.get(94)).setAttribute("cod","AppRutasTrans.valObse.label" );
      ...
      ((Element)v.get(101)).setAttribute("nombre","Observaciones" );
      ((Element)v.get(101)).setAttribute("readOnly","N" );
      ((Element)v.get(101)).setAttribute("req","N" );
      ((Element)v.get(101)).setAttribute("rows","3" );
      ((Element)v.get(101)).setAttribute("tabindex","" );
      ((Element)v.get(101)).setAttribute("valor","" );
      ((Element)v.get(101)).setAttribute("max","100" );
      ((Element)v.get(101)).setAttribute("ontab","onTABObservaciones();" );
      ((Element)v.get(101)).setAttribute("onshtab","onSHTABObservaciones();" );
      ...
      /* Empieza nodo:107 / Elemento padre: 28   */
      v.add(doc.createElement("fieldset"));
      ((Element)v.get(28)).appendChild((Element)v.get(107));
      ...
      ((Element)v.get(111)).setAttribute("nombre","btnAceptar" );
      ((Element)v.get(111)).setAttribute("ID","botonContenido" );
      ((Element)v.get(111)).setAttribute("tipo","html" );
      ((Element)v.get(111)).setAttribute("accion","onClickAceptar();" );
      ((Element)v.get(111)).setAttribute("estado","false" );
      ((Element)v.get(111)).setAttribute("cod","MMGGlobal.localization.bindbutton.label" );
      ((Element)v.get(111)).setAttribute("ontab","onTABBotonAceptar();" );
      ((Element)v.get(111)).setAttribute("onshtab","onSHTABBotonAceptar();" );
