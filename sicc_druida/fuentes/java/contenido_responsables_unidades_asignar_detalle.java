...
public class contenido_responsables_unidades_asignar_detalle  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_responsables_unidades_asigna_detaller" );
      ((Element)v.get(0)).setAttribute("cod","0944" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(2)).setAttribute("src","contenido_responsables_unidades_asignar_detalle.js" );
      ...
      ((Element)v.get(10)).setAttribute("align","center" );
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(12)).setAttribute("width","750" );
      ...
      ((Element)v.get(15)).setAttribute("height","1" );
      ...
      ((Element)v.get(21)).setAttribute("class","legend" );
      ((Element)v.get(20)).appendChild((Element)v.get(21));

      /* Empieza nodo:22 / Elemento padre: 21   */
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(22)).setAttribute("nombre","lblDatosAsociados" );
      ((Element)v.get(22)).setAttribute("alto","13" );
      ((Element)v.get(22)).setAttribute("filas","1" );
      ((Element)v.get(22)).setAttribute("valor","" );
      ((Element)v.get(22)).setAttribute("cod","00364" );
      ((Element)v.get(22)).setAttribute("id","legend" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(31)).setAttribute("nombre","lblTipoCliente" );
      ...
      ((Element)v.get(31)).setAttribute("cod","0068" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(35)).setAttribute("nombre","lblSubtipoCliente" );
      ...
      ((Element)v.get(35)).setAttribute("cod","00240" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(42)).setAttribute("nombre","lbldtTipoCliente" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(46)).setAttribute("nombre","lbldtSubtipoCliente" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(57)).setAttribute("nombre","lblTipoClasificacion" );
      ...
      ((Element)v.get(57)).setAttribute("cod","00242" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(61)).setAttribute("nombre","lblClasificacion" );
      ...
      ((Element)v.get(61)).setAttribute("cod","00241" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(68)).setAttribute("nombre","lbldtTipoClasificacion" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(72)).setAttribute("nombre","lbldtClasificacion" );
      ...
      /* Empieza nodo:78 / Elemento padre: 16   */
      v.add(doc.createElement("td"));
      ((Element)v.get(16)).appendChild((Element)v.get(78));
