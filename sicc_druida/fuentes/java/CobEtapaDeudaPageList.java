...
public class CobEtapaDeudaPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","cobEtapaDeudaList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","CobEtapaDeuda.codEtapDeud.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","CobEtapaDeuda.valDesc.label" );
      ...
      ((Element)v.get(17)).setAttribute("cod","CobEtapaDeuda.valEdadInic.label" );
      ...
      ((Element)v.get(18)).setAttribute("cod","CobEtapaDeuda.valEdadFina.label" );
