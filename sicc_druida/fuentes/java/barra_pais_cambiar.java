...
public class barra_pais_cambiar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","barra_pais_cambiar" );
      ...
      v.add(doc.createTextNode("\r         return false;\r\r"));
      ...
      ((Element)v.get(14)).setAttribute("codi","" );
      ((Element)v.get(14)).setAttribute("valor","Cambiar País" );
      ...
      ((Element)v.get(17)).setAttribute("funcion","APP_CONTENIDO.insertar()" );
      ((Element)v.get(17)).setAttribute("off","iconGuardarOff.gif" );
      ((Element)v.get(17)).setAttribute("on","iconGuardarOff.gif" );
