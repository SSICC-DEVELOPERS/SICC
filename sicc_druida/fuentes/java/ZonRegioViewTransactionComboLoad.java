...
/*
    INDRA/CAR/mmg
    $Id: ZonRegioViewTransactionComboLoad.java,v 1.1 2009/12/03 18:33:34 pecbazalar Exp $
    DESC
*/
...
public class ZonRegioViewTransactionComboLoad extends MMGDruidaTransaction {
	//Constantes usadas en la clase. Simplemente representan 
	//los nombre de conectore y de logicas de negocio
	public static final String BUSINESSID_QUERY = "MMGZonRegioViewQueryFromToUserStructuralSecurity";
	public static final String CONECTOR_QUERY_COMBO= "ZonRegioViewConectorCombo";

	// Definicion del constructor
	public ZonRegioViewTransactionComboLoad(){
		super();
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			dto.addProperty("zonRegioViewFrom", zonRegioView);
			dto.addProperty("zonRegioViewTo", zonRegioView.clone());
