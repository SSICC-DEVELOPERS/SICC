...
public class FacTipoDocumPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","FacTipoDocum.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","FacTipoDocum.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('facTipoDocumFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('facTipoDocumFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(50)).setAttribute("nombre","codTipoDocuTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lblCodTipoDocu" );
      ((Element)v.get(54)).setAttribute("alto","13" );
      ((Element)v.get(54)).setAttribute("filas","1" );
      ((Element)v.get(54)).setAttribute("id","datosTitle" );
      ((Element)v.get(54)).setAttribute("cod","FacTipoDocum.codTipoDocu.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(55)).setAttribute("nombre","codTipoDocuWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(57)).setAttribute("nombre","codTipoDocu" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('facTipoDocumFrm',2, true)" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('facTipoDocumFrm', 2, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(58)).setAttribute("nombre","codTipoDocuGapTdId" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(75)).setAttribute("nombre","desTipoDocuTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(80)).setAttribute("nombre","desTipoDocuWidgetTrId" );
   }
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(82)).setAttribute("ontab","ejecutarAccionFoco('facTipoDocumFrm',3, true)" );
      ((Element)v.get(82)).setAttribute("onshtab","ejecutarAccionFoco('facTipoDocumFrm', 3, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(83)).setAttribute("nombre","desTipoDocuGapTdId" );
      ...
      /* Empieza nodo:97 / Elemento padre: 0   */
      v.add(doc.createElement("TR"));
      ((Element)v.get(97)).setAttribute("nombre","facTipoDocumTrButtons" );
      ((Element)v.get(0)).appendChild((Element)v.get(97));
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(104)).setAttribute("nombre","facTipoDocumTdQueryButton" );
      ((Element)v.get(103)).appendChild((Element)v.get(104));

      /* Empieza nodo:105 / Elemento padre: 104   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(105)).setAttribute("nombre","facTipoDocumQueryButton" );
      ((Element)v.get(105)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(105)).setAttribute("estado","false" );
      ((Element)v.get(105)).setAttribute("accion","facTipoDocumFirstPage();" );
      ...
      ((Element)v.get(106)).setAttribute("nombre","facTipoDocumTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(108)).setAttribute("nombre","facTipoDocumLovNullButton" );
      ((Element)v.get(108)).setAttribute("ID","botonContenido" );
      ((Element)v.get(108)).setAttribute("tipo","html" );
      ((Element)v.get(108)).setAttribute("accion","facTipoDocumLovNullSelectionAction();" );
      ((Element)v.get(108)).setAttribute("estado","true" );
      ((Element)v.get(108)).setAttribute("cod","MMGGlobal.lovNullButton.label" );
