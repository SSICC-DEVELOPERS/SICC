...
public class contenido_informe_consultoras_detalle_generar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_informe_consultoras_detalle_generar" );
      ((Element)v.get(0)).setAttribute("cod","0870" );
      ((Element)v.get(0)).setAttribute("titulo","Generar informe consultoras que recomiendan detalle" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(53)).setAttribute("nombre","cbPais" );
      ...
      ((Element)v.get(53)).setAttribute("onshtab","focalizaBotonHTML('botonContenido','btnGenerarInforme');" );
      ((Element)v.get(53)).setAttribute("onchange","cambioPais()" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(108)).setAttribute("onchange","cambioSGV()" );
      ...
      ((Element)v.get(113)).setAttribute("onchange","cambioRegion()" );
   ...
   private void getXML450(Document doc) {
      ...
      /* Empieza nodo:120 / Elemento padre: 35   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(35)).appendChild((Element)v.get(120));
      ...
      /* Empieza nodo:141 / Elemento padre: 35   */
      v.add(doc.createElement("tr"));
   }

   private void getXML540(Document doc) {
      ((Element)v.get(35)).appendChild((Element)v.get(141));
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(163)).setAttribute("nombre","cbUnidadNegocio" );
   ...
   private void getXML630(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(168)).setAttribute("nombre","cbNegocio" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(173)).setAttribute("nombre","cbNumConcurso" );
      ((Element)v.get(173)).setAttribute("size","5" );
      ((Element)v.get(173)).setAttribute("multiple","S" );
      ...
      /* Empieza nodo:180 / Elemento padre: 28   */
      v.add(doc.createElement("td"));
      ((Element)v.get(28)).appendChild((Element)v.get(180));
      ...
      /* Empieza nodo:182 / Elemento padre: 20   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(20)).appendChild((Element)v.get(182));
   ...
   private void getXML720(Document doc) {
      ((Element)v.get(190)).setAttribute("nombre","btnGenerarInforme" );
      ((Element)v.get(190)).setAttribute("ID","botonContenido" );
      ((Element)v.get(190)).setAttribute("tipo","html" );
      ((Element)v.get(190)).setAttribute("accion","generar('pdf')" );
      ((Element)v.get(190)).setAttribute("estado","false" );
      ((Element)v.get(190)).setAttribute("cod","2495" );
      ((Element)v.get(190)).setAttribute("ontab","focaliza('Formulario.cbPais')" );
      ...
      /* Empieza nodo:193 / Elemento padre: 20   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(20)).appendChild((Element)v.get(193));
