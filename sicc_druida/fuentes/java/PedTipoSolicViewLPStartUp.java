/*
    INDRA/CAR/mmg
    $Id: PedTipoSolicViewLPStartUp.java,v 1.1 2009/12/03 18:32:57 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class PedTipoSolicViewLPStartUp extends MMGDruidaBase{
	//Constantes que definen la altura de los formularios según el modo
	public static final short QUERYFORM_SIZE = 315;
	public static final short CREATEFORM_SIZE = 355;
	public static final short UPDATEFORM_SIZE = 355;
	public static final short VIEWFORM_SIZE = 355;
	...
	public PedTipoSolicViewLPStartUp(){
		super();
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			buildJsPageSize("PedTipoSolicView");
			...
			asignarAtributo("PAGINA", "PedTipoSolicViewPage", "cod", "PedTipoSolicView." + accion + ".label");
			...
			limpiarBotoneraLista("pedTipoSolicView", accion);
	...
	protected void cmdLov() throws Exception{
		...
		//asignarAtributo("CAPA", "pedTipoSolicViewLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "PedTipoSolicViewPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		PedTipoSolicViewData pedTipoSolicViewQuery= new PedTipoSolicViewData();
		pedTipoSolicViewQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		PedTipoSolicViewData datosResult = (PedTipoSolicViewData)getSingleObject(BUSINESSID_QUERY, pedTipoSolicViewQuery, 
			pedTipoSolicViewQuery.clone(), "pedTipoSolicView");
		...
		preservaHiddensI18n(new Integer(1), "PED_TIPO_SOLIC", "pedTipoSolicViewFrm", "Descripcion", true);
		...
		PedTipoSolicViewData pedTipoSolicView = datosResult;
		asignar("TEXT", "codTipoSoli", FormatUtils.formatObject(pedTipoSolicView.getCodTipoSoli(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "indCons", FormatUtils.formatObject(pedTipoSolicView.getIndCons(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "indSoliNega", FormatUtils.formatObject(pedTipoSolicView.getIndSoliNega(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "indDevo", FormatUtils.formatObject(pedTipoSolicView.getIndDevo(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "indAnul", FormatUtils.formatObject(pedTipoSolicView.getIndAnul(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "codGrupSoli", FormatUtils.formatObject(pedTipoSolicView.getCodGrupSoli(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "Descripcion", FormatUtils.formatObject(pedTipoSolicView.getDescripcion(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		loadLocalizationVars(pedTipoSolicView);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "codTipoSoli", "disabled", "S");
		asignarAtributo("TEXT", "indCons", "disabled", "S");
		asignarAtributo("TEXT", "indSoliNega", "disabled", "S");
		asignarAtributo("TEXT", "indDevo", "disabled", "S");
		asignarAtributo("TEXT", "indAnul", "disabled", "S");
		asignarAtributo("TEXT", "codGrupSoli", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "PED_TIPO_SOLIC", "pedTipoSolicViewFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('pedTipoSolicViewFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "pedTipoSolicViewFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		PedTipoSolicViewData pedTipoSolicViewQuery= new PedTipoSolicViewData();
		pedTipoSolicViewQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(pedTipoSolicView.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"pedTipoSolicViewFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"pedTipoSolicViewFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codTipoSoli", "ontab","ejecutarAccionFocoModificacion(\"pedTipoSolicViewFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codTipoSoli", "onshtab","ejecutarAccionFocoModificacion(\"pedTipoSolicViewFrm\",2, false)");
				asignarAtributo("AREATEXTO", "indCons", "ontab","ejecutarAccionFocoModificacion(\"pedTipoSolicViewFrm\",7, true)");
				asignarAtributo("AREATEXTO", "indCons", "onshtab","ejecutarAccionFocoModificacion(\"pedTipoSolicViewFrm\",7, false)");
				asignarAtributo("AREATEXTO", "indSoliNega", "ontab","ejecutarAccionFocoModificacion(\"pedTipoSolicViewFrm\",8, true)");
				asignarAtributo("AREATEXTO", "indSoliNega", "onshtab","ejecutarAccionFocoModificacion(\"pedTipoSolicViewFrm\",8, false)");
				asignarAtributo("AREATEXTO", "indDevo", "ontab","ejecutarAccionFocoModificacion(\"pedTipoSolicViewFrm\",10, true)");
				asignarAtributo("AREATEXTO", "indDevo", "onshtab","ejecutarAccionFocoModificacion(\"pedTipoSolicViewFrm\",10, false)");
				asignarAtributo("AREATEXTO", "indAnul", "ontab","ejecutarAccionFocoModificacion(\"pedTipoSolicViewFrm\",11, true)");
				asignarAtributo("AREATEXTO", "indAnul", "onshtab","ejecutarAccionFocoModificacion(\"pedTipoSolicViewFrm\",11, false)");
				asignarAtributo("AREATEXTO", "codGrupSoli", "ontab","ejecutarAccionFocoModificacion(\"pedTipoSolicViewFrm\",13, true)");
				asignarAtributo("AREATEXTO", "codGrupSoli", "onshtab","ejecutarAccionFocoModificacion(\"pedTipoSolicViewFrm\",13, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"pedTipoSolicViewFrm\",14, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"pedTipoSolicViewFrm\",14, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","pedTipoSolicViewTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","pedTipoSolicViewTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","pedTipoSolicViewFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","pedTipoSolicViewListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","pedTipoSolicViewListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(PedTipoSolicViewData pedTipoSolicView) throws Exception{
	...
	* @param pedTipoSolicView La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(PedTipoSolicViewData pedTipoSolicView) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		PedTipoSolicViewData pedTipoSolicView = 
			(PedTipoSolicViewData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(pedTipoSolicView);
		loadLeafDependenceCombos(pedTipoSolicView);
	}
	...
	*/
	...
	protected void loadLocalizationVars(PedTipoSolicViewData pedTipoSolicView) throws Exception{
		...
		mmgLocalizationQuery.setEntiPk(pedTipoSolicView.getId());
