/*
    INDRA/CAR/mmg
    $Id: CalTipoGestiClienLPStartUp.java,v 1.1 2009/12/03 18:43:15 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class CalTipoGestiClienLPStartUp extends MMGDruidaBase{
	...
	public static final String BUSINESSID_QUERY = "MMGCalTipoGestiClienQueryFromToUserPage";
	...
	public CalTipoGestiClienLPStartUp(){
		super();
	}

	public void inicio() throws Exception {
		pagina("CalTipoGestiClienPage");
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			buildJsPageSize("CalTipoGestiClien");
			...
			asignarAtributo("PAGINA", "CalTipoGestiClienPage", "cod", "CalTipoGestiClien." + accion + ".label");
			...
			limpiarBotoneraLista("calTipoGestiClien", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codGest", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 2);");
		...
		//asignarAtributo("CAPA", "calTipoGestiClienLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "CalTipoGestiClienPage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("CalTipoGestiClienLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		CalTipoGestiClienData calTipoGestiClienQuery= new CalTipoGestiClienData();
		calTipoGestiClienQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		CalTipoGestiClienData datosResult = (CalTipoGestiClienData)getSingleObject(BUSINESSID_QUERY, calTipoGestiClienQuery, 
			calTipoGestiClienQuery.clone(), "calTipoGestiClien");
		...
		preservaHiddensI18n(new Integer(1), "CAL_TIPO_GESTI_CLIEN", "calTipoGestiClienFrm", "Descripcion", true);
		...
		CalTipoGestiClienData calTipoGestiClien = datosResult;
		asignar("TEXT", "codGest", FormatUtils.formatObject(calTipoGestiClien.getCodGest(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "Descripcion", FormatUtils.formatObject(calTipoGestiClien.getDescripcion(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		loadLocalizationVars(calTipoGestiClien);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "codGest", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "CAL_TIPO_GESTI_CLIEN", "calTipoGestiClienFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "codGest", "req", "S");
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('calTipoGestiClienFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "calTipoGestiClienFrm", "oculto", "N");
		...
		traza("MMG::Creando CalTipoGestiClien");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		CalTipoGestiClienData calTipoGestiClienQuery= new CalTipoGestiClienData();
		calTipoGestiClienQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(calTipoGestiClien.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"calTipoGestiClienFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"calTipoGestiClienFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codGest", "ontab","ejecutarAccionFocoModificacion(\"calTipoGestiClienFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codGest", "onshtab","ejecutarAccionFocoModificacion(\"calTipoGestiClienFrm\",2, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"calTipoGestiClienFrm\",3, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"calTipoGestiClienFrm\",3, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","calTipoGestiClienTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","calTipoGestiClienTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codGest...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","calTipoGestiClienFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","calTipoGestiClienListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","calTipoGestiClienListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(CalTipoGestiClienData calTipoGestiClien) throws Exception{
	...
	* @param calTipoGestiClien La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(CalTipoGestiClienData calTipoGestiClien) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		CalTipoGestiClienData calTipoGestiClien = 
			(CalTipoGestiClienData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(calTipoGestiClien);
		loadLeafDependenceCombos(calTipoGestiClien);
	}
	...
	*/
	...
	protected void loadLocalizationVars(CalTipoGestiClienData calTipoGestiClien) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("CAL_TIPO_GESTI_CLIEN");
		mmgLocalizationQuery.setEntiPk(calTipoGestiClien.getId());
