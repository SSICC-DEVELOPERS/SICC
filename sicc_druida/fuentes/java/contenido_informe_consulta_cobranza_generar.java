...
public class contenido_informe_consulta_cobranza_generar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_informe_consulta_cobranza_generar" );
      ((Element)v.get(0)).setAttribute("cod","0819" );
      ((Element)v.get(0)).setAttribute("titulo","Generar informe consulta de cobranza" );
      ...
      v.add(doc.createTextNode("\r   \r   \r   function onLoad(){\r      configurarMenuSecundario('Formulario');\r      fMostrarMensajeError();\r      focaliza('Formulario.txtCodCliente');\r   }\r   function generar(formato){\r      if(sicc_validaciones_generales()){\r        /*recolectarParametros();\r        set('Formulario.conectorAction', 'COBConsultaCobranza');            \r        set('Formulario.accion', 'generar');\r        enviaSICC('Formulario');*/\r        var a = new Object();\r        a.accion = 'generar';\r        a.codigoCliente = get('Formulario.txtCodCliente');\r        a.camposBusqueda = get('Formulario.cbCamposBusqueda');          \r        mostrarModalSICC('COBConsultaCobranza','generar', a);  \r      }      \r   }\r\r\r\r   function recolectarParametros(){\r            \r      set('Formulario.codigoCliente', get('Formulario.txtCodCliente'));\r      set('Formulario.camposBusqueda', get('Formulario.cbCamposBusqueda'));      \r\r   }\r \r    \r\r   function fLimpiar(){\r      focaliza('Formulario.txtCodCliente');\r   }\r\r\r   function buscarCliente(){ \r      var obj = new Object();\r\r      var whnd = mostrarModalSICC('LPBusquedaRapidaCliente','',obj);\r    \r      if(whnd==null){\r                 }else{\r           var cod = whnd[1];\r                      set('Formulario.txtCodCliente', cod)\r      }           \r   }\r   \r\r  function clienteOnBlur() {\r\r          var longiCod = get('Formulario.hLongCliente');\r          var elTexto  = get('Formulario.txtCodCliente');\r\r          if(elTexto.length!=0){\r             var faltantes = longiCod -  elTexto.length;\r             var resultCod = new String(\"\");\r             if(faltantes > 0){\r                  for(var t = 0 ; t<faltantes; t++){\r                      resultCod = resultCod + \"0\";\r                  }\r           }\r           resultCod = resultCod + elTexto;\r           set('Formulario.txtCodCliente', resultCod);\r          }\r                \r   }\r\r   \r\r \r\r   \r"));
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(6)).setAttribute("name","cbCamposBusqueda" );
      ((Element)v.get(6)).setAttribute("required","true" );
      ((Element)v.get(6)).setAttribute("cod","2657" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(16)).setAttribute("nombre","camposBusqueda" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(17)).setAttribute("nombre","hLongCliente" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(49)).setAttribute("nombre","lblCamposBusqueda" );
      ((Element)v.get(49)).setAttribute("alto","13" );
      ((Element)v.get(49)).setAttribute("filas","1" );
      ((Element)v.get(49)).setAttribute("id","datosTitle" );
      ((Element)v.get(49)).setAttribute("cod","2657" );
      ...
      ((Element)v.get(56)).setAttribute("onblur","clienteOnBlur();" );
      ...
      ((Element)v.get(60)).setAttribute("onclick","buscarCliente();" );
      ...
      ((Element)v.get(64)).setAttribute("nombre","cbCamposBusqueda" );
      ((Element)v.get(64)).setAttribute("size","1" );
      ((Element)v.get(64)).setAttribute("multiple","N" );
      ((Element)v.get(64)).setAttribute("valorinicial","1" );
      ((Element)v.get(64)).setAttribute("textoinicial","Consulta de cuenta corriente" );
      ...
      ((Element)v.get(66)).setAttribute("ID","1" );
      ...
      ((Element)v.get(67)).setAttribute("VALOR","2" );
      ...
      ((Element)v.get(68)).setAttribute("VALOR","Histórico de cobranza" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(84)).setAttribute("nombre","btnGenerarInforme" );
      ((Element)v.get(84)).setAttribute("ID","botonContenido" );
      ((Element)v.get(84)).setAttribute("tipo","html" );
      ((Element)v.get(84)).setAttribute("accion","generar();" );
      ((Element)v.get(84)).setAttribute("estado","false" );
      ((Element)v.get(84)).setAttribute("cod","2495" );
      ((Element)v.get(84)).setAttribute("ontab","focaliza('Formulario.txtCodCliente')" );
