...
public class RECProductoMotivos extends LPSICCBase {           
   public RECProductoMotivos() {	 
     super();
  }
     ...
     try {
        ...
        if (accion.equals("generar")){
          ...
          //cargarPagina();
           ...
           cargarPagina();
           getConfiguracionMenu("RECProductoMotivos");
        }
  ...
  private void cargarPagina() throws Exception{
     pagina("contenido_informe_consulta_producto_motivos_generar");   
    ...
    // asignarAtributo("LABELC", "lbldtPais", "valor", UtilidadesSession.getDescripcionPais(this));
     ...
     vecCAT.add(dto);
     vecCAT.add(idCAT);
     DTOSalida dtoSalCAT = (DTOSalida)conectar("ConectorUA",vecCAT).objeto("dtoSalida"); 
     ...
     asignar("COMBO", "cbTipoCatalogo", catalogos, "DTOSalida.catalogos_ROWSET");  
 ...
 private void generarReporte() throws Exception{
     ...
     String tipoCampanaDesc        = conectorParametroLimpia("tipoCampanaDesc", "", true);
     if(!tipoCampanaDesc.equals("")){
       datos.put(ConstantesREP.TIPOCAMPANIADESC, tipoCampanaDesc);
     }
     
     String tipoOrdenacion        = conectorParametroLimpia("tipoOrdenacion", "", true);
     if(!tipoOrdenacion.equals("")){
		 if(tipoOrdenacion.equals("1")){
           datos.put(ConstantesREP.TIPOORDENACION, "CABECERA.UNI_RECLAMADAS");
		 }else{
 	       datos.put(ConstantesREP.TIPOORDENACION, "CABECERA.PORC");
		 }
     }
     ...
     String tipoCatalogo        = conectorParametroLimpia("tipoCatalogo", "", true);
     if(!tipoCatalogo.equals("")){
        datos.put(ConstantesREP.TIPOCATALOGO, tipoCatalogo);
     }
     ...
     datos.put(ConstantesREP.CANTIDADREGISTROS, cantidad);
   
       
       
     datos.put(ConstantesREP.TITULO, "Consulta de producto por motivos");     
     ...
     String tipoCampana        = conectorParametroLimpia("tipoCampana", "", true);
	 String quiebreUnidadNegocio        = conectorParametroLimpia("quiebreUnidadNegocio", "", true);
     
     
     String reporte = null;
     if((tipoCampana.equals("1")) && (quiebreUnidadNegocio.equals("N"))){
       reporte = "RD_REP-118_01";
     }else{
		  if((tipoCampana.equals("1")) && (quiebreUnidadNegocio.equals("S"))){
             reporte = "RD_REP-118_03";
          }else{
		     if((tipoCampana.equals("2")) && (quiebreUnidadNegocio.equals("N"))){
		         reporte = "RD_REP-118";
			 }else{
                 reporte = "RD_REP-118_02";
...
//     ejecutarReporte(datos, "REPGenerarReporte", "RD_REP-118", formato);
