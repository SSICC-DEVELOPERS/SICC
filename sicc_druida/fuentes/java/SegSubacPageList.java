...
public class SegSubacPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","segSubacList" );
      ...
      ((Element)v.get(14)).setAttribute("cod","SegSubac.acceOidAcce.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","SegSubac.codSbac.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","SegSubac.Descripcion.label" );
