...
public class contenido_cabecera_matriz_facturacion_modificar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_cabecera_matriz_facturacion_modificar" );
      ((Element)v.get(0)).setAttribute("cod","0142" );
      ((Element)v.get(0)).setAttribute("titulo","Modificar Cabecera Matriz de Facturación" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","Modificar Cabecera Matriz de Facturación" );
      ...
      v.add(doc.createTextNode("\r \r\r    var formName = 'frmFormulario.';\r    var formNameSinPunto = 'frmFormulario';\r    \r    function fGuardar(){\r        if (sicc_validaciones_generales()){\r            set(\"frmFormulario.varCanal\",get('frmFormulario.Canal'));  \r            set(\"frmFormulario.varMarca\",get('frmFormulario.Marca'));	\r            set(\"frmFormulario.varPeriodo\",get('frmFormulario.Periodo'));\r            set(\"frmFormulario.varNumeroPedidosEstimados\",get('frmFormulario.NumeroPedidosEstimados'));\r            set(\"frmFormulario.varUnidadesEstimadas\",get('frmFormulario.UnidadesEstimadas'));\r            set(\"frmFormulario.varClientesEstimados\",get('frmFormulario.ClientesEstimados'));			\r            set(\"frmFormulario.varValorEstimado\",get('frmFormulario.ClientesEstimados')); 		 \r            set(\"frmFormulario.varTipoCambio\",get('frmFormulario.TipoCambio'));		\r					\r            set(\"frmFormulario.accion\", \"Guardar\");\r            set(\"frmFormulario.conectorAction\", \"LPModificarCabeceraMF\");		\r  	 \r            enviaSICC(\"frmFormulario\");\r      }\r    }\r\r    function inicializar(){\r      configurarMenuSecundario(getFormularioSICC());\r\r      set( 'frmFormulario.hNumeroPedidosEstimados', get('frmFormulario.NumeroPedidosEstimados') );\r      set( 'frmFormulario.hUnidadesEstimadas', get('frmFormulario.UnidadesEstimadas') );\r      set( 'frmFormulario.hClientesEstimados', get('frmFormulario.ClientesEstimados') );\r      set( 'frmFormulario.hValorEstimado', get('frmFormulario.ValorEstimado') );\r      set( 'frmFormulario.hTipoCambio', get('frmFormulario.TipoCambio') );\r\r      focaliza(getFormularioSICC()+\".NumeroPedidosEstimados\");\r      fMostrarMensajeError();\r    }\r\r    function fLimpiar(){    \r        /*set('frmFormulario.NumeroPedidosEstimados', get('frmFormulario.hNumeroPedidosEstimados'));     \r        set(getFormularioSICC()+\".UnidadesEstimadas\", get('frmFormulario.hUnidadesEstimadas' ));\r        set(getFormularioSICC()+\".ClientesEstimados\", get('frmFormulario.hClientesEstimados'));\r        set(getFormularioSICC()+\".ValorEstimado\", get('frmFormulario.hValorEstimado'));\r        set(getFormularioSICC()+\".TipoCambio\", get('frmFormulario.hTipoCambio'));*/\r        focaliza(getFormularioSICC()+\".NumeroPedidosEstimados\");\r    }\r/*\r    function seleccionarMatriz(){\r        set(\"frmFormulario.accion\", \"\");\r        set(\"frmFormulario.conectorAction\", \"LPModificarCabeceraMF\");\r        eval(\"frmFormulario.oculto='N'\")\r        enviaSICC(\"frmFormulario\");\r    }*/\r \r  "));
      ...
      ((Element)v.get(5)).setAttribute("name","NumeroPedidosEstimados" );
      ((Element)v.get(5)).setAttribute("required","true" );
      ((Element)v.get(5)).setAttribute("cod","448" );
      ((Element)v.get(5)).setAttribute("format","e" );
      ((Element)v.get(5)).setAttribute("min","0" );
      ((Element)v.get(5)).setAttribute("max","9999999999" );
      ((Element)v.get(4)).appendChild((Element)v.get(5));
      /* Termina nodo:5   */

      /* Empieza nodo:6 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(6)).setAttribute("name","UnidadesEstimadas" );
      ((Element)v.get(6)).setAttribute("required","true" );
      ((Element)v.get(6)).setAttribute("cod","449" );
      ((Element)v.get(6)).setAttribute("format","e" );
      ((Element)v.get(6)).setAttribute("min","0" );
      ((Element)v.get(6)).setAttribute("max","9999999999" );
      ((Element)v.get(4)).appendChild((Element)v.get(6));
      /* Termina nodo:6   */

      /* Empieza nodo:7 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(7)).setAttribute("name","ClientesEstimados" );
      ((Element)v.get(7)).setAttribute("required","true" );
      ((Element)v.get(7)).setAttribute("cod","450" );
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(8)).setAttribute("name","ValorEstimado" );
      ((Element)v.get(8)).setAttribute("required","true" );
      ((Element)v.get(8)).setAttribute("cod","2465" );
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(9)).setAttribute("name","TipoCambio" );
      ((Element)v.get(9)).setAttribute("required","false" );
      ((Element)v.get(9)).setAttribute("cod","130" );
      ((Element)v.get(9)).setAttribute("format","a" );
      ((Element)v.get(9)).setAttribute("min","0" );
      ((Element)v.get(9)).setAttribute("max","9999999.99999" );
      ...
      ((Element)v.get(12)).setAttribute("valor","LPModificarCabeceraMF" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(15)).setAttribute("nombre","varExitoModifica" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(16)).setAttribute("nombre","nombreLogicas" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(17)).setAttribute("nombre","hNumeroPedidosEstimados" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(18)).setAttribute("nombre","hUnidadesEstimadas" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(19)).setAttribute("nombre","hClientesEstimados" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(20)).setAttribute("nombre","hValorEstimado" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(54)).setAttribute("cod","447" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(61)).setAttribute("nombre","Marca" );
   ...
   private void getXML270(Document doc) {
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(65)).setAttribute("nombre","Canal" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(69)).setAttribute("nombre","Periodo" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(80)).setAttribute("nombre","lblNumeroPedidosEstimados" );
      ...
      ((Element)v.get(80)).setAttribute("cod","448" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(84)).setAttribute("nombre","lblUnidadesEstimadas" );
      ...
      ((Element)v.get(84)).setAttribute("cod","449" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(88)).setAttribute("nombre","lblClientesEstimados" );
      ...
      ((Element)v.get(88)).setAttribute("cod","450" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(92)).setAttribute("nombre","lblValorEstimado" );
      ...
      ((Element)v.get(92)).setAttribute("cod","2465" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(96)).setAttribute("nombre","lblTipoCambio" );
      ...
      ((Element)v.get(96)).setAttribute("cod","130" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(115)).setAttribute("nombre","ValorEstimado" );
      ...
      ((Element)v.get(115)).setAttribute("size","15" );
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(119)).setAttribute("nombre","TipoCambio" );
      ...
      ((Element)v.get(119)).setAttribute("size","17" );
      ((Element)v.get(119)).setAttribute("valor","" );
      ((Element)v.get(119)).setAttribute("validacion","" );
      ((Element)v.get(119)).setAttribute("ontab","focaliza('frmFormulario.NumeroPedidosEstimados','');" );
      ((Element)v.get(119)).setAttribute("onshtab","focaliza('frmFormulario.TipoCambio','');" );
   ...
   private void getXML540(Document doc) {
      ...
      /* Empieza nodo:125 / Elemento padre: 31   */
      v.add(doc.createElement("td"));
      ((Element)v.get(31)).appendChild((Element)v.get(125));
      ...
      /* Empieza nodo:127 / Elemento padre: 23   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(23)).appendChild((Element)v.get(127));
