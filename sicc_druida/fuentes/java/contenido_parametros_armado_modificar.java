...
public class contenido_parametros_armado_modificar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_parametros_armado_modificar" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","contenido_parametros_armado_modificar.js" );
      ...
      ((Element)v.get(7)).setAttribute("name","txtAgrupacioEspecifica" );
      ((Element)v.get(7)).setAttribute("required","true" );
      ((Element)v.get(7)).setAttribute("group","gBuscar" );
      ((Element)v.get(7)).setAttribute("cod","3136" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(31)).setAttribute("nombre","lblDatosPrincipales" );
      ((Element)v.get(31)).setAttribute("alto","13" );
      ((Element)v.get(31)).setAttribute("filas","1" );
      ((Element)v.get(31)).setAttribute("cod","ApeGestVAsigProdAnaqueles.legend.label" );
      ...
      ((Element)v.get(40)).setAttribute("cod","ApeParamLineaArmado.centroDistrib.label" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(44)).setAttribute("nombre","lblAgrupacionEspecifica" );
      ...
      ((Element)v.get(44)).setAttribute("cod","3136" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(51)).setAttribute("nombre","cbCentroDistribucion" );
      ...
      ((Element)v.get(51)).setAttribute("onshtab","focalizaShTab(1);" );
      ...
      ((Element)v.get(66)).setAttribute("nombre","btnBuscar" );
      ((Element)v.get(66)).setAttribute("ID","botonContenido" );
      ((Element)v.get(66)).setAttribute("tipo","html" );
      ((Element)v.get(66)).setAttribute("accion","btnBuscarOnClick();" );
      ((Element)v.get(66)).setAttribute("ontab","focalizaTab(1);" );
      ((Element)v.get(66)).setAttribute("estado","false" );
      ((Element)v.get(66)).setAttribute("cod","1" );
   ...
   private void getXML270(Document doc) {
      ...
      /* Empieza nodo:69 / Elemento padre: 17   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(17)).appendChild((Element)v.get(69));
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(76)).setAttribute("nombre","capaLista" );
      ((Element)v.get(76)).setAttribute("ancho","100%" );
      ((Element)v.get(76)).setAttribute("alto","400" );
      ((Element)v.get(76)).setAttribute("x","7" );
      ((Element)v.get(76)).setAttribute("y","140" );
      ...
      ((Element)v.get(77)).setAttribute("ancho","369" );
      ((Element)v.get(77)).setAttribute("alto","301" );
      ((Element)v.get(77)).setAttribute("x","12" );
      ((Element)v.get(77)).setAttribute("y","0" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(93)).setAttribute("alto","25" );
      ...
      ((Element)v.get(94)).setAttribute("cod","ApeParamLineaArmado.centroDistrib.label" );
      ...
      ((Element)v.get(96)).setAttribute("cod","3136" );
      ((Element)v.get(93)).appendChild((Element)v.get(96));

      /* Elemento padre:96 / Elemento actual: 97   */
      v.add(doc.createTextNode("Agrupación Específica"));
      ...
      ((Element)v.get(100)).setAttribute("cod","EduTipoCurso.marcOidMarc.label" );
      ...
      ((Element)v.get(102)).setAttribute("cod","FacAsignImpre.canaOidCana.label" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(104)).setAttribute("onLoad","" );
      ...
      ((Element)v.get(111)).setAttribute("ancho","679" );
      ((Element)v.get(111)).setAttribute("sep","$" );
      ((Element)v.get(111)).setAttribute("x","12" );
      ((Element)v.get(111)).setAttribute("class","botonera" );
      ((Element)v.get(111)).setAttribute("y","294" );
      ((Element)v.get(111)).setAttribute("control","|" );
      ((Element)v.get(111)).setAttribute("conector","ConectorBuscarCargosAbonos" );
      ((Element)v.get(111)).setAttribute("rowset","" );
      ((Element)v.get(111)).setAttribute("cargainicial","N" );
      ((Element)v.get(111)).setAttribute("onload","procesarPaginado(mipgndo,msgError, ultima, rowset, 'muestraLista(ultima, rowset)')" );
      ...
      ((Element)v.get(112)).setAttribute("y","282" );
      ...
      ((Element)v.get(113)).setAttribute("y","282" );
      ...
      ((Element)v.get(76)).appendChild((Element)v.get(114));
      /* Termina nodo:114   */

      /* Empieza nodo:115 / Elemento padre: 76   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(115)).setAttribute("nombre","separa" );
      ((Element)v.get(115)).setAttribute("x","59" );
      ((Element)v.get(115)).setAttribute("y","278" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(76)).appendChild((Element)v.get(115));
      /* Termina nodo:115   */

      /* Empieza nodo:116 / Elemento padre: 76   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(116)).setAttribute("nombre","Modificar" );
      ((Element)v.get(116)).setAttribute("x","80" );
      ((Element)v.get(116)).setAttribute("y","279" );
      ...
      ((Element)v.get(116)).setAttribute("accion","btnModificarOnClick();" );
      ((Element)v.get(116)).setAttribute("ontab","focalizaTab(2);" );
      ((Element)v.get(116)).setAttribute("onshtab","focalizaShTab(2);" );
      ((Element)v.get(76)).appendChild((Element)v.get(116));
      /* Termina nodo:116   */

      /* Empieza nodo:117 / Elemento padre: 76   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(117)).setAttribute("nombre","Detalle" );
      ((Element)v.get(117)).setAttribute("x","80" );
      ((Element)v.get(117)).setAttribute("y","279" );
      ...
      ((Element)v.get(117)).setAttribute("accion","btnDetalleOnClick();" );
      ((Element)v.get(117)).setAttribute("ontab","focalizaTab(2);" );
      ((Element)v.get(117)).setAttribute("onshtab","focalizaShTab(2);" );
      ((Element)v.get(76)).appendChild((Element)v.get(117));
      /* Termina nodo:117   */
      /* Termina nodo:76   */
      ...
      ((Element)v.get(118)).setAttribute("y","428" );
