...
public class BelTipoCajaPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","BelTipoCaja.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","BelTipoCaja.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('belTipoCajaFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('belTipoCajaFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(50)).setAttribute("nombre","codTipoCajaTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lblCodTipoCaja" );
      ((Element)v.get(54)).setAttribute("alto","13" );
      ((Element)v.get(54)).setAttribute("filas","1" );
      ((Element)v.get(54)).setAttribute("id","datosTitle" );
      ((Element)v.get(54)).setAttribute("cod","BelTipoCaja.codTipoCaja.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(55)).setAttribute("nombre","codTipoCajaWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(57)).setAttribute("nombre","codTipoCaja" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('belTipoCajaFrm',2, true)" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('belTipoCajaFrm', 2, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(58)).setAttribute("nombre","codTipoCajaGapTdId" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(72)).setAttribute("nombre","belTipoCajaTrButtons" );
      ...
      ((Element)v.get(79)).setAttribute("nombre","belTipoCajaTdQueryButton" );
      ((Element)v.get(78)).appendChild((Element)v.get(79));

      /* Empieza nodo:80 / Elemento padre: 79   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(80)).setAttribute("nombre","belTipoCajaQueryButton" );
      ((Element)v.get(80)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(80)).setAttribute("estado","false" );
      ((Element)v.get(80)).setAttribute("accion","belTipoCajaFirstPage();" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(81)).setAttribute("nombre","belTipoCajaTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(83)).setAttribute("nombre","belTipoCajaLovNullButton" );
      ((Element)v.get(83)).setAttribute("ID","botonContenido" );
      ((Element)v.get(83)).setAttribute("tipo","html" );
      ((Element)v.get(83)).setAttribute("accion","belTipoCajaLovNullSelectionAction();" );
