...
public class CccCuentCorriBancaPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","cccCuentCorriBancaList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(18)).setAttribute("cod","CccCuentCorriBanca.codCc.label" );
      ...
      ((Element)v.get(19)).setAttribute("cod","CccCuentCorriBanca.sociOidSoci.label" );
      ...
      ((Element)v.get(20)).setAttribute("cod","CccCuentCorriBanca.desCc.label" );
      ...
      ((Element)v.get(21)).setAttribute("cod","CccCuentCorriBanca.cucoOidCcTeso.label" );
      ...
      ((Element)v.get(22)).setAttribute("cod","CccCuentCorriBanca.cucoOidCcPnte.label" );
      ...
      ((Element)v.get(23)).setAttribute("cod","CccCuentCorriBanca.codCcBanc.label" );
      ...
      ((Element)v.get(24)).setAttribute("cod","CccCuentCorriBanca.sucuOidSucu.label" );
      ...
      ((Element)v.get(25)).setAttribute("accion","" );
      ((Element)v.get(25)).setAttribute("tipoEnvio","seleccion" );
      ((Element)v.get(25)).setAttribute("formaEnvio","xml" );
      ((Element)v.get(25)).setAttribute("maxSel","1" );
      ((Element)v.get(25)).setAttribute("msgErrMaxSel","" );
      ((Element)v.get(25)).setAttribute("coloresScrollNativo","#D4D0C8,black,white,#D4D0C8,#D4D0C8,#ECE9E4,black" );
      ((Element)v.get(25)).setAttribute("colorROver","#D0D9E8" );
      ((Element)v.get(25)).setAttribute("onLoad","" );
      ((Element)v.get(25)).setAttribute("colorSelecc","#D0D9E8" );
