...
public class MaeTipoDirecPage  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","MaeTipoDirecPage" );
      ((Element)v.get(0)).setAttribute("titulo","" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","" );
      ((Element)v.get(0)).setAttribute("onload","maeTipoDirecInitComponents()" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","maetipodirec.js" );
      ((Element)v.get(0)).appendChild((Element)v.get(4));
      /* Termina nodo:4   */

      /* Empieza nodo:5 / Elemento padre: 0   */
      v.add(doc.createElement("FORMULARIO"));
      ((Element)v.get(5)).setAttribute("nombre","maeTipoDirecFrm" );
      ...
      ((Element)v.get(6)).setAttribute("valor","MaeTipoDirecLPExecution" );
      ...
      ((Element)v.get(7)).setAttribute("valor","MaeTipoDirecLPExecution" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(37)).setAttribute("nombre","maeTipoDirecFormLayer" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(52)).setAttribute("cod","MaeTipoDirec.legend.label" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(67)).setAttribute("cod","MaeTipoDirec.id.label" );
      ...
      ((Element)v.get(70)).setAttribute("ontab","ejecutarAccionFoco('maeTipoDirecFrm',1, true)" );
      ((Element)v.get(70)).setAttribute("onshtab","ejecutarAccionFoco('maeTipoDirecFrm', 1, false)" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(88)).setAttribute("nombre","codTipoDireTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(93)).setAttribute("nombre","codTipoDireWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(95)).setAttribute("nombre","codTipoDire" );
      ...
      ((Element)v.get(95)).setAttribute("ontab","ejecutarAccionFoco('maeTipoDirecFrm',2, true)" );
      ((Element)v.get(95)).setAttribute("onshtab","ejecutarAccionFoco('maeTipoDirecFrm', 2, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(96)).setAttribute("nombre","codTipoDireGapTdId" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(102)).setAttribute("cod","MaeTipoDirec.Descripcion.label" );
      ...
      ((Element)v.get(106)).setAttribute("ontab","ejecutarAccionFoco('maeTipoDirecFrm',3, true)" );
      ((Element)v.get(106)).setAttribute("onshtab","ejecutarAccionFoco('maeTipoDirecFrm', 3, false)" );
      ...
      ((Element)v.get(110)).setAttribute("href","javascript:openLocalizationDialog('maeTipoDirecFrm', 'Descripcion', 1);" );
      ((Element)v.get(110)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"maeTipoDirecFrm\",3, true)', 'ejecutarAccionFoco(\"maeTipoDirecFrm\",3, false)')" );
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(126)).setAttribute("nombre","maeTipoDirecTrButtons" );
      ...
      ((Element)v.get(133)).setAttribute("nombre","maeTipoDirecTdQueryButton" );
      ((Element)v.get(132)).appendChild((Element)v.get(133));

      /* Empieza nodo:134 / Elemento padre: 133   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(134)).setAttribute("nombre","maeTipoDirecQueryButton" );
      ((Element)v.get(134)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(134)).setAttribute("estado","false" );
      ((Element)v.get(134)).setAttribute("accion","maeTipoDirecFirstPage();" );
      ...
      ((Element)v.get(135)).setAttribute("nombre","maeTipoDirecTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(137)).setAttribute("nombre","maeTipoDirecLovNullButton" );
      ((Element)v.get(137)).setAttribute("ID","botonContenido" );
      ((Element)v.get(137)).setAttribute("tipo","html" );
      ((Element)v.get(137)).setAttribute("accion","maeTipoDirecLovNullSelectionAction();" );
   ...
   private void getXML630(Document doc) {
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(140)).setAttribute("nombre","maeTipoDirecListLayer" );
      ...
      ((Element)v.get(141)).setAttribute("nombre","maeTipoDirecList" );
   ...
   private void getXML720(Document doc) {
      ...
      ((Element)v.get(154)).setAttribute("cod","MaeTipoDirec.codTipoDire.label" );
      ...
      ((Element)v.get(155)).setAttribute("cod","MaeTipoDirec.Descripcion.label" );
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(160)).setAttribute("nombre","maeTipoDirecListButtonsLayer" );
      ...
      ((Element)v.get(166)).setAttribute("nombre","maeTipoDirecPaginationButtonBar" );
   }
   ...
   private void getXML810(Document doc) {
      ...
      ((Element)v.get(167)).setAttribute("nombre","maeTipoDirecFirstPageButton" );
      ((Element)v.get(167)).setAttribute("funcion","maeTipoDirecFirstPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(168)).setAttribute("nombre","maeTipoDirecFirstPageButtonGapTd" );
      ...
      v.add(doc.createElement("BTN"));
      ((Element)v.get(170)).setAttribute("nombre","maeTipoDirecPreviousPageButton" );
      ((Element)v.get(170)).setAttribute("funcion","maeTipoDirecPreviousPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(171)).setAttribute("nombre","maeTipoDirecPreviousPageButtonGapTd" );
      ...
      v.add(doc.createElement("BTN"));
      ((Element)v.get(173)).setAttribute("nombre","maeTipoDirecNextPageButton" );
      ((Element)v.get(173)).setAttribute("funcion","maeTipoDirecNextPage();" );
      ...
      ((Element)v.get(176)).setAttribute("nombre","maeTipoDirecUpdateButtonTd" );
      ((Element)v.get(162)).appendChild((Element)v.get(176));

      /* Empieza nodo:177 / Elemento padre: 176   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(177)).setAttribute("nombre","maeTipoDirecUpdateButton" );
      ((Element)v.get(177)).setAttribute("ID","botonContenido" );
      ((Element)v.get(177)).setAttribute("tipo","html" );
      ((Element)v.get(177)).setAttribute("accion","maeTipoDirecUpdateSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(178)).setAttribute("nombre","maeTipoDirecUpdateButtonGapTd" );
      ...
      ((Element)v.get(180)).setAttribute("nombre","maeTipoDirecViewForRemoveButtonTd" );
      ((Element)v.get(162)).appendChild((Element)v.get(180));

      /* Empieza nodo:181 / Elemento padre: 180   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(181)).setAttribute("nombre","maeTipoDirecViewForRemoveButton" );
      ((Element)v.get(181)).setAttribute("ID","botonContenido" );
      ((Element)v.get(181)).setAttribute("tipo","html" );
      ((Element)v.get(181)).setAttribute("accion","maeTipoDirecViewSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(182)).setAttribute("nombre","maeTipoDirecViewForRemoveButtonGapTd" );
   ...
   private void getXML900(Document doc) {
      ...
      ((Element)v.get(184)).setAttribute("nombre","maeTipoDirecLovSelectButtonTd" );
      ((Element)v.get(162)).appendChild((Element)v.get(184));

      /* Empieza nodo:185 / Elemento padre: 184   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(185)).setAttribute("nombre","maeTipoDirecLovSelectButton" );
      ((Element)v.get(185)).setAttribute("ID","botonContenido" );
      ((Element)v.get(185)).setAttribute("tipo","html" );
      ((Element)v.get(185)).setAttribute("accion","maeTipoDirecLovSelectionAction();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(186)).setAttribute("nombre","maeTipoDirecLovSelectButtonGapTd" );
      ...
      ((Element)v.get(188)).setAttribute("nombre","maeTipoDirecViewButtonTd" );
      ((Element)v.get(162)).appendChild((Element)v.get(188));

      /* Empieza nodo:189 / Elemento padre: 188   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(189)).setAttribute("nombre","maeTipoDirecViewButton" );
      ((Element)v.get(189)).setAttribute("ID","botonContenido" );
      ((Element)v.get(189)).setAttribute("tipo","html" );
      ((Element)v.get(189)).setAttribute("accion","maeTipoDirecViewSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(190)).setAttribute("nombre","maeTipoDirecViewButtonGapTd" );
