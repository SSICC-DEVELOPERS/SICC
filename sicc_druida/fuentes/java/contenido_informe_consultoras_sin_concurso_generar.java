...
public class contenido_informe_consultoras_sin_concurso_generar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_informe_consultoras_sin_concurso_generar" );
      ((Element)v.get(0)).setAttribute("cod","0871" );
      ((Element)v.get(0)).setAttribute("titulo","Generar Informe Consultoras que no cumplieron con Concurso Recomendación" );
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(147)).setAttribute("nombre","cbMotivosIncumplimiento" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(152)).setAttribute("nombre","cbNumConcurso" );
      ...
      /* Empieza nodo:159 / Elemento padre: 28   */
      v.add(doc.createElement("td"));
      ((Element)v.get(28)).appendChild((Element)v.get(159));
      ...
      /* Empieza nodo:161 / Elemento padre: 20   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(20)).appendChild((Element)v.get(161));
   ...
   private void getXML630(Document doc) {
      ...
      ((Element)v.get(169)).setAttribute("ontab","focaliza('Formulario.cbPais')" );
      ...
      /* Empieza nodo:172 / Elemento padre: 20   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(20)).appendChild((Element)v.get(172));
