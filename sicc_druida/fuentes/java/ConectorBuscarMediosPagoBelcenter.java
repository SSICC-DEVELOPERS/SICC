...
public class ConectorBuscarMediosPagoBelcenter  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","DTOEBuscarMediosPagoBelcenter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(6)).setAttribute("NOMBRE","OID_MEDIO_PAGO_BEL_CENTER" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","DESCRIPCION_INTERNACIONALIZADA_CANAL" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(8)).setAttribute("NOMBRE","DESCRIPCION_INTERNACIONALIZADA_ACCESO" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(9)).setAttribute("NOMBRE","DESCRIPCION_INTERNACIONALIZADA_SUBACCESO" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(10)).setAttribute("NOMBRE","CODIGO_MEDIO_PAGO" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(11)).setAttribute("NOMBRE","DESCRIPCION_INTERNACIONALIZADA_MEDIO_PAGO" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(12)).setAttribute("NOMBRE","DESCRIPCION_TIPO_MEDIO_PAGO" );
