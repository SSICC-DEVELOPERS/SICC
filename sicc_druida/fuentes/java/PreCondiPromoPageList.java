...
public class PreCondiPromoPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","preCondiPromoList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","PreCondiPromo.codCondProm.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","PreCondiPromo.Descripcion.label" );
