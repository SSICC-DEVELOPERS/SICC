...
public class ConectorObtenerRegionesCRA  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Cargar Regiones" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","DTOUnidadesAdministrativas" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","CARObtenerRegiones" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(6)).setAttribute("NOMBRE","OID_REGI" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","ZSGV_OID_SUBG_VENT" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(11)).setAttribute("NOMBRE","DES_REG" );
      ...
      ((Element)v.get(12)).setAttribute("ID","dtoSalida.resultado_ROWSET" );
      ((Element)v.get(0)).appendChild((Element)v.get(12));

      /* Empieza nodo:13 / Elemento padre: 12   */
      v.add(doc.createElement("CCAMPO"));
      ((Element)v.get(13)).setAttribute("NOMBRE","OID_REGI" );
      ...
      v.add(doc.createElement("CCAMPO"));
      ((Element)v.get(14)).setAttribute("NOMBRE","OID_REGI" );
