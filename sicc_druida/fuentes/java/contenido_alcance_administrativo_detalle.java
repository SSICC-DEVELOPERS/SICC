...
public class contenido_alcance_administrativo_detalle  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_alcance_administrativo_detalle" );
      ...
      v.add(doc.createTextNode("\r   \r    var formName = 'formulario'; \r\r    function onLoadPag(){\r        configurarMenuSecundario('formulario');\r        focaliza(\"formulario.cbSubgerenciaVenta\");\r        btnProxy(7,'0');\r        btnProxy(8,'0');\r        btnProxy(9,'0');   \r        btnProxy(3,'0');\r        btnProxy(2,'1');\r    }\r\r    function fVolver(){\r        window.close();\r    }\r    \r    function accionAceptar()\r    {\r        if(sicc_validaciones_generales()) {\r                     var arr = new Array();   \r            arr[0] = get(\"formulario.cbSubgerenciaVenta\",\"V\");\r            arr[1] = get(\"formulario.cbSubgerenciaVenta\",\"T\");\r            arr[2] = get(\"formulario.cbRegiones\",\"V\");\r            arr[3] = get(\"formulario.cbRegiones\",\"T\");\r            arr[4] = get(\"formulario.cbZonas\",\"V\");\r            arr[5] = get(\"formulario.cbZonas\",\"T\");\r            arr[6] = get(\"formulario.txtDtoAdiccional\");\r\r\r            returnValue = arr;   \r            close(); \r        }\r    }\r\r    function subgerenciaVentasOnChange(){\r        		  recargaCombo('formulario.cbRegiones','ZONRecargaRegiones', \r          'es.indra.sicc.dtos.zon.DTOUnidadAdministrativa',\r          makeParameter('oidSGV',get('formulario.cbSubgerenciaVenta','V')));\r\r\r        focaliza(\"formulario.cbRegiones\");    \r    }\r\r    function regionesOnChange() {\r        		  recargaCombo('formulario.cbZonas','ZONRecargaZonas', \r                'es.indra.sicc.dtos.zon.DTOUnidadAdministrativa', \r                makeParameter('oidRegion',get('formulario.cbRegiones')));\r\r        focaliza(\"formulario.cbZonas\");\r    }\r\r    function makeParameter(oid, valor){\r          var array = new Array();          \r          array[0] = new Array(oid,valor);\r          return array;\r    }\r    \r    \r   \r"));
      ...
      ((Element)v.get(8)).setAttribute("name","cbSubgerenciaVenta" );
      ((Element)v.get(8)).setAttribute("required","true" );
      ((Element)v.get(8)).setAttribute("cod","00231" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(12)).setAttribute("nombre","hidPais" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(14)).setAttribute("nombre","hidHabilitaBotonesConsulta" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(15)).setAttribute("nombre","hidOidDescuento" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(16)).setAttribute("nombre","hidPestanya" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(18)).setAttribute("nombre","hidAlcance" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(19)).setAttribute("nombre","hidSubGerenciaVentas" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(20)).setAttribute("nombre","hidRegion" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(21)).setAttribute("nombre","hidZona" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(22)).setAttribute("nombre","hidPorcentaje" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(23)).setAttribute("nombre","VisibleAlcance" );
   }
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(24)).setAttribute("nombre","ObligatorioAlcance" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(25)).setAttribute("nombre","ModificableAlcance" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(26)).setAttribute("nombre","txtNmaximoAlcance" );
      ...
      ((Element)v.get(42)).setAttribute("nombre","lblUnidadesAdministrativas" );
      ((Element)v.get(42)).setAttribute("alto","13" );
      ((Element)v.get(42)).setAttribute("filas","1" );
      ((Element)v.get(42)).setAttribute("valor","" );
      ((Element)v.get(42)).setAttribute("cod","0043" );
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(46)).setAttribute("width","575" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lblSubgerenciaVenta" );
      ((Element)v.get(54)).setAttribute("alto","13" );
      ((Element)v.get(54)).setAttribute("filas","1" );
      ((Element)v.get(54)).setAttribute("valor","" );
      ((Element)v.get(54)).setAttribute("id","datosTitle" );
      ((Element)v.get(54)).setAttribute("cod","124" );
      ...
      ((Element)v.get(61)).setAttribute("nombre","cbSubgerenciaVenta" );
      ...
      ((Element)v.get(61)).setAttribute("onchange","subgerenciaVentasOnChange();" );
      ((Element)v.get(61)).setAttribute("onshtab","focalizaBotonHTML('botonContenido','btnAceptar')" );
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(70)).setAttribute("width","575" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(75)).setAttribute("nombre","lblRegiones" );
      ...
      ((Element)v.get(75)).setAttribute("cod","1308" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(79)).setAttribute("nombre","lblZonas" );
      ...
      ((Element)v.get(79)).setAttribute("cod","1309" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(86)).setAttribute("nombre","cbRegiones" );
      ...
      ((Element)v.get(86)).setAttribute("onchange","regionesOnChange();" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(91)).setAttribute("nombre","cbZonas" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(100)).setAttribute("width","575" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(105)).setAttribute("nombre","lblDtoAdiccional" );
      ...
      ((Element)v.get(105)).setAttribute("cod","1315" );
   ...
   private void getXML450(Document doc) {
      ...
      /* Empieza nodo:119 / Elemento padre: 36   */
      v.add(doc.createElement("td"));
      ((Element)v.get(36)).appendChild((Element)v.get(119));
      ...
      /* Empieza nodo:121 / Elemento padre: 28   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(28)).appendChild((Element)v.get(121));
      ...
      ((Element)v.get(129)).setAttribute("nombre","btnAceptar" );
      ((Element)v.get(129)).setAttribute("ID","botonContenido" );
      ((Element)v.get(129)).setAttribute("tipo","html" );
      ((Element)v.get(129)).setAttribute("accion","accionAceptar();" );
      ((Element)v.get(129)).setAttribute("estado","false" );
      ((Element)v.get(129)).setAttribute("cod","12" );
      ((Element)v.get(129)).setAttribute("ontab","focaliza('formulario.cbSubgerenciaVenta')" );
      ...
      /* Empieza nodo:132 / Elemento padre: 28   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(28)).appendChild((Element)v.get(132));
