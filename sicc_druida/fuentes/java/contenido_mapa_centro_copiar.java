...
public class contenido_mapa_centro_copiar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_mapa_centro_copiar" );
      ((Element)v.get(0)).setAttribute("cod","0964" );
      ((Element)v.get(0)).setAttribute("titulo","Copiar mapa de centro de distribucion" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","Copiar mapa de centro de distribucion" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","contenido_mapa_centro_copiar.js" );
      ...
      ((Element)v.get(10)).setAttribute("cod","2968" );
      ((Element)v.get(10)).setAttribute("format","t" );
      ((Element)v.get(10)).setAttribute("max","30" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(38)).setAttribute("nombre","lblDatosACopiar" );
      ((Element)v.get(38)).setAttribute("alto","13" );
      ((Element)v.get(38)).setAttribute("filas","1" );
      ((Element)v.get(38)).setAttribute("cod","00427" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(51)).setAttribute("nombre","lblMapaCentroDistribucion" );
      ((Element)v.get(51)).setAttribute("alto","13" );
      ((Element)v.get(51)).setAttribute("filas","1" );
      ((Element)v.get(51)).setAttribute("valor","" );
      ((Element)v.get(51)).setAttribute("id","datosTitle" );
      ((Element)v.get(51)).setAttribute("cod","2925" );
      ...
      ((Element)v.get(58)).setAttribute("ontab","onTabCentro();" );
      ((Element)v.get(58)).setAttribute("onshtab","onShTabCentro();" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(63)).setAttribute("nombre","cbMapaCentroDistribucion" );
      ...
      ((Element)v.get(63)).setAttribute("ontab","onTabMapa();" );
      ((Element)v.get(63)).setAttribute("onshtab","onShTabMapa();" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(78)).setAttribute("nombre","lblMapaZonas" );
      ...
      ((Element)v.get(78)).setAttribute("cod","2968" );
      ...
      ((Element)v.get(85)).setAttribute("nombre","txtDescripcion" );
      ((Element)v.get(85)).setAttribute("id","datosCampos" );
      ((Element)v.get(85)).setAttribute("max","30" );
      ((Element)v.get(85)).setAttribute("tipo","" );
      ((Element)v.get(85)).setAttribute("onchange","" );
      ((Element)v.get(85)).setAttribute("req","S" );
      ((Element)v.get(85)).setAttribute("size","30" );
      ((Element)v.get(85)).setAttribute("valor","" );
      ((Element)v.get(85)).setAttribute("validacion","" );
      ((Element)v.get(85)).setAttribute("ontab","onTabDescripcion();" );
      ((Element)v.get(85)).setAttribute("onshtab","onShTabDescripcion();" );
   ...
   private void getXML360(Document doc) {
      ...
      /* Empieza nodo:93 / Elemento padre: 35   */
      v.add(doc.createElement("fieldset"));
      ((Element)v.get(35)).appendChild((Element)v.get(93));
      ...
      ((Element)v.get(97)).setAttribute("nombre","btnCopiar" );
      ((Element)v.get(97)).setAttribute("ID","botonContenido" );
      ((Element)v.get(97)).setAttribute("tipo","html" );
      ((Element)v.get(97)).setAttribute("accion","onClickCopiar();" );
      ((Element)v.get(97)).setAttribute("estado","false" );
      ((Element)v.get(97)).setAttribute("cod","721" );
      ((Element)v.get(97)).setAttribute("ontab","onTabBotonCopiar();" );
      ((Element)v.get(97)).setAttribute("onshtab","onShTabBotonCopiar();" );
