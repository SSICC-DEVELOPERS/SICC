...
public class ZonZonaView2ConectorQueryForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad ZonZonaView2" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGZonZonaView2QueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGZonZonaView2QueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","ZonZonaView2FormFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(11)).setAttribute("NOMBRE","indActi" );
