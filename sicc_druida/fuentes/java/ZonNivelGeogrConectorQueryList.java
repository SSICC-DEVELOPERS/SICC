...
public class ZonNivelGeogrConectorQueryList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad ZonNivelGeogr" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGZonNivelGeogrQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGZonNivelGeogrQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","ZonNivelGeogrListFormatter" );
