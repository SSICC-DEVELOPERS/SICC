...
public class EduPlantCursoCabecConectorTransactionComboLoad  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("NOMBRE","EduPlantCursoCabecTransactionComboLoad" );
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector transaccional para la ejección de la carga de combos de tipo EduPlantCursoCabec" );
