...
public class BelContrAlmacPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","belContrAlmacList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(18)).setAttribute("cod","BelContrAlmac.sbacOidSbac.label" );
      ...
      ((Element)v.get(19)).setAttribute("cod","BelContrAlmac.prodOidProd.label" );
      ...
      ((Element)v.get(20)).setAttribute("cod","BelContrAlmac.almcOidAlma.label" );
      ...
      ((Element)v.get(21)).setAttribute("cod","BelContrAlmac.valStocMini.label" );
      ...
      ((Element)v.get(22)).setAttribute("cod","BelContrAlmac.valStocMaxi.label" );
      ...
      ((Element)v.get(23)).setAttribute("cod","BelContrAlmac.valStocRepo.label" );
      ...
      ((Element)v.get(24)).setAttribute("cod","BelContrAlmac.indActi.label" );
