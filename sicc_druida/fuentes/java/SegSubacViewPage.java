...
public class SegSubacViewPage  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","SegSubacViewPage" );
      ((Element)v.get(0)).setAttribute("titulo","" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","" );
      ((Element)v.get(0)).setAttribute("onload","segSubacViewInitComponents()" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","segsubacview.js" );
      ((Element)v.get(0)).appendChild((Element)v.get(4));
      /* Termina nodo:4   */

      /* Empieza nodo:5 / Elemento padre: 0   */
      v.add(doc.createElement("FORMULARIO"));
      ((Element)v.get(5)).setAttribute("nombre","segSubacViewFrm" );
      ...
      ((Element)v.get(6)).setAttribute("valor","SegSubacViewLPExecution" );
      ...
      ((Element)v.get(7)).setAttribute("valor","SegSubacViewLPExecution" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(37)).setAttribute("nombre","segSubacViewFormLayer" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(52)).setAttribute("cod","SegSubacView.legend.label" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(67)).setAttribute("cod","SegSubacView.id.label" );
      ...
      ((Element)v.get(70)).setAttribute("ontab","ejecutarAccionFoco('segSubacViewFrm',1, true)" );
      ((Element)v.get(70)).setAttribute("onshtab","ejecutarAccionFoco('segSubacViewFrm', 1, false)" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(92)).setAttribute("cod","SegSubacView.Descripcion.label" );
      ...
      ((Element)v.get(96)).setAttribute("max","30" );
      ((Element)v.get(96)).setAttribute("onchange","" );
      ((Element)v.get(96)).setAttribute("req","N" );
      ((Element)v.get(96)).setAttribute("size","30" );
      ...
      ((Element)v.get(96)).setAttribute("ontab","ejecutarAccionFoco('segSubacViewFrm',2, true)" );
      ((Element)v.get(96)).setAttribute("onshtab","ejecutarAccionFoco('segSubacViewFrm', 2, false)" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(100)).setAttribute("href","javascript:openLocalizationDialog('segSubacViewFrm', 'Descripcion', 1);" );
      ((Element)v.get(100)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"segSubacViewFrm\",2, true)', 'ejecutarAccionFoco(\"segSubacViewFrm\",2, false)')" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(116)).setAttribute("nombre","segSubacViewTrButtons" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(123)).setAttribute("nombre","segSubacViewTdQueryButton" );
      ((Element)v.get(122)).appendChild((Element)v.get(123));

      /* Empieza nodo:124 / Elemento padre: 123   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(124)).setAttribute("nombre","segSubacViewQueryButton" );
      ((Element)v.get(124)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(124)).setAttribute("estado","false" );
      ((Element)v.get(124)).setAttribute("accion","segSubacViewFirstPage();" );
      ...
      ((Element)v.get(125)).setAttribute("nombre","segSubacViewTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(127)).setAttribute("nombre","segSubacViewLovNullButton" );
      ((Element)v.get(127)).setAttribute("ID","botonContenido" );
      ((Element)v.get(127)).setAttribute("tipo","html" );
      ((Element)v.get(127)).setAttribute("accion","segSubacViewLovNullSelectionAction();" );
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(130)).setAttribute("nombre","segSubacViewListLayer" );
      ...
      ((Element)v.get(131)).setAttribute("nombre","segSubacViewList" );
   ...
   private void getXML630(Document doc) {
      ...
      ((Element)v.get(143)).setAttribute("cod","SegSubacView.Descripcion.label" );
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(147)).setAttribute("nombre","segSubacViewListButtonsLayer" );
   ...
   private void getXML720(Document doc) {
      ...
      ((Element)v.get(153)).setAttribute("nombre","segSubacViewPaginationButtonBar" );
      ...
      ((Element)v.get(154)).setAttribute("nombre","segSubacViewFirstPageButton" );
      ((Element)v.get(154)).setAttribute("funcion","segSubacViewFirstPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(155)).setAttribute("nombre","segSubacViewFirstPageButtonGapTd" );
      ...
      v.add(doc.createElement("BTN"));
      ((Element)v.get(157)).setAttribute("nombre","segSubacViewPreviousPageButton" );
      ((Element)v.get(157)).setAttribute("funcion","segSubacViewPreviousPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(158)).setAttribute("nombre","segSubacViewPreviousPageButtonGapTd" );
      ...
      v.add(doc.createElement("BTN"));
      ((Element)v.get(160)).setAttribute("nombre","segSubacViewNextPageButton" );
      ((Element)v.get(160)).setAttribute("funcion","segSubacViewNextPage();" );
      ...
      ((Element)v.get(163)).setAttribute("nombre","segSubacViewUpdateButtonTd" );
      ((Element)v.get(149)).appendChild((Element)v.get(163));

      /* Empieza nodo:164 / Elemento padre: 163   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(164)).setAttribute("nombre","segSubacViewUpdateButton" );
      ((Element)v.get(164)).setAttribute("ID","botonContenido" );
      ((Element)v.get(164)).setAttribute("tipo","html" );
      ((Element)v.get(164)).setAttribute("accion","segSubacViewUpdateSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(165)).setAttribute("nombre","segSubacViewUpdateButtonGapTd" );
   ...
   private void getXML810(Document doc) {
      ...
      ((Element)v.get(167)).setAttribute("nombre","segSubacViewViewForRemoveButtonTd" );
      ((Element)v.get(149)).appendChild((Element)v.get(167));

      /* Empieza nodo:168 / Elemento padre: 167   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(168)).setAttribute("nombre","segSubacViewViewForRemoveButton" );
      ((Element)v.get(168)).setAttribute("ID","botonContenido" );
      ((Element)v.get(168)).setAttribute("tipo","html" );
      ((Element)v.get(168)).setAttribute("accion","segSubacViewViewSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(169)).setAttribute("nombre","segSubacViewViewForRemoveButtonGapTd" );
      ...
      ((Element)v.get(171)).setAttribute("nombre","segSubacViewLovSelectButtonTd" );
      ((Element)v.get(149)).appendChild((Element)v.get(171));

      /* Empieza nodo:172 / Elemento padre: 171   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(172)).setAttribute("nombre","segSubacViewLovSelectButton" );
      ((Element)v.get(172)).setAttribute("ID","botonContenido" );
      ((Element)v.get(172)).setAttribute("tipo","html" );
      ((Element)v.get(172)).setAttribute("accion","segSubacViewLovSelectionAction();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(173)).setAttribute("nombre","segSubacViewLovSelectButtonGapTd" );
      ...
      ((Element)v.get(175)).setAttribute("nombre","segSubacViewViewButtonTd" );
      ((Element)v.get(149)).appendChild((Element)v.get(175));

      /* Empieza nodo:176 / Elemento padre: 175   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(176)).setAttribute("nombre","segSubacViewViewButton" );
      ((Element)v.get(176)).setAttribute("ID","botonContenido" );
      ((Element)v.get(176)).setAttribute("tipo","html" );
      ((Element)v.get(176)).setAttribute("accion","segSubacViewViewSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(177)).setAttribute("nombre","segSubacViewViewButtonGapTd" );
