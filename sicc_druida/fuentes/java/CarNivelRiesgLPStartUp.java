/*
    INDRA/CAR/mmg
    $Id: CarNivelRiesgLPStartUp.java,v 1.1 2009/12/03 18:37:39 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class CarNivelRiesgLPStartUp extends MMGDruidaBase{
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "CarNivelRiesgPage", "cod", "CarNivelRiesg." + accion + ".label");
			...
			limpiarBotoneraLista("carNivelRiesg", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codNiveRies", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 1);");
		asignarAtributo("TEXT", "Descripcion", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 20);");
		
		//Primero determianmos el nombre del campo en la entidad de oriegen donde se van a cargar los datos
		asignar("VAR", "idAttributeLovOpener", conectorParametro(PARAMETRO_LOV_ATTRIBUTO));
		asignar("VAR", "idEntityLovOpener", conectorParametro(PARAMETRO_LOV_ENTIDAD));
		//asignarAtributo("CAPA", "carNivelRiesgLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "CarNivelRiesgPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		CarNivelRiesgData carNivelRiesgQuery= new CarNivelRiesgData();
		carNivelRiesgQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		CarNivelRiesgData datosResult = (CarNivelRiesgData)getSingleObject(BUSINESSID_QUERY, carNivelRiesgQuery, 
			carNivelRiesgQuery.clone(), "carNivelRiesg");
		...
		preservaHiddensI18n(new Integer(1), "CAR_NIVEL_RIESG", "carNivelRiesgFrm", "Descripcion", true);
		...
		CarNivelRiesgData carNivelRiesg = datosResult;
		asignar("TEXT", "codNiveRies", FormatUtils.formatObject(carNivelRiesg.getCodNiveRies(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "Descripcion", FormatUtils.formatObject(carNivelRiesg.getDescripcion(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		loadLocalizationVars(carNivelRiesg);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "codNiveRies", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "CAR_NIVEL_RIESG", "carNivelRiesgFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "codNiveRies", "req", "S");
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('carNivelRiesgFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "carNivelRiesgFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		CarNivelRiesgData carNivelRiesgQuery= new CarNivelRiesgData();
		carNivelRiesgQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(carNivelRiesg.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"carNivelRiesgFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"carNivelRiesgFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codNiveRies", "ontab","ejecutarAccionFocoModificacion(\"carNivelRiesgFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codNiveRies", "onshtab","ejecutarAccionFocoModificacion(\"carNivelRiesgFrm\",2, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"carNivelRiesgFrm\",3, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"carNivelRiesgFrm\",3, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","carNivelRiesgTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","carNivelRiesgTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","carNivelRiesgFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","carNivelRiesgListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","carNivelRiesgListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(CarNivelRiesgData carNivelRiesg) throws Exception{
	...
	* @param carNivelRiesg La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(CarNivelRiesgData carNivelRiesg) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		CarNivelRiesgData carNivelRiesg = 
			(CarNivelRiesgData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(carNivelRiesg);
		loadLeafDependenceCombos(carNivelRiesg);
	}
	...
	*/
	...
	protected void loadLocalizationVars(CarNivelRiesgData carNivelRiesg) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("CAR_NIVEL_RIESG");
		mmgLocalizationQuery.setEntiPk(carNivelRiesg.getId());
