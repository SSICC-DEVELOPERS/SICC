/*
    INDRA/CAR/mmg
    $Id: CobGuionArgumCabecLPStartUp.java,v 1.1 2009/12/03 18:43:17 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class CobGuionArgumCabecLPStartUp extends MMGDruidaBase{
	...
	public CobGuionArgumCabecLPStartUp(){
		super();
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			buildJsPageSize("CobGuionArgumCabec");
			...
			asignarAtributo("PAGINA", "CobGuionArgumCabecPage", "cod", "CobGuionArgumCabec." + accion + ".label");
			...
			limpiarBotoneraLista("cobGuionArgumCabec", accion);
	...
	protected void cmdLov() throws Exception{
		...
		//asignarAtributo("CAPA", "cobGuionArgumCabecLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "CobGuionArgumCabecPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		CobGuionArgumCabecData cobGuionArgumCabecQuery= new CobGuionArgumCabecData();
		cobGuionArgumCabecQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		CobGuionArgumCabecData datosResult = (CobGuionArgumCabecData)getSingleObject(BUSINESSID_QUERY, cobGuionArgumCabecQuery, 
			cobGuionArgumCabecQuery.clone(), "cobGuionArgumCabec");
		...
		preservaHiddensI18n(new Integer(1), "COB_GUION_ARGUM_CABEC", "cobGuionArgumCabecFrm", "Descripcion", true);
		...
		CobGuionArgumCabecData cobGuionArgumCabec = datosResult;
		asignar("TEXT", "codGuiaArgu", FormatUtils.formatObject(cobGuionArgumCabec.getCodGuiaArgu(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "Descripcion", FormatUtils.formatObject(cobGuionArgumCabec.getDescripcion(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("AREATEXTO", "valObse", FormatUtils.formatObject(cobGuionArgumCabec.getValObse(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		loadLocalizationVars(cobGuionArgumCabec);
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "COB_GUION_ARGUM_CABEC", "cobGuionArgumCabecFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('cobGuionArgumCabecFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "cobGuionArgumCabecFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		CobGuionArgumCabecData cobGuionArgumCabecQuery= new CobGuionArgumCabecData();
		cobGuionArgumCabecQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(cobGuionArgumCabec.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"cobGuionArgumCabecFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"cobGuionArgumCabecFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codGuiaArgu", "ontab","ejecutarAccionFocoModificacion(\"cobGuionArgumCabecFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codGuiaArgu", "onshtab","ejecutarAccionFocoModificacion(\"cobGuionArgumCabecFrm\",2, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"cobGuionArgumCabecFrm\",3, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"cobGuionArgumCabecFrm\",3, false)");
					asignarAtributo("COMBO","paisOidPais", "ontab", "ejecutarAccionFocoModificacion(\"cobGuionArgumCabecFrm\",4, true)");
					asignarAtributo("COMBO","paisOidPais", "onshtab", "ejecutarAccionFocoModificacion(\"cobGuionArgumCabecFrm\",4, false)");
				asignarAtributo("AREATEXTO", "valObse", "ontab","ejecutarAccionFocoModificacion(\"cobGuionArgumCabecFrm\",5, true)");
				asignarAtributo("AREATEXTO", "valObse", "onshtab","ejecutarAccionFocoModificacion(\"cobGuionArgumCabecFrm\",5, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","cobGuionArgumCabecTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","cobGuionArgumCabecTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","cobGuionArgumCabecFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","cobGuionArgumCabecListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","cobGuionArgumCabecListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(CobGuionArgumCabecData cobGuionArgumCabec) throws Exception{
		...
		if(cobGuionArgumCabec != null && cobGuionArgumCabec.getPaisOidPais() != null){
				checkCombo("paisOidPais" , cobGuionArgumCabec.getPaisOidPais().getId().toString());
			}
	...
	* @param cobGuionArgumCabec La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(CobGuionArgumCabecData cobGuionArgumCabec) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		CobGuionArgumCabecData cobGuionArgumCabec = 
			(CobGuionArgumCabecData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(cobGuionArgumCabec.getPaisOidPais() != null){
			cobGuionArgumCabec.setPaisOidPais((es.indra.belcorp.mso.SegPaisViewData)
			getSingleObject(BUSINESSID_PAISOIDPAIS_QUERY, 
			cobGuionArgumCabec.getPaisOidPais(),
			cobGuionArgumCabec.getPaisOidPais().clone(),
			"segPaisView"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(cobGuionArgumCabec);
		loadLeafDependenceCombos(cobGuionArgumCabec);
	}
	...
	*/
	...
	protected void loadLocalizationVars(CobGuionArgumCabecData cobGuionArgumCabec) throws Exception{
		...
		mmgLocalizationQuery.setEntiPk(cobGuionArgumCabec.getId());
