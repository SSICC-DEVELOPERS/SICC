/*
    INDRA/CAR/mmg
    $Id: MaeEstatClienLPStartUp.java,v 1.1 2009/12/03 18:32:24 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class MaeEstatClienLPStartUp extends MMGDruidaBase{
	...
	public static final String BUSINESSID_QUERY = "MMGMaeEstatClienQueryFromToUserPage";
				...
				public static final String BUSINESSID_TESCOIDTIPOESTA_QUERY ="MMGMaeTipoEstatClienViewQueryFromToUser";
				public static final String TESCOIDTIPOESTA_COMBO_CONNECTOR = "MaeTipoEstatClienViewConectorCombo";
	
				public static final String BUSINESSID_ESTAOIDESTACLIE_QUERY ="MMGMaeEstatClienViewQueryFromToUser";
				public static final String ESTAOIDESTACLIE_COMBO_CONNECTOR = "MaeEstatClienViewConectorCombo";
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "MaeEstatClienPage", "cod", "MaeEstatClien." + accion + ".label");
			...
			limpiarBotoneraLista("maeEstatClien", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codEstaClie", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 2);");
		...
		//asignarAtributo("CAPA", "maeEstatClienLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "MaeEstatClienPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		MaeEstatClienData maeEstatClienQuery= new MaeEstatClienData();
		maeEstatClienQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		MaeEstatClienData datosResult = (MaeEstatClienData)getSingleObject(BUSINESSID_QUERY, maeEstatClienQuery, 
			maeEstatClienQuery.clone(), "maeEstatClien");
		...
		preservaHiddensI18n(new Integer(1), "MAE_ESTAT_CLIEN", "maeEstatClienFrm", "Descripcion", true);
		...
		MaeEstatClienData maeEstatClien = datosResult;
		es.indra.belcorp.mso.MaeTipoEstatClienViewData tescOidTipoEsta = maeEstatClien.getTescOidTipoEsta();
		if(tescOidTipoEsta != null && tescOidTipoEsta.getId() != null) checkCombo("tescOidTipoEsta" , tescOidTipoEsta.getId().toString());
		asignar("TEXT", "codEstaClie", FormatUtils.formatObject(maeEstatClien.getCodEstaClie(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "Descripcion", FormatUtils.formatObject(maeEstatClien.getDescripcion(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		es.indra.belcorp.mso.MaeEstatClienViewData estaOidEstaClie = maeEstatClien.getEstaOidEstaClie();
		if(estaOidEstaClie != null && estaOidEstaClie.getId() != null) checkCombo("estaOidEstaClie" , estaOidEstaClie.getId().toString());
		...
		loadLocalizationVars(maeEstatClien);
		
			
		//Deshabilitamos todos los campos para que no se editen
		
					asignarAtributo("COMBO", "tescOidTipoEsta", "disabled", "S");asignarAtributo("TEXT", "codEstaClie", "disabled", "S");
		asignarAtributo("TEXT", "Descripcion", "disabled", "S");
		
					asignarAtributo("COMBO", "estaOidEstaClie", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "MAE_ESTAT_CLIEN", "maeEstatClienFrm", "Descripcion", false);
		...
		asignarAtributo("COMBO", "tescOidTipoEsta", "req", "S");
		asignarAtributo("TEXT", "codEstaClie", "req", "S");
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('maeEstatClienFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "maeEstatClienFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		MaeEstatClienData maeEstatClienQuery= new MaeEstatClienData();
		maeEstatClienQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(maeEstatClien.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"maeEstatClienFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"maeEstatClienFrm\",1, false)");
					asignarAtributo("COMBO","tescOidTipoEsta", "ontab", "ejecutarAccionFocoModificacion(\"maeEstatClienFrm\",2, true)");
					asignarAtributo("COMBO","tescOidTipoEsta", "onshtab", "ejecutarAccionFocoModificacion(\"maeEstatClienFrm\",2, false)");
				asignarAtributo("AREATEXTO", "codEstaClie", "ontab","ejecutarAccionFocoModificacion(\"maeEstatClienFrm\",3, true)");
				asignarAtributo("AREATEXTO", "codEstaClie", "onshtab","ejecutarAccionFocoModificacion(\"maeEstatClienFrm\",3, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"maeEstatClienFrm\",4, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"maeEstatClienFrm\",4, false)");
					asignarAtributo("COMBO","estaOidEstaClie", "ontab", "ejecutarAccionFocoModificacion(\"maeEstatClienFrm\",5, true)");
					asignarAtributo("COMBO","estaOidEstaClie", "onshtab", "ejecutarAccionFocoModificacion(\"maeEstatClienFrm\",5, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","maeEstatClienTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","maeEstatClienTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es tescOidTipoEsta...");		
				
					traza("MMG: en desactivateNonModifyFields encontrado atributo no editable...");
				
						asignarAtributo("COMBO", "tescOidTipoEsta", "disabled", "S");
				traza("MMG: el atributo es codEstaClie...");		
				
					traza("MMG: en desactivateNonModifyFields encontrado atributo no editable...");
				
						// borrarCampo("codEstaClie");
						asignarAtributo ("TEXT", "codEstaClie", "disabled", "S");
				traza("MMG: el atributo es Descripcion...");		
				
				traza("MMG: el atributo es estaOidEstaClie...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","maeEstatClienFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","maeEstatClienListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","maeEstatClienListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(MaeEstatClienData maeEstatClien) throws Exception{
		HashMap checkedCombos = new HashMap();
		MaeTipoEstatClienViewData tescOidTipoEsta = new MaeTipoEstatClienViewData();
		
						asignarComboResultados(BUSINESSID_TESCOIDTIPOESTA_QUERY,TESCOIDTIPOESTA_COMBO_CONNECTOR, 
			tescOidTipoEsta, tescOidTipoEsta.clone(), "maeTipoEstatClienView", "tescOidTipoEsta", "result_ROWSET" );
		if(maeEstatClien != null && maeEstatClien.getTescOidTipoEsta() != null){
				checkCombo("tescOidTipoEsta" , maeEstatClien.getTescOidTipoEsta().getId().toString());
			}
		MaeEstatClienViewData estaOidEstaClie = new MaeEstatClienViewData();
		
						asignarComboResultados(BUSINESSID_ESTAOIDESTACLIE_QUERY,ESTAOIDESTACLIE_COMBO_CONNECTOR, 
			estaOidEstaClie, estaOidEstaClie.clone(), "maeEstatClienView", "estaOidEstaClie", "result_ROWSET" );
		if(maeEstatClien != null && maeEstatClien.getEstaOidEstaClie() != null){
				checkCombo("estaOidEstaClie" , maeEstatClien.getEstaOidEstaClie().getId().toString());
			}
	...
	* @param maeEstatClien La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(MaeEstatClienData maeEstatClien) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		MaeEstatClienData maeEstatClien = 
			(MaeEstatClienData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(maeEstatClien.getTescOidTipoEsta() != null){
			maeEstatClien.setTescOidTipoEsta((es.indra.belcorp.mso.MaeTipoEstatClienViewData)
			getSingleObject(BUSINESSID_TESCOIDTIPOESTA_QUERY, 
			maeEstatClien.getTescOidTipoEsta(),
			maeEstatClien.getTescOidTipoEsta().clone(),
			"maeTipoEstatClienView"));
		}
		if(maeEstatClien.getEstaOidEstaClie() != null){
			maeEstatClien.setEstaOidEstaClie((es.indra.belcorp.mso.MaeEstatClienViewData)
			getSingleObject(BUSINESSID_ESTAOIDESTACLIE_QUERY, 
			maeEstatClien.getEstaOidEstaClie(),
			maeEstatClien.getEstaOidEstaClie().clone(),
			"maeEstatClienView"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(maeEstatClien);
		loadLeafDependenceCombos(maeEstatClien);
	}
	...
	*/
	...
	protected void loadLocalizationVars(MaeEstatClienData maeEstatClien) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("MAE_ESTAT_CLIEN");
		mmgLocalizationQuery.setEntiPk(maeEstatClien.getId());
