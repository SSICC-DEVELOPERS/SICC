/*
    INDRA/CAR/mmg
    $Id: MaeNegocViewLPStartUp.java,v 1.1 2009/12/03 18:43:08 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class MaeNegocViewLPStartUp extends MMGDruidaBase{
	...
	public static final String BUSINESSID_QUERY = "MMGMaeNegocViewQueryFromToUserPage";
	...
	public MaeNegocViewLPStartUp(){
		super();
	}

	public void inicio() throws Exception {
		pagina("MaeNegocViewPage");
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "MaeNegocViewPage", "cod", "MaeNegocView." + accion + ".label");
			...
			limpiarBotoneraLista("maeNegocView", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codNego", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 9);");
		...
		//asignarAtributo("CAPA", "maeNegocViewLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "MaeNegocViewPage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("MaeNegocViewLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		MaeNegocViewData maeNegocViewQuery= new MaeNegocViewData();
		maeNegocViewQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		MaeNegocViewData datosResult = (MaeNegocViewData)getSingleObject(BUSINESSID_QUERY, maeNegocViewQuery, 
			maeNegocViewQuery.clone(), "maeNegocView");
		...
		preservaHiddensI18n(new Integer(1), "MAE_NEGOC", "maeNegocViewFrm", "Descripcion", true);
		...
		MaeNegocViewData maeNegocView = datosResult;
		asignar("TEXT", "codNego", FormatUtils.formatObject(maeNegocView.getCodNego(), 
		...
		loadLocalizationVars(maeNegocView);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "codNego", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "MAE_NEGOC", "maeNegocViewFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "codNego", "req", "S");
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('maeNegocViewFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "maeNegocViewFrm", "oculto", "N");
		...
		traza("MMG::Creando MaeNegocView");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		MaeNegocViewData maeNegocViewQuery= new MaeNegocViewData();
		maeNegocViewQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(maeNegocView.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"maeNegocViewFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"maeNegocViewFrm\",1, false)");
					asignarAtributo("COMBO","paisOidPais", "ontab", "ejecutarAccionFocoModificacion(\"maeNegocViewFrm\",2, true)");
					asignarAtributo("COMBO","paisOidPais", "onshtab", "ejecutarAccionFocoModificacion(\"maeNegocViewFrm\",2, false)");
				asignarAtributo("AREATEXTO", "codNego", "ontab","ejecutarAccionFocoModificacion(\"maeNegocViewFrm\",3, true)");
				asignarAtributo("AREATEXTO", "codNego", "onshtab","ejecutarAccionFocoModificacion(\"maeNegocViewFrm\",3, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"maeNegocViewFrm\",4, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"maeNegocViewFrm\",4, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","maeNegocViewTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","maeNegocViewTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codNego...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","maeNegocViewFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","maeNegocViewListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","maeNegocViewListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(MaeNegocViewData maeNegocView) throws Exception{
		...
		if(maeNegocView != null && maeNegocView.getPaisOidPais() != null){
				checkCombo("paisOidPais" , maeNegocView.getPaisOidPais().getId().toString());
			}
	...
	* @param maeNegocView La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(MaeNegocViewData maeNegocView) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		MaeNegocViewData maeNegocView = 
			(MaeNegocViewData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(maeNegocView.getPaisOidPais() != null){
			maeNegocView.setPaisOidPais((es.indra.belcorp.mso.SegPaisViewData)
			getSingleObject(BUSINESSID_PAISOIDPAIS_QUERY, 
			maeNegocView.getPaisOidPais(),
			maeNegocView.getPaisOidPais().clone(),
			"segPaisView"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(maeNegocView);
		loadLeafDependenceCombos(maeNegocView);
	}
	...
	*/
	...
	protected void loadLocalizationVars(MaeNegocViewData maeNegocView) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("MAE_NEGOC");
		mmgLocalizationQuery.setEntiPk(maeNegocView.getId());
