...
public class PreArgumVentaPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","preArgumVentaList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","PreArgumVenta.codArguVent.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","PreArgumVenta.Descripcion.label" );
      ...
      ((Element)v.get(17)).setAttribute("cod","PreArgumVenta.tiesOidTipoEstr.label" );
      ...
      ((Element)v.get(18)).setAttribute("cod","PreArgumVenta.valFactRepe.label" );
