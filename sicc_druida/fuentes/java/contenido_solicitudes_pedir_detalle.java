...
public class contenido_solicitudes_pedir_detalle  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_solicitudes_pedir_detalle" );
      ((Element)v.get(0)).setAttribute("cod","0280" );
      ((Element)v.get(0)).setAttribute("titulo","Pedir solicitudes" );
      ...
      v.add(doc.createTextNode("\r   \r\r  function onLoadPag()   {\r    configurarMenuSecundario(\"formulario\");\r    fMostrarMensajeError();\r\r    DrdEnsanchaConMargenDcho('listado1',12);\r    document.all[\"Cplistado1\"].style.visibility='visible';\r    document.all[\"CpLin1listado1\"].style.visibility='visible';\r    document.all[\"CpLin2listado1\"].style.visibility='visible';\r    document.all[\"CpLin3listado1\"].style.visibility='visible';\r    document.all[\"CpLin4listado1\"].style.visibility='visible';\r   \r    document.all[\"primera1Div\"].style.visibility='visible';\r    document.all[\"ret1Div\"].style.visibility='visible';\r    document.all[\"ava1Div\"].style.visibility='visible';\r    document.all[\"separaDiv\"].style.visibility='visible';\r    eval (ON_RSZ);\r  }\r\r\r  function fVolver()  {\r    window.close();\r  }\r\r\r\r \r"));
      ...
      ((Element)v.get(25)).setAttribute("nombre","lblCabeceraSolicitud" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(25)).setAttribute("cod","0088" );
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(29)).setAttribute("width","626" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(49)).setAttribute("nombre","lblFechaSolicitud" );
      ((Element)v.get(49)).setAttribute("alto","13" );
      ((Element)v.get(49)).setAttribute("filas","1" );
      ((Element)v.get(49)).setAttribute("id","datosTitle" );
      ((Element)v.get(49)).setAttribute("cod","1171" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(53)).setAttribute("nombre","lblMontoTotalSolicitud" );
      ((Element)v.get(53)).setAttribute("alto","13" );
      ((Element)v.get(53)).setAttribute("filas","1" );
      ((Element)v.get(53)).setAttribute("id","datosTitle" );
      ((Element)v.get(53)).setAttribute("cod","921" );
      ...
      /* Empieza nodo:56 / Elemento padre: 29   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(29)).appendChild((Element)v.get(56));
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(64)).setAttribute("nombre","lbldtNombreCliente" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(68)).setAttribute("nombre","lbldtCampanaSolicitud" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(72)).setAttribute("nombre","lbldtFechaSolicitud" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(76)).setAttribute("nombre","lbldtMontoTotalSolicitud" );
      ...
      /* Empieza nodo:79 / Elemento padre: 29   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(29)).appendChild((Element)v.get(79));
      ...
      /* Empieza nodo:82 / Elemento padre: 19   */
      v.add(doc.createElement("td"));
      ((Element)v.get(19)).appendChild((Element)v.get(82));
      ...
      /* Empieza nodo:84 / Elemento padre: 11   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(11)).appendChild((Element)v.get(84));
      ...
      ((Element)v.get(91)).setAttribute("ancho","630" );
      ((Element)v.get(91)).setAttribute("alto","317" );
      ((Element)v.get(91)).setAttribute("x","12" );
      ((Element)v.get(91)).setAttribute("y","92" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(99)).setAttribute("cod","0089" );
      ...
      ((Element)v.get(102)).setAttribute("ancho","26" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(105)).setAttribute("ancho","26" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(109)).setAttribute("cod","336" );
      ...
      ((Element)v.get(111)).setAttribute("cod","338" );
      ...
      ((Element)v.get(113)).setAttribute("cod","1172" );
      ...
      ((Element)v.get(115)).setAttribute("cod","1173" );
      ...
      ((Element)v.get(117)).setAttribute("cod","583" );
      ...
      ((Element)v.get(119)).setAttribute("cod","341" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(133)).setAttribute("y","386" );
      ...
      ((Element)v.get(134)).setAttribute("y","409" );
