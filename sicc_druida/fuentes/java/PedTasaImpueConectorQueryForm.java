...
public class PedTasaImpueConectorQueryForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad PedTasaImpue" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGPedTasaImpueQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGPedTasaImpueQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","PedTasaImpueFormFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","valIndiImpu" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(9)).setAttribute("NOMBRE","valTasaImpu" );
