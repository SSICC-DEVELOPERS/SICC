...
public class ConectorGuardarBloqAdm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","CAL Conector guarda Bloq Adm." );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","DTOBloqueoAdm" );
