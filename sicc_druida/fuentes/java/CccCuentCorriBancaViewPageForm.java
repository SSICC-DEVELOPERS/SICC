...
public class CccCuentCorriBancaViewPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","CccCuentCorriBancaView.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","CccCuentCorriBancaView.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('cccCuentCorriBancaViewFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('cccCuentCorriBancaViewFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(50)).setAttribute("nombre","sociOidSociTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lblsociOidSoci" );
      ((Element)v.get(54)).setAttribute("id","datosTitle" );
      ((Element)v.get(54)).setAttribute("ancho","150" );
      ((Element)v.get(54)).setAttribute("alto","13" );
      ((Element)v.get(54)).setAttribute("cod","CccCuentCorriBancaView.sociOidSoci.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(55)).setAttribute("nombre","sociOidSociWidgetTrId" );
      ...
      ((Element)v.get(57)).setAttribute("nombre","sociOidSoci" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('cccCuentCorriBancaViewFrm',2, true);" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('cccCuentCorriBancaViewFrm',2, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(59)).setAttribute("nombre","sociOidSociGapTdId" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(61)).setAttribute("nombre","desCcTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(66)).setAttribute("nombre","desCcWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(68)).setAttribute("nombre","desCc" );
      ...
      ((Element)v.get(68)).setAttribute("ontab","ejecutarAccionFoco('cccCuentCorriBancaViewFrm',4, true)" );
      ((Element)v.get(68)).setAttribute("onshtab","ejecutarAccionFoco('cccCuentCorriBancaViewFrm', 4, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(69)).setAttribute("nombre","desCcGapTdId" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(90)).setAttribute("cod","CccCuentCorriBancaView.paisOidPais.label" );
      ...
      ((Element)v.get(93)).setAttribute("ontab","ejecutarAccionFoco('cccCuentCorriBancaViewFrm',15, true);" );
      ((Element)v.get(93)).setAttribute("onshtab","ejecutarAccionFoco('cccCuentCorriBancaViewFrm',15, false);" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(109)).setAttribute("nombre","cccCuentCorriBancaViewTrButtons" );
      ...
      ((Element)v.get(116)).setAttribute("nombre","cccCuentCorriBancaViewTdQueryButton" );
      ((Element)v.get(115)).appendChild((Element)v.get(116));

      /* Empieza nodo:117 / Elemento padre: 116   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(117)).setAttribute("nombre","cccCuentCorriBancaViewQueryButton" );
      ((Element)v.get(117)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(117)).setAttribute("estado","false" );
      ((Element)v.get(117)).setAttribute("accion","cccCuentCorriBancaViewFirstPage();" );
      ...
      ((Element)v.get(118)).setAttribute("nombre","cccCuentCorriBancaViewTdLovNullSelectionButton" );
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(120)).setAttribute("nombre","cccCuentCorriBancaViewLovNullButton" );
      ((Element)v.get(120)).setAttribute("ID","botonContenido" );
      ((Element)v.get(120)).setAttribute("tipo","html" );
      ((Element)v.get(120)).setAttribute("accion","cccCuentCorriBancaViewLovNullSelectionAction();" );
