...
public class FacTipoImpreConectorQueryForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad FacTipoImpre" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGFacTipoImpreQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGFacTipoImpreQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","FacTipoImpreFormFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","valNombPrinSend" );
