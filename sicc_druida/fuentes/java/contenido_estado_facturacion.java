...
public class contenido_estado_facturacion  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_estado_facturacion" );
      ((Element)v.get(0)).setAttribute("cod","0790" );
      ...
      v.add(doc.createTextNode("\r   \r   \r   function loadPag(){\r      configurarMenuSecundario('Formulario');\r      focaliza('Formulario.cbMarca');\r   }\r\r     function quitarItemVacio(elemento){\r      var elementoADevolver = new Array();\r     \r      for(var k=0;k<elemento.length;k++) {\r          if (elemento[k] != ''){                            \r             elementoADevolver[elementoADevolver.length] = elemento[k];\r          }\r      }\r         \r      return elementoADevolver;\r      \r   }\r\r   function generar(){\r      if(sicc_validaciones_generales()){\r          /*recolectarParametros();\r          set('Formulario.conectorAction', 'FACEstadoFacturacionAlDia');           \r          set('Formulario.accion', 'generar');\r          enviaSICC('Formulario');*/\r          var a = new Object();\r          a.accion = 'generar';\r          a.marca = get('Formulario.cbMarca');\r          a.canal = get('Formulario.cbCanal');\r          a.periodos = get('Formulario.cbPeriodo');\r          a.accesos = get('Formulario.cbAcceso');\r    \r          a.unidNegocio = quitarItemVacio(get('Formulario.cbUnidadNegocio'));\r          a.negocio = quitarItemVacio(get('Formulario.cbNegocio')); \r          mostrarModalSICC('FACEstadoFacturacionAlDia','generar', a);  \r      }\r\r   }\r\r   function recolectarParametros(){     \r      set('Formulario.marca', get('Formulario.cbMarca'));\r      set('Formulario.canal', get('Formulario.cbCanal'));\r      set('Formulario.periodos', get('Formulario.cbPeriodo'));\r      set('Formulario.accesos', get('Formulario.cbAcceso'));\r\r      set('Formulario.unidNegocio', get('Formulario.cbUnidadNegocio'));\r      set('Formulario.negocio', get('Formulario.cbNegocio'));\r   }\r\r\r   function fLimpiar(){\r      var aCombo = new Array(new Array(\"\",\"\"));\r      set_combo('Formulario.cbPeriodo', aCombo, []);\r      set_combo('Formulario.cbAcceso', aCombo, []);\r      \r      focaliza('Formulario.cbMarca'); \r   }\r\r    function onchangeMarcaCanal(){\r      	tipoM = get('Formulario.cbMarca','V');\r		tipoC = get('Formulario.cbCanal','V');\r		pais   = get('Formulario.pais');\r	    idioma = get('Formulario.idioma');\r		var aCombo = new Array(new Array(\"\",\"\"));\r		if(tipoM != '' && tipoC != ''){\r			 var arr = new Array();\r			 arr[arr.length] = [\"oidIdioma\", idioma]; \r			 arr[arr.length] = [\"oidPais\", pais]; \r			 arr[arr.length] = [\"marca\", tipoM];\r			 arr[arr.length] = [\"canal\", tipoC];\r			 set_combo('Formulario.cbPeriodo', aCombo, []); \r			 recargaCombo(\"Formulario.cbPeriodo\",\"PRECargarPeriodos\",\"es.indra.sicc.dtos.cra.DTOPeriodo\",arr);\r		} else {\r			 set_combo('Formulario.cbPeriodo', aCombo, []); \r		}\r    } \r    function onchangeCanal(){\r      onchangeMarcaCanal();\r      cargaAccesos();\r    }\r\r    function cargaAccesos(){\r        \r       canal  = get('Formulario.cbCanal');\r       pais   = get('Formulario.pais');\r       idioma = get('Formulario.idioma');\r	   var aCombo = new Array(new Array(\"\",\"\"));\r        \r       if(canal != ''){\r		   set_combo('Formulario.cbAcceso', aCombo, []);\r       \r          var arr = new Array();\r               \r          arr[arr.length] = [\"oidIdioma\", idioma]; \r          arr[arr.length] = [\"oidPais\", pais]; \r                    arr[arr.length] = [\"oid\", canal];\r             \r          recargaCombo(\"Formulario.cbAcceso\",\"SEGObtieneAccesosPorCanal\",\"es.indra.sicc.util.DTOOID\",arr);\r       }else{\r          set_combo('Formulario.cbAcceso', aCombo, []);\r       }\r    } \r        function arrayComponentes(){\r              var arr = new Array();\r              arr[arr.length]= new Array(\"cbMarca\",\"\");\r              arr[arr.length]= new Array(\"cbCanal\",\"\");\r              arr[arr.length]= new Array(\"cbPeriodo\",\"\");\r              arr[arr.length]= new Array(\"cbAcceso\",\"\");\r	      arr[arr.length]= new Array(\"cbUnidadNegocio\",\"\");\r	      arr[arr.length]= new Array(\"cbNegocio\",\"\");\r\r              arr[arr.length]= new Array(\"btnGenerarInforme\",\"BOTON\");\r              \r              return arr;\r          }\r\r          function tabGenerico(nombreComp, tipotab){       \r            var arr = arrayComponentes();\r            var tabular = false;\r            var nombreFormulario = getFormularioSICC();\r            var j = 0;\r            var k = arr.length;\r            if (tipotab != \"sh\") {\r                j = j-1;                \r                k = k-1;\r            }\r\r            while(j<k){\r                var t;\r                if(tipotab == \"sh\"){\r                  k--;\r                  t = k;\r                } else{\r                  j++;\r                  t = j;                  \r                }\r                  \r                var nombre = arr[t][0];\r                var tipo = arr[t][1];\r                if (tabular==false){\r                  if (nombreComp==nombre){\r                      tabular=true;\r                      if (tipotab == \"sh\"){\r                        if (k==0) k= arr.length;\r                      } else {\r                        if ((j+1)==arr.length)  j = -1;\r                      }\r                  }                \r                } else {\r                  try {\r                    var name = nombreFormulario+\".\"+nombre;\r                    if (tipo==\"BOTONXY\"){\r                       focalizaBotonHTML_XY(nombre);\r                    } else if (tipo==\"BOTON\") {\r                       focalizaBotonHTML(\"botonContenido\",nombre)\r                    } else {\r                       focaliza(name);\r                    }\r                    return;\r                  } catch (e) {\r                  }\r                }\r            }\r          } \r\r   \r"));
      ...
      ((Element)v.get(12)).setAttribute("valor","FACEstadoFacturacionAlDia" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(22)).setAttribute("nombre","unidNegocio" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(23)).setAttribute("nombre","negocio" );
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(42)).setAttribute("colspan","7" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(64)).setAttribute("onchange","onchangeCanal();" );
   ...
   private void getXML270(Document doc) {
      v.add(doc.createElement("td"));
      ((Element)v.get(69)).setAttribute("colspan","7" );
      ...
      ((Element)v.get(87)).setAttribute("ontab","tabGenerico('cbPeriodo');" );
      ((Element)v.get(87)).setAttribute("onshtab","tabGenerico('cbPeriodo','sh');" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(92)).setAttribute("ontab","tabGenerico('cbAcceso');" );
      ((Element)v.get(92)).setAttribute("onshtab","tabGenerico('cbAcceso','sh');" );
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(97)).setAttribute("colspan","7" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(115)).setAttribute("nombre","cbUnidadNegocio" );
      ...
      ((Element)v.get(115)).setAttribute("ontab","tabGenerico('cbUnidadNegocio');" );
      ((Element)v.get(115)).setAttribute("onshtab","tabGenerico('cbUnidadNegocio','sh');" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(120)).setAttribute("nombre","cbNegocio" );
      ...
      ((Element)v.get(120)).setAttribute("ontab","tabGenerico('cbNegocio');" );
      ((Element)v.get(120)).setAttribute("onshtab","tabGenerico('cbNegocio','sh');" );
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(125)).setAttribute("colspan","7" );
      ...
      /* Empieza nodo:127 / Elemento padre: 33   */
      v.add(doc.createElement("td"));
      ((Element)v.get(33)).appendChild((Element)v.get(127));
      ...
      /* Empieza nodo:129 / Elemento padre: 25   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(25)).appendChild((Element)v.get(129));
      ...
      ((Element)v.get(137)).setAttribute("nombre","btnGenerarInforme" );
      ((Element)v.get(137)).setAttribute("ID","botonContenido" );
      ((Element)v.get(137)).setAttribute("tipo","html" );
   }

   private void getXML540(Document doc) {
      ((Element)v.get(137)).setAttribute("accion","generar();" );
      ((Element)v.get(137)).setAttribute("estado","false" );
      ((Element)v.get(137)).setAttribute("cod","2495" );
      ((Element)v.get(137)).setAttribute("ontab","tabGenerico('btnGenerarInforme');" );
      ((Element)v.get(137)).setAttribute("onshtab","tabGenerico('btnGenerarInforme','sh');" );
      ...
      /* Empieza nodo:147 / Elemento padre: 10   */
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(147)).setAttribute("nombre","capaPeriodo" );
      ((Element)v.get(147)).setAttribute("alto","3" );
      ((Element)v.get(147)).setAttribute("ancho","624" );
      ...
      ((Element)v.get(147)).setAttribute("y","165" );
      ((Element)v.get(147)).setAttribute("zindex","" );
      ((Element)v.get(10)).appendChild((Element)v.get(147));

      /* Empieza nodo:148 / Elemento padre: 147   */
      v.add(doc.createElement("LISTA"));
      ((Element)v.get(148)).setAttribute("seleccion","boton" );
      ((Element)v.get(148)).setAttribute("nombre","lstPeriodo" );
      ((Element)v.get(148)).setAttribute("x","12" );
      ((Element)v.get(148)).setAttribute("y","10" );
      ((Element)v.get(148)).setAttribute("ancho","600" );
      ((Element)v.get(148)).setAttribute("alto","3" );
      ((Element)v.get(148)).setAttribute("multisel","-1" );
      ((Element)v.get(148)).setAttribute("incy","10" );
      ((Element)v.get(148)).setAttribute("incx","10" );
      ((Element)v.get(148)).setAttribute("colorf","#EFEFEF" );
      ((Element)v.get(148)).setAttribute("imagenoff","close_no.gif" );
      ((Element)v.get(148)).setAttribute("imagenon","close_up.gif" );
      ((Element)v.get(148)).setAttribute("accion","" );
      ((Element)v.get(148)).setAttribute("sep","|" );
      ((Element)v.get(148)).setAttribute("pixelsborde","2" );
      ((Element)v.get(148)).setAttribute("colorborde","#CCCCCC" );
      ((Element)v.get(147)).appendChild((Element)v.get(148));

      /* Empieza nodo:149 / Elemento padre: 148   */
      v.add(doc.createElement("CABECERA"));
      ((Element)v.get(149)).setAttribute("nombre","cab1" );
      ((Element)v.get(149)).setAttribute("height","20" );
      ((Element)v.get(148)).appendChild((Element)v.get(149));

      /* Empieza nodo:150 / Elemento padre: 149   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(150)).setAttribute("id","datosCamposCabecera" );
      ((Element)v.get(150)).setAttribute("ancho","40" );
