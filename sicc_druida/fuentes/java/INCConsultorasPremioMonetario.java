...
public class INCConsultorasPremioMonetario extends LPSICCBase {

  public INCConsultorasPremioMonetario() {
  ...
  public void ejecucion() throws Exception {
    ...
    try {
      ...
      if (accion.equals("generar")){
        ...
        cargarPagina();
        getConfiguracionMenu("INCConsultorasPremioMonetario");
      }
  ...
  private void cargarPagina() throws Exception{
    ...
    pagina("contenido_informe_premios_monetarios_generar");   
  ...
  private void generarReporte() throws Exception{
    ...
    datos.put(ConstantesREP.TITULO, "Relacion Consultoras con Premios Monetarios");
    ...
    ejecutarReporte2(datos, "REPGenerarReporteBatch", "RD_REP-080", formato);
