...
public class CCCConsolidadoCobranza extends LPSICCBase {           
   public CCCConsolidadoCobranza() {	 
     super();
  }
     ...
     try {
        ...
        if (accion.equals("generar")){
          ...
          //cargarPagina();
           ...
           cargarPagina();
           getConfiguracionMenu("CCCConsolidadoCobranza");
        }
  ...
  private void cargarPagina() throws Exception{
     pagina("contenido_informe_consolidado_cobranza_generar");   
 ...
 private void generarReporte() throws Exception{
     ...
     if(vista.equals("1")){
        reporte = "RD_REP-136";
		  ...
		  if(vista.equals("2")){
			  reporte = "RD_REP-136_01";
  	      }else{
		     if(vista.equals("3")){
		        reporte = "RD_REP-136_02";
			 }else{
			    reporte = "RD_REP-136_03";
			 }
		  }
     }
...
//     datos.put(ConstantesREP.TITULO, "Consolidado de Cobranza");     
     datos.put(ConstantesREP.TITULO, "Resumen diario importes y registros");     // Inc. BELC300022611
