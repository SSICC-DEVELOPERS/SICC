...
public class PreIndicCuadrPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","PreIndicCuadr.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","PreIndicCuadr.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('preIndicCuadrFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('preIndicCuadrFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(50)).setAttribute("nombre","codIndiCuadTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lblCodIndiCuad" );
      ((Element)v.get(54)).setAttribute("alto","13" );
      ((Element)v.get(54)).setAttribute("filas","1" );
      ((Element)v.get(54)).setAttribute("id","datosTitle" );
      ((Element)v.get(54)).setAttribute("cod","PreIndicCuadr.codIndiCuad.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(55)).setAttribute("nombre","codIndiCuadWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(57)).setAttribute("nombre","codIndiCuad" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('preIndicCuadrFrm',2, true)" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('preIndicCuadrFrm', 2, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(58)).setAttribute("nombre","codIndiCuadGapTdId" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(64)).setAttribute("cod","PreIndicCuadr.Descripcion.label" );
      ...
      ((Element)v.get(68)).setAttribute("ontab","ejecutarAccionFoco('preIndicCuadrFrm',3, true)" );
      ((Element)v.get(68)).setAttribute("onshtab","ejecutarAccionFoco('preIndicCuadrFrm', 3, false)" );
      ...
      ((Element)v.get(72)).setAttribute("href","javascript:openLocalizationDialog('preIndicCuadrFrm', 'Descripcion', 1);" );
      ((Element)v.get(72)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"preIndicCuadrFrm\",3, true)', 'ejecutarAccionFoco(\"preIndicCuadrFrm\",3, false)')" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(76)).setAttribute("nombre","valFactCuadTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(81)).setAttribute("nombre","valFactCuadWidgetTrId" );
      ...
      ((Element)v.get(83)).setAttribute("nombre","valFactCuad" );
      ...
      ((Element)v.get(83)).setAttribute("ontab","ejecutarAccionFoco('preIndicCuadrFrm',4, true)" );
      ((Element)v.get(83)).setAttribute("onshtab","ejecutarAccionFoco('preIndicCuadrFrm',4, false)" );
      ((Element)v.get(82)).appendChild((Element)v.get(83));

      /* Empieza nodo:84 / Elemento padre: 83   */
      v.add(doc.createElement("RBINPUT"));
      ((Element)v.get(84)).setAttribute("id","datosCampos" );
      ((Element)v.get(84)).setAttribute("valor","U" );
      ((Element)v.get(84)).setAttribute("cod","PreIndicCuadr.valFactCuad.U.label" );
      ...
      ((Element)v.get(86)).setAttribute("valor","M" );
      ((Element)v.get(86)).setAttribute("cod","PreIndicCuadr.valFactCuad.M.label" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(88)).setAttribute("nombre","valFactCuadGapTdId" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(102)).setAttribute("nombre","preIndicCuadrTrButtons" );
      ...
      ((Element)v.get(109)).setAttribute("nombre","preIndicCuadrTdQueryButton" );
      ((Element)v.get(108)).appendChild((Element)v.get(109));

      /* Empieza nodo:110 / Elemento padre: 109   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(110)).setAttribute("nombre","preIndicCuadrQueryButton" );
      ((Element)v.get(110)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(110)).setAttribute("estado","false" );
      ((Element)v.get(110)).setAttribute("accion","preIndicCuadrFirstPage();" );
      ...
      ((Element)v.get(111)).setAttribute("nombre","preIndicCuadrTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(113)).setAttribute("nombre","preIndicCuadrLovNullButton" );
      ((Element)v.get(113)).setAttribute("ID","botonContenido" );
      ((Element)v.get(113)).setAttribute("tipo","html" );
      ((Element)v.get(113)).setAttribute("accion","preIndicCuadrLovNullSelectionAction();" );
