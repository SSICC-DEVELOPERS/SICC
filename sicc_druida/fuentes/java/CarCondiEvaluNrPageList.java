...
public class CarCondiEvaluNrPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","carCondiEvaluNrList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","CarCondiEvaluNr.penrOidParaEvalNr.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","CarCondiEvaluNr.valMini.label" );
      ...
      ((Element)v.get(17)).setAttribute("cod","CarCondiEvaluNr.valMaxi.label" );
      ...
      ((Element)v.get(18)).setAttribute("cod","CarCondiEvaluNr.valEscaMini.label" );
