...
public class MaeEncueAplicClienConectorQueryList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad MaeEncueAplicClien" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGMaeEncueAplicClienQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGMaeEncueAplicClienQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","MaeEncueAplicClienListFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(8)).setAttribute("NOMBRE","reenOidResp" );
