...
public class contenido_unidades_administrativas_clientes  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_unidades_administrativas_clientes" );
      ((Element)v.get(0)).setAttribute("cod","0737" );
      ((Element)v.get(0)).setAttribute("titulo","Clientes que cambian unidades administrativas" );
      ...
      v.add(doc.createTextNode("\r   \r   \r   function onLoad(){\r      configurarMenuSecundario('Formulario');\r      fMostrarMensajeError();\r      focaliza('Formulario.cbMarca');\r   }\r   function generar(){\r      \r      if(sicc_validaciones_generales()){\r       \r        var a = new Object();\r        a.accion = 'generar';\r        a.marca = get('Formulario.cbMarca');\r        a.marcaDesc = get('Formulario.cbMarca', 'T');\r        a.canal = get('Formulario.cbCanal');\r        a.canalDesc = get('Formulario.cbCanal', 'T');\r        a.sgv = get('Formulario.cbSubgerenciaVentas');\r        a.region = get('Formulario.cbRegion');\r        a.zona = get('Formulario.cbZona');\r        a.codigoCliente = get('Formulario.txtCodCliente');\r        a.periodoDesde = get('Formulario.cbPeriodoDesde');\r        a.periodoHasta = get('Formulario.cbPeriodoHasta');         \r        mostrarModalSICC('LPClientesCambioUA','generar', a);  \r      }\r\r   }\r   function recolectarParametros(){\r      \r      set('Formulario.marca', get('Formulario.cbMarca') );\r      set('Formulario.canal', get('Formulario.cbCanal'));\r      set('Formulario.sgv', get('Formulario.cbSubgerenciaVentas'));\r      set('Formulario.region', get('Formulario.cbRegion'));\r      set('Formulario.zona', get('Formulario.cbZona'));\r      set('Formulario.codigoCliente', get('Formulario.txtCodCliente'));\r      set('Formulario.periodoDesde', get('Formulario.cbPeriodoDesde'));\r      set('Formulario.periodoHasta', get('Formulario.cbPeriodoHasta'));\r      \r    \r  \r   }\r   \r   \r   function recargaSGV(){\r      var marca = get(\"Formulario.cbMarca\");\r      var canal = get(\"Formulario.cbCanal\");\r      var pais = get(\"Formulario.pais\");\r                 \r      var arr = new Array();\r      var arr2 = new Array();\r            \r      arr[arr.length] = [\"oidPais\", pais]; \r      arr[arr.length] = [\"marca\", marca];\r      arr[arr.length] = [\"canal\", canal];\r          \r      arr2[arr2.length] = [\"oidMarca\", marca]; \r      arr2[arr2.length] = [\"oidCanal\", canal]; \r	  arr2[arr2.length] = [\"oidPais\", pais]; \r      \r      if ( marca != \"\" && canal != \"\"){\r         recargaCombo(\"Formulario.cbSubgerenciaVentas\",\"ZONRecargaSubgerenciaVentas\", \"es.indra.sicc.dtos.zon.DTOUnidadAdministrativa\",arr2);\r         recargaCombo(\"Formulario.cbPeriodoDesde\",\"PRECargarPeriodos\",\"es.indra.sicc.dtos.cra.DTOPeriodo\",arr);\r         recargaCombo(\"Formulario.cbPeriodoHasta\",\"PRECargarPeriodos\",\"es.indra.sicc.dtos.cra.DTOPeriodo\",arr);\r      }else{\r      \r         var aCombo = new Array(new Array(\"\",\"\"));\r         set_combo('Formulario.cbSubgerenciaVentas', aCombo, []);\r         set_combo('Formulario.cbPeriodoDesde', aCombo, []);\r         set_combo('Formulario.cbPeriodoHasta', aCombo, []);\r         \r         limpiar('1') ;\r      \r      }\r   }\r\r   function onchangeSgv(){\r      limpiar('1');  \r      if(get('Formulario.cbSubgerenciaVentas') != ''){\r         recargaCombo(\"Formulario.cbRegion\",\"ZONRecargaRegiones\", \"es.indra.sicc.dtos.zon.DTOUnidadAdministrativa\",[[\"oidSGV\", get('Formulario.cbSubgerenciaVentas')]]);        \r      }\r   \r   }\r    function onchange_Region(){\r        limpiar('2');\r \r        if(get('Formulario.cbRegion') != ''){\r             recargaCombo('Formulario.cbZona', 'ZONRecargaZonas', 'es.indra.sicc.dtos.zon.DTOUnidadAdministrativa',[[ \"oidRegion\", get('Formulario.cbRegion') ]] );\r        }\r    }\r\r\r\r\r  function limpiar(param){\r     var aCombo = new Array(new Array(\"\",\"\"));\r     \r     if(param == '1'){\r        set_combo('Formulario.cbRegion', aCombo, []);\r        set_combo('Formulario.cbZona', aCombo, []);\r     }\r     \r     if(param == '2'){\r        set_combo('Formulario.cbZona', aCombo, []);\r       \r     }\r   \r  }\r  function fLimpiar(){\r     var aCombo = new Array(new Array(\"\",\"\"));\r     set_combo('Formulario.cbSubgerenciaVentas', aCombo, []);\r     limpiar('1') ;\r  }\r  \r\r  function clienteOnBlur() {\r\r        var longiCod = get('Formulario.hLongCliente');\r        var elTexto  = get('Formulario.txtCodCliente');\r\r        if(elTexto.length!=0){\r           var faltantes = longiCod -  elTexto.length;\r           var resultCod = new String(\"\");\r           if(faltantes > 0){\r              for(var t = 0 ; t<faltantes; t++){\r                  resultCod = resultCod + \"0\";\r              }\r         }\r         resultCod = resultCod + elTexto;\r         set('Formulario.txtCodCliente', resultCod);\r        }\r             \r   }\r  \r    function buscarCliente(){ \r      var obj = new Object();\r\r      var whnd = mostrarModalSICC('LPBusquedaRapidaCliente','',obj);\r    \r      if(whnd==null){\r               }else{\r         var cod = whnd[1];\r                  set('Formulario.txtCodCliente', cod)\r      }		\r   }\r   \r   \r  \r  \r  \r"));
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(24)).setAttribute("nombre","codigoCliente" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(25)).setAttribute("nombre","periodoDesde" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(26)).setAttribute("nombre","periodoHasta" );
   ...
   private void getXML180(Document doc) {
      ...
      /* Empieza nodo:65 / Elemento padre: 47   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(47)).appendChild((Element)v.get(65));
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(86)).setAttribute("nombre","cbMarca" );
      ...
      ((Element)v.get(86)).setAttribute("onchange","recargaSGV();" );
      ((Element)v.get(86)).setAttribute("onshtab","focalizaBotonHTML('botonContenido','btnGenerarInforme')" );
      ...
      ((Element)v.get(91)).setAttribute("onchange","recargaSGV();" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(116)).setAttribute("nombre","cbSubgerenciaVentas" );
      ...
      ((Element)v.get(116)).setAttribute("onchange","onchangeSgv();" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(121)).setAttribute("nombre","cbRegion" );
      ...
      ((Element)v.get(121)).setAttribute("onchange","onchange_Region();" );
      ...
      /* Empieza nodo:128 / Elemento padre: 44   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(44)).appendChild((Element)v.get(128));
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(143)).setAttribute("nombre","lblPeriodoDesde" );
      ...
      ((Element)v.get(143)).setAttribute("cod","1175" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(147)).setAttribute("nombre","lblPeriodoHasta" );
      ...
      ((Element)v.get(147)).setAttribute("cod","1176" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(154)).setAttribute("nombre","cbZona" );
   ...
   private void getXML630(Document doc) {
      ...
      ((Element)v.get(163)).setAttribute("onclick","buscarCliente();" );
      ...
      ((Element)v.get(166)).setAttribute("valign","bottom" );
      ((Element)v.get(150)).appendChild((Element)v.get(166));

      /* Empieza nodo:167 / Elemento padre: 166   */
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(167)).setAttribute("nombre","cbPeriodoDesde" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(172)).setAttribute("nombre","cbPeriodoHasta" );
      ...
      /* Empieza nodo:174 / Elemento padre: 150   */
      v.add(doc.createElement("td"));
      ((Element)v.get(174)).setAttribute("width","100%" );
      ((Element)v.get(150)).appendChild((Element)v.get(174));
      ...
      /* Empieza nodo:176 / Elemento padre: 130   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(130)).appendChild((Element)v.get(176));
      ...
      /* Empieza nodo:179 / Elemento padre: 37   */
      v.add(doc.createElement("td"));
      ((Element)v.get(37)).appendChild((Element)v.get(179));
   ...
   private void getXML720(Document doc) {
      ...
      ((Element)v.get(189)).setAttribute("nombre","btnGenerarInforme" );
      ((Element)v.get(189)).setAttribute("ID","botonContenido" );
      ((Element)v.get(189)).setAttribute("tipo","html" );
      ((Element)v.get(189)).setAttribute("accion","generar();" );
      ((Element)v.get(189)).setAttribute("estado","false" );
      ((Element)v.get(189)).setAttribute("cod","2495" );
      ((Element)v.get(189)).setAttribute("ontab","focaliza('Formulario.cbMarca')" );
      ...
      /* Empieza nodo:192 / Elemento padre: 29   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(29)).appendChild((Element)v.get(192));
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(195)).setAttribute("width","756" );
