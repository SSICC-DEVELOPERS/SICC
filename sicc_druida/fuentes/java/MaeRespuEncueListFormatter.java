...
/*
    INDRA/CAR/mmg
    $Id: MaeRespuEncueListFormatter.java,v 1.1 2009/12/03 18:36:50 pecbazalar Exp $
    DESC
*/
 ...
 * @author Indra
 */
public class MaeRespuEncueListFormatter extends MMGDruidaFormatoObjeto {
	
	public MaeRespuEncueListFormatter() {
	}
	...
	public void formatea(String s, Object obj) throws Exception {
		...
		for (int i = 0; i < maeRespuEncueList.size(); i++) {
			...
			row.add((maeRespuEncueData.getPrenOidPreg() != null ? 
				FormatUtils.formatObject(maeRespuEncueData.getPrenOidPreg(), 
