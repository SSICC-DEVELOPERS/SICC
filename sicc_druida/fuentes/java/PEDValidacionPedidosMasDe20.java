...
public class PEDValidacionPedidosMasDe20 extends LPSICCBase {   
  
   Long pais = null;
   Long idioma = null;

   public PEDValidacionPedidosMasDe20() {	 
     super();
   }
   ...
   public void ejecucion() throws Exception {		
      ...
      try {
         ...
         if (accion.equals("generar")){
            ...
            traza("c. inicial...............");
            cargarPagina();
            getConfiguracionMenu("PEDValidacionPedidosMasDe20");
         }
   ...
   private void cargarPagina() throws Exception{
      traza("seteo pagina");
      pagina("contenido_informe_validacion_pedidos_generar");   
	  traza("setie pagina");
  ...
  private void generarReporte() throws Exception{
     ...
     datos.put(ConstantesREP.TITULO, "Validación de Pedidos con más de 20 unidades");
          
     traza("++++++Antes de enviar a reportes " + datos); 
   //  ejecutarReporte(datos, "REPGenerarReporte", "RD_REP-017", null);
     ejecutarReporte2(datos, "REPGenerarReporteBatch", "RD_REP-017", "pdf");
  }
