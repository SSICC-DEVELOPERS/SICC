/*
    INDRA/CAR/mmg
    $Id: SegMarcaLPStartUp.java,v 1.1 2009/12/03 18:38:44 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class SegMarcaLPStartUp extends MMGDruidaBase{
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "SegMarcaPage", "cod", "SegMarca." + accion + ".label");
			...
			limpiarBotoneraLista("segMarca", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codMarc", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 3);");
		asignarAtributo("TEXT", "desMarc", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 30);");
		
		//Primero determianmos el nombre del campo en la entidad de oriegen donde se van a cargar los datos
		asignar("VAR", "idAttributeLovOpener", conectorParametro(PARAMETRO_LOV_ATTRIBUTO));
		asignar("VAR", "idEntityLovOpener", conectorParametro(PARAMETRO_LOV_ENTIDAD));
		//asignarAtributo("CAPA", "segMarcaLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "SegMarcaPage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("SegMarcaLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		SegMarcaData segMarcaQuery= new SegMarcaData();
		segMarcaQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		SegMarcaData datosResult = (SegMarcaData)getSingleObject(BUSINESSID_QUERY, segMarcaQuery, 
			segMarcaQuery.clone(), "segMarca", false);
		...
		SegMarcaData segMarca = datosResult;
		asignar("TEXT", "codMarc", FormatUtils.formatObject(segMarca.getCodMarc(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "desMarc", FormatUtils.formatObject(segMarca.getDesMarc(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		asignarAtributo("TEXT", "codMarc", "disabled", "S");
		asignarAtributo("TEXT", "desMarc", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		...
		asignarAtributo("TEXT", "codMarc", "req", "S");
		asignarAtributo("TEXT", "desMarc", "req", "S");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "segMarcaFrm", "oculto", "N");
		...
		traza("MMG::Creando SegMarca");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		SegMarcaData segMarcaQuery= new SegMarcaData();
		segMarcaQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(segMarca.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"segMarcaFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"segMarcaFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codMarc", "ontab","ejecutarAccionFocoModificacion(\"segMarcaFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codMarc", "onshtab","ejecutarAccionFocoModificacion(\"segMarcaFrm\",2, false)");
				asignarAtributo("AREATEXTO", "desMarc", "ontab","ejecutarAccionFocoModificacion(\"segMarcaFrm\",3, true)");
				asignarAtributo("AREATEXTO", "desMarc", "onshtab","ejecutarAccionFocoModificacion(\"segMarcaFrm\",3, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","segMarcaTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","segMarcaTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","segMarcaFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","segMarcaListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","segMarcaListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(SegMarcaData segMarca) throws Exception{
	...
	* @param segMarca La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(SegMarcaData segMarca) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		SegMarcaData segMarca = 
			(SegMarcaData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(segMarca);
		loadLeafDependenceCombos(segMarca);
	}
