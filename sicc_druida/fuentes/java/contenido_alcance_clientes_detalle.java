...
public class contenido_alcance_clientes_detalle  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_alcance_clientes_detalle" );
      ((Element)v.get(0)).setAttribute("cod","0644" );
      ((Element)v.get(0)).setAttribute("titulo","Ingresar valores descuentos" );
      ...
      v.add(doc.createTextNode("\r   \r\r        function onLoadPag(){\r   		configurarMenuSecundario('formulario');\r		fMostrarMensajeError();\r	        accion('formulario.txtCodCliente','.readOnly=false');\r	        focaliza('formulario.txtCodCliente');\r	 }\r\r       	 function asignarDatosCliente(oidClie, codClie, nombUsua, nombUsua2, apeUsua, apeUsua2){\r\r                var vNombre = nombUsua + ' ' + nombUsua2;\r                var vApellido = apeUsua + ' ' + apeUsua2;\r\r		set(\"formulario.hidOidCliente\", oidClie);\r		set(\"formulario.codCliente\", codClie);\r		set(\"formulario.nombre\", vNombre);\r		set(\"formulario.apellido\", vApellido);\r		set(\"formulario.txtCodCliente\", codClie);\r		focaliza('formulario.txtDescuento');\r\r	 }\r		\r	 function codClienteRellenar(){\r	   \r	   var value = get(\"formulario.txtCodCliente\");\r	   var longmax = get(\"formulario.hidLongCliente\");\r	   var long = get(\"formulario.txtCodCliente\");\r\r	   set(\"formulario.txtCodCliente\",rellenaCeros(value,longmax,long.length));\r\r	       \r  	       eval('formulario').oculto = 'S';\r               set(\"formulario.accion\", \"busquedaRapidaOculta\");\r               set('formulario.conectorAction','LPMantenimientoAlcanceCliente');\r	       enviaSICC('formulario','','','S');\r				\r	 }\r\r	 function buscar(){\r			var obj = new Object();\r			obj.hidOidDescuento = get('formulario.hidOidDescuento');\r			var whnd = mostrarModalSICC('LPBusquedaRapidaCliente','',obj);\r			if(whnd==null){\r							}else{\r				var cod = whnd[1];\r                var vNombre = whnd[2] + ' ' + whnd[3];\r                var vApellido = whnd[4] + ' ' + whnd[5];\r                \r				set(\"formulario.hidOidCliente\",whnd[0]);\r				set(\"formulario.codCliente\",whnd[1]);\r				set(\"formulario.nombre\", vNombre);\r				set(\"formulario.apellido\",vApellido);\r				set(\"formulario.txtCodCliente\", cod);\r			}\r			focaliza('formulario.txtDescuento');\r		}\r\r	function accionAceptar() {\r        if(sicc_validaciones_generales()){\r            if((get(\"formulario.txtDescuento\")!=\"\") && (get(\"formulario.txtImporteFijoDto\")!=\"\")){\r                                                        GestionarMensaje(\"1387\",null,null,null);\r            }else \r                if((get(\"formulario.txtDescuento\")==\"\") && (get(\"formulario.txtImporteFijoDto\")==\"\")){\r                        GestionarMensaje(\"1387\",null,null,null);\r                        focaliza('formulario.txtDescuento');\r		}else{\r\r                    var arrDatosClte = new Array();\r\r		    arrDatosClte[0] = get(\"formulario.hidOidCliente\");\r		    arrDatosClte[1] = get(\"formulario.codCliente\");\r		    arrDatosClte[2] = get(\"formulario.nombre\");\r		    arrDatosClte[3] = get(\"formulario.apellido\");\r		    arrDatosClte[4] = get(\"formulario.txtDescuento\")\r		    arrDatosClte[5] = get(\"formulario.txtImporteFijoDto\")\r\r	            returnValue = arrDatosClte;   \r		    close(); \r                }\r        }\r		 \r    }\r\r	function errorClienteBusqueda(){\r				set(\"formulario.txtCodCliente\", '');\r		focaliza('formulario.txtCodCliente');\r	}\r	 \r	 function cerrar(){\r	        var arr = new Array();   \r            arr[0] = get(\"formulario.hidOidCliente\");            \r			arr[1] = get(\"formulario.txtCodCliente\");\r            arr[2] = get(\"formulario.nombre\");\r            arr[3] = get(\"formulario.apellido\");\r            arr[4] = get(\"formulario.txtDescuento\");\r            arr[5] = get(\"formulario.txtImporteFijoDto\");\r            returnValue = arr;   \r            close(); \r	 }\r\r     function fVolver(){\r        window.close();\r     }\r     \r     function fGuardar()\r     {\r        accionAceptar();\r     }\r     \r	 \r	   \r"));
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(12)).setAttribute("nombre","hidOidCliente" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(13)).setAttribute("nombre","codCliente" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(15)).setAttribute("nombre","apellido" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(16)).setAttribute("nombre","hidPorcentajeDescuento" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(18)).setAttribute("nombre","hidOidDescuento" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(19)).setAttribute("nombre","hidIdioma" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(20)).setAttribute("nombre","hidLongCliente" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(36)).setAttribute("nombre","lblDatosCliente" );
      ((Element)v.get(36)).setAttribute("alto","13" );
      ((Element)v.get(36)).setAttribute("filas","1" );
      ((Element)v.get(36)).setAttribute("valor","" );
      ((Element)v.get(36)).setAttribute("cod","0091" );
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(40)).setAttribute("width","320" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(52)).setAttribute("nombre","lblDescuento" );
      ((Element)v.get(52)).setAttribute("alto","13" );
      ((Element)v.get(52)).setAttribute("filas","1" );
      ((Element)v.get(52)).setAttribute("valor","" );
      ((Element)v.get(52)).setAttribute("id","datosTitle" );
      ((Element)v.get(52)).setAttribute("cod","341" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(56)).setAttribute("nombre","lblImporteFijoDto" );
      ...
      ((Element)v.get(56)).setAttribute("cod","898" );
      ...
      ((Element)v.get(57)).setAttribute("colspan","2" );
      ...
      ((Element)v.get(63)).setAttribute("onchange","codClienteRellenar()" );
      ...
      ((Element)v.get(67)).setAttribute("onclick","buscar();" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(71)).setAttribute("nombre","txtDescuento" );
      ((Element)v.get(71)).setAttribute("id","datosCampos" );
      ((Element)v.get(71)).setAttribute("max","3" );
      ((Element)v.get(71)).setAttribute("tipo","" );
      ((Element)v.get(71)).setAttribute("onchange","" );
      ((Element)v.get(71)).setAttribute("req","N" );
      ((Element)v.get(71)).setAttribute("size","3" );
      ((Element)v.get(71)).setAttribute("valor","" );
      ((Element)v.get(71)).setAttribute("validacion","" );
      ((Element)v.get(71)).setAttribute("onshtab","focalizaBotonHTML('botonContenido','btnAceptar')" );
      ((Element)v.get(70)).appendChild((Element)v.get(71));
      /* Termina nodo:71   */

      /* Elemento padre:70 / Elemento actual: 72   */
      v.add(doc.createTextNode("%\r                   "));
      ((Element)v.get(70)).appendChild((Text)v.get(72));
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(75)).setAttribute("valign","bottom" );
      ((Element)v.get(59)).appendChild((Element)v.get(75));

      /* Empieza nodo:76 / Elemento padre: 75   */
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(76)).setAttribute("nombre","txtImporteFijoDto" );
      ...
      ((Element)v.get(76)).setAttribute("size","10" );
      ...
      /* Empieza nodo:77 / Elemento padre: 59   */
      v.add(doc.createElement("td"));
      ((Element)v.get(77)).setAttribute("width","100%" );
      ((Element)v.get(59)).appendChild((Element)v.get(77));
      ...
      /* Empieza nodo:79 / Elemento padre: 40   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(40)).appendChild((Element)v.get(79));
      ...
      /* Empieza nodo:84 / Elemento padre: 22   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(22)).appendChild((Element)v.get(84));
   ...
   private void getXML360(Document doc) {
      ((Element)v.get(92)).setAttribute("nombre","btnAceptar" );
      ((Element)v.get(92)).setAttribute("ID","botonContenido" );
      ((Element)v.get(92)).setAttribute("tipo","html" );
      ((Element)v.get(92)).setAttribute("accion","accionAceptar();" );
      ((Element)v.get(92)).setAttribute("estado","false" );
      ((Element)v.get(92)).setAttribute("cod","12" );
      ((Element)v.get(92)).setAttribute("ontab","focaliza('formulario.txtDescuento')" );
