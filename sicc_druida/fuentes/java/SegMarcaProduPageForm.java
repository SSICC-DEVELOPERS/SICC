...
public class SegMarcaProduPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","SegMarcaProdu.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","SegMarcaProdu.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('segMarcaProduFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('segMarcaProduFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(50)).setAttribute("nombre","codMarcProdTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lblCodMarcProd" );
      ((Element)v.get(54)).setAttribute("alto","13" );
      ((Element)v.get(54)).setAttribute("filas","1" );
      ((Element)v.get(54)).setAttribute("id","datosTitle" );
      ((Element)v.get(54)).setAttribute("cod","SegMarcaProdu.codMarcProd.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(55)).setAttribute("nombre","codMarcProdWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(57)).setAttribute("nombre","codMarcProd" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('segMarcaProduFrm',2, true)" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('segMarcaProduFrm', 2, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(58)).setAttribute("nombre","codMarcProdGapTdId" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(60)).setAttribute("nombre","desMarcProdTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(65)).setAttribute("nombre","desMarcProdWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(67)).setAttribute("nombre","desMarcProd" );
      ...
      ((Element)v.get(67)).setAttribute("ontab","ejecutarAccionFoco('segMarcaProduFrm',3, true)" );
      ((Element)v.get(67)).setAttribute("onshtab","ejecutarAccionFoco('segMarcaProduFrm', 3, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(68)).setAttribute("nombre","desMarcProdGapTdId" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(82)).setAttribute("nombre","segMarcaProduTrButtons" );
      ...
      ((Element)v.get(89)).setAttribute("nombre","segMarcaProduTdQueryButton" );
      ((Element)v.get(88)).appendChild((Element)v.get(89));

      /* Empieza nodo:90 / Elemento padre: 89   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(90)).setAttribute("nombre","segMarcaProduQueryButton" );
      ((Element)v.get(90)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(90)).setAttribute("estado","false" );
      ((Element)v.get(90)).setAttribute("accion","segMarcaProduFirstPage();" );
      ...
      ((Element)v.get(91)).setAttribute("nombre","segMarcaProduTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(93)).setAttribute("nombre","segMarcaProduLovNullButton" );
      ((Element)v.get(93)).setAttribute("ID","botonContenido" );
      ((Element)v.get(93)).setAttribute("tipo","html" );
      ((Element)v.get(93)).setAttribute("accion","segMarcaProduLovNullSelectionAction();" );
