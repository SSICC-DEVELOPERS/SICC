...
public class contenido_usuarios_bloqueo_insertar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_usuarios_bloqueo_insertar" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(3)).setAttribute("src","contenido_usuarios_bloqueo_insertar.js" );
      ...
      ((Element)v.get(6)).setAttribute("name","txtCodigoUsuario" );
      ((Element)v.get(6)).setAttribute("required","true" );
      ((Element)v.get(6)).setAttribute("cod","3210" );
      ...
      ((Element)v.get(7)).setAttribute("cod","3207" );
      ((Element)v.get(5)).appendChild((Element)v.get(7));
      /* Termina nodo:7   */

      /* Empieza nodo:8 / Elemento padre: 5   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(8)).setAttribute("name","cbAccionPermitida" );
      ((Element)v.get(8)).setAttribute("required","true" );
      ((Element)v.get(8)).setAttribute("cod","3212" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(17)).setAttribute("nombre","oidAccionPermitida" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(18)).setAttribute("nombre","oidUsuarioBloqueo" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(19)).setAttribute("nombre","idUser" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(36)).setAttribute("width","98%" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(44)).setAttribute("nombre","lblCodigoUsuario" );
      ...
      ((Element)v.get(44)).setAttribute("cod","3210" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(48)).setAttribute("nombre","lblNombreUsuario" );
      ...
      ((Element)v.get(48)).setAttribute("cod","3213" );
      ...
      ((Element)v.get(55)).setAttribute("nombre","txtCodigoUsuario" );
      ...
      ((Element)v.get(55)).setAttribute("size","30" );
      ((Element)v.get(55)).setAttribute("valor","" );
      ((Element)v.get(55)).setAttribute("validacion","" );
      ((Element)v.get(55)).setAttribute("onchange","validarCodigoUsuario();" );
      ((Element)v.get(55)).setAttribute("onshtab","foco('formulario.cbAccionPermitida');" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(59)).setAttribute("nombre","nombreUsuario" );
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(62)).setAttribute("width","98%" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(70)).setAttribute("nombre","lblTipoBloqueo" );
      ...
      ((Element)v.get(70)).setAttribute("cod","3207" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(74)).setAttribute("nombre","lblAccionPermitida" );
      ...
      ((Element)v.get(74)).setAttribute("cod","3212" );
      ...
      ((Element)v.get(81)).setAttribute("nombre","cbTipoBloqueo" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(86)).setAttribute("nombre","cbAccionPermitida" );
      ...
      ((Element)v.get(86)).setAttribute("ontab","onTabAccionPermitida();" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(92)).setAttribute("height","16" );
