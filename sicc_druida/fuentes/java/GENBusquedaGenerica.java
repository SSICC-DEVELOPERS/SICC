...
public class GENBusquedaGenerica  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","GENBusquedaGenerica" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(9)).setAttribute("src","GENBusquedaGenerica.js" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(40)).setAttribute("width","8px" );
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(42)).setAttribute("width","250px" );
      ((Element)v.get(39)).appendChild((Element)v.get(42));

      /* Empieza nodo:43 / Elemento padre: 42   */
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(43)).setAttribute("nombre","lblCodigo" );
      ...
      ((Element)v.get(43)).setAttribute("cod","8" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(47)).setAttribute("cod","9" );
      ...
      ((Element)v.get(54)).setAttribute("nombre","txtCodigo" );
      ((Element)v.get(54)).setAttribute("id","datosCampos" );
      ((Element)v.get(54)).setAttribute("max","" );
      ((Element)v.get(54)).setAttribute("tipo","" );
      ((Element)v.get(54)).setAttribute("onblur","" );
      ((Element)v.get(54)).setAttribute("onchange","" );
      ((Element)v.get(54)).setAttribute("req","N" );
      ((Element)v.get(54)).setAttribute("size","30" );
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(58)).setAttribute("nombre","txtDescripcion" );
      ((Element)v.get(58)).setAttribute("id","datosCampos" );
      ((Element)v.get(58)).setAttribute("max","" );
      ((Element)v.get(58)).setAttribute("tipo","" );
      ((Element)v.get(58)).setAttribute("onblur","" );
      ((Element)v.get(58)).setAttribute("onchange","" );
      ((Element)v.get(58)).setAttribute("req","N" );
      ((Element)v.get(58)).setAttribute("size","40" );
      ...
      /* Empieza nodo:61 / Elemento padre: 35   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(35)).appendChild((Element)v.get(61));
      ...
      /* Empieza nodo:64 / Elemento padre: 25   */
      v.add(doc.createElement("td"));
      ((Element)v.get(25)).appendChild((Element)v.get(64));
      ...
      /* Empieza nodo:66 / Elemento padre: 17   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(17)).appendChild((Element)v.get(66));
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(74)).setAttribute("ontab","" );
      ((Element)v.get(74)).setAttribute("tipo","html" );
      ((Element)v.get(74)).setAttribute("accion","btnBuscar_onClick();" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(92)).setAttribute("cod","693" );
      ...
      ((Element)v.get(95)).setAttribute("ancho","60" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(97)).setAttribute("ancho","90" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(98)).setAttribute("ancho","90" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(99)).setAttribute("ancho","90" );
      ...
      ((Element)v.get(103)).setAttribute("cod","" );
      ...
      /* Empieza nodo:106 / Elemento padre: 84   */
   }
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(84)).appendChild((Element)v.get(106));
      ...
      /* Empieza nodo:112 / Elemento padre: 84   */
      v.add(doc.createElement("ROWSET"));
      ((Element)v.get(84)).appendChild((Element)v.get(112));
      /* Termina nodo:112   */

      /* Empieza nodo:113 / Elemento padre: 84   */
      v.add(doc.createElement("PAGINADO"));
      ((Element)v.get(113)).setAttribute("nombre","mipgndo1" );
      ((Element)v.get(113)).setAttribute("ancho","668" );
      ...
      ((Element)v.get(113)).setAttribute("conector","conector_prototipo_2" );
      ((Element)v.get(113)).setAttribute("rowset","" );
      ((Element)v.get(113)).setAttribute("cargainicial","N" );
      ((Element)v.get(113)).setAttribute("onload","procesarPaginado(mipgndo1,msgError, ultima, rowset, 'mostrarListado(rowset)', null)" );
      ...
      ((Element)v.get(114)).setAttribute("y","410" );
      ...
      ((Element)v.get(114)).setAttribute("accion","mipgndo1.retroceder();" );
      ...
      ((Element)v.get(115)).setAttribute("y","410" );
      ...
      ((Element)v.get(115)).setAttribute("accion","mipgndo1.avanzar();" );
      ((Element)v.get(113)).appendChild((Element)v.get(115));
      /* Termina nodo:115   */
      /* Termina nodo:113   */
      /* Termina nodo:84   */

      /* Empieza nodo:116 / Elemento padre: 10   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(116)).setAttribute("nombre","Aceptar" );
      ((Element)v.get(116)).setAttribute("x","90" );
      ((Element)v.get(116)).setAttribute("y","404" );
      ((Element)v.get(116)).setAttribute("accion","btnAceptar_onclick();" );
      ((Element)v.get(116)).setAttribute("ontab","" );
      ((Element)v.get(116)).setAttribute("onshtab","" );
      ...
      ((Element)v.get(116)).setAttribute("cod","12" );
      ((Element)v.get(10)).appendChild((Element)v.get(116));
      /* Termina nodo:116   */
      /* Termina nodo:10   */
