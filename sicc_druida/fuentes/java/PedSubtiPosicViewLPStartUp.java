/*
    INDRA/CAR/mmg
    $Id: PedSubtiPosicViewLPStartUp.java,v 1.1 2009/12/03 18:34:18 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class PedSubtiPosicViewLPStartUp extends MMGDruidaBase{
	...
	public PedSubtiPosicViewLPStartUp(){
		super();
	}

	public void inicio() throws Exception {
		pagina("PedSubtiPosicViewPage");
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			buildJsPageSize("PedSubtiPosicView");
			...
			asignarAtributo("PAGINA", "PedSubtiPosicViewPage", "cod", "PedSubtiPosicView." + accion + ".label");
			...
			limpiarBotoneraLista("pedSubtiPosicView", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codSubtPosi", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 2);");
		...
		//asignarAtributo("CAPA", "pedSubtiPosicViewLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "PedSubtiPosicViewPage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("PedSubtiPosicViewLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		PedSubtiPosicViewData pedSubtiPosicViewQuery= new PedSubtiPosicViewData();
		pedSubtiPosicViewQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		PedSubtiPosicViewData datosResult = (PedSubtiPosicViewData)getSingleObject(BUSINESSID_QUERY, pedSubtiPosicViewQuery, 
			pedSubtiPosicViewQuery.clone(), "pedSubtiPosicView");
		...
		preservaHiddensI18n(new Integer(1), "PED_SUBTI_POSIC", "pedSubtiPosicViewFrm", "Descripcion", true);
		...
		PedSubtiPosicViewData pedSubtiPosicView = datosResult;
		asignar("TEXT", "codSubtPosi", FormatUtils.formatObject(pedSubtiPosicView.getCodSubtPosi(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		es.indra.belcorp.mso.PedTipoPosicData tposOidTipoPosi = pedSubtiPosicView.getTposOidTipoPosi();
		if(tposOidTipoPosi != null && tposOidTipoPosi.getId() != null) checkCombo("tposOidTipoPosi" , tposOidTipoPosi.getId().toString());
		asignar("TEXT", "Descripcion", FormatUtils.formatObject(pedSubtiPosicView.getDescripcion(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		loadLocalizationVars(pedSubtiPosicView);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "codSubtPosi", "disabled", "S");
		
					asignarAtributo("COMBO", "tposOidTipoPosi", "disabled", "S");asignarAtributo("TEXT", "Descripcion", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "PED_SUBTI_POSIC", "pedSubtiPosicViewFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "codSubtPosi", "req", "S");
		asignarAtributo("COMBO", "tposOidTipoPosi", "req", "S");
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('pedSubtiPosicViewFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "pedSubtiPosicViewFrm", "oculto", "N");
		...
		traza("MMG::Creando PedSubtiPosicView");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		PedSubtiPosicViewData pedSubtiPosicViewQuery= new PedSubtiPosicViewData();
		pedSubtiPosicViewQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(pedSubtiPosicView.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"pedSubtiPosicViewFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"pedSubtiPosicViewFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codSubtPosi", "ontab","ejecutarAccionFocoModificacion(\"pedSubtiPosicViewFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codSubtPosi", "onshtab","ejecutarAccionFocoModificacion(\"pedSubtiPosicViewFrm\",2, false)");
					asignarAtributo("COMBO","tposOidTipoPosi", "ontab", "ejecutarAccionFocoModificacion(\"pedSubtiPosicViewFrm\",3, true)");
					asignarAtributo("COMBO","tposOidTipoPosi", "onshtab", "ejecutarAccionFocoModificacion(\"pedSubtiPosicViewFrm\",3, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"pedSubtiPosicViewFrm\",4, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"pedSubtiPosicViewFrm\",4, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","pedSubtiPosicViewTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","pedSubtiPosicViewTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","pedSubtiPosicViewFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","pedSubtiPosicViewListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","pedSubtiPosicViewListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(PedSubtiPosicViewData pedSubtiPosicView) throws Exception{
		...
		if(pedSubtiPosicView != null && pedSubtiPosicView.getTposOidTipoPosi() != null){
				checkCombo("tposOidTipoPosi" , pedSubtiPosicView.getTposOidTipoPosi().getId().toString());
			}
	...
	* @param pedSubtiPosicView La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(PedSubtiPosicViewData pedSubtiPosicView) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		PedSubtiPosicViewData pedSubtiPosicView = 
			(PedSubtiPosicViewData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(pedSubtiPosicView.getTposOidTipoPosi() != null){
			pedSubtiPosicView.setTposOidTipoPosi((es.indra.belcorp.mso.PedTipoPosicData)
			getSingleObject(BUSINESSID_TPOSOIDTIPOPOSI_QUERY, 
			pedSubtiPosicView.getTposOidTipoPosi(),
			pedSubtiPosicView.getTposOidTipoPosi().clone(),
			"pedTipoPosic"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(pedSubtiPosicView);
		loadLeafDependenceCombos(pedSubtiPosicView);
	}
	...
	*/
	...
	protected void loadLocalizationVars(PedSubtiPosicViewData pedSubtiPosicView) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("PED_SUBTI_POSIC");
		mmgLocalizationQuery.setEntiPk(pedSubtiPosicView.getId());
