...
public class EduTipoCursoPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","eduTipoCursoList" );
      ...
      ((Element)v.get(14)).setAttribute("cod","EduTipoCurso.marcOidMarc.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","EduTipoCurso.codTipoCurs.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","EduTipoCurso.Descripcion.label" );
