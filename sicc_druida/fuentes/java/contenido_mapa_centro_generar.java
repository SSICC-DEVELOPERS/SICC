...
public class contenido_mapa_centro_generar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_mapa_centro_generar" );
      ((Element)v.get(0)).setAttribute("cod","0962" );
      ((Element)v.get(0)).setAttribute("titulo","Generacion mapa del centro de distribucion" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","Generacion mapa del centro de distribucion" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","contenido_mapa_centro_generar.js" );
      ...
      ((Element)v.get(9)).setAttribute("cod","MMGGlobal.localization.description.label" );
      ((Element)v.get(9)).setAttribute("format","t" );
      ((Element)v.get(9)).setAttribute("max","30" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(18)).setAttribute("nombre","codigoMapa" );
   ...
   private void getXML90(Document doc) {
      v.add(doc.createElement("VAR"));
      ((Element)v.get(22)).setAttribute("nombre","descripcion" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(23)).setAttribute("nombre","habilitoBotonMantener" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(24)).setAttribute("nombre","hOidMapaGenerado" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(53)).setAttribute("nombre","lblCodigoMapaCentroDistribucion" );
      ((Element)v.get(53)).setAttribute("alto","13" );
      ((Element)v.get(53)).setAttribute("filas","1" );
      ((Element)v.get(53)).setAttribute("valor","" );
      ((Element)v.get(53)).setAttribute("id","datosTitle" );
      ((Element)v.get(53)).setAttribute("cod","2056" );
      ...
      ((Element)v.get(60)).setAttribute("nombre","cbCentroDistribucion" );
      ...
      ((Element)v.get(60)).setAttribute("onshtab","onShtabComboCentro();" );
      ((Element)v.get(60)).setAttribute("valorinicial","" );
      ((Element)v.get(60)).setAttribute("textoinicial","" );
      ((Element)v.get(60)).setAttribute("ontab","onTabComboCentro();" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(65)).setAttribute("nombre","lblCodigoMapaCentroDistribucionValor" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(88)).setAttribute("onclick","levantarI18N('formulario','1');" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(98)).setAttribute("nombre","btnCrear" );
      ((Element)v.get(98)).setAttribute("ID","botonContenido" );
      ((Element)v.get(98)).setAttribute("tipo","html" );
      ((Element)v.get(98)).setAttribute("accion","onClickCrear();" );
      ((Element)v.get(98)).setAttribute("estado","false" );
      ((Element)v.get(98)).setAttribute("cod","835" );
      ((Element)v.get(98)).setAttribute("ontab","onTabBotonCrear();" );
      ((Element)v.get(98)).setAttribute("onshtab","onShTabBotonCrear();" );
      ((Element)v.get(97)).appendChild((Element)v.get(98));
      /* Termina nodo:98   */

      /* Empieza nodo:99 / Elemento padre: 97   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(99)).setAttribute("nombre","btnMantenerMapa" );
      ((Element)v.get(99)).setAttribute("ID","botonContenido" );
      ((Element)v.get(99)).setAttribute("tipo","html" );
      ((Element)v.get(99)).setAttribute("accion","onClickMantener();" );
      ((Element)v.get(99)).setAttribute("estado","false" );
      ((Element)v.get(99)).setAttribute("cod","2934" );
      ((Element)v.get(99)).setAttribute("ontab","onTabBotonMantener();" );
      ((Element)v.get(99)).setAttribute("onshtab","onShTabBotonMantener();" );
