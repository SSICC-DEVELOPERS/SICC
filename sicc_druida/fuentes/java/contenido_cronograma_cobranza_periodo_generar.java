...
public class contenido_cronograma_cobranza_periodo_generar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_cronograma_cobranza_periodo_generar" );
      ((Element)v.get(0)).setAttribute("cod","0264" );
      ((Element)v.get(0)).setAttribute("titulo","Generar cronograma de cobranza para periodo" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","Generar cronograma de cobranza para periodo" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(3)).setAttribute("src","contenido_cronograma_cobranza_periodo_generar.js" );
      ...
      ((Element)v.get(6)).setAttribute("group","todos" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(16)).setAttribute("nombre","deshabilitaBoton" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(17)).setAttribute("nombre","oidSeleccionados" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(18)).setAttribute("nombre","hOidPeriodo" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(38)).setAttribute("width","711" );
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(40)).setAttribute("colspan","5" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(57)).setAttribute("onshtab","shtabMarca();" );
      ...
      ((Element)v.get(62)).setAttribute("onchange","recargaPeriodo();" );
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(67)).setAttribute("colspan","5" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(71)).setAttribute("width","711" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(83)).setAttribute("nombre","cbPeriodo" );
      ((Element)v.get(83)).setAttribute("id","datosCampos" );
      ((Element)v.get(83)).setAttribute("size","1" );
      ((Element)v.get(83)).setAttribute("ontab","tabPeriodo();" );
      ...
      ((Element)v.get(89)).setAttribute("height","7" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(99)).setAttribute("ancho","714" );
      ((Element)v.get(99)).setAttribute("alto","299" );
      ((Element)v.get(99)).setAttribute("x","12" );
      ((Element)v.get(99)).setAttribute("y","142" );
      ...
      ((Element)v.get(107)).setAttribute("cod","00451" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(115)).setAttribute("cod","1061" );
      ...
      ((Element)v.get(129)).setAttribute("ancho","400" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(129)).setAttribute("y","418" );
      ...
      ((Element)v.get(130)).setAttribute("y","422" );
      ...
      /* Empieza nodo:132 / Elemento padre: 9   */
      v.add(doc.createElement("BOTON"));
      ...
      ((Element)v.get(9)).appendChild((Element)v.get(132));
      /* Termina nodo:132   */
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(134)).setAttribute("nombre","Generar" );
      ((Element)v.get(134)).setAttribute("x","80" );
      ((Element)v.get(134)).setAttribute("y","419" );
      ((Element)v.get(134)).setAttribute("ID","botonContenido" );
      ((Element)v.get(134)).setAttribute("tipo","html" );
      ((Element)v.get(134)).setAttribute("accion","accionGenerarCronograma();" );
      ((Element)v.get(134)).setAttribute("estado","false" );
      ((Element)v.get(134)).setAttribute("cod","886" );
