...
public class contenido_premios_recomendacion_elegir  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("msgle","premios_recomendacion_elegir" );
      ...
      v.add(doc.createTextNode("    \r  \r   \r   var LP = 'LPElegirPremiosRecomendacion';\r\r   function onLoadPag()  {           \r      configurarMenuSecundario(\"formulario\");\r	  DrdEnsanchaConMargenDcho('listado1',12);      \r      document.all[\"Cplistado1\"].style.visibility=''; \r      document.all[\"CpLin1listado1\"].style.visibility='';  \r      document.all[\"CpLin2listado1\"].style.visibility=''; \r      document.all[\"CpLin3listado1\"].style.visibility='';\r      document.all[\"CpLin4listado1\"].style.visibility='';        \r      document.all[\"primera1Div\"].style.visibility=''; \r      document.all[\"ret1Div\"].style.visibility='';\r      document.all[\"ava1Div\"].style.visibility='';  \r      document.all[\"separaDiv\"].style.visibility='';\r      document.all[\"btnAceptarDiv\"].style.visibility='';\r          \r      eval (ON_RSZ);  \r	  var arr = [ [\"oidPais\", get(\"formulario.oidPais\")], \r	              [\"oidIdioma\", get(\"formulario.oidIdioma\")],\r	              [\"oidClienteRecomendada\", get(\"formulario.hidRecomendado\")], \r				  [\"oidClienteRecomendante\", get(\"formulario.hidRecomendante\")]\r                 ];\r\r	  configurarPaginado(mipgndo, \"INCBuscarConcursosPremiosRec\", \"ConectorBuscarConcursosPremiosRec\", \"es.indra.sicc.dtos.inc.DTOElegirPremiosRec\", arr);\r	  \r	  btnProxy(1, '1');   \r	  focalizaBotonHTML_XY('btnAceptar');\r    }\r\r	function fGuardar() {\r	    set('formulario.conectorAction', 'LPInsertarCliente');\r		set('formulario.accion', '');\r		enviaSICC('formulario', null, null, 'N');\r	}\r\r	function onClickAceptar() {\r        pos = chkPos()\r        if (pos != -1) {\r            obj = new Object();\r		    obj.hidRecomendante = get('formulario.hidRecomendante');\r			obj.hidRecomendado = get('formulario.hidRecomendado');\r			obj.oidPais = get('formulario.oidPais');\r			obj.oidIdioma = get('formulario.oidIdioma');\r			obj.oidConcursoParametrosGenerales = listado1.datos[pos][0];\r            obj.hidPeriodoContacto = get('formulario.hidPeriodoContacto');\r			mostrarModalSICC(LP, 'buscarPremios', obj, 820, 390);			\r		}\r	}\r\r   function chkPos()  {	\r		if (listado1.numSelecc() == 1) {\r			return obtenerPosicionListaEditable(listado1.codSeleccionados(), listado1);			\r		}\r		else {  \r			if (listado1.numSelecc() > 1) {\r			  cdos_mostrarAlert(GestionarMensaje(\"240\"));	  \r			}\r		    else {  \r				if (listado1.numSelecc() < 1) {\r					GestionarMensaje(\"4\");\r				}\r		    }\r		}\r		return -1;\r	} \r\rfunction muestraLista( ultima, rowset){\r         \r         var tamano = rowset.length;\r         if (tamano > 0) {\r                  return true;\r         } else {\r                  return false;\r         }\r}\r\r\r     \r"));
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(30)).setAttribute("cod","00283" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(43)).setAttribute("cod","1604" );
      ...
      ((Element)v.get(44)).setAttribute("cod","1607" );
      ...
      ((Element)v.get(45)).setAttribute("cod","1605" );
      ...
      ((Element)v.get(48)).setAttribute("cod","1175" );
      ...
      ((Element)v.get(49)).setAttribute("cod","1176" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(60)).setAttribute("ancho","683" );
      ...
      ((Element)v.get(60)).setAttribute("conector","" );
      ((Element)v.get(60)).setAttribute("rowset","" );
      ((Element)v.get(60)).setAttribute("cargainicial","N" );
      ((Element)v.get(60)).setAttribute("onload","procesarPaginado(mipgndo,msgError, ultima, rowset, 'muestraLista(ultima, rowset)');" );
      ...
      ((Element)v.get(63)).setAttribute("y","310" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(65)).setAttribute("nombre","btnAceptar" );
      ((Element)v.get(65)).setAttribute("x","80" );
      ((Element)v.get(65)).setAttribute("y","307" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(65)).setAttribute("cod","12" );
      ((Element)v.get(65)).setAttribute("accion","onClickAceptar();" );
      ...
      ((Element)v.get(66)).setAttribute("y","329" );
