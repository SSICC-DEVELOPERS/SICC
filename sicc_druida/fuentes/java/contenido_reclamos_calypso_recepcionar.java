...
public class contenido_reclamos_calypso_recepcionar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_reclamos_calypso_recepcionar" );
      ((Element)v.get(0)).setAttribute("cod","01016" );
      ((Element)v.get(0)).setAttribute("titulo","Recepcionar reclamos Calypso" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","Recepcionar reclamos Calypso" );
      ...
      v.add(doc.createTextNode("\r  \r\rfunction onLoadPag() {\r  	configurarMenuSecundario(\"frmFormulario\");\r	set(\"frmFormulario.areatxtObservaciones\", get(\"frmFormulario.observaciones\"));\r	focoDescripcion();\r}\r\rfunction fLimpiar() {\r	onLoadPag();\r}\r\rfunction focoDescripcion() {\r	focaliza(\"frmFormulario.txtDescripcion\");\r}\r\rfunction focoBotonRecepcionar() {\r	focalizaBotonHTML('botonContenido','btnRecepcionar');	\r}\r\rfunction enviarOnClick() {	\r	if(!sicc_validaciones_generales('obligatorios')) {\r		return;\r	}\r\r	var numeroLote = get(\"frmFormulario.numeroLote\");\r	var descripcionLote = get(\"frmFormulario.txtDescripcion\");\r	var observaciones = get(\"frmFormulario.areatxtObservaciones\");\r\r	set(\"frmFormulario.numeroLote\", numeroLote);\r	set(\"frmFormulario.descripcionLote\", descripcionLote);\r	set(\"frmFormulario.observaciones\", observaciones);\r\r	eval(\"frmFormulario\").oculto= \"S\";\r	set(\"frmFormulario.accion\",'recepcionar');\r	set(\"frmFormulario.conectorAction\",'LPRecepcionarReclamosCalypso');\r	enviaSICC(\"frmFormulario\", \"\", \"\", \"N\");\r}\r\rfunction errorEnRecepcionar() {\r	focoDescripcion();\r}\r\rfunction cerrarVentana() { \r    var formulario = getFormularioSICC();\r    set(formulario+\".conectorAction\",\"LPInicioBelcorp\"); \r    set(formulario+\".accion\",\"\");\r    try { \r        /* parent.frames['menu'].location.reload(); */\r        parent.frames[\"iconos\"].mostrarCapa(); \r    } catch(e) { }\r    eval(formulario).oculto = 'N';\r    enviaSICC(formulario,'','','N');\r}\r\r \r"));
      ...
      ((Element)v.get(10)).setAttribute("valor","LPRecepcionarReclamosCalypso" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(15)).setAttribute("nombre","numeroLote" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(16)).setAttribute("nombre","descripcionLote" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(17)).setAttribute("nombre","observaciones" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(49)).setAttribute("cod","844" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(53)).setAttribute("nombre","lblObservaciones" );
      ((Element)v.get(53)).setAttribute("alto","13" );
      ((Element)v.get(53)).setAttribute("filas","1" );
      ((Element)v.get(53)).setAttribute("id","datosTitle" );
      ((Element)v.get(53)).setAttribute("cod","169" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(60)).setAttribute("nombre","lblvalorLote" );
      ...
      ((Element)v.get(64)).setAttribute("onshtab","focoBotonRecepcionar();" );
      ((Element)v.get(64)).setAttribute("onblur","" );
      ...
      ((Element)v.get(68)).setAttribute("cols","50" );
      ((Element)v.get(68)).setAttribute("id","datosCampos" );
      ((Element)v.get(68)).setAttribute("msjreq","" );
      ((Element)v.get(68)).setAttribute("nombre","areatxtObservaciones" );
      ((Element)v.get(68)).setAttribute("readonly","N" );
      ((Element)v.get(68)).setAttribute("req","N" );
      ((Element)v.get(68)).setAttribute("rows","3" );
   }

   private void getXML270(Document doc) {
      ((Element)v.get(68)).setAttribute("tabindex","2" );
      ((Element)v.get(68)).setAttribute("valor","" );
      ((Element)v.get(68)).setAttribute("max","100" );
      ...
      /* Empieza nodo:74 / Elemento padre: 27   */
      v.add(doc.createElement("td"));
      ((Element)v.get(27)).appendChild((Element)v.get(74));
      ...
      /* Empieza nodo:76 / Elemento padre: 19   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(19)).appendChild((Element)v.get(76));
      ...
      ((Element)v.get(84)).setAttribute("nombre","btnRecepcionar" );
      ((Element)v.get(84)).setAttribute("ID","botonContenido" );
      ((Element)v.get(84)).setAttribute("tipo","html" );
      ((Element)v.get(84)).setAttribute("accion","enviarOnClick();" );
      ((Element)v.get(84)).setAttribute("ontab","focoDescripcion();" );
      ((Element)v.get(84)).setAttribute("estado","false" );
      ((Element)v.get(84)).setAttribute("cod","2265" );
      ...
      /* Empieza nodo:87 / Elemento padre: 19   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(19)).appendChild((Element)v.get(87));
