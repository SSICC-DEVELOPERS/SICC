...
public class ConectorObtenerFuncionesPerfilesUsuario  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","ConectorObtenerFuncionesPerfilesUsuario" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","DTOUsuario" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(6)).setAttribute("NOMBRE","OID_FUNC" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","nom_func" );
