...
public class contenido_cuenta_corriente_puntos_consultar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","cuenta_corriente_puntos" );
      ((Element)v.get(0)).setAttribute("cod","0496" );
      ((Element)v.get(0)).setAttribute("titulo","Consultar cuenta corriente de puntos" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","Consultar cuenta corriente de puntos" );
      ...
      v.add(doc.createTextNode("    \r  \r   function onLoadPag()   \r   {  configurarMenuSecundario(\"formulario\");\r	  ocultaLista1();\r      eval(ON_RSZ);	\r	  fMostrarMensajeError();	  	  \r	  btnProxy(1,0); \r	  btnProxy(2,0);\r	  btnProxy(3,1);\r	  btnProxy(4,0);\r	  btnProxy(5,1);\r	  btnProxy(6,1);\r	  btnProxy(7,0);\r	  btnProxy(8,0);\r	  btnProxy(9,0);\r	  btnProxy(10,1);\r	  focaliza(\"formulario.txtCodigoCliente\");      \r   }\r\r   /* Método que se ejecuta al pulsar sobre el icono de búsqueda rápida del campo Cod.cliente \r	  Abrir una ventana modal, llamando a la \"LPBusquedaRapidaCliente\" con accion \"\" \r      Recuperar el array de respuesta con los valores de la fila seleccionada (oid, codigo, nombre1, nombre2, apellido1, apellido2). \r      Asignamos \"codigo\" al campo txtCodigoCliente \r   */\r   function accionBusquedaCliente()\r   {  var obj = new Object();\r	  obj.accion = \"\";\r      var val_fila = mostrarModalSICC('LPBusquedaRapidaCliente', '', obj, 800, 500);\r	  if (val_fila != null)	    \r		set('formulario.txtCodigoCliente', val_fila[1]);\r	  delete obj;\r   }\r   \r   /*Metodo que se ejecuta al pulsar sobre el botón btBuscar \r	Obtiene de la página los criterios de búsqueda establecidos por el usuario: \r		- codigoCliente = valor de txtCodigoCliente \r		- oidConcurso = oid del valor seleccionado en el combo cbNumeroConcurso \r		- pais = pais activo 		- idioma = idioma activo 	Llamamos a configurarPaginado pasándole los siguientes parametros: \r		- Objeto paginado (lstResultado) \r		- idBusiness (\"INCBuscarCtaCtePtos\") \r		- \"ConectorBuscarCtaCtePtos\" \r		- \"DTOBuscarCtaCtePtos\" \r		- Parametros del DTO: \r		- codigoCliente \r		- numeroConcurso \r		- pais \r		- idioma \r	deshabilitar todos los campos */\r   function accionBuscar()\r   { configurarPaginado(mipgndo,'INCBuscarCtaCtePtos',\r	                            'ConectorBuscarCtaCtePtos',\r								'es.indra.sicc.dtos.inc.DTOBuscarCtaCtePtos', \r                                [[\"codigoCliente\", get(\"formulario.txtCodigoCliente\")], /* como en DTO */ \r								 [\"numeroConcurso\",get(\"formulario.cbNumeroConcurso\")], /* como en DTO */\r								 [\"oidPais\",get(\"formulario.oidPais\")],\r								 [\"oidIdioma\",get(\"formulario.oidIdioma\")]]);\r	    }\r\r   /*Esta accion se ejecuta cuando se pulsa la opcion volver del menú secundario \r     Se cierra la ventana*/\r   function accionVolver() { window.close(); }\r\r      function muestraLista( ultima, rowset)\r   {	var tamano = rowset.length;\r		if (tamano > 0)\r		{  muestraLista1();\r		   eval (ON_RSZ);      \r		   return true;\r		}\r		else \r		{  ocultaLista1();\r		   eval (ON_RSZ);                      \r		   return false;\r		}\r   }\r\r   function muestraLista1()\r   {	DrdEnsanchaConMargenDcho('listado1',12);	    \r	    document.all[\"Cplistado1\"].style.visibility='';\r	    document.all[\"CpLin1listado1\"].style.visibility='';\r	    document.all[\"CpLin2listado1\"].style.visibility='';\r	    document.all[\"CpLin3listado1\"].style.visibility='';\r	    document.all[\"CpLin4listado1\"].style.visibility='';\r	    document.all[\"primera1Div\"].style.visibility='';\r	    document.all[\"ret1Div\"].style.visibility='';\r	    document.all[\"ava1Div\"].style.visibility='';\r	    document.all[\"separaDiv\"].style.visibility='';\r	}\r\r   function ocultaLista1()\r   {	DrdEnsanchaConMargenDcho('listado1',12);	    \r	    document.all[\"Cplistado1\"].style.visibility='hidden';\r	    document.all[\"CpLin1listado1\"].style.visibility='hidden';\r	    document.all[\"CpLin2listado1\"].style.visibility='hidden';\r	    document.all[\"CpLin3listado1\"].style.visibility='hidden';\r	    document.all[\"CpLin4listado1\"].style.visibility='hidden';\r	    document.all[\"primera1Div\"].style.visibility='hidden';\r	    document.all[\"ret1Div\"].style.visibility='hidden';\r	    document.all[\"ava1Div\"].style.visibility='hidden';\r	    document.all[\"separaDiv\"].style.visibility='hidden';\r   }\r\r     \r"));
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(49)).setAttribute("nombre","lblNumConcurso" );
      ...
      ((Element)v.get(56)).setAttribute("nombre","txtCodigoCliente" );
      ...
      ((Element)v.get(56)).setAttribute("onshtab","focalizaBotonHTML('btnBuscar')" );
      ...
      v.add(doc.createElement("IMG"));
      ((Element)v.get(60)).setAttribute("src","iconBuscar.gif" );
      ((Element)v.get(60)).setAttribute("onclick","accionBusquedaCliente();" );
      ...
      ((Element)v.get(64)).setAttribute("nombre","cbNumeroConcurso" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(81)).setAttribute("accion","accionBuscar();" );
      ((Element)v.get(81)).setAttribute("estado","false" );
      ((Element)v.get(81)).setAttribute("cod","1" );
      ((Element)v.get(81)).setAttribute("ontab","focaliza('formulario.txtCodigoCliente')" );
      ...
      ((Element)v.get(91)).setAttribute("ancho","403" );
      ((Element)v.get(91)).setAttribute("alto","317" );
      ((Element)v.get(91)).setAttribute("x","12" );
      ((Element)v.get(91)).setAttribute("y","124" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(102)).setAttribute("ancho","0" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(106)).setAttribute("ancho","0" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(115)).setAttribute("cod","0" );
      ...
      ((Element)v.get(116)).setAttribute("cod","304" );
      ...
      ((Element)v.get(117)).setAttribute("cod","651" );
      ...
      ((Element)v.get(118)).setAttribute("cod","1659" );
      ...
      ((Element)v.get(119)).setAttribute("cod","0" );
      ...
      ((Element)v.get(120)).setAttribute("cod","0" );
      ...
      ((Element)v.get(121)).setAttribute("cod","0" );
      ...
      ((Element)v.get(122)).setAttribute("cod","2424" );
      ...
      ((Element)v.get(123)).setAttribute("cod","1817" );
      ...
      ((Element)v.get(124)).setAttribute("cod","0" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(126)).setAttribute("cod","1662" );
      ...
      ((Element)v.get(127)).setAttribute("cod","0" );
   ...
   private void getXML630(Document doc) {
      ...
      ((Element)v.get(143)).setAttribute("y","422" );
      ...
      ((Element)v.get(144)).setAttribute("y","422" );
      ...
      ((Element)v.get(145)).setAttribute("y","422" );
      ...
      ((Element)v.get(146)).setAttribute("y","418" );
      ...
      ((Element)v.get(147)).setAttribute("y","441" );
