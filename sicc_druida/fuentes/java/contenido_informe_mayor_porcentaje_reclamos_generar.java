...
public class contenido_informe_mayor_porcentaje_reclamos_generar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_informe_mayor_porcentaje_reclamos_generar" );
      ((Element)v.get(0)).setAttribute("cod","0917" );
      ((Element)v.get(0)).setAttribute("titulo","Generar informe zonas con mayor porcentaje de reclamos" );
      ...
      v.add(doc.createTextNode("\r   \r   \r   function onLoad(){\r      configurarMenuSecundario('Formulario');\r      fMostrarMensajeError();\r      focaliza('Formulario.cbMarca');\r   }\r   function generar(formato){\r      if(sicc_validaciones_generales()){\r      \r      \r   \r           var a = new Object();\r           a.accion = 'generar';\r           a.marca = get('Formulario.cbMarca');      \r           a.canal = get('Formulario.cbCanal'); \r           a.periodoDesde = get('Formulario.cbPeriodoInicial');      \r		   a.periodoDesdeDesc = get('Formulario.cbPeriodoInicial', 'T');      \r		   a.periodoHastaDesc = get('Formulario.cbPeriodoFinal', 'T');      \r		   a.operacionDesc = get('Formulario.cbOperacion', 'T');   \r		   a.tipoOperacionDesc = get('Formulario.cbTipoOperacion', 'T');\r\r           a.periodoHasta = get('Formulario.cbPeriodoFinal');      \r           a.operacion = get('Formulario.cbOperacion');  \r           a.tipoOperacion = get('Formulario.cbTipoOperacion');  \r           a.cantidadZonas = get('Formulario.txtCantidadZonas');\r           a.tipoSalida = get('Formulario.cbTipoSalida');\r              \r           mostrarModalSICC('RECZonasMasReclamos','generar', a); \r    \r      }\r    }\r\r\r  \r\r   \rfunction onchangeMarcaCanal(){\r        \r       marca  = get('Formulario.cbMarca');\r       canal  = get('Formulario.cbCanal');\r       pais   = get('Formulario.pais');\r       idioma = get('Formulario.idioma');\r      \r       if(marca != '' && canal != ''){\r          var arr = new Array();\r          \r          arr[arr.length] = [\"oidIdioma\", idioma]; \r          arr[arr.length] = [\"oidPais\", pais]; \r          arr[arr.length] = [\"marca\", marca];\r          arr[arr.length] = [\"canal\", canal];\r             \r          recargaCombo(\"Formulario.cbPeriodoInicial\",\"PRECargarPeriodos\",\"es.indra.sicc.dtos.cra.DTOPeriodo\",arr);\r          recargaCombo(\"Formulario.cbPeriodoFinal\",\"PRECargarPeriodos\",\"es.indra.sicc.dtos.cra.DTOPeriodo\",arr);\r	            \r                        \r      }else{\r          var aCombo = new Array(new Array(\"\",\"\"));\r          set_combo('Formulario.cbPeriodoInicial', aCombo, []);\r          set_combo('Formulario.cbPeriodoFinal', aCombo, []);\r         \r       }\r      \r    } \r\r\r   function fLimpiar(){\r     var aCombo = new Array(new Array(\"\",\"\"));\r     \r     set_combo('Formulario.cbPeriodo', aCombo, []); \r\r     \r     focaliza('Formulario.cbMarca');\r   }\r\r\r\r \r\r   \r"));
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(11)).setAttribute("name","txtCantidadZonas" );
      ((Element)v.get(11)).setAttribute("required","true" );
      ((Element)v.get(11)).setAttribute("cod","2739" );
      ((Element)v.get(6)).appendChild((Element)v.get(11));
      /* Termina nodo:11   */

      /* Empieza nodo:12 / Elemento padre: 6   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(12)).setAttribute("name","cbTipoSalida" );
      ((Element)v.get(12)).setAttribute("required","true" );
      ((Element)v.get(12)).setAttribute("cod","2731" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(61)).setAttribute("onchange","onchangeMarcaCanal();" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(86)).setAttribute("nombre","cbPeriodoInicial" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(91)).setAttribute("nombre","cbPeriodoFinal" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(116)).setAttribute("nombre","cbOperacion" );
   }
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(121)).setAttribute("nombre","cbTipoOperacion" );
      ...
      /* Empieza nodo:128 / Elemento padre: 37   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(37)).appendChild((Element)v.get(128));
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(139)).setAttribute("nombre","lblTipoSalida" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(139)).setAttribute("cod","2731" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(150)).setAttribute("nombre","cbTipoSalida" );
      ((Element)v.get(150)).setAttribute("size","1" );
      ((Element)v.get(150)).setAttribute("multiple","N" );
      ((Element)v.get(150)).setAttribute("valorinicial","1" );
      ((Element)v.get(150)).setAttribute("textoinicial","Reporte" );
      ...
      ((Element)v.get(153)).setAttribute("VALOR","2" );
      ...
      ((Element)v.get(154)).setAttribute("VALOR","Excel" );
      ...
      /* Empieza nodo:157 / Elemento padre: 130   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(130)).appendChild((Element)v.get(157));
   ...
   private void getXML630(Document doc) {
      ...
      /* Empieza nodo:162 / Elemento padre: 22   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(22)).appendChild((Element)v.get(162));
      ...
      ((Element)v.get(170)).setAttribute("nombre","btnGenerarInforme" );
      ((Element)v.get(170)).setAttribute("ID","botonContenido" );
      ((Element)v.get(170)).setAttribute("tipo","html" );
      ((Element)v.get(170)).setAttribute("accion","generar('pdf')" );
      ((Element)v.get(170)).setAttribute("estado","false" );
      ((Element)v.get(170)).setAttribute("cod","2495" );
      ((Element)v.get(170)).setAttribute("ontab","focaliza('Formulario.cbMarca')" );
      ...
      /* Empieza nodo:173 / Elemento padre: 22   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(22)).appendChild((Element)v.get(173));
