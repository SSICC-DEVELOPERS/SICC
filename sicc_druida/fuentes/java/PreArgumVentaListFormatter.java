...
/*
    INDRA/CAR/mmg
    $Id: PreArgumVentaListFormatter.java,v 1.1 2009/12/03 18:36:34 pecbazalar Exp $
    DESC
*/
 ...
 * @author Indra
 */
public class PreArgumVentaListFormatter extends MMGDruidaFormatoObjeto {
	
	public PreArgumVentaListFormatter() {
	}
		...
		for (int i = 0; i < preArgumVentaList.size(); i++) {
			...
			row.add((preArgumVentaData.getDescripcion() != null ? 
				FormatUtils.formatObject(preArgumVentaData.getDescripcion(), 
				 MMGDruidaHelper.getUserDecimalFormatPattern(this), 
				symbols) : ""));
			row.add((preArgumVentaData.getTiesOidTipoEstr() != null ? 
				FormatUtils.formatObject(preArgumVentaData.getTiesOidTipoEstr(), 
				 MMGDruidaHelper.getUserDecimalFormatPattern(this), 
				symbols) : ""));
