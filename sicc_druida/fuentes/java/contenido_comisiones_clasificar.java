...
public class contenido_comisiones_clasificar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_comisiones_clasificar" );
      ((Element)v.get(0)).setAttribute("cod","0662" );
      ((Element)v.get(0)).setAttribute("titulo","Clasificar Comisiones" );
      ...
      v.add(doc.createTextNode("\r   \r\rvar formName = \"formulario\";\r\r    function onLoadPag()   {\r        configurarMenuSecundario('formulario');\r        fMostrarMensajeError();\r        \r        cargaPaginaInicial();\r    }\r    	\r    function onClickAceptar()\r    {\r        if(sicc_validaciones_generales(\"g1\")){\r            vMarca = get('formulario.cbMarca','V');\r            vCanal = get('formulario.cbCanal','V');\r            vPeriodo = get('formulario.cbPeriodo','V')\r        \r            set('formulario.hidOidMarca',   vMarca);\r            set('formulario.hidOidCanal',   vCanal);\r            set('formulario.hidOidPeriodo', vPeriodo);\r        \r            set('formulario.conectorAction', 'LPClasificarComisiones');\r            set('formulario.accion', 'clasificar');\r            enviaSICC('formulario');\r        }\r    }\r    \r    function marcaOnChange()\r    {\r        recargarPeriodo();\r    }\r     \r\r    function canalOnChange()\r    {\r        recargarPeriodo();\r    }\r    \r    function recargarPeriodo()\r    {\r        /*recargaCombo('periodo', 'CRAObtienePeriodos', 'DTOPeriodo', \r        [\r           [ 'pais', get(pais de sesión) ], \r           [ 'marca', get(marca) ], \r           [ 'canal', get(canal) ]\r        ] );*/\r        \r        var pais = get(\"formulario.oidPais\");\r        var marca = get(\"formulario.cbMarca\");\r        var canal = get(\"formulario.cbCanal\");\r        \r        if (get('formulario.cbMarca','V') != '' && get('formulario.cbCanal','V') != ''){\r\r		    accion('formulario.cbPeriodo', '.disabled=false');\r			\r            var arr = new Array();  \r            arr[arr.length]=new Array(\"pais\", pais);\r            arr[arr.length]=new Array(\"marca\", marca);\r            arr[arr.length]=new Array(\"canal\", canal);\r         \r            recargaCombo(formName + \".cbPeriodo\",\r            \"CRAObtienePeriodos\",\r            \"es.indra.sicc.dtos.cra.DTOPeriodo\",\r            arr,\"\");      \r        }\r        else\r        {\r            var datosNuevo = new Array();\r            datosNuevo[0] = [\"\",\"\"];    \r            set_combo(\"formulario.cbPeriodo\", datosNuevo); \r			accion('formulario.cbPeriodo', '.disabled=true');\r        }\r    }\r    \r    function fLimpiar()\r    {\r        cargaPaginaInicial();\r    }\r    \r    function accionExitosa(){\r        cargaPaginaInicial();\r    }\r    \r    function accionError(){\r        focaliza('formulario.cbMarca');\r    }\r    \r    function cargaPaginaInicial()\r    {\r        focaliza(\"formulario.cbMarca\");\r        marcaSeleccionDelUsuario('formulario.cbMarca', get(\"formulario.hidMarcaDef\"));\r        marcaSeleccionDelUsuario('formulario.cbCanal', get(\"formulario.hidCanalDef\"));\r        recargarPeriodo();\r    }\r    \r    \r    function marcaSeleccionDelUsuario(pControl, datos)\r	{\r		datos = datos.split(\",\");\r		var comb = pControl;\r		set(comb, datos);\r	}\r   \r    \r       \r"));
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(16)).setAttribute("nombre","hidOidMarca" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(17)).setAttribute("nombre","hidOidCanal" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(18)).setAttribute("nombre","hidOidPeriodo" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(19)).setAttribute("nombre","hidMarcaDef" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(20)).setAttribute("nombre","hidCanalDef" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(40)).setAttribute("width","635" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(63)).setAttribute("ontab","focaliza('formulario.cbCanal')" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(90)).setAttribute("accion","onClickAceptar();" );
      ((Element)v.get(90)).setAttribute("cod","12" );
      ((Element)v.get(90)).setAttribute("estado","false" );
      ((Element)v.get(90)).setAttribute("ontab","focaliza('formulario.cbMarca')" );
      ((Element)v.get(90)).setAttribute("onshtab","focaliza('formulario.cbPeriodo')" );
