...
public class ConectorConfiguracionCamposProductos  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Rellenar combos de la pantalla busqueda Materiales" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","DTOSalidaTipoConfig" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(5)).setAttribute("NOMBRE","DTOSalidaTipoConfig" );
