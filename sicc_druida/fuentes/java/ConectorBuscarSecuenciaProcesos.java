...
public class ConectorBuscarSecuenciaProcesos  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(6)).setAttribute("NOMBRE","OID_SECU_PROC" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","TSPA_OID_TIPO_SOLI_PAIS" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(8)).setAttribute("NOMBRE","DESCRIPCION_TSP" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(9)).setAttribute("NOMBRE","GRPR_OID_GRUP_PROC" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(10)).setAttribute("NOMBRE","DESCRIPCION_GP" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(11)).setAttribute("NOMBRE","PROC_OID_PROC" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(12)).setAttribute("NOMBRE","COD_SECU" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(13)).setAttribute("NOMBRE","IND_EJEC_ONLI" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(14)).setAttribute("NOMBRE","DTOSalida" );
      ...
      ((Element)v.get(16)).setAttribute("NOMBRE","OID_SECU_PROC" );
      ...
      v.add(doc.createElement("CCAMPO"));
      ((Element)v.get(17)).setAttribute("NOMBRE","DESCRIPCION_TSP" );
      ((Element)v.get(17)).setAttribute("TIPO","STRING" );
      ((Element)v.get(17)).setAttribute("LONGITUD","400" );
      ((Element)v.get(15)).appendChild((Element)v.get(17));
      /* Termina nodo:17   */

      /* Empieza nodo:18 / Elemento padre: 15   */
      v.add(doc.createElement("CCAMPO"));
      ((Element)v.get(18)).setAttribute("NOMBRE","DESCRIPCION_GP" );
      ((Element)v.get(18)).setAttribute("TIPO","STRING" );
      ((Element)v.get(18)).setAttribute("LONGITUD","400" );
      ((Element)v.get(15)).appendChild((Element)v.get(18));
      /* Termina nodo:18   */

      /* Empieza nodo:19 / Elemento padre: 15   */
      v.add(doc.createElement("CCAMPO"));
      ((Element)v.get(19)).setAttribute("NOMBRE","PROC_OID_PROC" );
   }
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("CCAMPO"));
      ((Element)v.get(20)).setAttribute("NOMBRE","COD_SECU" );
      ((Element)v.get(20)).setAttribute("TIPO","STRING" );
      ((Element)v.get(20)).setAttribute("LONGITUD","3" );
      ((Element)v.get(15)).appendChild((Element)v.get(20));
      /* Termina nodo:20   */

      /* Empieza nodo:21 / Elemento padre: 15   */
      v.add(doc.createElement("CCAMPO"));
      ((Element)v.get(21)).setAttribute("NOMBRE","IND_EJEC_ONLI" );
