/*
    INDRA/CAR/mmg
    $Id: CobEtapaDeudaTipoCargoLPStartUp.java,v 1.1 2009/12/03 18:35:56 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class CobEtapaDeudaTipoCargoLPStartUp extends MMGDruidaBase{
	...
	public static final String BUSINESSID_QUERY = "MMGCobEtapaDeudaTipoCargoQueryFromToUserPage";
				...
				public static final String BUSINESSID_ETDEOIDETAPDEUD_QUERY ="MMGCobEtapaDeudaQueryFromToUser";
				public static final String ETDEOIDETAPDEUD_COMBO_CONNECTOR = "CobEtapaDeudaConectorCombo";
	
				public static final String BUSINESSID_TCABOIDTIPOCARGABON_QUERY ="MMGCccTipoCargoAbonoQueryFromToUser";
				public static final String TCABOIDTIPOCARGABON_COMBO_CONNECTOR = "CccTipoCargoAbonoConectorCombo";
	...
	public CobEtapaDeudaTipoCargoLPStartUp(){
		super();
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			buildJsPageSize("CobEtapaDeudaTipoCargo");
			...
			asignarAtributo("PAGINA", "CobEtapaDeudaTipoCargoPage", "cod", "CobEtapaDeudaTipoCargo." + accion + ".label");
			...
			limpiarBotoneraLista("cobEtapaDeudaTipoCargo", accion);
	...
	protected void cmdLov() throws Exception{
		...
		//asignarAtributo("CAPA", "cobEtapaDeudaTipoCargoLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "CobEtapaDeudaTipoCargoPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		CobEtapaDeudaTipoCargoData cobEtapaDeudaTipoCargoQuery= new CobEtapaDeudaTipoCargoData();
		cobEtapaDeudaTipoCargoQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		CobEtapaDeudaTipoCargoData datosResult = (CobEtapaDeudaTipoCargoData)getSingleObject(BUSINESSID_QUERY, cobEtapaDeudaTipoCargoQuery, 
			cobEtapaDeudaTipoCargoQuery.clone(), "cobEtapaDeudaTipoCargo");
		...
		CobEtapaDeudaTipoCargoData cobEtapaDeudaTipoCargo = datosResult;
		es.indra.belcorp.mso.CobEtapaDeudaData etdeOidEtapDeud = cobEtapaDeudaTipoCargo.getEtdeOidEtapDeud();
		if(etdeOidEtapDeud != null && etdeOidEtapDeud.getId() != null) checkCombo("etdeOidEtapDeud" , etdeOidEtapDeud.getId().toString());
		es.indra.belcorp.mso.CccTipoCargoAbonoData tcabOidTipoCargAbon = cobEtapaDeudaTipoCargo.getTcabOidTipoCargAbon();
		if(tcabOidTipoCargAbon != null && tcabOidTipoCargAbon.getId() != null) checkCombo("tcabOidTipoCargAbon" , tcabOidTipoCargAbon.getId().toString());
		asignar("TEXT", "valDesc", FormatUtils.formatObject(cobEtapaDeudaTipoCargo.getValDesc(), 
		...
		//Deshabilitamos todos los campos para que no se editen
					...
					asignarAtributo("COMBO", "etdeOidEtapDeud", "disabled", "S");
					asignarAtributo("COMBO", "tcabOidTipoCargAbon", "disabled", "S");asignarAtributo("TEXT", "valDesc", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		...
		asignarAtributo("COMBO", "etdeOidEtapDeud", "req", "S");
		asignarAtributo("COMBO", "tcabOidTipoCargAbon", "req", "S");
		...
		asignarAtributo("TEXT", "valDesc", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 0, 100);");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "cobEtapaDeudaTipoCargoFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		CobEtapaDeudaTipoCargoData cobEtapaDeudaTipoCargoQuery= new CobEtapaDeudaTipoCargoData();
		cobEtapaDeudaTipoCargoQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(cobEtapaDeudaTipoCargo.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"cobEtapaDeudaTipoCargoFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"cobEtapaDeudaTipoCargoFrm\",1, false)");
					asignarAtributo("COMBO","etdeOidEtapDeud", "ontab", "ejecutarAccionFocoModificacion(\"cobEtapaDeudaTipoCargoFrm\",2, true)");
					asignarAtributo("COMBO","etdeOidEtapDeud", "onshtab", "ejecutarAccionFocoModificacion(\"cobEtapaDeudaTipoCargoFrm\",2, false)");
					asignarAtributo("COMBO","tcabOidTipoCargAbon", "ontab", "ejecutarAccionFocoModificacion(\"cobEtapaDeudaTipoCargoFrm\",3, true)");
					asignarAtributo("COMBO","tcabOidTipoCargAbon", "onshtab", "ejecutarAccionFocoModificacion(\"cobEtapaDeudaTipoCargoFrm\",3, false)");
				asignarAtributo("AREATEXTO", "valDesc", "ontab","ejecutarAccionFocoModificacion(\"cobEtapaDeudaTipoCargoFrm\",4, true)");
				asignarAtributo("AREATEXTO", "valDesc", "onshtab","ejecutarAccionFocoModificacion(\"cobEtapaDeudaTipoCargoFrm\",4, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","cobEtapaDeudaTipoCargoTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","cobEtapaDeudaTipoCargoTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es etdeOidEtapDeud...");		
				
					traza("MMG: en desactivateNonModifyFields encontrado atributo no editable...");
				
						asignarAtributo("COMBO", "etdeOidEtapDeud", "disabled", "S");
				traza("MMG: el atributo es tcabOidTipoCargAbon...");		
				
					traza("MMG: en desactivateNonModifyFields encontrado atributo no editable...");
				
						asignarAtributo("COMBO", "tcabOidTipoCargAbon", "disabled", "S");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","cobEtapaDeudaTipoCargoFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","cobEtapaDeudaTipoCargoListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","cobEtapaDeudaTipoCargoListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(CobEtapaDeudaTipoCargoData cobEtapaDeudaTipoCargo) throws Exception{
		HashMap checkedCombos = new HashMap();
		CobEtapaDeudaData etdeOidEtapDeud = new CobEtapaDeudaData();
		
						asignarComboResultados(BUSINESSID_ETDEOIDETAPDEUD_QUERY,ETDEOIDETAPDEUD_COMBO_CONNECTOR, 
			etdeOidEtapDeud, etdeOidEtapDeud.clone(), "cobEtapaDeuda", "etdeOidEtapDeud", "result_ROWSET" );
		if(cobEtapaDeudaTipoCargo != null && cobEtapaDeudaTipoCargo.getEtdeOidEtapDeud() != null){
				checkCombo("etdeOidEtapDeud" , cobEtapaDeudaTipoCargo.getEtdeOidEtapDeud().getId().toString());
			}
		CccTipoCargoAbonoData tcabOidTipoCargAbon = new CccTipoCargoAbonoData();
		
						asignarComboResultados(BUSINESSID_TCABOIDTIPOCARGABON_QUERY,TCABOIDTIPOCARGABON_COMBO_CONNECTOR, 
			tcabOidTipoCargAbon, tcabOidTipoCargAbon.clone(), "cccTipoCargoAbono", "tcabOidTipoCargAbon", "result_ROWSET" );
		if(cobEtapaDeudaTipoCargo != null && cobEtapaDeudaTipoCargo.getTcabOidTipoCargAbon() != null){
				checkCombo("tcabOidTipoCargAbon" , cobEtapaDeudaTipoCargo.getTcabOidTipoCargAbon().getId().toString());
			}
	...
	* @param cobEtapaDeudaTipoCargo La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(CobEtapaDeudaTipoCargoData cobEtapaDeudaTipoCargo) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		CobEtapaDeudaTipoCargoData cobEtapaDeudaTipoCargo = 
			(CobEtapaDeudaTipoCargoData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(cobEtapaDeudaTipoCargo.getEtdeOidEtapDeud() != null){
			cobEtapaDeudaTipoCargo.setEtdeOidEtapDeud((es.indra.belcorp.mso.CobEtapaDeudaData)
			getSingleObject(BUSINESSID_ETDEOIDETAPDEUD_QUERY, 
			cobEtapaDeudaTipoCargo.getEtdeOidEtapDeud(),
			cobEtapaDeudaTipoCargo.getEtdeOidEtapDeud().clone(),
			"cobEtapaDeuda"));
		}
		if(cobEtapaDeudaTipoCargo.getTcabOidTipoCargAbon() != null){
			cobEtapaDeudaTipoCargo.setTcabOidTipoCargAbon((es.indra.belcorp.mso.CccTipoCargoAbonoData)
			getSingleObject(BUSINESSID_TCABOIDTIPOCARGABON_QUERY, 
			cobEtapaDeudaTipoCargo.getTcabOidTipoCargAbon(),
			cobEtapaDeudaTipoCargo.getTcabOidTipoCargAbon().clone(),
			"cccTipoCargoAbono"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(cobEtapaDeudaTipoCargo);
		loadLeafDependenceCombos(cobEtapaDeudaTipoCargo);
	}
