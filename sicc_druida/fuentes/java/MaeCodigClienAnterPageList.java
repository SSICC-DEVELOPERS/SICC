...
public class MaeCodigClienAnterPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","maeCodigClienAnterList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","MaeCodigClienAnter.clieOidClieNuev.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","MaeCodigClienAnter.codClieAnti.label" );
      ...
      ((Element)v.get(17)).setAttribute("cod","MaeCodigClienAnter.paisOidPais.label" );
      ...
      ((Element)v.get(18)).setAttribute("cod","MaeCodigClienAnter.valSistProc.label" );
