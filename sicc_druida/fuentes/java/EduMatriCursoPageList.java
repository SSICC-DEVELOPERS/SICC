...
public class EduMatriCursoPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","eduMatriCursoList" );
   ...
   private void getXML180(Document doc) {
      ...
      /* Empieza nodo:52 / Elemento padre: 0   */
   }

   private void getXML270(Document doc) {
      v.add(doc.createElement("CABECERA"));
      ((Element)v.get(52)).setAttribute("height","20" );
      ((Element)v.get(52)).setAttribute("IDScroll","EstCab" );
      ((Element)v.get(52)).setAttribute("imgFondo","" );
      ((Element)v.get(52)).setAttribute("colFondo","#CCCCCC" );
      ((Element)v.get(0)).appendChild((Element)v.get(52));

      /* Empieza nodo:53 / Elemento padre: 52   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(53)).setAttribute("colFondo","" );
      ((Element)v.get(53)).setAttribute("ID","EstCab" );
      ((Element)v.get(53)).setAttribute("cod","EduMatriCurso.paisOidPais.label" );
      ...
      ((Element)v.get(54)).setAttribute("cod","EduMatriCurso.cplcOidCabePlanCurs.label" );
      ...
      ((Element)v.get(55)).setAttribute("cod","EduMatriCurso.codCurs.label" );
      ...
      ((Element)v.get(56)).setAttribute("cod","EduMatriCurso.terrOidTerr.label" );
      ...
      ((Element)v.get(57)).setAttribute("cod","EduMatriCurso.clasOidClas.label" );
      ...
      ((Element)v.get(58)).setAttribute("cod","EduMatriCurso.frcuOidFrec.label" );
      ...
      ((Element)v.get(59)).setAttribute("cod","EduMatriCurso.regaOidRega.label" );
      ...
      ((Element)v.get(60)).setAttribute("cod","EduMatriCurso.zsgvOidSubgVent.label" );
      ...
      ((Element)v.get(61)).setAttribute("cod","EduMatriCurso.zorgOidRegi.label" );
      ...
      ((Element)v.get(62)).setAttribute("cod","EduMatriCurso.zzonOidZona.label" );
      ...
      ((Element)v.get(63)).setAttribute("cod","EduMatriCurso.zsccOidSecc.label" );
      ...
      ((Element)v.get(64)).setAttribute("cod","EduMatriCurso.ztadOidTerrAdmi.label" );
      ...
      ((Element)v.get(65)).setAttribute("cod","EduMatriCurso.perdOidPeriInicComp.label" );
      ...
      ((Element)v.get(66)).setAttribute("cod","EduMatriCurso.perdOidPeriFinaComp.label" );
      ...
      ((Element)v.get(67)).setAttribute("cod","EduMatriCurso.perdOidPeriInicCons.label" );
      ...
      ((Element)v.get(68)).setAttribute("cod","EduMatriCurso.perdOidPeriFinaCons.label" );
      ...
      ((Element)v.get(69)).setAttribute("cod","EduMatriCurso.perdOidPeriIngr.label" );
   }
   ...
   private void getXML360(Document doc) {
      ...
      /* Empieza nodo:70 / Elemento padre: 52   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(70)).setAttribute("colFondo","" );
      ((Element)v.get(70)).setAttribute("ID","EstCab" );
      ((Element)v.get(70)).setAttribute("cod","EduMatriCurso.ticuOidTipoCurs.label" );
      ((Element)v.get(52)).appendChild((Element)v.get(70));
      /* Termina nodo:70   */
      ...
      ((Element)v.get(71)).setAttribute("cod","EduMatriCurso.valPathFich.label" );
      ((Element)v.get(52)).appendChild((Element)v.get(71));
      /* Termina nodo:71   */

      /* Empieza nodo:72 / Elemento padre: 52   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(72)).setAttribute("colFondo","" );
      ((Element)v.get(72)).setAttribute("ID","EstCab" );
      ((Element)v.get(72)).setAttribute("cod","EduMatriCurso.valObjeCurs.label" );
      ((Element)v.get(52)).appendChild((Element)v.get(72));
      /* Termina nodo:72   */
      ...
      ((Element)v.get(73)).setAttribute("cod","EduMatriCurso.valContCurs.label" );
      ...
      ((Element)v.get(74)).setAttribute("cod","EduMatriCurso.valRelaMateCurs.label" );
      ...
      ((Element)v.get(75)).setAttribute("cod","EduMatriCurso.valMontVent.label" );
      ((Element)v.get(52)).appendChild((Element)v.get(75));
      /* Termina nodo:75   */

      /* Empieza nodo:76 / Elemento padre: 52   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(76)).setAttribute("colFondo","" );
      ((Element)v.get(76)).setAttribute("ID","EstCab" );
      ((Element)v.get(76)).setAttribute("cod","EduMatriCurso.fecDispCurs.label" );
      ((Element)v.get(52)).appendChild((Element)v.get(76));
      /* Termina nodo:76   */

      /* Empieza nodo:77 / Elemento padre: 52   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(77)).setAttribute("colFondo","" );
      ((Element)v.get(77)).setAttribute("ID","EstCab" );
      ((Element)v.get(77)).setAttribute("cod","EduMatriCurso.fecLanz.label" );
      ((Element)v.get(52)).appendChild((Element)v.get(77));
      /* Termina nodo:77   */
      ...
      ((Element)v.get(78)).setAttribute("cod","EduMatriCurso.fecFinCurs.label" );
      ...
      ((Element)v.get(79)).setAttribute("cod","EduMatriCurso.fecUltiCurs.label" );
      ...
      ((Element)v.get(80)).setAttribute("cod","EduMatriCurso.fecConcCurs.label" );
      ...
      ((Element)v.get(81)).setAttribute("cod","EduMatriCurso.fecIngr.label" );
      ...
      ((Element)v.get(82)).setAttribute("cod","EduMatriCurso.numPart.label" );
      ((Element)v.get(52)).appendChild((Element)v.get(82));
      /* Termina nodo:82   */

      /* Empieza nodo:83 / Elemento padre: 52   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(83)).setAttribute("colFondo","" );
      ((Element)v.get(83)).setAttribute("ID","EstCab" );
      ((Element)v.get(83)).setAttribute("cod","EduMatriCurso.numOrde.label" );
      ((Element)v.get(52)).appendChild((Element)v.get(83));
      /* Termina nodo:83   */

      /* Empieza nodo:84 / Elemento padre: 52   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(84)).setAttribute("colFondo","" );
      ((Element)v.get(84)).setAttribute("ID","EstCab" );
      ((Element)v.get(84)).setAttribute("cod","EduMatriCurso.numCampa.label" );
      ((Element)v.get(52)).appendChild((Element)v.get(84));
      /* Termina nodo:84   */

      /* Empieza nodo:85 / Elemento padre: 52   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(85)).setAttribute("colFondo","" );
      ((Element)v.get(85)).setAttribute("ID","EstCab" );
      ((Element)v.get(85)).setAttribute("cod","EduMatriCurso.numUnid.label" );
      ((Element)v.get(52)).appendChild((Element)v.get(85));
      /* Termina nodo:85   */
      ...
      ((Element)v.get(86)).setAttribute("cod","EduMatriCurso.desCurs.label" );
      ((Element)v.get(52)).appendChild((Element)v.get(86));
      /* Termina nodo:86   */

      /* Empieza nodo:87 / Elemento padre: 52   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(87)).setAttribute("colFondo","" );
      ((Element)v.get(87)).setAttribute("ID","EstCab" );
      ((Element)v.get(87)).setAttribute("cod","EduMatriCurso.indAcceDmrt.label" );
   }

   private void getXML450(Document doc) {
      ((Element)v.get(52)).appendChild((Element)v.get(87));
      /* Termina nodo:87   */
      ...
      ((Element)v.get(88)).setAttribute("cod","EduMatriCurso.indAcceInfo.label" );
      ...
      ((Element)v.get(89)).setAttribute("cod","EduMatriCurso.indAlcaGeog.label" );
      ((Element)v.get(52)).appendChild((Element)v.get(89));
      /* Termina nodo:89   */

      /* Empieza nodo:90 / Elemento padre: 52   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(90)).setAttribute("colFondo","" );
      ((Element)v.get(90)).setAttribute("ID","EstCab" );
      ((Element)v.get(90)).setAttribute("cod","EduMatriCurso.indBloqExte.label" );
      ((Element)v.get(52)).appendChild((Element)v.get(90));
      /* Termina nodo:90   */

      /* Empieza nodo:91 / Elemento padre: 52   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(91)).setAttribute("colFondo","" );
      ((Element)v.get(91)).setAttribute("ID","EstCab" );
      ((Element)v.get(91)).setAttribute("cod","EduMatriCurso.indMomeEntr.label" );
      ((Element)v.get(52)).appendChild((Element)v.get(91));
      /* Termina nodo:91   */

      /* Empieza nodo:92 / Elemento padre: 52   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(92)).setAttribute("colFondo","" );
      ((Element)v.get(92)).setAttribute("ID","EstCab" );
      ((Element)v.get(92)).setAttribute("cod","EduMatriCurso.indCondPedi.label" );
      ((Element)v.get(52)).appendChild((Element)v.get(92));
      /* Termina nodo:92   */
      ...
      ((Element)v.get(93)).setAttribute("cod","EduMatriCurso.indCtrlMoro.label" );
      ((Element)v.get(52)).appendChild((Element)v.get(93));
      /* Termina nodo:93   */

      /* Empieza nodo:94 / Elemento padre: 52   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(94)).setAttribute("colFondo","" );
      ((Element)v.get(94)).setAttribute("ID","EstCab" );
      ((Element)v.get(94)).setAttribute("cod","EduMatriCurso.indCtrlFunc.label" );
      ((Element)v.get(52)).appendChild((Element)v.get(94));
      /* Termina nodo:94   */
      ...
      ((Element)v.get(95)).setAttribute("cod","EduMatriCurso.clclOidClieClasCapa.label" );
      ((Element)v.get(52)).appendChild((Element)v.get(95));
      /* Termina nodo:95   */
      /* Termina nodo:52   */

      /* Empieza nodo:96 / Elemento padre: 0   */
      v.add(doc.createElement("DATOS"));
      ((Element)v.get(96)).setAttribute("alto","22" );
      ((Element)v.get(96)).setAttribute("accion","" );
      ((Element)v.get(96)).setAttribute("tipoEnvio","seleccion" );
      ((Element)v.get(96)).setAttribute("formaEnvio","xml" );
      ((Element)v.get(96)).setAttribute("maxSel","1" );
      ((Element)v.get(96)).setAttribute("msgErrMaxSel","" );
      ((Element)v.get(96)).setAttribute("coloresScrollNativo","#D4D0C8,black,white,#D4D0C8,#D4D0C8,#ECE9E4,black" );
      ((Element)v.get(96)).setAttribute("colorROver","#D0D9E8" );
      ((Element)v.get(96)).setAttribute("onLoad","" );
      ((Element)v.get(96)).setAttribute("colorSelecc","#D0D9E8" );
      ((Element)v.get(0)).appendChild((Element)v.get(96));
   ...
   private void getXML540(Document doc) {
      ...
      /* Empieza nodo:125 / Elemento padre: 96   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(125)).setAttribute("tipo","texto" );
      ((Element)v.get(125)).setAttribute("ID","EstDat" );
      ((Element)v.get(96)).appendChild((Element)v.get(125));
      /* Termina nodo:125   */

      /* Empieza nodo:126 / Elemento padre: 96   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(126)).setAttribute("tipo","texto" );
      ((Element)v.get(126)).setAttribute("ID","EstDat2" );
      ((Element)v.get(96)).appendChild((Element)v.get(126));
      /* Termina nodo:126   */

      /* Empieza nodo:127 / Elemento padre: 96   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(127)).setAttribute("tipo","texto" );
      ((Element)v.get(127)).setAttribute("ID","EstDat" );
      ((Element)v.get(96)).appendChild((Element)v.get(127));
      /* Termina nodo:127   */

      /* Empieza nodo:128 / Elemento padre: 96   */
      v.add(doc.createElement("COL"));
   ...
   private void getXML630(Document doc) {
      ((Element)v.get(96)).appendChild((Element)v.get(128));
      /* Termina nodo:128   */
      ...
      /* Empieza nodo:138 / Elemento padre: 96   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(138)).setAttribute("tipo","texto" );
      ((Element)v.get(138)).setAttribute("ID","EstDat2" );
      ((Element)v.get(96)).appendChild((Element)v.get(138));
      /* Termina nodo:138   */

      /* Empieza nodo:139 / Elemento padre: 96   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(139)).setAttribute("tipo","texto" );
      ((Element)v.get(139)).setAttribute("ID","EstDat" );
      ((Element)v.get(96)).appendChild((Element)v.get(139));
      /* Termina nodo:139   */
      /* Termina nodo:96   */

      /* Empieza nodo:140 / Elemento padre: 0   */
      v.add(doc.createElement("ROWSET"));
      ((Element)v.get(0)).appendChild((Element)v.get(140));
      /* Termina nodo:140   */
