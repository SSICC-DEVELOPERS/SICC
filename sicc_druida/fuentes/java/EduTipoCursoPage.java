...
public class EduTipoCursoPage  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","EduTipoCursoPage" );
      ((Element)v.get(0)).setAttribute("titulo","" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","" );
      ((Element)v.get(0)).setAttribute("onload","eduTipoCursoInitComponents()" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","edutipocurso.js" );
      ((Element)v.get(0)).appendChild((Element)v.get(4));
      /* Termina nodo:4   */

      /* Empieza nodo:5 / Elemento padre: 0   */
      v.add(doc.createElement("FORMULARIO"));
      ((Element)v.get(5)).setAttribute("nombre","eduTipoCursoFrm" );
      ...
      ((Element)v.get(6)).setAttribute("valor","EduTipoCursoLPExecution" );
      ...
      ((Element)v.get(7)).setAttribute("valor","EduTipoCursoLPExecution" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(37)).setAttribute("nombre","eduTipoCursoFormLayer" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(52)).setAttribute("cod","EduTipoCurso.legend.label" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(67)).setAttribute("cod","EduTipoCurso.id.label" );
      ...
      ((Element)v.get(70)).setAttribute("ontab","ejecutarAccionFoco('eduTipoCursoFrm',1, true)" );
      ((Element)v.get(70)).setAttribute("onshtab","ejecutarAccionFoco('eduTipoCursoFrm', 1, false)" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(88)).setAttribute("nombre","marcOidMarcTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(93)).setAttribute("nombre","marcOidMarcWidgetTrId" );
      ...
      ((Element)v.get(95)).setAttribute("nombre","marcOidMarc" );
      ...
      ((Element)v.get(95)).setAttribute("ontab","ejecutarAccionFoco('eduTipoCursoFrm',2, true);" );
      ((Element)v.get(95)).setAttribute("onshtab","ejecutarAccionFoco('eduTipoCursoFrm',2, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(97)).setAttribute("nombre","marcOidMarcGapTdId" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(99)).setAttribute("nombre","codTipoCursTdId" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(104)).setAttribute("nombre","codTipoCursWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(106)).setAttribute("nombre","codTipoCurs" );
      ...
      ((Element)v.get(106)).setAttribute("ontab","ejecutarAccionFoco('eduTipoCursoFrm',3, true)" );
      ((Element)v.get(106)).setAttribute("onshtab","ejecutarAccionFoco('eduTipoCursoFrm', 3, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(107)).setAttribute("nombre","codTipoCursGapTdId" );
      ...
      ((Element)v.get(113)).setAttribute("cod","EduTipoCurso.Descripcion.label" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(117)).setAttribute("ontab","ejecutarAccionFoco('eduTipoCursoFrm',4, true)" );
      ((Element)v.get(117)).setAttribute("onshtab","ejecutarAccionFoco('eduTipoCursoFrm', 4, false)" );
      ...
      ((Element)v.get(121)).setAttribute("href","javascript:openLocalizationDialog('eduTipoCursoFrm', 'Descripcion', 1);" );
      ((Element)v.get(121)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"eduTipoCursoFrm\",4, true)', 'ejecutarAccionFoco(\"eduTipoCursoFrm\",4, false)')" );
   ...
   private void getXML630(Document doc) {
      ((Element)v.get(137)).setAttribute("nombre","eduTipoCursoTrButtons" );
      ...
      ((Element)v.get(144)).setAttribute("nombre","eduTipoCursoTdQueryButton" );
      ((Element)v.get(143)).appendChild((Element)v.get(144));

      /* Empieza nodo:145 / Elemento padre: 144   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(145)).setAttribute("nombre","eduTipoCursoQueryButton" );
      ((Element)v.get(145)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(145)).setAttribute("estado","false" );
      ((Element)v.get(145)).setAttribute("accion","eduTipoCursoFirstPage();" );
      ...
      ((Element)v.get(146)).setAttribute("nombre","eduTipoCursoTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(148)).setAttribute("nombre","eduTipoCursoLovNullButton" );
      ((Element)v.get(148)).setAttribute("ID","botonContenido" );
      ((Element)v.get(148)).setAttribute("tipo","html" );
      ((Element)v.get(148)).setAttribute("accion","eduTipoCursoLovNullSelectionAction();" );
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(151)).setAttribute("nombre","eduTipoCursoListLayer" );
      ...
      ((Element)v.get(152)).setAttribute("nombre","eduTipoCursoList" );
   ...
   private void getXML720(Document doc) {
      ...
      ((Element)v.get(166)).setAttribute("cod","EduTipoCurso.marcOidMarc.label" );
      ...
      ((Element)v.get(167)).setAttribute("cod","EduTipoCurso.codTipoCurs.label" );
      ...
      ((Element)v.get(168)).setAttribute("cod","EduTipoCurso.Descripcion.label" );
   ...
   private void getXML810(Document doc) {
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(174)).setAttribute("nombre","eduTipoCursoListButtonsLayer" );
      ...
      ((Element)v.get(180)).setAttribute("nombre","eduTipoCursoPaginationButtonBar" );
      ...
      ((Element)v.get(181)).setAttribute("nombre","eduTipoCursoFirstPageButton" );
      ((Element)v.get(181)).setAttribute("funcion","eduTipoCursoFirstPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(182)).setAttribute("nombre","eduTipoCursoFirstPageButtonGapTd" );
   ...
   private void getXML900(Document doc) {
      v.add(doc.createElement("BTN"));
      ((Element)v.get(184)).setAttribute("nombre","eduTipoCursoPreviousPageButton" );
      ((Element)v.get(184)).setAttribute("funcion","eduTipoCursoPreviousPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(185)).setAttribute("nombre","eduTipoCursoPreviousPageButtonGapTd" );
      ...
      v.add(doc.createElement("BTN"));
      ((Element)v.get(187)).setAttribute("nombre","eduTipoCursoNextPageButton" );
      ((Element)v.get(187)).setAttribute("funcion","eduTipoCursoNextPage();" );
      ...
      ((Element)v.get(190)).setAttribute("nombre","eduTipoCursoUpdateButtonTd" );
      ((Element)v.get(176)).appendChild((Element)v.get(190));

      /* Empieza nodo:191 / Elemento padre: 190   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(191)).setAttribute("nombre","eduTipoCursoUpdateButton" );
      ((Element)v.get(191)).setAttribute("ID","botonContenido" );
      ((Element)v.get(191)).setAttribute("tipo","html" );
      ((Element)v.get(191)).setAttribute("accion","eduTipoCursoUpdateSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(192)).setAttribute("nombre","eduTipoCursoUpdateButtonGapTd" );
      ...
      ((Element)v.get(194)).setAttribute("nombre","eduTipoCursoViewForRemoveButtonTd" );
      ((Element)v.get(176)).appendChild((Element)v.get(194));

      /* Empieza nodo:195 / Elemento padre: 194   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(195)).setAttribute("nombre","eduTipoCursoViewForRemoveButton" );
      ((Element)v.get(195)).setAttribute("ID","botonContenido" );
      ((Element)v.get(195)).setAttribute("tipo","html" );
      ((Element)v.get(195)).setAttribute("accion","eduTipoCursoViewSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(196)).setAttribute("nombre","eduTipoCursoViewForRemoveButtonGapTd" );
      ...
      ((Element)v.get(198)).setAttribute("nombre","eduTipoCursoLovSelectButtonTd" );
      ((Element)v.get(176)).appendChild((Element)v.get(198));

      /* Empieza nodo:199 / Elemento padre: 198   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(199)).setAttribute("nombre","eduTipoCursoLovSelectButton" );
      ((Element)v.get(199)).setAttribute("ID","botonContenido" );
      ((Element)v.get(199)).setAttribute("tipo","html" );
      ((Element)v.get(199)).setAttribute("accion","eduTipoCursoLovSelectionAction();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(200)).setAttribute("nombre","eduTipoCursoLovSelectButtonGapTd" );
   ...
   private void getXML990(Document doc) {
      ...
      ((Element)v.get(202)).setAttribute("nombre","eduTipoCursoViewButtonTd" );
      ((Element)v.get(176)).appendChild((Element)v.get(202));

      /* Empieza nodo:203 / Elemento padre: 202   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(203)).setAttribute("nombre","eduTipoCursoViewButton" );
      ((Element)v.get(203)).setAttribute("ID","botonContenido" );
      ((Element)v.get(203)).setAttribute("tipo","html" );
      ((Element)v.get(203)).setAttribute("accion","eduTipoCursoViewSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(204)).setAttribute("nombre","eduTipoCursoViewButtonGapTd" );
