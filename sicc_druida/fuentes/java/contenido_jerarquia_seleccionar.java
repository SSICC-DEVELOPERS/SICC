...
public class contenido_jerarquia_seleccionar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_jerarquia_seleccionar" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(2)).setAttribute("src","jerarquia_seleccionar.js" );
      ...
      v.add(doc.createTextNode("\r\r   \rfunction fInit(){\r  configurarMenuSecundario(getFormularioSICC());\r    var CasoUso = get('frmSeleccionar.CasoUso');\r    if (CasoUso == '') { \r      focalizaBotonHTML('botonContenido','btnInsertar');\r    }\r    else {\r      if (CasoUso == 'Modificar') {\r        focalizaBotonHTML('botonContenido','btnModificar');\r      }\r      else {\r        if (CasoUso == 'Consultar') {\r          focalizaBotonHTML('botonContenido','btnConsultar');\r        } \r      }\r    }\r}\r\r"));
      ...
      ((Element)v.get(6)).setAttribute("nombre","frmSeleccionar" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(9)).setAttribute("nombre","nombreArbol" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(10)).setAttribute("nombre","seleccionado" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(11)).setAttribute("nombre","nivel_padre" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(14)).setAttribute("nombre","nivel_pulsado" );
      ...
      ((Element)v.get(17)).setAttribute("nombre","capaPrincipal" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(36)).setAttribute("height","230" );
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(44)).setAttribute("width","756" );
      ...
      ((Element)v.get(48)).setAttribute("nombre","miscroll" );
   }

   private void getXML180(Document doc) {
      ((Element)v.get(48)).setAttribute("x","22" );
      ((Element)v.get(48)).setAttribute("y","28" );
      ((Element)v.get(48)).setAttribute("ancho","800" );
      ((Element)v.get(48)).setAttribute("alto","250" );
      ((Element)v.get(48)).setAttribute("colorf","" );
      ((Element)v.get(48)).setAttribute("visibilidad","visible" );
      ((Element)v.get(48)).setAttribute("incx","10" );
      ((Element)v.get(48)).setAttribute("incy","10" );
      ((Element)v.get(48)).setAttribute("colores","" );
      ((Element)v.get(17)).appendChild((Element)v.get(48));

      /* Empieza nodo:49 / Elemento padre: 48   */
      v.add(doc.createElement("REJILLA"));
      ((Element)v.get(49)).setAttribute("nombre","RArbol" );
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(50)).setAttribute("nombre","capaInsertar" );
      ((Element)v.get(50)).setAttribute("x","0" );
      ((Element)v.get(50)).setAttribute("y","255" );
      ((Element)v.get(50)).setAttribute("visibilidad","" );
      ...
      ((Element)v.get(60)).setAttribute("nombre","btnInsertar" );
      ((Element)v.get(60)).setAttribute("ID","botonContenido" );
      ((Element)v.get(60)).setAttribute("tipo","html" );
      ((Element)v.get(60)).setAttribute("accion","fInsertar();" );
      ((Element)v.get(60)).setAttribute("estado","false" );
      ((Element)v.get(60)).setAttribute("cod","1217" );
      ((Element)v.get(60)).setAttribute("ontab","focoBotonInsertar();" );
      ((Element)v.get(60)).setAttribute("onshtab","focoBotonInsertar();" );
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(66)).setAttribute("width","756" );
      ...
      ((Element)v.get(67)).setAttribute("width","412" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(70)).setAttribute("nombre","capaConsultar" );
      ((Element)v.get(70)).setAttribute("x","0" );
      ((Element)v.get(70)).setAttribute("y","255" );
      ((Element)v.get(70)).setAttribute("visibilidad","hidden" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(80)).setAttribute("nombre","btnConsultar" );
      ((Element)v.get(80)).setAttribute("ID","botonContenido" );
      ((Element)v.get(80)).setAttribute("tipo","html" );
      ((Element)v.get(80)).setAttribute("accion","fConsultar();" );
      ((Element)v.get(80)).setAttribute("estado","false" );
      ((Element)v.get(80)).setAttribute("cod","150" );
      ((Element)v.get(80)).setAttribute("ontab","focoBotonConsultar();" );
      ((Element)v.get(80)).setAttribute("onshtab","focoBotonConsultar();" );
      ...
      ((Element)v.get(87)).setAttribute("width","412" );
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(90)).setAttribute("nombre","capaModificar" );
      ((Element)v.get(90)).setAttribute("x","0" );
      ((Element)v.get(90)).setAttribute("y","255" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(100)).setAttribute("nombre","btnModificar" );
      ...
      ((Element)v.get(100)).setAttribute("ontab","focoBotonModificar();" );
      ((Element)v.get(100)).setAttribute("onshtab","focoBotonModificar();" );
      ...
      ((Element)v.get(107)).setAttribute("width","412" );
