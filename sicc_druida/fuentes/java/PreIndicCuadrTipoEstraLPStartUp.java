/*
    INDRA/CAR/mmg
    $Id: PreIndicCuadrTipoEstraLPStartUp.java,v 1.1 2009/12/03 18:38:47 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class PreIndicCuadrTipoEstraLPStartUp extends MMGDruidaBase{
	...
	public static final String BUSINESSID_QUERY = "MMGPreIndicCuadrTipoEstraQueryFromToUserPage";
				...
				public static final String BUSINESSID_INDCOIDINDICUAD_QUERY ="MMGPreIndicCuadrQueryFromToUser";
				public static final String INDCOIDINDICUAD_COMBO_CONNECTOR = "PreIndicCuadrConectorCombo";
	...
	public PreIndicCuadrTipoEstraLPStartUp(){
		super();
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			buildJsPageSize("PreIndicCuadrTipoEstra");
			...
			asignarAtributo("PAGINA", "PreIndicCuadrTipoEstraPage", "cod", "PreIndicCuadrTipoEstra." + accion + ".label");
			...
			limpiarBotoneraLista("preIndicCuadrTipoEstra", accion);
	...
	protected void cmdLov() throws Exception{
		...
		//asignarAtributo("CAPA", "preIndicCuadrTipoEstraLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "PreIndicCuadrTipoEstraPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		PreIndicCuadrTipoEstraData preIndicCuadrTipoEstraQuery= new PreIndicCuadrTipoEstraData();
		preIndicCuadrTipoEstraQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		PreIndicCuadrTipoEstraData datosResult = (PreIndicCuadrTipoEstraData)getSingleObject(BUSINESSID_QUERY, preIndicCuadrTipoEstraQuery, 
			preIndicCuadrTipoEstraQuery.clone(), "preIndicCuadrTipoEstra");
		...
		PreIndicCuadrTipoEstraData preIndicCuadrTipoEstra = datosResult;
		es.indra.belcorp.mso.PreIndicCuadrData indcOidIndiCuad = preIndicCuadrTipoEstra.getIndcOidIndiCuad();
		if(indcOidIndiCuad != null && indcOidIndiCuad.getId() != null) checkCombo("indcOidIndiCuad" , indcOidIndiCuad.getId().toString());
		es.indra.belcorp.mso.PreTipoEstraData tiesOidTipoEstr = preIndicCuadrTipoEstra.getTiesOidTipoEstr();
		if(tiesOidTipoEstr != null && tiesOidTipoEstr.getId() != null) checkCombo("tiesOidTipoEstr" , tiesOidTipoEstr.getId().toString());
		asignarAtributo("CHECKBOX", "indOferMonoGrup" , "check", FormatUtils.formatObject(
			preIndicCuadrTipoEstra.getIndOferMonoGrup(), 
		...
		//Deshabilitamos todos los campos para que no se editen
					...
					asignarAtributo("COMBO", "indcOidIndiCuad", "disabled", "S");
					asignarAtributo("COMBO", "tiesOidTipoEstr", "disabled", "S");
					asignarAtributo("CHECKBOX", "indOferMonoGrup", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		...
		asignarAtributo("COMBO", "indcOidIndiCuad", "req", "S");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "preIndicCuadrTipoEstraFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		PreIndicCuadrTipoEstraData preIndicCuadrTipoEstraQuery= new PreIndicCuadrTipoEstraData();
		preIndicCuadrTipoEstraQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(preIndicCuadrTipoEstra.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"preIndicCuadrTipoEstraFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"preIndicCuadrTipoEstraFrm\",1, false)");
					asignarAtributo("COMBO","indcOidIndiCuad", "ontab", "ejecutarAccionFocoModificacion(\"preIndicCuadrTipoEstraFrm\",2, true)");
					asignarAtributo("COMBO","indcOidIndiCuad", "onshtab", "ejecutarAccionFocoModificacion(\"preIndicCuadrTipoEstraFrm\",2, false)");
					asignarAtributo("COMBO","tiesOidTipoEstr", "ontab", "ejecutarAccionFocoModificacion(\"preIndicCuadrTipoEstraFrm\",3, true)");
					asignarAtributo("COMBO","tiesOidTipoEstr", "onshtab", "ejecutarAccionFocoModificacion(\"preIndicCuadrTipoEstraFrm\",3, false)");
				asignarAtributo("TEXT", "indOferMonoGrup", "ontab","ejecutarAccionFocoModificacion(\"preIndicCuadrTipoEstraFrm\",4, true)");
				asignarAtributo("TEXT", "indOferMonoGrup", "onshtab","ejecutarAccionFocoModificacion(\"preIndicCuadrTipoEstraFrm\",4, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","preIndicCuadrTipoEstraTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","preIndicCuadrTipoEstraTrButtons");
	...
	*/
	protected void removeNonSearchElements() throws Exception{
		borrarCampo("id");
		borrarCampo("indcOidIndiCuad");
		borrarCampo("indOferMonoGrup");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es indcOidIndiCuad...");		
				
				traza("MMG: el atributo es tiesOidTipoEstr...");		
				
				traza("MMG: el atributo es indOferMonoGrup...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","preIndicCuadrTipoEstraFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","preIndicCuadrTipoEstraListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","preIndicCuadrTipoEstraListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(PreIndicCuadrTipoEstraData preIndicCuadrTipoEstra) throws Exception{
		HashMap checkedCombos = new HashMap();
		PreIndicCuadrData indcOidIndiCuad = new PreIndicCuadrData();
		
						asignarComboResultados(BUSINESSID_INDCOIDINDICUAD_QUERY,INDCOIDINDICUAD_COMBO_CONNECTOR, 
			indcOidIndiCuad, indcOidIndiCuad.clone(), "preIndicCuadr", "indcOidIndiCuad", "result_ROWSET" );
		if(preIndicCuadrTipoEstra != null && preIndicCuadrTipoEstra.getIndcOidIndiCuad() != null){
				checkCombo("indcOidIndiCuad" , preIndicCuadrTipoEstra.getIndcOidIndiCuad().getId().toString());
			}
		...
		if(preIndicCuadrTipoEstra != null && preIndicCuadrTipoEstra.getTiesOidTipoEstr() != null){
				checkCombo("tiesOidTipoEstr" , preIndicCuadrTipoEstra.getTiesOidTipoEstr().getId().toString());
			}
	...
	* @param preIndicCuadrTipoEstra La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(PreIndicCuadrTipoEstraData preIndicCuadrTipoEstra) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		PreIndicCuadrTipoEstraData preIndicCuadrTipoEstra = 
			(PreIndicCuadrTipoEstraData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(preIndicCuadrTipoEstra.getIndcOidIndiCuad() != null){
			preIndicCuadrTipoEstra.setIndcOidIndiCuad((es.indra.belcorp.mso.PreIndicCuadrData)
			getSingleObject(BUSINESSID_INDCOIDINDICUAD_QUERY, 
			preIndicCuadrTipoEstra.getIndcOidIndiCuad(),
			preIndicCuadrTipoEstra.getIndcOidIndiCuad().clone(),
			"preIndicCuadr"));
		}
		if(preIndicCuadrTipoEstra.getTiesOidTipoEstr() != null){
			preIndicCuadrTipoEstra.setTiesOidTipoEstr((es.indra.belcorp.mso.PreTipoEstraData)
			getSingleObject(BUSINESSID_TIESOIDTIPOESTR_QUERY, 
			preIndicCuadrTipoEstra.getTiesOidTipoEstr(),
			preIndicCuadrTipoEstra.getTiesOidTipoEstr().clone(),
			"preTipoEstra"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(preIndicCuadrTipoEstra);
		loadLeafDependenceCombos(preIndicCuadrTipoEstra);
	}
