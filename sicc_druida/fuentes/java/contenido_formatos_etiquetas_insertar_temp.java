...
public class contenido_formatos_etiquetas_insertar_temp  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(21)).setAttribute("nombre","lblDatosAlta" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(34)).setAttribute("nombre","lblLineaArmado" );
      ...
      ((Element)v.get(34)).setAttribute("cod","2095" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(46)).setAttribute("nombre","cbLineaArmado" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(61)).setAttribute("nombre","lblSublinea" );
      ...
      ((Element)v.get(61)).setAttribute("cod","2928" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(65)).setAttribute("nombre","lblFormato" );
      ...
      ((Element)v.get(65)).setAttribute("cod","2928" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(72)).setAttribute("nombre","cbSublinea" );
      ...
      ((Element)v.get(77)).setAttribute("nombre","txtFormato" );
      ...
      ((Element)v.get(87)).setAttribute("cod","MMGGlobal.localization.bindbutton.label" );
