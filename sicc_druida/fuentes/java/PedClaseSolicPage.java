...
public class PedClaseSolicPage  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","PedClaseSolicPage" );
      ((Element)v.get(0)).setAttribute("titulo","" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","" );
      ((Element)v.get(0)).setAttribute("onload","pedClaseSolicInitComponents()" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","pedclasesolic.js" );
      ((Element)v.get(0)).appendChild((Element)v.get(4));
      /* Termina nodo:4   */

      /* Empieza nodo:5 / Elemento padre: 0   */
      v.add(doc.createElement("FORMULARIO"));
      ((Element)v.get(5)).setAttribute("nombre","pedClaseSolicFrm" );
      ...
      ((Element)v.get(6)).setAttribute("valor","PedClaseSolicLPExecution" );
      ...
      ((Element)v.get(7)).setAttribute("valor","PedClaseSolicLPExecution" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(37)).setAttribute("nombre","indOrdeCompCheckValue" );
      ...
      ((Element)v.get(38)).setAttribute("nombre","pedClaseSolicFormLayer" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(53)).setAttribute("cod","PedClaseSolic.legend.label" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(68)).setAttribute("cod","PedClaseSolic.id.label" );
      ...
      ((Element)v.get(71)).setAttribute("ontab","ejecutarAccionFoco('pedClaseSolicFrm',1, true)" );
      ((Element)v.get(71)).setAttribute("onshtab","ejecutarAccionFoco('pedClaseSolicFrm', 1, false)" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(89)).setAttribute("nombre","codClasSoliTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(94)).setAttribute("nombre","codClasSoliWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(96)).setAttribute("nombre","codClasSoli" );
      ...
      ((Element)v.get(96)).setAttribute("ontab","ejecutarAccionFoco('pedClaseSolicFrm',2, true)" );
      ((Element)v.get(96)).setAttribute("onshtab","ejecutarAccionFoco('pedClaseSolicFrm', 2, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(97)).setAttribute("nombre","codClasSoliGapTdId" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(103)).setAttribute("cod","PedClaseSolic.Descripcion.label" );
      ...
      ((Element)v.get(107)).setAttribute("ontab","ejecutarAccionFoco('pedClaseSolicFrm',3, true)" );
      ((Element)v.get(107)).setAttribute("onshtab","ejecutarAccionFoco('pedClaseSolicFrm', 3, false)" );
      ...
      ((Element)v.get(111)).setAttribute("href","javascript:openLocalizationDialog('pedClaseSolicFrm', 'Descripcion', 1);" );
      ((Element)v.get(111)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"pedClaseSolicFrm\",3, true)', 'ejecutarAccionFoco(\"pedClaseSolicFrm\",3, false)')" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(115)).setAttribute("nombre","indOrdeCompTdId" );
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(120)).setAttribute("nombre","indOrdeCompWidgetTrId" );
      ...
      ((Element)v.get(122)).setAttribute("nombre","indOrdeComp" );
      ...
      ((Element)v.get(122)).setAttribute("ontab","ejecutarAccionFoco('pedClaseSolicFrm',4, true)" );
      ((Element)v.get(122)).setAttribute("onshtab","ejecutarAccionFoco('pedClaseSolicFrm',4, false)" );
      ((Element)v.get(121)).appendChild((Element)v.get(122));

      /* Empieza nodo:123 / Elemento padre: 122   */
      v.add(doc.createElement("RBINPUT"));
      ((Element)v.get(123)).setAttribute("id","datosCampos" );
      ((Element)v.get(123)).setAttribute("valor","1" );
      ((Element)v.get(123)).setAttribute("cod","PedClaseSolic.indOrdeComp.1.label" );
      ...
      ((Element)v.get(125)).setAttribute("cod","PedClaseSolic.indOrdeComp.0.label" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(127)).setAttribute("nombre","indOrdeCompGapTdId" );
   ...
   private void getXML630(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(141)).setAttribute("nombre","pedClaseSolicTrButtons" );
      ...
      ((Element)v.get(148)).setAttribute("nombre","pedClaseSolicTdQueryButton" );
      ((Element)v.get(147)).appendChild((Element)v.get(148));

      /* Empieza nodo:149 / Elemento padre: 148   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(149)).setAttribute("nombre","pedClaseSolicQueryButton" );
      ((Element)v.get(149)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(149)).setAttribute("estado","false" );
      ((Element)v.get(149)).setAttribute("accion","pedClaseSolicFirstPage();" );
      ...
      ((Element)v.get(150)).setAttribute("nombre","pedClaseSolicTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(152)).setAttribute("nombre","pedClaseSolicLovNullButton" );
      ((Element)v.get(152)).setAttribute("ID","botonContenido" );
      ((Element)v.get(152)).setAttribute("tipo","html" );
      ((Element)v.get(152)).setAttribute("accion","pedClaseSolicLovNullSelectionAction();" );
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(155)).setAttribute("nombre","pedClaseSolicListLayer" );
   ...
   private void getXML720(Document doc) {
      ...
      ((Element)v.get(156)).setAttribute("nombre","pedClaseSolicList" );
      ...
      ((Element)v.get(170)).setAttribute("cod","PedClaseSolic.codClasSoli.label" );
   ...
   private void getXML810(Document doc) {
      ...
      ((Element)v.get(171)).setAttribute("cod","PedClaseSolic.Descripcion.label" );
      ...
      ((Element)v.get(172)).setAttribute("cod","PedClaseSolic.indOrdeComp.label" );
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(178)).setAttribute("nombre","pedClaseSolicListButtonsLayer" );
      ...
      ((Element)v.get(184)).setAttribute("nombre","pedClaseSolicPaginationButtonBar" );
      ...
      ((Element)v.get(185)).setAttribute("nombre","pedClaseSolicFirstPageButton" );
      ((Element)v.get(185)).setAttribute("funcion","pedClaseSolicFirstPage();" );
   ...
   private void getXML900(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(186)).setAttribute("nombre","pedClaseSolicFirstPageButtonGapTd" );
      ...
      v.add(doc.createElement("BTN"));
      ((Element)v.get(188)).setAttribute("nombre","pedClaseSolicPreviousPageButton" );
      ((Element)v.get(188)).setAttribute("funcion","pedClaseSolicPreviousPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(189)).setAttribute("nombre","pedClaseSolicPreviousPageButtonGapTd" );
      ...
      v.add(doc.createElement("BTN"));
      ((Element)v.get(191)).setAttribute("nombre","pedClaseSolicNextPageButton" );
      ((Element)v.get(191)).setAttribute("funcion","pedClaseSolicNextPage();" );
      ...
      ((Element)v.get(194)).setAttribute("nombre","pedClaseSolicUpdateButtonTd" );
      ((Element)v.get(180)).appendChild((Element)v.get(194));

      /* Empieza nodo:195 / Elemento padre: 194   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(195)).setAttribute("nombre","pedClaseSolicUpdateButton" );
      ((Element)v.get(195)).setAttribute("ID","botonContenido" );
      ((Element)v.get(195)).setAttribute("tipo","html" );
      ((Element)v.get(195)).setAttribute("accion","pedClaseSolicUpdateSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(196)).setAttribute("nombre","pedClaseSolicUpdateButtonGapTd" );
      ...
      ((Element)v.get(198)).setAttribute("nombre","pedClaseSolicViewForRemoveButtonTd" );
      ((Element)v.get(180)).appendChild((Element)v.get(198));

      /* Empieza nodo:199 / Elemento padre: 198   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(199)).setAttribute("nombre","pedClaseSolicViewForRemoveButton" );
      ((Element)v.get(199)).setAttribute("ID","botonContenido" );
      ((Element)v.get(199)).setAttribute("tipo","html" );
      ((Element)v.get(199)).setAttribute("accion","pedClaseSolicViewSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(200)).setAttribute("nombre","pedClaseSolicViewForRemoveButtonGapTd" );
      ...
      ((Element)v.get(202)).setAttribute("nombre","pedClaseSolicLovSelectButtonTd" );
      ((Element)v.get(180)).appendChild((Element)v.get(202));

      /* Empieza nodo:203 / Elemento padre: 202   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(203)).setAttribute("nombre","pedClaseSolicLovSelectButton" );
      ((Element)v.get(203)).setAttribute("ID","botonContenido" );
   }

   private void getXML990(Document doc) {
      ((Element)v.get(203)).setAttribute("tipo","html" );
      ((Element)v.get(203)).setAttribute("accion","pedClaseSolicLovSelectionAction();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(204)).setAttribute("nombre","pedClaseSolicLovSelectButtonGapTd" );
      ...
      ((Element)v.get(206)).setAttribute("nombre","pedClaseSolicViewButtonTd" );
      ((Element)v.get(180)).appendChild((Element)v.get(206));

      /* Empieza nodo:207 / Elemento padre: 206   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(207)).setAttribute("nombre","pedClaseSolicViewButton" );
      ((Element)v.get(207)).setAttribute("ID","botonContenido" );
      ((Element)v.get(207)).setAttribute("tipo","html" );
      ((Element)v.get(207)).setAttribute("accion","pedClaseSolicViewSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(208)).setAttribute("nombre","pedClaseSolicViewButtonGapTd" );
