...
public class contenido_ordenes_chequeo_introducir_linea_detalle  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_ordenes_chequeo_introducir_linea_detalle" );
      ((Element)v.get(0)).setAttribute("cod","00133" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","contenido_ordenes_chequeo_introducir_linea_detalle.js" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(8)).setAttribute("nombre","errSeverity" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(13)).setAttribute("nombre","hOidTipoChequeo" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(14)).setAttribute("nombre","hOidMarca" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(15)).setAttribute("nombre","hOidCanal" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(16)).setAttribute("nombre","hOidSubgerencia" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(17)).setAttribute("nombre","hOidRegion" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(19)).setAttribute("nombre","hOidSeccion" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(32)).setAttribute("cod","00133" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(39)).setAttribute("ancho","200" );
      ...
      ((Element)v.get(40)).setAttribute("alto","20" );
      ((Element)v.get(40)).setAttribute("IDScroll","EstCab" );
      ((Element)v.get(40)).setAttribute("imgFondo","" );
      ((Element)v.get(40)).setAttribute("colFondo","#CCCCCC" );
      ...
      ((Element)v.get(41)).setAttribute("cod","447" );
      ...
      ((Element)v.get(42)).setAttribute("cod","124" );
      ...
      ((Element)v.get(43)).setAttribute("cod","109" );
      ...
      ((Element)v.get(44)).setAttribute("cod","143" );
      ...
      ((Element)v.get(45)).setAttribute("cod","112" );
      ...
      ((Element)v.get(53)).setAttribute("y","306" );
      ((Element)v.get(53)).setAttribute("control","|" );
      ((Element)v.get(53)).setAttribute("conector","conectorSandra" );
      ((Element)v.get(53)).setAttribute("onload","procesarPaginado(mipgndo, msgError, ultima, rowset)" );
   }
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(54)).setAttribute("y","310" );
      ...
      ((Element)v.get(55)).setAttribute("y","310" );
      ...
      ((Element)v.get(55)).setAttribute("ontab","document.all['primera1I'].parentElement.focus();" );
      ...
      ((Element)v.get(56)).setAttribute("y","310" );
      ...
      ((Element)v.get(58)).setAttribute("y","329" );
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(59)).setAttribute("nombre","capaAniadir" );
      ((Element)v.get(59)).setAttribute("x","77" );
      ((Element)v.get(59)).setAttribute("y","304" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(63)).setAttribute("nombre","Aniadir" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(63)).setAttribute("accion","onClickAniadir();" );
      ((Element)v.get(63)).setAttribute("ontab","focalizaBoton();" );
      ((Element)v.get(63)).setAttribute("onshtab","focalizaBoton();" );
