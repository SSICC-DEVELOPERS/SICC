...
public class PedClaseSolicPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","PedClaseSolic.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","PedClaseSolic.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('pedClaseSolicFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('pedClaseSolicFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(50)).setAttribute("nombre","codClasSoliTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lblCodClasSoli" );
      ((Element)v.get(54)).setAttribute("alto","13" );
      ((Element)v.get(54)).setAttribute("filas","1" );
      ((Element)v.get(54)).setAttribute("id","datosTitle" );
      ((Element)v.get(54)).setAttribute("cod","PedClaseSolic.codClasSoli.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(55)).setAttribute("nombre","codClasSoliWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(57)).setAttribute("nombre","codClasSoli" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('pedClaseSolicFrm',2, true)" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('pedClaseSolicFrm', 2, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(58)).setAttribute("nombre","codClasSoliGapTdId" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(64)).setAttribute("cod","PedClaseSolic.Descripcion.label" );
      ...
      ((Element)v.get(68)).setAttribute("ontab","ejecutarAccionFoco('pedClaseSolicFrm',3, true)" );
      ((Element)v.get(68)).setAttribute("onshtab","ejecutarAccionFoco('pedClaseSolicFrm', 3, false)" );
      ...
      ((Element)v.get(72)).setAttribute("href","javascript:openLocalizationDialog('pedClaseSolicFrm', 'Descripcion', 1);" );
      ((Element)v.get(72)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"pedClaseSolicFrm\",3, true)', 'ejecutarAccionFoco(\"pedClaseSolicFrm\",3, false)')" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(76)).setAttribute("nombre","indOrdeCompTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(81)).setAttribute("nombre","indOrdeCompWidgetTrId" );
      ...
      ((Element)v.get(83)).setAttribute("nombre","indOrdeComp" );
      ...
      ((Element)v.get(83)).setAttribute("ontab","ejecutarAccionFoco('pedClaseSolicFrm',4, true)" );
      ((Element)v.get(83)).setAttribute("onshtab","ejecutarAccionFoco('pedClaseSolicFrm',4, false)" );
      ...
      ((Element)v.get(84)).setAttribute("cod","PedClaseSolic.indOrdeComp.1.label" );
      ...
      ((Element)v.get(86)).setAttribute("cod","PedClaseSolic.indOrdeComp.0.label" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(88)).setAttribute("nombre","indOrdeCompGapTdId" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(102)).setAttribute("nombre","pedClaseSolicTrButtons" );
      ...
      ((Element)v.get(109)).setAttribute("nombre","pedClaseSolicTdQueryButton" );
      ((Element)v.get(108)).appendChild((Element)v.get(109));

      /* Empieza nodo:110 / Elemento padre: 109   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(110)).setAttribute("nombre","pedClaseSolicQueryButton" );
      ((Element)v.get(110)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(110)).setAttribute("estado","false" );
      ((Element)v.get(110)).setAttribute("accion","pedClaseSolicFirstPage();" );
      ...
      ((Element)v.get(111)).setAttribute("nombre","pedClaseSolicTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(113)).setAttribute("nombre","pedClaseSolicLovNullButton" );
      ((Element)v.get(113)).setAttribute("ID","botonContenido" );
      ((Element)v.get(113)).setAttribute("tipo","html" );
      ((Element)v.get(113)).setAttribute("accion","pedClaseSolicLovNullSelectionAction();" );
