/*
    INDRA/CAR/mmg
    $Id: MaeSuperGenerLPStartUp.java,v 1.1 2009/12/03 18:36:19 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class MaeSuperGenerLPStartUp extends MMGDruidaBase{
	...
	public MaeSuperGenerLPStartUp(){
		super();
	}

	public void inicio() throws Exception {
		pagina("MaeSuperGenerPage");
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "MaeSuperGenerPage", "cod", "MaeSuperGener." + accion + ".label");
			...
			limpiarBotoneraLista("maeSuperGener", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codSupeGene", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 9);");
		...
		//asignarAtributo("CAPA", "maeSuperGenerLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "MaeSuperGenerPage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("MaeSuperGenerLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		MaeSuperGenerData maeSuperGenerQuery= new MaeSuperGenerData();
		maeSuperGenerQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		MaeSuperGenerData datosResult = (MaeSuperGenerData)getSingleObject(BUSINESSID_QUERY, maeSuperGenerQuery, 
			maeSuperGenerQuery.clone(), "maeSuperGener");
		...
		preservaHiddensI18n(new Integer(1), "MAE_SUPER_GENER", "maeSuperGenerFrm", "Descripcion", true);
		...
		MaeSuperGenerData maeSuperGener = datosResult;
		asignar("TEXT", "codSupeGene", FormatUtils.formatObject(maeSuperGener.getCodSupeGene(), 
		...
		loadLocalizationVars(maeSuperGener);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "codSupeGene", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "MAE_SUPER_GENER", "maeSuperGenerFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "codSupeGene", "req", "S");
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('maeSuperGenerFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "maeSuperGenerFrm", "oculto", "N");
		...
		traza("MMG::Creando MaeSuperGener");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		MaeSuperGenerData maeSuperGenerQuery= new MaeSuperGenerData();
		maeSuperGenerQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(maeSuperGener.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"maeSuperGenerFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"maeSuperGenerFrm\",1, false)");
					asignarAtributo("COMBO","paisOidPais", "ontab", "ejecutarAccionFocoModificacion(\"maeSuperGenerFrm\",2, true)");
					asignarAtributo("COMBO","paisOidPais", "onshtab", "ejecutarAccionFocoModificacion(\"maeSuperGenerFrm\",2, false)");
				asignarAtributo("AREATEXTO", "codSupeGene", "ontab","ejecutarAccionFocoModificacion(\"maeSuperGenerFrm\",3, true)");
				asignarAtributo("AREATEXTO", "codSupeGene", "onshtab","ejecutarAccionFocoModificacion(\"maeSuperGenerFrm\",3, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"maeSuperGenerFrm\",4, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"maeSuperGenerFrm\",4, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","maeSuperGenerTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","maeSuperGenerTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codSupeGene...");		
				
					traza("MMG: en desactivateNonModifyFields encontrado atributo no editable...");
				
						// borrarCampo("codSupeGene");
						asignarAtributo ("TEXT", "codSupeGene", "disabled", "S");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","maeSuperGenerFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","maeSuperGenerListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","maeSuperGenerListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(MaeSuperGenerData maeSuperGener) throws Exception{
		...
		if(maeSuperGener != null && maeSuperGener.getPaisOidPais() != null){
				checkCombo("paisOidPais" , maeSuperGener.getPaisOidPais().getId().toString());
			}
	...
	* @param maeSuperGener La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(MaeSuperGenerData maeSuperGener) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		MaeSuperGenerData maeSuperGener = 
			(MaeSuperGenerData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(maeSuperGener.getPaisOidPais() != null){
			maeSuperGener.setPaisOidPais((es.indra.belcorp.mso.SegPaisViewData)
			getSingleObject(BUSINESSID_PAISOIDPAIS_QUERY, 
			maeSuperGener.getPaisOidPais(),
			maeSuperGener.getPaisOidPais().clone(),
			"segPaisView"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(maeSuperGener);
		loadLeafDependenceCombos(maeSuperGener);
	}
	...
	*/
	...
	protected void loadLocalizationVars(MaeSuperGenerData maeSuperGener) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("MAE_SUPER_GENER");
		mmgLocalizationQuery.setEntiPk(maeSuperGener.getId());
