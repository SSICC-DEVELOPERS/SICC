/*
    INDRA/CAR/mmg
    $Id: SegNacioLPStartUp.java,v 1.1 2009/12/03 18:34:34 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class SegNacioLPStartUp extends MMGDruidaBase{
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "SegNacioPage", "cod", "SegNacio." + accion + ".label");
			...
			limpiarBotoneraLista("segNacio", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codNaci", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 2);");
		...
		//asignarAtributo("CAPA", "segNacioLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "SegNacioPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		SegNacioData segNacioQuery= new SegNacioData();
		segNacioQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		SegNacioData datosResult = (SegNacioData)getSingleObject(BUSINESSID_QUERY, segNacioQuery, 
			segNacioQuery.clone(), "segNacio");
		...
		preservaHiddensI18n(new Integer(1), "SEG_NACIO", "segNacioFrm", "Descripcion", true);
		...
		SegNacioData segNacio = datosResult;
		asignar("TEXT", "codNaci", FormatUtils.formatObject(segNacio.getCodNaci(), 
		...
		loadLocalizationVars(segNacio);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "codNaci", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "SEG_NACIO", "segNacioFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "codNaci", "req", "S");
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('segNacioFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "segNacioFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		SegNacioData segNacioQuery= new SegNacioData();
		segNacioQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(segNacio.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"segNacioFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"segNacioFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codNaci", "ontab","ejecutarAccionFocoModificacion(\"segNacioFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codNaci", "onshtab","ejecutarAccionFocoModificacion(\"segNacioFrm\",2, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"segNacioFrm\",3, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"segNacioFrm\",3, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","segNacioTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","segNacioTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codNaci...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","segNacioFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","segNacioListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","segNacioListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(SegNacioData segNacio) throws Exception{
	...
	* @param segNacio La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(SegNacioData segNacio) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		SegNacioData segNacio = 
			(SegNacioData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(segNacio);
		loadLeafDependenceCombos(segNacio);
	}
	...
	*/
	...
	protected void loadLocalizationVars(SegNacioData segNacio) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("SEG_NACIO");
		mmgLocalizationQuery.setEntiPk(segNacio.getId());
