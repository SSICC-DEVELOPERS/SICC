...
public class contenido_movimientos_bancarios_recepcionar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_movimientos_bancarios_recepcionar" );
      ((Element)v.get(0)).setAttribute("cod","0291" );
      ((Element)v.get(0)).setAttribute("titulo","Recepcionar movimientos bancarios" );
      ...
      v.add(doc.createTextNode("\r   \r    var varNoLimpiarSICC = true;\r    function load()\r    {\r        configurarMenuSecundario(\"frmFormulario\");\r        fMostrarMensajeError();\r        focaliza(\"frmFormulario.Descripcion\");       \r        \r    }\r		\r    function fLimpiar()\r	{\r        set(\"frmFormulario.Descripcion\", \"\");\r        set(\"frmFormulario.Fecha\", \"\");\r        set(\"frmFormulario.areatxtObservaciones\",\"\");\r        focaliza(\"frmFormulario.Descripcion\", \"\");\r    }\r\r	function accionRecepcionar()\r	{\r        if(sicc_validaciones_generales()){\r            set(\"frmFormulario.numeroL\", get(\"frmFormulario.numeroLote\"));\r            set(\"frmFormulario.accion\", \"recepcionar\");\r            enviaSICC(\"frmFormulario\");\r        }\r    }        \r     \r"));
      ...
      ((Element)v.get(6)).setAttribute("cod","870" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(12)).setAttribute("nombre","numeroLote" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(13)).setAttribute("nombre","numeroL" );
      ...
      ((Element)v.get(14)).setAttribute("nombre","capa" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(45)).setAttribute("cod","844" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(56)).setAttribute("nombre","lblvalorLote" );
      ...
      ((Element)v.get(60)).setAttribute("onshtab","document.selection.empty();document.all.btnRecepcionar.focus();" );
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(64)).setAttribute("nombre","Fecha" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(84)).setAttribute("cols","50" );
      ((Element)v.get(84)).setAttribute("id","datosCampos" );
      ((Element)v.get(84)).setAttribute("msjreq","" );
      ((Element)v.get(84)).setAttribute("nombre","areatxtObservaciones" );
      ((Element)v.get(84)).setAttribute("readonly","N" );
      ((Element)v.get(84)).setAttribute("req","N" );
      ((Element)v.get(84)).setAttribute("rows","3" );
      ((Element)v.get(84)).setAttribute("tabindex","2" );
      ((Element)v.get(84)).setAttribute("valor","" );
      ((Element)v.get(84)).setAttribute("max","256" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(100)).setAttribute("nombre","btnRecepcionar" );
      ((Element)v.get(100)).setAttribute("ID","botonContenido" );
      ((Element)v.get(100)).setAttribute("tipo","html" );
      ((Element)v.get(100)).setAttribute("accion","accionRecepcionar();" );
      ((Element)v.get(100)).setAttribute("estado","false" );
      ((Element)v.get(100)).setAttribute("cod","2265" );
      ((Element)v.get(100)).setAttribute("ontab","focaliza('frmFormulario.Descripcion');" );
