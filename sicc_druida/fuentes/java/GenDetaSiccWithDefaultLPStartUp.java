/*
    INDRA/CAR/mmg
    $Id: GenDetaSiccWithDefaultLPStartUp.java,v 1.1 2009/12/03 18:33:06 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class GenDetaSiccWithDefaultLPStartUp extends MMGDruidaBase{
	...
	public static final short VIEWFORM_SIZE = 267;
	...
	public static final String BUSINESSID_QUERY = "MMGGenDetaSiccWithDefaultQueryFromToUserPage";
				...
				public static final String BUSINESSID_IDIOOIDIDIO_QUERY ="MMGSegIdiomQueryFromToUser";
				public static final String IDIOOIDIDIO_COMBO_CONNECTOR = "SegIdiomConectorCombo";
	...
	public GenDetaSiccWithDefaultLPStartUp(){
		super();
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			buildJsPageSize("GenDetaSiccWithDefault");
			...
			asignarAtributo("PAGINA", "GenDetaSiccWithDefaultPage", "cod", "GenDetaSiccWithDefault." + accion + ".label");
			...
			limpiarBotoneraLista("genDetaSiccWithDefault", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "enti", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 40);");
		asignarAtributo("TEXT", "entiPk", "validacion", "mensaje = ValidaInt(cdos_trim(valor), 12, 0, 999999999999);");
		asignarAtributo("TEXT", "atri", "validacion", "mensaje = ValidaInt(cdos_trim(valor), 2, 0, 99);");
		asignarAtributo("TEXT", "deta", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 400);");
		
		
		//Primero determianmos el nombre del campo en la entidad de oriegen donde se van a cargar los datos
		asignar("VAR", "idAttributeLovOpener", conectorParametro(PARAMETRO_LOV_ATTRIBUTO));
		asignar("VAR", "idEntityLovOpener", conectorParametro(PARAMETRO_LOV_ENTIDAD));
		//asignarAtributo("CAPA", "genDetaSiccWithDefaultLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "GenDetaSiccWithDefaultPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		GenDetaSiccWithDefaultData genDetaSiccWithDefaultQuery= new GenDetaSiccWithDefaultData();
		genDetaSiccWithDefaultQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		GenDetaSiccWithDefaultData datosResult = (GenDetaSiccWithDefaultData)getSingleObject(BUSINESSID_QUERY, genDetaSiccWithDefaultQuery, 
			genDetaSiccWithDefaultQuery.clone(), "genDetaSiccWithDefault");
		...
		GenDetaSiccWithDefaultData genDetaSiccWithDefault = datosResult;
		asignar("TEXT", "enti", FormatUtils.formatObject(genDetaSiccWithDefault.getEnti(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "entiPk", FormatUtils.formatObject(genDetaSiccWithDefault.getEntiPk(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "atri", FormatUtils.formatObject(genDetaSiccWithDefault.getAtri(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "deta", FormatUtils.formatObject(genDetaSiccWithDefault.getDeta(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		es.indra.belcorp.mso.SegIdiomData idioOidIdio = genDetaSiccWithDefault.getIdioOidIdio();
		if(idioOidIdio != null && idioOidIdio.getId() != null) checkCombo("idioOidIdio" , idioOidIdio.getId().toString());
		...
		asignarAtributo("TEXT", "enti", "disabled", "S");
		asignarAtributo("TEXT", "entiPk", "disabled", "S");
		asignarAtributo("TEXT", "atri", "disabled", "S");
		asignarAtributo("TEXT", "deta", "disabled", "S");
		
					asignarAtributo("COMBO", "idioOidIdio", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		...
		asignarAtributo("TEXT", "enti", "req", "S");
		asignarAtributo("TEXT", "entiPk", "req", "S");
		asignarAtributo("TEXT", "atri", "req", "S");
		asignarAtributo("TEXT", "deta", "req", "S");
		asignarAtributo("COMBO", "idioOidIdio", "req", "S");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "genDetaSiccWithDefaultFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		GenDetaSiccWithDefaultData genDetaSiccWithDefaultQuery= new GenDetaSiccWithDefaultData();
		genDetaSiccWithDefaultQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(genDetaSiccWithDefault.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"genDetaSiccWithDefaultFrm\",0, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"genDetaSiccWithDefaultFrm\",0, false)");
				asignarAtributo("AREATEXTO", "enti", "ontab","ejecutarAccionFocoModificacion(\"genDetaSiccWithDefaultFrm\",0, true)");
				asignarAtributo("AREATEXTO", "enti", "onshtab","ejecutarAccionFocoModificacion(\"genDetaSiccWithDefaultFrm\",0, false)");
				asignarAtributo("AREATEXTO", "entiPk", "ontab","ejecutarAccionFocoModificacion(\"genDetaSiccWithDefaultFrm\",0, true)");
				asignarAtributo("AREATEXTO", "entiPk", "onshtab","ejecutarAccionFocoModificacion(\"genDetaSiccWithDefaultFrm\",0, false)");
				asignarAtributo("AREATEXTO", "atri", "ontab","ejecutarAccionFocoModificacion(\"genDetaSiccWithDefaultFrm\",0, true)");
				asignarAtributo("AREATEXTO", "atri", "onshtab","ejecutarAccionFocoModificacion(\"genDetaSiccWithDefaultFrm\",0, false)");
				asignarAtributo("AREATEXTO", "deta", "ontab","ejecutarAccionFocoModificacion(\"genDetaSiccWithDefaultFrm\",0, true)");
				asignarAtributo("AREATEXTO", "deta", "onshtab","ejecutarAccionFocoModificacion(\"genDetaSiccWithDefaultFrm\",0, false)");
					asignarAtributo("COMBO","idioOidIdio", "ontab", "ejecutarAccionFocoModificacion(\"genDetaSiccWithDefaultFrm\",0, true)");
					asignarAtributo("COMBO","idioOidIdio", "onshtab", "ejecutarAccionFocoModificacion(\"genDetaSiccWithDefaultFrm\",0, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","genDetaSiccWithDefaultTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","genDetaSiccWithDefaultTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es enti...");		
				
				traza("MMG: el atributo es entiPk...");		
				
				traza("MMG: el atributo es atri...");		
				
				traza("MMG: el atributo es deta...");		
				
				traza("MMG: el atributo es idioOidIdio...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","genDetaSiccWithDefaultFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","genDetaSiccWithDefaultListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","genDetaSiccWithDefaultListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(GenDetaSiccWithDefaultData genDetaSiccWithDefault) throws Exception{
		HashMap checkedCombos = new HashMap();
		SegIdiomData idioOidIdio = new SegIdiomData();
		
						asignarComboResultados(BUSINESSID_IDIOOIDIDIO_QUERY,IDIOOIDIDIO_COMBO_CONNECTOR, 
			idioOidIdio, idioOidIdio.clone(), "segIdiom", "idioOidIdio", "result_ROWSET" );
		if(genDetaSiccWithDefault != null && genDetaSiccWithDefault.getIdioOidIdio() != null){
				checkCombo("idioOidIdio" , genDetaSiccWithDefault.getIdioOidIdio().getId().toString());
			}
	...
	* @param genDetaSiccWithDefault La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(GenDetaSiccWithDefaultData genDetaSiccWithDefault) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		GenDetaSiccWithDefaultData genDetaSiccWithDefault = 
			(GenDetaSiccWithDefaultData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(genDetaSiccWithDefault.getIdioOidIdio() != null){
			genDetaSiccWithDefault.setIdioOidIdio((es.indra.belcorp.mso.SegIdiomData)
			getSingleObject(BUSINESSID_IDIOOIDIDIO_QUERY, 
			genDetaSiccWithDefault.getIdioOidIdio(),
			genDetaSiccWithDefault.getIdioOidIdio().clone(),
			"segIdiom"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(genDetaSiccWithDefault);
		loadLeafDependenceCombos(genDetaSiccWithDefault);
	}
