...
public class RecPreciPerdiConectorQueryList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad RecPreciPerdi" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGRecPreciPerdiQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGRecPreciPerdiQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","RecPreciPerdiListFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","codPrecPerd" );
