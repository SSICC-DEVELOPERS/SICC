...
public class ConectorGenerarFicheroMatrizPrecios  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Generar Fichero de matriz de Precios" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","DTOInformacionDeFiltradoBatch" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","NDGGenerarFicherosMatrizPreciosBatch" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(5)).setAttribute("NOMBRE","DTOSalidaBatch" );
