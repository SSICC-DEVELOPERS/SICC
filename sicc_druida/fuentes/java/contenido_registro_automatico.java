...
public class contenido_registro_automatico  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      v.add(doc.createTextNode("\r\r \r\r\r    function onLoad(){\r        if (get('frmContenido.errCodigo') != ''){\r            fMostrarMensajeError();\r        }else {     \r            fMostrarMensajeExito();\r            set('frmContenido.conectorAction','LPSeleccionarMF');\r            enviaSICC('frmContenido');\r        }\r    }\r\r \r  \r \r"));
      ...
      ((Element)v.get(9)).setAttribute("valor","LPRegistroAutomaticoOfertasIndividuales" );
      ((Element)v.get(4)).appendChild((Element)v.get(9));
      /* Termina nodo:9   */

      /* Empieza nodo:10 / Elemento padre: 4   */
      v.add(doc.createElement("VAR"));
      ((Element)v.get(10)).setAttribute("nombre","ofertasOrdenadas" );
