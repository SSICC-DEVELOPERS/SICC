...
public class FacAsignImpreConectorQueryForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad FacAsignImpre" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGFacAsignImpreQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGFacAsignImpreQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","FacAsignImpreFormFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","imviOidImpr" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(9)).setAttribute("NOMBRE","forsOidForm" );
