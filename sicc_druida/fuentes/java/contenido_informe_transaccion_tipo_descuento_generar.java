...
public class contenido_informe_transaccion_tipo_descuento_generar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_informe_transaccion_tipo_descuento_generar" );
      ((Element)v.get(0)).setAttribute("cod","0751" );
      ((Element)v.get(0)).setAttribute("titulo","Generar Informe Transacción por tipo de descuento" );
      ...
      v.add(doc.createTextNode("\r   \r   \r   function onLoad(){\r      configurarMenuSecundario('Formulario');\r      fMostrarMensajeError();\r      setearPais();\r      focaliza('Formulario.cbPais');\r   }\r   function generar(formato){\r      \r      if(sicc_validaciones_generales()){\r          /*recolectarParametros();\r          set('Formulario.conectorAction', 'DTOTransaccionTipoDescuento');           \r          set('Formulario.accion', 'generar');\r          enviaSICC('Formulario');*/\r          var a = new Object();\r          a.accion = 'generar';\r          a.paisSelec = get('Formulario.cbPais');  \r          a.tipoDescuento = quitarItemVacio(get('Formulario.cbTipoDescuento'));\r          a.numeroDescuento = get('Formulario.txtNumDescuento');\r          a.marca = get('Formulario.cbMarca');\r          a.canal = get('Formulario.cbCanal');   \r		  a.periodoDesde = get('Formulario.cbPeriodoDesde');\r 		  a.periodoHasta = get('Formulario.cbPeriodoHasta');\r          mostrarModalSICC('DTOTransaccionTipoDescuento','generar', a);  \r    \r      }\r\r   }\r\r   function recolectarParametros(){\r      \r           \r      set('Formulario.paisSelec', get('Formulario.cbPais') );  \r      set('Formulario.tipoDescuento', quitarItemVacio(get('Formulario.cbTipoDescuento')));\r      set('Formulario.numeroDescuento', get('Formulario.txtNumDescuento'));\r      set('Formulario.marca', get('Formulario.cbMarca'));\r      set('Formulario.canal', get('Formulario.cbCanal'));\r      \r      \r      \r      \r   \r   }\r \r   \r\r   function fLimpiar(){\r       var aCombo = new Array(new Array(\"\",\"\"));\r       set_combo('Formulario.cbPeriodoDesde', aCombo, []);\r       set_combo('Formulario.cbPeriodoHasta', aCombo, []);\r       focaliza('Formulario.cbPais');\r \r   }\r   \r    function onchangeMarcaCanal(){\r        \r       marca  = get('Formulario.cbMarca');\r       canal  = get('Formulario.cbCanal');\r       pais   = get('Formulario.pais');\r       idioma = get('Formulario.idioma');\r        \r       if(marca != '' && canal != ''){\r       \r          var arr = new Array();\r               \r          arr[arr.length] = [\"oidIdioma\", idioma]; \r          arr[arr.length] = [\"oidPais\", pais]; \r          arr[arr.length] = [\"marca\", marca];\r          arr[arr.length] = [\"canal\", canal];\r             \r          recargaCombo(\"Formulario.cbPeriodoDesde\",\"PRECargarPeriodos\",\"es.indra.sicc.dtos.cra.DTOPeriodo\",arr);\r          recargaCombo(\"Formulario.cbPeriodoHasta\",\"PRECargarPeriodos\",\"es.indra.sicc.dtos.cra.DTOPeriodo\",arr);\r         \r       }else{\r          var aCombo = new Array(new Array(\"\",\"\"));\r          set_combo('Formulario.cbPeriodoDesde', aCombo, []);\r          set_combo('Formulario.cbPeriodoHasta', aCombo, []);\r       \r       }\r   \r    } \r \r\r   function setearPais(){\r      var pais = get('Formulario.pais');\r      \r      iSeleccionado = new Array(); \r      iSeleccionado[0] = pais;\r      set('Formulario.cbPais',iSeleccionado);\r   }\r\r\r   function quitarItemVacio(elemento){\r      var elementoADevolver = new Array();\r     \r      for(var k=0;k<elemento.length;k++) {\r         if (elemento[k] != ''){ 			 \r            elementoADevolver[elementoADevolver.length] = elemento[k];\r         }\r      }\r        \r      return elementoADevolver;\r      \r   }\r   \r"));
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(8)).setAttribute("name","cbTipoDescuento" );
      ((Element)v.get(8)).setAttribute("required","true" );
      ((Element)v.get(8)).setAttribute("cod","1940" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(17)).setAttribute("nombre","paisSelec" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(18)).setAttribute("nombre","tipoDescuento" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(19)).setAttribute("nombre","numeroDescuento" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(121)).setAttribute("nombre","cbTipoDescuento" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(130)).setAttribute("nombre","cbPeriodoDesde" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(135)).setAttribute("nombre","cbPeriodoHasta" );
      ...
      /* Empieza nodo:137 / Elemento padre: 117   */
      v.add(doc.createElement("td"));
      ((Element)v.get(137)).setAttribute("width","100%" );
      ((Element)v.get(117)).appendChild((Element)v.get(137));
      ...
      /* Empieza nodo:139 / Elemento padre: 97   */
   }

   private void getXML540(Document doc) {
      v.add(doc.createElement("tr"));
      ((Element)v.get(97)).appendChild((Element)v.get(139));

      /* Empieza nodo:140 / Elemento padre: 139   */
      v.add(doc.createElement("td"));
      ((Element)v.get(140)).setAttribute("colspan","9" );
      ...
      ((Element)v.get(152)).setAttribute("nombre","btnGenerarInforme" );
      ((Element)v.get(152)).setAttribute("ID","botonContenido" );
      ((Element)v.get(152)).setAttribute("tipo","html" );
      ((Element)v.get(152)).setAttribute("accion","generar();" );
      ((Element)v.get(152)).setAttribute("estado","false" );
      ((Element)v.get(152)).setAttribute("cod","2495" );
      ((Element)v.get(152)).setAttribute("ontab","focaliza('Formulario.cbPais');" );
      ...
      /* Empieza nodo:155 / Elemento padre: 25   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(25)).appendChild((Element)v.get(155));
