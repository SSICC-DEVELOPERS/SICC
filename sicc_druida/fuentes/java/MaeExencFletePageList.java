...
public class MaeExencFletePageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","maeExencFleteList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(16)).setAttribute("cod","MaeExencFlete.ticlOidTipoClie.label" );
      ...
      ((Element)v.get(17)).setAttribute("cod","MaeExencFlete.sbtiOidSubtClie.label" );
      ...
      ((Element)v.get(18)).setAttribute("cod","MaeExencFlete.tcclOidTipoClas.label" );
      ...
      ((Element)v.get(19)).setAttribute("cod","MaeExencFlete.clasOidClas.label" );
      ...
      ((Element)v.get(20)).setAttribute("cod","MaeExencFlete.indExenFlet.label" );
