...
public class contenido_informe_rango_cuotas_generar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_informe_rango_cuotas_generar" );
      ((Element)v.get(0)).setAttribute("cod","0862" );
      ((Element)v.get(0)).setAttribute("titulo","Generar informe rango de cuotas (venta incremental)" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(106)).setAttribute("nombre","cbZona" );
      ...
      ((Element)v.get(111)).setAttribute("onchange","onchangePais();" );
      ...
      /* Empieza nodo:117 / Elemento padre: 90   */
   }

   private void getXML450(Document doc) {
      v.add(doc.createElement("tr"));
      ((Element)v.get(90)).appendChild((Element)v.get(117));
      ...
      /* Empieza nodo:120 / Elemento padre: 33   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(33)).appendChild((Element)v.get(120));
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(131)).setAttribute("nombre","lblNegocio" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(138)).setAttribute("nombre","cbUnidadNegocio" );
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(143)).setAttribute("nombre","cbNegocio" );
      ...
      /* Empieza nodo:147 / Elemento padre: 122   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(122)).appendChild((Element)v.get(147));
      ...
      /* Empieza nodo:150 / Elemento padre: 33   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(33)).appendChild((Element)v.get(150));
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(164)).setAttribute("nombre","cbNumConcurso" );
   ...
   private void getXML630(Document doc) {
      ...
      /* Empieza nodo:171 / Elemento padre: 26   */
      v.add(doc.createElement("td"));
      ((Element)v.get(26)).appendChild((Element)v.get(171));
      ...
      ((Element)v.get(181)).setAttribute("accion","generar('pdf')" );
      ((Element)v.get(181)).setAttribute("estado","false" );
      ((Element)v.get(181)).setAttribute("cod","2495" );
      ((Element)v.get(181)).setAttribute("ontab","focaliza('Formulario.cbPais')" );
      ...
      /* Empieza nodo:184 / Elemento padre: 18   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(18)).appendChild((Element)v.get(184));
