/*
    INDRA/CAR/mmg
    $Id: PedTasaImpueLPStartUp.java,v 1.1 2009/12/03 18:37:35 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class PedTasaImpueLPStartUp extends MMGDruidaBase{
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "PedTasaImpuePage", "cod", "PedTasaImpue." + accion + ".label");
			...
			limpiarBotoneraLista("pedTasaImpue", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "valIndiImpu", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 3);");
		asignarAtributo("TEXT", "Descripcion", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 40);");
		asignarAtributo("TEXT", "valTasaImpu", "validacion", "mensaje = ValidaNumeroMMG(cdos_trim(valor), " + (6 - MMGDruidaHelper.getUserDecimalPrecision(this)) + ", " + MMGDruidaHelper.getUserDecimalPrecision(this)+ ", 'PedTasaImpue.valTasaImpu', 0, " + MMGDruidaHelper.getMaxValueForDruidaValidaFloat((6 - MMGDruidaHelper.getUserDecimalPrecision(this)), this) + ");");
		
		//Primero determianmos el nombre del campo en la entidad de oriegen donde se van a cargar los datos
		asignar("VAR", "idAttributeLovOpener", conectorParametro(PARAMETRO_LOV_ATTRIBUTO));
		asignar("VAR", "idEntityLovOpener", conectorParametro(PARAMETRO_LOV_ENTIDAD));
		//asignarAtributo("CAPA", "pedTasaImpueLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "PedTasaImpuePage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		PedTasaImpueData pedTasaImpueQuery= new PedTasaImpueData();
		pedTasaImpueQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		PedTasaImpueData datosResult = (PedTasaImpueData)getSingleObject(BUSINESSID_QUERY, pedTasaImpueQuery, 
			pedTasaImpueQuery.clone(), "pedTasaImpue");
		...
		preservaHiddensI18n(new Integer(1), "PED_TASA_IMPUE", "pedTasaImpueFrm", "Descripcion", true);
		...
		PedTasaImpueData pedTasaImpue = datosResult;
		asignar("TEXT", "valIndiImpu", FormatUtils.formatObject(pedTasaImpue.getValIndiImpu(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "valTasaImpu", FormatUtils.formatObject(pedTasaImpue.getValTasaImpu(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		loadLocalizationVars(pedTasaImpue);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "valIndiImpu", "disabled", "S");
		asignarAtributo("TEXT", "Descripcion", "disabled", "S");
		asignarAtributo("TEXT", "valTasaImpu", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "PED_TASA_IMPUE", "pedTasaImpueFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "valIndiImpu", "req", "S");
		asignarAtributo("TEXT", "Descripcion", "req", "S");
		asignarAtributo("TEXT", "valTasaImpu", "req", "S");
		
		
		//Asiganamos a los campos internacionalizables la función de onblur para actualizar el 
		//valor del idioma por defecto
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('pedTasaImpueFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "pedTasaImpueFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		PedTasaImpueData pedTasaImpueQuery= new PedTasaImpueData();
		pedTasaImpueQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(pedTasaImpue.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"pedTasaImpueFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"pedTasaImpueFrm\",1, false)");
				asignarAtributo("AREATEXTO", "valIndiImpu", "ontab","ejecutarAccionFocoModificacion(\"pedTasaImpueFrm\",2, true)");
				asignarAtributo("AREATEXTO", "valIndiImpu", "onshtab","ejecutarAccionFocoModificacion(\"pedTasaImpueFrm\",2, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"pedTasaImpueFrm\",3, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"pedTasaImpueFrm\",3, false)");
				asignarAtributo("AREATEXTO", "valTasaImpu", "ontab","ejecutarAccionFocoModificacion(\"pedTasaImpueFrm\",4, true)");
				asignarAtributo("AREATEXTO", "valTasaImpu", "onshtab","ejecutarAccionFocoModificacion(\"pedTasaImpueFrm\",4, false)");
					asignarAtributo("COMBO","paisOidPais", "ontab", "ejecutarAccionFocoModificacion(\"pedTasaImpueFrm\",5, true)");
					asignarAtributo("COMBO","paisOidPais", "onshtab", "ejecutarAccionFocoModificacion(\"pedTasaImpueFrm\",5, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","pedTasaImpueTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","pedTasaImpueTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es valIndiImpu...");		
				
					traza("MMG: en desactivateNonModifyFields encontrado atributo no editable...");
				
						// borrarCampo("valIndiImpu");
						asignarAtributo ("TEXT", "valIndiImpu", "disabled", "S");
				traza("MMG: el atributo es Descripcion...");		
				
				traza("MMG: el atributo es valTasaImpu...");		
				
					traza("MMG: en desactivateNonModifyFields encontrado atributo no editable...");
				
						// borrarCampo("valTasaImpu");
						asignarAtributo ("TEXT", "valTasaImpu", "disabled", "S");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","pedTasaImpueFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","pedTasaImpueListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","pedTasaImpueListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(PedTasaImpueData pedTasaImpue) throws Exception{
		...
		if(pedTasaImpue != null && pedTasaImpue.getPaisOidPais() != null){
				checkCombo("paisOidPais" , pedTasaImpue.getPaisOidPais().getId().toString());
			}
	...
	* @param pedTasaImpue La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(PedTasaImpueData pedTasaImpue) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		PedTasaImpueData pedTasaImpue = 
			(PedTasaImpueData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(pedTasaImpue.getPaisOidPais() != null){
			pedTasaImpue.setPaisOidPais((es.indra.belcorp.mso.SegPaisViewData)
			getSingleObject(BUSINESSID_PAISOIDPAIS_QUERY, 
			pedTasaImpue.getPaisOidPais(),
			pedTasaImpue.getPaisOidPais().clone(),
			"segPaisView"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(pedTasaImpue);
		loadLeafDependenceCombos(pedTasaImpue);
	}
	...
	*/
	...
	protected void loadLocalizationVars(PedTasaImpueData pedTasaImpue) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("PED_TASA_IMPUE");
		mmgLocalizationQuery.setEntiPk(pedTasaImpue.getId());
