...
public class CccCuentCorriBancaViewLPExecution extends MMGDruidaBase{
  ...
  /**Permite crear un nuevo elemento de la entidad. Invoca la lógica de negocio
  	correspondiente a la creación de un/a nuevo CccCuentCorriBancaView*/  
	protected void cmdCreate() throws Exception{
		...
		traza("MMG:: Iniciada ejecución Create de entidad CccCuentCorriBancaView");
		DruidaConector conectorCreate =  conectar(CONECTOR_CREATE, datos);
		traza("MMG:: Finalizada ejecución Create de entidad CccCuentCorriBancaView");
  ...
  /**Invoca la operación de modificación sobre el elemento seleccionado*/  
	protected void cmdUpdate() throws Exception{
		...
		//Invocamos la lógica de negocio
		traza("MMG:: Iniciada ejecución Update de entidad CccCuentCorriBancaView");
		DruidaConector conectorCreate =  conectar(MMG_UPDATE_CONNECTOR, datos);
		traza("MMG:: Finalizada ejecución Update de entidad CccCuentCorriBancaView");
	...
	protected void cmdRemove() throws Exception{
		...
		//Invocamos la lógica de negocio
		traza("MMG:: Iniciada ejecución Remove de entidad CccCuentCorriBancaView");
		DruidaConector conectorCreate =  conectar(CONECTOR_REMOVE, datos);
		traza("MMG:: Finalizada ejecución Remove de entidad CccCuentCorriBancaView");
