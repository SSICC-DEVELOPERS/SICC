/*
    INDRA/CAR/mmg
    $Id: MaeEstatClienViewLPStartUp.java,v 1.1 2009/12/03 18:40:38 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class MaeEstatClienViewLPStartUp extends MMGDruidaBase{
	...
	public MaeEstatClienViewLPStartUp(){
		super();
	}

	public void inicio() throws Exception {
		pagina("MaeEstatClienViewPage");
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			buildJsPageSize("MaeEstatClienView");
			...
			asignarAtributo("PAGINA", "MaeEstatClienViewPage", "cod", "MaeEstatClienView." + accion + ".label");
			...
			limpiarBotoneraLista("maeEstatClienView", accion);
	...
	protected void cmdLov() throws Exception{
		...
		//asignarAtributo("CAPA", "maeEstatClienViewLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "MaeEstatClienViewPage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("MaeEstatClienViewLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		MaeEstatClienViewData maeEstatClienViewQuery= new MaeEstatClienViewData();
		maeEstatClienViewQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		MaeEstatClienViewData datosResult = (MaeEstatClienViewData)getSingleObject(BUSINESSID_QUERY, maeEstatClienViewQuery, 
			maeEstatClienViewQuery.clone(), "maeEstatClienView");
		...
		preservaHiddensI18n(new Integer(1), "MAE_ESTAT_CLIEN", "maeEstatClienViewFrm", "Descripcion", true);
		...
		MaeEstatClienViewData maeEstatClienView = datosResult;
		asignar("TEXT", "Descripcion", FormatUtils.formatObject(maeEstatClienView.getDescripcion(), 
		...
		loadLocalizationVars(maeEstatClienView);
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "MAE_ESTAT_CLIEN", "maeEstatClienViewFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('maeEstatClienViewFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "maeEstatClienViewFrm", "oculto", "N");
		...
		traza("MMG::Creando MaeEstatClienView");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		MaeEstatClienViewData maeEstatClienViewQuery= new MaeEstatClienViewData();
		maeEstatClienViewQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(maeEstatClienView.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"maeEstatClienViewFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"maeEstatClienViewFrm\",1, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"maeEstatClienViewFrm\",4, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"maeEstatClienViewFrm\",4, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","maeEstatClienViewTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","maeEstatClienViewTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","maeEstatClienViewFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","maeEstatClienViewListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","maeEstatClienViewListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(MaeEstatClienViewData maeEstatClienView) throws Exception{
	...
	* @param maeEstatClienView La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(MaeEstatClienViewData maeEstatClienView) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		MaeEstatClienViewData maeEstatClienView = 
			(MaeEstatClienViewData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(maeEstatClienView);
		loadLeafDependenceCombos(maeEstatClienView);
	}
	...
	*/
	...
	protected void loadLocalizationVars(MaeEstatClienViewData maeEstatClienView) throws Exception{
		...
		mmgLocalizationQuery.setEntiPk(maeEstatClienView.getId());
