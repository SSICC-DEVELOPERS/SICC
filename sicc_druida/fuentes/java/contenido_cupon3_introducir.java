...
public class contenido_cupon3_introducir  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_cupon3_introducir" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(5)).setAttribute("src","contenido_cupon3_introducir.js" );
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(10)).setAttribute("name","textFechaDigit" );
      ((Element)v.get(10)).setAttribute("required","true" );
      ((Element)v.get(10)).setAttribute("cod","647" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(21)).setAttribute("nombre","mes" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(22)).setAttribute("nombre","anyo" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(23)).setAttribute("nombre","numero" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(24)).setAttribute("nombre","hOidCanal" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(25)).setAttribute("nombre","hOidPeriodo" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(26)).setAttribute("nombre","hOidMarca" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(27)).setAttribute("nombre","hFechaDigitacion" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(28)).setAttribute("nombre","numeroDeCuponEnSesion" );
      ...
      ((Element)v.get(43)).setAttribute("nombre","lblTitCritBusc" );
      ((Element)v.get(43)).setAttribute("alto","13" );
      ((Element)v.get(43)).setAttribute("filas","1" );
      ((Element)v.get(43)).setAttribute("valor","" );
      ((Element)v.get(43)).setAttribute("cod","0083" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(47)).setAttribute("width","600" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(55)).setAttribute("nombre","lblAno" );
      ...
      ((Element)v.get(55)).setAttribute("cod","171" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(59)).setAttribute("nombre","lblMes" );
      ...
      ((Element)v.get(59)).setAttribute("cod","674" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(63)).setAttribute("nombre","lblNumero" );
      ...
      ((Element)v.get(63)).setAttribute("cod","226" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(70)).setAttribute("nombre","lblAnoActual" );
      ((Element)v.get(70)).setAttribute("alto","13" );
      ((Element)v.get(70)).setAttribute("filas","1" );
      ((Element)v.get(70)).setAttribute("valor","xx" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(74)).setAttribute("nombre","lblMesActual" );
      ((Element)v.get(74)).setAttribute("alto","13" );
      ((Element)v.get(74)).setAttribute("filas","1" );
      ((Element)v.get(74)).setAttribute("valor","xx" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(78)).setAttribute("nombre","lbldtNumero" );
      ((Element)v.get(78)).setAttribute("alto","13" );
      ((Element)v.get(78)).setAttribute("filas","1" );
      ((Element)v.get(78)).setAttribute("valor","xxxxxxxx" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(102)).setAttribute("onchange","cambioMarcaCanal();" );
      ...
      ((Element)v.get(107)).setAttribute("onchange","cambioMarcaCanal();" );
      ((Element)v.get(107)).setAttribute("onshtab","document.all['btnIntroducir'].focus();" );
      ...
      /* Empieza nodo:114 / Elemento padre: 44   */
      v.add(doc.createElement("tr"));
   }

   private void getXML450(Document doc) {
      ((Element)v.get(44)).appendChild((Element)v.get(114));
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(116)).setAttribute("width","left" );
      ...
      ((Element)v.get(121)).setAttribute("cod","447" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(125)).setAttribute("nombre","lblFechaDigitacion" );
      ...
      ((Element)v.get(125)).setAttribute("cod","647" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(129)).setAttribute("nombre","lblRefExt" );
      ...
      ((Element)v.get(129)).setAttribute("cod","692" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(136)).setAttribute("nombre","cbPeriodo" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(141)).setAttribute("nombre","textFechaDigit" );
      ...
      ((Element)v.get(141)).setAttribute("onblur","validaFecha();" );
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(145)).setAttribute("nombre","textRefExt" );
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(153)).setAttribute("width","600" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(158)).setAttribute("nombre","lblObservaciones" );
   }
   ...
   private void getXML630(Document doc) {
      ...
      ((Element)v.get(158)).setAttribute("cod","169" );
      ...
      ((Element)v.get(165)).setAttribute("cols","50" );
      ((Element)v.get(165)).setAttribute("id","datosCampos" );
      ((Element)v.get(165)).setAttribute("msjreq","" );
      ((Element)v.get(165)).setAttribute("nombre","areatxtObservaciones" );
      ((Element)v.get(165)).setAttribute("readonly","N" );
      ((Element)v.get(165)).setAttribute("req","N" );
      ((Element)v.get(165)).setAttribute("rows","3" );
      ((Element)v.get(165)).setAttribute("tabindex","2" );
      ((Element)v.get(165)).setAttribute("valor","" );
      ((Element)v.get(165)).setAttribute("max","100" );
      ...
      ((Element)v.get(181)).setAttribute("nombre","btnIntroducir" );
   ...
   private void getXML720(Document doc) {
      ...
      ((Element)v.get(181)).setAttribute("accion","accionBTN_Introducir()" );
      ((Element)v.get(181)).setAttribute("estado","false" );
      ((Element)v.get(181)).setAttribute("cod","2212" );
      ...
      /* Empieza nodo:184 / Elemento padre: 29   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(29)).appendChild((Element)v.get(184));
      ...
      ((Element)v.get(186)).setAttribute("height","24" );
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(187)).setAttribute("width","750" );
      ...
      ((Element)v.get(190)).setAttribute("height","24" );
