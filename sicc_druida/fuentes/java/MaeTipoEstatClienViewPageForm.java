...
public class MaeTipoEstatClienViewPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","MaeTipoEstatClienView.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","MaeTipoEstatClienView.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('maeTipoEstatClienViewFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('maeTipoEstatClienViewFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(54)).setAttribute("cod","MaeTipoEstatClienView.codTipoEsta.label" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('maeTipoEstatClienViewFrm',2, true)" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('maeTipoEstatClienViewFrm', 2, false)" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(64)).setAttribute("cod","MaeTipoEstatClienView.Descripcion.label" );
      ...
      ((Element)v.get(68)).setAttribute("ontab","ejecutarAccionFoco('maeTipoEstatClienViewFrm',4, true)" );
      ((Element)v.get(68)).setAttribute("onshtab","ejecutarAccionFoco('maeTipoEstatClienViewFrm', 4, false)" );
      ...
      ((Element)v.get(72)).setAttribute("href","javascript:openLocalizationDialog('maeTipoEstatClienViewFrm', 'Descripcion', 1);" );
      ((Element)v.get(72)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"maeTipoEstatClienViewFrm\",4, true)', 'ejecutarAccionFoco(\"maeTipoEstatClienViewFrm\",4, false)')" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(79)).setAttribute("nombre","formGapTr1" );
      ...
      /* Empieza nodo:88 / Elemento padre: 0   */
      v.add(doc.createElement("TR"));
      ((Element)v.get(88)).setAttribute("nombre","maeTipoEstatClienViewTrButtons" );
      ((Element)v.get(0)).appendChild((Element)v.get(88));
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(95)).setAttribute("class","tablaTitle" );
      ((Element)v.get(95)).setAttribute("nombre","maeTipoEstatClienViewTdQueryButton" );
      ((Element)v.get(94)).appendChild((Element)v.get(95));

      /* Empieza nodo:96 / Elemento padre: 95   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(96)).setAttribute("nombre","maeTipoEstatClienViewQueryButton" );
      ((Element)v.get(96)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(96)).setAttribute("estado","false" );
      ((Element)v.get(96)).setAttribute("accion","maeTipoEstatClienViewFirstPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(97)).setAttribute("class","tablaTitle" );
      ((Element)v.get(97)).setAttribute("nombre","maeTipoEstatClienViewTdLovNullSelectionButton" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(99)).setAttribute("nombre","maeTipoEstatClienViewLovNullButton" );
      ((Element)v.get(99)).setAttribute("ID","botonContenido" );
      ((Element)v.get(99)).setAttribute("tipo","html" );
      ((Element)v.get(99)).setAttribute("accion","maeTipoEstatClienViewLovNullSelectionAction();" );
      ((Element)v.get(99)).setAttribute("estado","true" );
      ((Element)v.get(99)).setAttribute("cod","MMGGlobal.lovNullButton.label" );
