...
public class INCVariablesPeriodoRegionZonaDetalle extends LPSICCBase {
   
  public INCVariablesPeriodoRegionZonaDetalle() {
    super();
  }
  ...
  public void ejecucion() throws Exception {		
    ...
    try {
      ...
      if (accion.equals("generar")){
        ...
        cargarPagina();
        getConfiguracionMenu("INCVariablesPeriodoRegionZonaDetalle");
      }
     
    } catch (Exception ex) {
     			
      //pagina("contenido_informe_resultados_variables_generar");
      //getConfiguracionMenu("INCVariablesPeriodoRegionZonaDetalle");
  ...
  private void generarReporte() throws Exception{
    ...
    datos.put(ConstantesREP.TITULO, "Resultados de Variables " + periodoDesc);
    ...
    ejecutarReporte2(datos, "REPGenerarReporteBatch", "RD_REP-068", formato);
