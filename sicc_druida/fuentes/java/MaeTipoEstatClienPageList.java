...
public class MaeTipoEstatClienPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","maeTipoEstatClienList" );
      ...
      ((Element)v.get(14)).setAttribute("cod","MaeTipoEstatClien.codTipoEsta.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","MaeTipoEstatClien.marcOidMarc.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","MaeTipoEstatClien.Descripcion.label" );
