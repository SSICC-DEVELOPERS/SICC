...
public class RecTiposOperaViewPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","recTiposOperaViewList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","RecTiposOperaView.ropeOidOper.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","RecTiposOperaView.valTipoOper.label" );
