...
public class CraActivPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","craActivList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(17)).setAttribute("cod","CraActiv.codActi.label" );
      ...
      ((Element)v.get(18)).setAttribute("cod","CraActiv.numDiasDesp.label" );
      ...
      ((Element)v.get(19)).setAttribute("cod","CraActiv.numCampAnte.label" );
      ...
      ((Element)v.get(20)).setAttribute("cod","CraActiv.indEbel.label" );
      ...
      ((Element)v.get(21)).setAttribute("cod","CraActiv.indFest.label" );
      ...
      ((Element)v.get(22)).setAttribute("cod","CraActiv.indLabo.label" );
