...
/*
    INDRA/CAR/mmg
    $Id: IncPartiConcuDetalTransactionQuery.java,v 1.1 2009/12/03 18:35:05 pecbazalar Exp $
    DESC
*/
...
public class IncPartiConcuDetalTransactionQuery extends MMGDruidaTransaction {
	...
	public static final String CONECTOR_QUERY_LIST = "IncPartiConcuDetalConectorQueryList";

	// Definicion del constructor
	public IncPartiConcuDetalTransactionQuery(){
		super();
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			String paciOidPartConcCabe = (String)getEntrada("paciOidPartConcCabe");
			...
			IncPartiConcuDetalData incPartiConcuDetalFrom =new IncPartiConcuDetalData();
			IncPartiConcuDetalData incPartiConcuDetalTo = new IncPartiConcuDetalData();
			...
			incPartiConcuDetalFrom.setPaciOidPartConcCabe(paciOidPartConcCabeData);
			...
			incPartiConcuDetalFrom.setTiclOidTipoClie(ticlOidTipoClieData);
			...
			incPartiConcuDetalFrom.setSbtiOidSubtClie(sbtiOidSubtClieData);
			...
			incPartiConcuDetalFrom.setTcclOidTipoClas(tcclOidTipoClasData);
			...
			incPartiConcuDetalFrom.setClasOidClas(clasOidClasData);
			
			
			//Construimos el to
			incPartiConcuDetalTo = (IncPartiConcuDetalData)incPartiConcuDetalFrom.clone();
			
			
			//Metemos tanto el fromo como el to como últimos mso con parámetros de búsqueda
			conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM, incPartiConcuDetalFrom);
			conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_TO, incPartiConcuDetalTo);
			...
			dto.addProperty("incPartiConcuDetalFrom", incPartiConcuDetalFrom);
			dto.addProperty("incPartiConcuDetalTo", incPartiConcuDetalTo);
			...
			traza("MMG:: Iniciada ejecución Query de entidad IncPartiConcuDetal");
			DruidaConector conectorQuery =  conectar(CONECTOR_QUERY_LIST, datos);
			traza("MMG:: Finalizada ejecución Query de entidad IncPartiConcuDetal");
