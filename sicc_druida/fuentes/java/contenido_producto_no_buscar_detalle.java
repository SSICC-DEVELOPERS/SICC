...
public class contenido_producto_no_buscar_detalle  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_producto_no_buscar_detalle" );
      ...
      ((Element)v.get(2)).setAttribute("name","txtNumUnidadesReclamadas" );
      ((Element)v.get(2)).setAttribute("required","true" );
      ((Element)v.get(2)).setAttribute("cod","506" );
      ((Element)v.get(1)).appendChild((Element)v.get(2));
      /* Termina nodo:2   */

      /* Empieza nodo:3 / Elemento padre: 1   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(3)).setAttribute("name","txtNumUnidadesDevueltas" );
      ((Element)v.get(3)).setAttribute("required","true" );
      ((Element)v.get(3)).setAttribute("cod","309" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(5)).setAttribute("src","contenido_producto_no_buscar_detalle.js" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(15)).setAttribute("nombre","unidadesReclamadas" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(16)).setAttribute("nombre","unidadesRecibidas" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(18)).setAttribute("nombre","hid_SeparadorDecimales" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(19)).setAttribute("nombre","hid_NumeroDecimales" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(35)).setAttribute("nombre","lblDatosProducto" );
      ...
      ((Element)v.get(35)).setAttribute("cod","00105" );
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(39)).setAttribute("width","628" );
   ...
   private void getXML180(Document doc) {
      ((Element)v.get(47)).setAttribute("nombre","lblNumUnidadesReclamadas" );
      ...
      ((Element)v.get(47)).setAttribute("cod","506" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(51)).setAttribute("nombre","lblNumUnidadesDevueltas" );
      ((Element)v.get(51)).setAttribute("alto","13" );
      ((Element)v.get(51)).setAttribute("filas","1" );
      ((Element)v.get(51)).setAttribute("valor","" );
      ((Element)v.get(51)).setAttribute("id","datosTitle" );
      ((Element)v.get(51)).setAttribute("cod","309" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(55)).setAttribute("nombre","lblMotivoDevolucion" );
      ...
      ((Element)v.get(55)).setAttribute("cod","302" );
      ...
      ((Element)v.get(62)).setAttribute("nombre","txtNumUnidadesReclamadas" );
      ((Element)v.get(62)).setAttribute("id","datosCampos" );
      ((Element)v.get(62)).setAttribute("max","7" );
      ((Element)v.get(62)).setAttribute("onshtab","document.body.focus();document.all['btnAceptar'].focus();" );
      ((Element)v.get(62)).setAttribute("onblur","validaUnidades('txtNumUnidadesReclamadas', 6)" );
      ((Element)v.get(62)).setAttribute("tipo","" );
      ((Element)v.get(62)).setAttribute("onchange","" );
      ((Element)v.get(62)).setAttribute("req","S" );
      ((Element)v.get(62)).setAttribute("size","8" );
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(66)).setAttribute("nombre","txtNumUnidadesDevueltas" );
      ((Element)v.get(66)).setAttribute("id","datosCampos" );
      ((Element)v.get(66)).setAttribute("max","7" );
      ((Element)v.get(66)).setAttribute("tipo","" );
      ((Element)v.get(66)).setAttribute("onblur","validaUnidades('txtNumUnidadesDevueltas', 6)" );
   }

   private void getXML270(Document doc) {
      ((Element)v.get(66)).setAttribute("onchange","" );
      ((Element)v.get(66)).setAttribute("req","S" );
      ((Element)v.get(66)).setAttribute("size","8" );
      ...
      ((Element)v.get(69)).setAttribute("valign","bottom" );
      ((Element)v.get(58)).appendChild((Element)v.get(69));

      /* Empieza nodo:70 / Elemento padre: 69   */
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(70)).setAttribute("nombre","cbMotivoDevolucion" );
      ...
      ((Element)v.get(87)).setAttribute("ontab","focaliza(FORMULARIO + '.txtNumUnidadesReclamadas')" );
      ((Element)v.get(87)).setAttribute("accion","cargarLista();" );
