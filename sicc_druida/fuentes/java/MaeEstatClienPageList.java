...
public class MaeEstatClienPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","maeEstatClienList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","MaeEstatClien.tescOidTipoEsta.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","MaeEstatClien.codEstaClie.label" );
      ...
      ((Element)v.get(17)).setAttribute("cod","MaeEstatClien.Descripcion.label" );
      ...
      ((Element)v.get(18)).setAttribute("cod","MaeEstatClien.estaOidEstaClie.label" );
