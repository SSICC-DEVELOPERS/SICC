...
public class RECRankingProdUNCRef extends LPSICCBase {           
   public RECRankingProdUNCRef() {	 
     super();
  }
     ...
     try {
        ...
        if (accion.equals("generar")){
          ...
          //cargarPagina();
           ...
           cargarPagina();
           getConfiguracionMenu("RECRankingProdUNCRef");
        }
  ...
  private void cargarPagina() throws Exception{
     ...
     pagina("contenido_informe_ranking_producto_generar");
     
     asignarAtributoPagina("cod", "0904");
     asignarAtributo("VAR", "lp", "valor", "RECRankingProdUNCRef");
...
////////////////////////////////////////////////////////////////////////////////////////
 ...
 private void generarReporte() throws Exception{
     ...
     String cantidadProductos        = conectorParametroLimpia("cantidadProductos", "", true);
     datos.put(ConstantesREP.CANTIDADPRODUCTOS, cantidadProductos);     
     ...
     datos.put(ConstantesREP.CRITERIODEORDENAMIENTO, tipoOrdenacion);
     ...
     datos.put(ConstantesREP.TITULO, "Ranking Unidad de Negocio Campaña Referencia");     
     traza("++++++Antes de enviar a reportes " + datos); 
        
     
     traza("el formaro es  " + formato);
//     ejecutarReporte(datos, "REPGenerarReporte", "RD_REP-102", formato);
     ejecutarReporte2(datos, "REPGenerarReporteBatch", "RD_REP-102", formato);
