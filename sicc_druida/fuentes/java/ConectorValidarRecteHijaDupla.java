...
public class ConectorValidarRecteHijaDupla  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("REVISION","1.0" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","DTOCodigoCliente" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","IdBussines" );
