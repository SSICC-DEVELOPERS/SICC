...
public class ConectorLocalizacionVias  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","ConectorLocalizacionVias" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","DTOLocalizacionDirecciones" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","ZONLocalizacionVias" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","DescripcionUnidadGeo" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(8)).setAttribute("NOMBRE","TipoVia" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(9)).setAttribute("NOMBRE","NombreVia" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(10)).setAttribute("NOMBRE","InicioSeg" );
      ((Element)v.get(10)).setAttribute("TIPO","ENTERO" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(11)).setAttribute("NOMBRE","FinSeg" );
      ((Element)v.get(11)).setAttribute("TIPO","ENTERO" );
