...
public class contenido_seleccion_fichero_registro_venta  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_seleccion_fichero_registro_venta" );
      ((Element)v.get(0)).setAttribute("cod","0784" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(2)).setAttribute("src","contenido_seleccion_fichero_registro_venta.js" );
      ((Element)v.get(0)).appendChild((Element)v.get(2));
      /* Termina nodo:2   */

      /* Empieza nodo:3 / Elemento padre: 0   */
      v.add(doc.createElement("FORMULARIO"));
      ((Element)v.get(3)).setAttribute("nombre","frmFichero" );
      ...
      ((Element)v.get(6)).setAttribute("name","txtFichero" );
      ((Element)v.get(6)).setAttribute("required","true" );
      ((Element)v.get(6)).setAttribute("group","gFichero" );
      ((Element)v.get(6)).setAttribute("cod","1904" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(11)).setAttribute("nombre","hFechaEmisionDesde" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(12)).setAttribute("nombre","hFechaEmisionHasta" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(13)).setAttribute("nombre","hCodigoClienteDesde" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(14)).setAttribute("nombre","hCodigoClienteHasta" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(15)).setAttribute("nombre","hOidImpuestos" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(17)).setAttribute("nombre","hOidAcceso" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(18)).setAttribute("nombre","hOidSubacceso" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(19)).setAttribute("nombre","hOidTipoDocLegal" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(20)).setAttribute("nombre","hSerieDocLegal" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(21)).setAttribute("nombre","hNumeroDocLegalDesde" );
   ...
   private void getXML90(Document doc) {
      ((Element)v.get(22)).setAttribute("nombre","hNumeroDocLegalHasta" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(23)).setAttribute("nombre","hSI" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(24)).setAttribute("nombre","hNO" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(55)).setAttribute("nombre","txtFichero" );
      ((Element)v.get(55)).setAttribute("id","datosCampos" );
      ((Element)v.get(55)).setAttribute("max","400" );
      ((Element)v.get(55)).setAttribute("tipo","" );
      ((Element)v.get(55)).setAttribute("onchange","" );
      ((Element)v.get(55)).setAttribute("req","S" );
      ((Element)v.get(55)).setAttribute("size","100" );
      ((Element)v.get(55)).setAttribute("valor","" );
      ((Element)v.get(55)).setAttribute("ontab","focalizaFichero();" );
      ((Element)v.get(55)).setAttribute("onshtab","focalizaFichero();" );
