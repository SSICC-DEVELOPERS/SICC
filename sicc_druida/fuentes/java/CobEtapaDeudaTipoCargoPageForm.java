...
public class CobEtapaDeudaTipoCargoPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","CobEtapaDeudaTipoCargo.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","CobEtapaDeudaTipoCargo.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('cobEtapaDeudaTipoCargoFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('cobEtapaDeudaTipoCargoFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(50)).setAttribute("nombre","etdeOidEtapDeudTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lbletdeOidEtapDeud" );
      ((Element)v.get(54)).setAttribute("id","datosTitle" );
      ((Element)v.get(54)).setAttribute("ancho","150" );
      ((Element)v.get(54)).setAttribute("alto","13" );
      ((Element)v.get(54)).setAttribute("cod","CobEtapaDeudaTipoCargo.etdeOidEtapDeud.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(55)).setAttribute("nombre","etdeOidEtapDeudWidgetTrId" );
      ...
      ((Element)v.get(57)).setAttribute("nombre","etdeOidEtapDeud" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('cobEtapaDeudaTipoCargoFrm',2, true);" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('cobEtapaDeudaTipoCargoFrm',2, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(59)).setAttribute("nombre","etdeOidEtapDeudGapTdId" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(76)).setAttribute("nombre","tcabOidTipoCargAbonTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(80)).setAttribute("nombre","lbltcabOidTipoCargAbon" );
      ((Element)v.get(80)).setAttribute("id","datosTitle" );
      ((Element)v.get(80)).setAttribute("ancho","150" );
      ((Element)v.get(80)).setAttribute("alto","13" );
      ((Element)v.get(80)).setAttribute("cod","CobEtapaDeudaTipoCargo.tcabOidTipoCargAbon.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(81)).setAttribute("nombre","tcabOidTipoCargAbonWidgetTrId" );
   }
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(83)).setAttribute("nombre","tcabOidTipoCargAbon" );
      ...
      ((Element)v.get(83)).setAttribute("ontab","ejecutarAccionFoco('cobEtapaDeudaTipoCargoFrm',3, true);" );
      ((Element)v.get(83)).setAttribute("onshtab","ejecutarAccionFoco('cobEtapaDeudaTipoCargoFrm',3, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(85)).setAttribute("nombre","tcabOidTipoCargAbonGapTdId" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(102)).setAttribute("nombre","valDescTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(107)).setAttribute("nombre","valDescWidgetTrId" );
      ...
      ((Element)v.get(109)).setAttribute("ontab","ejecutarAccionFoco('cobEtapaDeudaTipoCargoFrm',4, true)" );
      ((Element)v.get(109)).setAttribute("onshtab","ejecutarAccionFoco('cobEtapaDeudaTipoCargoFrm', 4, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(110)).setAttribute("nombre","valDescGapTdId" );
   ...
   private void getXML540(Document doc) {
      ...
      /* Empieza nodo:124 / Elemento padre: 0   */
      v.add(doc.createElement("TR"));
      ((Element)v.get(124)).setAttribute("nombre","cobEtapaDeudaTipoCargoTrButtons" );
      ((Element)v.get(0)).appendChild((Element)v.get(124));
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(131)).setAttribute("class","tablaTitle" );
      ((Element)v.get(131)).setAttribute("nombre","cobEtapaDeudaTipoCargoTdQueryButton" );
      ((Element)v.get(130)).appendChild((Element)v.get(131));

      /* Empieza nodo:132 / Elemento padre: 131   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(132)).setAttribute("nombre","cobEtapaDeudaTipoCargoQueryButton" );
      ((Element)v.get(132)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(132)).setAttribute("estado","false" );
      ((Element)v.get(132)).setAttribute("accion","cobEtapaDeudaTipoCargoFirstPage();" );
      ...
      ((Element)v.get(133)).setAttribute("nombre","cobEtapaDeudaTipoCargoTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(135)).setAttribute("nombre","cobEtapaDeudaTipoCargoLovNullButton" );
      ((Element)v.get(135)).setAttribute("ID","botonContenido" );
      ((Element)v.get(135)).setAttribute("tipo","html" );
      ((Element)v.get(135)).setAttribute("accion","cobEtapaDeudaTipoCargoLovNullSelectionAction();" );
      ((Element)v.get(135)).setAttribute("estado","true" );
      ((Element)v.get(135)).setAttribute("cod","MMGGlobal.lovNullButton.label" );
