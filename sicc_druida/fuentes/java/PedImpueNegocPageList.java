...
public class PedImpueNegocPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","pedImpueNegocList" );
      ...
      ((Element)v.get(14)).setAttribute("cod","PedImpueNegoc.sbacOidSbac.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","PedImpueNegoc.negoOidNego.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","PedImpueNegoc.taimOidTasaImpu.label" );
