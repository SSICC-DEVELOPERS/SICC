/*
    INDRA/CAR/mmg
    $Id: MaeRespuEncueViewLPStartUp.java,v 1.1 2009/12/03 18:42:07 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class MaeRespuEncueViewLPStartUp extends MMGDruidaBase{
	...
	public MaeRespuEncueViewLPStartUp(){
		super();
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			buildJsPageSize("MaeRespuEncueView");
			...
			asignarAtributo("PAGINA", "MaeRespuEncueViewPage", "cod", "MaeRespuEncueView." + accion + ".label");
			...
			limpiarBotoneraLista("maeRespuEncueView", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("AREATEXTO", "Descripcion", "validacion", "ValidaLongitud(cdos_trim(valor), 1, 100)");
		
		//Primero determianmos el nombre del campo en la entidad de oriegen donde se van a cargar los datos
		asignar("VAR", "idAttributeLovOpener", conectorParametro(PARAMETRO_LOV_ATTRIBUTO));
		asignar("VAR", "idEntityLovOpener", conectorParametro(PARAMETRO_LOV_ENTIDAD));
		//asignarAtributo("CAPA", "maeRespuEncueViewLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "MaeRespuEncueViewPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		MaeRespuEncueViewData maeRespuEncueViewQuery= new MaeRespuEncueViewData();
		maeRespuEncueViewQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		MaeRespuEncueViewData datosResult = (MaeRespuEncueViewData)getSingleObject(BUSINESSID_QUERY, maeRespuEncueViewQuery, 
			maeRespuEncueViewQuery.clone(), "maeRespuEncueView");
		...
		preservaHiddensI18n(new Integer(1), "MAE_RESPU_ENCUE", "maeRespuEncueViewFrm", "Descripcion", true);
		...
		MaeRespuEncueViewData maeRespuEncueView = datosResult;
		asignar("TEXT", "codResp", FormatUtils.formatObject(maeRespuEncueView.getCodResp(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "valPeso", FormatUtils.formatObject(maeRespuEncueView.getValPeso(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("AREATEXTO", "Descripcion", FormatUtils.formatObject(maeRespuEncueView.getDescripcion(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		loadLocalizationVars(maeRespuEncueView);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "codResp", "disabled", "S");
		asignarAtributo("TEXT", "valPeso", "disabled", "S");
		asignarAtributo("AREATEXTO", "Descripcion", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "MAE_RESPU_ENCUE", "maeRespuEncueViewFrm", "Descripcion", false);
		...
		asignarAtributo("AREATEXTO", "Descripcion", "req", "S");
		
		
		//Asiganamos a los campos internacionalizables la función de onblur para actualizar el 
		//valor del idioma por defecto
		asignarAtributo("AREATEXTO", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('maeRespuEncueViewFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "maeRespuEncueViewFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		MaeRespuEncueViewData maeRespuEncueViewQuery= new MaeRespuEncueViewData();
		maeRespuEncueViewQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(maeRespuEncueView.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"maeRespuEncueViewFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"maeRespuEncueViewFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codResp", "ontab","ejecutarAccionFocoModificacion(\"maeRespuEncueViewFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codResp", "onshtab","ejecutarAccionFocoModificacion(\"maeRespuEncueViewFrm\",2, false)");
				asignarAtributo("AREATEXTO", "valPeso", "ontab","ejecutarAccionFocoModificacion(\"maeRespuEncueViewFrm\",3, true)");
				asignarAtributo("AREATEXTO", "valPeso", "onshtab","ejecutarAccionFocoModificacion(\"maeRespuEncueViewFrm\",3, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"maeRespuEncueViewFrm\",4, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"maeRespuEncueViewFrm\",4, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","maeRespuEncueViewTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","maeRespuEncueViewTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","maeRespuEncueViewFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","maeRespuEncueViewListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","maeRespuEncueViewListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(MaeRespuEncueViewData maeRespuEncueView) throws Exception{
	...
	* @param maeRespuEncueView La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(MaeRespuEncueViewData maeRespuEncueView) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		MaeRespuEncueViewData maeRespuEncueView = 
			(MaeRespuEncueViewData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(maeRespuEncueView);
		loadLeafDependenceCombos(maeRespuEncueView);
	}
	...
	*/
	...
	protected void loadLocalizationVars(MaeRespuEncueViewData maeRespuEncueView) throws Exception{
		...
		mmgLocalizationQuery.setEntiPk(maeRespuEncueView.getId());
