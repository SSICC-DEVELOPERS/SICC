...
public class contenido_mantenimiento_cajas_consultar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_mantenimiento_cajas_consultar" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","contenido_mantenimiento_cajas_consultar.js" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(13)).setAttribute("nombre","oidCaja" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(19)).setAttribute("nombre","oidTipoCaja" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(20)).setAttribute("nombre","oidRespCierreCaja" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(21)).setAttribute("nombre","hOidsEliminar" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(37)).setAttribute("cod","BelCaja.legend.label" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(46)).setAttribute("nombre","lblCanal" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(53)).setAttribute("nombre","cbCanal" );
      ...
      ((Element)v.get(53)).setAttribute("onchange","canalOnChange();" );
      ((Element)v.get(53)).setAttribute("onshtab","focaliza('formulario.cbTipoCaja')" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(65)).setAttribute("nombre","lblAcceso" );
      ...
      ((Element)v.get(65)).setAttribute("cod","10" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(69)).setAttribute("nombre","lblSubacceso" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(69)).setAttribute("cod","122" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(76)).setAttribute("nombre","cbAcceso" );
      ...
      ((Element)v.get(76)).setAttribute("onchange","accesoOnChange();" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(81)).setAttribute("nombre","cbSubacceso" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(92)).setAttribute("nombre","lblCodigoCaja" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(92)).setAttribute("cod","BelCaja.codCaja.label" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(96)).setAttribute("nombre","lblRespCierreCaja" );
      ((Element)v.get(96)).setAttribute("alto","3" );
      ((Element)v.get(96)).setAttribute("filas","1" );
      ((Element)v.get(96)).setAttribute("valor","" );
      ((Element)v.get(96)).setAttribute("id","datosTitle" );
      ((Element)v.get(96)).setAttribute("cod","BelCaja.userOidUser.label" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(107)).setAttribute("nombre","cbRespCierreCaja" );
      ...
      /* Empieza nodo:111 / Elemento padre: 60   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(60)).appendChild((Element)v.get(111));
      ...
      /* Empieza nodo:114 / Elemento padre: 35   */
   }
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(35)).appendChild((Element)v.get(114));
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(119)).setAttribute("nombre","lblTipoCaja" );
      ((Element)v.get(119)).setAttribute("alto","3" );
      ((Element)v.get(119)).setAttribute("filas","1" );
      ((Element)v.get(119)).setAttribute("valor","" );
      ((Element)v.get(119)).setAttribute("id","datosTitle" );
      ((Element)v.get(119)).setAttribute("cod","BelCaja.ticjOidTipoCaja.label" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(126)).setAttribute("nombre","cbTipoCaja" );
      ...
      ((Element)v.get(126)).setAttribute("ontab","focaliza('formulario.cbAcceso')" );
      ...
      /* Empieza nodo:133 / Elemento padre: 34   */
      v.add(doc.createElement("fieldset"));
      ((Element)v.get(34)).appendChild((Element)v.get(133));
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(137)).setAttribute("nombre","btnBuscar" );
      ((Element)v.get(137)).setAttribute("ID","botonContenido" );
      ((Element)v.get(137)).setAttribute("tipo","html" );
      ((Element)v.get(137)).setAttribute("accion","onClickBuscar();" );
      ((Element)v.get(137)).setAttribute("estado","false" );
      ((Element)v.get(137)).setAttribute("cod","1" );
      ...
      /* Empieza nodo:138 / Elemento padre: 31   */
      v.add(doc.createElement("td"));
      ((Element)v.get(31)).appendChild((Element)v.get(138));
      ...
      /* Empieza nodo:140 / Elemento padre: 23   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(23)).appendChild((Element)v.get(140));
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(147)).setAttribute("nombre","capaLista" );
      ((Element)v.get(147)).setAttribute("ancho","100%" );
      ((Element)v.get(147)).setAttribute("alto","330" );
      ((Element)v.get(147)).setAttribute("x","7" );
      ((Element)v.get(147)).setAttribute("y","270" );
      ...
      ((Element)v.get(147)).setAttribute("visibilidad","" );
      ...
      ((Element)v.get(148)).setAttribute("nombre","listado1" );
      ((Element)v.get(148)).setAttribute("ancho","369" );
      ((Element)v.get(148)).setAttribute("alto","301" );
      ((Element)v.get(148)).setAttribute("x","12" );
      ((Element)v.get(148)).setAttribute("y","0" );
      ((Element)v.get(148)).setAttribute("colorFondo","#CECFCE" );
      ((Element)v.get(148)).setAttribute("msgDebugJS","S" );
   ...
   private void getXML630(Document doc) {
      ...
      ((Element)v.get(158)).setAttribute("botonOrdenar","S" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(160)).setAttribute("ancho","80" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(161)).setAttribute("ancho","80" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(163)).setAttribute("ancho","260" );
   ...
   private void getXML720(Document doc) {
      ...
      ((Element)v.get(173)).setAttribute("cod","7" );
      ...
      ((Element)v.get(175)).setAttribute("cod","10" );
      ...
      ((Element)v.get(177)).setAttribute("cod","122" );
      ...
      ((Element)v.get(179)).setAttribute("cod","BelCaja.codCaja.label" );
      ((Element)v.get(172)).appendChild((Element)v.get(179));

      /* Elemento padre:179 / Elemento actual: 180   */
      v.add(doc.createTextNode("Cód. caja"));
      ...
      ((Element)v.get(181)).setAttribute("cod","BelCaja.userOidUser.label" );
      ((Element)v.get(172)).appendChild((Element)v.get(181));

      /* Elemento padre:181 / Elemento actual: 182   */
      v.add(doc.createTextNode("Responsable de caja"));
      ...
      ((Element)v.get(183)).setAttribute("cod","BelCaja.ticjOidTipoCaja.label" );
   ...
   private void getXML810(Document doc) {
      ...
      /* Empieza nodo:192 / Elemento padre: 148   */
      ...
      ((Element)v.get(148)).appendChild((Element)v.get(192));
      ...
      /* Empieza nodo:206 / Elemento padre: 148   */
      v.add(doc.createElement("ROWSET"));
      ((Element)v.get(148)).appendChild((Element)v.get(206));
      /* Termina nodo:206   */

      /* Empieza nodo:207 / Elemento padre: 148   */
      v.add(doc.createElement("PAGINADO"));
      ((Element)v.get(207)).setAttribute("nombre","mipgndo" );
      ((Element)v.get(207)).setAttribute("ancho","679" );
      ((Element)v.get(207)).setAttribute("sep","$" );
      ((Element)v.get(207)).setAttribute("x","12" );
      ((Element)v.get(207)).setAttribute("class","botonera" );
      ((Element)v.get(207)).setAttribute("y","294" );
      ((Element)v.get(207)).setAttribute("control","|" );
      ((Element)v.get(207)).setAttribute("conector","ConectorBuscarCargosAbonos" );
      ((Element)v.get(207)).setAttribute("rowset","" );
      ((Element)v.get(207)).setAttribute("cargainicial","N" );
      ((Element)v.get(207)).setAttribute("onload","procesarPaginado(mipgndo,msgError, ultima, rowset, 'muestraLista(ultima, rowset)')" );
      ((Element)v.get(148)).appendChild((Element)v.get(207));

      /* Empieza nodo:208 / Elemento padre: 207   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(208)).setAttribute("nombre","ret1" );
      ((Element)v.get(208)).setAttribute("x","37" );
      ((Element)v.get(208)).setAttribute("y","282" );
      ((Element)v.get(208)).setAttribute("ID","botonContenido" );
      ((Element)v.get(208)).setAttribute("img","retroceder_on" );
   ...
   private void getXML900(Document doc) {
      ...
      ((Element)v.get(208)).setAttribute("accion","mipgndo.retroceder();" );
      ((Element)v.get(207)).appendChild((Element)v.get(208));
      /* Termina nodo:208   */

      /* Empieza nodo:209 / Elemento padre: 207   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(209)).setAttribute("nombre","ava1" );
      ((Element)v.get(209)).setAttribute("x","52" );
      ((Element)v.get(209)).setAttribute("y","282" );
      ((Element)v.get(209)).setAttribute("ID","botonContenido" );
      ((Element)v.get(209)).setAttribute("img","avanzar_on" );
      ...
      ((Element)v.get(209)).setAttribute("accion","mipgndo.avanzar();" );
      ((Element)v.get(207)).appendChild((Element)v.get(209));
      /* Termina nodo:209   */
      /* Termina nodo:207   */
      /* Termina nodo:148   */

      /* Empieza nodo:210 / Elemento padre: 147   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(210)).setAttribute("nombre","primera1" );
      ((Element)v.get(210)).setAttribute("x","20" );
      ((Element)v.get(210)).setAttribute("y","282" );
      ((Element)v.get(210)).setAttribute("ID","botonContenido" );
      ((Element)v.get(210)).setAttribute("img","primera_on" );
      ((Element)v.get(210)).setAttribute("tipo","-2" );
      ((Element)v.get(210)).setAttribute("estado","false" );
      ((Element)v.get(210)).setAttribute("alt","" );
      ((Element)v.get(210)).setAttribute("codigo","" );
      ((Element)v.get(210)).setAttribute("accion","mipgndo.retrocederPrimeraPagina();" );
      ((Element)v.get(147)).appendChild((Element)v.get(210));
      /* Termina nodo:210   */

      /* Empieza nodo:211 / Elemento padre: 147   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(211)).setAttribute("nombre","separa" );
      ((Element)v.get(211)).setAttribute("x","59" );
      ((Element)v.get(211)).setAttribute("y","278" );
      ((Element)v.get(211)).setAttribute("ID","botonContenido" );
      ((Element)v.get(211)).setAttribute("img","separa_base" );
      ...
      /* Empieza nodo:212 / Elemento padre: 147   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(212)).setAttribute("nombre","Modificar" );
      ((Element)v.get(212)).setAttribute("x","80" );
      ((Element)v.get(212)).setAttribute("y","279" );
      ...
      ((Element)v.get(212)).setAttribute("accion","onClickModificar();" );
      ((Element)v.get(147)).appendChild((Element)v.get(212));
      /* Termina nodo:212   */

      /* Empieza nodo:213 / Elemento padre: 147   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(213)).setAttribute("nombre","Detalle" );
      ((Element)v.get(213)).setAttribute("x","80" );
      ((Element)v.get(213)).setAttribute("y","279" );
      ...
      ((Element)v.get(213)).setAttribute("cod","3" );
      ((Element)v.get(213)).setAttribute("accion","onClickDetalle();" );
      ((Element)v.get(147)).appendChild((Element)v.get(213));
      /* Termina nodo:213   */
      /* Termina nodo:147   */

      /* Empieza nodo:214 / Elemento padre: 6   */
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(214)).setAttribute("nombre","capaEspacio" );
      ((Element)v.get(214)).setAttribute("alto","12" );
      ...
      ((Element)v.get(214)).setAttribute("y","428" );
