...
public class contenido_grupo_crear_perf  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_grupo_crear_perf" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(3)).setAttribute("src","contenido_grupo_crear_perf.js" );
      ...
      ((Element)v.get(8)).setAttribute("group","factCuadreDec" );
      ...
      ((Element)v.get(10)).setAttribute("valor","LPCrearGrupoPerf" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(13)).setAttribute("nombre","hidNroGrupo" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(19)).setAttribute("nombre","cteCuadreTotalMontos" );
   ...
   private void getXML90(Document doc) {
      v.add(doc.createElement("VAR"));
      ((Element)v.get(20)).setAttribute("nombre","varIndCuadre" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(21)).setAttribute("nombre","hidListaEditable" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(22)).setAttribute("nombre","hidCodSeleccionadosLE" );
   ...
   private void getXML180(Document doc) {
      ((Element)v.get(42)).setAttribute("width","472" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(50)).setAttribute("nombre","lblNGrupo" );
      ...
      ((Element)v.get(50)).setAttribute("cod","533" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lblTipoGrupo" );
      ((Element)v.get(54)).setAttribute("alto","13" );
      ((Element)v.get(54)).setAttribute("filas","1" );
      ((Element)v.get(54)).setAttribute("valor","" );
      ((Element)v.get(54)).setAttribute("id","datosTitle" );
      ((Element)v.get(54)).setAttribute("cod","479" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(58)).setAttribute("nombre","lblIndicadorCuadre" );
      ...
      ((Element)v.get(58)).setAttribute("cod","461" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(62)).setAttribute("nombre","lblFactorCuadre" );
      ...
      ((Element)v.get(62)).setAttribute("cod","459" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(69)).setAttribute("nombre","lblNGrupoX" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(73)).setAttribute("nombre","lblTipoGrupoX" );
      ...
      ((Element)v.get(77)).setAttribute("nombre","cbIndicadorCuadre" );
      ...
      ((Element)v.get(77)).setAttribute("ontab","tabGenerico('cbIndicadorCuadre');" );
      ((Element)v.get(77)).setAttribute("onshtab","tabGenerico('cbIndicadorCuadre','sh');" );
      ...
      ((Element)v.get(82)).setAttribute("nombre","txtFactorCuadre" );
      ...
      ((Element)v.get(82)).setAttribute("ontab","tabGenerico('txtFactorCuadre');" );
      ((Element)v.get(82)).setAttribute("onshtab","tabGenerico('txtFactorCuadre','sh');" );
      ((Element)v.get(81)).appendChild((Element)v.get(82));
      /* Termina nodo:82   */
      /* Termina nodo:81   */

      /* Empieza nodo:83 / Elemento padre: 65   */
      v.add(doc.createElement("td"));
      ((Element)v.get(83)).setAttribute("width","100%" );
      ((Element)v.get(65)).appendChild((Element)v.get(83));
   ...
   private void getXML360(Document doc) {
      ...
      /* Empieza nodo:88 / Elemento padre: 32   */
      v.add(doc.createElement("td"));
      ((Element)v.get(32)).appendChild((Element)v.get(88));
      ...
      ((Element)v.get(97)).setAttribute("ancho","475" );
      ((Element)v.get(97)).setAttribute("alto","317" );
      ((Element)v.get(97)).setAttribute("x","12" );
      ((Element)v.get(97)).setAttribute("y","99" );
      ((Element)v.get(97)).setAttribute("colorFondo","#CECFCE" );
      ((Element)v.get(97)).setAttribute("msgDebugJS","S" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(105)).setAttribute("cod","0067" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(116)).setAttribute("ancho","120" );
      ...
      /* Empieza nodo:117 / Elemento padre: 97   */
      ...
      ((Element)v.get(97)).appendChild((Element)v.get(117));
      ...
      ((Element)v.get(122)).setAttribute("cod","608" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(124)).setAttribute("cod","581" );
      ...
      ((Element)v.get(126)).setAttribute("cod","529" );
      ...
      ((Element)v.get(128)).setAttribute("cod","530" );
      ...
      ((Element)v.get(130)).setAttribute("cod","481" );
      ...
      ((Element)v.get(132)).setAttribute("cod","482" );
      ...
      ((Element)v.get(134)).setAttribute("cod","483" );
      ...
      /* Empieza nodo:136 / Elemento padre: 97   */
      ...
      ((Element)v.get(97)).appendChild((Element)v.get(136));
   ...
   private void getXML630(Document doc) {
      ...
      /* Empieza nodo:148 / Elemento padre: 9   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(148)).setAttribute("nombre","Buscar" );
      ((Element)v.get(148)).setAttribute("x","13" );
      ((Element)v.get(148)).setAttribute("y","394" );
      ...
      ((Element)v.get(148)).setAttribute("cod","1" );
      ((Element)v.get(148)).setAttribute("accion","buscar();" );
      ((Element)v.get(148)).setAttribute("ontab","tabGenerico('Buscar');" );
      ((Element)v.get(148)).setAttribute("onshtab","tabGenerico('Buscar','sh');" );
      ((Element)v.get(9)).appendChild((Element)v.get(148));
      /* Termina nodo:148   */

      /* Empieza nodo:149 / Elemento padre: 9   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(149)).setAttribute("nombre","Modificar" );
      ((Element)v.get(149)).setAttribute("x","65" );
      ((Element)v.get(149)).setAttribute("y","394" );
      ...
      ((Element)v.get(149)).setAttribute("accion","accionModificarProducto();" );
      ((Element)v.get(149)).setAttribute("ontab","tabGenerico('Modificar');" );
      ((Element)v.get(149)).setAttribute("onshtab","tabGenerico('Modificar','sh');" );
      ((Element)v.get(9)).appendChild((Element)v.get(149));
      /* Termina nodo:149   */

      /* Empieza nodo:150 / Elemento padre: 9   */
      v.add(doc.createElement("CAPA"));
      ...
      ((Element)v.get(150)).setAttribute("y","416" );
      ((Element)v.get(150)).setAttribute("zindex","" );
      ((Element)v.get(9)).appendChild((Element)v.get(150));
      /* Termina nodo:150   */
      /* Termina nodo:9   */
