...
public class contenido_envio_inifin_periodo  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_envio_inifin_periodo" );
      ((Element)v.get(0)).setAttribute("cod","01071" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","contenido_envio_inifin_periodo.js" );
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(9)).setAttribute("name","cbActividad" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(21)).setAttribute("nombre","hActividades" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(63)).setAttribute("onshtab","focalizaAnterior();" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(82)).setAttribute("width","525" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(87)).setAttribute("nombre","lblTipoDespacho" );
      ...
      ((Element)v.get(87)).setAttribute("cod","1000" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(103)).setAttribute("nombre","cbActividad" );
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(104)).setAttribute("width","300" );
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(107)).setAttribute("colspan","5" );
      ...
      /* Empieza nodo:111 / Elemento padre: 22   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(22)).appendChild((Element)v.get(111));
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(119)).setAttribute("nombre","btnAceptar" );
      ((Element)v.get(119)).setAttribute("ID","botonContenido" );
      ((Element)v.get(119)).setAttribute("tipo","html" );
      ((Element)v.get(119)).setAttribute("accion","aceptarOnClick();" );
      ((Element)v.get(119)).setAttribute("estado","false" );
      ((Element)v.get(119)).setAttribute("cod","12" );
      ((Element)v.get(119)).setAttribute("ontab","focalizaSiguiente('frmFormulario.cbMarca');" );
