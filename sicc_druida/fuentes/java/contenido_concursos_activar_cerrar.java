...
public class contenido_concursos_activar_cerrar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_concursos_activar_cerrar" );
      ((Element)v.get(0)).setAttribute("cod","3365" );
      ((Element)v.get(0)).setAttribute("titulo","Activar/Cerrar concursos" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(5)).setAttribute("src","contenido_concursos_activar_cerrar.js" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(19)).setAttribute("nombre","hOidPeriodoActual" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(20)).setAttribute("nombre","hOidPeriodoPosteriorActual" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(21)).setAttribute("nombre","hOidPeriodoActivar" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(22)).setAttribute("nombre","hOidPeriodoCerrar" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(23)).setAttribute("nombre","hVariableEntorno" );
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(42)).setAttribute("width","696" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(61)).setAttribute("ontab","onTab('cbMarca')" );
      ((Element)v.get(61)).setAttribute("onshtab","onShiftTab('cbMarca')" );
      ...
      ((Element)v.get(66)).setAttribute("ontab","onTab('cbCanal')" );
      ((Element)v.get(66)).setAttribute("onshtab","onShiftTab('cbCanal')" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(72)).setAttribute("width","696" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(80)).setAttribute("nombre","lblPeriodoCerrar" );
      ...
      ((Element)v.get(80)).setAttribute("cod","3366" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(90)).setAttribute("nombre","cbPeriodoCerrar" );
      ...
      ((Element)v.get(90)).setAttribute("ontab","onTab('cbPeriodoCerrar')" );
      ((Element)v.get(90)).setAttribute("onshtab","onShiftTab('cbPeriodoCerrar')" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(95)).setAttribute("nombre","btnCerrarConcursos" );
      ((Element)v.get(95)).setAttribute("ID","botonContenido" );
      ((Element)v.get(95)).setAttribute("tipo","html" );
      ((Element)v.get(95)).setAttribute("accion","onClickBtnCerrarConcursos();" );
      ((Element)v.get(95)).setAttribute("estado","false" );
      ((Element)v.get(95)).setAttribute("cod","3368" );
      ((Element)v.get(95)).setAttribute("onshtab","onShiftTab('btnCerrarConcursos')" );
      ((Element)v.get(95)).setAttribute("ontab","onTab('btnCerrarConcursos');" );
      ...
      /* Empieza nodo:101 / Elemento padre: 39   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(39)).appendChild((Element)v.get(101));
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(103)).setAttribute("width","696" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(111)).setAttribute("nombre","lblPeriodoActivar" );
      ...
      ((Element)v.get(111)).setAttribute("cod","3367" );
   ...
   private void getXML450(Document doc) {
      ...
      /* Empieza nodo:117 / Elemento padre: 103   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(103)).appendChild((Element)v.get(117));
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(121)).setAttribute("nombre","cbPeriodoActivar" );
      ...
      ((Element)v.get(121)).setAttribute("ontab","onTab('cbPeriodoActivar')" );
      ((Element)v.get(121)).setAttribute("onshtab","onShiftTab('cbPeriodoActivar')" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(126)).setAttribute("nombre","btnActivarConcursos" );
      ((Element)v.get(126)).setAttribute("ID","botonContenido" );
      ((Element)v.get(126)).setAttribute("tipo","html" );
      ((Element)v.get(126)).setAttribute("accion","onClickBtnActivarConcursos();" );
      ((Element)v.get(126)).setAttribute("estado","false" );
      ((Element)v.get(126)).setAttribute("cod","3369" );
      ((Element)v.get(126)).setAttribute("onshtab","onShiftTab('btnActivarConcursos')" );
      ((Element)v.get(126)).setAttribute("ontab","onTab('btnActivarConcursos');" );
      ...
      /* Empieza nodo:132 / Elemento padre: 32   */
      v.add(doc.createElement("td"));
      ((Element)v.get(32)).appendChild((Element)v.get(132));
