...
public class contenido_hoja_demanda_ingresar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_hoja_demanda_ingresar" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(3)).setAttribute("src","contenido_hoja_demanda_ingresar.js" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(18)).setAttribute("nombre","subacceso" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(20)).setAttribute("nombre","oidSubacceso" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(21)).setAttribute("nombre","almacen" );
   ...
   private void getXML90(Document doc) {
      v.add(doc.createElement("VAR"));
      ((Element)v.get(22)).setAttribute("nombre","oidAlmacen" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(24)).setAttribute("nombre","oidRegistroAbastecimientoCabecera" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(25)).setAttribute("nombre","oidAgrupacionStock" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(26)).setAttribute("nombre","oidPeriodo" );
   ...
   private void getXML540(Document doc) {
      ...
      /* Empieza nodo:145 / Elemento padre: 127   */
      ...
      ((Element)v.get(147)).setAttribute("cod","338" );
      ...
      ((Element)v.get(148)).setAttribute("cod","2324" );
      ...
      ((Element)v.get(149)).setAttribute("cod","2325" );
      ...
      ((Element)v.get(150)).setAttribute("cod","504" );
   ...
   private void getXML630(Document doc) {
      ((Element)v.get(151)).setAttribute("cod","1601" );
      ...
      /* Empieza nodo:153 / Elemento padre: 127   */
      ...
      ((Element)v.get(127)).appendChild((Element)v.get(153));
      ...
      ((Element)v.get(161)).setAttribute("ancho","614" );
      ((Element)v.get(161)).setAttribute("sep","$" );
      ((Element)v.get(161)).setAttribute("x","24" );
      ((Element)v.get(161)).setAttribute("class","botonera" );
      ((Element)v.get(161)).setAttribute("y","419" );
      ...
      ((Element)v.get(162)).setAttribute("y","423" );
      ...
      ((Element)v.get(163)).setAttribute("y","423" );
   ...
   private void getXML720(Document doc) {
      ...
      ((Element)v.get(5)).appendChild((Element)v.get(164));
      /* Termina nodo:164   */
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(166)).setAttribute("nombre","btnAnadir" );
      ((Element)v.get(166)).setAttribute("x","80" );
      ((Element)v.get(166)).setAttribute("y","420" );
      ...
      ((Element)v.get(166)).setAttribute("cod","404" );
      ((Element)v.get(166)).setAttribute("accion","accionAnadir();" );
      ((Element)v.get(166)).setAttribute("onshtab","focoshAnadir();" );
      ((Element)v.get(5)).appendChild((Element)v.get(166));
      /* Termina nodo:166   */

      /* Empieza nodo:167 / Elemento padre: 5   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(167)).setAttribute("nombre","btnModificar" );
      ((Element)v.get(167)).setAttribute("x","128" );
      ((Element)v.get(167)).setAttribute("y","420" );
      ((Element)v.get(167)).setAttribute("ID","botonContenido" );
      ((Element)v.get(167)).setAttribute("img","" );
      ((Element)v.get(167)).setAttribute("tipo","html" );
      ((Element)v.get(167)).setAttribute("estado","false" );
      ((Element)v.get(167)).setAttribute("cod","2" );
      ((Element)v.get(167)).setAttribute("accion","accionModificar();" );
      ((Element)v.get(167)).setAttribute("ontab","focotabModificar();" );
      ((Element)v.get(5)).appendChild((Element)v.get(167));
      /* Termina nodo:167   */

      /* Empieza nodo:168 / Elemento padre: 5   */
      ...
      ((Element)v.get(168)).setAttribute("y","442" );
      ((Element)v.get(168)).setAttribute("zindex","" );
      ((Element)v.get(5)).appendChild((Element)v.get(168));
      /* Termina nodo:168   */
      /* Termina nodo:5   */
