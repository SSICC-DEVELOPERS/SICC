...
public class INCRankingVariablesResumen extends LPSICCBase {           

  public INCRankingVariablesResumen() {	 
     super();
  }
  ...
  public void ejecucion() throws Exception {		
    ...
    try {
      ...
      if (accion.equals("generar")){
        ...
        cargarPagina();
        getConfiguracionMenu("INCRankingVariablesResumen");
      }
     
    } catch (Exception ex) {
     			
      //pagina("contenido_informe_ranking_variables_generar");
      //getConfiguracionMenu("INCRankingVariablesResumen");
  ...
  private void generarReporte() throws Exception{
    ...
    datos.put(ConstantesREP.TITULO, "RANKING DE VARIABLES I");
    ...
    ejecutarReporte2(datos, "REPGenerarReporteBatch", "RD_REP-069", formato);
