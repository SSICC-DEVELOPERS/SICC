...
public class MaePreguEncuePageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","MaePreguEncue.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","MaePreguEncue.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('maePreguEncueFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('maePreguEncueFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(50)).setAttribute("nombre","codPregTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lblCodPreg" );
      ((Element)v.get(54)).setAttribute("alto","13" );
      ((Element)v.get(54)).setAttribute("filas","1" );
      ((Element)v.get(54)).setAttribute("id","datosTitle" );
      ((Element)v.get(54)).setAttribute("cod","MaePreguEncue.codPreg.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(55)).setAttribute("nombre","codPregWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(57)).setAttribute("nombre","codPreg" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('maePreguEncueFrm',2, true)" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('maePreguEncueFrm', 2, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(58)).setAttribute("nombre","codPregGapTdId" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(60)).setAttribute("nombre","valPesoPregTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(65)).setAttribute("nombre","valPesoPregWidgetTrId" );
      ...
      ((Element)v.get(67)).setAttribute("ontab","ejecutarAccionFoco('maePreguEncueFrm',3, true)" );
      ((Element)v.get(67)).setAttribute("onshtab","ejecutarAccionFoco('maePreguEncueFrm', 3, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(68)).setAttribute("nombre","valPesoPregGapTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(72)).setAttribute("nombre","formGapTr1" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(79)).setAttribute("nombre","formTr2" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(85)).setAttribute("nombre","enseOidEncuTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(90)).setAttribute("nombre","enseOidEncuWidgetTrId" );
      ((Element)v.get(86)).appendChild((Element)v.get(90));

      /* Empieza nodo:91 / Elemento padre: 90   */
      v.add(doc.createElement("TD"));
      ((Element)v.get(91)).setAttribute("align","left" );
      ((Element)v.get(91)).setAttribute("nowrap","true" );
      ((Element)v.get(90)).appendChild((Element)v.get(91));

      /* Empieza nodo:92 / Elemento padre: 91   */
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(92)).setAttribute("nombre","enseOidEncu" );
      ...
      ((Element)v.get(92)).setAttribute("disabled","" );
      ((Element)v.get(92)).setAttribute("validacion","" );
      ((Element)v.get(92)).setAttribute("onchange","" );
      ((Element)v.get(92)).setAttribute("onfocus","" );
      ((Element)v.get(92)).setAttribute("valorinicial","" );
      ((Element)v.get(92)).setAttribute("textoinicial","" );
      ((Element)v.get(92)).setAttribute("ontab","ejecutarAccionFoco('maePreguEncueFrm',4, true);" );
      ((Element)v.get(92)).setAttribute("onshtab","ejecutarAccionFoco('maePreguEncueFrm',4, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(94)).setAttribute("nombre","enseOidEncuGapTdId" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(111)).setAttribute("nombre","DescripcionTdId" );
      ...
      ((Element)v.get(115)).setAttribute("cod","MaePreguEncue.Descripcion.label" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(116)).setAttribute("nombre","DescripcionTdLocalizationButtonGapHeader" );
      ((Element)v.get(116)).setAttribute("colspan","2" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(117)).setAttribute("nombre","DescripcionWidgetTrId" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(119)).setAttribute("max","50" );
      ((Element)v.get(119)).setAttribute("onchange","" );
      ((Element)v.get(119)).setAttribute("req","N" );
      ((Element)v.get(119)).setAttribute("size","50" );
      ...
      ((Element)v.get(119)).setAttribute("ontab","ejecutarAccionFoco('maePreguEncueFrm',5, true)" );
      ((Element)v.get(119)).setAttribute("onshtab","ejecutarAccionFoco('maePreguEncueFrm', 5, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(122)).setAttribute("nombre","DescripcionTdLocalizationButton" );
      ...
      ((Element)v.get(123)).setAttribute("id","DescripcionLocalizationButton" );
      ((Element)v.get(123)).setAttribute("href","javascript:openLocalizationDialog('maePreguEncueFrm', 'Descripcion', 1);" );
      ((Element)v.get(123)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"maePreguEncueFrm\",5, true)', 'ejecutarAccionFoco(\"maePreguEncueFrm\",5, false)')" );
      ((Element)v.get(122)).appendChild((Element)v.get(123));

      /* Empieza nodo:124 / Elemento padre: 123   */
      v.add(doc.createElement("IMG"));
      ((Element)v.get(124)).setAttribute("nombre","DescripcionLocalizationButton" );
      ((Element)v.get(124)).setAttribute("src","iconmultidioma.gif" );
      ((Element)v.get(124)).setAttribute("border","0" );
      ((Element)v.get(124)).setAttribute("width","21" );
      ((Element)v.get(124)).setAttribute("height","15" );
      ((Element)v.get(124)).setAttribute("class","main" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(125)).setAttribute("nombre","DescripcionGapTdId" );
      ...
      /* Empieza nodo:129 / Elemento padre: 105   */
      v.add(doc.createElement("TD"));
      ((Element)v.get(129)).setAttribute("width","100%" );
      ((Element)v.get(105)).appendChild((Element)v.get(129));
      /* Termina nodo:129   */
      /* Termina nodo:105   */
   ...
   private void getXML630(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(139)).setAttribute("nombre","maePreguEncueTrButtons" );
      ...
      ((Element)v.get(146)).setAttribute("nombre","maePreguEncueTdQueryButton" );
      ((Element)v.get(145)).appendChild((Element)v.get(146));

      /* Empieza nodo:147 / Elemento padre: 146   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(147)).setAttribute("nombre","maePreguEncueQueryButton" );
      ((Element)v.get(147)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(147)).setAttribute("estado","false" );
      ((Element)v.get(147)).setAttribute("accion","maePreguEncueFirstPage();" );
      ...
      ((Element)v.get(148)).setAttribute("nombre","maePreguEncueTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(150)).setAttribute("nombre","maePreguEncueLovNullButton" );
      ((Element)v.get(150)).setAttribute("ID","botonContenido" );
      ((Element)v.get(150)).setAttribute("tipo","html" );
      ((Element)v.get(150)).setAttribute("accion","maePreguEncueLovNullSelectionAction();" );
