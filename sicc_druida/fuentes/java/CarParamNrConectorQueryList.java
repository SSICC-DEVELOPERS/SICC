...
public class CarParamNrConectorQueryList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad CarParamNr" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGCarParamNrQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGCarParamNrQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","CarParamNrListFormatter" );
