...
public class contenido_plantilla_cursos_modificar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_plantilla_cursos_modificar" );
      ((Element)v.get(0)).setAttribute("cod","" );
      ((Element)v.get(0)).setAttribute("titulo","" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","Modificar plantilla de cursos" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(3)).setAttribute("src","contenido_plantilla_cursos_modificar.js" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(31)).setAttribute("width","648" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(39)).setAttribute("nombre","lblNombrePlantilla" );
      ...
      ((Element)v.get(39)).setAttribute("cod","743" );
      ...
      ((Element)v.get(41)).setAttribute("width","120" );
      ...
      ((Element)v.get(46)).setAttribute("nombre","txtNombrePlantilla" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(46)).setAttribute("onshtab","focalizaTabAux('txtNombrePlantilla');" );
      ...
      ((Element)v.get(48)).setAttribute("width","120" );
      ...
      ((Element)v.get(62)).setAttribute("nombre","btnBuscar" );
      ((Element)v.get(62)).setAttribute("ID","botonContenido" );
      ((Element)v.get(62)).setAttribute("tipo","html" );
      ((Element)v.get(62)).setAttribute("accion","accionBuscar();" );
      ((Element)v.get(62)).setAttribute("estado","false" );
      ((Element)v.get(62)).setAttribute("cod","1" );
      ((Element)v.get(62)).setAttribute("ontab","focalizaTabAux('btnBuscar');" );
      ...
      ((Element)v.get(64)).setAttribute("height","12" );
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(68)).setAttribute("width","756" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(72)).setAttribute("nombre","capaLista" );
      ((Element)v.get(72)).setAttribute("alto","300" );
      ((Element)v.get(72)).setAttribute("ancho","100%" );
      ((Element)v.get(72)).setAttribute("colorf","" );
      ((Element)v.get(72)).setAttribute("borde","0" );
      ((Element)v.get(72)).setAttribute("imagenf","" );
      ((Element)v.get(72)).setAttribute("repeat","" );
      ((Element)v.get(72)).setAttribute("padding","" );
      ((Element)v.get(72)).setAttribute("visibilidad","hidden" );
      ((Element)v.get(72)).setAttribute("contravsb","" );
      ((Element)v.get(72)).setAttribute("x","0" );
      ((Element)v.get(72)).setAttribute("y","124" );
      ((Element)v.get(72)).setAttribute("zindex","" );
      ((Element)v.get(5)).appendChild((Element)v.get(72));

      /* Empieza nodo:73 / Elemento padre: 72   */
      v.add(doc.createElement("LISTAEDITABLE"));
      ((Element)v.get(73)).setAttribute("nombre","listado1" );
      ((Element)v.get(73)).setAttribute("ancho","652" );
      ((Element)v.get(73)).setAttribute("alto","299" );
      ((Element)v.get(73)).setAttribute("x","12" );
      ((Element)v.get(73)).setAttribute("y","0" );
      ...
      ((Element)v.get(81)).setAttribute("cod","00135" );
      ...
      ((Element)v.get(84)).setAttribute("ancho","5" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(87)).setAttribute("cod","8" );
      ...
      ((Element)v.get(89)).setAttribute("cod","743" );
      ...
      ((Element)v.get(91)).setAttribute("tipoEnvio","seleccion" );
      ((Element)v.get(91)).setAttribute("formaEnvio","xml" );
      ((Element)v.get(91)).setAttribute("maxSel","-1" );
      ((Element)v.get(91)).setAttribute("msgErrMaxSel","" );
      ((Element)v.get(91)).setAttribute("coloresScrollNativo","#D4D0C8,black,white,#D4D0C8,#D4D0C8,#ECE9E4,black" );
      ((Element)v.get(91)).setAttribute("colorROver","#D0D9E8" );
      ((Element)v.get(91)).setAttribute("onLoad","" );
      ((Element)v.get(91)).setAttribute("colorSelecc","#D0D9E8" );
      ...
      ((Element)v.get(95)).setAttribute("nombre","mipgndo" );
      ((Element)v.get(95)).setAttribute("onload","procesarPaginado(mipgndo,msgError, ultima, rowset, 'muestraLista(ultima, rowset)')" );
      ((Element)v.get(95)).setAttribute("ancho","726" );
      ((Element)v.get(95)).setAttribute("sep","$" );
      ((Element)v.get(95)).setAttribute("x","12" );
      ((Element)v.get(95)).setAttribute("class","botonera" );
      ((Element)v.get(95)).setAttribute("y","401" );
      ((Element)v.get(95)).setAttribute("control","|" );
      ((Element)v.get(95)).setAttribute("conector","conectorSandra" );
      ((Element)v.get(95)).setAttribute("rowset","" );
      ((Element)v.get(95)).setAttribute("cargainicial","N" );
      ((Element)v.get(73)).appendChild((Element)v.get(95));

      /* Empieza nodo:96 / Elemento padre: 95   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(96)).setAttribute("nombre","ret1" );
      ((Element)v.get(96)).setAttribute("x","37" );
      ((Element)v.get(96)).setAttribute("y","280" );
      ((Element)v.get(96)).setAttribute("ID","botonContenido" );
      ((Element)v.get(96)).setAttribute("img","retroceder_on" );
      ...
      ((Element)v.get(96)).setAttribute("accion","mipgndo.retroceder();" );
      ((Element)v.get(95)).appendChild((Element)v.get(96));
      /* Termina nodo:96   */

      /* Empieza nodo:97 / Elemento padre: 95   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(97)).setAttribute("nombre","ava1" );
      ((Element)v.get(97)).setAttribute("x","52" );
      ((Element)v.get(97)).setAttribute("y","280" );
      ((Element)v.get(97)).setAttribute("ID","botonContenido" );
      ((Element)v.get(97)).setAttribute("img","avanzar_on" );
      ...
      ((Element)v.get(97)).setAttribute("accion","mipgndo.avanzar();" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(98)).setAttribute("nombre","primera1" );
      ((Element)v.get(98)).setAttribute("x","20" );
      ((Element)v.get(98)).setAttribute("y","280" );
      ((Element)v.get(98)).setAttribute("ID","botonContenido" );
   }

   private void getXML450(Document doc) {
      ((Element)v.get(98)).setAttribute("img","primera_on" );
      ((Element)v.get(98)).setAttribute("tipo","-2" );
      ((Element)v.get(98)).setAttribute("estado","false" );
      ((Element)v.get(98)).setAttribute("alt","" );
      ((Element)v.get(98)).setAttribute("codigo","" );
      ((Element)v.get(98)).setAttribute("accion","mipgndo.retrocederPrimeraPagina();" );
      ((Element)v.get(72)).appendChild((Element)v.get(98));
      /* Termina nodo:98   */

      /* Empieza nodo:99 / Elemento padre: 72   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(99)).setAttribute("nombre","separa" );
      ((Element)v.get(99)).setAttribute("x","59" );
      ((Element)v.get(99)).setAttribute("y","276" );
      ((Element)v.get(99)).setAttribute("ID","botonContenido" );
      ((Element)v.get(99)).setAttribute("img","separa_base" );
      ...
      ((Element)v.get(72)).appendChild((Element)v.get(99));
      /* Termina nodo:99   */

      /* Empieza nodo:100 / Elemento padre: 72   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(100)).setAttribute("nombre","Modificar" );
      ((Element)v.get(100)).setAttribute("x","80" );
      ((Element)v.get(100)).setAttribute("y","277" );
      ...
      ((Element)v.get(100)).setAttribute("cod","2" );
      ((Element)v.get(100)).setAttribute("accion","accionModificar();" );
      ((Element)v.get(100)).setAttribute("ontab","focaliza('frmFormulario.txtNombrePlantilla');" );
      ((Element)v.get(100)).setAttribute("onshtab","document.all['btnBuscar'].focus();" );
      ((Element)v.get(72)).appendChild((Element)v.get(100));
      /* Termina nodo:100   */

      /* Empieza nodo:101 / Elemento padre: 72   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(101)).setAttribute("nombre","Detalle" );
      ...
      ((Element)v.get(101)).setAttribute("cod","3" );
      ((Element)v.get(101)).setAttribute("accion","accionDetalle();" );
      ((Element)v.get(101)).setAttribute("ontab","focaliza('frmFormulario.txtNombrePlantilla');" );
      ((Element)v.get(101)).setAttribute("onshtab","document.all['btnBuscar'].focus();" );
      ((Element)v.get(72)).appendChild((Element)v.get(101));
      /* Termina nodo:101   */

      /* Empieza nodo:102 / Elemento padre: 72   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(102)).setAttribute("nombre","Copiar" );
      ((Element)v.get(102)).setAttribute("x","80" );
      ((Element)v.get(102)).setAttribute("y","277" );
      ...
      ((Element)v.get(102)).setAttribute("cod","721" );
      ((Element)v.get(102)).setAttribute("accion","accionCopiar();" );
      ((Element)v.get(102)).setAttribute("ontab","focaliza('frmFormulario.txtNombrePlantilla');" );
      ((Element)v.get(102)).setAttribute("onshtab","document.all['btnBuscar'].focus();" );
      ((Element)v.get(72)).appendChild((Element)v.get(102));
      /* Termina nodo:102   */
      /* Termina nodo:72   */
      ...
      ((Element)v.get(103)).setAttribute("y","423" );
