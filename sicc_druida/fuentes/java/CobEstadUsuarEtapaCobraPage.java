...
public class CobEstadUsuarEtapaCobraPage  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","CobEstadUsuarEtapaCobraPage" );
      ((Element)v.get(0)).setAttribute("titulo","" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","" );
      ((Element)v.get(0)).setAttribute("onload","cobEstadUsuarEtapaCobraInitComponents()" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","cobestadusuaretapacobra.js" );
      ((Element)v.get(0)).appendChild((Element)v.get(4));
      /* Termina nodo:4   */

      /* Empieza nodo:5 / Elemento padre: 0   */
      v.add(doc.createElement("FORMULARIO"));
      ((Element)v.get(5)).setAttribute("nombre","cobEstadUsuarEtapaCobraFrm" );
      ...
      ((Element)v.get(6)).setAttribute("valor","CobEstadUsuarEtapaCobraLPExecution" );
      ...
      ((Element)v.get(7)).setAttribute("valor","CobEstadUsuarEtapaCobraLPExecution" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(37)).setAttribute("nombre","cobEstadUsuarEtapaCobraFormLayer" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(52)).setAttribute("cod","CobEstadUsuarEtapaCobra.legend.label" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(67)).setAttribute("cod","CobEstadUsuarEtapaCobra.id.label" );
      ...
      ((Element)v.get(70)).setAttribute("ontab","ejecutarAccionFoco('cobEstadUsuarEtapaCobraFrm',1, true)" );
      ((Element)v.get(70)).setAttribute("onshtab","ejecutarAccionFoco('cobEstadUsuarEtapaCobraFrm', 1, false)" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(88)).setAttribute("nombre","codEstaUsuaEtapCobrTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(92)).setAttribute("nombre","lblCodEstaUsuaEtapCobr" );
      ((Element)v.get(92)).setAttribute("alto","13" );
      ((Element)v.get(92)).setAttribute("filas","1" );
      ((Element)v.get(92)).setAttribute("id","datosTitle" );
      ((Element)v.get(92)).setAttribute("cod","CobEstadUsuarEtapaCobra.codEstaUsuaEtapCobr.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(93)).setAttribute("nombre","codEstaUsuaEtapCobrWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(95)).setAttribute("nombre","codEstaUsuaEtapCobr" );
      ((Element)v.get(95)).setAttribute("id","datosCampos" );
      ((Element)v.get(95)).setAttribute("trim","S" );
      ((Element)v.get(95)).setAttribute("max","1" );
      ...
      ((Element)v.get(95)).setAttribute("ontab","ejecutarAccionFoco('cobEstadUsuarEtapaCobraFrm',2, true)" );
      ((Element)v.get(95)).setAttribute("onshtab","ejecutarAccionFoco('cobEstadUsuarEtapaCobraFrm', 2, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(96)).setAttribute("nombre","codEstaUsuaEtapCobrGapTdId" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(117)).setAttribute("cod","CobEstadUsuarEtapaCobra.Descripcion.label" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(121)).setAttribute("ontab","ejecutarAccionFoco('cobEstadUsuarEtapaCobraFrm',3, true)" );
      ((Element)v.get(121)).setAttribute("onshtab","ejecutarAccionFoco('cobEstadUsuarEtapaCobraFrm', 3, false)" );
      ...
      ((Element)v.get(125)).setAttribute("href","javascript:openLocalizationDialog('cobEstadUsuarEtapaCobraFrm', 'Descripcion', 1);" );
      ((Element)v.get(125)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"cobEstadUsuarEtapaCobraFrm\",3, true)', 'ejecutarAccionFoco(\"cobEstadUsuarEtapaCobraFrm\",3, false)')" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(132)).setAttribute("nombre","formGapTr2" );
   ...
   private void getXML630(Document doc) {
      ...
      /* Empieza nodo:141 / Elemento padre: 38   */
      v.add(doc.createElement("TR"));
      ((Element)v.get(141)).setAttribute("nombre","cobEstadUsuarEtapaCobraTrButtons" );
      ((Element)v.get(38)).appendChild((Element)v.get(141));
      ...
      ((Element)v.get(148)).setAttribute("nombre","cobEstadUsuarEtapaCobraTdQueryButton" );
      ((Element)v.get(147)).appendChild((Element)v.get(148));

      /* Empieza nodo:149 / Elemento padre: 148   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(149)).setAttribute("nombre","cobEstadUsuarEtapaCobraQueryButton" );
      ((Element)v.get(149)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(149)).setAttribute("estado","false" );
      ((Element)v.get(149)).setAttribute("accion","cobEstadUsuarEtapaCobraFirstPage();" );
      ...
      ((Element)v.get(150)).setAttribute("nombre","cobEstadUsuarEtapaCobraTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(152)).setAttribute("nombre","cobEstadUsuarEtapaCobraLovNullButton" );
      ((Element)v.get(152)).setAttribute("ID","botonContenido" );
      ((Element)v.get(152)).setAttribute("tipo","html" );
      ((Element)v.get(152)).setAttribute("accion","cobEstadUsuarEtapaCobraLovNullSelectionAction();" );
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(155)).setAttribute("nombre","cobEstadUsuarEtapaCobraListLayer" );
      ...
      ((Element)v.get(156)).setAttribute("nombre","cobEstadUsuarEtapaCobraList" );
   ...
   private void getXML720(Document doc) {
      ...
      ((Element)v.get(167)).setAttribute("IDScroll","EstCab" );
      ((Element)v.get(167)).setAttribute("imgFondo","" );
      ((Element)v.get(167)).setAttribute("colFondo","#CCCCCC" );
      ...
      ((Element)v.get(168)).setAttribute("cod","CobEstadUsuarEtapaCobra.codEstaUsuaEtapCobr.label" );
      ...
      /* Empieza nodo:172 / Elemento padre: 5   */
      v.add(doc.createElement("CAPA"));
   }

   private void getXML810(Document doc) {
      ((Element)v.get(172)).setAttribute("nombre","cobEstadUsuarEtapaCobraListButtonsLayer" );
      ((Element)v.get(172)).setAttribute("visibilidad","hidden" );
      ((Element)v.get(172)).setAttribute("alto","30" );
      ((Element)v.get(172)).setAttribute("ancho","98%" );
      ((Element)v.get(172)).setAttribute("borde","n" );
      ((Element)v.get(172)).setAttribute("imagenf","" );
      ((Element)v.get(172)).setAttribute("repeat","" );
      ((Element)v.get(172)).setAttribute("padding","0" );
      ((Element)v.get(172)).setAttribute("contravsb","" );
      ((Element)v.get(172)).setAttribute("x","16" );
      ((Element)v.get(172)).setAttribute("y","" );
      ((Element)v.get(172)).setAttribute("zindex","" );
      ((Element)v.get(5)).appendChild((Element)v.get(172));

      /* Empieza nodo:173 / Elemento padre: 172   */
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(173)).setAttribute("nombre","toolbarSeparatorLayer" );
      ((Element)v.get(173)).setAttribute("visibilidad","inherit" );
      ((Element)v.get(173)).setAttribute("alto","23" );
      ((Element)v.get(173)).setAttribute("ancho","1" );
      ...
      ((Element)v.get(173)).setAttribute("x","56" );
      ((Element)v.get(173)).setAttribute("y","0" );
      ((Element)v.get(173)).setAttribute("zindex","" );
      ((Element)v.get(173)).setAttribute("colborde","#999999" );
      ...
      ((Element)v.get(174)).setAttribute("cellspacing","1" );
      ...
      ((Element)v.get(176)).setAttribute("height","22" );
      ((Element)v.get(176)).setAttribute("width","5" );
      ...
      ((Element)v.get(178)).setAttribute("nombre","cobEstadUsuarEtapaCobraPaginationButtonBar" );
      ...
      ((Element)v.get(179)).setAttribute("nombre","cobEstadUsuarEtapaCobraFirstPageButton" );
      ((Element)v.get(179)).setAttribute("funcion","cobEstadUsuarEtapaCobraFirstPage();" );
      ((Element)v.get(179)).setAttribute("off","primera_over0.gif" );
      ((Element)v.get(179)).setAttribute("on","primera_over0.gif" );
      ((Element)v.get(179)).setAttribute("disable","primera_on0.gif" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(180)).setAttribute("nombre","cobEstadUsuarEtapaCobraFirstPageButtonGapTd" );
      ...
      v.add(doc.createElement("BTN"));
      ((Element)v.get(182)).setAttribute("nombre","cobEstadUsuarEtapaCobraPreviousPageButton" );
      ((Element)v.get(182)).setAttribute("funcion","cobEstadUsuarEtapaCobraPreviousPage();" );
      ((Element)v.get(182)).setAttribute("off","retroceder_over0.gif" );
      ((Element)v.get(182)).setAttribute("on","retroceder_over0.gif" );
      ((Element)v.get(182)).setAttribute("disable","retroceder_on0.gif" );
      ((Element)v.get(182)).setAttribute("estado","inactivo" );
      ((Element)v.get(178)).appendChild((Element)v.get(182));
      /* Termina nodo:182   */

      /* Empieza nodo:183 / Elemento padre: 178   */
      v.add(doc.createElement("TD"));
      ((Element)v.get(183)).setAttribute("nombre","cobEstadUsuarEtapaCobraPreviousPageButtonGapTd" );
      ...
      v.add(doc.createElement("BTN"));
      ((Element)v.get(185)).setAttribute("nombre","cobEstadUsuarEtapaCobraNextPageButton" );
      ((Element)v.get(185)).setAttribute("funcion","cobEstadUsuarEtapaCobraNextPage();" );
      ((Element)v.get(185)).setAttribute("off","avanzar_over0.gif" );
      ((Element)v.get(185)).setAttribute("on","avanzar_over0.gif" );
      ((Element)v.get(185)).setAttribute("disable","avanzar_on0.gif" );
   ...
   private void getXML900(Document doc) {
      ...
      ((Element)v.get(187)).setAttribute("height","22" );
      ((Element)v.get(187)).setAttribute("width","19" );
      ...
      ((Element)v.get(188)).setAttribute("nombre","cobEstadUsuarEtapaCobraUpdateButtonTd" );
      ((Element)v.get(174)).appendChild((Element)v.get(188));

      /* Empieza nodo:189 / Elemento padre: 188   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(189)).setAttribute("nombre","cobEstadUsuarEtapaCobraUpdateButton" );
      ((Element)v.get(189)).setAttribute("ID","botonContenido" );
      ((Element)v.get(189)).setAttribute("tipo","html" );
      ((Element)v.get(189)).setAttribute("accion","cobEstadUsuarEtapaCobraUpdateSelection();" );
      ((Element)v.get(189)).setAttribute("estado","false" );
      ((Element)v.get(189)).setAttribute("cod","MMGGlobal.updateButton.label" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(190)).setAttribute("nombre","cobEstadUsuarEtapaCobraUpdateButtonGapTd" );
      ...
      ((Element)v.get(192)).setAttribute("nombre","cobEstadUsuarEtapaCobraViewForRemoveButtonTd" );
      ((Element)v.get(174)).appendChild((Element)v.get(192));

      /* Empieza nodo:193 / Elemento padre: 192   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(193)).setAttribute("nombre","cobEstadUsuarEtapaCobraViewForRemoveButton" );
      ((Element)v.get(193)).setAttribute("ID","botonContenido" );
      ((Element)v.get(193)).setAttribute("tipo","html" );
      ((Element)v.get(193)).setAttribute("accion","cobEstadUsuarEtapaCobraViewSelection();" );
      ((Element)v.get(193)).setAttribute("estado","false" );
      ((Element)v.get(193)).setAttribute("cod","MMGGlobal.viewButton.label" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(194)).setAttribute("nombre","cobEstadUsuarEtapaCobraViewForRemoveButtonGapTd" );
      ...
      ((Element)v.get(196)).setAttribute("nombre","cobEstadUsuarEtapaCobraLovSelectButtonTd" );
      ((Element)v.get(174)).appendChild((Element)v.get(196));

      /* Empieza nodo:197 / Elemento padre: 196   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(197)).setAttribute("nombre","cobEstadUsuarEtapaCobraLovSelectButton" );
      ((Element)v.get(197)).setAttribute("ID","botonContenido" );
      ((Element)v.get(197)).setAttribute("tipo","html" );
      ((Element)v.get(197)).setAttribute("accion","cobEstadUsuarEtapaCobraLovSelectionAction();" );
      ((Element)v.get(197)).setAttribute("estado","true" );
      ((Element)v.get(197)).setAttribute("cod","MMGGlobal.lovSelectButton.label" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(198)).setAttribute("nombre","cobEstadUsuarEtapaCobraLovSelectButtonGapTd" );
      ...
      ((Element)v.get(200)).setAttribute("nombre","cobEstadUsuarEtapaCobraViewButtonTd" );
      ((Element)v.get(174)).appendChild((Element)v.get(200));

      /* Empieza nodo:201 / Elemento padre: 200   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(201)).setAttribute("nombre","cobEstadUsuarEtapaCobraViewButton" );
      ((Element)v.get(201)).setAttribute("ID","botonContenido" );
      ((Element)v.get(201)).setAttribute("tipo","html" );
      ((Element)v.get(201)).setAttribute("accion","cobEstadUsuarEtapaCobraViewSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(202)).setAttribute("nombre","cobEstadUsuarEtapaCobraViewButtonGapTd" );
