...
public class MaeTipoClienPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","MaeTipoClien.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","MaeTipoClien.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('maeTipoClienFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('maeTipoClienFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(50)).setAttribute("nombre","codTipoClieTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lblCodTipoClie" );
      ((Element)v.get(54)).setAttribute("alto","13" );
      ((Element)v.get(54)).setAttribute("filas","1" );
      ((Element)v.get(54)).setAttribute("id","datosTitle" );
      ((Element)v.get(54)).setAttribute("cod","MaeTipoClien.codTipoClie.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(55)).setAttribute("nombre","codTipoClieWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(57)).setAttribute("nombre","codTipoClie" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('maeTipoClienFrm',2, true)" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('maeTipoClienFrm', 2, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(58)).setAttribute("nombre","codTipoClieGapTdId" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(64)).setAttribute("cod","MaeTipoClien.Descripcion.label" );
      ...
      ((Element)v.get(68)).setAttribute("ontab","ejecutarAccionFoco('maeTipoClienFrm',3, true)" );
      ((Element)v.get(68)).setAttribute("onshtab","ejecutarAccionFoco('maeTipoClienFrm', 3, false)" );
      ...
      ((Element)v.get(72)).setAttribute("href","javascript:openLocalizationDialog('maeTipoClienFrm', 'Descripcion', 1);" );
      ((Element)v.get(72)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"maeTipoClienFrm\",3, true)', 'ejecutarAccionFoco(\"maeTipoClienFrm\",3, false)')" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(76)).setAttribute("nombre","indEvalEstaTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(81)).setAttribute("nombre","indEvalEstaWidgetTrId" );
      ...
      ((Element)v.get(83)).setAttribute("nombre","indEvalEsta" );
      ...
      ((Element)v.get(83)).setAttribute("ontab","ejecutarAccionFoco('maeTipoClienFrm',4, true)" );
      ((Element)v.get(83)).setAttribute("onshtab","ejecutarAccionFoco('maeTipoClienFrm',4, false)" );
      ((Element)v.get(82)).appendChild((Element)v.get(83));

      /* Empieza nodo:84 / Elemento padre: 83   */
      v.add(doc.createElement("RBINPUT"));
      ((Element)v.get(84)).setAttribute("id","datosCampos" );
      ((Element)v.get(84)).setAttribute("valor","1" );
      ((Element)v.get(84)).setAttribute("cod","MaeTipoClien.indEvalEsta.1.label" );
      ...
      ((Element)v.get(86)).setAttribute("valor","0" );
      ((Element)v.get(86)).setAttribute("cod","MaeTipoClien.indEvalEsta.0.label" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(88)).setAttribute("nombre","indEvalEstaGapTdId" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(90)).setAttribute("nombre","indEmplTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(95)).setAttribute("nombre","indEmplWidgetTrId" );
   }
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("RADIOB"));
      ((Element)v.get(97)).setAttribute("nombre","indEmpl" );
      ...
      ((Element)v.get(97)).setAttribute("ontab","ejecutarAccionFoco('maeTipoClienFrm',5, true)" );
      ((Element)v.get(97)).setAttribute("onshtab","ejecutarAccionFoco('maeTipoClienFrm',5, false)" );
      ...
      ((Element)v.get(98)).setAttribute("cod","MaeTipoClien.indEmpl.1.label" );
      ...
      ((Element)v.get(100)).setAttribute("cod","MaeTipoClien.indEmpl.0.label" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(102)).setAttribute("nombre","indEmplGapTdId" );
      ...
      /* Empieza nodo:106 / Elemento padre: 44   */
      v.add(doc.createElement("TD"));
      ((Element)v.get(106)).setAttribute("width","100%" );
      ((Element)v.get(44)).appendChild((Element)v.get(106));
      /* Termina nodo:106   */
      /* Termina nodo:44   */
      ...
      /* Empieza nodo:116 / Elemento padre: 0   */
      v.add(doc.createElement("TR"));
      ((Element)v.get(116)).setAttribute("nombre","maeTipoClienTrButtons" );
      ((Element)v.get(0)).appendChild((Element)v.get(116));
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(123)).setAttribute("nombre","maeTipoClienTdQueryButton" );
      ((Element)v.get(122)).appendChild((Element)v.get(123));

      /* Empieza nodo:124 / Elemento padre: 123   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(124)).setAttribute("nombre","maeTipoClienQueryButton" );
      ((Element)v.get(124)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(124)).setAttribute("estado","false" );
      ((Element)v.get(124)).setAttribute("accion","maeTipoClienFirstPage();" );
      ...
      ((Element)v.get(125)).setAttribute("nombre","maeTipoClienTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(127)).setAttribute("nombre","maeTipoClienLovNullButton" );
      ((Element)v.get(127)).setAttribute("ID","botonContenido" );
      ((Element)v.get(127)).setAttribute("tipo","html" );
      ((Element)v.get(127)).setAttribute("accion","maeTipoClienLovNullSelectionAction();" );
