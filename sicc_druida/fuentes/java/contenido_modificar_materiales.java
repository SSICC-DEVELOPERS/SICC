...
public class contenido_modificar_materiales  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("titulo","Consultar Materiales" );
      ((Element)v.get(0)).setAttribute("estilos","estilos.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","Consultar Materiales" );
      ...
      ((Element)v.get(11)).setAttribute("valor","LPConsultarMateriales" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(59)).setAttribute("witdh","8" );
      ...
      ((Element)v.get(64)).setAttribute("witdh","8" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(71)).setAttribute("cod","2467" );
