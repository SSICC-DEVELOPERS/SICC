...
public class COMComisionGerentesZona extends LPSICCBase {           
   public COMComisionGerentesZona() {	 
     super();
  }
     ...
     try {
        ...
        if (accion.equals("generar")){
          ...
          //cargarPagina();
           ...
           cargarPagina();
           getConfiguracionMenu("COMComisionGerentesZona");
        }
  ...
  private void cargarPagina() throws Exception{
     pagina("contenido_informe_comision_gerentes_generar");   
     ...
     */
     ...
     MareBusinessID id = new MareBusinessID("COMObtenerTodasComisiones");
     ...
     asignar("COMBO", "cbComision", mcs, "DTOSalida.mc_ROWSET");  
 ...
 private void generarReporte() throws Exception{
     ...
     String tramoInicial        = conectorParametroLimpia("tramoInicial", "", true);
     datos.put(ConstantesREP.TRAMOINICIAL, tramoInicial);
     
     String tramoFinal        = conectorParametroLimpia("tramoFinal", "", true);
     datos.put(ConstantesREP.TRAMOFINAL, tramoFinal);
     ...
     datos.put(ConstantesREP.TITULO, "Comisiones Gerentes de Zona");     
...
//     ejecutarReporte(datos, "REPGenerarReporte", "RD_REP-150", formato);
          ejecutarReporte2(datos, "REPGenerarReporteBatch", "RD_REP-150", formato);
