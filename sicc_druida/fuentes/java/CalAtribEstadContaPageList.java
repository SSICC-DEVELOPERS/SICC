...
public class CalAtribEstadContaPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","calAtribEstadContaList" );
      ...
      ((Element)v.get(14)).setAttribute("cod","CalAtribEstadConta.tecoOidTipoEstaCont.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","CalAtribEstadConta.codAtri.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","CalAtribEstadConta.Descripcion.label" );
