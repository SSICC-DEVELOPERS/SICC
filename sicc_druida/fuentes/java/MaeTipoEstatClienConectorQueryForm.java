...
public class MaeTipoEstatClienConectorQueryForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad MaeTipoEstatClien" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGMaeTipoEstatClienQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGMaeTipoEstatClienQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","MaeTipoEstatClienFormFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","codTipoEsta" );
