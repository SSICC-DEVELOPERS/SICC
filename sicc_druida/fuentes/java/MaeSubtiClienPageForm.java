...
public class MaeSubtiClienPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","MaeSubtiClien.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","MaeSubtiClien.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('maeSubtiClienFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('maeSubtiClienFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('maeSubtiClienFrm',2, true);" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('maeSubtiClienFrm',2, false);" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(65)).setAttribute("cod","MaeSubtiClien.codSubtClie.label" );
      ...
      ((Element)v.get(68)).setAttribute("ontab","ejecutarAccionFoco('maeSubtiClienFrm',3, true)" );
      ((Element)v.get(68)).setAttribute("onshtab","ejecutarAccionFoco('maeSubtiClienFrm', 3, false)" );
      ...
      ((Element)v.get(75)).setAttribute("cod","MaeSubtiClien.Descripcion.label" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(79)).setAttribute("ontab","ejecutarAccionFoco('maeSubtiClienFrm',4, true)" );
      ((Element)v.get(79)).setAttribute("onshtab","ejecutarAccionFoco('maeSubtiClienFrm', 4, false)" );
      ...
      ((Element)v.get(83)).setAttribute("href","javascript:openLocalizationDialog('maeSubtiClienFrm', 'Descripcion', 1);" );
      ((Element)v.get(83)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"maeSubtiClienFrm\",4, true)', 'ejecutarAccionFoco(\"maeSubtiClienFrm\",4, false)')" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(99)).setAttribute("nombre","maeSubtiClienTrButtons" );
      ...
      ((Element)v.get(106)).setAttribute("nombre","maeSubtiClienTdQueryButton" );
      ((Element)v.get(105)).appendChild((Element)v.get(106));

      /* Empieza nodo:107 / Elemento padre: 106   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(107)).setAttribute("nombre","maeSubtiClienQueryButton" );
      ((Element)v.get(107)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(107)).setAttribute("estado","false" );
      ((Element)v.get(107)).setAttribute("accion","maeSubtiClienFirstPage();" );
      ...
      ((Element)v.get(108)).setAttribute("nombre","maeSubtiClienTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(110)).setAttribute("nombre","maeSubtiClienLovNullButton" );
      ((Element)v.get(110)).setAttribute("ID","botonContenido" );
      ((Element)v.get(110)).setAttribute("tipo","html" );
      ((Element)v.get(110)).setAttribute("accion","maeSubtiClienLovNullSelectionAction();" );
