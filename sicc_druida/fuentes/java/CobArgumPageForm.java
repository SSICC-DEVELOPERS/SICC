...
public class CobArgumPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","CobArgum.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","CobArgum.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('cobArgumFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('cobArgumFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(50)).setAttribute("nombre","codArguTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lblCodArgu" );
      ((Element)v.get(54)).setAttribute("alto","13" );
      ((Element)v.get(54)).setAttribute("filas","1" );
      ((Element)v.get(54)).setAttribute("id","datosTitle" );
      ((Element)v.get(54)).setAttribute("cod","CobArgum.codArgu.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(55)).setAttribute("nombre","codArguWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(57)).setAttribute("nombre","codArgu" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('cobArgumFrm',2, true)" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('cobArgumFrm', 2, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(58)).setAttribute("nombre","codArguGapTdId" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(79)).setAttribute("cod","CobArgum.valDesc.label" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(82)).setAttribute("ontab","ejecutarAccionFoco('cobArgumFrm',3, true)" );
      ((Element)v.get(82)).setAttribute("onshtab","ejecutarAccionFoco('cobArgumFrm', 3, false)" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(104)).setAttribute("cod","CobArgum.valObse.label" );
      ...
      ((Element)v.get(107)).setAttribute("ontab","ejecutarAccionFoco('cobArgumFrm',4, true)" );
      ((Element)v.get(107)).setAttribute("onshtab","ejecutarAccionFoco('cobArgumFrm', 4, false)" );
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(125)).setAttribute("nombre","paisOidPaisTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(129)).setAttribute("nombre","lblpaisOidPais" );
      ...
      ((Element)v.get(129)).setAttribute("cod","CobArgum.paisOidPais.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(130)).setAttribute("nombre","paisOidPaisWidgetTrId" );
      ...
      ((Element)v.get(132)).setAttribute("nombre","paisOidPais" );
      ...
      ((Element)v.get(132)).setAttribute("ontab","ejecutarAccionFoco('cobArgumFrm',5, true);" );
      ((Element)v.get(132)).setAttribute("onshtab","ejecutarAccionFoco('cobArgumFrm',5, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(134)).setAttribute("nombre","paisOidPaisGapTdId" );
   ...
   private void getXML630(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(148)).setAttribute("nombre","cobArgumTrButtons" );
      ...
      ((Element)v.get(155)).setAttribute("nombre","cobArgumTdQueryButton" );
      ((Element)v.get(154)).appendChild((Element)v.get(155));

      /* Empieza nodo:156 / Elemento padre: 155   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(156)).setAttribute("nombre","cobArgumQueryButton" );
      ((Element)v.get(156)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(156)).setAttribute("estado","false" );
      ((Element)v.get(156)).setAttribute("accion","cobArgumFirstPage();" );
      ...
      ((Element)v.get(157)).setAttribute("nombre","cobArgumTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(159)).setAttribute("nombre","cobArgumLovNullButton" );
      ((Element)v.get(159)).setAttribute("ID","botonContenido" );
      ((Element)v.get(159)).setAttribute("tipo","html" );
      ((Element)v.get(159)).setAttribute("accion","cobArgumLovNullSelectionAction();" );
