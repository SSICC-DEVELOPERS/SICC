...
public class contenido_linea_credito_nivel_riesgo_individual_revaluar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_linea_credito_nivel_riesgo_individual_revaluar" );
      ((Element)v.get(0)).setAttribute("cod","0295" );
      ...
      v.add(doc.createTextNode("\r   \r  \r     function onLoadPag()   \r      {\r          var hayErrores = chequeaErrores();\r          \r            \r            configurarMenuSecundario(\"frmFormulario\");\r            desactivarCombos();\r            del_combo('frmFormulario.cmbTipoReevaluacion',0);\r            focaliza('frmFormulario.txtCodigoCliente');\r          \r          \r      }\r             function accionBuscarCliente() {\r          focaliza(\"frmFormulario.txtCodigoCliente\");\r          var obj = new Object();\r              var whnd = mostrarModalSICC('LPBusquedaRapidaCliente','',obj);\r              if(whnd==null){\r\r              }else{\r                  var oid;\r                  var oid = whnd[0];\r                  var cod = whnd[1];\r                  var nombre1 = whnd[2];\r                  var nombre2 = whnd[3];\r                  var apellido1 = whnd[4];\r                  var apellido2 = whnd[5];\r                  set(\"frmFormulario.txtCodigoCliente\", cod);\r                  llenaComboMarcaCanal();\r              }  \r        }\r            \r    function llenaComboMarcaCanal(){\r        var arr = new Array();\r        arr[arr.length] = new Array(\"oidPais\", get('frmFormulario.hPais'));\r        arr[arr.length] = new Array(\"oidIdioma\", get('frmFormulario.hIdioma'));\r        arr[arr.length] = new Array(\"codigoCliente\", get('frmFormulario.txtCodigoCliente'));\r        recargaCombo('frmFormulario.cbMarca','MAEMarcasClienteUnidadAdministrativa','es.indra.sicc.dtos.mae.DTOCodigoCliente',arr);\r        activarCombos(\"cbMarca\");\r        recargaCombo('frmFormulario.cbCanal','MAECanalesClienteUnidadAdministrativa','es.indra.sicc.dtos.mae.DTOCodigoCliente',arr);\r        activarCombos(\"cbCanal\");\r        focaliza('frmFormulario.cbMarca');\r    }\r        \r                \r        function onClickReevaluar (){\r          if(sicc_validaciones_generales()){\r            guardarSeleccionados();\r            set('frmFormulario.accion','Reevaluar');\r            eval('frmFormulario').oculto = 'S';\r            set('frmFormulario.conectorAction', 'LPCreditoRiesgoIndividual');\r            enviaSICC('frmFormulario'); \r          }\r        }\r                \r        function guardarSeleccionados(){\r           var cmb = document.getElementById(\"cmbTipoReevaluacion\");\r           var option = cmb.options;\r           var oid = new Array(2);\r           for(var i = 0; i < option.length;i++){\r              if(option.item(i).selected == true){\r                    oid[i] = option(i).value;   \r              }\r           }\r           set('frmFormulario.hvalOids',oid);\r           \r        }\r        \r                \r         function TabUp(){\r                    var obj=document.getElementsByName(\"txtCodigoCliente\");\r          obj.item(0).focus();\r         }\r        \r    function TabShift(){\r        var obj=document.getElementsByName(\"btnReevaluar\");\r        obj.item(0).focus();\r    }\r        \r        \r    function mensajeLP(cod){\r        GestionarMensaje(cod, get('frmFormulario.txtCodigoCliente') , null, null); \r        focaliza('frmFormulario.txtCodigoCliente');\r    }\r        \r        function desactivarCombos(){\r        var obj = document.all.tags(\"SELECT\");\r        for(var i = 0; i<obj.length;i++){\r            if(obj.item(i).name==\"cbMarca\"){ \r                obj.item(i).disabled=true;\r            }\r            if(obj.item(i).name==\"cbCanal\"){ \r                obj.item(i).disabled=true;\r            }\r        }\r    }\r    \r        function activarCombos(combo){\r        var cboEnabled = document.getElementById(combo);\r        cboEnabled.disabled=false; \r    } \r  \r    function limpiarCombos(){\r     \r      var cmb1 = document.getElementById(\"cbMarca\");\r			var cmb = document.getElementById(\"cbCanal\");\r      var opt1 = cmb1.options;\r      var opt = cmb.options;\r        \r         for(var i=0;i < opt1.length;i++){\r					cmb1.all.item(i).text=\"\";\r				}\r        \r        for(var i=0;i < opt.length;i++){\r					cmb.all.item(i).text=\"\";\r				}\r      		\r  }\r    function fLimpiar(){\r    \r    accion('frmFormulario.cbMarca', '.disabled=true');\r        set_combo('frmFormulario.cbMarca', ['','']);\r        \r    accion('frmFormulario.cbCanal', '.disabled=true');\r        set_combo('frmFormulario.cbCanal', ['','']);\r        \r     focaliza('frmFormulario.txtCodigoCliente');   \r\r  }\r  \r    \r  function  chequeaErrores()\r	{\r		var errCod = get(\"frmFormulario.errCodigo\");\r\r		if (errCod != null)\r		{\r				fMostrarMensajeError();\r				return true;\r		}\r   \r		return false;\r\r	}\r  function foc(){\r    \r    focaliza('frmFormulario.txtCodigoCliente');\r  }\r  \r \r    function validarLongCodClienteYCargaCombos() {\r        var elemento = 'frmFormulario.txtCodigoCliente';\r        var longiCod = get('frmFormulario.longCodClienteDefault');\r        var codCliente = get(elemento);\r        if((codCliente.length>0) && (codCliente.length<=longiCod)){\r            var faltantes = longiCod*1 -  codCliente.length;\r            if(faltantes > 0){\r                                var resultCod = new String(\"\");\r                for(var t = 0 ; t<faltantes; t++){\r                    resultCod = resultCod + \"0\";\r                }\r                resultCod = resultCod + codCliente;\r                set(elemento, resultCod);\r            }\r            \r                        llenaComboMarcaCanal();\r            \r        }else{\r            accion('frmFormulario.cbMarca', '.disabled=true');\r            set_combo('frmFormulario.cbMarca', ['','']);\r            accion('frmFormulario.cbCanal', '.disabled=true');\r            set_combo('frmFormulario.cbCanal', ['','']);\r            focaliza('frmFormulario.cbClaseSolicitud');\r        }\r    }\r         \r\r  \r  "));
      ...
      ((Element)v.get(6)).setAttribute("name","txtCodigoCliente" );
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(10)).setAttribute("name","cmbTipoReevaluacion" );
      ((Element)v.get(10)).setAttribute("required","true" );
      ((Element)v.get(10)).setAttribute("cod","1003" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(18)).setAttribute("nombre","hvalOids" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(19)).setAttribute("nombre","hConstMsg" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(20)).setAttribute("nombre","ejecutar" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(21)).setAttribute("nombre","ejecutarError" );
   ...
   private void getXML90(Document doc) {
      v.add(doc.createElement("VAR"));
      ((Element)v.get(22)).setAttribute("nombre","tabCodClie" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(23)).setAttribute("nombre","longCodClienteDefault" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(48)).setAttribute("nombre","lblCodigoCliente" );
      ...
      ((Element)v.get(63)).setAttribute("nombre","txtCodigoCliente" );
      ...
      ((Element)v.get(63)).setAttribute("size","15" );
      ((Element)v.get(63)).setAttribute("valor","" );
      ((Element)v.get(63)).setAttribute("validacion","" );
      ((Element)v.get(63)).setAttribute("onshtab","TabShift();" );
      ((Element)v.get(63)).setAttribute("onblur","validarLongCodClienteYCargaCombos();" );
   ...
   private void getXML270(Document doc) {
      ((Element)v.get(67)).setAttribute("onclick","accionBuscarCliente();" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(76)).setAttribute("nombre","cbCanal" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(88)).setAttribute("nombre","lblClaseSolicitud" );
      ...
      ((Element)v.get(88)).setAttribute("cod","814" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(92)).setAttribute("nombre","lblTipoReevaluacion" );
      ...
      ((Element)v.get(92)).setAttribute("cod","1003" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(99)).setAttribute("nombre","cbClaseSolicitud" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(104)).setAttribute("nombre","cmbTipoReevaluacion" );
      ...
      ((Element)v.get(110)).setAttribute("height","7" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(121)).setAttribute("nombre","btnReevaluar" );
      ((Element)v.get(121)).setAttribute("ID","botonContenido" );
      ((Element)v.get(121)).setAttribute("tipo","html" );
      ((Element)v.get(121)).setAttribute("accion","onClickReevaluar();" );
      ((Element)v.get(121)).setAttribute("estado","false" );
      ((Element)v.get(121)).setAttribute("cod","980" );
      ((Element)v.get(121)).setAttribute("ontab","TabUp();" );
