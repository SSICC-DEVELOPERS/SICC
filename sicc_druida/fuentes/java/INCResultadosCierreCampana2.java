...
/*
 * LP del CU: Generar Informe Resultado al Cierre de Campaña
 */
public class INCResultadosCierreCampana2 extends LPSICCBase {           
    public INCResultadosCierreCampana2() {	 
        super();
    }
     ...
     try {
        ...
        if (accion.equals("generar")){
          ...
          //cargarPagina();
           ...
           cargarPagina();
           getConfiguracionMenu("INCResultadosCierreCampana2");
        }
  ...
  private DruidaConector generarConector(String rowsetID, RecordSet datos,
    ...
    private void cargarPagina() throws Exception{
        pagina("contenido_informe_resultados_campana_generar");

        asignarAtributoPagina("cod", "0873");
        asignarAtributo("VAR", "lp", "valor", "INCResultadosCierreCampana2");
        ...
        // Carga lista oculta Territorios 
    ...
    private void generarReporte() throws Exception{
         ...
         String numeroPuestos       = conectorParametroLimpia("numeroPuestos", "", true);
         if(!numeroPuestos.equals("")){
            datos.put(ConstantesREP.NUMEROPUESTOS, numeroPuestos);
         }
         ...
         if(!tipoClasificacion.equals("")){
            datos.put(ConstantesREP.TIPOCLASIFICACION, tipoClasificacion);
         }
        
         String clasificacion  = conectorParametroLimpia("clasificacion", "", true);
         if(!clasificacion.equals("")){
            datos.put(ConstantesREP.CLASIFICACION, clasificacion);
         }
         ...
         datos.put(ConstantesREP.TITULO, "Resultados al cierre de Campaña");
