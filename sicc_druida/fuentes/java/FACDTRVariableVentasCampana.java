...
public class FACDTRVariableVentasCampana extends LPSICCBase {           
   public FACDTRVariableVentasCampana() {	 
     super();
  }
 ...
 String accion = conectorParametroLimpia("accion","", true);
     ...
     try {
        ...
        if (accion.equals("generar")){
          ...
          //cargarPagina();
                 ...
                 cargarPagina();
                 getConfiguracionMenu("FACDTRVariableVentasCampana");
        }
     } catch (Exception ex) {
  ...
  private void cargarPagina() throws Exception{
     ...
     asignarAtributoPagina("cod","0809");     
     ...
     asignarAtributo("VAR", "lp", "valor", "FACDTRVariableVentasCampana");
 ...
 private void generarReporte() throws Exception{
     ...
     datos.put(ConstantesREP.TITULO, "Resultado Variables de Venta de Campaña XXXX / XX");     
     traza("++++++Antes de enviar a reportes " + datos); 
     
     String formato = conectorParametroLimpia("formato", "", true);
     
       
     //ejecutarReporte(datos, "REPGenerarReporte", "RFD-004", formato);
     ejecutarReporte2(datos, "REPGenerarReporteBatch", "RD_RFD-004", formato);
