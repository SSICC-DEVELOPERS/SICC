...
public class CarEstatPedidPage  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","CarEstatPedidPage" );
      ((Element)v.get(0)).setAttribute("titulo","" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","" );
      ((Element)v.get(0)).setAttribute("onload","carEstatPedidInitComponents()" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","carestatpedid.js" );
      ((Element)v.get(0)).appendChild((Element)v.get(4));
      /* Termina nodo:4   */

      /* Empieza nodo:5 / Elemento padre: 0   */
      v.add(doc.createElement("FORMULARIO"));
      ((Element)v.get(5)).setAttribute("nombre","carEstatPedidFrm" );
      ...
      ((Element)v.get(6)).setAttribute("valor","CarEstatPedidLPExecution" );
      ...
      ((Element)v.get(7)).setAttribute("valor","CarEstatPedidLPExecution" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(37)).setAttribute("nombre","carEstatPedidFormLayer" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(52)).setAttribute("cod","CarEstatPedid.legend.label" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(67)).setAttribute("cod","CarEstatPedid.id.label" );
      ...
      ((Element)v.get(70)).setAttribute("ontab","ejecutarAccionFoco('carEstatPedidFrm',1, true)" );
      ((Element)v.get(70)).setAttribute("onshtab","ejecutarAccionFoco('carEstatPedidFrm', 1, false)" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(92)).setAttribute("cod","CarEstatPedid.codEsta.label" );
      ...
      ((Element)v.get(95)).setAttribute("ontab","ejecutarAccionFoco('carEstatPedidFrm',2, true)" );
      ((Element)v.get(95)).setAttribute("onshtab","ejecutarAccionFoco('carEstatPedidFrm', 2, false)" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(102)).setAttribute("cod","CarEstatPedid.Descripcion.label" );
      ...
      ((Element)v.get(106)).setAttribute("ontab","ejecutarAccionFoco('carEstatPedidFrm',3, true)" );
      ((Element)v.get(106)).setAttribute("onshtab","ejecutarAccionFoco('carEstatPedidFrm', 3, false)" );
      ...
      ((Element)v.get(110)).setAttribute("href","javascript:openLocalizationDialog('carEstatPedidFrm', 'Descripcion', 1);" );
      ((Element)v.get(110)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"carEstatPedidFrm\",3, true)', 'ejecutarAccionFoco(\"carEstatPedidFrm\",3, false)')" );
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(126)).setAttribute("nombre","carEstatPedidTrButtons" );
      ...
      ((Element)v.get(133)).setAttribute("nombre","carEstatPedidTdQueryButton" );
      ((Element)v.get(132)).appendChild((Element)v.get(133));

      /* Empieza nodo:134 / Elemento padre: 133   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(134)).setAttribute("nombre","carEstatPedidQueryButton" );
      ((Element)v.get(134)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(134)).setAttribute("estado","false" );
      ((Element)v.get(134)).setAttribute("accion","carEstatPedidFirstPage();" );
      ...
      ((Element)v.get(135)).setAttribute("nombre","carEstatPedidTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(137)).setAttribute("nombre","carEstatPedidLovNullButton" );
      ((Element)v.get(137)).setAttribute("ID","botonContenido" );
      ((Element)v.get(137)).setAttribute("tipo","html" );
      ((Element)v.get(137)).setAttribute("accion","carEstatPedidLovNullSelectionAction();" );
   ...
   private void getXML630(Document doc) {
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(140)).setAttribute("nombre","carEstatPedidListLayer" );
      ...
      ((Element)v.get(141)).setAttribute("nombre","carEstatPedidList" );
   ...
   private void getXML720(Document doc) {
      ...
      ((Element)v.get(154)).setAttribute("cod","CarEstatPedid.codEsta.label" );
      ...
      ((Element)v.get(155)).setAttribute("cod","CarEstatPedid.Descripcion.label" );
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(160)).setAttribute("nombre","carEstatPedidListButtonsLayer" );
      ...
      ((Element)v.get(166)).setAttribute("nombre","carEstatPedidPaginationButtonBar" );
   }
   ...
   private void getXML810(Document doc) {
      ...
      ((Element)v.get(167)).setAttribute("nombre","carEstatPedidFirstPageButton" );
      ((Element)v.get(167)).setAttribute("funcion","carEstatPedidFirstPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(168)).setAttribute("nombre","carEstatPedidFirstPageButtonGapTd" );
      ...
      v.add(doc.createElement("BTN"));
      ((Element)v.get(170)).setAttribute("nombre","carEstatPedidPreviousPageButton" );
      ((Element)v.get(170)).setAttribute("funcion","carEstatPedidPreviousPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(171)).setAttribute("nombre","carEstatPedidPreviousPageButtonGapTd" );
      ...
      v.add(doc.createElement("BTN"));
      ((Element)v.get(173)).setAttribute("nombre","carEstatPedidNextPageButton" );
      ((Element)v.get(173)).setAttribute("funcion","carEstatPedidNextPage();" );
      ...
      ((Element)v.get(176)).setAttribute("nombre","carEstatPedidUpdateButtonTd" );
      ((Element)v.get(162)).appendChild((Element)v.get(176));

      /* Empieza nodo:177 / Elemento padre: 176   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(177)).setAttribute("nombre","carEstatPedidUpdateButton" );
      ((Element)v.get(177)).setAttribute("ID","botonContenido" );
      ((Element)v.get(177)).setAttribute("tipo","html" );
      ((Element)v.get(177)).setAttribute("accion","carEstatPedidUpdateSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(178)).setAttribute("nombre","carEstatPedidUpdateButtonGapTd" );
      ...
      ((Element)v.get(180)).setAttribute("nombre","carEstatPedidViewForRemoveButtonTd" );
      ((Element)v.get(162)).appendChild((Element)v.get(180));

      /* Empieza nodo:181 / Elemento padre: 180   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(181)).setAttribute("nombre","carEstatPedidViewForRemoveButton" );
      ((Element)v.get(181)).setAttribute("ID","botonContenido" );
      ((Element)v.get(181)).setAttribute("tipo","html" );
      ((Element)v.get(181)).setAttribute("accion","carEstatPedidViewSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(182)).setAttribute("nombre","carEstatPedidViewForRemoveButtonGapTd" );
   ...
   private void getXML900(Document doc) {
      ...
      ((Element)v.get(184)).setAttribute("nombre","carEstatPedidLovSelectButtonTd" );
      ((Element)v.get(162)).appendChild((Element)v.get(184));

      /* Empieza nodo:185 / Elemento padre: 184   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(185)).setAttribute("nombre","carEstatPedidLovSelectButton" );
      ((Element)v.get(185)).setAttribute("ID","botonContenido" );
      ((Element)v.get(185)).setAttribute("tipo","html" );
      ((Element)v.get(185)).setAttribute("accion","carEstatPedidLovSelectionAction();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(186)).setAttribute("nombre","carEstatPedidLovSelectButtonGapTd" );
      ...
      ((Element)v.get(188)).setAttribute("nombre","carEstatPedidViewButtonTd" );
      ((Element)v.get(162)).appendChild((Element)v.get(188));

      /* Empieza nodo:189 / Elemento padre: 188   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(189)).setAttribute("nombre","carEstatPedidViewButton" );
      ((Element)v.get(189)).setAttribute("ID","botonContenido" );
      ((Element)v.get(189)).setAttribute("tipo","html" );
      ((Element)v.get(189)).setAttribute("accion","carEstatPedidViewSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(190)).setAttribute("nombre","carEstatPedidViewButtonGapTd" );
