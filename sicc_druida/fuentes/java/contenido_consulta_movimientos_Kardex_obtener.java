...
public class contenido_consulta_movimientos_Kardex_obtener  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_consulta_movimientos_Kardex_obtener" );
      ((Element)v.get(0)).setAttribute("cod","0745" );
      ((Element)v.get(0)).setAttribute("titulo","Obtener consulta de movimientos de Kardex" );
      ...
      v.add(doc.createTextNode("\r   \r   \r   function onLoad(){\r      configurarMenuSecundario('Formulario');\r      fMostrarMensajeError();\r      focaliza('Formulario.cbAlmacen');\r   }\r     function quitarItemVacio(elemento){\r      var elementoADevolver = new Array();\r     \r      for(var k=0;k<elemento.length;k++) {\r          if (elemento[k] != ''){                            \r             elementoADevolver[elementoADevolver.length] = elemento[k];\r          }\r      }\r         \r      return elementoADevolver;\r      \r   }\r   function generar(formato){\r      if(sicc_validaciones_generales()){\r         if(validarFechas()){\r            /*recolectarParametros();\r            set('Formulario.conectorAction', 'BELMovimientosKardex');           \r            set('Formulario.accion', 'generar');*/\r            var a = new Object();\r            a.accion = 'generar';\r            a.almacen = quitarItemVacio(get('Formulario.cbAlmacen'));  \r            a.estadoMercancia = get('Formulario.cbEstadoMercaderia');\r            a.codigoProducto = get('Formulario.txtCodigoProducto');\r            a.fechaDesde = get('Formulario.txtFechaDesde');\r            a.fechaHasta = get('Formulario.txtFechaHasta');       \r            \r            \r            if(formato == 'xls'){\r               a.formatoSalida = formato;\r            }\r                        mostrarModalSICC('BELMovimientosKardex','generar', a); \r          }\r       }\r   }\r\r   function recolectarParametros(){\r               \r    set('Formulario.almacen', get('Formulario.cbAlmacen') );  \r    set('Formulario.estadoMercancia', get('Formulario.cbEstadoMercaderia'));\r    set('Formulario.codigoProducto', get('Formulario.txtCodigoProducto'));\r    set('Formulario.fechaDesde', get('Formulario.txtFechaDesde'));\r    set('Formulario.fechaHasta', get('Formulario.txtFechaHasta'));\r        \r       \r   }\r \r   \r\r   function fLimpiar(){\r     focaliza('Formulario.cbAlmacen');\r \r   }\r   \r\r  function validarFechas(){\r      var fechaInicio = get('Formulario.txtFechaDesde');\r      var fechaFin = get('Formulario.txtFechaHasta');\r      var formatoFecha = get('Formulario.hFormatoFechaPais');\r           \r     \r      if (! EsFechaValida_SICC(fechaInicio , \"Formulario\")){\r         GestionarMensaje(\"1006\", formatoFecha, null, null);\r         focaliza(\"Formulario.txtFechaDesde\");\r         return false;\r      }\r     \r      if(! EsFechaValida_SICC(fechaFin , \"Formulario\")){\r         GestionarMensaje(\"1006\", formatoFecha, null, null);\r         focaliza(\"Formulario.txtFechaHasta\");\r         return false;\r      }\r               \r      var errorLevel = EsFechaValida( fechaInicio, fechaFin, \"Formulario\", \"S\");\r      if ( errorLevel == 3){\r         GestionarMensaje(\"1191\");\r         focaliza('Formulario.txtFechaDesde');\r         return false;\r      }\r     \r      return true;   \r   \r   }\r   \r   \r\r\r\r  \r   "));
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(7)).setAttribute("name","cbEstadoMercaderia" );
      ((Element)v.get(7)).setAttribute("required","true" );
      ((Element)v.get(7)).setAttribute("cod","2525" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(20)).setAttribute("nombre","estadoMercancia" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(21)).setAttribute("nombre","codigoProducto" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(23)).setAttribute("nombre","fechaHasta" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(24)).setAttribute("nombre","formatoSalida" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(52)).setAttribute("nombre","lblAlmacen" );
      ((Element)v.get(52)).setAttribute("alto","13" );
      ((Element)v.get(52)).setAttribute("filas","1" );
      ((Element)v.get(52)).setAttribute("id","datosTitle" );
      ((Element)v.get(52)).setAttribute("cod","797" );
      ...
      ((Element)v.get(59)).setAttribute("nombre","cbAlmacen" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(77)).setAttribute("nombre","lblCodigoProducto" );
      ...
      ((Element)v.get(77)).setAttribute("cod","337" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(84)).setAttribute("nombre","cbEstadoMercaderia" );
   ...
   private void getXML360(Document doc) {
      ...
      /* Empieza nodo:95 / Elemento padre: 41   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(41)).appendChild((Element)v.get(95));
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(102)).setAttribute("nombre","lblFechaDesde" );
      ...
      ((Element)v.get(102)).setAttribute("cod","59" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(106)).setAttribute("nombre","lblFechaHasta" );
      ...
      ((Element)v.get(106)).setAttribute("cod","1339" );
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(113)).setAttribute("nombre","txtFechaDesde" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(117)).setAttribute("nombre","txtFechaHasta" );
      ...
      /* Empieza nodo:123 / Elemento padre: 34   */
      v.add(doc.createElement("td"));
      ((Element)v.get(34)).appendChild((Element)v.get(123));
      ...
      /* Empieza nodo:125 / Elemento padre: 26   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(26)).appendChild((Element)v.get(125));
      ...
      ((Element)v.get(133)).setAttribute("nombre","btnGenerarInforme" );
      ((Element)v.get(133)).setAttribute("ID","botonContenido" );
      ((Element)v.get(133)).setAttribute("tipo","html" );
      ((Element)v.get(133)).setAttribute("accion","generar();" );
      ((Element)v.get(133)).setAttribute("estado","false" );
      ((Element)v.get(133)).setAttribute("cod","2495" );
      ((Element)v.get(132)).appendChild((Element)v.get(133));
      /* Termina nodo:133   */

      /* Empieza nodo:134 / Elemento padre: 132   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(134)).setAttribute("nombre","btnGenerarExcel" );
      ((Element)v.get(134)).setAttribute("ID","botonContenido" );
      ((Element)v.get(134)).setAttribute("tipo","html" );
      ((Element)v.get(134)).setAttribute("accion","generar('xls')" );
      ((Element)v.get(134)).setAttribute("estado","false" );
      ((Element)v.get(134)).setAttribute("cod","2526" );
      ((Element)v.get(134)).setAttribute("ontab","focaliza('Formulario.cbAlmacen');" );
