...
public class plantilla_cursos_copiar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","plantilla_cursos_copiar" );
      ...
      ((Element)v.get(1)).setAttribute("src","plantilla_cursos_copiar.js" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(7)).setAttribute("nombre","oidsSeleccionados" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(40)).setAttribute("max","3000" );
      ((Element)v.get(40)).setAttribute("tipo","" );
      ((Element)v.get(40)).setAttribute("onblur","accionAceptar();" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(79)).setAttribute("tipoEnvio","seleccion" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(83)).setAttribute("conector","TaponConectorObtienePlantilla" );
      ...
      ((Element)v.get(86)).setAttribute("accion","copiar();" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(87)).setAttribute("nombre","prim1" );
