...
public class LPComparativoVentasEstimadoVsReal extends LPSICCBase {           
   public LPComparativoVentasEstimadoVsReal() {	 
     super();
  }
     ...
     this.rastreo();
        if (accion.equals("generar")){
           generarReporte();         
			     ...
			     cargarPantalla();
           getConfiguracionMenu("LPComparativoVentasEstimadoVsReal");
  ...
  private void cargarPantalla() throws Exception{
     ...
     pagina("contenido_actividad_tipo_cliente_periodo_obtener"); 
     asignarAtributoPagina("cod", "0741");
     asignarAtributo("VAR", "casoDeUso", "valor", "LPComparativoVentasEstimadoVsReal");
  ...
  private void generarReporte() throws Exception{
       ...
       datos.put(ConstantesREP.TITULO, "COmparativo de Ventas estimado versus real");
        
        traza("los datos son " + datos);
       //ejecutarReporte(datos, "REPGenerarReporte", "RD_REP-039", null);
       ejecutarReporte2(datos, "REPGenerarReporteBatch", "RD_REP-039", "pdf");
  }
