...
public class ZonEstruGeopoConectorQueryList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad ZonEstruGeopo" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGZonEstruGeopoQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGZonEstruGeopoQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","ZonEstruGeopoListFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","codOrde" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(10)).setAttribute("NOMBRE","dipoOidDiviPoli" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(11)).setAttribute("NOMBRE","fecActu" );
