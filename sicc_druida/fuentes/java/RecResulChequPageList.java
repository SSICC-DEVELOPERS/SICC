...
public class RecResulChequPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","recResulChequList" );
      ...
      ((Element)v.get(14)).setAttribute("cod","RecResulChequ.codResuCheq.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","RecResulChequ.Descripcion.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","RecResulChequ.indResu.label" );
