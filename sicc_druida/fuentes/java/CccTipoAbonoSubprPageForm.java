...
public class CccTipoAbonoSubprPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","CccTipoAbonoSubpr.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","CccTipoAbonoSubpr.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('cccTipoAbonoSubprFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('cccTipoAbonoSubprFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(57)).setAttribute("onchange","mmgDependeneChange('subpOidSubp_ccprOidProc', 'subpOidSubp' , 'cccTipoAbonoSubpr')" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","focaliza('cccTipoAbonoSubprFrm.subpOidSubp');" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('cccTipoAbonoSubprFrm',3, false);" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(65)).setAttribute("cod","CccTipoAbonoSubpr.subpOidSubp.label" );
      ...
      ((Element)v.get(68)).setAttribute("ontab","ejecutarAccionFoco('cccTipoAbonoSubprFrm',3, true);" );
      ((Element)v.get(68)).setAttribute("onshtab","focaliza('cccTipoAbonoSubprFrm.subpOidSubp_ccprOidProc');" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(87)).setAttribute("nombre","tcabOidTcabTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(91)).setAttribute("nombre","lbltcabOidTcab" );
      ((Element)v.get(91)).setAttribute("id","datosTitle" );
      ((Element)v.get(91)).setAttribute("ancho","150" );
      ((Element)v.get(91)).setAttribute("alto","13" );
      ((Element)v.get(91)).setAttribute("cod","CccTipoAbonoSubpr.tcabOidTcab.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(92)).setAttribute("nombre","tcabOidTcabWidgetTrId" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(94)).setAttribute("nombre","tcabOidTcab" );
      ...
      ((Element)v.get(94)).setAttribute("ontab","ejecutarAccionFoco('cccTipoAbonoSubprFrm',4, true);" );
      ((Element)v.get(94)).setAttribute("onshtab","ejecutarAccionFoco('cccTipoAbonoSubprFrm',4, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(96)).setAttribute("nombre","tcabOidTcabGapTdId" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(98)).setAttribute("nombre","cucoOidCuenContTdId" );
   }
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(102)).setAttribute("nombre","lblcucoOidCuenCont" );
      ...
      ((Element)v.get(102)).setAttribute("cod","CccTipoAbonoSubpr.cucoOidCuenCont.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(103)).setAttribute("nombre","cucoOidCuenContWidgetTrId" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(105)).setAttribute("nombre","cucoOidCuenCont" );
      ...
      ((Element)v.get(105)).setAttribute("ontab","ejecutarAccionFoco('cccTipoAbonoSubprFrm',5, true);" );
      ((Element)v.get(105)).setAttribute("onshtab","ejecutarAccionFoco('cccTipoAbonoSubprFrm',5, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(107)).setAttribute("nombre","cucoOidCuenContGapTdId" );
   ...
   private void getXML540(Document doc) {
      ...
      /* Empieza nodo:121 / Elemento padre: 0   */
      v.add(doc.createElement("TR"));
      ((Element)v.get(121)).setAttribute("nombre","cccTipoAbonoSubprTrButtons" );
      ((Element)v.get(0)).appendChild((Element)v.get(121));
      ...
      ((Element)v.get(128)).setAttribute("nombre","cccTipoAbonoSubprTdQueryButton" );
      ((Element)v.get(127)).appendChild((Element)v.get(128));

      /* Empieza nodo:129 / Elemento padre: 128   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(129)).setAttribute("nombre","cccTipoAbonoSubprQueryButton" );
      ((Element)v.get(129)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(129)).setAttribute("estado","false" );
      ((Element)v.get(129)).setAttribute("accion","cccTipoAbonoSubprFirstPage();" );
      ...
      ((Element)v.get(130)).setAttribute("nombre","cccTipoAbonoSubprTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(132)).setAttribute("nombre","cccTipoAbonoSubprLovNullButton" );
      ((Element)v.get(132)).setAttribute("ID","botonContenido" );
      ((Element)v.get(132)).setAttribute("tipo","html" );
      ((Element)v.get(132)).setAttribute("accion","cccTipoAbonoSubprLovNullSelectionAction();" );
