...
public class contenido_informe_estado_campana_generar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_informe_estado_campana_generar" );
      ((Element)v.get(0)).setAttribute("cod","0835" );
      ((Element)v.get(0)).setAttribute("titulo","Generar Informe Estado de Digitación por Campaña" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","Generar Informe Estado de Digitación por Campaña" );
      ...
      ((Element)v.get(11)).setAttribute("valor","PEDEstadoDigitacionInformeCampana" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(19)).setAttribute("nombre","accesos" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(20)).setAttribute("nombre","subaccesos" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(57)).setAttribute("ontab","tabGenerico('cbMarca');" );
      ((Element)v.get(57)).setAttribute("onshtab","tabGenerico('cbMarca','sh');" );
      ...
      ((Element)v.get(62)).setAttribute("ontab","tabGenerico('cbCanal');" );
      ((Element)v.get(62)).setAttribute("onshtab","tabGenerico('cbCanal','sh');" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(87)).setAttribute("nombre","cbAcceso" );
      ((Element)v.get(87)).setAttribute("onchange","cambioAcceso();" );
      ...
      ((Element)v.get(87)).setAttribute("ontab","tabGenerico('cbAcceso');" );
      ((Element)v.get(87)).setAttribute("onshtab","tabGenerico('cbAcceso','sh');" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(92)).setAttribute("nombre","cbSubacceso" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(92)).setAttribute("ontab","tabGenerico('cbSubacceso');" );
      ((Element)v.get(92)).setAttribute("onshtab","tabGenerico('cbSubacceso','sh');" );
      ...
      /* Empieza nodo:99 / Elemento padre: 38   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(38)).appendChild((Element)v.get(99));
      ...
      ((Element)v.get(104)).setAttribute("width","2" );
      ...
      ((Element)v.get(109)).setAttribute("width","2" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(111)).setAttribute("nombre","cbPeriodo" );
      ...
      ((Element)v.get(111)).setAttribute("ontab","tabGenerico('cbPeriodo');" );
      ((Element)v.get(111)).setAttribute("onshtab","tabGenerico('cbPeriodo','sh');" );
      ...
      /* Empieza nodo:116 / Elemento padre: 31   */
      v.add(doc.createElement("td"));
   }

   private void getXML450(Document doc) {
      ((Element)v.get(31)).appendChild((Element)v.get(116));
      ...
      /* Empieza nodo:118 / Elemento padre: 23   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(23)).appendChild((Element)v.get(118));
      ...
      ((Element)v.get(126)).setAttribute("nombre","btnGenerarInforme" );
      ((Element)v.get(126)).setAttribute("ID","botonContenido" );
      ((Element)v.get(126)).setAttribute("tipo","html" );
      ((Element)v.get(126)).setAttribute("accion","generar();" );
      ((Element)v.get(126)).setAttribute("estado","false" );
      ((Element)v.get(126)).setAttribute("cod","2495" );
      ((Element)v.get(126)).setAttribute("ontab","tabGenerico('btnGenerarInforme');" );
      ((Element)v.get(126)).setAttribute("onshtab","tabGenerico('btnGenerarInforme','sh');" );
      ...
      /* Empieza nodo:129 / Elemento padre: 23   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(23)).appendChild((Element)v.get(129));
      ...
      /* Empieza nodo:136 / Elemento padre: 9   */
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(136)).setAttribute("nombre","capaSubacceso" );
      ((Element)v.get(136)).setAttribute("alto","3" );
      ((Element)v.get(136)).setAttribute("ancho","624" );
      ...
      ((Element)v.get(136)).setAttribute("y","165" );
      ((Element)v.get(136)).setAttribute("zindex","" );
      ((Element)v.get(9)).appendChild((Element)v.get(136));

      /* Empieza nodo:137 / Elemento padre: 136   */
      v.add(doc.createElement("LISTA"));
      ((Element)v.get(137)).setAttribute("seleccion","boton" );
      ((Element)v.get(137)).setAttribute("nombre","lstSubacceso" );
      ((Element)v.get(137)).setAttribute("x","12" );
      ((Element)v.get(137)).setAttribute("y","10" );
      ((Element)v.get(137)).setAttribute("ancho","600" );
   }

   private void getXML540(Document doc) {
      ((Element)v.get(137)).setAttribute("alto","3" );
      ((Element)v.get(137)).setAttribute("multisel","-1" );
      ((Element)v.get(137)).setAttribute("incy","10" );
      ((Element)v.get(137)).setAttribute("incx","10" );
      ((Element)v.get(137)).setAttribute("colorf","#EFEFEF" );
      ((Element)v.get(137)).setAttribute("imagenoff","close_no.gif" );
      ((Element)v.get(137)).setAttribute("imagenon","close_up.gif" );
      ((Element)v.get(137)).setAttribute("accion","" );
      ((Element)v.get(137)).setAttribute("sep","|" );
      ((Element)v.get(137)).setAttribute("pixelsborde","2" );
      ((Element)v.get(137)).setAttribute("colorborde","#CCCCCC" );
      ((Element)v.get(136)).appendChild((Element)v.get(137));

      /* Empieza nodo:138 / Elemento padre: 137   */
      v.add(doc.createElement("CABECERA"));
      ((Element)v.get(138)).setAttribute("nombre","cab1" );
      ((Element)v.get(138)).setAttribute("height","20" );
      ((Element)v.get(137)).appendChild((Element)v.get(138));

      /* Empieza nodo:139 / Elemento padre: 138   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(139)).setAttribute("id","datosCamposCabecera" );
      ...
      ((Element)v.get(140)).setAttribute("ancho","60" );
