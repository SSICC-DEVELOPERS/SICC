...
public class RecMotivBloquConectorQueryForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad RecMotivBloqu" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGRecMotivBloquQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGRecMotivBloquQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","RecMotivBloquFormFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","valMotiBloq" );
