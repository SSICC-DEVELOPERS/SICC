...
public class contenido_informe_relacion_unidades_administrativas_generar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_informe_relacion_unidades_administrativas_generar" );
      ((Element)v.get(0)).setAttribute("cod","0735" );
      ((Element)v.get(0)).setAttribute("titulo","Generar informe relación de unidades administrativas" );
      ...
      v.add(doc.createTextNode("\r   \r   \r   function onLoad(){\r      configurarMenuSecundario('Formulario');\r      fMostrarMensajeError();\r      focaliza('Formulario.cbMarca');\r   }\r   function generar(){\r      \r      if(sicc_validaciones_generales()){\r        /*recolectarParametros();\r      \r        set('Formulario.conectorAction', 'LPRelacionUA');           \r        set('Formulario.accion', 'generar');\r      \r        enviaSICC('Formulario');*/\r        \r        var a = new Object();\r        \r        a.accion = 'generar';\r        a.marca = get('Formulario.cbMarca');\r        a.marcaDesc = get('Formulario.cbMarca','T');\r        a.canal = get('Formulario.cbCanal');\r        a.canalDesc = get('Formulario.cbCanal','T');\r        \r        mostrarModalSICC('LPRelacionUA','generar', a);  \r      \r      }\r   \r   }\r\r   function recolectarParametros(){\r      \r      set('Formulario.marca', get('Formulario.cbMarca') );\r      set('Formulario.canal', get('Formulario.cbCanal'));\r    \r  \r   }\r   \r"));
      ...
      ((Element)v.get(17)).setAttribute("nombre","capa" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(51)).setAttribute("nombre","lbldtPais" );
      ((Element)v.get(51)).setAttribute("alto","13" );
      ((Element)v.get(51)).setAttribute("filas","1" );
      ((Element)v.get(51)).setAttribute("id","datosCampos" );
      ((Element)v.get(51)).setAttribute("valor","xxxxxxxxxxxxxxxxxxxxxxxxxxxxx1" );
      ...
      /* Empieza nodo:57 / Elemento padre: 33   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(33)).appendChild((Element)v.get(57));
   ...
   private void getXML270(Document doc) {
      ...
      /* Empieza nodo:87 / Elemento padre: 26   */
      v.add(doc.createElement("td"));
      ((Element)v.get(26)).appendChild((Element)v.get(87));
      ...
      ((Element)v.get(97)).setAttribute("nombre","btnGenerarInforme" );
   }

   private void getXML360(Document doc) {
      ((Element)v.get(97)).setAttribute("ID","botonContenido" );
      ((Element)v.get(97)).setAttribute("tipo","html" );
      ((Element)v.get(97)).setAttribute("accion","generar();" );
      ((Element)v.get(97)).setAttribute("estado","false" );
      ((Element)v.get(97)).setAttribute("cod","2495" );
      ((Element)v.get(97)).setAttribute("ontab","focaliza('Formulario.cbMarca')" );
      ...
      /* Empieza nodo:100 / Elemento padre: 18   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(18)).appendChild((Element)v.get(100));
