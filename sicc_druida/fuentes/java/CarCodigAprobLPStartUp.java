/*
    INDRA/CAR/mmg
    $Id: CarCodigAprobLPStartUp.java,v 1.1 2009/12/03 18:42:00 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class CarCodigAprobLPStartUp extends MMGDruidaBase{
	...
	public static final String BUSINESSID_QUERY = "MMGCarCodigAprobQueryFromToUserPage";
	...
	public CarCodigAprobLPStartUp(){
		super();
	}

	public void inicio() throws Exception {
		pagina("CarCodigAprobPage");
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "CarCodigAprobPage", "cod", "CarCodigAprob." + accion + ".label");
			...
			limpiarBotoneraLista("carCodigAprob", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codApro", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 2);");
		...
		//asignarAtributo("CAPA", "carCodigAprobLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "CarCodigAprobPage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("CarCodigAprobLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		CarCodigAprobData carCodigAprobQuery= new CarCodigAprobData();
		carCodigAprobQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		CarCodigAprobData datosResult = (CarCodigAprobData)getSingleObject(BUSINESSID_QUERY, carCodigAprobQuery, 
			carCodigAprobQuery.clone(), "carCodigAprob");
		...
		preservaHiddensI18n(new Integer(1), "CAR_CODIG_APROB", "carCodigAprobFrm", "Descripcion", true);
		...
		CarCodigAprobData carCodigAprob = datosResult;
		asignar("TEXT", "codApro", FormatUtils.formatObject(carCodigAprob.getCodApro(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "Descripcion", FormatUtils.formatObject(carCodigAprob.getDescripcion(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		loadLocalizationVars(carCodigAprob);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "codApro", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "CAR_CODIG_APROB", "carCodigAprobFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "codApro", "req", "S");
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('carCodigAprobFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "carCodigAprobFrm", "oculto", "N");
		...
		traza("MMG::Creando CarCodigAprob");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		CarCodigAprobData carCodigAprobQuery= new CarCodigAprobData();
		carCodigAprobQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(carCodigAprob.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"carCodigAprobFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"carCodigAprobFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codApro", "ontab","ejecutarAccionFocoModificacion(\"carCodigAprobFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codApro", "onshtab","ejecutarAccionFocoModificacion(\"carCodigAprobFrm\",2, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"carCodigAprobFrm\",3, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"carCodigAprobFrm\",3, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","carCodigAprobTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","carCodigAprobTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codApro...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","carCodigAprobFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","carCodigAprobListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","carCodigAprobListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(CarCodigAprobData carCodigAprob) throws Exception{
	...
	* @param carCodigAprob La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(CarCodigAprobData carCodigAprob) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		CarCodigAprobData carCodigAprob = 
			(CarCodigAprobData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(carCodigAprob);
		loadLeafDependenceCombos(carCodigAprob);
	}
	...
	*/
	...
	protected void loadLocalizationVars(CarCodigAprobData carCodigAprob) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("CAR_CODIG_APROB");
		mmgLocalizationQuery.setEntiPk(carCodigAprob.getId());
