...
public class ConectorCargaInicialFavoritos  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","ConectorCargaInicialFavoritos" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MENCargaInicialFavoritos" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(5)).setAttribute("NOMBRE","DTOCargaFavoritos" );
