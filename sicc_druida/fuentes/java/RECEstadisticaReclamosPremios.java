...
public class RECEstadisticaReclamosPremios extends LPSICCBase {           
   public RECEstadisticaReclamosPremios() {	 
     super();
  }
     ...
     try {
        ...
        if (accion.equals("generar")){
          ...
          //cargarPagina();
           ...
           cargarPagina();
           getConfiguracionMenu("RECEstadisticaReclamosPremios");
        }
  ...
  private void cargarPagina() throws Exception{
     pagina("contenido_informe_estadistica_reclamos_premios_generar");
     
     asignarAtributoPagina("cod", "0910");
     asignarAtributo("VAR", "lp", "valor", "RECEstadisticaReclamosPremios");
     ...
     MareBusinessID idCAT2 = new MareBusinessID("RECComboOperacionesPremio");
     ...
     //comentado por Sapaza, para que las zonas no se cargen en la LP 
 ...
 private void generarReporte() throws Exception{
     ...
     String periodoInicial        = conectorParametroLimpia("periodoInicial", "", true);
     datos.put(ConstantesREP.PERIODOINICIAL, periodoInicial);
     
     String periodoFinal        = conectorParametroLimpia("periodoFinal", "", true);
     if(!periodoFinal.equals("")){
        datos.put(ConstantesREP.PERIODOFINAL, periodoFinal);       
     }
     
     String periodoInicialDesc        = conectorParametroLimpia("periodoInicialDesc", "", true);
     datos.put(ConstantesREP.PERIODOINICIALDESC, periodoInicialDesc);
     
     String periodoFinalDesc        = conectorParametroLimpia("periodoFinalDesc", "", true);
     if(!periodoFinalDesc.equals("")){
        datos.put(ConstantesREP.PERIODOFINALDESC, periodoFinalDesc);       
     }
     ...
     datos.put(ConstantesREP.TITULO, "Estadística de Reclamos de Premios");     
     traza("++++++Antes de enviar a reportes " + datos); 
        
     
     traza("el formaro es  " + formato);
//     ejecutarReporte(datos, "REPGenerarReporte", "RD_REP-108", formato);
     ejecutarReporte2(datos, "REPGenerarReporteBatch", "RD_REP-108", formato);
