/*
    INDRA/CAR/mmg
    $Id: SegIdiomLPStartUp.java,v 1.1 2009/12/03 18:38:16 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class SegIdiomLPStartUp extends MMGDruidaBase{
	...
	public static final String BUSINESSID_QUERY = "MMGSegIdiomQueryFromToUserPage";
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "SegIdiomPage", "cod", "SegIdiom." + accion + ".label");
			...
			limpiarBotoneraLista("segIdiom", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codIdio", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 2);");
		asignarAtributo("TEXT", "Descripcion", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 15);");
		
		//Primero determianmos el nombre del campo en la entidad de oriegen donde se van a cargar los datos
		asignar("VAR", "idAttributeLovOpener", conectorParametro(PARAMETRO_LOV_ATTRIBUTO));
		asignar("VAR", "idEntityLovOpener", conectorParametro(PARAMETRO_LOV_ENTIDAD));
		//asignarAtributo("CAPA", "segIdiomLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "SegIdiomPage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("SegIdiomLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		SegIdiomData segIdiomQuery= new SegIdiomData();
		segIdiomQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		SegIdiomData datosResult = (SegIdiomData)getSingleObject(BUSINESSID_QUERY, segIdiomQuery, 
			segIdiomQuery.clone(), "segIdiom");
		...
		preservaHiddensI18n(new Integer(1), "SEG_IDIOM", "segIdiomFrm", "Descripcion", true);
		...
		SegIdiomData segIdiom = datosResult;
		asignar("TEXT", "codIdio", FormatUtils.formatObject(segIdiom.getCodIdio(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "Descripcion", FormatUtils.formatObject(segIdiom.getDescripcion(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignarAtributo("CHECKBOX", "indIdioTrad" , "check", FormatUtils.formatObject(
			segIdiom.getIndIdioTrad(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols).equals("true")? "S": "N");
		asignar("TEXT", "codIsoIdio", FormatUtils.formatObject(segIdiom.getCodIsoIdio(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		loadLocalizationVars(segIdiom);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "codIdio", "disabled", "S");
		asignarAtributo("TEXT", "Descripcion", "disabled", "S");
		
					asignarAtributo("CHECKBOX", "indIdioTrad", "disabled", "S");
		asignarAtributo("TEXT", "codIsoIdio", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "SEG_IDIOM", "segIdiomFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "codIdio", "req", "S");
		asignarAtributo("TEXT", "Descripcion", "req", "S");
		asignarAtributo("TEXT", "codIsoIdio", "req", "S");
		
		
		//Asiganamos a los campos internacionalizables la función de onblur para actualizar el 
		//valor del idioma por defecto
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('segIdiomFrm.Descripcion'))");
		...
		asignarAtributo("TEXT", "codIsoIdio", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 2);");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "segIdiomFrm", "oculto", "N");
		...
		traza("MMG::Creando SegIdiom");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		SegIdiomData segIdiomQuery= new SegIdiomData();
		segIdiomQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(segIdiom.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"segIdiomFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"segIdiomFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codIdio", "ontab","ejecutarAccionFocoModificacion(\"segIdiomFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codIdio", "onshtab","ejecutarAccionFocoModificacion(\"segIdiomFrm\",2, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"segIdiomFrm\",3, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"segIdiomFrm\",3, false)");
				asignarAtributo("TEXT", "indIdioTrad", "ontab","ejecutarAccionFocoModificacion(\"segIdiomFrm\",4, true)");
				asignarAtributo("TEXT", "indIdioTrad", "onshtab","ejecutarAccionFocoModificacion(\"segIdiomFrm\",4, false)");
				asignarAtributo("AREATEXTO", "codIsoIdio", "ontab","ejecutarAccionFocoModificacion(\"segIdiomFrm\",5, true)");
				asignarAtributo("AREATEXTO", "codIsoIdio", "onshtab","ejecutarAccionFocoModificacion(\"segIdiomFrm\",5, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","segIdiomTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","segIdiomTrButtons");
	...
	*/
	protected void removeNonSearchElements() throws Exception{
		borrarCampo("id");
		borrarCampo("indIdioTrad");
		borrarCampo("codIsoIdio");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codIdio...");		
				...
				traza("MMG: el atributo es indIdioTrad...");		
				
				traza("MMG: el atributo es codIsoIdio...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","segIdiomFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","segIdiomListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","segIdiomListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(SegIdiomData segIdiom) throws Exception{
	...
	* @param segIdiom La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(SegIdiomData segIdiom) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		SegIdiomData segIdiom = 
			(SegIdiomData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(segIdiom);
		loadLeafDependenceCombos(segIdiom);
	}
	...
	*/
	...
	protected void loadLocalizationVars(SegIdiomData segIdiom) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("SEG_IDIOM");
		mmgLocalizationQuery.setEntiPk(segIdiom.getId());
