/*
    INDRA/CAR/mmg
    $Id: CobGuionArgumCabecViewLPStartUp.java,v 1.1 2009/12/03 18:40:47 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class CobGuionArgumCabecViewLPStartUp extends MMGDruidaBase{
	...
	public CobGuionArgumCabecViewLPStartUp(){
		super();
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			buildJsPageSize("CobGuionArgumCabecView");
			...
			asignarAtributo("PAGINA", "CobGuionArgumCabecViewPage", "cod", "CobGuionArgumCabecView." + accion + ".label");
			...
			limpiarBotoneraLista("cobGuionArgumCabecView", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codGuiaArgu", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 4);");
		...
		//asignarAtributo("CAPA", "cobGuionArgumCabecViewLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "CobGuionArgumCabecViewPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		CobGuionArgumCabecViewData cobGuionArgumCabecViewQuery= new CobGuionArgumCabecViewData();
		cobGuionArgumCabecViewQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		CobGuionArgumCabecViewData datosResult = (CobGuionArgumCabecViewData)getSingleObject(BUSINESSID_QUERY, cobGuionArgumCabecViewQuery, 
			cobGuionArgumCabecViewQuery.clone(), "cobGuionArgumCabecView");
		...
		preservaHiddensI18n(new Integer(1), "COB_GUION_ARGUM_CABEC", "cobGuionArgumCabecViewFrm", "Descripcion", true);
		...
		CobGuionArgumCabecViewData cobGuionArgumCabecView = datosResult;
		asignar("TEXT", "codGuiaArgu", FormatUtils.formatObject(cobGuionArgumCabecView.getCodGuiaArgu(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("AREATEXTO", "valObse", FormatUtils.formatObject(cobGuionArgumCabecView.getValObse(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "Descripcion", FormatUtils.formatObject(cobGuionArgumCabecView.getDescripcion(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		loadLocalizationVars(cobGuionArgumCabecView);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "codGuiaArgu", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "COB_GUION_ARGUM_CABEC", "cobGuionArgumCabecViewFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "codGuiaArgu", "req", "S");
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('cobGuionArgumCabecViewFrm.Descripcion'))");
		...
		String separadorMiles = decimalSeparator.equals(".") ? "," : ".";
		asignarAtributo("TEXT", "codGuiaArgu", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 4);");
		asignarAtributo("AREATEXTO", "valObse", "validacion", "ValidaLongitud(cdos_trim(valor), 0, 4000)");
		asignarAtributo("TEXT", "Descripcion", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 50);");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "cobGuionArgumCabecViewFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		CobGuionArgumCabecViewData cobGuionArgumCabecViewQuery= new CobGuionArgumCabecViewData();
		cobGuionArgumCabecViewQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(cobGuionArgumCabecView.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"cobGuionArgumCabecViewFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"cobGuionArgumCabecViewFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codGuiaArgu", "ontab","ejecutarAccionFocoModificacion(\"cobGuionArgumCabecViewFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codGuiaArgu", "onshtab","ejecutarAccionFocoModificacion(\"cobGuionArgumCabecViewFrm\",2, false)");
				asignarAtributo("AREATEXTO", "valObse", "ontab","ejecutarAccionFocoModificacion(\"cobGuionArgumCabecViewFrm\",3, true)");
				asignarAtributo("AREATEXTO", "valObse", "onshtab","ejecutarAccionFocoModificacion(\"cobGuionArgumCabecViewFrm\",3, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"cobGuionArgumCabecViewFrm\",4, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"cobGuionArgumCabecViewFrm\",4, false)");
					asignarAtributo("COMBO","paisOidPais", "ontab", "ejecutarAccionFocoModificacion(\"cobGuionArgumCabecViewFrm\",5, true)");
					asignarAtributo("COMBO","paisOidPais", "onshtab", "ejecutarAccionFocoModificacion(\"cobGuionArgumCabecViewFrm\",5, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","cobGuionArgumCabecViewTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","cobGuionArgumCabecViewTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","cobGuionArgumCabecViewFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","cobGuionArgumCabecViewListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","cobGuionArgumCabecViewListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(CobGuionArgumCabecViewData cobGuionArgumCabecView) throws Exception{
		...
		if(cobGuionArgumCabecView != null && cobGuionArgumCabecView.getPaisOidPais() != null){
				checkCombo("paisOidPais" , cobGuionArgumCabecView.getPaisOidPais().getId().toString());
			}
	...
	* @param cobGuionArgumCabecView La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(CobGuionArgumCabecViewData cobGuionArgumCabecView) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		CobGuionArgumCabecViewData cobGuionArgumCabecView = 
			(CobGuionArgumCabecViewData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(cobGuionArgumCabecView.getPaisOidPais() != null){
			cobGuionArgumCabecView.setPaisOidPais((es.indra.belcorp.mso.SegPaisViewData)
			getSingleObject(BUSINESSID_PAISOIDPAIS_QUERY, 
			cobGuionArgumCabecView.getPaisOidPais(),
			cobGuionArgumCabecView.getPaisOidPais().clone(),
			"segPaisView"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(cobGuionArgumCabecView);
		loadLeafDependenceCombos(cobGuionArgumCabecView);
	}
	...
	*/
	...
	protected void loadLocalizationVars(CobGuionArgumCabecViewData cobGuionArgumCabecView) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("COB_GUION_ARGUM_CABEC");
		mmgLocalizationQuery.setEntiPk(cobGuionArgumCabecView.getId());
