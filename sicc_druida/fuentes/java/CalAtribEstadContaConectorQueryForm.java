...
public class CalAtribEstadContaConectorQueryForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad CalAtribEstadConta" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGCalAtribEstadContaQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGCalAtribEstadContaQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","CalAtribEstadContaFormFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","tecoOidTipoEstaCont" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(8)).setAttribute("NOMBRE","codAtri" );
