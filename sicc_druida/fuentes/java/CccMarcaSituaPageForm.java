...
public class CccMarcaSituaPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","CccMarcaSitua.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","CccMarcaSitua.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('cccMarcaSituaFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('cccMarcaSituaFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(54)).setAttribute("cod","CccMarcaSitua.paisOidPais.label" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('cccMarcaSituaFrm',2, true);" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('cccMarcaSituaFrm',2, false);" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(76)).setAttribute("nombre","codMarcSituTdId" );
   ...
   private void getXML360(Document doc) {
      ((Element)v.get(81)).setAttribute("nombre","codMarcSituWidgetTrId" );
      ...
      ((Element)v.get(83)).setAttribute("ontab","ejecutarAccionFoco('cccMarcaSituaFrm',3, true)" );
      ((Element)v.get(83)).setAttribute("onshtab","ejecutarAccionFoco('cccMarcaSituaFrm', 3, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(84)).setAttribute("nombre","codMarcSituGapTdId" );
      ...
      ((Element)v.get(90)).setAttribute("cod","CccMarcaSitua.Descripcion.label" );
      ...
      ((Element)v.get(94)).setAttribute("ontab","ejecutarAccionFoco('cccMarcaSituaFrm',4, true)" );
      ((Element)v.get(94)).setAttribute("onshtab","ejecutarAccionFoco('cccMarcaSituaFrm', 4, false)" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(98)).setAttribute("href","javascript:openLocalizationDialog('cccMarcaSituaFrm', 'Descripcion', 1);" );
      ((Element)v.get(98)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"cccMarcaSituaFrm\",4, true)', 'ejecutarAccionFoco(\"cccMarcaSituaFrm\",4, false)')" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(102)).setAttribute("nombre","indCuenCastTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(107)).setAttribute("nombre","indCuenCastWidgetTrId" );
      ...
      ((Element)v.get(109)).setAttribute("nombre","indCuenCast" );
      ...
      ((Element)v.get(109)).setAttribute("ontab","ejecutarAccionFoco('cccMarcaSituaFrm',5, true)" );
      ((Element)v.get(109)).setAttribute("onshtab","ejecutarAccionFoco('cccMarcaSituaFrm',5, false)" );
      ...
      ((Element)v.get(110)).setAttribute("cod","CccMarcaSitua.indCuenCast.1.label" );
      ...
      ((Element)v.get(112)).setAttribute("valor","0" );
      ((Element)v.get(112)).setAttribute("cod","CccMarcaSitua.indCuenCast.0.label" );
      ...
      /* Empieza nodo:114 / Elemento padre: 75   */
      v.add(doc.createElement("TD"));
      ((Element)v.get(114)).setAttribute("nombre","indCuenCastGapTdId" );
      ((Element)v.get(114)).setAttribute("nowrap","true" );
      ((Element)v.get(114)).setAttribute("class","datosCampos" );
      ((Element)v.get(75)).appendChild((Element)v.get(114));
      ...
      /* Empieza nodo:116 / Elemento padre: 75   */
   }

   private void getXML540(Document doc) {
      v.add(doc.createElement("TD"));
      ((Element)v.get(116)).setAttribute("width","100%" );
      ((Element)v.get(75)).appendChild((Element)v.get(116));
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(131)).setAttribute("nombre","valObseTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(136)).setAttribute("nombre","valObseWidgetTrId" );
   ...
   private void getXML630(Document doc) {
      ((Element)v.get(138)).setAttribute("nombre","valObse" );
      ((Element)v.get(138)).setAttribute("valor","" );
      ((Element)v.get(138)).setAttribute("rows","3" );
      ((Element)v.get(138)).setAttribute("cols","40" );
      ...
      ((Element)v.get(138)).setAttribute("ontab","ejecutarAccionFoco('cccMarcaSituaFrm',6, true)" );
      ((Element)v.get(138)).setAttribute("onshtab","ejecutarAccionFoco('cccMarcaSituaFrm',6, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(139)).setAttribute("nombre","valObseGapTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(144)).setAttribute("nombre","formGapTr3" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(153)).setAttribute("nombre","cccMarcaSituaTrButtons" );
   ...
   private void getXML720(Document doc) {
      ...
      ((Element)v.get(160)).setAttribute("nombre","cccMarcaSituaTdQueryButton" );
      ((Element)v.get(159)).appendChild((Element)v.get(160));

      /* Empieza nodo:161 / Elemento padre: 160   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(161)).setAttribute("nombre","cccMarcaSituaQueryButton" );
      ((Element)v.get(161)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(161)).setAttribute("estado","false" );
      ((Element)v.get(161)).setAttribute("accion","cccMarcaSituaFirstPage();" );
      ...
      ((Element)v.get(162)).setAttribute("nombre","cccMarcaSituaTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(164)).setAttribute("nombre","cccMarcaSituaLovNullButton" );
      ((Element)v.get(164)).setAttribute("ID","botonContenido" );
      ((Element)v.get(164)).setAttribute("tipo","html" );
      ((Element)v.get(164)).setAttribute("accion","cccMarcaSituaLovNullSelectionAction();" );
