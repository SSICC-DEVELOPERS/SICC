...
public class MaeTipoPrefeConectorQueryForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad MaeTipoPrefe" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGMaeTipoPrefeQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGMaeTipoPrefeQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","MaeTipoPrefeFormFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(8)).setAttribute("NOMBRE","codTipoPref" );
