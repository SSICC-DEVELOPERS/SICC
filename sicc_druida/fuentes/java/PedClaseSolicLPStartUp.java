/*
    INDRA/CAR/mmg
    $Id: PedClaseSolicLPStartUp.java,v 1.1 2009/12/03 18:35:37 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class PedClaseSolicLPStartUp extends MMGDruidaBase{
	...
	protected static Hashtable indOrdeCompValues = new Hashtable();
	static{
		indOrdeCompValues.put(new java.lang.String("1"), "Si");
		indOrdeCompValues.put(new java.lang.String("0"), "No");
	}
	
	
	// Definicion del constructor
	public PedClaseSolicLPStartUp(){
		super();
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "PedClaseSolicPage", "cod", "PedClaseSolic." + accion + ".label");
			...
			limpiarBotoneraLista("pedClaseSolic", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codClasSoli", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 2);");
		...
		//asignarAtributo("CAPA", "pedClaseSolicLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "PedClaseSolicPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		PedClaseSolicData pedClaseSolicQuery= new PedClaseSolicData();
		pedClaseSolicQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		PedClaseSolicData datosResult = (PedClaseSolicData)getSingleObject(BUSINESSID_QUERY, pedClaseSolicQuery, 
			pedClaseSolicQuery.clone(), "pedClaseSolic");
		...
		preservaHiddensI18n(new Integer(1), "PED_CLASE_SOLIC", "pedClaseSolicFrm", "Descripcion", true);
		
		
		//Guardamos los valores de los radiobuttons
		if(datosResult.getIndOrdeComp() != null)
			asignar("VAR", "indOrdeCompCheckValue", datosResult.getIndOrdeComp().toString());
		...
		PedClaseSolicData pedClaseSolic = datosResult;
		asignar("TEXT", "codClasSoli", FormatUtils.formatObject(pedClaseSolic.getCodClasSoli(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "Descripcion", FormatUtils.formatObject(pedClaseSolic.getDescripcion(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignarAtributo("RADIOB", "indOrdeComp" , "valor", FormatUtils.formatObject(
			pedClaseSolic.getIndOrdeComp(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		loadLocalizationVars(pedClaseSolic);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "codClasSoli", "disabled", "S");
		asignarAtributo("TEXT", "Descripcion", "disabled", "S");
		
					asignarAtributo("RADIOB", "indOrdeComp", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "PED_CLASE_SOLIC", "pedClaseSolicFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "codClasSoli", "req", "S");
		asignarAtributo("TEXT", "Descripcion", "req", "S");
		asignarAtributo("RADIOB", "indOrdeComp", "req", "S");
		
		
		//Asiganamos a los campos internacionalizables la función de onblur para actualizar el 
		//valor del idioma por defecto
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('pedClaseSolicFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "pedClaseSolicFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		PedClaseSolicData pedClaseSolicQuery= new PedClaseSolicData();
		pedClaseSolicQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(pedClaseSolic.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"pedClaseSolicFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"pedClaseSolicFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codClasSoli", "ontab","ejecutarAccionFocoModificacion(\"pedClaseSolicFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codClasSoli", "onshtab","ejecutarAccionFocoModificacion(\"pedClaseSolicFrm\",2, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"pedClaseSolicFrm\",3, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"pedClaseSolicFrm\",3, false)");
				asignarAtributo("TEXT", "indOrdeComp", "ontab","ejecutarAccionFocoModificacion(\"pedClaseSolicFrm\",4, true)");
				asignarAtributo("TEXT", "indOrdeComp", "onshtab","ejecutarAccionFocoModificacion(\"pedClaseSolicFrm\",4, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","pedClaseSolicTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","pedClaseSolicTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","pedClaseSolicFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","pedClaseSolicListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","pedClaseSolicListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(PedClaseSolicData pedClaseSolic) throws Exception{
	...
	* @param pedClaseSolic La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(PedClaseSolicData pedClaseSolic) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		PedClaseSolicData pedClaseSolic = 
			(PedClaseSolicData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(pedClaseSolic);
		loadLeafDependenceCombos(pedClaseSolic);
	}
	...
	*/
	...
	protected void loadLocalizationVars(PedClaseSolicData pedClaseSolic) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("PED_CLASE_SOLIC");
		mmgLocalizationQuery.setEntiPk(pedClaseSolic.getId());
