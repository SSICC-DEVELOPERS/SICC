...
public class INCNoCumplimientoConstanciaPedido extends LPSICCBase {

  public INCNoCumplimientoConstanciaPedido() {
  ...
  public void ejecucion() throws Exception {
    ...
    try {
      ...
      if (accion.equals("generar")){
        ...
        cargarPagina();
        getConfiguracionMenu("INCNoCumplimientoConstanciaPedido");
      }
  ...
  private void cargarPagina() throws Exception{
    ...
    pagina("contenido_informe_no_cumplimiento_pedido_generar");   
  ...
  private void generarReporte() throws Exception{
    ...
    String baseCalculo = conectorParametroLimpia("baseCalculo", "", true);
    datos.put(ConstantesREP.BASECALCULO,baseCalculo);
    ...
    String nroConcurso = conectorParametroLimpia("nroConcurso", "", true);
    datos.put(ConstantesREP.NUMEROCONCURSO, nroConcurso);
    
    String mdr = conectorParametroLimpia("moneda", "", true);
    datos.put(ConstantesREP.MONEDA, mdr);
    
    String resultados = conectorParametroLimpia("resultados", "", true);
    datos.put(ConstantesREP.RESULTADOS, resultados);
    
    String desde = conectorParametroLimpia("rangoDesde","",true);
    if(!desde.equals("")){
      datos.put(ConstantesREP.RANGONUMEROPEDIDODESDE,desde);
    }
    
    String hasta = conectorParametroLimpia("rangoHasta","",true);
    if(!hasta.equals("")){
      datos.put(ConstantesREP.RANGONUMEROPEDIDOHASTA,hasta);
    }
    
    
    datos.put(ConstantesREP.TITULO, "No Cumplimiento de Constancia Un Pedido");
    ...
    if(region.equals("")){
       reporte = "RD_REP-077_02";    
    }else{
       if(zona.equals("")){
          reporte = "RD_REP-077_01";
       }else{
          reporte = "RD_REP-077";
       }
    }    
