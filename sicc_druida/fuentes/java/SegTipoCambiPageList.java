...
public class SegTipoCambiPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","segTipoCambiList" );
      ...
      ((Element)v.get(14)).setAttribute("cod","SegTipoCambi.moneOidMon1.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","SegTipoCambi.moneOidMon2.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","SegTipoCambi.fecDesd.label" );
