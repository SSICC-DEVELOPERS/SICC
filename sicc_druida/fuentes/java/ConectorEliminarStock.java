...
public class ConectorEliminarStock  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Eliminar Stock" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","DTOStock" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","BELEliminarRegistrosDeStock" );
