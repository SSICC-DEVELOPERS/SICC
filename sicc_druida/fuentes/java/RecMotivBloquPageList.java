...
public class RecMotivBloquPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","recMotivBloquList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","RecMotivBloqu.valMotiBloq.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","RecMotivBloqu.Descripcion.label" );
