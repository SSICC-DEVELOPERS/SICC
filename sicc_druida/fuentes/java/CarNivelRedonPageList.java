...
public class CarNivelRedonPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","carNivelRedonList" );
      ...
      ((Element)v.get(11)).setAttribute("alto","22" );
      ((Element)v.get(11)).setAttribute("accion","" );
      ((Element)v.get(11)).setAttribute("tipoEnvio","seleccion" );
      ((Element)v.get(11)).setAttribute("formaEnvio","xml" );
      ((Element)v.get(11)).setAttribute("maxSel","1" );
      ((Element)v.get(11)).setAttribute("msgErrMaxSel","" );
      ((Element)v.get(11)).setAttribute("coloresScrollNativo","#D4D0C8,black,white,#D4D0C8,#D4D0C8,#ECE9E4,black" );
      ((Element)v.get(11)).setAttribute("colorROver","#D0D9E8" );
      ((Element)v.get(11)).setAttribute("onLoad","" );
      ((Element)v.get(11)).setAttribute("colorSelecc","#D0D9E8" );
