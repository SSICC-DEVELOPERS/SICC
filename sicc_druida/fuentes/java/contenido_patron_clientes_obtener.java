...
public class contenido_patron_clientes_obtener  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_patron_clientes_obtener" );
      ((Element)v.get(0)).setAttribute("cod","0739" );
      ((Element)v.get(0)).setAttribute("titulo","Obtener patrón de clientes" );
      ...
      v.add(doc.createTextNode("\r   \r   \r   function onLoad(){\r      configurarMenuSecundario('Formulario');\r      fMostrarMensajeError();\r      focaliza('Formulario.cbPais');\r   }\r   \r   function generar(){\r        \r	  if(sicc_validaciones_generales()){\r\r		  var a = new Object();\r		  a.accion = 'generar';\r		  a.pais = quitarItemVacio(get('Formulario.cbPais'));\r		  a.codigoCliente = get('Formulario.txtCodCliente');\r		  a.apePat = get('Formulario.txtApellidoPaterno');\r		  a.apeMat = get('Formulario.txtApellidoMaterno');\r		  a.nombre1 = get('Formulario.txtNombre1');\r		  a.nombre2 = get('Formulario.txtNombre2');    \r		  a.region = get('Formulario.cbRegion');\r		  a.status = get('Formulario.cbStatusCliente');\r\r		  mostrarModalSICC('LPPadronClientes','generar', a);  \r\r      }\r   }\r   \r     \r   function buscarCliente(){ \r      var obj = new Object();\r\r      var whnd = mostrarModalSICC('LPBusquedaRapidaCliente','',obj);\r    \r      if(whnd==null){\r               }else{\r         var cod = whnd[1];\r                  set('Formulario.txtCodCliente', cod)\r      }		\r   }\r   \r   \r   function  quitarItemVacio(elemento){\r      var elementoADevolver = new Array();\r     \r      for(var k=0;k<elemento.length;k++) {\r         if (elemento[k] != ''){ 			 \r            elementoADevolver[elementoADevolver.length] = elemento[k];\r         }\r      }\r        \r      return elementoADevolver;\r      \r   }\r   \r\r  function clienteOnBlur() {\r\r        var longiCod = get('Formulario.hLongCliente');\r        var elTexto  = get('Formulario.txtCodCliente');\r\r        if(elTexto.length!=0){\r           var faltantes = longiCod -  elTexto.length;\r           var resultCod = new String(\"\");\r           if(faltantes > 0){\r              for(var t = 0 ; t<faltantes; t++){\r                  resultCod = resultCod + \"0\";\r              }\r         }\r         resultCod = resultCod + elTexto;\r         set('Formulario.txtCodCliente', resultCod);\r        }\r             \r   }\r  \r   \r   \r\r   "));
      ...
      ((Element)v.get(5)).setAttribute("name","cbPais" );
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(6)).setAttribute("name","cbRegion" );
      ((Element)v.get(6)).setAttribute("required","true" );
      ((Element)v.get(6)).setAttribute("cod","612" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(13)).setAttribute("nombre","apePat" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(14)).setAttribute("nombre","apeMat" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(15)).setAttribute("nombre","nombre1" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(16)).setAttribute("nombre","nombre2" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(18)).setAttribute("nombre","hLongCliente" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(62)).setAttribute("onblur","clienteOnBlur();" );
      ...
      ((Element)v.get(66)).setAttribute("onclick","buscarCliente();" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(79)).setAttribute("nombre","lblApellidoPaterno" );
      ...
      ((Element)v.get(79)).setAttribute("cod","2382" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(83)).setAttribute("nombre","lblApellidoMaterno" );
      ...
      ((Element)v.get(83)).setAttribute("cod","2383" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(87)).setAttribute("nombre","lblNombre1" );
      ...
      ((Element)v.get(87)).setAttribute("cod","93" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(91)).setAttribute("nombre","lblNombre2" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(91)).setAttribute("cod","94" );
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(98)).setAttribute("nombre","txtApellidoPaterno" );
      ...
      ((Element)v.get(98)).setAttribute("size","25" );
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(102)).setAttribute("nombre","txtApellidoMaterno" );
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(106)).setAttribute("nombre","txtNombre1" );
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(110)).setAttribute("nombre","txtNombre2" );
      ((Element)v.get(110)).setAttribute("id","datosCampos" );
      ((Element)v.get(110)).setAttribute("max","25" );
   }
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(110)).setAttribute("size","25" );
      ...
      /* Empieza nodo:113 / Elemento padre: 74   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(74)).appendChild((Element)v.get(113));
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(139)).setAttribute("nombre","cbStatusCliente" );
      ...
      ((Element)v.get(156)).setAttribute("accion","generar();" );
      ((Element)v.get(156)).setAttribute("estado","false" );
      ((Element)v.get(156)).setAttribute("cod","2495" );
      ((Element)v.get(156)).setAttribute("ontab","focaliza('Formulario.cbPais')" );
   }
   ...
   private void getXML630(Document doc) {
      ...
      /* Empieza nodo:159 / Elemento padre: 20   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(20)).appendChild((Element)v.get(159));
