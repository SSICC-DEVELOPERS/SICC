...
public class BelEstadMercaConectorQueryForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad BelEstadMerca" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGBelEstadMercaQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGBelEstadMercaQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","BelEstadMercaFormFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(8)).setAttribute("NOMBRE","codEsta" );
