...
public class contenido_pallets_asignar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_pallets_asignar" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","contenido_pallets_asignar.js" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(14)).setAttribute("nombre","hOidListaPicadoCabecera" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(15)).setAttribute("nombre","hLineas" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(47)).setAttribute("cod","ApeCubicArticFueraPed.pallet.label" );
      ...
      ((Element)v.get(56)).setAttribute("cod","ApeCubicArticFueraPed.codProd.label" );
      ...
      ((Element)v.get(59)).setAttribute("cod","ApeCubicArticFueraPed.descrip.label" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(61)).setAttribute("cod","ApeCubicArticFueraPed.Anaquel.label" );
      ...
      ((Element)v.get(63)).setAttribute("cod","ApeCubicArticFueraPed.NroUnidades.label" );
      ...
      ((Element)v.get(65)).setAttribute("cod","ApeCubicArticFueraPed.NroPallet.label" );
      ((Element)v.get(55)).appendChild((Element)v.get(65));

      /* Elemento padre:65 / Elemento actual: 66   */
      v.add(doc.createTextNode("N° pallet"));
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(72)).setAttribute("tipo","cajatexto" );
      ((Element)v.get(72)).setAttribute("nombre","NroPallet" );
      ((Element)v.get(72)).setAttribute("size","8" );
      ((Element)v.get(72)).setAttribute("max","6" );
      ((Element)v.get(72)).setAttribute("IDOBJ","EstCajaDatForm" );
      ((Element)v.get(72)).setAttribute("ID","EstDat2" );
      ((Element)v.get(72)).setAttribute("onBlur","" );
      ((Element)v.get(72)).setAttribute("onTab","" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(79)).setAttribute("nombre","btnDesdoblar" );
      ((Element)v.get(79)).setAttribute("x","80" );
      ((Element)v.get(79)).setAttribute("y","279" );
      ...
      ((Element)v.get(79)).setAttribute("cod","ApeCubicArticFueraPed.desdoblar.label" );
      ((Element)v.get(79)).setAttribute("accion","accionBtnDesdoblar();" );
      ...
      ((Element)v.get(80)).setAttribute("y","428" );
