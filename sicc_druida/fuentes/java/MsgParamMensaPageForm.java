...
public class MsgParamMensaPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","MsgParamMensa.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","MsgParamMensa.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('msgParamMensaFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('msgParamMensaFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(54)).setAttribute("cod","MsgParamMensa.paisOidPais.label" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('msgParamMensaFrm',2, true);" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('msgParamMensaFrm',2, false);" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(61)).setAttribute("nombre","codDatoVariTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(66)).setAttribute("nombre","codDatoVariWidgetTrId" );
      ...
      ((Element)v.get(68)).setAttribute("ontab","ejecutarAccionFoco('msgParamMensaFrm',3, true)" );
      ((Element)v.get(68)).setAttribute("onshtab","ejecutarAccionFoco('msgParamMensaFrm', 3, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(69)).setAttribute("nombre","codDatoVariGapTdId" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(71)).setAttribute("nombre","desDatoVariTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(76)).setAttribute("nombre","desDatoVariWidgetTrId" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(78)).setAttribute("nombre","desDatoVari" );
      ((Element)v.get(78)).setAttribute("valor","" );
      ((Element)v.get(78)).setAttribute("rows","3" );
      ((Element)v.get(78)).setAttribute("cols","40" );
      ...
      ((Element)v.get(78)).setAttribute("ontab","ejecutarAccionFoco('msgParamMensaFrm',4, true)" );
      ((Element)v.get(78)).setAttribute("onshtab","ejecutarAccionFoco('msgParamMensaFrm',4, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(79)).setAttribute("nombre","desDatoVariGapTdId" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(81)).setAttribute("nombre","fecSistTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(86)).setAttribute("nombre","fecSistWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(88)).setAttribute("nombre","fecSist" );
      ...
      ((Element)v.get(88)).setAttribute("ontab","ejecutarAccionFoco('msgParamMensaFrm',5, true)" );
      ((Element)v.get(88)).setAttribute("onshtab","ejecutarAccionFoco('msgParamMensaFrm', 5, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(89)).setAttribute("nombre","fecSistGapTdId" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(103)).setAttribute("nombre","msgParamMensaTrButtons" );
      ...
      ((Element)v.get(110)).setAttribute("nombre","msgParamMensaTdQueryButton" );
      ((Element)v.get(109)).appendChild((Element)v.get(110));

      /* Empieza nodo:111 / Elemento padre: 110   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(111)).setAttribute("nombre","msgParamMensaQueryButton" );
      ((Element)v.get(111)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(111)).setAttribute("estado","false" );
      ((Element)v.get(111)).setAttribute("accion","msgParamMensaFirstPage();" );
      ...
      ((Element)v.get(112)).setAttribute("nombre","msgParamMensaTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(114)).setAttribute("nombre","msgParamMensaLovNullButton" );
      ((Element)v.get(114)).setAttribute("ID","botonContenido" );
      ((Element)v.get(114)).setAttribute("tipo","html" );
   }

   private void getXML540(Document doc) {
      ((Element)v.get(114)).setAttribute("accion","msgParamMensaLovNullSelectionAction();" );
