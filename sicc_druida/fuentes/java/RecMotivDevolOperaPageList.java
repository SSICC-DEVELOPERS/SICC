...
public class RecMotivDevolOperaPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","recMotivDevolOperaList" );
      ...
      ((Element)v.get(14)).setAttribute("cod","RecMotivDevolOpera.ropeOidOper.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","RecMotivDevolOpera.modvOidMotiDevo.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","RecMotivDevolOpera.valMarcDefe.label" );
