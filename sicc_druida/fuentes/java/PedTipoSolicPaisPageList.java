...
public class PedTipoSolicPaisPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","pedTipoSolicPaisList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(33)).setAttribute("height","20" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(34)).setAttribute("cod","PedTipoSolicPais.tsolOidTipoSoli.label" );
      ...
      ((Element)v.get(35)).setAttribute("cod","PedTipoSolicPais.numSoliLote.label" );
      ...
      ((Element)v.get(36)).setAttribute("cod","PedTipoSolicPais.numUnidAlar.label" );
      ...
      ((Element)v.get(37)).setAttribute("cod","PedTipoSolicPais.fopaOidFormPago.label" );
      ...
      ((Element)v.get(38)).setAttribute("cod","PedTipoSolicPais.indSujeFlet.label" );
      ...
      ((Element)v.get(39)).setAttribute("cod","PedTipoSolicPais.indReseStoc.label" );
      ...
      ((Element)v.get(40)).setAttribute("cod","PedTipoSolicPais.indPermReve.label" );
      ...
      ((Element)v.get(41)).setAttribute("cod","PedTipoSolicPais.indPediPrue.label" );
      ...
      ((Element)v.get(42)).setAttribute("cod","PedTipoSolicPais.indComi.label" );
      ((Element)v.get(33)).appendChild((Element)v.get(42));
      /* Termina nodo:42   */

      /* Empieza nodo:43 / Elemento padre: 33   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(43)).setAttribute("colFondo","" );
      ((Element)v.get(43)).setAttribute("ID","EstCab" );
      ((Element)v.get(43)).setAttribute("cod","PedTipoSolicPais.indVentInteSab14.label" );
      ((Element)v.get(33)).appendChild((Element)v.get(43));
      /* Termina nodo:43   */
      ...
      ((Element)v.get(44)).setAttribute("cod","PedTipoSolicPais.cactOidActi.label" );
      ((Element)v.get(33)).appendChild((Element)v.get(44));
      /* Termina nodo:44   */

      /* Empieza nodo:45 / Elemento padre: 33   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(45)).setAttribute("colFondo","" );
      ((Element)v.get(45)).setAttribute("ID","EstCab" );
      ((Element)v.get(45)).setAttribute("cod","PedTipoSolicPais.moneOidMone.label" );
      ((Element)v.get(33)).appendChild((Element)v.get(45));
      /* Termina nodo:45   */
      ...
      ((Element)v.get(46)).setAttribute("cod","PedTipoSolicPais.tmalOidTipoMoviAsig.label" );
      ((Element)v.get(33)).appendChild((Element)v.get(46));
      /* Termina nodo:46   */

      /* Empieza nodo:47 / Elemento padre: 33   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(47)).setAttribute("colFondo","" );
      ((Element)v.get(47)).setAttribute("ID","EstCab" );
      ((Element)v.get(47)).setAttribute("cod","PedTipoSolicPais.tmalOidTipoMoviRese.label" );
      ((Element)v.get(33)).appendChild((Element)v.get(47));
      /* Termina nodo:47   */
      ...
      ((Element)v.get(48)).setAttribute("cod","PedTipoSolicPais.tmalOidTipoMoviFact.label" );
      ((Element)v.get(33)).appendChild((Element)v.get(48));
      /* Termina nodo:48   */

      /* Empieza nodo:49 / Elemento padre: 33   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(49)).setAttribute("colFondo","" );
      ((Element)v.get(49)).setAttribute("ID","EstCab" );
      ((Element)v.get(49)).setAttribute("cod","PedTipoSolicPais.tidoOidTipoDocu.label" );
      ((Element)v.get(33)).appendChild((Element)v.get(49));
      /* Termina nodo:49   */
      ...
      ((Element)v.get(50)).setAttribute("cod","PedTipoSolicPais.indPermUnio.label" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(51)).setAttribute("cod","PedTipoSolicPais.indPediGtZona.label" );
      ...
      ((Element)v.get(52)).setAttribute("cod","PedTipoSolicPais.indCambVentBel.label" );
      ((Element)v.get(33)).appendChild((Element)v.get(52));
      /* Termina nodo:52   */

      /* Empieza nodo:53 / Elemento padre: 33   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(53)).setAttribute("colFondo","" );
      ((Element)v.get(53)).setAttribute("ID","EstCab" );
      ((Element)v.get(53)).setAttribute("cod","PedTipoSolicPais.almcOidAlma.label" );
      ((Element)v.get(33)).appendChild((Element)v.get(53));
      /* Termina nodo:53   */
      ...
      ((Element)v.get(54)).setAttribute("cod","PedTipoSolicPais.sociOidSoci.label" );
      ((Element)v.get(33)).appendChild((Element)v.get(54));
      /* Termina nodo:54   */

      /* Empieza nodo:55 / Elemento padre: 33   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(55)).setAttribute("colFondo","" );
      ((Element)v.get(55)).setAttribute("ID","EstCab" );
      ((Element)v.get(55)).setAttribute("cod","PedTipoSolicPais.valGlos.label" );
      ((Element)v.get(33)).appendChild((Element)v.get(55));
      /* Termina nodo:55   */

      /* Empieza nodo:56 / Elemento padre: 33   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(56)).setAttribute("colFondo","" );
      ((Element)v.get(56)).setAttribute("ID","EstCab" );
      ((Element)v.get(56)).setAttribute("cod","PedTipoSolicPais.tsolOidTipoCons.label" );
      ((Element)v.get(33)).appendChild((Element)v.get(56));
      /* Termina nodo:56   */
      /* Termina nodo:33   */

      /* Empieza nodo:57 / Elemento padre: 0   */
      v.add(doc.createElement("DATOS"));
      ((Element)v.get(57)).setAttribute("alto","22" );
      ((Element)v.get(57)).setAttribute("accion","" );
      ((Element)v.get(57)).setAttribute("tipoEnvio","seleccion" );
      ...
      ((Element)v.get(0)).appendChild((Element)v.get(57));
   ...
   private void getXML360(Document doc) {
      ...
      /* Empieza nodo:81 / Elemento padre: 0   */
      v.add(doc.createElement("ROWSET"));
      ((Element)v.get(0)).appendChild((Element)v.get(81));
      /* Termina nodo:81   */
