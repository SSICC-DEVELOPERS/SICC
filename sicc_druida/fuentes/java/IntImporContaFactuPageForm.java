...
public class IntImporContaFactuPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","IntImporContaFactu.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","IntImporContaFactu.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('intImporContaFactuFrm',0, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('intImporContaFactuFrm', 0, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(50)).setAttribute("nombre","codImpoContTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lblCodImpoCont" );
      ((Element)v.get(54)).setAttribute("alto","13" );
      ((Element)v.get(54)).setAttribute("filas","1" );
      ((Element)v.get(54)).setAttribute("id","datosTitle" );
      ((Element)v.get(54)).setAttribute("cod","IntImporContaFactu.codImpoCont.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(55)).setAttribute("nombre","codImpoContWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(57)).setAttribute("nombre","codImpoCont" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('intImporContaFactuFrm',0, true)" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('intImporContaFactuFrm', 0, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(58)).setAttribute("nombre","codImpoContGapTdId" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(75)).setAttribute("nombre","valIdenCabeDetaTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(79)).setAttribute("nombre","lblValIdenCabeDeta" );
      ((Element)v.get(79)).setAttribute("alto","13" );
      ((Element)v.get(79)).setAttribute("filas","1" );
      ((Element)v.get(79)).setAttribute("id","datosTitle" );
      ((Element)v.get(79)).setAttribute("cod","IntImporContaFactu.valIdenCabeDeta.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(80)).setAttribute("nombre","valIdenCabeDetaWidgetTrId" );
   }
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(82)).setAttribute("nombre","valIdenCabeDeta" );
      ...
      ((Element)v.get(82)).setAttribute("ontab","ejecutarAccionFoco('intImporContaFactuFrm',0, true)" );
      ((Element)v.get(82)).setAttribute("onshtab","ejecutarAccionFoco('intImporContaFactuFrm', 0, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(83)).setAttribute("nombre","valIdenCabeDetaGapTdId" );
   ...
   private void getXML450(Document doc) {
      ((Element)v.get(100)).setAttribute("nombre","valDescImpoTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(104)).setAttribute("nombre","lblValDescImpo" );
      ((Element)v.get(104)).setAttribute("alto","13" );
      ((Element)v.get(104)).setAttribute("filas","1" );
      ((Element)v.get(104)).setAttribute("id","datosTitle" );
      ((Element)v.get(104)).setAttribute("cod","IntImporContaFactu.valDescImpo.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(105)).setAttribute("nombre","valDescImpoWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(107)).setAttribute("nombre","valDescImpo" );
      ...
      ((Element)v.get(107)).setAttribute("ontab","ejecutarAccionFoco('intImporContaFactuFrm',0, true)" );
      ((Element)v.get(107)).setAttribute("onshtab","ejecutarAccionFoco('intImporContaFactuFrm', 0, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(108)).setAttribute("nombre","valDescImpoGapTdId" );
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(125)).setAttribute("nombre","valObseTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(130)).setAttribute("nombre","valObseWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(132)).setAttribute("nombre","valObse" );
      ...
      ((Element)v.get(132)).setAttribute("size","100" );
      ...
      ((Element)v.get(132)).setAttribute("ontab","ejecutarAccionFoco('intImporContaFactuFrm',0, true)" );
      ((Element)v.get(132)).setAttribute("onshtab","ejecutarAccionFoco('intImporContaFactuFrm', 0, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(133)).setAttribute("nombre","valObseGapTdId" );
   ...
   private void getXML630(Document doc) {
      ...
      /* Empieza nodo:147 / Elemento padre: 0   */
      v.add(doc.createElement("TR"));
      ((Element)v.get(147)).setAttribute("nombre","intImporContaFactuTrButtons" );
      ((Element)v.get(0)).appendChild((Element)v.get(147));
      ...
      ((Element)v.get(154)).setAttribute("nombre","intImporContaFactuTdQueryButton" );
      ((Element)v.get(153)).appendChild((Element)v.get(154));

      /* Empieza nodo:155 / Elemento padre: 154   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(155)).setAttribute("nombre","intImporContaFactuQueryButton" );
      ((Element)v.get(155)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(155)).setAttribute("estado","false" );
      ((Element)v.get(155)).setAttribute("accion","intImporContaFactuFirstPage();" );
      ...
      ((Element)v.get(156)).setAttribute("nombre","intImporContaFactuTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(158)).setAttribute("nombre","intImporContaFactuLovNullButton" );
      ((Element)v.get(158)).setAttribute("ID","botonContenido" );
      ((Element)v.get(158)).setAttribute("tipo","html" );
      ((Element)v.get(158)).setAttribute("accion","intImporContaFactuLovNullSelectionAction();" );
