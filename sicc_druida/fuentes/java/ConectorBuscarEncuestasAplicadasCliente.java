...
public class ConectorBuscarEncuestasAplicadasCliente  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector Buscar Encuesta Aplicada a Cliente" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","DTOEncuestaAplicadaPorCliente" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(8)).setAttribute("NOMBRE","DESC_RESP" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(9)).setAttribute("NOMBRE","DESC_PREG" );
