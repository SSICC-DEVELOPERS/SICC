...
public class PedTipoPosicPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","pedTipoPosicList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","PedTipoPosic.codTipoPosi.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","PedTipoPosic.Descripcion.label" );
