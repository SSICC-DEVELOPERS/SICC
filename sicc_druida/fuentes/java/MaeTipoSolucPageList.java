...
public class MaeTipoSolucPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","maeTipoSolucList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","MaeTipoSoluc.codTipoSolu.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","MaeTipoSoluc.Descripcion.label" );
