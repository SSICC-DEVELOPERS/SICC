...
public class ConectorGuardarAccionesProcesosBloqueo  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","MAE Guardar acciones procesos bloqueo" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","DTOAccionesProcesosBloqueo" );
