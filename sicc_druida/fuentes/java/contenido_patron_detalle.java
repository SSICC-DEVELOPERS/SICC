...
public class contenido_patron_detalle  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_patron_detalle" );
      ((Element)v.get(0)).setAttribute("cod","0238" );
      ((Element)v.get(0)).setAttribute("titulo","Consultar patrón" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","Consultar patrón" );
      ...
      v.add(doc.createTextNode("\r   \r\r  function onLoadPag()   {\r        var secciones = eval(get(\"frmFormulario.hdnSecciones\"));\r        configurarMenuSecundario('frmFormulario');\r				\r		/*\r		 * INC 22279 - dmorello, 09/01/2006\r		 * Se descomenta la primera línea del FOR para asignar un valor a ON_RSZ\r		 * a fin de que el ancho de las listas editables se ajuste al de la ventana\r		 * Además se hace que el ciclo vaya de 1 a secciones, por la forma en que\r		 * cada lista fue creada.\r		 *\r		 * dmorello, 17/02/2006\r		 * Se modifica el ciclo para que vaya de 0 a secciones - 1, ya que los\r		 * números de orden de secuencia empiezan en cero.\r		 */\r		for(i = 0; i < secciones; i++) {\r            DrdEnsanchaConMargenDcho('listaMensajesSeccion'+i,40);\r                                                			            						        }\r        eval (ON_RSZ);\r   }\r\r   function fVolver(){\r	this.close();\r   }\r   \r   \r"));
      ...
      ((Element)v.get(10)).setAttribute("valor","LPMantenimientoPatrones" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(16)).setAttribute("nombre","hOidPeriodo" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(17)).setAttribute("nombre","hOidPatronOrigen" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(18)).setAttribute("nombre","hOidPatronPeriodo" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(19)).setAttribute("nombre","hCodigoPatron" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(20)).setAttribute("nombre","hDescripcionPatron" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(21)).setAttribute("nombre","hCodigoFormulario" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(22)).setAttribute("nombre","hMedioEnvio" );
   ...
   private void getXML90(Document doc) {
      v.add(doc.createElement("VAR"));
      ((Element)v.get(23)).setAttribute("nombre","hActivo" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(24)).setAttribute("nombre","hPatronPeriodo" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(25)).setAttribute("nombre","hdnSecciones" );
      ...
      ((Element)v.get(26)).setAttribute("nombre","capaPrototipo" );
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(45)).setAttribute("width","740" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(57)).setAttribute("nombre","lblDesc" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(61)).setAttribute("nombre","lblFormulario" );
      ...
      ((Element)v.get(61)).setAttribute("cod","2285" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(68)).setAttribute("nombre","lblvalorCodigoPatron" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(72)).setAttribute("nombre","lblvalorDesc" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(76)).setAttribute("nombre","lblvalorFormulario" );
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(80)).setAttribute("colspan","9" );
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(84)).setAttribute("width","699" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(89)).setAttribute("nombre","lblMedioEnvio" );
      ...
      ((Element)v.get(89)).setAttribute("cod","913" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(93)).setAttribute("nombre","lblActivo" );
   ...
   private void getXML360(Document doc) {
      ((Element)v.get(93)).setAttribute("cod","795" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(97)).setAttribute("nombre","lblIndicadorPatronPeriodo" );
      ...
      ((Element)v.get(97)).setAttribute("cod","965" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(104)).setAttribute("nombre","lblvalorMedioEnvio" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(108)).setAttribute("nombre","lblvalorActivo" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(112)).setAttribute("nombre","lblvalorIndicadorPatronPeriodo" );
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(116)).setAttribute("colspan","9" );
   ...
   private void getXML450(Document doc) {
      ...
      /* Empieza nodo:118 / Elemento padre: 42   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(42)).appendChild((Element)v.get(118));
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(120)).setAttribute("width","699" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(125)).setAttribute("nombre","lblTipoPeriodo" );
      ...
      ((Element)v.get(125)).setAttribute("cod","132" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(129)).setAttribute("nombre","lblPeriodoCorporativo" );
      ...
      ((Element)v.get(129)).setAttribute("cod","2511" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(136)).setAttribute("nombre","lbldtTipoPeriodo" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(140)).setAttribute("nombre","lbldtPeriodoCorporativo" );
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(144)).setAttribute("colspan","9" );
      ...
      /* Empieza nodo:146 / Elemento padre: 35   */
      v.add(doc.createElement("td"));
      ((Element)v.get(35)).appendChild((Element)v.get(146));
      ...
      /* Empieza nodo:148 / Elemento padre: 27   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(27)).appendChild((Element)v.get(148));
      ...
      ((Element)v.get(155)).setAttribute("nombre","rejSecciones" );
