...
public class SegNacioPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","segNacioList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","SegNacio.codNaci.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","SegNacio.Descripcion.label" );
