...
public class CccSucurPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","cccSucurList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","CccSucur.cbanOidBanc.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","CccSucur.codSucu.label" );
      ...
      ((Element)v.get(17)).setAttribute("cod","CccSucur.valDire.label" );
      ...
      ((Element)v.get(18)).setAttribute("cod","CccSucur.valCiud.label" );
