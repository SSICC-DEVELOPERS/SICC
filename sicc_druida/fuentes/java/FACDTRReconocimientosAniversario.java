...
public class FACDTRReconocimientosAniversario extends LPSICCBase {           
   public FACDTRReconocimientosAniversario() {	 
     super();
  }
  ...
  public void ejecucion() throws Exception {	
     ...
     try {
        ...
        if (accion.equals("generar")){
          ...
          //cargarPagina();
                 ...
                 cargarPagina();
                 getConfiguracionMenu("FACDTRReconocimientosAniversario");
        }
    ...
    private void validarPeriodos() throws Exception{
	 ...
	 String mes = conectorParametroLimpia("hidMes", "", true);
  ...
  private void cargarPagina() throws Exception{
     pagina("contenido_reconocimiento_aniversario");   
     asignarAtributoPagina("cod","0814");  
     ...
     asignarAtributo("VAR", "lp", "valor", "FACDTRReconocimientosAniversario");
 ...
 private void generarReporte() throws Exception{
     ...
     //ejecutarReporte(datos, "REPGenerarReporte", "RFD-011", formato);
     ejecutarReporte2(datos, "REPGenerarReporteBatch", "RD_RFD-011", formato);
