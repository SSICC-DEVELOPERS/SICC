...
public class LPCreaMatrizDiasNoGrafica extends LPSICCBase {
    ...
    public LPCreaMatrizDiasNoGrafica() {
        super();
    }
    ...
    public void ejecucion() throws Exception {
        ...
        try {
            rastreo();
            if (accion.equals("")) {
                asignarAtributo("VAR","accion","valor","creaNoGrafica");
                asignarAtributo("VAR","varModo","valor",MODO_CREAR);
                asignarAtributo("VAR","varTipo","valor",TIPO_NOGRAFICA);
                // Invoca a LPMantieneMatrizDias cambiando la accion = "creaNoGrafica"
                conectorAction("LPMantieneMatrizDias");
                conectorActionParametro("accion","creaNoGrafica");
