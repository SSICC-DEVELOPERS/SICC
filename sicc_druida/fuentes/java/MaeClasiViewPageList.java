...
public class MaeClasiViewPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","maeClasiViewList" );
      ...
      ((Element)v.get(14)).setAttribute("cod","MaeClasiView.tcclOidTipoClas.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","MaeClasiView.codClas.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","MaeClasiView.Descripcion.label" );
