...
public class ConectorAgrupacionTipoSubtipoClasificacion  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","ConectorCargaInicialMonitor" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","DTOEDesglose" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","PEDAgrupacionTipoSubtipoClasificacion" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","TIPO_CLIENTE" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(8)).setAttribute("NOMBRE","OID_SUBTIPO_CLIENTE" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(9)).setAttribute("NOMBRE","SUBTIPO_CLIENTE" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(10)).setAttribute("NOMBRE","OID_TIPO_CLASIFICACION" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(11)).setAttribute("NOMBRE","TIPO_CLASIFICACION" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(12)).setAttribute("NOMBRE","OID_CLASIFICACION" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(13)).setAttribute("NOMBRE","CLASIFICACION" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(14)).setAttribute("NOMBRE","NRO_SOLICITUDES" );
      ((Element)v.get(14)).setAttribute("TIPO","ENTERO" );
