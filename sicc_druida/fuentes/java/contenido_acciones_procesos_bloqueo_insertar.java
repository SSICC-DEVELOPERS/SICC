...
public class contenido_acciones_procesos_bloqueo_insertar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_acciones_procesos_bloqueo_insertar" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(3)).setAttribute("src","contenido_acciones_procesos_bloqueo_insertar.js" );
      ...
      ((Element)v.get(6)).setAttribute("cod","3207" );
      ((Element)v.get(5)).appendChild((Element)v.get(6));
      /* Termina nodo:6   */

      /* Empieza nodo:7 / Elemento padre: 5   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(7)).setAttribute("name","cbProcesoBloqueo" );
      ((Element)v.get(7)).setAttribute("required","true" );
      ((Element)v.get(7)).setAttribute("cod","3208" );
      ((Element)v.get(5)).appendChild((Element)v.get(7));
      /* Termina nodo:7   */

      /* Empieza nodo:8 / Elemento padre: 5   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(8)).setAttribute("name","cbAccionBloqueo" );
      ((Element)v.get(8)).setAttribute("required","true" );
      ((Element)v.get(8)).setAttribute("cod","3209" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(33)).setAttribute("width","98%" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(41)).setAttribute("nombre","lblTipoBloqueo" );
      ...
      ((Element)v.get(41)).setAttribute("cod","3207" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(48)).setAttribute("nombre","cbTipoBloqueo" );
      ...
      ((Element)v.get(48)).setAttribute("onshtab","foco('formulario.cbAccionBloqueo');" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(60)).setAttribute("nombre","lblProcesoBloqueo" );
      ...
      ((Element)v.get(60)).setAttribute("cod","3208" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(64)).setAttribute("nombre","lblAccionBloqueo" );
      ...
      ((Element)v.get(64)).setAttribute("cod","3209" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(71)).setAttribute("nombre","cbProcesoBloqueo" );
      ...
      ((Element)v.get(71)).setAttribute("onchange","recargarComboAcciones();" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(76)).setAttribute("nombre","cbAccionBloqueo" );
      ...
      ((Element)v.get(76)).setAttribute("ontab","foco('formulario.cbTipoBloqueo');" );
