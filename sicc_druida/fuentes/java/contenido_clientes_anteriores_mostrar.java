...
public class contenido_clientes_anteriores_mostrar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_clientes_anteriores_mostrar" );
      ((Element)v.get(0)).setAttribute("cod","01050" );
      ...
      ((Element)v.get(1)).setAttribute("nombre","formulario" );
      ((Element)v.get(1)).setAttribute("oculto","N" );
      ((Element)v.get(0)).appendChild((Element)v.get(1));

      /* Empieza nodo:2 / Elemento padre: 1   */
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(2)).setAttribute("nombre","capa1" );
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(21)).setAttribute("width","499" );
      ((Element)v.get(21)).setAttribute("border","0" );
      ((Element)v.get(21)).setAttribute("align","left" );
   ...
   private void getXML90(Document doc) {
      v.add(doc.createElement("td"));
      ((Element)v.get(23)).setAttribute("colspan","4" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(29)).setAttribute("nombre","lblPaisNuevo" );
      ((Element)v.get(29)).setAttribute("alto","13" );
      ((Element)v.get(29)).setAttribute("filas","1" );
      ((Element)v.get(29)).setAttribute("valor","" );
      ((Element)v.get(29)).setAttribute("cod","3064" );
      ...
      ((Element)v.get(36)).setAttribute("nombre","cbPaisNuevo" );
      ((Element)v.get(36)).setAttribute("id","datosCampos" );
      ((Element)v.get(36)).setAttribute("size","1" );
      ((Element)v.get(36)).setAttribute("req","S" );
      ((Element)v.get(36)).setAttribute("multiple","N" );
      ((Element)v.get(36)).setAttribute("valorinicial","" );
      ((Element)v.get(36)).setAttribute("textoinicial","xxxxxxxxxxxxxx1" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(51)).setAttribute("nombre","lblClienteNuevo" );
      ((Element)v.get(51)).setAttribute("alto","13" );
      ((Element)v.get(51)).setAttribute("filas","1" );
      ((Element)v.get(51)).setAttribute("valor","" );
      ((Element)v.get(51)).setAttribute("id","datosTitle" );
      ((Element)v.get(51)).setAttribute("cod","3066" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(55)).setAttribute("nombre","lblClienteAntiguo" );
      ...
      ((Element)v.get(55)).setAttribute("cod","3067" );
      ...
      ((Element)v.get(62)).setAttribute("nombre","txtClienteNuevo" );
      ...
      ((Element)v.get(62)).setAttribute("onshtab","" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(74)).setAttribute("width","499" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(82)).setAttribute("nombre","lblSistemaProcedencia" );
      ((Element)v.get(82)).setAttribute("alto","13" );
      ((Element)v.get(82)).setAttribute("filas","1" );
      ((Element)v.get(82)).setAttribute("valor","" );
      ((Element)v.get(82)).setAttribute("cod","3068" );
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(89)).setAttribute("nombre","txtSistemaProcedencia" );
   ...
   private void getXML360(Document doc) {
      ...
      /* Empieza nodo:95 / Elemento padre: 18   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(18)).appendChild((Element)v.get(95));
      ...
      /* Empieza nodo:97 / Elemento padre: 11   */
      v.add(doc.createElement("td"));
      ((Element)v.get(11)).appendChild((Element)v.get(97));
