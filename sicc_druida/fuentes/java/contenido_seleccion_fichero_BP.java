...
public class contenido_seleccion_fichero_BP  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(2)).setAttribute("src","contenido_seleccion_fichero_BP.js" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(8)).setAttribute("nombre","seleccion" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(9)).setAttribute("nombre","mensaje" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(10)).setAttribute("nombre","longMinima" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(11)).setAttribute("nombre","nombreFile" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(12)).setAttribute("nombre","hidIdFuncion" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(43)).setAttribute("nombre","fichero1" );
      ((Element)v.get(43)).setAttribute("campo","f1.ruta" );
      ((Element)v.get(43)).setAttribute("comprimir","NO" );
      ((Element)v.get(43)).setAttribute("descomprimir","NO" );
      ((Element)v.get(43)).setAttribute("id","datosCampos" );
      ((Element)v.get(43)).setAttribute("idenviar","datosCampos" );
      ((Element)v.get(43)).setAttribute("max","100" );
      ((Element)v.get(43)).setAttribute("ON","LPObjetoFicheroUpload" );
      ((Element)v.get(43)).setAttribute("funcion","processFile(file)" );
      ((Element)v.get(43)).setAttribute("readonly","N" );
      ((Element)v.get(43)).setAttribute("cod","12" );
      ((Element)v.get(43)).setAttribute("size","100" );
      ((Element)v.get(43)).setAttribute("ontab","fichero1.focaliza()" );
      ((Element)v.get(43)).setAttribute("onshtab","fichero1.focalizaFinal()" );
