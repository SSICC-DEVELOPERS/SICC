...
public class Contenido_reporte_cobranza_externa_generar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_reporte_cobranza_externa_generar" );
      ((Element)v.get(0)).setAttribute("cod","0267" );
      ((Element)v.get(0)).setAttribute("titulo","Consultar cobranza externa" );
      ...
      v.add(doc.createTextNode("\r     \r    \r    var listadoVisible = false;  \r	\r    function onLoadPag()   \r	{\r\r        configurarMenuSecundario('frmFormulario');\r        DrdEnsanchaConMargenDcho('listado1',12);\r	    \r	    document.all[\"Cplistado1\"].style.visibility='hidden';\r	    document.all[\"CpLin1listado1\"].style.visibility='hidden';\r	    document.all[\"CpLin2listado1\"].style.visibility='hidden';\r	    document.all[\"CpLin3listado1\"].style.visibility='hidden';\r	    document.all[\"CpLin4listado1\"].style.visibility='hidden';\r\r	    document.all[\"primera1Div\"].style.visibility='hidden';\r	    document.all[\"ret1Div\"].style.visibility='hidden';\r	    document.all[\"ava1Div\"].style.visibility='hidden';\r	    document.all[\"separaDiv\"].style.visibility='hidden';\r        document.all[\"DetalleDiv\"].style.visibility='hidden';\r        document.all[\"CompromisoPagoDiv\"].style.visibility='hidden'; \r\r	    eval (ON_RSZ);  \r	}\r    \r    function marcaOnChange(){\r        recargarPeriodo();\r    }\r\r    function canalOnChange(){\r        recargarPeriodo();\r    }\r    \r    function tipoCargoOnchange(){\r        /*var arr = new Array();\r        arr[arr.length] = new Array(\"oid\",get('frmFormulario.cbTipoCargo'));\r        recargaCombo('frmFormulario.cbEtapaDeuda','COBObtenerEtapasDeudaPorTipoCargo', 'es.indra.sicc.util.DTOOID', arr);*/\r    }\r    \r    function recargarPeriodo(){\r      set_combo('frmFormulario.cbCodPeriodo', [[''],['']]);\r      if (get('frmFormulario.cbMarca') != ''  ||  get('frmFormulario.cbCanal') != '' )  {\r          var arr = new Array();\r          arr[arr.length] = new Array(\"oidPais\",get('frmFormulario.hPais'));\r          arr[arr.length] = new Array(\"marca\",get('frmFormulario.cbMarca'));\r          arr[arr.length] = new Array(\"canal\",get('frmFormulario.cbCanal'));\r          recargaCombo('frmFormulario.cbCodPeriodo', 'CRAObtienePeriodos', 'es.indra.sicc.dtos.cra.DTOPeriodo', arr);\r      }      \r    }\r    \r   function muestraLista(ultima, rowset) {\r        var tamano = rowset.length;\r        if (tamano > 0) {\r				mostrarLista();\r				return true;\r        }else{\r				ocultarLista();\r				return false;\r		  }\r		\r	}   \r\r	function mostrarLista(){\r	    document.all[\"Cplistado1\"].style.visibility='';\r	    document.all[\"CpLin1listado1\"].style.visibility='';\r	    document.all[\"CpLin2listado1\"].style.visibility='';\r	    document.all[\"CpLin3listado1\"].style.visibility='';\r	    document.all[\"CpLin4listado1\"].style.visibility='';\r\r	    document.all[\"primera1Div\"].style.visibility='';\r	    document.all[\"ret1Div\"].style.visibility='';\r	    document.all[\"ava1Div\"].style.visibility='';\r	    document.all[\"separaDiv\"].style.visibility='';\r        document.all[\"DetalleDiv\"].style.visibility='';\r        document.all[\"CompromisoPagoDiv\"].style.visibility='';\r        listadoVisible = true;\r	}\r\r	function ocultarLista(){\r	    document.all[\"Cplistado1\"].style.visibility='hidden';\r	    document.all[\"CpLin1listado1\"].style.visibility='hidden';\r	    document.all[\"CpLin2listado1\"].style.visibility='hidden';\r	    document.all[\"CpLin3listado1\"].style.visibility='hidden';\r	    document.all[\"CpLin4listado1\"].style.visibility='hidden';\r\r	    document.all[\"primera1Div\"].style.visibility='hidden';\r	    document.all[\"ret1Div\"].style.visibility='hidden';\r	    document.all[\"ava1Div\"].style.visibility='hidden';\r	    document.all[\"separaDiv\"].style.visibility='hidden';\r        document.all[\"DetalleDiv\"].style.visibility='hidden';\r        document.all[\"CompromisoPagoDiv\"].style.visibility='hidden';\r        listadoVisible = false;\r	}\r    \r    function buscarOnClick(){\r        /*\r        configurarPaginado(resultados, \"COBBuscarCobranzaExterna\", \r        \"ConectorBuscarCobranzaExterna\", \"DTOEBuscarCobranzaExterna\", \r        [ [\"pais\", get(pais de sesión)], [\"idioma\", get(idioma de sesión)], \r        [\"periodo\", get(periodo)], [\"etapasDeuda\", get(etapasDeuda)] ] ); (*) \r    \r        (*) \"etapasDeuda\" es un atributo de tipo String que llevará los oid seleccionados separados por comas \r    \r        */\r        \r        if ((get('frmFormulario.cbCodGrupoUsuario') != '') ||\r            (get('frmFormulario.cbCodUsuario') != '')){\r           	if(!sicc_validaciones_generales()){\r						return false;\r			   }  \r				var arr = new Array();\r            arr[arr.length] = new Array(\"oidPais\", get('frmFormulario.hPais'));\r            arr[arr.length] = new Array(\"oidIdioma\", get('frmFormulario.hIdioma'));\r            arr[arr.length] = new Array(\"periodo\", get('frmFormulario.cbCodPeriodo'));\r            arr[arr.length] = new Array(\"etapasDeuda\", get('frmFormulario.cbEtapaDeuda'));\r            arr[arr.length] = new Array(\"usuarioCobranza\", get('frmFormulario.cbCodUsuario'));\r            arr[arr.length] = new Array(\"grupoUsuarioCobranza\", get('frmFormulario.cbCodGrupoUsuario'));\r            \r            configurarPaginado(mipgndo,'COBBuscarCobranzaExterna','ConectorBuscarCobranzaExterna',\r                'es.indra.sicc.dtos.cob.DTOEBuscarCobranzaExterna',arr);\r        } else {\r            /*GestionarMensaje('UICOB0001');*/\r						GestionarMensaje('UICOB0006');\r        }\r    \r    }\r    \r	function compromisoOnClick(){\r		if(listado1.numSelecc()== 1){\r			var obj = new Object();\r			var oidGestion = listado1.codSeleccionados();\r			obj.hOidGestionCobranza = oidGestion;\r			var wndw = mostrarModalSICC('LPConsultarConsultorasPorTipoAccion','compromisoPago',obj);\r		} else {\r			GestionarMensaje('4');\r		}\r	}\r    \r	function detalleOnClick(){\r		if(listado1.numSelecc()== 1){\r			var obj = new Object();\r			var oidGestion = listado1.codSeleccionados();\r			obj.hOidGestionCobranza = oidGestion;\r			var wndw = mostrarModalSICC('LPConsultarConsultorasPorTipoAccion','detalle',obj);\r		} else {\r			GestionarMensaje('4');\r		}\r	}\r    \r    function onChange_UsuarioCOB(){\r        if (get('frmFormulario.cbCodUsuario') == ''){\r                        accion('frmFormulario.cbCodGrupoUsuario', '.disabled=false' );\r        } else {\r                        set('frmFormulario.cbCodGrupoUsuario', '');\r        }\r    }\r    \r    function onChange_grupoUsuarioCOB(){\r        if (get('frmFormulario.cbCodGrupoUsuario') == '') {\r            accion('frmFormulario.cbCodUsuario', '.disabled=false');\r                    } else {\r            set('frmFormulario.cbCodUsuario', '');\r                    }\r    }\r\r    \r  \r\r  "));
      ...
      ((Element)v.get(4)).setAttribute("name","cbEtapaDeuda" );
      ((Element)v.get(4)).setAttribute("required","true" );
      ((Element)v.get(4)).setAttribute("cod","866" );
      ...
      ((Element)v.get(9)).setAttribute("valor","LPConsultarCobranzaExterna" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(35)).setAttribute("width","640" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(43)).setAttribute("nombre","lblCodUsuario" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(47)).setAttribute("nombre","lblCodGrupoUsuario" );
      ...
      ((Element)v.get(47)).setAttribute("cod","2517" );
   }
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(58)).setAttribute("nombre","cbCodUsuario" );
      ...
      ((Element)v.get(58)).setAttribute("onchange","onChange_UsuarioCOB();" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(63)).setAttribute("nombre","cbCodGrupoUsuario" );
      ...
      ((Element)v.get(63)).setAttribute("onchange","onChange_grupoUsuarioCOB();" );
      ...
      ((Element)v.get(68)).setAttribute("onchange","tipoCargoOnchange();" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(77)).setAttribute("width","640" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(82)).setAttribute("nombre","lblEtapaDeuda" );
      ...
      ((Element)v.get(82)).setAttribute("cod","866" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(89)).setAttribute("nombre","cbEtapaDeuda" );
   ...
   private void getXML360(Document doc) {
      ...
      /* Empieza nodo:96 / Elemento padre: 32   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(32)).appendChild((Element)v.get(96));
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(98)).setAttribute("width","640" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(111)).setAttribute("nombre","lblCodPeriodo" );
      ...
      ((Element)v.get(111)).setAttribute("cod","30" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(118)).setAttribute("nombre","cbMarca" );
      ...
      ((Element)v.get(118)).setAttribute("onchange","marcaOnChange();" );
      ...
      ((Element)v.get(123)).setAttribute("onchange","canalOnChange();" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(128)).setAttribute("nombre","cbCodPeriodo" );
      ...
      /* Empieza nodo:132 / Elemento padre: 98   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(98)).appendChild((Element)v.get(132));
      ...
      /* Empieza nodo:135 / Elemento padre: 25   */
      v.add(doc.createElement("td"));
      ((Element)v.get(25)).appendChild((Element)v.get(135));
      ...
      /* Empieza nodo:137 / Elemento padre: 17   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(17)).appendChild((Element)v.get(137));
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(145)).setAttribute("accion","buscarOnClick();" );
      ...
      /* Empieza nodo:148 / Elemento padre: 17   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(17)).appendChild((Element)v.get(148));
      ...
      /* Empieza nodo:155 / Elemento padre: 8   */
      v.add(doc.createElement("LISTAEDITABLE"));
      ((Element)v.get(155)).setAttribute("nombre","listado1" );
      ((Element)v.get(155)).setAttribute("ancho","644" );
      ((Element)v.get(155)).setAttribute("alto","317" );
      ((Element)v.get(155)).setAttribute("x","12" );
      ((Element)v.get(155)).setAttribute("y","248" );
      ((Element)v.get(155)).setAttribute("colorFondo","#CECFCE" );
      ((Element)v.get(155)).setAttribute("msgDebugJS","S" );
      ((Element)v.get(8)).appendChild((Element)v.get(155));
      ...
      ((Element)v.get(159)).setAttribute("ordenar","ascendente_on.gif" );
      ((Element)v.get(159)).setAttribute("ordenarInv","descendente_on.gif" );
   ...
   private void getXML630(Document doc) {
      ...
      ((Element)v.get(165)).setAttribute("botonOrdenar","S" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(175)).setAttribute("ancho","150" );
   ...
   private void getXML720(Document doc) {
      ...
      ((Element)v.get(178)).setAttribute("cod","120" );
      ...
      ((Element)v.get(184)).setAttribute("cod","30" );
      ...
      ((Element)v.get(186)).setAttribute("cod","999" );
      ...
      ((Element)v.get(188)).setAttribute("cod","263" );
      ...
      ((Element)v.get(190)).setAttribute("cod","1039" );
      ...
      ((Element)v.get(192)).setAttribute("cod","1141" );
      ...
      /* Empieza nodo:200 / Elemento padre: 155   */
      v.add(doc.createElement("DATOS"));
      ((Element)v.get(200)).setAttribute("alto","22" );
      ((Element)v.get(200)).setAttribute("accion","" );
      ((Element)v.get(200)).setAttribute("tipoEnvio","edicion" );
      ((Element)v.get(200)).setAttribute("formaEnvio","xml" );
      ((Element)v.get(200)).setAttribute("maxSel","-1" );
      ((Element)v.get(200)).setAttribute("msgErrMaxSel","" );
      ((Element)v.get(200)).setAttribute("coloresScrollNativo","#D4D0C8,black,white,#D4D0C8,#D4D0C8,#ECE9E4,black" );
      ((Element)v.get(200)).setAttribute("colorROver","#D0D9E8" );
      ((Element)v.get(200)).setAttribute("onLoad","" );
      ((Element)v.get(200)).setAttribute("colorSelecc","#D0D9E8" );
      ((Element)v.get(155)).appendChild((Element)v.get(200));
   ...
   private void getXML810(Document doc) {
      ...
      /* Empieza nodo:206 / Elemento padre: 200   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(206)).setAttribute("tipo","texto" );
      ((Element)v.get(206)).setAttribute("ID","EstDat2" );
      ((Element)v.get(200)).appendChild((Element)v.get(206));
      /* Termina nodo:206   */
      ...
      /* Empieza nodo:212 / Elemento padre: 155   */
      v.add(doc.createElement("ROWSET"));
      ((Element)v.get(155)).appendChild((Element)v.get(212));
      /* Termina nodo:212   */

      /* Empieza nodo:213 / Elemento padre: 155   */
      v.add(doc.createElement("PAGINADO"));
      ((Element)v.get(213)).setAttribute("nombre","mipgndo" );
      ((Element)v.get(213)).setAttribute("ancho","644" );
      ((Element)v.get(213)).setAttribute("sep","$" );
      ((Element)v.get(213)).setAttribute("x","12" );
      ((Element)v.get(213)).setAttribute("class","botonera" );
      ((Element)v.get(213)).setAttribute("y","542" );
      ((Element)v.get(213)).setAttribute("control","|" );
      ((Element)v.get(213)).setAttribute("conector","conector_prototipo_2" );
      ...
      ((Element)v.get(215)).setAttribute("y","546" );
   ...
   private void getXML900(Document doc) {
      ...
      ((Element)v.get(217)).setAttribute("y","542" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(218)).setAttribute("nombre","Detalle" );
      ((Element)v.get(218)).setAttribute("x","80" );
      ((Element)v.get(218)).setAttribute("y","543" );
      ...
      ((Element)v.get(218)).setAttribute("cod","3" );
      ((Element)v.get(218)).setAttribute("accion","detalleOnClick();" );
      ((Element)v.get(8)).appendChild((Element)v.get(218));
      /* Termina nodo:218   */

      /* Empieza nodo:219 / Elemento padre: 8   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(219)).setAttribute("nombre","CompromisoPago" );
      ((Element)v.get(219)).setAttribute("x","128" );
      ((Element)v.get(219)).setAttribute("y","543" );
      ...
      ((Element)v.get(219)).setAttribute("cod","2515" );
      ((Element)v.get(219)).setAttribute("accion","compromisoOnClick();" );
      ...
      ((Element)v.get(220)).setAttribute("y","565" );
