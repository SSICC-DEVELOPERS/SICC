...
public class MaeClienPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","maeClienList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(26)).setAttribute("cod","MaeClien.codClie.label" );
      ...
      ((Element)v.get(27)).setAttribute("cod","MaeClien.indFichInsc.label" );
      ...
      ((Element)v.get(28)).setAttribute("cod","MaeClien.paisOidPais.label" );
      ...
      ((Element)v.get(29)).setAttribute("cod","MaeClien.codDigiCtrl.label" );
      ...
      ((Element)v.get(30)).setAttribute("cod","MaeClien.valApe1.label" );
      ...
      ((Element)v.get(31)).setAttribute("cod","MaeClien.valApe2.label" );
      ...
      ((Element)v.get(32)).setAttribute("cod","MaeClien.valNom1.label" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(33)).setAttribute("cod","MaeClien.valNom2.label" );
      ...
      ((Element)v.get(34)).setAttribute("cod","MaeClien.valTrat.label" );
      ...
      ((Element)v.get(35)).setAttribute("cod","MaeClien.valCritBus1.label" );
      ...
      ((Element)v.get(36)).setAttribute("cod","MaeClien.valCritBus2.label" );
      ...
      ((Element)v.get(37)).setAttribute("cod","MaeClien.codSexo.label" );
      ...
      ((Element)v.get(38)).setAttribute("cod","MaeClien.fecIngr.label" );
      ...
      ((Element)v.get(39)).setAttribute("cod","MaeClien.fopaOidFormPago.label" );
      ...
      ((Element)v.get(40)).setAttribute("cod","MaeClien.valApelCasa.label" );
      ((Element)v.get(25)).appendChild((Element)v.get(40));
      /* Termina nodo:40   */
      /* Termina nodo:25   */

      /* Empieza nodo:41 / Elemento padre: 0   */
      v.add(doc.createElement("DATOS"));
      ((Element)v.get(41)).setAttribute("alto","22" );
      ((Element)v.get(41)).setAttribute("accion","" );
      ((Element)v.get(41)).setAttribute("tipoEnvio","seleccion" );
      ((Element)v.get(41)).setAttribute("formaEnvio","xml" );
      ((Element)v.get(41)).setAttribute("maxSel","1" );
      ((Element)v.get(41)).setAttribute("msgErrMaxSel","" );
      ((Element)v.get(41)).setAttribute("coloresScrollNativo","#D4D0C8,black,white,#D4D0C8,#D4D0C8,#ECE9E4,black" );
      ((Element)v.get(41)).setAttribute("colorROver","#D0D9E8" );
      ((Element)v.get(41)).setAttribute("onLoad","" );
      ((Element)v.get(41)).setAttribute("colorSelecc","#D0D9E8" );
      ((Element)v.get(0)).appendChild((Element)v.get(41));
