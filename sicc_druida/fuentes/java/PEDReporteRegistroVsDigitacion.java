...
public class PEDReporteRegistroVsDigitacion extends LPSICCBase {   
  
   Long pais = null;
   Long idioma = null;

   public PEDReporteRegistroVsDigitacion() {	 
     super();
  }
     ...
     try {
        ...
        if (accion.equals("generar")){
          ...
          //cargarPagina();
           ...
           cargarPagina();
           getConfiguracionMenu("PEDReporteRegistroVsDigitacion");
        }
  ...
  private void cargarPagina() throws Exception{
      pagina("contenido_informe_registro_digitacion_generar");   
 ...
 private void generarReporte() throws Exception{
   // pagina("contenido_generando_fichero");
     ...
     String nloteinicio    = conectorParametroLimpia("nloteinicio", "", true);
     if(!nloteinicio.equals("")){
        datos.put(ConstantesREP.LOTEINICIO, nloteinicio);     
     }     

     String nlotefin    = conectorParametroLimpia("nlotefin", "", true);
     if(!nlotefin.equals("")){
        datos.put(ConstantesREP.LOTEFIN, nlotefin);     
     }     
     
     datos.put(ConstantesREP.TITULO, "Reporte de Lotes");
          
     traza("++++++Antes de enviar a reportes " + datos); 
     //ejecutarReporte(datos, "REPGenerarReporte", "RD_REP-025", null);
     ejecutarReporte2(datos, "REPGenerarReporteBatch", "RD_REP-025", "pdf");
