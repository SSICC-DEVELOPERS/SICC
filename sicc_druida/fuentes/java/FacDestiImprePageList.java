...
public class FacDestiImprePageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","facDestiImpreList" );
      ...
      ((Element)v.get(12)).setAttribute("cod","FacDestiImpre.desDest.label" );
