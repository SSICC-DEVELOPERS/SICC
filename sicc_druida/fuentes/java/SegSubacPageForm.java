...
public class SegSubacPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","SegSubac.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","SegSubac.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('segSubacFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('segSubacFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(50)).setAttribute("nombre","acceOidAcce_canaOidCanaTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lblacceOidAcce_canaOidCana" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(55)).setAttribute("nombre","acceOidAcce_canaOidCanaWidgetTrId" );
      ...
      ((Element)v.get(57)).setAttribute("nombre","acceOidAcce_canaOidCana" );
      ...
      ((Element)v.get(57)).setAttribute("onchange","mmgDependeneChange('acceOidAcce_canaOidCana', 'acceOidAcce' , 'segSubac')" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","focaliza('segSubacFrm.acceOidAcce');" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('segSubacFrm',2, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(59)).setAttribute("nombre","acceOidAcce_canaOidCanaGapTdId" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(61)).setAttribute("nombre","acceOidAcceTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(65)).setAttribute("nombre","lblacceOidAcce" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(66)).setAttribute("nombre","acceOidAcceWidgetTrId" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(68)).setAttribute("nombre","acceOidAcce" );
      ...
      ((Element)v.get(68)).setAttribute("ontab","ejecutarAccionFoco('segSubacFrm',2, true);" );
      ((Element)v.get(68)).setAttribute("onshtab","focaliza('segSubacFrm.acceOidAcce_canaOidCana');" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(70)).setAttribute("nombre","acceOidAcceGapTdId" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(87)).setAttribute("nombre","codSbacTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(91)).setAttribute("nombre","lblCodSbac" );
      ((Element)v.get(91)).setAttribute("alto","13" );
      ((Element)v.get(91)).setAttribute("filas","1" );
      ((Element)v.get(91)).setAttribute("id","datosTitle" );
      ((Element)v.get(91)).setAttribute("cod","SegSubac.codSbac.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(92)).setAttribute("nombre","codSbacWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(94)).setAttribute("nombre","codSbac" );
      ...
      ((Element)v.get(94)).setAttribute("ontab","ejecutarAccionFoco('segSubacFrm',3, true)" );
      ((Element)v.get(94)).setAttribute("onshtab","ejecutarAccionFoco('segSubacFrm', 3, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(95)).setAttribute("nombre","codSbacGapTdId" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(112)).setAttribute("nombre","DescripcionTdId" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(117)).setAttribute("nombre","DescripcionTdLocalizationButtonGapHeader" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(118)).setAttribute("nombre","DescripcionWidgetTrId" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(120)).setAttribute("max","30" );
      ((Element)v.get(120)).setAttribute("onchange","" );
      ((Element)v.get(120)).setAttribute("req","N" );
      ((Element)v.get(120)).setAttribute("size","30" );
      ...
      ((Element)v.get(120)).setAttribute("ontab","ejecutarAccionFoco('segSubacFrm',4, true)" );
      ((Element)v.get(120)).setAttribute("onshtab","ejecutarAccionFoco('segSubacFrm', 4, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(123)).setAttribute("nombre","DescripcionTdLocalizationButton" );
      ...
      ((Element)v.get(124)).setAttribute("id","DescripcionLocalizationButton" );
      ((Element)v.get(124)).setAttribute("href","javascript:openLocalizationDialog('segSubacFrm', 'Descripcion', 1);" );
      ((Element)v.get(124)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"segSubacFrm\",4, true)', 'ejecutarAccionFoco(\"segSubacFrm\",4, false)')" );
      ((Element)v.get(123)).appendChild((Element)v.get(124));

      /* Empieza nodo:125 / Elemento padre: 124   */
      v.add(doc.createElement("IMG"));
      ((Element)v.get(125)).setAttribute("nombre","DescripcionLocalizationButton" );
      ...
      ((Element)v.get(125)).setAttribute("class","main" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(126)).setAttribute("nombre","DescripcionGapTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(131)).setAttribute("nombre","formGapTr3" );
   ...
   private void getXML630(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(140)).setAttribute("nombre","segSubacTrButtons" );
      ...
      ((Element)v.get(147)).setAttribute("nombre","segSubacTdQueryButton" );
      ((Element)v.get(146)).appendChild((Element)v.get(147));

      /* Empieza nodo:148 / Elemento padre: 147   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(148)).setAttribute("nombre","segSubacQueryButton" );
      ((Element)v.get(148)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(148)).setAttribute("estado","false" );
      ((Element)v.get(148)).setAttribute("accion","segSubacFirstPage();" );
      ...
      ((Element)v.get(149)).setAttribute("nombre","segSubacTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(151)).setAttribute("nombre","segSubacLovNullButton" );
      ((Element)v.get(151)).setAttribute("ID","botonContenido" );
      ((Element)v.get(151)).setAttribute("tipo","html" );
      ((Element)v.get(151)).setAttribute("accion","segSubacLovNullSelectionAction();" );
