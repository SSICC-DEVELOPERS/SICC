...
public class RECAntiguReclamosCampana extends LPSICCBase {           
   public RECAntiguReclamosCampana() {	 
     super();
  }
     ...
     try {
        ...
        if (accion.equals("generar")){
          ...
          //cargarPagina();
           ...
           cargarPagina();
           getConfiguracionMenu("RECAntiguReclamosCampana");
        }
  ...
  private void cargarPagina() throws Exception{
     pagina("contenido_informe_reclamos_ingresados_campana_generar");
     
     asignarAtributoPagina("cod", "0914");
     asignarAtributo("VAR", "lp", "valor", "RECAntiguReclamosCampana");
 ...
 private void generarReporte() throws Exception{
     ...
     String tipoDetalle        = conectorParametroLimpia("tipoDetalle", "", true);
     String reporte = null;
     
     if(tipoDetalle.equals("1")){
        reporte = "RD_REP-112";
     }else{
        reporte = "RD_REP-112_01";
     }
     ...
     datos.put(ConstantesREP.TITULO, "Antigüedad de Reclamos Ingresados en una Campaña");     
     traza("++++++Antes de enviar a reportes " + datos); 
        
     
     traza("el formaro es  " + formato);
     //ejecutarReporte(datos, "REPGenerarReporte", "RD_REP-112", formato);
