...
public class CobGuionArgumCabecViewPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","cobGuionArgumCabecViewList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","CobGuionArgumCabecView.codGuiaArgu.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","CobGuionArgumCabecView.Descripcion.label" );
