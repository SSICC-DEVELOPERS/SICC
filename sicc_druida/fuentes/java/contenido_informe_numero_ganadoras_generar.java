...
public class contenido_informe_numero_ganadoras_generar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("cod","0876" );
      ...
      v.add(doc.createTextNode("\r  \r   \r  \r  function onLoad(){\r    \r    configurarMenuSecundario('Formulario');\r    fMostrarMensajeError();\r    setearPais();\r    set('Formulario.txtAno',get('Formulario.anioDefault'));\r    set('Formulario.txtPorcentajeGanadoras','5');\r    focaliza('Formulario.cbPais');\r  \r  }\r\r  \r  function setearPais(){\r  \r    var pais = get('Formulario.pais');\r    \r    iSeleccionado = new Array();\r    iSeleccionado[0] = pais;\r    set('Formulario.cbPais',iSeleccionado);\r  \r  }\r  \r  \r  function fLimpiar(){\r    \r    set('Formulario.txtAno','');\r    \r    set('Formulario.txtAno',get('Formulario.anioDefault'));\r    set('Formulario.txtPorcentajeGanadoras','5');\r    \r    focaliza('Formulario.cbPais');\r    \r  }\r   \r  \r  function generar(formato){\r    \r    if(sicc_validaciones_generales()){\r         \r      var a = new Object();\r      a.accion = 'generar';\r           \r      a.pais = get('Formulario.cbPais');  \r      a.marca = get('Formulario.cbMarca');\r      a.canal = get('Formulario.cbCanal');\r      a.anio = get('Formulario.txtAno');\r      a.porcentajeGanadoras = get('Formulario.txtPorcentajeGanadoras');\r      \r      a.formato = formato;\r      \r      mostrarModalSICC('INCReconocimientoGanadoras','generar', a);\r      \r    }\r\r  }\r  \r\r\r  "));
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(10)).setAttribute("name","txtAno" );
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(11)).setAttribute("name","txtPorcentajeGanadoras" );
      ((Element)v.get(11)).setAttribute("required","true" );
      ((Element)v.get(11)).setAttribute("cod","2716" );
      ((Element)v.get(11)).setAttribute("format","e" );
      ((Element)v.get(11)).setAttribute("min","1" );
      ((Element)v.get(11)).setAttribute("max","100" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(55)).setAttribute("multiple","S" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(114)).setAttribute("nombre","txtPorcentajeGanadoras" );
   ...
   private void getXML450(Document doc) {
      ...
      /* Empieza nodo:122 / Elemento padre: 22   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(22)).appendChild((Element)v.get(122));
      ...
      ((Element)v.get(130)).setAttribute("accion","generar('pdf')" );
      ...
      /* Empieza nodo:133 / Elemento padre: 22   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(22)).appendChild((Element)v.get(133));
