...
public class contenido_comisiones_modificar_autorizar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_comisiones_modificar_autorizar" );
      ...
      v.add(doc.createTextNode("\r  \r\r   function onLoadPag()   \r   {\r		configurarMenuSecundario(\"formulario\");\r		ocultaLista1();\r		document.all[\"btnModificarDiv\"].style.visibility='hidden';\r		document.all[\"btnConfirmarDiv\"].style.visibility='hidden';\r		eval(ON_RSZ);	\r		fMostrarMensajeError();	  \r		focaliza(\"formulario.cbEstadoComision\");\r\r		btnProxy(1,0);\r		btnProxy(2,1);\r		btnProxy(3,1);\r		btnProxy(4,0);\r		btnProxy(5,0);\r		btnProxy(6,1);\r		btnProxy(7,1);\r		btnProxy(8,1);\r		btnProxy(9,0);\r		btnProxy(10,1);\r   }\r\r   function ocultaLista1()\r   {\r		DrdEnsanchaConMargenDcho('listado1',12);	    \r	    document.all[\"Cplistado1\"].style.visibility='hidden';\r	    document.all[\"CpLin1listado1\"].style.visibility='hidden';\r	    document.all[\"CpLin2listado1\"].style.visibility='hidden';\r	    document.all[\"CpLin3listado1\"].style.visibility='hidden';\r	    document.all[\"CpLin4listado1\"].style.visibility='hidden';\r	    document.all[\"primera1Div\"].style.visibility='hidden';\r	    document.all[\"ret1Div\"].style.visibility='hidden';\r	    document.all[\"ava1Div\"].style.visibility='hidden';\r	    document.all[\"separaDiv\"].style.visibility='hidden';\r   }\r\r   /*Este método javascript se ejecuta cuando pulsa sobre btnBuscar. \r	Se carga la lista lstResultados con las comisiones que cumplen el criterio de búsqueda especificado por el usuario. \r	Proceso: \r	======= \r	configurarPaginado(lstResultados, \"COMBuscarAceptarModificacion\", \"ConectorBuscarAceptarModificacion\", \"DTOEstadoComision\", [ [\"pais\", get(país de la sesión)], [\"idioma\", get(idioma de la sesión)], [\"oidEstadoComision\", get(cmbEstado)] );\r	------------\r	cmbEstadoComision\r	*/\r   function onClickBuscar()\r   {\r						        configurarPaginado(mipgndo,\"COMBuscarAceptarModificacion\",\r		                           \"ConectorBuscarAceptarModificacion\",\r	                               \"es.indra.sicc.dtos.com.DTOEstadoComision\",armarArray());\r				document.all[\"Cplistado1\"].style.visibility='';\r				document.all[\"CpLin1listado1\"].style.visibility='';\r				document.all[\"CpLin2listado1\"].style.visibility='';\r				document.all[\"CpLin3listado1\"].style.visibility='';\r				document.all[\"CpLin4listado1\"].style.visibility='';\r				document.all[\"primera1Div\"].style.visibility='';\r				document.all[\"ret1Div\"].style.visibility='';\r				document.all[\"ava1Div\"].style.visibility='';\r				document.all[\"separaDiv\"].style.visibility='';\r				document.all[\"btnModificarDiv\"].style.visibility='visible';\r		        document.all[\"btnConfirmarDiv\"].style.visibility='visible';\r		\r				deshabilitarHabilitarBoton('botonContenido','btnModificar','A');\r		deshabilitarHabilitarBoton('botonContenido','btnConfirmar','A');\r   }\r\r\r      function testLoadDTOSalida()\r   {  obj = new Object();var posicion = obtenerPosicionListaEditable(listado1.codSeleccionados(),listado1);\r	  obj.oid = listado1.datos[posicion][1]\r	  obj.bid = 'COMCargaConfirmarModificar'\r	  obj.con = 'ConectorCargaConfirmarModificar'\r	  	  	  mostrarModalSICC('LPMantenimientoComisiones','test', obj, 600, 160);	 \r   }\r      /*eval('formulario').oculto = 'S'\r	  set('formulario.conectorAction', 'LPDosMantenimientoComisiones')\r	  set('formulario.accion', 'ConfirmarAceptar')\r	  enviaSICC('formulario', null, null, 'N')*/\r\r\r   function armarArray()\r   {\r     var arr = new Array();      \r	 arr[arr.length] = new Array(\"oidPais\", get(\"formulario.varOidPais\"));\r	 arr[arr.length] = new Array(\"oidIdioma\", get(\"formulario.varOidIdioma\")); \r	 arr[arr.length] = new Array(\"oidEstadoComision\", get(\"formulario.cbEstadoComision\")); \r	      return arr;  \r   }\r\r   /*\r    Cuando se selecciona una fila de la lista lstResultados \r	Proceso \r	======== \r		Si la columna oidEstadoComision de la fila seleccionada == ConstantesCOM.ESTADO_COMISION_SOLICITUD_CAMBIO \r		Se habilita el botón btnPermitir \r		Se deshabilita el botón btnConfirmar \r		Si no \r		Se deshabilita el botón btnPermitir \r		Se habilita el botón btnConfirmar \r		Fin del Si\r	------------\r	 cargar ConstantesCOM.ESTADO_COMISION_SOLICITUD_CAMBIO en var de pagina\r	*/\r   function onSeleccionaComision()\r   {\r       if(listado1.numSelecc() == 1)\r	   {\r         var posicion = obtenerPosicionListaEditable(listado1.codSeleccionados(),listado1);\r		 		 if(''+listado1.datos[posicion][10] == get(\"formulario.varEstadoComisionSolicitudCambio\"))\r		 {\r             			 /* dmorello, 29/05/2006: En lugar de modificar la visibilidad, se activan o desactivan los botones, tal como dice el DMCO */\r			 			 			 deshabilitarHabilitarBoton('botonContenido','btnModificar','A');\r			 deshabilitarHabilitarBoton('botonContenido','btnConfirmar','D');\r\r		 }\r		 else\r		 {\r             			 /* dmorello, 29/05/2006: En lugar de modificar la visibilidad, se activan o desactivan los botones, tal como dice el DMCO */\r			 			 			 deshabilitarHabilitarBoton('botonContenido','btnModificar','D');\r			 deshabilitarHabilitarBoton('botonContenido','btnConfirmar','A');\r		 }\r	   }\r   }\r\r   /*Este método se ejecuta cuando pulsa sobre btnPermitir = btnModificar \r	Proceso: \r	======= \r		Si hay seleccionada una fila en lstResultados \r		Se abre una ventana emergente modal y en la nueva ventana se invoca LPMantenimientoComisiones con: \r		accion = \"PermitirModificar\" \r		oidComision = columna oid de la fila seleccionada en lstResultados \r		Se refresca lstResultados \r		Fin del Si\r   */\r   function onClickPermitir()\r   {\r       if(listado1.numSelecc() == 1)\r	   {\r          var posicion = obtenerPosicionListaEditable(listado1.codSeleccionados(),listado1);\r		  obj = new Object()\r		  obj.oidComision = listado1.datos[posicion][1]\r		  		  vWnd = mostrarModalSICC('LPMantenimientoComisiones','PermitirModificar', obj, 600, 160);\r		  onClickBuscar()\r	   }\r   }\r   \r   /*Este método se ejecuta cuando pulsa sobre btnConfirmar. \r	Proceso: \r	======= \r		Si hay seleccionada una fila en lstResultados \r		Se abre una ventana emergente modal y en la nueva ventana se invoca LPMantenimientoComisiones con: \r		accion = \"ConfirmarModificar\" \r		oidComision = columna oid de la fila seleccionada en lstResultados \r		codComision = columna codigo de la fila seleccionada en lstResultados \r		version = columna version de la fila seleccionada en lstResultados \r		descripcion = columna descripcion de la fila seleccionada en lstResultados \r		tipoComision = columna tipoComision de la fila seleccionada en lstResultados \r		marca = columna marca de la fila seleccionada en lstResultados \r		canal = columna canal de la fila seleccionada en lstResultados \r		acceso = columna acceso de la fila seleccionada en lstResultados \r		concepto = columna concepto de la fila seleccionada en lstResultados \r\r		fecIniVigor = columna fecIniVigor de la fila seleccionada en lstResultados \r\r		Se refresca lstResultados \r		Fin del Si\r   */\r   function onClickConfirmar()\r   {\r       if(listado1.numSelecc() == 1)\r	   {\r          var posicion = obtenerPosicionListaEditable(listado1.codSeleccionados(),listado1);\r		  obj = new Object()		  \r		  obj.oidComision = listado1.datos[posicion][1]\r		  obj.codComision = listado1.datos[posicion][2]\r		  obj.version = listado1.datos[posicion][3]\r		  obj.descripcion = listado1.datos[posicion][4]		  \r		  obj.marca = listado1.datos[posicion][5]\r		  obj.canal = listado1.datos[posicion][6]\r		  obj.acceso = listado1.datos[posicion][7]\r		  obj.tipoComision = listado1.datos[posicion][8]\r		  obj.concepto = listado1.datos[posicion][9]\r		  obj.fecIniVigor = listado1.datos[posicion][11]\r\r		  vWnd = mostrarModalSICC('LPMantenimientoComisiones','ConfirmarModificar',obj, 800, 520)\r		  onClickBuscar()\r	   }else\r	   {  if(listado1.numSelecc() > 1)\r			 cdos_mostrarAlert(GestionarMensaje(\"240\"));		  \r		   else\r		   {  if(listado1.numSelecc() < 1)\r				 GestionarMensaje(\"4\");\r		   }\r	   }\r   }\r\r   function toDetalle()\r   {\r	   if(document.all[\"btnConfirmarDiv\"].style.visibility == 'visible')\r		 focalizaBotonHTML('botonContenido','btnConfirmar');\r	   else\r	   {\r		 if(arguments[0])\r			 focalizaBotonHTML('botonContenido','btnBuscar');\r		 else\r			 focaliza('formulario.cbEstadoComision');\r	   }\r   }\r\r\r  \r"));
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(11)).setAttribute("nombre","varOidPais" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(12)).setAttribute("nombre","varOidIdioma" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(13)).setAttribute("nombre","varEstadoComisionSolicitudCambio" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(41)).setAttribute("nombre","lblEstadoComision" );
      ...
      ((Element)v.get(41)).setAttribute("cod","1713" );
      ...
      ((Element)v.get(48)).setAttribute("nombre","cbEstadoComision" );
   }
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(48)).setAttribute("valorinicial","" );
      ((Element)v.get(48)).setAttribute("textoinicial","" );
      ((Element)v.get(48)).setAttribute("onshtab","toDetalle(true)" );
      ...
      ((Element)v.get(65)).setAttribute("nombre","btnBuscar" );
      ((Element)v.get(65)).setAttribute("ID","botonContenido" );
      ((Element)v.get(65)).setAttribute("tipo","html" );
      ((Element)v.get(65)).setAttribute("accion","onClickBuscar();" );
      ((Element)v.get(65)).setAttribute("estado","true" );
      ((Element)v.get(65)).setAttribute("cod","1" );
      ((Element)v.get(65)).setAttribute("ontab","toDetalle(false)" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(75)).setAttribute("nombre","listado1" );
      ((Element)v.get(75)).setAttribute("ancho","404" );
      ((Element)v.get(75)).setAttribute("alto","317" );
      ((Element)v.get(75)).setAttribute("x","12" );
      ((Element)v.get(75)).setAttribute("y","123" );
      ((Element)v.get(75)).setAttribute("colorFondo","#CECFCE" );
      ((Element)v.get(75)).setAttribute("msgDebugJS","S" );
      ((Element)v.get(6)).appendChild((Element)v.get(75));

      /* Empieza nodo:76 / Elemento padre: 75   */
      v.add(doc.createElement("IMGBOTONES"));
      ((Element)v.get(76)).setAttribute("precarga","S" );
      ((Element)v.get(76)).setAttribute("conROver","S" );
      ((Element)v.get(75)).appendChild((Element)v.get(76));

      /* Empieza nodo:77 / Elemento padre: 76   */
      v.add(doc.createElement("BTNSELECCION"));
      ((Element)v.get(77)).setAttribute("normal","btnLista2N.gif" );
      ((Element)v.get(77)).setAttribute("rollOver","btnLista2S.gif" );
      ((Element)v.get(77)).setAttribute("seleccionado","btnLista2M.gif" );
      ((Element)v.get(77)).setAttribute("desactivado","btnLista2D.gif" );
      ((Element)v.get(76)).appendChild((Element)v.get(77));
      /* Termina nodo:77   */

      /* Empieza nodo:78 / Elemento padre: 76   */
      v.add(doc.createElement("BTNMINIMIZAR"));
      ((Element)v.get(78)).setAttribute("minimizar","bot_pliega_columna_on.gif" );
      ((Element)v.get(78)).setAttribute("minimROver","bot_pliega_columna_over.gif" );
      ((Element)v.get(78)).setAttribute("maximizar","bot_despliega_columna_on.gif" );
      ((Element)v.get(78)).setAttribute("maximROver","bot_despliega_columna_over.gif" );
      ((Element)v.get(76)).appendChild((Element)v.get(78));
      /* Termina nodo:78   */

      /* Empieza nodo:79 / Elemento padre: 76   */
      v.add(doc.createElement("BTNORDENAR"));
      ((Element)v.get(79)).setAttribute("ordenar","ascendente_on.gif" );
      ((Element)v.get(79)).setAttribute("ordenarInv","descendente_on.gif" );
      ...
      ((Element)v.get(81)).setAttribute("borde","1" );
      ((Element)v.get(81)).setAttribute("horizDatos","1" );
      ((Element)v.get(81)).setAttribute("horizCabecera","1" );
      ((Element)v.get(81)).setAttribute("vertical","0" );
      ((Element)v.get(81)).setAttribute("horizTitulo","1" );
      ((Element)v.get(81)).setAttribute("horizBase","1" );
      ((Element)v.get(80)).appendChild((Element)v.get(81));
      /* Termina nodo:81   */

      /* Empieza nodo:82 / Elemento padre: 80   */
      v.add(doc.createElement("COLOR"));
      ((Element)v.get(82)).setAttribute("borde","#999999" );
      ((Element)v.get(82)).setAttribute("vertCabecera","#E0E0E0" );
      ((Element)v.get(82)).setAttribute("vertDatos","#FFFFFF" );
      ((Element)v.get(82)).setAttribute("horizDatos","#FFFFFF" );
      ((Element)v.get(82)).setAttribute("horizCabecera","#999999" );
      ((Element)v.get(82)).setAttribute("horizTitulo","#999999" );
      ((Element)v.get(82)).setAttribute("horizBase","#999999" );
      ...
      ((Element)v.get(83)).setAttribute("colFondo","#CECFCE" );
      ((Element)v.get(83)).setAttribute("alto","22" );
      ((Element)v.get(83)).setAttribute("imgFondo","" );
      ((Element)v.get(83)).setAttribute("cod","00135" );
      ...
      ((Element)v.get(85)).setAttribute("ajustarMinimo","S" );
      ((Element)v.get(85)).setAttribute("permiteOrdenar","S" );
      ((Element)v.get(85)).setAttribute("blancosAInsertar","1" );
      ((Element)v.get(85)).setAttribute("sinSaltoLinea","S" );
      ((Element)v.get(85)).setAttribute("AnchoMinimizadas","20" );
      ((Element)v.get(85)).setAttribute("botonOrdenar","S" );
      ((Element)v.get(75)).appendChild((Element)v.get(85));

      /* Empieza nodo:86 / Elemento padre: 85   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(86)).setAttribute("ancho","30" );
   ...
   private void getXML360(Document doc) {
      ((Element)v.get(88)).setAttribute("orden","alfanumerico" );
      ...
      ((Element)v.get(91)).setAttribute("orden","numerico" );
      ...
      ((Element)v.get(100)).setAttribute("cod","1709" );
      ...
      ((Element)v.get(101)).setAttribute("cod","1607" );
      ...
      ((Element)v.get(102)).setAttribute("cod","1710" );
      ...
      ((Element)v.get(105)).setAttribute("cod","10" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(106)).setAttribute("cod","1857" );
      ...
      ((Element)v.get(107)).setAttribute("cod","1711" );
      ...
      v.add(doc.createTextNode("oidEstadoComision"));
      ...
      v.add(doc.createTextNode("FechaInicioVigor"));
      ...
      /* Empieza nodo:112 / Elemento padre: 75   */
      v.add(doc.createElement("DATOS"));
      ((Element)v.get(112)).setAttribute("alto","22" );
      ((Element)v.get(112)).setAttribute("accion","onSeleccionaComision();" );
      ...
      ((Element)v.get(75)).appendChild((Element)v.get(112));
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(127)).setAttribute("y","421" );
      ...
      ((Element)v.get(129)).setAttribute("y","417" );
      ...
      ((Element)v.get(130)).setAttribute("x","80" );
      ...
      ((Element)v.get(130)).setAttribute("accion","onClickPermitir();" );
      ((Element)v.get(130)).setAttribute("ontab","focalizaBotonHTML('botonContenido','btnConfirmar')" );
      ((Element)v.get(130)).setAttribute("onshtab","focalizaBotonHTML('botonContenido','btnBuscar')" );
      ((Element)v.get(6)).appendChild((Element)v.get(130));
      /* Termina nodo:130   */

      /* Empieza nodo:131 / Elemento padre: 6   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(131)).setAttribute("nombre","btnConfirmar" );
      ((Element)v.get(131)).setAttribute("x","146" );
      ((Element)v.get(131)).setAttribute("y","418" );
      ...
      ((Element)v.get(131)).setAttribute("cod","633" );
      ((Element)v.get(131)).setAttribute("accion","onClickConfirmar();" );
      ((Element)v.get(131)).setAttribute("ontab","focaliza('formulario.cbEstadoComision')" );
      ((Element)v.get(131)).setAttribute("onshtab","focalizaBotonHTML('botonContenido','btnModificar')" );
      ...
      ((Element)v.get(132)).setAttribute("y","440" );
