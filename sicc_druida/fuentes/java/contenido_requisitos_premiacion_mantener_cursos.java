...
public class contenido_requisitos_premiacion_mantener_cursos  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_requisitos_premiacion_mantener_cursos" );
      ...
      v.add(doc.createTextNode("    \r\r\rfunction onLoadPag() {           \r  configurarMenuSecundario(\"formulario\");	\r	muestraCapa();   \r\r	var opcionMenu = get(\"formulario.opcionMenu\");\r \r	if(opcionMenu==\"Consultar Concurso\") {\r	   \r		document.getElementById(\"cbCurso\").disabled = true;\r		document.getElementById(\"btnAnadir\").disabled = true;\r		document.getElementById(\"btnAceptar\").disabled = true;\r		document.getElementById(\"Eliminar\").disabled = true;\r		btnProxy(4, '0');	\r		btnProxy(5, '0');	\r	}\r	else {\r		focoComboTipoConcurso();\r	}	\r}\r\rfunction fBorrar() {\r	accionEliminar();\r}\r\rfunction accionEliminar() {	\r	if (listado1.numSelecc()== 0) {\r		GestionarMensaje('1021',null,null,null);\r		return false;\r    }\r\r	listado1.eliminarSelecc();\r}\r\rfunction fLimpiar() {\r	var arrayVacio = new Array();\r	listado1.setDatos(arrayVacio);\r	focoComboTipoConcurso();\r}\r\rfunction muestraCapa() {\r	DrdEnsanchaConMargenDcho('listado1',26);      \r    document.all[\"Cplistado1\"].style.visibility=''; \r    document.all[\"CpLin1listado1\"].style.visibility='';  \r    document.all[\"CpLin2listado1\"].style.visibility=''; \r    document.all[\"CpLin3listado1\"].style.visibility='';\r    document.all[\"CpLin4listado1\"].style.visibility='';        \r    document.all[\"primera1Div\"].style.visibility=''; \r    document.all[\"ret1Div\"].style.visibility='';\r    document.all[\"ava1Div\"].style.visibility='';  \r    document.all[\"separaDiv\"].style.visibility='';           \r    eval (ON_RSZ);            \r}\r\rfunction fVolver() {\r	window.close();\r}\r\rfunction focoComboTipoConcurso() {\r	focaliza(\"formulario.cbCurso\");\r}\r\rfunction focoBotonEliminar() {\r	focalizaBotonHTML('botonContenido','Eliminar');	\r}\r\rfunction focoBotonAceptar() {\r	focalizaBotonHTML('botonContenido','btnAceptar');	\r}\r\rfunction focoBotonAnadir() {\r	focalizaBotonHTML('botonContenido','btnAnadir');	\r}\r\rfunction accionEliminar() {\r	if (listado1.numSelecc()== 0) {\r		GestionarMensaje('1021',null,null,null);\r		return false;\r    }\r\r	listado1.eliminarSelecc();\r}\r\rfunction accionAnadir() {	\r	if(!sicc_validaciones_generales('grupoAnadir')) {\r		return;\r	}\r\r	var oidCursoExigido = \" \";\r	var tipoCurso = \" \";\r	var oidTipoCurso = \" \";\r\r	if(get(\"formulario.cbCurso\", \"T\")!=\"\") tipoCurso = get(\"formulario.cbCurso\", \"T\");\r	if(get(\"formulario.cbCurso\")!=\"\") oidTipoCurso = get(\"formulario.cbCurso\");\r\r	/*\r	- 0 = oid curso exigido\r	- 1 = tipo curso\r	- 2 = oid tipo curso\r	*/\r\r	var existe = \"false\";\r	var datos = listado1.datos; \r\r	for(var i=0 ; i<datos.length; i++) {\r		var temp = datos[i][2];\r		var valor1 = parseInt(temp, 10);\r		var valor2 = parseInt(oidTipoCurso, 10);\r\r		if(valor1 == valor2) {\r			existe = \"true\";\r		}\r	}\r\r   if(existe==\"false\") {\r		if(oidTipoCurso!=\"\") {\r			var array = new Array();\r\r			array[0] = new String(oidCursoExigido);\r			array[1] = new String(tipoCurso);\r			array[2] = new String(oidTipoCurso);\r\r			listado1.actualizaDat();\r			var datos = listado1.datos;\r			datos[datos.length] = array; \r			listado1.setDatos(datos);\r			listado1.repintaDat();\r		}\r   }	\r}\r\rfunction accionAceptar() {\r	var datos = listado1.datos;\r	var datosCompletos = \"[\";\r\r	for(var i=0; i<datos.length; i++) {\r		var fila = new Array();\r\r		var temp0 = datos[i][0];\r		if(temp0==\"\") temp0 = \" \";\r		fila[0] = temp0;\r\r		var temp1 = datos[i][1];\r		if(temp1==\"\") temp1 = \" \";\r		fila[1] = temp1;\r\r		var temp2 = datos[i][2];\r		if(temp2==\"\") temp2 = \" \";\r		fila[2] = temp2;\r\r		if(i==0) datosCompletos = datosCompletos + fila;	\r		else datosCompletos = datosCompletos + \"|\" + fila;			\r	}\r\r	datosCompletos = datosCompletos + \"]\";\r	returnValue = datosCompletos;\r	window.close();\r}\r\r   \r\r"));
      ...
      ((Element)v.get(9)).setAttribute("name","cbCurso" );
      ((Element)v.get(9)).setAttribute("required","true" );
      ((Element)v.get(9)).setAttribute("cod","758" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(49)).setAttribute("nombre","lblDatosAnadir" );
   ...
   private void getXML180(Document doc) {
      ((Element)v.get(49)).setAttribute("cod","00280" );
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(53)).setAttribute("width","562" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(61)).setAttribute("nombre","lblTipoCurso" );
      ...
      ((Element)v.get(61)).setAttribute("cod","758" );
      ...
      ((Element)v.get(68)).setAttribute("nombre","cbCurso" );
      ...
      ((Element)v.get(68)).setAttribute("onshtab","focoBotonAceptar();" );
   ...
   private void getXML270(Document doc) {
      ...
      /* Empieza nodo:77 / Elemento padre: 39   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(39)).appendChild((Element)v.get(77));
      ...
      ((Element)v.get(85)).setAttribute("nombre","btnAnadir" );
      ((Element)v.get(85)).setAttribute("ID","botonContenido" );
      ((Element)v.get(85)).setAttribute("tipo","html" );
      ((Element)v.get(85)).setAttribute("accion","accionAnadir();" );
      ((Element)v.get(85)).setAttribute("estado","false" );
      ((Element)v.get(85)).setAttribute("cod","404" );
      ((Element)v.get(85)).setAttribute("ontab","focoBotonEliminar();" );
      ...
      /* Empieza nodo:88 / Elemento padre: 39   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(39)).appendChild((Element)v.get(88));
      ...
      ((Element)v.get(90)).setAttribute("height","338" );
      ...
      /* Empieza nodo:97 / Elemento padre: 21   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(21)).appendChild((Element)v.get(97));
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(105)).setAttribute("accion","accionAceptar();" );
      ((Element)v.get(105)).setAttribute("estado","false" );
      ((Element)v.get(105)).setAttribute("cod","12" );
      ((Element)v.get(105)).setAttribute("ontab","focoComboTipoConcurso();" );
      ((Element)v.get(105)).setAttribute("onshtab","focoBotonEliminar();" );
      ...
      /* Empieza nodo:108 / Elemento padre: 21   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(21)).appendChild((Element)v.get(108));
      ...
      /* Empieza nodo:115 / Elemento padre: 10   */
      v.add(doc.createElement("LISTAEDITABLE"));
      ((Element)v.get(115)).setAttribute("nombre","listado1" );
      ((Element)v.get(115)).setAttribute("ancho","566" );
      ((Element)v.get(115)).setAttribute("alto","299" );
      ((Element)v.get(115)).setAttribute("x","26" );
      ((Element)v.get(115)).setAttribute("y","147" );
      ((Element)v.get(115)).setAttribute("colorFondo","#CECFCE" );
      ((Element)v.get(115)).setAttribute("msgDebugJS","S" );
      ((Element)v.get(10)).appendChild((Element)v.get(115));
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(123)).setAttribute("cod","00621" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(127)).setAttribute("ancho","26" );
      ...
      ((Element)v.get(129)).setAttribute("cod","758" );
      ...
      /* Empieza nodo:134 / Elemento padre: 115   */
      v.add(doc.createElement("ROWSET"));
      ((Element)v.get(115)).appendChild((Element)v.get(134));
      /* Termina nodo:134   */

      /* Empieza nodo:135 / Elemento padre: 115   */
      v.add(doc.createElement("PAGINADO"));
      ((Element)v.get(135)).setAttribute("nombre","mipgndo" );
      ((Element)v.get(135)).setAttribute("ancho","564" );
      ((Element)v.get(135)).setAttribute("sep","$" );
      ((Element)v.get(135)).setAttribute("x","26" );
      ((Element)v.get(135)).setAttribute("class","botonera" );
   }

   private void getXML540(Document doc) {
      ((Element)v.get(135)).setAttribute("y","423" );
      ...
      ((Element)v.get(115)).appendChild((Element)v.get(135));

      /* Empieza nodo:136 / Elemento padre: 135   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(136)).setAttribute("nombre","ret1" );
      ((Element)v.get(136)).setAttribute("x","51" );
      ((Element)v.get(136)).setAttribute("y","427" );
      ...
      ((Element)v.get(137)).setAttribute("x","66" );
      ((Element)v.get(137)).setAttribute("y","427" );
      ...
      /* Empieza nodo:138 / Elemento padre: 10   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(138)).setAttribute("nombre","primera1" );
      ((Element)v.get(138)).setAttribute("x","34" );
      ((Element)v.get(138)).setAttribute("y","427" );
      ...
      ((Element)v.get(10)).appendChild((Element)v.get(138));
      /* Termina nodo:138   */

      /* Empieza nodo:139 / Elemento padre: 10   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(139)).setAttribute("nombre","separa" );
      ((Element)v.get(139)).setAttribute("x","73" );
      ((Element)v.get(139)).setAttribute("y","423" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(140)).setAttribute("nombre","Eliminar" );
      ((Element)v.get(140)).setAttribute("x","93" );
      ...
      ((Element)v.get(140)).setAttribute("cod","1254" );
      ((Element)v.get(140)).setAttribute("ontab","focoBotonAceptar();" );
      ((Element)v.get(140)).setAttribute("onshtab","focoBotonAnadir();" );
      ((Element)v.get(140)).setAttribute("accion","accionEliminar();" );
