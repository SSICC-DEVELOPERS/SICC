...
public class MaeTipoComunConectorQueryList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad MaeTipoComun" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGMaeTipoComunQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGMaeTipoComunQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","MaeTipoComunListFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","codTipoComu" );
