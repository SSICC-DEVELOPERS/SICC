...
public class COMComisionesLideres extends LPSICCBase {           
   public COMComisionesLideres() {	 
     super();
  }
     ...
     try {
        ...
        if (accion.equals("generar")){
          ...
          //cargarPagina();
           ...
           cargarPagina();
           getConfiguracionMenu("COMComisionesLideres");
        }
  ...
  private void cargarPagina() throws Exception{
     pagina("contenido_informe_comisiones_lideres_generar");   
     ...
     traza("antesde la lista oculta de Secciones");
     MareBusinessID idTerritorio = new MareBusinessID("ZONObtenerTerritoriosPorSecciones");
     Vector vecTER = new Vector();
     vecTER.add(dtoUA);
     vecTER.add(idTerritorio);
     ...
     traza("colSeccion "+dtoTerritorios.getResultado());
     traza("colSeccion "+dtoTerritorios.getResultado().getColumnIdentifiers());
     this.crearListaLP(colTerritorio, territorio.getColumnCount(), "Capater","ListaTerritorios", "14", "200");
 ...
 private void generarReporte() throws Exception{
     ...
     datos.put(ConstantesREP.PERIODOINICIO, periodoDesde);
     
     String periodoDesdeDesc        = conectorParametroLimpia("periodoDesdeDesc", "", true);
     datos.put(ConstantesREP.PERIODOINICIODESC, periodoDesdeDesc);
     
     String periodoHasta        = conectorParametroLimpia("periodoHasta", "", true);
     datos.put(ConstantesREP.PERIODOFIN, periodoHasta);
     
     String periodoHastaDesc        = conectorParametroLimpia("periodoHastaDesc", "", true);
     datos.put(ConstantesREP.PERIODOFINDESC, periodoHastaDesc);
     ...
     datos.put(ConstantesREP.TITULO, "Comisiones de Lideres por Seccion");     
...
//     ejecutarReporte(datos, "REPGenerarReporte", "RD_REP-148", formato);
          ejecutarReporte2(datos, "REPGenerarReporteBatch", "RD_REP-148", formato);
