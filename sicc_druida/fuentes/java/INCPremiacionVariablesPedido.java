...
public class INCPremiacionVariablesPedido extends LPSICCBase {           
    public INCPremiacionVariablesPedido() {	 
        super();
    }
     ...
     try {
        ...
        if (accion.equals("generar")){
          ...
          //cargarPagina();
           ...
           cargarPagina();
           getConfiguracionMenu("INCPremiacionVariablesPedido");
        }
     
     } catch (Exception ex) {
     			
        //pagina("contenido_informe_premiacion_variables_generar");
        //getConfiguracionMenu("INCPremiacionVariablesPedido");
 ...
 private void generarReporte() throws Exception{
     ...
     String variablesVenta  = conectorParametroLimpia("variablesVenta", "", true);
     datos.put(ConstantesREP.VARIABLEVENTAS, variablesVenta);
     
     
     datos.put(ConstantesREP.TITULO, "Premiacion Variables x Periodo, Region y Zona");
     ...
     if(region.equals("")){
       reporte = "RD_REP-065_02";    
     }else{
        if(zona.equals("")){
           reporte = "RD_REP-065_01";
        }else{
           reporte = "RD_REP-065";
        }
     }    
