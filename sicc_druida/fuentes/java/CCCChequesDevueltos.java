...
public class CCCChequesDevueltos extends LPSICCBase {           
   public CCCChequesDevueltos() {	 
     super();
  }
     ...
     try {
        ...
        if (accion.equals("generar")){
          ...
          //cargarPagina();
           ...
           cargarPagina();
           getConfiguracionMenu("CCCChequesDevueltos");
        }
  ...
  private void cargarPagina() throws Exception{
     pagina("contenido_informe_cheques_devueltos_generar");  
     ...
     MareBusinessID id = new MareBusinessID("CCCObtenerTipoCargoCCC004");
     ...
     DruidaConector mcs = generarConector("DTOSalida.mc_ROWSET",mc, colMC);
       ...
       asignar("COMBO", "cbTipoCargoAbono", mcs, "DTOSalida.mc_ROWSET");  
 ...
 private void generarReporte() throws Exception{
     ...
     if(!tipoCargo.equals("")){
        datos.put(ConstantesREP.FECHADEVALORDESDE, tipoCargo);        
     }
     ...
     if(orden.equals("1")){
        datos.put(ConstantesREP.CRITERIOORDENAMIENTO, "'CODIGO, FECHA'");
     }else{
        datos.put(ConstantesREP.CRITERIOORDENAMIENTO, "'FECHA, CODIGO'");
     }
     ...
     datos.put(ConstantesREP.TITULO, "Cheques Devueltos Pendientes");
     traza("++++++Antes de enviar a reportes " + datos); 
        
     String reporte = conectorParametroLimpia("reporte", "", true);
     traza("el formaro es  " + formato);
     //ejecutarReporte(datos, "REPGenerarReporte", "RD_REP-139", formato);
