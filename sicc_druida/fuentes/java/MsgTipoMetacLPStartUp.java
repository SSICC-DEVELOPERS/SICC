/*
    INDRA/CAR/mmg
    $Id: MsgTipoMetacLPStartUp.java,v 1.1 2009/12/03 18:40:38 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class MsgTipoMetacLPStartUp extends MMGDruidaBase{
	...
	public static final String BUSINESSID_QUERY = "MMGMsgTipoMetacQueryFromToUserPage";
	...
	public MsgTipoMetacLPStartUp(){
		super();
	}

	public void inicio() throws Exception {
		pagina("MsgTipoMetacPage");
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "MsgTipoMetacPage", "cod", "MsgTipoMetac." + accion + ".label");
			...
			limpiarBotoneraLista("msgTipoMetac", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codTipo", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 1);");
		
		//Primero determianmos el nombre del campo en la entidad de oriegen donde se van a cargar los datos
		asignar("VAR", "idAttributeLovOpener", conectorParametro(PARAMETRO_LOV_ATTRIBUTO));
		asignar("VAR", "idEntityLovOpener", conectorParametro(PARAMETRO_LOV_ENTIDAD));
		//asignarAtributo("CAPA", "msgTipoMetacLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "MsgTipoMetacPage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("MsgTipoMetacLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		MsgTipoMetacData msgTipoMetacQuery= new MsgTipoMetacData();
		msgTipoMetacQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		MsgTipoMetacData datosResult = (MsgTipoMetacData)getSingleObject(BUSINESSID_QUERY, msgTipoMetacQuery, 
			msgTipoMetacQuery.clone(), "msgTipoMetac");
		...
		MsgTipoMetacData msgTipoMetac = datosResult;
		asignar("TEXT", "codTipo", FormatUtils.formatObject(msgTipoMetac.getCodTipo(), 
		...
		asignarAtributo("TEXT", "codTipo", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		...
		asignarAtributo("TEXT", "codTipo", "req", "S");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "msgTipoMetacFrm", "oculto", "N");
		...
		traza("MMG::Creando MsgTipoMetac");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		MsgTipoMetacData msgTipoMetacQuery= new MsgTipoMetacData();
		msgTipoMetacQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(msgTipoMetac.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"msgTipoMetacFrm\",0, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"msgTipoMetacFrm\",0, false)");
				asignarAtributo("AREATEXTO", "codTipo", "ontab","ejecutarAccionFocoModificacion(\"msgTipoMetacFrm\",0, true)");
				asignarAtributo("AREATEXTO", "codTipo", "onshtab","ejecutarAccionFocoModificacion(\"msgTipoMetacFrm\",0, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","msgTipoMetacTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","msgTipoMetacTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codTipo...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","msgTipoMetacFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","msgTipoMetacListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","msgTipoMetacListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(MsgTipoMetacData msgTipoMetac) throws Exception{
	...
	* @param msgTipoMetac La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(MsgTipoMetacData msgTipoMetac) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		MsgTipoMetacData msgTipoMetac = 
			(MsgTipoMetacData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(msgTipoMetac);
		loadLeafDependenceCombos(msgTipoMetac);
	}
