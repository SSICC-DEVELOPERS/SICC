/*
    INDRA/CAR/mmg
    $Id: MaeEstadCivilLPStartUp.java,v 1.1 2009/12/03 18:42:10 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class MaeEstadCivilLPStartUp extends MMGDruidaBase{
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "MaeEstadCivilPage", "cod", "MaeEstadCivil." + accion + ".label");
			...
			limpiarBotoneraLista("maeEstadCivil", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codEstaCivi", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 2);");
		...
		//asignarAtributo("CAPA", "maeEstadCivilLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "MaeEstadCivilPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		MaeEstadCivilData maeEstadCivilQuery= new MaeEstadCivilData();
		maeEstadCivilQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		MaeEstadCivilData datosResult = (MaeEstadCivilData)getSingleObject(BUSINESSID_QUERY, maeEstadCivilQuery, 
			maeEstadCivilQuery.clone(), "maeEstadCivil");
		...
		preservaHiddensI18n(new Integer(1), "MAE_ESTAD_CIVIL", "maeEstadCivilFrm", "Descripcion", true);
		...
		MaeEstadCivilData maeEstadCivil = datosResult;
		asignar("TEXT", "codEstaCivi", FormatUtils.formatObject(maeEstadCivil.getCodEstaCivi(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "Descripcion", FormatUtils.formatObject(maeEstadCivil.getDescripcion(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		loadLocalizationVars(maeEstadCivil);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "codEstaCivi", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "MAE_ESTAD_CIVIL", "maeEstadCivilFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "codEstaCivi", "req", "S");
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('maeEstadCivilFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "maeEstadCivilFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		MaeEstadCivilData maeEstadCivilQuery= new MaeEstadCivilData();
		maeEstadCivilQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(maeEstadCivil.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"maeEstadCivilFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"maeEstadCivilFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codEstaCivi", "ontab","ejecutarAccionFocoModificacion(\"maeEstadCivilFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codEstaCivi", "onshtab","ejecutarAccionFocoModificacion(\"maeEstadCivilFrm\",2, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"maeEstadCivilFrm\",3, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"maeEstadCivilFrm\",3, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","maeEstadCivilTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","maeEstadCivilTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","maeEstadCivilFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","maeEstadCivilListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","maeEstadCivilListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(MaeEstadCivilData maeEstadCivil) throws Exception{
	...
	* @param maeEstadCivil La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(MaeEstadCivilData maeEstadCivil) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		MaeEstadCivilData maeEstadCivil = 
			(MaeEstadCivilData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(maeEstadCivil);
		loadLeafDependenceCombos(maeEstadCivil);
	}
	...
	*/
	...
	protected void loadLocalizationVars(MaeEstadCivilData maeEstadCivil) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("MAE_ESTAD_CIVIL");
		mmgLocalizationQuery.setEntiPk(maeEstadCivil.getId());
