/*
    INDRA/CAR/mmg
    $Id: MaeLineaProduLPStartUp.java,v 1.1 2009/12/03 18:32:47 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class MaeLineaProduLPStartUp extends MMGDruidaBase{
	...
	public MaeLineaProduLPStartUp(){
		super();
	}

	public void inicio() throws Exception {
		pagina("MaeLineaProduPage");
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "MaeLineaProduPage", "cod", "MaeLineaProdu." + accion + ".label");
			...
			limpiarBotoneraLista("maeLineaProdu", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codLineProd", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 3);");
		...
		//asignarAtributo("CAPA", "maeLineaProduLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "MaeLineaProduPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		MaeLineaProduData maeLineaProduQuery= new MaeLineaProduData();
		maeLineaProduQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		MaeLineaProduData datosResult = (MaeLineaProduData)getSingleObject(BUSINESSID_QUERY, maeLineaProduQuery, 
			maeLineaProduQuery.clone(), "maeLineaProdu");
		...
		preservaHiddensI18n(new Integer(1), "MAE_LINEA_PRODU", "maeLineaProduFrm", "Descripcion", true);
		...
		MaeLineaProduData maeLineaProdu = datosResult;
		asignar("TEXT", "codLineProd", FormatUtils.formatObject(maeLineaProdu.getCodLineProd(), 
		...
		loadLocalizationVars(maeLineaProdu);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "codLineProd", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "MAE_LINEA_PRODU", "maeLineaProduFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "codLineProd", "req", "S");
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('maeLineaProduFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "maeLineaProduFrm", "oculto", "N");
		...
		traza("MMG::Creando MaeLineaProdu");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		MaeLineaProduData maeLineaProduQuery= new MaeLineaProduData();
		maeLineaProduQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(maeLineaProdu.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"maeLineaProduFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"maeLineaProduFrm\",1, false)");
					asignarAtributo("COMBO","paisOidPais", "ontab", "ejecutarAccionFocoModificacion(\"maeLineaProduFrm\",2, true)");
					asignarAtributo("COMBO","paisOidPais", "onshtab", "ejecutarAccionFocoModificacion(\"maeLineaProduFrm\",2, false)");
				asignarAtributo("AREATEXTO", "codLineProd", "ontab","ejecutarAccionFocoModificacion(\"maeLineaProduFrm\",3, true)");
				asignarAtributo("AREATEXTO", "codLineProd", "onshtab","ejecutarAccionFocoModificacion(\"maeLineaProduFrm\",3, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"maeLineaProduFrm\",4, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"maeLineaProduFrm\",4, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","maeLineaProduTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","maeLineaProduTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codLineProd...");		
				
					traza("MMG: en desactivateNonModifyFields encontrado atributo no editable...");
				
						// borrarCampo("codLineProd");
						asignarAtributo ("TEXT", "codLineProd", "disabled", "S");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","maeLineaProduFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","maeLineaProduListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","maeLineaProduListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(MaeLineaProduData maeLineaProdu) throws Exception{
		...
		if(maeLineaProdu != null && maeLineaProdu.getPaisOidPais() != null){
				checkCombo("paisOidPais" , maeLineaProdu.getPaisOidPais().getId().toString());
			}
	...
	* @param maeLineaProdu La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(MaeLineaProduData maeLineaProdu) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		MaeLineaProduData maeLineaProdu = 
			(MaeLineaProduData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(maeLineaProdu.getPaisOidPais() != null){
			maeLineaProdu.setPaisOidPais((es.indra.belcorp.mso.SegPaisViewData)
			getSingleObject(BUSINESSID_PAISOIDPAIS_QUERY, 
			maeLineaProdu.getPaisOidPais(),
			maeLineaProdu.getPaisOidPais().clone(),
			"segPaisView"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(maeLineaProdu);
		loadLeafDependenceCombos(maeLineaProdu);
	}
	...
	*/
	...
	protected void loadLocalizationVars(MaeLineaProduData maeLineaProdu) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("MAE_LINEA_PRODU");
		mmgLocalizationQuery.setEntiPk(maeLineaProdu.getId());
