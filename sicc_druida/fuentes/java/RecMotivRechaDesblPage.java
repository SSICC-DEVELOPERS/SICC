...
public class RecMotivRechaDesblPage  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","RecMotivRechaDesblPage" );
      ((Element)v.get(0)).setAttribute("titulo","" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","" );
      ((Element)v.get(0)).setAttribute("onload","recMotivRechaDesblInitComponents()" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","recmotivrechadesbl.js" );
      ((Element)v.get(0)).appendChild((Element)v.get(4));
      /* Termina nodo:4   */

      /* Empieza nodo:5 / Elemento padre: 0   */
      v.add(doc.createElement("FORMULARIO"));
      ((Element)v.get(5)).setAttribute("nombre","recMotivRechaDesblFrm" );
      ...
      ((Element)v.get(6)).setAttribute("valor","RecMotivRechaDesblLPExecution" );
      ...
      ((Element)v.get(7)).setAttribute("valor","RecMotivRechaDesblLPExecution" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(37)).setAttribute("nombre","recMotivRechaDesblFormLayer" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(52)).setAttribute("cod","RecMotivRechaDesbl.legend.label" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(67)).setAttribute("cod","RecMotivRechaDesbl.id.label" );
      ...
      ((Element)v.get(70)).setAttribute("ontab","ejecutarAccionFoco('recMotivRechaDesblFrm',1, true)" );
      ((Element)v.get(70)).setAttribute("onshtab","ejecutarAccionFoco('recMotivRechaDesblFrm', 1, false)" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(92)).setAttribute("cod","RecMotivRechaDesbl.paisOidPais.label" );
      ...
      ((Element)v.get(95)).setAttribute("ontab","ejecutarAccionFoco('recMotivRechaDesblFrm',2, true);" );
      ((Element)v.get(95)).setAttribute("onshtab","ejecutarAccionFoco('recMotivRechaDesblFrm',2, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(99)).setAttribute("nombre","codRechDesbTdId" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(103)).setAttribute("nombre","lblCodRechDesb" );
      ((Element)v.get(103)).setAttribute("alto","13" );
      ((Element)v.get(103)).setAttribute("filas","1" );
      ((Element)v.get(103)).setAttribute("id","datosTitle" );
      ((Element)v.get(103)).setAttribute("cod","RecMotivRechaDesbl.codRechDesb.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(104)).setAttribute("nombre","codRechDesbWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(106)).setAttribute("nombre","codRechDesb" );
      ...
      ((Element)v.get(106)).setAttribute("ontab","ejecutarAccionFoco('recMotivRechaDesblFrm',3, true)" );
      ((Element)v.get(106)).setAttribute("onshtab","ejecutarAccionFoco('recMotivRechaDesblFrm', 3, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(107)).setAttribute("nombre","codRechDesbGapTdId" );
      ...
      ((Element)v.get(113)).setAttribute("cod","RecMotivRechaDesbl.Descripcion.label" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(117)).setAttribute("ontab","ejecutarAccionFoco('recMotivRechaDesblFrm',4, true)" );
      ((Element)v.get(117)).setAttribute("onshtab","ejecutarAccionFoco('recMotivRechaDesblFrm', 4, false)" );
      ...
      ((Element)v.get(121)).setAttribute("href","javascript:openLocalizationDialog('recMotivRechaDesblFrm', 'Descripcion', 1);" );
      ((Element)v.get(121)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"recMotivRechaDesblFrm\",4, true)', 'ejecutarAccionFoco(\"recMotivRechaDesblFrm\",4, false)')" );
   ...
   private void getXML630(Document doc) {
      ((Element)v.get(137)).setAttribute("nombre","recMotivRechaDesblTrButtons" );
      ...
      ((Element)v.get(144)).setAttribute("nombre","recMotivRechaDesblTdQueryButton" );
      ((Element)v.get(143)).appendChild((Element)v.get(144));

      /* Empieza nodo:145 / Elemento padre: 144   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(145)).setAttribute("nombre","recMotivRechaDesblQueryButton" );
      ((Element)v.get(145)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(145)).setAttribute("estado","false" );
      ((Element)v.get(145)).setAttribute("accion","recMotivRechaDesblFirstPage();" );
      ...
      ((Element)v.get(146)).setAttribute("nombre","recMotivRechaDesblTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(148)).setAttribute("nombre","recMotivRechaDesblLovNullButton" );
      ((Element)v.get(148)).setAttribute("ID","botonContenido" );
      ((Element)v.get(148)).setAttribute("tipo","html" );
      ((Element)v.get(148)).setAttribute("accion","recMotivRechaDesblLovNullSelectionAction();" );
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(151)).setAttribute("nombre","recMotivRechaDesblListLayer" );
      ...
      ((Element)v.get(152)).setAttribute("nombre","recMotivRechaDesblList" );
   ...
   private void getXML720(Document doc) {
      ...
      ((Element)v.get(165)).setAttribute("cod","RecMotivRechaDesbl.codRechDesb.label" );
      ...
      ((Element)v.get(166)).setAttribute("cod","RecMotivRechaDesbl.Descripcion.label" );
   ...
   private void getXML810(Document doc) {
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(171)).setAttribute("nombre","recMotivRechaDesblListButtonsLayer" );
      ...
      ((Element)v.get(177)).setAttribute("nombre","recMotivRechaDesblPaginationButtonBar" );
      ...
      ((Element)v.get(178)).setAttribute("nombre","recMotivRechaDesblFirstPageButton" );
      ((Element)v.get(178)).setAttribute("funcion","recMotivRechaDesblFirstPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(179)).setAttribute("nombre","recMotivRechaDesblFirstPageButtonGapTd" );
      ...
      v.add(doc.createElement("BTN"));
      ((Element)v.get(181)).setAttribute("nombre","recMotivRechaDesblPreviousPageButton" );
      ((Element)v.get(181)).setAttribute("funcion","recMotivRechaDesblPreviousPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(182)).setAttribute("nombre","recMotivRechaDesblPreviousPageButtonGapTd" );
   ...
   private void getXML900(Document doc) {
      ...
      v.add(doc.createElement("BTN"));
      ((Element)v.get(184)).setAttribute("nombre","recMotivRechaDesblNextPageButton" );
      ((Element)v.get(184)).setAttribute("funcion","recMotivRechaDesblNextPage();" );
      ...
      ((Element)v.get(187)).setAttribute("nombre","recMotivRechaDesblUpdateButtonTd" );
      ((Element)v.get(173)).appendChild((Element)v.get(187));

      /* Empieza nodo:188 / Elemento padre: 187   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(188)).setAttribute("nombre","recMotivRechaDesblUpdateButton" );
      ((Element)v.get(188)).setAttribute("ID","botonContenido" );
      ((Element)v.get(188)).setAttribute("tipo","html" );
      ((Element)v.get(188)).setAttribute("accion","recMotivRechaDesblUpdateSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(189)).setAttribute("nombre","recMotivRechaDesblUpdateButtonGapTd" );
      ...
      ((Element)v.get(191)).setAttribute("nombre","recMotivRechaDesblViewForRemoveButtonTd" );
      ((Element)v.get(173)).appendChild((Element)v.get(191));

      /* Empieza nodo:192 / Elemento padre: 191   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(192)).setAttribute("nombre","recMotivRechaDesblViewForRemoveButton" );
      ((Element)v.get(192)).setAttribute("ID","botonContenido" );
      ((Element)v.get(192)).setAttribute("tipo","html" );
      ((Element)v.get(192)).setAttribute("accion","recMotivRechaDesblViewSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(193)).setAttribute("nombre","recMotivRechaDesblViewForRemoveButtonGapTd" );
      ...
      ((Element)v.get(195)).setAttribute("nombre","recMotivRechaDesblLovSelectButtonTd" );
      ((Element)v.get(173)).appendChild((Element)v.get(195));

      /* Empieza nodo:196 / Elemento padre: 195   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(196)).setAttribute("nombre","recMotivRechaDesblLovSelectButton" );
      ((Element)v.get(196)).setAttribute("ID","botonContenido" );
      ((Element)v.get(196)).setAttribute("tipo","html" );
      ((Element)v.get(196)).setAttribute("accion","recMotivRechaDesblLovSelectionAction();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(197)).setAttribute("nombre","recMotivRechaDesblLovSelectButtonGapTd" );
      ...
      ((Element)v.get(199)).setAttribute("nombre","recMotivRechaDesblViewButtonTd" );
      ((Element)v.get(173)).appendChild((Element)v.get(199));

      /* Empieza nodo:200 / Elemento padre: 199   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(200)).setAttribute("nombre","recMotivRechaDesblViewButton" );
      ((Element)v.get(200)).setAttribute("ID","botonContenido" );
      ((Element)v.get(200)).setAttribute("tipo","html" );
      ((Element)v.get(200)).setAttribute("accion","recMotivRechaDesblViewSelection();" );
   ...
   private void getXML990(Document doc) {
      ((Element)v.get(201)).setAttribute("nombre","recMotivRechaDesblViewButtonGapTd" );
