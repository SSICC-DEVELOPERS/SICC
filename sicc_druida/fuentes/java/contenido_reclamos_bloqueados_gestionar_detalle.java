...
public class contenido_reclamos_bloqueados_gestionar_detalle  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_reclamos_bloqueados_gestionar_detalle" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(5)).setAttribute("src","contenido_reclamos_bloqueados_gestionar_detalle.js" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(11)).setAttribute("nombre","opcion" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(30)).setAttribute("cod","00297" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(34)).setAttribute("ancho","80" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(36)).setAttribute("ancho","130" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(37)).setAttribute("ancho","130" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(42)).setAttribute("cod","304" );
      ...
      ((Element)v.get(43)).setAttribute("cod","336" );
      ...
      ((Element)v.get(45)).setAttribute("cod","339" );
      ...
      ((Element)v.get(46)).setAttribute("cod","376" );
      ...
      ((Element)v.get(47)).setAttribute("cod","377" );
      ...
      ((Element)v.get(48)).setAttribute("cod","307" );
      ...
      ((Element)v.get(49)).setAttribute("cod","308" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(60)).setAttribute("ancho","500" );
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(65)).setAttribute("nombre","capaEspacio" );
      ((Element)v.get(65)).setAttribute("alto","12" );
      ((Element)v.get(65)).setAttribute("ancho","50" );
      ...
      ((Element)v.get(65)).setAttribute("y","329" );
