...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      v.add(doc.createTextNode("\r  \r\r function onLoadPag()\r {  configurarMenuSecundario(\"formulario\");\r	fMostrarMensajeError();	  \r	focalizaBotonHTML('botonContenido','btnAceptar');\r\r	btnProxy(1,0);\r	btnProxy(2,1);\r	btnProxy(3,0);\r	btnProxy(4,0);\r	btnProxy(5,0);\r	btnProxy(6,1);\r	btnProxy(7,1);\r	btnProxy(8,1);\r	btnProxy(9,0);\r	btnProxy(10,1);\r }\r \r /*Este método se ejecuta cuando pulsa sobre btnAceptar. \r	Proceso: \r	======= \r	Si varFechaInicioVigorModificacion <= varFechaInicioPeriodoActual \r	    Se muestra el mensaje de error UICOM0001 \r	    (No se puede aceptar una modificación cuyo periodo de entrada en vigor es anterior al periodo actual) \r	    y no se continua el flujo del metodo. \r	Fin del Si \r\r	Se invoca LPMantenimientoComisiones a través de un EnviarOculto con: \r	accion = \"ConfirmarAceptar\" \r	oidComision = varOidComisionPendiente\r */\r function onClickAceptar()\r {\r    	if(ComparaFechas(get(\"formulario.varFechaInicioVigorModificacion\"), get(\"formulario.varFechaInicioPeriodoActual\")) == 1 ||    ComparaFechas(get(\"formulario.varFechaInicioVigorModificacion\"), get(\"formulario.varFechaInicioPeriodoActual\")) == 0 )\r	{    	     GestionarMensaje('UICOM0001');\r	}\r	else \r	{	 		 eval('formulario').oculto = 'S'\r		 set('formulario.conectorAction', 'LPMantenimientoComisiones')\r		 set('formulario.accion', 'ConfirmarAceptar')\r		 enviaSICC('formulario', null, null, 'N')		 \r	}\r }\r\r function fVolver()	{ window.close(); }\r\r  /*Este método se ejecuta cuando pulsa sobre btnRechazar. \r	Proceso: \r	======= \r	Se invoca LPMantenimientoComisiones a través de un EnviarOculto con: \r	accion = \"ConfirmarRechazar\" \r	oidComision = varOidComisionPendiente\r	*/\r  function onClickRechazar()\r  {\r    			 		 eval('formulario').oculto = 'S'\r		 set('formulario.conectorAction', 'LPMantenimientoComisiones')\r		 set('formulario.accion', 'ConfirmarRechazar')\r		 enviaSICC('formulario', null, null, 'N')\r	  }\r  \r  /*Este método se ejecuta cuando pulsa sobre btnConsultarPendiente. \r	Proceso: \r	======= \r	Se abre una ventana emergente modal y en la nueva ventana se invoca LPMantenimientoComisiones con: \r	accion = \"ConsultarComision\" \r	oidComision = varOidComisionPendiente \r\r	========== inc. BELC300014680\r	Todas estas llamadas deben hacerse a \"LPMantenimientoComisionesDatosGenerales\" con acción \"\" y\r    opcionMenu = \"consultar\", también se pasa el oid de la comisión que se está consultando.\r  */\r  function onClickConsultarPendiente()\r  {\r	  obj = new Object()\r	  obj.oidComision = get(\"formulario.varOidComisionPendiente\")\r   	  obj.titulo = \"ConsultarComisiones\"\r	  obj.opcionMenu = \"consultar\"\r   	  obj.estadoVentana = \"M\"\r	  vWnd = mostrarModalSICC('LPMantenimientoComisionesDatosGenerales','',obj, 850,500)\r  }\r\r  /*Este método se ejecuta cuando pulsa sobre btnConsultarVigente. \r	Proceso: \r	======= \r	Se abre una ventana emergente modal y en la nueva ventana se invoca LPMantenimientoComisiones con: \r	accion = \"ConsultarComision\" \r	oidComision = varOidComisionVigente\r\r	========== inc. BELC300014680\r	Todas estas llamadas deben hacerse a \"LPMantenimientoComisionesDatosGenerales\" con acción \"\" y\r    opcionMenu = \"consultar\", también se pasa el oid de la comisión que se está consultando.\r	*/\r  function onClickConsultarVigente()\r  {\r	  obj = new Object()\r	  obj.oidComision = get(\"formulario.varOidComisionVigente\")\r   	  obj.titulo = \"ConsultarComisiones\"\r	  obj.opcionMenu = \"consultar\"\r  	  obj.estadoVentana = \"M\"\r	  vWnd = mostrarModalSICC('LPMantenimientoComisionesDatosGenerales','',obj, 850,500)\r  }\r\r  \r"));
