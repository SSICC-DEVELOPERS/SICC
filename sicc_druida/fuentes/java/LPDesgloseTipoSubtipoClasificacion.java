...
public class LPDesgloseTipoSubtipoClasificacion extends LPSICCBase{
	private String accion;

	public LPDesgloseTipoSubtipoClasificacion(){
		super();
	}
	...
	public void ejecucion() throws Exception{
		...
		try{
			if( accion.equals("") ){
				cargarPagina();
				getConfiguracionMenu("LPDesgloseTipoSubtipoClasificacion", "buscar");
			}
	...
	private void cargarPagina() throws Exception{
		// -> Asignar página "contenido_desglose_tipo_consultar" 
		pagina("contenido_desglose_tipo_consultar");
		...
		// -> datosDesglose.tipoDesglose = ConstantesDesglosesPED.DESGLOSE_TIPO_SUBTIPO_CLASIFICACION 
		...
		datosDesglose.setTipoDesglose(ConstantesDesglosesPED.DESGLOSE_TIPO_SUBTIPO_CLASIFICACION);
	...
	private void desglose() throws Exception{
		...
		conectorActionParametro("accion","tipocliente");
	}
