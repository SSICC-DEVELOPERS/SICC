/*
    INDRA/CAR/mmg
    $Id: MaeTipoDocumLPStartUp.java,v 1.1 2009/12/03 18:34:47 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class MaeTipoDocumLPStartUp extends MMGDruidaBase{
	...
	protected static Hashtable indObliValues = new Hashtable();
	static{
		indObliValues.put(new java.lang.String("1"), "Si");
		indObliValues.put(new java.lang.String("0"), "No");
	}
	protected static Hashtable indDniValues = new Hashtable();
	static{
		indDniValues.put(new java.lang.String("1"), "Si");
		indDniValues.put(new java.lang.String("0"), "No");
	}
	protected static Hashtable indDocIdenFiscValues = new Hashtable();
	static{
		indDocIdenFiscValues.put(new java.lang.String("1"), "Si");
		indDocIdenFiscValues.put(new java.lang.String("0"), "No");
	}
	
	
	// Definicion del constructor
	public MaeTipoDocumLPStartUp(){
		super();
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "MaeTipoDocumPage", "cod", "MaeTipoDocum." + accion + ".label");
			...
			limpiarBotoneraLista("maeTipoDocum", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codTipoDocu", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 2);");
		
		asignarAtributo("TEXT", "Descripcion", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 40);");
		asignarAtributo("TEXT", "valSigl", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 0, 5);");
		asignarAtributo("TEXT", "valLong", "validacion", "mensaje = ValidaInt(cdos_trim(valor), 2, 0, 99);");
		...
		//asignarAtributo("CAPA", "maeTipoDocumLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "MaeTipoDocumPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		MaeTipoDocumData maeTipoDocumQuery= new MaeTipoDocumData();
		maeTipoDocumQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		MaeTipoDocumData datosResult = (MaeTipoDocumData)getSingleObject(BUSINESSID_QUERY, maeTipoDocumQuery, 
			maeTipoDocumQuery.clone(), "maeTipoDocum");
		...
		preservaHiddensI18n(new Integer(1), "MAE_TIPO_DOCUM", "maeTipoDocumFrm", "Descripcion", true);
		
		
		//Guardamos los valores de los radiobuttons
		if(datosResult.getIndObli() != null)
			asignar("VAR", "indObliCheckValue", datosResult.getIndObli().toString());
		if(datosResult.getIndDni() != null)
			asignar("VAR", "indDniCheckValue", datosResult.getIndDni().toString());
		if(datosResult.getIndDocIdenFisc() != null)
			asignar("VAR", "indDocIdenFiscCheckValue", datosResult.getIndDocIdenFisc().toString());
		...
		MaeTipoDocumData maeTipoDocum = datosResult;
		asignar("TEXT", "codTipoDocu", FormatUtils.formatObject(maeTipoDocum.getCodTipoDocu(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignarAtributo("RADIOB", "indObli" , "valor", FormatUtils.formatObject(
			maeTipoDocum.getIndObli(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "Descripcion", FormatUtils.formatObject(maeTipoDocum.getDescripcion(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "valSigl", FormatUtils.formatObject(maeTipoDocum.getValSigl(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "valLong", FormatUtils.formatObject(maeTipoDocum.getValLong(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignarAtributo("RADIOB", "indDni" , "valor", FormatUtils.formatObject(
			maeTipoDocum.getIndDni(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignarAtributo("RADIOB", "indDocIdenFisc" , "valor", FormatUtils.formatObject(
			maeTipoDocum.getIndDocIdenFisc(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		es.indra.belcorp.mso.FacTipoDocumData tidoOidTipoDocu = maeTipoDocum.getTidoOidTipoDocu();
		...
		loadLocalizationVars(maeTipoDocum);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "codTipoDocu", "disabled", "S");
		
					asignarAtributo("RADIOB", "indObli", "disabled", "S");
		asignarAtributo("TEXT", "Descripcion", "disabled", "S");
		asignarAtributo("TEXT", "valSigl", "disabled", "S");
		asignarAtributo("TEXT", "valLong", "disabled", "S");
		
					asignarAtributo("RADIOB", "indDni", "disabled", "S");
		
					asignarAtributo("RADIOB", "indDocIdenFisc", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "MAE_TIPO_DOCUM", "maeTipoDocumFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "codTipoDocu", "req", "S");
		asignarAtributo("RADIOB", "indObli", "req", "S");
		asignarAtributo("TEXT", "Descripcion", "req", "S");
		asignarAtributo("RADIOB", "indDni", "req", "S");
		asignarAtributo("RADIOB", "indDocIdenFisc", "req", "S");
		asignarAtributo("COMBO", "tidoOidTipoDocu", "req", "S");
		
		
		//Asiganamos a los campos internacionalizables la función de onblur para actualizar el 
		//valor del idioma por defecto
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('maeTipoDocumFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "maeTipoDocumFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		MaeTipoDocumData maeTipoDocumQuery= new MaeTipoDocumData();
		maeTipoDocumQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(maeTipoDocum.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"maeTipoDocumFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"maeTipoDocumFrm\",1, false)");
					asignarAtributo("COMBO","paisOidPais", "ontab", "ejecutarAccionFocoModificacion(\"maeTipoDocumFrm\",2, true)");
					asignarAtributo("COMBO","paisOidPais", "onshtab", "ejecutarAccionFocoModificacion(\"maeTipoDocumFrm\",2, false)");
				asignarAtributo("AREATEXTO", "codTipoDocu", "ontab","ejecutarAccionFocoModificacion(\"maeTipoDocumFrm\",3, true)");
				asignarAtributo("AREATEXTO", "codTipoDocu", "onshtab","ejecutarAccionFocoModificacion(\"maeTipoDocumFrm\",3, false)");
				asignarAtributo("TEXT", "indObli", "ontab","ejecutarAccionFocoModificacion(\"maeTipoDocumFrm\",4, true)");
				asignarAtributo("TEXT", "indObli", "onshtab","ejecutarAccionFocoModificacion(\"maeTipoDocumFrm\",4, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"maeTipoDocumFrm\",5, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"maeTipoDocumFrm\",5, false)");
				asignarAtributo("AREATEXTO", "valSigl", "ontab","ejecutarAccionFocoModificacion(\"maeTipoDocumFrm\",6, true)");
				asignarAtributo("AREATEXTO", "valSigl", "onshtab","ejecutarAccionFocoModificacion(\"maeTipoDocumFrm\",6, false)");
				asignarAtributo("AREATEXTO", "valLong", "ontab","ejecutarAccionFocoModificacion(\"maeTipoDocumFrm\",7, true)");
				asignarAtributo("AREATEXTO", "valLong", "onshtab","ejecutarAccionFocoModificacion(\"maeTipoDocumFrm\",7, false)");
				asignarAtributo("TEXT", "indDni", "ontab","ejecutarAccionFocoModificacion(\"maeTipoDocumFrm\",8, true)");
				asignarAtributo("TEXT", "indDni", "onshtab","ejecutarAccionFocoModificacion(\"maeTipoDocumFrm\",8, false)");
				asignarAtributo("TEXT", "indDocIdenFisc", "ontab","ejecutarAccionFocoModificacion(\"maeTipoDocumFrm\",9, true)");
				asignarAtributo("TEXT", "indDocIdenFisc", "onshtab","ejecutarAccionFocoModificacion(\"maeTipoDocumFrm\",9, false)");
					asignarAtributo("COMBO","tidoOidTipoDocu", "ontab", "ejecutarAccionFocoModificacion(\"maeTipoDocumFrm\",10, true)");
					asignarAtributo("COMBO","tidoOidTipoDocu", "onshtab", "ejecutarAccionFocoModificacion(\"maeTipoDocumFrm\",10, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","maeTipoDocumTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","maeTipoDocumTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codTipoDocu...");		
				
					traza("MMG: en desactivateNonModifyFields encontrado atributo no editable...");
				
						// borrarCampo("codTipoDocu");
						asignarAtributo ("TEXT", "codTipoDocu", "disabled", "S");
				traza("MMG: el atributo es indObli...");		
				...
				traza("MMG: el atributo es valSigl...");		
				
				traza("MMG: el atributo es valLong...");		
				
				traza("MMG: el atributo es indDni...");		
				
				traza("MMG: el atributo es indDocIdenFisc...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","maeTipoDocumFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","maeTipoDocumListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","maeTipoDocumListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(MaeTipoDocumData maeTipoDocum) throws Exception{
		...
		if(maeTipoDocum != null && maeTipoDocum.getPaisOidPais() != null){
				checkCombo("paisOidPais" , maeTipoDocum.getPaisOidPais().getId().toString());
			}
		...
		if(maeTipoDocum != null && maeTipoDocum.getTidoOidTipoDocu() != null){
				checkCombo("tidoOidTipoDocu" , maeTipoDocum.getTidoOidTipoDocu().getId().toString());
			}
	...
	* @param maeTipoDocum La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(MaeTipoDocumData maeTipoDocum) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		MaeTipoDocumData maeTipoDocum = 
			(MaeTipoDocumData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(maeTipoDocum.getPaisOidPais() != null){
			maeTipoDocum.setPaisOidPais((es.indra.belcorp.mso.SegPaisViewData)
			getSingleObject(BUSINESSID_PAISOIDPAIS_QUERY, 
			maeTipoDocum.getPaisOidPais(),
			maeTipoDocum.getPaisOidPais().clone(),
			"segPaisView"));
		}
		if(maeTipoDocum.getTidoOidTipoDocu() != null){
			maeTipoDocum.setTidoOidTipoDocu((es.indra.belcorp.mso.FacTipoDocumData)
			getSingleObject(BUSINESSID_TIDOOIDTIPODOCU_QUERY, 
			maeTipoDocum.getTidoOidTipoDocu(),
			maeTipoDocum.getTidoOidTipoDocu().clone(),
			"facTipoDocum"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(maeTipoDocum);
		loadLeafDependenceCombos(maeTipoDocum);
	}
	...
	*/
	...
	protected void loadLocalizationVars(MaeTipoDocumData maeTipoDocum) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("MAE_TIPO_DOCUM");
		mmgLocalizationQuery.setEntiPk(maeTipoDocum.getId());
