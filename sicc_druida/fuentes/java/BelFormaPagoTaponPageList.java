...
public class BelFormaPagoTaponPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","belFormaPagoTaponList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","BelFormaPagoTapon.codFormPago.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","BelFormaPagoTapon.Descripcion.label" );
