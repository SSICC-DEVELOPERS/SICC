...
public class RECEstadisticaModalidadAtencionOpCampana extends LPSICCBase {           
   public RECEstadisticaModalidadAtencionOpCampana() {	 
     super();
  }
     ...
     try {
        ...
        if (accion.equals("generar")){
          ...
          //cargarPagina();
           ...
           cargarPagina();
           getConfiguracionMenu("RECEstadisticaModalidadAtencionOpCampana");
        }
  ...
  private void cargarPagina() throws Exception{
     ...
     asignarAtributoPagina("cod", "0911");
     asignarAtributo("VAR", "lp", "valor", "RECEstadisticaModalidadAtencionOpCampana");
 ...
 private void generarReporte() throws Exception{
    ...
    String marca        = conectorParametroLimpia("marca", "", true);
     ...
     datos.put(ConstantesREP.TITULO, "Estadística de Modalidad de Atención por Operación por Campaña");     
     traza("++++++Antes de enviar a reportes " + datos); 
        
     
     traza("el formaro es  " + formato);
     //ejecutarReporte(datos, "REPGenerarReporte", "RD_REP-109", formato);
