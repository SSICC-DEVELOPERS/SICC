...
public class MaeTipoBloquPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","maeTipoBloquList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","MaeTipoBloqu.codTipoBloq.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","MaeTipoBloqu.Descripcion.label" );
