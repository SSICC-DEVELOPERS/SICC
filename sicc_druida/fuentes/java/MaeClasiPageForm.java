...
public class MaeClasiPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","MaeClasi.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","MaeClasi.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('maeClasiFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('maeClasiFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(57)).setAttribute("onchange","mmgDependeneChange('tcclOidTipoClas_sbtiOidSubtClie_ticlOidTipoClie', 'tcclOidTipoClas' , 'maeClasi')" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","focaliza('maeClasiFrm.tcclOidTipoClas_sbtiOidSubtClie');" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('maeClasiFrm',2, false);" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(68)).setAttribute("onchange","mmgDependeneChange('tcclOidTipoClas_sbtiOidSubtClie', 'tcclOidTipoClas' , 'maeClasi')" );
      ...
      ((Element)v.get(68)).setAttribute("ontab","focaliza('maeClasiFrm.tcclOidTipoClas');" );
      ((Element)v.get(68)).setAttribute("onshtab","focaliza('maeClasiFrm.tcclOidTipoClas_sbtiOidSubtClie_ticlOidTipoClie');" );
      ...
      ((Element)v.get(76)).setAttribute("cod","MaeClasi.tcclOidTipoClas.label" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(79)).setAttribute("ontab","ejecutarAccionFoco('maeClasiFrm',2, true);" );
      ((Element)v.get(79)).setAttribute("onshtab","focaliza('maeClasiFrm.tcclOidTipoClas_sbtiOidSubtClie');" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(102)).setAttribute("cod","MaeClasi.codClas.label" );
      ...
      ((Element)v.get(105)).setAttribute("ontab","ejecutarAccionFoco('maeClasiFrm',3, true)" );
      ((Element)v.get(105)).setAttribute("onshtab","ejecutarAccionFoco('maeClasiFrm', 3, false)" );
      ...
      ((Element)v.get(112)).setAttribute("cod","MaeClasi.Descripcion.label" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(116)).setAttribute("ontab","ejecutarAccionFoco('maeClasiFrm',4, true)" );
      ((Element)v.get(116)).setAttribute("onshtab","ejecutarAccionFoco('maeClasiFrm', 4, false)" );
      ...
      ((Element)v.get(120)).setAttribute("href","javascript:openLocalizationDialog('maeClasiFrm', 'Descripcion', 1);" );
      ((Element)v.get(120)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"maeClasiFrm\",4, true)', 'ejecutarAccionFoco(\"maeClasiFrm\",4, false)')" );
   ...
   private void getXML630(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(136)).setAttribute("nombre","maeClasiTrButtons" );
      ...
      ((Element)v.get(143)).setAttribute("nombre","maeClasiTdQueryButton" );
      ((Element)v.get(142)).appendChild((Element)v.get(143));

      /* Empieza nodo:144 / Elemento padre: 143   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(144)).setAttribute("nombre","maeClasiQueryButton" );
      ((Element)v.get(144)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(144)).setAttribute("estado","false" );
      ((Element)v.get(144)).setAttribute("accion","maeClasiFirstPage();" );
      ...
      ((Element)v.get(145)).setAttribute("nombre","maeClasiTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(147)).setAttribute("nombre","maeClasiLovNullButton" );
      ((Element)v.get(147)).setAttribute("ID","botonContenido" );
      ((Element)v.get(147)).setAttribute("tipo","html" );
      ((Element)v.get(147)).setAttribute("accion","maeClasiLovNullSelectionAction();" );
