...
public class FacParamFactuPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","facParamFactuList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(19)).setAttribute("cod","FacParamFactu.indDocuMonoPagi.label" );
      ...
      ((Element)v.get(20)).setAttribute("cod","FacParamFactu.valMontLimiUit.label" );
      ...
      ((Element)v.get(21)).setAttribute("cod","FacParamFactu.numMaxiCampPrd.label" );
      ...
      ((Element)v.get(22)).setAttribute("cod","FacParamFactu.indTipoProyRegi.label" );
      ...
      ((Element)v.get(23)).setAttribute("cod","FacParamFactu.indMostVencCupo.label" );
      ...
      ((Element)v.get(24)).setAttribute("cod","FacParamFactu.numMaxiPediProy.label" );
      ...
      ((Element)v.get(25)).setAttribute("cod","FacParamFactu.codModaDist.label" );
      ...
      ((Element)v.get(26)).setAttribute("cod","FacParamFactu.indCheqClieNuev.label" );
