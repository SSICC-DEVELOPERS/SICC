...
public class BelFormaPagoTaponPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","BelFormaPagoTapon.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","BelFormaPagoTapon.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('belFormaPagoTaponFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('belFormaPagoTaponFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(54)).setAttribute("cod","BelFormaPagoTapon.codFormPago.label" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('belFormaPagoTaponFrm',2, true)" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('belFormaPagoTaponFrm', 2, false)" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(79)).setAttribute("cod","BelFormaPagoTapon.Descripcion.label" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(83)).setAttribute("ontab","ejecutarAccionFoco('belFormaPagoTaponFrm',3, true)" );
      ((Element)v.get(83)).setAttribute("onshtab","ejecutarAccionFoco('belFormaPagoTaponFrm',3, false)" );
      ...
      ((Element)v.get(87)).setAttribute("href","javascript:openLocalizationDialog('belFormaPagoTaponFrm', 'Descripcion', 1);" );
      ((Element)v.get(87)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"belFormaPagoTaponFrm\",3, true)', 'ejecutarAccionFoco(\"belFormaPagoTaponFrm\",3, false)')" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(103)).setAttribute("nombre","belFormaPagoTaponTrButtons" );
      ...
      ((Element)v.get(110)).setAttribute("nombre","belFormaPagoTaponTdQueryButton" );
      ((Element)v.get(109)).appendChild((Element)v.get(110));

      /* Empieza nodo:111 / Elemento padre: 110   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(111)).setAttribute("nombre","belFormaPagoTaponQueryButton" );
      ((Element)v.get(111)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(111)).setAttribute("estado","false" );
      ((Element)v.get(111)).setAttribute("accion","belFormaPagoTaponFirstPage();" );
      ...
      ((Element)v.get(112)).setAttribute("nombre","belFormaPagoTaponTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(114)).setAttribute("nombre","belFormaPagoTaponLovNullButton" );
      ((Element)v.get(114)).setAttribute("ID","botonContenido" );
      ((Element)v.get(114)).setAttribute("tipo","html" );
      ((Element)v.get(114)).setAttribute("accion","belFormaPagoTaponLovNullSelectionAction();" );
