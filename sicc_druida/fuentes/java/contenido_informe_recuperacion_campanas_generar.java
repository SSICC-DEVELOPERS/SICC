...
public class contenido_informe_recuperacion_campanas_generar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_informe_recuperacion_campanas_generar" );
      ((Element)v.get(0)).setAttribute("cod","0853" );
      ((Element)v.get(0)).setAttribute("titulo","Generar informe recuperación por camapañas" );
      ...
      v.add(doc.createTextNode("\r   \r \r   function onLoad(){\r      configurarMenuSecundario('Formulario');\r      fMostrarMensajeError();\r      focaliza('Formulario.cbMarca');\r                 \r   }\r\r     function quitarItemVacio(elemento){\r      var elementoADevolver = new Array();\r     \r      for(var k=0;k<elemento.length;k++) {\r          if (elemento[k] != ''){                            \r             elementoADevolver[elementoADevolver.length] = elemento[k];\r          }\r      }\r         \r      return elementoADevolver;\r      \r   }\r   function generar(formato){\r      if(sicc_validaciones_generales()){\r                     \r               /*recolectarParametros();\r               set('Formulario.conectorAction', 'CCCBaseRecCamp');           \r               set('Formulario.accion', 'generar');\r               set('Formulario.formatoSalida', formato);\r               enviaSICC('Formulario');*/\r               var a = new Object();\r               a.accion = 'generar';\r               a.marca = get('Formulario.cbMarca');\r               a.marcaDesc = get('Formulario.cbMarca', 'T');\r               a.canal = get('Formulario.cbCanal');\r               a.canalDesc = get('Formulario.cbCanal', 'T');\r               a.sgv = quitarItemVacio(get('Formulario.cbSubgerenciaVentas'));\r               a.sgvDesc = quitarItemVacio(get('Formulario.cbSubgerenciaVentas', 'T'));\r               a.region = quitarItemVacio(get('Formulario.cbRegion'));  \r               a.regionDesc = quitarItemVacio(get('Formulario.cbRegion', 'T'));  \r               a.zona = quitarItemVacio(get('Formulario.cbZona'));\r               a.seccion = quitarItemVacio(get('Formulario.cbSeccion'));\r               a.seccionDesc = quitarItemVacio(get('Formulario.cbSeccion', 'T'));\r               a.periodoDesde = get('Formulario.cbPeriodoDesde');\r               a.periodoDesdeDesc = get('Formulario.cbPeriodoDesde', 'T');\r               a.periodoHasta = get('Formulario.cbPeriodoHasta');\r               a.periodoHastaDesc = get('Formulario.cbPeriodoHasta', 'T');\r               a.agrupacion = get('Formulario.cbAgrupacion');   \r               a.formatoSalida = formato;\r               mostrarModalSICC('CCCBaseRecCamp','generar', a);  \r                   \r      }\r   }\r\r\r\r   function onchangeMarcaCanal(){\r        \r       marca  = get('Formulario.cbMarca');\r       canal  = get('Formulario.cbCanal');\r       pais   = get('Formulario.pais');\r       idioma = get('Formulario.idioma');\r      \r       if(marca != '' && canal != ''){\r          var arr = new Array();\r          var arr2 = new Array();\r                      \r          arr[arr.length] = [\"oidIdioma\", idioma]; \r          arr[arr.length] = [\"oidPais\", pais]; \r          arr[arr.length] = [\"marca\", marca];\r          arr[arr.length] = [\"canal\", canal];\r          \r          arr2[arr2.length] = [\"oidPais\", pais]; \r          arr2[arr2.length] = [\"oidMarca\", marca];\r          arr2[arr2.length] = [\"oidCanal\", canal];\r                    \r          recargaCombo(\"Formulario.cbPeriodoDesde\",\"PRECargarPeriodos\",\"es.indra.sicc.dtos.cra.DTOPeriodo\",arr);\r          recargaCombo(\"Formulario.cbPeriodoHasta\",\"PRECargarPeriodos\",\"es.indra.sicc.dtos.cra.DTOPeriodo\",arr);\r          recargaCombo(\"Formulario.cbSubgerenciaVentas\",\"ZONRecargaSubgerenciaVentas\", \"es.indra.sicc.dtos.zon.DTOUnidadAdministrativa\",arr2); \r            \r       }else{\r           var aCombo = new Array(new Array(\"\",\"\"));\r           set_combo('Formulario.cbSubgerenciaVentas', aCombo, []); \r           set_combo('Formulario.cbRegion', aCombo, []); \r           set_combo('Formulario.cbZona', aCombo, []); \r           set_combo('Formulario.cbSeccion', aCombo, []); \r           set_combo('Formulario.cbPeriodoDesde', aCombo, []); \r           set_combo('Formulario.cbPeriodoHasta', aCombo, []); \r          \r       }\r    } \r \r    function cambioSubgerencia(){\r  \r    opciones = new Array();\r    set_combo('Formulario.cbRegion',opciones);\r    set_combo('Formulario.cbZona',opciones);\r    set_combo('Formulario.cbSeccion',opciones);\r   \r    combo_add('Formulario.cbRegion', '', '');\r    combo_add('Formulario.cbZona', '', '');\r    combo_add('Formulario.cbSeccion', '', '');\r    \r    var sgvs = quitarItemVacio(get('Formulario.cbSubgerenciaVentas'));\r        var pais = get('Formulario.pais');\r    var sgvsConc = new String();\r    \r    for(i=0;i<sgvs.length;i++){\r        sgvsConc += sgvs[i] + \"x\";\r    }\r         \r    sgvsConc = sgvsConc.substring(0, sgvsConc.length-1);\r    \r    var arr = new Array();\r    arr[arr.length] = ['cadena', sgvsConc];\r    arr[arr.length] = ['oidPais', pais]\r    \r    if(sgvsConc != ''){\r        recargaCombo(\"Formulario.cbRegion\", \"REPRecargaRegiones\", \"es.indra.sicc.util.DTOString\",arr);\r    }\r  }\r\r  function cambioRegion(){\r    \r    opciones = new Array();\r    \r    set_combo('Formulario.cbZona',opciones);\r    set_combo('Formulario.cbSeccion',opciones);\r        \r    combo_add('Formulario.cbZona', '', '');\r    combo_add('Formulario.cbSeccion', '', '');\r    \r    var regiones = quitarItemVacio(get('Formulario.cbRegion'));\r        var pais = get('Formulario.pais');\r    var regionConc = new String();\r    \r    for(i=0;i<regiones.length;i++){\r        regionConc += regiones[i] + \"x\";\r    }\r         \r    regionConc = regionConc.substring(0, regionConc.length-1);\r    \r    var arr = new Array();\r    arr[arr.length] = ['cadena', regionConc];\r    arr[arr.length] = ['oidPais', pais]\r    \r    if(regionConc != ''){\r        recargaCombo(\"Formulario.cbZona\", \"REPRecargaZonas\", \"es.indra.sicc.util.DTOString\",arr);\r    }\r  }\r  \r   function cambioZona(){\r\r     opciones = new Array();\r     set_combo('Formulario.cbSeccion',opciones);\r        \r     combo_add('Formulario.cbSeccion', '', '');\r     var zonas = quitarItemVacio(get('Formulario.cbZona'));\r     	 var pais = get('Formulario.pais');\r     var zonaConc = new String();\r    \r     for(i=0;i<zonas.length;i++){\r        zonaConc += zonas[i] + \"x\";\r     }\r         \r     zonaConc = zonaConc.substring(0, zonaConc.length-1);\r\r     var arr = new Array();\r     arr[arr.length] = ['cadena', zonaConc];\r     arr[arr.length] = ['oidPais', pais]\r    \r     if(zonaConc != ''){\r        recargaCombo(\"Formulario.cbSeccion\", \"REPRecargaSecciones\", \"es.indra.sicc.util.DTOString\",arr);\r     }  \r   }  \r\r\r   function recolectarParametros(){\r           \r      set('Formulario.marca', get('Formulario.cbMarca'));\r      set('Formulario.marcaDesc', get('Formulario.cbMarca', 'T'));\r      set('Formulario.canal', get('Formulario.cbCanal'));\r      set('Formulario.canalDesc', get('Formulario.cbCanal', 'T'));\r      set('Formulario.sgv', get('Formulario.cbSubgerenciaVentas'));\r      set('Formulario.sgvDesc', get('Formulario.cbSubgerenciaVentas', 'T'));\r      set('Formulario.region', get('Formulario.cbRegion'));  \r      set('Formulario.regionDesc', get('Formulario.cbRegion', 'T'));  \r      set('Formulario.zona', get('Formulario.cbZona'));\r      set('Formulario.seccion', get('Formulario.cbSeccion'));\r      set('Formulario.seccionDesc', get('Formulario.cbSeccion', 'T'));\r      set('Formulario.periodoDesde', get('Formulario.cbPeriodoDesde'));\r      set('Formulario.periodoDesdeDesc', get('Formulario.cbPeriodoDesde', 'T'));\r      set('Formulario.periodoHasta', get('Formulario.cbPeriodoHasta'));\r      set('Formulario.periodoHastaDesc', get('Formulario.cbPeriodoHasta', 'T'));\r      set('Formulario.agrupacion', get('Formulario.cbAgrupacion'));\r        \r   }\r\r   \r\r\r   function fLimpiar(){\r     var aCombo = new Array(new Array(\"\",\"\"));\r     set_combo('Formulario.cbRegion', aCombo, []); \r     set_combo('Formulario.cbZona', aCombo, []); \r     set_combo('Formulario.cbSeccion', aCombo, []); \r     focaliza('Formulario.cbMarca');\r   }\r  \r   \r  \r  "));
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(11)).setAttribute("name","cbAgrupacion" );
      ((Element)v.get(11)).setAttribute("required","true" );
      ((Element)v.get(11)).setAttribute("cod","1903" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(34)).setAttribute("nombre","marcaDesc" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(35)).setAttribute("nombre","sgvDesc" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(36)).setAttribute("nombre","regionDesc" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(37)).setAttribute("nombre","seccionDesc" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(38)).setAttribute("nombre","periodoDesdeDesc" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(39)).setAttribute("nombre","periodoHastaDesc" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(40)).setAttribute("nombre","formato" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(79)).setAttribute("onchange","onchangeMarcaCanal();" );
      ((Element)v.get(79)).setAttribute("onshtab","focalizaBotonHTML('botonContenido','btnGenerarExcel');" );
      ...
      /* Empieza nodo:88 / Elemento padre: 60   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(60)).appendChild((Element)v.get(88));
      ...
      /* Empieza nodo:91 / Elemento padre: 57   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(57)).appendChild((Element)v.get(91));
   ...
   private void getXML450(Document doc) {
      ...
      /* Empieza nodo:121 / Elemento padre: 57   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(57)).appendChild((Element)v.get(121));
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(139)).setAttribute("onchange","cambioZona();" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(144)).setAttribute("nombre","cbSeccion" );
      ...
      /* Empieza nodo:151 / Elemento padre: 57   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(57)).appendChild((Element)v.get(151));
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(162)).setAttribute("nombre","lblPeriodoHasta" );
   ...
   private void getXML630(Document doc) {
      ...
      ((Element)v.get(162)).setAttribute("cod","1176" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(173)).setAttribute("nombre","cbPeriodoDesde" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(178)).setAttribute("nombre","cbPeriodoHasta" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(183)).setAttribute("nombre","cbAgrupacion" );
      ((Element)v.get(183)).setAttribute("size","1" );
      ((Element)v.get(183)).setAttribute("multiple","N" );
      ((Element)v.get(183)).setAttribute("valorinicial","2" );
      ((Element)v.get(183)).setAttribute("textoinicial","Por region" );
   ...
   private void getXML720(Document doc) {
      ...
      ((Element)v.get(186)).setAttribute("VALOR","3" );
      ...
      ((Element)v.get(187)).setAttribute("VALOR","Por zona" );
      ...
      /* Empieza nodo:193 / Elemento padre: 50   */
      v.add(doc.createElement("td"));
      ((Element)v.get(50)).appendChild((Element)v.get(193));
      ...
      /* Empieza nodo:195 / Elemento padre: 42   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(42)).appendChild((Element)v.get(195));
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(204)).setAttribute("nombre","btnGenerarExcel" );
      ((Element)v.get(204)).setAttribute("ID","botonContenido" );
      ((Element)v.get(204)).setAttribute("tipo","html" );
      ((Element)v.get(204)).setAttribute("accion","generar('xls');" );
      ((Element)v.get(204)).setAttribute("estado","false" );
      ((Element)v.get(204)).setAttribute("cod","2526" );
      ((Element)v.get(204)).setAttribute("ontab","focaliza('Formulario.cbMarca')" );
   ...
   private void getXML810(Document doc) {
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(210)).setAttribute("width","756" );
      ...
      ((Element)v.get(213)).setAttribute("height","1" );
