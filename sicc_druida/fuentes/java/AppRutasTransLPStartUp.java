/*
    INDRA/CAR/mmg
    $Id: AppRutasTransLPStartUp.java,v 1.1 2009/12/03 18:34:43 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class AppRutasTransLPStartUp extends MMGDruidaBase{
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "AppRutasTransPage", "cod", "AppRutasTrans." + accion + ".label");
			...
			limpiarBotoneraLista("appRutasTrans", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codRuta", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 6);");
		asignarAtributo("TEXT", "Descripcion", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 40);");
		asignarAtributo("TEXT", "numSecu", "validacion", "mensaje = ValidaInt(cdos_trim(valor), 6, 0, 999999);");
		
		//Primero determianmos el nombre del campo en la entidad de oriegen donde se van a cargar los datos
		asignar("VAR", "idAttributeLovOpener", conectorParametro(PARAMETRO_LOV_ATTRIBUTO));
		asignar("VAR", "idEntityLovOpener", conectorParametro(PARAMETRO_LOV_ENTIDAD));
		//asignarAtributo("CAPA", "appRutasTransLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "AppRutasTransPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		AppRutasTransData appRutasTransQuery= new AppRutasTransData();
		appRutasTransQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		AppRutasTransData datosResult = (AppRutasTransData)getSingleObject(BUSINESSID_QUERY, appRutasTransQuery, 
			appRutasTransQuery.clone(), "appRutasTrans");
		...
		preservaHiddensI18n(new Integer(1), "APP_RUTAS_TRANS", "appRutasTransFrm", "Descripcion", true);
		...
		AppRutasTransData appRutasTrans = datosResult;
		asignar("TEXT", "codRuta", FormatUtils.formatObject(appRutasTrans.getCodRuta(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "Descripcion", FormatUtils.formatObject(appRutasTrans.getDescripcion(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "numSecu", FormatUtils.formatObject(appRutasTrans.getNumSecu(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("AREATEXTO", "valObse", FormatUtils.formatObject(appRutasTrans.getValObse(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		loadLocalizationVars(appRutasTrans);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "codRuta", "disabled", "S");
		asignarAtributo("TEXT", "Descripcion", "disabled", "S");
		asignarAtributo("TEXT", "numSecu", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "APP_RUTAS_TRANS", "appRutasTransFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "codRuta", "req", "S");
		asignarAtributo("TEXT", "Descripcion", "req", "S");
		asignarAtributo("TEXT", "numSecu", "req", "S");
		
		
		//Asiganamos a los campos internacionalizables la función de onblur para actualizar el 
		//valor del idioma por defecto
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('appRutasTransFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "appRutasTransFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		AppRutasTransData appRutasTransQuery= new AppRutasTransData();
		appRutasTransQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(appRutasTrans.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"appRutasTransFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"appRutasTransFrm\",1, false)");
					asignarAtributo("COMBO","paisOidPais", "ontab", "ejecutarAccionFocoModificacion(\"appRutasTransFrm\",2, true)");
					asignarAtributo("COMBO","paisOidPais", "onshtab", "ejecutarAccionFocoModificacion(\"appRutasTransFrm\",2, false)");
				asignarAtributo("AREATEXTO", "codRuta", "ontab","ejecutarAccionFocoModificacion(\"appRutasTransFrm\",3, true)");
				asignarAtributo("AREATEXTO", "codRuta", "onshtab","ejecutarAccionFocoModificacion(\"appRutasTransFrm\",3, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"appRutasTransFrm\",4, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"appRutasTransFrm\",4, false)");
				asignarAtributo("AREATEXTO", "numSecu", "ontab","ejecutarAccionFocoModificacion(\"appRutasTransFrm\",5, true)");
				asignarAtributo("AREATEXTO", "numSecu", "onshtab","ejecutarAccionFocoModificacion(\"appRutasTransFrm\",5, false)");
				asignarAtributo("AREATEXTO", "valObse", "ontab","ejecutarAccionFocoModificacion(\"appRutasTransFrm\",6, true)");
				asignarAtributo("AREATEXTO", "valObse", "onshtab","ejecutarAccionFocoModificacion(\"appRutasTransFrm\",6, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","appRutasTransTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","appRutasTransTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codRuta...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","appRutasTransFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","appRutasTransListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","appRutasTransListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(AppRutasTransData appRutasTrans) throws Exception{
		...
		if(appRutasTrans != null && appRutasTrans.getPaisOidPais() != null){
				checkCombo("paisOidPais" , appRutasTrans.getPaisOidPais().getId().toString());
			}
	...
	* @param appRutasTrans La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(AppRutasTransData appRutasTrans) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		AppRutasTransData appRutasTrans = 
			(AppRutasTransData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(appRutasTrans.getPaisOidPais() != null){
			appRutasTrans.setPaisOidPais((es.indra.belcorp.mso.SegPaisViewData)
			getSingleObject(BUSINESSID_PAISOIDPAIS_QUERY, 
			appRutasTrans.getPaisOidPais(),
			appRutasTrans.getPaisOidPais().clone(),
			"segPaisView"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(appRutasTrans);
		loadLeafDependenceCombos(appRutasTrans);
	}
	...
	*/
	...
	protected void loadLocalizationVars(AppRutasTransData appRutasTrans) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("APP_RUTAS_TRANS");
		mmgLocalizationQuery.setEntiPk(appRutasTrans.getId());
