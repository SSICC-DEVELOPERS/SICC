...
public class LPEvaluarRankingPorDemandaPerf extends LPSICCBase {
    ...
    public void inicio() throws Exception {
        pagina ("contenido_ranking_demanda_evaluar_perf");
    }
    ...
    public void ejecucion() throws Exception {
        try{
            ...
            getConfiguracionMenu("LPEvaluarRankingPorDemandaPerf","");
            if (accion.equals("")){
    ...
    private void finalizar() throws Exception {
        if (comprobarNumerosRanking()){
            ...
            conectorAction("LPDefinirOfertaPerf");
