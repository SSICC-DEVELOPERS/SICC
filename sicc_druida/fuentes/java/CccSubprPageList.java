...
public class CccSubprPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","cccSubprList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(18)).setAttribute("cod","CccSubpr.ccprOidProc.label" );
      ...
      ((Element)v.get(19)).setAttribute("cod","CccSubpr.codSubp.label" );
      ...
      ((Element)v.get(20)).setAttribute("cod","CccSubpr.desSubp.label" );
      ...
      ((Element)v.get(21)).setAttribute("cod","CccSubpr.valIndiGestMarc.label" );
      ...
      ((Element)v.get(22)).setAttribute("cod","CccSubpr.valIndiActuCuot.label" );
      ...
      ((Element)v.get(23)).setAttribute("cod","CccSubpr.valIndiTipoAbon.label" );
      ...
      ((Element)v.get(24)).setAttribute("cod","CccSubpr.valIndiCons.label" );
