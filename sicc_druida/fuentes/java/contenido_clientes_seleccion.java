...
public class contenido_clientes_seleccion  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_clientes_seleccion" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(5)).setAttribute("src","contenido_clientes_seleccion.js" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(16)).setAttribute("nombre","indConsultoraInterna" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(17)).setAttribute("nombre","txtCodigoCliente" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(20)).setAttribute("nombre","llamadaDirecta" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(21)).setAttribute("nombre","cosultasinternas" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(22)).setAttribute("nombre","indCosultaInterna" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(23)).setAttribute("nombre","numDigitosCodigoCliente" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(25)).setAttribute("nombre","cteLlamadaDirecta" );
      ...
      ((Element)v.get(26)).setAttribute("alto","115" );
      ...
      ((Element)v.get(41)).setAttribute("nombre","lblDatosSeleccion" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(60)).setAttribute("nombre","cbSeleccion" );
      ((Element)v.get(60)).setAttribute("id","datosCampos" );
      ((Element)v.get(60)).setAttribute("onshtab","onshtabPag();" );
      ...
      ((Element)v.get(63)).setAttribute("VALOR","01" );
      ...
      ((Element)v.get(64)).setAttribute("VALOR","Consultas internas" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(80)).setAttribute("nombre","btnAceptar" );
      ((Element)v.get(80)).setAttribute("ID","botonContenido" );
      ((Element)v.get(80)).setAttribute("tipo","html" );
      ((Element)v.get(80)).setAttribute("accion","accionAceptar();" );
      ((Element)v.get(80)).setAttribute("ontab","siguienteAceptar();" );
      ((Element)v.get(80)).setAttribute("estado","false" );
      ((Element)v.get(80)).setAttribute("cod","12" );
      ...
      ((Element)v.get(89)).setAttribute("height","15" );
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(90)).setAttribute("nombre","capa2" );
      ((Element)v.get(90)).setAttribute("x","0" );
      ((Element)v.get(90)).setAttribute("y","100" );
      ((Element)v.get(90)).setAttribute("visibilidad","" );
      ((Element)v.get(90)).setAttribute("ancho","100%" );
      ((Element)v.get(90)).setAttribute("alto","115" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(98)).setAttribute("width","15" );
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(109)).setAttribute("width","400" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(117)).setAttribute("nombre","lblCodCliente" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(124)).setAttribute("nombre","txtCodCliente" );
      ((Element)v.get(124)).setAttribute("id","datosCampos" );
      ((Element)v.get(124)).setAttribute("max","15" );
      ((Element)v.get(124)).setAttribute("tipo","" );
      ((Element)v.get(124)).setAttribute("onchange","" );
      ((Element)v.get(124)).setAttribute("req","S" );
      ((Element)v.get(124)).setAttribute("onblur","codClienteOnBlur();" );
      ((Element)v.get(124)).setAttribute("size","19" );
      ...
      v.add(doc.createElement("IMG"));
      ((Element)v.get(128)).setAttribute("src","iconBuscar.gif" );
      ((Element)v.get(128)).setAttribute("onclick","accionBuscarCliente();" );
      ...
      /* Empieza nodo:131 / Elemento padre: 109   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(109)).appendChild((Element)v.get(131));
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(144)).setAttribute("nombre","btnVerFicha" );
      ((Element)v.get(144)).setAttribute("ID","botonContenido" );
      ((Element)v.get(144)).setAttribute("tipo","html" );
      ((Element)v.get(144)).setAttribute("ontab","ontabPag();" );
      ((Element)v.get(144)).setAttribute("accion","accionVerFicha();" );
      ((Element)v.get(144)).setAttribute("estado","false" );
      ((Element)v.get(144)).setAttribute("cod","2074" );
