...
public class contenido_cursos_modificar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_cursos_modificar" );
      ((Element)v.get(0)).setAttribute("cod","0466" );
      ((Element)v.get(0)).setAttribute("titulo","" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","Modificar cursos" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","contenido_cursos_modificar.js" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(32)).setAttribute("width","649" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(51)).setAttribute("onshtab","focalizaTabAux('cbMarca');" );
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(65)).setAttribute("width","649" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(90)).setAttribute("onblur","validaEntero('txtCodCurso');" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(110)).setAttribute("accion","accionBuscar();" );
      ((Element)v.get(110)).setAttribute("estado","false" );
      ((Element)v.get(110)).setAttribute("cod","1" );
      ((Element)v.get(110)).setAttribute("ontab","focalizaTabAux('btnBuscar');" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(120)).setAttribute("alto","350" );
      ...
      ((Element)v.get(120)).setAttribute("y","163" );
      ...
      ((Element)v.get(121)).setAttribute("ancho","652" );
      ((Element)v.get(121)).setAttribute("alto","299" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(132)).setAttribute("ancho","60" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(133)).setAttribute("ancho","130" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(135)).setAttribute("ancho","60" );
      ...
      /* Empieza nodo:137 / Elemento padre: 121   */
      v.add(doc.createElement("CABECERA"));
      ((Element)v.get(137)).setAttribute("alto","20" );
      ((Element)v.get(137)).setAttribute("IDScroll","EstCab" );
      ((Element)v.get(137)).setAttribute("imgFondo","" );
      ((Element)v.get(137)).setAttribute("colFondo","#CCCCCC" );
      ((Element)v.get(121)).appendChild((Element)v.get(137));

      /* Empieza nodo:138 / Elemento padre: 137   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(138)).setAttribute("colFondo","" );
      ((Element)v.get(138)).setAttribute("ID","EstCab" );
      ((Element)v.get(138)).setAttribute("cod","758" );
      ((Element)v.get(137)).appendChild((Element)v.get(138));

      /* Elemento padre:138 / Elemento actual: 139   */
      v.add(doc.createTextNode("Tipo curso"));
      ...
      ((Element)v.get(140)).setAttribute("cod","9" );
      ...
      /* Empieza nodo:148 / Elemento padre: 121   */
   ...
   private void getXML630(Document doc) {
      ((Element)v.get(121)).appendChild((Element)v.get(148));
      ...
      /* Empieza nodo:154 / Elemento padre: 121   */
      v.add(doc.createElement("ROWSET"));
      ((Element)v.get(121)).appendChild((Element)v.get(154));
      /* Termina nodo:154   */
      ...
      ((Element)v.get(156)).setAttribute("y","280" );
      ...
      ((Element)v.get(157)).setAttribute("y","280" );
      ...
      ((Element)v.get(158)).setAttribute("y","280" );
      ...
      ((Element)v.get(159)).setAttribute("y","276" );
      ...
      /* Empieza nodo:160 / Elemento padre: 120   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(160)).setAttribute("nombre","Modificar" );
      ((Element)v.get(160)).setAttribute("x","80" );
      ((Element)v.get(160)).setAttribute("y","277" );
   ...
   private void getXML720(Document doc) {
      ...
      ((Element)v.get(160)).setAttribute("cod","2" );
      ((Element)v.get(160)).setAttribute("accion","accionModificar();" );
      ((Element)v.get(160)).setAttribute("ontab","focaliza('frmFormulario.cbMarca');" );
      ((Element)v.get(160)).setAttribute("onshtab","document.all['btnBuscar'].focus();" );
      ((Element)v.get(120)).appendChild((Element)v.get(160));
      /* Termina nodo:160   */

      /* Empieza nodo:161 / Elemento padre: 120   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(161)).setAttribute("nombre","Detalle" );
      ((Element)v.get(161)).setAttribute("x","80" );
      ((Element)v.get(161)).setAttribute("y","277" );
      ...
      ((Element)v.get(161)).setAttribute("cod","3" );
      ((Element)v.get(161)).setAttribute("accion","accionDetalle();" );
      ((Element)v.get(161)).setAttribute("ontab","focaliza('frmFormulario.cbMarca');" );
      ((Element)v.get(161)).setAttribute("onshtab","document.all['btnBuscar'].focus();" );
      ((Element)v.get(120)).appendChild((Element)v.get(161));
      /* Termina nodo:161   */

      /* Empieza nodo:162 / Elemento padre: 120   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(162)).setAttribute("nombre","Copiar" );
      ((Element)v.get(162)).setAttribute("x","80" );
      ((Element)v.get(162)).setAttribute("y","277" );
      ...
      ((Element)v.get(162)).setAttribute("cod","721" );
      ((Element)v.get(162)).setAttribute("accion","accionCopiar();" );
      ((Element)v.get(162)).setAttribute("ontab","focaliza('frmFormulario.cbMarca');" );
      ((Element)v.get(162)).setAttribute("onshtab","document.all['btnBuscar'].focus();" );
      ((Element)v.get(120)).appendChild((Element)v.get(162));
      /* Termina nodo:162   */
      /* Termina nodo:120   */

      /* Empieza nodo:163 / Elemento padre: 5   */
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(163)).setAttribute("nombre","capaEspacio" );
      ((Element)v.get(163)).setAttribute("alto","12" );
      ((Element)v.get(163)).setAttribute("ancho","50" );
      ((Element)v.get(163)).setAttribute("x","0" );
      ((Element)v.get(163)).setAttribute("y","462" );
      ((Element)v.get(5)).appendChild((Element)v.get(163));
      /* Termina nodo:163   */
      /* Termina nodo:5   */
