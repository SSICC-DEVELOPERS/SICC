...
public class contenido_ordenes_compra_recepcion  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_ordenes_compra_recepcion" );
      ((Element)v.get(0)).setAttribute("cod","0292" );
      ((Element)v.get(0)).setAttribute("titulo","Recepcionar Ordenes de Compra" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","Recepcionar movimientos bancarios" );
      ((Element)v.get(0)).setAttribute("onload","load();" );
      ...
      v.add(doc.createTextNode("\r   \r    var varNoLimpiarSICC = true;\r  function load()\r  {\r    configurarMenuSecundario(\"frmFormulario\");\r    fMostrarMensajeError();\r\r    txt_to('lblvalorLote',get('frmFormulario.hValorLote'));\r    set('frmFormulario.Descripcion', get('frmFormulario.hDescLote'));\r        \r    focaliza(\"frmFormulario.Descripcion\");\r  }\r		\r  function fLimpiar()\r	{\r    set(\"frmFormulario.Descripcion\", \"\");\r    set(\"frmFormulario.Fecha\", \"\");\r    set(\"frmFormulario.areatxtObservaciones\",\"\");\r    focaliza(\"frmFormulario.Descripcion\", \"\");\r  }\r\r	function fGuardar()\r	{\r    if(sicc_validaciones_generales()){\r      if(validarFecha()){\r        set(\"frmFormulario.conectorAction\", \"LPRecepcionarOC\");\r        set(\"frmFormulario.accion\", \"RecibirInterfaz\");\r        enviaSICC(\"frmFormulario\");\r      }\r    }\r  }\r\r  function validarFecha(){\r\r    var msgValidaFecha;\r\r        var fechaInicio = get('frmFormulario.hFechaUltimoInicioProceso');   \r    var fechaFin = get('frmFormulario.Fecha');   \r\r        if(EsFechaValida_SICC(fechaFin, 'frmFormulario') && EsFechaValida_SICC(fechaInicio, 'frmFormulario')){\r      msgValidaFecha = ValidaFecha(fechaInicio,'D/M/Y',fechaInicio,fechaFin);\r    }else if(EsFechaValida_SICC(fechaFin, 'frmFormulario') && fechaInicio == ''){\r      msgValidaFecha = 'OK';\r    }\r\r    if (msgValidaFecha != 'OK') {   \r      GestionarMensaje('1462');\r      return false;\r    }else{\r      fechaInicio = get('frmFormulario.Fecha');  \r      fechaFin = get('frmFormulario.hFechaSistema');\r      msgValidaFecha = '';\r\r      if(EsFechaValida_SICC(fechaFin, 'frmFormulario') && EsFechaValida_SICC(fechaInicio, 'frmFormulario')){\r        msgValidaFecha = ValidaFecha(fechaInicio,'D/M/Y',fechaInicio,fechaFin);\r      }\r\r      if (msgValidaFecha != 'OK') {   \r        GestionarMensaje('1450');\r        return false;\r      }else{\r        return true;\r      }\r    }\r  }\r  \r     \r"));
      ...
      ((Element)v.get(5)).setAttribute("name","Descripcion" );
      ((Element)v.get(5)).setAttribute("required","true" );
      ((Element)v.get(5)).setAttribute("format","T" );
      ((Element)v.get(5)).setAttribute("max","100" );
      ((Element)v.get(5)).setAttribute("min","0" );
      ((Element)v.get(5)).setAttribute("cod","844" );
      ((Element)v.get(4)).appendChild((Element)v.get(5));
      /* Termina nodo:5   */

      /* Empieza nodo:6 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(6)).setAttribute("name","Fecha" );
      ((Element)v.get(6)).setAttribute("cod","878" );
      ...
      ((Element)v.get(9)).setAttribute("valor","LPRecepcionMovimientos" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(12)).setAttribute("nombre","hFechaUltimoInicioProceso" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(13)).setAttribute("nombre","hFechaSistema" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(14)).setAttribute("nombre","hValorLote" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(15)).setAttribute("nombre","hDescLote" );
      ...
      ((Element)v.get(16)).setAttribute("nombre","capa" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(31)).setAttribute("cod","00263" );
   ...
   private void getXML180(Document doc) {
      ((Element)v.get(47)).setAttribute("nombre","lblDescripcion" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(51)).setAttribute("nombre","lblFecha" );
      ((Element)v.get(51)).setAttribute("alto","13" );
      ((Element)v.get(51)).setAttribute("filas","1" );
      ((Element)v.get(51)).setAttribute("id","datosTitle" );
      ((Element)v.get(51)).setAttribute("cod","878" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(58)).setAttribute("nombre","lblvalorLote" );
      ...
      ((Element)v.get(62)).setAttribute("max","40" );
      ((Element)v.get(62)).setAttribute("tipo","" );
      ((Element)v.get(62)).setAttribute("onchange","" );
      ((Element)v.get(62)).setAttribute("req","S" );
      ((Element)v.get(62)).setAttribute("size","40" );
      ((Element)v.get(62)).setAttribute("valor","" );
      ((Element)v.get(62)).setAttribute("validacion","" );
      ((Element)v.get(62)).setAttribute("onshtab","document.selection.empty();document.all.btnRecepcionar.focus();" );
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(66)).setAttribute("nombre","Fecha" );
      ...
      ((Element)v.get(66)).setAttribute("size","10" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(86)).setAttribute("cols","50" );
      ((Element)v.get(86)).setAttribute("id","datosCampos" );
      ((Element)v.get(86)).setAttribute("msjreq","" );
      ((Element)v.get(86)).setAttribute("nombre","areatxtObservaciones" );
      ((Element)v.get(86)).setAttribute("readonly","N" );
      ((Element)v.get(86)).setAttribute("req","N" );
      ((Element)v.get(86)).setAttribute("rows","3" );
      ((Element)v.get(86)).setAttribute("tabindex","2" );
      ((Element)v.get(86)).setAttribute("valor","" );
      ((Element)v.get(86)).setAttribute("max","256" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(102)).setAttribute("nombre","btnRecepcionar" );
      ((Element)v.get(102)).setAttribute("ID","botonContenido" );
      ((Element)v.get(102)).setAttribute("tipo","html" );
      ((Element)v.get(102)).setAttribute("accion","fGuardar();" );
      ((Element)v.get(102)).setAttribute("estado","false" );
      ((Element)v.get(102)).setAttribute("cod","2263" );
      ((Element)v.get(102)).setAttribute("ontab","focaliza('frmFormulario.Descripcion');" );
