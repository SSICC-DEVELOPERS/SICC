...
public class MaeTipoBloquConectorQueryForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad MaeTipoBloqu" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGMaeTipoBloquQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGMaeTipoBloquQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","MaeTipoBloquFormFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","codTipoBloq" );
