...
public class MsgTipoMensaConectorQueryForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad MsgTipoMensa" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGMsgTipoMensaQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGMsgTipoMensaQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","MsgTipoMensaFormFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","codTipoMens" );
