...
public class SegPaisViewPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","segPaisViewList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","SegPaisView.codPais.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","SegPaisView.moneOidMone.label" );
