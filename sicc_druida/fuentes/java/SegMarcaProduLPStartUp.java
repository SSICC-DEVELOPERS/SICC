/*
    INDRA/CAR/mmg
    $Id: SegMarcaProduLPStartUp.java,v 1.1 2009/12/03 18:36:05 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class SegMarcaProduLPStartUp extends MMGDruidaBase{
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "SegMarcaProduPage", "cod", "SegMarcaProdu." + accion + ".label");
			...
			limpiarBotoneraLista("segMarcaProdu", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codMarcProd", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 3);");
		asignarAtributo("TEXT", "desMarcProd", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 30);");
		
		//Primero determianmos el nombre del campo en la entidad de oriegen donde se van a cargar los datos
		asignar("VAR", "idAttributeLovOpener", conectorParametro(PARAMETRO_LOV_ATTRIBUTO));
		asignar("VAR", "idEntityLovOpener", conectorParametro(PARAMETRO_LOV_ENTIDAD));
		//asignarAtributo("CAPA", "segMarcaProduLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "SegMarcaProduPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		SegMarcaProduData segMarcaProduQuery= new SegMarcaProduData();
		segMarcaProduQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		SegMarcaProduData datosResult = (SegMarcaProduData)getSingleObject(BUSINESSID_QUERY, segMarcaProduQuery, 
			segMarcaProduQuery.clone(), "segMarcaProdu");
		...
		SegMarcaProduData segMarcaProdu = datosResult;
		asignar("TEXT", "codMarcProd", FormatUtils.formatObject(segMarcaProdu.getCodMarcProd(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "desMarcProd", FormatUtils.formatObject(segMarcaProdu.getDesMarcProd(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		asignarAtributo("TEXT", "codMarcProd", "disabled", "S");
		asignarAtributo("TEXT", "desMarcProd", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		...
		asignarAtributo("TEXT", "codMarcProd", "req", "S");
		asignarAtributo("TEXT", "desMarcProd", "req", "S");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "segMarcaProduFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		SegMarcaProduData segMarcaProduQuery= new SegMarcaProduData();
		segMarcaProduQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(segMarcaProdu.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"segMarcaProduFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"segMarcaProduFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codMarcProd", "ontab","ejecutarAccionFocoModificacion(\"segMarcaProduFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codMarcProd", "onshtab","ejecutarAccionFocoModificacion(\"segMarcaProduFrm\",2, false)");
				asignarAtributo("AREATEXTO", "desMarcProd", "ontab","ejecutarAccionFocoModificacion(\"segMarcaProduFrm\",3, true)");
				asignarAtributo("AREATEXTO", "desMarcProd", "onshtab","ejecutarAccionFocoModificacion(\"segMarcaProduFrm\",3, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","segMarcaProduTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","segMarcaProduTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codMarcProd...");		
				
					traza("MMG: en desactivateNonModifyFields encontrado atributo no editable...");
				
						// borrarCampo("codMarcProd");
						asignarAtributo ("TEXT", "codMarcProd", "disabled", "S");
				traza("MMG: el atributo es desMarcProd...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","segMarcaProduFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","segMarcaProduListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","segMarcaProduListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(SegMarcaProduData segMarcaProdu) throws Exception{
	...
	* @param segMarcaProdu La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(SegMarcaProduData segMarcaProdu) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		SegMarcaProduData segMarcaProdu = 
			(SegMarcaProduData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(segMarcaProdu);
		loadLeafDependenceCombos(segMarcaProdu);
	}
