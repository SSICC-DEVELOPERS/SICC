...
public class contenido_pais_configurar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_pais_configurar" );
      ((Element)v.get(0)).setAttribute("titulo","" );
      ((Element)v.get(0)).setAttribute("cod","0170" );
      ...
      v.add(doc.createTextNode("\r\r\r    function fGuardar(){\r        if(sicc_validaciones_generales(\"grupo2\")){\r            set('frmConfigurarMFPais.oidMarca',get('frmConfigurarMFPais.cbMarca','V'));\r            set('frmConfigurarMFPais.oidCanal',get('frmConfigurarMFPais.cbCanal','V'));\r            set('frmConfigurarMFPais.hMoneda',get('frmConfigurarMFPais.cbMoneda','V'));\r                                    set('frmConfigurarMFPais.accion','Guardar');\r            enviaSICC('frmConfigurarMFPais');\r        }\r    }\r\r    function fLimpiar(){\r        if (get('frmConfigurarMFPais.accion','T') == \"\"){\r                        			var array = new Array();\r		    array[0] = get('frmConfigurarMFPais.hMarca');\r	        set('frmConfigurarMFPais.cbMarca',array);\r			array = new Array();\r		    array[0] = get('frmConfigurarMFPais.hCanal');\r	        set('frmConfigurarMFPais.cbCanal',array);\r            focaliza('frmConfigurarMFPais.cbMarca','');\r        }else{\r            			        			\r			var array = new Array();\r	        array[0] = get('frmConfigurarMFPais.hMoneda');\r		    set('frmConfigurarMFPais.cbMoneda',array);\r            focaliza('frmConfigurarMFPais.cbMoneda','');\r        }\r    }\r          \r\r    function LoadBar(){\r        configurarMenuSecundario(\"frmConfigurarMFPais\");\r        focaliza('frmConfigurarMFPais.cbMarca','');\r        fMostrarMensajeError();\r        cargarCombos();\r        \r                   \r        if ((get('frmConfigurarMFPais.accion','T') == \"\") || get('frmConfigurarMFPais.errCodigo') == 51000 ) {\r			set('frmConfigurarMFPais.accion','');\r            focaliza('frmConfigurarMFPais.cbMarca','');\r            accion ('frmConfigurarMFPais.cbMoneda','.disabled=true');\r                                    accion ('frmConfigurarMFPais.cbCanal','.disabled=false');\r            accion ('frmConfigurarMFPais.cbMarca','.disabled=false');\r                                                            setMV('frmConfigurarMFPais.cbMoneda','N');\r            varNoLimpiarSICC = true;\r        }else {\r            accion ('frmConfigurarMFPais.cbMoneda','.disabled=false');\r                                    accion ('frmConfigurarMFPais.cbCanal','.disabled=true');\r            accion ('frmConfigurarMFPais.cbMarca','.disabled=true');\r			focaliza('frmConfigurarMFPais.cbMoneda','');\r                                    setMV('frmConfigurarMFPais.cbMoneda','S');\r						            varNoLimpiarSICC = false;\r        }\r    }\r    \r          \r    function CargarLista() {\r        \r        if(sicc_validaciones_generales(\"grupo1\")){\r            set('frmConfigurarMFPais.sMarca',get('frmConfigurarMFPais.cbMarca','T'));\r            set('frmConfigurarMFPais.oidMarca',get('frmConfigurarMFPais.cbMarca','V'));\r            set('frmConfigurarMFPais.sCanal',get('frmConfigurarMFPais.cbCanal','T'));\r            set('frmConfigurarMFPais.oidCanal',get('frmConfigurarMFPais.cbCanal','V'));\r            set('frmConfigurarMFPais.accion','Siguiente');\r            enviaSICC('frmConfigurarMFPais');\r        }\r    }\r\r    function cargarCombos(){\r        var array = new Array();\r        array[0] = get('frmConfigurarMFPais.hMoneda');\r        set('frmConfigurarMFPais.cbMoneda',array);\r        array = new Array();\r        array[0] = get('frmConfigurarMFPais.sMarca');\r        set('frmConfigurarMFPais.cbMarca',array);\r        array = new Array();\r        array[0] = get('frmConfigurarMFPais.sCanal');\r        set('frmConfigurarMFPais.cbCanal',array);\r    }    \r\r    function onTabBoton(){\r        try{\r            focaliza('frmConfigurarMFPais.cbMarca','');\r        }catch(e){\r            focaliza('frmConfigurarMFPais.cbMoneda','');\r        }\r    }\r\r	function onShtabBoton(){\r		if(get('frmConfigurarMFPais.txtLonSerie','.disabled') != '') {\r            focaliza('frmConfigurarMFPais.cbMoneda','');\r        } else {\r		     focaliza('frmConfigurarMFPais.cbCanal','');\r        }\r    }\r	 \r\r\r\r"));
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(7)).setAttribute("name","cbMoneda" );
      ((Element)v.get(7)).setAttribute("required","true" );
      ((Element)v.get(7)).setAttribute("cod","457" );
      ...
      ((Element)v.get(8)).setAttribute("nombre","frmConfigurarMFPais" );
      ((Element)v.get(0)).appendChild((Element)v.get(8));

      /* Empieza nodo:9 / Elemento padre: 8   */
      v.add(doc.createElement("VAR"));
      ((Element)v.get(9)).setAttribute("nombre","conectorAction" );
      ((Element)v.get(9)).setAttribute("valor","LPConfigurarMFPais" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(13)).setAttribute("nombre","sMarca" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(14)).setAttribute("nombre","sCanal" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(17)).setAttribute("nombre","hMoneda" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(20)).setAttribute("nombre","oidConfiguracionMF" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(36)).setAttribute("nombre","lblSeleccion" );
      ((Element)v.get(36)).setAttribute("alto","13" );
      ((Element)v.get(36)).setAttribute("filas","1" );
      ((Element)v.get(36)).setAttribute("valor","Selección de datos" );
      ((Element)v.get(36)).setAttribute("id","legend" );
      ((Element)v.get(36)).setAttribute("cod","00109" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(56)).setAttribute("onshtab","document.all.btnAceptar.focus();" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(78)).setAttribute("nombre","btnAceptar" );
      ((Element)v.get(78)).setAttribute("ID","botonContenido" );
      ((Element)v.get(78)).setAttribute("tipo","html" );
      ((Element)v.get(78)).setAttribute("accion","CargarLista();" );
      ((Element)v.get(78)).setAttribute("estado","false" );
      ((Element)v.get(78)).setAttribute("cod","12" );
      ((Element)v.get(78)).setAttribute("ontab","onTabBoton();" );
      ((Element)v.get(78)).setAttribute("onshtab","onShtabBoton();" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(90)).setAttribute("nombre","lblConfiguracion" );
      ((Element)v.get(90)).setAttribute("alto","13" );
      ((Element)v.get(90)).setAttribute("filas","1" );
      ((Element)v.get(90)).setAttribute("valor","Configuración matriz de facturación" );
      ((Element)v.get(90)).setAttribute("id","legend" );
      ((Element)v.get(90)).setAttribute("cod","00110" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(99)).setAttribute("nombre","lblMoneda" );
      ...
      ((Element)v.get(99)).setAttribute("cod","457" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(106)).setAttribute("nombre","cbMoneda" );
      ...
      ((Element)v.get(106)).setAttribute("ontab","focaliza('frmConfigurarMFPais.txtLonTipo','');" );
      ...
      /* Empieza nodo:113 / Elemento padre: 84   */
      v.add(doc.createElement("td"));
      ((Element)v.get(84)).appendChild((Element)v.get(113));
      ...
      /* Empieza nodo:115 / Elemento padre: 22   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(22)).appendChild((Element)v.get(115));
