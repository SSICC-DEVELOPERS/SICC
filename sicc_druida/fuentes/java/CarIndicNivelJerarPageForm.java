...
public class CarIndicNivelJerarPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","CarIndicNivelJerar.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","CarIndicNivelJerar.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('carIndicNivelJerarFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('carIndicNivelJerarFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(50)).setAttribute("nombre","codIndiNiveJeraTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lblCodIndiNiveJera" );
      ((Element)v.get(54)).setAttribute("alto","13" );
      ((Element)v.get(54)).setAttribute("filas","1" );
      ((Element)v.get(54)).setAttribute("id","datosTitle" );
      ((Element)v.get(54)).setAttribute("cod","CarIndicNivelJerar.codIndiNiveJera.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(55)).setAttribute("nombre","codIndiNiveJeraWidgetTrId" );
      ...
      ((Element)v.get(57)).setAttribute("nombre","codIndiNiveJera" );
      ((Element)v.get(57)).setAttribute("tipo","H" );
      ((Element)v.get(57)).setAttribute("req","N" );
      ((Element)v.get(57)).setAttribute("id","datosCampos" );
      ((Element)v.get(57)).setAttribute("valor","" );
      ((Element)v.get(57)).setAttribute("disabled","" );
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('carIndicNivelJerarFrm',2, true)" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('carIndicNivelJerarFrm',2, false)" );
      ((Element)v.get(56)).appendChild((Element)v.get(57));

      /* Empieza nodo:58 / Elemento padre: 57   */
      v.add(doc.createElement("RBINPUT"));
      ((Element)v.get(58)).setAttribute("id","datosCampos" );
      ((Element)v.get(58)).setAttribute("valor","A" );
      ((Element)v.get(58)).setAttribute("cod","CarIndicNivelJerar.codIndiNiveJera.A.label" );
   ...
   private void getXML270(Document doc) {
      ((Element)v.get(60)).setAttribute("valor","I" );
      ((Element)v.get(60)).setAttribute("cod","CarIndicNivelJerar.codIndiNiveJera.I.label" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(62)).setAttribute("nombre","codIndiNiveJeraGapTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(67)).setAttribute("nombre","formGapTr1" );
      ...
      /* Empieza nodo:76 / Elemento padre: 0   */
      v.add(doc.createElement("TR"));
      ((Element)v.get(76)).setAttribute("nombre","carIndicNivelJerarTrButtons" );
      ((Element)v.get(0)).appendChild((Element)v.get(76));
      ...
      ((Element)v.get(83)).setAttribute("nombre","carIndicNivelJerarTdQueryButton" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(84)).setAttribute("nombre","carIndicNivelJerarQueryButton" );
      ((Element)v.get(84)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(84)).setAttribute("estado","false" );
      ((Element)v.get(84)).setAttribute("accion","carIndicNivelJerarFirstPage();" );
      ...
      ((Element)v.get(85)).setAttribute("nombre","carIndicNivelJerarTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(87)).setAttribute("nombre","carIndicNivelJerarLovNullButton" );
      ((Element)v.get(87)).setAttribute("ID","botonContenido" );
      ((Element)v.get(87)).setAttribute("tipo","html" );
      ((Element)v.get(87)).setAttribute("accion","carIndicNivelJerarLovNullSelectionAction();" );
      ((Element)v.get(87)).setAttribute("estado","true" );
      ((Element)v.get(87)).setAttribute("cod","MMGGlobal.lovNullButton.label" );
