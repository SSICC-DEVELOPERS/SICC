...
public class SegSociePageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","segSocieList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","SegSocie.codSoci.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","SegSocie.valDeno.label" );
