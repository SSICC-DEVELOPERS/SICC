...
public class PedAsignAlmacPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","pedAsignAlmacList" );
      ...
      ((Element)v.get(14)).setAttribute("cod","PedAsignAlmac.marcOidMarc.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","PedAsignAlmac.sbacOidSbac.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","PedAsignAlmac.almcOidAlma.label" );
