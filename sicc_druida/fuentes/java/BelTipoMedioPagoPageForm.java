...
public class BelTipoMedioPagoPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","BelTipoMedioPago.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","BelTipoMedioPago.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('belTipoMedioPagoFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('belTipoMedioPagoFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(54)).setAttribute("cod","BelTipoMedioPago.Descripcion.label" );
      ...
      ((Element)v.get(58)).setAttribute("ontab","ejecutarAccionFoco('belTipoMedioPagoFrm',4, true)" );
      ((Element)v.get(58)).setAttribute("onshtab","ejecutarAccionFoco('belTipoMedioPagoFrm', 4, false)" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(62)).setAttribute("href","javascript:openLocalizationDialog('belTipoMedioPagoFrm', 'Descripcion', 1);" );
      ((Element)v.get(62)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"belTipoMedioPagoFrm\",4, true)', 'ejecutarAccionFoco(\"belTipoMedioPagoFrm\",4, false)')" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(78)).setAttribute("nombre","belTipoMedioPagoTrButtons" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(85)).setAttribute("nombre","belTipoMedioPagoTdQueryButton" );
      ((Element)v.get(84)).appendChild((Element)v.get(85));

      /* Empieza nodo:86 / Elemento padre: 85   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(86)).setAttribute("nombre","belTipoMedioPagoQueryButton" );
      ((Element)v.get(86)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(86)).setAttribute("estado","false" );
      ((Element)v.get(86)).setAttribute("accion","belTipoMedioPagoFirstPage();" );
      ...
      ((Element)v.get(87)).setAttribute("nombre","belTipoMedioPagoTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(89)).setAttribute("nombre","belTipoMedioPagoLovNullButton" );
      ((Element)v.get(89)).setAttribute("ID","botonContenido" );
      ((Element)v.get(89)).setAttribute("tipo","html" );
      ((Element)v.get(89)).setAttribute("accion","belTipoMedioPagoLovNullSelectionAction();" );
