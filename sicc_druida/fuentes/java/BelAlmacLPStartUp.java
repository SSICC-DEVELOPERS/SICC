/*
    INDRA/CAR/mmg
    $Id: BelAlmacLPStartUp.java,v 1.1 2009/12/03 18:32:56 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class BelAlmacLPStartUp extends MMGDruidaBase{
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "BelAlmacPage", "cod", "BelAlmac." + accion + ".label");
			...
			limpiarBotoneraLista("belAlmac", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codAlma", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 3);");
		...
		//asignarAtributo("CAPA", "belAlmacLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "BelAlmacPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		BelAlmacData belAlmacQuery= new BelAlmacData();
		belAlmacQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		BelAlmacData datosResult = (BelAlmacData)getSingleObject(BUSINESSID_QUERY, belAlmacQuery, 
			belAlmacQuery.clone(), "belAlmac");
		...
		preservaHiddensI18n(new Integer(1), "BEL_ALMAC", "belAlmacFrm", "Descripcion", true);
		...
		BelAlmacData belAlmac = datosResult;
		asignar("TEXT", "codAlma", FormatUtils.formatObject(belAlmac.getCodAlma(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "Descripcion", FormatUtils.formatObject(belAlmac.getDescripcion(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignarAtributo("CHECKBOX", "indInfoSap" , "check", FormatUtils.formatObject(
			belAlmac.getIndInfoSap(), 
		...
		loadLocalizationVars(belAlmac);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "codAlma", "disabled", "S");
		asignarAtributo("TEXT", "Descripcion", "disabled", "S");
		
					asignarAtributo("CHECKBOX", "indInfoSap", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "BEL_ALMAC", "belAlmacFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "codAlma", "req", "S");
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('belAlmacFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "belAlmacFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		BelAlmacData belAlmacQuery= new BelAlmacData();
		belAlmacQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(belAlmac.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"belAlmacFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"belAlmacFrm\",1, false)");
					asignarAtributo("COMBO","paisOidPais", "ontab", "ejecutarAccionFocoModificacion(\"belAlmacFrm\",2, true)");
					asignarAtributo("COMBO","paisOidPais", "onshtab", "ejecutarAccionFocoModificacion(\"belAlmacFrm\",2, false)");
				asignarAtributo("AREATEXTO", "codAlma", "ontab","ejecutarAccionFocoModificacion(\"belAlmacFrm\",3, true)");
				asignarAtributo("AREATEXTO", "codAlma", "onshtab","ejecutarAccionFocoModificacion(\"belAlmacFrm\",3, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"belAlmacFrm\",4, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"belAlmacFrm\",4, false)");
				asignarAtributo("TEXT", "indInfoSap", "ontab","ejecutarAccionFocoModificacion(\"belAlmacFrm\",5, true)");
				asignarAtributo("TEXT", "indInfoSap", "onshtab","ejecutarAccionFocoModificacion(\"belAlmacFrm\",5, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","belAlmacTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","belAlmacTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codAlma...");		
				...
				traza("MMG: el atributo es indInfoSap...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","belAlmacFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","belAlmacListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","belAlmacListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(BelAlmacData belAlmac) throws Exception{
		...
		if(belAlmac != null && belAlmac.getPaisOidPais() != null){
				checkCombo("paisOidPais" , belAlmac.getPaisOidPais().getId().toString());
			}
	...
	* @param belAlmac La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(BelAlmacData belAlmac) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		BelAlmacData belAlmac = 
			(BelAlmacData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(belAlmac.getPaisOidPais() != null){
			belAlmac.setPaisOidPais((es.indra.belcorp.mso.SegPaisViewData)
			getSingleObject(BUSINESSID_PAISOIDPAIS_QUERY, 
			belAlmac.getPaisOidPais(),
			belAlmac.getPaisOidPais().clone(),
			"segPaisView"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(belAlmac);
		loadLeafDependenceCombos(belAlmac);
	}
	...
	*/
	...
	protected void loadLocalizationVars(BelAlmacData belAlmac) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("BEL_ALMAC");
		mmgLocalizationQuery.setEntiPk(belAlmac.getId());
