...
public class INCConsultorasRecomiendan extends LPSICCBase {           

  public INCConsultorasRecomiendan() {	 
    super();
  }
  ...
  public void ejecucion() throws Exception {
    ...
    try {
      ...
      if (accion.equals("generar")){
        ...
        cargarPagina();
        getConfiguracionMenu("INCConsultorasRecomiendan");
      }
  ...
  private void cargarPagina() throws Exception{
    ...
    pagina("contenido_informe_consultoras_detalle_generar");   
  ...
  private void generarReporte() throws Exception{
    ...
    datos.put(ConstantesREP.TITULO, "Consultoras que Recomiendan detalle");
    ...
    if(region.equals("")){
       reporte = "RD_REP-061_02";    
    }else{
       if(zona.equals("")){
          reporte = "RD_REP-061_01";
       }else{
          reporte = "RD_REP-061";
       }
    }   
  ...
  private void crearListaLP(Vector nomColumns, int cantColumns,
    ...
    String nomCapa, String nomLista, String XCapa, String YCapa) throws Exception {
