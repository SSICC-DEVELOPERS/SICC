...
public class contenido_errores_digitar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_errores_digitar" );
      ...
      v.add(doc.createTextNode("\r     \r      \r	function onLoadPag()   \r	{\r	    DrdEnsanchaConMargenDcho('listado1',12);\r	    document.all[\"Cplistado1\"].style.visibility='';\r	    document.all[\"CpLin1listado1\"].style.visibility='';\r	    document.all[\"CpLin2listado1\"].style.visibility='';\r	    document.all[\"CpLin3listado1\"].style.visibility='';\r	    document.all[\"CpLin4listado1\"].style.visibility='';\r\r	    document.all[\"primera1Div\"].style.visibility='hidden';\r	    document.all[\"ret1Div\"].style.visibility='hidden';\r	    document.all[\"ava1Div\"].style.visibility='hidden';\r	    document.all[\"separaDiv\"].style.visibility='hidden';\r\r	    eval (ON_RSZ);  \r	}\r    \r    function accionConsolidar(){\r        var posicionesConsolidar = '';\r        var numPosiciones = 0;\r        for (var i=0; i< listado1.datos.length; i++){\r            if (document.getElementById(\"chb1_\"+i).checked == true)  {\r                posicionesConsolidar = posicionesConsolidar + listado1.datos[i][0] + '|';\r                posicionesConsolidar = posicionesConsolidar + listado1.datos[i][4] + '|';\r                posicionesConsolidar = posicionesConsolidar + listado1.datos[i][5] + '#';\r                numPosiciones++;\r            }\r        }\r        posicionesConsolidar = posicionesConsolidar.substring(0,posicionesConsolidar.length-1);\r        \r        set('frmContenido.accion','Consolidar_posiciones');\r        set('frmContenido.hPosicionesConsolidar',posicionesConsolidar);\r        set('frmContenido.hNumPosiciones',numPosiciones);\r        eval('frmContenido').oculto = 'S';\r        enviaSICC('frmContenido');                \r    }\r    \r    function onclick_check(fila){\r        if (listado1.datos[fila][1] == 'Correcto'){\r            document.getElementById(\"chb1_\"+fila).checked = false;\r            listado1.actualizaDat();\r            listado1.repinta();                        \r        }\r        \r    }\r  \r  "));
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(14)).setAttribute("nombre","hPosicionesDigitacion" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(15)).setAttribute("nombre","hPosicionesConsolidar" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(16)).setAttribute("nombre","hNumPosiciones" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(17)).setAttribute("nombre","hOidCabeceraSolicitud" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(18)).setAttribute("nombre","hOidTipoSolicitud" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(20)).setAttribute("nombre","hOidCliente" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(25)).setAttribute("width","674" );
      ...
      ((Element)v.get(26)).setAttribute("ancho","650" );
      ((Element)v.get(26)).setAttribute("alto","337" );
      ...
      ((Element)v.get(34)).setAttribute("cod","00640" );
      ...
      ((Element)v.get(37)).setAttribute("ancho","50" );
   ...
   private void getXML180(Document doc) {
      ((Element)v.get(39)).setAttribute("ancho","130" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(40)).setAttribute("ancho","80" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(41)).setAttribute("ancho","130" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(42)).setAttribute("ancho","110" );
      ...
      ((Element)v.get(43)).setAttribute("alto","40" );
      ...
      ((Element)v.get(44)).setAttribute("cod","1043" );
      ...
      ((Element)v.get(45)).setAttribute("cod","2777" );
      ...
      ((Element)v.get(46)).setAttribute("cod","336" );
      ...
      ((Element)v.get(47)).setAttribute("cod","1395" );
      ...
      ((Element)v.get(48)).setAttribute("cod","2778" );
      ...
      ((Element)v.get(50)).setAttribute("cod","1395" );
      ...
      ((Element)v.get(51)).setAttribute("cod","2779" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(58)).setAttribute("tipo","checkbox" );
      ((Element)v.get(58)).setAttribute("nombre","chb1" );
      ((Element)v.get(58)).setAttribute("ID","EstDat2" );
      ((Element)v.get(58)).setAttribute("onchange","onclick_check(FILAEVENTO);" );
      ...
      ((Element)v.get(60)).setAttribute("nombre","mipgndo" );
      ((Element)v.get(60)).setAttribute("ancho","612" );
      ((Element)v.get(60)).setAttribute("sep","$" );
      ((Element)v.get(60)).setAttribute("x","12" );
      ((Element)v.get(60)).setAttribute("class","botonera" );
      ((Element)v.get(60)).setAttribute("y","326" );
      ((Element)v.get(60)).setAttribute("control","|" );
      ((Element)v.get(60)).setAttribute("conector","conector_prototipo_2" );
      ((Element)v.get(60)).setAttribute("rowset","" );
      ((Element)v.get(60)).setAttribute("cargainicial","N" );
      ((Element)v.get(26)).appendChild((Element)v.get(60));

      /* Empieza nodo:61 / Elemento padre: 60   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(61)).setAttribute("nombre","ret1" );
      ((Element)v.get(61)).setAttribute("x","37" );
      ((Element)v.get(61)).setAttribute("y","330" );
      ((Element)v.get(61)).setAttribute("ID","botonContenido" );
      ((Element)v.get(61)).setAttribute("img","retroceder_on" );
      ...
      ((Element)v.get(61)).setAttribute("accion","mipgndo.retroceder();" );
      ((Element)v.get(60)).appendChild((Element)v.get(61));
      /* Termina nodo:61   */

      /* Empieza nodo:62 / Elemento padre: 60   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(62)).setAttribute("nombre","ava1" );
      ((Element)v.get(62)).setAttribute("x","52" );
      ((Element)v.get(62)).setAttribute("y","310" );
      ((Element)v.get(62)).setAttribute("ID","botonContenido" );
      ((Element)v.get(62)).setAttribute("img","avanzar_on" );
      ...
      ((Element)v.get(62)).setAttribute("accion","mipgndo.avanzar();" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(63)).setAttribute("nombre","primera1" );
      ((Element)v.get(63)).setAttribute("x","20" );
      ((Element)v.get(63)).setAttribute("y","330" );
      ((Element)v.get(63)).setAttribute("ID","botonContenido" );
      ((Element)v.get(63)).setAttribute("img","primera_on" );
      ((Element)v.get(63)).setAttribute("tipo","-2" );
      ((Element)v.get(63)).setAttribute("estado","false" );
      ((Element)v.get(63)).setAttribute("alt","" );
      ((Element)v.get(63)).setAttribute("codigo","" );
      ((Element)v.get(63)).setAttribute("accion","mipgndo.retrocederPrimeraPagina();" );
      ((Element)v.get(6)).appendChild((Element)v.get(63));
      /* Termina nodo:63   */

      /* Empieza nodo:64 / Elemento padre: 6   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(64)).setAttribute("nombre","separa" );
      ((Element)v.get(64)).setAttribute("x","59" );
      ((Element)v.get(64)).setAttribute("y","326" );
      ((Element)v.get(64)).setAttribute("ID","botonContenido" );
      ((Element)v.get(64)).setAttribute("img","separa_base" );
      ((Element)v.get(64)).setAttribute("tipo","0" );
      ((Element)v.get(64)).setAttribute("estado","false" );
      ((Element)v.get(64)).setAttribute("alt","" );
      ((Element)v.get(64)).setAttribute("codigo","" );
      ((Element)v.get(64)).setAttribute("accion","" );
      ((Element)v.get(6)).appendChild((Element)v.get(64));
      /* Termina nodo:64   */

      /* Empieza nodo:65 / Elemento padre: 6   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(65)).setAttribute("nombre","Consolidar" );
      ((Element)v.get(65)).setAttribute("x","13" );
      ((Element)v.get(65)).setAttribute("y","327" );
      ...
      ((Element)v.get(65)).setAttribute("cod","2780" );
      ((Element)v.get(65)).setAttribute("accion","accionConsolidar();" );
      ...
      ((Element)v.get(66)).setAttribute("ancho","50" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(66)).setAttribute("y","349" );
