/*
    INDRA/CAR/mmg
    $Id: SegMonedLPStartUp.java,v 1.1 2009/12/03 18:40:46 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class SegMonedLPStartUp extends MMGDruidaBase{
	...
	public static final String BUSINESSID_QUERY = "MMGSegMonedQueryFromToUserPage";
	
	
		
	//Hashtables con los valores estáticos de radiobuttons y combos
	protected static Hashtable numDeciValues = new Hashtable();
	static{
		numDeciValues.put(new java.lang.Long(0), "0");
		numDeciValues.put(new java.lang.Long(1), "1");
		numDeciValues.put(new java.lang.Long(2), "2");
	}
	
	
	// Definicion del constructor
	public SegMonedLPStartUp(){
		super();
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "SegMonedPage", "cod", "SegMoned." + accion + ".label");
			...
			limpiarBotoneraLista("segMoned", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codMone", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 3);");
		...
		//asignarAtributo("CAPA", "segMonedLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "SegMonedPage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("SegMonedLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		SegMonedData segMonedQuery= new SegMonedData();
		segMonedQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		SegMonedData datosResult = (SegMonedData)getSingleObject(BUSINESSID_QUERY, segMonedQuery, 
			segMonedQuery.clone(), "segMoned");
		...
		preservaHiddensI18n(new Integer(1), "SEG_MONED", "segMonedFrm", "Descripcion", true);
		...
		SegMonedData segMoned = datosResult;
		asignar("TEXT", "codMone", FormatUtils.formatObject(segMoned.getCodMone(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "Descripcion", FormatUtils.formatObject(segMoned.getDescripcion(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "valNombCortMone", FormatUtils.formatObject(segMoned.getValNombCortMone(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "valSimbMone", FormatUtils.formatObject(segMoned.getValSimbMone(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		loadLocalizationVars(segMoned);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "codMone", "disabled", "S");
		asignarAtributo("TEXT", "Descripcion", "disabled", "S");
		asignarAtributo("TEXT", "valNombCortMone", "disabled", "S");
		asignarAtributo("TEXT", "valSimbMone", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "SEG_MONED", "segMonedFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "codMone", "req", "S");
		asignarAtributo("TEXT", "Descripcion", "req", "S");
		asignarAtributo("COMBO", "numDeci", "req", "S");
		
		
		//Asiganamos a los campos internacionalizables la función de onblur para actualizar el 
		//valor del idioma por defecto
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('segMonedFrm.Descripcion'))");
		...
		asignarAtributo("TEXT", "codMone", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 3);");
		asignarAtributo("TEXT", "Descripcion", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 30);");
		asignarAtributo("TEXT", "valNombCortMone", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 0, 3);");
		asignarAtributo("TEXT", "valSimbMone", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 0, 1);");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "segMonedFrm", "oculto", "N");
		...
		traza("MMG::Creando SegMoned");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		SegMonedData segMonedQuery= new SegMonedData();
		segMonedQuery.setId(new Long(id));
		...
		asignar("TEXT", "valSimbMone", FormatUtils.formatObject(segMoned.getValSimbMone(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		if(segMoned.getNumDeci() != null){	
			checkCombo("numDeci", FormatUtils.formatObject(segMoned.getNumDeci(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		}
		...
		//asignar("VAR","timestamp",Long.toString(segMoned.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"segMonedFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"segMonedFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codMone", "ontab","ejecutarAccionFocoModificacion(\"segMonedFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codMone", "onshtab","ejecutarAccionFocoModificacion(\"segMonedFrm\",2, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"segMonedFrm\",3, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"segMonedFrm\",3, false)");
				asignarAtributo("AREATEXTO", "valNombCortMone", "ontab","ejecutarAccionFocoModificacion(\"segMonedFrm\",4, true)");
				asignarAtributo("AREATEXTO", "valNombCortMone", "onshtab","ejecutarAccionFocoModificacion(\"segMonedFrm\",4, false)");
				asignarAtributo("AREATEXTO", "valSimbMone", "ontab","ejecutarAccionFocoModificacion(\"segMonedFrm\",5, true)");
				asignarAtributo("AREATEXTO", "valSimbMone", "onshtab","ejecutarAccionFocoModificacion(\"segMonedFrm\",5, false)");
				asignarAtributo("TEXT", "numDeci", "ontab","ejecutarAccionFocoModificacion(\"segMonedFrm\",6, true)");
				asignarAtributo("TEXT", "numDeci", "onshtab","ejecutarAccionFocoModificacion(\"segMonedFrm\",6, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","segMonedTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","segMonedTrButtons");
	...
	*/
	protected void removeNonSearchElements() throws Exception{
		borrarCampo("id");
		borrarCampo("valNombCortMone");
		borrarCampo("valSimbMone");
		borrarCampo("numDeci");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codMone...");		
				...
				traza("MMG: el atributo es valNombCortMone...");		
				
				traza("MMG: el atributo es valSimbMone...");		
				
				traza("MMG: el atributo es numDeci...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","segMonedFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","segMonedListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","segMonedListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(SegMonedData segMoned) throws Exception{
	...
	* @param segMoned La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(SegMonedData segMoned) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		SegMonedData segMoned = 
			(SegMonedData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(segMoned);
		loadLeafDependenceCombos(segMoned);
	}
	...
	*/
	...
	protected void loadLocalizationVars(SegMonedData segMoned) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("SEG_MONED");
		mmgLocalizationQuery.setEntiPk(segMoned.getId());
