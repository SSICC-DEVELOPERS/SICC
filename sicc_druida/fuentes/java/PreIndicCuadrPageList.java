...
public class PreIndicCuadrPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","preIndicCuadrList" );
      ...
      ((Element)v.get(14)).setAttribute("cod","PreIndicCuadr.codIndiCuad.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","PreIndicCuadr.Descripcion.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","PreIndicCuadr.valFactCuad.label" );
