...
public class SegSocieViewPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","segSocieViewList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","SegSocieView.codSoci.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","SegSocieView.valDeno.label" );
