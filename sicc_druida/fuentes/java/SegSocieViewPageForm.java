...
public class SegSocieViewPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","SegSocieView.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","SegSocieView.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('segSocieViewFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('segSocieViewFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(54)).setAttribute("cod","SegSocieView.paisOidPais.label" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('segSocieViewFrm',2, true);" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('segSocieViewFrm',2, false);" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(61)).setAttribute("nombre","codSociTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(66)).setAttribute("nombre","codSociWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(68)).setAttribute("nombre","codSoci" );
      ...
      ((Element)v.get(68)).setAttribute("ontab","ejecutarAccionFoco('segSocieViewFrm',3, true)" );
      ((Element)v.get(68)).setAttribute("onshtab","ejecutarAccionFoco('segSocieViewFrm', 3, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(69)).setAttribute("nombre","codSociGapTdId" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(71)).setAttribute("nombre","valDenoTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(76)).setAttribute("nombre","valDenoWidgetTrId" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(78)).setAttribute("nombre","valDeno" );
      ...
      ((Element)v.get(78)).setAttribute("ontab","ejecutarAccionFoco('segSocieViewFrm',4, true)" );
      ((Element)v.get(78)).setAttribute("onshtab","ejecutarAccionFoco('segSocieViewFrm', 4, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(79)).setAttribute("nombre","valDenoGapTdId" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(96)).setAttribute("nombre","valDireTdId" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(101)).setAttribute("nombre","valDireWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(103)).setAttribute("nombre","valDire" );
      ...
      ((Element)v.get(103)).setAttribute("ontab","ejecutarAccionFoco('segSocieViewFrm',5, true)" );
      ((Element)v.get(103)).setAttribute("onshtab","ejecutarAccionFoco('segSocieViewFrm', 5, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(104)).setAttribute("nombre","valDireGapTdId" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(106)).setAttribute("nombre","valTlfnTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(111)).setAttribute("nombre","valTlfnWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(113)).setAttribute("nombre","valTlfn" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(113)).setAttribute("ontab","ejecutarAccionFoco('segSocieViewFrm',6, true)" );
      ((Element)v.get(113)).setAttribute("onshtab","ejecutarAccionFoco('segSocieViewFrm', 6, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(114)).setAttribute("nombre","valTlfnGapTdId" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(116)).setAttribute("nombre","valFaxTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(121)).setAttribute("nombre","valFaxWidgetTrId" );
      ...
      ((Element)v.get(123)).setAttribute("ontab","ejecutarAccionFoco('segSocieViewFrm',7, true)" );
      ((Element)v.get(123)).setAttribute("onshtab","ejecutarAccionFoco('segSocieViewFrm', 7, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(124)).setAttribute("nombre","valFaxGapTdId" );
   ...
   private void getXML630(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(141)).setAttribute("nombre","valIdenFiscTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(146)).setAttribute("nombre","valIdenFiscWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(148)).setAttribute("nombre","valIdenFisc" );
      ...
      ((Element)v.get(148)).setAttribute("size","15" );
      ...
      ((Element)v.get(148)).setAttribute("ontab","ejecutarAccionFoco('segSocieViewFrm',8, true)" );
      ((Element)v.get(148)).setAttribute("onshtab","ejecutarAccionFoco('segSocieViewFrm', 8, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(149)).setAttribute("nombre","valIdenFiscGapTdId" );
   ...
   private void getXML720(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(163)).setAttribute("nombre","segSocieViewTrButtons" );
      ...
      ((Element)v.get(170)).setAttribute("nombre","segSocieViewTdQueryButton" );
      ((Element)v.get(169)).appendChild((Element)v.get(170));

      /* Empieza nodo:171 / Elemento padre: 170   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(171)).setAttribute("nombre","segSocieViewQueryButton" );
      ((Element)v.get(171)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(171)).setAttribute("estado","false" );
      ((Element)v.get(171)).setAttribute("accion","segSocieViewFirstPage();" );
   ...
   private void getXML810(Document doc) {
      ((Element)v.get(172)).setAttribute("nombre","segSocieViewTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(174)).setAttribute("nombre","segSocieViewLovNullButton" );
      ((Element)v.get(174)).setAttribute("ID","botonContenido" );
      ((Element)v.get(174)).setAttribute("tipo","html" );
      ((Element)v.get(174)).setAttribute("accion","segSocieViewLovNullSelectionAction();" );
