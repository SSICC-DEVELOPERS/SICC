/*
    INDRA/CAR/mmg
    $Id: EduPlantCursoCabecLPStartUp.java,v 1.1 2009/12/03 18:41:56 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class EduPlantCursoCabecLPStartUp extends MMGDruidaBase{
	//Constantes que definen la altura de los formularios según el modo
	public static final short QUERYFORM_SIZE = 83;
	...
	public EduPlantCursoCabecLPStartUp(){
		super();
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			buildJsPageSize("EduPlantCursoCabec");
			...
			asignarAtributo("PAGINA", "EduPlantCursoCabecPage", "cod", "EduPlantCursoCabec." + accion + ".label");
			...
			limpiarBotoneraLista("eduPlantCursoCabec", accion);
	...
	protected void cmdLov() throws Exception{
		...
		//asignarAtributo("CAPA", "eduPlantCursoCabecLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "EduPlantCursoCabecPage", "onblur", "window.focus();");
	...
	protected void cmdView() throws Exception{
		...
		EduPlantCursoCabecData eduPlantCursoCabecQuery= new EduPlantCursoCabecData();
		eduPlantCursoCabecQuery.setId(new Integer(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		EduPlantCursoCabecData datosResult = (EduPlantCursoCabecData)getSingleObject(BUSINESSID_QUERY, eduPlantCursoCabecQuery, 
			eduPlantCursoCabecQuery.clone(), "eduPlantCursoCabec");
		...
		EduPlantCursoCabecData eduPlantCursoCabec = datosResult;
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "eduPlantCursoCabecFrm", "oculto", "N");
		...
		EduPlantCursoCabecData eduPlantCursoCabecQuery= new EduPlantCursoCabecData();
		eduPlantCursoCabecQuery.setId(new Integer(id));
		...
		//asignar("VAR","timestamp",Long.toString(eduPlantCursoCabec.jdoGetTimeStamp()));
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","eduPlantCursoCabecTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","eduPlantCursoCabecTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","eduPlantCursoCabecFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","eduPlantCursoCabecPreListLayer", "y", String.valueOf(sizeForm + 24));
		asignarAtributo("CAPA","eduPlantCursoCabecListLayer", "y", String.valueOf(sizeForm + 46));		
		asignarAtributo("CAPA","eduPlantCursoCabecListButtonsLayer", "y", String.valueOf(sizeForm + 299));		
	}
	...
	* @param eduPlantCursoCabec La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(EduPlantCursoCabecData eduPlantCursoCabec) 
		throws Exception{
	...
	*/
	protected void setDependenceComboLabels(EduPlantCursoCabecData eduPlantCursoCabec) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		EduPlantCursoCabecData eduPlantCursoCabec = 
			(EduPlantCursoCabecData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(eduPlantCursoCabec);
	}
