...
public class CalTipoGestiClienPage  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","CalTipoGestiClienPage" );
      ((Element)v.get(0)).setAttribute("titulo","" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","" );
      ((Element)v.get(0)).setAttribute("onload","calTipoGestiClienInitComponents()" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","caltipogesticlien.js" );
      ((Element)v.get(0)).appendChild((Element)v.get(4));
      /* Termina nodo:4   */

      /* Empieza nodo:5 / Elemento padre: 0   */
      v.add(doc.createElement("FORMULARIO"));
      ((Element)v.get(5)).setAttribute("nombre","calTipoGestiClienFrm" );
      ...
      ((Element)v.get(6)).setAttribute("valor","CalTipoGestiClienLPExecution" );
      ...
      ((Element)v.get(7)).setAttribute("valor","CalTipoGestiClienLPExecution" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(37)).setAttribute("nombre","calTipoGestiClienFormLayer" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(52)).setAttribute("cod","CalTipoGestiClien.legend.label" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(67)).setAttribute("cod","CalTipoGestiClien.id.label" );
      ...
      ((Element)v.get(70)).setAttribute("ontab","ejecutarAccionFoco('calTipoGestiClienFrm',1, true)" );
      ((Element)v.get(70)).setAttribute("onshtab","ejecutarAccionFoco('calTipoGestiClienFrm', 1, false)" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(88)).setAttribute("nombre","codGestTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(93)).setAttribute("nombre","codGestWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(95)).setAttribute("nombre","codGest" );
      ...
      ((Element)v.get(95)).setAttribute("ontab","ejecutarAccionFoco('calTipoGestiClienFrm',2, true)" );
      ((Element)v.get(95)).setAttribute("onshtab","ejecutarAccionFoco('calTipoGestiClienFrm', 2, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(96)).setAttribute("nombre","codGestGapTdId" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(102)).setAttribute("cod","CalTipoGestiClien.Descripcion.label" );
      ...
      ((Element)v.get(106)).setAttribute("ontab","ejecutarAccionFoco('calTipoGestiClienFrm',3, true)" );
      ((Element)v.get(106)).setAttribute("onshtab","ejecutarAccionFoco('calTipoGestiClienFrm', 3, false)" );
      ...
      ((Element)v.get(110)).setAttribute("href","javascript:openLocalizationDialog('calTipoGestiClienFrm', 'Descripcion', 1);" );
      ((Element)v.get(110)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"calTipoGestiClienFrm\",3, true)', 'ejecutarAccionFoco(\"calTipoGestiClienFrm\",3, false)')" );
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(126)).setAttribute("nombre","calTipoGestiClienTrButtons" );
      ...
      ((Element)v.get(133)).setAttribute("nombre","calTipoGestiClienTdQueryButton" );
      ((Element)v.get(132)).appendChild((Element)v.get(133));

      /* Empieza nodo:134 / Elemento padre: 133   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(134)).setAttribute("nombre","calTipoGestiClienQueryButton" );
      ((Element)v.get(134)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(134)).setAttribute("estado","false" );
      ((Element)v.get(134)).setAttribute("accion","calTipoGestiClienFirstPage();" );
      ...
      ((Element)v.get(135)).setAttribute("nombre","calTipoGestiClienTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(137)).setAttribute("nombre","calTipoGestiClienLovNullButton" );
      ((Element)v.get(137)).setAttribute("ID","botonContenido" );
      ((Element)v.get(137)).setAttribute("tipo","html" );
      ((Element)v.get(137)).setAttribute("accion","calTipoGestiClienLovNullSelectionAction();" );
   ...
   private void getXML630(Document doc) {
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(140)).setAttribute("nombre","calTipoGestiClienListLayer" );
      ...
      ((Element)v.get(141)).setAttribute("nombre","calTipoGestiClienList" );
   ...
   private void getXML720(Document doc) {
      ...
      ((Element)v.get(154)).setAttribute("cod","CalTipoGestiClien.codGest.label" );
      ...
      ((Element)v.get(155)).setAttribute("cod","CalTipoGestiClien.Descripcion.label" );
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(160)).setAttribute("nombre","calTipoGestiClienListButtonsLayer" );
      ...
      ((Element)v.get(166)).setAttribute("nombre","calTipoGestiClienPaginationButtonBar" );
   }
   ...
   private void getXML810(Document doc) {
      ...
      ((Element)v.get(167)).setAttribute("nombre","calTipoGestiClienFirstPageButton" );
      ((Element)v.get(167)).setAttribute("funcion","calTipoGestiClienFirstPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(168)).setAttribute("nombre","calTipoGestiClienFirstPageButtonGapTd" );
      ...
      v.add(doc.createElement("BTN"));
      ((Element)v.get(170)).setAttribute("nombre","calTipoGestiClienPreviousPageButton" );
      ((Element)v.get(170)).setAttribute("funcion","calTipoGestiClienPreviousPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(171)).setAttribute("nombre","calTipoGestiClienPreviousPageButtonGapTd" );
      ...
      v.add(doc.createElement("BTN"));
      ((Element)v.get(173)).setAttribute("nombre","calTipoGestiClienNextPageButton" );
      ((Element)v.get(173)).setAttribute("funcion","calTipoGestiClienNextPage();" );
      ...
      ((Element)v.get(176)).setAttribute("nombre","calTipoGestiClienUpdateButtonTd" );
      ((Element)v.get(162)).appendChild((Element)v.get(176));

      /* Empieza nodo:177 / Elemento padre: 176   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(177)).setAttribute("nombre","calTipoGestiClienUpdateButton" );
      ((Element)v.get(177)).setAttribute("ID","botonContenido" );
      ((Element)v.get(177)).setAttribute("tipo","html" );
      ((Element)v.get(177)).setAttribute("accion","calTipoGestiClienUpdateSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(178)).setAttribute("nombre","calTipoGestiClienUpdateButtonGapTd" );
      ...
      ((Element)v.get(180)).setAttribute("nombre","calTipoGestiClienViewForRemoveButtonTd" );
      ((Element)v.get(162)).appendChild((Element)v.get(180));

      /* Empieza nodo:181 / Elemento padre: 180   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(181)).setAttribute("nombre","calTipoGestiClienViewForRemoveButton" );
      ((Element)v.get(181)).setAttribute("ID","botonContenido" );
      ((Element)v.get(181)).setAttribute("tipo","html" );
      ((Element)v.get(181)).setAttribute("accion","calTipoGestiClienViewSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(182)).setAttribute("nombre","calTipoGestiClienViewForRemoveButtonGapTd" );
   ...
   private void getXML900(Document doc) {
      ...
      ((Element)v.get(184)).setAttribute("nombre","calTipoGestiClienLovSelectButtonTd" );
      ((Element)v.get(162)).appendChild((Element)v.get(184));

      /* Empieza nodo:185 / Elemento padre: 184   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(185)).setAttribute("nombre","calTipoGestiClienLovSelectButton" );
      ((Element)v.get(185)).setAttribute("ID","botonContenido" );
      ((Element)v.get(185)).setAttribute("tipo","html" );
      ((Element)v.get(185)).setAttribute("accion","calTipoGestiClienLovSelectionAction();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(186)).setAttribute("nombre","calTipoGestiClienLovSelectButtonGapTd" );
      ...
      ((Element)v.get(188)).setAttribute("nombre","calTipoGestiClienViewButtonTd" );
      ((Element)v.get(162)).appendChild((Element)v.get(188));

      /* Empieza nodo:189 / Elemento padre: 188   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(189)).setAttribute("nombre","calTipoGestiClienViewButton" );
      ((Element)v.get(189)).setAttribute("ID","botonContenido" );
      ((Element)v.get(189)).setAttribute("tipo","html" );
      ((Element)v.get(189)).setAttribute("accion","calTipoGestiClienViewSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(190)).setAttribute("nombre","calTipoGestiClienViewButtonGapTd" );
