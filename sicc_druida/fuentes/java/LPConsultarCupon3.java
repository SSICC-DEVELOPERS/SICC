...
public class LPConsultarCupon3 extends LPSICCBase {
    ...
    public void ejecucion() throws Exception {
    	setTrazaFichero();
    	try  {         
			traza("*** LPConsultarCupon3: Entrada ***");
    		...
    		asignarAtributo("PAGINA","contenido_cupon3_consultar", "cod", "0341");
            asignarAtributo("PAGINA","contenido_cupon3_consultar", "msgle", "Consultar Cupón 3");
            getConfiguracionMenu("LPConsultarCupon3","");
    		
    		if(this.accion.equals("") ){
    			//Carga inicial de los combos:
				this.cargaInicial(this.idioma,this.pais);
			}
    
    		traza("*** LPConsultarCupon3: Salida ***");
