...
public class CarIndicValidPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","carIndicValidList" );
      ...
      ((Element)v.get(10)).setAttribute("height","20" );
      ((Element)v.get(10)).setAttribute("IDScroll","EstCab" );
      ((Element)v.get(10)).setAttribute("imgFondo","" );
      ((Element)v.get(10)).setAttribute("colFondo","#CCCCCC" );
      ((Element)v.get(0)).appendChild((Element)v.get(10));

      /* Empieza nodo:11 / Elemento padre: 10   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(11)).setAttribute("colFondo","" );
      ((Element)v.get(11)).setAttribute("ID","EstCab" );
      ((Element)v.get(11)).setAttribute("cod","CarIndicValid.codIndiVali.label" );
      ...
      ((Element)v.get(12)).setAttribute("alto","22" );
      ((Element)v.get(12)).setAttribute("accion","" );
      ((Element)v.get(12)).setAttribute("tipoEnvio","seleccion" );
      ((Element)v.get(12)).setAttribute("formaEnvio","xml" );
      ((Element)v.get(12)).setAttribute("maxSel","1" );
      ((Element)v.get(12)).setAttribute("msgErrMaxSel","" );
      ((Element)v.get(12)).setAttribute("coloresScrollNativo","#D4D0C8,black,white,#D4D0C8,#D4D0C8,#ECE9E4,black" );
      ((Element)v.get(12)).setAttribute("colorROver","#D0D9E8" );
      ((Element)v.get(12)).setAttribute("onLoad","" );
      ((Element)v.get(12)).setAttribute("colorSelecc","#D0D9E8" );
      ((Element)v.get(0)).appendChild((Element)v.get(12));

      /* Empieza nodo:13 / Elemento padre: 12   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(13)).setAttribute("tipo","texto" );
      ((Element)v.get(13)).setAttribute("ID","EstDat" );
