...
public class MaeNegocConectorQueryForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad MaeNegoc" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGMaeNegocQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGMaeNegocQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","MaeNegocFormFormatter" );
