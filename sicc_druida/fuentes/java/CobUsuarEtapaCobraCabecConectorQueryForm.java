...
public class CobUsuarEtapaCobraCabecConectorQueryForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad CobUsuarEtapaCobraCabec" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGCobUsuarEtapaCobraCabecQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGCobUsuarEtapaCobraCabecQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","CobUsuarEtapaCobraCabecFormFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","uscoOidUsuaCobr" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(8)).setAttribute("NOMBRE","etdeOidEtapDeud" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(9)).setAttribute("NOMBRE","valObse" );
