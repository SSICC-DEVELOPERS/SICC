/*
    INDRA/CAR/mmg
    $Id: SegCanalLPStartUp.java,v 1.1 2009/12/03 18:35:44 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class SegCanalLPStartUp extends MMGDruidaBase{
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "SegCanalPage", "cod", "SegCanal." + accion + ".label");
			...
			limpiarBotoneraLista("segCanal", accion);
	...
	protected void cmdLov() throws Exception{
		...
		//asignarAtributo("CAPA", "segCanalLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "SegCanalPage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("SegCanalLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		SegCanalData segCanalQuery= new SegCanalData();
		segCanalQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		SegCanalData datosResult = (SegCanalData)getSingleObject(BUSINESSID_QUERY, segCanalQuery, 
			segCanalQuery.clone(), "segCanal", false);
		...
		preservaHiddensI18n(new Integer(1), "SEG_CANAL", "segCanalFrm", "Descripcion", true);
		...
		SegCanalData segCanal = datosResult;
		asignar("TEXT", "codCana", FormatUtils.formatObject(segCanal.getCodCana(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "Descripcion", FormatUtils.formatObject(segCanal.getDescripcion(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		es.indra.belcorp.mso.SegTipoPerioData tipeOidTipoPeri = segCanal.getTipeOidTipoPeri();
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "SEG_CANAL", "segCanalFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('segCanalFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "segCanalFrm", "oculto", "N");
		...
		traza("MMG::Creando SegCanal");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		SegCanalData segCanalQuery= new SegCanalData();
		segCanalQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(segCanal.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"segCanalFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"segCanalFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codCana", "ontab","ejecutarAccionFocoModificacion(\"segCanalFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codCana", "onshtab","ejecutarAccionFocoModificacion(\"segCanalFrm\",2, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"segCanalFrm\",3, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"segCanalFrm\",3, false)");
					asignarAtributo("COMBO","tipeOidTipoPeri", "ontab", "ejecutarAccionFocoModificacion(\"segCanalFrm\",4, true)");
					asignarAtributo("COMBO","tipeOidTipoPeri", "onshtab", "ejecutarAccionFocoModificacion(\"segCanalFrm\",4, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","segCanalTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","segCanalTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","segCanalFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","segCanalListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","segCanalListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(SegCanalData segCanal) throws Exception{
		...
		if(segCanal != null && segCanal.getTipeOidTipoPeri() != null){
				checkCombo("tipeOidTipoPeri" , segCanal.getTipeOidTipoPeri().getId().toString());
			}
	...
	* @param segCanal La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(SegCanalData segCanal) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		SegCanalData segCanal = 
			(SegCanalData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(segCanal.getTipeOidTipoPeri() != null){
			segCanal.setTipeOidTipoPeri((es.indra.belcorp.mso.SegTipoPerioData)
			getSingleObject(BUSINESSID_TIPEOIDTIPOPERI_QUERY, 
			segCanal.getTipeOidTipoPeri(),
			segCanal.getTipeOidTipoPeri().clone(),
			"segTipoPerio"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(segCanal);
		loadLeafDependenceCombos(segCanal);
	}
	...
	*/
	...
	protected void loadLocalizationVars(SegCanalData segCanal) throws Exception{
		...
		mmgLocalizationQuery.setEntiPk(segCanal.getId());
