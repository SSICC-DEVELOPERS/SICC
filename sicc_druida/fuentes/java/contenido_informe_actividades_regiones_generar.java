...
public class contenido_informe_actividades_regiones_generar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("cod","0771" );
      ...
      v.add(doc.createTextNode("\r   \r   \r   function onLoad(){\r      configurarMenuSecundario('Formulario');\r      fMostrarMensajeError();\r      focaliza('Formulario.cbCanal');\r   }\r   function generar(formato){\r      \r      if(sicc_validaciones_generales()){\r        \r        \r            /*recolectarParametros();\r      \r            set('Formulario.conectorAction', 'CRAActividadesTotalesRegiones');           \r            set('Formulario.accion', 'generar');*/\r            var a = new Object();\r            a.accion = 'generar';\r            a.marca = get('Formulario.cbMarca');  \r            a.canal = get('Formulario.cbCanal');\r            a.periodo = get('Formulario.cbPeriodo');\r            a.modelo = get('Formulario.cbModelo');          \r                        \r            if(formato == 'EXCEL'){\r               a.formatoSalida = formato;\r            }\r                        mostrarModalSICC('CRAActividadesTotalesRegiones','generar', a);  \r        \r        \r      }\r\r   }\r\r   function recolectarParametros(){\r                \r      set('Formulario.marca', get('Formulario.cbMarca') );  \r      set('Formulario.canal', get('Formulario.cbCanal'));\r      set('Formulario.periodo', get('Formulario.cbPeriodo') );\r      set('Formulario.modelo', get('Formulario.cbModelo'));            \r  \r   }\r \r   \r\r   function fLimpiar(){\r      var aCombo = new Array(new Array(\"\",\"\"));\r      set_combo('Formulario.cbPeriodo', aCombo, []);\r      \r      focaliza('Formulario.cbCanal');\r \r   }\r   \r    function onchangeMarcaCanal(){\r        \r       marca  = get('Formulario.cbMarca');\r       canal  = get('Formulario.cbCanal');\r       pais   = get('Formulario.pais');\r       idioma = get('Formulario.idioma');\r       \r       \r       if(marca != '' && canal != ''){\r       \r          var arr = new Array();\r          \r              \r          arr[arr.length] = [\"oidIdioma\", idioma]; \r          arr[arr.length] = [\"oidPais\", pais]; \r          arr[arr.length] = [\"marca\", marca];\r          arr[arr.length] = [\"canal\", canal];\r            \r           \r          /*recargaCombo(\"Formulario.cbPeriodo\",\"PRECargarPeriodos\",\"es.indra.sicc.dtos.cra.DTOPeriodo\",arr);*/\r		  recargaCombo(\"Formulario.cbPeriodo\",\"REPPeriodosCronogramaTotalGrupo\",\"es.indra.sicc.dtos.cra.DTOPeriodo\",arr);\r\r           \r       }else{\r           var aCombo = new Array(new Array(\"\",\"\"));\r           set_combo('Formulario.cbPeriodo', aCombo, []);\r       }\r   \r    } \r    \r\r\r\r   \r"));
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(10)).setAttribute("name","cbModelo" );
      ((Element)v.get(10)).setAttribute("required","true" );
      ((Element)v.get(10)).setAttribute("cod","2569" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(22)).setAttribute("nombre","modelo" );
   }
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(97)).setAttribute("nombre","cbModelo" );
      ((Element)v.get(97)).setAttribute("size","1" );
      ((Element)v.get(97)).setAttribute("multiple","N" );
      ((Element)v.get(97)).setAttribute("valorinicial","1" );
      ((Element)v.get(97)).setAttribute("textoinicial","Modelo 1" );
      ...
      ((Element)v.get(99)).setAttribute("ID","1" );
      ((Element)v.get(98)).appendChild((Element)v.get(99));

      /* Empieza nodo:100 / Elemento padre: 99   */
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(100)).setAttribute("NOMBRE","CODIGO" );
      ((Element)v.get(100)).setAttribute("TIPO","STRING" );
      ((Element)v.get(100)).setAttribute("VALOR","2" );
      ((Element)v.get(99)).appendChild((Element)v.get(100));
      /* Termina nodo:100   */

      /* Empieza nodo:101 / Elemento padre: 99   */
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(101)).setAttribute("NOMBRE","DESCRIPCION" );
      ((Element)v.get(101)).setAttribute("TIPO","STRING" );
      ((Element)v.get(101)).setAttribute("VALOR","Modelo 2" );
      ...
      ((Element)v.get(117)).setAttribute("nombre","btnGenerarInforme" );
      ((Element)v.get(117)).setAttribute("ID","botonContenido" );
      ((Element)v.get(117)).setAttribute("tipo","html" );
      ((Element)v.get(117)).setAttribute("accion","generar();" );
      ((Element)v.get(117)).setAttribute("estado","false" );
      ((Element)v.get(117)).setAttribute("cod","2495" );
   }
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(118)).setAttribute("nombre","btnGenerarExcel" );
      ((Element)v.get(118)).setAttribute("ID","botonContenido" );
      ((Element)v.get(118)).setAttribute("tipo","html" );
      ((Element)v.get(118)).setAttribute("accion","generar('EXCEL')" );
      ((Element)v.get(118)).setAttribute("estado","false" );
      ((Element)v.get(118)).setAttribute("cod","2526" );
      ((Element)v.get(118)).setAttribute("ontab","focaliza('Formulario.cbCanal')" );
      ...
      /* Empieza nodo:121 / Elemento padre: 25   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(25)).appendChild((Element)v.get(121));
