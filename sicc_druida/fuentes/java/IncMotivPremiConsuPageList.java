...
public class IncMotivPremiConsuPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","incMotivPremiConsuList" );
      ...
      ((Element)v.get(12)).setAttribute("cod","IncMotivPremiConsu.Descripcion.label" );
