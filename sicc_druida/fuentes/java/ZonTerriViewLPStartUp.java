/*
    INDRA/CAR/mmg
    $Id: ZonTerriViewLPStartUp.java,v 1.1 2009/12/03 18:38:29 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class ZonTerriViewLPStartUp extends MMGDruidaBase{
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "ZonTerriViewPage", "cod", "ZonTerriView." + accion + ".label");
			...
			limpiarBotoneraLista("zonTerriView", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codTerr", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 6);");
		...
		asignarAtributo("TEXT", "fecRtz", "validacion", "mensaje = ValidaFechaMMG(cdos_trim(valor), '" + datePattern + "');");
		
		//Primero determianmos el nombre del campo en la entidad de oriegen donde se van a cargar los datos
		asignar("VAR", "idAttributeLovOpener", conectorParametro(PARAMETRO_LOV_ATTRIBUTO));
		asignar("VAR", "idEntityLovOpener", conectorParametro(PARAMETRO_LOV_ENTIDAD));
		//asignarAtributo("CAPA", "zonTerriViewLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "ZonTerriViewPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		ZonTerriViewData zonTerriViewQuery= new ZonTerriViewData();
		zonTerriViewQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		ZonTerriViewData datosResult = (ZonTerriViewData)getSingleObject(BUSINESSID_QUERY, zonTerriViewQuery, 
			zonTerriViewQuery.clone(), "zonTerriView");
		...
		ZonTerriViewData zonTerriView = datosResult;
		asignar("TEXT", "codTerr", FormatUtils.formatObject(zonTerriView.getCodTerr(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "codNse1", FormatUtils.formatObject(zonTerriView.getCodNse1(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "codNse2", FormatUtils.formatObject(zonTerriView.getCodNse2(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "codNse3", FormatUtils.formatObject(zonTerriView.getCodNse3(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "indBorr", FormatUtils.formatObject(zonTerriView.getIndBorr(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "fecRtz", FormatUtils.formatObject(zonTerriView.getFecRtz(), 
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "zonTerriViewFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		ZonTerriViewData zonTerriViewQuery= new ZonTerriViewData();
		zonTerriViewQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(zonTerriView.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"zonTerriViewFrm\",0, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"zonTerriViewFrm\",0, false)");
				asignarAtributo("AREATEXTO", "codTerr", "ontab","ejecutarAccionFocoModificacion(\"zonTerriViewFrm\",0, true)");
				asignarAtributo("AREATEXTO", "codTerr", "onshtab","ejecutarAccionFocoModificacion(\"zonTerriViewFrm\",0, false)");
				asignarAtributo("AREATEXTO", "codNse1", "ontab","ejecutarAccionFocoModificacion(\"zonTerriViewFrm\",0, true)");
				asignarAtributo("AREATEXTO", "codNse1", "onshtab","ejecutarAccionFocoModificacion(\"zonTerriViewFrm\",0, false)");
				asignarAtributo("AREATEXTO", "codNse2", "ontab","ejecutarAccionFocoModificacion(\"zonTerriViewFrm\",0, true)");
				asignarAtributo("AREATEXTO", "codNse2", "onshtab","ejecutarAccionFocoModificacion(\"zonTerriViewFrm\",0, false)");
				asignarAtributo("AREATEXTO", "codNse3", "ontab","ejecutarAccionFocoModificacion(\"zonTerriViewFrm\",0, true)");
				asignarAtributo("AREATEXTO", "codNse3", "onshtab","ejecutarAccionFocoModificacion(\"zonTerriViewFrm\",0, false)");
				asignarAtributo("AREATEXTO", "indBorr", "ontab","ejecutarAccionFocoModificacion(\"zonTerriViewFrm\",0, true)");
				asignarAtributo("AREATEXTO", "indBorr", "onshtab","ejecutarAccionFocoModificacion(\"zonTerriViewFrm\",0, false)");
				asignarAtributo("AREATEXTO", "fecRtz", "ontab","ejecutarAccionFocoModificacion(\"zonTerriViewFrm\",0, true)");
				asignarAtributo("AREATEXTO", "fecRtz", "onshtab","ejecutarAccionFocoModificacion(\"zonTerriViewFrm\",0, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","zonTerriViewTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","zonTerriViewTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codTerr...");		
				...
				traza("MMG: el atributo es fecRtz...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","zonTerriViewFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","zonTerriViewListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","zonTerriViewListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(ZonTerriViewData zonTerriView) throws Exception{
	...
	* @param zonTerriView La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(ZonTerriViewData zonTerriView) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		ZonTerriViewData zonTerriView = 
			(ZonTerriViewData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(zonTerriView);
		loadLeafDependenceCombos(zonTerriView);
	}
