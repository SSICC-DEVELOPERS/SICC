...
public class contenido_parametros_belcenter_detalle  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(18)).setAttribute("cod","BelParamBelce.valFactLoca.label" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(59)).setAttribute("y","24" );
