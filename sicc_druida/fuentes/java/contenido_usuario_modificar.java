...
public class contenido_usuario_modificar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_usuario_modificar" );
      ((Element)v.get(0)).setAttribute("titulo","" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","" );
      ((Element)v.get(0)).setAttribute("onload","inicializar(false);" );
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(6)).setAttribute("name","cbPerfil" );
      ((Element)v.get(6)).setAttribute("required","true" );
      ((Element)v.get(6)).setAttribute("cod","104" );
      ((Element)v.get(4)).appendChild((Element)v.get(6));
      /* Termina nodo:6   */

      /* Empieza nodo:7 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(7)).setAttribute("name","rbClaveInicial" );
      ((Element)v.get(7)).setAttribute("required","true" );
      ((Element)v.get(7)).setAttribute("cod","22" );
      ((Element)v.get(4)).appendChild((Element)v.get(7));
      /* Termina nodo:7   */

      /* Empieza nodo:8 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(8)).setAttribute("name","txtPrimerApellido" );
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(9)).setAttribute("name","txtSegundoApellido" );
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(10)).setAttribute("name","txtPrimerNombre" );
      ((Element)v.get(10)).setAttribute("required","true" );
      ((Element)v.get(10)).setAttribute("cod","93" );
      ((Element)v.get(4)).appendChild((Element)v.get(10));
      /* Termina nodo:10   */

      /* Empieza nodo:11 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(11)).setAttribute("name","txtSegundoNombre" );
      ((Element)v.get(11)).setAttribute("required","true" );
      ((Element)v.get(11)).setAttribute("cod","94" );
      ((Element)v.get(4)).appendChild((Element)v.get(11));
      /* Termina nodo:11   */

      /* Empieza nodo:12 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(12)).setAttribute("name","txtValidezDesde" );
      ((Element)v.get(12)).setAttribute("required","true" );
      ((Element)v.get(12)).setAttribute("cod","141" );
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(13)).setAttribute("name","txtValidezHasta" );
      ((Element)v.get(13)).setAttribute("required","true" );
      ((Element)v.get(13)).setAttribute("cod","142" );
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(14)).setAttribute("name","cbSociedad" );
      ((Element)v.get(14)).setAttribute("required","true" );
      ((Element)v.get(14)).setAttribute("cod","120" );
      ((Element)v.get(4)).appendChild((Element)v.get(14));
      /* Termina nodo:14   */

      /* Empieza nodo:15 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(15)).setAttribute("name","cbMarca" );
      ((Element)v.get(15)).setAttribute("required","true" );
      ((Element)v.get(15)).setAttribute("cod","6" );
      ((Element)v.get(4)).appendChild((Element)v.get(15));
      /* Termina nodo:15   */

      /* Empieza nodo:16 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(16)).setAttribute("name","cbCanal" );
      ((Element)v.get(16)).setAttribute("required","true" );
      ((Element)v.get(16)).setAttribute("cod","7" );
      ((Element)v.get(4)).appendChild((Element)v.get(16));
      /* Termina nodo:16   */

      /* Empieza nodo:17 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(17)).setAttribute("name","cbAcceso" );
      ((Element)v.get(17)).setAttribute("required","true" );
      ((Element)v.get(17)).setAttribute("cod","10" );
      ((Element)v.get(4)).appendChild((Element)v.get(17));
      /* Termina nodo:17   */

      /* Empieza nodo:18 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(18)).setAttribute("name","cbSubacceso" );
   }

   private void getXML90(Document doc) {
      ((Element)v.get(18)).setAttribute("required","true" );
      ((Element)v.get(18)).setAttribute("cod","122" );
      ((Element)v.get(4)).appendChild((Element)v.get(18));
      /* Termina nodo:18   */

      /* Empieza nodo:19 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(19)).setAttribute("name","cbPais" );
      ((Element)v.get(19)).setAttribute("required","true" );
      ((Element)v.get(19)).setAttribute("cod","5" );
      ((Element)v.get(4)).appendChild((Element)v.get(19));
      /* Termina nodo:19   */

      /* Empieza nodo:20 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(20)).setAttribute("name","cbSubgerenciaVentas" );
      ((Element)v.get(20)).setAttribute("required","true" );
      ((Element)v.get(20)).setAttribute("cod","124" );
      ((Element)v.get(4)).appendChild((Element)v.get(20));
      /* Termina nodo:20   */

      /* Empieza nodo:21 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(21)).setAttribute("name","cbRegion" );
      ((Element)v.get(21)).setAttribute("required","true" );
      ((Element)v.get(21)).setAttribute("cod","109" );
      ((Element)v.get(4)).appendChild((Element)v.get(21));
      /* Termina nodo:21   */

      /* Empieza nodo:22 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(22)).setAttribute("name","cbZona" );
      ((Element)v.get(22)).setAttribute("required","true" );
      ((Element)v.get(22)).setAttribute("cod","143" );
      ((Element)v.get(4)).appendChild((Element)v.get(22));
      /* Termina nodo:22   */

      /* Empieza nodo:23 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(23)).setAttribute("name","cbSeccion" );
      ((Element)v.get(23)).setAttribute("required","true" );
      ((Element)v.get(23)).setAttribute("cod","112" );
      ((Element)v.get(4)).appendChild((Element)v.get(23));
      /* Termina nodo:23   */

      /* Empieza nodo:24 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(24)).setAttribute("name","cbTerritorio" );
      ((Element)v.get(24)).setAttribute("required","true" );
      ((Element)v.get(24)).setAttribute("cod","126" );
      ((Element)v.get(4)).appendChild((Element)v.get(24));
      /* Termina nodo:24   */

      /* Empieza nodo:25 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(25)).setAttribute("name","cbPaisPorDefecto" );
      ((Element)v.get(25)).setAttribute("required","true" );
      ((Element)v.get(25)).setAttribute("cod","101" );
      ((Element)v.get(4)).appendChild((Element)v.get(25));
      /* Termina nodo:25   */

      /* Empieza nodo:26 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(26)).setAttribute("name","cbSGVPorDefecto" );
      ((Element)v.get(26)).setAttribute("required","true" );
      ((Element)v.get(26)).setAttribute("cod","166" );
      ((Element)v.get(4)).appendChild((Element)v.get(26));
      /* Termina nodo:26   */

      /* Empieza nodo:27 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(27)).setAttribute("name","cbRegionPorDefecto" );
      ((Element)v.get(27)).setAttribute("required","true" );
      ((Element)v.get(27)).setAttribute("cod","110" );
      ((Element)v.get(4)).appendChild((Element)v.get(27));
      /* Termina nodo:27   */

      /* Empieza nodo:28 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(28)).setAttribute("name","cbZonaPorDefecto" );
      ((Element)v.get(28)).setAttribute("required","true" );
      ((Element)v.get(28)).setAttribute("cod","140" );
      ((Element)v.get(4)).appendChild((Element)v.get(28));
      /* Termina nodo:28   */

      /* Empieza nodo:29 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(29)).setAttribute("name","cbSeccionPorDefecto" );
      ((Element)v.get(29)).setAttribute("required","true" );
      ((Element)v.get(29)).setAttribute("cod","113" );
      ((Element)v.get(4)).appendChild((Element)v.get(29));
      /* Termina nodo:29   */

      /* Empieza nodo:30 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(30)).setAttribute("name","cbTerritorioPorDefecto" );
      ((Element)v.get(30)).setAttribute("required","true" );
      ((Element)v.get(30)).setAttribute("cod","127" );
      ((Element)v.get(4)).appendChild((Element)v.get(30));
      /* Termina nodo:30   */

      /* Empieza nodo:31 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(31)).setAttribute("name","cbSociedadPorDefecto" );
      ((Element)v.get(31)).setAttribute("required","true" );
      ((Element)v.get(31)).setAttribute("cod","121" );
      ((Element)v.get(4)).appendChild((Element)v.get(31));
      /* Termina nodo:31   */

      /* Empieza nodo:32 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(32)).setAttribute("name","cbMarcaPorDefecto" );
      ((Element)v.get(32)).setAttribute("required","true" );
      ((Element)v.get(32)).setAttribute("cod","81" );
      ((Element)v.get(4)).appendChild((Element)v.get(32));
      /* Termina nodo:32   */

      /* Empieza nodo:33 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(33)).setAttribute("name","cbCanalPorDefecto" );
      ((Element)v.get(33)).setAttribute("required","true" );
      ((Element)v.get(33)).setAttribute("cod","19" );
      ((Element)v.get(4)).appendChild((Element)v.get(33));
      /* Termina nodo:33   */

      /* Empieza nodo:34 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(34)).setAttribute("name","cbAccesoPorDefecto" );
      ((Element)v.get(34)).setAttribute("required","true" );
      ((Element)v.get(34)).setAttribute("cod","11" );
      ((Element)v.get(4)).appendChild((Element)v.get(34));
      /* Termina nodo:34   */

      /* Empieza nodo:35 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(35)).setAttribute("name","cbSubaccesoPorDefecto" );
      ((Element)v.get(35)).setAttribute("required","true" );
      ((Element)v.get(35)).setAttribute("cod","123" );
      ((Element)v.get(4)).appendChild((Element)v.get(35));
      /* Termina nodo:35   */

      /* Empieza nodo:36 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(36)).setAttribute("name","cbTipoUsuario" );
   }

   private void getXML180(Document doc) {
      ((Element)v.get(36)).setAttribute("required","true" );
      ((Element)v.get(36)).setAttribute("cod","131" );
      ((Element)v.get(4)).appendChild((Element)v.get(36));
      /* Termina nodo:36   */

      /* Empieza nodo:37 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(37)).setAttribute("name","cbIdioma" );
      ((Element)v.get(37)).setAttribute("required","true" );
      ((Element)v.get(37)).setAttribute("cod","71" );
      ((Element)v.get(4)).appendChild((Element)v.get(37));
      /* Termina nodo:37   */

      /* Empieza nodo:38 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(38)).setAttribute("name","cbTipoRastreo" );
      ((Element)v.get(38)).setAttribute("required","true" );
      ((Element)v.get(38)).setAttribute("cod","108" );
      ((Element)v.get(4)).appendChild((Element)v.get(38));
      /* Termina nodo:38   */

      /* Empieza nodo:39 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(39)).setAttribute("name","rbUsuarioHabilitado" );
      ((Element)v.get(39)).setAttribute("required","true" );
      ((Element)v.get(39)).setAttribute("cod","138" );
      ((Element)v.get(4)).appendChild((Element)v.get(39));
      /* Termina nodo:39   */

      /* Empieza nodo:40 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(40)).setAttribute("name","txtFechaSustitucionDesde" );
      ((Element)v.get(40)).setAttribute("group","txtFechaSustitucionDesde" );
      ((Element)v.get(40)).setAttribute("required","false" );
      ((Element)v.get(40)).setAttribute("cod","168" );
      ((Element)v.get(40)).setAttribute("format","F" );
      ((Element)v.get(4)).appendChild((Element)v.get(40));
      /* Termina nodo:40   */

      /* Empieza nodo:41 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(41)).setAttribute("name","txtFechaSustitucionHasta" );
      ((Element)v.get(41)).setAttribute("group","txtFechaSustitucionHasta" );
      ((Element)v.get(41)).setAttribute("required","false" );
      ((Element)v.get(41)).setAttribute("cod","2211" );
      ((Element)v.get(41)).setAttribute("format","F" );
      ((Element)v.get(4)).appendChild((Element)v.get(41));
      /* Termina nodo:41   */

      /* Empieza nodo:42 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(42)).setAttribute("name","txtFechaInicioRastreo" );
      ((Element)v.get(42)).setAttribute("group","txtFechaInicioRastreo" );
      ((Element)v.get(42)).setAttribute("required","false" );
      ((Element)v.get(42)).setAttribute("cod","61" );
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(43)).setAttribute("name","txtFechaFinRastreo" );
      ((Element)v.get(43)).setAttribute("group","txtFechaFinRastreo" );
      ((Element)v.get(43)).setAttribute("required","false" );
      ((Element)v.get(43)).setAttribute("cod","60" );
      ((Element)v.get(43)).setAttribute("format","F" );
      ((Element)v.get(4)).appendChild((Element)v.get(43));
      /* Termina nodo:43   */
      /* Termina nodo:4   */

      /* Empieza nodo:44 / Elemento padre: 0   */
      v.add(doc.createElement("FORMULARIO"));
      ((Element)v.get(44)).setAttribute("nombre","frmFormulario" );
      ((Element)v.get(44)).setAttribute("oculto","S" );
      ((Element)v.get(0)).appendChild((Element)v.get(44));

      /* Empieza nodo:45 / Elemento padre: 44   */
      v.add(doc.createElement("VAR"));
      ((Element)v.get(45)).setAttribute("nombre","duplicado" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(47)).setAttribute("nombre","conectorAction" );
      ((Element)v.get(47)).setAttribute("valor","LPInsertarUsuarios" );
      ((Element)v.get(44)).appendChild((Element)v.get(47));
      /* Termina nodo:47   */

      /* Empieza nodo:48 / Elemento padre: 44   */
      v.add(doc.createElement("VAR"));
      ((Element)v.get(48)).setAttribute("nombre","casodeuso" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(49)).setAttribute("nombre","casoUso" );
      ((Element)v.get(49)).setAttribute("valor","modificar" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(52)).setAttribute("nombre","hIndicacionClaveInicial" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(53)).setAttribute("nombre","hUsuarioHabilitado" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(54)).setAttribute("nombre","hPerfil" );
   ...
   private void getXML270(Document doc) {
      v.add(doc.createElement("VAR"));
      ((Element)v.get(55)).setAttribute("nombre","hPais" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(56)).setAttribute("nombre","hSubgerenciaVentas" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(57)).setAttribute("nombre","hRegion" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(58)).setAttribute("nombre","hZona" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(59)).setAttribute("nombre","hSeccion" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(60)).setAttribute("nombre","hTerritorio" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(61)).setAttribute("nombre","hDepartamento" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(62)).setAttribute("nombre","hSociedad" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(63)).setAttribute("nombre","hMarca" );
      ((Element)v.get(63)).setAttribute("valor","" );
      ((Element)v.get(44)).appendChild((Element)v.get(63));
      /* Termina nodo:63   */

      /* Empieza nodo:64 / Elemento padre: 44   */
      v.add(doc.createElement("VAR"));
      ((Element)v.get(64)).setAttribute("nombre","hCanal" );
      ((Element)v.get(64)).setAttribute("valor","" );
      ((Element)v.get(44)).appendChild((Element)v.get(64));
      /* Termina nodo:64   */

      /* Empieza nodo:65 / Elemento padre: 44   */
      v.add(doc.createElement("VAR"));
      ((Element)v.get(65)).setAttribute("nombre","hAcceso" );
      ((Element)v.get(65)).setAttribute("valor","" );
      ((Element)v.get(44)).appendChild((Element)v.get(65));
      /* Termina nodo:65   */

      /* Empieza nodo:66 / Elemento padre: 44   */
      v.add(doc.createElement("VAR"));
      ((Element)v.get(66)).setAttribute("nombre","hSubnivelAcceso" );
      ((Element)v.get(66)).setAttribute("valor","" );
      ((Element)v.get(44)).appendChild((Element)v.get(66));
      /* Termina nodo:66   */

      /* Empieza nodo:67 / Elemento padre: 44   */
      v.add(doc.createElement("VAR"));
      ((Element)v.get(67)).setAttribute("nombre","hTipoUsuario" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(68)).setAttribute("nombre","hIdioma" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(69)).setAttribute("nombre","hFormatoFecha" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(70)).setAttribute("nombre","hTipoRastreo" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(71)).setAttribute("nombre","hUsuarioSustitucion" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(72)).setAttribute("nombre","hFuncionDirecta" );
      ((Element)v.get(72)).setAttribute("valor","" );
      ((Element)v.get(44)).appendChild((Element)v.get(72));
      /* Termina nodo:72   */

      /* Empieza nodo:73 / Elemento padre: 44   */
      v.add(doc.createElement("VAR"));
      ((Element)v.get(73)).setAttribute("nombre","hPaisPorDefecto" );
      ((Element)v.get(73)).setAttribute("valor","" );
      ((Element)v.get(44)).appendChild((Element)v.get(73));
      /* Termina nodo:73   */

      /* Empieza nodo:74 / Elemento padre: 44   */
      v.add(doc.createElement("VAR"));
      ((Element)v.get(74)).setAttribute("nombre","hRegionPorDefecto" );
      ((Element)v.get(74)).setAttribute("valor","" );
      ((Element)v.get(44)).appendChild((Element)v.get(74));
      /* Termina nodo:74   */

      /* Empieza nodo:75 / Elemento padre: 44   */
      v.add(doc.createElement("VAR"));
      ((Element)v.get(75)).setAttribute("nombre","hZonaPorDefecto" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(76)).setAttribute("nombre","hSeccionPorDefecto" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(77)).setAttribute("nombre","hSGVPorDefecto" );
   }
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(78)).setAttribute("nombre","hTerritorioPorDefecto" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(79)).setAttribute("nombre","hSociedadPorDefecto" );
      ((Element)v.get(79)).setAttribute("valor","" );
      ((Element)v.get(44)).appendChild((Element)v.get(79));
      /* Termina nodo:79   */

      /* Empieza nodo:80 / Elemento padre: 44   */
      v.add(doc.createElement("VAR"));
      ((Element)v.get(80)).setAttribute("nombre","hMarcaPorDefecto" );
      ((Element)v.get(80)).setAttribute("valor","" );
      ((Element)v.get(44)).appendChild((Element)v.get(80));
      /* Termina nodo:80   */

      /* Empieza nodo:81 / Elemento padre: 44   */
      v.add(doc.createElement("VAR"));
      ((Element)v.get(81)).setAttribute("nombre","hCanalPorDefecto" );
      ((Element)v.get(81)).setAttribute("valor","" );
      ((Element)v.get(44)).appendChild((Element)v.get(81));
      /* Termina nodo:81   */

      /* Empieza nodo:82 / Elemento padre: 44   */
      v.add(doc.createElement("VAR"));
      ((Element)v.get(82)).setAttribute("nombre","hAccesoPorDefecto" );
      ((Element)v.get(82)).setAttribute("valor","" );
      ((Element)v.get(44)).appendChild((Element)v.get(82));
      /* Termina nodo:82   */

      /* Empieza nodo:83 / Elemento padre: 44   */
      v.add(doc.createElement("VAR"));
      ((Element)v.get(83)).setAttribute("nombre","hSubaccesoPorDefecto" );
      ((Element)v.get(83)).setAttribute("valor","" );
      ((Element)v.get(44)).appendChild((Element)v.get(83));
      /* Termina nodo:83   */

      /* Empieza nodo:84 / Elemento padre: 44   */
      v.add(doc.createElement("VAR"));
      ((Element)v.get(84)).setAttribute("nombre","hUsuarioActual" );
      ((Element)v.get(84)).setAttribute("valor","" );
      ((Element)v.get(44)).appendChild((Element)v.get(84));
      /* Termina nodo:84   */

      /* Empieza nodo:85 / Elemento padre: 44   */
      v.add(doc.createElement("VAR"));
      ((Element)v.get(85)).setAttribute("nombre","hIndNDG" );
      ((Element)v.get(85)).setAttribute("valor","" );
      ((Element)v.get(44)).appendChild((Element)v.get(85));
      /* Termina nodo:85   */

      /* Empieza nodo:86 / Elemento padre: 44   */
      v.add(doc.createElement("VAR"));
      ((Element)v.get(86)).setAttribute("nombre","hIndAdmNDG" );
      ((Element)v.get(86)).setAttribute("valor","" );
      ((Element)v.get(44)).appendChild((Element)v.get(86));
      /* Termina nodo:86   */

      /* Empieza nodo:87 / Elemento padre: 44   */
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(87)).setAttribute("nombre","capa" );
      ((Element)v.get(44)).appendChild((Element)v.get(87));
   ...
   private void getXML810(Document doc) {
      ...
      ((Element)v.get(196)).setAttribute("valor","xxxxxxxxx1" );
