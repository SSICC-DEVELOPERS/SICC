...
public class EduHistoCursoPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","eduHistoCursoList" );
      ...
      ((Element)v.get(15)).setAttribute("cod","EduHistoCurso.ctsuOidClieTipoSubt.label" );
   }
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(16)).setAttribute("cod","EduHistoCurso.mcurOidCurs.label" );
      ...
      ((Element)v.get(17)).setAttribute("cod","EduHistoCurso.indApta.label" );
      ...
      ((Element)v.get(18)).setAttribute("cod","EduHistoCurso.indInvit.label" );
      ...
      ((Element)v.get(19)).setAttribute("cod","EduHistoCurso.indAsis.label" );
