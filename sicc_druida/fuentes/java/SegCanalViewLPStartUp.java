/*
    INDRA/CAR/mmg
    $Id: SegCanalViewLPStartUp.java,v 1.1 2009/12/03 18:41:28 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class SegCanalViewLPStartUp extends MMGDruidaBase{
	...
	public static final String BUSINESSID_QUERY = "MMGSegCanalViewQueryFromToUserPageStructuralSecurity";
				...
				public static final String BUSINESSID_TIPEOIDTIPOPERI_QUERY ="MMGSegTipoPerioQueryFromToUserStructuralSecurity";
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "SegCanalViewPage", "cod", "SegCanalView." + accion + ".label");
			...
			limpiarBotoneraLista("segCanalView", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codCana", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 3);");
		...
		//asignarAtributo("CAPA", "segCanalViewLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "SegCanalViewPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		SegCanalViewData segCanalViewQuery= new SegCanalViewData();
		segCanalViewQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		SegCanalViewData datosResult = (SegCanalViewData)getSingleObject(BUSINESSID_QUERY, segCanalViewQuery, 
			segCanalViewQuery.clone(), "segCanalView", false);
		...
		preservaHiddensI18n(new Integer(1), "SEG_CANAL", "segCanalViewFrm", "Descripcion", true);
		...
		SegCanalViewData segCanalView = datosResult;
		asignar("TEXT", "codCana", FormatUtils.formatObject(segCanalView.getCodCana(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "Descripcion", FormatUtils.formatObject(segCanalView.getDescripcion(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		es.indra.belcorp.mso.SegTipoPerioData tipeOidTipoPeri = segCanalView.getTipeOidTipoPeri();
		...
		loadLocalizationVars(segCanalView);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "codCana", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "SEG_CANAL", "segCanalViewFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "codCana", "req", "S");
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('segCanalViewFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "segCanalViewFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		SegCanalViewData segCanalViewQuery= new SegCanalViewData();
		segCanalViewQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(segCanalView.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"segCanalViewFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"segCanalViewFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codCana", "ontab","ejecutarAccionFocoModificacion(\"segCanalViewFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codCana", "onshtab","ejecutarAccionFocoModificacion(\"segCanalViewFrm\",2, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"segCanalViewFrm\",3, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"segCanalViewFrm\",3, false)");
					asignarAtributo("COMBO","tipeOidTipoPeri", "ontab", "ejecutarAccionFocoModificacion(\"segCanalViewFrm\",4, true)");
					asignarAtributo("COMBO","tipeOidTipoPeri", "onshtab", "ejecutarAccionFocoModificacion(\"segCanalViewFrm\",4, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","segCanalViewTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","segCanalViewTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codCana...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","segCanalViewFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","segCanalViewListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","segCanalViewListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(SegCanalViewData segCanalView) throws Exception{
		...
		SegTipoPerioData tipeOidTipoPeri = new SegTipoPerioData();
			...
			tipeOidTipoPeri, tipeOidTipoPeri.clone(), "segTipoPerio", "tipeOidTipoPeri", "result_ROWSET",false );
		if(segCanalView != null && segCanalView.getTipeOidTipoPeri() != null){
				checkCombo("tipeOidTipoPeri" , segCanalView.getTipeOidTipoPeri().getId().toString());
			}
	...
	* @param segCanalView La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(SegCanalViewData segCanalView) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		SegCanalViewData segCanalView = 
			(SegCanalViewData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(segCanalView.getTipeOidTipoPeri() != null){
			segCanalView.setTipeOidTipoPeri((es.indra.belcorp.mso.SegTipoPerioData)
			getSingleObject(BUSINESSID_TIPEOIDTIPOPERI_QUERY, 
			segCanalView.getTipeOidTipoPeri(),
			segCanalView.getTipeOidTipoPeri().clone(),
			"segTipoPerio"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(segCanalView);
		loadLeafDependenceCombos(segCanalView);
	}
	...
	*/
	...
	protected void loadLocalizationVars(SegCanalViewData segCanalView) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("SEG_CANAL");
		mmgLocalizationQuery.setEntiPk(segCanalView.getId());
