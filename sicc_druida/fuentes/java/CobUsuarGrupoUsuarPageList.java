...
public class CobUsuarGrupoUsuarPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","cobUsuarGrupoUsuarList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","CobUsuarGrupoUsuar.uscoOidUsuaCobr.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","CobUsuarGrupoUsuar.gucoOidGrupUsuaCobr.label" );
