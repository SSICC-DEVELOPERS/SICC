...
public class contenido_generico_datamart_enviar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_generico_datamart_enviar" );
      ...
      ((Element)v.get(2)).setAttribute("name","cbMarca" );
      ((Element)v.get(2)).setAttribute("required","true" );
      ((Element)v.get(2)).setAttribute("cod","6" );
      ((Element)v.get(1)).appendChild((Element)v.get(2));
      /* Termina nodo:2   */

      /* Empieza nodo:3 / Elemento padre: 1   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(3)).setAttribute("name","cbCanal" );
      ((Element)v.get(3)).setAttribute("required","true" );
      ((Element)v.get(3)).setAttribute("cod","7" );
      ((Element)v.get(1)).appendChild((Element)v.get(3));
      /* Termina nodo:3   */

      /* Empieza nodo:4 / Elemento padre: 1   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(4)).setAttribute("name","Descripcion" );
      ((Element)v.get(4)).setAttribute("required","true" );
      ((Element)v.get(4)).setAttribute("cod","844" );
      ((Element)v.get(1)).appendChild((Element)v.get(4));
      /* Termina nodo:4   */

      /* Empieza nodo:5 / Elemento padre: 1   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(5)).setAttribute("name","txtFechaFacturacion" );
      ((Element)v.get(5)).setAttribute("required","true" );
      ((Element)v.get(5)).setAttribute("cod","876" );
      ((Element)v.get(1)).appendChild((Element)v.get(5));
      /* Termina nodo:5   */

      /* Empieza nodo:6 / Elemento padre: 1   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(6)).setAttribute("name","cbPeriodoFacturacion" );
      ((Element)v.get(6)).setAttribute("required","true" );
      ((Element)v.get(6)).setAttribute("cod","966" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(9)).setAttribute("src","contenido_generico_datamart_enviar.js" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(16)).setAttribute("nombre","hNumeroLote" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(17)).setAttribute("nombre","hDescripcionLote" );
   ...
   private void getXML90(Document doc) {
      v.add(doc.createElement("VAR"));
      ((Element)v.get(21)).setAttribute("nombre","hListaInterfaces" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(60)).setAttribute("onshtab","document.all['btnEnviar'].focus()" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(131)).setAttribute("cols","50" );
      ((Element)v.get(131)).setAttribute("id","datosCampos" );
      ((Element)v.get(131)).setAttribute("msjreq","" );
      ((Element)v.get(131)).setAttribute("nombre","areatxtObservaciones" );
      ((Element)v.get(131)).setAttribute("readonly","N" );
      ((Element)v.get(131)).setAttribute("req","N" );
      ((Element)v.get(131)).setAttribute("rows","3" );
      ((Element)v.get(131)).setAttribute("tabindex","2" );
      ((Element)v.get(131)).setAttribute("valor","" );
      ((Element)v.get(131)).setAttribute("max","256" );
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(135)).setAttribute("nombre","txtFechaFacturacion" );
   }
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(135)).setAttribute("onblur","fechaValida('txtFechaFacturacion')" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(139)).setAttribute("nombre","cbPeriodoFacturacion" );
      ...
      /* Empieza nodo:148 / Elemento padre: 23   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(23)).appendChild((Element)v.get(148));
      ...
      ((Element)v.get(155)).setAttribute("ancho","730" );
      ((Element)v.get(155)).setAttribute("alto","223" );
      ((Element)v.get(155)).setAttribute("x","18" );
      ((Element)v.get(155)).setAttribute("y","190" );
   ...
   private void getXML630(Document doc) {
      ...
      ((Element)v.get(156)).setAttribute("cod","00635" );
      ...
      ((Element)v.get(164)).setAttribute("vertCabecera","#999999" );
      ((Element)v.get(164)).setAttribute("vertDatos","#999999" );
      ((Element)v.get(164)).setAttribute("horizDatos","#999999" );
      ...
      ((Element)v.get(165)).setAttribute("permiteOrdenar","N" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(167)).setAttribute("ancho","200" );
      ...
      ((Element)v.get(170)).setAttribute("cod","8" );
   ...
   private void getXML720(Document doc) {
      ...
      ((Element)v.get(172)).setAttribute("cod","3055" );
      ...
      ((Element)v.get(173)).setAttribute("maxSel","0" );
      ...
      ((Element)v.get(174)).setAttribute("nombre","lblCodigo" );
      ...
      ((Element)v.get(175)).setAttribute("nombre","lblDescripcion" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(176)).setAttribute("tipo","checkbox" );
      ((Element)v.get(176)).setAttribute("nombre","chkProcesar" );
      ((Element)v.get(176)).setAttribute("ID","EstDat" );
      ((Element)v.get(176)).setAttribute("valor","S" );
      ...
      ((Element)v.get(178)).setAttribute("x","25" );
      ((Element)v.get(178)).setAttribute("y","390" );
      ((Element)v.get(178)).setAttribute("nombre","btnEnviar" );
      ((Element)v.get(178)).setAttribute("ID","botonContenido" );
      ((Element)v.get(178)).setAttribute("tipo","html" );
      ((Element)v.get(178)).setAttribute("accion","onclikEnviar();" );
      ((Element)v.get(178)).setAttribute("estado","false" );
      ((Element)v.get(178)).setAttribute("cod","1597" );
      ((Element)v.get(178)).setAttribute("ontab","focaliza('frmFormulario.cbMarca')" );
