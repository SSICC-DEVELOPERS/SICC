...
public class FacTipoFormuPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","FacTipoFormu.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","FacTipoFormu.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('facTipoFormuFrm',0, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('facTipoFormuFrm', 0, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(50)).setAttribute("nombre","codTipoFormTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lblCodTipoForm" );
      ((Element)v.get(54)).setAttribute("alto","13" );
      ((Element)v.get(54)).setAttribute("filas","1" );
      ((Element)v.get(54)).setAttribute("id","datosTitle" );
      ((Element)v.get(54)).setAttribute("cod","FacTipoFormu.codTipoForm.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(55)).setAttribute("nombre","codTipoFormWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(57)).setAttribute("nombre","codTipoForm" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('facTipoFormuFrm',0, true)" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('facTipoFormuFrm', 0, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(58)).setAttribute("nombre","codTipoFormGapTdId" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(79)).setAttribute("cod","FacTipoFormu.valDesc.label" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(82)).setAttribute("ontab","ejecutarAccionFoco('facTipoFormuFrm',0, true)" );
      ((Element)v.get(82)).setAttribute("onshtab","ejecutarAccionFoco('facTipoFormuFrm', 0, false)" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(97)).setAttribute("nombre","facTipoFormuTrButtons" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(104)).setAttribute("nombre","facTipoFormuTdQueryButton" );
      ((Element)v.get(103)).appendChild((Element)v.get(104));

      /* Empieza nodo:105 / Elemento padre: 104   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(105)).setAttribute("nombre","facTipoFormuQueryButton" );
      ((Element)v.get(105)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(105)).setAttribute("estado","false" );
      ((Element)v.get(105)).setAttribute("accion","facTipoFormuFirstPage();" );
      ...
      ((Element)v.get(106)).setAttribute("nombre","facTipoFormuTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(108)).setAttribute("nombre","facTipoFormuLovNullButton" );
      ((Element)v.get(108)).setAttribute("ID","botonContenido" );
      ((Element)v.get(108)).setAttribute("tipo","html" );
      ((Element)v.get(108)).setAttribute("accion","facTipoFormuLovNullSelectionAction();" );
