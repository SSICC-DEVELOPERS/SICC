...
/*
    INDRA/CAR/mmg
    $Id: MaeEncueNseViewFormFormatter.java,v 1.1 2009/12/03 18:34:11 pecbazalar Exp $
    DESC
*/
 ...
 * @author Indra
 */
public class MaeEncueNseViewFormFormatter extends MMGDruidaFormatoObjeto {
	
	public MaeEncueNseViewFormFormatter() {
	}
	...
	public void formatea(String s, Object obj) throws Exception {
		...
		for (int i = 0; i < maeEncueNseViewList.size(); i++) {
			...
			row.add((maeEncueNseViewData.getPaisOidPais() != null ? maeEncueNseViewData.getPaisOidPais().getId() : null));
			...
			row.add((maeEncueNseViewData.getDescripcion() != null ? 
				FormatUtils.formatObject(maeEncueNseViewData.getDescripcion(), 
				 MMGDruidaHelper.getUserDecimalFormatPattern(this), 
				MMGDruidaHelper.getUserDecimalFormatSymbols(this)) : ""));
			row.add((maeEncueNseViewData.getMarcOidMarc() != null ? maeEncueNseViewData.getMarcOidMarc().getId() : null));
