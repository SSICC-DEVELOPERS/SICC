...
public class contenido_confirmacion  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_confirmacion" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(2)).setAttribute("src","contenido_confirmacion.js" );
      ((Element)v.get(0)).appendChild((Element)v.get(2));
      /* Termina nodo:2   */

      /* Empieza nodo:3 / Elemento padre: 0   */
      v.add(doc.createElement("FORMULARIO"));
      ((Element)v.get(3)).setAttribute("nombre","frmMain" );
      ((Element)v.get(0)).appendChild((Element)v.get(3));

      /* Empieza nodo:4 / Elemento padre: 3   */
      v.add(doc.createElement("VAR"));
      ((Element)v.get(4)).setAttribute("nombre","conectorAction" );
      ((Element)v.get(4)).setAttribute("valor","LPEliminarUnidadesGeograficas" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(6)).setAttribute("nombre","exito" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(7)).setAttribute("nombre","nombrePais" );
