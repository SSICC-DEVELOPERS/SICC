...
public class ZonNivelGeogrPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","zonNivelGeogrList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","ZonNivelGeogr.codDiviPoli.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","ZonNivelGeogr.Descripcion.label" );
