...
public class contenido_base_aplicacion_detalle  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_base_aplicacion_detalle" );
      ((Element)v.get(0)).setAttribute("cod","0644" );
      ((Element)v.get(0)).setAttribute("titulo","Ingresar valores de descuentos" );
      ...
      v.add(doc.createTextNode("\r   \r\r  function onLoadPag(){\r     configurarMenuSecundario('formulario');\r     focaliza('formulario.txtEscalaDesde');\r  }\r\r  function seleccionar(){\r        if(sicc_validaciones_generales() && validarEscalas()){\r            var arr = new Array();\r            arr[0] = cdos_trim(get('formulario.txtEscalaDesde'));		\r            arr[1] = cdos_trim(get('formulario.txtEscalaHasta'));				\r            arr[2] = cdos_trim(get('formulario.txtDescuento'));\r\r            returnValue = arr;\r            close();\r       }else {\r       \r       }\r  }\r\r     function validarEscalas(){\r      var escalaDesde = get('formulario.txtEscalaDesde');        \r      var escalaHasta = get('formulario.txtEscalaHasta');\r	 \r       \r	  var escalaD = escalaDesde.split(\".\");\r	  var escalaH = escalaHasta.split(\".\");\r	  var eD = rellenaCeros(escalaD[0],16,escalaD[0].length)\r	  var eH = rellenaCeros(escalaH[0],16,escalaH[0].length)\r	\r	  if(escalaHasta!=\"\") {\r\r			if(parseFloat(eD) > parseFloat(eH)){\r				var vMensaje = \"\";\r				vMensaje = GestionarMensaje('257');\r				cdos_mostrarAlert (vMensaje);\r				return false;\r			} else {\r				if(eD > eH){\r			  		var vMensaje = \"\";\r					vMensaje = GestionarMensaje('257');\r					cdos_mostrarAlert (vMensaje);\r					return false;\r				}\r				return true;\r							}\r	  } else {\r        return true;\r      }\r  }\r  \r  function fVolver() {\r    window.close();\r  }\r\r\r     \r"));
      ...
      ((Element)v.get(8)).setAttribute("name","txtEscalaDesde" );
      ((Element)v.get(8)).setAttribute("required","true" );
      ((Element)v.get(8)).setAttribute("cod","860" );
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(9)).setAttribute("name","txtEscalaHasta" );
      ((Element)v.get(9)).setAttribute("required","false" );
      ((Element)v.get(9)).setAttribute("cod","1303" );
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(10)).setAttribute("name","txtDescuento" );
      ((Element)v.get(10)).setAttribute("required","true" );
      ((Element)v.get(10)).setAttribute("cod","341" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(16)).setAttribute("nombre","hidOidBase" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(17)).setAttribute("nombre","hidOidDescuento" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(18)).setAttribute("nombre","hidMensajeExito" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(20)).setAttribute("nombre","secuencia" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(36)).setAttribute("nombre","lblDefinicionEscalas" );
      ((Element)v.get(36)).setAttribute("alto","13" );
      ((Element)v.get(36)).setAttribute("filas","1" );
      ((Element)v.get(36)).setAttribute("cod","0098" );
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(40)).setAttribute("width","400" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(48)).setAttribute("nombre","lblEscalaDesde" );
      ...
      ((Element)v.get(48)).setAttribute("cod","860" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(52)).setAttribute("nombre","lblEscalaHasta" );
      ((Element)v.get(52)).setAttribute("alto","13" );
      ((Element)v.get(52)).setAttribute("filas","1" );
      ((Element)v.get(52)).setAttribute("valor","" );
      ((Element)v.get(52)).setAttribute("id","datosTitle" );
      ((Element)v.get(52)).setAttribute("cod","1303" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(56)).setAttribute("nombre","lblDescuento" );
      ...
      ((Element)v.get(56)).setAttribute("cod","341" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(87)).setAttribute("nombre","btnAceptar" );
      ((Element)v.get(87)).setAttribute("ID","botonContenido" );
      ((Element)v.get(87)).setAttribute("tipo","html" );
      ((Element)v.get(87)).setAttribute("accion","seleccionar();" );
      ((Element)v.get(87)).setAttribute("estado","false" );
      ((Element)v.get(87)).setAttribute("cod","12" );
      ((Element)v.get(87)).setAttribute("ontab","focaliza('formulario.txtEscalaDesde')" );
   }
   ...
   private void getXML360(Document doc) {
      ...
      /* Empieza nodo:90 / Elemento padre: 22   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(22)).appendChild((Element)v.get(90));
