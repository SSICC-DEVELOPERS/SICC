...
public class CobEstadUsuarEtapaCobraPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","cobEstadUsuarEtapaCobraList" );
      ...
      ((Element)v.get(12)).setAttribute("cod","CobEstadUsuarEtapaCobra.codEstaUsuaEtapCobr.label" );
      ...
      ((Element)v.get(13)).setAttribute("alto","22" );
      ((Element)v.get(13)).setAttribute("accion","" );
      ((Element)v.get(13)).setAttribute("tipoEnvio","seleccion" );
      ((Element)v.get(13)).setAttribute("formaEnvio","xml" );
      ((Element)v.get(13)).setAttribute("maxSel","1" );
      ((Element)v.get(13)).setAttribute("msgErrMaxSel","" );
      ((Element)v.get(13)).setAttribute("coloresScrollNativo","#D4D0C8,black,white,#D4D0C8,#D4D0C8,#ECE9E4,black" );
      ((Element)v.get(13)).setAttribute("colorROver","#D0D9E8" );
      ((Element)v.get(13)).setAttribute("onLoad","" );
      ((Element)v.get(13)).setAttribute("colorSelecc","#D0D9E8" );
   ...
   private void getXML90(Document doc) {
      v.add(doc.createElement("COL"));
      ((Element)v.get(14)).setAttribute("tipo","texto" );
      ((Element)v.get(14)).setAttribute("ID","EstDat" );
