...
public class contenido_extemporaneas_cursos_actualizar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(7)).setAttribute("src","contenido_extemporaneas_cursos_actualizar.js" );
      ((Element)v.get(0)).appendChild((Element)v.get(7));
      /* Termina nodo:7   */

      /* Empieza nodo:8 / Elemento padre: 0   */
      v.add(doc.createElement("FORMULARIO"));
      ((Element)v.get(8)).setAttribute("nombre","frm" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(16)).setAttribute("nombre","oidCurso" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(17)).setAttribute("nombre","lista" );
   ...
   private void getXML90(Document doc) {
      ((Element)v.get(21)).setAttribute("nombre","apellido1" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(22)).setAttribute("nombre","apellido2" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(23)).setAttribute("nombre","nombre1" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(24)).setAttribute("nombre","nombre2" );
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(45)).setAttribute("width","486" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(53)).setAttribute("nombre","lblCodigoCliente" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(57)).setAttribute("nombre","lblFechaAsistenciaCurso" );
      ...
      ((Element)v.get(57)).setAttribute("cod","1187" );
      ...
      ((Element)v.get(64)).setAttribute("nombre","txtCodigoCliente" );
      ((Element)v.get(64)).setAttribute("id","datosCampos" );
      ((Element)v.get(64)).setAttribute("max","15" );
      ((Element)v.get(64)).setAttribute("tipo","" );
      ((Element)v.get(64)).setAttribute("onshtab","codigoClienteOnShTab();" );
      ((Element)v.get(64)).setAttribute("onblur","codigoClienteOnBlur();" );
      ((Element)v.get(64)).setAttribute("onchange","limpiaVarsOcultas();" );
      ((Element)v.get(64)).setAttribute("req","S" );
      ((Element)v.get(64)).setAttribute("size","15" );
   ...
   private void getXML270(Document doc) {
      v.add(doc.createElement("IMG"));
      ((Element)v.get(68)).setAttribute("src","iconBuscar.gif" );
      ((Element)v.get(68)).setAttribute("onclick","accionBuscar();" );
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(72)).setAttribute("nombre","txtFechaAsistenciaCurso" );
      ...
      ((Element)v.get(77)).setAttribute("height","7" );
      ...
      ((Element)v.get(88)).setAttribute("nombre","btnAnadir" );
      ((Element)v.get(88)).setAttribute("ID","botonContenido" );
      ((Element)v.get(88)).setAttribute("tipo","html" );
      ((Element)v.get(88)).setAttribute("accion","accionAniadir();" );
      ((Element)v.get(88)).setAttribute("estado","false" );
      ((Element)v.get(88)).setAttribute("cod","404" );
   ...
   private void getXML360(Document doc) {
      ...
      /* Empieza nodo:98 / Elemento padre: 26   */
      v.add(doc.createElement("LISTAEDITABLE"));
      ((Element)v.get(98)).setAttribute("nombre","listado1" );
      ((Element)v.get(98)).setAttribute("ancho","760" );
      ((Element)v.get(98)).setAttribute("alto","317" );
      ((Element)v.get(98)).setAttribute("x","12" );
      ((Element)v.get(98)).setAttribute("y","135" );
      ((Element)v.get(98)).setAttribute("colorFondo","#CECFCE" );
      ((Element)v.get(98)).setAttribute("msgDebugJS","S" );
      ((Element)v.get(26)).appendChild((Element)v.get(98));
      ...
      ((Element)v.get(106)).setAttribute("cod","0022" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(118)).setAttribute("cod","1187" );
      ...
      ((Element)v.get(120)).setAttribute("cod","17" );
      ...
      ((Element)v.get(121)).setAttribute("cod","93" );
      ...
      ((Element)v.get(122)).setAttribute("cod","94" );
      ...
      /* Empieza nodo:125 / Elemento padre: 98   */
      v.add(doc.createElement("DATOS"));
      ((Element)v.get(125)).setAttribute("alto","22" );
      ((Element)v.get(125)).setAttribute("accion","" );
      ((Element)v.get(125)).setAttribute("tipoEnvio","seleccion" );
      ...
      ((Element)v.get(98)).appendChild((Element)v.get(125));
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(127)).setAttribute("nombre","Texto1" );
      ((Element)v.get(127)).setAttribute("size","12" );
      ((Element)v.get(127)).setAttribute("max","10" );
      ((Element)v.get(127)).setAttribute("deshabilitado","S" );
      ((Element)v.get(127)).setAttribute("IDOBJ","EstCajaDatForm" );
      ((Element)v.get(127)).setAttribute("ID","EstDat" );
      ((Element)v.get(127)).setAttribute("onBlur","/*validaFormularioOnBlur(FILAEVENTO);*/" );
      ((Element)v.get(127)).setAttribute("onShTab","focalizaAnterior(FILAEVENTO, TECLAEVENTO)" );
      ...
      /* Empieza nodo:133 / Elemento padre: 98   */
      v.add(doc.createElement("ROWSET"));
      ((Element)v.get(98)).appendChild((Element)v.get(133));
      /* Termina nodo:133   */

      /* Empieza nodo:134 / Elemento padre: 98   */
      v.add(doc.createElement("PAGINADO"));
      ((Element)v.get(134)).setAttribute("nombre","mipgndo" );
      ((Element)v.get(134)).setAttribute("ancho","760" );
      ((Element)v.get(134)).setAttribute("sep","$" );
      ((Element)v.get(134)).setAttribute("x","12" );
      ((Element)v.get(134)).setAttribute("class","botonera" );
      ((Element)v.get(134)).setAttribute("y","429" );
      ...
      ((Element)v.get(138)).setAttribute("y","429" );
   ...
   private void getXML630(Document doc) {
      ...
      ((Element)v.get(138)).setAttribute("onshtab","/*document.all['Aceptar'].focus();*/" );
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(139)).setAttribute("nombre","capaEspacio" );
      ((Element)v.get(139)).setAttribute("alto","12" );
      ((Element)v.get(139)).setAttribute("ancho","50" );
      ((Element)v.get(139)).setAttribute("x","0" );
      ((Element)v.get(139)).setAttribute("y","329" );
