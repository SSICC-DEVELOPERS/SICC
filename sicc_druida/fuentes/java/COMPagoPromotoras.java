...
public class COMPagoPromotoras extends LPSICCBase {           
   public COMPagoPromotoras() {	 
     super();
  }
     ...
     try {
        ...
        if (accion.equals("generar")){
          ...
          //cargarPagina();
           ...
           cargarPagina();
           getConfiguracionMenu("COMPagoPromotoras");
        }
  ...
  private void cargarPagina() throws Exception{
     pagina("contenido_informe_pago_promotoras_generar");   
 ...
 private void generarReporte() throws Exception{
    ...
    /**/
     ...
     if(tipoComision.equals("V")){
        reporte = "RD_REP-146";
     }else{
        reporte = "RD_REP-146_01";
     }


     datos.put(ConstantesREP.TITULO, "Pago de Promotoras(Periodo/Mes)");     
...
//     ejecutarReporte(datos, "REPGenerarReporte", "RD_REP-146", formato);
