/*
    INDRA/CAR/mmg
    $Id: MaeTipoEstatClienViewLPStartUp.java,v 1.1 2009/12/03 18:40:12 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class MaeTipoEstatClienViewLPStartUp extends MMGDruidaBase{
	...
	public static final String BUSINESSID_QUERY = "MMGMaeTipoEstatClienViewQueryFromToUserPage";
	...
	public MaeTipoEstatClienViewLPStartUp(){
		super();
	}

	public void inicio() throws Exception {
		pagina("MaeTipoEstatClienViewPage");
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			buildJsPageSize("MaeTipoEstatClienView");
			...
			asignarAtributo("PAGINA", "MaeTipoEstatClienViewPage", "cod", "MaeTipoEstatClienView." + accion + ".label");
			...
			limpiarBotoneraLista("maeTipoEstatClienView", accion);
	...
	protected void cmdLov() throws Exception{
		...
		//asignarAtributo("CAPA", "maeTipoEstatClienViewLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "MaeTipoEstatClienViewPage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("MaeTipoEstatClienViewLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		MaeTipoEstatClienViewData maeTipoEstatClienViewQuery= new MaeTipoEstatClienViewData();
		maeTipoEstatClienViewQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		MaeTipoEstatClienViewData datosResult = (MaeTipoEstatClienViewData)getSingleObject(BUSINESSID_QUERY, maeTipoEstatClienViewQuery, 
			maeTipoEstatClienViewQuery.clone(), "maeTipoEstatClienView");
		...
		preservaHiddensI18n(new Integer(1), "MAE_TIPO_ESTAT_CLIEN", "maeTipoEstatClienViewFrm", "Descripcion", true);
		...
		MaeTipoEstatClienViewData maeTipoEstatClienView = datosResult;
		asignar("TEXT", "codTipoEsta", FormatUtils.formatObject(maeTipoEstatClienView.getCodTipoEsta(), 
		...
		loadLocalizationVars(maeTipoEstatClienView);
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "MAE_TIPO_ESTAT_CLIEN", "maeTipoEstatClienViewFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('maeTipoEstatClienViewFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "maeTipoEstatClienViewFrm", "oculto", "N");
		...
		traza("MMG::Creando MaeTipoEstatClienView");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		MaeTipoEstatClienViewData maeTipoEstatClienViewQuery= new MaeTipoEstatClienViewData();
		maeTipoEstatClienViewQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(maeTipoEstatClienView.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"maeTipoEstatClienViewFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"maeTipoEstatClienViewFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codTipoEsta", "ontab","ejecutarAccionFocoModificacion(\"maeTipoEstatClienViewFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codTipoEsta", "onshtab","ejecutarAccionFocoModificacion(\"maeTipoEstatClienViewFrm\",2, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"maeTipoEstatClienViewFrm\",4, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"maeTipoEstatClienViewFrm\",4, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","maeTipoEstatClienViewTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","maeTipoEstatClienViewTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","maeTipoEstatClienViewFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","maeTipoEstatClienViewListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","maeTipoEstatClienViewListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(MaeTipoEstatClienViewData maeTipoEstatClienView) throws Exception{
	...
	* @param maeTipoEstatClienView La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(MaeTipoEstatClienViewData maeTipoEstatClienView) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		MaeTipoEstatClienViewData maeTipoEstatClienView = 
			(MaeTipoEstatClienViewData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(maeTipoEstatClienView);
		loadLeafDependenceCombos(maeTipoEstatClienView);
	}
	...
	*/
	...
	protected void loadLocalizationVars(MaeTipoEstatClienViewData maeTipoEstatClienView) throws Exception{
		...
		mmgLocalizationQuery.setEntiPk(maeTipoEstatClienView.getId());
