...
public class CarIndicValidConectorQueryForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad CarIndicValid" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGCarIndicValidQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGCarIndicValidQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","CarIndicValidFormFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","codIndiVali" );
