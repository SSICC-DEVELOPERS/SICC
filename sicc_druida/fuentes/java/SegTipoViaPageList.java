...
public class SegTipoViaPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","segTipoViaList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","SegTipoVia.codTipoVia.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","SegTipoVia.desAbrvTipoVia.label" );
