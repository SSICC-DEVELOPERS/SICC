...
public class MsgTipoMetacConectorQueryList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad MsgTipoMetac" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGMsgTipoMetacQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGMsgTipoMetacQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","MsgTipoMetacListFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","codTipo" );
