...
public class EDURelacionAsistenciaCursos extends LPSICCBase {           
   public EDURelacionAsistenciaCursos() {	 
     super();
  }
     ...
     try {
        ...
        if (accion.equals("generar")){
          ...
          //cargarPagina();
           ...
           cargarPagina();
           getConfiguracionMenu("EDURelacionAsistenciaCursos");
        }
  ...
  private void cargarPagina() throws Exception{
     pagina("contenido_informe_asistencia_cursos_generar");   
 ...
 private void generarReporte() throws Exception{
     ...
     if(!codigoCurso.equals("")){
        datos.put(ConstantesREP.CURSO, codigoCurso); 
	   }
     ...
     datos.put(ConstantesREP.TITULO, "Relacion de Asistentes al Curso");     
     traza("++++++Antes de enviar a reportes " + datos); 
     //ejecutarReporte(datos, "REPGenerarReporte", "RD_REP-010", null);
     ejecutarReporte2(datos, "REPGenerarReporteBatch", "RD_REP-010", "pdf");
