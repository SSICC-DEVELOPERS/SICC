...
public class PreCatalPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","preCatalList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","PreCatal.codCata.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","PreCatal.desCata.label" );
