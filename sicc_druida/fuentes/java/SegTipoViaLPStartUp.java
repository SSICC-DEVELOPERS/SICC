/*
    INDRA/CAR/mmg
    $Id: SegTipoViaLPStartUp.java,v 1.1 2009/12/03 18:39:46 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class SegTipoViaLPStartUp extends MMGDruidaBase{
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "SegTipoViaPage", "cod", "SegTipoVia." + accion + ".label");
			...
			limpiarBotoneraLista("segTipoVia", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codTipoVia", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 2);");
		asignarAtributo("TEXT", "desAbrvTipoVia", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 10);");
		
		//Primero determianmos el nombre del campo en la entidad de oriegen donde se van a cargar los datos
		asignar("VAR", "idAttributeLovOpener", conectorParametro(PARAMETRO_LOV_ATTRIBUTO));
		asignar("VAR", "idEntityLovOpener", conectorParametro(PARAMETRO_LOV_ENTIDAD));
		//asignarAtributo("CAPA", "segTipoViaLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "SegTipoViaPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		SegTipoViaData segTipoViaQuery= new SegTipoViaData();
		segTipoViaQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		SegTipoViaData datosResult = (SegTipoViaData)getSingleObject(BUSINESSID_QUERY, segTipoViaQuery, 
			segTipoViaQuery.clone(), "segTipoVia");
		...
		preservaHiddensI18n(new Integer(1), "SEG_TIPO_VIA", "segTipoViaFrm", "Descripcion", true);
		...
		SegTipoViaData segTipoVia = datosResult;
		asignar("TEXT", "codTipoVia", FormatUtils.formatObject(segTipoVia.getCodTipoVia(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "desAbrvTipoVia", FormatUtils.formatObject(segTipoVia.getDesAbrvTipoVia(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		loadLocalizationVars(segTipoVia);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "codTipoVia", "disabled", "S");
		asignarAtributo("TEXT", "desAbrvTipoVia", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "SEG_TIPO_VIA", "segTipoViaFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "codTipoVia", "req", "S");
		asignarAtributo("TEXT", "desAbrvTipoVia", "req", "S");
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('segTipoViaFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "segTipoViaFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		SegTipoViaData segTipoViaQuery= new SegTipoViaData();
		segTipoViaQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(segTipoVia.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"segTipoViaFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"segTipoViaFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codTipoVia", "ontab","ejecutarAccionFocoModificacion(\"segTipoViaFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codTipoVia", "onshtab","ejecutarAccionFocoModificacion(\"segTipoViaFrm\",2, false)");
				asignarAtributo("AREATEXTO", "desAbrvTipoVia", "ontab","ejecutarAccionFocoModificacion(\"segTipoViaFrm\",3, true)");
				asignarAtributo("AREATEXTO", "desAbrvTipoVia", "onshtab","ejecutarAccionFocoModificacion(\"segTipoViaFrm\",3, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"segTipoViaFrm\",4, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"segTipoViaFrm\",4, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","segTipoViaTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","segTipoViaTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codTipoVia...");		
				
					traza("MMG: en desactivateNonModifyFields encontrado atributo no editable...");
				
						// borrarCampo("codTipoVia");
						asignarAtributo ("TEXT", "codTipoVia", "disabled", "S");
				traza("MMG: el atributo es desAbrvTipoVia...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","segTipoViaFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","segTipoViaListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","segTipoViaListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(SegTipoViaData segTipoVia) throws Exception{
	...
	* @param segTipoVia La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(SegTipoViaData segTipoVia) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		SegTipoViaData segTipoVia = 
			(SegTipoViaData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(segTipoVia);
		loadLeafDependenceCombos(segTipoVia);
	}
	...
	*/
	...
	protected void loadLocalizationVars(SegTipoViaData segTipoVia) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("SEG_TIPO_VIA");
		mmgLocalizationQuery.setEntiPk(segTipoVia.getId());
