...
public class SegIdiomPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","SegIdiom.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","SegIdiom.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('segIdiomFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('segIdiomFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(50)).setAttribute("nombre","codIdioTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lblCodIdio" );
      ((Element)v.get(54)).setAttribute("alto","13" );
      ((Element)v.get(54)).setAttribute("filas","1" );
      ((Element)v.get(54)).setAttribute("id","datosTitle" );
      ((Element)v.get(54)).setAttribute("cod","SegIdiom.codIdio.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(55)).setAttribute("nombre","codIdioWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(57)).setAttribute("nombre","codIdio" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('segIdiomFrm',2, true)" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('segIdiomFrm', 2, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(58)).setAttribute("nombre","codIdioGapTdId" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(64)).setAttribute("cod","SegIdiom.Descripcion.label" );
      ...
      ((Element)v.get(68)).setAttribute("max","15" );
      ((Element)v.get(68)).setAttribute("onchange","" );
      ((Element)v.get(68)).setAttribute("req","N" );
      ((Element)v.get(68)).setAttribute("size","15" );
      ...
      ((Element)v.get(68)).setAttribute("ontab","ejecutarAccionFoco('segIdiomFrm',3, true)" );
      ((Element)v.get(68)).setAttribute("onshtab","ejecutarAccionFoco('segIdiomFrm', 3, false)" );
      ...
      ((Element)v.get(72)).setAttribute("href","javascript:openLocalizationDialog('segIdiomFrm', 'Descripcion', 1);" );
      ((Element)v.get(72)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"segIdiomFrm\",3, true)', 'ejecutarAccionFoco(\"segIdiomFrm\",3, false)')" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(76)).setAttribute("nombre","indIdioTradTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(81)).setAttribute("nombre","indIdioTradWidgetTrId" );
      ...
      ((Element)v.get(83)).setAttribute("nombre","indIdioTrad" );
      ...
      ((Element)v.get(83)).setAttribute("ontab","ejecutarAccionFoco('segIdiomFrm',4, true)" );
      ((Element)v.get(83)).setAttribute("onshtab","ejecutarAccionFoco('segIdiomFrm',4, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(84)).setAttribute("nombre","indIdioTradGapTdId" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(86)).setAttribute("nombre","codIsoIdioTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(91)).setAttribute("nombre","codIsoIdioWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(93)).setAttribute("nombre","codIsoIdio" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(93)).setAttribute("ontab","ejecutarAccionFoco('segIdiomFrm',5, true)" );
      ((Element)v.get(93)).setAttribute("onshtab","ejecutarAccionFoco('segIdiomFrm', 5, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(94)).setAttribute("nombre","codIsoIdioGapTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(108)).setAttribute("nombre","segIdiomTrButtons" );
      ...
      ((Element)v.get(115)).setAttribute("nombre","segIdiomTdQueryButton" );
   }
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(116)).setAttribute("nombre","segIdiomQueryButton" );
      ((Element)v.get(116)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(116)).setAttribute("estado","false" );
      ((Element)v.get(116)).setAttribute("accion","segIdiomFirstPage();" );
      ...
      ((Element)v.get(117)).setAttribute("nombre","segIdiomTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(119)).setAttribute("nombre","segIdiomLovNullButton" );
      ((Element)v.get(119)).setAttribute("ID","botonContenido" );
      ((Element)v.get(119)).setAttribute("tipo","html" );
      ((Element)v.get(119)).setAttribute("accion","segIdiomLovNullSelectionAction();" );
