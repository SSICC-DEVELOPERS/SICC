...
public class contenido_informe_consulta_CCC_generar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_informe_consulta_CCC_generar" );
      ((Element)v.get(0)).setAttribute("cod","0841" );
      ((Element)v.get(0)).setAttribute("titulo","Generar informe consulta de cuenta corriente" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","contenido_informe_consulta_CCC_generar.js" );
      ...
      ((Element)v.get(7)).setAttribute("name","txtCodConsultora" );
      ((Element)v.get(7)).setAttribute("required","true" );
      ((Element)v.get(7)).setAttribute("cod","628" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(16)).setAttribute("nombre","codigoConsultora" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(17)).setAttribute("nombre","numeroCargo" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(57)).setAttribute("nombre","txtCodConsultora" );
      ((Element)v.get(57)).setAttribute("id","datosCampos" );
      ((Element)v.get(57)).setAttribute("max","11" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(81)).setAttribute("nombre","btnGenerarInforme" );
      ((Element)v.get(81)).setAttribute("ID","botonContenido" );
      ((Element)v.get(81)).setAttribute("tipo","html" );
      ((Element)v.get(81)).setAttribute("accion","generarInforme();" );
      ((Element)v.get(81)).setAttribute("estado","false" );
      ((Element)v.get(81)).setAttribute("cod","2495" );
      ((Element)v.get(81)).setAttribute("ontab","focaliza('Formulario.txtCodConsultora');" );
      ...
      /* Empieza nodo:91 / Elemento padre: 0   */
      v.add(doc.createElement("FORMULARIO"));
      ((Element)v.get(91)).setAttribute("nombre","frmContenidoEnvia" );
      ((Element)v.get(91)).setAttribute("oculto","N" );
      ((Element)v.get(0)).appendChild((Element)v.get(91));

      /* Empieza nodo:92 / Elemento padre: 91   */
      v.add(doc.createElement("VAR"));
      ((Element)v.get(92)).setAttribute("nombre","conectorAction" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(93)).setAttribute("nombre","errCodigo" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(94)).setAttribute("nombre","errDescripcion" );
