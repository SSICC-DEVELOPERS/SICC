...
public class contenido_mantenimiento_gerente_congelado_modificar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_mantenimiento_gerente_congelado_modificar" );
      ((Element)v.get(0)).setAttribute("cod","ComConge.update.label" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","contenido_mantenimiento_gerente_congelado_modificar.js" );
      ...
      ((Element)v.get(18)).setAttribute("valor","modificacion" );
      ((Element)v.get(9)).appendChild((Element)v.get(18));
      /* Termina nodo:18   */

      /* Empieza nodo:19 / Elemento padre: 9   */
      v.add(doc.createElement("VAR"));
      ((Element)v.get(19)).setAttribute("nombre","oidCongelado" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(20)).setAttribute("nombre","fechaDesde" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(22)).setAttribute("nombre","importe" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(23)).setAttribute("nombre","DescongelacionAutomatica" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(24)).setAttribute("nombre","vigente" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(53)).setAttribute("colspan","2" );
      ...
      ((Element)v.get(61)).setAttribute("onshtab","setOnShTab('txtCodCliente');" );
      ((Element)v.get(61)).setAttribute("ontab","setOnTab('txtCodCliente');" );
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(67)).setAttribute("colspan","2" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(87)).setAttribute("onshtab","setOnShTab('txtFechaDesde');" );
      ((Element)v.get(87)).setAttribute("ontab","setOnTab('txtFechaDesde');" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(91)).setAttribute("onshtab","setOnShTab('txtFechaHasta');" );
      ((Element)v.get(91)).setAttribute("ontab","setOnTab('txtFechaHasta');" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(115)).setAttribute("onshtab","setOnShTab('txtImporte');" );
      ((Element)v.get(115)).setAttribute("ontab","setOnTab('txtImporte');" );
      ...
      ((Element)v.get(119)).setAttribute("onshtab","setOnShTab('ckDescongelacionAutomatica');" );
      ((Element)v.get(119)).setAttribute("ontab","setOnTab('ckDescongelacionAutomatica');" );
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(123)).setAttribute("colspan","2" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(135)).setAttribute("accion","validarBuscarOnClick();" );
      ((Element)v.get(135)).setAttribute("cod","1" );
      ((Element)v.get(135)).setAttribute("estado","false" );
      ((Element)v.get(135)).setAttribute("onshtab","setOnShTab('btnBuscar');" );
      ((Element)v.get(135)).setAttribute("ontab","setOnTab('btnBuscar');" );
      ...
      ((Element)v.get(145)).setAttribute("ancho","690" );
      ((Element)v.get(145)).setAttribute("alto","317" );
      ((Element)v.get(145)).setAttribute("x","12" );
      ((Element)v.get(145)).setAttribute("y","202" );
   ...
   private void getXML630(Document doc) {
      ...
      ((Element)v.get(163)).setAttribute("cod","263" );
      ...
      ((Element)v.get(164)).setAttribute("cod","ComConge.fecDesd.label" );
      ...
      ((Element)v.get(165)).setAttribute("cod","ComConge.fecHast.label" );
      ...
      ((Element)v.get(166)).setAttribute("cod","ComConge.impCong.label" );
      ...
      ((Element)v.get(167)).setAttribute("cod","ComConge.indDescAuto.label" );
   ...
   private void getXML720(Document doc) {
      ...
      /* Empieza nodo:177 / Elemento padre: 145   */
      ...
      ((Element)v.get(177)).setAttribute("y","496" );
      ...
      ((Element)v.get(179)).setAttribute("y","500" );
      ...
      ((Element)v.get(9)).appendChild((Element)v.get(180));
      /* Termina nodo:180   */
   ...
   private void getXML810(Document doc) {
      ((Element)v.get(181)).setAttribute("y","496" );
      ...
      ((Element)v.get(182)).setAttribute("y","497" );
      ...
      ((Element)v.get(182)).setAttribute("accion","modificarOnClick();" );
      ((Element)v.get(182)).setAttribute("onshtab","setOnShTab('btnModificar');" );
      ((Element)v.get(182)).setAttribute("ontab","setOnTab('btnModificar');" );
      ((Element)v.get(9)).appendChild((Element)v.get(182));
      /* Termina nodo:182   */

      /* Empieza nodo:183 / Elemento padre: 9   */
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(183)).setAttribute("nombre","capaEspacio" );
      ((Element)v.get(183)).setAttribute("alto","12" );
      ...
      ((Element)v.get(183)).setAttribute("y","519" );
