...
public class ComTipoClienComisDetalConectorQueryForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad ComTipoClienComisDetal" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGComTipoClienComisDetalQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGComTipoClienComisDetalQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","ComTipoClienComisDetalFormFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","tcccOidTipoClieComiCabe" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(8)).setAttribute("NOMBRE","clasOidClas" );
