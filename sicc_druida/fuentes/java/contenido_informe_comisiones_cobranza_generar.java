...
public class contenido_informe_comisiones_cobranza_generar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_informe_comisiones_cobranza_generar" );
      ((Element)v.get(0)).setAttribute("cod","0825" );
      ((Element)v.get(0)).setAttribute("titulo","Generar informe comisiones por cobranza" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(100)).setAttribute("nombre","lblDetalle" );
   ...
   private void getXML450(Document doc) {
      ((Element)v.get(116)).setAttribute("textoinicial","Gerente de región" );
      ((Element)v.get(116)).setAttribute("id","datosCampos" );
      ((Element)v.get(116)).setAttribute("req","S" );
      ((Element)v.get(116)).setAttribute("onchange","habilitaZona();" );
      ...
      ((Element)v.get(120)).setAttribute("VALOR","Gerente de zona" );
      ...
      ((Element)v.get(123)).setAttribute("VALOR","Líder" );
      ...
      /* Empieza nodo:124 / Elemento padre: 103   */
      v.add(doc.createElement("td"));
      ((Element)v.get(103)).appendChild((Element)v.get(124));
      ...
      ((Element)v.get(127)).setAttribute("nombre","ckDetalle" );
      ...
      /* Empieza nodo:133 / Elemento padre: 38   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(38)).appendChild((Element)v.get(133));
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(140)).setAttribute("nombre","lblSubgerenciaVenta" );
   }

   private void getXML540(Document doc) {
      ((Element)v.get(140)).setAttribute("filas","1" );
      ((Element)v.get(140)).setAttribute("id","datosTitle" );
      ((Element)v.get(140)).setAttribute("cod","124" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(144)).setAttribute("nombre","lblRegion" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(151)).setAttribute("nombre","cbSubgerenciaVentas" );
      ...
      ((Element)v.get(151)).setAttribute("onchange","cambioSubgerencia()" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(156)).setAttribute("nombre","cbRegion" );
      ...
      ((Element)v.get(156)).setAttribute("onchange","cambioRegion();" );
   ...
   private void getXML630(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(174)).setAttribute("nombre","lblSeccion" );
      ...
      ((Element)v.get(181)).setAttribute("onchange","cambioZona();" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(186)).setAttribute("nombre","cbSeccion" );
   ...
   private void getXML720(Document doc) {
      ...
      /* Empieza nodo:193 / Elemento padre: 31   */
      v.add(doc.createElement("td"));
      ((Element)v.get(31)).appendChild((Element)v.get(193));
      ...
      /* Empieza nodo:195 / Elemento padre: 23   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(23)).appendChild((Element)v.get(195));
      ...
      ((Element)v.get(203)).setAttribute("accion","generar('pdf');" );
      ...
      /* Empieza nodo:207 / Elemento padre: 23   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(23)).appendChild((Element)v.get(207));
