...
/*
    INDRA/CAR/mmg
    $Id: CccSubprTransactionComboLoad.java,v 1.1 2009/12/03 18:39:53 pecbazalar Exp $
    DESC
*/
...
public class CccSubprTransactionComboLoad extends MMGDruidaTransaction {
	//Constantes usadas en la clase. Simplemente representan 
	//los nombre de conectore y de logicas de negocio
	public static final String BUSINESSID_QUERY = "MMGCccSubprQueryFromToUserStructuralSecurity";
	public static final String CONECTOR_QUERY_COMBO= "CccSubprConectorCombo";

	// Definicion del constructor
	public CccSubprTransactionComboLoad(){
		super();
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			dto.addProperty("cccSubprFrom", cccSubpr);
			dto.addProperty("cccSubprTo", cccSubpr.clone());
