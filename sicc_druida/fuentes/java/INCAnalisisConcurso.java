...
public class INCAnalisisConcurso extends LPSICCBase {
   
  public INCAnalisisConcurso() {
  ...
  public void ejecucion() throws Exception {		
    ...
    try {
      ...
      if (accion.equals("generar")){
        ...
        cargarPagina();
        getConfiguracionMenu("INCAnalisisConcurso");
      }
     
      } catch (Exception ex) {
     			
      //pagina("contenido_informe_analisis_concurso_recomendacion_generar");
      //getConfiguracionMenu("INCAnalisisConcurso");
  ...
  private void generarReporte() throws Exception{
    ...
    if(!tipoOfertaExcluir.equals("")){
      datos.put(ConstantesREP.TIPOOFERTA,tipoOfertaExcluir);
    }
    
    String numeroConcurso = conectorParametroLimpia("numeroConcurso", "", true);
    datos.put(ConstantesREP.NUMEROCONCURSOS, numeroConcurso);
    
    String monedaAnalisis = conectorParametroLimpia("monedaAnalisis", "", true);
    datos.put(ConstantesREP.MONEDA, monedaAnalisis);
    ...
    String nroRecomendadas = conectorParametroLimpia("nroRecomendadas","",true);
    datos.put(ConstantesREP.NUMERORECOMENDADAS,nroRecomendadas);
    
    
    
    datos.put(ConstantesREP.TITULO, "Analisis de Concurso de Recomendacion");
    ...
    if(region.equals("")){
       reporte = "RD_REP-060_02";    
    }else{
       if(zona.equals("")){
          reporte = "RD_REP-060_01";
       }else{
          reporte = "RD_REP-060";
       }
    }   
