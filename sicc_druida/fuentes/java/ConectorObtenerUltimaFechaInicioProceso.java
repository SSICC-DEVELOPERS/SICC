...
public class ConectorObtenerUltimaFechaInicioProceso  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector Obtener Ultima Fecha Inicio Proceso" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","DTOInterfaz" );
