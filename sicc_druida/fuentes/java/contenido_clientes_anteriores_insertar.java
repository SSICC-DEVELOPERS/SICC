...
public class contenido_clientes_anteriores_insertar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_clientes_anteriores_insertar" );
      ((Element)v.get(0)).setAttribute("cod","01046" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","contenido_clientes_anteriores_insertar.js" );
      ...
      ((Element)v.get(6)).setAttribute("name","cbPaisNuevo" );
      ((Element)v.get(6)).setAttribute("required","true" );
      ((Element)v.get(6)).setAttribute("cod","3064" );
      ((Element)v.get(5)).appendChild((Element)v.get(6));
      /* Termina nodo:6   */

      /* Empieza nodo:7 / Elemento padre: 5   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(7)).setAttribute("name","txtClienteNuevo" );
      ((Element)v.get(7)).setAttribute("format","e" );
      ((Element)v.get(7)).setAttribute("required","true" );
      ((Element)v.get(7)).setAttribute("cod","3066" );
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(8)).setAttribute("name","txtClienteAntiguo" );
      ((Element)v.get(8)).setAttribute("format","e" );
      ((Element)v.get(8)).setAttribute("required","true" );
      ((Element)v.get(8)).setAttribute("cod","3067" );
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(9)).setAttribute("name","txtSistemaProcedencia" );
      ((Element)v.get(9)).setAttribute("format","t" );
      ((Element)v.get(9)).setAttribute("required","true" );
      ((Element)v.get(9)).setAttribute("cod","3068" );
      ...
      ((Element)v.get(10)).setAttribute("nombre","frmClientesAnteriores" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(17)).setAttribute("nombre","habilitaBtnGuardar" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(18)).setAttribute("nombre","habilitaBtnDetalle" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(19)).setAttribute("nombre","habilitaBtnModificar" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(20)).setAttribute("nombre","habilitaBtnEliminar" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(21)).setAttribute("nombre","cerrar" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(22)).setAttribute("nombre","ejecutar" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(23)).setAttribute("nombre","ejecutarError" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(27)).setAttribute("nombre","hLongitudCodCliente" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(28)).setAttribute("nombre","hoidCliente" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(29)).setAttribute("nombre","CLIENTENUEVO" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(30)).setAttribute("nombre","CLIENTEANTI" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(31)).setAttribute("nombre","SISTEMA" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(32)).setAttribute("nombre","PAIS_OID_PAIS" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(33)).setAttribute("nombre","OID_CLIE" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(34)).setAttribute("nombre","OID_CODI_CLIE_ANTE" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(62)).setAttribute("nombre","lblPaisAntiguo" );
      ((Element)v.get(62)).setAttribute("alto","13" );
      ((Element)v.get(62)).setAttribute("filas","1" );
      ((Element)v.get(62)).setAttribute("valor","" );
      ((Element)v.get(62)).setAttribute("cod","3065" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(69)).setAttribute("nombre","cbPaisNuevo" );
      ...
      ((Element)v.get(69)).setAttribute("onshtab","focoEnTxtSistemaProcedencia();" );
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(76)).setAttribute("width","499" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(84)).setAttribute("nombre","lblClienteNuevo" );
      ...
      ((Element)v.get(84)).setAttribute("cod","3066" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(88)).setAttribute("nombre","lblClienteAntiguo" );
      ...
      ((Element)v.get(88)).setAttribute("cod","3067" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(95)).setAttribute("nombre","txtClienteNuevo" );
      ...
      ((Element)v.get(95)).setAttribute("size","22" );
      ((Element)v.get(95)).setAttribute("valor","" );
      ((Element)v.get(95)).setAttribute("validacion","" );
      ((Element)v.get(95)).setAttribute("onchange","onchange_codCliente();" );
      ...
      ((Element)v.get(99)).setAttribute("name","lupa" );
      ((Element)v.get(99)).setAttribute("onmouseover","poneManito('lupa');" );
      ((Element)v.get(99)).setAttribute("onclick","seleccionarClienteContactado();" );
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(103)).setAttribute("nombre","txtClienteAntiguo" );
      ((Element)v.get(103)).setAttribute("id","datosCampos" );
      ((Element)v.get(103)).setAttribute("max","15" );
      ((Element)v.get(103)).setAttribute("tipo","" );
      ((Element)v.get(103)).setAttribute("onchange","onchange_codClienteAnt();" );
      ((Element)v.get(103)).setAttribute("req","S" );
      ((Element)v.get(103)).setAttribute("size","22" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(126)).setAttribute("nombre","txtSistemaProcedencia" );
      ...
      ((Element)v.get(126)).setAttribute("size","50" );
      ((Element)v.get(126)).setAttribute("valor","" );
      ((Element)v.get(126)).setAttribute("validacion","" );
      ((Element)v.get(126)).setAttribute("ontab","focoEnCbPaisNuevo();" );
      ...
      /* Empieza nodo:134 / Elemento padre: 44   */
      v.add(doc.createElement("td"));
      ((Element)v.get(44)).appendChild((Element)v.get(134));
