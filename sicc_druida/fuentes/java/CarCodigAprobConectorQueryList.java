...
public class CarCodigAprobConectorQueryList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad CarCodigAprob" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGCarCodigAprobQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGCarCodigAprobQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","CarCodigAprobListFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","codApro" );
