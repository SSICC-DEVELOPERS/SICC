...
public class contenido_premios_consuelo_enviar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_premios_consuelo_enviar" );
      ((Element)v.get(0)).setAttribute("cod","0503" );
      ((Element)v.get(0)).setAttribute("titulo","contenido_premios_consuelo_enviar" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","Enviar premios de consuelo" );
      ...
      v.add(doc.createTextNode("\r\r    \r    \r    function onLoad(){\r       \r       configurarMenuSecundario(\"formulario\");       \r       var accion = get(\"formulario.accion\");\r       \r       btnProxy(1, 0);\r       btnProxy(2, 1);\r       btnProxy(3, 0);\r       btnProxy(7, 0);\r       btnProxy(8, 0);\r       btnProxy(9, 0);  \r       \r       \r       if (accion ==\"Cliente\"){\r              \r            document.getElementById(\"capa1\").style.visibility='hidden';\r            document.getElementById(\"capa2\").style.visibility='';            \r            document.getElementById(\"capa3\").style.visibility='hidden';\r            focaliza(\"formulario.cbClientes\");    \r       }\r\r       if (accion ==\"Concurso\"){\r            document.getElementById(\"capa1\").style.visibility='';\r            document.getElementById(\"capa2\").style.visibility='hidden';            \r            document.getElementById(\"capa3\").style.visibility='hidden'; \r            focaliza(\"formulario.cbNumConcurso\");\r       }\r       \r       \r       if (accion ==\"Fichero\"){\r            document.getElementById(\"capa1\").style.visibility='hidden';\r            document.getElementById(\"capa2\").style.visibility='hidden';            \r            document.getElementById(\"capa3\").style.visibility=''; \r            fichero1.focaliza();\r       }\r       \r       \r      if (get('formulario.errDescripcion')!='') {\r		    var wnd = fMostrarMensajeError(get('formulario.errCodigo'), get('formulario.errDescripcion'));\r      }\r\r   }\r\r\r    function onChangebtAceptarCliente(){\r        \r        if(sicc_validaciones_generales(\"grupo1\")){\r\r            var ar = new Array();\r            ar = get(\"formulario.cbClientes\");\r           \r            var datos = new Array();\r            \r            for(i=0;i<ar.length;i++){\r             	var newRow = new Array();\r				newRow = ar[i].split(\",\");\r				datos =  datos + newRow + \"|\"; 			\r            }             \r            set(\"formulario.clientesSeleccionados\", datos);\r            returnValue = datos;        \r            close();        \r        \r        }   \r    \r    }    \r    \r    \r    function onChangebtAceptarNroConcurso(){\r        if(sicc_validaciones_generales(\"grupo2\")){\r            var ar = new Array();\r            ar = get(\"formulario.cbNumConcurso\");\r            set(\"formulario.nroConcursoSeleccionados\", ar);\r            returnValue = ar;        \r            close();\r            \r        }\r    \r    }    \r      \r   \r   \r    function processFile(file) {\r        set(\"formulario.clientesFicheroSeleccionados\",file);\r        set(\"formulario.conectorAction\",\"LPAsignarPremiosConsuelo\");\r		set(\"formulario.accion\",\"procesarFichero\");	\r        enviaSICC('formulario', null, null, 'N');\r    }\r    \r    function fLimpiar(){\r    \r        var accion = get(\"formulario.accion\");\r    \r    \r        if (accion ==\"Cliente\"){\r            set(\"formulario.cbClientes\", \"\");\r            focaliza(\"formulario.cbClientes\");   \r        }\r        \r        if (accion ==\"Concurso\"){\r            set(\"formulario.cbNumConcurso\", \"\");\r            focaliza(\"formulario.cbNumConcurso\");   \r        }\r        \r        if (accion ==\"Fichero\"){\r            fichero1.reset();\r        }\r    \r    }    \r    \r    function tomaValores(dato){\r        btnProxy(1, 0);\r        btnProxy(2, 1);\r        btnProxy(7, 0);\r        btnProxy(8, 0);\r        btnProxy(9, 0);  \r        document.getElementById(\"capa1\").style.visibility='hidden';\r        document.getElementById(\"capa2\").style.visibility='hidden';  \r        set(\"formulario.clientesFicheroSeleccionados\", dato);\r    \r    \r    }\r    \r    \r    function onChangebtAceptarFichero(){\r        var fichero = get(\"formulario.clientesFicheroSeleccionados\");\r               \r        if (fichero !=\"\"){\r            var datos = new Array();\r            datos = fichero;\r            set(\"formulario.clientesFicheroSeleccionados\", datos);\r            returnValue = fichero;        \r            close();\r        \r        }\r        else{\r         GestionarMensaje('3334', null, null, null);\r        \r        }       \r    \r    }\r    \r    \r     \r   function fVolver(){\r       close();\r   }\r\r\r\r\r\r\r"));
      ...
      ((Element)v.get(9)).setAttribute("name","cbClientes" );
      ((Element)v.get(9)).setAttribute("required","true" );
      ((Element)v.get(9)).setAttribute("cod","0026" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(16)).setAttribute("nombre","clientesSeleccionados" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(17)).setAttribute("nombre","nroConcursoSeleccionados" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(18)).setAttribute("nombre","clientesFicheroSeleccionados" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(35)).setAttribute("nombre","lblDestinatariosPremio1" );
      ((Element)v.get(35)).setAttribute("alto","13" );
      ((Element)v.get(35)).setAttribute("filas","1" );
      ((Element)v.get(35)).setAttribute("valor","" );
      ((Element)v.get(35)).setAttribute("cod","00306" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(44)).setAttribute("nombre","lblNumConcurso" );
      ...
      ((Element)v.get(44)).setAttribute("cod","1604" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(51)).setAttribute("nombre","cbNumConcurso" );
      ((Element)v.get(51)).setAttribute("id","datosCampos" );
      ((Element)v.get(51)).setAttribute("size","5" );
      ...
      ((Element)v.get(51)).setAttribute("onshtab","focalizaBotonHTML('botonContenido','btnAceptar1');" );
      ...
      /* Empieza nodo:60 / Elemento padre: 21   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(21)).appendChild((Element)v.get(60));
      ...
      ((Element)v.get(68)).setAttribute("nombre","btnAceptar1" );
      ((Element)v.get(68)).setAttribute("ID","botonContenido" );
      ((Element)v.get(68)).setAttribute("tipo","html" );
      ((Element)v.get(68)).setAttribute("accion","onChangebtAceptarNroConcurso();" );
      ((Element)v.get(68)).setAttribute("estado","false" );
      ((Element)v.get(68)).setAttribute("cod","12" );
      ((Element)v.get(68)).setAttribute("ontab","focaliza('formulario.cbNumConcurso');" );
      ((Element)v.get(68)).setAttribute("onshtab","focaliza('formulario.cbNumConcurso');" );
   ...
   private void getXML270(Document doc) {
      ...
      /* Empieza nodo:78 / Elemento padre: 11   */
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(78)).setAttribute("nombre","capa2" );
      ((Element)v.get(78)).setAttribute("visibilidad","" );
      ((Element)v.get(11)).appendChild((Element)v.get(78));
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(93)).setAttribute("nombre","lblDestinatariosPremio2" );
      ((Element)v.get(93)).setAttribute("alto","13" );
      ((Element)v.get(93)).setAttribute("filas","1" );
      ((Element)v.get(93)).setAttribute("valor","" );
      ((Element)v.get(93)).setAttribute("cod","00306" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(102)).setAttribute("nombre","lblClientes" );
      ...
      ((Element)v.get(102)).setAttribute("cod","0026" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(109)).setAttribute("nombre","cbClientes" );
      ...
      ((Element)v.get(109)).setAttribute("onshtab","focalizaBotonHTML('botonContenido','btnAceptar2');" );
      ...
      /* Empieza nodo:118 / Elemento padre: 79   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(79)).appendChild((Element)v.get(118));
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(126)).setAttribute("nombre","btnAceptar2" );
      ((Element)v.get(126)).setAttribute("ID","botonContenido" );
      ((Element)v.get(126)).setAttribute("tipo","html" );
      ((Element)v.get(126)).setAttribute("accion","onChangebtAceptarCliente();" );
      ((Element)v.get(126)).setAttribute("estado","false" );
      ((Element)v.get(126)).setAttribute("cod","12" );
      ((Element)v.get(126)).setAttribute("ontab","focaliza('formulario.cbClientes');" );
      ...
      /* Empieza nodo:129 / Elemento padre: 79   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(79)).appendChild((Element)v.get(129));
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(136)).setAttribute("nombre","capa3" );
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(154)).setAttribute("colspan","3" );
      ...
      ((Element)v.get(160)).setAttribute("nombre","fichero1" );
      ((Element)v.get(160)).setAttribute("campo","f1.ruta" );
      ((Element)v.get(160)).setAttribute("comprimir","NO" );
      ((Element)v.get(160)).setAttribute("descomprimir","NO" );
      ((Element)v.get(160)).setAttribute("id","datosCampos" );
      ((Element)v.get(160)).setAttribute("idenviar","datosCampos" );
      ((Element)v.get(160)).setAttribute("max","100" );
      ((Element)v.get(160)).setAttribute("ON","LPObjetoFicheroUpload" );
      ((Element)v.get(160)).setAttribute("funcion","processFile(file)" );
      ((Element)v.get(160)).setAttribute("readonly","N" );
      ((Element)v.get(160)).setAttribute("cod","3055" );
      ((Element)v.get(160)).setAttribute("size","100" );
      ((Element)v.get(160)).setAttribute("ontab","fichero1.focaliza()" );
      ((Element)v.get(160)).setAttribute("onshtab","fichero1.focalizaFinal()" );
   ...
   private void getXML630(Document doc) {
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(173)).setAttribute("nombre","btnAceptar3" );
      ((Element)v.get(173)).setAttribute("ID","botonContenido" );
      ((Element)v.get(173)).setAttribute("tipo","html" );
      ((Element)v.get(173)).setAttribute("accion","onChangebtAceptarFichero();" );
      ((Element)v.get(173)).setAttribute("estado","false" );
      ((Element)v.get(173)).setAttribute("cod","12" );
      ((Element)v.get(173)).setAttribute("ontab","fichero1.focaliza()" );
