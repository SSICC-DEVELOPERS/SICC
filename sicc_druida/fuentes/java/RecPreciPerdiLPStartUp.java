/*
    INDRA/CAR/mmg
    $Id: RecPreciPerdiLPStartUp.java,v 1.1 2009/12/03 18:33:57 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class RecPreciPerdiLPStartUp extends MMGDruidaBase{
	...
	public static final String BUSINESSID_QUERY = "MMGRecPreciPerdiQueryFromToUserPage";
	...
	public RecPreciPerdiLPStartUp(){
		super();
	}

	public void inicio() throws Exception {
		pagina("RecPreciPerdiPage");
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "RecPreciPerdiPage", "cod", "RecPreciPerdi." + accion + ".label");
			...
			limpiarBotoneraLista("recPreciPerdi", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codPrecPerd", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 1);");
		
		//Primero determianmos el nombre del campo en la entidad de oriegen donde se van a cargar los datos
		asignar("VAR", "idAttributeLovOpener", conectorParametro(PARAMETRO_LOV_ATTRIBUTO));
		asignar("VAR", "idEntityLovOpener", conectorParametro(PARAMETRO_LOV_ENTIDAD));
		//asignarAtributo("CAPA", "recPreciPerdiLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "RecPreciPerdiPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		RecPreciPerdiData recPreciPerdiQuery= new RecPreciPerdiData();
		recPreciPerdiQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		RecPreciPerdiData datosResult = (RecPreciPerdiData)getSingleObject(BUSINESSID_QUERY, recPreciPerdiQuery, 
			recPreciPerdiQuery.clone(), "recPreciPerdi");
		...
		RecPreciPerdiData recPreciPerdi = datosResult;
		asignar("TEXT", "codPrecPerd", FormatUtils.formatObject(recPreciPerdi.getCodPrecPerd(), 
		...
		asignarAtributo("TEXT", "codPrecPerd", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		...
		asignarAtributo("TEXT", "codPrecPerd", "req", "S");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "recPreciPerdiFrm", "oculto", "N");
		...
		traza("MMG::Creando RecPreciPerdi");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		RecPreciPerdiData recPreciPerdiQuery= new RecPreciPerdiData();
		recPreciPerdiQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(recPreciPerdi.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"recPreciPerdiFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"recPreciPerdiFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codPrecPerd", "ontab","ejecutarAccionFocoModificacion(\"recPreciPerdiFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codPrecPerd", "onshtab","ejecutarAccionFocoModificacion(\"recPreciPerdiFrm\",2, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","recPreciPerdiTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","recPreciPerdiTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codPrecPerd...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","recPreciPerdiFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","recPreciPerdiListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","recPreciPerdiListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(RecPreciPerdiData recPreciPerdi) throws Exception{
	...
	* @param recPreciPerdi La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(RecPreciPerdiData recPreciPerdi) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		RecPreciPerdiData recPreciPerdi = 
			(RecPreciPerdiData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(recPreciPerdi);
		loadLeafDependenceCombos(recPreciPerdi);
	}
