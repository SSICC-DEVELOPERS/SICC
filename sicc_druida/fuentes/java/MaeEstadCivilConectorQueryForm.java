...
public class MaeEstadCivilConectorQueryForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad MaeEstadCivil" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGMaeEstadCivilQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGMaeEstadCivilQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","MaeEstadCivilFormFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","codEstaCivi" );
