...
public class EduPlantCursoEstatPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","eduPlantCursoEstatList" );
      ...
      ((Element)v.get(12)).setAttribute("cod","EduPlantCursoEstat.mcurOidCurs.label" );
      ...
      ((Element)v.get(13)).setAttribute("cod","EduPlantCursoEstat.dpcuOidDetaPlanCurs.label" );
