...
public class PedSubtiPosicViewPage  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","PedSubtiPosicViewPage" );
      ((Element)v.get(0)).setAttribute("titulo","" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","" );
      ((Element)v.get(0)).setAttribute("onload","pedSubtiPosicViewInitComponents()" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","pedsubtiposicview.js" );
      ((Element)v.get(0)).appendChild((Element)v.get(4));
      /* Termina nodo:4   */

      /* Empieza nodo:5 / Elemento padre: 0   */
      v.add(doc.createElement("FORMULARIO"));
      ((Element)v.get(5)).setAttribute("nombre","pedSubtiPosicViewFrm" );
      ...
      ((Element)v.get(6)).setAttribute("valor","PedSubtiPosicViewLPExecution" );
      ...
      ((Element)v.get(7)).setAttribute("valor","PedSubtiPosicViewLPExecution" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(37)).setAttribute("nombre","pedSubtiPosicViewFormLayer" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(52)).setAttribute("cod","PedSubtiPosicView.legend.label" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(67)).setAttribute("cod","PedSubtiPosicView.id.label" );
      ...
      ((Element)v.get(70)).setAttribute("ontab","ejecutarAccionFoco('pedSubtiPosicViewFrm',1, true)" );
      ((Element)v.get(70)).setAttribute("onshtab","ejecutarAccionFoco('pedSubtiPosicViewFrm', 1, false)" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(88)).setAttribute("nombre","codSubtPosiTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(92)).setAttribute("nombre","lblCodSubtPosi" );
      ((Element)v.get(92)).setAttribute("alto","13" );
      ((Element)v.get(92)).setAttribute("filas","1" );
      ((Element)v.get(92)).setAttribute("id","datosTitle" );
      ((Element)v.get(92)).setAttribute("cod","PedSubtiPosicView.codSubtPosi.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(93)).setAttribute("nombre","codSubtPosiWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(95)).setAttribute("nombre","codSubtPosi" );
      ...
      ((Element)v.get(95)).setAttribute("ontab","ejecutarAccionFoco('pedSubtiPosicViewFrm',2, true)" );
      ((Element)v.get(95)).setAttribute("onshtab","ejecutarAccionFoco('pedSubtiPosicViewFrm', 2, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(96)).setAttribute("nombre","codSubtPosiGapTdId" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(98)).setAttribute("nombre","tposOidTipoPosiTdId" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(102)).setAttribute("nombre","lbltposOidTipoPosi" );
      ...
      ((Element)v.get(102)).setAttribute("cod","PedSubtiPosicView.tposOidTipoPosi.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(103)).setAttribute("nombre","tposOidTipoPosiWidgetTrId" );
      ...
      ((Element)v.get(105)).setAttribute("nombre","tposOidTipoPosi" );
      ...
      ((Element)v.get(105)).setAttribute("ontab","ejecutarAccionFoco('pedSubtiPosicViewFrm',3, true);" );
      ((Element)v.get(105)).setAttribute("onshtab","ejecutarAccionFoco('pedSubtiPosicViewFrm',3, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(107)).setAttribute("nombre","tposOidTipoPosiGapTdId" );
      ...
      ((Element)v.get(113)).setAttribute("cod","PedSubtiPosicView.Descripcion.label" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(117)).setAttribute("ontab","ejecutarAccionFoco('pedSubtiPosicViewFrm',4, true)" );
      ((Element)v.get(117)).setAttribute("onshtab","ejecutarAccionFoco('pedSubtiPosicViewFrm', 4, false)" );
      ...
      ((Element)v.get(121)).setAttribute("href","javascript:openLocalizationDialog('pedSubtiPosicViewFrm', 'Descripcion', 1);" );
      ((Element)v.get(121)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"pedSubtiPosicViewFrm\",4, true)', 'ejecutarAccionFoco(\"pedSubtiPosicViewFrm\",4, false)')" );
   ...
   private void getXML630(Document doc) {
      ((Element)v.get(137)).setAttribute("nombre","pedSubtiPosicViewTrButtons" );
      ...
      ((Element)v.get(144)).setAttribute("nombre","pedSubtiPosicViewTdQueryButton" );
      ((Element)v.get(143)).appendChild((Element)v.get(144));

      /* Empieza nodo:145 / Elemento padre: 144   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(145)).setAttribute("nombre","pedSubtiPosicViewQueryButton" );
      ((Element)v.get(145)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(145)).setAttribute("estado","false" );
      ((Element)v.get(145)).setAttribute("accion","pedSubtiPosicViewFirstPage();" );
      ...
      ((Element)v.get(146)).setAttribute("nombre","pedSubtiPosicViewTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(148)).setAttribute("nombre","pedSubtiPosicViewLovNullButton" );
      ((Element)v.get(148)).setAttribute("ID","botonContenido" );
      ((Element)v.get(148)).setAttribute("tipo","html" );
      ((Element)v.get(148)).setAttribute("accion","pedSubtiPosicViewLovNullSelectionAction();" );
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(151)).setAttribute("nombre","pedSubtiPosicViewListLayer" );
      ...
      ((Element)v.get(152)).setAttribute("nombre","pedSubtiPosicViewList" );
   ...
   private void getXML720(Document doc) {
      ...
      ((Element)v.get(166)).setAttribute("cod","PedSubtiPosicView.codSubtPosi.label" );
      ...
      ((Element)v.get(167)).setAttribute("cod","PedSubtiPosicView.tposOidTipoPosi.label" );
      ...
      ((Element)v.get(168)).setAttribute("cod","PedSubtiPosicView.Descripcion.label" );
   ...
   private void getXML810(Document doc) {
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(174)).setAttribute("nombre","pedSubtiPosicViewListButtonsLayer" );
      ...
      ((Element)v.get(180)).setAttribute("nombre","pedSubtiPosicViewPaginationButtonBar" );
      ...
      ((Element)v.get(181)).setAttribute("nombre","pedSubtiPosicViewFirstPageButton" );
      ((Element)v.get(181)).setAttribute("funcion","pedSubtiPosicViewFirstPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(182)).setAttribute("nombre","pedSubtiPosicViewFirstPageButtonGapTd" );
   ...
   private void getXML900(Document doc) {
      v.add(doc.createElement("BTN"));
      ((Element)v.get(184)).setAttribute("nombre","pedSubtiPosicViewPreviousPageButton" );
      ((Element)v.get(184)).setAttribute("funcion","pedSubtiPosicViewPreviousPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(185)).setAttribute("nombre","pedSubtiPosicViewPreviousPageButtonGapTd" );
      ...
      v.add(doc.createElement("BTN"));
      ((Element)v.get(187)).setAttribute("nombre","pedSubtiPosicViewNextPageButton" );
      ((Element)v.get(187)).setAttribute("funcion","pedSubtiPosicViewNextPage();" );
      ...
      ((Element)v.get(190)).setAttribute("nombre","pedSubtiPosicViewUpdateButtonTd" );
      ((Element)v.get(176)).appendChild((Element)v.get(190));

      /* Empieza nodo:191 / Elemento padre: 190   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(191)).setAttribute("nombre","pedSubtiPosicViewUpdateButton" );
      ((Element)v.get(191)).setAttribute("ID","botonContenido" );
      ((Element)v.get(191)).setAttribute("tipo","html" );
      ((Element)v.get(191)).setAttribute("accion","pedSubtiPosicViewUpdateSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(192)).setAttribute("nombre","pedSubtiPosicViewUpdateButtonGapTd" );
      ...
      ((Element)v.get(194)).setAttribute("nombre","pedSubtiPosicViewViewForRemoveButtonTd" );
      ((Element)v.get(176)).appendChild((Element)v.get(194));

      /* Empieza nodo:195 / Elemento padre: 194   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(195)).setAttribute("nombre","pedSubtiPosicViewViewForRemoveButton" );
      ((Element)v.get(195)).setAttribute("ID","botonContenido" );
      ((Element)v.get(195)).setAttribute("tipo","html" );
      ((Element)v.get(195)).setAttribute("accion","pedSubtiPosicViewViewSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(196)).setAttribute("nombre","pedSubtiPosicViewViewForRemoveButtonGapTd" );
      ...
      ((Element)v.get(198)).setAttribute("nombre","pedSubtiPosicViewLovSelectButtonTd" );
      ((Element)v.get(176)).appendChild((Element)v.get(198));

      /* Empieza nodo:199 / Elemento padre: 198   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(199)).setAttribute("nombre","pedSubtiPosicViewLovSelectButton" );
      ((Element)v.get(199)).setAttribute("ID","botonContenido" );
      ((Element)v.get(199)).setAttribute("tipo","html" );
      ((Element)v.get(199)).setAttribute("accion","pedSubtiPosicViewLovSelectionAction();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(200)).setAttribute("nombre","pedSubtiPosicViewLovSelectButtonGapTd" );
   ...
   private void getXML990(Document doc) {
      ...
      ((Element)v.get(202)).setAttribute("nombre","pedSubtiPosicViewViewButtonTd" );
      ((Element)v.get(176)).appendChild((Element)v.get(202));

      /* Empieza nodo:203 / Elemento padre: 202   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(203)).setAttribute("nombre","pedSubtiPosicViewViewButton" );
      ((Element)v.get(203)).setAttribute("ID","botonContenido" );
      ((Element)v.get(203)).setAttribute("tipo","html" );
      ((Element)v.get(203)).setAttribute("accion","pedSubtiPosicViewViewSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(204)).setAttribute("nombre","pedSubtiPosicViewViewButtonGapTd" );
