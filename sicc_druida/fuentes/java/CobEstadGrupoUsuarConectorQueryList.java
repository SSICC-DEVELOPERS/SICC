...
public class CobEstadGrupoUsuarConectorQueryList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad CobEstadGrupoUsuar" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGCobEstadGrupoUsuarQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGCobEstadGrupoUsuarQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","CobEstadGrupoUsuarListFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","codEstaGrupUsua" );
