...
public class MaeUnidaNegocConectorQueryForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad MaeUnidaNegoc" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGMaeUnidaNegocQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGMaeUnidaNegocQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","MaeUnidaNegocFormFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(8)).setAttribute("NOMBRE","codUnidNego" );
