...
public class CARObtenerJerarquiaUsuario  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","CARObtenerJerarquiaUsuario" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","DTOUsuarioJerarquia" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","CARObtenerJerarquiaUsuario" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(5)).setAttribute("NOMBRE","DTOUsuarioJerarquia" );
