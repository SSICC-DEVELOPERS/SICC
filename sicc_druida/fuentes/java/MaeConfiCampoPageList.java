...
public class MaeConfiCampoPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","maeConfiCampoList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(17)).setAttribute("cod","MaeConfiCampo.paisOidPais.label" );
      ...
      ((Element)v.get(18)).setAttribute("cod","MaeConfiCampo.sbtiOidSubtClie.label" );
      ...
      ((Element)v.get(19)).setAttribute("cod","MaeConfiCampo.atreOidAtriEspe.label" );
      ...
      ((Element)v.get(20)).setAttribute("cod","MaeConfiCampo.valDefe.label" );
      ...
      ((Element)v.get(21)).setAttribute("cod","MaeConfiCampo.indObli.label" );
      ...
      ((Element)v.get(22)).setAttribute("cod","MaeConfiCampo.indModi.label" );
