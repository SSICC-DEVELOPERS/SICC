...
public class MaeTipoProblTipoSolucLPStartUp extends MMGDruidaBase{
	...
	public static final String BUSINESSID_QUERY = "MMGMaeTipoProblTipoSolucQueryFromToUserPage";
				...
				public static final String BUSINESSID_TIPBOIDTIPOPROB_QUERY ="MMGMaeTipoProblQueryFromToUser";
				public static final String TIPBOIDTIPOPROB_COMBO_CONNECTOR = "MaeTipoProblConectorCombo";
	
				public static final String BUSINESSID_TSOCOIDTIPOSOLU_QUERY ="MMGMaeTipoSolucQueryFromToUser";
				public static final String TSOCOIDTIPOSOLU_COMBO_CONNECTOR = "MaeTipoSolucConectorCombo";
	...
	public MaeTipoProblTipoSolucLPStartUp(){
		super();
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			buildJsPageSize("MaeTipoProblTipoSoluc");
			...
			asignarAtributo("PAGINA", "MaeTipoProblTipoSolucPage", "cod", "MaeTipoProblTipoSoluc." + accion + ".label");
			...
			limpiarBotoneraLista("maeTipoProblTipoSoluc", accion);
	...
	protected void cmdLov() throws Exception{
		...
		//asignarAtributo("CAPA", "maeTipoProblTipoSolucLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "MaeTipoProblTipoSolucPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		MaeTipoProblTipoSolucData maeTipoProblTipoSolucQuery= new MaeTipoProblTipoSolucData();
		maeTipoProblTipoSolucQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		MaeTipoProblTipoSolucData datosResult = (MaeTipoProblTipoSolucData)getSingleObject(BUSINESSID_QUERY, maeTipoProblTipoSolucQuery, 
			maeTipoProblTipoSolucQuery.clone(), "maeTipoProblTipoSoluc");
		...
		MaeTipoProblTipoSolucData maeTipoProblTipoSoluc = datosResult;
		es.indra.belcorp.mso.MaeTipoProblData tipbOidTipoProb = maeTipoProblTipoSoluc.getTipbOidTipoProb();
		if(tipbOidTipoProb != null && tipbOidTipoProb.getId() != null) checkCombo("tipbOidTipoProb" , tipbOidTipoProb.getId().toString());
		es.indra.belcorp.mso.MaeTipoSolucData tsocOidTipoSolu = maeTipoProblTipoSoluc.getTsocOidTipoSolu();
		if(tsocOidTipoSolu != null && tsocOidTipoSolu.getId() != null) checkCombo("tsocOidTipoSolu" , tsocOidTipoSolu.getId().toString());
		...
		//Deshabilitamos todos los campos para que no se editen
					...
					asignarAtributo("COMBO", "tipbOidTipoProb", "disabled", "S");
					asignarAtributo("COMBO", "tsocOidTipoSolu", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		...
		asignarAtributo("COMBO", "tipbOidTipoProb", "req", "S");
		asignarAtributo("COMBO", "tsocOidTipoSolu", "req", "S");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "maeTipoProblTipoSolucFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		MaeTipoProblTipoSolucData maeTipoProblTipoSolucQuery= new MaeTipoProblTipoSolucData();
		maeTipoProblTipoSolucQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(maeTipoProblTipoSoluc.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"maeTipoProblTipoSolucFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"maeTipoProblTipoSolucFrm\",1, false)");
					asignarAtributo("COMBO","tipbOidTipoProb", "ontab", "ejecutarAccionFocoModificacion(\"maeTipoProblTipoSolucFrm\",2, true)");
					asignarAtributo("COMBO","tipbOidTipoProb", "onshtab", "ejecutarAccionFocoModificacion(\"maeTipoProblTipoSolucFrm\",2, false)");
					asignarAtributo("COMBO","tsocOidTipoSolu", "ontab", "ejecutarAccionFocoModificacion(\"maeTipoProblTipoSolucFrm\",3, true)");
					asignarAtributo("COMBO","tsocOidTipoSolu", "onshtab", "ejecutarAccionFocoModificacion(\"maeTipoProblTipoSolucFrm\",3, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","maeTipoProblTipoSolucTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","maeTipoProblTipoSolucTrButtons");
	...
	*/
	protected void removeNonModifyFields() throws Exception{
		borrarCampo("id");
		borrarCampo("tipbOidTipoProb");
		borrarCampo("tsocOidTipoSolu");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es tipbOidTipoProb...");		
				
				traza("MMG: el atributo es tsocOidTipoSolu...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","maeTipoProblTipoSolucFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","maeTipoProblTipoSolucListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","maeTipoProblTipoSolucListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(MaeTipoProblTipoSolucData maeTipoProblTipoSoluc) throws Exception{
		HashMap checkedCombos = new HashMap();
		MaeTipoProblData tipbOidTipoProb = new MaeTipoProblData();
		
						asignarComboResultados(BUSINESSID_TIPBOIDTIPOPROB_QUERY,TIPBOIDTIPOPROB_COMBO_CONNECTOR, 
			tipbOidTipoProb, tipbOidTipoProb.clone(), "maeTipoProbl", "tipbOidTipoProb", "result_ROWSET" );
		if(maeTipoProblTipoSoluc != null && maeTipoProblTipoSoluc.getTipbOidTipoProb() != null){
				checkCombo("tipbOidTipoProb" , maeTipoProblTipoSoluc.getTipbOidTipoProb().getId().toString());
			}
		MaeTipoSolucData tsocOidTipoSolu = new MaeTipoSolucData();
		
						asignarComboResultados(BUSINESSID_TSOCOIDTIPOSOLU_QUERY,TSOCOIDTIPOSOLU_COMBO_CONNECTOR, 
			tsocOidTipoSolu, tsocOidTipoSolu.clone(), "maeTipoSoluc", "tsocOidTipoSolu", "result_ROWSET" );
		if(maeTipoProblTipoSoluc != null && maeTipoProblTipoSoluc.getTsocOidTipoSolu() != null){
				checkCombo("tsocOidTipoSolu" , maeTipoProblTipoSoluc.getTsocOidTipoSolu().getId().toString());
			}
	...
	* @param maeTipoProblTipoSoluc La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(MaeTipoProblTipoSolucData maeTipoProblTipoSoluc) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		MaeTipoProblTipoSolucData maeTipoProblTipoSoluc = 
			(MaeTipoProblTipoSolucData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(maeTipoProblTipoSoluc.getTipbOidTipoProb() != null){
			maeTipoProblTipoSoluc.setTipbOidTipoProb((es.indra.belcorp.mso.MaeTipoProblData)
			getSingleObject(BUSINESSID_TIPBOIDTIPOPROB_QUERY, 
			maeTipoProblTipoSoluc.getTipbOidTipoProb(),
			maeTipoProblTipoSoluc.getTipbOidTipoProb().clone(),
			"maeTipoProbl"));
		}
		if(maeTipoProblTipoSoluc.getTsocOidTipoSolu() != null){
			maeTipoProblTipoSoluc.setTsocOidTipoSolu((es.indra.belcorp.mso.MaeTipoSolucData)
			getSingleObject(BUSINESSID_TSOCOIDTIPOSOLU_QUERY, 
			maeTipoProblTipoSoluc.getTsocOidTipoSolu(),
			maeTipoProblTipoSoluc.getTsocOidTipoSolu().clone(),
			"maeTipoSoluc"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(maeTipoProblTipoSoluc);
		loadLeafDependenceCombos(maeTipoProblTipoSoluc);
	}
