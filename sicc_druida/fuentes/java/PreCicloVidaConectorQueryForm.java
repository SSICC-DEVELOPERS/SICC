...
public class PreCicloVidaConectorQueryForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad PreCicloVida" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGPreCicloVidaQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGPreCicloVidaQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","PreCicloVidaFormFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","codCiclVida" );
