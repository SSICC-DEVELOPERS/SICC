...
public class PreConfiGpPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","preConfiGpList" );
      ...
      ((Element)v.get(14)).setAttribute("cod","PreConfiGp.marcOidMarc.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","PreConfiGp.canaOidCana.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","PreConfiGp.valIncr.label" );
