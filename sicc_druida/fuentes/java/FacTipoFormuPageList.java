...
public class FacTipoFormuPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","facTipoFormuList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","FacTipoFormu.codTipoForm.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","FacTipoFormu.valDesc.label" );
