...
public class GenDetaSiccPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","GenDetaSicc.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","GenDetaSicc.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('genDetaSiccFrm',0, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('genDetaSiccFrm', 0, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(54)).setAttribute("cod","GenDetaSicc.enti.label" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('genDetaSiccFrm',0, true)" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('genDetaSiccFrm', 0, false)" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(79)).setAttribute("cod","GenDetaSicc.entiPk.label" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(82)).setAttribute("ontab","ejecutarAccionFoco('genDetaSiccFrm',0, true)" );
      ((Element)v.get(82)).setAttribute("onshtab","ejecutarAccionFoco('genDetaSiccFrm', 0, false)" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(104)).setAttribute("cod","GenDetaSicc.atri.label" );
      ...
      ((Element)v.get(107)).setAttribute("ontab","ejecutarAccionFoco('genDetaSiccFrm',0, true)" );
      ((Element)v.get(107)).setAttribute("onshtab","ejecutarAccionFoco('genDetaSiccFrm', 0, false)" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(129)).setAttribute("cod","GenDetaSicc.deta.label" );
      ...
      ((Element)v.get(132)).setAttribute("ontab","ejecutarAccionFoco('genDetaSiccFrm',0, true)" );
      ((Element)v.get(132)).setAttribute("onshtab","ejecutarAccionFoco('genDetaSiccFrm', 0, false)" );
   ...
   private void getXML630(Document doc) {
      ...
      ((Element)v.get(154)).setAttribute("cod","GenDetaSicc.idioOidIdio.label" );
      ...
      ((Element)v.get(157)).setAttribute("ontab","ejecutarAccionFoco('genDetaSiccFrm',0, true);" );
      ((Element)v.get(157)).setAttribute("onshtab","ejecutarAccionFoco('genDetaSiccFrm',0, false);" );
   }
   ...
   private void getXML720(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(173)).setAttribute("nombre","genDetaSiccTrButtons" );
      ...
      ((Element)v.get(180)).setAttribute("nombre","genDetaSiccTdQueryButton" );
      ((Element)v.get(179)).appendChild((Element)v.get(180));

      /* Empieza nodo:181 / Elemento padre: 180   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(181)).setAttribute("nombre","genDetaSiccQueryButton" );
   }

   private void getXML810(Document doc) {
      ((Element)v.get(181)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(181)).setAttribute("estado","false" );
      ((Element)v.get(181)).setAttribute("accion","genDetaSiccFirstPage();" );
      ...
      ((Element)v.get(182)).setAttribute("nombre","genDetaSiccTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(184)).setAttribute("nombre","genDetaSiccLovNullButton" );
      ((Element)v.get(184)).setAttribute("ID","botonContenido" );
      ((Element)v.get(184)).setAttribute("tipo","html" );
      ((Element)v.get(184)).setAttribute("accion","genDetaSiccLovNullSelectionAction();" );
