...
public class CobGuionArgumCabecPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","cobGuionArgumCabecList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","CobGuionArgumCabec.codGuiaArgu.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","CobGuionArgumCabec.Descripcion.label" );
