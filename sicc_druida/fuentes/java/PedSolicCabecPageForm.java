...
public class PedSolicCabecPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","PedSolicCabec.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","PedSolicCabec.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('pedSolicCabecFrm',0, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('pedSolicCabecFrm', 0, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(50)).setAttribute("nombre","pedSolicCabecTrButtons" );
      ...
      ((Element)v.get(57)).setAttribute("nombre","pedSolicCabecTdQueryButton" );
      ((Element)v.get(56)).appendChild((Element)v.get(57));

      /* Empieza nodo:58 / Elemento padre: 57   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(58)).setAttribute("nombre","pedSolicCabecQueryButton" );
      ((Element)v.get(58)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(58)).setAttribute("estado","false" );
      ((Element)v.get(58)).setAttribute("accion","pedSolicCabecFirstPage();" );
      ...
      ((Element)v.get(59)).setAttribute("nombre","pedSolicCabecTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(61)).setAttribute("nombre","pedSolicCabecLovNullButton" );
   }

   private void getXML270(Document doc) {
      ((Element)v.get(61)).setAttribute("ID","botonContenido" );
      ((Element)v.get(61)).setAttribute("tipo","html" );
      ((Element)v.get(61)).setAttribute("accion","pedSolicCabecLovNullSelectionAction();" );
