/*
    INDRA/CAR/mmg
    $Id: CccCuentContaLPStartUp.java,v 1.1 2009/12/03 18:40:42 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class CccCuentContaLPStartUp extends MMGDruidaBase{
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "CccCuentContaPage", "cod", "CccCuentConta." + accion + ".label");
			...
			limpiarBotoneraLista("cccCuentConta", accion);
	...
	protected void cmdLov() throws Exception{
		...
		//asignarAtributo("CAPA", "cccCuentContaLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "CccCuentContaPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		CccCuentContaData cccCuentContaQuery= new CccCuentContaData();
		cccCuentContaQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		CccCuentContaData datosResult = (CccCuentContaData)getSingleObject(BUSINESSID_QUERY, cccCuentContaQuery, 
			cccCuentContaQuery.clone(), "cccCuentConta");
		...
		preservaHiddensI18n(new Integer(1), "CCC_CUENT_CONTA", "cccCuentContaFrm", "Descripcion", true);
		...
		CccCuentContaData cccCuentConta = datosResult;
		asignar("TEXT", "codCuenCont", FormatUtils.formatObject(cccCuentConta.getCodCuenCont(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "Descripcion", FormatUtils.formatObject(cccCuentConta.getDescripcion(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "codCuenSap", FormatUtils.formatObject(cccCuentConta.getCodCuenSap(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("AREATEXTO", "valObse", FormatUtils.formatObject(cccCuentConta.getValObse(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		loadLocalizationVars(cccCuentConta);
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "CCC_CUENT_CONTA", "cccCuentContaFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('cccCuentContaFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "cccCuentContaFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		CccCuentContaData cccCuentContaQuery= new CccCuentContaData();
		cccCuentContaQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(cccCuentConta.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"cccCuentContaFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"cccCuentContaFrm\",1, false)");
					asignarAtributo("COMBO","paisOidPais", "ontab", "ejecutarAccionFocoModificacion(\"cccCuentContaFrm\",2, true)");
					asignarAtributo("COMBO","paisOidPais", "onshtab", "ejecutarAccionFocoModificacion(\"cccCuentContaFrm\",2, false)");
				asignarAtributo("AREATEXTO", "codCuenCont", "ontab","ejecutarAccionFocoModificacion(\"cccCuentContaFrm\",3, true)");
				asignarAtributo("AREATEXTO", "codCuenCont", "onshtab","ejecutarAccionFocoModificacion(\"cccCuentContaFrm\",3, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"cccCuentContaFrm\",4, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"cccCuentContaFrm\",4, false)");
				asignarAtributo("AREATEXTO", "codCuenSap", "ontab","ejecutarAccionFocoModificacion(\"cccCuentContaFrm\",5, true)");
				asignarAtributo("AREATEXTO", "codCuenSap", "onshtab","ejecutarAccionFocoModificacion(\"cccCuentContaFrm\",5, false)");
				asignarAtributo("AREATEXTO", "valObse", "ontab","ejecutarAccionFocoModificacion(\"cccCuentContaFrm\",6, true)");
				asignarAtributo("AREATEXTO", "valObse", "onshtab","ejecutarAccionFocoModificacion(\"cccCuentContaFrm\",6, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","cccCuentContaTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","cccCuentContaTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","cccCuentContaFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","cccCuentContaListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","cccCuentContaListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(CccCuentContaData cccCuentConta) throws Exception{
		...
		if(cccCuentConta != null && cccCuentConta.getPaisOidPais() != null){
				checkCombo("paisOidPais" , cccCuentConta.getPaisOidPais().getId().toString());
			}
	...
	* @param cccCuentConta La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(CccCuentContaData cccCuentConta) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		CccCuentContaData cccCuentConta = 
			(CccCuentContaData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(cccCuentConta.getPaisOidPais() != null){
			cccCuentConta.setPaisOidPais((es.indra.belcorp.mso.SegPaisViewData)
			getSingleObject(BUSINESSID_PAISOIDPAIS_QUERY, 
			cccCuentConta.getPaisOidPais(),
			cccCuentConta.getPaisOidPais().clone(),
			"segPaisView"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(cccCuentConta);
		loadLeafDependenceCombos(cccCuentConta);
	}
	...
	*/
	...
	protected void loadLocalizationVars(CccCuentContaData cccCuentConta) throws Exception{
		...
		mmgLocalizationQuery.setEntiPk(cccCuentConta.getId());
