...
public class contenido_tipo_encuesta_insertar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_tipo_encuesta_insertar" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","contenido_tipo_encuesta_insertar.js" );
      ...
      ((Element)v.get(8)).setAttribute("name","txtCodEncuesta" );
      ((Element)v.get(8)).setAttribute("required","true" );
      ((Element)v.get(8)).setAttribute("cod","MaeEncueAplicClien.enseOidEncu.label" );
      ...
      ((Element)v.get(9)).setAttribute("cod","MaeEncueNse.Descripcion.label" );
      ...
      ((Element)v.get(10)).setAttribute("cod","MaeEncueNseView.marcOidMarc.label" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(17)).setAttribute("nombre","oidTipoEncuesta" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(18)).setAttribute("nombre","CodEncuesta" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(19)).setAttribute("nombre","descripcion" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(21)).setAttribute("nombre","desMarace" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(43)).setAttribute("width","584" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(51)).setAttribute("nombre","lblCodEncuesta" );
      ((Element)v.get(51)).setAttribute("alto","13" );
      ((Element)v.get(51)).setAttribute("filas","1" );
      ((Element)v.get(51)).setAttribute("valor","" );
      ((Element)v.get(51)).setAttribute("id","datosTitle" );
      ((Element)v.get(51)).setAttribute("cod","MaeEncueAplicClien.enseOidEncu.label" );
      ...
      ((Element)v.get(55)).setAttribute("cod","MaeEncueNse.Descripcion.label" );
      ...
      ((Element)v.get(62)).setAttribute("nombre","txtCodEncuesta" );
      ...
      ((Element)v.get(62)).setAttribute("onshtab","onShTabTxtCodEncuesta();" );
      ((Element)v.get(62)).setAttribute("ontab","onTabTxtCodEncuesta();" );
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(66)).setAttribute("nombre","txtDescripcion" );
      ((Element)v.get(66)).setAttribute("id","datosCampos" );
      ((Element)v.get(66)).setAttribute("max","30" );
      ((Element)v.get(66)).setAttribute("tipo","" );
      ((Element)v.get(66)).setAttribute("onchange","" );
      ((Element)v.get(66)).setAttribute("req","S" );
      ((Element)v.get(66)).setAttribute("size","30" );
      ((Element)v.get(66)).setAttribute("valor","" );
      ((Element)v.get(66)).setAttribute("validacion","" );
      ((Element)v.get(66)).setAttribute("onshtab","onShTabTxtDescripcion();" );
   }

   private void getXML270(Document doc) {
      ((Element)v.get(66)).setAttribute("ontab","onTabTxtDescripcion();" );
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(76)).setAttribute("width","584" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(81)).setAttribute("nombre","lblMarca" );
      ...
      ((Element)v.get(81)).setAttribute("cod","MaeEncueNseView.marcOidMarc.label" );
      ...
      ((Element)v.get(88)).setAttribute("ontab","onTabCbMarca();" );
      ((Element)v.get(88)).setAttribute("onshtab","onShTabCbMarca();" );
