...
public class Contenido_simulacion_liquidacion_consultar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_simulacion_liquidacion_consultar" );
      ...
      v.add(doc.createTextNode("\r     \r      \r	function onLoadPag()   \r	{\r	    configurarMenuSecundario('frmFormulario');\r		fMostrarMensajeError();\r\r		ocultarLista();   \r\r		set('frmFormulario.cbMarca', [get('frmFormulario.hCbMarca')]);\r		set('frmFormulario.cbCanal', [get('frmFormulario.hCbCanal')]);\r\r        recargaPeriodo();\r\r        document.all[\"SimularDiv\"].style.visibility='hidden';\r		document.all[\"GenerarLiquidacionDiv\"].style.visibility='hidden';\r\r        		if(get('frmFormulario.hTipoUsuario')==\"0\") {\r		    del_combo('frmFormulario.cbUsuarioCobranza', 0);\r			accion('frmFormulario.cbUsuarioCobranza', '.disabled=true');\r		} \r\r		\r        		if(get('frmFormulario.hTipoUsuario')==\"0\") {\r			focaliza(\"frmFormulario.cbEtapa\");\r		}else{\r			focaliza(\"frmFormulario.cbUsuarioCobranza\");\r		}\r	}\r\r\r	function recargaPeriodo(){\r\r	  if( get('frmFormulario.cbCanal') != '' && get('frmFormulario.cbMarca') != ''){\r\r        accion('frmFormulario.cbPeriodo', '.disabled=false');\r\r        recargaCombo('frmFormulario.cbPeriodo', 'CRAObtienePeriodos', \r            'es.indra.sicc.dtos.cra.DTOPeriodo', [['pais', get('frmFormulario.hPais')], \r            ['marca', get('frmFormulario.cbMarca')], ['canal', get('frmFormulario.cbCanal')]]);\r\r      } else {        \r        \r        set_combo('frmFormulario.cbPeriodo', arrayVacio());\r        accion('frmFormulario.cbPeriodo', '.disabled=true');\r      }\r	}\r\r	 function arrayVacio(){  \r      var array = new Array();             \r          array[0] = new Array('','');\r  \r      return array;\r    }\r\r	\r	function marcaOnChange(){\r		recargaPeriodo();\r	}\r\r	function canalOnChange(){\r		recargaPeriodo();\r	}\r\r\r    function usuarioCobranzaOnChange(){\r		recargaCombo('frmFormulario.cbEtapa', 'COBObtenerEtapasUsuarioCOB', \r            'es.indra.sicc.util.DTOOID', [['oidPais', get('frmFormulario.hPais')], \r            ['oid', get('frmFormulario.cbUsuarioCobranza')]]);\r	}\r\r\r\r	function ocultarLista() {\r		document.all[\"Cplistado1\"].style.visibility='hidden';\r	    document.all[\"CpLin1listado1\"].style.visibility='hidden';\r	    document.all[\"CpLin2listado1\"].style.visibility='hidden';\r	    document.all[\"CpLin3listado1\"].style.visibility='hidden';\r	    document.all[\"CpLin4listado1\"].style.visibility='hidden';\r\r	    document.all[\"primera1Div\"].style.visibility='hidden';\r	    document.all[\"ret1Div\"].style.visibility='hidden';\r	    document.all[\"ava1Div\"].style.visibility='hidden';\r	    document.all[\"separaDiv\"].style.visibility='hidden';\r\r	    eval (ON_RSZ);  \r    }\r\r	function mostrarLista() {\r	    DrdEnsanchaConMargenDcho('listado1',12);\r\r		document.all[\"Cplistado1\"].style.visibility='';\r	    document.all[\"CpLin1listado1\"].style.visibility='';\r	    document.all[\"CpLin2listado1\"].style.visibility='';\r	    document.all[\"CpLin3listado1\"].style.visibility='';\r	    document.all[\"CpLin4listado1\"].style.visibility='';\r\r	    document.all[\"primera1Div\"].style.visibility='hidden';\r	    document.all[\"ret1Div\"].style.visibility='hidden';\r	    document.all[\"ava1Div\"].style.visibility='hidden';\r	    document.all[\"separaDiv\"].style.visibility='hidden';\r\r	    eval (ON_RSZ);  \r    }\r\r	function fLimpiar(){\r\r	    set('frmFormulario.txtFechaAsignacion','');\r\r		if(get('frmFormulario.hTipoUsuario')!=\"0\") {\r			set('frmFormulario.cbUsuarioCobranza','');\r			usuarioCobranzaOnChange();\r		} else {\r			set('frmFormulario.cbEtapa','');\r		}\r\r	    set('frmFormulario.cbMarca', [get('frmFormulario.hCbMarca')]);\r	    set('frmFormulario.cbCanal', [get('frmFormulario.hCbCanal')]);\r\r	    recargaPeriodo();\r\r	    		if(get('frmFormulario.hTipoUsuario')==\"0\") {\r			focaliza(\"frmFormulario.cbEtapa\");\r		}else{\r			focaliza(\"frmFormulario.cbUsuarioCobranza\");\r		}\r	}\r\r\r		function focalizaShTab(tab){\r		if(tab==1) {\r			focalizaBotonHTML('botonContenido','btnBuscar');\r		} else if(tab==2){\r			if(get('frmFormulario.hTipoUsuario')!=\"0\") {\r				focaliza(\"frmFormulario.cbUsuarioCobranza\");\r			}else{\r				if(document.all[\"Cplistado1\"].style.visibility!='hidden'){\r					if(get('frmFormulario.hSimulacion')==\"S\"){\r						focalizaBotonHTML_XY('Simular');\r					} else if(get('frmFormulario.hSimulacion')==\"N\"){\r						focalizaBotonHTML_XY('GenerarLiquidacion');\r					}\r				} else {\r					focalizaBotonHTML('botonContenido','btnBuscar');\r				}\r			}\r		} else if(tab==3){\r			if(document.all[\"Cplistado1\"].style.visibility!='hidden'){\r				if(get('frmFormulario.hSimulacion')==\"S\"){\r					focalizaBotonHTML_XY('Simular');\r				} else if(get('frmFormulario.hSimulacion')==\"N\"){\r					focalizaBotonHTML_XY('GenerarLiquidacion');\r				}\r			} else {\r				focalizaBotonHTML('botonContenido','btnBuscar');\r			}\r		}\r	}\r\r	function focalizaTab(tab){\r	    if(tab==1){\r						if(document.all[\"Cplistado1\"].style.visibility!='hidden'){\r				if(get('frmFormulario.hSimulacion')==\"S\"){\r					focalizaBotonHTML_XY('Simular');\r				} else if(get('frmFormulario.hSimulacion')==\"N\"){\r					focalizaBotonHTML_XY('GenerarLiquidacion');\r				}\r			} else {\r				if(get('frmFormulario.hTipoUsuario')==\"0\") {\r					focaliza(\"frmFormulario.cbEtapa\");\r				}else{\r					focaliza(\"frmFormulario.cbUsuarioCobranza\");\r				}\r			}\r		} else if(tab==2){\r			if(get('frmFormulario.hTipoUsuario')==\"0\") {\r				focaliza(\"frmFormulario.cbEtapa\");\r			}else{\r				focaliza(\"frmFormulario.cbUsuarioCobranza\");\r			}\r		}\r\r		\r	}\r\r    function onClickBuscar(){\r		if(sicc_validaciones_generales(\"gBuscar\")){	\r\r			ocultarLista();\r			document.all[\"SimularDiv\"].style.visibility='hidden';\r			document.all[\"GenerarLiquidacionDiv\"].style.visibility='hidden';\r\r						var arrDatos = new Array();\r			var i=0;\r			\r			arrDatos[i] = new Array('oidPais',get('frmFormulario.hPais'));\r			i++;\r			arrDatos[i] = new Array('oidIdioma',get('frmFormulario.hIdioma'));\r			i++;\r			arrDatos[i] = new Array('usuarioCobranza', get('frmFormulario.cbUsuarioCobranza'));\r			i++;\r			arrDatos[i] = new Array('etapa', get('frmFormulario.cbEtapa'));\r			i++;\r			arrDatos[i] = new Array('marca', get('frmFormulario.cbMarca'));\r			i++;\r			arrDatos[i] = new Array('canal', get('frmFormulario.cbCanal'));\r			i++;\r			arrDatos[i] = new Array('periodo', get('frmFormulario.cbPeriodo'));\r			i++;			\r			arrDatos[i] = new Array('fechaAsignacionString', get('frmFormulario.txtFechaAsignacion'));\r			i++;\r			arrDatos[i] = new Array('formatoFecha', get('frmFormulario.hFormatoFecha'));\r			i++;\r		\r\r						configurarPaginado(mipgndo,'COBListadoDeudasUsuario','ConectorListadoDeudasUsuario',\r				'es.indra.sicc.dtos.cob.DTOCriteriosBusquedaLiquidacionCom',arrDatos);\r		}\r	}\r\r\r	function simulacionOK(datosSimulacion){\r\r		var obj = new Object();		\r		obj.datosSimulacion = datosSimulacion;\r		obj.accion = 'visualizarSimulacion';\r		var retorno = mostrarModalSICC('LPConsultarSimulacionLiquidacion', 'visualizarSimulacion', obj, null, null);\r\r\r				ocultarLista();   \r\r		document.all[\"SimularDiv\"].style.visibility='hidden';\r		document.all[\"GenerarLiquidacionDiv\"].style.visibility='hidden';\r\r		set('frmFormulario.txtFechaAsignacion','');\r\r		if(get('frmFormulario.hTipoUsuario')!=\"0\") {\r			set('frmFormulario.cbUsuarioCobranza','');\r			usuarioCobranzaOnChange();\r		} else {\r			set('frmFormulario.cbEtapa','');\r		}       \r\r		set('frmFormulario.cbMarca', [get('frmFormulario.hCbMarca')]);\r		set('frmFormulario.cbCanal', [get('frmFormulario.hCbCanal')]);\r\r        recargaPeriodo();\r        \r\r        		if(get('frmFormulario.hTipoUsuario')==\"0\") {\r			focaliza(\"frmFormulario.cbEtapa\");\r		}else{\r			focaliza(\"frmFormulario.cbUsuarioCobranza\");\r		}\r			\r	}\r\r\r    function generacionOK(datosSimulacion){\r        		      \r	  \r	  /*********Agregado por Hugo Mansi******************/\r	  	    var obj = new Object();		\r		\r		obj.datosSimulacion = datosSimulacion;\r		\r		obj.accion = 'visualizarSimulacion';\r		\r		var retorno = mostrarModalSICC('LPConsultarSimulacionLiquidacion', 'visualizarSimulacion', obj, null, null); \r      /*Fin agregado por Hugo Mansi  */\r\r\r\r				ocultarLista();   \r\r		document.all[\"SimularDiv\"].style.visibility='hidden';\r		document.all[\"GenerarLiquidacionDiv\"].style.visibility='hidden';\r\r		set('frmFormulario.txtFechaAsignacion','');\r\r		if(get('frmFormulario.hTipoUsuario')!=\"0\") {\r			set('frmFormulario.cbUsuarioCobranza','');\r			usuarioCobranzaOnChange();\r		} else {\r			set('frmFormulario.cbEtapa','');\r		}       \r\r		set('frmFormulario.cbMarca', [get('frmFormulario.hCbMarca')]);\r		set('frmFormulario.cbCanal', [get('frmFormulario.hCbCanal')]);\r\r        recargaPeriodo();\r        \r\r        		if(get('frmFormulario.hTipoUsuario')==\"0\") {\r			focaliza(\"frmFormulario.cbEtapa\");\r		}else{\r			focaliza(\"frmFormulario.cbUsuarioCobranza\");\r		}\r	}\r\r\r	function errorAlSimular(){\r				if(get('frmFormulario.hTipoUsuario')==\"0\") {\r			focaliza(\"frmFormulario.cbEtapa\");\r		}else{\r			focaliza(\"frmFormulario.cbUsuarioCobranza\");\r		}\r	}\r\r\r	function simularLiquidacionOnClick(){\r		var valorSeleccionado = listado1.codSeleccionados();\r\r		if( valorSeleccionado != '' ){\r\r						       regSimulacion = armarDatosSimulacion();				\r				   set('frmFormulario.regSimulacion',regSimulacion);\r\r				   set('frmFormulario.conectorAction', 'LPConsultarSimulacionLiquidacion');\r				   set('frmFormulario.accion', 'simular');\r				   eval('frmFormulario').oculto = 'S';\r				   enviaSICC('frmFormulario');\r			\r		}else{\r			GestionarMensaje('8', null, null, null);\r		}\r\r    }\r\r	function validarSeleccion(){\r		var codigos = listado1.codSeleccionados();\r\r		for (var i=0; i<codigos.length ; i++){\r			idLiquidacion = listado1.extraeDato(codigos[i], 20);\r\r			if(idLiquidacion==0){\r				GestionarMensaje('1488', null, null, null);\r				return false;\r			}\r		}\r\r		return true;\r	}\r\r\r	function armarDatosSimulacion(){	\r		var codigos = listado1.codSeleccionados();\r		  var cadena = \"\";\r		  \r		  for (var i=0; i<codigos.length ; i++){\r			   if( i != 0)\r					cadena = cadena + \"|\";\r\r			   oid = listado1.extraeDato(codigos[i], 21);\r			   cadena = cadena + isBlanco(oid) + \"#\";\r\r			   usuario = listado1.extraeDato(codigos[i], 0);\r			   cadena = cadena + isBlanco(usuario) + \"#\";\r\r			   codEtapa = listado1.extraeDato(codigos[i], 1);\r			   cadena = cadena + isBlanco(codEtapa) + \"#\";\r\r			   descMarca = listado1.extraeDato(codigos[i], 2);\r			   cadena = cadena + isBlanco(descMarca) + \"#\";\r\r			   descCanal = listado1.extraeDato(codigos[i], 3);\r			   cadena = cadena + isBlanco(descCanal) + \"#\";\r\r			   codPeriodo = listado1.extraeDato(codigos[i], 4);\r			   cadena = cadena + isBlanco(codPeriodo) + \"#\";\r\r			   impDeudaAsig = listado1.extraeDato(codigos[i], 5);\r			   cadena = cadena + isBlanco(impDeudaAsig) + \"#\";\r\r			   impDeudaCan = listado1.extraeDato(codigos[i], 6);\r			   cadena = cadena + isBlanco(impDeudaCan) + \"#\";\r\r			   fechaAsig = listado1.extraeDato(codigos[i], 7);\r			   cadena = cadena + isBlanco(fechaAsig) + \"#\";\r\r			   metLiquidacion = listado1.extraeDato(codigos[i], 8);\r			   cadena = cadena + isBlanco(metLiquidacion) + \"#\";\r\r			   indLiqDesc = listado1.extraeDato(codigos[i], 9);\r			   cadena = cadena + isBlanco(indLiqDesc) + \"#\";\r\r			   indLiqGrupoDesc = listado1.extraeDato(codigos[i], 10);\r			   cadena = cadena + isBlanco(indLiqGrupoDesc) + \"#\";\r\r			   descEscala = listado1.extraeDato(codigos[i], 11);\r			   cadena = cadena + isBlanco(descEscala) + \"#\";\r\r			   oidUsuario = listado1.extraeDato(codigos[i], 12);\r			   cadena = cadena + isBlanco(oidUsuario) + \"#\";\r\r			   oidEtapa = listado1.extraeDato(codigos[i], 13);\r			   cadena = cadena + isBlanco(oidEtapa) + \"#\";\r\r			   oidPeriodo = listado1.extraeDato(codigos[i], 14);\r			   cadena = cadena + isBlanco(oidPeriodo) + \"#\";\r\r			   oidMetLiq = listado1.extraeDato(codigos[i], 15);\r			   cadena = cadena + isBlanco(oidMetLiq) + \"#\";\r\r			   oidBaseEscala = listado1.extraeDato(codigos[i], 16);\r			   cadena = cadena + isBlanco(oidBaseEscala) + \"#\";\r\r			   periodo = listado1.extraeDato(codigos[i], 17);\r			   cadena = cadena + isBlanco(periodo) + \"#\";\r\r			   codCliente = listado1.extraeDato(codigos[i], 18);\r			   cadena = cadena + isBlanco(codCliente) + \"#\";\r\r			   descEtapa = listado1.extraeDato(codigos[i], 19);\r			   cadena = cadena + isBlanco(descEtapa);\r		 }\r\r         		 return cadena;\r\r	}\r\r\r	function isBlanco(valor){\r		if(valor==\"\")\r			return \" \";\r\r		return valor;\r	}\r\r\r	function muestraLista( ultima, rowset, error){\r		var tamano = rowset.length;\r\r		if (tamano > 0){\r			mostrarLista();\r\r            			if(get('frmFormulario.hSimulacion')==\"S\") {\r				document.all[\"SimularDiv\"].style.visibility='';\r				document.all[\"GenerarLiquidacionDiv\"].style.visibility='hidden';\r			} else if(get('frmFormulario.hSimulacion')==\"N\") {\r				document.all[\"SimularDiv\"].style.visibility='hidden';\r				document.all[\"GenerarLiquidacionDiv\"].style.visibility='';\r			} \r\r			return true;\r		} else {			   \r		  ocultarLista();\r\r          		  document.all[\"SimularDiv\"].style.visibility='hidden';\r		  document.all[\"GenerarLiquidacionDiv\"].style.visibility='hidden';\r\r		  return false;\r		 }\r    }\r	\r\r  \r\r  "));
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(11)).setAttribute("name","txtFechaAsignacion" );
      ...
      ((Element)v.get(11)).setAttribute("cod","1660" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(19)).setAttribute("nombre","hCbMarca" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(20)).setAttribute("nombre","hCbCanal" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(21)).setAttribute("nombre","hFormatoFecha" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(22)).setAttribute("nombre","hTipoUsuario" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(23)).setAttribute("nombre","hSimulacion" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(24)).setAttribute("nombre","regSimulacion" );
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(44)).setAttribute("width","538" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(56)).setAttribute("nombre","lblEtapa" );
      ...
      ((Element)v.get(56)).setAttribute("cod","865" );
      ...
      ((Element)v.get(63)).setAttribute("nombre","cbUsuarioCobranza" );
      ...
      ((Element)v.get(63)).setAttribute("onchange","usuarioCobranzaOnChange();" );
      ((Element)v.get(63)).setAttribute("onshtab","focalizaShTab(3);" );
   ...
   private void getXML270(Document doc) {
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(68)).setAttribute("nombre","cbEtapa" );
      ...
      ((Element)v.get(68)).setAttribute("onshtab","focalizaShTab(2);" );
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(77)).setAttribute("width","538" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(82)).setAttribute("nombre","lblMarca" );
      ...
      ((Element)v.get(82)).setAttribute("cod","6" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(93)).setAttribute("nombre","cbMarca" );
      ...
      ((Element)v.get(93)).setAttribute("onchange","marcaOnChange();" );
      ...
      ((Element)v.get(98)).setAttribute("onchange","canalOnChange();" );
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(107)).setAttribute("width","538" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(116)).setAttribute("nombre","lblFechaAsignacion" );
      ...
      ((Element)v.get(116)).setAttribute("cod","1660" );
      ...
      ((Element)v.get(128)).setAttribute("nombre","txtFechaAsignacion" );
      ...
      /* Empieza nodo:134 / Elemento padre: 34   */
      v.add(doc.createElement("td"));
      ((Element)v.get(34)).appendChild((Element)v.get(134));
   ...
   private void getXML540(Document doc) {
      ...
      /* Empieza nodo:136 / Elemento padre: 26   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(26)).appendChild((Element)v.get(136));
      ...
      ((Element)v.get(144)).setAttribute("accion","onClickBuscar();" );
      ...
      /* Empieza nodo:147 / Elemento padre: 26   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(26)).appendChild((Element)v.get(147));
   ...
   private void getXML630(Document doc) {
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(171)).setAttribute("ancho","180" );
   ...
   private void getXML720(Document doc) {
      ...
      ((Element)v.get(181)).setAttribute("oculta","S" );
      ...
      ((Element)v.get(187)).setAttribute("cod","1219" );
   ...
   private void getXML810(Document doc) {
      ((Element)v.get(191)).setAttribute("cod","6" );
      ...
      ((Element)v.get(193)).setAttribute("cod","7" );
      ...
      ((Element)v.get(197)).setAttribute("cod","895" );
      ...
      ((Element)v.get(199)).setAttribute("cod","2128" );
      ((Element)v.get(186)).appendChild((Element)v.get(199));

      /* Elemento padre:199 / Elemento actual: 200   */
      v.add(doc.createTextNode("Importe deuda cancelada"));
      ...
      ((Element)v.get(201)).setAttribute("cod","1660" );
      ...
      /* Empieza nodo:203 / Elemento padre: 186   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(203)).setAttribute("colFondo","" );
      ((Element)v.get(203)).setAttribute("ID","EstCab" );
      ((Element)v.get(203)).setAttribute("cod","1196" );
      ((Element)v.get(186)).appendChild((Element)v.get(203));

      /* Elemento padre:203 / Elemento actual: 204   */
      v.add(doc.createTextNode("Método liquidación defecto"));
      ((Element)v.get(203)).appendChild((Text)v.get(204));

      /* Termina nodo Texto:204   */
      /* Termina nodo:203   */

      /* Empieza nodo:205 / Elemento padre: 186   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(205)).setAttribute("colFondo","" );
      ((Element)v.get(205)).setAttribute("ID","EstCab" );
      ((Element)v.get(205)).setAttribute("cod","1197" );
      ((Element)v.get(186)).appendChild((Element)v.get(205));

      /* Elemento padre:205 / Elemento actual: 206   */
      v.add(doc.createTextNode("Liquidación"));
      ...
      ((Element)v.get(207)).setAttribute("cod","1198" );
      ((Element)v.get(186)).appendChild((Element)v.get(207));

      /* Elemento padre:207 / Elemento actual: 208   */
      v.add(doc.createTextNode("Liquidación grupo usuarios"));
      ...
      /* Empieza nodo:217 / Elemento padre: 186   */
      v.add(doc.createElement("COL"));
   ...
   private void getXML900(Document doc) {
      ...
      ((Element)v.get(217)).setAttribute("cod","1199" );
      ((Element)v.get(186)).appendChild((Element)v.get(217));

      /* Elemento padre:217 / Elemento actual: 218   */
      v.add(doc.createTextNode("oidLiquidacion"));
      ((Element)v.get(217)).appendChild((Text)v.get(218));

      /* Termina nodo Texto:218   */
      /* Termina nodo:217   */

      /* Empieza nodo:219 / Elemento padre: 186   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(219)).setAttribute("colFondo","" );
      ((Element)v.get(219)).setAttribute("ID","EstCab" );
      ((Element)v.get(219)).setAttribute("cod","1199" );
      ((Element)v.get(186)).appendChild((Element)v.get(219));

      /* Elemento padre:219 / Elemento actual: 220   */
      v.add(doc.createTextNode("oidBaseEscala"));
      ((Element)v.get(219)).appendChild((Text)v.get(220));

      /* Termina nodo Texto:220   */
      /* Termina nodo:219   */

      /* Empieza nodo:221 / Elemento padre: 186   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(221)).setAttribute("colFondo","" );
      ((Element)v.get(221)).setAttribute("ID","EstCab" );
      ((Element)v.get(221)).setAttribute("cod","1199" );
      ((Element)v.get(186)).appendChild((Element)v.get(221));
      ...
      /* Empieza nodo:223 / Elemento padre: 186   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(223)).setAttribute("colFondo","" );
      ((Element)v.get(223)).setAttribute("ID","EstCab" );
      ((Element)v.get(223)).setAttribute("cod","1199" );
      ((Element)v.get(186)).appendChild((Element)v.get(223));
      ...
      /* Empieza nodo:225 / Elemento padre: 186   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(225)).setAttribute("colFondo","" );
      ((Element)v.get(225)).setAttribute("ID","EstCab" );
      ((Element)v.get(225)).setAttribute("cod","1199" );
      ((Element)v.get(186)).appendChild((Element)v.get(225));

      /* Elemento padre:225 / Elemento actual: 226   */
      v.add(doc.createTextNode("desc Etapa"));
      ((Element)v.get(225)).appendChild((Text)v.get(226));

      /* Termina nodo Texto:226   */
      /* Termina nodo:225   */

      /* Empieza nodo:227 / Elemento padre: 186   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(227)).setAttribute("colFondo","" );
      ((Element)v.get(227)).setAttribute("ID","EstCab" );
      ((Element)v.get(227)).setAttribute("cod","1199" );
      ((Element)v.get(186)).appendChild((Element)v.get(227));
      ...
      /* Empieza nodo:229 / Elemento padre: 154   */
      v.add(doc.createElement("DATOS"));
      ((Element)v.get(229)).setAttribute("alto","22" );
      ((Element)v.get(229)).setAttribute("accion","" );
      ((Element)v.get(229)).setAttribute("tipoEnvio","edicion" );
      ...
      ((Element)v.get(154)).appendChild((Element)v.get(229));
      ...
      /* Empieza nodo:239 / Elemento padre: 229   */
      v.add(doc.createElement("COL"));
   ...
   private void getXML990(Document doc) {
      ...
      ((Element)v.get(229)).appendChild((Element)v.get(239));
      /* Termina nodo:239   */
      ...
      /* Empieza nodo:243 / Elemento padre: 229   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(243)).setAttribute("tipo","texto" );
      ((Element)v.get(243)).setAttribute("ID","EstDat2" );
      ((Element)v.get(229)).appendChild((Element)v.get(243));
      /* Termina nodo:243   */
      ...
      /* Empieza nodo:245 / Elemento padre: 229   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(245)).setAttribute("tipo","texto" );
      ((Element)v.get(245)).setAttribute("ID","EstDat2" );
      ((Element)v.get(229)).appendChild((Element)v.get(245));
      /* Termina nodo:245   */
      ...
      /* Empieza nodo:247 / Elemento padre: 229   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(247)).setAttribute("tipo","texto" );
      ((Element)v.get(247)).setAttribute("ID","EstDat2" );
      ((Element)v.get(229)).appendChild((Element)v.get(247));
      /* Termina nodo:247   */

      /* Empieza nodo:248 / Elemento padre: 229   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(248)).setAttribute("tipo","texto" );
      ((Element)v.get(248)).setAttribute("ID","EstDat2" );
      ((Element)v.get(229)).appendChild((Element)v.get(248));
      /* Termina nodo:248   */

      /* Empieza nodo:249 / Elemento padre: 229   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(249)).setAttribute("tipo","texto" );
      ((Element)v.get(249)).setAttribute("ID","EstDat2" );
      ((Element)v.get(229)).appendChild((Element)v.get(249));
      /* Termina nodo:249   */

      /* Empieza nodo:250 / Elemento padre: 229   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(250)).setAttribute("tipo","texto" );
      ((Element)v.get(250)).setAttribute("ID","EstDat2" );
      ((Element)v.get(229)).appendChild((Element)v.get(250));
      /* Termina nodo:250   */
      /* Termina nodo:229   */

      /* Empieza nodo:251 / Elemento padre: 154   */
      v.add(doc.createElement("ROWSET"));
      ((Element)v.get(154)).appendChild((Element)v.get(251));
      /* Termina nodo:251   */

      /* Empieza nodo:252 / Elemento padre: 154   */
      v.add(doc.createElement("PAGINADO"));
      ((Element)v.get(252)).setAttribute("nombre","mipgndo" );
      ((Element)v.get(252)).setAttribute("ancho","542" );
      ((Element)v.get(252)).setAttribute("sep","$" );
      ((Element)v.get(252)).setAttribute("x","12" );
      ((Element)v.get(252)).setAttribute("class","botonera" );
      ((Element)v.get(252)).setAttribute("y","504" );
      ((Element)v.get(252)).setAttribute("control","|" );
      ((Element)v.get(252)).setAttribute("conector","conector_prototipo_2" );
      ((Element)v.get(252)).setAttribute("onload","procesarPaginado(mipgndo,msgError, ultima, rowset, 'muestraLista(ultima, rowset)')" );
      ((Element)v.get(252)).setAttribute("rowset","" );
      ((Element)v.get(252)).setAttribute("cargainicial","N" );
      ((Element)v.get(154)).appendChild((Element)v.get(252));

      /* Empieza nodo:253 / Elemento padre: 252   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(253)).setAttribute("nombre","ret1" );
      ((Element)v.get(253)).setAttribute("x","37" );
      ((Element)v.get(253)).setAttribute("y","508" );
      ((Element)v.get(253)).setAttribute("ID","botonContenido" );
      ((Element)v.get(253)).setAttribute("img","retroceder_on" );
      ((Element)v.get(253)).setAttribute("tipo","0" );
      ((Element)v.get(253)).setAttribute("estado","false" );
      ((Element)v.get(253)).setAttribute("alt","" );
      ((Element)v.get(253)).setAttribute("codigo","" );
      ((Element)v.get(253)).setAttribute("accion","mipgndo.retroceder();" );
      ((Element)v.get(252)).appendChild((Element)v.get(253));
      /* Termina nodo:253   */

      /* Empieza nodo:254 / Elemento padre: 252   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(254)).setAttribute("nombre","ava1" );
      ((Element)v.get(254)).setAttribute("x","52" );
      ((Element)v.get(254)).setAttribute("y","508" );
      ((Element)v.get(254)).setAttribute("ID","botonContenido" );
      ((Element)v.get(254)).setAttribute("img","avanzar_on" );
      ((Element)v.get(254)).setAttribute("tipo","0" );
      ((Element)v.get(254)).setAttribute("estado","false" );
      ((Element)v.get(254)).setAttribute("alt","" );
      ((Element)v.get(254)).setAttribute("codigo","" );
      ((Element)v.get(254)).setAttribute("accion","mipgndo.avanzar();" );
      ((Element)v.get(252)).appendChild((Element)v.get(254));
      /* Termina nodo:254   */
      /* Termina nodo:252   */
      /* Termina nodo:154   */

      /* Empieza nodo:255 / Elemento padre: 12   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(255)).setAttribute("nombre","primera1" );
      ((Element)v.get(255)).setAttribute("x","20" );
      ((Element)v.get(255)).setAttribute("y","508" );
      ((Element)v.get(255)).setAttribute("ID","botonContenido" );
   }

   private void getXML1080(Document doc) {
      ((Element)v.get(255)).setAttribute("img","primera_on" );
      ((Element)v.get(255)).setAttribute("tipo","-2" );
      ((Element)v.get(255)).setAttribute("estado","false" );
      ((Element)v.get(255)).setAttribute("alt","" );
      ((Element)v.get(255)).setAttribute("codigo","" );
      ((Element)v.get(255)).setAttribute("accion","mipgndo.retrocederPrimeraPagina();" );
      ((Element)v.get(12)).appendChild((Element)v.get(255));
      /* Termina nodo:255   */

      /* Empieza nodo:256 / Elemento padre: 12   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(256)).setAttribute("nombre","separa" );
      ((Element)v.get(256)).setAttribute("x","59" );
      ((Element)v.get(256)).setAttribute("y","504" );
      ((Element)v.get(256)).setAttribute("ID","botonContenido" );
      ((Element)v.get(256)).setAttribute("img","separa_base" );
      ...
      ((Element)v.get(256)).setAttribute("accion","" );
      ((Element)v.get(12)).appendChild((Element)v.get(256));
      /* Termina nodo:256   */

      /* Empieza nodo:257 / Elemento padre: 12   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(257)).setAttribute("nombre","Simular" );
      ((Element)v.get(257)).setAttribute("x","13" );
      ((Element)v.get(257)).setAttribute("y","505" );
      ((Element)v.get(257)).setAttribute("ID","botonContenido" );
      ((Element)v.get(257)).setAttribute("tipo","html" );
      ((Element)v.get(257)).setAttribute("accion","simularLiquidacionOnClick();" );
      ((Element)v.get(257)).setAttribute("ontab","focalizaTab(2);" );
      ((Element)v.get(257)).setAttribute("onshtab","focalizaShTab(1);" );
      ((Element)v.get(257)).setAttribute("estado","false" );
      ((Element)v.get(257)).setAttribute("cod","2134" );
      ((Element)v.get(12)).appendChild((Element)v.get(257));
      /* Termina nodo:257   */

      /* Empieza nodo:258 / Elemento padre: 12   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(258)).setAttribute("nombre","GenerarLiquidacion" );
      ((Element)v.get(258)).setAttribute("x","13" );
      ((Element)v.get(258)).setAttribute("y","505" );
      ((Element)v.get(258)).setAttribute("ID","botonContenido" );
      ((Element)v.get(258)).setAttribute("tipo","html" );
      ((Element)v.get(258)).setAttribute("accion","simularLiquidacionOnClick();" );
      ((Element)v.get(258)).setAttribute("ontab","focalizaTab(2);" );
      ((Element)v.get(258)).setAttribute("onshtab","focalizaShTab(1);" );
      ((Element)v.get(258)).setAttribute("estado","false" );
      ((Element)v.get(258)).setAttribute("cod","1202" );
      ((Element)v.get(12)).appendChild((Element)v.get(258));
      /* Termina nodo:258   */

      /* Empieza nodo:259 / Elemento padre: 12   */
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(259)).setAttribute("nombre","capaEspacio" );
      ((Element)v.get(259)).setAttribute("alto","12" );
      ((Element)v.get(259)).setAttribute("ancho","50" );
      ((Element)v.get(259)).setAttribute("colorf","" );
      ((Element)v.get(259)).setAttribute("borde","0" );
      ((Element)v.get(259)).setAttribute("imagenf","" );
      ((Element)v.get(259)).setAttribute("repeat","" );
      ((Element)v.get(259)).setAttribute("padding","" );
      ((Element)v.get(259)).setAttribute("visibilidad","visible" );
      ((Element)v.get(259)).setAttribute("contravsb","" );
      ((Element)v.get(259)).setAttribute("x","0" );
      ((Element)v.get(259)).setAttribute("y","527" );
