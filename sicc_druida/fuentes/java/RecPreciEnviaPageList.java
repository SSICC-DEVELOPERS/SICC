...
public class RecPreciEnviaPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","recPreciEnviaList" );
      ...
      ((Element)v.get(12)).setAttribute("cod","RecPreciEnvia.codPrecEnvi.label" );
