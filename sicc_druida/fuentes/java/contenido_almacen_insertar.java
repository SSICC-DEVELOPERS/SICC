...
public class contenido_almacen_insertar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_almacen_insertar" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(5)).setAttribute("src","contenido_almacen_insertar.js" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(14)).setAttribute("nombre","oidAlmacen" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(15)).setAttribute("nombre","infSAP_detalle" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(16)).setAttribute("nombre","oidCentroDistribucion_detalle" );
      ...
      ((Element)v.get(19)).setAttribute("name","codAlma" );
      ((Element)v.get(19)).setAttribute("required","true" );
      ((Element)v.get(19)).setAttribute("group","gAlmacen" );
      ((Element)v.get(19)).setAttribute("cod","BelAlmac.codAlma.label" );
      ...
      ((Element)v.get(20)).setAttribute("group","gAlmacen" );
      ((Element)v.get(20)).setAttribute("cod","BelAlmac.Descripcion.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(36)).setAttribute("nombre","lblDatosDeAlta" );
      ...
      ((Element)v.get(37)).setAttribute("id","primeraFila" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(45)).setAttribute("nombre","lblCodAlma" );
      ...
      ((Element)v.get(45)).setAttribute("cod","BelAlmac.codAlma.label" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(49)).setAttribute("cod","BelAlmac.Descripcion.label" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(53)).setAttribute("nombre","lblIndInfoSap" );
      ((Element)v.get(53)).setAttribute("alto","13" );
      ((Element)v.get(53)).setAttribute("filas","1" );
      ((Element)v.get(53)).setAttribute("valor","" );
      ((Element)v.get(53)).setAttribute("id","datosTitle" );
      ((Element)v.get(53)).setAttribute("cod","BelAlmac.indInfoSap.label" );
      ...
      ((Element)v.get(60)).setAttribute("nombre","codAlma" );
      ...
      ((Element)v.get(60)).setAttribute("onshtab","focalizaShTab(1);" );
      ...
      v.add(doc.createElement("IMG"));
      ((Element)v.get(65)).setAttribute("src","iconmultidioma.gif" );
      ((Element)v.get(65)).setAttribute("width","21" );
      ((Element)v.get(65)).setAttribute("height","15" );
      ((Element)v.get(65)).setAttribute("onclick","levantarI18N('formulario','1');" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(69)).setAttribute("nombre","indInfoSap" );
      ((Element)v.get(69)).setAttribute("id","datosCampos" );
      ((Element)v.get(69)).setAttribute("onclick","" );
      ((Element)v.get(69)).setAttribute("check","N" );
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(73)).setAttribute("colspan","6" );
      ...
      /* Empieza nodo:75 / Elemento padre: 34   */
      v.add(doc.createElement("table"));
      ...
      ((Element)v.get(34)).appendChild((Element)v.get(75));
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(83)).setAttribute("nombre","lblCentroDistribucion" );
      ...
      ((Element)v.get(83)).setAttribute("cod","2054" );
      ...
      ((Element)v.get(90)).setAttribute("nombre","cbCentroDistribucion" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(90)).setAttribute("ontab","focalizaTab();" );
      ...
      ((Element)v.get(96)).setAttribute("height","15" );
