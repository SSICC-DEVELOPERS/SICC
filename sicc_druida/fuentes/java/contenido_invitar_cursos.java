...
public class contenido_invitar_cursos  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_invitar_cursos" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","contenido_invitar_cursos.js" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(13)).setAttribute("nombre","datosInvitadas" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(36)).setAttribute("width","609" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(52)).setAttribute("nombre","lblCodCliente" );
      ...
      ((Element)v.get(59)).setAttribute("onshtab","compruebashtab();" );
      ((Element)v.get(59)).setAttribute("valorinicial","" );
      ((Element)v.get(59)).setAttribute("textoinicial","" );
      ((Element)v.get(59)).setAttribute("onchange","onSeleccionaMarca();" );
      ...
      ((Element)v.get(64)).setAttribute("onchange","onSeleccionaMarca();" );
      ...
      ((Element)v.get(69)).setAttribute("nombre","txtCodCliente" );
   }
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(69)).setAttribute("onblur","textCodClienteOnBlur();" );
      ((Element)v.get(69)).setAttribute("req","N" );
      ((Element)v.get(69)).setAttribute("size","18" );
      ...
      ((Element)v.get(73)).setAttribute("onclick","accionSeleccionarCliente()" );
      ...
      /* Empieza nodo:79 / Elemento padre: 33   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(33)).appendChild((Element)v.get(79));
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(81)).setAttribute("width","609" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(86)).setAttribute("nombre","lblSubgerenciaVentas" );
      ...
      ((Element)v.get(86)).setAttribute("cod","124" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(90)).setAttribute("nombre","lblRegion" );
      ...
      ((Element)v.get(90)).setAttribute("cod","109" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(97)).setAttribute("nombre","cbSubgerenciaVentas" );
      ...
      ((Element)v.get(97)).setAttribute("onchange","onSeleccionaSubgerencia();" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(102)).setAttribute("nombre","cbRegion" );
      ...
      ((Element)v.get(102)).setAttribute("onchange","onSeleccionaRegion();" );
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(111)).setAttribute("width","609" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(116)).setAttribute("cod","143" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(120)).setAttribute("nombre","lblSeccion" );
      ...
      ((Element)v.get(120)).setAttribute("cod","112" );
      ...
      ((Element)v.get(127)).setAttribute("onchange","onSeleccionaZona();" );
      ...
      ((Element)v.get(132)).setAttribute("onchange","onSeleccionaSeccion();" );
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(137)).setAttribute("colspan","3" );
   ...
   private void getXML540(Document doc) {
      ...
      /* Empieza nodo:139 / Elemento padre: 33   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(33)).appendChild((Element)v.get(139));
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(141)).setAttribute("width","609" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(146)).setAttribute("nombre","lblTerritorio" );
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(158)).setAttribute("colspan","3" );
      ...
      /* Empieza nodo:160 / Elemento padre: 26   */
      v.add(doc.createElement("td"));
      ((Element)v.get(26)).appendChild((Element)v.get(160));
      ...
      /* Empieza nodo:162 / Elemento padre: 18   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(18)).appendChild((Element)v.get(162));
   ...
   private void getXML630(Document doc) {
      ...
      ((Element)v.get(170)).setAttribute("nombre","btnBuscar" );
      ((Element)v.get(170)).setAttribute("ID","botonContenido" );
      ((Element)v.get(170)).setAttribute("tipo","html" );
      ((Element)v.get(170)).setAttribute("ontab","compruebatab();" );
      ((Element)v.get(170)).setAttribute("accion","onClickBuscar();" );
      ...
      /* Empieza nodo:173 / Elemento padre: 18   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(18)).appendChild((Element)v.get(173));
      ...
      /* Empieza nodo:180 / Elemento padre: 7   */
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(180)).setAttribute("nombre","capaLista" );
      ...
      ((Element)v.get(180)).setAttribute("y","240" );
      ((Element)v.get(180)).setAttribute("zindex","" );
      ((Element)v.get(7)).appendChild((Element)v.get(180));

      /* Empieza nodo:181 / Elemento padre: 180   */
      v.add(doc.createElement("LISTAEDITABLE"));
      ((Element)v.get(181)).setAttribute("nombre","listado1" );
      ((Element)v.get(181)).setAttribute("ancho","612" );
      ((Element)v.get(181)).setAttribute("alto","317" );
   ...
   private void getXML720(Document doc) {
      ...
      ((Element)v.get(185)).setAttribute("ordenar","ascendente_on.gif" );
      ((Element)v.get(185)).setAttribute("ordenarInv","descendente_on.gif" );
      ...
      ((Element)v.get(191)).setAttribute("botonOrdenar","S" );
   ...
   private void getXML810(Document doc) {
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(200)).setAttribute("ancho","130" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(204)).setAttribute("ancho","50" );
      ...
      ((Element)v.get(208)).setAttribute("cod","263" );
      ...
      ((Element)v.get(209)).setAttribute("cod","16" );
      ...
      ((Element)v.get(210)).setAttribute("cod","17" );
      ...
      ((Element)v.get(211)).setAttribute("cod","18" );
      ...
      ((Element)v.get(212)).setAttribute("cod","93" );
      ...
      ((Element)v.get(214)).setAttribute("cod","757" );
      ...
      ((Element)v.get(215)).setAttribute("cod","1122" );
   ...
   private void getXML900(Document doc) {
      ((Element)v.get(216)).setAttribute("cod","1095" );
      ...
      ((Element)v.get(217)).setAttribute("cod","1074" );
      ...
      /* Empieza nodo:220 / Elemento padre: 181   */
      ...
      ((Element)v.get(181)).appendChild((Element)v.get(220));
      ...
      ((Element)v.get(181)).appendChild((Element)v.get(234));
   ...
   private void getXML990(Document doc) {
      ...
      ((Element)v.get(236)).setAttribute("y","298" );
      ...
      ((Element)v.get(180)).appendChild((Element)v.get(237));
      /* Termina nodo:237   */

      /* Empieza nodo:238 / Elemento padre: 180   */
      v.add(doc.createElement("BOTON"));
      ...
      ((Element)v.get(180)).appendChild((Element)v.get(238));
      /* Termina nodo:238   */

      /* Empieza nodo:239 / Elemento padre: 180   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(239)).setAttribute("nombre","Aceptar" );
      ((Element)v.get(239)).setAttribute("x","80" );
      ((Element)v.get(239)).setAttribute("y","295" );
      ...
      ((Element)v.get(239)).setAttribute("cod","12" );
      ((Element)v.get(239)).setAttribute("ontab","focaliza('formulario.cbMarca');" );
      ((Element)v.get(239)).setAttribute("onshtab","document.all['btnBuscar'].focus();" );
      ((Element)v.get(239)).setAttribute("accion","onClickAceptar();" );
      ((Element)v.get(180)).appendChild((Element)v.get(239));
      /* Termina nodo:239   */
      /* Termina nodo:180   */

      /* Empieza nodo:240 / Elemento padre: 7   */
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(240)).setAttribute("nombre","capaEspacio" );
      ((Element)v.get(240)).setAttribute("alto","12" );
      ((Element)v.get(240)).setAttribute("ancho","50" );
      ((Element)v.get(240)).setAttribute("x","0" );
      ((Element)v.get(240)).setAttribute("y","557" );
      ((Element)v.get(7)).appendChild((Element)v.get(240));
      /* Termina nodo:240   */
      /* Termina nodo:7   */
