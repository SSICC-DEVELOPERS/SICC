...
public class PedAtribEspecPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","PedAtribEspec.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","PedAtribEspec.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('pedAtribEspecFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('pedAtribEspecFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(50)).setAttribute("nombre","codAtriTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lblCodAtri" );
      ((Element)v.get(54)).setAttribute("alto","13" );
      ((Element)v.get(54)).setAttribute("filas","1" );
      ((Element)v.get(54)).setAttribute("id","datosTitle" );
      ((Element)v.get(54)).setAttribute("cod","PedAtribEspec.codAtri.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(55)).setAttribute("nombre","codAtriWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(57)).setAttribute("nombre","codAtri" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('pedAtribEspecFrm',2, true)" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('pedAtribEspecFrm', 2, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(58)).setAttribute("nombre","codAtriGapTdId" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(75)).setAttribute("nombre","desAtriTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(80)).setAttribute("nombre","desAtriWidgetTrId" );
   }
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(82)).setAttribute("nombre","desAtri" );
      ...
      ((Element)v.get(82)).setAttribute("ontab","ejecutarAccionFoco('pedAtribEspecFrm',3, true)" );
      ((Element)v.get(82)).setAttribute("onshtab","ejecutarAccionFoco('pedAtribEspecFrm', 3, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(83)).setAttribute("nombre","desAtriGapTdId" );
   ...
   private void getXML450(Document doc) {
      ((Element)v.get(100)).setAttribute("nombre","valFormTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(105)).setAttribute("nombre","valFormWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(107)).setAttribute("nombre","valForm" );
      ...
      ((Element)v.get(107)).setAttribute("ontab","ejecutarAccionFoco('pedAtribEspecFrm',4, true)" );
      ((Element)v.get(107)).setAttribute("onshtab","ejecutarAccionFoco('pedAtribEspecFrm', 4, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(108)).setAttribute("nombre","valFormGapTdId" );
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(125)).setAttribute("nombre","moduOidModuTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(129)).setAttribute("nombre","lblmoduOidModu" );
      ...
      ((Element)v.get(129)).setAttribute("cod","PedAtribEspec.moduOidModu.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(130)).setAttribute("nombre","moduOidModuWidgetTrId" );
      ...
      ((Element)v.get(132)).setAttribute("nombre","moduOidModu" );
      ...
      ((Element)v.get(132)).setAttribute("ontab","ejecutarAccionFoco('pedAtribEspecFrm',5, true);" );
      ((Element)v.get(132)).setAttribute("onshtab","ejecutarAccionFoco('pedAtribEspecFrm',5, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(134)).setAttribute("nombre","moduOidModuGapTdId" );
   ...
   private void getXML630(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(148)).setAttribute("nombre","pedAtribEspecTrButtons" );
      ...
      ((Element)v.get(155)).setAttribute("nombre","pedAtribEspecTdQueryButton" );
      ((Element)v.get(154)).appendChild((Element)v.get(155));

      /* Empieza nodo:156 / Elemento padre: 155   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(156)).setAttribute("nombre","pedAtribEspecQueryButton" );
      ((Element)v.get(156)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(156)).setAttribute("estado","false" );
      ((Element)v.get(156)).setAttribute("accion","pedAtribEspecFirstPage();" );
      ...
      ((Element)v.get(157)).setAttribute("nombre","pedAtribEspecTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(159)).setAttribute("nombre","pedAtribEspecLovNullButton" );
      ((Element)v.get(159)).setAttribute("ID","botonContenido" );
      ((Element)v.get(159)).setAttribute("tipo","html" );
      ((Element)v.get(159)).setAttribute("accion","pedAtribEspecLovNullSelectionAction();" );
