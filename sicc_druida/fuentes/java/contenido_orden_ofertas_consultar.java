...
/* Primer nodo */
   ...
   private void getXML810(Document doc) {
      ...
      v.add(doc.createTextNode("Nº órden"));
      ...
      v.add(doc.createTextNode("Nº oferta"));
   ...
   private void getXML900(Document doc) {
      ...
      v.add(doc.createTextNode("Descripción producto/Texto"));
      ...
      v.add(doc.createTextNode("Imprimible guía"));
