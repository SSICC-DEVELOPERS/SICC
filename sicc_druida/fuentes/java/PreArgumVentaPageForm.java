...
public class PreArgumVentaPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","PreArgumVenta.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","PreArgumVenta.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('preArgumVentaFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('preArgumVentaFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(50)).setAttribute("nombre","codArguVentTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lblCodArguVent" );
      ((Element)v.get(54)).setAttribute("alto","13" );
      ((Element)v.get(54)).setAttribute("filas","1" );
      ((Element)v.get(54)).setAttribute("id","datosTitle" );
      ((Element)v.get(54)).setAttribute("cod","PreArgumVenta.codArguVent.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(55)).setAttribute("nombre","codArguVentWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(57)).setAttribute("nombre","codArguVent" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('preArgumVentaFrm',2, true)" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('preArgumVentaFrm', 2, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(58)).setAttribute("nombre","codArguVentGapTdId" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(64)).setAttribute("cod","PreArgumVenta.Descripcion.label" );
      ...
      ((Element)v.get(68)).setAttribute("ontab","ejecutarAccionFoco('preArgumVentaFrm',3, true)" );
      ((Element)v.get(68)).setAttribute("onshtab","ejecutarAccionFoco('preArgumVentaFrm', 3, false)" );
      ...
      ((Element)v.get(72)).setAttribute("href","javascript:openLocalizationDialog('preArgumVentaFrm', 'Descripcion', 1);" );
      ((Element)v.get(72)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"preArgumVentaFrm\",3, true)', 'ejecutarAccionFoco(\"preArgumVentaFrm\",3, false)')" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(76)).setAttribute("nombre","tiesOidTipoEstrTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(80)).setAttribute("nombre","lbltiesOidTipoEstr" );
      ((Element)v.get(80)).setAttribute("id","datosTitle" );
      ((Element)v.get(80)).setAttribute("ancho","150" );
      ((Element)v.get(80)).setAttribute("alto","13" );
      ((Element)v.get(80)).setAttribute("cod","PreArgumVenta.tiesOidTipoEstr.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(81)).setAttribute("nombre","tiesOidTipoEstrWidgetTrId" );
      ...
      ((Element)v.get(83)).setAttribute("nombre","tiesOidTipoEstr" );
      ...
      ((Element)v.get(83)).setAttribute("ontab","ejecutarAccionFoco('preArgumVentaFrm',4, true);" );
      ((Element)v.get(83)).setAttribute("onshtab","ejecutarAccionFoco('preArgumVentaFrm',4, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(85)).setAttribute("nombre","tiesOidTipoEstrGapTdId" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(87)).setAttribute("nombre","valFactRepeTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(91)).setAttribute("nombre","lblValFactRepe" );
      ((Element)v.get(91)).setAttribute("alto","13" );
      ((Element)v.get(91)).setAttribute("filas","1" );
      ((Element)v.get(91)).setAttribute("id","datosTitle" );
      ((Element)v.get(91)).setAttribute("cod","PreArgumVenta.valFactRepe.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(92)).setAttribute("nombre","valFactRepeWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(94)).setAttribute("nombre","valFactRepe" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(94)).setAttribute("ontab","ejecutarAccionFoco('preArgumVentaFrm',5, true)" );
      ((Element)v.get(94)).setAttribute("onshtab","ejecutarAccionFoco('preArgumVentaFrm', 5, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(95)).setAttribute("nombre","valFactRepeGapTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(109)).setAttribute("nombre","preArgumVentaTrButtons" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(116)).setAttribute("nombre","preArgumVentaTdQueryButton" );
      ((Element)v.get(115)).appendChild((Element)v.get(116));

      /* Empieza nodo:117 / Elemento padre: 116   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(117)).setAttribute("nombre","preArgumVentaQueryButton" );
      ((Element)v.get(117)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(117)).setAttribute("estado","false" );
      ((Element)v.get(117)).setAttribute("accion","preArgumVentaFirstPage();" );
      ...
      ((Element)v.get(118)).setAttribute("nombre","preArgumVentaTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(120)).setAttribute("nombre","preArgumVentaLovNullButton" );
      ((Element)v.get(120)).setAttribute("ID","botonContenido" );
      ((Element)v.get(120)).setAttribute("tipo","html" );
      ((Element)v.get(120)).setAttribute("accion","preArgumVentaLovNullSelectionAction();" );
