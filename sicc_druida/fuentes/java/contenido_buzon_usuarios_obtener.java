...
public class contenido_buzon_usuarios_obtener  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_buzon_usuarios_obtener" );
      ((Element)v.get(0)).setAttribute("cod","0759" );
      ((Element)v.get(0)).setAttribute("titulo","Obtener buzón de usuarios" );
      ...
      v.add(doc.createTextNode("\r   \r   \r   function onLoad(){\r      configurarMenuSecundario('Formulario');\r      fMostrarMensajeError();\r      focaliza('Formulario.txtFechaInicio');\r   }\r   function generar(formato){\r     if(sicc_validaciones_generales()){\r        if(validarFechas()){\r\r           var a = new Object();\r           a.accion = 'generar';\r           a.fechaInicio = get('Formulario.txtFechaInicio');\r           a.fechaFin = get('Formulario.txtFechaFin');      \r           a.buzon = get('Formulario.cbBuzon');\r           a.buzonDesc = get('Formulario.cbBuzon', 'T');\r           a.codigoCliente = get('Formulario.txtCliente');         \r           mostrarModalSICC('CALBuzonUsuarios','generar', a); \r        }\r     }\r   }\r\r   function recolectarParametros(){\r           \r      set('Formulario.fechaInicio', get('Formulario.txtFechaInicio'));\r      set('Formulario.fechaFin', get('Formulario.txtFechaFin'));      \r      set('Formulario.buzon', get('Formulario.cbBuzon'));\r      set('Formulario.codigoCliente', get('Formulario.txtCliente'));\r            \r   }\r \r   \r\r   function fLimpiar(){\r     focaliza('Formulario.txtFechaInicio');\r   }\r\r\r  function validarFechas(){\r      var fechaInicio = get('Formulario.txtFechaInicio');\r      var fechaFin = get('Formulario.txtFechaFin');\r      var formatoFecha = get('Formulario.hFormatoFechaPais');\r           \r     \r      if (! EsFechaValida_SICC(fechaInicio , \"Formulario\")){\r         GestionarMensaje(\"1006\", formatoFecha, null, null);\r         focaliza(\"Formulario.txtFechaInicio\");\r         return false;\r      }\r     \r      if(! EsFechaValida_SICC(fechaFin , \"Formulario\")){\r         GestionarMensaje(\"1006\", formatoFecha, null, null);\r         focaliza(\"Formulario.txtFechaFin\");\r         return false;\r      }\r               \r      var errorLevel = EsFechaValida( fechaInicio, fechaFin, \"Formulario\", \"S\");\r      if ( errorLevel == 3){\r         GestionarMensaje(\"1191\");\r         focaliza('Formulario.txtFechaInicio');\r         return false;\r      }\r     \r      return true;   \r   \r   }\r   \r\r  function buscarCliente(){ \r      var obj = new Object();\r\r      var whnd = mostrarModalSICC('LPBusquedaRapidaCliente','',obj);\r    \r      if(whnd==null){\r                }else{\r          var cod = whnd[1];\r                    set('Formulario.txtCliente', cod)\r      }          \r   }\r   \r\r  function clienteOnBlur() {\r\r         var longiCod = get('Formulario.hLongCliente');\r         var elTexto  = get('Formulario.txtCliente');\r\r         if(elTexto.length!=0){\r            var faltantes = longiCod -  elTexto.length;\r            var resultCod = new String(\"\");\r            if(faltantes > 0){\r                for(var t = 0 ; t<faltantes; t++){\r                    resultCod = resultCod + \"0\";\r                }\r          }\r          resultCod = resultCod + elTexto;\r          set('Formulario.txtCliente', resultCod);\r         }\r              \r   }\r\r \r\r\r   \r"));
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(20)).setAttribute("nombre","hLongCliente" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(48)).setAttribute("nombre","lblFechaInicio" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(56)).setAttribute("nombre","lblBuzon" );
      ...
      ((Element)v.get(56)).setAttribute("cod","1980" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(60)).setAttribute("nombre","lblCliente" );
      ...
      ((Element)v.get(60)).setAttribute("cod","1471" );
      ...
      ((Element)v.get(67)).setAttribute("nombre","txtFechaInicio" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(71)).setAttribute("nombre","txtFechaFin" );
      ...
      ((Element)v.get(74)).setAttribute("valign","bottom" );
      ((Element)v.get(63)).appendChild((Element)v.get(74));

      /* Empieza nodo:75 / Elemento padre: 74   */
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(75)).setAttribute("nombre","cbBuzon" );
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(80)).setAttribute("nombre","txtCliente" );
      ...
      ((Element)v.get(80)).setAttribute("size","19" );
      ((Element)v.get(80)).setAttribute("valor","" );
      ((Element)v.get(80)).setAttribute("validacion","" );
      ((Element)v.get(80)).setAttribute("onblur","clienteOnBlur();" );
      ...
      /* Empieza nodo:83 / Elemento padre: 63   */
      v.add(doc.createElement("td"));
      ((Element)v.get(63)).appendChild((Element)v.get(83));

      /* Empieza nodo:84 / Elemento padre: 83   */
      v.add(doc.createElement("IMG"));
      ((Element)v.get(84)).setAttribute("src","iconBuscar.gif" );
      ((Element)v.get(84)).setAttribute("onclick","buscarCliente();" );
   ...
   private void getXML360(Document doc) {
      ...
      /* Empieza nodo:92 / Elemento padre: 22   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(22)).appendChild((Element)v.get(92));
      ...
      ((Element)v.get(100)).setAttribute("nombre","btnGenerarInforme" );
      ((Element)v.get(100)).setAttribute("ID","botonContenido" );
      ((Element)v.get(100)).setAttribute("tipo","html" );
      ((Element)v.get(100)).setAttribute("accion","generar();" );
      ((Element)v.get(100)).setAttribute("estado","false" );
      ((Element)v.get(100)).setAttribute("cod","2495" );
      ((Element)v.get(100)).setAttribute("ontab","focaliza('Formulario.txtFechaInicio')" );
