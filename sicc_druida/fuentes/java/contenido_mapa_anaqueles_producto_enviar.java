...
public class contenido_mapa_anaqueles_producto_enviar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_mapa_anaqueles_producto_enviar" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","contenido_mapa_anaqueles_producto_enviar.js" );
      ...
      ((Element)v.get(6)).setAttribute("cod","EduTipoCurso.marcOidMarc.label" );
      ...
      ((Element)v.get(7)).setAttribute("cod","FacAsignImpre.canaOidCana.label" );
      ...
      ((Element)v.get(9)).setAttribute("cod","ApeConfCentroDistribucion.centroDistrib.label" );
      ...
      ((Element)v.get(10)).setAttribute("cod","ApeGestVAsigProdAnaqueles.mapaCentro.label" );
      ((Element)v.get(5)).appendChild((Element)v.get(10));
      /* Termina nodo:10   */

      /* Empieza nodo:11 / Elemento padre: 5   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(11)).setAttribute("name","cbVersionAsignacion" );
      ((Element)v.get(11)).setAttribute("required","true" );
      ((Element)v.get(11)).setAttribute("cod","3026" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(22)).setAttribute("nombre","hCbPeriodo" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(24)).setAttribute("nombre","hCbMapaCentroDistribucion" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(25)).setAttribute("nombre","hCbVersionAsignacion" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(26)).setAttribute("nombre","hPeriodosActualesDefault" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(51)).setAttribute("cod","EduTipoCurso.marcOidMarc.label" );
      ...
      ((Element)v.get(55)).setAttribute("cod","FacAsignImpre.canaOidCana.label" );
      ...
      ((Element)v.get(66)).setAttribute("onchange","onChangeCbMarca();" );
      ((Element)v.get(66)).setAttribute("onshtab","onShTABMarca();" );
      ((Element)v.get(66)).setAttribute("ontab","onTABMarca();" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(71)).setAttribute("onchange","onChangeCbCanal();" );
      ((Element)v.get(71)).setAttribute("onshtab","onShTABCanal();" );
      ((Element)v.get(71)).setAttribute("ontab","onTABCanal();" );
      ...
      ((Element)v.get(76)).setAttribute("onchange","onChangeCbPeriodo();" );
      ((Element)v.get(76)).setAttribute("onshtab","onShTABPeriodo();" );
      ((Element)v.get(76)).setAttribute("ontab","onTABPeriodo();" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(91)).setAttribute("nombre","lblCentroDistribucion" );
      ((Element)v.get(91)).setAttribute("alto","13" );
      ((Element)v.get(91)).setAttribute("filas","1" );
      ((Element)v.get(91)).setAttribute("valor","" );
      ((Element)v.get(91)).setAttribute("id","datosTitle" );
      ((Element)v.get(91)).setAttribute("cod","ApeConfCentroDistribucion.centroDistrib.label" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(95)).setAttribute("nombre","lblMapaCentroDistribucion" );
      ...
      ((Element)v.get(95)).setAttribute("cod","ApeGestVAsigProdAnaqueles.mapaCentro.label" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(102)).setAttribute("nombre","cbCentroDistribucion" );
      ...
      ((Element)v.get(102)).setAttribute("onchange","onChangeCentroDistribucion();" );
      ((Element)v.get(102)).setAttribute("onshtab","onShTABCentrDistr();" );
      ((Element)v.get(102)).setAttribute("ontab","onTABCentrDistr();" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(107)).setAttribute("nombre","cbMapaCentroDistribucion" );
      ...
      ((Element)v.get(107)).setAttribute("onchange","onChangeCbMapaCentroDistribucion();" );
      ((Element)v.get(107)).setAttribute("onshtab","onShTABMapaCentrDistr();" );
      ((Element)v.get(107)).setAttribute("ontab","onTABMapaCentrDistr();" );
   ...
   private void getXML450(Document doc) {
      ...
      /* Empieza nodo:114 / Elemento padre: 40   */
      v.add(doc.createElement("table"));
      ...
      ((Element)v.get(40)).appendChild((Element)v.get(114));
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(122)).setAttribute("nombre","lblVersionAsignacion" );
      ...
      ((Element)v.get(122)).setAttribute("cod","3026" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(129)).setAttribute("nombre","cbVersionAsignacion" );
      ...
      ((Element)v.get(129)).setAttribute("onshtab","onShTABVersion();" );
      ((Element)v.get(129)).setAttribute("ontab","onTABVersion();" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(140)).setAttribute("nombre","btnEnviar" );
      ((Element)v.get(140)).setAttribute("ID","botonContenido" );
      ((Element)v.get(140)).setAttribute("tipo","html" );
      ((Element)v.get(140)).setAttribute("accion","onClickEnviar();" );
      ((Element)v.get(140)).setAttribute("onshtab","onShTABBtnEnviar();" );
      ((Element)v.get(140)).setAttribute("ontab","onTABBtnEnviar();" );
      ((Element)v.get(140)).setAttribute("estado","false" );
      ((Element)v.get(140)).setAttribute("cod","1597" );
