...
public class contenido_informe_facturacion_companias_generar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_informe_facturacion_campania_generar" );
      ((Element)v.get(0)).setAttribute("cod","0774" );
      ((Element)v.get(0)).setAttribute("titulo","Generar informe facturación entre compañías de MAV" );
      ...
      v.add(doc.createTextNode("\r   \r   \r   function onLoad(){\r      configurarMenuSecundario('Formulario');\r      fMostrarMensajeError();\r      setearPais();\r      onChangePais();\r      focaliza('Formulario.cbPais');\r   }\r   function generar(formato){\r      \r      if(sicc_validaciones_generales()){\r         if(validarFechas()){\r            /*recolectarParametros();\r            set('Formulario.conectorAction', 'MAVFacturacionEntreCompanias');           \r            set('Formulario.accion', 'generar');\r            enviaSICC('Formulario');*/\r            var a = new Object();\r            a.accion = 'generar';\r            a.paisSelec = get('Formulario.cbPais');  \r            a.marca = quitarItemVacio(get('Formulario.cbMarca'));\r            a.canal = quitarItemVacio(get('Formulario.cbCanal'));\r            a.canalDesc = get('Formulario.cbCanal', 'T');\r            a.actividad = quitarItemVacio(get('Formulario.cbActividad'));\r            a.actividadesDesc = quitarItemVacio(get('Formulario.cbActividad', 'T'));\r            a.fechaDesde = get('Formulario.txtFechaDesde');\r            a.fechaHasta = get('Formulario.txtFechaHasta');         \r            mostrarModalSICC('MAVFacturacionEntreCompanias','generar', a);  \r         }\r    \r      }\r\r   }\r\r\r\r   function recolectarParametros(){\r      \r           \r      set('Formulario.paisSelec', get('Formulario.cbPais') );  \r      set('Formulario.marca', quitarItemVacio(get('Formulario.cbMarca')));\r      set('Formulario.canal', quitarItemVacio(get('Formulario.cbCanal')));\r      set('Formulario.actividad', quitarItemVacio(get('Formulario.cbActividad')));\r      set('Formulario.actividadesDesc', quitarItemVacio(get('Formulario.cbActividad', 'T')));\r      set('Formulario.fechaDesde', get('Formulario.txtFechaDesde'));\r      set('Formulario.fechaHasta', get('Formulario.txtFechaHasta'));\r      \r   }\r \r   \r\r   function fLimpiar(){\r      var aCombo = new Array(new Array(\"\",\"\"));\r      set_combo('Formulario.cbActividad', aCombo, []);\r      \r      \r      focaliza('Formulario.cbPais');\r \r   }\r   \r    function onChangePais(){\r    \r       pais   = get('Formulario.cbPais');\r       idioma = get('Formulario.idioma');\r              \r       if(pais != ''){\r          var arr2 = new Array();\r          arr2[arr2.length] = ['oidPais', pais];\r          arr2[arr2.length] = ['oidIdioma', idioma];\r          recargaCombo(\"Formulario.cbActividad\",\"MAVObtieneActividadesMAV\", \"es.indra.sicc.dtos.mav.DTOActividadMAV\", arr2); \r    \r       }\r   \r    } \r \r\r   function setearPais(){\r      var pais = get('Formulario.pais');\r      \r      iSeleccionado = new Array(); \r      iSeleccionado[0] = pais;\r      set('Formulario.cbPais',iSeleccionado);\r   }\r\r   function validarFechas(){\r   \r      var fechaDesde = get('Formulario.txtFechaDesde');\r      var fechaHasta = get('Formulario.txtFechaHasta');\r      var formatoFecha = get('Formulario.hFormatoFechaPais');\r           \r      if(fechaDesde != ''){\r          if (! EsFechaValida_SICC(fechaDesde , \"Formulario\")){\r             GestionarMensaje(\"1006\", formatoFecha, null, null);\r             focaliza(\"Formulario.txtFechaDesde\");\r             return false;\r          }\r      }\r      \r      if(fechaHasta != ''){\r          if (! EsFechaValida_SICC(fechaHasta , \"Formulario\")){\r             GestionarMensaje(\"1006\", formatoFecha, null, null);\r             focaliza(\"Formulario.txtFechaHasta\");\r             return false;\r          }\r      }\r\r      if(fechaDesde != '' && fechaHasta != ''){\r           var errorLevel = EsFechaValida( fechaDesde, fechaHasta, \"Formulario\", \"S\");\r           if ( errorLevel == 3){\r              GestionarMensaje(\"1191\");\r              focaliza('Formulario.txtFechaDesde');\r              return false;\r           }\r          \r      }\r      \r      return true;\r \r   }\r   \r   function quitarItemVacio(elemento){\r      var elementoADevolver = new Array();\r     \r      for(var k=0;k<elemento.length;k++) {\r         if (elemento[k] != ''){ 			 \r            elementoADevolver[elementoADevolver.length] = elemento[k];\r         }\r      }\r        \r      return elementoADevolver;\r      \r   }\r     \r\r   \r"));
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(10)).setAttribute("name","cbActividad" );
      ((Element)v.get(10)).setAttribute("required","true" );
      ((Element)v.get(10)).setAttribute("cod","173" );
      ((Element)v.get(6)).appendChild((Element)v.get(10));
      /* Termina nodo:10   */

      /* Empieza nodo:11 / Elemento padre: 6   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(11)).setAttribute("name","txtFechaDesde" );
      ((Element)v.get(11)).setAttribute("required","true" );
      ((Element)v.get(11)).setAttribute("cod","59" );
      ((Element)v.get(6)).appendChild((Element)v.get(11));
      /* Termina nodo:11   */

      /* Empieza nodo:12 / Elemento padre: 6   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(12)).setAttribute("name","txtFechaHasta" );
      ((Element)v.get(12)).setAttribute("required","true" );
      ((Element)v.get(12)).setAttribute("cod","1339" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(24)).setAttribute("nombre","actividad" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(25)).setAttribute("nombre","actividadesDesc" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(62)).setAttribute("onchange","onChangePais();" );
   ...
   private void getXML360(Document doc) {
      ...
      /* Empieza nodo:99 / Elemento padre: 44   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(44)).appendChild((Element)v.get(99));
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(110)).setAttribute("nombre","lblFechaDesde" );
      ((Element)v.get(110)).setAttribute("alto","13" );
      ((Element)v.get(110)).setAttribute("filas","1" );
      ((Element)v.get(110)).setAttribute("cod","59" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(114)).setAttribute("nombre","lblFechaHasta" );
      ((Element)v.get(114)).setAttribute("alto","13" );
      ((Element)v.get(114)).setAttribute("filas","1" );
      ((Element)v.get(114)).setAttribute("cod","1339" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(121)).setAttribute("nombre","cbActividad" );
      ...
      ((Element)v.get(126)).setAttribute("nombre","txtFechaDesde" );
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(130)).setAttribute("nombre","txtFechaHasta" );
      ...
      ((Element)v.get(130)).setAttribute("size","12" );
   ...
   private void getXML540(Document doc) {
      ...
      /* Empieza nodo:138 / Elemento padre: 29   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(29)).appendChild((Element)v.get(138));
      ...
      ((Element)v.get(146)).setAttribute("nombre","btnGenerarInforme" );
      ((Element)v.get(146)).setAttribute("ID","botonContenido" );
      ((Element)v.get(146)).setAttribute("tipo","html" );
      ((Element)v.get(146)).setAttribute("accion","generar()" );
      ((Element)v.get(146)).setAttribute("estado","false" );
      ((Element)v.get(146)).setAttribute("cod","2495" );
      ((Element)v.get(146)).setAttribute("ontab","focaliza('Formulario.cbPais');" );
      ...
      /* Empieza nodo:149 / Elemento padre: 29   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(29)).appendChild((Element)v.get(149));
