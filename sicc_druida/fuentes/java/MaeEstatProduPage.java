...
public class MaeEstatProduPage  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","MaeEstatProduPage" );
      ((Element)v.get(0)).setAttribute("titulo","" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","" );
      ((Element)v.get(0)).setAttribute("onload","maeEstatProduInitComponents()" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","maeestatprodu.js" );
      ((Element)v.get(0)).appendChild((Element)v.get(4));
      /* Termina nodo:4   */

      /* Empieza nodo:5 / Elemento padre: 0   */
      v.add(doc.createElement("FORMULARIO"));
      ((Element)v.get(5)).setAttribute("nombre","maeEstatProduFrm" );
      ...
      ((Element)v.get(6)).setAttribute("valor","MaeEstatProduLPExecution" );
      ...
      ((Element)v.get(7)).setAttribute("valor","MaeEstatProduLPExecution" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(37)).setAttribute("nombre","maeEstatProduFormLayer" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(52)).setAttribute("cod","MaeEstatProdu.legend.label" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(67)).setAttribute("cod","MaeEstatProdu.id.label" );
      ...
      ((Element)v.get(70)).setAttribute("ontab","ejecutarAccionFoco('maeEstatProduFrm',1, true)" );
      ((Element)v.get(70)).setAttribute("onshtab","ejecutarAccionFoco('maeEstatProduFrm', 1, false)" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(92)).setAttribute("cod","MaeEstatProdu.paisOidPais.label" );
      ...
      ((Element)v.get(95)).setAttribute("ontab","ejecutarAccionFoco('maeEstatProduFrm',2, true);" );
      ((Element)v.get(95)).setAttribute("onshtab","ejecutarAccionFoco('maeEstatProduFrm',2, false);" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(114)).setAttribute("nombre","codEstaProdTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(119)).setAttribute("nombre","codEstaProdWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(121)).setAttribute("nombre","codEstaProd" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(121)).setAttribute("ontab","ejecutarAccionFoco('maeEstatProduFrm',3, true)" );
      ((Element)v.get(121)).setAttribute("onshtab","ejecutarAccionFoco('maeEstatProduFrm', 3, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(122)).setAttribute("nombre","codEstaProdGapTdId" );
      ...
      ((Element)v.get(128)).setAttribute("cod","MaeEstatProdu.Descripcion.label" );
      ...
      ((Element)v.get(132)).setAttribute("ontab","ejecutarAccionFoco('maeEstatProduFrm',4, true)" );
      ((Element)v.get(132)).setAttribute("onshtab","ejecutarAccionFoco('maeEstatProduFrm', 4, false)" );
      ...
      ((Element)v.get(136)).setAttribute("href","javascript:openLocalizationDialog('maeEstatProduFrm', 'Descripcion', 1);" );
      ((Element)v.get(136)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"maeEstatProduFrm\",4, true)', 'ejecutarAccionFoco(\"maeEstatProduFrm\",4, false)')" );
   ...
   private void getXML630(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(152)).setAttribute("nombre","maeEstatProduTrButtons" );
      ...
      ((Element)v.get(159)).setAttribute("nombre","maeEstatProduTdQueryButton" );
      ((Element)v.get(158)).appendChild((Element)v.get(159));

      /* Empieza nodo:160 / Elemento padre: 159   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(160)).setAttribute("nombre","maeEstatProduQueryButton" );
      ((Element)v.get(160)).setAttribute("cod","MMGGlobal.queryButton.label" );
   }

   private void getXML720(Document doc) {
      ((Element)v.get(160)).setAttribute("estado","false" );
      ((Element)v.get(160)).setAttribute("accion","maeEstatProduFirstPage();" );
      ...
      ((Element)v.get(161)).setAttribute("nombre","maeEstatProduTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(163)).setAttribute("nombre","maeEstatProduLovNullButton" );
      ((Element)v.get(163)).setAttribute("ID","botonContenido" );
      ((Element)v.get(163)).setAttribute("tipo","html" );
      ((Element)v.get(163)).setAttribute("accion","maeEstatProduLovNullSelectionAction();" );
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(166)).setAttribute("nombre","maeEstatProduListLayer" );
      ...
      ((Element)v.get(167)).setAttribute("nombre","maeEstatProduList" );
   ...
   private void getXML810(Document doc) {
      ...
      ((Element)v.get(180)).setAttribute("cod","MaeEstatProdu.codEstaProd.label" );
      ...
      ((Element)v.get(181)).setAttribute("cod","MaeEstatProdu.Descripcion.label" );
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(186)).setAttribute("nombre","maeEstatProduListButtonsLayer" );
   ...
   private void getXML900(Document doc) {
      ...
      ((Element)v.get(192)).setAttribute("nombre","maeEstatProduPaginationButtonBar" );
      ...
      ((Element)v.get(193)).setAttribute("nombre","maeEstatProduFirstPageButton" );
      ((Element)v.get(193)).setAttribute("funcion","maeEstatProduFirstPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(194)).setAttribute("nombre","maeEstatProduFirstPageButtonGapTd" );
      ...
      v.add(doc.createElement("BTN"));
      ((Element)v.get(196)).setAttribute("nombre","maeEstatProduPreviousPageButton" );
      ((Element)v.get(196)).setAttribute("funcion","maeEstatProduPreviousPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(197)).setAttribute("nombre","maeEstatProduPreviousPageButtonGapTd" );
      ...
      v.add(doc.createElement("BTN"));
      ((Element)v.get(199)).setAttribute("nombre","maeEstatProduNextPageButton" );
      ((Element)v.get(199)).setAttribute("funcion","maeEstatProduNextPage();" );
      ...
      ((Element)v.get(202)).setAttribute("nombre","maeEstatProduUpdateButtonTd" );
      ((Element)v.get(188)).appendChild((Element)v.get(202));

      /* Empieza nodo:203 / Elemento padre: 202   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(203)).setAttribute("nombre","maeEstatProduUpdateButton" );
      ((Element)v.get(203)).setAttribute("ID","botonContenido" );
      ((Element)v.get(203)).setAttribute("tipo","html" );
      ((Element)v.get(203)).setAttribute("accion","maeEstatProduUpdateSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(204)).setAttribute("nombre","maeEstatProduUpdateButtonGapTd" );
   }
   ...
   private void getXML990(Document doc) {
      ...
      ((Element)v.get(206)).setAttribute("nombre","maeEstatProduViewForRemoveButtonTd" );
      ((Element)v.get(188)).appendChild((Element)v.get(206));

      /* Empieza nodo:207 / Elemento padre: 206   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(207)).setAttribute("nombre","maeEstatProduViewForRemoveButton" );
      ((Element)v.get(207)).setAttribute("ID","botonContenido" );
      ((Element)v.get(207)).setAttribute("tipo","html" );
      ((Element)v.get(207)).setAttribute("accion","maeEstatProduViewSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(208)).setAttribute("nombre","maeEstatProduViewForRemoveButtonGapTd" );
      ...
      ((Element)v.get(210)).setAttribute("nombre","maeEstatProduLovSelectButtonTd" );
      ((Element)v.get(188)).appendChild((Element)v.get(210));

      /* Empieza nodo:211 / Elemento padre: 210   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(211)).setAttribute("nombre","maeEstatProduLovSelectButton" );
      ((Element)v.get(211)).setAttribute("ID","botonContenido" );
      ((Element)v.get(211)).setAttribute("tipo","html" );
      ((Element)v.get(211)).setAttribute("accion","maeEstatProduLovSelectionAction();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(212)).setAttribute("nombre","maeEstatProduLovSelectButtonGapTd" );
      ...
      ((Element)v.get(214)).setAttribute("nombre","maeEstatProduViewButtonTd" );
      ((Element)v.get(188)).appendChild((Element)v.get(214));

      /* Empieza nodo:215 / Elemento padre: 214   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(215)).setAttribute("nombre","maeEstatProduViewButton" );
      ((Element)v.get(215)).setAttribute("ID","botonContenido" );
      ((Element)v.get(215)).setAttribute("tipo","html" );
      ((Element)v.get(215)).setAttribute("accion","maeEstatProduViewSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(216)).setAttribute("nombre","maeEstatProduViewButtonGapTd" );
