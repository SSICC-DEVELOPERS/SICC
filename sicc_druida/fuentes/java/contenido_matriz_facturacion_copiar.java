...
public class contenido_matriz_facturacion_copiar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      v.add(doc.createTextNode("\r \r    function onLoad(){\r        if( !fMostrarMensajeError() ){\r            configurarMenuSecundario(\"frmFormulario\");\r            btnProxy(1,0);\r            btnProxy(2,0);\r\r						accion('frmFormulario.ckOrdenarCodVenta', '.disabled=true'); \r\r			posicionaCombos();\r\r            if (get('frmFormulario.bandera')==\"OK\"){\r                GestionarMensaje(\"804\");\r            }\r        }\r        \r    }\r\r    function posicionaCombos(){\r		var array = new Array();\r		array[0]=get(\"frmFormulario.hoidProgramaFidelizacion\");\r		set('frmFormulario.cbProgramaFidelizacion',array);\r\r		array = new Array();\r		array[0]=get(\"frmFormulario.hoidVariante\");\r		set('frmFormulario.cbVariante',array);	\r\r				array = new Array();\r		array[0]=get(\"frmFormulario.hoidTipoOferta\");\r		set('frmFormulario.cbTipoOferta',array);	\r\r		set('frmFormulario.ckOrdenarCodVenta', get(\"frmFormulario.hIndOrdenarCodVenta\")); \r\r		if(get(\"frmFormulario.cbTipoOferta\") == \"\") {\r			if(get(\"frmFormulario.cbProgramaFidelizacion\") != \"\") {\r				accion('frmFormulario.ckOrdenarCodVenta', '.disabled=false'); \r			} else {\r				accion('frmFormulario.ckOrdenarCodVenta', '.disabled=true'); \r			}\r		} else {\r			accion('frmFormulario.ckOrdenarCodVenta', '.disabled=true'); \r		}\r    }\r\r    		function onChangeProgramaFidelizacion(){\r		if(get(\"frmFormulario.cbProgramaFidelizacion\") == \"\") {\r			set('frmFormulario.ckOrdenarCodVenta','N');\r			accion('frmFormulario.ckOrdenarCodVenta', '.disabled=true'); \r			accion('frmFormulario.cbTipoOferta', '.disabled=false'); \r		} else {\r			if(get(\"frmFormulario.cbTipoOferta\") == \"\") {\r				accion('frmFormulario.ckOrdenarCodVenta', '.disabled=false'); \r				accion('frmFormulario.cbTipoOferta', '.disabled=true'); \r			} else {\r				set('frmFormulario.cbTipoOferta','');\r				accion('frmFormulario.cbTipoOferta', '.disabled=true'); \r			}\r		}\r    }\r\r	 	 	function onChangeTipoOferta(){\r		if(get(\"frmFormulario.cbTipoOferta\") == \"\") {\r			if(get(\"frmFormulario.cbProgramaFidelizacion\") != \"\") {\r				accion('frmFormulario.ckOrdenarCodVenta', '.disabled=false'); \r				set('frmFormulario.cbProgramaFidelizacion','');\r				accion('frmFormulario.cbProgramaFidelizacion', '.disabled=false'); \r			} else {\r				accion('frmFormulario.cbProgramaFidelizacion', '.disabled=false'); \r			}\r		} else {\r			set('frmFormulario.ckOrdenarCodVenta','N');\r			accion('frmFormulario.ckOrdenarCodVenta', '.disabled=true'); \r			set('frmFormulario.cbProgramaFidelizacion','');\r			accion('frmFormulario.cbProgramaFidelizacion', '.disabled=true'); \r		}\r    }\r\r    function llamarAccion(accion){\r        set('frmFormulario.accion', accion);\r        set('frmFormulario.conectorAction', 'LPCopiarMF');\r        enviaSICC('frmFormulario');\r    }\r    \r    function copiar(){\r        if(!validar()){\r        }else{\r            set('frmFormulario.accion', 'Copiar');\r            set('frmFormulario.conectorAction', 'LPCopiarMF');\r            eval('frmFormulario').oculto='S';\r            enviaSICC('frmFormulario');\r        }\r    }\r\r    function fGuardar(){\r        if (validar()){\r            set( 'frmFormulario.accion', 'Copiar' );\r        }\r    }\r\r    function validar(){\r        if (get('frmFormulario.marcaOriginal')==\"\" &&   get('frmFormulario.marcaNueva')==\"\"){\r            GestionarMensaje(\"PRE0043\");\r            return false;\r        }\r        if (get('frmFormulario.marcaOriginal')==\"\"){\r            GestionarMensaje(\"1246\");\r		        return false;\r        }	\r        if (  get('frmFormulario.marcaNueva')==\"\"){\r            GestionarMensaje(\"1247\");\r            return false;\r        }\r        return true;\r    }\r\r    function fLimpiar(){\r        txt_to('lblMarca1XX',''); \r        txt_to('lblCanal1XX',''); \r        txt_to('lblPeriodo1XX',''); \r        txt_to('lblMarca2XX',''); \r        txt_to('lblCanal2XX',''); \r        txt_to('lblPeriodo2XX',''); \r        set( 'frmFormulario.hidLimpia', 'SI' );\r    }\r\r    function despuesDeCopiar(){\r        eval('frmFormulario').oculto='N';\r        fLimpiar();\r    }\r \r\r"));
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(10)).setAttribute("nombre","marcaOriginal" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(11)).setAttribute("nombre","canalOriginal" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(12)).setAttribute("nombre","periodoOriginal" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(13)).setAttribute("nombre","marcaNueva" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(14)).setAttribute("nombre","canalNueva" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(15)).setAttribute("nombre","periodoNueva" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(16)).setAttribute("nombre","bandera" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(17)).setAttribute("nombre","hidLimpia" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(18)).setAttribute("nombre","hoidProgramaFidelizacion" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(19)).setAttribute("nombre","hoidVariante" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(20)).setAttribute("nombre","hIndOrdenarCodVenta" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(21)).setAttribute("nombre","hoidTipoOferta" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(45)).setAttribute("nombre","lblMarca1" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(49)).setAttribute("nombre","lblCanal1" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(60)).setAttribute("nombre","lblMarca1XX" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(64)).setAttribute("nombre","lblCanal1XX" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(68)).setAttribute("nombre","lblPeriodo1XX" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(79)).setAttribute("nombre","lblProgramaFidelizacion" );
      ...
      ((Element)v.get(79)).setAttribute("cod","3052" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(83)).setAttribute("nombre","lblVariante" );
      ...
      ((Element)v.get(83)).setAttribute("cod","3053" );
      ...
      ((Element)v.get(90)).setAttribute("nombre","cbProgramaFidelizacion" );
      ((Element)v.get(90)).setAttribute("id","datosCampos" );
      ((Element)v.get(90)).setAttribute("onchange","onChangeProgramaFidelizacion();" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(95)).setAttribute("nombre","cbVariante" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(106)).setAttribute("nombre","lblOrdenarCodVenta" );
      ...
      ((Element)v.get(106)).setAttribute("cod","3387" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(110)).setAttribute("nombre","lblTipoOferta" );
      ...
      ((Element)v.get(110)).setAttribute("cod","608" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(117)).setAttribute("nombre","ckOrdenarCodVenta" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(121)).setAttribute("nombre","cbTipoOferta" );
      ((Element)v.get(121)).setAttribute("id","datosCampos" );
      ((Element)v.get(121)).setAttribute("onchange","onChangeTipoOferta();" );
      ...
      /* Empieza nodo:125 / Elemento padre: 74   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(74)).appendChild((Element)v.get(125));
      ...
      ((Element)v.get(138)).setAttribute("nombre","btnSeleccionarMatrizOrigen" );
      ((Element)v.get(138)).setAttribute("ID","botonContenido" );
      ((Element)v.get(138)).setAttribute("tipo","html" );
      ((Element)v.get(138)).setAttribute("accion","llamarAccion('Seleccionar matriz origen');" );
      ((Element)v.get(138)).setAttribute("estado","false" );
   }

   private void getXML540(Document doc) {
      ((Element)v.get(138)).setAttribute("cod","1121" );
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(142)).setAttribute("width","15" );
      ...
      ((Element)v.get(143)).setAttribute("width","15" );
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(144)).setAttribute("width","750" );
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(146)).setAttribute("width","15" );
      ((Element)v.get(141)).appendChild((Element)v.get(146));

      /* Empieza nodo:147 / Elemento padre: 146   */
      v.add(doc.createElement("IMG"));
      ((Element)v.get(147)).setAttribute("src","b.gif" );
      ((Element)v.get(147)).setAttribute("width","15" );
      ((Element)v.get(147)).setAttribute("height","15" );
      ((Element)v.get(146)).appendChild((Element)v.get(147));
      /* Termina nodo:147   */
      /* Termina nodo:146   */
      /* Termina nodo:141   */

      /* Empieza nodo:148 / Elemento padre: 22   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(22)).appendChild((Element)v.get(148));
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(154)).setAttribute("nombre","lblMatrizNueva" );
      ...
      ((Element)v.get(154)).setAttribute("cod","0062" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(163)).setAttribute("nombre","lblMarca2" );
   ...
   private void getXML630(Document doc) {
      ((Element)v.get(163)).setAttribute("cod","6" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(167)).setAttribute("nombre","lblCanal2" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(171)).setAttribute("nombre","lblPeriodo2" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(178)).setAttribute("nombre","lblMarca2XX" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(182)).setAttribute("nombre","lblCanal2XX" );
   ...
   private void getXML720(Document doc) {
      ((Element)v.get(186)).setAttribute("nombre","lblPeriodo2XX" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(202)).setAttribute("nombre","btnSeleccionarMatrizNueva" );
      ((Element)v.get(202)).setAttribute("ID","botonContenido" );
      ((Element)v.get(202)).setAttribute("tipo","html" );
      ((Element)v.get(202)).setAttribute("accion","llamarAccion('Seleccionar matriz nueva');" );
      ((Element)v.get(202)).setAttribute("estado","false" );
      ((Element)v.get(202)).setAttribute("cod","1120" );
      ...
      ((Element)v.get(203)).setAttribute("accion","copiar();" );
