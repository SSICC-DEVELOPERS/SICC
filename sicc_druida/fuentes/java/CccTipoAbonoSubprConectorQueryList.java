...
public class CccTipoAbonoSubprConectorQueryList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad CccTipoAbonoSubpr" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGCccTipoAbonoSubprQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGCccTipoAbonoSubprQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","CccTipoAbonoSubprListFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(8)).setAttribute("NOMBRE","tcabOidTcab" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(9)).setAttribute("NOMBRE","cucoOidCuenCont" );
