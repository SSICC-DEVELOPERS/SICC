...
public class CarParamEvaluNrPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","carParamEvaluNrList" );
      ...
      ((Element)v.get(14)).setAttribute("cod","CarParamEvaluNr.codPara.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","CarParamEvaluNr.desPara.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","CarParamEvaluNr.valPeso.label" );
