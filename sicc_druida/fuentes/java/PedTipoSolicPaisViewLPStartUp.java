/*
    INDRA/CAR/mmg
    $Id: PedTipoSolicPaisViewLPStartUp.java,v 1.1 2009/12/03 18:39:47 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class PedTipoSolicPaisViewLPStartUp extends MMGDruidaBase{
	...
	public static final String BUSINESSID_QUERY = "MMGPedTipoSolicPaisViewQueryFromToUserPage";
				...
				public static final String BUSINESSID_TSOLOIDTIPOSOLI_QUERY ="MMGPedTipoSolicQueryFromToUser";
				public static final String TSOLOIDTIPOSOLI_COMBO_CONNECTOR = "PedTipoSolicConectorCombo";
	...
	public PedTipoSolicPaisViewLPStartUp(){
		super();
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			buildJsPageSize("PedTipoSolicPaisView");
			...
			asignarAtributo("PAGINA", "PedTipoSolicPaisViewPage", "cod", "PedTipoSolicPaisView." + accion + ".label");
			...
			limpiarBotoneraLista("pedTipoSolicPaisView", accion);
	...
	protected void cmdLov() throws Exception{
		...
		//asignarAtributo("CAPA", "pedTipoSolicPaisViewLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "PedTipoSolicPaisViewPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		PedTipoSolicPaisViewData pedTipoSolicPaisViewQuery= new PedTipoSolicPaisViewData();
		pedTipoSolicPaisViewQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		PedTipoSolicPaisViewData datosResult = (PedTipoSolicPaisViewData)getSingleObject(BUSINESSID_QUERY, pedTipoSolicPaisViewQuery, 
			pedTipoSolicPaisViewQuery.clone(), "pedTipoSolicPaisView");
		...
		PedTipoSolicPaisViewData pedTipoSolicPaisView = datosResult;
		es.indra.belcorp.mso.PedTipoSolicData tsolOidTipoSoli = pedTipoSolicPaisView.getTsolOidTipoSoli();
		...
		//Deshabilitamos todos los campos para que no se editen
					...
					asignarAtributo("COMBO", "tsolOidTipoSoli", "disabled", "S");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "pedTipoSolicPaisViewFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		PedTipoSolicPaisViewData pedTipoSolicPaisViewQuery= new PedTipoSolicPaisViewData();
		pedTipoSolicPaisViewQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(pedTipoSolicPaisView.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"pedTipoSolicPaisViewFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"pedTipoSolicPaisViewFrm\",1, false)");
					asignarAtributo("COMBO","paisOidPais", "ontab", "ejecutarAccionFocoModificacion(\"pedTipoSolicPaisViewFrm\",2, true)");
					asignarAtributo("COMBO","paisOidPais", "onshtab", "ejecutarAccionFocoModificacion(\"pedTipoSolicPaisViewFrm\",2, false)");
					asignarAtributo("COMBO","tsolOidTipoSoli", "ontab", "ejecutarAccionFocoModificacion(\"pedTipoSolicPaisViewFrm\",3, true)");
					asignarAtributo("COMBO","tsolOidTipoSoli", "onshtab", "ejecutarAccionFocoModificacion(\"pedTipoSolicPaisViewFrm\",3, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","pedTipoSolicPaisViewTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","pedTipoSolicPaisViewTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","pedTipoSolicPaisViewFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","pedTipoSolicPaisViewListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","pedTipoSolicPaisViewListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(PedTipoSolicPaisViewData pedTipoSolicPaisView) throws Exception{
		...
		if(pedTipoSolicPaisView != null && pedTipoSolicPaisView.getPaisOidPais() != null){
				checkCombo("paisOidPais" , pedTipoSolicPaisView.getPaisOidPais().getId().toString());
			}
		...
		PedTipoSolicData tsolOidTipoSoli = new PedTipoSolicData();
		
						asignarComboResultados(BUSINESSID_TSOLOIDTIPOSOLI_QUERY,TSOLOIDTIPOSOLI_COMBO_CONNECTOR, 
			tsolOidTipoSoli, tsolOidTipoSoli.clone(), "pedTipoSolic", "tsolOidTipoSoli", "result_ROWSET" );
		if(pedTipoSolicPaisView != null && pedTipoSolicPaisView.getTsolOidTipoSoli() != null){
				checkCombo("tsolOidTipoSoli" , pedTipoSolicPaisView.getTsolOidTipoSoli().getId().toString());
			}
	...
	* @param pedTipoSolicPaisView La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(PedTipoSolicPaisViewData pedTipoSolicPaisView) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		PedTipoSolicPaisViewData pedTipoSolicPaisView = 
			(PedTipoSolicPaisViewData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(pedTipoSolicPaisView.getPaisOidPais() != null){
			pedTipoSolicPaisView.setPaisOidPais((es.indra.belcorp.mso.SegPaisViewData)
			getSingleObject(BUSINESSID_PAISOIDPAIS_QUERY, 
			pedTipoSolicPaisView.getPaisOidPais(),
			pedTipoSolicPaisView.getPaisOidPais().clone(),
			"segPaisView"));
		}
		if(pedTipoSolicPaisView.getTsolOidTipoSoli() != null){
			pedTipoSolicPaisView.setTsolOidTipoSoli((es.indra.belcorp.mso.PedTipoSolicData)
			getSingleObject(BUSINESSID_TSOLOIDTIPOSOLI_QUERY, 
			pedTipoSolicPaisView.getTsolOidTipoSoli(),
			pedTipoSolicPaisView.getTsolOidTipoSoli().clone(),
			"pedTipoSolic"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(pedTipoSolicPaisView);
		loadLeafDependenceCombos(pedTipoSolicPaisView);
	}
