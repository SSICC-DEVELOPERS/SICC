/*
    INDRA/CAR/mmg
    $Id: PedGrupoProceLPStartUp.java,v 1.1 2009/12/03 18:32:28 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class PedGrupoProceLPStartUp extends MMGDruidaBase{
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "PedGrupoProcePage", "cod", "PedGrupoProce." + accion + ".label");
			...
			limpiarBotoneraLista("pedGrupoProce", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codGrupProc", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 3);");
		asignarAtributo("TEXT", "desGrupProc", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 0, 40);");
		
		//Primero determianmos el nombre del campo en la entidad de oriegen donde se van a cargar los datos
		asignar("VAR", "idAttributeLovOpener", conectorParametro(PARAMETRO_LOV_ATTRIBUTO));
		asignar("VAR", "idEntityLovOpener", conectorParametro(PARAMETRO_LOV_ENTIDAD));
		//asignarAtributo("CAPA", "pedGrupoProceLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "PedGrupoProcePage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		PedGrupoProceData pedGrupoProceQuery= new PedGrupoProceData();
		pedGrupoProceQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		PedGrupoProceData datosResult = (PedGrupoProceData)getSingleObject(BUSINESSID_QUERY, pedGrupoProceQuery, 
			pedGrupoProceQuery.clone(), "pedGrupoProce");
		...
		PedGrupoProceData pedGrupoProce = datosResult;
		asignar("TEXT", "codGrupProc", FormatUtils.formatObject(pedGrupoProce.getCodGrupProc(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "desGrupProc", FormatUtils.formatObject(pedGrupoProce.getDesGrupProc(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		asignarAtributo("TEXT", "codGrupProc", "disabled", "S");
		asignarAtributo("TEXT", "desGrupProc", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		...
		asignarAtributo("TEXT", "codGrupProc", "req", "S");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "pedGrupoProceFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		PedGrupoProceData pedGrupoProceQuery= new PedGrupoProceData();
		pedGrupoProceQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(pedGrupoProce.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"pedGrupoProceFrm\",0, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"pedGrupoProceFrm\",0, false)");
				asignarAtributo("AREATEXTO", "codGrupProc", "ontab","ejecutarAccionFocoModificacion(\"pedGrupoProceFrm\",0, true)");
				asignarAtributo("AREATEXTO", "codGrupProc", "onshtab","ejecutarAccionFocoModificacion(\"pedGrupoProceFrm\",0, false)");
				asignarAtributo("AREATEXTO", "desGrupProc", "ontab","ejecutarAccionFocoModificacion(\"pedGrupoProceFrm\",0, true)");
				asignarAtributo("AREATEXTO", "desGrupProc", "onshtab","ejecutarAccionFocoModificacion(\"pedGrupoProceFrm\",0, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","pedGrupoProceTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","pedGrupoProceTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codGrupProc...");		
				
				traza("MMG: el atributo es desGrupProc...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","pedGrupoProceFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","pedGrupoProceListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","pedGrupoProceListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(PedGrupoProceData pedGrupoProce) throws Exception{
	...
	* @param pedGrupoProce La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(PedGrupoProceData pedGrupoProce) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		PedGrupoProceData pedGrupoProce = 
			(PedGrupoProceData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(pedGrupoProce);
		loadLeafDependenceCombos(pedGrupoProce);
	}
