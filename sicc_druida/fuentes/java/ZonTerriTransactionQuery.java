...
/*
    INDRA/CAR/mmg
    $Id: ZonTerriTransactionQuery.java,v 1.1 2009/12/03 18:38:32 pecbazalar Exp $
    DESC
*/
...
public class ZonTerriTransactionQuery extends MMGDruidaTransaction {
	...
	public static final String CONECTOR_QUERY_LIST = "ZonTerriConectorQueryList";

	// Definicion del constructor
	public ZonTerriTransactionQuery(){
		super();
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			traza("MMG:: LLegao a transaction Query de entidad ZonTerri");
			...
			String vepoOidValoEstrGeop = (String)getEntrada("vepoOidValoEstrGeop");
			...
			ZonTerriData zonTerriFrom =new ZonTerriData();
			ZonTerriData zonTerriTo = new ZonTerriData();
			...
			zonTerriFrom.setVepoOidValoEstrGeop(vepoOidValoEstrGeopData);
			zonTerriFrom.setFecRtz(
			...
			//Construimos el to
			zonTerriTo = (ZonTerriData)zonTerriFrom.clone();
			
			
			//Metemos tanto el fromo como el to como últimos mso con parámetros de búsqueda
			conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM, zonTerriFrom);
			conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_TO, zonTerriTo);
			...
			dto.addProperty("zonTerriFrom", zonTerriFrom);
			dto.addProperty("zonTerriTo", zonTerriTo);
			...
			traza("MMG:: Iniciada ejecución Query de entidad ZonTerri");
			DruidaConector conectorQuery =  conectar(CONECTOR_QUERY_LIST, datos);
			traza("MMG:: Finalizada ejecución Query de entidad ZonTerri");
