...
public class CccTipoTransPage  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","CccTipoTransPage" );
      ((Element)v.get(0)).setAttribute("titulo","" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","" );
      ((Element)v.get(0)).setAttribute("onload","cccTipoTransInitComponents()" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","ccctipotrans.js" );
      ((Element)v.get(0)).appendChild((Element)v.get(4));
      /* Termina nodo:4   */

      /* Empieza nodo:5 / Elemento padre: 0   */
      v.add(doc.createElement("FORMULARIO"));
      ((Element)v.get(5)).setAttribute("nombre","cccTipoTransFrm" );
      ...
      ((Element)v.get(6)).setAttribute("valor","CccTipoTransLPExecution" );
      ...
      ((Element)v.get(7)).setAttribute("valor","CccTipoTransLPExecution" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(38)).setAttribute("nombre","cccTipoTransFormLayer" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(53)).setAttribute("cod","CccTipoTrans.legend.label" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(68)).setAttribute("cod","CccTipoTrans.id.label" );
      ...
      ((Element)v.get(71)).setAttribute("ontab","ejecutarAccionFoco('cccTipoTransFrm',1, true)" );
      ((Element)v.get(71)).setAttribute("onshtab","ejecutarAccionFoco('cccTipoTransFrm', 1, false)" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(93)).setAttribute("cod","CccTipoTrans.paisOidPais.label" );
      ...
      ((Element)v.get(96)).setAttribute("ontab","ejecutarAccionFoco('cccTipoTransFrm',2, true);" );
      ((Element)v.get(96)).setAttribute("onshtab","ejecutarAccionFoco('cccTipoTransFrm',2, false);" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(115)).setAttribute("nombre","codTipoTranTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(120)).setAttribute("nombre","codTipoTranWidgetTrId" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(122)).setAttribute("ontab","ejecutarAccionFoco('cccTipoTransFrm',3, true)" );
      ((Element)v.get(122)).setAttribute("onshtab","ejecutarAccionFoco('cccTipoTransFrm', 3, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(123)).setAttribute("nombre","codTipoTranGapTdId" );
      ...
      ((Element)v.get(129)).setAttribute("cod","CccTipoTrans.Descripcion.label" );
      ...
      ((Element)v.get(133)).setAttribute("max","50" );
      ((Element)v.get(133)).setAttribute("onchange","" );
      ((Element)v.get(133)).setAttribute("req","N" );
      ((Element)v.get(133)).setAttribute("size","50" );
      ...
      ((Element)v.get(133)).setAttribute("ontab","ejecutarAccionFoco('cccTipoTransFrm',4, true)" );
      ((Element)v.get(133)).setAttribute("onshtab","ejecutarAccionFoco('cccTipoTransFrm', 4, false)" );
      ...
      ((Element)v.get(137)).setAttribute("href","javascript:openLocalizationDialog('cccTipoTransFrm', 'Descripcion', 1);" );
      ((Element)v.get(137)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"cccTipoTransFrm\",4, true)', 'ejecutarAccionFoco(\"cccTipoTransFrm\",4, false)')" );
   ...
   private void getXML630(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(141)).setAttribute("nombre","codTipoTranCheqTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(145)).setAttribute("nombre","lblCodTipoTranCheq" );
      ((Element)v.get(145)).setAttribute("alto","13" );
      ((Element)v.get(145)).setAttribute("filas","1" );
      ((Element)v.get(145)).setAttribute("id","datosTitle" );
      ((Element)v.get(145)).setAttribute("cod","CccTipoTrans.codTipoTranCheq.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(146)).setAttribute("nombre","codTipoTranCheqWidgetTrId" );
      ...
      ((Element)v.get(148)).setAttribute("nombre","codTipoTranCheq" );
      ...
      ((Element)v.get(148)).setAttribute("ontab","ejecutarAccionFoco('cccTipoTransFrm',5, true)" );
      ((Element)v.get(148)).setAttribute("onshtab","ejecutarAccionFoco('cccTipoTransFrm',5, false)" );
      ((Element)v.get(147)).appendChild((Element)v.get(148));

      /* Empieza nodo:149 / Elemento padre: 148   */
      v.add(doc.createElement("RBINPUT"));
      ((Element)v.get(149)).setAttribute("id","datosCampos" );
      ((Element)v.get(149)).setAttribute("valor","S" );
      ((Element)v.get(149)).setAttribute("cod","CccTipoTrans.codTipoTranCheq.S.label" );
      ...
      ((Element)v.get(151)).setAttribute("cod","CccTipoTrans.codTipoTranCheq.N.label" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(153)).setAttribute("nombre","codTipoTranCheqGapTdId" );
   ...
   private void getXML720(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(167)).setAttribute("nombre","cccTipoTransTrButtons" );
      ...
      ((Element)v.get(174)).setAttribute("nombre","cccTipoTransTdQueryButton" );
      ((Element)v.get(173)).appendChild((Element)v.get(174));

      /* Empieza nodo:175 / Elemento padre: 174   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(175)).setAttribute("nombre","cccTipoTransQueryButton" );
      ((Element)v.get(175)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(175)).setAttribute("estado","false" );
      ((Element)v.get(175)).setAttribute("accion","cccTipoTransFirstPage();" );
      ...
      ((Element)v.get(176)).setAttribute("nombre","cccTipoTransTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(178)).setAttribute("nombre","cccTipoTransLovNullButton" );
      ((Element)v.get(178)).setAttribute("ID","botonContenido" );
      ((Element)v.get(178)).setAttribute("tipo","html" );
      ((Element)v.get(178)).setAttribute("accion","cccTipoTransLovNullSelectionAction();" );
   ...
   private void getXML810(Document doc) {
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(181)).setAttribute("nombre","cccTipoTransListLayer" );
      ...
      ((Element)v.get(182)).setAttribute("nombre","cccTipoTransList" );
   ...
   private void getXML900(Document doc) {
      ...
      ((Element)v.get(196)).setAttribute("cod","CccTipoTrans.codTipoTran.label" );
      ...
      ((Element)v.get(197)).setAttribute("cod","CccTipoTrans.Descripcion.label" );
      ...
      ((Element)v.get(198)).setAttribute("cod","CccTipoTrans.codTipoTranCheq.label" );
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(204)).setAttribute("nombre","cccTipoTransListButtonsLayer" );
   ...
   private void getXML990(Document doc) {
      ...
      ((Element)v.get(210)).setAttribute("nombre","cccTipoTransPaginationButtonBar" );
      ...
      ((Element)v.get(211)).setAttribute("nombre","cccTipoTransFirstPageButton" );
      ((Element)v.get(211)).setAttribute("funcion","cccTipoTransFirstPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(212)).setAttribute("nombre","cccTipoTransFirstPageButtonGapTd" );
      ...
      v.add(doc.createElement("BTN"));
      ((Element)v.get(214)).setAttribute("nombre","cccTipoTransPreviousPageButton" );
      ((Element)v.get(214)).setAttribute("funcion","cccTipoTransPreviousPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(215)).setAttribute("nombre","cccTipoTransPreviousPageButtonGapTd" );
      ...
      v.add(doc.createElement("BTN"));
      ((Element)v.get(217)).setAttribute("nombre","cccTipoTransNextPageButton" );
      ((Element)v.get(217)).setAttribute("funcion","cccTipoTransNextPage();" );
      ...
      ((Element)v.get(220)).setAttribute("nombre","cccTipoTransUpdateButtonTd" );
      ((Element)v.get(206)).appendChild((Element)v.get(220));

      /* Empieza nodo:221 / Elemento padre: 220   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(221)).setAttribute("nombre","cccTipoTransUpdateButton" );
      ((Element)v.get(221)).setAttribute("ID","botonContenido" );
      ((Element)v.get(221)).setAttribute("tipo","html" );
      ((Element)v.get(221)).setAttribute("accion","cccTipoTransUpdateSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(222)).setAttribute("nombre","cccTipoTransUpdateButtonGapTd" );
   ...
   private void getXML1080(Document doc) {
      ((Element)v.get(224)).setAttribute("nombre","cccTipoTransViewForRemoveButtonTd" );
      ((Element)v.get(206)).appendChild((Element)v.get(224));

      /* Empieza nodo:225 / Elemento padre: 224   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(225)).setAttribute("nombre","cccTipoTransViewForRemoveButton" );
      ((Element)v.get(225)).setAttribute("ID","botonContenido" );
      ((Element)v.get(225)).setAttribute("tipo","html" );
      ((Element)v.get(225)).setAttribute("accion","cccTipoTransViewSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(226)).setAttribute("nombre","cccTipoTransViewForRemoveButtonGapTd" );
      ...
      ((Element)v.get(228)).setAttribute("nombre","cccTipoTransLovSelectButtonTd" );
      ((Element)v.get(206)).appendChild((Element)v.get(228));

      /* Empieza nodo:229 / Elemento padre: 228   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(229)).setAttribute("nombre","cccTipoTransLovSelectButton" );
      ((Element)v.get(229)).setAttribute("ID","botonContenido" );
      ((Element)v.get(229)).setAttribute("tipo","html" );
      ((Element)v.get(229)).setAttribute("accion","cccTipoTransLovSelectionAction();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(230)).setAttribute("nombre","cccTipoTransLovSelectButtonGapTd" );
      ...
      ((Element)v.get(232)).setAttribute("nombre","cccTipoTransViewButtonTd" );
      ((Element)v.get(206)).appendChild((Element)v.get(232));

      /* Empieza nodo:233 / Elemento padre: 232   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(233)).setAttribute("nombre","cccTipoTransViewButton" );
      ((Element)v.get(233)).setAttribute("ID","botonContenido" );
      ((Element)v.get(233)).setAttribute("tipo","html" );
      ((Element)v.get(233)).setAttribute("accion","cccTipoTransViewSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(234)).setAttribute("nombre","cccTipoTransViewButtonGapTd" );
