...
public class ConectorObtenerZonasParaMoverActividad  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","DTOEntradaModificarCronograma" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","CRAObtieneZonasParaModificacion" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(6)).setAttribute("NOMBRE","ZZON_OID_ZONA" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","DES_ZONA" );
      ...
      ((Element)v.get(8)).setAttribute("ID","dtoSalida.resultado_ROWSET" );
      ((Element)v.get(0)).appendChild((Element)v.get(8));

      /* Empieza nodo:9 / Elemento padre: 8   */
      v.add(doc.createElement("CCAMPO"));
      ((Element)v.get(9)).setAttribute("NOMBRE","ZZON_OID_ZONA" );
      ...
      v.add(doc.createElement("CCAMPO"));
      ((Element)v.get(10)).setAttribute("NOMBRE","DES_ZONA" );
