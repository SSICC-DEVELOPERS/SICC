...
public class SegPerioCorpoConectorQueryForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad SegPerioCorpo" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGSegPerioCorpoQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGSegPerioCorpoQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","SegPerioCorpoFormFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","tipeOidTipoPeri" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(8)).setAttribute("NOMBRE","codPeri" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(10)).setAttribute("NOMBRE","valAnio" );
