...
public class COMGananciaLideres extends LPSICCBase {           
   public COMGananciaLideres() {	 
     super();
  }
     ...
     try {
        ...
        if (accion.equals("generar")){
          ...
          //cargarPagina();
           ...
           cargarPagina();
           getConfiguracionMenu("COMGanaciaLideres");
        }
  ...
  private void cargarPagina() throws Exception{
     pagina("contenido_informe_ganancia_lideres_generar");   
 ...
 private void generarReporte() throws Exception{
     ...
     datos.put(ConstantesREP.TITULO, "Ganancia de Lideres - Recuperacion de Consultoras");     
...
//     ejecutarReporte(datos, "REPGenerarReporte", "RD_REP-147", formato);
          ejecutarReporte2(datos, "REPGenerarReporteBatch", "RD_REP-147", formato);
