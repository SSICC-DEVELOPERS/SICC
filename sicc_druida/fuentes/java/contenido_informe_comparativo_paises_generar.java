...
public class contenido_informe_comparativo_paises_generar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_informe_comparativo_paises_generar" );
      ((Element)v.get(0)).setAttribute("cod","0857" );
      ((Element)v.get(0)).setAttribute("titulo","Generar informe comparativo de países de retención de pedidos" );
      ...
      v.add(doc.createTextNode("\r  \r   \r  \r  function onLoad(){\r  \r    configurarMenuSecundario('Formulario');\r    fMostrarMensajeError();\r    set('Formulario.txtAnio',get('Formulario.anio') );\r    setearPais();\r    cambioPais();\r    focaliza('Formulario.cbPais');\r  \r  }\r  \r\r    function quitarItemVacio(elemento){\r      var elementoADevolver = new Array();\r     \r      for(var k=0;k<elemento.length;k++) {\r          if (elemento[k] != ''){                            \r             elementoADevolver[elementoADevolver.length] = elemento[k];\r          }\r      }\r         \r      return elementoADevolver;\r      \r   }	\r\r  function anioActual() {\r  \r    d = new Date();\r    y = d.getFullYear();\r    return y;\r  \r  }\r  \r  \r  function setearPais(){\r  \r    var pais = get('Formulario.pais');\r    \r    iSeleccionado = new Array();\r    iSeleccionado[0] = pais;\r    set('Formulario.cbPais',iSeleccionado);\r  \r  }\r\r  \r  function fLimpiar(){\r    \r    var aCombo = new Array(new Array(\"\",\"\"));\r    \r    set_combo('Formulario.cbSubtipoCliente', aCombo, []);\r    set_combo('Formulario.cbTipoClasificacion', aCombo, []);\r    set_combo('Formulario.cbClasificacion', aCombo, []);\r    set_combo('Formulario.cbUnidadNegocio', aCombo, []);\r    set_combo('Formulario.cbNegocio', aCombo, []);\r    \r    set('Formulario.txtAnio', get('Formulario.anio'));\r    \r    focaliza('Formulario.cbPais');\r    \r  } \r   \r  \r  function cambioPais(){\r  \r    \r    pais   = get('Formulario.cbPais');\r    idioma = get('Formulario.idioma');\r    \r    if(pais != ''){\r\r      var arr = new Array();\r      arr[arr.length] = [\"oidPais\", pais];\r      arr[arr.length] = [\"oidIdioma\", idioma];          \r    \r      recargaCombo(\"Formulario.cbUnidadNegocio\",\"MAEObtenerUnidadesNegocioPorPais\", \"es.indra.sicc.util.DTOBelcorp\",arr);\r      recargaCombo(\"Formulario.cbNegocio\",\"MAEObtenerNegocioPorPais\", \"es.indra.sicc.util.DTOBelcorp\",arr);\r    \r    }else{\r      \r      var aCombo = new Array(new Array(\"\",\"\"));\r      set_combo('Formulario.cbUnidadNegocio', aCombo, []); \r      set_combo('Formulario.cbNegocio', aCombo, []); \r    \r    }\r  \r}\r\r\r  \r\r  function cambioTipo(){\r         \r     opciones = new Array();\r     set_combo('Formulario.cbSubtipoCliente',opciones);\r     set_combo('Formulario.cbTipoClasificacion',opciones);\r     set_combo('Formulario.cbClasificacion',opciones);\r     tipo = get('Formulario.cbTipoCliente','V');\r     combo_add('Formulario.cbSubtipoCliente', '', '');\r       \r     for(var k=0;k<lstSubtipo.datos.longitud;k++) {\r        for(var y=0;y<tipo.length;y++){\r           if (lstSubtipo.datos.ij(k,1) == tipo[y]){ 			 \r              combo_add('Formulario.cbSubtipoCliente',lstSubtipo.datos.ij(k,0),lstSubtipo.datos.ij(k,2));\r    \r            }\r        }\r     }\r  }    \r  \r\r  function cambioSubtipo(){\r     \r    opciones = new Array();\r    set_combo('Formulario.cbTipoClasificacion',opciones);\r    set_combo('Formulario.cbClasificacion',opciones);\r    var subTipo = get('Formulario.cbSubtipoCliente','V');\r    combo_add('Formulario.cbTipoClasificacion', '', '');\r    \r    for(var k=0;k<lstTipoClasificacion.datos.longitud;k++) {\r        for(var y=0;y<subTipo.length;y++){\r           if (lstTipoClasificacion.datos.ij(k,1) == subTipo[y]){ 			 \r              combo_add('Formulario.cbTipoClasificacion',lstTipoClasificacion.datos.ij(k,0),lstTipoClasificacion.datos.ij(k,2));\r           \r           }\r        }\r    }\r          \r    \r  }\r\r\r  function cambioTipoClasificacion(){\r    \r    opciones = new Array();\r    set_combo('Formulario.cbClasificacion',opciones);\r    var tipoClasificacion = get('Formulario.cbTipoClasificacion','V');\r    combo_add('Formulario.cbClasificacion', '', '');\r  \r    for(var k=0;k<lstClasificacion.datos.longitud;k++) {\r      for(var y=0;y<tipoClasificacion.length;y++){\r        if (lstClasificacion.datos.ij(k,1) == tipoClasificacion[y]){ 			 \r          combo_add('Formulario.cbClasificacion',lstClasificacion.datos.ij(k,0),lstClasificacion.datos.ij(k,2));\r            \r        }\r      }\r    }\r  }\r   \r\r  function generar(formato){\r     \r    if(sicc_validaciones_generales()){\r      \r      var a = new Object();\r      a.accion = 'generar';\r      \r      a.pais = get('Formulario.cbPais');  \r      a.marca = get('Formulario.cbMarca');\r      a.marcaDesc = get('Formulario.cbMarca','T');\r      a.canal = get('Formulario.cbCanal');\r      a.tipoCliente = quitarItemVacio(get('Formulario.cbTipoCliente'));\r      a.tipoClienteDesc = quitarItemVacio(get('Formulario.cbTipoCliente', 'T'));\r      a.subtipoCliente = quitarItemVacio(get('Formulario.cbSubtipoCliente'));\r      a.subtipoClienteDesc = quitarItemVacio(get('Formulario.cbSubtipoCliente', 'T'));\r      a.tipoClasificacion = quitarItemVacio(get('Formulario.cbTipoClasificacion'));\r      a.tipoClasificacionDesc = quitarItemVacio(get('Formulario.cbTipoClasificacion', 'T'));\r      a.clasificacion = quitarItemVacio(get('Formulario.cbClasificacion'));\r      a.clasificacionDesc = quitarItemVacio(get('Formulario.cbClasificacion', 'T'));\r      a.unidadNegocio = quitarItemVacio(get('Formulario.cbUnidadNegocio'));\r      a.unidadNegocioDesc= quitarItemVacio(get('Formulario.cbUnidadNegocio', 'T'));\r      a.negocio = quitarItemVacio(get('Formulario.cbNegocio'));\r      a.negocioDesc = quitarItemVacio(get('Formulario.cbNegocio', 'T'));\r      a.anio = get('Formulario.txtAnio');\r      a.pedidosAnioAnterior = get('Formulario.txtPorcentajeRetencionAnioAnterior');\r   \r      a.formato = formato;\r   \r      mostrarModalSICC('INCComparativoPaisesRetencion','generar', a);\r      \r    }\r    \r  }\r\r\r\r\r\r  \r  "));
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(10)).setAttribute("name","txtAnio" );
      ((Element)v.get(10)).setAttribute("required","true" );
      ((Element)v.get(10)).setAttribute("cod","171" );
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(11)).setAttribute("name","txtPorcentajeRetencionAnioAnterior" );
      ((Element)v.get(11)).setAttribute("required","true" );
      ((Element)v.get(11)).setAttribute("cod","2696" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(20)).setAttribute("nombre","anio" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(55)).setAttribute("onshtab","focalizaBotonHTML('botonContenido','btnGenerarExcel');" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(110)).setAttribute("nombre","cbTipoCliente" );
      ...
      ((Element)v.get(110)).setAttribute("onchange","cambioTipo()" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(115)).setAttribute("nombre","cbSubtipoCliente" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(115)).setAttribute("onchange","cambioSubtipo()" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(133)).setAttribute("nombre","lblClasificacion" );
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(140)).setAttribute("nombre","cbTipoClasificacion" );
      ...
      ((Element)v.get(140)).setAttribute("onchange","cambioTipoClasificacion()" );
      ...
      ((Element)v.get(144)).setAttribute("valign","bottom" );
      ((Element)v.get(136)).appendChild((Element)v.get(144));

      /* Empieza nodo:145 / Elemento padre: 144   */
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(145)).setAttribute("nombre","cbClasificacion" );
      ...
      /* Empieza nodo:149 / Elemento padre: 124   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(124)).appendChild((Element)v.get(149));
      ...
      /* Empieza nodo:152 / Elemento padre: 37   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(37)).appendChild((Element)v.get(152));
   ...
   private void getXML630(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(170)).setAttribute("nombre","cbUnidadNegocio" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(175)).setAttribute("nombre","cbNegocio" );
      ((Element)v.get(175)).setAttribute("size","5" );
      ((Element)v.get(175)).setAttribute("multiple","S" );
      ...
      /* Empieza nodo:179 / Elemento padre: 154   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(154)).appendChild((Element)v.get(179));
      ...
      /* Empieza nodo:182 / Elemento padre: 37   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(37)).appendChild((Element)v.get(182));
   ...
   private void getXML720(Document doc) {
      ...
      ((Element)v.get(200)).setAttribute("nombre","txtAnio" );
   ...
   private void getXML810(Document doc) {
      ...
      ((Element)v.get(222)).setAttribute("accion","generar('pdf')" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(223)).setAttribute("nombre","btnGenerarExcel" );
      ((Element)v.get(223)).setAttribute("ID","botonContenido" );
      ((Element)v.get(223)).setAttribute("tipo","html" );
      ((Element)v.get(223)).setAttribute("accion","generar('xls')" );
      ((Element)v.get(223)).setAttribute("estado","false" );
      ((Element)v.get(223)).setAttribute("cod","2526" );
      ((Element)v.get(223)).setAttribute("ontab","focaliza('Formulario.cbPais')" );
   ...
   private void getXML900(Document doc) {
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(233)).setAttribute("nombre","capaSubtipo" );
      ((Element)v.get(233)).setAttribute("alto","3" );
      ((Element)v.get(233)).setAttribute("ancho","624" );
      ...
      ((Element)v.get(233)).setAttribute("visibilidad","visible" );
      ((Element)v.get(233)).setAttribute("contravsb","" );
      ((Element)v.get(233)).setAttribute("x","0" );
      ((Element)v.get(233)).setAttribute("y","165" );
      ...
      ((Element)v.get(234)).setAttribute("nombre","lstSubtipo" );
      ((Element)v.get(234)).setAttribute("x","12" );
      ((Element)v.get(234)).setAttribute("y","10" );
      ((Element)v.get(234)).setAttribute("ancho","600" );
      ((Element)v.get(234)).setAttribute("alto","3" );
      ...
      ((Element)v.get(234)).setAttribute("pixelsborde","2" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(237)).setAttribute("id","datosCamposCabecera" );
      ...
      ((Element)v.get(241)).setAttribute("ancho","590" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(242)).setAttribute("ancho","40" );
      ((Element)v.get(242)).setAttribute("caracteres","20" );
      ...
      ((Element)v.get(244)).setAttribute("caracteres","30" );
      ...
      /* Empieza nodo:246 / Elemento padre: 12   */
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(246)).setAttribute("nombre","capaTipoClasificacion" );
      ((Element)v.get(246)).setAttribute("alto","3" );
      ((Element)v.get(246)).setAttribute("ancho","624" );
   ...
   private void getXML990(Document doc) {
      ((Element)v.get(246)).setAttribute("visibilidad","visible" );
      ((Element)v.get(246)).setAttribute("contravsb","" );
      ((Element)v.get(246)).setAttribute("x","0" );
      ((Element)v.get(246)).setAttribute("y","165" );
      ((Element)v.get(246)).setAttribute("zindex","" );
      ((Element)v.get(12)).appendChild((Element)v.get(246));

      /* Empieza nodo:247 / Elemento padre: 246   */
      v.add(doc.createElement("LISTA"));
      ((Element)v.get(247)).setAttribute("seleccion","boton" );
      ((Element)v.get(247)).setAttribute("nombre","lstTipoClasificacion" );
      ((Element)v.get(247)).setAttribute("x","12" );
      ((Element)v.get(247)).setAttribute("y","10" );
      ((Element)v.get(247)).setAttribute("ancho","600" );
      ((Element)v.get(247)).setAttribute("alto","3" );
      ...
      ((Element)v.get(247)).setAttribute("pixelsborde","2" );
      ((Element)v.get(247)).setAttribute("colorborde","#CCCCCC" );
      ((Element)v.get(246)).appendChild((Element)v.get(247));

      /* Empieza nodo:248 / Elemento padre: 247   */
      v.add(doc.createElement("CABECERA"));
      ((Element)v.get(248)).setAttribute("nombre","cab1" );
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(259)).setAttribute("nombre","capaClasificacion" );
      ((Element)v.get(259)).setAttribute("alto","3" );
      ((Element)v.get(259)).setAttribute("ancho","624" );
      ...
      ((Element)v.get(259)).setAttribute("y","165" );
      ...
      ((Element)v.get(260)).setAttribute("nombre","lstClasificacion" );
      ((Element)v.get(260)).setAttribute("x","12" );
      ((Element)v.get(260)).setAttribute("y","10" );
      ((Element)v.get(260)).setAttribute("ancho","600" );
      ((Element)v.get(260)).setAttribute("alto","3" );
      ((Element)v.get(260)).setAttribute("multisel","-1" );
      ((Element)v.get(260)).setAttribute("incy","10" );
   ...
   private void getXML1080(Document doc) {
      ...
      ((Element)v.get(260)).setAttribute("pixelsborde","2" );
      ((Element)v.get(260)).setAttribute("colorborde","#CCCCCC" );
      ((Element)v.get(259)).appendChild((Element)v.get(260));

      /* Empieza nodo:261 / Elemento padre: 260   */
      v.add(doc.createElement("CABECERA"));
      ((Element)v.get(261)).setAttribute("nombre","cab1" );
      ((Element)v.get(261)).setAttribute("height","20" );
      ((Element)v.get(260)).appendChild((Element)v.get(261));

      /* Empieza nodo:262 / Elemento padre: 261   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(262)).setAttribute("id","datosCamposCabecera" );
      ((Element)v.get(262)).setAttribute("ancho","40" );
      ...
      ((Element)v.get(263)).setAttribute("ancho","60" );
