...
public class contenido_cajas_producto_buscar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_cajas_producto_buscar" );
      ...
      v.add(doc.createTextNode("\r  \r        function onLoad() {\r            configurarMenuSecundario('formulario');\r            btnProxy(2,1);\r            btnProxy(3,0);\r        }  \r\r        function onClickAceptar() {\r            var arr = new Array();\r            arr[0] = get(\"formulario.txtProducto\");                 \r            returnValue = arr;\r            close();\r        }\r        \r        function fVolver() {\r            close();\r        }\r   \r"));
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(30)).setAttribute("nombre","lblDatosDeAlta" );
      ((Element)v.get(30)).setAttribute("alto","13" );
      ((Element)v.get(30)).setAttribute("filas","1" );
      ((Element)v.get(30)).setAttribute("cod","ApeCajasCheq.datosProd.label" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(39)).setAttribute("nombre","lblProducto" );
      ...
      ((Element)v.get(39)).setAttribute("cod","ApeCajasCheq.prod.label" );
      ...
      ((Element)v.get(46)).setAttribute("nombre","txtProducto" );
      ((Element)v.get(46)).setAttribute("id","datosCampos" );
      ((Element)v.get(46)).setAttribute("max","40" );
      ((Element)v.get(46)).setAttribute("tipo","" );
      ((Element)v.get(46)).setAttribute("req","N" );
      ((Element)v.get(46)).setAttribute("size","50" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(63)).setAttribute("accion","onClickAceptar();" );
      ((Element)v.get(63)).setAttribute("estado","false" );
      ((Element)v.get(63)).setAttribute("cod","ApeCajasCheq.aceptar.label" );
      ((Element)v.get(63)).setAttribute("ontab","" );
