/*
    INDRA/CAR/mmg
    $Id: FacImpreVirtuViewLPStartUp.java,v 1.1 2009/12/03 18:33:05 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class FacImpreVirtuViewLPStartUp extends MMGDruidaBase{
	...
	public FacImpreVirtuViewLPStartUp(){
		super();
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			buildJsPageSize("FacImpreVirtuView");
			...
			asignarAtributo("PAGINA", "FacImpreVirtuViewPage", "cod", "FacImpreVirtuView." + accion + ".label");
			...
			limpiarBotoneraLista("facImpreVirtuView", accion);
	...
	protected void cmdLov() throws Exception{
		...
		//asignarAtributo("CAPA", "facImpreVirtuViewLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "FacImpreVirtuViewPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		FacImpreVirtuViewData facImpreVirtuViewQuery= new FacImpreVirtuViewData();
		facImpreVirtuViewQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		FacImpreVirtuViewData datosResult = (FacImpreVirtuViewData)getSingleObject(BUSINESSID_QUERY, facImpreVirtuViewQuery, 
			facImpreVirtuViewQuery.clone(), "facImpreVirtuView");
		...
		FacImpreVirtuViewData facImpreVirtuView = datosResult;
		asignar("TEXT", "codImpr", FormatUtils.formatObject(facImpreVirtuView.getCodImpr(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "desImpr", FormatUtils.formatObject(facImpreVirtuView.getDesImpr(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "facImpreVirtuViewFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		FacImpreVirtuViewData facImpreVirtuViewQuery= new FacImpreVirtuViewData();
		facImpreVirtuViewQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(facImpreVirtuView.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"facImpreVirtuViewFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"facImpreVirtuViewFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codImpr", "ontab","ejecutarAccionFocoModificacion(\"facImpreVirtuViewFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codImpr", "onshtab","ejecutarAccionFocoModificacion(\"facImpreVirtuViewFrm\",2, false)");
				asignarAtributo("AREATEXTO", "desImpr", "ontab","ejecutarAccionFocoModificacion(\"facImpreVirtuViewFrm\",3, true)");
				asignarAtributo("AREATEXTO", "desImpr", "onshtab","ejecutarAccionFocoModificacion(\"facImpreVirtuViewFrm\",3, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","facImpreVirtuViewTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","facImpreVirtuViewTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","facImpreVirtuViewFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","facImpreVirtuViewListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","facImpreVirtuViewListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(FacImpreVirtuViewData facImpreVirtuView) throws Exception{
	...
	* @param facImpreVirtuView La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(FacImpreVirtuViewData facImpreVirtuView) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		FacImpreVirtuViewData facImpreVirtuView = 
			(FacImpreVirtuViewData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(facImpreVirtuView);
		loadLeafDependenceCombos(facImpreVirtuView);
	}
