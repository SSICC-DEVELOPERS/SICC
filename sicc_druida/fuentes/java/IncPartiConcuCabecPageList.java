...
public class IncPartiConcuCabecPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","incPartiConcuCabecList" );
      ...
      ((Element)v.get(14)).setAttribute("cod","IncPartiConcuCabec.valGrupClie.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","IncPartiConcuCabec.diriOidDiri.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","IncPartiConcuCabec.desDesc.label" );
