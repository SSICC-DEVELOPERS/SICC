/*
    INDRA/CAR/mmg
    $Id: IntImporContaFactuLPStartUp.java,v 1.1 2009/12/03 18:33:35 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class IntImporContaFactuLPStartUp extends MMGDruidaBase{
	...
	public IntImporContaFactuLPStartUp(){
		super();
	}

	public void inicio() throws Exception {
		pagina("IntImporContaFactuPage");
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			buildJsPageSize("IntImporContaFactu");
			...
			asignarAtributo("PAGINA", "IntImporContaFactuPage", "cod", "IntImporContaFactu." + accion + ".label");
			...
			limpiarBotoneraLista("intImporContaFactu", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codImpoCont", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 2);");
		asignarAtributo("TEXT", "valIdenCabeDeta", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 1);");
		asignarAtributo("TEXT", "valDescImpo", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 40);");
		...
		//asignarAtributo("CAPA", "intImporContaFactuLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "IntImporContaFactuPage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("IntImporContaFactuLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		IntImporContaFactuData intImporContaFactuQuery= new IntImporContaFactuData();
		intImporContaFactuQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		IntImporContaFactuData datosResult = (IntImporContaFactuData)getSingleObject(BUSINESSID_QUERY, intImporContaFactuQuery, 
			intImporContaFactuQuery.clone(), "intImporContaFactu");
		...
		IntImporContaFactuData intImporContaFactu = datosResult;
		asignar("TEXT", "codImpoCont", FormatUtils.formatObject(intImporContaFactu.getCodImpoCont(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "valIdenCabeDeta", FormatUtils.formatObject(intImporContaFactu.getValIdenCabeDeta(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "valDescImpo", FormatUtils.formatObject(intImporContaFactu.getValDescImpo(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "valObse", FormatUtils.formatObject(intImporContaFactu.getValObse(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		asignarAtributo("TEXT", "codImpoCont", "disabled", "S");
		asignarAtributo("TEXT", "valIdenCabeDeta", "disabled", "S");
		asignarAtributo("TEXT", "valDescImpo", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		...
		asignarAtributo("TEXT", "codImpoCont", "req", "S");
		asignarAtributo("TEXT", "valIdenCabeDeta", "req", "S");
		asignarAtributo("TEXT", "valDescImpo", "req", "S");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "intImporContaFactuFrm", "oculto", "N");
		...
		traza("MMG::Creando IntImporContaFactu");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		IntImporContaFactuData intImporContaFactuQuery= new IntImporContaFactuData();
		intImporContaFactuQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(intImporContaFactu.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"intImporContaFactuFrm\",0, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"intImporContaFactuFrm\",0, false)");
				asignarAtributo("AREATEXTO", "codImpoCont", "ontab","ejecutarAccionFocoModificacion(\"intImporContaFactuFrm\",0, true)");
				asignarAtributo("AREATEXTO", "codImpoCont", "onshtab","ejecutarAccionFocoModificacion(\"intImporContaFactuFrm\",0, false)");
				asignarAtributo("AREATEXTO", "valIdenCabeDeta", "ontab","ejecutarAccionFocoModificacion(\"intImporContaFactuFrm\",0, true)");
				asignarAtributo("AREATEXTO", "valIdenCabeDeta", "onshtab","ejecutarAccionFocoModificacion(\"intImporContaFactuFrm\",0, false)");
				asignarAtributo("AREATEXTO", "valDescImpo", "ontab","ejecutarAccionFocoModificacion(\"intImporContaFactuFrm\",0, true)");
				asignarAtributo("AREATEXTO", "valDescImpo", "onshtab","ejecutarAccionFocoModificacion(\"intImporContaFactuFrm\",0, false)");
				asignarAtributo("AREATEXTO", "valObse", "ontab","ejecutarAccionFocoModificacion(\"intImporContaFactuFrm\",0, true)");
				asignarAtributo("AREATEXTO", "valObse", "onshtab","ejecutarAccionFocoModificacion(\"intImporContaFactuFrm\",0, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","intImporContaFactuTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","intImporContaFactuTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codImpoCont...");		
				
				traza("MMG: el atributo es valIdenCabeDeta...");		
				
				traza("MMG: el atributo es valDescImpo...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","intImporContaFactuFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","intImporContaFactuListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","intImporContaFactuListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(IntImporContaFactuData intImporContaFactu) throws Exception{
	...
	* @param intImporContaFactu La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(IntImporContaFactuData intImporContaFactu) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		IntImporContaFactuData intImporContaFactu = 
			(IntImporContaFactuData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(intImporContaFactu);
		loadLeafDependenceCombos(intImporContaFactu);
	}
