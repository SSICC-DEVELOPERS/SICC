...
public class FacFormuPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","facFormuList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(16)).setAttribute("cod","FacFormu.codForm.label" );
      ...
      ((Element)v.get(17)).setAttribute("cod","FacFormu.indImpr.label" );
      ...
      ((Element)v.get(18)).setAttribute("cod","FacFormu.valNombForm.label" );
      ...
      ((Element)v.get(19)).setAttribute("cod","FacFormu.indActi.label" );
      ...
      ((Element)v.get(20)).setAttribute("cod","FacFormu.tidoOidTipoDocu.label" );
