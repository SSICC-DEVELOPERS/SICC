...
public class CccTipoTransViewPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","cccTipoTransViewList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","CccTipoTransView.codTipoTranCheq.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","CccTipoTransView.Descripcion.label" );
