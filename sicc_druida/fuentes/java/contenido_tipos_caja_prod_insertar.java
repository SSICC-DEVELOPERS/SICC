...
public class contenido_tipos_caja_prod_insertar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_tipos_caja_prod_insertar" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","contenido_tipos_caja_prod_insertar.js" );
      ...
      ((Element)v.get(8)).setAttribute("name","txtCodigoCaja" );
      ((Element)v.get(8)).setAttribute("required","true" );
      ((Element)v.get(8)).setAttribute("cod","3106" );
      ...
      ((Element)v.get(9)).setAttribute("cod","3107" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(18)).setAttribute("nombre","oidTipoCaja" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(19)).setAttribute("nombre","hDescripcion" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(36)).setAttribute("cod","00678" );
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(37)).setAttribute("width","95%" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(45)).setAttribute("nombre","lblCodigoCaja" );
      ...
      ((Element)v.get(45)).setAttribute("cod","3106" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(49)).setAttribute("cod","3107" );
      ...
      ((Element)v.get(56)).setAttribute("nombre","txtCodigoCaja" );
      ((Element)v.get(56)).setAttribute("id","datosCampos" );
      ((Element)v.get(56)).setAttribute("max","2" );
      ...
      ((Element)v.get(56)).setAttribute("onshtab","focaliza('formulario.txtDescripcion');" );
      ...
      ((Element)v.get(60)).setAttribute("ontab","focaliza('formulario.txtCodigoCaja');" );
      ...
      ((Element)v.get(61)).setAttribute("width","21" );
      ((Element)v.get(61)).setAttribute("height","15" );
      ((Element)v.get(61)).setAttribute("onclick","levantarI18N('formulario','1');" );
      ((Element)v.get(61)).setAttribute("onmouseover","this.style.cursor='hand';" );
      ...
      ((Element)v.get(66)).setAttribute("height","28" );
