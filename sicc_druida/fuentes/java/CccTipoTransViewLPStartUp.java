/*
    INDRA/CAR/mmg
    $Id: CccTipoTransViewLPStartUp.java,v 1.1 2009/12/03 18:42:11 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class CccTipoTransViewLPStartUp extends MMGDruidaBase{
	...
	public static final String BUSINESSID_QUERY = "MMGCccTipoTransViewQueryFromToUserPage";
	...
	public CccTipoTransViewLPStartUp(){
		super();
	}

	public void inicio() throws Exception {
		pagina("CccTipoTransViewPage");
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			buildJsPageSize("CccTipoTransView");
			...
			asignarAtributo("PAGINA", "CccTipoTransViewPage", "cod", "CccTipoTransView." + accion + ".label");
			...
			limpiarBotoneraLista("cccTipoTransView", accion);
	...
	protected void cmdLov() throws Exception{
		...
		//asignarAtributo("CAPA", "cccTipoTransViewLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "CccTipoTransViewPage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("CccTipoTransViewLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		CccTipoTransViewData cccTipoTransViewQuery= new CccTipoTransViewData();
		cccTipoTransViewQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		CccTipoTransViewData datosResult = (CccTipoTransViewData)getSingleObject(BUSINESSID_QUERY, cccTipoTransViewQuery, 
			cccTipoTransViewQuery.clone(), "cccTipoTransView");
		...
		preservaHiddensI18n(new Integer(1), "CCC_TIPO_TRANS", "cccTipoTransViewFrm", "Descripcion", true);
		...
		CccTipoTransViewData cccTipoTransView = datosResult;
		asignarAtributo("RADIOB", "codTipoTranCheq" , "valor", FormatUtils.formatObject(
			cccTipoTransView.getCodTipoTranCheq(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "Descripcion", FormatUtils.formatObject(cccTipoTransView.getDescripcion(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		loadLocalizationVars(cccTipoTransView);
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "CCC_TIPO_TRANS", "cccTipoTransViewFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('cccTipoTransViewFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "cccTipoTransViewFrm", "oculto", "N");
		...
		traza("MMG::Creando CccTipoTransView");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		CccTipoTransViewData cccTipoTransViewQuery= new CccTipoTransViewData();
		cccTipoTransViewQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(cccTipoTransView.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"cccTipoTransViewFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"cccTipoTransViewFrm\",1, false)");
					asignarAtributo("COMBO","paisOidPais", "ontab", "ejecutarAccionFocoModificacion(\"cccTipoTransViewFrm\",2, true)");
					asignarAtributo("COMBO","paisOidPais", "onshtab", "ejecutarAccionFocoModificacion(\"cccTipoTransViewFrm\",2, false)");
				asignarAtributo("TEXT", "codTipoTranCheq", "ontab","ejecutarAccionFocoModificacion(\"cccTipoTransViewFrm\",3, true)");
				asignarAtributo("TEXT", "codTipoTranCheq", "onshtab","ejecutarAccionFocoModificacion(\"cccTipoTransViewFrm\",3, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"cccTipoTransViewFrm\",4, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"cccTipoTransViewFrm\",4, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","cccTipoTransViewTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","cccTipoTransViewTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","cccTipoTransViewFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","cccTipoTransViewListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","cccTipoTransViewListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(CccTipoTransViewData cccTipoTransView) throws Exception{
		...
		if(cccTipoTransView != null && cccTipoTransView.getPaisOidPais() != null){
				checkCombo("paisOidPais" , cccTipoTransView.getPaisOidPais().getId().toString());
			}
	...
	* @param cccTipoTransView La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(CccTipoTransViewData cccTipoTransView) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		CccTipoTransViewData cccTipoTransView = 
			(CccTipoTransViewData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(cccTipoTransView.getPaisOidPais() != null){
			cccTipoTransView.setPaisOidPais((es.indra.belcorp.mso.SegPaisViewData)
			getSingleObject(BUSINESSID_PAISOIDPAIS_QUERY, 
			cccTipoTransView.getPaisOidPais(),
			cccTipoTransView.getPaisOidPais().clone(),
			"segPaisView"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(cccTipoTransView);
		loadLeafDependenceCombos(cccTipoTransView);
	}
	...
	*/
	...
	protected void loadLocalizationVars(CccTipoTransViewData cccTipoTransView) throws Exception{
		...
		mmgLocalizationQuery.setEntiPk(cccTipoTransView.getId());
