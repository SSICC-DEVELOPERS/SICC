...
public class ConectorBusquedaRapidaCliente  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","BusquedaRapidaCliente" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","DTOBusquedaRapidaCliente" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MAEBusquedaRapidaCliente" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(8)).setAttribute("NOMBRE","VAL_NOM1" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(9)).setAttribute("NOMBRE","VAL_NOM2" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(12)).setAttribute("NOMBRE","DTOSalida" );
      ((Element)v.get(12)).setAttribute("TIPO","OBJETO" );
