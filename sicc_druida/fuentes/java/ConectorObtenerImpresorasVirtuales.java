...
public class ConectorObtenerImpresorasVirtuales  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","FACObtenerImpresorasVirtuales" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(4)).setAttribute("NOMBRE","dtoSalida" );
      ((Element)v.get(4)).setAttribute("TIPO","OBJETO" );
