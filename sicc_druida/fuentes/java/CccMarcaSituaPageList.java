...
public class CccMarcaSituaPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","cccMarcaSituaList" );
      ...
      ((Element)v.get(14)).setAttribute("cod","CccMarcaSitua.codMarcSitu.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","CccMarcaSitua.Descripcion.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","CccMarcaSitua.indCuenCast.label" );
