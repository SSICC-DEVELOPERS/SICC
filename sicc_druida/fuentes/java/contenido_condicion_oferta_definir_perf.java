...
public class contenido_condicion_oferta_definir_perf  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_condicion_oferta_definir_perf" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(3)).setAttribute("src","contenido_condicion_oferta_definir_perf.js" );
      ...
      ((Element)v.get(11)).setAttribute("valor","LPDefinirCondicionOfertaPerf" );
