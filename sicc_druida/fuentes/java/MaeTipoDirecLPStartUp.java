/*
    INDRA/CAR/mmg
    $Id: MaeTipoDirecLPStartUp.java,v 1.1 2009/12/03 18:36:43 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class MaeTipoDirecLPStartUp extends MMGDruidaBase{
	...
	public MaeTipoDirecLPStartUp(){
		super();
	}

	public void inicio() throws Exception {
		pagina("MaeTipoDirecPage");
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "MaeTipoDirecPage", "cod", "MaeTipoDirec." + accion + ".label");
			...
			limpiarBotoneraLista("maeTipoDirec", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codTipoDire", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 2);");
		...
		//asignarAtributo("CAPA", "maeTipoDirecLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "MaeTipoDirecPage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("MaeTipoDirecLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		MaeTipoDirecData maeTipoDirecQuery= new MaeTipoDirecData();
		maeTipoDirecQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		MaeTipoDirecData datosResult = (MaeTipoDirecData)getSingleObject(BUSINESSID_QUERY, maeTipoDirecQuery, 
			maeTipoDirecQuery.clone(), "maeTipoDirec");
		...
		preservaHiddensI18n(new Integer(1), "MAE_TIPO_DIREC", "maeTipoDirecFrm", "Descripcion", true);
		...
		MaeTipoDirecData maeTipoDirec = datosResult;
		asignar("TEXT", "codTipoDire", FormatUtils.formatObject(maeTipoDirec.getCodTipoDire(), 
		...
		loadLocalizationVars(maeTipoDirec);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "codTipoDire", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "MAE_TIPO_DIREC", "maeTipoDirecFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "codTipoDire", "req", "S");
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('maeTipoDirecFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "maeTipoDirecFrm", "oculto", "N");
		...
		traza("MMG::Creando MaeTipoDirec");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		MaeTipoDirecData maeTipoDirecQuery= new MaeTipoDirecData();
		maeTipoDirecQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(maeTipoDirec.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"maeTipoDirecFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"maeTipoDirecFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codTipoDire", "ontab","ejecutarAccionFocoModificacion(\"maeTipoDirecFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codTipoDire", "onshtab","ejecutarAccionFocoModificacion(\"maeTipoDirecFrm\",2, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"maeTipoDirecFrm\",3, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"maeTipoDirecFrm\",3, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","maeTipoDirecTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","maeTipoDirecTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","maeTipoDirecFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","maeTipoDirecListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","maeTipoDirecListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(MaeTipoDirecData maeTipoDirec) throws Exception{
	...
	* @param maeTipoDirec La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(MaeTipoDirecData maeTipoDirec) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		MaeTipoDirecData maeTipoDirec = 
			(MaeTipoDirecData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(maeTipoDirec);
		loadLeafDependenceCombos(maeTipoDirec);
	}
	...
	*/
	...
	protected void loadLocalizationVars(MaeTipoDirecData maeTipoDirec) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("MAE_TIPO_DIREC");
		mmgLocalizationQuery.setEntiPk(maeTipoDirec.getId());
