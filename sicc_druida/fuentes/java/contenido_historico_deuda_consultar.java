...
public class contenido_historico_deuda_consultar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_historico_deuda_consultar" );
      ((Element)v.get(0)).setAttribute("cod","0235" );
      ((Element)v.get(0)).setAttribute("titulo","Consultar Histórico de Deuda" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","contenido_historico_deuda_consultar.js" );
      ...
      ((Element)v.get(9)).setAttribute("valor","LPConsultarHistoricoDeuda" );
      ((Element)v.get(5)).appendChild((Element)v.get(9));
      /* Termina nodo:9   */

      /* Empieza nodo:10 / Elemento padre: 5   */
      v.add(doc.createElement("VAR"));
      ((Element)v.get(10)).setAttribute("nombre","hOidCliente" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(36)).setAttribute("height","7" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(41)).setAttribute("nombre","lblCodigoCliente" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(48)).setAttribute("nombre","txtCodigoCliente" );
      ((Element)v.get(48)).setAttribute("id","datosCampos" );
      ((Element)v.get(48)).setAttribute("max","15" );
      ((Element)v.get(48)).setAttribute("tipo","" );
      ((Element)v.get(48)).setAttribute("onchange","onchange_codCliente()" );
      ((Element)v.get(48)).setAttribute("onshtab","onShifTab_txtCodigoCliente()" );
      ((Element)v.get(48)).setAttribute("req","N" );
      ((Element)v.get(48)).setAttribute("size","15" );
      ...
      v.add(doc.createElement("IMG"));
      ((Element)v.get(52)).setAttribute("src","iconBuscar.gif" );
      ((Element)v.get(52)).setAttribute("onclick","buscarClienteOnClick();" );
      ...
      ((Element)v.get(57)).setAttribute("height","7" );
      ...
      /* Empieza nodo:58 / Elemento padre: 23   */
      v.add(doc.createElement("td"));
      ((Element)v.get(23)).appendChild((Element)v.get(58));
      ...
      ((Element)v.get(68)).setAttribute("accion","botonOnClick()" );
      ((Element)v.get(68)).setAttribute("ontab","ontab_Buscar()" );
