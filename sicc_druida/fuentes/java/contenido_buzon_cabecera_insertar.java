...
public class contenido_buzon_cabecera_insertar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_buzon_cabecera_insertar" );
      ((Element)v.get(0)).setAttribute("cod","" );
      ((Element)v.get(0)).setAttribute("titulo","" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","Insertar Cabecera de Buzón" );
      ...
      v.add(doc.createTextNode("\r  \r\r function onLoadPag()   {  \r	configurarMenuSecundario(\"formulario\");   \r	fMostrarMensajeError();\r	focoCodigo();	\r }\r\r\r\r function onClickGuardar() {\r		\r	if(sicc_validaciones_generales()) {\r		var codBuzon = get(\"formulario.txtCodBuzon\");		\r		var descripcion = get(\"formulario.txtDescripcionBuzon\");\r		if(idUsuario!=\"\"){\r			var idUsuario = get(\"formulario.cbUsuario\",\"T\");\r			var arr = idUsuario[0].split(\" \");\r			set(\"formulario.idUsuario\", arr[0]);\r		}\r\r		set(\"formulario.conectorAction\", \"LPBuzon\");\r		set(\"formulario.accion\", \"insertar cabecera\");\r		set(\"formulario.codBuzon\", codBuzon);\r		set(\"formulario.descripcion\", descripcion);\r		\r		enviaSICC(\"formulario\");\r	}	\r }\r\r function fGuardar() {\r	onClickGuardar();\r }\r\r function focoCodigo() {\r   focaliza(\"formulario.txtCodBuzon\");  \r }\r\r function focoDescripcion() {\r   focaliza(\"formulario.txtDescripcionBuzon\");  \r }\r\r function focoUsuario() {	\r   focaliza(\"formulario.cbUsuario\");  \r }\r\r function fLimpiar() {\r	set(\"formulario.txtDescripcionBuzon\",\"\");\r	var arr = new Array();\r	arr[0] = \"\";\r	set(\"formulario.cbUsuario\", arr);\r	focoCodigo();\r }\r\r\r\r function reInicio(){\r	set(\"formulario.conectorAction\", \"LPBuzon\");\r	set(\"formulario.accion\", \"\");\r	set(\"formulario.opcionMenu\", \"Crear Buzon\");\r	eval(\"formulario\").oculto = \"N\";\r	enviaSICC(\"formulario\"); \r }\r   \r  "));
      ...
      ((Element)v.get(7)).setAttribute("name","txtCodBuzon" );
      ((Element)v.get(7)).setAttribute("required","true" );
      ((Element)v.get(7)).setAttribute("cod","2026" );
      ((Element)v.get(6)).appendChild((Element)v.get(7));
      /* Termina nodo:7   */

      /* Empieza nodo:8 / Elemento padre: 6   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(8)).setAttribute("name","txtDescripcionBuzon" );
      ((Element)v.get(8)).setAttribute("required","true" );
      ((Element)v.get(8)).setAttribute("cod","2027" );
      ((Element)v.get(6)).appendChild((Element)v.get(8));
      /* Termina nodo:8   */

      /* Empieza nodo:9 / Elemento padre: 6   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(9)).setAttribute("name","cbUsuario" );
      ((Element)v.get(9)).setAttribute("required","true" );
      ((Element)v.get(9)).setAttribute("cod","136" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(18)).setAttribute("nombre","idUsuario" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(46)).setAttribute("nombre","lblCodBuzon" );
      ...
      ((Element)v.get(46)).setAttribute("cod","2026" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(50)).setAttribute("nombre","lblDescripcionBuzon" );
      ...
      ((Element)v.get(50)).setAttribute("cod","2027" );
      ...
      ((Element)v.get(57)).setAttribute("nombre","txtCodBuzon" );
      ...
      ((Element)v.get(57)).setAttribute("onshtab","focoUsuario();" );
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(61)).setAttribute("nombre","txtDescripcionBuzon" );
      ((Element)v.get(61)).setAttribute("id","datosCampos" );
      ((Element)v.get(61)).setAttribute("max","40" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(74)).setAttribute("nombre","lblUsuario" );
      ...
      ((Element)v.get(74)).setAttribute("cod","136" );
      ...
      ((Element)v.get(81)).setAttribute("ontab","focoCodigo();" );
      ((Element)v.get(81)).setAttribute("onshtab","focoDescripcion();" );
