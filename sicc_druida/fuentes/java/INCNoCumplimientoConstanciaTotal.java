...
public class INCNoCumplimientoConstanciaTotal extends LPSICCBase {

  public INCNoCumplimientoConstanciaTotal() {
  ...
  private void cargarPagina() throws Exception{
    ...
    pagina("contenido_informe_no_cumplimiento_total_generar");
  ...
  private void generarReporte() throws Exception{
    ...
    datos.put(ConstantesREP.TITULO, "No Cumplimiento de Constancia Total");
    ...
    if(region.equals("")){
       reporte = "RD_REP-076_02";    
    }else{
       if(zona.equals("")){
          reporte = "RD_REP-076_01";
       }else{
          reporte = "RD_REP-076";
       }
    }    
