...
public class INCEvolucionAporte extends LPSICCBase {           
    public INCEvolucionAporte() {	 
        super();
    }
    ...
    public void ejecucion() throws Exception {		
        ...
        try {
            ...
            if (accion.equals("generar")){
                ...
                cargarPagina();
                getConfiguracionMenu("INCEvolucionAporte");
            }
        } catch (Exception ex) {
    ...
    private void cargarPagina() throws Exception{
        pagina("contenido_informe_evolucion_aporte_generar");   
    ...
    private void generarReporte() throws Exception{
        ...
        String tipoAporte  = conectorParametroLimpia("tipoAporte", "", true);
        datos.put(ConstantesREP.TIPOAPORTE, tipoAporte);
        ...
        String reporte;
        if (tipoAporte.equals("1")){
          datos.put(ConstantesREP.TITULO, "EVOLUCIÓN DEL APORTE ACUMULADO");
          reporte = "RD_REP-055";
        }else{
          datos.put(ConstantesREP.TITULO, "EVOLUCIÓN DEL APORTE DESACUMULADO");
          reporte = "RD_REP-055_01";
        }
