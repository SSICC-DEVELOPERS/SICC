...
public class MaeSuperGenerPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","maeSuperGenerList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","MaeSuperGener.codSupeGene.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","MaeSuperGener.Descripcion.label" );
