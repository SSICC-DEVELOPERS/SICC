/*
    INDRA/CAR/mmg
    $Id: MaeSubtiClienLPStartUp.java,v 1.1 2009/12/03 18:34:31 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class MaeSubtiClienLPStartUp extends MMGDruidaBase{
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "MaeSubtiClienPage", "cod", "MaeSubtiClien." + accion + ".label");
			...
			limpiarBotoneraLista("maeSubtiClien", accion);
	...
	protected void cmdLov() throws Exception{
		...
		//asignarAtributo("CAPA", "maeSubtiClienLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "MaeSubtiClienPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		MaeSubtiClienData maeSubtiClienQuery= new MaeSubtiClienData();
		maeSubtiClienQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		MaeSubtiClienData datosResult = (MaeSubtiClienData)getSingleObject(BUSINESSID_QUERY, maeSubtiClienQuery, 
			maeSubtiClienQuery.clone(), "maeSubtiClien");
		...
		preservaHiddensI18n(new Integer(1), "MAE_SUBTI_CLIEN", "maeSubtiClienFrm", "Descripcion", true);
		...
		MaeSubtiClienData maeSubtiClien = datosResult;
		es.indra.belcorp.mso.MaeTipoClienData ticlOidTipoClie = maeSubtiClien.getTiclOidTipoClie();
		if(ticlOidTipoClie != null && ticlOidTipoClie.getId() != null) checkCombo("ticlOidTipoClie" , ticlOidTipoClie.getId().toString());
		asignar("TEXT", "codSubtClie", FormatUtils.formatObject(maeSubtiClien.getCodSubtClie(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "Descripcion", FormatUtils.formatObject(maeSubtiClien.getDescripcion(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		loadLocalizationVars(maeSubtiClien);
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "MAE_SUBTI_CLIEN", "maeSubtiClienFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('maeSubtiClienFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "maeSubtiClienFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		MaeSubtiClienData maeSubtiClienQuery= new MaeSubtiClienData();
		maeSubtiClienQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(maeSubtiClien.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"maeSubtiClienFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"maeSubtiClienFrm\",1, false)");
					asignarAtributo("COMBO","ticlOidTipoClie", "ontab", "ejecutarAccionFocoModificacion(\"maeSubtiClienFrm\",2, true)");
					asignarAtributo("COMBO","ticlOidTipoClie", "onshtab", "ejecutarAccionFocoModificacion(\"maeSubtiClienFrm\",2, false)");
				asignarAtributo("AREATEXTO", "codSubtClie", "ontab","ejecutarAccionFocoModificacion(\"maeSubtiClienFrm\",3, true)");
				asignarAtributo("AREATEXTO", "codSubtClie", "onshtab","ejecutarAccionFocoModificacion(\"maeSubtiClienFrm\",3, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"maeSubtiClienFrm\",4, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"maeSubtiClienFrm\",4, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","maeSubtiClienTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","maeSubtiClienTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","maeSubtiClienFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","maeSubtiClienListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","maeSubtiClienListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(MaeSubtiClienData maeSubtiClien) throws Exception{
		...
		if(maeSubtiClien != null && maeSubtiClien.getTiclOidTipoClie() != null){
				checkCombo("ticlOidTipoClie" , maeSubtiClien.getTiclOidTipoClie().getId().toString());
			}
	...
	* @param maeSubtiClien La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(MaeSubtiClienData maeSubtiClien) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		MaeSubtiClienData maeSubtiClien = 
			(MaeSubtiClienData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(maeSubtiClien.getTiclOidTipoClie() != null){
			maeSubtiClien.setTiclOidTipoClie((es.indra.belcorp.mso.MaeTipoClienData)
			getSingleObject(BUSINESSID_TICLOIDTIPOCLIE_QUERY, 
			maeSubtiClien.getTiclOidTipoClie(),
			maeSubtiClien.getTiclOidTipoClie().clone(),
			"maeTipoClien"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(maeSubtiClien);
		loadLeafDependenceCombos(maeSubtiClien);
	}
	...
	*/
	...
	protected void loadLocalizationVars(MaeSubtiClienData maeSubtiClien) throws Exception{
		...
		mmgLocalizationQuery.setEntiPk(maeSubtiClien.getId());
