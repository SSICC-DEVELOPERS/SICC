...
public class contenido_pedidos_facturados_alarma  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_pedidos_facturados_alarma" );
      ((Element)v.get(0)).setAttribute("cod","0448" );
      ...
      v.add(doc.createTextNode("\r     \r  \r\r	function onLoadPag()   \r	{\r        \r        configurarMenuSecundario(\"frmContenido\");\r \r        var arr = new Array();\r        arr[arr.length] = new Array(\"fechaIni\", get('frmContenido.varFechaIni'));\r        \r        arr[arr.length] = new Array(\"fechaFin\", get('frmContenido.varFechaFin'));\r		arr[arr.length] = new Array(\"oidPais\",  get('frmContenido.varOidPais'));\r        \r        configurarPaginado(mipgndo, \"PEDAlarmaPedidos\", \"ConectorAlarmaPedidos\", \"es.indra.sicc.dtos.ped.DTOAlarmaPedidos\",arr);\r        txt_to('lblTotalSolicitudesX', get('frmContenido.varTotales'));\r        DrdEnsanchaConMargenDcho('listado1',12);\r	    \r	    document.all[\"Cplistado1\"].style.visibility='';\r	    document.all[\"CpLin1listado1\"].style.visibility='';\r	    document.all[\"CpLin2listado1\"].style.visibility='';\r	    document.all[\"CpLin3listado1\"].style.visibility='';\r	    document.all[\"CpLin4listado1\"].style.visibility='';\r\r	    document.all[\"primera1Div\"].style.visibility='';\r	    document.all[\"ret1Div\"].style.visibility='';\r	    document.all[\"ava1Div\"].style.visibility='';\r	    document.all[\"separaDiv\"].style.visibility='';\r        \r        \r	    eval (ON_RSZ);  \r	}\r	function fVolver(){\r       \r	   history.back();\r	}\r  \r\r  \r  "));
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(12)).setAttribute("nombre","varFechaIni" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(13)).setAttribute("nombre","varFechaFin" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(14)).setAttribute("nombre","varTotales" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(15)).setAttribute("nombre","varOidPais" );
      ...
      ((Element)v.get(16)).setAttribute("nombre","capaTitulo" );
      ((Element)v.get(16)).setAttribute("x","0" );
      ((Element)v.get(16)).setAttribute("y","341" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(43)).setAttribute("nombre","lblTotalSolicitudes" );
      ...
      ((Element)v.get(43)).setAttribute("cod","2340" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(50)).setAttribute("nombre","lblTotalSolicitudesX" );
      ...
      ((Element)v.get(50)).setAttribute("codi","5" );
      ...
      /* Empieza nodo:53 / Elemento padre: 35   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(35)).appendChild((Element)v.get(53));
      ...
      /* Empieza nodo:56 / Elemento padre: 25   */
      v.add(doc.createElement("td"));
      ((Element)v.get(25)).appendChild((Element)v.get(56));
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(61)).setAttribute("width","750" );
      ...
      ((Element)v.get(65)).setAttribute("ancho","503" );
      ((Element)v.get(65)).setAttribute("alto","317" );
      ((Element)v.get(65)).setAttribute("x","12" );
      ((Element)v.get(65)).setAttribute("y","12" );
      ...
      ((Element)v.get(68)).setAttribute("maximROver","bot_despliega_columna_over.gif" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(73)).setAttribute("cod","00186" );
      ...
      ((Element)v.get(76)).setAttribute("ancho","60" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(77)).setAttribute("ancho","60" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(78)).setAttribute("ancho","60" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(79)).setAttribute("ancho","120" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(80)).setAttribute("ancho","60" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(81)).setAttribute("ancho","130" );
      ...
      ((Element)v.get(82)).setAttribute("alto","20" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(86)).setAttribute("cod","415" );
      ...
      ((Element)v.get(87)).setAttribute("cod","424" );
      ...
      ((Element)v.get(88)).setAttribute("cod","1394" );
      ((Element)v.get(82)).appendChild((Element)v.get(88));
      /* Termina nodo:88   */
      /* Termina nodo:82   */

      /* Empieza nodo:89 / Elemento padre: 65   */
      ...
      ((Element)v.get(65)).appendChild((Element)v.get(89));
      ...
      ((Element)v.get(101)).setAttribute("VALOR","xxxxxxxxxxxxxxxxxxxxxxxxxxxxx1" );
      ...
      ((Element)v.get(102)).setAttribute("VALOR","xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx1" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(104)).setAttribute("VALOR","xx-xx-xxxx" );
      ...
      ((Element)v.get(109)).setAttribute("VALOR","xxxxxxxxxxxxxxxxxxxxxxxxxxxxx1" );
      ...
      ((Element)v.get(110)).setAttribute("VALOR","xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx1" );
      ...
      ((Element)v.get(111)).setAttribute("VALOR","xxxxxxx1" );
      ...
      ((Element)v.get(112)).setAttribute("VALOR","xx-xx-xxxx" );
      ...
      ((Element)v.get(117)).setAttribute("VALOR","xxxxxxxxxxxxxxxxxxxxxxxxxxxxx1" );
      ...
      ((Element)v.get(118)).setAttribute("VALOR","xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx1" );
      ...
      ((Element)v.get(119)).setAttribute("VALOR","xxxxxxx1" );
      ...
      ((Element)v.get(120)).setAttribute("VALOR","xx-xx-xxxx" );
      ...
      v.add(doc.createElement("ROW"));
      ((Element)v.get(121)).setAttribute("ID","1" );
      ((Element)v.get(96)).appendChild((Element)v.get(121));

      /* Empieza nodo:122 / Elemento padre: 121   */
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(122)).setAttribute("NOMBRE","dato1" );
      ((Element)v.get(122)).setAttribute("TIPO","STRING" );
      ((Element)v.get(122)).setAttribute("VALOR","COD3" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(125)).setAttribute("VALOR","xxxxxxxxxxxxxxxxxxxxxxxxxxxxx1" );
      ...
      ((Element)v.get(127)).setAttribute("VALOR","xxxxxxx1" );
      ...
      ((Element)v.get(128)).setAttribute("VALOR","xx-xx-xxxx" );
      ((Element)v.get(121)).appendChild((Element)v.get(128));
      /* Termina nodo:128   */
      /* Termina nodo:121   */

      /* Empieza nodo:129 / Elemento padre: 96   */
      v.add(doc.createElement("ROW"));
      ((Element)v.get(129)).setAttribute("ID","2" );
      ((Element)v.get(96)).appendChild((Element)v.get(129));

      /* Empieza nodo:130 / Elemento padre: 129   */
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(130)).setAttribute("NOMBRE","dato1" );
      ((Element)v.get(130)).setAttribute("TIPO","STRING" );
      ((Element)v.get(130)).setAttribute("VALOR","COD4" );
      ...
      ((Element)v.get(133)).setAttribute("VALOR","xxxxxxxxxxxxxxxxxxxxxxxxxxxxx1" );
      ...
      ((Element)v.get(134)).setAttribute("VALOR","xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx1" );
      ...
      ((Element)v.get(135)).setAttribute("VALOR","xxxxxxx1" );
      ...
      ((Element)v.get(136)).setAttribute("VALOR","xx-xx-xxxx" );
      ((Element)v.get(129)).appendChild((Element)v.get(136));
      /* Termina nodo:136   */
      /* Termina nodo:129   */

      /* Empieza nodo:137 / Elemento padre: 96   */
      v.add(doc.createElement("ROW"));
      ((Element)v.get(137)).setAttribute("ID","3" );
      ((Element)v.get(96)).appendChild((Element)v.get(137));

      /* Empieza nodo:138 / Elemento padre: 137   */
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(138)).setAttribute("NOMBRE","dato1" );
      ((Element)v.get(138)).setAttribute("TIPO","STRING" );
      ((Element)v.get(138)).setAttribute("VALOR","COD5" );
      ...
      ((Element)v.get(141)).setAttribute("VALOR","xxxxxxxxxxxxxxxxxxxxxxxxxxxxx1" );
   ...
   private void getXML630(Document doc) {
      ...
      ((Element)v.get(142)).setAttribute("VALOR","xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx1" );
      ...
      ((Element)v.get(143)).setAttribute("VALOR","xxxxxxx1" );
      ...
      ((Element)v.get(144)).setAttribute("VALOR","xx-xx-xxxx" );
      ...
      ((Element)v.get(146)).setAttribute("VALOR","COD6" );
      ...
      ((Element)v.get(147)).setAttribute("VALOR","xxxxxxxxxxxxxxxxxxxxxxxxxxxxx1" );
      ...
      ((Element)v.get(148)).setAttribute("VALOR","xxxxxxxxxxxxxxxxxxxxxxxxxxxxx1" );
      ...
      ((Element)v.get(149)).setAttribute("VALOR","xxxxxxxxxxxxxxxxxxxxxxxxxxxxx1" );
      ...
      ((Element)v.get(150)).setAttribute("VALOR","xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx1" );
      ...
      ((Element)v.get(151)).setAttribute("VALOR","xxxxxxx1" );
      ...
      ((Element)v.get(152)).setAttribute("VALOR","xx-xx-xxxx" );
      ((Element)v.get(145)).appendChild((Element)v.get(152));
      /* Termina nodo:152   */
      /* Termina nodo:145   */

      /* Empieza nodo:153 / Elemento padre: 96   */
      v.add(doc.createElement("ROW"));
      ((Element)v.get(153)).setAttribute("ID","1" );
      ((Element)v.get(96)).appendChild((Element)v.get(153));

      /* Empieza nodo:154 / Elemento padre: 153   */
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(154)).setAttribute("NOMBRE","dato1" );
      ((Element)v.get(154)).setAttribute("TIPO","STRING" );
      ((Element)v.get(154)).setAttribute("VALOR","COD0" );
      ...
      ((Element)v.get(155)).setAttribute("VALOR","xxxxxxxxxxxxxxxxxxxxxxxxxxxxx1" );
      ...
      ((Element)v.get(156)).setAttribute("VALOR","xxxxxxxxxxxxxxxxxxxxxxxxxxxxx1" );
      ...
      ((Element)v.get(157)).setAttribute("VALOR","xxxxxxxxxxxxxxxxxxxxxxxxxxxxx1" );
      ...
      ((Element)v.get(158)).setAttribute("VALOR","xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx1" );
      ...
      ((Element)v.get(159)).setAttribute("VALOR","xxxxxxx1" );
      ...
      ((Element)v.get(160)).setAttribute("VALOR","xx-xx-xxxx" );
      ((Element)v.get(153)).appendChild((Element)v.get(160));
      /* Termina nodo:160   */
      /* Termina nodo:153   */

      /* Empieza nodo:161 / Elemento padre: 96   */
   }

   private void getXML720(Document doc) {
      v.add(doc.createElement("ROW"));
      ((Element)v.get(161)).setAttribute("ID","2" );
      ((Element)v.get(96)).appendChild((Element)v.get(161));

      /* Empieza nodo:162 / Elemento padre: 161   */
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(162)).setAttribute("NOMBRE","dato1" );
      ((Element)v.get(162)).setAttribute("TIPO","STRING" );
      ((Element)v.get(162)).setAttribute("VALOR","COD1" );
      ...
      ((Element)v.get(163)).setAttribute("VALOR","xxxxxxxxxxxxxxxxxxxxxxxxxxxxx1" );
      ...
      ((Element)v.get(164)).setAttribute("VALOR","xxxxxxxxxxxxxxxxxxxxxxxxxxxxx1" );
      ...
      ((Element)v.get(165)).setAttribute("VALOR","xxxxxxxxxxxxxxxxxxxxxxxxxxxxx1" );
      ...
      ((Element)v.get(166)).setAttribute("VALOR","xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx1" );
      ...
      ((Element)v.get(167)).setAttribute("VALOR","xxxxxxx1" );
      ...
      ((Element)v.get(168)).setAttribute("VALOR","xx-xx-xxxx" );
      ((Element)v.get(161)).appendChild((Element)v.get(168));
      /* Termina nodo:168   */
      /* Termina nodo:161   */

      /* Empieza nodo:169 / Elemento padre: 96   */
      v.add(doc.createElement("ROW"));
      ((Element)v.get(169)).setAttribute("ID","3" );
      ((Element)v.get(96)).appendChild((Element)v.get(169));

      /* Empieza nodo:170 / Elemento padre: 169   */
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(170)).setAttribute("NOMBRE","dato1" );
      ((Element)v.get(170)).setAttribute("TIPO","STRING" );
      ((Element)v.get(170)).setAttribute("VALOR","COD2" );
      ...
      ((Element)v.get(171)).setAttribute("VALOR","xxxxxxxxxxxxxxxxxxxxxxxxxxxxx1" );
      ...
      ((Element)v.get(172)).setAttribute("VALOR","xxxxxxxxxxxxxxxxxxxxxxxxxxxxx1" );
      ...
      ((Element)v.get(174)).setAttribute("VALOR","xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx1" );
      ...
      ((Element)v.get(175)).setAttribute("VALOR","xxxxxxx1" );
   ...
   private void getXML810(Document doc) {
      ...
      ((Element)v.get(178)).setAttribute("y","310" );
      ...
      ((Element)v.get(179)).setAttribute("y","310" );
      ...
      ((Element)v.get(180)).setAttribute("y","310" );
      ...
      ((Element)v.get(181)).setAttribute("y","306" );
