...
public class ZonZonaView2PageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","ZonZonaView2.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","ZonZonaView2.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('zonZonaView2Frm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('zonZonaView2Frm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(54)).setAttribute("cod","ZonZonaView2.marcOidMarc.label" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('zonZonaView2Frm',2, true);" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('zonZonaView2Frm',2, false);" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(76)).setAttribute("nombre","canaOidCanaTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(81)).setAttribute("nombre","canaOidCanaWidgetTrId" );
   }
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(83)).setAttribute("nombre","canaOidCana" );
      ...
      ((Element)v.get(83)).setAttribute("ontab","ejecutarAccionFoco('zonZonaView2Frm',3, true);" );
      ((Element)v.get(83)).setAttribute("onshtab","ejecutarAccionFoco('zonZonaView2Frm',3, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(85)).setAttribute("nombre","canaOidCanaGapTdId" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(106)).setAttribute("cod","ZonZonaView2.codZona.label" );
      ...
      ((Element)v.get(109)).setAttribute("ontab","ejecutarAccionFoco('zonZonaView2Frm',4, true)" );
      ((Element)v.get(109)).setAttribute("onshtab","ejecutarAccionFoco('zonZonaView2Frm', 4, false)" );
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(127)).setAttribute("nombre","paisOidPaisTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(131)).setAttribute("nombre","lblpaisOidPais" );
      ...
      ((Element)v.get(131)).setAttribute("cod","ZonZonaView2.paisOidPais.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(132)).setAttribute("nombre","paisOidPaisWidgetTrId" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(134)).setAttribute("nombre","paisOidPais" );
      ...
      ((Element)v.get(134)).setAttribute("ontab","ejecutarAccionFoco('zonZonaView2Frm',5, true);" );
      ((Element)v.get(134)).setAttribute("onshtab","ejecutarAccionFoco('zonZonaView2Frm',5, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(136)).setAttribute("nombre","paisOidPaisGapTdId" );
   ...
   private void getXML630(Document doc) {
      ...
      ((Element)v.get(142)).setAttribute("cod","ZonZonaView2.indActi.label" );
      ...
      ((Element)v.get(145)).setAttribute("ontab","ejecutarAccionFoco('zonZonaView2Frm',6, true)" );
      ((Element)v.get(145)).setAttribute("onshtab","ejecutarAccionFoco('zonZonaView2Frm', 6, false)" );
   ...
   private void getXML720(Document doc) {
      ...
      ((Element)v.get(167)).setAttribute("cod","ZonZonaView2.indBorr.label" );
      ...
      ((Element)v.get(170)).setAttribute("ontab","ejecutarAccionFoco('zonZonaView2Frm',7, true)" );
      ((Element)v.get(170)).setAttribute("onshtab","ejecutarAccionFoco('zonZonaView2Frm', 7, false)" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(176)).setAttribute("nombre","formGapTr5" );
   ...
   private void getXML810(Document doc) {
      ...
      /* Empieza nodo:185 / Elemento padre: 0   */
      v.add(doc.createElement("TR"));
      ((Element)v.get(185)).setAttribute("nombre","zonZonaView2TrButtons" );
      ((Element)v.get(0)).appendChild((Element)v.get(185));
      ...
      ((Element)v.get(192)).setAttribute("nombre","zonZonaView2TdQueryButton" );
      ((Element)v.get(191)).appendChild((Element)v.get(192));

      /* Empieza nodo:193 / Elemento padre: 192   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(193)).setAttribute("nombre","zonZonaView2QueryButton" );
      ((Element)v.get(193)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(193)).setAttribute("estado","false" );
      ((Element)v.get(193)).setAttribute("accion","zonZonaView2FirstPage();" );
      ...
      ((Element)v.get(194)).setAttribute("nombre","zonZonaView2TdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(196)).setAttribute("nombre","zonZonaView2LovNullButton" );
      ((Element)v.get(196)).setAttribute("ID","botonContenido" );
      ((Element)v.get(196)).setAttribute("tipo","html" );
      ((Element)v.get(196)).setAttribute("accion","zonZonaView2LovNullSelectionAction();" );
