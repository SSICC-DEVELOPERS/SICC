...
public class ConectorAplicarCargosAbonos  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","ConectorAplicarCargosAbonos" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","DTOCargosAbonos" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","CCCGuardarCargosAbonos" );
