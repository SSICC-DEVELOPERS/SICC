/*
    INDRA/CAR/mmg
    $Id: MaeTipoProblLPStartUp.java,v 1.1 2009/12/03 18:42:06 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class MaeTipoProblLPStartUp extends MMGDruidaBase{
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "MaeTipoProblPage", "cod", "MaeTipoProbl." + accion + ".label");
			...
			limpiarBotoneraLista("maeTipoProbl", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codTipoProb", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 2);");
		...
		//asignarAtributo("CAPA", "maeTipoProblLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "MaeTipoProblPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		MaeTipoProblData maeTipoProblQuery= new MaeTipoProblData();
		maeTipoProblQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		MaeTipoProblData datosResult = (MaeTipoProblData)getSingleObject(BUSINESSID_QUERY, maeTipoProblQuery, 
			maeTipoProblQuery.clone(), "maeTipoProbl");
		...
		preservaHiddensI18n(new Integer(1), "MAE_TIPO_PROBL", "maeTipoProblFrm", "Descripcion", true);
		...
		MaeTipoProblData maeTipoProbl = datosResult;
		asignar("TEXT", "codTipoProb", FormatUtils.formatObject(maeTipoProbl.getCodTipoProb(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("AREATEXTO", "Descripcion", FormatUtils.formatObject(maeTipoProbl.getDescripcion(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		loadLocalizationVars(maeTipoProbl);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "codTipoProb", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "MAE_TIPO_PROBL", "maeTipoProblFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "codTipoProb", "req", "S");
		...
		asignarAtributo("AREATEXTO", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('maeTipoProblFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "maeTipoProblFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		MaeTipoProblData maeTipoProblQuery= new MaeTipoProblData();
		maeTipoProblQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(maeTipoProbl.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"maeTipoProblFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"maeTipoProblFrm\",1, false)");
					asignarAtributo("COMBO","paisOidPais", "ontab", "ejecutarAccionFocoModificacion(\"maeTipoProblFrm\",2, true)");
					asignarAtributo("COMBO","paisOidPais", "onshtab", "ejecutarAccionFocoModificacion(\"maeTipoProblFrm\",2, false)");
				asignarAtributo("AREATEXTO", "codTipoProb", "ontab","ejecutarAccionFocoModificacion(\"maeTipoProblFrm\",3, true)");
				asignarAtributo("AREATEXTO", "codTipoProb", "onshtab","ejecutarAccionFocoModificacion(\"maeTipoProblFrm\",3, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"maeTipoProblFrm\",5, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"maeTipoProblFrm\",5, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","maeTipoProblTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","maeTipoProblTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codTipoProb...");		
				
					traza("MMG: en desactivateNonModifyFields encontrado atributo no editable...");
				
						// borrarCampo("codTipoProb");
						asignarAtributo ("TEXT", "codTipoProb", "disabled", "S");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","maeTipoProblFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","maeTipoProblListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","maeTipoProblListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(MaeTipoProblData maeTipoProbl) throws Exception{
		...
		if(maeTipoProbl != null && maeTipoProbl.getPaisOidPais() != null){
				checkCombo("paisOidPais" , maeTipoProbl.getPaisOidPais().getId().toString());
			}
	...
	* @param maeTipoProbl La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(MaeTipoProblData maeTipoProbl) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		MaeTipoProblData maeTipoProbl = 
			(MaeTipoProblData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(maeTipoProbl.getPaisOidPais() != null){
			maeTipoProbl.setPaisOidPais((es.indra.belcorp.mso.SegPaisViewData)
			getSingleObject(BUSINESSID_PAISOIDPAIS_QUERY, 
			maeTipoProbl.getPaisOidPais(),
			maeTipoProbl.getPaisOidPais().clone(),
			"segPaisView"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(maeTipoProbl);
		loadLeafDependenceCombos(maeTipoProbl);
	}
	...
	*/
	...
	protected void loadLocalizationVars(MaeTipoProblData maeTipoProbl) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("MAE_TIPO_PROBL");
		mmgLocalizationQuery.setEntiPk(maeTipoProbl.getId());
