...
public class contenido_informe_porcentaje_elevado_abonos_generar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_informe_porcentaje_elevado_abonos_generar" );
      ((Element)v.get(0)).setAttribute("cod","0918" );
      ((Element)v.get(0)).setAttribute("titulo","Generar informe zonas con porcentaje elevado de abonos" );
      ...
      v.add(doc.createTextNode("\r   \r   \r   function onLoad(){\r      configurarMenuSecundario('Formulario');\r      fMostrarMensajeError();\r      focaliza('Formulario.cbMarca');\r           \r   }\r   function generar(formato){\r      \r      if(sicc_validaciones_generales()){\r        \r          var a = new Object();\r          a.accion = 'generar';\r          a.marca = get('Formulario.cbMarca');\r          a.canal = get('Formulario.cbCanal');\r          a.periodoDesde = get('Formulario.cbPeriodoInicial');\r          a.periodoHasta = get('Formulario.cbPeriodoFinal');\r          a.periodoDesdeDesc = get('Formulario.cbPeriodoInicial', 'T');\r          a.periodoHastaDesc = get('Formulario.cbPeriodoFinal', 'T');\r          \r          a.zona = get('Formulario.cbZona');\r          a.region = get('Formulario.cbRegion');\r          \r          \r          a.formato = formato;\r          mostrarModalSICC('RECZonasEleveadosAbonos','generar', a);\r    \r      }\r\r   }\r\r\r\r        \r     function onchangeMarcaCanal(){\r        \r       marca  = get('Formulario.cbMarca');\r       canal  = get('Formulario.cbCanal');\r       pais   = get('Formulario.pais');\r       idioma = get('Formulario.idioma');\r      \r       if(marca != '' && canal != ''){\r          var arr = new Array();\r          \r          arr[arr.length] = [\"oidIdioma\", idioma]; \r          arr[arr.length] = [\"oidPais\", pais]; \r          arr[arr.length] = [\"marca\", marca];\r          arr[arr.length] = [\"canal\", canal];\r             \r          recargaCombo(\"Formulario.cbPeriodoInicial\",\"PRECargarPeriodos\",\"es.indra.sicc.dtos.cra.DTOPeriodo\",arr);\r          recargaCombo(\"Formulario.cbPeriodoFinal\",\"PRECargarPeriodos\",\"es.indra.sicc.dtos.cra.DTOPeriodo\",arr);\r	            \r          var arr2 = new Array();\r              \r          arr2[arr2.length] = [\"oidPais\", pais]; \r          arr2[arr2.length] = [\"oidMarca\", marca];\r          arr2[arr2.length] = [\"oidCanal\", canal];\r                     \r          recargaCombo(\"Formulario.cbRegion\",\"ZONRecargaRegiones\", \"es.indra.sicc.dtos.zon.DTOUnidadAdministrativa\",arr2); \r                 \r      }else{\r          var aCombo = new Array(new Array(\"\",\"\"));\r          set_combo('Formulario.cbPeriodoInicial', aCombo, []);\r          set_combo('Formulario.cbPeriodoFinal', aCombo, []);\r         \r       }\r      \r    } \r      \r      \r\r\r\r\r   function onchange_Region(){\r       \r         if(get('Formulario.cbRegion') != ''){\r              recargaCombo('Formulario.cbZona', 'ZONRecargaZonas', 'es.indra.sicc.dtos.zon.DTOUnidadAdministrativa',[[ \"oidRegion\", get('Formulario.cbRegion') ]] );\r         }\r    }\r\r\r\r   function fLimpiar(){\r     var aCombo = new Array(new Array(\"\",\"\"));\r     set_combo('Formulario.cbPeriodoInicial', aCombo, []); \r     set_combo('Formulario.cbPeriodoFinal', aCombo, []); \r     focaliza('Formulario.cbMarca');\r \r   }\r   \r\r\r   \r  \r  "));
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(53)).setAttribute("nombre","cbMarca" );
      ...
      ((Element)v.get(53)).setAttribute("onchange","onchangeMarcaCanal();" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(83)).setAttribute("nombre","cbPeriodoInicial" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(88)).setAttribute("nombre","cbPeriodoFinal" );
   ...
   private void getXML360(Document doc) {
      ...
      /* Empieza nodo:95 / Elemento padre: 34   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(34)).appendChild((Element)v.get(95));
      ...
      ((Element)v.get(106)).setAttribute("cod","143" );
      ...
      ((Element)v.get(113)).setAttribute("onchange","onchange_Region();" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(135)).setAttribute("nombre","btnGenerarInforme" );
      ((Element)v.get(135)).setAttribute("ID","botonContenido" );
      ((Element)v.get(135)).setAttribute("tipo","html" );
      ((Element)v.get(135)).setAttribute("accion","generar('pdf')" );
      ((Element)v.get(135)).setAttribute("estado","false" );
      ((Element)v.get(135)).setAttribute("cod","2495" );
      ((Element)v.get(135)).setAttribute("ontab","focaliza('Formulario.cbMarca')" );
