...
public class MaeEstatClienViewPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","maeEstatClienViewList" );
      ...
      ((Element)v.get(12)).setAttribute("cod","MaeEstatClienView.Descripcion.label" );
