...
public class contenido_actividad_tipo_cliente_periodo_obtener  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_actividad_tipo_cliente_periodo_obtener" );
      ((Element)v.get(0)).setAttribute("cod","0740" );
      ((Element)v.get(0)).setAttribute("titulo","Obtener actividad por tipo de cliente por período" );
      ...
      v.add(doc.createTextNode("\r   \r   \r   function onLoad(){\r        configurarMenuSecundario('Formulario');\r      fMostrarMensajeError();\r      focaliza('Formulario.cbPais');\r   }\r   function generar(){\r       if(sicc_validaciones_generales()){\r          /*recolectarParametros();\r      \r          set('Formulario.conectorAction', get('Formulario.casoDeUso'));           \r          set('Formulario.accion', 'generar');\r      \r          enviaSICC('Formulario');*/\r          var a = new Object();\r          a.accion = 'generar';\r          a.pais = get('Formulario.pais');      \r          a.marca = get('Formulario.cbMarca');\r          a.canal = get('Formulario.cbCanal');\r          a.periodo = get('Formulario.cbPeriodoCierre');\r          a.periodoDesc = get('Formulario.cbPeriodoCierre', 'T');\r          a.subgerencia = get('Formulario.cbSubgerenciaVentas');\r          a.region = get('Formulario.cbRegion');\r          a.zona = get('Formulario.cbZona'); \r          var lp = get('Formulario.casoDeUso');\r          mostrarModalSICC(lp,'generar', a); \r      }\r   }\r    function onchange_Region(){\r        limpiarZona();\r        if(get('Formulario.cbRegion') != ''){\r             recargaCombo('Formulario.cbZona', 'ZONRecargaZonas', 'es.indra.sicc.dtos.zon.DTOUnidadAdministrativa',[[ \"oidRegion\", get('Formulario.cbRegion') ]] );\r        }\r    }\r\r\r   function limpiarZona(){\r      var aCombo = new Array(new Array(\"\",\"\"));\r      set_combo('Formulario.cbZona', aCombo, []);\r      \r   }\r   \r\r   function limpiarPeriSub(){\r      var aCombo = new Array(new Array(\"\",\"\"));\r      set_combo('Formulario.cbPeriodoCierre', aCombo, []);\r      set_combo('Formulario.cbSubgerenciaVentas', aCombo, []);\r      \r   }   \r   \r\r   function recargaPeriodo(){\r   \r      var marca = get(\"Formulario.cbMarca\");\r      var canal = get(\"Formulario.cbCanal\");\r      var pais = get(\"Formulario.pais\");\r      var idioma = get(\"Formulario.idioma\");\r      \r      var arr = new Array();\r      var arr2 = new Array();\r      \r      arr[arr.length] = [\"oidIdioma\", idioma]; \r      arr[arr.length] = [\"oidPais\", pais]; \r      arr[arr.length] = [\"marca\", marca];\r      arr[arr.length] = [\"canal\", canal];\r      \r      arr2[arr2.length] = [\"oidIdioma\", idioma]; \r      arr2[arr2.length] = [\"oidPais\", pais]; \r      arr2[arr2.length] = [\"oidMarca\", marca]; \r      arr2[arr2.length] = [\"oidCanal\", canal]; \r      limpiarPeriSub();\r\r      if ( marca != \"\" && canal != \"\"){\r         \r         recargaCombo(\"Formulario.cbPeriodoCierre\",\"PRECargarPeriodos\",\"es.indra.sicc.dtos.cra.DTOPeriodo\",arr);\r         recargaCombo(\"Formulario.cbSubgerenciaVentas\",\"ZONRecargaSubgerenciaVentas\", \"es.indra.sicc.dtos.zon.DTOUnidadAdministrativa\",arr2);\r         \r      }else{\r        var aCombo = new Array(new Array(\"\",\"\"));\r        set_combo('Formulario.cbPeriodoCierre', aCombo, []);\r        set_combo('Formulario.cbSubgerenciaVentas', aCombo, []);\r      }\r   }\r   function fLimpiar(){\r     limpiarZona(); \r     limpiarPeriSub();\r     focaliza('Formulario.cbPais');\r   }\r  \r\r   function recolectarParametros(){\r      \r      set('Formulario.pais', get('Formulario.pais') );      \r      set('Formulario.marca', get('Formulario.cbMarca') );\r      set('Formulario.canal', get('Formulario.cbCanal'));\r      set('Formulario.periodo', get('Formulario.cbPeriodoCierre'));\r      set('Formulario.periodoDesc', get('Formulario.cbPeriodoCierre', 'T'));\r      set('Formulario.subgerencia', get('Formulario.cbSubgerenciaVentas'));\r      set('Formulario.region', get('Formulario.cbRegion'));\r      set('Formulario.zona', get('Formulario.cbZona'));\r  \r      \r  \r   }\r   \r"));
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(10)).setAttribute("name","cbPeriodoCierre" );
      ((Element)v.get(10)).setAttribute("required","true" );
      ((Element)v.get(10)).setAttribute("cod","2501" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(22)).setAttribute("nombre","periodoDesc" );
   }
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(23)).setAttribute("nombre","subgerencia" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(60)).setAttribute("nombre","cbPais" );
      ...
      /* Empieza nodo:67 / Elemento padre: 42   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(42)).appendChild((Element)v.get(67));
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(85)).setAttribute("nombre","cbMarca" );
      ...
      ((Element)v.get(85)).setAttribute("onchange","recargaPeriodo();" );
      ...
      ((Element)v.get(90)).setAttribute("onchange","recargaPeriodo();" );
   ...
   private void getXML360(Document doc) {
      ...
      /* Empieza nodo:97 / Elemento padre: 42   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(42)).appendChild((Element)v.get(97));
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(115)).setAttribute("nombre","cbPeriodoCierre" );
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(145)).setAttribute("nombre","cbRegion" );
      ...
      ((Element)v.get(145)).setAttribute("onchange","onchange_Region();" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(150)).setAttribute("nombre","cbZona" );
      ...
      /* Empieza nodo:159 / Elemento padre: 27   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(27)).appendChild((Element)v.get(159));
   ...
   private void getXML630(Document doc) {
      ...
      ((Element)v.get(167)).setAttribute("accion","generar();" );
      ((Element)v.get(167)).setAttribute("estado","false" );
      ((Element)v.get(167)).setAttribute("cod","2495" );
      ((Element)v.get(167)).setAttribute("ontab","focaliza('Formulario.cbPais')" );
      ...
      /* Empieza nodo:170 / Elemento padre: 27   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(27)).appendChild((Element)v.get(170));
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(173)).setAttribute("width","756" );
      ...
      ((Element)v.get(176)).setAttribute("height","1" );
