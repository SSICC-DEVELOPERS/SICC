...
public class contenido_llamadas_status_obtener  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("cod","0757" );
      ((Element)v.get(0)).setAttribute("titulo","Obtener llamadas por status" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(56)).setAttribute("nombre","lblCliente" );
      ...
      ((Element)v.get(56)).setAttribute("cod","1471" );
      ...
      ((Element)v.get(63)).setAttribute("nombre","txtFechaInicio" );
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(67)).setAttribute("nombre","txtFechaFin" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(71)).setAttribute("nombre","txtCliente" );
      ...
      ((Element)v.get(71)).setAttribute("size","19" );
      ...
      /* Empieza nodo:78 / Elemento padre: 40   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(40)).appendChild((Element)v.get(78));
      ...
      /* Empieza nodo:83 / Elemento padre: 22   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(22)).appendChild((Element)v.get(83));
      ...
      ((Element)v.get(91)).setAttribute("nombre","btnGenerarInforme" );
      ((Element)v.get(91)).setAttribute("ID","botonContenido" );
      ((Element)v.get(91)).setAttribute("tipo","html" );
      ((Element)v.get(91)).setAttribute("accion","generar()" );
   }

   private void getXML360(Document doc) {
      ((Element)v.get(91)).setAttribute("estado","false" );
      ((Element)v.get(91)).setAttribute("cod","2495" );
      ((Element)v.get(91)).setAttribute("ontab","focaliza('Formulario.txtFechaInicio')" );
