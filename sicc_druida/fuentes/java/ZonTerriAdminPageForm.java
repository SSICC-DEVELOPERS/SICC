...
public class ZonTerriAdminPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","ZonTerriAdmin.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","ZonTerriAdmin.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('zonTerriAdminFrm',0, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('zonTerriAdminFrm', 0, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(50)).setAttribute("nombre","indBorrTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lblIndBorr" );
      ((Element)v.get(54)).setAttribute("alto","13" );
      ((Element)v.get(54)).setAttribute("filas","1" );
      ((Element)v.get(54)).setAttribute("id","datosTitle" );
      ((Element)v.get(54)).setAttribute("cod","ZonTerriAdmin.indBorr.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(55)).setAttribute("nombre","indBorrWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(57)).setAttribute("nombre","indBorr" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('zonTerriAdminFrm',0, true)" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('zonTerriAdminFrm', 0, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(58)).setAttribute("nombre","indBorrGapTdId" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(75)).setAttribute("nombre","zsccOidSeccTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(80)).setAttribute("nombre","zsccOidSeccWidgetTrId" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(82)).setAttribute("nombre","zsccOidSecc" );
      ...
      ((Element)v.get(82)).setAttribute("ontab","ejecutarAccionFoco('zonTerriAdminFrm',0, true);" );
      ((Element)v.get(82)).setAttribute("onshtab","ejecutarAccionFoco('zonTerriAdminFrm',0, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(84)).setAttribute("nombre","zsccOidSeccGapTdId" );
   ...
   private void getXML450(Document doc) {
      v.add(doc.createElement("TD"));
      ((Element)v.get(101)).setAttribute("nombre","terrOidTerrTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(105)).setAttribute("nombre","lblterrOidTerr" );
      ...
      ((Element)v.get(105)).setAttribute("cod","ZonTerriAdmin.terrOidTerr.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(106)).setAttribute("nombre","terrOidTerrWidgetTrId" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(108)).setAttribute("nombre","terrOidTerr" );
      ...
      ((Element)v.get(108)).setAttribute("ontab","ejecutarAccionFoco('zonTerriAdminFrm',0, true);" );
      ((Element)v.get(108)).setAttribute("onshtab","ejecutarAccionFoco('zonTerriAdminFrm',0, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(110)).setAttribute("nombre","terrOidTerrGapTdId" );
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(127)).setAttribute("nombre","fecRtzTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(132)).setAttribute("nombre","fecRtzWidgetTrId" );
      ...
      ((Element)v.get(134)).setAttribute("ontab","ejecutarAccionFoco('zonTerriAdminFrm',0, true)" );
      ((Element)v.get(134)).setAttribute("onshtab","ejecutarAccionFoco('zonTerriAdminFrm', 0, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(135)).setAttribute("nombre","fecRtzGapTdId" );
   ...
   private void getXML630(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(149)).setAttribute("nombre","zonTerriAdminTrButtons" );
      ...
      ((Element)v.get(156)).setAttribute("nombre","zonTerriAdminTdQueryButton" );
      ((Element)v.get(155)).appendChild((Element)v.get(156));

      /* Empieza nodo:157 / Elemento padre: 156   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(157)).setAttribute("nombre","zonTerriAdminQueryButton" );
      ((Element)v.get(157)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(157)).setAttribute("estado","false" );
      ((Element)v.get(157)).setAttribute("accion","zonTerriAdminFirstPage();" );
      ...
      ((Element)v.get(158)).setAttribute("nombre","zonTerriAdminTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(160)).setAttribute("nombre","zonTerriAdminLovNullButton" );
      ((Element)v.get(160)).setAttribute("ID","botonContenido" );
      ((Element)v.get(160)).setAttribute("tipo","html" );
      ((Element)v.get(160)).setAttribute("accion","zonTerriAdminLovNullSelectionAction();" );
