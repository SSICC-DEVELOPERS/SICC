...
public class ZonRegioViewConectorQueryForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad ZonRegioView" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGZonRegioViewQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGZonRegioViewQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","ZonRegioViewFormFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(13)).setAttribute("NOMBRE","desRegi" );
