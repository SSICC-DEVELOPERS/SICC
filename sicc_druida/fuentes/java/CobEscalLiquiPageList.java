...
public class CobEscalLiquiPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","cobEscalLiquiList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(20)).setAttribute("cod","CobEscalLiqui.numOrdeEsca.label" );
      ...
      ((Element)v.get(21)).setAttribute("cod","CobEscalLiqui.impRangDesdImpo.label" );
      ...
      ((Element)v.get(22)).setAttribute("cod","CobEscalLiqui.impRangHastImpo.label" );
      ...
      ((Element)v.get(23)).setAttribute("cod","CobEscalLiqui.valRangDesdPorc.label" );
      ...
      ((Element)v.get(24)).setAttribute("cod","CobEscalLiqui.valRangHastPorc.label" );
      ...
      ((Element)v.get(25)).setAttribute("cod","CobEscalLiqui.impComiPorc.label" );
      ...
      ((Element)v.get(26)).setAttribute("cod","CobEscalLiqui.impComiImpo.label" );
      ...
      ((Element)v.get(27)).setAttribute("cod","CobEscalLiqui.valObse.label" );
      ...
      ((Element)v.get(28)).setAttribute("cod","CobEscalLiqui.melcOidMetoLiquCobr.label" );
