...
public class FacImpreVirtuViewPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","FacImpreVirtuView.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","FacImpreVirtuView.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('facImpreVirtuViewFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('facImpreVirtuViewFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(54)).setAttribute("cod","FacImpreVirtuView.codImpr.label" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('facImpreVirtuViewFrm',2, true)" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('facImpreVirtuViewFrm', 2, false)" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(79)).setAttribute("cod","FacImpreVirtuView.desImpr.label" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(82)).setAttribute("ontab","ejecutarAccionFoco('facImpreVirtuViewFrm',3, true)" );
      ((Element)v.get(82)).setAttribute("onshtab","ejecutarAccionFoco('facImpreVirtuViewFrm', 3, false)" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(97)).setAttribute("nombre","facImpreVirtuViewTrButtons" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(104)).setAttribute("nombre","facImpreVirtuViewTdQueryButton" );
      ((Element)v.get(103)).appendChild((Element)v.get(104));

      /* Empieza nodo:105 / Elemento padre: 104   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(105)).setAttribute("nombre","facImpreVirtuViewQueryButton" );
      ((Element)v.get(105)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(105)).setAttribute("estado","false" );
      ((Element)v.get(105)).setAttribute("accion","facImpreVirtuViewFirstPage();" );
      ...
      ((Element)v.get(106)).setAttribute("nombre","facImpreVirtuViewTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(108)).setAttribute("nombre","facImpreVirtuViewLovNullButton" );
      ((Element)v.get(108)).setAttribute("ID","botonContenido" );
      ((Element)v.get(108)).setAttribute("tipo","html" );
      ((Element)v.get(108)).setAttribute("accion","facImpreVirtuViewLovNullSelectionAction();" );
