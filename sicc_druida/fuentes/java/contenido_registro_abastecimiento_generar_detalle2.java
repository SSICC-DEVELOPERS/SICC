...
public class contenido_registro_abastecimiento_generar_detalle2  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_registro_abastecimiento_generar_detalle2" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(3)).setAttribute("src","contenido_registro_abastecimiento_generar_detalle2.js" );
      ((Element)v.get(0)).appendChild((Element)v.get(3));
      /* Termina nodo:3   */

      /* Empieza nodo:4 / Elemento padre: 0   */
      v.add(doc.createElement("FORMULARIO"));
      ((Element)v.get(4)).setAttribute("nombre","formularios" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(12)).setAttribute("nombre","oidSubacceso" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(13)).setAttribute("nombre","oidAlmacen" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("nombre","lblDatosDetalle" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(47)).setAttribute("valign","bottom" );
      ((Element)v.get(44)).appendChild((Element)v.get(47));

      /* Empieza nodo:48 / Elemento padre: 47   */
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(48)).setAttribute("nombre","txtCodProducto" );
      ((Element)v.get(48)).setAttribute("id","datosCampos" );
      ((Element)v.get(48)).setAttribute("max","20" );
      ((Element)v.get(48)).setAttribute("tipo","" );
      ((Element)v.get(48)).setAttribute("onblur","convertirAMayusculas()" );
      ((Element)v.get(48)).setAttribute("onshtab","irABoton()" );
      ((Element)v.get(48)).setAttribute("onchange","" );
      ((Element)v.get(48)).setAttribute("req","N" );
      ((Element)v.get(48)).setAttribute("size","23" );
      ...
      /* Empieza nodo:54 / Elemento padre: 23   */
      v.add(doc.createElement("td"));
      ((Element)v.get(23)).appendChild((Element)v.get(54));
      ...
      ((Element)v.get(64)).setAttribute("nombre","btnAceptar" );
      ((Element)v.get(64)).setAttribute("ID","botonContenido" );
      ((Element)v.get(64)).setAttribute("tipo","html" );
      ((Element)v.get(64)).setAttribute("accion","accionAceptar();" );
      ((Element)v.get(64)).setAttribute("ontab","irACajaTexto()" );
      ((Element)v.get(64)).setAttribute("estado","false" );
      ((Element)v.get(64)).setAttribute("cod","12" );
