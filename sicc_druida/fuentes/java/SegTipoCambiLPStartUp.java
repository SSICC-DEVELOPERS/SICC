/*
    INDRA/CAR/mmg
    $Id: SegTipoCambiLPStartUp.java,v 1.1 2009/12/03 18:32:19 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class SegTipoCambiLPStartUp extends MMGDruidaBase{
	...
	public static final String BUSINESSID_QUERY = "MMGSegTipoCambiQueryFromToUserPage";
				...
				public static final String BUSINESSID_MONEOIDMON1_QUERY ="MMGSegMonedQueryFromToUser";
				public static final String MONEOIDMON1_COMBO_CONNECTOR = "SegMonedConectorCombo";
	
				public static final String BUSINESSID_MONEOIDMON2_QUERY ="MMGSegMonedQueryFromToUser";
				public static final String MONEOIDMON2_COMBO_CONNECTOR = "SegMonedConectorCombo";
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "SegTipoCambiPage", "cod", "SegTipoCambi." + accion + ".label");
			...
			limpiarBotoneraLista("segTipoCambi", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("COMBO", "moneOidMon1", "validacion", "VerificaContenidoCmbs('segTipoCambiFrm.moneOidMon1','segTipoCambiFrm.moneOidMon2','SegTipoCambi','moneOidMon1')");
		...
		//asignarAtributo("CAPA", "segTipoCambiLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "SegTipoCambiPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		SegTipoCambiData segTipoCambiQuery= new SegTipoCambiData();
		segTipoCambiQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		SegTipoCambiData datosResult = (SegTipoCambiData)getSingleObject(BUSINESSID_QUERY, segTipoCambiQuery, 
			segTipoCambiQuery.clone(), "segTipoCambi");
		...
		SegTipoCambiData segTipoCambi = datosResult;
		es.indra.belcorp.mso.SegMonedData moneOidMon1 = segTipoCambi.getMoneOidMon1();
		if(moneOidMon1 != null && moneOidMon1.getId() != null) checkCombo("moneOidMon1" , moneOidMon1.getId().toString());
		es.indra.belcorp.mso.SegMonedData moneOidMon2 = segTipoCambi.getMoneOidMon2();
		if(moneOidMon2 != null && moneOidMon2.getId() != null) checkCombo("moneOidMon2" , moneOidMon2.getId().toString());
		asignar("TEXT", "fecDesd", FormatUtils.formatObject(segTipoCambi.getFecDesd(), 
			 UtilidadesSession.getFormatoFecha(this), decimalFormatSymbols));
		asignar("TEXT", "valTipoCamb", FormatUtils.formatObject(segTipoCambi.getValTipoCamb(), 
		...
		//Deshabilitamos todos los campos para que no se editen
					...
					asignarAtributo("COMBO", "moneOidMon1", "disabled", "S");
					asignarAtributo("COMBO", "moneOidMon2", "disabled", "S");asignarAtributo("TEXT", "fecDesd", "disabled", "S");
		asignarAtributo("TEXT", "valTipoCamb", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		...
		asignarAtributo("COMBO", "moneOidMon1", "req", "S");
		asignarAtributo("COMBO", "moneOidMon2", "req", "S");
		asignarAtributo("TEXT", "fecDesd", "req", "S");
		asignarAtributo("TEXT", "valTipoCamb", "req", "S");
		...
		asignarAtributo("TEXT", "fecDesd", "validacion", "mensaje = ValidaFechaMMG(cdos_trim(valor), '" + datePattern + "');");
		asignarAtributo("TEXT", "valTipoCamb", "validacion", "mensaje = ValidaNumeroMMG(cdos_trim(valor), " + (12 - MMGDruidaHelper.getUserDecimalPrecision(this)) + ", " + MMGDruidaHelper.getUserDecimalPrecision(this)+ ", 'SegTipoCambi.valTipoCamb', 0, " + MMGDruidaHelper.getMaxValueForDruidaValidaFloat((12 - MMGDruidaHelper.getUserDecimalPrecision(this)), this) + ");");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "segTipoCambiFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		SegTipoCambiData segTipoCambiQuery= new SegTipoCambiData();
		segTipoCambiQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(segTipoCambi.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"segTipoCambiFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"segTipoCambiFrm\",1, false)");
					asignarAtributo("COMBO","moneOidMon1", "ontab", "ejecutarAccionFocoModificacion(\"segTipoCambiFrm\",2, true)");
					asignarAtributo("COMBO","moneOidMon1", "onshtab", "ejecutarAccionFocoModificacion(\"segTipoCambiFrm\",2, false)");
					asignarAtributo("COMBO","moneOidMon2", "ontab", "ejecutarAccionFocoModificacion(\"segTipoCambiFrm\",3, true)");
					asignarAtributo("COMBO","moneOidMon2", "onshtab", "ejecutarAccionFocoModificacion(\"segTipoCambiFrm\",3, false)");
				asignarAtributo("AREATEXTO", "fecDesd", "ontab","ejecutarAccionFocoModificacion(\"segTipoCambiFrm\",4, true)");
				asignarAtributo("AREATEXTO", "fecDesd", "onshtab","ejecutarAccionFocoModificacion(\"segTipoCambiFrm\",4, false)");
				asignarAtributo("AREATEXTO", "valTipoCamb", "ontab","ejecutarAccionFocoModificacion(\"segTipoCambiFrm\",5, true)");
				asignarAtributo("AREATEXTO", "valTipoCamb", "onshtab","ejecutarAccionFocoModificacion(\"segTipoCambiFrm\",5, false)");
				asignarAtributo("AREATEXTO", "fecHast", "ontab","ejecutarAccionFocoModificacion(\"segTipoCambiFrm\",6, true)");
				asignarAtributo("AREATEXTO", "fecHast", "onshtab","ejecutarAccionFocoModificacion(\"segTipoCambiFrm\",6, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","segTipoCambiTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","segTipoCambiTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es moneOidMon1...");		
				
					traza("MMG: en desactivateNonModifyFields encontrado atributo no editable...");
				
						asignarAtributo("COMBO", "moneOidMon1", "disabled", "S");
				traza("MMG: el atributo es moneOidMon2...");		
				
					traza("MMG: en desactivateNonModifyFields encontrado atributo no editable...");
				
						asignarAtributo("COMBO", "moneOidMon2", "disabled", "S");
				traza("MMG: el atributo es fecDesd...");		
				
					traza("MMG: en desactivateNonModifyFields encontrado atributo no editable...");
				
						// borrarCampo("fecDesd");
						asignarAtributo ("TEXT", "fecDesd", "disabled", "S");
				traza("MMG: el atributo es valTipoCamb...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","segTipoCambiFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","segTipoCambiListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","segTipoCambiListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(SegTipoCambiData segTipoCambi) throws Exception{
		HashMap checkedCombos = new HashMap();
		SegMonedData moneOidMon1 = new SegMonedData();
		
						asignarComboResultados(BUSINESSID_MONEOIDMON1_QUERY,MONEOIDMON1_COMBO_CONNECTOR, 
			moneOidMon1, moneOidMon1.clone(), "segMoned", "moneOidMon1", "result_ROWSET" );
		if(segTipoCambi != null && segTipoCambi.getMoneOidMon1() != null){
				checkCombo("moneOidMon1" , segTipoCambi.getMoneOidMon1().getId().toString());
			}
		SegMonedData moneOidMon2 = new SegMonedData();
		
						asignarComboResultados(BUSINESSID_MONEOIDMON2_QUERY,MONEOIDMON2_COMBO_CONNECTOR, 
			moneOidMon2, moneOidMon2.clone(), "segMoned", "moneOidMon2", "result_ROWSET" );
		if(segTipoCambi != null && segTipoCambi.getMoneOidMon2() != null){
				checkCombo("moneOidMon2" , segTipoCambi.getMoneOidMon2().getId().toString());
			}
	...
	* @param segTipoCambi La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(SegTipoCambiData segTipoCambi) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		SegTipoCambiData segTipoCambi = 
			(SegTipoCambiData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(segTipoCambi.getMoneOidMon1() != null){
			segTipoCambi.setMoneOidMon1((es.indra.belcorp.mso.SegMonedData)
			getSingleObject(BUSINESSID_MONEOIDMON1_QUERY, 
			segTipoCambi.getMoneOidMon1(),
			segTipoCambi.getMoneOidMon1().clone(),
			"segMoned"));
		}
		if(segTipoCambi.getMoneOidMon2() != null){
			segTipoCambi.setMoneOidMon2((es.indra.belcorp.mso.SegMonedData)
			getSingleObject(BUSINESSID_MONEOIDMON2_QUERY, 
			segTipoCambi.getMoneOidMon2(),
			segTipoCambi.getMoneOidMon2().clone(),
			"segMoned"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(segTipoCambi);
		loadLeafDependenceCombos(segTipoCambi);
	}
