...
public class MaeEncueNseViewPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","MaeEncueNseView.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","MaeEncueNseView.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('maeEncueNseViewFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('maeEncueNseViewFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(54)).setAttribute("cod","MaeEncueNseView.paisOidPais.label" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('maeEncueNseViewFrm',2, true);" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('maeEncueNseViewFrm',2, false);" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(61)).setAttribute("nombre","codTipoEncuTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(65)).setAttribute("nombre","lblCodTipoEncu" );
      ((Element)v.get(65)).setAttribute("alto","13" );
      ((Element)v.get(65)).setAttribute("filas","1" );
      ((Element)v.get(65)).setAttribute("id","datosTitle" );
      ((Element)v.get(65)).setAttribute("cod","MaeEncueNseView.codTipoEncu.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(66)).setAttribute("nombre","codTipoEncuWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(68)).setAttribute("nombre","codTipoEncu" );
      ...
      ((Element)v.get(68)).setAttribute("ontab","ejecutarAccionFoco('maeEncueNseViewFrm',3, true)" );
      ((Element)v.get(68)).setAttribute("onshtab","ejecutarAccionFoco('maeEncueNseViewFrm', 3, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(69)).setAttribute("nombre","codTipoEncuGapTdId" );
      ...
      ((Element)v.get(75)).setAttribute("cod","MaeEncueNseView.Descripcion.label" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(79)).setAttribute("ontab","ejecutarAccionFoco('maeEncueNseViewFrm',4, true)" );
      ((Element)v.get(79)).setAttribute("onshtab","ejecutarAccionFoco('maeEncueNseViewFrm', 4, false)" );
      ...
      ((Element)v.get(83)).setAttribute("href","javascript:openLocalizationDialog('maeEncueNseViewFrm', 'Descripcion', 1);" );
      ((Element)v.get(83)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"maeEncueNseViewFrm\",4, true)', 'ejecutarAccionFoco(\"maeEncueNseViewFrm\",4, false)')" );
      ...
      ((Element)v.get(91)).setAttribute("cod","MaeEncueNseView.marcOidMarc.label" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(94)).setAttribute("ontab","ejecutarAccionFoco('maeEncueNseViewFrm',7, true);" );
      ((Element)v.get(94)).setAttribute("onshtab","ejecutarAccionFoco('maeEncueNseViewFrm',7, false);" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(110)).setAttribute("nombre","maeEncueNseViewTrButtons" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(117)).setAttribute("nombre","maeEncueNseViewTdQueryButton" );
      ((Element)v.get(116)).appendChild((Element)v.get(117));

      /* Empieza nodo:118 / Elemento padre: 117   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(118)).setAttribute("nombre","maeEncueNseViewQueryButton" );
      ((Element)v.get(118)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(118)).setAttribute("estado","false" );
      ((Element)v.get(118)).setAttribute("accion","maeEncueNseViewFirstPage();" );
      ...
      ((Element)v.get(119)).setAttribute("nombre","maeEncueNseViewTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(121)).setAttribute("nombre","maeEncueNseViewLovNullButton" );
      ((Element)v.get(121)).setAttribute("ID","botonContenido" );
      ((Element)v.get(121)).setAttribute("tipo","html" );
      ((Element)v.get(121)).setAttribute("accion","maeEncueNseViewLovNullSelectionAction();" );
