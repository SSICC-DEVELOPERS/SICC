/*
    INDRA/CAR/mmg
    $Id: EduTipoCursoLPStartUp.java,v 1.1 2009/12/03 18:35:43 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class EduTipoCursoLPStartUp extends MMGDruidaBase{
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "EduTipoCursoPage", "cod", "EduTipoCurso." + accion + ".label");
			...
			limpiarBotoneraLista("eduTipoCurso", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codTipoCurs", "validacion", "mensaje = ValidaInt(cdos_trim(valor), 2, 0, 99);");
		...
		//asignarAtributo("CAPA", "eduTipoCursoLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "EduTipoCursoPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		EduTipoCursoData eduTipoCursoQuery= new EduTipoCursoData();
		eduTipoCursoQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		EduTipoCursoData datosResult = (EduTipoCursoData)getSingleObject(BUSINESSID_QUERY, eduTipoCursoQuery, 
			eduTipoCursoQuery.clone(), "eduTipoCurso");
		...
		preservaHiddensI18n(new Integer(1), "EDU_TIPO_CURSO", "eduTipoCursoFrm", "Descripcion", true);
		...
		EduTipoCursoData eduTipoCurso = datosResult;
		es.indra.belcorp.mso.SegMarcaData marcOidMarc = eduTipoCurso.getMarcOidMarc();
		if(marcOidMarc != null && marcOidMarc.getId() != null) checkCombo("marcOidMarc" , marcOidMarc.getId().toString());
		asignar("TEXT", "codTipoCurs", FormatUtils.formatObject(eduTipoCurso.getCodTipoCurs(), 
		...
		loadLocalizationVars(eduTipoCurso);
		
			
		//Deshabilitamos todos los campos para que no se editen
		
					asignarAtributo("COMBO", "marcOidMarc", "disabled", "S");asignarAtributo("TEXT", "codTipoCurs", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "EDU_TIPO_CURSO", "eduTipoCursoFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "codTipoCurs", "req", "S");
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('eduTipoCursoFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "eduTipoCursoFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		EduTipoCursoData eduTipoCursoQuery= new EduTipoCursoData();
		eduTipoCursoQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(eduTipoCurso.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"eduTipoCursoFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"eduTipoCursoFrm\",1, false)");
					asignarAtributo("COMBO","marcOidMarc", "ontab", "ejecutarAccionFocoModificacion(\"eduTipoCursoFrm\",2, true)");
					asignarAtributo("COMBO","marcOidMarc", "onshtab", "ejecutarAccionFocoModificacion(\"eduTipoCursoFrm\",2, false)");
				asignarAtributo("AREATEXTO", "codTipoCurs", "ontab","ejecutarAccionFocoModificacion(\"eduTipoCursoFrm\",3, true)");
				asignarAtributo("AREATEXTO", "codTipoCurs", "onshtab","ejecutarAccionFocoModificacion(\"eduTipoCursoFrm\",3, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"eduTipoCursoFrm\",4, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"eduTipoCursoFrm\",4, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","eduTipoCursoTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","eduTipoCursoTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codTipoCurs...");		
				
					traza("MMG: en desactivateNonModifyFields encontrado atributo no editable...");
				
						// borrarCampo("codTipoCurs");
						asignarAtributo ("TEXT", "codTipoCurs", "disabled", "S");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","eduTipoCursoFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","eduTipoCursoListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","eduTipoCursoListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(EduTipoCursoData eduTipoCurso) throws Exception{
		...
		if(eduTipoCurso != null && eduTipoCurso.getMarcOidMarc() != null){
				checkCombo("marcOidMarc" , eduTipoCurso.getMarcOidMarc().getId().toString());
			}
	...
	* @param eduTipoCurso La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(EduTipoCursoData eduTipoCurso) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		EduTipoCursoData eduTipoCurso = 
			(EduTipoCursoData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(eduTipoCurso.getMarcOidMarc() != null){
			eduTipoCurso.setMarcOidMarc((es.indra.belcorp.mso.SegMarcaData)
			getSingleObject(BUSINESSID_MARCOIDMARC_QUERY, 
			eduTipoCurso.getMarcOidMarc(),
			eduTipoCurso.getMarcOidMarc().clone(),
			"segMarca"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(eduTipoCurso);
		loadLeafDependenceCombos(eduTipoCurso);
	}
	...
	*/
	...
	protected void loadLocalizationVars(EduTipoCursoData eduTipoCurso) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("EDU_TIPO_CURSO");
		mmgLocalizationQuery.setEntiPk(eduTipoCurso.getId());
