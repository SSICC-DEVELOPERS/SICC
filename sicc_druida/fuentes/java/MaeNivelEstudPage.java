...
public class MaeNivelEstudPage  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","MaeNivelEstudPage" );
      ((Element)v.get(0)).setAttribute("titulo","" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","" );
      ((Element)v.get(0)).setAttribute("onload","maeNivelEstudInitComponents()" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","maenivelestud.js" );
      ((Element)v.get(0)).appendChild((Element)v.get(4));
      /* Termina nodo:4   */

      /* Empieza nodo:5 / Elemento padre: 0   */
      v.add(doc.createElement("FORMULARIO"));
      ((Element)v.get(5)).setAttribute("nombre","maeNivelEstudFrm" );
      ...
      ((Element)v.get(6)).setAttribute("valor","MaeNivelEstudLPExecution" );
      ...
      ((Element)v.get(7)).setAttribute("valor","MaeNivelEstudLPExecution" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(37)).setAttribute("nombre","maeNivelEstudFormLayer" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(52)).setAttribute("cod","MaeNivelEstud.legend.label" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(67)).setAttribute("cod","MaeNivelEstud.id.label" );
      ...
      ((Element)v.get(70)).setAttribute("ontab","ejecutarAccionFoco('maeNivelEstudFrm',1, true)" );
      ((Element)v.get(70)).setAttribute("onshtab","ejecutarAccionFoco('maeNivelEstudFrm', 1, false)" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(92)).setAttribute("cod","MaeNivelEstud.paisOidPais.label" );
      ...
      ((Element)v.get(95)).setAttribute("ontab","ejecutarAccionFoco('maeNivelEstudFrm',2, true);" );
      ((Element)v.get(95)).setAttribute("onshtab","ejecutarAccionFoco('maeNivelEstudFrm',2, false);" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(114)).setAttribute("nombre","codNiveEstuTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(119)).setAttribute("nombre","codNiveEstuWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(121)).setAttribute("nombre","codNiveEstu" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(121)).setAttribute("ontab","ejecutarAccionFoco('maeNivelEstudFrm',3, true)" );
      ((Element)v.get(121)).setAttribute("onshtab","ejecutarAccionFoco('maeNivelEstudFrm', 3, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(122)).setAttribute("nombre","codNiveEstuGapTdId" );
      ...
      ((Element)v.get(128)).setAttribute("cod","MaeNivelEstud.Descripcion.label" );
      ...
      ((Element)v.get(132)).setAttribute("ontab","ejecutarAccionFoco('maeNivelEstudFrm',4, true)" );
      ((Element)v.get(132)).setAttribute("onshtab","ejecutarAccionFoco('maeNivelEstudFrm', 4, false)" );
      ...
      ((Element)v.get(136)).setAttribute("href","javascript:openLocalizationDialog('maeNivelEstudFrm', 'Descripcion', 1);" );
      ((Element)v.get(136)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"maeNivelEstudFrm\",4, true)', 'ejecutarAccionFoco(\"maeNivelEstudFrm\",4, false)')" );
   ...
   private void getXML630(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(152)).setAttribute("nombre","maeNivelEstudTrButtons" );
      ...
      ((Element)v.get(159)).setAttribute("nombre","maeNivelEstudTdQueryButton" );
      ((Element)v.get(158)).appendChild((Element)v.get(159));

      /* Empieza nodo:160 / Elemento padre: 159   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(160)).setAttribute("nombre","maeNivelEstudQueryButton" );
      ((Element)v.get(160)).setAttribute("cod","MMGGlobal.queryButton.label" );
   }

   private void getXML720(Document doc) {
      ((Element)v.get(160)).setAttribute("estado","false" );
      ((Element)v.get(160)).setAttribute("accion","maeNivelEstudFirstPage();" );
      ...
      ((Element)v.get(161)).setAttribute("nombre","maeNivelEstudTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(163)).setAttribute("nombre","maeNivelEstudLovNullButton" );
      ((Element)v.get(163)).setAttribute("ID","botonContenido" );
      ((Element)v.get(163)).setAttribute("tipo","html" );
      ((Element)v.get(163)).setAttribute("accion","maeNivelEstudLovNullSelectionAction();" );
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(166)).setAttribute("nombre","maeNivelEstudListLayer" );
      ...
      ((Element)v.get(167)).setAttribute("nombre","maeNivelEstudList" );
   ...
   private void getXML810(Document doc) {
      ...
      ((Element)v.get(180)).setAttribute("cod","MaeNivelEstud.codNiveEstu.label" );
      ...
      ((Element)v.get(181)).setAttribute("cod","MaeNivelEstud.Descripcion.label" );
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(186)).setAttribute("nombre","maeNivelEstudListButtonsLayer" );
   ...
   private void getXML900(Document doc) {
      ...
      ((Element)v.get(192)).setAttribute("nombre","maeNivelEstudPaginationButtonBar" );
      ...
      ((Element)v.get(193)).setAttribute("nombre","maeNivelEstudFirstPageButton" );
      ((Element)v.get(193)).setAttribute("funcion","maeNivelEstudFirstPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(194)).setAttribute("nombre","maeNivelEstudFirstPageButtonGapTd" );
      ...
      v.add(doc.createElement("BTN"));
      ((Element)v.get(196)).setAttribute("nombre","maeNivelEstudPreviousPageButton" );
      ((Element)v.get(196)).setAttribute("funcion","maeNivelEstudPreviousPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(197)).setAttribute("nombre","maeNivelEstudPreviousPageButtonGapTd" );
      ...
      v.add(doc.createElement("BTN"));
      ((Element)v.get(199)).setAttribute("nombre","maeNivelEstudNextPageButton" );
      ((Element)v.get(199)).setAttribute("funcion","maeNivelEstudNextPage();" );
      ...
      ((Element)v.get(202)).setAttribute("nombre","maeNivelEstudUpdateButtonTd" );
      ((Element)v.get(188)).appendChild((Element)v.get(202));

      /* Empieza nodo:203 / Elemento padre: 202   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(203)).setAttribute("nombre","maeNivelEstudUpdateButton" );
      ((Element)v.get(203)).setAttribute("ID","botonContenido" );
      ((Element)v.get(203)).setAttribute("tipo","html" );
      ((Element)v.get(203)).setAttribute("accion","maeNivelEstudUpdateSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(204)).setAttribute("nombre","maeNivelEstudUpdateButtonGapTd" );
   }
   ...
   private void getXML990(Document doc) {
      ...
      ((Element)v.get(206)).setAttribute("nombre","maeNivelEstudViewForRemoveButtonTd" );
      ((Element)v.get(188)).appendChild((Element)v.get(206));

      /* Empieza nodo:207 / Elemento padre: 206   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(207)).setAttribute("nombre","maeNivelEstudViewForRemoveButton" );
      ((Element)v.get(207)).setAttribute("ID","botonContenido" );
      ((Element)v.get(207)).setAttribute("tipo","html" );
      ((Element)v.get(207)).setAttribute("accion","maeNivelEstudViewSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(208)).setAttribute("nombre","maeNivelEstudViewForRemoveButtonGapTd" );
      ...
      ((Element)v.get(210)).setAttribute("nombre","maeNivelEstudLovSelectButtonTd" );
      ((Element)v.get(188)).appendChild((Element)v.get(210));

      /* Empieza nodo:211 / Elemento padre: 210   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(211)).setAttribute("nombre","maeNivelEstudLovSelectButton" );
      ((Element)v.get(211)).setAttribute("ID","botonContenido" );
      ((Element)v.get(211)).setAttribute("tipo","html" );
      ((Element)v.get(211)).setAttribute("accion","maeNivelEstudLovSelectionAction();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(212)).setAttribute("nombre","maeNivelEstudLovSelectButtonGapTd" );
      ...
      ((Element)v.get(214)).setAttribute("nombre","maeNivelEstudViewButtonTd" );
      ((Element)v.get(188)).appendChild((Element)v.get(214));

      /* Empieza nodo:215 / Elemento padre: 214   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(215)).setAttribute("nombre","maeNivelEstudViewButton" );
      ((Element)v.get(215)).setAttribute("ID","botonContenido" );
      ((Element)v.get(215)).setAttribute("tipo","html" );
      ((Element)v.get(215)).setAttribute("accion","maeNivelEstudViewSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(216)).setAttribute("nombre","maeNivelEstudViewButtonGapTd" );
