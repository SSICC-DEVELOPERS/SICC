...
public class CalMotivTipoClienPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","calMotivTipoClienList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","CalMotivTipoClien.mocoOidMotiCont.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","CalMotivTipoClien.ticlOidTipoClie.label" );
