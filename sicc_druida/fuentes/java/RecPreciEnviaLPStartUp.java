/*
    INDRA/CAR/mmg
    $Id: RecPreciEnviaLPStartUp.java,v 1.1 2009/12/03 18:35:53 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class RecPreciEnviaLPStartUp extends MMGDruidaBase{
	...
	public static final String BUSINESSID_QUERY = "MMGRecPreciEnviaQueryFromToUserPage";
	...
	public RecPreciEnviaLPStartUp(){
		super();
	}

	public void inicio() throws Exception {
		pagina("RecPreciEnviaPage");
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "RecPreciEnviaPage", "cod", "RecPreciEnvia." + accion + ".label");
			...
			limpiarBotoneraLista("recPreciEnvia", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codPrecEnvi", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 1);");
		
		//Primero determianmos el nombre del campo en la entidad de oriegen donde se van a cargar los datos
		asignar("VAR", "idAttributeLovOpener", conectorParametro(PARAMETRO_LOV_ATTRIBUTO));
		asignar("VAR", "idEntityLovOpener", conectorParametro(PARAMETRO_LOV_ENTIDAD));
		//asignarAtributo("CAPA", "recPreciEnviaLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "RecPreciEnviaPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		RecPreciEnviaData recPreciEnviaQuery= new RecPreciEnviaData();
		recPreciEnviaQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		RecPreciEnviaData datosResult = (RecPreciEnviaData)getSingleObject(BUSINESSID_QUERY, recPreciEnviaQuery, 
			recPreciEnviaQuery.clone(), "recPreciEnvia");
		...
		RecPreciEnviaData recPreciEnvia = datosResult;
		asignar("TEXT", "codPrecEnvi", FormatUtils.formatObject(recPreciEnvia.getCodPrecEnvi(), 
		...
		asignarAtributo("TEXT", "codPrecEnvi", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		...
		asignarAtributo("TEXT", "codPrecEnvi", "req", "S");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "recPreciEnviaFrm", "oculto", "N");
		...
		traza("MMG::Creando RecPreciEnvia");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		RecPreciEnviaData recPreciEnviaQuery= new RecPreciEnviaData();
		recPreciEnviaQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(recPreciEnvia.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"recPreciEnviaFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"recPreciEnviaFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codPrecEnvi", "ontab","ejecutarAccionFocoModificacion(\"recPreciEnviaFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codPrecEnvi", "onshtab","ejecutarAccionFocoModificacion(\"recPreciEnviaFrm\",2, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","recPreciEnviaTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","recPreciEnviaTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codPrecEnvi...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","recPreciEnviaFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","recPreciEnviaListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","recPreciEnviaListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(RecPreciEnviaData recPreciEnvia) throws Exception{
	...
	* @param recPreciEnvia La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(RecPreciEnviaData recPreciEnvia) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		RecPreciEnviaData recPreciEnvia = 
			(RecPreciEnviaData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(recPreciEnvia);
		loadLeafDependenceCombos(recPreciEnvia);
	}
