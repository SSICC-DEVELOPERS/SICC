...
public class MaeLineaProduConectorQueryForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad MaeLineaProdu" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGMaeLineaProduQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGMaeLineaProduQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","MaeLineaProduFormFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(8)).setAttribute("NOMBRE","codLineProd" );
