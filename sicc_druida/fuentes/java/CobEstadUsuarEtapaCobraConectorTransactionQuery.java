...
public class CobEstadUsuarEtapaCobraConectorTransactionQuery  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("NOMBRE","CobEstadUsuarEtapaCobraTransactionQuery" );
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector transaccional para la ejección de query sobre la entidad CobEstadUsuarEtapaCobra" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","codEstaUsuaEtapCobr" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(8)).setAttribute("NOMBRE","codEstaUsuaEtapCobr" );
