...
public class INCGanadorasPorMetaConstanciaVariaciones extends LPSICCBase {           

  public INCGanadorasPorMetaConstanciaVariaciones() {	 
    super();
  }
  ...
  public void ejecucion() throws Exception {		
    ...
    try {
      ...
      if (accion.equals("generar")){
        ...
        cargarPagina();
        getConfiguracionMenu("INCGanadorasPorMetaConstanciaVariaciones");
      }
  ...
  private void cargarPagina() throws Exception{
    ...
    pagina("contenido_informe_ganadoras_variaciones_generar");   
  ...
  private void generarReporte() throws Exception{
    ...
    if(region.equals("")){
       reporte = "RD_REP-073_02";    
    }else{
       if(zona.equals("")){
          reporte = "RD_REP-073_01";
       }else{
          reporte = "RD_REP-073";
       }
    }    
