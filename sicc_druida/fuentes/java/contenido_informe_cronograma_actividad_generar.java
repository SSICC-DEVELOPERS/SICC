...
public class contenido_informe_cronograma_actividad_generar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_informe_cronograma_actividad_generar" );
      ((Element)v.get(0)).setAttribute("cod","0766" );
      ((Element)v.get(0)).setAttribute("titulo","Generar informe cronograma total de actividad" );
      ...
      v.add(doc.createTextNode("\r   \r   \r   function onLoad(){\r      configurarMenuSecundario('Formulario');\r      fMostrarMensajeError();\r      set('Formulario.txtAno', get('Formulario.anioDefault'));\r      focaliza('Formulario.txtAno');\r   }\r   function generar(){\r      \r      if(sicc_validaciones_generales()){\r         if(validarAnio()){\r            /*recolectarParametros();\r      \r            set('Formulario.conectorAction', 'CRACronoTotalActi');           \r            set('Formulario.accion', 'generar');\r      \r            enviaSICC('Formulario');*/\r            var a = new Object();\r            a.accion = 'generar';\r            a.anio = get('Formulario.txtAno');\r            a.marca = get('Formulario.cbMarca');  \r            a.canal = get('Formulario.cbCanal');\r            a.actividad = get('Formulario.cbActividad');\r            a.grupoZona = quitarItemVacio(get('Formulario.cbGrupoZona'));         \r            mostrarModalSICC('CRACronoTotalActi','generar', a);  \r         }\r      }\r\r   }\r\r   function recolectarParametros(){\r      \r      \r      set('Formulario.anio', get('Formulario.txtAno'));\r      set('Formulario.marca', get('Formulario.cbMarca') );  \r      set('Formulario.canal', get('Formulario.cbCanal'));\r      set('Formulario.actividad', get('Formulario.cbActividad') );\r      set('Formulario.grupoZona', quitarItemVacio(get('Formulario.cbGrupoZona')));\r      \r          \r      \r  \r   }\r \r   \r\r   function fLimpiar(){\r      var aCombo = new Array(new Array(\"\",\"\"));\r      set_combo('Formulario.cbActividad', aCombo, []);\r      set_combo('Formulario.cbGrupoZona', aCombo, []);\r      focaliza('Formulario.txtAno');\r \r   }\r   \r    function onchangeMarcaCanal(){\r       \r       marca  = get('Formulario.cbMarca');\r       canal  = get('Formulario.cbCanal');\r       pais   = get('Formulario.pais');\r       idioma = get('Formulario.idioma')\r       \r       if(marca != '' && canal != ''){\r       \r          var arr = new Array();\r\r\r          arr[arr.length] = ['oidMarca', marca];\r          arr[arr.length] = ['oidCanal', canal];\r          arr[arr.length] = ['oidPais', pais];\r          arr[arr.length] = ['oidIdioma', idioma];\r          \r                    \r       \r          recargaCombo(\"Formulario.cbActividad\",\"CRAObtieneActividad\", \"es.indra.sicc.dtos.cra.DTOActividad\", arr); \r          recargaCombo(\"Formulario.cbGrupoZona\",\"CRAObtieneGruposZonas\", \"es.indra.sicc.dtos.cra.DTOGrupoZonas\",arr);\r          \r       \r       }\r   \r    }  \r\r    \r     function validarAnio(){\r    \r       var anio = get('Formulario.txtAno') ;\r       \r       if(fValidarNumero(anio, 200, 0, 9999999)!='OK'){\r          GestionarMensaje('405'); \r          focaliza('Formulario.txtAno');\r          return  false;\r       }else{\r          return true;\r       }\r  \r    }\r    \r\r   function quitarItemVacio(elemento){\r      var elementoADevolver = new Array();\r     \r      for(var k=0;k<elemento.length;k++) {\r         if (elemento[k] != ''){ 			 \r            elementoADevolver[elementoADevolver.length] = elemento[k];\r         }\r      }\r        \r      return elementoADevolver;\r      \r   }\r\r   \r"));
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(19)).setAttribute("nombre","anio" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(22)).setAttribute("nombre","grupoZona" );
   }
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(24)).setAttribute("nombre","anioDefault" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(52)).setAttribute("nombre","lblAno" );
      ((Element)v.get(52)).setAttribute("alto","13" );
      ((Element)v.get(52)).setAttribute("filas","1" );
      ((Element)v.get(52)).setAttribute("id","datosTitle" );
      ((Element)v.get(52)).setAttribute("cod","171" );
      ...
      ((Element)v.get(67)).setAttribute("nombre","txtAno" );
      ((Element)v.get(67)).setAttribute("id","datosCampos" );
      ((Element)v.get(67)).setAttribute("max","4" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(101)).setAttribute("nombre","cbActividad" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(106)).setAttribute("nombre","cbGrupoZona" );
      ...
      /* Empieza nodo:115 / Elemento padre: 26   */
      v.add(doc.createElement("tr"));
   }

   private void getXML450(Document doc) {
      ((Element)v.get(26)).appendChild((Element)v.get(115));
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(122)).setAttribute("class","botonera" );
      ((Element)v.get(121)).appendChild((Element)v.get(122));

      /* Empieza nodo:123 / Elemento padre: 122   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(123)).setAttribute("nombre","btnGenerarInforme" );
      ((Element)v.get(123)).setAttribute("ID","botonContenido" );
      ((Element)v.get(123)).setAttribute("tipo","html" );
      ((Element)v.get(123)).setAttribute("accion","generar();" );
      ((Element)v.get(123)).setAttribute("estado","false" );
      ((Element)v.get(123)).setAttribute("cod","2495" );
      ((Element)v.get(123)).setAttribute("ontab","focaliza('Formulario.txtAno')" );
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(129)).setAttribute("width","756" );
