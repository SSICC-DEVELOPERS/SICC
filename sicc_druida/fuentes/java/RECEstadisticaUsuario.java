...
public class RECEstadisticaUsuario extends LPSICCBase {           
   public RECEstadisticaUsuario() {	 
     super();
  }
     ...
     try {
        ...
        if (accion.equals("generar")){
          ...
          //cargarPagina();
           ...
           cargarPagina();
           getConfiguracionMenu("RECEstadisticaUsuario");
        }
  ...
  private void cargarPagina() throws Exception{
     pagina("contenido_informe_estadistica_usuario_generar");
     
     asignarAtributoPagina("cod", "0912");
     asignarAtributo("VAR", "lp", "valor", "RECEstadisticaUsuario");
 ...
 private void generarReporte() throws Exception{
     ...
     String formaIngreso        = conectorParametroLimpia("formaIngreso", "", true);
     if(!formaIngreso.equals("")){
        datos.put(ConstantesREP.FORMAINGRESOS, formaIngreso);
     }
     ...
     datos.put(ConstantesREP.TITULO, "Estadística por Usuario");     
     traza("++++++Antes de enviar a reportes " + datos); 
        
     
     traza("el formaro es  " + formato);
//     ejecutarReporte(datos, "REPGenerarReporte", "RD_REP-110", formato);
     ejecutarReporte2(datos, "REPGenerarReporteBatch", "RD_REP-110", formato);
