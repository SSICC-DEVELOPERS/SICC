/*
    INDRA/CAR/mmg
    $Id: FacTipoImpreLPStartUp.java,v 1.1 2009/12/03 18:40:55 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class FacTipoImpreLPStartUp extends MMGDruidaBase{
	//Constantes que definen la altura de los formularios según el modo
	public static final short QUERYFORM_SIZE = 105;
	public static final short CREATEFORM_SIZE = 79;
	public static final short UPDATEFORM_SIZE = 79;
	public static final short VIEWFORM_SIZE = 79;
	...
	public FacTipoImpreLPStartUp(){
		super();
	}

	public void inicio() throws Exception {
		pagina("FacTipoImprePage");
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "FacTipoImprePage", "cod", "FacTipoImpre." + accion + ".label");
			...
			limpiarBotoneraLista("facTipoImpre", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "valNombPrinSend", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 0, 20);");
		
		//Primero determianmos el nombre del campo en la entidad de oriegen donde se van a cargar los datos
		asignar("VAR", "idAttributeLovOpener", conectorParametro(PARAMETRO_LOV_ATTRIBUTO));
		asignar("VAR", "idEntityLovOpener", conectorParametro(PARAMETRO_LOV_ENTIDAD));
		//asignarAtributo("CAPA", "facTipoImpreLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "FacTipoImprePage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("FacTipoImpreLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		FacTipoImpreData facTipoImpreQuery= new FacTipoImpreData();
		facTipoImpreQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		FacTipoImpreData datosResult = (FacTipoImpreData)getSingleObject(BUSINESSID_QUERY, facTipoImpreQuery, 
			facTipoImpreQuery.clone(), "facTipoImpre");
		...
		FacTipoImpreData facTipoImpre = datosResult;
		asignar("TEXT", "valNombPrinSend", FormatUtils.formatObject(facTipoImpre.getValNombPrinSend(), 
		...
		asignarAtributo("TEXT", "valNombPrinSend", "disabled", "S");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "facTipoImpreFrm", "oculto", "N");
		...
		traza("MMG::Creando FacTipoImpre");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		FacTipoImpreData facTipoImpreQuery= new FacTipoImpreData();
		facTipoImpreQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(facTipoImpre.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"facTipoImpreFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"facTipoImpreFrm\",1, false)");
				asignarAtributo("AREATEXTO", "valNombPrinSend", "ontab","ejecutarAccionFocoModificacion(\"facTipoImpreFrm\",2, true)");
				asignarAtributo("AREATEXTO", "valNombPrinSend", "onshtab","ejecutarAccionFocoModificacion(\"facTipoImpreFrm\",2, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","facTipoImpreTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","facTipoImpreTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es valNombPrinSend...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","facTipoImpreFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","facTipoImpreListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","facTipoImpreListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(FacTipoImpreData facTipoImpre) throws Exception{
	...
	* @param facTipoImpre La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(FacTipoImpreData facTipoImpre) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		FacTipoImpreData facTipoImpre = 
			(FacTipoImpreData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(facTipoImpre);
		loadLeafDependenceCombos(facTipoImpre);
	}
