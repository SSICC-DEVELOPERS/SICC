/*
    INDRA/CAR/mmg
    $Id: MsgMensaLPStartUp.java,v 1.1 2009/12/03 18:36:51 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class MsgMensaLPStartUp extends MMGDruidaBase{
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "MsgMensaPage", "cod", "MsgMensa." + accion + ".label");
			...
			limpiarBotoneraLista("msgMensa", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codMens", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 5);");
		asignarAtributo("TEXT", "desMens", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 80);");
		asignarAtributo("TEXT", "valBloqGrupPerm", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 0, 20);");
		asignarAtributo("TEXT", "fecPermDesd", "validacion", "mensaje = ValidaFechaMMG(cdos_trim(valor), '" + datePattern + "');");
		asignarAtributo("TEXT", "fecPermHast", "validacion", "mensaje = ValidaFechaMMG(cdos_trim(valor), '" + datePattern + "');");
		asignarAtributo("TEXT", "valText", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 2000);");
		
		//Primero determianmos el nombre del campo en la entidad de oriegen donde se van a cargar los datos
		asignar("VAR", "idAttributeLovOpener", conectorParametro(PARAMETRO_LOV_ATTRIBUTO));
		asignar("VAR", "idEntityLovOpener", conectorParametro(PARAMETRO_LOV_ENTIDAD));
		//asignarAtributo("CAPA", "msgMensaLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "MsgMensaPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		MsgMensaData msgMensaQuery= new MsgMensaData();
		msgMensaQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		MsgMensaData datosResult = (MsgMensaData)getSingleObject(BUSINESSID_QUERY, msgMensaQuery, 
			msgMensaQuery.clone(), "msgMensa");
		...
		MsgMensaData msgMensa = datosResult;
		asignar("TEXT", "codMens", FormatUtils.formatObject(msgMensa.getCodMens(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "desMens", FormatUtils.formatObject(msgMensa.getDesMens(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "valBloqGrupPerm", FormatUtils.formatObject(msgMensa.getValBloqGrupPerm(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "fecPermDesd", FormatUtils.formatObject(msgMensa.getFecPermDesd(), 
			 UtilidadesSession.getFormatoFecha(this), decimalFormatSymbols));
		asignar("TEXT", "fecPermHast", FormatUtils.formatObject(msgMensa.getFecPermHast(), 
			 UtilidadesSession.getFormatoFecha(this), decimalFormatSymbols));
		asignar("TEXT", "valText", FormatUtils.formatObject(msgMensa.getValText(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		asignarAtributo("TEXT", "codMens", "disabled", "S");
		asignarAtributo("TEXT", "desMens", "disabled", "S");
		asignarAtributo("TEXT", "valBloqGrupPerm", "disabled", "S");
		asignarAtributo("TEXT", "fecPermDesd", "disabled", "S");
		asignarAtributo("TEXT", "fecPermHast", "disabled", "S");
		asignarAtributo("TEXT", "valText", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		...
		asignarAtributo("TEXT", "codMens", "req", "S");
		asignarAtributo("TEXT", "desMens", "req", "S");
		asignarAtributo("TEXT", "valText", "req", "S");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "msgMensaFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		MsgMensaData msgMensaQuery= new MsgMensaData();
		msgMensaQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(msgMensa.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"msgMensaFrm\",0, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"msgMensaFrm\",0, false)");
				asignarAtributo("AREATEXTO", "codMens", "ontab","ejecutarAccionFocoModificacion(\"msgMensaFrm\",0, true)");
				asignarAtributo("AREATEXTO", "codMens", "onshtab","ejecutarAccionFocoModificacion(\"msgMensaFrm\",0, false)");
				asignarAtributo("AREATEXTO", "desMens", "ontab","ejecutarAccionFocoModificacion(\"msgMensaFrm\",0, true)");
				asignarAtributo("AREATEXTO", "desMens", "onshtab","ejecutarAccionFocoModificacion(\"msgMensaFrm\",0, false)");
				asignarAtributo("AREATEXTO", "valBloqGrupPerm", "ontab","ejecutarAccionFocoModificacion(\"msgMensaFrm\",0, true)");
				asignarAtributo("AREATEXTO", "valBloqGrupPerm", "onshtab","ejecutarAccionFocoModificacion(\"msgMensaFrm\",0, false)");
				asignarAtributo("AREATEXTO", "fecPermDesd", "ontab","ejecutarAccionFocoModificacion(\"msgMensaFrm\",0, true)");
				asignarAtributo("AREATEXTO", "fecPermDesd", "onshtab","ejecutarAccionFocoModificacion(\"msgMensaFrm\",0, false)");
				asignarAtributo("AREATEXTO", "fecPermHast", "ontab","ejecutarAccionFocoModificacion(\"msgMensaFrm\",0, true)");
				asignarAtributo("AREATEXTO", "fecPermHast", "onshtab","ejecutarAccionFocoModificacion(\"msgMensaFrm\",0, false)");
				asignarAtributo("AREATEXTO", "valText", "ontab","ejecutarAccionFocoModificacion(\"msgMensaFrm\",0, true)");
				asignarAtributo("AREATEXTO", "valText", "onshtab","ejecutarAccionFocoModificacion(\"msgMensaFrm\",0, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","msgMensaTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","msgMensaTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codMens...");		
				
				traza("MMG: el atributo es desMens...");		
				
				traza("MMG: el atributo es valBloqGrupPerm...");		
				
				traza("MMG: el atributo es fecPermDesd...");		
				
				traza("MMG: el atributo es fecPermHast...");		
				
				traza("MMG: el atributo es valText...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","msgMensaFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","msgMensaListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","msgMensaListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(MsgMensaData msgMensa) throws Exception{
	...
	* @param msgMensa La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(MsgMensaData msgMensa) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		MsgMensaData msgMensa = 
			(MsgMensaData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(msgMensa);
		loadLeafDependenceCombos(msgMensa);
	}
