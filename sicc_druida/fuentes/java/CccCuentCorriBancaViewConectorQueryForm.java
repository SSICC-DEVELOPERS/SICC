...
public class CccCuentCorriBancaViewConectorQueryForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad CccCuentCorriBancaView" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGCccCuentCorriBancaViewQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGCccCuentCorriBancaViewQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","CccCuentCorriBancaViewFormFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(8)).setAttribute("NOMBRE","desCc" );
