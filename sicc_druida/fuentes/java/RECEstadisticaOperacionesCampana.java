...
public class RECEstadisticaOperacionesCampana extends LPSICCBase {           
   public RECEstadisticaOperacionesCampana() {	 
     super();
  }
     ...
     try {
        ...
        if (accion.equals("generar")){
          ...
          //cargarPagina();
           ...
           cargarPagina();
           getConfiguracionMenu("RECEstadisticaOperacionesCampana");
        }
  ...
  private void cargarPagina() throws Exception{
     pagina("contenido_informe_estadistica_operaciones_generar");
     
     asignarAtributoPagina("cod", "0908");
     asignarAtributo("VAR", "lp", "valor", "RECEstadisticaOperacionesCampana");
     ...
     MareBusinessID idCAT2 = new MareBusinessID("REPOperacionesSinAnulacion");
 ...
 private void generarReporte() throws Exception{
     ...
     if(tipoReporte.equals("1")){
      ...
      reporte = "RD_REP-106_01";
	 }
          
     String formato = conectorParametroLimpia("formato", "", true);
         
 
     datos.put(ConstantesREP.TITULO, "Generar Informe Estadística de operaciones por campaña");     
     traza("++++++Antes de enviar a reportes " + datos); 
        
     
     traza("el formaro es  " + formato);
     //ejecutarReporte(datos, "REPGenerarReporte", "RD_REP-106", formato);
