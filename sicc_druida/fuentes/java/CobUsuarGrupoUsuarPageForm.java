...
public class CobUsuarGrupoUsuarPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","CobUsuarGrupoUsuar.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(25)).setAttribute("nombre","uscoOidUsuaCobrTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(29)).setAttribute("nombre","lbluscoOidUsuaCobr" );
      ((Element)v.get(29)).setAttribute("id","datosTitle" );
      ((Element)v.get(29)).setAttribute("ancho","150" );
      ((Element)v.get(29)).setAttribute("alto","13" );
      ((Element)v.get(29)).setAttribute("cod","CobUsuarGrupoUsuar.uscoOidUsuaCobr.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(30)).setAttribute("nombre","uscoOidUsuaCobrWidgetTrId" );
      ...
      ((Element)v.get(32)).setAttribute("nombre","uscoOidUsuaCobr" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('cobUsuarGrupoUsuarFrm',2, true);" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('cobUsuarGrupoUsuarFrm',2, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(34)).setAttribute("nombre","uscoOidUsuaCobrGapTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(38)).setAttribute("nombre","formGapTr0" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(45)).setAttribute("nombre","formTr1" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(51)).setAttribute("nombre","gucoOidGrupUsuaCobrTdId" );
      ...
      ((Element)v.get(54)).setAttribute("height","13" );
      ((Element)v.get(53)).appendChild((Element)v.get(54));

      /* Empieza nodo:55 / Elemento padre: 54   */
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(55)).setAttribute("nombre","lblgucoOidGrupUsuaCobr" );
      ((Element)v.get(55)).setAttribute("id","datosTitle" );
      ((Element)v.get(55)).setAttribute("ancho","150" );
      ((Element)v.get(55)).setAttribute("alto","13" );
      ((Element)v.get(55)).setAttribute("cod","CobUsuarGrupoUsuar.gucoOidGrupUsuaCobr.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(56)).setAttribute("nombre","gucoOidGrupUsuaCobrWidgetTrId" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(58)).setAttribute("nombre","gucoOidGrupUsuaCobr" );
      ...
      ((Element)v.get(58)).setAttribute("onfocus","" );
      ((Element)v.get(58)).setAttribute("valorinicial","" );
      ((Element)v.get(58)).setAttribute("textoinicial","" );
      ((Element)v.get(58)).setAttribute("ontab","ejecutarAccionFoco('cobUsuarGrupoUsuarFrm',3, true);" );
      ((Element)v.get(58)).setAttribute("onshtab","ejecutarAccionFoco('cobUsuarGrupoUsuarFrm',3, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(60)).setAttribute("nombre","gucoOidGrupUsuaCobrGapTdId" );
   }

   private void getXML270(Document doc) {
      ((Element)v.get(60)).setAttribute("nowrap","true" );
      ((Element)v.get(60)).setAttribute("class","datosCampos" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(65)).setAttribute("nombre","formGapTr1" );
      ...
      /* Empieza nodo:74 / Elemento padre: 0   */
      v.add(doc.createElement("TR"));
      ((Element)v.get(74)).setAttribute("nombre","cobUsuarGrupoUsuarTrButtons" );
      ((Element)v.get(0)).appendChild((Element)v.get(74));
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(81)).setAttribute("class","tablaTitle" );
      ((Element)v.get(81)).setAttribute("nombre","cobUsuarGrupoUsuarTdQueryButton" );
      ((Element)v.get(80)).appendChild((Element)v.get(81));

      /* Empieza nodo:82 / Elemento padre: 81   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(82)).setAttribute("nombre","cobUsuarGrupoUsuarQueryButton" );
      ((Element)v.get(82)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(82)).setAttribute("estado","false" );
      ((Element)v.get(82)).setAttribute("accion","cobUsuarGrupoUsuarFirstPage();" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(83)).setAttribute("class","tablaTitle" );
      ((Element)v.get(83)).setAttribute("nombre","cobUsuarGrupoUsuarTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(85)).setAttribute("nombre","cobUsuarGrupoUsuarLovNullButton" );
      ((Element)v.get(85)).setAttribute("ID","botonContenido" );
      ((Element)v.get(85)).setAttribute("tipo","html" );
      ((Element)v.get(85)).setAttribute("accion","cobUsuarGrupoUsuarLovNullSelectionAction();" );
      ((Element)v.get(85)).setAttribute("estado","true" );
      ((Element)v.get(85)).setAttribute("cod","MMGGlobal.lovNullButton.label" );
