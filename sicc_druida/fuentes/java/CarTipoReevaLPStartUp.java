/*
    INDRA/CAR/mmg
    $Id: CarTipoReevaLPStartUp.java,v 1.1 2009/12/03 18:36:47 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class CarTipoReevaLPStartUp extends MMGDruidaBase{
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "CarTipoReevaPage", "cod", "CarTipoReeva." + accion + ".label");
			...
			limpiarBotoneraLista("carTipoReeva", accion);
	...
	protected void cmdLov() throws Exception{
		...
		//asignarAtributo("CAPA", "carTipoReevaLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "CarTipoReevaPage", "onblur", "window.focus();");
	...
	protected void cmdView() throws Exception{
		...
		CarTipoReevaData carTipoReevaQuery= new CarTipoReevaData();
		carTipoReevaQuery.setId(new Integer(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		CarTipoReevaData datosResult = (CarTipoReevaData)getSingleObject(BUSINESSID_QUERY, carTipoReevaQuery, 
			carTipoReevaQuery.clone(), "carTipoReeva");
		...
		CarTipoReevaData carTipoReeva = datosResult;
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "carTipoReevaFrm", "oculto", "N");
		...
		CarTipoReevaData carTipoReevaQuery= new CarTipoReevaData();
		carTipoReevaQuery.setId(new Integer(id));
		...
		//asignar("VAR","timestamp",Long.toString(carTipoReeva.jdoGetTimeStamp()));
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","carTipoReevaTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","carTipoReevaTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","carTipoReevaFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","carTipoReevaPreListLayer", "y", String.valueOf(sizeForm + 24));
		asignarAtributo("CAPA","carTipoReevaListLayer", "y", String.valueOf(sizeForm + 46));		
		asignarAtributo("CAPA","carTipoReevaListButtonsLayer", "y", String.valueOf(sizeForm + 299));		
	}
	...
	* @param carTipoReeva La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(CarTipoReevaData carTipoReeva) 
		throws Exception{
	...
	*/
	protected void setDependenceComboLabels(CarTipoReevaData carTipoReeva) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		CarTipoReevaData carTipoReeva = 
			(CarTipoReevaData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(carTipoReeva);
	}
