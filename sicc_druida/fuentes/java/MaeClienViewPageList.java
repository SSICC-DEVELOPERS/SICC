...
public class MaeClienViewPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","maeClienViewList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(24)).setAttribute("height","20" );
      ((Element)v.get(24)).setAttribute("IDScroll","EstCab" );
      ((Element)v.get(24)).setAttribute("imgFondo","" );
      ((Element)v.get(24)).setAttribute("colFondo","#CCCCCC" );
      ...
      ((Element)v.get(25)).setAttribute("cod","MaeClienView.codClie.label" );
      ...
      ((Element)v.get(26)).setAttribute("cod","MaeClienView.paisOidPais.label" );
      ...
      ((Element)v.get(27)).setAttribute("cod","MaeClienView.indFichInsc.label" );
      ...
      ((Element)v.get(28)).setAttribute("cod","MaeClienView.codDigiCtrl.label" );
      ...
      ((Element)v.get(29)).setAttribute("cod","MaeClienView.valApe1.label" );
      ...
      ((Element)v.get(30)).setAttribute("cod","MaeClienView.valApe2.label" );
      ...
      ((Element)v.get(31)).setAttribute("cod","MaeClienView.valNom1.label" );
      ...
      ((Element)v.get(32)).setAttribute("cod","MaeClienView.valNom2.label" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(33)).setAttribute("cod","MaeClienView.valTrat.label" );
      ...
      ((Element)v.get(34)).setAttribute("cod","MaeClienView.valCritBus1.label" );
      ...
      ((Element)v.get(35)).setAttribute("cod","MaeClienView.valCritBus2.label" );
      ...
      ((Element)v.get(36)).setAttribute("cod","MaeClienView.codSexo.label" );
      ...
      ((Element)v.get(37)).setAttribute("cod","MaeClienView.fecIngr.label" );
      ...
      ((Element)v.get(38)).setAttribute("cod","MaeClienView.valApelCasa.label" );
      ...
      ((Element)v.get(39)).setAttribute("tipoEnvio","seleccion" );
