...
public class contenido_ventas_asociadas_consultoras_recibir  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_ventas_asociadas_consultoras_recibir" );
      ((Element)v.get(0)).setAttribute("cod","0902" );
      ((Element)v.get(0)).setAttribute("titulo","Recibir ventas asociadas a consultoras" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(3)).setAttribute("src","contenido_ventas_asociadas_consultoras_recibir.js" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(7)).setAttribute("nombre","opcion" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(10)).setAttribute("nombre","numeroLote" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(11)).setAttribute("nombre","descripcionLote" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(30)).setAttribute("cod","00263" );
      ...
      ((Element)v.get(46)).setAttribute("cod","844" );
   }
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(53)).setAttribute("nombre","lbldtLote" );
      ...
      /* Empieza nodo:63 / Elemento padre: 31   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(31)).appendChild((Element)v.get(63));
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(77)).setAttribute("cols","50" );
      ((Element)v.get(77)).setAttribute("id","datosCampos" );
      ((Element)v.get(77)).setAttribute("msjreq","" );
      ((Element)v.get(77)).setAttribute("nombre","areatxtObservaciones" );
      ((Element)v.get(77)).setAttribute("readonly","N" );
      ((Element)v.get(77)).setAttribute("req","N" );
      ((Element)v.get(77)).setAttribute("rows","3" );
      ((Element)v.get(77)).setAttribute("tabindex","2" );
      ((Element)v.get(77)).setAttribute("valor","" );
      ((Element)v.get(77)).setAttribute("ontab","ontab();" );
      ((Element)v.get(77)).setAttribute("max","256" );
      ...
      /* Empieza nodo:83 / Elemento padre: 24   */
      v.add(doc.createElement("td"));
      ((Element)v.get(24)).appendChild((Element)v.get(83));
