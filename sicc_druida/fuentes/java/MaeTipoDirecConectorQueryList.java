...
public class MaeTipoDirecConectorQueryList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad MaeTipoDirec" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGMaeTipoDirecQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGMaeTipoDirecQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","MaeTipoDirecListFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","codTipoDire" );
