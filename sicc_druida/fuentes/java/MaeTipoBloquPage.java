...
public class MaeTipoBloquPage  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","MaeTipoBloquPage" );
      ((Element)v.get(0)).setAttribute("titulo","" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","" );
      ((Element)v.get(0)).setAttribute("onload","maeTipoBloquInitComponents()" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","maetipobloqu.js" );
      ((Element)v.get(0)).appendChild((Element)v.get(4));
      /* Termina nodo:4   */

      /* Empieza nodo:5 / Elemento padre: 0   */
      v.add(doc.createElement("FORMULARIO"));
      ((Element)v.get(5)).setAttribute("nombre","maeTipoBloquFrm" );
      ...
      ((Element)v.get(6)).setAttribute("valor","MaeTipoBloquLPExecution" );
      ...
      ((Element)v.get(7)).setAttribute("valor","MaeTipoBloquLPExecution" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(37)).setAttribute("nombre","maeTipoBloquFormLayer" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(52)).setAttribute("cod","MaeTipoBloqu.legend.label" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(67)).setAttribute("cod","MaeTipoBloqu.id.label" );
      ...
      ((Element)v.get(70)).setAttribute("ontab","ejecutarAccionFoco('maeTipoBloquFrm',1, true)" );
      ((Element)v.get(70)).setAttribute("onshtab","ejecutarAccionFoco('maeTipoBloquFrm', 1, false)" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(88)).setAttribute("nombre","codTipoBloqTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(93)).setAttribute("nombre","codTipoBloqWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(95)).setAttribute("nombre","codTipoBloq" );
      ...
      ((Element)v.get(95)).setAttribute("ontab","ejecutarAccionFoco('maeTipoBloquFrm',2, true)" );
      ((Element)v.get(95)).setAttribute("onshtab","ejecutarAccionFoco('maeTipoBloquFrm', 2, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(96)).setAttribute("nombre","codTipoBloqGapTdId" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(102)).setAttribute("cod","MaeTipoBloqu.Descripcion.label" );
      ...
      ((Element)v.get(106)).setAttribute("ontab","ejecutarAccionFoco('maeTipoBloquFrm',3, true)" );
      ((Element)v.get(106)).setAttribute("onshtab","ejecutarAccionFoco('maeTipoBloquFrm', 3, false)" );
      ...
      ((Element)v.get(110)).setAttribute("href","javascript:openLocalizationDialog('maeTipoBloquFrm', 'Descripcion', 1);" );
      ((Element)v.get(110)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"maeTipoBloquFrm\",3, true)', 'ejecutarAccionFoco(\"maeTipoBloquFrm\",3, false)')" );
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(126)).setAttribute("nombre","maeTipoBloquTrButtons" );
      ...
      ((Element)v.get(133)).setAttribute("nombre","maeTipoBloquTdQueryButton" );
      ((Element)v.get(132)).appendChild((Element)v.get(133));

      /* Empieza nodo:134 / Elemento padre: 133   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(134)).setAttribute("nombre","maeTipoBloquQueryButton" );
      ((Element)v.get(134)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(134)).setAttribute("estado","false" );
      ((Element)v.get(134)).setAttribute("accion","maeTipoBloquFirstPage();" );
      ...
      ((Element)v.get(135)).setAttribute("nombre","maeTipoBloquTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(137)).setAttribute("nombre","maeTipoBloquLovNullButton" );
      ((Element)v.get(137)).setAttribute("ID","botonContenido" );
      ((Element)v.get(137)).setAttribute("tipo","html" );
      ((Element)v.get(137)).setAttribute("accion","maeTipoBloquLovNullSelectionAction();" );
   ...
   private void getXML630(Document doc) {
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(140)).setAttribute("nombre","maeTipoBloquListLayer" );
      ...
      ((Element)v.get(141)).setAttribute("nombre","maeTipoBloquList" );
   ...
   private void getXML720(Document doc) {
      ...
      ((Element)v.get(154)).setAttribute("cod","MaeTipoBloqu.codTipoBloq.label" );
      ...
      ((Element)v.get(155)).setAttribute("cod","MaeTipoBloqu.Descripcion.label" );
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(160)).setAttribute("nombre","maeTipoBloquListButtonsLayer" );
      ...
      ((Element)v.get(166)).setAttribute("nombre","maeTipoBloquPaginationButtonBar" );
   }
   ...
   private void getXML810(Document doc) {
      ...
      ((Element)v.get(167)).setAttribute("nombre","maeTipoBloquFirstPageButton" );
      ((Element)v.get(167)).setAttribute("funcion","maeTipoBloquFirstPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(168)).setAttribute("nombre","maeTipoBloquFirstPageButtonGapTd" );
      ...
      v.add(doc.createElement("BTN"));
      ((Element)v.get(170)).setAttribute("nombre","maeTipoBloquPreviousPageButton" );
      ((Element)v.get(170)).setAttribute("funcion","maeTipoBloquPreviousPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(171)).setAttribute("nombre","maeTipoBloquPreviousPageButtonGapTd" );
      ...
      v.add(doc.createElement("BTN"));
      ((Element)v.get(173)).setAttribute("nombre","maeTipoBloquNextPageButton" );
      ((Element)v.get(173)).setAttribute("funcion","maeTipoBloquNextPage();" );
      ...
      ((Element)v.get(176)).setAttribute("nombre","maeTipoBloquUpdateButtonTd" );
      ((Element)v.get(162)).appendChild((Element)v.get(176));

      /* Empieza nodo:177 / Elemento padre: 176   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(177)).setAttribute("nombre","maeTipoBloquUpdateButton" );
      ((Element)v.get(177)).setAttribute("ID","botonContenido" );
      ((Element)v.get(177)).setAttribute("tipo","html" );
      ((Element)v.get(177)).setAttribute("accion","maeTipoBloquUpdateSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(178)).setAttribute("nombre","maeTipoBloquUpdateButtonGapTd" );
      ...
      ((Element)v.get(180)).setAttribute("nombre","maeTipoBloquViewForRemoveButtonTd" );
      ((Element)v.get(162)).appendChild((Element)v.get(180));

      /* Empieza nodo:181 / Elemento padre: 180   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(181)).setAttribute("nombre","maeTipoBloquViewForRemoveButton" );
      ((Element)v.get(181)).setAttribute("ID","botonContenido" );
      ((Element)v.get(181)).setAttribute("tipo","html" );
      ((Element)v.get(181)).setAttribute("accion","maeTipoBloquViewSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(182)).setAttribute("nombre","maeTipoBloquViewForRemoveButtonGapTd" );
   ...
   private void getXML900(Document doc) {
      ...
      ((Element)v.get(184)).setAttribute("nombre","maeTipoBloquLovSelectButtonTd" );
      ((Element)v.get(162)).appendChild((Element)v.get(184));

      /* Empieza nodo:185 / Elemento padre: 184   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(185)).setAttribute("nombre","maeTipoBloquLovSelectButton" );
      ((Element)v.get(185)).setAttribute("ID","botonContenido" );
      ((Element)v.get(185)).setAttribute("tipo","html" );
      ((Element)v.get(185)).setAttribute("accion","maeTipoBloquLovSelectionAction();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(186)).setAttribute("nombre","maeTipoBloquLovSelectButtonGapTd" );
      ...
      ((Element)v.get(188)).setAttribute("nombre","maeTipoBloquViewButtonTd" );
      ((Element)v.get(162)).appendChild((Element)v.get(188));

      /* Empieza nodo:189 / Elemento padre: 188   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(189)).setAttribute("nombre","maeTipoBloquViewButton" );
      ((Element)v.get(189)).setAttribute("ID","botonContenido" );
      ((Element)v.get(189)).setAttribute("tipo","html" );
      ((Element)v.get(189)).setAttribute("accion","maeTipoBloquViewSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(190)).setAttribute("nombre","maeTipoBloquViewButtonGapTd" );
