...
public class contenido_periodo_asignar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_periodo_asignar" );
      ...
      ((Element)v.get(2)).setAttribute("name","comboTipoPeriodo" );
      ((Element)v.get(2)).setAttribute("required","true" );
      ((Element)v.get(2)).setAttribute("cod","132" );
      ((Element)v.get(1)).appendChild((Element)v.get(2));
      /* Termina nodo:2   */

      /* Empieza nodo:3 / Elemento padre: 1   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(3)).setAttribute("name","comboPeriodoCorporativo" );
      ((Element)v.get(3)).setAttribute("required","true" );
      ((Element)v.get(3)).setAttribute("cod","2511" );
      ...
      v.add(doc.createTextNode("\r \r\rfunction onLoad(){\r	configurarMenuSecundario('frmFormulario');\r	focaliza('frmFormulario.comboTipoPeriodo','');\r	\r	if (combo_get('frmFormulario.comboPatronOrigen','L') == 1)  {\r		var arr = new Array();\r		arr[arr.length] = new Array('','');\r		arr[arr.length] = new Array('',get('frmFormulario.hCodigoPatron'));\r		set_combo('frmFormulario.comboPatronOrigen', arr);\r	}\r	if (get('frmFormulario.hPatronOrigenHabilitado')=='false'){\r		set('frmFormulario.comboPatronOrigen',new Array(get('frmFormulario.hOidPatronOrigen')));\r		accion('frmFormulario.comboPatronOrigen', '.disabled=true' );		\r	}\r}\r\r\rfunction tipoPeriodoOnChange(){\r	var arr = new Array();\r	arr[arr.length] = new Array(\"oidTipoPeriodo\", get('frmFormulario.comboTipoPeriodo'));\r\r	recargaCombo('frmFormulario.comboPeriodoCorporativo','SEGObtenerPeriodosPorTipoPeriodo',\r				'es.indra.sicc.dtos.seg.DTOPeriodosPorTipoPeriodo',arr);\r}\r\r\rfunction accionAceptar(){\r	if (sicc_validaciones_generales())  {\r		set('frmFormulario.hOidPeriodoCorporativo', get('frmFormulario.comboPeriodoCorporativo'));\r		set('frmFormulario.hOidPatronOrigen', get('frmFormulario.comboPatronOrigen'));		\r		set('frmFormulario.conectorAction','LPMantenimientoPatrones');\r		set('frmFormulario.accion','Guardar patron por periodo');\r		enviaSICC('frmFormulario');\r	}\r}\r\r\rfunction fLimpiar(){\r	set_combo('frmFormulario.comboPeriodoCorporativo', new Array(new Array(\"\",\"\")));\r\r}\r\rfunction cerrar(patronOrigen){\r		var arr = new Array();\r		arr[0] = get('frmFormulario.comboPeriodoCorporativo');\r		arr[1] = patronOrigen;\r		returnValue = arr;\r		close();\r}\r\rfunction onshtab_TipoPeriodo(){\r	focalizaBotonHTML('botonContenido', 'btnAceptar');\r}\r\rfunction ontab_Aceptar(){\r	focaliza('frmFormulario.comboTipoPeriodo','');\r}\r\r \r"));
      ...
      ((Element)v.get(13)).setAttribute("valor","LPMantenimientoPatrones" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(18)).setAttribute("nombre","hOidPeriodoCorporativo" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(19)).setAttribute("nombre","hOidPatronOrigen" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(20)).setAttribute("nombre","hOidTipoPeriodo" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(21)).setAttribute("nombre","hPatronOrigenHabilitado" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(22)).setAttribute("nombre","hCodigoPatron" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(42)).setAttribute("width","480" );
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(44)).setAttribute("colspan","8" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(50)).setAttribute("nombre","lblTipoPeriodo" );
      ...
      ((Element)v.get(50)).setAttribute("cod","132" );
      ...
      ((Element)v.get(57)).setAttribute("nombre","comboTipoPeriodo" );
      ...
      ((Element)v.get(57)).setAttribute("onchange","tipoPeriodoOnChange();" );
      ((Element)v.get(57)).setAttribute("onshtab","onshtab_TipoPeriodo();" );
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(62)).setAttribute("colspan","9" );
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(66)).setAttribute("width","480" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(71)).setAttribute("nombre","lblPeriodoCorporativo" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(71)).setAttribute("cod","2511" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(75)).setAttribute("nombre","lblPatronOrigen" );
      ...
      ((Element)v.get(75)).setAttribute("cod","964" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(82)).setAttribute("nombre","comboPeriodoCorporativo" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(87)).setAttribute("nombre","comboPatronOrigen" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(104)).setAttribute("nombre","btnAceptar" );
      ((Element)v.get(104)).setAttribute("ID","botonContenido" );
      ((Element)v.get(104)).setAttribute("tipo","html" );
      ((Element)v.get(104)).setAttribute("accion","accionAceptar();" );
      ((Element)v.get(104)).setAttribute("estado","false" );
      ((Element)v.get(104)).setAttribute("cod","12" );
      ((Element)v.get(104)).setAttribute("ontab","ontab_Aceptar();" );
