/*
    INDRA/CAR/mmg
    $Id: PedProceViewLPStartUp.java,v 1.1 2009/12/03 18:41:15 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class PedProceViewLPStartUp extends MMGDruidaBase{
	...
	public static final String BUSINESSID_QUERY = "MMGPedProceViewQueryFromToUserPage";
	...
	public PedProceViewLPStartUp(){
		super();
	}

	public void inicio() throws Exception {
		pagina("PedProceViewPage");
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "PedProceViewPage", "cod", "PedProceView." + accion + ".label");
			...
			limpiarBotoneraLista("pedProceView", accion);
	...
	protected void cmdLov() throws Exception{
		...
		//asignarAtributo("CAPA", "pedProceViewLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "PedProceViewPage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("PedProceViewLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		PedProceViewData pedProceViewQuery= new PedProceViewData();
		pedProceViewQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		PedProceViewData datosResult = (PedProceViewData)getSingleObject(BUSINESSID_QUERY, pedProceViewQuery, 
			pedProceViewQuery.clone(), "pedProceView");
		...
		preservaHiddensI18n(new Integer(1), "PED_PROCE", "pedProceViewFrm", "Descripcion", true);
		...
		PedProceViewData pedProceView = datosResult;
		asignar("TEXT", "codProc", FormatUtils.formatObject(pedProceView.getCodProc(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "Descripcion", FormatUtils.formatObject(pedProceView.getDescripcion(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		loadLocalizationVars(pedProceView);
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "PED_PROCE", "pedProceViewFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('pedProceViewFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "pedProceViewFrm", "oculto", "N");
		...
		traza("MMG::Creando PedProceView");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		PedProceViewData pedProceViewQuery= new PedProceViewData();
		pedProceViewQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(pedProceView.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"pedProceViewFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"pedProceViewFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codProc", "ontab","ejecutarAccionFocoModificacion(\"pedProceViewFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codProc", "onshtab","ejecutarAccionFocoModificacion(\"pedProceViewFrm\",2, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"pedProceViewFrm\",3, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"pedProceViewFrm\",3, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","pedProceViewTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","pedProceViewTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","pedProceViewFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","pedProceViewListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","pedProceViewListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(PedProceViewData pedProceView) throws Exception{
	...
	* @param pedProceView La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(PedProceViewData pedProceView) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		PedProceViewData pedProceView = 
			(PedProceViewData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(pedProceView);
		loadLeafDependenceCombos(pedProceView);
	}
	...
	*/
	...
	protected void loadLocalizationVars(PedProceViewData pedProceView) throws Exception{
		...
		mmgLocalizationQuery.setEntiPk(pedProceView.getId());
