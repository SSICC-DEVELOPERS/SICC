...
public class ZonZonaPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","zonZonaList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(23)).setAttribute("height","20" );
      ((Element)v.get(23)).setAttribute("IDScroll","EstCab" );
      ((Element)v.get(23)).setAttribute("imgFondo","" );
      ((Element)v.get(23)).setAttribute("colFondo","#CCCCCC" );
      ...
      ((Element)v.get(24)).setAttribute("cod","ZonZona.clieOidClie.label" );
      ...
      ((Element)v.get(25)).setAttribute("cod","ZonZona.zorgOidRegi.label" );
      ...
      ((Element)v.get(26)).setAttribute("cod","ZonZona.codZona.label" );
      ...
      ((Element)v.get(27)).setAttribute("cod","ZonZona.indActi.label" );
      ...
      ((Element)v.get(28)).setAttribute("cod","ZonZona.indRezo.label" );
      ...
      ((Element)v.get(29)).setAttribute("cod","ZonZona.codNse1.label" );
      ...
      ((Element)v.get(30)).setAttribute("cod","ZonZona.codNse2.label" );
      ...
      ((Element)v.get(31)).setAttribute("cod","ZonZona.codNse3.label" );
      ...
      ((Element)v.get(32)).setAttribute("cod","ZonZona.indBorr.label" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(33)).setAttribute("cod","ZonZona.eszoOidEstaZona.label" );
      ...
      ((Element)v.get(34)).setAttribute("cod","ZonZona.desZona.label" );
      ...
      ((Element)v.get(35)).setAttribute("cod","ZonZona.fecCambEsta.label" );
      ...
      ((Element)v.get(36)).setAttribute("cod","ZonZona.fecRezo.label" );
      ...
      ((Element)v.get(37)).setAttribute("accion","" );
      ((Element)v.get(37)).setAttribute("tipoEnvio","seleccion" );
      ((Element)v.get(37)).setAttribute("formaEnvio","xml" );
      ((Element)v.get(37)).setAttribute("maxSel","1" );
      ((Element)v.get(37)).setAttribute("msgErrMaxSel","" );
      ((Element)v.get(37)).setAttribute("coloresScrollNativo","#D4D0C8,black,white,#D4D0C8,#D4D0C8,#ECE9E4,black" );
      ((Element)v.get(37)).setAttribute("colorROver","#D0D9E8" );
      ((Element)v.get(37)).setAttribute("onLoad","" );
      ((Element)v.get(37)).setAttribute("colorSelecc","#D0D9E8" );
