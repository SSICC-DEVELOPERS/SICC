...
public class contenido_clave_acceso_cambiar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_clave_acceso_cambiar" );
      ((Element)v.get(0)).setAttribute("cod","01" );
      ((Element)v.get(0)).setAttribute("titulo","" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","" );
      ((Element)v.get(0)).setAttribute("onload","doInit_Clave_acceso_cambiar();" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(2)).setAttribute("src","contenido_clave_acceso_cambiar.js" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(7)).setAttribute("nombre","mensaje" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(8)).setAttribute("nombre","volverAlLogin" );
      ((Element)v.get(8)).setAttribute("valor","false" );
      ((Element)v.get(4)).appendChild((Element)v.get(8));
      /* Termina nodo:8   */

      /* Empieza nodo:9 / Elemento padre: 4   */
      v.add(doc.createElement("VAR"));
      ((Element)v.get(9)).setAttribute("nombre","desactivarBotonBack" );
      ((Element)v.get(9)).setAttribute("valor","false" );
      ((Element)v.get(4)).appendChild((Element)v.get(9));
      /* Termina nodo:9   */

      /* Empieza nodo:10 / Elemento padre: 4   */
      v.add(doc.createElement("VAR"));
      ((Element)v.get(10)).setAttribute("nombre","hidAqueLPseVuelve" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(11)).setAttribute("nombre","hidtmp" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(12)).setAttribute("nombre","recargaMenu" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(14)).setAttribute("nombre","pass" );
      ...
      ((Element)v.get(15)).setAttribute("colorf","#F0F0F0" );
      ...
      ((Element)v.get(15)).setAttribute("visibilidad","" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(30)).setAttribute("nombre","lblDatosGen" );
      ...
      ((Element)v.get(30)).setAttribute("cod","0011" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(39)).setAttribute("nombre","lblClaveNueva" );
      ...
      ((Element)v.get(39)).setAttribute("cod","23" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(43)).setAttribute("nombre","lblClaveNueva2" );
      ...
      ((Element)v.get(43)).setAttribute("cod","43" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(50)).setAttribute("nombre","txtClaveNueva" );
      ((Element)v.get(50)).setAttribute("id","datosCampos" );
      ((Element)v.get(50)).setAttribute("max","15" );
      ((Element)v.get(50)).setAttribute("tipo","password" );
      ((Element)v.get(50)).setAttribute("onchange","" );
      ((Element)v.get(50)).setAttribute("req","N" );
      ((Element)v.get(50)).setAttribute("size","20" );
      ((Element)v.get(50)).setAttribute("valor","" );
      ((Element)v.get(50)).setAttribute("validacion","" );
      ((Element)v.get(50)).setAttribute("ontab","focoClaveNueva();" );
      ((Element)v.get(50)).setAttribute("onshtab","focoClaveNueva();" );
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(54)).setAttribute("nombre","txtConfirmarClaveNueva" );
      ((Element)v.get(54)).setAttribute("id","datosCampos" );
      ((Element)v.get(54)).setAttribute("max","15" );
      ((Element)v.get(54)).setAttribute("tipo","password" );
      ((Element)v.get(54)).setAttribute("onchange","" );
      ((Element)v.get(54)).setAttribute("req","N" );
      ((Element)v.get(54)).setAttribute("size","20" );
      ((Element)v.get(54)).setAttribute("valor","" );
      ((Element)v.get(54)).setAttribute("validacion","" );
      ((Element)v.get(54)).setAttribute("ontab","focoClave();" );
      ((Element)v.get(54)).setAttribute("onshtab","focoClave();" );
   ...
   private void getXML270(Document doc) {
      v.add(doc.createElement("td"));
      ((Element)v.get(65)).setAttribute("width","750" );
      ...
      ((Element)v.get(68)).setAttribute("height","1" );
      ...
      ((Element)v.get(69)).setAttribute("target","top" );
      ((Element)v.get(69)).setAttribute("action","" );
      ((Element)v.get(69)).setAttribute("method","post" );
      ((Element)v.get(69)).setAttribute("name","formularioDespedida" );
      ((Element)v.get(0)).appendChild((Element)v.get(69));

      /* Empieza nodo:70 / Elemento padre: 69   */
      v.add(doc.createElement("input"));
      ((Element)v.get(70)).setAttribute("type","hidden" );
      ((Element)v.get(70)).setAttribute("name","accion" );
      ((Element)v.get(70)).setAttribute("value","validar" );
      ...
      ((Element)v.get(71)).setAttribute("name","usuario" );
      ((Element)v.get(71)).setAttribute("value","" );
      ((Element)v.get(69)).appendChild((Element)v.get(71));
      /* Termina nodo:71   */

      /* Empieza nodo:72 / Elemento padre: 69   */
      v.add(doc.createElement("input"));
      ((Element)v.get(72)).setAttribute("type","hidden" );
      ((Element)v.get(72)).setAttribute("name","contrasenia" );
      ((Element)v.get(72)).setAttribute("value","" );
      ((Element)v.get(69)).appendChild((Element)v.get(72));
      /* Termina nodo:72   */

      /* Empieza nodo:73 / Elemento padre: 69   */
      v.add(doc.createElement("input"));
      ((Element)v.get(73)).setAttribute("type","hidden" );
      ((Element)v.get(73)).setAttribute("name","ON" );
      ((Element)v.get(73)).setAttribute("value","LPIdentificarUsuario" );
