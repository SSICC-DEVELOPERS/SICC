...
/*
    INDRA/CAR/mmg
    $Id: PedTipoPosicFormFormatter.java,v 1.1 2009/12/03 18:36:54 pecbazalar Exp $
    DESC
*/
 ...
 * @author Indra
 */
public class PedTipoPosicFormFormatter extends MMGDruidaFormatoObjeto {
	
	public PedTipoPosicFormFormatter() {
	}
		...
		for (int i = 0; i < pedTipoPosicList.size(); i++) {
			...
			row.add((pedTipoPosicData.getDescripcion() != null ? 
				FormatUtils.formatObject(pedTipoPosicData.getDescripcion(), 
				 MMGDruidaHelper.getUserDecimalFormatPattern(this), 
				MMGDruidaHelper.getUserDecimalFormatSymbols(this)) : ""));
			row.add((pedTipoPosicData.getIndDemaNorm() != null ? 
				FormatUtils.formatObject(pedTipoPosicData.getIndDemaNorm(), 
				 MMGDruidaHelper.getUserDecimalFormatPattern(this), 
				MMGDruidaHelper.getUserDecimalFormatSymbols(this)) : ""));
