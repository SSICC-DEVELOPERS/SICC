...
public class CalMotivContaPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","calMotivContaList" );
      ...
      ((Element)v.get(14)).setAttribute("cod","CalMotivConta.codMoti.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","CalMotivConta.Descripcion.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","CalMotivConta.codProc.label" );
