...
public class INCEscalaRecomendacion extends LPSICCBase {
   
  public INCEscalaRecomendacion() {
  ...
  public void ejecucion() throws Exception {
    ...
    try {
      ...
      if (accion.equals("generar")){
        ...
        cargarPagina();
        getConfiguracionMenu("INCEscalaRecomendacion");
      }
  ...
  private void cargarPagina() throws Exception{
    ...
    pagina("contenido_informe_reporte_escala_generar");   
  ...
  private void generarReporte() throws Exception{
    ...
    //es nro recomendadas efectivas pero esta NUMERORECOMENDADAS
    String numeroRecomendadas = conectorParametroLimpia("numeroRecomendadas","",true);
    if(!numeroRecomendadas.equals("")){
      datos.put(ConstantesREP.NUMERORECOMENDADAS,numeroRecomendadas);
    }
    
    String ingresoPorCampania = conectorParametroLimpia("ingresoPorCampania","",true);
    datos.put(ConstantesREP.INGRESOSCAMPANIA,ingresoPorCampania);
    
    
    datos.put(ConstantesREP.TITULO, "Reporte de Escala de Recomendacion");
    ...
    if(!region.equals("")){
       ...
       reporte = "RD_REP-079_01";
    }
    
    ejecutarReporte2(datos, "REPGenerarReporteBatch", "RD_REP-079", formato);
