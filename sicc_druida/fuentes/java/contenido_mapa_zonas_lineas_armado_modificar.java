...
public class contenido_mapa_zonas_lineas_armado_modificar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_mapa_zonas_lineas_armado_modificar" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","contenido_mapa_zonas_lineas_armado_modificar.js" );
      ...
      ((Element)v.get(7)).setAttribute("group","gMapZona" );
      ...
      ((Element)v.get(8)).setAttribute("group","gMapZona" );
      ...
      ((Element)v.get(9)).setAttribute("group","gMapZona" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(18)).setAttribute("nombre","hCbCentroDistribucion" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(19)).setAttribute("nombre","hCbLineasCDDef" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(35)).setAttribute("nombre","lblSeleccionDeMapa" );
      ((Element)v.get(35)).setAttribute("alto","13" );
      ((Element)v.get(35)).setAttribute("filas","1" );
      ((Element)v.get(35)).setAttribute("cod","00664" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(44)).setAttribute("nombre","lblCentroDistribucion" );
      ...
      ((Element)v.get(44)).setAttribute("cod","2054" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(48)).setAttribute("nombre","lblMapaCentroDistribucion" );
      ...
      ((Element)v.get(48)).setAttribute("cod","2925" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(60)).setAttribute("nombre","cbMapaCentroDistribucion" );
      ...
      ((Element)v.get(60)).setAttribute("onchange","onChangeMapaCentro();" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(75)).setAttribute("nombre","lblMapaZonas" );
      ...
      ((Element)v.get(75)).setAttribute("cod","2926" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(84)).setAttribute("nombre","cbMapaZonas" );
      ...
      /* Empieza nodo:90 / Elemento padre: 67   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(67)).appendChild((Element)v.get(90));
   ...
   private void getXML360(Document doc) {
      ...
      /* Empieza nodo:93 / Elemento padre: 32   */
      v.add(doc.createElement("fieldset"));
      ((Element)v.get(32)).appendChild((Element)v.get(93));
      ...
      ((Element)v.get(97)).setAttribute("height","20" );
      ((Element)v.get(96)).appendChild((Element)v.get(97));
      /* Termina nodo:97   */

      /* Empieza nodo:98 / Elemento padre: 96   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(98)).setAttribute("nombre","Consultar" );
      ((Element)v.get(98)).setAttribute("x","18" );
      ((Element)v.get(98)).setAttribute("ID","botonContenido" );
      ((Element)v.get(98)).setAttribute("tipo","html" );
      ((Element)v.get(98)).setAttribute("ontab","focalizaBotonTab(1);" );
      ((Element)v.get(98)).setAttribute("estado","false" );
      ((Element)v.get(98)).setAttribute("cod","150" );
      ((Element)v.get(98)).setAttribute("accion","onClickConsultar();" );
      ...
      ((Element)v.get(99)).setAttribute("x","18" );
      ((Element)v.get(99)).setAttribute("ID","botonContenido" );
      ((Element)v.get(99)).setAttribute("tipo","html" );
      ((Element)v.get(99)).setAttribute("ontab","focalizaBotonTab(0);" );
      ((Element)v.get(99)).setAttribute("estado","false" );
      ((Element)v.get(99)).setAttribute("cod","MMGGlobal.localization.updatebutton.label" );
      ((Element)v.get(99)).setAttribute("accion","onClickModificar();" );
      ...
      ((Element)v.get(100)).setAttribute("x","90" );
      ((Element)v.get(100)).setAttribute("ID","botonContenido" );
      ((Element)v.get(100)).setAttribute("tipo","html" );
      ((Element)v.get(100)).setAttribute("ontab","focalizaBotonTab(2);" );
      ((Element)v.get(100)).setAttribute("estado","false" );
      ((Element)v.get(100)).setAttribute("cod","MMGGlobal.removeButton.label" );
