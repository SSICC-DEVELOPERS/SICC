...
public class MaeProgrFidelPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","maeProgrFidelList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","MaeProgrFidel.codProgFide.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","MaeProgrFidel.desProgFide.label" );
      ...
      ((Element)v.get(17)).setAttribute("cod","MaeProgrFidel.factConv.label" );
      ...
      ((Element)v.get(18)).setAttribute("cod","MaeProgrFidel.paisOidPais.label" );
