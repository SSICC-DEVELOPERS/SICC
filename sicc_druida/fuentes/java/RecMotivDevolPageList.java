...
public class RecMotivDevolPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","recMotivDevolList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","RecMotivDevol.codMotiDevo.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","RecMotivDevol.Descripcion.label" );
