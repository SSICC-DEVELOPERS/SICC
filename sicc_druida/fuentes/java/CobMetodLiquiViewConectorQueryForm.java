...
public class CobMetodLiquiViewConectorQueryForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad CobMetodLiquiView" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGCobMetodLiquiViewQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGCobMetodLiquiViewQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","CobMetodLiquiViewFormFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(11)).setAttribute("NOMBRE","baesOidBaseEsca" );
