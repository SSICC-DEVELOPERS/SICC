...
public class ZonEstadZonaConectorRemove  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","onector para la eliminación de elementos de la entidad ZonEstadZona" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGZonEstadZonaRemoveID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGZonEstadZonaRemoveDTO" );
