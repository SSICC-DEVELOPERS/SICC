...
public class MaeNegocViewPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","maeNegocViewList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","MaeNegocView.codNego.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","MaeNegocView.Descripcion.label" );
