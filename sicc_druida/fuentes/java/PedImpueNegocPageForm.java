...
public class PedImpueNegocPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","PedImpueNegoc.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","PedImpueNegoc.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('pedImpueNegocFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('pedImpueNegocFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(54)).setAttribute("cod","PedImpueNegoc.paisOidPais.label" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('pedImpueNegocFrm',2, true);" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('pedImpueNegocFrm',2, false);" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(68)).setAttribute("onchange","mmgDependeneChangeNivel2('sbacOidSbac_acceOidAcce_canaOidCana', 'sbacOidSbac' , 'pedImpueNegoc', 'sbacOidSbac_acceOidAcce', 'sbacOidSbac')" );
      ...
      ((Element)v.get(68)).setAttribute("ontab","focaliza('pedImpueNegocFrm.sbacOidSbac_acceOidAcce');" );
      ((Element)v.get(68)).setAttribute("onshtab","ejecutarAccionFoco('pedImpueNegocFrm',5, false);" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(79)).setAttribute("onchange","mmgDependeneChange('sbacOidSbac_acceOidAcce', 'sbacOidSbac' , 'pedImpueNegoc')" );
      ...
      ((Element)v.get(79)).setAttribute("ontab","focaliza('pedImpueNegocFrm.sbacOidSbac');" );
      ((Element)v.get(79)).setAttribute("onshtab","focaliza('pedImpueNegocFrm.sbacOidSbac_acceOidAcce_canaOidCana');" );
      ...
      ((Element)v.get(87)).setAttribute("cod","PedImpueNegoc.sbacOidSbac.label" );
      ...
      ((Element)v.get(90)).setAttribute("ontab","ejecutarAccionFoco('pedImpueNegocFrm',5, true);" );
      ((Element)v.get(90)).setAttribute("onshtab","focaliza('pedImpueNegocFrm.sbacOidSbac_acceOidAcce');" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(109)).setAttribute("nombre","negoOidNegoTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(113)).setAttribute("nombre","lblnegoOidNego" );
      ...
      ((Element)v.get(113)).setAttribute("cod","PedImpueNegoc.negoOidNego.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(114)).setAttribute("nombre","negoOidNegoWidgetTrId" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(116)).setAttribute("nombre","negoOidNego" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(116)).setAttribute("ontab","ejecutarAccionFoco('pedImpueNegocFrm',6, true);" );
      ((Element)v.get(116)).setAttribute("onshtab","ejecutarAccionFoco('pedImpueNegocFrm',6, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(118)).setAttribute("nombre","negoOidNegoGapTdId" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(120)).setAttribute("nombre","taimOidTasaImpuTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(124)).setAttribute("nombre","lbltaimOidTasaImpu" );
      ...
      ((Element)v.get(124)).setAttribute("cod","PedImpueNegoc.taimOidTasaImpu.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(125)).setAttribute("nombre","taimOidTasaImpuWidgetTrId" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(127)).setAttribute("nombre","taimOidTasaImpu" );
      ...
      ((Element)v.get(127)).setAttribute("ontab","ejecutarAccionFoco('pedImpueNegocFrm',7, true);" );
      ((Element)v.get(127)).setAttribute("onshtab","ejecutarAccionFoco('pedImpueNegocFrm',7, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(129)).setAttribute("nombre","taimOidTasaImpuGapTdId" );
   ...
   private void getXML630(Document doc) {
      ...
      /* Empieza nodo:143 / Elemento padre: 0   */
      v.add(doc.createElement("TR"));
      ((Element)v.get(143)).setAttribute("nombre","pedImpueNegocTrButtons" );
      ((Element)v.get(0)).appendChild((Element)v.get(143));
      ...
      ((Element)v.get(150)).setAttribute("nombre","pedImpueNegocTdQueryButton" );
      ((Element)v.get(149)).appendChild((Element)v.get(150));

      /* Empieza nodo:151 / Elemento padre: 150   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(151)).setAttribute("nombre","pedImpueNegocQueryButton" );
      ((Element)v.get(151)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(151)).setAttribute("estado","false" );
      ((Element)v.get(151)).setAttribute("accion","pedImpueNegocFirstPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(152)).setAttribute("class","tablaTitle" );
      ((Element)v.get(152)).setAttribute("nombre","pedImpueNegocTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(154)).setAttribute("nombre","pedImpueNegocLovNullButton" );
      ((Element)v.get(154)).setAttribute("ID","botonContenido" );
      ((Element)v.get(154)).setAttribute("tipo","html" );
      ((Element)v.get(154)).setAttribute("accion","pedImpueNegocLovNullSelectionAction();" );
      ((Element)v.get(154)).setAttribute("estado","true" );
      ((Element)v.get(154)).setAttribute("cod","MMGGlobal.lovNullButton.label" );
