...
public class contenido_grupo_crear  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(5)).setAttribute("name","cbIndicadorCuadre" );
      ((Element)v.get(5)).setAttribute("required","true" );
      ((Element)v.get(5)).setAttribute("cod","461" );
      ((Element)v.get(5)).setAttribute("group","indCuadre" );
      ((Element)v.get(4)).appendChild((Element)v.get(5));
      /* Termina nodo:5   */

      /* Empieza nodo:6 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(6)).setAttribute("name","txtFactorCuadre" );
      ((Element)v.get(6)).setAttribute("required","true" );
      ((Element)v.get(6)).setAttribute("cod","459" );
      ((Element)v.get(6)).setAttribute("format","e" );
      ((Element)v.get(6)).setAttribute("min","1" );
      ((Element)v.get(6)).setAttribute("max","9999999999" );
      ((Element)v.get(6)).setAttribute("group","factCuadre" );
      ...
      ((Element)v.get(7)).setAttribute("group","factCuadreDec" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(20)).setAttribute("nombre","hidListaEditable" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(21)).setAttribute("nombre","hidCodSeleccionadosLE" );
      ...
      ((Element)v.get(37)).setAttribute("valor","Datos Búsqueda" );
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(41)).setAttribute("width","472" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(68)).setAttribute("nombre","lblNGrupoX" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(72)).setAttribute("nombre","lblTipoGrupoX" );
      ...
      ((Element)v.get(76)).setAttribute("nombre","cbIndicadorCuadre" );
      ...
      ((Element)v.get(76)).setAttribute("ontab","tabGenerico('cbIndicadorCuadre');" );
      ((Element)v.get(76)).setAttribute("onshtab","tabGenerico('cbIndicadorCuadre','sh');" );
      ...
      ((Element)v.get(81)).setAttribute("nombre","txtFactorCuadre" );
      ...
      ((Element)v.get(81)).setAttribute("ontab","tabGenerico('txtFactorCuadre');" );
      ((Element)v.get(81)).setAttribute("onshtab","tabGenerico('txtFactorCuadre','sh');" );
      ...
      /* Empieza nodo:84 / Elemento padre: 41   */
      v.add(doc.createElement("tr"));
   }

   private void getXML360(Document doc) {
      ((Element)v.get(41)).appendChild((Element)v.get(84));
      ...
      /* Empieza nodo:87 / Elemento padre: 31   */
      v.add(doc.createElement("td"));
      ((Element)v.get(31)).appendChild((Element)v.get(87));
      ...
      /* Empieza nodo:89 / Elemento padre: 23   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(23)).appendChild((Element)v.get(89));
      ...
      ((Element)v.get(96)).setAttribute("ancho","475" );
      ((Element)v.get(96)).setAttribute("alto","317" );
      ((Element)v.get(96)).setAttribute("x","12" );
      ((Element)v.get(96)).setAttribute("y","99" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(104)).setAttribute("cod","0067" );
      ...
      ((Element)v.get(117)).setAttribute("cod","8" );
      ...
      ((Element)v.get(119)).setAttribute("cod","9" );
      ...
      ((Element)v.get(121)).setAttribute("cod","608" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(123)).setAttribute("cod","581" );
      ...
      ((Element)v.get(125)).setAttribute("cod","529" );
      ...
      ((Element)v.get(127)).setAttribute("cod","530" );
      ...
      ((Element)v.get(129)).setAttribute("cod","481" );
      ...
      ((Element)v.get(131)).setAttribute("cod","482" );
      ...
      ((Element)v.get(133)).setAttribute("cod","483" );
   ...
   private void getXML630(Document doc) {
      ...
      ((Element)v.get(147)).setAttribute("nombre","Buscar" );
      ((Element)v.get(147)).setAttribute("x","13" );
      ...
      ((Element)v.get(147)).setAttribute("ontab","tabGenerico('Buscar');" );
      ((Element)v.get(147)).setAttribute("onshtab","tabGenerico('Buscar','sh');" );
      ((Element)v.get(8)).appendChild((Element)v.get(147));
      /* Termina nodo:147   */

      /* Empieza nodo:148 / Elemento padre: 8   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(148)).setAttribute("nombre","Modificar" );
      ((Element)v.get(148)).setAttribute("x","65" );
      ...
      ((Element)v.get(148)).setAttribute("cod","2" );
      ((Element)v.get(148)).setAttribute("accion","accionModificarProducto();" );
      ((Element)v.get(148)).setAttribute("ontab","tabGenerico('Modificar');" );
      ((Element)v.get(148)).setAttribute("onshtab","tabGenerico('Modificar','sh');" );
      ((Element)v.get(8)).appendChild((Element)v.get(148));
      /* Termina nodo:148   */

      /* Empieza nodo:149 / Elemento padre: 8   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(149)).setAttribute("nombre","Consultar" );
      ((Element)v.get(149)).setAttribute("x","13" );
      ...
      ((Element)v.get(149)).setAttribute("cod","150" );
      ((Element)v.get(149)).setAttribute("accion","accionConsultarProducto();" );
      ((Element)v.get(149)).setAttribute("ontab","tabGenerico('Consultar');" );
      ((Element)v.get(149)).setAttribute("onshtab","tabGenerico('Consultar','sh');" );
      ((Element)v.get(8)).appendChild((Element)v.get(149));
      /* Termina nodo:149   */

      /* Empieza nodo:150 / Elemento padre: 8   */
      v.add(doc.createElement("CAPA"));
      ...
      ((Element)v.get(8)).appendChild((Element)v.get(150));
      /* Termina nodo:150   */
      /* Termina nodo:8   */
