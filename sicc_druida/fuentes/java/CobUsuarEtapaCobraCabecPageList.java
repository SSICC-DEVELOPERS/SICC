...
public class CobUsuarEtapaCobraCabecPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","cobUsuarEtapaCobraCabecList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","CobUsuarEtapaCobraCabec.uscoOidUsuaCobr.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","CobUsuarEtapaCobraCabec.etdeOidEtapDeud.label" );
