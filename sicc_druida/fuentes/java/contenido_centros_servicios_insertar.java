...
public class contenido_centros_servicios_insertar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_centros_servicios_insertar" );
      ...
      ((Element)v.get(0)).setAttribute("cod","3180" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","contenido_centros_servicios_insertar.js" );
      ...
      ((Element)v.get(7)).setAttribute("name","txtCodCentroServ" );
      ((Element)v.get(7)).setAttribute("required","true" );
      ((Element)v.get(7)).setAttribute("cod","8" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(17)).setAttribute("nombre","cerrarVentana" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(19)).setAttribute("nombre","codCentroServicio" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(20)).setAttribute("nombre","desCentroServicio" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(21)).setAttribute("nombre","obsCentroServicio" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(22)).setAttribute("nombre","oidCentroServicio" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(38)).setAttribute("nombre","lblDatosAlta" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(50)).setAttribute("nombre","lblCodCentroServ" );
      ...
      ((Element)v.get(50)).setAttribute("cod","8" );
      ...
      ((Element)v.get(54)).setAttribute("cod","9" );
      ...
      ((Element)v.get(61)).setAttribute("nombre","txtCodCentroServ" );
      ((Element)v.get(61)).setAttribute("id","datosCampos" );
      ((Element)v.get(61)).setAttribute("max","3" );
      ...
      ((Element)v.get(61)).setAttribute("onshtab","focaliza('frmFormulario.areatxtObservaciones');" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(78)).setAttribute("nombre","lblObservaciones" );
      ...
      ((Element)v.get(78)).setAttribute("cod","169" );
      ...
      ((Element)v.get(85)).setAttribute("cols","50" );
      ((Element)v.get(85)).setAttribute("id","datosCampos" );
      ((Element)v.get(85)).setAttribute("msjreq","" );
      ((Element)v.get(85)).setAttribute("nombre","areatxtObservaciones" );
      ((Element)v.get(85)).setAttribute("readonly","N" );
      ((Element)v.get(85)).setAttribute("req","N" );
      ((Element)v.get(85)).setAttribute("rows","3" );
      ((Element)v.get(85)).setAttribute("tabindex","2" );
      ((Element)v.get(85)).setAttribute("valor","" );
      ((Element)v.get(85)).setAttribute("max","80" );
      ((Element)v.get(85)).setAttribute("ontab","focaliza2();" );
   ...
   private void getXML360(Document doc) {
      ...
      /* Empieza nodo:91 / Elemento padre: 32   */
      v.add(doc.createElement("td"));
      ((Element)v.get(32)).appendChild((Element)v.get(91));
