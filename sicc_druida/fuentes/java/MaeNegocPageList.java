...
public class MaeNegocPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","maeNegocList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","MaeNegoc.codNego.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","MaeNegoc.Descripcion.label" );
