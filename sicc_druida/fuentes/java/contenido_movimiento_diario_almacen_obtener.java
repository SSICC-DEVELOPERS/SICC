...
public class contenido_movimiento_diario_almacen_obtener  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_movimiento_diario_almacen_obtener" );
      ((Element)v.get(0)).setAttribute("cod","0738" );
      ((Element)v.get(0)).setAttribute("titulo","Obtener movimiento diario de almacén" );
      ...
      v.add(doc.createTextNode("\r   \r   \r   function onLoad(){\r      configurarMenuSecundario('Formulario');\r      fMostrarMensajeError();\r      focaliza('Formulario.cbPais');\r   }\r   \r   function generar(){\r     if(sicc_validaciones_generales()){\r        /*recolectarParametros();\r        \r        set('Formulario.conectorAction', 'LPMantenimientoAlmacen');           \r        set('Formulario.accion', 'generar');\r        \r        enviaSICC('Formulario');*/\r        var a = new Object();\r        a.accion = 'generar';\r        a.pais = quitarItemVacio(get('Formulario.cbPais'));\r        a.unidadNegocio = quitarItemVacio(get('Formulario.cbUnidadNegocio'));\r        a.negocio = quitarItemVacio(get('Formulario.cbNegocio'));\r        a.supergenerico = quitarItemVacio(get('Formulario.cbSupergenerico'));\r        a.generico = quitarItemVacio(get('Formulario.cbGenerico'));\r        a.almacen = quitarItemVacio(get('Formulario.cbAlmacen'));\r        a.estMercDisp = get('Formulario.cbEstadoMercaderiaDisponible');\r        a.estMercComp = get('Formulario.cbEstadoMercaderiaComprometido');\r        a.estMercAsign = get('Formulario.cbEstadoMercaderiaAsignado');\r        a.estMercRes = get('Formulario.cbEstadoMercaderiaReservado');          \r        mostrarModalSICC('LPMantenimientoAlmacen','generar', a);  \r     }\r\r   }\r      \r   function recolectarParametros(){\r   \r      set('Formulario.pais', quitarItemVacio(get('Formulario.cbPais')));\r      set('Formulario.unidadNegocio', quitarItemVacio(get('Formulario.cbUnidadNegocio')));\r      set('Formulario.negocio', quitarItemVacio(get('Formulario.cbNegocio')));\r      set('Formulario.supergenerico', quitarItemVacio(get('Formulario.cbSupergenerico')));\r      set('Formulario.generico', quitarItemVacio(get('Formulario.cbGenerico')));\r      set('Formulario.almacen', quitarItemVacio(get('Formulario.cbAlmacen')));\r      set('Formulario.estMercDisp', get('Formulario.cbEstadoMercaderiaDisponible'));\r      set('Formulario.estMercComp', get('Formulario.cbEstadoMercaderiaComprometido'));\r      set('Formulario.estMercAsign', get('Formulario.cbEstadoMercaderiaAsignado'));\r      set('Formulario.estMercRes', get('Formulario.cbEstadoMercaderiaReservado'));\r   \r   }   \r   \r   \r   function quitarItemVacio(elemento){\r      var elementoADevolver = new Array();\r     \r      for(var k=0;k<elemento.length;k++) {\r         if (elemento[k] != ''){ 			 \r            elementoADevolver[elementoADevolver.length] = elemento[k];\r         }\r      }\r        \r      return elementoADevolver;\r      \r   }\r\r   \r  \r\r   \r   \r\r   \r  \r"));
      ...
      ((Element)v.get(5)).setAttribute("name","cbEstadoMercaderiaDisponible" );
      ((Element)v.get(5)).setAttribute("required","true" );
      ((Element)v.get(5)).setAttribute("cod","2497" );
      ((Element)v.get(4)).appendChild((Element)v.get(5));
      /* Termina nodo:5   */

      /* Empieza nodo:6 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(6)).setAttribute("name","cbEstadoMercaderiaComprometido" );
      ((Element)v.get(6)).setAttribute("required","true" );
      ((Element)v.get(6)).setAttribute("cod","2498" );
      ((Element)v.get(4)).appendChild((Element)v.get(6));
      /* Termina nodo:6   */

      /* Empieza nodo:7 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(7)).setAttribute("name","cbEstadoMercaderiaAsignado" );
      ((Element)v.get(7)).setAttribute("required","true" );
      ((Element)v.get(7)).setAttribute("cod","2499" );
      ((Element)v.get(4)).appendChild((Element)v.get(7));
      /* Termina nodo:7   */

      /* Empieza nodo:8 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(8)).setAttribute("name","cbEstadoMercaderiaReservado" );
      ((Element)v.get(8)).setAttribute("required","true" );
      ((Element)v.get(8)).setAttribute("cod","2500" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(15)).setAttribute("nombre","unidadNegocio" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(16)).setAttribute("nombre","negocio" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(17)).setAttribute("nombre","supergenerico" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(18)).setAttribute("nombre","generico" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(19)).setAttribute("nombre","almacen" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(20)).setAttribute("nombre","estMercDisp" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(21)).setAttribute("nombre","estMercComp" );
   ...
   private void getXML90(Document doc) {
      v.add(doc.createElement("VAR"));
      ((Element)v.get(22)).setAttribute("nombre","estMercAsign" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(23)).setAttribute("nombre","estMercRes" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(84)).setAttribute("nombre","cbUnidadNegocio" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(114)).setAttribute("nombre","cbSupergenerico" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(140)).setAttribute("nombre","cbAlmacen" );
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(165)).setAttribute("nombre","cbEstadoMercaderiaDisponible" );
   ...
   private void getXML630(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(170)).setAttribute("nombre","cbEstadoMercaderiaComprometido" );
   ...
   private void getXML720(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(195)).setAttribute("nombre","cbEstadoMercaderiaAsignado" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(200)).setAttribute("nombre","cbEstadoMercaderiaReservado" );
      ...
      /* Empieza nodo:207 / Elemento padre: 34   */
      v.add(doc.createElement("td"));
      ((Element)v.get(34)).appendChild((Element)v.get(207));
      ...
      /* Empieza nodo:209 / Elemento padre: 26   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(26)).appendChild((Element)v.get(209));
      ...
      ((Element)v.get(217)).setAttribute("nombre","btnGenerarInforme" );
   }

   private void getXML810(Document doc) {
      ((Element)v.get(217)).setAttribute("ID","botonContenido" );
      ((Element)v.get(217)).setAttribute("tipo","html" );
      ((Element)v.get(217)).setAttribute("accion","generar();" );
      ((Element)v.get(217)).setAttribute("estado","false" );
      ((Element)v.get(217)).setAttribute("cod","2495" );
      ((Element)v.get(217)).setAttribute("ontab","focaliza('Formulario.cbPais')" );
      ...
      /* Empieza nodo:220 / Elemento padre: 26   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(26)).appendChild((Element)v.get(220));
