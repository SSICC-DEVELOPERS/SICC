...
public class PedTasaImpuePageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","pedTasaImpueList" );
      ...
      ((Element)v.get(14)).setAttribute("cod","PedTasaImpue.valIndiImpu.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","PedTasaImpue.Descripcion.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","PedTasaImpue.valTasaImpu.label" );
