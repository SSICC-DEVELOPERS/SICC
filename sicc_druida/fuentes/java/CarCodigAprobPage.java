...
public class CarCodigAprobPage  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","CarCodigAprobPage" );
      ((Element)v.get(0)).setAttribute("titulo","" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","" );
      ((Element)v.get(0)).setAttribute("onload","carCodigAprobInitComponents()" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","carcodigaprob.js" );
      ((Element)v.get(0)).appendChild((Element)v.get(4));
      /* Termina nodo:4   */

      /* Empieza nodo:5 / Elemento padre: 0   */
      v.add(doc.createElement("FORMULARIO"));
      ((Element)v.get(5)).setAttribute("nombre","carCodigAprobFrm" );
      ...
      ((Element)v.get(6)).setAttribute("valor","CarCodigAprobLPExecution" );
      ...
      ((Element)v.get(7)).setAttribute("valor","CarCodigAprobLPExecution" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(37)).setAttribute("nombre","carCodigAprobFormLayer" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(52)).setAttribute("cod","CarCodigAprob.legend.label" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(67)).setAttribute("cod","CarCodigAprob.id.label" );
      ...
      ((Element)v.get(70)).setAttribute("ontab","ejecutarAccionFoco('carCodigAprobFrm',1, true)" );
      ((Element)v.get(70)).setAttribute("onshtab","ejecutarAccionFoco('carCodigAprobFrm', 1, false)" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(88)).setAttribute("nombre","codAproTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(93)).setAttribute("nombre","codAproWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(95)).setAttribute("nombre","codApro" );
      ...
      ((Element)v.get(95)).setAttribute("ontab","ejecutarAccionFoco('carCodigAprobFrm',2, true)" );
      ((Element)v.get(95)).setAttribute("onshtab","ejecutarAccionFoco('carCodigAprobFrm', 2, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(96)).setAttribute("nombre","codAproGapTdId" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(102)).setAttribute("cod","CarCodigAprob.Descripcion.label" );
      ...
      ((Element)v.get(106)).setAttribute("ontab","ejecutarAccionFoco('carCodigAprobFrm',3, true)" );
      ((Element)v.get(106)).setAttribute("onshtab","ejecutarAccionFoco('carCodigAprobFrm', 3, false)" );
      ...
      ((Element)v.get(110)).setAttribute("href","javascript:openLocalizationDialog('carCodigAprobFrm', 'Descripcion', 1);" );
      ((Element)v.get(110)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"carCodigAprobFrm\",3, true)', 'ejecutarAccionFoco(\"carCodigAprobFrm\",3, false)')" );
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(126)).setAttribute("nombre","carCodigAprobTrButtons" );
      ...
      ((Element)v.get(133)).setAttribute("nombre","carCodigAprobTdQueryButton" );
      ((Element)v.get(132)).appendChild((Element)v.get(133));

      /* Empieza nodo:134 / Elemento padre: 133   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(134)).setAttribute("nombre","carCodigAprobQueryButton" );
      ((Element)v.get(134)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(134)).setAttribute("estado","false" );
      ((Element)v.get(134)).setAttribute("accion","carCodigAprobFirstPage();" );
      ...
      ((Element)v.get(135)).setAttribute("nombre","carCodigAprobTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(137)).setAttribute("nombre","carCodigAprobLovNullButton" );
      ((Element)v.get(137)).setAttribute("ID","botonContenido" );
      ((Element)v.get(137)).setAttribute("tipo","html" );
      ((Element)v.get(137)).setAttribute("accion","carCodigAprobLovNullSelectionAction();" );
   ...
   private void getXML630(Document doc) {
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(140)).setAttribute("nombre","carCodigAprobListLayer" );
      ...
      ((Element)v.get(141)).setAttribute("nombre","carCodigAprobList" );
   ...
   private void getXML720(Document doc) {
      ...
      ((Element)v.get(154)).setAttribute("cod","CarCodigAprob.codApro.label" );
      ...
      ((Element)v.get(155)).setAttribute("cod","CarCodigAprob.Descripcion.label" );
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(160)).setAttribute("nombre","carCodigAprobListButtonsLayer" );
      ...
      ((Element)v.get(166)).setAttribute("nombre","carCodigAprobPaginationButtonBar" );
   }
   ...
   private void getXML810(Document doc) {
      ...
      ((Element)v.get(167)).setAttribute("nombre","carCodigAprobFirstPageButton" );
      ((Element)v.get(167)).setAttribute("funcion","carCodigAprobFirstPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(168)).setAttribute("nombre","carCodigAprobFirstPageButtonGapTd" );
      ...
      v.add(doc.createElement("BTN"));
      ((Element)v.get(170)).setAttribute("nombre","carCodigAprobPreviousPageButton" );
      ((Element)v.get(170)).setAttribute("funcion","carCodigAprobPreviousPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(171)).setAttribute("nombre","carCodigAprobPreviousPageButtonGapTd" );
      ...
      v.add(doc.createElement("BTN"));
      ((Element)v.get(173)).setAttribute("nombre","carCodigAprobNextPageButton" );
      ((Element)v.get(173)).setAttribute("funcion","carCodigAprobNextPage();" );
      ...
      ((Element)v.get(176)).setAttribute("nombre","carCodigAprobUpdateButtonTd" );
      ((Element)v.get(162)).appendChild((Element)v.get(176));

      /* Empieza nodo:177 / Elemento padre: 176   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(177)).setAttribute("nombre","carCodigAprobUpdateButton" );
      ((Element)v.get(177)).setAttribute("ID","botonContenido" );
      ((Element)v.get(177)).setAttribute("tipo","html" );
      ((Element)v.get(177)).setAttribute("accion","carCodigAprobUpdateSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(178)).setAttribute("nombre","carCodigAprobUpdateButtonGapTd" );
      ...
      ((Element)v.get(180)).setAttribute("nombre","carCodigAprobViewForRemoveButtonTd" );
      ((Element)v.get(162)).appendChild((Element)v.get(180));

      /* Empieza nodo:181 / Elemento padre: 180   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(181)).setAttribute("nombre","carCodigAprobViewForRemoveButton" );
      ((Element)v.get(181)).setAttribute("ID","botonContenido" );
      ((Element)v.get(181)).setAttribute("tipo","html" );
      ((Element)v.get(181)).setAttribute("accion","carCodigAprobViewSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(182)).setAttribute("nombre","carCodigAprobViewForRemoveButtonGapTd" );
   ...
   private void getXML900(Document doc) {
      ...
      ((Element)v.get(184)).setAttribute("nombre","carCodigAprobLovSelectButtonTd" );
      ((Element)v.get(162)).appendChild((Element)v.get(184));

      /* Empieza nodo:185 / Elemento padre: 184   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(185)).setAttribute("nombre","carCodigAprobLovSelectButton" );
      ((Element)v.get(185)).setAttribute("ID","botonContenido" );
      ((Element)v.get(185)).setAttribute("tipo","html" );
      ((Element)v.get(185)).setAttribute("accion","carCodigAprobLovSelectionAction();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(186)).setAttribute("nombre","carCodigAprobLovSelectButtonGapTd" );
      ...
      ((Element)v.get(188)).setAttribute("nombre","carCodigAprobViewButtonTd" );
      ((Element)v.get(162)).appendChild((Element)v.get(188));

      /* Empieza nodo:189 / Elemento padre: 188   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(189)).setAttribute("nombre","carCodigAprobViewButton" );
      ((Element)v.get(189)).setAttribute("ID","botonContenido" );
      ((Element)v.get(189)).setAttribute("tipo","html" );
      ((Element)v.get(189)).setAttribute("accion","carCodigAprobViewSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(190)).setAttribute("nombre","carCodigAprobViewButtonGapTd" );
