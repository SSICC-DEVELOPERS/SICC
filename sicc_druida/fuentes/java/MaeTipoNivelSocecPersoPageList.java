...
public class MaeTipoNivelSocecPersoPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","maeTipoNivelSocecPersoList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","MaeTipoNivelSocecPerso.codNsep.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","MaeTipoNivelSocecPerso.Descripcion.label" );
