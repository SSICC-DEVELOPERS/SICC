...
public class MaeProgrFidelPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","MaeProgrFidel.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","MaeProgrFidel.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('maeProgrFidelFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('maeProgrFidelFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(50)).setAttribute("nombre","codProgFideTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lblCodProgFide" );
      ((Element)v.get(54)).setAttribute("alto","13" );
      ((Element)v.get(54)).setAttribute("filas","1" );
      ((Element)v.get(54)).setAttribute("id","datosTitle" );
      ((Element)v.get(54)).setAttribute("cod","MaeProgrFidel.codProgFide.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(55)).setAttribute("nombre","codProgFideWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(57)).setAttribute("nombre","codProgFide" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('maeProgrFidelFrm',2, true)" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('maeProgrFidelFrm', 2, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(58)).setAttribute("nombre","codProgFideGapTdId" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(75)).setAttribute("nombre","desProgFideTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(80)).setAttribute("nombre","desProgFideWidgetTrId" );
   }
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(82)).setAttribute("nombre","desProgFide" );
      ...
      ((Element)v.get(82)).setAttribute("ontab","ejecutarAccionFoco('maeProgrFidelFrm',3, true)" );
      ((Element)v.get(82)).setAttribute("onshtab","ejecutarAccionFoco('maeProgrFidelFrm', 3, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(83)).setAttribute("nombre","desProgFideGapTdId" );
   ...
   private void getXML450(Document doc) {
      ((Element)v.get(100)).setAttribute("nombre","factConvTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(105)).setAttribute("nombre","factConvWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(107)).setAttribute("nombre","factConv" );
      ...
      ((Element)v.get(107)).setAttribute("ontab","ejecutarAccionFoco('maeProgrFidelFrm',4, true)" );
      ((Element)v.get(107)).setAttribute("onshtab","ejecutarAccionFoco('maeProgrFidelFrm', 4, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(108)).setAttribute("nombre","factConvGapTdId" );
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(125)).setAttribute("nombre","paisOidPais_moneOidMoneAltTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(129)).setAttribute("nombre","lblpaisOidPais_moneOidMoneAlt" );
      ...
      ((Element)v.get(129)).setAttribute("cod","SegPais.moneOidMoneAlt.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(130)).setAttribute("nombre","paisOidPais_moneOidMoneAltWidgetTrId" );
      ...
      ((Element)v.get(132)).setAttribute("nombre","paisOidPais_moneOidMoneAlt" );
      ...
      ((Element)v.get(132)).setAttribute("onchange","mmgDependeneChange('paisOidPais_moneOidMoneAlt', 'paisOidPais' , 'maeProgrFidel')" );
      ...
      ((Element)v.get(132)).setAttribute("ontab","focaliza('maeProgrFidelFrm.paisOidPais_fopaOidFormPago');" );
      ((Element)v.get(132)).setAttribute("onshtab","ejecutarAccionFoco('maeProgrFidelFrm',5, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(134)).setAttribute("nombre","paisOidPais_moneOidMoneAltGapTdId" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(136)).setAttribute("nombre","paisOidPais_fopaOidFormPagoTdId" );
   ...
   private void getXML630(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(140)).setAttribute("nombre","lblpaisOidPais_fopaOidFormPago" );
      ...
      ((Element)v.get(140)).setAttribute("cod","SegPais.fopaOidFormPago.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(141)).setAttribute("nombre","paisOidPais_fopaOidFormPagoWidgetTrId" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(143)).setAttribute("nombre","paisOidPais_fopaOidFormPago" );
      ...
      ((Element)v.get(143)).setAttribute("onchange","mmgDependeneChange('paisOidPais_fopaOidFormPago', 'paisOidPais' , 'maeProgrFidel')" );
      ...
      ((Element)v.get(143)).setAttribute("ontab","focaliza('maeProgrFidelFrm.paisOidPais_moneOidMone');" );
      ((Element)v.get(143)).setAttribute("onshtab","ejecutarAccionFoco('maeProgrFidelFrm',4, true);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(145)).setAttribute("nombre","paisOidPais_fopaOidFormPagoGapTdId" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(147)).setAttribute("nombre","paisOidPais_moneOidMoneTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(151)).setAttribute("nombre","lblpaisOidPais_moneOidMone" );
      ...
      ((Element)v.get(151)).setAttribute("cod","SegPais.moneOidMone.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(152)).setAttribute("nombre","paisOidPais_moneOidMoneWidgetTrId" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(154)).setAttribute("nombre","paisOidPais_moneOidMone" );
      ...
      ((Element)v.get(154)).setAttribute("onchange","mmgDependeneChange('paisOidPais_moneOidMone', 'paisOidPais' , 'maeProgrFidel')" );
      ...
      ((Element)v.get(154)).setAttribute("ontab","focaliza('maeProgrFidelFrm.paisOidPais');" );
      ((Element)v.get(154)).setAttribute("onshtab","ejecutarAccionFoco('maeProgrFidelFrm',5, true);" );
   ...
   private void getXML720(Document doc) {
      ...
      /* Empieza nodo:156 / Elemento padre: 124   */
      v.add(doc.createElement("TD"));
      ((Element)v.get(156)).setAttribute("nombre","paisOidPais_moneOidMoneGapTdId" );
      ((Element)v.get(156)).setAttribute("nowrap","true" );
      ((Element)v.get(156)).setAttribute("class","datosCampos" );
      ((Element)v.get(124)).appendChild((Element)v.get(156));
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(158)).setAttribute("nombre","paisOidPaisTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(162)).setAttribute("nombre","lblpaisOidPais" );
      ...
      ((Element)v.get(162)).setAttribute("cod","MaeProgrFidel.paisOidPais.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(163)).setAttribute("nombre","paisOidPaisWidgetTrId" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(165)).setAttribute("nombre","paisOidPais" );
      ...
      ((Element)v.get(165)).setAttribute("ontab","ejecutarAccionFoco('maeProgrFidelFrm',1, true);" );
      ((Element)v.get(165)).setAttribute("onshtab","focaliza('maeProgrFidelFrm.paisOidPais_moneOidMone');" );
      ...
      /* Empieza nodo:167 / Elemento padre: 124   */
      v.add(doc.createElement("TD"));
      ((Element)v.get(167)).setAttribute("nombre","paisOidPaisGapTdId" );
      ((Element)v.get(167)).setAttribute("nowrap","true" );
      ((Element)v.get(167)).setAttribute("class","datosCampos" );
      ((Element)v.get(124)).appendChild((Element)v.get(167));
      ...
      /* Empieza nodo:169 / Elemento padre: 124   */
      v.add(doc.createElement("TD"));
      ((Element)v.get(169)).setAttribute("width","100%" );
      ((Element)v.get(124)).appendChild((Element)v.get(169));
      ...
      /* Empieza nodo:171 / Elemento padre: 119   */
      v.add(doc.createElement("TD"));
      ((Element)v.get(171)).setAttribute("width","100%" );
      ((Element)v.get(119)).appendChild((Element)v.get(171));
      /* Termina nodo:171   */
      /* Termina nodo:119   */
   ...
   private void getXML810(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(181)).setAttribute("nombre","maeProgrFidelTrButtons" );
      ...
      ((Element)v.get(188)).setAttribute("nombre","maeProgrFidelTdQueryButton" );
      ((Element)v.get(187)).appendChild((Element)v.get(188));

      /* Empieza nodo:189 / Elemento padre: 188   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(189)).setAttribute("nombre","maeProgrFidelQueryButton" );
      ((Element)v.get(189)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(189)).setAttribute("estado","false" );
      ((Element)v.get(189)).setAttribute("accion","maeProgrFidelFirstPage();" );
      ...
      ((Element)v.get(190)).setAttribute("nombre","maeProgrFidelTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(192)).setAttribute("nombre","maeProgrFidelLovNullButton" );
      ((Element)v.get(192)).setAttribute("ID","botonContenido" );
      ((Element)v.get(192)).setAttribute("tipo","html" );
      ((Element)v.get(192)).setAttribute("accion","maeProgrFidelLovNullSelectionAction();" );
