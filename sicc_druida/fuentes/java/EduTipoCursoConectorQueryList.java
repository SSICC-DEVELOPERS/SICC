...
public class EduTipoCursoConectorQueryList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad EduTipoCurso" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGEduTipoCursoQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGEduTipoCursoQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","EduTipoCursoListFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(8)).setAttribute("NOMBRE","codTipoCurs" );
