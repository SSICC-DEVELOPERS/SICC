...
/*
    INDRA/CAR/mmg
    $Id: MsgMedioEnvioPaisTransactionComboLoad.java,v 1.1 2009/12/03 18:33:44 pecbazalar Exp $
    DESC
*/
...
public class MsgMedioEnvioPaisTransactionComboLoad extends MMGDruidaTransaction {
	//Constantes usadas en la clase. Simplemente representan 
	//los nombre de conectore y de logicas de negocio
	public static final String BUSINESSID_QUERY = "MMGMsgMedioEnvioPaisQueryFromToUserStructuralSecurity";
	public static final String CONECTOR_QUERY_COMBO= "MsgMedioEnvioPaisConectorCombo";

	// Definicion del constructor
	public MsgMedioEnvioPaisTransactionComboLoad(){
		super();
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			dto.addProperty("msgMedioEnvioPaisFrom", msgMedioEnvioPais);
			dto.addProperty("msgMedioEnvioPaisTo", msgMedioEnvioPais.clone());
