...
public class SegMonedPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","segMonedList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","SegMoned.codMone.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","SegMoned.Descripcion.label" );
