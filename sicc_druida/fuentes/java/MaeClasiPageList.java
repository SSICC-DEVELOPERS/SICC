...
public class MaeClasiPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","maeClasiList" );
      ...
      ((Element)v.get(14)).setAttribute("cod","MaeClasi.tcclOidTipoClas.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","MaeClasi.codClas.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","MaeClasi.Descripcion.label" );
