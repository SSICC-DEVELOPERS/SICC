...
public class ZonValorEstruGeopoPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","zonValorEstruGeopoList" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(33)).setAttribute("cod","ZonValorEstruGeopo.codUnidGeog.label" );
      ...
      ((Element)v.get(34)).setAttribute("cod","ZonValorEstruGeopo.desGeog.label" );
      ...
      ((Element)v.get(35)).setAttribute("cod","ZonValorEstruGeopo.codNse1.label" );
      ...
      ((Element)v.get(36)).setAttribute("cod","ZonValorEstruGeopo.codNse2.label" );
      ...
      ((Element)v.get(37)).setAttribute("cod","ZonValorEstruGeopo.codNse3.label" );
      ...
      ((Element)v.get(38)).setAttribute("cod","ZonValorEstruGeopo.codPost.label" );
      ...
      ((Element)v.get(39)).setAttribute("cod","ZonValorEstruGeopo.indActi.label" );
      ...
      ((Element)v.get(40)).setAttribute("cod","ZonValorEstruGeopo.indAsig.label" );
      ...
      ((Element)v.get(41)).setAttribute("cod","ZonValorEstruGeopo.indBorr.label" );
      ...
      ((Element)v.get(42)).setAttribute("cod","ZonValorEstruGeopo.orde1.label" );
      ...
      ((Element)v.get(43)).setAttribute("cod","ZonValorEstruGeopo.orde2.label" );
      ...
      ((Element)v.get(44)).setAttribute("cod","ZonValorEstruGeopo.orde3.label" );
      ...
      ((Element)v.get(45)).setAttribute("cod","ZonValorEstruGeopo.orde4.label" );
      ...
      ((Element)v.get(46)).setAttribute("cod","ZonValorEstruGeopo.orde5.label" );
      ...
      ((Element)v.get(47)).setAttribute("cod","ZonValorEstruGeopo.orde6.label" );
      ...
      ((Element)v.get(48)).setAttribute("cod","ZonValorEstruGeopo.orde7.label" );
      ...
      ((Element)v.get(49)).setAttribute("cod","ZonValorEstruGeopo.orde8.label" );
      ...
      ((Element)v.get(50)).setAttribute("cod","ZonValorEstruGeopo.orde9.label" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(51)).setAttribute("cod","ZonValorEstruGeopo.egeoOidEstrGeop.label" );
      ...
      ((Element)v.get(52)).setAttribute("cod","ZonValorEstruGeopo.paisOidPais.label" );
      ...
      ((Element)v.get(53)).setAttribute("cod","ZonValorEstruGeopo.fecActu.label" );
      ...
      ((Element)v.get(54)).setAttribute("cod","ZonValorEstruGeopo.sgeoOidSubeGeop.label" );
