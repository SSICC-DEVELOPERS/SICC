 ...
 * Componente:    LPGeneraCronogramaFase2 
 * Fecha:             02/06/2004
 * Observaciones:     
 * @version        1.0
 * @autor           Luis Ramos
...
public class LPGeneraCronogramaFase2 extends LPSICCBase {

	public LPGeneraCronogramaFase2() {
		super();
	}
    ...
    setTrazaFichero();
      ...
      if (mAccion.equals("")) {
          ...
          conectorActionParametro("accion","muestraCronogramaFase2");
