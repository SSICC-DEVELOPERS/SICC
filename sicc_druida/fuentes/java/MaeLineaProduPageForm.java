...
public class MaeLineaProduPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","MaeLineaProdu.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","MaeLineaProdu.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("max","10" );
      ((Element)v.get(32)).setAttribute("onchange","" );
      ((Element)v.get(32)).setAttribute("req","N" );
      ((Element)v.get(32)).setAttribute("size","10" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('maeLineaProduFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('maeLineaProduFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(54)).setAttribute("cod","MaeLineaProdu.paisOidPais.label" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('maeLineaProduFrm',2, true);" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('maeLineaProduFrm',2, false);" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(76)).setAttribute("nombre","codLineProdTdId" );
   ...
   private void getXML360(Document doc) {
      ((Element)v.get(81)).setAttribute("nombre","codLineProdWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(83)).setAttribute("nombre","codLineProd" );
      ...
      ((Element)v.get(83)).setAttribute("ontab","ejecutarAccionFoco('maeLineaProduFrm',3, true)" );
      ((Element)v.get(83)).setAttribute("onshtab","ejecutarAccionFoco('maeLineaProduFrm', 3, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(84)).setAttribute("nombre","codLineProdGapTdId" );
      ...
      ((Element)v.get(90)).setAttribute("cod","MaeLineaProdu.Descripcion.label" );
      ...
      ((Element)v.get(94)).setAttribute("ontab","ejecutarAccionFoco('maeLineaProduFrm',4, true)" );
      ((Element)v.get(94)).setAttribute("onshtab","ejecutarAccionFoco('maeLineaProduFrm', 4, false)" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(98)).setAttribute("href","javascript:openLocalizationDialog('maeLineaProduFrm', 'Descripcion', 1);" );
      ((Element)v.get(98)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"maeLineaProduFrm\",4, true)', 'ejecutarAccionFoco(\"maeLineaProduFrm\",4, false)')" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(114)).setAttribute("nombre","maeLineaProduTrButtons" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(121)).setAttribute("nombre","maeLineaProduTdQueryButton" );
      ((Element)v.get(120)).appendChild((Element)v.get(121));

      /* Empieza nodo:122 / Elemento padre: 121   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(122)).setAttribute("nombre","maeLineaProduQueryButton" );
      ((Element)v.get(122)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(122)).setAttribute("estado","false" );
      ((Element)v.get(122)).setAttribute("accion","maeLineaProduFirstPage();" );
      ...
      ((Element)v.get(123)).setAttribute("nombre","maeLineaProduTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(125)).setAttribute("nombre","maeLineaProduLovNullButton" );
      ((Element)v.get(125)).setAttribute("ID","botonContenido" );
      ((Element)v.get(125)).setAttribute("tipo","html" );
      ((Element)v.get(125)).setAttribute("accion","maeLineaProduLovNullSelectionAction();" );
