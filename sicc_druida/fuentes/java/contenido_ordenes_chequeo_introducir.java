...
public class contenido_ordenes_chequeo_introducir  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_ordenes_chequeo_introducir" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(3)).setAttribute("src","contenido_ordenes_chequeo_introducir.js" );
      ...
      ((Element)v.get(5)).setAttribute("name","cbSeleccionarChequeo" );
      ((Element)v.get(5)).setAttribute("required","true" );
      ((Element)v.get(5)).setAttribute("cod","2385" );
      ...
      ((Element)v.get(14)).setAttribute("nombre","capaContenido1" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(33)).setAttribute("width","705" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(41)).setAttribute("nombre","lblSeleccionarChequeo" );
      ...
      ((Element)v.get(41)).setAttribute("cod","2385" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(48)).setAttribute("nombre","cbSeleccionarChequeo" );
      ((Element)v.get(48)).setAttribute("valorinicial","" );
      ((Element)v.get(48)).setAttribute("onshtab","document.all['btnAceptar'].focus();" );
      ((Element)v.get(48)).setAttribute("ontab","document.all['btnAceptar'].focus();" );
      ...
      ((Element)v.get(65)).setAttribute("accion","btnAceptar_onclick();" );
      ((Element)v.get(65)).setAttribute("onshtab","focaliza(FORMULARIO + '.cbSeleccionarChequeo')" );
      ((Element)v.get(65)).setAttribute("ontab","focaliza(FORMULARIO + '.cbSeleccionarChequeo')" );
   ...
   private void getXML270(Document doc) {
      ((Element)v.get(71)).setAttribute("width","756" );
