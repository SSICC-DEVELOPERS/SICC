...
public class CarParamEvaluNrPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","CarParamEvaluNr.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","CarParamEvaluNr.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('carParamEvaluNrFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('carParamEvaluNrFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(50)).setAttribute("nombre","codParaTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lblCodPara" );
      ((Element)v.get(54)).setAttribute("alto","13" );
      ((Element)v.get(54)).setAttribute("filas","1" );
      ((Element)v.get(54)).setAttribute("id","datosTitle" );
      ((Element)v.get(54)).setAttribute("cod","CarParamEvaluNr.codPara.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(55)).setAttribute("nombre","codParaWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(57)).setAttribute("nombre","codPara" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('carParamEvaluNrFrm',2, true)" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('carParamEvaluNrFrm', 2, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(58)).setAttribute("nombre","codParaGapTdId" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(60)).setAttribute("nombre","desParaTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(65)).setAttribute("nombre","desParaWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(67)).setAttribute("nombre","desPara" );
      ...
      ((Element)v.get(67)).setAttribute("ontab","ejecutarAccionFoco('carParamEvaluNrFrm',3, true)" );
      ((Element)v.get(67)).setAttribute("onshtab","ejecutarAccionFoco('carParamEvaluNrFrm', 3, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(68)).setAttribute("nombre","desParaGapTdId" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(70)).setAttribute("nombre","valPesoTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(75)).setAttribute("nombre","valPesoWidgetTrId" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(77)).setAttribute("nombre","valPeso" );
      ...
      ((Element)v.get(77)).setAttribute("size","4" );
      ...
      ((Element)v.get(77)).setAttribute("ontab","ejecutarAccionFoco('carParamEvaluNrFrm',4, true)" );
      ((Element)v.get(77)).setAttribute("onshtab","ejecutarAccionFoco('carParamEvaluNrFrm', 4, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(78)).setAttribute("nombre","valPesoGapTdId" );
      ...
      /* Empieza nodo:92 / Elemento padre: 0   */
      v.add(doc.createElement("TR"));
      ((Element)v.get(92)).setAttribute("nombre","carParamEvaluNrTrButtons" );
      ((Element)v.get(0)).appendChild((Element)v.get(92));
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(99)).setAttribute("class","tablaTitle" );
      ((Element)v.get(99)).setAttribute("nombre","carParamEvaluNrTdQueryButton" );
      ((Element)v.get(98)).appendChild((Element)v.get(99));

      /* Empieza nodo:100 / Elemento padre: 99   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(100)).setAttribute("nombre","carParamEvaluNrQueryButton" );
      ((Element)v.get(100)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(100)).setAttribute("estado","false" );
      ((Element)v.get(100)).setAttribute("accion","carParamEvaluNrFirstPage();" );
      ...
      ((Element)v.get(101)).setAttribute("nombre","carParamEvaluNrTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(103)).setAttribute("nombre","carParamEvaluNrLovNullButton" );
      ((Element)v.get(103)).setAttribute("ID","botonContenido" );
      ((Element)v.get(103)).setAttribute("tipo","html" );
      ((Element)v.get(103)).setAttribute("accion","carParamEvaluNrLovNullSelectionAction();" );
      ((Element)v.get(103)).setAttribute("estado","true" );
      ((Element)v.get(103)).setAttribute("cod","MMGGlobal.lovNullButton.label" );
