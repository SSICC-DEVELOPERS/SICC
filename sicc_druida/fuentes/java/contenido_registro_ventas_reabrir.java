...
public class contenido_registro_ventas_reabrir  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_registro_ventas_reabrir" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(5)).setAttribute("src","contenido_registro_ventas_reabrir.js" );
      ...
      ((Element)v.get(7)).setAttribute("name","txtFechaCierre" );
      ((Element)v.get(7)).setAttribute("required","true" );
      ((Element)v.get(7)).setAttribute("cod","645" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(17)).setAttribute("nombre","opcion" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(18)).setAttribute("nombre","numRegistros" );
      ...
      ((Element)v.get(19)).setAttribute("nombre","capaUnica" );
      ((Element)v.get(19)).setAttribute("alto","121" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(34)).setAttribute("nombre","lblTit" );
      ((Element)v.get(34)).setAttribute("alto","13" );
      ((Element)v.get(34)).setAttribute("filas","1" );
      ((Element)v.get(34)).setAttribute("valor","" );
      ((Element)v.get(34)).setAttribute("cod","00137" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(46)).setAttribute("nombre","lblFechaCierre" );
      ...
      ((Element)v.get(46)).setAttribute("cod","645" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(53)).setAttribute("nombre","txtFechaCierre" );
      ((Element)v.get(53)).setAttribute("id","datosCampos" );
      ((Element)v.get(53)).setAttribute("max","10" );
      ((Element)v.get(53)).setAttribute("tipo","" );
      ((Element)v.get(53)).setAttribute("onshtab","document.all['btnReabrir'].focus();" );
      ((Element)v.get(53)).setAttribute("onchange","" );
      ((Element)v.get(53)).setAttribute("onblur","comprobarFecha('txtFechaCierre');" );
      ((Element)v.get(53)).setAttribute("req","S" );
      ((Element)v.get(53)).setAttribute("size","12" );
      ...
      ((Element)v.get(69)).setAttribute("nombre","btnReabrir" );
      ((Element)v.get(69)).setAttribute("ID","botonContenido" );
      ((Element)v.get(69)).setAttribute("tipo","html" );
      ((Element)v.get(69)).setAttribute("ontab","focaliza('Formulario.txtFechaCierre');" );
      ((Element)v.get(69)).setAttribute("accion","accionBTN_ReabrirPeriodo ();" );
      ((Element)v.get(69)).setAttribute("estado","false" );
      ((Element)v.get(69)).setAttribute("cod","1247" );
