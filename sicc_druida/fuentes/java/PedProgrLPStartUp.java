/*
    INDRA/CAR/mmg
    $Id: PedProgrLPStartUp.java,v 1.1 2009/12/03 18:42:19 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class PedProgrLPStartUp extends MMGDruidaBase{
	//Constantes que definen la altura de los formularios según el modo
	public static final short QUERYFORM_SIZE = 147;
	public static final short CREATEFORM_SIZE = 121;
	public static final short UPDATEFORM_SIZE = 121;
	public static final short VIEWFORM_SIZE = 121;
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "PedProgrPage", "cod", "PedProgr." + accion + ".label");
			...
			limpiarBotoneraLista("pedProgr", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "valNomb", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 0, 40);");
		asignarAtributo("TEXT", "valClasEjec", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 0, 40);");
		
		//Primero determianmos el nombre del campo en la entidad de oriegen donde se van a cargar los datos
		asignar("VAR", "idAttributeLovOpener", conectorParametro(PARAMETRO_LOV_ATTRIBUTO));
		asignar("VAR", "idEntityLovOpener", conectorParametro(PARAMETRO_LOV_ENTIDAD));
		//asignarAtributo("CAPA", "pedProgrLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "PedProgrPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		PedProgrData pedProgrQuery= new PedProgrData();
		pedProgrQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		PedProgrData datosResult = (PedProgrData)getSingleObject(BUSINESSID_QUERY, pedProgrQuery, 
			pedProgrQuery.clone(), "pedProgr");
		...
		PedProgrData pedProgr = datosResult;
		asignar("TEXT", "valNomb", FormatUtils.formatObject(pedProgr.getValNomb(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "valClasEjec", FormatUtils.formatObject(pedProgr.getValClasEjec(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		asignarAtributo("TEXT", "valNomb", "disabled", "S");
		asignarAtributo("TEXT", "valClasEjec", "disabled", "S");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "pedProgrFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		PedProgrData pedProgrQuery= new PedProgrData();
		pedProgrQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(pedProgr.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"pedProgrFrm\",0, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"pedProgrFrm\",0, false)");
				asignarAtributo("AREATEXTO", "valNomb", "ontab","ejecutarAccionFocoModificacion(\"pedProgrFrm\",0, true)");
				asignarAtributo("AREATEXTO", "valNomb", "onshtab","ejecutarAccionFocoModificacion(\"pedProgrFrm\",0, false)");
				asignarAtributo("AREATEXTO", "valClasEjec", "ontab","ejecutarAccionFocoModificacion(\"pedProgrFrm\",0, true)");
				asignarAtributo("AREATEXTO", "valClasEjec", "onshtab","ejecutarAccionFocoModificacion(\"pedProgrFrm\",0, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","pedProgrTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","pedProgrTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es valNomb...");		
				
				traza("MMG: el atributo es valClasEjec...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","pedProgrFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","pedProgrListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","pedProgrListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(PedProgrData pedProgr) throws Exception{
	...
	* @param pedProgr La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(PedProgrData pedProgr) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		PedProgrData pedProgr = 
			(PedProgrData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(pedProgr);
		loadLeafDependenceCombos(pedProgr);
	}
