/*
    INDRA/CAR/mmg
    $Id: BelTipoMovimAlmacViewLPStartUp.java,v 1.1 2009/12/03 18:43:40 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class BelTipoMovimAlmacViewLPStartUp extends MMGDruidaBase{
	//Constantes que definen la altura de los formularios según el modo
	public static final short QUERYFORM_SIZE = 399;
	public static final short CREATEFORM_SIZE = 393;
	public static final short UPDATEFORM_SIZE = 393;
	public static final short VIEWFORM_SIZE = 393;
	...
	public BelTipoMovimAlmacViewLPStartUp(){
		super();
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			buildJsPageSize("BelTipoMovimAlmacView");
			...
			asignarAtributo("PAGINA", "BelTipoMovimAlmacViewPage", "cod", "BelTipoMovimAlmacView." + accion + ".label");
			...
			limpiarBotoneraLista("belTipoMovimAlmacView", accion);
	...
	protected void cmdLov() throws Exception{
		...
		//asignarAtributo("CAPA", "belTipoMovimAlmacViewLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "BelTipoMovimAlmacViewPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		BelTipoMovimAlmacViewData belTipoMovimAlmacViewQuery= new BelTipoMovimAlmacViewData();
		belTipoMovimAlmacViewQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		BelTipoMovimAlmacViewData datosResult = (BelTipoMovimAlmacViewData)getSingleObject(BUSINESSID_QUERY, belTipoMovimAlmacViewQuery, 
			belTipoMovimAlmacViewQuery.clone(), "belTipoMovimAlmacView");
		...
		BelTipoMovimAlmacViewData belTipoMovimAlmacView = datosResult;
		es.indra.belcorp.mso.SegPaisViewData paisOidPais = belTipoMovimAlmacView.getPaisOidPais();
		if(paisOidPais != null && paisOidPais.getId() != null) checkCombo("paisOidPais" , paisOidPais.getId().toString());
		asignar("TEXT", "codTipoMovi", FormatUtils.formatObject(belTipoMovimAlmacView.getCodTipoMovi(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "codMoviSap", FormatUtils.formatObject(belTipoMovimAlmacView.getCodMoviSap(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "indMoviEntrAlma", FormatUtils.formatObject(belTipoMovimAlmacView.getIndMoviEntrAlma(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "indMantMovi", FormatUtils.formatObject(belTipoMovimAlmacView.getIndMantMovi(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "indSap", FormatUtils.formatObject(belTipoMovimAlmacView.getIndSap(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "codOper1", FormatUtils.formatObject(belTipoMovimAlmacView.getCodOper1(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "codOper2", FormatUtils.formatObject(belTipoMovimAlmacView.getCodOper2(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		asignarAtributo("TEXT", "codOper1", "disabled", "S");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "belTipoMovimAlmacViewFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		BelTipoMovimAlmacViewData belTipoMovimAlmacViewQuery= new BelTipoMovimAlmacViewData();
		belTipoMovimAlmacViewQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(belTipoMovimAlmacView.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"belTipoMovimAlmacViewFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"belTipoMovimAlmacViewFrm\",1, false)");
					asignarAtributo("COMBO","paisOidPais", "ontab", "ejecutarAccionFocoModificacion(\"belTipoMovimAlmacViewFrm\",2, true)");
					asignarAtributo("COMBO","paisOidPais", "onshtab", "ejecutarAccionFocoModificacion(\"belTipoMovimAlmacViewFrm\",2, false)");
				asignarAtributo("AREATEXTO", "codTipoMovi", "ontab","ejecutarAccionFocoModificacion(\"belTipoMovimAlmacViewFrm\",3, true)");
				asignarAtributo("AREATEXTO", "codTipoMovi", "onshtab","ejecutarAccionFocoModificacion(\"belTipoMovimAlmacViewFrm\",3, false)");
				asignarAtributo("AREATEXTO", "codMoviSap", "ontab","ejecutarAccionFocoModificacion(\"belTipoMovimAlmacViewFrm\",4, true)");
				asignarAtributo("AREATEXTO", "codMoviSap", "onshtab","ejecutarAccionFocoModificacion(\"belTipoMovimAlmacViewFrm\",4, false)");
				asignarAtributo("AREATEXTO", "indMoviEntrAlma", "ontab","ejecutarAccionFocoModificacion(\"belTipoMovimAlmacViewFrm\",5, true)");
				asignarAtributo("AREATEXTO", "indMoviEntrAlma", "onshtab","ejecutarAccionFocoModificacion(\"belTipoMovimAlmacViewFrm\",5, false)");
				asignarAtributo("AREATEXTO", "indMantMovi", "ontab","ejecutarAccionFocoModificacion(\"belTipoMovimAlmacViewFrm\",6, true)");
				asignarAtributo("AREATEXTO", "indMantMovi", "onshtab","ejecutarAccionFocoModificacion(\"belTipoMovimAlmacViewFrm\",6, false)");
				asignarAtributo("AREATEXTO", "indSap", "ontab","ejecutarAccionFocoModificacion(\"belTipoMovimAlmacViewFrm\",7, true)");
				asignarAtributo("AREATEXTO", "indSap", "onshtab","ejecutarAccionFocoModificacion(\"belTipoMovimAlmacViewFrm\",7, false)");
				asignarAtributo("AREATEXTO", "codOper1", "ontab","ejecutarAccionFocoModificacion(\"belTipoMovimAlmacViewFrm\",10, true)");
				asignarAtributo("AREATEXTO", "codOper1", "onshtab","ejecutarAccionFocoModificacion(\"belTipoMovimAlmacViewFrm\",10, false)");
				asignarAtributo("AREATEXTO", "codOper2", "ontab","ejecutarAccionFocoModificacion(\"belTipoMovimAlmacViewFrm\",11, true)");
				asignarAtributo("AREATEXTO", "codOper2", "onshtab","ejecutarAccionFocoModificacion(\"belTipoMovimAlmacViewFrm\",11, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","belTipoMovimAlmacViewTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","belTipoMovimAlmacViewTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","belTipoMovimAlmacViewFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","belTipoMovimAlmacViewListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","belTipoMovimAlmacViewListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(BelTipoMovimAlmacViewData belTipoMovimAlmacView) throws Exception{
		...
		if(belTipoMovimAlmacView != null && belTipoMovimAlmacView.getPaisOidPais() != null){
				checkCombo("paisOidPais" , belTipoMovimAlmacView.getPaisOidPais().getId().toString());
			}
	...
	* @param belTipoMovimAlmacView La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(BelTipoMovimAlmacViewData belTipoMovimAlmacView) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		BelTipoMovimAlmacViewData belTipoMovimAlmacView = 
			(BelTipoMovimAlmacViewData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(belTipoMovimAlmacView.getPaisOidPais() != null){
			belTipoMovimAlmacView.setPaisOidPais((es.indra.belcorp.mso.SegPaisViewData)
			getSingleObject(BUSINESSID_PAISOIDPAIS_QUERY, 
			belTipoMovimAlmacView.getPaisOidPais(),
			belTipoMovimAlmacView.getPaisOidPais().clone(),
			"segPaisView"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(belTipoMovimAlmacView);
		loadLeafDependenceCombos(belTipoMovimAlmacView);
	}
