...
public class contenido_historial_credito_cliente_obtener  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_historial_credito_cliente_obtener" );
      ...
      v.add(doc.createTextNode("\r   \r   \r   function onLoad(){\r      configurarMenuSecundario('Formulario');\r      fMostrarMensajeError();\r      focaliza('Formulario.txtCliente');\r   }\r   function generar(tipo){\r          if(sicc_validaciones_generales()){\r       if (tipo=='CU'){\r          var a = new Object();\r          a.accion = 'casoDeUso';        \r          a.codigoCliente= get('Formulario.txtCliente');           \r          mostrarModalSICC('CARHistorialCredito','casoDeUso', a);       \r       } else {\r         /*set('Formulario.conectorAction', 'CARHistorialCredito');       \r         set('Formulario.accion', 'generar');\r         enviaSICC('Formulario');*/\r         var a = new Object();\r         a.accion = 'generar';\r         a.codigoCliente = get('Formulario.txtCliente');     \r         mostrarModalSICC('CARHistorialCredito','generar', a);  \r        }\r      }     \r   }\r\r   function recolectarParametros(){\r      set('Formulario.codigoCliente', get('Formulario.txtCliente'));\r              \r   }\r\r   function buscarCliente(){ \r      var obj = new Object();\r\r      var whnd = mostrarModalSICC('LPBusquedaRapidaCliente','',obj);\r    \r      if(whnd==null){\r                }else{\r          var cod = whnd[1];\r                    set('Formulario.txtCliente', cod)\r      }          \r   }\r   \r   \r   function fLimpiar(){\r      focaliza('Formulario.txtCliente');\r   }\r   \r\r  function clienteOnBlur() {\r\r        var longiCod = get('Formulario.hLongCliente');\r        var elTexto  = get('Formulario.txtCliente');\r\r        if(elTexto.length!=0){\r           var faltantes = longiCod -  elTexto.length;\r           var resultCod = new String(\"\");\r           if(faltantes > 0){\r              for(var t = 0 ; t<faltantes; t++){\r                  resultCod = resultCod + \"0\";\r              }\r         }\r         resultCod = resultCod + elTexto;\r         set('Formulario.txtCliente', resultCod);\r        }\r             \r   }\r\r\r   \r  \r  "));
      ...
      ((Element)v.get(5)).setAttribute("name","txtCliente" );
      ((Element)v.get(5)).setAttribute("required","true" );
      ((Element)v.get(5)).setAttribute("cod","1471" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(31)).setAttribute("nombre","lblCriteriosSeleccion" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(43)).setAttribute("nombre","lblCliente" );
      ...
      ((Element)v.get(43)).setAttribute("cod","1471" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(50)).setAttribute("nombre","txtCliente" );
      ...
      ((Element)v.get(50)).setAttribute("size","19" );
      ((Element)v.get(50)).setAttribute("valor","" );
      ((Element)v.get(50)).setAttribute("validacion","" );
      ((Element)v.get(50)).setAttribute("onshtab","focalizaBotonHTML('botonContenido','btnGenerarCU')" );
      ((Element)v.get(50)).setAttribute("onblur","clienteOnBlur();" );
      ...
      v.add(doc.createElement("IMG"));
      ((Element)v.get(54)).setAttribute("src","iconBuscar.gif" );
      ((Element)v.get(54)).setAttribute("onclick","buscarCliente();" );
      ...
      /* Empieza nodo:57 / Elemento padre: 35   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(35)).appendChild((Element)v.get(57));
      ...
      ((Element)v.get(70)).setAttribute("ontab","focalizaBotonHTML('botonContenido','btnGenerarCU')" );
      ((Element)v.get(69)).appendChild((Element)v.get(70));
      /* Termina nodo:70   */

      /* Empieza nodo:71 / Elemento padre: 69   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(71)).setAttribute("nombre","btnGenerarCU" );
   }

   private void getXML270(Document doc) {
      ((Element)v.get(71)).setAttribute("ID","botonContenido" );
      ((Element)v.get(71)).setAttribute("tipo","html" );
      ((Element)v.get(71)).setAttribute("accion","generar('CU');" );
      ((Element)v.get(71)).setAttribute("estado","false" );
      ((Element)v.get(71)).setAttribute("cod","190" );
      ((Element)v.get(71)).setAttribute("ontab","focaliza('Formulario.txtCliente')" );
