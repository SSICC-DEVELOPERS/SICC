...
public class RECEstadisticaAnulacionesCampaana extends LPSICCBase {           
   public RECEstadisticaAnulacionesCampaana() {	 
     super();
  }
     ...
     try {
        ...
        if (accion.equals("generar")){
          ...
          //cargarPagina();
           ...
           cargarPagina();
           getConfiguracionMenu("RECEstadisticaAnulacionesCampaana");
        }
  ...
  private void cargarPagina() throws Exception{
     ...
     pagina("contenido_informe_estadistica_anulaciones_generar");
     
     asignarAtributoPagina("cod", "0909");
     asignarAtributo("VAR", "lp", "valor", "RECEstadisticaAnulacionesCampaana");
     ...
     MareBusinessID idCAT2 = new MareBusinessID("RecObtenerOperacionesAnulacion");
 ...
 private void generarReporte() throws Exception{
     ...
     datos.put(ConstantesREP.TITULO, "Estadística de Anulaciones por campaña");     
     traza("++++++Antes de enviar a reportes " + datos); 
        
     
     traza("el formaro es  " + formato);
     //ejecutarReporte(datos, "REPGenerarReporte", "RD_REP-107", formato);
