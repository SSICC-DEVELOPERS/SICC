...
public class CalMotivContaPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","CalMotivConta.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","CalMotivConta.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('calMotivContaFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('calMotivContaFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(50)).setAttribute("nombre","codMotiTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lblCodMoti" );
      ((Element)v.get(54)).setAttribute("alto","13" );
      ((Element)v.get(54)).setAttribute("filas","1" );
      ((Element)v.get(54)).setAttribute("id","datosTitle" );
      ((Element)v.get(54)).setAttribute("cod","CalMotivConta.codMoti.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(55)).setAttribute("nombre","codMotiWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(57)).setAttribute("nombre","codMoti" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('calMotivContaFrm',2, true)" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('calMotivContaFrm', 2, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(58)).setAttribute("nombre","codMotiGapTdId" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(64)).setAttribute("cod","CalMotivConta.Descripcion.label" );
      ...
      ((Element)v.get(68)).setAttribute("ontab","ejecutarAccionFoco('calMotivContaFrm',3, true)" );
      ((Element)v.get(68)).setAttribute("onshtab","ejecutarAccionFoco('calMotivContaFrm', 3, false)" );
      ...
      ((Element)v.get(72)).setAttribute("href","javascript:openLocalizationDialog('calMotivContaFrm', 'Descripcion', 1);" );
      ((Element)v.get(72)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"calMotivContaFrm\",3, true)', 'ejecutarAccionFoco(\"calMotivContaFrm\",3, false)')" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(80)).setAttribute("cod","CalMotivConta.codProc.label" );
      ...
      ((Element)v.get(83)).setAttribute("ontab","ejecutarAccionFoco('calMotivContaFrm',4, true)" );
      ((Element)v.get(83)).setAttribute("onshtab","ejecutarAccionFoco('calMotivContaFrm', 4, false)" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(98)).setAttribute("nombre","calMotivContaTrButtons" );
      ...
      ((Element)v.get(105)).setAttribute("nombre","calMotivContaTdQueryButton" );
      ((Element)v.get(104)).appendChild((Element)v.get(105));

      /* Empieza nodo:106 / Elemento padre: 105   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(106)).setAttribute("nombre","calMotivContaQueryButton" );
      ((Element)v.get(106)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(106)).setAttribute("estado","false" );
      ((Element)v.get(106)).setAttribute("accion","calMotivContaFirstPage();" );
      ...
      ((Element)v.get(107)).setAttribute("nombre","calMotivContaTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(109)).setAttribute("nombre","calMotivContaLovNullButton" );
      ((Element)v.get(109)).setAttribute("ID","botonContenido" );
      ((Element)v.get(109)).setAttribute("tipo","html" );
      ((Element)v.get(109)).setAttribute("accion","calMotivContaLovNullSelectionAction();" );
