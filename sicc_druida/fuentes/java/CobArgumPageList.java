...
public class CobArgumPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","cobArgumList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","CobArgum.codArgu.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","CobArgum.valDesc.label" );
