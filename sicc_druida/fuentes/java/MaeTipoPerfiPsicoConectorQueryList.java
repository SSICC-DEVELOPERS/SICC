...
public class MaeTipoPerfiPsicoConectorQueryList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad MaeTipoPerfiPsico" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGMaeTipoPerfiPsicoQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGMaeTipoPerfiPsicoQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","MaeTipoPerfiPsicoListFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","codTipoPerfPsic" );
