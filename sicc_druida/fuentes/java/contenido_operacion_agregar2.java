...
public class contenido_operacion_agregar2  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","contenido_operacion_agregar2.js" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(16)).setAttribute("nombre","numSecuencial" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(17)).setAttribute("nombre","oidOperacion" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(18)).setAttribute("nombre","oidTipoOperacion" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(20)).setAttribute("nombre","oidClientePerdida" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(21)).setAttribute("nombre","oidAsumePerdida" );
   ...
   private void getXML90(Document doc) {
      v.add(doc.createElement("VAR"));
      ((Element)v.get(22)).setAttribute("nombre","oidPrecioCalcula" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(23)).setAttribute("nombre","oidPorcentaje" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(24)).setAttribute("nombre","oidProducto" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(25)).setAttribute("nombre","oidClienteSeguro" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(26)).setAttribute("nombre","importe" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(27)).setAttribute("nombre","existeOperacion" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(28)).setAttribute("nombre","indAnulacion" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(29)).setAttribute("nombre","hIngresaDevuelve" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(30)).setAttribute("nombre","hIngresaEnvia" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(31)).setAttribute("nombre","hEnviaGeneraDevuelve" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(32)).setAttribute("nombre","hDevuelveGeneraEnvia" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(33)).setAttribute("nombre","hDevuelveFisicoFactura" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(34)).setAttribute("nombre","hDevuelveFactura" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(35)).setAttribute("nombre","hEnviaFactura" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(36)).setAttribute("nombre","hAnulacion" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(37)).setAttribute("nombre","hPerdida" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(38)).setAttribute("nombre","sChequeoFisico" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(39)).setAttribute("nombre","sPrecioEnvia" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(40)).setAttribute("nombre","constantesAsumeCliente" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(41)).setAttribute("nombre","constantesPrecioPerdida" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(42)).setAttribute("nombre","hListaLineasOperacion" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(43)).setAttribute("name","hStrLineasPosiciones" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(44)).setAttribute("name","hOidMotivoBloqueo" );
   }
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(45)).setAttribute("name","hOidEstadoOperacion" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(46)).setAttribute("name","hTipoBloqueo" );
      ...
      ((Element)v.get(47)).setAttribute("alto","100%" );
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(66)).setAttribute("width","754" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(74)).setAttribute("nombre","lblNumSecOper" );
      ...
      ((Element)v.get(74)).setAttribute("cod","374" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(78)).setAttribute("nombre","lblCodOper" );
      ...
      ((Element)v.get(78)).setAttribute("cod","299" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(82)).setAttribute("nombre","lblCodTipoOper" );
      ...
      ((Element)v.get(82)).setAttribute("cod","301" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(86)).setAttribute("nombre","lblMotivoBloq" );
      ...
      ((Element)v.get(86)).setAttribute("cod","379" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(92)).setAttribute("valign","bottom" );
      ((Element)v.get(89)).appendChild((Element)v.get(92));

      /* Empieza nodo:93 / Elemento padre: 92   */
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(93)).setAttribute("nombre","lblNumSecOperX" );
      ...
      ((Element)v.get(97)).setAttribute("nombre","cbCodOper" );
      ...
      ((Element)v.get(97)).setAttribute("onshtab","" );
      ((Element)v.get(97)).setAttribute("onchange","onChangeCodigoOperacion();" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(102)).setAttribute("nombre","cbCodTipoOper" );
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(106)).setAttribute("valign","bottom" );
      ((Element)v.get(89)).appendChild((Element)v.get(106));

      /* Empieza nodo:107 / Elemento padre: 106   */
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(107)).setAttribute("nombre","cbMotivoBloq" );
      ...
      /* Empieza nodo:111 / Elemento padre: 66   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(66)).appendChild((Element)v.get(111));
   ...
   private void getXML450(Document doc) {
      ...
      /* Empieza nodo:114 / Elemento padre: 56   */
      v.add(doc.createElement("td"));
      ((Element)v.get(56)).appendChild((Element)v.get(114));
      ...
      /* Empieza nodo:116 / Elemento padre: 48   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(48)).appendChild((Element)v.get(116));
      ...
      ((Element)v.get(124)).setAttribute("nombre","btnAceptar" );
      ((Element)v.get(124)).setAttribute("ID","botonContenido" );
      ((Element)v.get(124)).setAttribute("tipo","html" );
      ((Element)v.get(124)).setAttribute("accion","onClickAceptar();" );
      ((Element)v.get(124)).setAttribute("estado","false" );
      ((Element)v.get(124)).setAttribute("cod","12" );
      ...
      /* Empieza nodo:127 / Elemento padre: 48   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(48)).appendChild((Element)v.get(127));
      ...
      ((Element)v.get(134)).setAttribute("nombre","listado1" );
      ((Element)v.get(134)).setAttribute("ancho","758" );
      ((Element)v.get(134)).setAttribute("alto","317" );
      ((Element)v.get(134)).setAttribute("x","12" );
      ((Element)v.get(134)).setAttribute("y","126" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(142)).setAttribute("cod","00293" );
   ...
   private void getXML630(Document doc) {
      ...
      /* Empieza nodo:158 / Elemento padre: 144   */
      v.add(doc.createElement("COL"));
      ...
      ((Element)v.get(144)).appendChild((Element)v.get(158));
      /* Termina nodo:158   */
      ...
      /* Empieza nodo:160 / Elemento padre: 144   */
      v.add(doc.createElement("COL"));
      ...
      ((Element)v.get(144)).appendChild((Element)v.get(160));
      /* Termina nodo:160   */
      ...
      ((Element)v.get(166)).setAttribute("cod","402" );
      ...
      ((Element)v.get(167)).setAttribute("cod","304" );
   ...
   private void getXML720(Document doc) {
      ...
      ((Element)v.get(169)).setAttribute("cod","337" );
      ...
      ((Element)v.get(171)).setAttribute("cod","408" );
      ...
      ((Element)v.get(173)).setAttribute("cod","340" );
      ...
      ((Element)v.get(174)).setAttribute("cod","307" );
      ...
      ((Element)v.get(175)).setAttribute("cod","308" );
      ...
      ((Element)v.get(176)).setAttribute("cod","309" );
      ...
      ((Element)v.get(177)).setAttribute("cod","309" );
      ...
      ((Element)v.get(178)).setAttribute("cod","309" );
      ((Element)v.get(165)).appendChild((Element)v.get(178));
      /* Termina nodo:178   */

      /* Empieza nodo:179 / Elemento padre: 165   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(179)).setAttribute("colFondo","" );
      ((Element)v.get(179)).setAttribute("ID","EstCab" );
      ((Element)v.get(179)).setAttribute("cod","309" );
      ((Element)v.get(165)).appendChild((Element)v.get(179));
      /* Termina nodo:179   */
      ...
      ((Element)v.get(180)).setAttribute("cod","309" );
      ...
      ((Element)v.get(181)).setAttribute("cod","309" );
      ...
      ((Element)v.get(182)).setAttribute("cod","309" );
      ((Element)v.get(165)).appendChild((Element)v.get(182));
      /* Termina nodo:182   */

      /* Empieza nodo:183 / Elemento padre: 165   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(183)).setAttribute("colFondo","" );
      ((Element)v.get(183)).setAttribute("ID","EstCab" );
      ((Element)v.get(183)).setAttribute("cod","309" );
      ((Element)v.get(165)).appendChild((Element)v.get(183));
      /* Termina nodo:183   */

      /* Empieza nodo:184 / Elemento padre: 165   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(184)).setAttribute("colFondo","" );
      ((Element)v.get(184)).setAttribute("ID","EstCab" );
      ((Element)v.get(184)).setAttribute("cod","309" );
      ((Element)v.get(165)).appendChild((Element)v.get(184));
      /* Termina nodo:184   */
      ...
      ((Element)v.get(185)).setAttribute("cod","309" );
      ((Element)v.get(165)).appendChild((Element)v.get(185));
      /* Termina nodo:185   */
      /* Termina nodo:165   */

      /* Empieza nodo:186 / Elemento padre: 134   */
   ...
   private void getXML810(Document doc) {
      ...
      ((Element)v.get(134)).appendChild((Element)v.get(186));
   ...
   private void getXML900(Document doc) {
      ...
      /* Empieza nodo:207 / Elemento padre: 134   */
      v.add(doc.createElement("ROWSET"));
      ((Element)v.get(134)).appendChild((Element)v.get(207));
      /* Termina nodo:207   */

      /* Empieza nodo:208 / Elemento padre: 134   */
      v.add(doc.createElement("PAGINADO"));
      ((Element)v.get(208)).setAttribute("nombre","mipgndo" );
      ((Element)v.get(208)).setAttribute("ancho","758" );
      ((Element)v.get(208)).setAttribute("sep","$" );
      ((Element)v.get(208)).setAttribute("x","12" );
      ((Element)v.get(208)).setAttribute("class","botonera" );
      ((Element)v.get(208)).setAttribute("y","420" );
      ((Element)v.get(208)).setAttribute("control","|" );
      ((Element)v.get(208)).setAttribute("conector","" );
      ((Element)v.get(208)).setAttribute("rowset","" );
      ((Element)v.get(208)).setAttribute("cargainicial","N" );
      ((Element)v.get(208)).setAttribute("onload","procesarPaginado(mipgndo,msgError, ultima, rowset, 'muestraLista(ultima,rowset,error)');" );
      ((Element)v.get(134)).appendChild((Element)v.get(208));

      /* Empieza nodo:209 / Elemento padre: 208   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(209)).setAttribute("nombre","ret1" );
      ((Element)v.get(209)).setAttribute("x","37" );
      ((Element)v.get(209)).setAttribute("y","424" );
      ...
      ((Element)v.get(210)).setAttribute("y","424" );
      ...
      ((Element)v.get(211)).setAttribute("y","424" );
      ...
      ((Element)v.get(212)).setAttribute("y","420" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(213)).setAttribute("nombre","BuscarProd" );
      ((Element)v.get(213)).setAttribute("x","80" );
      ((Element)v.get(213)).setAttribute("y","421" );
      ...
      ((Element)v.get(213)).setAttribute("cod","445" );
      ((Element)v.get(213)).setAttribute("ontab","" );
      ((Element)v.get(213)).setAttribute("onshtab","" );
      ((Element)v.get(213)).setAttribute("accion","onClickBuscarProducto();" );
      ((Element)v.get(8)).appendChild((Element)v.get(213));
      /* Termina nodo:213   */

      /* Empieza nodo:214 / Elemento padre: 8   */
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(214)).setAttribute("nombre","capa1" );
      ((Element)v.get(214)).setAttribute("alto","50" );
      ((Element)v.get(214)).setAttribute("ancho","450" );
      ...
      ((Element)v.get(214)).setAttribute("visibilidad","O" );
      ((Element)v.get(214)).setAttribute("contravsb","" );
      ((Element)v.get(214)).setAttribute("x","300" );
      ((Element)v.get(214)).setAttribute("y","424" );
      ((Element)v.get(214)).setAttribute("zindex","" );
   }

   private void getXML990(Document doc) {
      ((Element)v.get(8)).appendChild((Element)v.get(214));
      ...
      ((Element)v.get(215)).setAttribute("align","right" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(223)).setAttribute("nombre","lblImporteCabeceraDevolver" );
      ...
      ((Element)v.get(223)).setAttribute("cod","3032" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(227)).setAttribute("nombre","lbldtImporteCabeceraDevolver" );
      ...
      v.add(doc.createElement("MATRIZJS"));
      ((Element)v.get(233)).setAttribute("nombre","lsOperacion" );
      ...
      /* Empieza nodo:235 / Elemento padre: 8   */
      v.add(doc.createElement("MATRIZJS"));
      ((Element)v.get(235)).setAttribute("nombre","lstOperacionesPerdida" );
      ((Element)v.get(8)).appendChild((Element)v.get(235));
