...
public class CRAEstructuraFacturacion extends LPSICCBase {           
   public CRAEstructuraFacturacion() {	 
     super();
  }
     ...
     try {
        ...
        if (accion.equals("generar")){
          ...
          //cargarPagina();
           ...
           cargarPagina();
           getConfiguracionMenu("CRAEstructuraFacturacion");
        }
  ...
  private void cargarPagina() throws Exception{
      pagina("contenido_informe_estructura_facturacion_generar");   
     ...
     //cargo la lista oculta de accesos
     //SEGObtenerAccesosSinFiltro 
      DTOOID dtoOid = new DTOOID();
      
      dtoOid.setOidIdioma(UtilidadesSession.getIdioma(this));
     
      DruidaConector conectorRecargaAcceso = null;
      MareBusinessID bId = new MareBusinessID("SEGObtenerAccesosSinFiltro");
      ...
      DTOSalida dtoSal = (DTOSalida) conectar("ConectorRecargaAccesos",vec).objeto("dtoSalida"); 
         
      RecordSet acceso = (RecordSet)dtoSal.getResultado();
      Vector colAcceso = acceso.getColumnIdentifiers();
      DruidaConector accesos = generarConector("DTOSalida.zonas_ROWSET",acceso, colAcceso);
      traza("accesos "+dtoSal.getResultado());
      traza("accesos "+dtoSal.getResultado().getColumnIdentifiers());
      this.crearListaLP(colAcceso, acceso.getColumnCount(), "Capa1","Lista1", "14", "200");
      asignar("LISTA", "Lista1", accesos, "DTOSalida.zonas_ROWSET");  
 ...
 private void generarReporte() throws Exception{
     ...
     datos.put(ConstantesREP.TITULO, "Estructura de facturacion");
        
     traza("++++++Antes de enviar a reportes " + datos); 
     //ejecutarReporte(datos, "REPGenerarReporte", "RD_REP-002", null);
     ejecutarReporte2(datos, "REPGenerarReporteBatch", "RD_REP-002", "pdf");
