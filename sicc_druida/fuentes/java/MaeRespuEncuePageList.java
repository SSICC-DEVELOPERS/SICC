...
public class MaeRespuEncuePageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","maeRespuEncueList" );
      ...
      ((Element)v.get(14)).setAttribute("cod","MaeRespuEncue.prenOidPreg.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","MaeRespuEncue.codResp.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","MaeRespuEncue.valPeso.label" );
