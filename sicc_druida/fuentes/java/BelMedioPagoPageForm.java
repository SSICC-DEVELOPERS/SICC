...
public class BelMedioPagoPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","BelMedioPago.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","BelMedioPago.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('belMedioPagoFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('belMedioPagoFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(54)).setAttribute("cod","BelMedioPago.paisOidPais.label" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('belMedioPagoFrm',2, true);" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('belMedioPagoFrm',2, false);" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(61)).setAttribute("nombre","codMediPagoTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(66)).setAttribute("nombre","codMediPagoWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(68)).setAttribute("nombre","codMediPago" );
      ...
      ((Element)v.get(68)).setAttribute("ontab","ejecutarAccionFoco('belMedioPagoFrm',3, true)" );
      ((Element)v.get(68)).setAttribute("onshtab","ejecutarAccionFoco('belMedioPagoFrm', 3, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(69)).setAttribute("nombre","codMediPagoGapTdId" );
      ...
      ((Element)v.get(75)).setAttribute("cod","BelMedioPago.Descripcion.label" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(79)).setAttribute("ontab","ejecutarAccionFoco('belMedioPagoFrm',4, true)" );
      ((Element)v.get(79)).setAttribute("onshtab","ejecutarAccionFoco('belMedioPagoFrm', 4, false)" );
      ...
      ((Element)v.get(83)).setAttribute("href","javascript:openLocalizationDialog('belMedioPagoFrm', 'Descripcion', 1);" );
      ((Element)v.get(83)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"belMedioPagoFrm\",4, true)', 'ejecutarAccionFoco(\"belMedioPagoFrm\",4, false)')" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(87)).setAttribute("nombre","tmepOidTipoMediPagoTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(91)).setAttribute("nombre","lbltmepOidTipoMediPago" );
      ((Element)v.get(91)).setAttribute("id","datosTitle" );
      ((Element)v.get(91)).setAttribute("ancho","150" );
      ((Element)v.get(91)).setAttribute("alto","13" );
      ((Element)v.get(91)).setAttribute("cod","BelMedioPago.tmepOidTipoMediPago.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(92)).setAttribute("nombre","tmepOidTipoMediPagoWidgetTrId" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(94)).setAttribute("nombre","tmepOidTipoMediPago" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(94)).setAttribute("ontab","ejecutarAccionFoco('belMedioPagoFrm',5, true);" );
      ((Element)v.get(94)).setAttribute("onshtab","ejecutarAccionFoco('belMedioPagoFrm',5, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(96)).setAttribute("nombre","tmepOidTipoMediPagoGapTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(110)).setAttribute("nombre","belMedioPagoTrButtons" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(117)).setAttribute("nombre","belMedioPagoTdQueryButton" );
      ((Element)v.get(116)).appendChild((Element)v.get(117));

      /* Empieza nodo:118 / Elemento padre: 117   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(118)).setAttribute("nombre","belMedioPagoQueryButton" );
      ((Element)v.get(118)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(118)).setAttribute("estado","false" );
      ((Element)v.get(118)).setAttribute("accion","belMedioPagoFirstPage();" );
      ...
      ((Element)v.get(119)).setAttribute("nombre","belMedioPagoTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(121)).setAttribute("nombre","belMedioPagoLovNullButton" );
      ((Element)v.get(121)).setAttribute("ID","botonContenido" );
      ((Element)v.get(121)).setAttribute("tipo","html" );
      ((Element)v.get(121)).setAttribute("accion","belMedioPagoLovNullSelectionAction();" );
