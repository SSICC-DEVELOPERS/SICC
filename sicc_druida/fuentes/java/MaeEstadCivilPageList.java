...
public class MaeEstadCivilPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","maeEstadCivilList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","MaeEstadCivil.codEstaCivi.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","MaeEstadCivil.Descripcion.label" );
