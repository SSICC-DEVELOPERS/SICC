...
public class BelParamBelcePageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","belParamBelceList" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(36)).setAttribute("height","20" );
      ...
      ((Element)v.get(37)).setAttribute("cod","BelParamBelce.sbacOidSbac.label" );
      ...
      ((Element)v.get(38)).setAttribute("cod","BelParamBelce.valDire.label" );
      ...
      ((Element)v.get(39)).setAttribute("cod","BelParamBelce.valTfno.label" );
      ...
      ((Element)v.get(40)).setAttribute("cod","BelParamBelce.valMontMaxiDife.label" );
      ...
      ((Element)v.get(41)).setAttribute("cod","BelParamBelce.valLimiEfecCaja.label" );
      ...
      ((Element)v.get(42)).setAttribute("cod","BelParamBelce.numCaja.label" );
      ...
      ((Element)v.get(43)).setAttribute("cod","BelParamBelce.valNombLoca.label" );
      ...
      ((Element)v.get(44)).setAttribute("cod","BelParamBelce.valTiempRepo.label" );
      ...
      ((Element)v.get(45)).setAttribute("cod","BelParamBelce.valFactLoca.label" );
      ...
      ((Element)v.get(46)).setAttribute("cod","BelParamBelce.numMaxiProd.label" );
      ...
      ((Element)v.get(47)).setAttribute("cod","BelParamBelce.valAlerStoc.label" );
      ...
      ((Element)v.get(48)).setAttribute("cod","BelParamBelce.valUsua.label" );
      ...
      ((Element)v.get(49)).setAttribute("cod","BelParamBelce.clieOidClie.label" );
      ...
      ((Element)v.get(50)).setAttribute("cod","BelParamBelce.sociOidSoci.label" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(51)).setAttribute("cod","BelParamBelce.ttraOidTipoTran.label" );
      ...
      ((Element)v.get(52)).setAttribute("cod","BelParamBelce.ccbaOidCuenCorrBanc.label" );
      ...
      ((Element)v.get(53)).setAttribute("cod","BelParamBelce.tmvcOidCobr.label" );
      ...
      ((Element)v.get(54)).setAttribute("cod","BelParamBelce.tmvcOidCier.label" );
      ...
      ((Element)v.get(55)).setAttribute("cod","BelParamBelce.tmalOidConfStoc.label" );
      ...
      ((Element)v.get(56)).setAttribute("cod","BelParamBelce.tmalOidConfStocTran.label" );
      ...
      ((Element)v.get(57)).setAttribute("cod","BelParamBelce.tmalOidStocTran.label" );
      ...
      ((Element)v.get(58)).setAttribute("cod","BelParamBelce.tmalOidStocDevo.label" );
      ...
      ((Element)v.get(59)).setAttribute("cod","BelParamBelce.tmalOidRegu.label" );
      ...
      ((Element)v.get(60)).setAttribute("cod","BelParamBelce.tmalOidReguSap.label" );
      ...
      ((Element)v.get(61)).setAttribute("cod","BelParamBelce.tmalOidDevoStoc.label" );
      ...
      ((Element)v.get(62)).setAttribute("cod","BelParamBelce.tmalOidPetiExis.label" );
      ((Element)v.get(36)).appendChild((Element)v.get(62));
      /* Termina nodo:62   */
      /* Termina nodo:36   */

      /* Empieza nodo:63 / Elemento padre: 0   */
      v.add(doc.createElement("DATOS"));
      ((Element)v.get(63)).setAttribute("alto","22" );
      ((Element)v.get(63)).setAttribute("accion","" );
      ((Element)v.get(63)).setAttribute("tipoEnvio","seleccion" );
      ((Element)v.get(63)).setAttribute("formaEnvio","xml" );
      ((Element)v.get(63)).setAttribute("maxSel","1" );
      ((Element)v.get(63)).setAttribute("msgErrMaxSel","" );
      ((Element)v.get(63)).setAttribute("coloresScrollNativo","#D4D0C8,black,white,#D4D0C8,#D4D0C8,#ECE9E4,black" );
      ((Element)v.get(63)).setAttribute("colorROver","#D0D9E8" );
      ((Element)v.get(63)).setAttribute("onLoad","" );
      ((Element)v.get(63)).setAttribute("colorSelecc","#D0D9E8" );
      ((Element)v.get(0)).appendChild((Element)v.get(63));
   ...
   private void getXML360(Document doc) {
      ...
      /* Empieza nodo:90 / Elemento padre: 0   */
      v.add(doc.createElement("ROWSET"));
      ((Element)v.get(0)).appendChild((Element)v.get(90));
      /* Termina nodo:90   */
