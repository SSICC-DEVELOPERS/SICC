...
public class RecMotivBloquPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","RecMotivBloqu.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","RecMotivBloqu.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('recMotivBloquFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('recMotivBloquFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(50)).setAttribute("nombre","valMotiBloqTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lblValMotiBloq" );
      ((Element)v.get(54)).setAttribute("alto","13" );
      ((Element)v.get(54)).setAttribute("filas","1" );
      ((Element)v.get(54)).setAttribute("id","datosTitle" );
      ((Element)v.get(54)).setAttribute("cod","RecMotivBloqu.valMotiBloq.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(55)).setAttribute("nombre","valMotiBloqWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(57)).setAttribute("nombre","valMotiBloq" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('recMotivBloquFrm',2, true)" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('recMotivBloquFrm', 2, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(58)).setAttribute("nombre","valMotiBloqGapTdId" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(79)).setAttribute("cod","RecMotivBloqu.paisOidPais.label" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(82)).setAttribute("ontab","ejecutarAccionFoco('recMotivBloquFrm',3, true);" );
      ((Element)v.get(82)).setAttribute("onshtab","ejecutarAccionFoco('recMotivBloquFrm',3, false);" );
      ...
      ((Element)v.get(90)).setAttribute("cod","RecMotivBloqu.Descripcion.label" );
      ...
      ((Element)v.get(94)).setAttribute("ontab","ejecutarAccionFoco('recMotivBloquFrm',4, true)" );
      ((Element)v.get(94)).setAttribute("onshtab","ejecutarAccionFoco('recMotivBloquFrm', 4, false)" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(98)).setAttribute("href","javascript:openLocalizationDialog('recMotivBloquFrm', 'Descripcion', 1);" );
      ((Element)v.get(98)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"recMotivBloquFrm\",4, true)', 'ejecutarAccionFoco(\"recMotivBloquFrm\",4, false)')" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(114)).setAttribute("nombre","recMotivBloquTrButtons" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(121)).setAttribute("nombre","recMotivBloquTdQueryButton" );
      ((Element)v.get(120)).appendChild((Element)v.get(121));

      /* Empieza nodo:122 / Elemento padre: 121   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(122)).setAttribute("nombre","recMotivBloquQueryButton" );
      ((Element)v.get(122)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(122)).setAttribute("estado","false" );
      ((Element)v.get(122)).setAttribute("accion","recMotivBloquFirstPage();" );
      ...
      ((Element)v.get(123)).setAttribute("nombre","recMotivBloquTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(125)).setAttribute("nombre","recMotivBloquLovNullButton" );
      ((Element)v.get(125)).setAttribute("ID","botonContenido" );
      ((Element)v.get(125)).setAttribute("tipo","html" );
      ((Element)v.get(125)).setAttribute("accion","recMotivBloquLovNullSelectionAction();" );
