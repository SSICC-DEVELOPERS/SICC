/*
    INDRA/CAR/mmg
    $Id: PedTipoPosicLPStartUp.java,v 1.1 2009/12/03 18:32:24 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class PedTipoPosicLPStartUp extends MMGDruidaBase{
	...
	public PedTipoPosicLPStartUp(){
		super();
	}

	public void inicio() throws Exception {
		pagina("PedTipoPosicPage");
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "PedTipoPosicPage", "cod", "PedTipoPosic." + accion + ".label");
			...
			limpiarBotoneraLista("pedTipoPosic", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codTipoPosi", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 2);");
		...
		//asignarAtributo("CAPA", "pedTipoPosicLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "PedTipoPosicPage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("PedTipoPosicLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		PedTipoPosicData pedTipoPosicQuery= new PedTipoPosicData();
		pedTipoPosicQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		PedTipoPosicData datosResult = (PedTipoPosicData)getSingleObject(BUSINESSID_QUERY, pedTipoPosicQuery, 
			pedTipoPosicQuery.clone(), "pedTipoPosic");
		...
		preservaHiddensI18n(new Integer(1), "PED_TIPO_POSIC", "pedTipoPosicFrm", "Descripcion", true);
		...
		PedTipoPosicData pedTipoPosic = datosResult;
		asignar("TEXT", "codTipoPosi", FormatUtils.formatObject(pedTipoPosic.getCodTipoPosi(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "Descripcion", FormatUtils.formatObject(pedTipoPosic.getDescripcion(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignarAtributo("CHECKBOX", "indDemaNorm" , "check", FormatUtils.formatObject(
			pedTipoPosic.getIndDemaNorm(), 
		...
		loadLocalizationVars(pedTipoPosic);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "codTipoPosi", "disabled", "S");
		asignarAtributo("TEXT", "Descripcion", "disabled", "S");
		
					asignarAtributo("CHECKBOX", "indDemaNorm", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "PED_TIPO_POSIC", "pedTipoPosicFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "codTipoPosi", "req", "S");
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('pedTipoPosicFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "pedTipoPosicFrm", "oculto", "N");
		...
		traza("MMG::Creando PedTipoPosic");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		PedTipoPosicData pedTipoPosicQuery= new PedTipoPosicData();
		pedTipoPosicQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(pedTipoPosic.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"pedTipoPosicFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"pedTipoPosicFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codTipoPosi", "ontab","ejecutarAccionFocoModificacion(\"pedTipoPosicFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codTipoPosi", "onshtab","ejecutarAccionFocoModificacion(\"pedTipoPosicFrm\",2, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"pedTipoPosicFrm\",3, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"pedTipoPosicFrm\",3, false)");
				asignarAtributo("TEXT", "indDemaNorm", "ontab","ejecutarAccionFocoModificacion(\"pedTipoPosicFrm\",4, true)");
				asignarAtributo("TEXT", "indDemaNorm", "onshtab","ejecutarAccionFocoModificacion(\"pedTipoPosicFrm\",4, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","pedTipoPosicTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","pedTipoPosicTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","pedTipoPosicFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","pedTipoPosicListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","pedTipoPosicListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(PedTipoPosicData pedTipoPosic) throws Exception{
	...
	* @param pedTipoPosic La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(PedTipoPosicData pedTipoPosic) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		PedTipoPosicData pedTipoPosic = 
			(PedTipoPosicData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(pedTipoPosic);
		loadLeafDependenceCombos(pedTipoPosic);
	}
	...
	*/
	...
	protected void loadLocalizationVars(PedTipoPosicData pedTipoPosic) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("PED_TIPO_POSIC");
		mmgLocalizationQuery.setEntiPk(pedTipoPosic.getId());
