...
public class contenido_estrategia_modificar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_estrategia_modificar" );
      ((Element)v.get(0)).setAttribute("cod","0780" );
      ...
      v.add(doc.createTextNode("    \r  \r    function onLoadPag() {          \r        fMostrarMensajeError();\r        configurarMenuSecundario(\"formulario\");\r        DrdEnsanchaConMargenDcho('listado1',12); \r        eval (ON_RSZ);   \r        ocultarLista();\r        focaliza('formulario.txtCodEstrategia','');\r        if(get('formulario.opcionMenu')=='Eliminar'){\r            btnProxy(4, '0');\r        }\r            \r    }   \r\r	function ocultarLista() {\r        document.all[\"Cplistado1\"].style.visibility='hidden'; \r        document.all[\"CpLin1listado1\"].style.visibility='hidden';  \r        document.all[\"CpLin2listado1\"].style.visibility='hidden'; \r        document.all[\"CpLin3listado1\"].style.visibility='hidden';\r        document.all[\"CpLin4listado1\"].style.visibility='hidden';  \r        document.all[\"primera1Div\"].style.visibility='hidden'; \r        document.all[\"ret1Div\"].style.visibility='hidden';\r        document.all[\"ava1Div\"].style.visibility='hidden';  \r        document.all[\"separaDiv\"].style.visibility='hidden'; \r        document.all[\"DetalleDiv\"].style.visibility='hidden'; \r        document.all[\"ModificarDiv\"].style.visibility='hidden'; \r        document.all[\"EliminarDiv\"].style.visibility='hidden'; \r	}\r\r	function mostrarLista() {\r        document.all[\"Cplistado1\"].style.visibility='visible'; \r        document.all[\"CpLin1listado1\"].style.visibility='visible';  \r        document.all[\"CpLin2listado1\"].style.visibility='visible'; \r        document.all[\"CpLin3listado1\"].style.visibility='visible';\r        document.all[\"CpLin4listado1\"].style.visibility='visible';  \r        document.all[\"primera1Div\"].style.visibility='visible'; \r        document.all[\"ret1Div\"].style.visibility='visible';\r        document.all[\"ava1Div\"].style.visibility='visible';  \r        document.all[\"separaDiv\"].style.visibility='visible'; \r        document.all[\"DetalleDiv\"].style.visibility='visible'; \r        document.all[\"ModificarDiv\"].style.visibility='hidden';\r        document.all[\"EliminarDiv\"].style.visibility='hidden'; \r\r  \r        if (get('formulario.opcionMenu')=='Modificar' ){\r            document.all[\"ModificarDiv\"].style.visibility='visible';\r            document.all[\"DetalleDiv\"].style.visibility='hidden';\r        }\r\r        if(get('formulario.opcionMenu')=='Eliminar'){\r            btnProxy(4, '1');\r            document.all[\"EliminarDiv\"].style.visibility='visible'; \r            document.all[\"DetalleDiv\"].style.visibility='hidden';\r            document.all[\"ModificarDiv\"].style.visibility='hidden';\r        }\r\r    }         \r\r\r	function accionBuscar() {\r		var arra = new Array();\r		var i = 0;\r\r\r          arra[i] = [\"codigo\",get('formulario.txtCodEstrategia')];\r          i++;\r\r        \r\r		if((get(\"formulario.txtDescipcion\"))!=\"\"){\r			arra[i] = [\"descripcion\",get('formulario.txtDescipcion')];\r        }\r\r		configurarPaginado(mipgndo,\"PREBusquedaEstrategias\",\"ConectorBusquedaEstrategias\",\"es.indra.sicc.dtos.pre.DTODatosEstrategia\", arra);\r        mostrarLista();\r	}\r\r  	function accionModificar(){\r        var codigos = new Array();\r		codigos = listado1.codSeleccionados();\r		var cant = codigos.length;\r        var posicion = obtenerPosicionListaEditable(listado1.codSeleccionados(),listado1);\r		set(\"formulario.hidOidMatriz\", codigos[0]);\r		\r		if (cant == 1){\r            var obj = new Object();\r			obj.hidOidMatriz=codigos[0];\r			obj.opcionMenu = \"Modificar\"\r			var salida = mostrarModalSICC('LPMantenimientoEstrategias',\"Mostrar datos\",obj);\r			accionBuscar();\r		}else	\r            GestionarMensaje('50');\r	}\r\r	function accionDetalle()	{\r        var codigos = new Array();\r		codigos = listado1.codSeleccionados();\r		var cant = codigos.length;\r        var posicion = obtenerPosicionListaEditable(listado1.codSeleccionados(),listado1);\r		set(\"formulario.hidOidMatriz\", codigos[0]);\r		\r		if (cant == 1)	{\r            var obj = new Object();\r			obj.hidOidMatriz=codigos[0];\r			obj.opcionMenu = \"Consultar\"\r			mostrarModalSICC('LPMantenimientoEstrategias',\"Mostrar datos\",obj);\r		}else{	\r            GestionarMensaje('50');\r        }\r	}\r\r  function fBorrar(){\r      accionEliminar();\r  }\r\r	function accionEliminar()	{\r      if (listado1.codSeleccionados().length > 0){\r          var arr = new Array();\r          arr = listado1.codSeleccionados();\r          eliminarFilas(arr,\"PREEliminarEstrategia\", mipgndo);\r      }else{\r          GestionarMensaje('4');\r          return;\r      }\r	}\r\r	function fVolver(){\r		window.close();\r	} \r\r    function tabularTXTHasta(tipo){\r        document.selection.empty();\r        if (tipo=='tab'){\r            focaliza('formulario.txtCodEstrategia','');\r        }else \r        if (tipo=='shtab'){\r            focalizaBotonHTML('botonContenido','btnBuscar');\r        }\r    }   \r\rfunction muestraLista( ultima, rowset){\r	var tamano = rowset.length;\r	if (tamano > 0) {\r		mostrarLista();\r		eval (ON_RSZ);\r		focaliza(\"formulario.txtCodEstrategia\");\r		return true;\r	} else {\r		ocultarLista();\r		focaliza(\"formulario.txtCodEstrategia\");\r		return false;\r	}\r}\r        \r    function fLimpiar(){\r        focaliza('formulario.txtCodEstrategia');\r    }\r\r\r     \r"));
      ...
      ((Element)v.get(11)).setAttribute("valor","LPMantenimientoEstrategias" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(13)).setAttribute("nombre","hidOidMatriz" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(36)).setAttribute("width","500" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(44)).setAttribute("nombre","lblCodEstrategia" );
      ...
      ((Element)v.get(44)).setAttribute("cod","2592" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(48)).setAttribute("nombre","lblDescripcion" );
   }
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(48)).setAttribute("cod","9" );
      ...
      /* Empieza nodo:65 / Elemento padre: 26   */
      v.add(doc.createElement("td"));
      ((Element)v.get(26)).appendChild((Element)v.get(65));
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(75)).setAttribute("nombre","btnBuscar" );
      ((Element)v.get(75)).setAttribute("ID","botonContenido" );
      ((Element)v.get(75)).setAttribute("tipo","html" );
      ((Element)v.get(75)).setAttribute("accion","accionBuscar();" );
      ((Element)v.get(75)).setAttribute("estado","false" );
      ((Element)v.get(75)).setAttribute("cod","1" );
      ((Element)v.get(75)).setAttribute("ontab","tabularTXTHasta('tab')" );
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(81)).setAttribute("width","750" );
      ...
      ((Element)v.get(85)).setAttribute("nombre","listado1" );
      ((Element)v.get(85)).setAttribute("ancho","503" );
      ((Element)v.get(85)).setAttribute("alto","299" );
      ((Element)v.get(85)).setAttribute("x","12" );
      ((Element)v.get(85)).setAttribute("y","124" );
      ((Element)v.get(85)).setAttribute("colorFondo","#CECFCE" );
      ((Element)v.get(85)).setAttribute("msgDebugJS","S" );
      ((Element)v.get(6)).appendChild((Element)v.get(85));

      /* Empieza nodo:86 / Elemento padre: 85   */
      v.add(doc.createElement("IMGBOTONES"));
      ((Element)v.get(86)).setAttribute("precarga","S" );
      ((Element)v.get(86)).setAttribute("conROver","S" );
      ((Element)v.get(85)).appendChild((Element)v.get(86));

      /* Empieza nodo:87 / Elemento padre: 86   */
      v.add(doc.createElement("BTNSELECCION"));
      ((Element)v.get(87)).setAttribute("normal","btnLista2N.gif" );
      ((Element)v.get(87)).setAttribute("rollOver","btnLista2S.gif" );
      ((Element)v.get(87)).setAttribute("seleccionado","btnLista2M.gif" );
      ((Element)v.get(87)).setAttribute("desactivado","btnLista2D.gif" );
      ((Element)v.get(86)).appendChild((Element)v.get(87));
      /* Termina nodo:87   */

      /* Empieza nodo:88 / Elemento padre: 86   */
      v.add(doc.createElement("BTNMINIMIZAR"));
      ((Element)v.get(88)).setAttribute("minimizar","bot_pliega_columna_on.gif" );
      ((Element)v.get(88)).setAttribute("minimROver","bot_pliega_columna_over.gif" );
      ((Element)v.get(88)).setAttribute("maximizar","bot_despliega_columna_on.gif" );
      ((Element)v.get(88)).setAttribute("maximROver","bot_despliega_columna_over.gif" );
      ((Element)v.get(86)).appendChild((Element)v.get(88));
      /* Termina nodo:88   */

      /* Empieza nodo:89 / Elemento padre: 86   */
      v.add(doc.createElement("BTNORDENAR"));
      ((Element)v.get(89)).setAttribute("ordenar","ascendente_on.gif" );
      ((Element)v.get(89)).setAttribute("ordenarInv","descendente_on.gif" );
      ...
      ((Element)v.get(91)).setAttribute("borde","1" );
      ((Element)v.get(91)).setAttribute("horizDatos","1" );
   }

   private void getXML360(Document doc) {
      ((Element)v.get(91)).setAttribute("horizCabecera","1" );
      ((Element)v.get(91)).setAttribute("vertical","1" );
      ((Element)v.get(91)).setAttribute("horizTitulo","1" );
      ((Element)v.get(91)).setAttribute("horizBase","1" );
      ((Element)v.get(90)).appendChild((Element)v.get(91));
      /* Termina nodo:91   */

      /* Empieza nodo:92 / Elemento padre: 90   */
      v.add(doc.createElement("COLOR"));
      ((Element)v.get(92)).setAttribute("borde","#999999" );
      ((Element)v.get(92)).setAttribute("vertCabecera","#E0E0E0" );
      ((Element)v.get(92)).setAttribute("vertDatos","#FFFFFF" );
      ((Element)v.get(92)).setAttribute("horizDatos","#FFFFFF" );
      ((Element)v.get(92)).setAttribute("horizCabecera","#999999" );
      ((Element)v.get(92)).setAttribute("horizTitulo","#999999" );
      ((Element)v.get(92)).setAttribute("horizBase","#999999" );
      ...
      ((Element)v.get(95)).setAttribute("ajustarMinimo","S" );
      ((Element)v.get(95)).setAttribute("permiteOrdenar","S" );
      ((Element)v.get(95)).setAttribute("blancosAInsertar","1" );
      ((Element)v.get(95)).setAttribute("sinSaltoLinea","S" );
      ((Element)v.get(95)).setAttribute("AnchoMinimizadas","20" );
      ((Element)v.get(95)).setAttribute("botonOrdenar","S" );
      ...
      ((Element)v.get(99)).setAttribute("alto","20" );
      ...
      ((Element)v.get(100)).setAttribute("cod","460" );
      ...
      ((Element)v.get(101)).setAttribute("cod","2592" );
      ...
      ((Element)v.get(102)).setAttribute("cod","9" );
   ...
   private void getXML450(Document doc) {
      ...
      /* Empieza nodo:107 / Elemento padre: 85   */
      v.add(doc.createElement("ROWSET"));
      ((Element)v.get(85)).appendChild((Element)v.get(107));
      /* Termina nodo:107   */

      /* Empieza nodo:108 / Elemento padre: 85   */
      v.add(doc.createElement("PAGINADO"));
      ((Element)v.get(108)).setAttribute("nombre","mipgndo" );
      ((Element)v.get(108)).setAttribute("ancho","503" );
      ...
      ((Element)v.get(112)).setAttribute("y","400" );
      ...
      /* Empieza nodo:113 / Elemento padre: 6   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(113)).setAttribute("nombre","Modificar" );
      ((Element)v.get(113)).setAttribute("x","80" );
      ((Element)v.get(113)).setAttribute("y","401" );
      ...
      ((Element)v.get(113)).setAttribute("accion","accionModificar();" );
      ((Element)v.get(113)).setAttribute("ontab","tabularTXTHasta('tab')" );
      ((Element)v.get(6)).appendChild((Element)v.get(113));
      /* Termina nodo:113   */

      /* Empieza nodo:114 / Elemento padre: 6   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(114)).setAttribute("nombre","Detalle" );
      ...
      ((Element)v.get(114)).setAttribute("accion","accionDetalle();" );
      ((Element)v.get(114)).setAttribute("ontab","tabularTXTHasta('tab')" );
   ...
   private void getXML540(Document doc) {
      ((Element)v.get(115)).setAttribute("nombre","Eliminar" );
      ((Element)v.get(115)).setAttribute("x","80" );
      ((Element)v.get(115)).setAttribute("y","401" );
      ...
      ((Element)v.get(115)).setAttribute("cod","1254" );
      ((Element)v.get(115)).setAttribute("accion","accionEliminar(); " );
      ((Element)v.get(115)).setAttribute("ontab","tabularTXTHasta('tab')" );
      ...
      ((Element)v.get(116)).setAttribute("ancho","50" );
      ((Element)v.get(116)).setAttribute("x","0" );
      ((Element)v.get(116)).setAttribute("y","423" );
