...
public class contenido_pedidos_nofacturados_consultar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_pedidos_nofacturados_consultar" );
      ((Element)v.get(0)).setAttribute("cod","0581" );
      ((Element)v.get(0)).setAttribute("titulo","Consultar pedidos no facturados" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","contenido_pedidos_nofacturados_consultar.js" );
      ...
      ((Element)v.get(6)).setAttribute("name","cbTipoPeriodo" );
      ((Element)v.get(6)).setAttribute("required","true" );
      ((Element)v.get(6)).setAttribute("cod","132" );
   ...
   private void getXML90(Document doc) {
      v.add(doc.createElement("VAR"));
      ((Element)v.get(22)).setAttribute("nombre","indConsultoraInterna" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(23)).setAttribute("nombre","oidSubTipoCliente" );
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(43)).setAttribute("width","425" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(51)).setAttribute("nombre","lblTipoPeriodo" );
      ((Element)v.get(51)).setAttribute("alto","13" );
      ((Element)v.get(51)).setAttribute("filas","1" );
      ((Element)v.get(51)).setAttribute("valor","" );
      ((Element)v.get(51)).setAttribute("id","datosTitle" );
      ((Element)v.get(51)).setAttribute("cod","132" );
      ...
      ((Element)v.get(62)).setAttribute("nombre","cbTipoPeriodo" );
      ...
      ((Element)v.get(62)).setAttribute("onchange","onSeleccionaTipoPeriodo();" );
      ((Element)v.get(62)).setAttribute("onshtab","focalizaOnshTabCombo();" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(67)).setAttribute("nombre","cbPeriodo" );
   ...
   private void getXML270(Document doc) {
      ...
      /* Empieza nodo:76 / Elemento padre: 25   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(25)).appendChild((Element)v.get(76));
      ...
      ((Element)v.get(84)).setAttribute("accion","onClickBuscar();" );
      ((Element)v.get(84)).setAttribute("ontab","focalizaBuscarOntab();" );
      ...
      /* Empieza nodo:87 / Elemento padre: 25   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(25)).appendChild((Element)v.get(87));
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(94)).setAttribute("alto","350" );
      ...
      ((Element)v.get(94)).setAttribute("visibilidad","hidden" );
      ((Element)v.get(94)).setAttribute("contravsb","" );
      ((Element)v.get(94)).setAttribute("x","0" );
      ((Element)v.get(94)).setAttribute("y","125" );
      ...
      ((Element)v.get(95)).setAttribute("ancho","429" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(114)).setAttribute("cod","424" );
      ...
      ((Element)v.get(115)).setAttribute("cod","814" );
      ...
      ((Element)v.get(116)).setAttribute("cod","1423" );
      ...
      ((Element)v.get(117)).setAttribute("cod","1402" );
      ...
      ((Element)v.get(118)).setAttribute("cod","1400" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(127)).setAttribute("ancho","429" );
      ...
      ((Element)v.get(128)).setAttribute("y","298" );
      ...
      ((Element)v.get(129)).setAttribute("y","298" );
      ...
      ((Element)v.get(94)).appendChild((Element)v.get(130));
      /* Termina nodo:130   */

      /* Empieza nodo:131 / Elemento padre: 94   */
      v.add(doc.createElement("BOTON"));
      ...
      ((Element)v.get(94)).appendChild((Element)v.get(131));
      /* Termina nodo:131   */
      ...
      ((Element)v.get(132)).setAttribute("y","295" );
      ...
      ((Element)v.get(132)).setAttribute("ontab","focalizaOnTab();" );
      ((Element)v.get(132)).setAttribute("onshtab","document.all['btnBuscar'].focus();" );
      ((Element)v.get(132)).setAttribute("accion","onClickbtnDetalle();" );
   ...
   private void getXML630(Document doc) {
      ...
      ((Element)v.get(133)).setAttribute("y","442" );
