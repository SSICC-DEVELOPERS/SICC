...
public class PreCicloVidaPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","preCicloVidaList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","PreCicloVida.codCiclVida.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","PreCicloVida.Descripcion.label" );
