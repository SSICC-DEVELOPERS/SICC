...
/*
    INDRA/CAR/mmg
    $Id: MaeCriteBusquListFormatter.java,v 1.1 2009/12/03 18:41:03 pecbazalar Exp $
    DESC
*/
 ...
 * @author Indra
 */
public class MaeCriteBusquListFormatter extends MMGDruidaFormatoObjeto {
	
	public MaeCriteBusquListFormatter() {
	}
	...
	public void formatea(String s, Object obj) throws Exception {
		...
		for (int i = 0; i < maeCriteBusquList.size(); i++) {
			...
			row.add((maeCriteBusquData.getAtreOidAtriEsp1() != null ? 
				FormatUtils.formatObject(maeCriteBusquData.getAtreOidAtriEsp1(), 
