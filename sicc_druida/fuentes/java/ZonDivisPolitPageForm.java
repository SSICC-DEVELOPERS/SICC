...
public class ZonDivisPolitPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","ZonDivisPolit.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","ZonDivisPolit.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('zonDivisPolitFrm',0, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('zonDivisPolitFrm', 0, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(53)).setAttribute("nombre","codDiviPoliTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(58)).setAttribute("nombre","codDiviPoliWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(60)).setAttribute("nombre","codDiviPoli" );
      ((Element)v.get(60)).setAttribute("id","datosCampos" );
      ((Element)v.get(60)).setAttribute("trim","S" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(60)).setAttribute("ontab","ejecutarAccionFoco('zonDivisPolitFrm',0, true)" );
      ((Element)v.get(60)).setAttribute("onshtab","ejecutarAccionFoco('zonDivisPolitFrm', 0, false)" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(61)).setAttribute("nombre","codDiviPoliViewLabelTrId" );
      ((Element)v.get(54)).appendChild((Element)v.get(61));

      /* Empieza nodo:62 / Elemento padre: 61   */
      v.add(doc.createElement("TD"));
      ((Element)v.get(62)).setAttribute("valign","top" );
      ((Element)v.get(62)).setAttribute("height","13" );
      ((Element)v.get(61)).appendChild((Element)v.get(62));

      /* Empieza nodo:63 / Elemento padre: 62   */
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(63)).setAttribute("nombre","lblViewCodDiviPoli" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(64)).setAttribute("nombre","codDiviPoliGapTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(68)).setAttribute("nombre","formGapTr1" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(75)).setAttribute("nombre","formTr2" );
   ...
   private void getXML360(Document doc) {
      v.add(doc.createElement("TD"));
      ((Element)v.get(81)).setAttribute("nombre","ordeTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(86)).setAttribute("nombre","ordeWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(88)).setAttribute("nombre","orde" );
      ((Element)v.get(88)).setAttribute("id","datosCampos" );
      ((Element)v.get(88)).setAttribute("trim","S" );
      ((Element)v.get(88)).setAttribute("max","3" );
      ((Element)v.get(88)).setAttribute("onchange","" );
      ((Element)v.get(88)).setAttribute("req","N" );
      ((Element)v.get(88)).setAttribute("size","3" );
      ((Element)v.get(88)).setAttribute("valor","" );
      ((Element)v.get(88)).setAttribute("validacion","" );
      ((Element)v.get(88)).setAttribute("onblur","" );
      ((Element)v.get(88)).setAttribute("ontab","ejecutarAccionFoco('zonDivisPolitFrm',0, true)" );
      ((Element)v.get(88)).setAttribute("onshtab","ejecutarAccionFoco('zonDivisPolitFrm', 0, false)" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(89)).setAttribute("nombre","ordeViewLabelTrId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(91)).setAttribute("nombre","lblViewOrde" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(92)).setAttribute("nombre","ordeGapTdId" );
   ...
   private void getXML450(Document doc) {
      ...
      /* Empieza nodo:106 / Elemento padre: 0   */
      v.add(doc.createElement("TR"));
      ((Element)v.get(106)).setAttribute("nombre","zonDivisPolitTrButtons" );
      ((Element)v.get(0)).appendChild((Element)v.get(106));
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(113)).setAttribute("class","tablaTitle" );
      ((Element)v.get(113)).setAttribute("nombre","zonDivisPolitTdQueryButton" );
      ((Element)v.get(112)).appendChild((Element)v.get(113));

      /* Empieza nodo:114 / Elemento padre: 113   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(114)).setAttribute("nombre","zonDivisPolitQueryButton" );
      ((Element)v.get(114)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(114)).setAttribute("estado","false" );
      ((Element)v.get(114)).setAttribute("accion","zonDivisPolitFirstPage();" );
      ...
      ((Element)v.get(115)).setAttribute("nombre","zonDivisPolitTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(117)).setAttribute("nombre","zonDivisPolitLovNullButton" );
      ((Element)v.get(117)).setAttribute("ID","botonContenido" );
      ((Element)v.get(117)).setAttribute("tipo","html" );
      ((Element)v.get(117)).setAttribute("accion","zonDivisPolitLovNullSelectionAction();" );
      ((Element)v.get(117)).setAttribute("estado","true" );
      ((Element)v.get(117)).setAttribute("cod","MMGGlobal.lovNullButton.label" );
