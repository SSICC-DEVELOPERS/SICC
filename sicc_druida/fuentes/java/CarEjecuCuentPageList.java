...
public class CarEjecuCuentPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","carEjecuCuentList" );
      ...
      ((Element)v.get(12)).setAttribute("height","20" );
      ((Element)v.get(12)).setAttribute("IDScroll","EstCab" );
      ((Element)v.get(12)).setAttribute("imgFondo","" );
      ((Element)v.get(12)).setAttribute("colFondo","#CCCCCC" );
      ...
      ((Element)v.get(13)).setAttribute("cod","CarEjecuCuent.paisOidPais.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","CarEjecuCuent.codEjecCuen.label" );
      ...
      ((Element)v.get(15)).setAttribute("cod","CarEjecuCuent.jeraOidJera.label" );
   }
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(16)).setAttribute("accion","" );
      ((Element)v.get(16)).setAttribute("tipoEnvio","seleccion" );
      ((Element)v.get(16)).setAttribute("formaEnvio","xml" );
      ((Element)v.get(16)).setAttribute("maxSel","1" );
      ((Element)v.get(16)).setAttribute("msgErrMaxSel","" );
      ((Element)v.get(16)).setAttribute("coloresScrollNativo","#D4D0C8,black,white,#D4D0C8,#D4D0C8,#ECE9E4,black" );
      ((Element)v.get(16)).setAttribute("colorROver","#D0D9E8" );
      ((Element)v.get(16)).setAttribute("onLoad","" );
      ((Element)v.get(16)).setAttribute("colorSelecc","#D0D9E8" );
      ((Element)v.get(0)).appendChild((Element)v.get(16));

      /* Empieza nodo:17 / Elemento padre: 16   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(17)).setAttribute("tipo","texto" );
      ((Element)v.get(17)).setAttribute("ID","EstDat" );
      ...
      ((Element)v.get(18)).setAttribute("ID","EstDat2" );
      ...
      ((Element)v.get(19)).setAttribute("ID","EstDat" );
