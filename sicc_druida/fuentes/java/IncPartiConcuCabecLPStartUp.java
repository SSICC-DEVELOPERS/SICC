/*
    INDRA/CAR/mmg
    $Id: IncPartiConcuCabecLPStartUp.java,v 1.1 2009/12/03 18:32:14 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class IncPartiConcuCabecLPStartUp extends MMGDruidaBase{
	...
	public static final String BUSINESSID_QUERY = "MMGIncPartiConcuCabecQueryFromToUserPage";
				...
				public static final String BUSINESSID_DIRIOIDDIRI_QUERY ="MMGIncDirigQueryFromToUser";
				public static final String DIRIOIDDIRI_COMBO_CONNECTOR = "IncDirigConectorCombo";
	...
	public IncPartiConcuCabecLPStartUp(){
		super();
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			buildJsPageSize("IncPartiConcuCabec");
			...
			asignarAtributo("PAGINA", "IncPartiConcuCabecPage", "cod", "IncPartiConcuCabec." + accion + ".label");
			...
			limpiarBotoneraLista("incPartiConcuCabec", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "valGrupClie", "validacion", "mensaje = ValidaInt(cdos_trim(valor), 5, 0, 99999);");
		
		asignarAtributo("TEXT", "desDesc", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 40);");
		
		//Primero determianmos el nombre del campo en la entidad de oriegen donde se van a cargar los datos
		asignar("VAR", "idAttributeLovOpener", conectorParametro(PARAMETRO_LOV_ATTRIBUTO));
		asignar("VAR", "idEntityLovOpener", conectorParametro(PARAMETRO_LOV_ENTIDAD));
		//asignarAtributo("CAPA", "incPartiConcuCabecLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "IncPartiConcuCabecPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		IncPartiConcuCabecData incPartiConcuCabecQuery= new IncPartiConcuCabecData();
		incPartiConcuCabecQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		IncPartiConcuCabecData datosResult = (IncPartiConcuCabecData)getSingleObject(BUSINESSID_QUERY, incPartiConcuCabecQuery, 
			incPartiConcuCabecQuery.clone(), "incPartiConcuCabec");
		...
		IncPartiConcuCabecData incPartiConcuCabec = datosResult;
		asignar("TEXT", "valGrupClie", FormatUtils.formatObject(incPartiConcuCabec.getValGrupClie(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		es.indra.belcorp.mso.IncDirigData diriOidDiri = incPartiConcuCabec.getDiriOidDiri();
		if(diriOidDiri != null && diriOidDiri.getId() != null) checkCombo("diriOidDiri" , diriOidDiri.getId().toString());
		asignar("TEXT", "desDesc", FormatUtils.formatObject(incPartiConcuCabec.getDesDesc(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		asignarAtributo("TEXT", "valGrupClie", "disabled", "S");
		
					asignarAtributo("COMBO", "diriOidDiri", "disabled", "S");asignarAtributo("TEXT", "desDesc", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		...
		asignarAtributo("COMBO", "diriOidDiri", "req", "S");
		asignarAtributo("TEXT", "desDesc", "req", "S");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "incPartiConcuCabecFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		IncPartiConcuCabecData incPartiConcuCabecQuery= new IncPartiConcuCabecData();
		incPartiConcuCabecQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(incPartiConcuCabec.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"incPartiConcuCabecFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"incPartiConcuCabecFrm\",1, false)");
				asignarAtributo("AREATEXTO", "valGrupClie", "ontab","ejecutarAccionFocoModificacion(\"incPartiConcuCabecFrm\",2, true)");
				asignarAtributo("AREATEXTO", "valGrupClie", "onshtab","ejecutarAccionFocoModificacion(\"incPartiConcuCabecFrm\",2, false)");
					asignarAtributo("COMBO","paisOidPais", "ontab", "ejecutarAccionFocoModificacion(\"incPartiConcuCabecFrm\",3, true)");
					asignarAtributo("COMBO","paisOidPais", "onshtab", "ejecutarAccionFocoModificacion(\"incPartiConcuCabecFrm\",3, false)");
					asignarAtributo("COMBO","diriOidDiri", "ontab", "ejecutarAccionFocoModificacion(\"incPartiConcuCabecFrm\",4, true)");
					asignarAtributo("COMBO","diriOidDiri", "onshtab", "ejecutarAccionFocoModificacion(\"incPartiConcuCabecFrm\",4, false)");
				asignarAtributo("AREATEXTO", "desDesc", "ontab","ejecutarAccionFocoModificacion(\"incPartiConcuCabecFrm\",5, true)");
				asignarAtributo("AREATEXTO", "desDesc", "onshtab","ejecutarAccionFocoModificacion(\"incPartiConcuCabecFrm\",5, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","incPartiConcuCabecTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","incPartiConcuCabecTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es valGrupClie...");		
				
					traza("MMG: en desactivateNonModifyFields encontrado atributo no editable...");
				
						// borrarCampo("valGrupClie");
						asignarAtributo ("TEXT", "valGrupClie", "disabled", "S");
				traza("MMG: el atributo es paisOidPais...");		
				
				traza("MMG: el atributo es diriOidDiri...");		
				
					traza("MMG: en desactivateNonModifyFields encontrado atributo no editable...");
				
						asignarAtributo("COMBO", "diriOidDiri", "disabled", "S");
				traza("MMG: el atributo es desDesc...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","incPartiConcuCabecFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","incPartiConcuCabecListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","incPartiConcuCabecListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(IncPartiConcuCabecData incPartiConcuCabec) throws Exception{
		...
		if(incPartiConcuCabec != null && incPartiConcuCabec.getPaisOidPais() != null){
				checkCombo("paisOidPais" , incPartiConcuCabec.getPaisOidPais().getId().toString());
			}
		...
		IncDirigData diriOidDiri = new IncDirigData();
		
						asignarComboResultados(BUSINESSID_DIRIOIDDIRI_QUERY,DIRIOIDDIRI_COMBO_CONNECTOR, 
			diriOidDiri, diriOidDiri.clone(), "incDirig", "diriOidDiri", "result_ROWSET" );
		if(incPartiConcuCabec != null && incPartiConcuCabec.getDiriOidDiri() != null){
				checkCombo("diriOidDiri" , incPartiConcuCabec.getDiriOidDiri().getId().toString());
			}
	...
	* @param incPartiConcuCabec La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(IncPartiConcuCabecData incPartiConcuCabec) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		IncPartiConcuCabecData incPartiConcuCabec = 
			(IncPartiConcuCabecData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(incPartiConcuCabec.getPaisOidPais() != null){
			incPartiConcuCabec.setPaisOidPais((es.indra.belcorp.mso.SegPaisViewData)
			getSingleObject(BUSINESSID_PAISOIDPAIS_QUERY, 
			incPartiConcuCabec.getPaisOidPais(),
			incPartiConcuCabec.getPaisOidPais().clone(),
			"segPaisView"));
		}
		if(incPartiConcuCabec.getDiriOidDiri() != null){
			incPartiConcuCabec.setDiriOidDiri((es.indra.belcorp.mso.IncDirigData)
			getSingleObject(BUSINESSID_DIRIOIDDIRI_QUERY, 
			incPartiConcuCabec.getDiriOidDiri(),
			incPartiConcuCabec.getDiriOidDiri().clone(),
			"incDirig"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(incPartiConcuCabec);
		loadLeafDependenceCombos(incPartiConcuCabec);
	}
