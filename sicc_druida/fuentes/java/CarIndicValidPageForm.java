...
public class CarIndicValidPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","CarIndicValid.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","CarIndicValid.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('carIndicValidFrm',0, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('carIndicValidFrm', 0, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(53)).setAttribute("nombre","codIndiValiTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(58)).setAttribute("nombre","codIndiValiWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(60)).setAttribute("nombre","codIndiVali" );
      ((Element)v.get(60)).setAttribute("id","datosCampos" );
      ((Element)v.get(60)).setAttribute("trim","S" );
      ((Element)v.get(60)).setAttribute("max","1" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(60)).setAttribute("ontab","ejecutarAccionFoco('carIndicValidFrm',0, true)" );
      ((Element)v.get(60)).setAttribute("onshtab","ejecutarAccionFoco('carIndicValidFrm', 0, false)" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(61)).setAttribute("nombre","codIndiValiViewLabelTrId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(63)).setAttribute("nombre","lblViewCodIndiVali" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(64)).setAttribute("nombre","codIndiValiGapTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(78)).setAttribute("nombre","carIndicValidTrButtons" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(85)).setAttribute("nombre","carIndicValidTdQueryButton" );
      ((Element)v.get(84)).appendChild((Element)v.get(85));

      /* Empieza nodo:86 / Elemento padre: 85   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(86)).setAttribute("nombre","carIndicValidQueryButton" );
      ((Element)v.get(86)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(86)).setAttribute("estado","false" );
      ((Element)v.get(86)).setAttribute("accion","carIndicValidFirstPage();" );
      ...
      ((Element)v.get(87)).setAttribute("nombre","carIndicValidTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(89)).setAttribute("nombre","carIndicValidLovNullButton" );
      ((Element)v.get(89)).setAttribute("ID","botonContenido" );
      ((Element)v.get(89)).setAttribute("tipo","html" );
      ((Element)v.get(89)).setAttribute("accion","carIndicValidLovNullSelectionAction();" );
