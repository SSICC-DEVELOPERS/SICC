/*
    INDRA/CAR/mmg
    $Id: MaeTipoPerfiPsicoLPStartUp.java,v 1.1 2009/12/03 18:37:02 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class MaeTipoPerfiPsicoLPStartUp extends MMGDruidaBase{
	...
	public MaeTipoPerfiPsicoLPStartUp(){
		super();
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			buildJsPageSize("MaeTipoPerfiPsico");
			...
			asignarAtributo("PAGINA", "MaeTipoPerfiPsicoPage", "cod", "MaeTipoPerfiPsico." + accion + ".label");
			...
			limpiarBotoneraLista("maeTipoPerfiPsico", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codTipoPerfPsic", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 2);");
		...
		//asignarAtributo("CAPA", "maeTipoPerfiPsicoLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "MaeTipoPerfiPsicoPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		MaeTipoPerfiPsicoData maeTipoPerfiPsicoQuery= new MaeTipoPerfiPsicoData();
		maeTipoPerfiPsicoQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		MaeTipoPerfiPsicoData datosResult = (MaeTipoPerfiPsicoData)getSingleObject(BUSINESSID_QUERY, maeTipoPerfiPsicoQuery, 
			maeTipoPerfiPsicoQuery.clone(), "maeTipoPerfiPsico");
		...
		preservaHiddensI18n(new Integer(1), "MAE_TIPO_PERFI_PSICO", "maeTipoPerfiPsicoFrm", "Descripcion", true);
		...
		MaeTipoPerfiPsicoData maeTipoPerfiPsico = datosResult;
		asignar("TEXT", "codTipoPerfPsic", FormatUtils.formatObject(maeTipoPerfiPsico.getCodTipoPerfPsic(), 
		...
		loadLocalizationVars(maeTipoPerfiPsico);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "codTipoPerfPsic", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "MAE_TIPO_PERFI_PSICO", "maeTipoPerfiPsicoFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "codTipoPerfPsic", "req", "S");
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('maeTipoPerfiPsicoFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "maeTipoPerfiPsicoFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		MaeTipoPerfiPsicoData maeTipoPerfiPsicoQuery= new MaeTipoPerfiPsicoData();
		maeTipoPerfiPsicoQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(maeTipoPerfiPsico.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"maeTipoPerfiPsicoFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"maeTipoPerfiPsicoFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codTipoPerfPsic", "ontab","ejecutarAccionFocoModificacion(\"maeTipoPerfiPsicoFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codTipoPerfPsic", "onshtab","ejecutarAccionFocoModificacion(\"maeTipoPerfiPsicoFrm\",2, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"maeTipoPerfiPsicoFrm\",3, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"maeTipoPerfiPsicoFrm\",3, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","maeTipoPerfiPsicoTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","maeTipoPerfiPsicoTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","maeTipoPerfiPsicoFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","maeTipoPerfiPsicoListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","maeTipoPerfiPsicoListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(MaeTipoPerfiPsicoData maeTipoPerfiPsico) throws Exception{
	...
	* @param maeTipoPerfiPsico La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(MaeTipoPerfiPsicoData maeTipoPerfiPsico) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		MaeTipoPerfiPsicoData maeTipoPerfiPsico = 
			(MaeTipoPerfiPsicoData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(maeTipoPerfiPsico);
		loadLeafDependenceCombos(maeTipoPerfiPsico);
	}
	...
	*/
	...
	protected void loadLocalizationVars(MaeTipoPerfiPsicoData maeTipoPerfiPsico) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("MAE_TIPO_PERFI_PSICO");
		mmgLocalizationQuery.setEntiPk(maeTipoPerfiPsico.getId());
