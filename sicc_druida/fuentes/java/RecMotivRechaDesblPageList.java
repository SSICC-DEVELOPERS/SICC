...
public class RecMotivRechaDesblPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","recMotivRechaDesblList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","RecMotivRechaDesbl.codRechDesb.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","RecMotivRechaDesbl.Descripcion.label" );
