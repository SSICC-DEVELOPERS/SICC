...
public class contenido_informe_ficha_tecnica_generar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_informe_ficha_tecnica_generar" );
      ((Element)v.get(0)).setAttribute("cod","0803" );
      ((Element)v.get(0)).setAttribute("titulo","Generar Informe Ficha Técnica del Curso" );
      ...
      v.add(doc.createTextNode("\r    \r       \r  function onLoadPag()   {\r  \r     ocultarLista();\r     DrdEnsanchaConMargenDcho('listado1',12);\r     eval (ON_RSZ);  \r     configurarMenuSecundario('Formulario');\r     fMostrarMensajeError();\r     setearPais();\r     focaliza('Formulario.cbPais');\r }\r   function generar(){\r       var codigos = new Array();\r       codigos = listado1.codSeleccionados();\r	   var cant = codigos.length;\r	   var posicion = obtenerPosicionListaEditable(listado1.codSeleccionados(),listado1);   \r    \r            \r       \r       if (cant == 1)  {\r          /*set('Formulario.conectorAction', 'EDUFichaTecnicaCurso');           \r          set('Formulario.accion', 'generar');\r          set(\"Formulario.oidCurso\", codigos[0]);\r\r                  \r          enviaSICC('Formulario');*/\r          var a = new Object();\r          a.accion = 'generar';\r          a.codigoTipoCurso = listado1.datos[posicion][3];     \r          a.codigoCurso = listado1.datos[posicion][4];  \r          mostrarModalSICC('EDUFichaTecnicaCurso','generar', a);  \r       }else{\r          GestionarMensaje('1486');\r      \r       }     \r\r       \r      \r   }\r\r\r   function ocultarLista() {\r        document.all[\"Cplistado1\"].style.visibility='hidden'; \r        document.all[\"CpLin1listado1\"].style.visibility='hidden';\r        document.all[\"CpLin2listado1\"].style.visibility='hidden' ;\r        document.all[\"CpLin3listado1\"].style.visibility='hidden' ;\r        document.all[\"CpLin4listado1\"].style.visibility='hidden';\r        document.all[\"primera1Div\"].style.visibility='hidden'; \r        document.all[\"ret1Div\"].style.visibility='hidden'; \r        document.all[\"ava1Div\"].style.visibility='hidden';   \r        document.all[\"separaDiv\"].style.visibility='hidden';\r        document.all[\"GenerarInformeDiv\"].style.visibility='hidden';\r        \r    }\r         \r    \r    function mostrarLista() {\r       document.all[\"Cplistado1\"].style.visibility='visible';\r       document.all[\"CpLin1listado1\"].style.visibility='visible';\r       document.all[\"CpLin2listado1\"].style.visibility='visible';\r       document.all[\"CpLin3listado1\"].style.visibility='visible';\r       document.all[\"CpLin4listado1\"].style.visibility='visible';\r       document.all[\"primera1Div\"].style.visibility='visible';\r       document.all[\"ret1Div\"].style.visibility='visible';\r       document.all[\"ava1Div\"].style.visibility='visible';\r       document.all[\"separaDiv\"].style.visibility='visible';\r       document.all[\"GenerarInformeDiv\"].style.visibility='visible';\r   }\r\r  function buscar(){\r  \r     if(validarFechas()){\r        var pais             = get('Formulario.cbPais');\r        var tipoCurso        = get('Formulario.cbCodTipoCurso');\r        var curso            = get('Formulario.cbCodCurso', 'T');\r        var fechaDisponible  = get('Formulario.txtFechaDisponible');\r        var fechaLanzamiento = get('Formulario.txtFechaLanzamiento');\r        var fechaFinCurso    = get('Formulario.txtFechaFinCurso');\r   \r  \r        var arrayDatos = new Array();\r        \r        arrayDatos[arrayDatos.length] = ['oidPais', pais];\r        arrayDatos[arrayDatos.length] = ['oidTipoCurso', tipoCurso]\r        arrayDatos[arrayDatos.length] = ['codigoCurso', curso]\r        arrayDatos[arrayDatos.length] = ['fechaDisponible', fechaDisponible]\r        arrayDatos[arrayDatos.length] = ['fechaLanzamiento', fechaLanzamiento]\r        arrayDatos[arrayDatos.length] = ['fechaFinCurso', fechaFinCurso]\r        \r        configurarPaginado( mipgndo, \"EDUBuscarFichaTecnica\", \"ConectorBusquedaFichaTecnica\", \"es.indra.sicc.dtos.edu.DTOBusquedaFichaTecnica\", arrayDatos);\r     }\r      \r   }\r\r   function validarFechas(){\r   \r       var fechaDisponible  = get('Formulario.txtFechaDisponible');\r       var fechaLanzamiento = get('Formulario.txtFechaLanzamiento');\r       var fechaFinCurso    = get('Formulario.txtFechaFinCurso');\r       var formatoFecha = get('Formulario.hFormatoFechaPais');\r          \r       if(fechaDisponible != ''){\r         if(! EsFechaValida_SICC(fechaDisponible , \"Formulario\")){\r            GestionarMensaje(\"1006\", formatoFecha, null, null);\r            focaliza(\"Formulario.txtFechaDisponible\");\r            return false;\r          }\r       }\r      \r       if(fechaLanzamiento != ''){\r         if (! EsFechaValida_SICC(fechaLanzamiento , \"Formulario\")){\r            GestionarMensaje(\"1006\", formatoFecha, null, null);\r            focaliza(\"Formulario.txtFechaLanzamiento\");\r            return false;\r         }\r       }\r      \r      if(fechaFinCurso != ''){\r         if (! EsFechaValida_SICC(fechaFinCurso , \"Formulario\")){\r            GestionarMensaje(\"1006\", formatoFecha, null, null);\r            focaliza(\"Formulario.txtFechaFinCurso\");\r            return false;\r         }\r      }\r      \r      return true;\r   \r   \r   }\r\r\r   function fLimpiar(){\r      var aCombo = new Array(new Array(\"\",\"\"));\r      set_combo('Formulario.cbCodCurso', aCombo, []);\r   \r      focaliza('Formulario.cbPais');\r \r   }\r   \r\r   function setearPais(){\r      var pais = get('Formulario.pais');\r      \r      iSeleccionado = new Array(); \r      iSeleccionado[0] = pais;\r      set('Formulario.cbPais',iSeleccionado);\r   }\r   \r    function onchangeTipoCurso(){\r           \r       var pais   = get('Formulario.cbPais');\r       var tipoCurso = get('Formulario.cbCodTipoCurso');\r      \r       if(tipoCurso != '' && pais != ''){\r       \r          var arr = new Array();\r          arr[arr.length] = [\"oidPais\", pais]; \r          arr[arr.length] = [\"oidTipoCurso\", tipoCurso];\r          \r          recargaCombo(\"Formulario.cbCodCurso\",\"EDUObtieneCodigoCurso\", \"es.indra.sicc.dtos.edu.DTORelacionesCurso\",arr); \r                  \r       }else{\r          var aCombo = new Array(new Array(\"\",\"\"));\r          set_combo('Formulario.cbCodCurso', aCombo, []);\r       }\r   \r    } \r    function prueba(ultima, rowset, error){\r       var tamano = rowset.length;\r    \r       if (tamano > 0) {\r          mostrarLista();\r          return true;\r       }else{\r          ocultarLista(); \r          cdos_mostrarAlert(error);\r          return false;\r     }\r  } \r\r \r   \r\r\r  \r  \r \r"));
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(15)).setAttribute("nombre","oidCurso" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(35)).setAttribute("width","535" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(47)).setAttribute("nombre","lblCodTipoCurso" );
      ((Element)v.get(47)).setAttribute("filas","1" );
      ((Element)v.get(47)).setAttribute("id","datosTitle" );
      ((Element)v.get(47)).setAttribute("cod","2646" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(51)).setAttribute("nombre","lblCodCurso" );
      ((Element)v.get(51)).setAttribute("filas","1" );
      ((Element)v.get(51)).setAttribute("id","datosTitle" );
      ((Element)v.get(51)).setAttribute("cod","715" );
      ...
      ((Element)v.get(58)).setAttribute("onchange","onchangeTipoCurso();" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(63)).setAttribute("nombre","cbCodTipoCurso" );
      ...
      ((Element)v.get(63)).setAttribute("onchange","onchangeTipoCurso();" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(68)).setAttribute("nombre","cbCodCurso" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(77)).setAttribute("width","535" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(82)).setAttribute("nombre","lblFechaDisponible" );
      ((Element)v.get(82)).setAttribute("filas","1" );
      ((Element)v.get(82)).setAttribute("id","datosTitle" );
      ((Element)v.get(82)).setAttribute("cod","725" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(86)).setAttribute("nombre","lblFechaLanzamiento" );
      ((Element)v.get(86)).setAttribute("filas","1" );
      ((Element)v.get(86)).setAttribute("id","datosTitle" );
      ((Element)v.get(86)).setAttribute("cod","729" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(90)).setAttribute("nombre","lblFechaFinCurso" );
      ((Element)v.get(90)).setAttribute("filas","1" );
      ((Element)v.get(90)).setAttribute("id","datosTitle" );
      ((Element)v.get(90)).setAttribute("cod","726" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(101)).setAttribute("nombre","txtFechaLanzamiento" );
      ...
      ((Element)v.get(101)).setAttribute("size","12" );
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(105)).setAttribute("nombre","txtFechaFinCurso" );
      ((Element)v.get(105)).setAttribute("id","datosCampos" );
      ((Element)v.get(105)).setAttribute("max","10" );
      ...
      /* Empieza nodo:111 / Elemento padre: 25   */
      v.add(doc.createElement("td"));
      ((Element)v.get(25)).appendChild((Element)v.get(111));
      ...
      /* Empieza nodo:113 / Elemento padre: 17   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(17)).appendChild((Element)v.get(113));
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(121)).setAttribute("accion","buscar();" );
      ...
      ((Element)v.get(131)).setAttribute("ancho","538" );
      ((Element)v.get(131)).setAttribute("alto","317" );
      ((Element)v.get(131)).setAttribute("x","12" );
      ((Element)v.get(131)).setAttribute("y","162" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(142)).setAttribute("ancho","60" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(147)).setAttribute("ancho","135" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(148)).setAttribute("ancho","135" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(149)).setAttribute("ancho","135" );
      ...
      ((Element)v.get(151)).setAttribute("cod","5" );
      ...
      ((Element)v.get(152)).setAttribute("cod","716" );
      ...
      ((Element)v.get(153)).setAttribute("cod","2646" );
   }
   ...
   private void getXML630(Document doc) {
      ...
      ((Element)v.get(154)).setAttribute("cod","715" );
      ...
      ((Element)v.get(155)).setAttribute("cod","2648" );
      ...
      ((Element)v.get(156)).setAttribute("cod","725" );
      ...
      ((Element)v.get(157)).setAttribute("cod","729" );
      ...
      ((Element)v.get(158)).setAttribute("cod","726" );
      ...
      ((Element)v.get(169)).setAttribute("ancho","538" );
      ((Element)v.get(169)).setAttribute("sep","$" );
      ((Element)v.get(169)).setAttribute("x","12" );
      ((Element)v.get(169)).setAttribute("class","botonera" );
      ((Element)v.get(169)).setAttribute("y","456" );
      ((Element)v.get(169)).setAttribute("control","|" );
      ((Element)v.get(169)).setAttribute("conector","conector_prototipo_2" );
      ((Element)v.get(169)).setAttribute("rowset","" );
      ((Element)v.get(169)).setAttribute("cargainicial","N" );
      ((Element)v.get(169)).setAttribute("onload","procesarPaginado(mipgndo,msgError, ultima, rowset, 'prueba(ultima, rowset)')" );
      ...
      ((Element)v.get(170)).setAttribute("y","460" );
   ...
   private void getXML720(Document doc) {
      ...
      ((Element)v.get(171)).setAttribute("y","460" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(174)).setAttribute("nombre","GenerarInforme" );
      ((Element)v.get(174)).setAttribute("x","80" );
      ((Element)v.get(174)).setAttribute("y","457" );
      ...
      ((Element)v.get(174)).setAttribute("cod","2495" );
      ((Element)v.get(174)).setAttribute("accion","generar();" );
      ((Element)v.get(6)).appendChild((Element)v.get(174));
      /* Termina nodo:174   */

      /* Empieza nodo:175 / Elemento padre: 6   */
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(175)).setAttribute("nombre","capaEspacio2" );
      ...
      ((Element)v.get(175)).setAttribute("visibilidad","visible" );
      ((Element)v.get(175)).setAttribute("contravsb","" );
      ((Element)v.get(175)).setAttribute("x","0" );
      ((Element)v.get(175)).setAttribute("y","479" );
      ((Element)v.get(175)).setAttribute("zindex","" );
      ((Element)v.get(6)).appendChild((Element)v.get(175));
      /* Termina nodo:175   */
      /* Termina nodo:6   */
