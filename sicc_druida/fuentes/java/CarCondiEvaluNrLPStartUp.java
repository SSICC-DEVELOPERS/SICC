/*
    INDRA/CAR/mmg
    $Id: CarCondiEvaluNrLPStartUp.java,v 1.1 2009/12/03 18:35:14 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class CarCondiEvaluNrLPStartUp extends MMGDruidaBase{
	...
	public static final String BUSINESSID_QUERY = "MMGCarCondiEvaluNrQueryFromToUserPage";
				...
				public static final String BUSINESSID_PENROIDPARAEVALNR_QUERY ="MMGCarParamEvaluNrQueryFromToUser";
				public static final String PENROIDPARAEVALNR_COMBO_CONNECTOR = "CarParamEvaluNrConectorCombo";
	...
	public CarCondiEvaluNrLPStartUp(){
		super();
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			buildJsPageSize("CarCondiEvaluNr");
			...
			asignarAtributo("PAGINA", "CarCondiEvaluNrPage", "cod", "CarCondiEvaluNr." + accion + ".label");
			...
			limpiarBotoneraLista("carCondiEvaluNr", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "valMini", "validacion", "mensaje = ValidaNumeroMMG(cdos_trim(valor), " + (12 - MMGDruidaHelper.getUserDecimalPrecision(this)) + ", " + MMGDruidaHelper.getUserDecimalPrecision(this)+ ", 'CarCondiEvaluNr.valMini', 0, " + MMGDruidaHelper.getMaxValueForDruidaValidaFloat((12 - MMGDruidaHelper.getUserDecimalPrecision(this)), this) + ");");
		asignarAtributo("TEXT", "valMaxi", "validacion", "mensaje = ValidaNumeroMMG(cdos_trim(valor), " + (12 - MMGDruidaHelper.getUserDecimalPrecision(this)) + ", " + MMGDruidaHelper.getUserDecimalPrecision(this)+ ", 'CarCondiEvaluNr.valMaxi', 0, " + MMGDruidaHelper.getMaxValueForDruidaValidaFloat((12 - MMGDruidaHelper.getUserDecimalPrecision(this)), this) + ");if (mensaje=='OK') validacionvalMaxivalMini(); else muestraMsgError(mensaje);");
		asignarAtributo("TEXT", "valEscaMini", "validacion", "mensaje = ValidaNumeroMMG(cdos_trim(valor), " + (12 - MMGDruidaHelper.getUserDecimalPrecision(this)) + ", " + MMGDruidaHelper.getUserDecimalPrecision(this)+ ", 'CarCondiEvaluNr.valEscaMini', 0, " + MMGDruidaHelper.getMaxValueForDruidaValidaFloat((12 - MMGDruidaHelper.getUserDecimalPrecision(this)), this) + ");");
		
		//Primero determianmos el nombre del campo en la entidad de oriegen donde se van a cargar los datos
		asignar("VAR", "idAttributeLovOpener", conectorParametro(PARAMETRO_LOV_ATTRIBUTO));
		asignar("VAR", "idEntityLovOpener", conectorParametro(PARAMETRO_LOV_ENTIDAD));
		//asignarAtributo("CAPA", "carCondiEvaluNrLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "CarCondiEvaluNrPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		CarCondiEvaluNrData carCondiEvaluNrQuery= new CarCondiEvaluNrData();
		carCondiEvaluNrQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		CarCondiEvaluNrData datosResult = (CarCondiEvaluNrData)getSingleObject(BUSINESSID_QUERY, carCondiEvaluNrQuery, 
			carCondiEvaluNrQuery.clone(), "carCondiEvaluNr");
		...
		CarCondiEvaluNrData carCondiEvaluNr = datosResult;
		es.indra.belcorp.mso.CarParamEvaluNrData penrOidParaEvalNr = carCondiEvaluNr.getPenrOidParaEvalNr();
		if(penrOidParaEvalNr != null && penrOidParaEvalNr.getId() != null) checkCombo("penrOidParaEvalNr" , penrOidParaEvalNr.getId().toString());
		asignar("TEXT", "valMini", FormatUtils.formatObject(carCondiEvaluNr.getValMini(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "valMaxi", FormatUtils.formatObject(carCondiEvaluNr.getValMaxi(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "valEscaMini", FormatUtils.formatObject(carCondiEvaluNr.getValEscaMini(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		//Deshabilitamos todos los campos para que no se editen
					...
					asignarAtributo("COMBO", "penrOidParaEvalNr", "disabled", "S");asignarAtributo("TEXT", "valMini", "disabled", "S");
		asignarAtributo("TEXT", "valMaxi", "disabled", "S");
		asignarAtributo("TEXT", "valEscaMini", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		...
		asignarAtributo("COMBO", "penrOidParaEvalNr", "req", "S");
		asignarAtributo("TEXT", "valMini", "req", "S");
		asignarAtributo("TEXT", "valEscaMini", "req", "S");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "carCondiEvaluNrFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		CarCondiEvaluNrData carCondiEvaluNrQuery= new CarCondiEvaluNrData();
		carCondiEvaluNrQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(carCondiEvaluNr.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"carCondiEvaluNrFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"carCondiEvaluNrFrm\",1, false)");
					asignarAtributo("COMBO","penrOidParaEvalNr", "ontab", "ejecutarAccionFocoModificacion(\"carCondiEvaluNrFrm\",2, true)");
					asignarAtributo("COMBO","penrOidParaEvalNr", "onshtab", "ejecutarAccionFocoModificacion(\"carCondiEvaluNrFrm\",2, false)");
				asignarAtributo("AREATEXTO", "valMini", "ontab","ejecutarAccionFocoModificacion(\"carCondiEvaluNrFrm\",3, true)");
				asignarAtributo("AREATEXTO", "valMini", "onshtab","ejecutarAccionFocoModificacion(\"carCondiEvaluNrFrm\",3, false)");
				asignarAtributo("AREATEXTO", "valMaxi", "ontab","ejecutarAccionFocoModificacion(\"carCondiEvaluNrFrm\",4, true)");
				asignarAtributo("AREATEXTO", "valMaxi", "onshtab","ejecutarAccionFocoModificacion(\"carCondiEvaluNrFrm\",4, false)");
				asignarAtributo("AREATEXTO", "valEscaMini", "ontab","ejecutarAccionFocoModificacion(\"carCondiEvaluNrFrm\",5, true)");
				asignarAtributo("AREATEXTO", "valEscaMini", "onshtab","ejecutarAccionFocoModificacion(\"carCondiEvaluNrFrm\",5, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","carCondiEvaluNrTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","carCondiEvaluNrTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es penrOidParaEvalNr...");		
				
					traza("MMG: en desactivateNonModifyFields encontrado atributo no editable...");
				
						asignarAtributo("COMBO", "penrOidParaEvalNr", "disabled", "S");
				traza("MMG: el atributo es valMini...");		
				
				traza("MMG: el atributo es valMaxi...");		
				
				traza("MMG: el atributo es valEscaMini...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","carCondiEvaluNrFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","carCondiEvaluNrListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","carCondiEvaluNrListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(CarCondiEvaluNrData carCondiEvaluNr) throws Exception{
		HashMap checkedCombos = new HashMap();
		CarParamEvaluNrData penrOidParaEvalNr = new CarParamEvaluNrData();
		
						asignarComboResultados(BUSINESSID_PENROIDPARAEVALNR_QUERY,PENROIDPARAEVALNR_COMBO_CONNECTOR, 
			penrOidParaEvalNr, penrOidParaEvalNr.clone(), "carParamEvaluNr", "penrOidParaEvalNr", "result_ROWSET" );
		if(carCondiEvaluNr != null && carCondiEvaluNr.getPenrOidParaEvalNr() != null){
				checkCombo("penrOidParaEvalNr" , carCondiEvaluNr.getPenrOidParaEvalNr().getId().toString());
			}
	...
	* @param carCondiEvaluNr La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(CarCondiEvaluNrData carCondiEvaluNr) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		CarCondiEvaluNrData carCondiEvaluNr = 
			(CarCondiEvaluNrData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(carCondiEvaluNr.getPenrOidParaEvalNr() != null){
			carCondiEvaluNr.setPenrOidParaEvalNr((es.indra.belcorp.mso.CarParamEvaluNrData)
			getSingleObject(BUSINESSID_PENROIDPARAEVALNR_QUERY, 
			carCondiEvaluNr.getPenrOidParaEvalNr(),
			carCondiEvaluNr.getPenrOidParaEvalNr().clone(),
			"carParamEvaluNr"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(carCondiEvaluNr);
		loadLeafDependenceCombos(carCondiEvaluNr);
	}
