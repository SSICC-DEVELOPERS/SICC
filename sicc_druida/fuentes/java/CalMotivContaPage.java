...
public class CalMotivContaPage  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","CalMotivContaPage" );
      ((Element)v.get(0)).setAttribute("titulo","" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","" );
      ((Element)v.get(0)).setAttribute("onload","calMotivContaInitComponents()" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","calmotivconta.js" );
      ((Element)v.get(0)).appendChild((Element)v.get(4));
      /* Termina nodo:4   */

      /* Empieza nodo:5 / Elemento padre: 0   */
      v.add(doc.createElement("FORMULARIO"));
      ((Element)v.get(5)).setAttribute("nombre","calMotivContaFrm" );
      ...
      ((Element)v.get(6)).setAttribute("valor","CalMotivContaLPExecution" );
      ...
      ((Element)v.get(7)).setAttribute("valor","CalMotivContaLPExecution" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(37)).setAttribute("nombre","calMotivContaFormLayer" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(52)).setAttribute("cod","CalMotivConta.legend.label" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(67)).setAttribute("cod","CalMotivConta.id.label" );
      ...
      ((Element)v.get(70)).setAttribute("ontab","ejecutarAccionFoco('calMotivContaFrm',1, true)" );
      ((Element)v.get(70)).setAttribute("onshtab","ejecutarAccionFoco('calMotivContaFrm', 1, false)" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(88)).setAttribute("nombre","codMotiTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(93)).setAttribute("nombre","codMotiWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(95)).setAttribute("nombre","codMoti" );
      ...
      ((Element)v.get(95)).setAttribute("ontab","ejecutarAccionFoco('calMotivContaFrm',2, true)" );
      ((Element)v.get(95)).setAttribute("onshtab","ejecutarAccionFoco('calMotivContaFrm', 2, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(96)).setAttribute("nombre","codMotiGapTdId" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(102)).setAttribute("cod","CalMotivConta.Descripcion.label" );
      ...
      ((Element)v.get(106)).setAttribute("ontab","ejecutarAccionFoco('calMotivContaFrm',3, true)" );
      ((Element)v.get(106)).setAttribute("onshtab","ejecutarAccionFoco('calMotivContaFrm', 3, false)" );
      ...
      ((Element)v.get(110)).setAttribute("href","javascript:openLocalizationDialog('calMotivContaFrm', 'Descripcion', 1);" );
      ((Element)v.get(110)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"calMotivContaFrm\",3, true)', 'ejecutarAccionFoco(\"calMotivContaFrm\",3, false)')" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(114)).setAttribute("nombre","codProcTdId" );
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(119)).setAttribute("nombre","codProcWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(121)).setAttribute("nombre","codProc" );
      ...
      ((Element)v.get(121)).setAttribute("ontab","ejecutarAccionFoco('calMotivContaFrm',4, true)" );
      ((Element)v.get(121)).setAttribute("onshtab","ejecutarAccionFoco('calMotivContaFrm', 4, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(122)).setAttribute("nombre","codProcGapTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(136)).setAttribute("nombre","calMotivContaTrButtons" );
   }
   ...
   private void getXML630(Document doc) {
      ...
      ((Element)v.get(143)).setAttribute("nombre","calMotivContaTdQueryButton" );
      ((Element)v.get(142)).appendChild((Element)v.get(143));

      /* Empieza nodo:144 / Elemento padre: 143   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(144)).setAttribute("nombre","calMotivContaQueryButton" );
      ((Element)v.get(144)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(144)).setAttribute("estado","false" );
      ((Element)v.get(144)).setAttribute("accion","calMotivContaFirstPage();" );
      ...
      ((Element)v.get(145)).setAttribute("nombre","calMotivContaTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(147)).setAttribute("nombre","calMotivContaLovNullButton" );
      ((Element)v.get(147)).setAttribute("ID","botonContenido" );
      ((Element)v.get(147)).setAttribute("tipo","html" );
      ((Element)v.get(147)).setAttribute("accion","calMotivContaLovNullSelectionAction();" );
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(150)).setAttribute("nombre","calMotivContaListLayer" );
      ...
      ((Element)v.get(151)).setAttribute("nombre","calMotivContaList" );
   ...
   private void getXML720(Document doc) {
      ...
      ((Element)v.get(165)).setAttribute("cod","CalMotivConta.codMoti.label" );
      ...
      ((Element)v.get(166)).setAttribute("cod","CalMotivConta.Descripcion.label" );
      ...
      ((Element)v.get(167)).setAttribute("cod","CalMotivConta.codProc.label" );
   ...
   private void getXML810(Document doc) {
      ...
      /* Empieza nodo:173 / Elemento padre: 5   */
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(173)).setAttribute("nombre","calMotivContaListButtonsLayer" );
      ...
      ((Element)v.get(5)).appendChild((Element)v.get(173));
      ...
      ((Element)v.get(179)).setAttribute("nombre","calMotivContaPaginationButtonBar" );
      ...
      ((Element)v.get(180)).setAttribute("nombre","calMotivContaFirstPageButton" );
      ((Element)v.get(180)).setAttribute("funcion","calMotivContaFirstPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(181)).setAttribute("nombre","calMotivContaFirstPageButtonGapTd" );
   ...
   private void getXML900(Document doc) {
      ((Element)v.get(183)).setAttribute("nombre","calMotivContaPreviousPageButton" );
      ((Element)v.get(183)).setAttribute("funcion","calMotivContaPreviousPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(184)).setAttribute("nombre","calMotivContaPreviousPageButtonGapTd" );
      ...
      v.add(doc.createElement("BTN"));
      ((Element)v.get(186)).setAttribute("nombre","calMotivContaNextPageButton" );
      ((Element)v.get(186)).setAttribute("funcion","calMotivContaNextPage();" );
      ...
      ((Element)v.get(189)).setAttribute("nombre","calMotivContaUpdateButtonTd" );
      ((Element)v.get(175)).appendChild((Element)v.get(189));

      /* Empieza nodo:190 / Elemento padre: 189   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(190)).setAttribute("nombre","calMotivContaUpdateButton" );
      ((Element)v.get(190)).setAttribute("ID","botonContenido" );
      ((Element)v.get(190)).setAttribute("tipo","html" );
      ((Element)v.get(190)).setAttribute("accion","calMotivContaUpdateSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(191)).setAttribute("nombre","calMotivContaUpdateButtonGapTd" );
      ...
      ((Element)v.get(193)).setAttribute("nombre","calMotivContaViewForRemoveButtonTd" );
      ((Element)v.get(175)).appendChild((Element)v.get(193));

      /* Empieza nodo:194 / Elemento padre: 193   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(194)).setAttribute("nombre","calMotivContaViewForRemoveButton" );
      ((Element)v.get(194)).setAttribute("ID","botonContenido" );
      ((Element)v.get(194)).setAttribute("tipo","html" );
      ((Element)v.get(194)).setAttribute("accion","calMotivContaViewSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(195)).setAttribute("nombre","calMotivContaViewForRemoveButtonGapTd" );
      ...
      ((Element)v.get(197)).setAttribute("nombre","calMotivContaLovSelectButtonTd" );
      ((Element)v.get(175)).appendChild((Element)v.get(197));

      /* Empieza nodo:198 / Elemento padre: 197   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(198)).setAttribute("nombre","calMotivContaLovSelectButton" );
      ((Element)v.get(198)).setAttribute("ID","botonContenido" );
      ((Element)v.get(198)).setAttribute("tipo","html" );
      ((Element)v.get(198)).setAttribute("accion","calMotivContaLovSelectionAction();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(199)).setAttribute("nombre","calMotivContaLovSelectButtonGapTd" );
   ...
   private void getXML990(Document doc) {
      ...
      ((Element)v.get(201)).setAttribute("nombre","calMotivContaViewButtonTd" );
      ((Element)v.get(175)).appendChild((Element)v.get(201));

      /* Empieza nodo:202 / Elemento padre: 201   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(202)).setAttribute("nombre","calMotivContaViewButton" );
      ((Element)v.get(202)).setAttribute("ID","botonContenido" );
      ((Element)v.get(202)).setAttribute("tipo","html" );
      ((Element)v.get(202)).setAttribute("accion","calMotivContaViewSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(203)).setAttribute("nombre","calMotivContaViewButtonGapTd" );
