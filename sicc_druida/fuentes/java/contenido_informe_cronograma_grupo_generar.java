...
public class contenido_informe_cronograma_grupo_generar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_informe_cronograma_grupo_generar" );
      ((Element)v.get(0)).setAttribute("cod","0768" );
      ((Element)v.get(0)).setAttribute("titulo","Generar informe cronograma total por grupo" );
      ...
      v.add(doc.createTextNode("\r   \r   \r   function onLoad(){\r      configurarMenuSecundario('Formulario');\r      fMostrarMensajeError();\r      \r      focaliza('Formulario.cbCanal');\r   }\r   function generar(){\r      \r      if(sicc_validaciones_generales()){\r        \r            /*recolectarParametros();\r      \r            set('Formulario.conectorAction', 'CRACronoTotalGrupo');           \r            set('Formulario.accion', 'generar');\r      \r            enviaSICC('Formulario');*/\r            var a = new Object();\r            a.accion = 'generar';\r            a.marca = get('Formulario.cbMarca');  \r            a.canal = get('Formulario.cbCanal');\r            a.periodoDesde = get('Formulario.cbPeriodoDesde');\r            a.periodoHasta = get('Formulario.cbPeriodoHasta');\r            a.grupoFacturacion = get('Formulario.cbGrupoFacturacion');\r            a.actividades = quitarItemVacio(get('Formulario.cbActividad'));          \r            mostrarModalSICC('CRACronoTotalGrupo','generar', a);  \r        \r      }\r\r   }\r\r   function recolectarParametros(){\r     \r        \r      set('Formulario.marca', get('Formulario.cbMarca') );  \r      set('Formulario.canal', get('Formulario.cbCanal'));\r      set('Formulario.periodoDesde', get('Formulario.cbPeriodoDesde') );\r      set('Formulario.periodoHasta', get('Formulario.cbPeriodoHasta') );\r      set('Formulario.grupoFacturacion', get('Formulario.cbGrupoFacturacion'));\r      set('Formulario.actividades', quitarItemVacio(get('Formulario.cbActividad')));\r         \r      \r  \r   }\r \r   \r\r   function fLimpiar(){\r      var aCombo = new Array(new Array(\"\",\"\"));\r      set_combo('Formulario.cbPeriodoDesde', aCombo, []);\r      set_combo('Formulario.cbPeriodoHasta', aCombo, []);\r      set_combo('Formulario.cbGrupoFacturacion', aCombo, []);\r      set_combo('Formulario.cbActividad', aCombo, []);\r      focaliza('Formulario.cbCanal');\r \r   }\r   \r    function onchangeMarcaCanal(){\r        \r       marca  = get('Formulario.cbMarca');\r       canal  = get('Formulario.cbCanal');\r       pais   = get('Formulario.pais');\r       idioma = get('Formulario.idioma');\r       \r       \r       if(marca != '' && canal != ''){\r       \r          var arr = new Array();\r          var arr2 = new Array();\r              \r          arr[arr.length] = [\"oidIdioma\", idioma]; \r          arr[arr.length] = [\"oidPais\", pais]; \r          arr[arr.length] = [\"marca\", marca];\r          arr[arr.length] = [\"canal\", canal];\r          \r          arr2[arr2.length] = ['oidMarca', marca];\r          arr2[arr2.length] = ['oidCanal', canal];\r          arr2[arr2.length] = ['oidPais', pais];\r          arr2[arr2.length] = ['oidIdioma', idioma];\r           \r          recargaCombo(\"Formulario.cbPeriodoDesde\",\"REPPeriodosCronogramaTotalGrupo\",\"es.indra.sicc.dtos.cra.DTOPeriodo\",arr);\r          recargaCombo(\"Formulario.cbPeriodoHasta\",\"REPPeriodosCronogramaTotalGrupo\",\"es.indra.sicc.dtos.cra.DTOPeriodo\",arr);\r          recargaCombo(\"Formulario.cbGrupoFacturacion\",\"CRAObtieneGruposZonas\", \"es.indra.sicc.dtos.cra.DTOGrupoZonas\",arr2);\r          recargaCombo(\"Formulario.cbActividad\",\"CRAObtieneActividad\", \"es.indra.sicc.dtos.cra.DTOActividad\", arr2); \r       }else{\r          var aCombo = new Array(new Array(\"\",\"\"));\r          set_combo('Formulario.cbPeriodoDesde', aCombo, []);\r          set_combo('Formulario.cbPeriodoHasta', aCombo, []);\r          set_combo('Formulario.cbGrupoFacturacion', aCombo, []);\r          set_combo('Formulario.cbActividad', aCombo, []);\r       \r       \r       \r       \r       }\r   \r    } \r\r\r   function quitarItemVacio(elemento){\r      var elementoADevolver = new Array();\r     \r      for(var k=0;k<elemento.length;k++) {\r         if (elemento[k] != ''){ 			 \r            elementoADevolver[elementoADevolver.length] = elemento[k];\r         }\r      }\r        \r      return elementoADevolver;\r      \r   }\r\r\r\r   \r"));
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(11)).setAttribute("name","cbGrupoFacturacion" );
      ((Element)v.get(11)).setAttribute("required","true" );
      ((Element)v.get(11)).setAttribute("cod","2568" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(25)).setAttribute("nombre","grupoFacturacion" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(26)).setAttribute("nombre","actividades" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(70)).setAttribute("nombre","cbMarca" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(92)).setAttribute("nombre","lblGrupoFacturacion" );
   ...
   private void getXML360(Document doc) {
      ((Element)v.get(92)).setAttribute("cod","2568" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(99)).setAttribute("nombre","cbPeriodoDesde" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(104)).setAttribute("nombre","cbPeriodoHasta" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(109)).setAttribute("nombre","cbGrupoFacturacion" );
      ...
      /* Empieza nodo:113 / Elemento padre: 79   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(79)).appendChild((Element)v.get(113));
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(130)).setAttribute("nombre","cbActividad" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(147)).setAttribute("ontab","focaliza('Formulario.cbCanal')" );
