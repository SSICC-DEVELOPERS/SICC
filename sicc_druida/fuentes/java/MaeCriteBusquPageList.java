...
public class MaeCriteBusquPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","maeCriteBusquList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","MaeCriteBusqu.atreOidAtriEsp1.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","MaeCriteBusqu.atreOidAtriEsp2.label" );
