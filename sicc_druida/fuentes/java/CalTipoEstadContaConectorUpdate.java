...
public class CalTipoEstadContaConectorUpdate  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la modificacion de un  elemento de la entidad CalTipoEstadConta" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGCalTipoEstadContaUpdateID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGCalTipoEstadContaUpdateDTO" );
