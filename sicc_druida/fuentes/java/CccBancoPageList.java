...
public class CccBancoPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","cccBancoList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","CccBanco.codBanc.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","CccBanco.desBanc.label" );
      ...
      ((Element)v.get(17)).setAttribute("cod","CccBanco.codBrio.label" );
      ...
      ((Element)v.get(18)).setAttribute("cod","CccBanco.codSwifInfo.label" );
