...
public class FacTipoOfertExcluPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","facTipoOfertExcluList" );
      ...
      ((Element)v.get(14)).setAttribute("cod","FacTipoOfertExclu.fecDesd.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","FacTipoOfertExclu.fecHast.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","FacTipoOfertExclu.tofeOidTipoOfer.label" );
