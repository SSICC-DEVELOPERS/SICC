...
public class PreCatalOrdenPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","preCatalOrdenList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","PreCatalOrden.marcOidMarc.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","PreCatalOrden.canaOidCana.label" );
      ...
      ((Element)v.get(17)).setAttribute("cod","PreCatalOrden.ocatOidCata.label" );
      ...
      ((Element)v.get(18)).setAttribute("cod","PreCatalOrden.numOrde.label" );
