/*
    INDRA/CAR/mmg
    $Id: MaeTipoClienLPStartUp.java,v 1.1 2009/12/03 18:40:28 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class MaeTipoClienLPStartUp extends MMGDruidaBase{
	...
	protected static Hashtable indEvalEstaValues = new Hashtable();
	static{
		indEvalEstaValues.put(new java.lang.Long(1), "Si");
		indEvalEstaValues.put(new java.lang.Long(0), "No");
	}
	protected static Hashtable indEmplValues = new Hashtable();
	static{
		indEmplValues.put(new java.lang.Long(1), "Si");
		indEmplValues.put(new java.lang.Long(0), "No");
	}
	
	
	// Definicion del constructor
	public MaeTipoClienLPStartUp(){
		super();
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "MaeTipoClienPage", "cod", "MaeTipoClien." + accion + ".label");
			...
			limpiarBotoneraLista("maeTipoClien", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codTipoClie", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 2);");
		...
		//asignarAtributo("CAPA", "maeTipoClienLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "MaeTipoClienPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		MaeTipoClienData maeTipoClienQuery= new MaeTipoClienData();
		maeTipoClienQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		MaeTipoClienData datosResult = (MaeTipoClienData)getSingleObject(BUSINESSID_QUERY, maeTipoClienQuery, 
			maeTipoClienQuery.clone(), "maeTipoClien");
		...
		preservaHiddensI18n(new Integer(1), "MAE_TIPO_CLIEN", "maeTipoClienFrm", "Descripcion", true);
		
		
		//Guardamos los valores de los radiobuttons
		if(datosResult.getIndEvalEsta() != null)
			asignar("VAR", "indEvalEstaCheckValue", datosResult.getIndEvalEsta().toString());
		if(datosResult.getIndEmpl() != null)
			asignar("VAR", "indEmplCheckValue", datosResult.getIndEmpl().toString());
		...
		MaeTipoClienData maeTipoClien = datosResult;
		asignar("TEXT", "codTipoClie", FormatUtils.formatObject(maeTipoClien.getCodTipoClie(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "Descripcion", FormatUtils.formatObject(maeTipoClien.getDescripcion(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignarAtributo("RADIOB", "indEvalEsta" , "valor", FormatUtils.formatObject(
			maeTipoClien.getIndEvalEsta(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignarAtributo("RADIOB", "indEmpl" , "valor", FormatUtils.formatObject(
			maeTipoClien.getIndEmpl(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		loadLocalizationVars(maeTipoClien);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "codTipoClie", "disabled", "S");
		asignarAtributo("TEXT", "Descripcion", "disabled", "S");
		
					asignarAtributo("RADIOB", "indEvalEsta", "disabled", "S");
		
					asignarAtributo("RADIOB", "indEmpl", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "MAE_TIPO_CLIEN", "maeTipoClienFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "codTipoClie", "req", "S");
		asignarAtributo("TEXT", "Descripcion", "req", "S");
		asignarAtributo("RADIOB", "indEvalEsta", "req", "S");
		
		
		//Asiganamos a los campos internacionalizables la función de onblur para actualizar el 
		//valor del idioma por defecto
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('maeTipoClienFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "maeTipoClienFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		MaeTipoClienData maeTipoClienQuery= new MaeTipoClienData();
		maeTipoClienQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(maeTipoClien.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"maeTipoClienFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"maeTipoClienFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codTipoClie", "ontab","ejecutarAccionFocoModificacion(\"maeTipoClienFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codTipoClie", "onshtab","ejecutarAccionFocoModificacion(\"maeTipoClienFrm\",2, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"maeTipoClienFrm\",3, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"maeTipoClienFrm\",3, false)");
				asignarAtributo("TEXT", "indEvalEsta", "ontab","ejecutarAccionFocoModificacion(\"maeTipoClienFrm\",4, true)");
				asignarAtributo("TEXT", "indEvalEsta", "onshtab","ejecutarAccionFocoModificacion(\"maeTipoClienFrm\",4, false)");
				asignarAtributo("TEXT", "indEmpl", "ontab","ejecutarAccionFocoModificacion(\"maeTipoClienFrm\",5, true)");
				asignarAtributo("TEXT", "indEmpl", "onshtab","ejecutarAccionFocoModificacion(\"maeTipoClienFrm\",5, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","maeTipoClienTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","maeTipoClienTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codTipoClie...");		
				
					traza("MMG: en desactivateNonModifyFields encontrado atributo no editable...");
				
						// borrarCampo("codTipoClie");
						asignarAtributo ("TEXT", "codTipoClie", "disabled", "S");
				traza("MMG: el atributo es Descripcion...");		
				
				traza("MMG: el atributo es indEvalEsta...");		
				
				traza("MMG: el atributo es indEmpl...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","maeTipoClienFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","maeTipoClienListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","maeTipoClienListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(MaeTipoClienData maeTipoClien) throws Exception{
	...
	* @param maeTipoClien La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(MaeTipoClienData maeTipoClien) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		MaeTipoClienData maeTipoClien = 
			(MaeTipoClienData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(maeTipoClien);
		loadLeafDependenceCombos(maeTipoClien);
	}
	...
	*/
	...
	protected void loadLocalizationVars(MaeTipoClienData maeTipoClien) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("MAE_TIPO_CLIEN");
		mmgLocalizationQuery.setEntiPk(maeTipoClien.getId());
