...
public class SegPerioCorpoPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","segPerioCorpoList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","SegPerioCorpo.tipeOidTipoPeri.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","SegPerioCorpo.codPeri.label" );
      ...
      ((Element)v.get(17)).setAttribute("cod","SegPerioCorpo.Descripcion.label" );
      ...
      ((Element)v.get(18)).setAttribute("cod","SegPerioCorpo.valAnio.label" );
