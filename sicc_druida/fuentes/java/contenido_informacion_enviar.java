...
public class contenido_informacion_enviar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_informacion_enviar" );
      ((Element)v.get(0)).setAttribute("cod","0257" );
      ((Element)v.get(0)).setAttribute("titulo","Enviar información de cliente" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","Enviar información de cliente" );
      ...
      v.add(doc.createTextNode("\r\r  \r \r var varNoLimpiarSICC = true;\r \r function onLoadPag(){       \r         \r      configurarMenuSecundario('frmFormulario'); \r      focaliza(\"frmFormulario.Descripcion\");\r      \r            btnProxy(5,\"0\");\r    \r    \r      if (get('frmFormulario.errDescripcion')!='') {\r             var wnd = fMostrarMensajeError(get('frmFormulario.errCodigo'), get('frmFormulario.errDescripcion'));\r      }\r      \r      set(\"frmFormulario.Descripcion\", get(\"frmFormulario.descripcionH\"));\r  }\r  \r  \r  function focalizaShTab(){  \r    focalizaBotonHTML('botonContenido','btnEnviar');	\r }\r\r  function focalizaTab(){\r    focaliza(\"frmFormulario.Descripcion\"); \r\r  } \r  \r  \r   function onChangeCanal(){\r \r  /*\r    Si hay un valor seleccionado en la cbMarca{ \r      Llamar al método recargaCombo utilizando el DTOPeriodo y el \r      idBusiness = \"CRAObtienePeriodos\". \r      \r      Parametro del DTOPeriodo: \r      -DTOPeriodo.marc_oid_marc=oid del valor seleccionado en la cbMarca \r      -DTOPeriodo.periodo.cana_oid_cana=oid del valor seleccionado en la cbCanal \r    }\r  \r  */ \r\r    var pais = get(\"frmFormulario.hPais\");\r    var idioma = get(\"frmFormulario.hIdioma\");    \r\r    var arr = new Array();\r    \r    if(get(\"frmFormulario.cbMarca\") !=\"\"){\r          \r          arr[arr.length] = new Array(\"pais\", pais );\r          arr[arr.length] = new Array(\"oidIdioma\", idioma );\r          arr[arr.length] = new Array(\"marca\", get(\"frmFormulario.cbMarca\")+\"\");\r          arr[arr.length] = new Array(\"canal\", get(\"frmFormulario.cbCanal\")+\"\");          \r                 \r          recargaCombo('frmFormulario.cbPeriodo', 'CRAObtienePeriodos', 'es.indra.sicc.dtos.cra.DTOPeriodo',arr);\r\r    }\r\r  }\r\r\r function onChangeMarca(){\r \r  /*\r    Si hay un valor seleccionado en la cbCanal{ \r      Llamar al método recargaCombo utilizando el DTOPeriodo y el \r      idBusiness = \"CRAObtienePeriodos\". \r  \r      Parametro del DTOPeriodo: \r      -DTOPeriodo.marc_oid_marc=oid del valor seleccionado en la cbMarca \r      -DTOPeriodo.periodo.cana_oid_cana=oid del valor seleccionado en la cbCanal \r      \r      Obtenemos un DTOSalida y cargamos el combo cbPeriodo \r  }\r\r  \r  */ \r\r    var pais = get(\"frmFormulario.hPais\");\r    var idioma = get(\"frmFormulario.hIdioma\");    \r\r    var arr = new Array();\r    \r    if(get(\"frmFormulario.cbCanal\") !=\"\"){\r         \r          \r          arr[arr.length] = new Array(\"pais\", pais );\r          arr[arr.length] = new Array(\"oidIdioma\", idioma );\r          arr[arr.length] = new Array(\"marca\", get(\"frmFormulario.cbMarca\")+\"\");\r          arr[arr.length] = new Array(\"canal\", get(\"frmFormulario.cbCanal\")+\"\");          \r          \r          recargaCombo('frmFormulario.cbPeriodo', 'CRAObtienePeriodos', 'es.indra.sicc.dtos.cra.DTOPeriodo',arr);\r\r    }\r\r  }\r \r function enviar(){\r    /* Llamar a la LPGIS con un envio oculto del frmFormulario y accion=\"enviar\" */\r \r    if (sicc_validaciones_generales()){\r        var can = get(\"frmFormulario.cbCanal\");\r        var mar = get(\"frmFormulario.cbMarca\");\r        var per = get(\"frmFormulario.cbPeriodo\");\r        var lot = get(\"frmFormulario.loteH\");\r          \r        set(\"frmFormulario.observacionesH\", get(\"frmFormulario.areatxtObservaciones\"));\r        set(\"frmFormulario.descripcionH\", get(\"frmFormulario.Descripcion\"));\r        set(\"frmFormulario.canalH\", can);\r        set(\"frmFormulario.marcaH\", mar);\r        set(\"frmFormulario.periodoH\", per);\r        set(\"frmFormulario.loteH\", lot);\r        \r        set(\"frmFormulario.conectorAction\",\"LPGIS\");\r        set(\"frmFormulario.accion\",\"enviar\");\r        \r        enviaSICC(\"frmFormulario\"); \r    }\r \r }\r  \r  \r   \r\r "));
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(19)).setAttribute("nombre","hFormatoFechaPais" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(20)).setAttribute("nombre","marcaH" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(21)).setAttribute("nombre","canalH" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(22)).setAttribute("nombre","periodoH" );
   ...
   private void getXML90(Document doc) {
      v.add(doc.createElement("VAR"));
      ((Element)v.get(23)).setAttribute("nombre","observacionesH" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(24)).setAttribute("nombre","descripcionH" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(25)).setAttribute("nombre","loteH" );
      ...
      ((Element)v.get(26)).setAttribute("nombre","capa" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(57)).setAttribute("cod","844" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(68)).setAttribute("nombre","lblvalorLote" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(76)).setAttribute("onchange","onChangeMarca();" );
      ...
      /* Empieza nodo:83 / Elemento padre: 42   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(42)).appendChild((Element)v.get(83));
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(105)).setAttribute("nombre","areatxtObservaciones" );
   ...
   private void getXML450(Document doc) {
      ...
      /* Empieza nodo:118 / Elemento padre: 85   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(85)).appendChild((Element)v.get(118));
      ...
      /* Empieza nodo:121 / Elemento padre: 35   */
      v.add(doc.createElement("td"));
      ((Element)v.get(35)).appendChild((Element)v.get(121));
      ...
      /* Empieza nodo:123 / Elemento padre: 27   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(27)).appendChild((Element)v.get(123));
      ...
      ((Element)v.get(131)).setAttribute("nombre","btnEnviar" );
      ((Element)v.get(131)).setAttribute("ID","botonContenido" );
      ((Element)v.get(131)).setAttribute("tipo","html" );
      ((Element)v.get(131)).setAttribute("accion","enviar()" );
      ((Element)v.get(131)).setAttribute("estado","false" );
      ((Element)v.get(131)).setAttribute("cod","2264" );
      ((Element)v.get(131)).setAttribute("ontab","focalizaTab();" );
      ...
      /* Empieza nodo:134 / Elemento padre: 27   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(27)).appendChild((Element)v.get(134));
