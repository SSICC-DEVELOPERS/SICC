...
public class CarParamGenerCartePageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","carParamGenerCarteList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","CarParamGenerCarte.nireOidNiveRedo.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","CarParamGenerCarte.numPeriNuev.label" );
      ...
      ((Element)v.get(17)).setAttribute("cod","CarParamGenerCarte.numPeriAnti.label" );
      ...
      ((Element)v.get(18)).setAttribute("cod","CarParamGenerCarte.inijOidIndiNiveJera.label" );
      ...
      ((Element)v.get(19)).setAttribute("alto","22" );
      ((Element)v.get(19)).setAttribute("accion","" );
      ((Element)v.get(19)).setAttribute("tipoEnvio","seleccion" );
      ((Element)v.get(19)).setAttribute("formaEnvio","xml" );
      ((Element)v.get(19)).setAttribute("maxSel","1" );
      ((Element)v.get(19)).setAttribute("msgErrMaxSel","" );
      ((Element)v.get(19)).setAttribute("coloresScrollNativo","#D4D0C8,black,white,#D4D0C8,#D4D0C8,#ECE9E4,black" );
      ((Element)v.get(19)).setAttribute("colorROver","#D0D9E8" );
      ((Element)v.get(19)).setAttribute("onLoad","" );
      ((Element)v.get(19)).setAttribute("colorSelecc","#D0D9E8" );
      ...
      ((Element)v.get(21)).setAttribute("ID","EstDat2" );
      ...
      ((Element)v.get(22)).setAttribute("ID","EstDat" );
      ...
      ((Element)v.get(23)).setAttribute("ID","EstDat2" );
