...
public class SegModulPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","segModulList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","SegModul.codModu.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","SegModul.Descripcion.label" );
