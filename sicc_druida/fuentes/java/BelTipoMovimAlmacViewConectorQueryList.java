...
public class BelTipoMovimAlmacViewConectorQueryList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad BelTipoMovimAlmacView" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGBelTipoMovimAlmacViewQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGBelTipoMovimAlmacViewQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","BelTipoMovimAlmacViewListFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(13)).setAttribute("NOMBRE","codOper1" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(14)).setAttribute("NOMBRE","codOper2" );
