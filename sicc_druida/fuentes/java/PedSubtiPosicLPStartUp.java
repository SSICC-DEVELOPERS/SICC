/*
    INDRA/CAR/mmg
    $Id: PedSubtiPosicLPStartUp.java,v 1.1 2009/12/03 18:41:27 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class PedSubtiPosicLPStartUp extends MMGDruidaBase{
	...
	public PedSubtiPosicLPStartUp(){
		super();
	}

	public void inicio() throws Exception {
		pagina("PedSubtiPosicPage");
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "PedSubtiPosicPage", "cod", "PedSubtiPosic." + accion + ".label");
			...
			limpiarBotoneraLista("pedSubtiPosic", accion);
	...
	protected void cmdLov() throws Exception{
		...
		//asignarAtributo("CAPA", "pedSubtiPosicLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "PedSubtiPosicPage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("PedSubtiPosicLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		PedSubtiPosicData pedSubtiPosicQuery= new PedSubtiPosicData();
		pedSubtiPosicQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		PedSubtiPosicData datosResult = (PedSubtiPosicData)getSingleObject(BUSINESSID_QUERY, pedSubtiPosicQuery, 
			pedSubtiPosicQuery.clone(), "pedSubtiPosic");
		...
		preservaHiddensI18n(new Integer(1), "PED_SUBTI_POSIC", "pedSubtiPosicFrm", "Descripcion", true);
		...
		PedSubtiPosicData pedSubtiPosic = datosResult;
		asignar("TEXT", "codSubtPosi", FormatUtils.formatObject(pedSubtiPosic.getCodSubtPosi(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		es.indra.belcorp.mso.PedTipoPosicData tposOidTipoPosi = pedSubtiPosic.getTposOidTipoPosi();
		if(tposOidTipoPosi != null && tposOidTipoPosi.getId() != null) checkCombo("tposOidTipoPosi" , tposOidTipoPosi.getId().toString());
		asignar("TEXT", "Descripcion", FormatUtils.formatObject(pedSubtiPosic.getDescripcion(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		loadLocalizationVars(pedSubtiPosic);
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "PED_SUBTI_POSIC", "pedSubtiPosicFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('pedSubtiPosicFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "pedSubtiPosicFrm", "oculto", "N");
		...
		traza("MMG::Creando PedSubtiPosic");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		PedSubtiPosicData pedSubtiPosicQuery= new PedSubtiPosicData();
		pedSubtiPosicQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(pedSubtiPosic.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"pedSubtiPosicFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"pedSubtiPosicFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codSubtPosi", "ontab","ejecutarAccionFocoModificacion(\"pedSubtiPosicFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codSubtPosi", "onshtab","ejecutarAccionFocoModificacion(\"pedSubtiPosicFrm\",2, false)");
					asignarAtributo("COMBO","tposOidTipoPosi", "ontab", "ejecutarAccionFocoModificacion(\"pedSubtiPosicFrm\",3, true)");
					asignarAtributo("COMBO","tposOidTipoPosi", "onshtab", "ejecutarAccionFocoModificacion(\"pedSubtiPosicFrm\",3, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"pedSubtiPosicFrm\",4, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"pedSubtiPosicFrm\",4, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","pedSubtiPosicTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","pedSubtiPosicTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","pedSubtiPosicFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","pedSubtiPosicListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","pedSubtiPosicListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(PedSubtiPosicData pedSubtiPosic) throws Exception{
		...
		if(pedSubtiPosic != null && pedSubtiPosic.getTposOidTipoPosi() != null){
				checkCombo("tposOidTipoPosi" , pedSubtiPosic.getTposOidTipoPosi().getId().toString());
			}
	...
	* @param pedSubtiPosic La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(PedSubtiPosicData pedSubtiPosic) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		PedSubtiPosicData pedSubtiPosic = 
			(PedSubtiPosicData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(pedSubtiPosic.getTposOidTipoPosi() != null){
			pedSubtiPosic.setTposOidTipoPosi((es.indra.belcorp.mso.PedTipoPosicData)
			getSingleObject(BUSINESSID_TPOSOIDTIPOPOSI_QUERY, 
			pedSubtiPosic.getTposOidTipoPosi(),
			pedSubtiPosic.getTposOidTipoPosi().clone(),
			"pedTipoPosic"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(pedSubtiPosic);
		loadLeafDependenceCombos(pedSubtiPosic);
	}
	...
	*/
	...
	protected void loadLocalizationVars(PedSubtiPosicData pedSubtiPosic) throws Exception{
		...
		mmgLocalizationQuery.setEntiPk(pedSubtiPosic.getId());
