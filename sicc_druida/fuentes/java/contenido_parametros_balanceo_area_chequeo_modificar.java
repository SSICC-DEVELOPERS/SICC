...
public class contenido_parametros_balanceo_area_chequeo_modificar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_parametros_balanceo_area_chequeo_modificar" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","contenido_parametros_balanceo_area_chequeo_modificar.js" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(12)).setAttribute("nombre","oidParametros" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(13)).setAttribute("nombre","solicitudesLinea" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(14)).setAttribute("nombre","centroDistribucionVD" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(15)).setAttribute("nombre","hCbLineasCDDef" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(33)).setAttribute("nombre","lblDatosDeAlta" );
      ((Element)v.get(33)).setAttribute("alto","13" );
      ((Element)v.get(33)).setAttribute("filas","1" );
      ((Element)v.get(33)).setAttribute("cod","ApeParamBalanAreaCheq.legend.label" );
      ...
      ((Element)v.get(42)).setAttribute("cod","ApeParamBalanAreaCheq.centroDistrib.label" );
      ...
      ((Element)v.get(46)).setAttribute("cod","ApeParamBalanAreaCheq.lineaArmado.label" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(50)).setAttribute("nombre","lblCodigoAgrupacion" );
      ...
      ((Element)v.get(50)).setAttribute("cod","ApeCubicArticFueraPed.codAgrup.label" );
      ...
      ((Element)v.get(67)).setAttribute("nombre","txtCodigoAgrupacion" );
      ((Element)v.get(67)).setAttribute("id","datosCampos" );
      ((Element)v.get(67)).setAttribute("max","6" );
      ((Element)v.get(67)).setAttribute("tipo","" );
      ((Element)v.get(67)).setAttribute("req","N" );
      ((Element)v.get(67)).setAttribute("size","6" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(77)).setAttribute("ontab","" );
      ...
      /* Empieza nodo:78 / Elemento padre: 27   */
      v.add(doc.createElement("td"));
      ((Element)v.get(27)).appendChild((Element)v.get(78));
      ...
      /* Empieza nodo:80 / Elemento padre: 19   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(19)).appendChild((Element)v.get(80));
      ...
      ((Element)v.get(87)).setAttribute("x","7" );
      ((Element)v.get(87)).setAttribute("y","160" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(111)).setAttribute("alto","25" );
      ...
      ((Element)v.get(112)).setAttribute("cod","ApeParamLineaArmado.centroDistrib.label" );
      ((Element)v.get(111)).appendChild((Element)v.get(112));

      /* Elemento padre:112 / Elemento actual: 113   */
      v.add(doc.createTextNode("OID ParamBalanAreaCheck"));
      ...
      ((Element)v.get(114)).setAttribute("cod","ApeParamLineaArmado.centroDistrib.label" );
      ((Element)v.get(111)).appendChild((Element)v.get(114));

      /* Elemento padre:114 / Elemento actual: 115   */
      v.add(doc.createTextNode("OID Centro distribución"));
      ...
      ((Element)v.get(116)).setAttribute("cod","ApeParamLineaArmado.centroDistrib.label" );
      ...
      v.add(doc.createTextNode("OID Linea de Armado"));
      ...
      ((Element)v.get(120)).setAttribute("cod","ApeParamBalanAreaCheq.lineaArmado.label" );
      ...
      ((Element)v.get(122)).setAttribute("cod","ApeParamBalanAreaCheq.tipoSolicitud.label" );
      ((Element)v.get(111)).appendChild((Element)v.get(122));

      /* Elemento padre:122 / Elemento actual: 123   */
      v.add(doc.createTextNode("OID Tipo Solicitud"));
   ...
   private void getXML540(Document doc) {
      ((Element)v.get(124)).setAttribute("cod","ApeCubicArticFueraPed.codAgrup.label" );
      ((Element)v.get(111)).appendChild((Element)v.get(124));

      /* Elemento padre:124 / Elemento actual: 125   */
      v.add(doc.createTextNode("Codigo agrupación"));
      ...
      ((Element)v.get(126)).setAttribute("cod","ApeParamBalanAreaCheq.tipoSolicitud.label" );
      ...
      /* Empieza nodo:128 / Elemento padre: 111   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(128)).setAttribute("colFondo","" );
      ((Element)v.get(128)).setAttribute("ID","EstCab" );
      ((Element)v.get(128)).setAttribute("cod","ApeParamBalanAreaCheq.NroPedArmado.label" );
      ((Element)v.get(111)).appendChild((Element)v.get(128));

      /* Elemento padre:128 / Elemento actual: 129   */
      v.add(doc.createTextNode("Nro Pedidos armado/hora"));
      ...
      ((Element)v.get(130)).setAttribute("cod","ApeParamBalanAreaCheq.NroUniPersona.label" );
      ((Element)v.get(111)).appendChild((Element)v.get(130));

      /* Elemento padre:130 / Elemento actual: 131   */
      v.add(doc.createTextNode("Nro unidades chequeo/hora/persona"));
      ...
      ((Element)v.get(132)).setAttribute("cod","ApeParamBalanAreaCheq.ParamDistrib.label" );
      ((Element)v.get(111)).appendChild((Element)v.get(132));

      /* Elemento padre:132 / Elemento actual: 133   */
      v.add(doc.createTextNode("Parámetros distribución"));
      ...
      /* Empieza nodo:136 / Elemento padre: 88   */
      ...
      ((Element)v.get(136)).setAttribute("onAfterSetDatos","asignarEstadoBotonAvance();" );
      ((Element)v.get(88)).appendChild((Element)v.get(136));
   ...
   private void getXML630(Document doc) {
      ...
      /* Empieza nodo:149 / Elemento padre: 88   */
      v.add(doc.createElement("ROWSET"));
      ((Element)v.get(88)).appendChild((Element)v.get(149));
      /* Termina nodo:149   */

      /* Empieza nodo:150 / Elemento padre: 88   */
      v.add(doc.createElement("PAGINADO"));
      ((Element)v.get(150)).setAttribute("nombre","mipgndo" );
      ((Element)v.get(150)).setAttribute("ancho","679" );
      ((Element)v.get(150)).setAttribute("sep","$" );
      ((Element)v.get(150)).setAttribute("x","12" );
      ((Element)v.get(150)).setAttribute("class","botonera" );
      ((Element)v.get(150)).setAttribute("y","294" );
      ((Element)v.get(150)).setAttribute("control","|" );
      ((Element)v.get(150)).setAttribute("conector","" );
      ((Element)v.get(150)).setAttribute("rowset","" );
      ((Element)v.get(150)).setAttribute("cargainicial","N" );
      ((Element)v.get(150)).setAttribute("onload","procesarPaginado(mipgndo,msgError, ultima, rowset, 'muestraLista(ultima, rowset)')" );
      ((Element)v.get(88)).appendChild((Element)v.get(150));

      /* Empieza nodo:151 / Elemento padre: 150   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(151)).setAttribute("nombre","ret1" );
      ((Element)v.get(151)).setAttribute("x","37" );
      ((Element)v.get(151)).setAttribute("y","282" );
      ...
      ((Element)v.get(152)).setAttribute("y","282" );
      ...
      /* Empieza nodo:153 / Elemento padre: 87   */
      v.add(doc.createElement("BOTON"));
      ...
      ((Element)v.get(153)).setAttribute("tipo","-2" );
      ...
      ((Element)v.get(87)).appendChild((Element)v.get(153));
      /* Termina nodo:153   */
      ...
      ((Element)v.get(154)).setAttribute("y","278" );
      ...
      /* Empieza nodo:155 / Elemento padre: 87   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(155)).setAttribute("nombre","Modificar" );
      ((Element)v.get(155)).setAttribute("x","80" );
      ((Element)v.get(155)).setAttribute("y","279" );
      ...
      ((Element)v.get(155)).setAttribute("cod","2" );
      ((Element)v.get(155)).setAttribute("accion","onClickModificar();" );
      ((Element)v.get(87)).appendChild((Element)v.get(155));
      /* Termina nodo:155   */

      /* Empieza nodo:156 / Elemento padre: 87   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(156)).setAttribute("nombre","Detalle" );
      ((Element)v.get(156)).setAttribute("x","80" );
      ((Element)v.get(156)).setAttribute("y","279" );
   ...
   private void getXML720(Document doc) {
      ((Element)v.get(156)).setAttribute("cod","3" );
      ((Element)v.get(156)).setAttribute("accion","onClickDetalle();" );
      ((Element)v.get(87)).appendChild((Element)v.get(156));
      /* Termina nodo:156   */
      /* Termina nodo:87   */
      ...
      ((Element)v.get(157)).setAttribute("y","428" );
