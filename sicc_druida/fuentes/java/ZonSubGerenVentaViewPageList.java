...
public class ZonSubGerenVentaViewPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","zonSubGerenVentaViewList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(20)).setAttribute("height","20" );
      ...
      ((Element)v.get(21)).setAttribute("cod","ZonSubGerenVentaView.paisOidPais.label" );
      ...
      ((Element)v.get(22)).setAttribute("cod","ZonSubGerenVentaView.codSubgVent.label" );
      ...
      ((Element)v.get(23)).setAttribute("cod","ZonSubGerenVentaView.indBorr.label" );
      ...
      ((Element)v.get(24)).setAttribute("cod","ZonSubGerenVentaView.indActi.label" );
      ...
      ((Element)v.get(25)).setAttribute("cod","ZonSubGerenVentaView.codNse1.label" );
      ...
      ((Element)v.get(26)).setAttribute("cod","ZonSubGerenVentaView.codNse2.label" );
      ...
      ((Element)v.get(27)).setAttribute("cod","ZonSubGerenVentaView.codNse3.label" );
      ...
      ((Element)v.get(28)).setAttribute("cod","ZonSubGerenVentaView.desSubgVent.label" );
      ...
      ((Element)v.get(29)).setAttribute("cod","ZonSubGerenVentaView.marcOidMarc.label" );
      ...
      ((Element)v.get(30)).setAttribute("cod","ZonSubGerenVentaView.canaOidCana.label" );
      ((Element)v.get(20)).appendChild((Element)v.get(30));
      /* Termina nodo:30   */
      /* Termina nodo:20   */

      /* Empieza nodo:31 / Elemento padre: 0   */
      ...
      ((Element)v.get(0)).appendChild((Element)v.get(31));
