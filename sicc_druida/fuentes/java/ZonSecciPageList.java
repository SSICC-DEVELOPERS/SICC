...
public class ZonSecciPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","zonSecciList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(21)).setAttribute("cod","ZonSecci.zzonOidZona.label" );
      ...
      ((Element)v.get(22)).setAttribute("cod","ZonSecci.codSecc.label" );
      ...
      ((Element)v.get(23)).setAttribute("cod","ZonSecci.indActi.label" );
      ...
      ((Element)v.get(24)).setAttribute("cod","ZonSecci.indBorr.label" );
      ...
      ((Element)v.get(25)).setAttribute("cod","ZonSecci.clieOidClie.label" );
      ...
      ((Element)v.get(26)).setAttribute("cod","ZonSecci.codNse1.label" );
      ...
      ((Element)v.get(27)).setAttribute("cod","ZonSecci.codNse2.label" );
      ...
      ((Element)v.get(28)).setAttribute("cod","ZonSecci.codNse3.label" );
      ...
      ((Element)v.get(29)).setAttribute("cod","ZonSecci.desSecci.label" );
      ...
      ((Element)v.get(30)).setAttribute("cod","ZonSecci.fecRezo.label" );
