...
public class CobUsuarEtapaCobraCabecPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","CobUsuarEtapaCobraCabec.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","CobUsuarEtapaCobraCabec.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('cobUsuarEtapaCobraCabecFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('cobUsuarEtapaCobraCabecFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(50)).setAttribute("nombre","uscoOidUsuaCobrTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lbluscoOidUsuaCobr" );
      ((Element)v.get(54)).setAttribute("id","datosTitle" );
      ((Element)v.get(54)).setAttribute("ancho","150" );
      ((Element)v.get(54)).setAttribute("alto","13" );
      ((Element)v.get(54)).setAttribute("cod","CobUsuarEtapaCobraCabec.uscoOidUsuaCobr.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(55)).setAttribute("nombre","uscoOidUsuaCobrWidgetTrId" );
      ...
      ((Element)v.get(57)).setAttribute("nombre","uscoOidUsuaCobr" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('cobUsuarEtapaCobraCabecFrm',2, true);" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('cobUsuarEtapaCobraCabecFrm',2, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(59)).setAttribute("nombre","uscoOidUsuaCobrGapTdId" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(76)).setAttribute("nombre","etdeOidEtapDeudTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(80)).setAttribute("nombre","lbletdeOidEtapDeud" );
      ((Element)v.get(80)).setAttribute("id","datosTitle" );
      ((Element)v.get(80)).setAttribute("ancho","150" );
      ((Element)v.get(80)).setAttribute("alto","13" );
      ((Element)v.get(80)).setAttribute("cod","CobUsuarEtapaCobraCabec.etdeOidEtapDeud.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(81)).setAttribute("nombre","etdeOidEtapDeudWidgetTrId" );
   }
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(83)).setAttribute("nombre","etdeOidEtapDeud" );
      ...
      ((Element)v.get(83)).setAttribute("ontab","ejecutarAccionFoco('cobUsuarEtapaCobraCabecFrm',3, true);" );
      ((Element)v.get(83)).setAttribute("onshtab","ejecutarAccionFoco('cobUsuarEtapaCobraCabecFrm',3, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(85)).setAttribute("nombre","etdeOidEtapDeudGapTdId" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(102)).setAttribute("nombre","valObseTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(106)).setAttribute("nombre","lblValObse" );
      ((Element)v.get(106)).setAttribute("alto","13" );
      ((Element)v.get(106)).setAttribute("filas","1" );
      ((Element)v.get(106)).setAttribute("id","datosTitle" );
      ((Element)v.get(106)).setAttribute("cod","CobUsuarEtapaCobraCabec.valObse.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(107)).setAttribute("nombre","valObseWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(109)).setAttribute("nombre","valObse" );
      ...
      ((Element)v.get(109)).setAttribute("ontab","ejecutarAccionFoco('cobUsuarEtapaCobraCabecFrm',4, true)" );
      ((Element)v.get(109)).setAttribute("onshtab","ejecutarAccionFoco('cobUsuarEtapaCobraCabecFrm', 4, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(110)).setAttribute("nombre","valObseGapTdId" );
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(124)).setAttribute("nombre","cobUsuarEtapaCobraCabecTrButtons" );
      ...
      ((Element)v.get(131)).setAttribute("nombre","cobUsuarEtapaCobraCabecTdQueryButton" );
      ((Element)v.get(130)).appendChild((Element)v.get(131));

      /* Empieza nodo:132 / Elemento padre: 131   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(132)).setAttribute("nombre","cobUsuarEtapaCobraCabecQueryButton" );
      ((Element)v.get(132)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(132)).setAttribute("estado","false" );
      ((Element)v.get(132)).setAttribute("accion","cobUsuarEtapaCobraCabecFirstPage();" );
      ...
      ((Element)v.get(133)).setAttribute("nombre","cobUsuarEtapaCobraCabecTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(135)).setAttribute("nombre","cobUsuarEtapaCobraCabecLovNullButton" );
      ((Element)v.get(135)).setAttribute("ID","botonContenido" );
      ((Element)v.get(135)).setAttribute("tipo","html" );
      ((Element)v.get(135)).setAttribute("accion","cobUsuarEtapaCobraCabecLovNullSelectionAction();" );
