...
public class CccMarcaTipoAbonoPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","cccMarcaTipoAbonoList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","CccMarcaTipoAbono.valObse.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","CccMarcaTipoAbono.masiOidMarcSali.label" );
      ...
      ((Element)v.get(17)).setAttribute("cod","CccMarcaTipoAbono.taspOidTipoAbonSubp.label" );
      ...
      ((Element)v.get(18)).setAttribute("cod","CccMarcaTipoAbono.indEntrSali.label" );
