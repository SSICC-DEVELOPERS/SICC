...
public class MaeEstatClienPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","MaeEstatClien.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","MaeEstatClien.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('maeEstatClienFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('maeEstatClienFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(50)).setAttribute("nombre","tescOidTipoEstaTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lbltescOidTipoEsta" );
      ((Element)v.get(54)).setAttribute("id","datosTitle" );
      ((Element)v.get(54)).setAttribute("ancho","150" );
      ((Element)v.get(54)).setAttribute("alto","13" );
      ((Element)v.get(54)).setAttribute("cod","MaeEstatClien.tescOidTipoEsta.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(55)).setAttribute("nombre","tescOidTipoEstaWidgetTrId" );
      ...
      ((Element)v.get(57)).setAttribute("nombre","tescOidTipoEsta" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('maeEstatClienFrm',2, true);" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('maeEstatClienFrm',2, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(59)).setAttribute("nombre","tescOidTipoEstaGapTdId" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(61)).setAttribute("nombre","codEstaClieTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(66)).setAttribute("nombre","codEstaClieWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(68)).setAttribute("nombre","codEstaClie" );
      ...
      ((Element)v.get(68)).setAttribute("ontab","ejecutarAccionFoco('maeEstatClienFrm',3, true)" );
      ((Element)v.get(68)).setAttribute("onshtab","ejecutarAccionFoco('maeEstatClienFrm', 3, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(69)).setAttribute("nombre","codEstaClieGapTdId" );
      ...
      ((Element)v.get(75)).setAttribute("cod","MaeEstatClien.Descripcion.label" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(79)).setAttribute("ontab","ejecutarAccionFoco('maeEstatClienFrm',4, true)" );
      ((Element)v.get(79)).setAttribute("onshtab","ejecutarAccionFoco('maeEstatClienFrm', 4, false)" );
      ...
      ((Element)v.get(83)).setAttribute("href","javascript:openLocalizationDialog('maeEstatClienFrm', 'Descripcion', 1);" );
      ((Element)v.get(83)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"maeEstatClienFrm\",4, true)', 'ejecutarAccionFoco(\"maeEstatClienFrm\",4, false)')" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(87)).setAttribute("nombre","estaOidEstaClieTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(91)).setAttribute("nombre","lblestaOidEstaClie" );
      ((Element)v.get(91)).setAttribute("id","datosTitle" );
      ((Element)v.get(91)).setAttribute("ancho","150" );
      ((Element)v.get(91)).setAttribute("alto","13" );
      ((Element)v.get(91)).setAttribute("cod","MaeEstatClien.estaOidEstaClie.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(92)).setAttribute("nombre","estaOidEstaClieWidgetTrId" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(94)).setAttribute("nombre","estaOidEstaClie" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(94)).setAttribute("ontab","ejecutarAccionFoco('maeEstatClienFrm',5, true);" );
      ((Element)v.get(94)).setAttribute("onshtab","ejecutarAccionFoco('maeEstatClienFrm',5, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(96)).setAttribute("nombre","estaOidEstaClieGapTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(110)).setAttribute("nombre","maeEstatClienTrButtons" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(117)).setAttribute("nombre","maeEstatClienTdQueryButton" );
      ((Element)v.get(116)).appendChild((Element)v.get(117));

      /* Empieza nodo:118 / Elemento padre: 117   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(118)).setAttribute("nombre","maeEstatClienQueryButton" );
      ((Element)v.get(118)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(118)).setAttribute("estado","false" );
      ((Element)v.get(118)).setAttribute("accion","maeEstatClienFirstPage();" );
      ...
      ((Element)v.get(119)).setAttribute("nombre","maeEstatClienTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(121)).setAttribute("nombre","maeEstatClienLovNullButton" );
      ((Element)v.get(121)).setAttribute("ID","botonContenido" );
      ((Element)v.get(121)).setAttribute("tipo","html" );
      ((Element)v.get(121)).setAttribute("accion","maeEstatClienLovNullSelectionAction();" );
