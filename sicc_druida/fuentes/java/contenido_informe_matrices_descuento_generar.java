...
public class contenido_informe_matrices_descuento_generar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_informe_matrices_descuento_generar" );
      ((Element)v.get(0)).setAttribute("cod","0753" );
      ((Element)v.get(0)).setAttribute("titulo","Generar Informe Matrices de descuento" );
      ...
      v.add(doc.createTextNode("\r   \r   \r   function onLoad(){\r      configurarMenuSecundario('Formulario');\r      fMostrarMensajeError();\r      setearPais();\r      focaliza('Formulario.cbPais');\r   }\r   function generar(formato){\r      \r      if(sicc_validaciones_generales()){\r          /*recolectarParametros();\r          set('Formulario.conectorAction', 'DTOMatricesDescuento');           \r          set('Formulario.accion', 'generar');\r          enviaSICC('Formulario');*/\r          var a = new Object();\r          a.accion = 'generar';\r          a.paisSelec = get('Formulario.cbPais');           \r          mostrarModalSICC('DTOMatricesDescuento','generar', a);  \r    \r      }\r\r   }\r\r   function recolectarParametros(){\r      set('Formulario.paisSelec', get('Formulario.cbPais') );  \r   }\r \r\r    function setearPais(){\r      var pais = get('Formulario.pais');\r      \r      iSeleccionado = new Array(); \r      iSeleccionado[0] = pais;\r      set('Formulario.cbPais',iSeleccionado);\r   }\r\r \r\r\r   \r"));
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(17)).setAttribute("nombre","tipoDescuento" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(18)).setAttribute("nombre","numeroDescuento" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(70)).setAttribute("nombre","btnGenerarInforme" );
      ((Element)v.get(70)).setAttribute("ID","botonContenido" );
      ((Element)v.get(70)).setAttribute("tipo","html" );
      ((Element)v.get(70)).setAttribute("accion","generar();" );
      ((Element)v.get(70)).setAttribute("estado","false" );
      ((Element)v.get(70)).setAttribute("cod","2495" );
      ((Element)v.get(70)).setAttribute("ontab","focaliza('Formulario.cbPais')" );
