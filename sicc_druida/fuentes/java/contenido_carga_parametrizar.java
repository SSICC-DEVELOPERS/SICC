...
public class contenido_carga_parametrizar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_carga_parametrizar" );
      ((Element)v.get(0)).setAttribute("cod","0279" );
      ((Element)v.get(0)).setAttribute("titulo","Parametrizar carga" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","Parametrizar carga" );
      ...
      v.add(doc.createTextNode("\r   \r\r  function onLoadPag()  {\r    configurarMenuSecundario(\"frmUnico\");\r    fMostrarMensajeError();\r        focaliza('frmUnico.textNRegistroProductosGenerados');\r    setearCampos();\r\r  }\r\r\r  function setearCampos()  {\r    set('frmUnico.rbAutorizacionEnvioPago', get('frmUnico.hRbAutorizacionEnvioPago') );\r\r    var seleccionCbEstrategia = new Array( [get('frmUnico.hCbEstrategia')] );\r    set('frmUnico.cbEstrategia',seleccionCbEstrategia);\r\r    var seleccionCbAlmacen = new Array( [get('frmUnico.hCbAlmacen')] );\r    set('frmUnico.cbAlmacen',seleccionCbAlmacen);\r\r    var seleccionCbTipoCliente1 = new Array( [get('frmUnico.hCbTipoCliente1')] );\r    set('frmUnico.cbTipoCliente1',seleccionCbTipoCliente1);\r\r    var seleccionCbTipoCliente2 = new Array( [get('frmUnico.hCbTipoCliente2')] );\r    set('frmUnico.cbTipoCliente2',seleccionCbTipoCliente2);\r\r    var subtiposCliente = get('frmUnico.hCbSubtipoCliente1');\r    var listaValoresSTC = subtiposCliente.split(\"|\");\r    set('frmUnico.cbSubtipoCliente1', listaValoresSTC );\r\r    subtiposCliente = get('frmUnico.hCbSubtipoCliente2');\r    listaValoresSTC = subtiposCliente.split(\"|\");\r    set('frmUnico.cbSubtipoCliente2', listaValoresSTC );\r  }\r\r\r  function fLimpiar()  {\r    focaliza('frmUnico.textNRegistroProductosGenerados');\r    set('frmUnico.rbAutorizacionEnvioPago', get('frmUnico.hRbAutorizacionEnvioPago') );\r    var seleccionCbEstrategia = new Array( [get('frmUnico.hCbEstrategia')] );\r    set('frmUnico.cbEstrategia',seleccionCbEstrategia);\r    var seleccionCbAlmacen = new Array( [get('frmUnico.hCbAlmacen')] );\r    set('frmUnico.cbAlmacen',seleccionCbAlmacen);\r    var seleccionCbTipoCliente1 = new Array( [get('frmUnico.hCbTipoCliente1')] );\r    set('frmUnico.cbTipoCliente1',seleccionCbTipoCliente1);\r    var seleccionCbTipoCliente2 = new Array( [get('frmUnico.hCbTipoCliente2')] );\r    set('frmUnico.cbTipoCliente2',seleccionCbTipoCliente2);\r    recargarCombosSTCRegion();\r    recargarCombosSTCZona();\r  }\r\r\r  function recargarCombosSTCRegion()  {\r    var arr = new Array();\r    arr[arr.length] = new Array(\"oidIdioma\",get('frmUnico.hOidIdioma'));\r        arr[arr.length] = new Array(\"oid\", get('frmUnico.cbTipoCliente1') );\r    recargaCombo(\"frmUnico.cbSubtipoCliente1\", \"MAEobtenerSubtipos\", \"es.indra.sicc.util.DTOOID\", arr, \"setearSTCRegion(datos)\" );\r  }\r\r  function recargarCombosSTCZona()  {\r    var arr = new Array();\r    arr[arr.length] = new Array(\"oidIdioma\",get('frmUnico.hOidIdioma'));\r        arr[arr.length] = new Array(\"oid\", get('frmUnico.cbTipoCliente2') );\r    recargaCombo(\"frmUnico.cbSubtipoCliente2\", \"MAEobtenerSubtipos\", \"es.indra.sicc.util.DTOOID\", arr, \"setearSTCZona(datos)\" );\r  }\r\r  function setearSTCRegion(datos)  {\r    set_combo('frmUnico.cbSubtipoCliente1',[0]);\r    for(i=0;i<datos.length;i++) {\r      var stcRegion = new Array();\r      stcRegion = datos[i];\r      combo_add('frmUnico.cbSubtipoCliente1', stcRegion[0], stcRegion[1]);\r    }\r    if ( get('frmUnico.cbTipoCliente1') == get('frmUnico.hCbTipoCliente1') )  {\r      var subtiposCliente = get('frmUnico.hCbSubtipoCliente1');\r      var listaValoresSTC = subtiposCliente.split(\"|\");\r      set('frmUnico.cbSubtipoCliente1', listaValoresSTC );\r    }\r  }\r\r  function setearSTCZona(datos)  {\r    set_combo('frmUnico.cbSubtipoCliente2',[0]);\r    for(i=0;i<datos.length;i++) {\r      var stcZona = new Array();\r      stcZona = datos[i];\r      combo_add('frmUnico.cbSubtipoCliente2', stcZona[0], stcZona[1]);\r    }\r    if ( get('frmUnico.cbTipoCliente2') == get('frmUnico.hCbTipoCliente2') )  {\r      var subtiposCliente = get('frmUnico.hCbSubtipoCliente2');\r      var listaValoresSTC = subtiposCliente.split(\"|\");\r      set('frmUnico.cbSubtipoCliente2', listaValoresSTC );\r    }\r  }\r\r\r  function focalizar()  {\r    document.selection.empty( get('frmUnico.textNRegistroProductosGenerados') );\r    focaliza('frmUnico.cbSubtipoCliente2');\r  }\r\r\r  function fGuardar()  {\r    if (!sicc_validaciones_generales())  {\r      return;\r    }\r    if ( fValidarNatural(get('frmUnico.textNRegistroProductosGenerados'),'10','0','9999999999') !='OK' )  {\r      focaliza('frmUnico.textNRegistroProductosGenerados');\r      return;\r    }\r    if ( fValidarNatural(get('frmUnico.textLimitePrecio'),'10','0','9999999999') !='OK' )  {\r      focaliza('frmUnico.textLimitePrecio');\r      return;\r    }\r    set('frmUnico.accion','Guardar');\r    enviaSICC('frmUnico');\r  }\r\r\r  function muestraExito()\r  {\r		fMostrarMensajeExito();\r  }\r\r\r\r   \r"));
      ...
      ((Element)v.get(6)).setAttribute("valor","LPParametrizarCarga" );
      ((Element)v.get(5)).appendChild((Element)v.get(6));
      /* Termina nodo:6   */

      /* Empieza nodo:7 / Elemento padre: 5   */
      v.add(doc.createElement("VAR"));
      ((Element)v.get(7)).setAttribute("nombre","hOidIdioma" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(10)).setAttribute("nombre","hOidParametrizacionMAV" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(11)).setAttribute("nombre","hRbAutorizacionEnvioPago" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(12)).setAttribute("nombre","hCbEstrategia" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(13)).setAttribute("nombre","hCbAlmacen" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(14)).setAttribute("nombre","hCbTipoCliente1" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(15)).setAttribute("nombre","hCbTipoCliente2" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(16)).setAttribute("nombre","hCbSubtipoCliente1" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(17)).setAttribute("nombre","hCbSubtipoCliente2" );
      ...
      ((Element)v.get(22)).setAttribute("name","textNRegistroProductosGenerados" );
      ((Element)v.get(22)).setAttribute("required","true" );
      ((Element)v.get(22)).setAttribute("cod","940" );
   }
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(32)).setAttribute("nombre","capaUnica" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(47)).setAttribute("nombre","lblTitDatosCarga" );
      ((Element)v.get(47)).setAttribute("alto","13" );
      ((Element)v.get(47)).setAttribute("filas","1" );
      ((Element)v.get(47)).setAttribute("valor","" );
      ((Element)v.get(47)).setAttribute("cod","00162" );
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(51)).setAttribute("width","642" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(63)).setAttribute("nombre","lblNRegistroProductosGenerados" );
      ...
      ((Element)v.get(63)).setAttribute("cod","940" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(67)).setAttribute("nombre","lblLimitePrecio" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(67)).setAttribute("cod","909" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(71)).setAttribute("nombre","lblAutorizacionEnvioPago" );
      ...
      ((Element)v.get(71)).setAttribute("cod","804" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(78)).setAttribute("nombre","lblPaisActual" );
      ...
      ((Element)v.get(82)).setAttribute("nombre","textNRegistroProductosGenerados" );
      ((Element)v.get(82)).setAttribute("id","datosCampos" );
      ((Element)v.get(82)).setAttribute("max","10" );
      ((Element)v.get(82)).setAttribute("tipo","" );
      ((Element)v.get(82)).setAttribute("onshtab","focalizar();" );
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(86)).setAttribute("nombre","textLimitePrecio" );
      ...
      ((Element)v.get(86)).setAttribute("size","10" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(90)).setAttribute("nombre","rbAutorizacionEnvioPago" );
      ((Element)v.get(90)).setAttribute("tipo","H" );
      ...
      ((Element)v.get(91)).setAttribute("valor","S" );
      ((Element)v.get(91)).setAttribute("check","N" );
      ((Element)v.get(91)).setAttribute("onfocus","" );
      ((Element)v.get(91)).setAttribute("id","datosCampos" );
      ((Element)v.get(91)).setAttribute("cod","117" );
      ...
      v.add(doc.createElement("RBINPUT"));
      ((Element)v.get(93)).setAttribute("valor","N" );
      ((Element)v.get(93)).setAttribute("check","N" );
      ((Element)v.get(93)).setAttribute("onfocus","" );
      ((Element)v.get(93)).setAttribute("id","datosCampos" );
      ((Element)v.get(93)).setAttribute("cod","87" );
      ...
      /* Empieza nodo:100 / Elemento padre: 48   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(48)).appendChild((Element)v.get(100));
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(102)).setAttribute("width","642" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(111)).setAttribute("nombre","lblAlmacen" );
      ...
      ((Element)v.get(111)).setAttribute("cod","797" );
      ...
      ((Element)v.get(118)).setAttribute("nombre","cbEstrategia" );
      ...
      ((Element)v.get(126)).setAttribute("VALOR","0" );
      ...
      ((Element)v.get(127)).setAttribute("VALOR","almacenHC" );
   ...
   private void getXML540(Document doc) {
      ...
      /* Empieza nodo:133 / Elemento padre: 48   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(48)).appendChild((Element)v.get(133));
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(135)).setAttribute("width","642" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(140)).setAttribute("nombre","lblDireccionElectronica" );
      ...
      ((Element)v.get(140)).setAttribute("cod","850" );
      ...
      /* Empieza nodo:153 / Elemento padre: 41   */
      v.add(doc.createElement("td"));
      ((Element)v.get(41)).appendChild((Element)v.get(153));
      ...
      /* Empieza nodo:155 / Elemento padre: 33   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(33)).appendChild((Element)v.get(155));
   ...
   private void getXML630(Document doc) {
      ...
      ((Element)v.get(157)).setAttribute("height","15" );
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(158)).setAttribute("width","750" );
      ...
      ((Element)v.get(161)).setAttribute("height","15" );
      ((Element)v.get(160)).appendChild((Element)v.get(161));
      /* Termina nodo:161   */
      /* Termina nodo:160   */
      /* Termina nodo:155   */

      /* Empieza nodo:162 / Elemento padre: 33   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(33)).appendChild((Element)v.get(162));
      ...
      v.add(doc.createElement("legend"));
      ((Element)v.get(167)).setAttribute("class","legend" );
      ((Element)v.get(166)).appendChild((Element)v.get(167));

      /* Empieza nodo:168 / Elemento padre: 167   */
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(168)).setAttribute("nombre","lblTitGerentesRegion" );
      ((Element)v.get(168)).setAttribute("alto","13" );
      ((Element)v.get(168)).setAttribute("filas","1" );
      ((Element)v.get(168)).setAttribute("valor","" );
      ((Element)v.get(168)).setAttribute("cod","00160" );
      ((Element)v.get(168)).setAttribute("id","legend" );
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(172)).setAttribute("width","642" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(180)).setAttribute("nombre","lblTipoCliente1" );
   ...
   private void getXML720(Document doc) {
      ((Element)v.get(180)).setAttribute("cod","1301" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(184)).setAttribute("nombre","lblSubtipoCliente1" );
      ...
      ((Element)v.get(184)).setAttribute("cod","1302" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(191)).setAttribute("nombre","cbTipoCliente1" );
      ...
      ((Element)v.get(191)).setAttribute("onchange","recargarCombosSTCRegion();" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(196)).setAttribute("nombre","cbSubtipoCliente1" );
      ((Element)v.get(196)).setAttribute("id","datosCampos" );
      ((Element)v.get(196)).setAttribute("size","5" );
      ((Element)v.get(196)).setAttribute("multiple","S" );
   ...
   private void getXML810(Document doc) {
      ...
      /* Empieza nodo:203 / Elemento padre: 162   */
      v.add(doc.createElement("td"));
      ((Element)v.get(162)).appendChild((Element)v.get(203));
      ...
      /* Empieza nodo:205 / Elemento padre: 33   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(33)).appendChild((Element)v.get(205));
      ...
      ((Element)v.get(207)).setAttribute("height","15" );
      ...
      ((Element)v.get(211)).setAttribute("height","15" );
      ((Element)v.get(210)).appendChild((Element)v.get(211));
      /* Termina nodo:211   */
      /* Termina nodo:210   */
      /* Termina nodo:205   */

      /* Empieza nodo:212 / Elemento padre: 33   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(33)).appendChild((Element)v.get(212));
      ...
      v.add(doc.createElement("legend"));
      ((Element)v.get(217)).setAttribute("class","legend" );
      ((Element)v.get(216)).appendChild((Element)v.get(217));

      /* Empieza nodo:218 / Elemento padre: 217   */
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(218)).setAttribute("nombre","lblTitGerentesZona" );
      ((Element)v.get(218)).setAttribute("alto","13" );
      ((Element)v.get(218)).setAttribute("filas","1" );
      ((Element)v.get(218)).setAttribute("valor","" );
      ((Element)v.get(218)).setAttribute("cod","00161" );
      ((Element)v.get(218)).setAttribute("id","legend" );
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(222)).setAttribute("width","642" );
   ...
   private void getXML900(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(230)).setAttribute("nombre","lblTipoCliente2" );
      ...
      ((Element)v.get(230)).setAttribute("cod","1301" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(234)).setAttribute("nombre","lblSubtipoCliente2" );
      ...
      ((Element)v.get(234)).setAttribute("cod","1302" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(241)).setAttribute("nombre","cbTipoCliente2" );
      ...
      ((Element)v.get(241)).setAttribute("onchange","recargarCombosSTCZona();" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(246)).setAttribute("nombre","cbSubtipoCliente2" );
      ((Element)v.get(246)).setAttribute("id","datosCampos" );
      ((Element)v.get(246)).setAttribute("size","5" );
      ((Element)v.get(246)).setAttribute("multiple","S" );
      ...
      ((Element)v.get(246)).setAttribute("ontab","focaliza('frmUnico.textNRegistroProductosGenerados');" );
   ...
   private void getXML990(Document doc) {
      ...
      /* Empieza nodo:253 / Elemento padre: 212   */
      v.add(doc.createElement("td"));
      ((Element)v.get(212)).appendChild((Element)v.get(253));
      ...
      /* Empieza nodo:255 / Elemento padre: 33   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(33)).appendChild((Element)v.get(255));
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(258)).setAttribute("width","750" );
