...
public class ConectorConsultarPeriodosCRA  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Busqueda Periodo" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","DTOCriteriosPeriodos" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(23)).setAttribute("LONGITUD","20" );
