...
public class SegAccesPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","segAccesList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","SegAcces.codAcce.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","SegAcces.Descripcion.label" );
      ...
      ((Element)v.get(17)).setAttribute("cod","SegAcces.canaOidCana.label" );
      ...
      ((Element)v.get(18)).setAttribute("cod","SegAcces.indAcce.label" );
