...
public class CobTipoBalanConectorQueryList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad CobTipoBalan" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGCobTipoBalanQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGCobTipoBalanQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","CobTipoBalanListFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","codTipoBala" );
