...
/*
    INDRA/CAR/mmg
    $Id: SegCanalListFormatter.java,v 1.1 2009/12/03 18:40:32 pecbazalar Exp $
    DESC
*/
 ...
 * @author Indra
 */
public class SegCanalListFormatter extends MMGDruidaFormatoObjeto {
	
	public SegCanalListFormatter() {
	}
		...
		for (int i = 0; i < segCanalList.size(); i++) {
			...
			row.add((segCanalData.getDescripcion() != null ? 
				FormatUtils.formatObject(segCanalData.getDescripcion(), 
				 MMGDruidaHelper.getUserDecimalFormatPattern(this), 
				symbols) : ""));
			row.add((segCanalData.getTipeOidTipoPeri() != null ? 
				FormatUtils.formatObject(segCanalData.getTipeOidTipoPeri(), 
				 MMGDruidaHelper.getUserDecimalFormatPattern(this), 
				symbols) : ""));
