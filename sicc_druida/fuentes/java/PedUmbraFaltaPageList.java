...
public class PedUmbraFaltaPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","pedUmbraFaltaList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","PedUmbraFalta.negoOidNego.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","PedUmbraFalta.valUmbrFalt.label" );
