...
public class INCGanadorasPorUA extends LPSICCBase {
   
  public INCGanadorasPorUA() {
    super();
  }
     ...
     try {
        ...
        if (accion.equals("generar")){
          ...
          //cargarPagina();
           ...
           cargarPagina();
           getConfiguracionMenu("INCGanadorasPorUA");
        }
...
//        pagina("contenido_informe_pedidos_escala_generar");
 ...
 private void cargarPagina() throws Exception{
     pagina("contenido_informe_ganadoras_unidad_generar");   
...
private ComposerViewElementList crearParametrosEntrada() throws Exception{
  ...
  private void generarReporte() throws Exception{
    ...
    String nroconcurso = conectorParametroLimpia("numeroConcurso", "", true);
    datos.put(ConstantesREP.NUMEROCONCURSO, nroconcurso);
    
    
    
    datos.put(ConstantesREP.TITULO, "Ganadoras por Unidad Administrativa");
    ...
    if(region.equals("")){
       reporte = "RD_REP-078_02";    
    }else{
       if(zona.equals("")){
          reporte = "RD_REP-078_01";
       }else{
          reporte = "RD_REP-078";
       }
    }    
