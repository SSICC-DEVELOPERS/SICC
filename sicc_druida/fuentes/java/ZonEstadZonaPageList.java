...
public class ZonEstadZonaPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","zonEstadZonaList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(19)).setAttribute("cod","ZonEstadZona.codEstaZona.label" );
      ...
      ((Element)v.get(20)).setAttribute("cod","ZonEstadZona.marcOidMarc.label" );
      ...
      ((Element)v.get(21)).setAttribute("cod","ZonEstadZona.Descripcion.label" );
      ...
      ((Element)v.get(22)).setAttribute("cod","ZonEstadZona.indInic.label" );
      ...
      ((Element)v.get(23)).setAttribute("cod","ZonEstadZona.impoVentMini.label" );
      ...
      ((Element)v.get(24)).setAttribute("cod","ZonEstadZona.numConsMin.label" );
      ...
      ((Element)v.get(25)).setAttribute("cod","ZonEstadZona.numPediZona.label" );
      ...
      ((Element)v.get(26)).setAttribute("cod","ZonEstadZona.valoTiemMini.label" );
