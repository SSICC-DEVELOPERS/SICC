...
public class contenido_cierre_tramitar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_cierre_tramitar" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","contenido_cierre_tramitar.js" );
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(9)).setAttribute("name","cbTipoCierre" );
      ((Element)v.get(9)).setAttribute("required","true" );
      ((Element)v.get(9)).setAttribute("cod","1906" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(19)).setAttribute("nombre","errDescription" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(21)).setAttribute("nombre","ConstantesFAC_TIPO_CIERRE_PERIODO" );
   ...
   private void getXML90(Document doc) {
      v.add(doc.createElement("VAR"));
      ((Element)v.get(22)).setAttribute("nombre","ConstantesFAC_TIPO_CIERRE_REGION" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(23)).setAttribute("nombre","ConstantesFAC_TIPO_CIERRE_ZONA" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(24)).setAttribute("nombre","codTipoCierre" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(25)).setAttribute("nombre","listaRegiones" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(26)).setAttribute("nombre","listaZonas" );
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(45)).setAttribute("width","525" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(47)).setAttribute("colspan","7" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(68)).setAttribute("onshtab","focalizaAnterior();" );
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(87)).setAttribute("width","525" );
   ...
   private void getXML360(Document doc) {
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(92)).setAttribute("nombre","lblTipoCierre" );
      ...
      ((Element)v.get(92)).setAttribute("cod","1906" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(96)).setAttribute("nombre","lblRegiones" );
      ...
      ((Element)v.get(96)).setAttribute("cod","1308" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(100)).setAttribute("nombre","lblZonas" );
      ...
      ((Element)v.get(100)).setAttribute("cod","1309" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(107)).setAttribute("nombre","cbTipoCierre" );
      ...
      ((Element)v.get(107)).setAttribute("onchange","tipoCierreOnChange()" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(112)).setAttribute("nombre","cbRegiones" );
      ((Element)v.get(112)).setAttribute("id","datosCampos" );
      ((Element)v.get(112)).setAttribute("size","5" );
   }

   private void getXML450(Document doc) {
      ((Element)v.get(112)).setAttribute("onchange","regionOnSelect()" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(116)).setAttribute("nombre","cbZonas" );
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(120)).setAttribute("colspan","11" );
      ...
      /* Empieza nodo:122 / Elemento padre: 35   */
      v.add(doc.createElement("td"));
      ((Element)v.get(35)).appendChild((Element)v.get(122));
      ...
      /* Empieza nodo:124 / Elemento padre: 27   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(27)).appendChild((Element)v.get(124));
      ...
      ((Element)v.get(132)).setAttribute("nombre","btnCerrar" );
      ((Element)v.get(132)).setAttribute("ID","botonContenido" );
      ((Element)v.get(132)).setAttribute("tipo","html" );
      ((Element)v.get(132)).setAttribute("accion","cerrarOnClick();" );
      ((Element)v.get(132)).setAttribute("estado","false" );
      ((Element)v.get(132)).setAttribute("cod","1907" );
      ((Element)v.get(132)).setAttribute("ontab","focalizaSiguiente('frmFormulario.cbMarca');" );
      ...
      /* Empieza nodo:135 / Elemento padre: 27   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(27)).appendChild((Element)v.get(135));
