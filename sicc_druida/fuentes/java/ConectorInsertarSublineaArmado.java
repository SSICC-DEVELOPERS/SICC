...
public class ConectorInsertarSublineaArmado  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","APE Conector Insertar Sublinea Armado" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","DTOSublineaArmado" );
