...
public class COMComisionesCobranza extends LPSICCBase {           
   public COMComisionesCobranza() {	 
     super();
  }
     ...
     try {
        ...
        if (accion.equals("generar")){
          ...
          //cargarPagina();
           ...
           cargarPagina();
           getConfiguracionMenu("COMComisionesCobranza");
        }
  ...
  private void cargarPagina() throws Exception{
     pagina("contenido_informe_comisiones_cobranza_generar");   
 ...
 private void generarReporte() throws Exception{
     ...
     datos.put(ConstantesREP.TITULO, "Comisiones por Cobranza");     
...
//     ejecutarReporte(datos, "REPGenerarReporte", "RD_REP-144", formato);
     ejecutarReporte2(datos, "REPGenerarReporteBatch", "RD_REP-144", formato);
