/*
    INDRA/CAR/mmg
    $Id: MaeTipoClasiClienLPStartUp.java,v 1.1 2009/12/03 18:40:20 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class MaeTipoClasiClienLPStartUp extends MMGDruidaBase{
	...
	public MaeTipoClasiClienLPStartUp(){
		super();
	}

	public void inicio() throws Exception {
		pagina("MaeTipoClasiClienPage");
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			buildJsPageSize("MaeTipoClasiClien");
			...
			asignarAtributo("PAGINA", "MaeTipoClasiClienPage", "cod", "MaeTipoClasiClien." + accion + ".label");
			...
			limpiarBotoneraLista("maeTipoClasiClien", accion);
	...
	protected void cmdLov() throws Exception{
		...
		//asignarAtributo("CAPA", "maeTipoClasiClienLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "MaeTipoClasiClienPage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("MaeTipoClasiClienLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		MaeTipoClasiClienData maeTipoClasiClienQuery= new MaeTipoClasiClienData();
		maeTipoClasiClienQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		MaeTipoClasiClienData datosResult = (MaeTipoClasiClienData)getSingleObject(BUSINESSID_QUERY, maeTipoClasiClienQuery, 
			maeTipoClasiClienQuery.clone(), "maeTipoClasiClien");
		...
		preservaHiddensI18n(new Integer(1), "MAE_TIPO_CLASI_CLIEN", "maeTipoClasiClienFrm", "Descripcion", true);
		...
		MaeTipoClasiClienData maeTipoClasiClien = datosResult;
		es.indra.belcorp.mso.MaeSubtiClienData sbtiOidSubtClie = maeTipoClasiClien.getSbtiOidSubtClie();
		if(sbtiOidSubtClie != null && sbtiOidSubtClie.getId() != null) checkCombo("sbtiOidSubtClie" , sbtiOidSubtClie.getId().toString());
		asignar("TEXT", "codTipoClas", FormatUtils.formatObject(maeTipoClasiClien.getCodTipoClas(), 
		...
		loadLocalizationVars(maeTipoClasiClien);
		...
		//Deshabilitamos todos los campos para que no se editen
					...
					asignarAtributo("COMBO", "sbtiOidSubtClie", "disabled", "S");asignarAtributo("TEXT", "codTipoClas", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "MAE_TIPO_CLASI_CLIEN", "maeTipoClasiClienFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('maeTipoClasiClienFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "maeTipoClasiClienFrm", "oculto", "N");
		...
		traza("MMG::Creando MaeTipoClasiClien");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		MaeTipoClasiClienData maeTipoClasiClienQuery= new MaeTipoClasiClienData();
		maeTipoClasiClienQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(maeTipoClasiClien.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"maeTipoClasiClienFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"maeTipoClasiClienFrm\",1, false)");
					asignarAtributo("COMBO","sbtiOidSubtClie_ticlOidTipoClie", "ontab", "ejecutarAccionFocoModificacion(\"maeTipoClasiClienFrm\",2, true)");
					asignarAtributo("COMBO","sbtiOidSubtClie_ticlOidTipoClie", "onshtab", "ejecutarAccionFocoModificacion(\"maeTipoClasiClienFrm\",2, false)");
					asignarAtributo("COMBO","sbtiOidSubtClie", "ontab", "ejecutarAccionFocoModificacion(\"maeTipoClasiClienFrm\",2, true)");
					asignarAtributo("COMBO","sbtiOidSubtClie", "onshtab", "ejecutarAccionFocoModificacion(\"maeTipoClasiClienFrm\",2, false)");
				asignarAtributo("AREATEXTO", "codTipoClas", "ontab","ejecutarAccionFocoModificacion(\"maeTipoClasiClienFrm\",3, true)");
				asignarAtributo("AREATEXTO", "codTipoClas", "onshtab","ejecutarAccionFocoModificacion(\"maeTipoClasiClienFrm\",3, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"maeTipoClasiClienFrm\",4, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"maeTipoClasiClienFrm\",4, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","maeTipoClasiClienTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","maeTipoClasiClienTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","maeTipoClasiClienFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","maeTipoClasiClienListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","maeTipoClasiClienListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(MaeTipoClasiClienData maeTipoClasiClien) throws Exception{
		...
		if(maeTipoClasiClien != null && maeTipoClasiClien.getSbtiOidSubtClie().getTiclOidTipoClie() != null){
				checkCombo("sbtiOidSubtClie_ticlOidTipoClie" , maeTipoClasiClien.getSbtiOidSubtClie().getTiclOidTipoClie().getId().toString());
			}
	...
	* @param maeTipoClasiClien La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(MaeTipoClasiClienData maeTipoClasiClien) 
		throws Exception{
		
						if(maeTipoClasiClien.getSbtiOidSubtClie() != null){
			
						MaeSubtiClienData sbtiOidSubtClie = new MaeSubtiClienData();
			sbtiOidSubtClie.setTiclOidTipoClie(maeTipoClasiClien.getSbtiOidSubtClie().getTiclOidTipoClie());
			...
			checkCombo("sbtiOidSubtClie" , maeTipoClasiClien.getSbtiOidSubtClie().getId().toString());
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		MaeTipoClasiClienData maeTipoClasiClien = 
			(MaeTipoClasiClienData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(maeTipoClasiClien.getSbtiOidSubtClie() != null){
			maeTipoClasiClien.setSbtiOidSubtClie((es.indra.belcorp.mso.MaeSubtiClienData)
			getSingleObject(BUSINESSID_SBTIOIDSUBTCLIE_QUERY, 
			maeTipoClasiClien.getSbtiOidSubtClie(),
			maeTipoClasiClien.getSbtiOidSubtClie().clone(),
			"maeSubtiClien"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(maeTipoClasiClien);
		loadLeafDependenceCombos(maeTipoClasiClien);
	}
	...
	*/
	...
	protected void loadLocalizationVars(MaeTipoClasiClienData maeTipoClasiClien) throws Exception{
		...
		mmgLocalizationQuery.setEntiPk(maeTipoClasiClien.getId());
