/*
    INDRA/CAR/mmg
    $Id: MaeTipoEstatClienLPStartUp.java,v 1.1 2009/12/03 18:38:33 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class MaeTipoEstatClienLPStartUp extends MMGDruidaBase{
	...
	public static final String BUSINESSID_QUERY = "MMGMaeTipoEstatClienQueryFromToUserPage";
	...
	public MaeTipoEstatClienLPStartUp(){
		super();
	}

	public void inicio() throws Exception {
		pagina("MaeTipoEstatClienPage");
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			buildJsPageSize("MaeTipoEstatClien");
			...
			asignarAtributo("PAGINA", "MaeTipoEstatClienPage", "cod", "MaeTipoEstatClien." + accion + ".label");
			...
			limpiarBotoneraLista("maeTipoEstatClien", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codTipoEsta", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 2);");
		...
		//asignarAtributo("CAPA", "maeTipoEstatClienLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "MaeTipoEstatClienPage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("MaeTipoEstatClienLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		MaeTipoEstatClienData maeTipoEstatClienQuery= new MaeTipoEstatClienData();
		maeTipoEstatClienQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		MaeTipoEstatClienData datosResult = (MaeTipoEstatClienData)getSingleObject(BUSINESSID_QUERY, maeTipoEstatClienQuery, 
			maeTipoEstatClienQuery.clone(), "maeTipoEstatClien");
		...
		preservaHiddensI18n(new Integer(1), "MAE_TIPO_ESTAT_CLIEN", "maeTipoEstatClienFrm", "Descripcion", true);
		...
		MaeTipoEstatClienData maeTipoEstatClien = datosResult;
		asignar("TEXT", "codTipoEsta", FormatUtils.formatObject(maeTipoEstatClien.getCodTipoEsta(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		es.indra.belcorp.mso.SegMarcaData marcOidMarc = maeTipoEstatClien.getMarcOidMarc();
		...
		loadLocalizationVars(maeTipoEstatClien);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "codTipoEsta", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "MAE_TIPO_ESTAT_CLIEN", "maeTipoEstatClienFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "codTipoEsta", "req", "S");
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('maeTipoEstatClienFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "maeTipoEstatClienFrm", "oculto", "N");
		...
		traza("MMG::Creando MaeTipoEstatClien");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		MaeTipoEstatClienData maeTipoEstatClienQuery= new MaeTipoEstatClienData();
		maeTipoEstatClienQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(maeTipoEstatClien.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"maeTipoEstatClienFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"maeTipoEstatClienFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codTipoEsta", "ontab","ejecutarAccionFocoModificacion(\"maeTipoEstatClienFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codTipoEsta", "onshtab","ejecutarAccionFocoModificacion(\"maeTipoEstatClienFrm\",2, false)");
					asignarAtributo("COMBO","marcOidMarc", "ontab", "ejecutarAccionFocoModificacion(\"maeTipoEstatClienFrm\",3, true)");
					asignarAtributo("COMBO","marcOidMarc", "onshtab", "ejecutarAccionFocoModificacion(\"maeTipoEstatClienFrm\",3, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"maeTipoEstatClienFrm\",4, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"maeTipoEstatClienFrm\",4, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","maeTipoEstatClienTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","maeTipoEstatClienTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","maeTipoEstatClienFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","maeTipoEstatClienListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","maeTipoEstatClienListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(MaeTipoEstatClienData maeTipoEstatClien) throws Exception{
		...
		if(maeTipoEstatClien != null && maeTipoEstatClien.getMarcOidMarc() != null){
				checkCombo("marcOidMarc" , maeTipoEstatClien.getMarcOidMarc().getId().toString());
			}
	...
	* @param maeTipoEstatClien La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(MaeTipoEstatClienData maeTipoEstatClien) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		MaeTipoEstatClienData maeTipoEstatClien = 
			(MaeTipoEstatClienData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(maeTipoEstatClien.getMarcOidMarc() != null){
			maeTipoEstatClien.setMarcOidMarc((es.indra.belcorp.mso.SegMarcaData)
			getSingleObject(BUSINESSID_MARCOIDMARC_QUERY, 
			maeTipoEstatClien.getMarcOidMarc(),
			maeTipoEstatClien.getMarcOidMarc().clone(),
			"segMarca"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(maeTipoEstatClien);
		loadLeafDependenceCombos(maeTipoEstatClien);
	}
	...
	*/
	...
	protected void loadLocalizationVars(MaeTipoEstatClienData maeTipoEstatClien) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("MAE_TIPO_ESTAT_CLIEN");
		mmgLocalizationQuery.setEntiPk(maeTipoEstatClien.getId());
