...
public class PedProgrConectorUpdate  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la modificacion de un  elemento de la entidad PedProgr" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGPedProgrUpdateID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGPedProgrUpdateDTO" );
