...
public class ComTipoClienComisDetalPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","comTipoClienComisDetalList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","ComTipoClienComisDetal.tcccOidTipoClieComiCabe.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","ComTipoClienComisDetal.clasOidClas.label" );
   ...
   private void getXML90(Document doc) {
      ((Element)v.get(15)).setAttribute("accion","" );
      ((Element)v.get(15)).setAttribute("tipoEnvio","seleccion" );
      ((Element)v.get(15)).setAttribute("formaEnvio","xml" );
      ((Element)v.get(15)).setAttribute("maxSel","1" );
      ((Element)v.get(15)).setAttribute("msgErrMaxSel","" );
      ((Element)v.get(15)).setAttribute("coloresScrollNativo","#D4D0C8,black,white,#D4D0C8,#D4D0C8,#ECE9E4,black" );
      ((Element)v.get(15)).setAttribute("colorROver","#D0D9E8" );
      ((Element)v.get(15)).setAttribute("onLoad","" );
      ((Element)v.get(15)).setAttribute("colorSelecc","#D0D9E8" );
      ((Element)v.get(0)).appendChild((Element)v.get(15));

      /* Empieza nodo:16 / Elemento padre: 15   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(16)).setAttribute("tipo","texto" );
      ((Element)v.get(16)).setAttribute("ID","EstDat" );
      ...
      ((Element)v.get(17)).setAttribute("ID","EstDat2" );
