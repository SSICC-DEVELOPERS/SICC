...
public class IntImporContaFactuPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","intImporContaFactuList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","IntImporContaFactu.codImpoCont.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","IntImporContaFactu.valIdenCabeDeta.label" );
      ...
      ((Element)v.get(17)).setAttribute("cod","IntImporContaFactu.valDescImpo.label" );
      ...
      ((Element)v.get(18)).setAttribute("cod","IntImporContaFactu.valObse.label" );
