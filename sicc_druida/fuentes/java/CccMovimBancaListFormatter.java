...
/*
    INDRA/CAR/mmg
    $Id: CccMovimBancaListFormatter.java,v 1.1 2009/12/03 18:38:39 pecbazalar Exp $
    DESC
*/
 ...
 * @author Indra
 */
public class CccMovimBancaListFormatter extends MMGDruidaFormatoObjeto {
	
	public CccMovimBancaListFormatter() {
	}
	...
	public void formatea(String s, Object obj) throws Exception {
		...
		for (int i = 0; i < cccMovimBancaList.size(); i++) {
			...
			row.add((cccMovimBancaData.getSociOidSoci() != null ? 
				FormatUtils.formatObject(cccMovimBancaData.getSociOidSoci(), 
				 MMGDruidaHelper.getUserDecimalFormatPattern(this), 
				MMGDruidaHelper.getUserDecimalFormatSymbols(this)) : ""));
			row.add((cccMovimBancaData.getSubpOidMarcUlti() != null ? 
				FormatUtils.formatObject(cccMovimBancaData.getSubpOidMarcUlti(), 
				 MMGDruidaHelper.getUserDecimalFormatPattern(this), 
				MMGDruidaHelper.getUserDecimalFormatSymbols(this)) : ""));
			row.add((cccMovimBancaData.getSubpOidMarcCrea() != null ? 
				FormatUtils.formatObject(cccMovimBancaData.getSubpOidMarcCrea(), 
				 MMGDruidaHelper.getUserDecimalFormatPattern(this), 
				MMGDruidaHelper.getUserDecimalFormatSymbols(this)) : ""));
			row.add((cccMovimBancaData.getTcabOidAbonUlti() != null ? 
				FormatUtils.formatObject(cccMovimBancaData.getTcabOidAbonUlti(), 
				 MMGDruidaHelper.getUserDecimalFormatPattern(this), 
				MMGDruidaHelper.getUserDecimalFormatSymbols(this)) : ""));
			row.add((cccMovimBancaData.getTcabOidAbonCrea() != null ? 
				FormatUtils.formatObject(cccMovimBancaData.getTcabOidAbonCrea(), 
				 MMGDruidaHelper.getUserDecimalFormatPattern(this), 
				MMGDruidaHelper.getUserDecimalFormatSymbols(this)) : ""));
			row.add((cccMovimBancaData.getTtraOidTipoTrans() != null ? 
				FormatUtils.formatObject(cccMovimBancaData.getTtraOidTipoTrans(), 
				 MMGDruidaHelper.getUserDecimalFormatPattern(this), 
				MMGDruidaHelper.getUserDecimalFormatSymbols(this)) : ""));
			row.add((cccMovimBancaData.getCcbaOidCcBanc() != null ? 
				FormatUtils.formatObject(cccMovimBancaData.getCcbaOidCcBanc(), 
				 MMGDruidaHelper.getUserDecimalFormatPattern(this), 
				MMGDruidaHelper.getUserDecimalFormatSymbols(this)) : ""));
