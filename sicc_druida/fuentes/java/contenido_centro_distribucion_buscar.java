...
public class contenido_centro_distribucion_buscar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(5)).setAttribute("src","contenido_centro_distribucion_buscar.js" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(16)).setAttribute("nombre","hOidCentroDistribucion" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(41)).setAttribute("cod","2054" );
      ...
      ((Element)v.get(45)).setAttribute("cod","MMGGlobal.localization.description.label" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(52)).setAttribute("onshtab","onShTab('cbCentroDistribucion');" );
      ...
      /* Empieza nodo:64 / Elemento padre: 29   */
      v.add(doc.createElement("fieldset"));
      ((Element)v.get(29)).appendChild((Element)v.get(64));
      ...
      ((Element)v.get(68)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(68)).setAttribute("ontab","onTab('btnBuscar');" );
      ((Element)v.get(68)).setAttribute("onshtab","onShTab('btnBuscar');" );
   }
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(69)).setAttribute("nombre","capaLista" );
      ((Element)v.get(69)).setAttribute("ancho","100%" );
      ((Element)v.get(69)).setAttribute("alto","330" );
      ((Element)v.get(69)).setAttribute("x","5" );
      ((Element)v.get(69)).setAttribute("y","120" );
      ...
      ((Element)v.get(69)).setAttribute("visibilidad","" );
      ...
      ((Element)v.get(70)).setAttribute("nombre","listado1" );
      ((Element)v.get(70)).setAttribute("ancho","679" );
      ((Element)v.get(70)).setAttribute("alto","301" );
      ((Element)v.get(70)).setAttribute("x","12" );
      ((Element)v.get(70)).setAttribute("y","0" );
      ((Element)v.get(70)).setAttribute("colorFondo","#CECFCE" );
      ((Element)v.get(70)).setAttribute("msgDebugJS","S" );
      ((Element)v.get(69)).appendChild((Element)v.get(70));

      /* Empieza nodo:71 / Elemento padre: 70   */
      v.add(doc.createElement("IMGBOTONES"));
      ((Element)v.get(71)).setAttribute("precarga","S" );
      ((Element)v.get(71)).setAttribute("conROver","S" );
      ((Element)v.get(70)).appendChild((Element)v.get(71));

      /* Empieza nodo:72 / Elemento padre: 71   */
      v.add(doc.createElement("BTNSELECCION"));
      ((Element)v.get(72)).setAttribute("normal","btnLista2N.gif" );
      ((Element)v.get(72)).setAttribute("rollOver","btnLista2S.gif" );
      ((Element)v.get(72)).setAttribute("seleccionado","btnLista2M.gif" );
      ((Element)v.get(72)).setAttribute("desactivado","btnLista2D.gif" );
      ((Element)v.get(71)).appendChild((Element)v.get(72));
      /* Termina nodo:72   */

      /* Empieza nodo:73 / Elemento padre: 71   */
      v.add(doc.createElement("BTNMINIMIZAR"));
      ((Element)v.get(73)).setAttribute("minimizar","bot_pliega_columna_on.gif" );
      ((Element)v.get(73)).setAttribute("minimROver","bot_pliega_columna_over.gif" );
      ((Element)v.get(73)).setAttribute("maximizar","bot_despliega_columna_on.gif" );
      ((Element)v.get(73)).setAttribute("aximROver","bot_despliega_columna_over.gif" );
      ((Element)v.get(71)).appendChild((Element)v.get(73));
      /* Termina nodo:73   */

      /* Empieza nodo:74 / Elemento padre: 71   */
      v.add(doc.createElement("BTNORDENAR"));
      ((Element)v.get(74)).setAttribute("ordenar","ascendente_on.gif" );
      ((Element)v.get(74)).setAttribute("ordenarInv","descendente_on.gif" );
      ...
      ((Element)v.get(76)).setAttribute("borde","1" );
      ((Element)v.get(76)).setAttribute("horizDatos","1" );
      ((Element)v.get(76)).setAttribute("horizCabecera","1" );
      ((Element)v.get(76)).setAttribute("vertical","1" );
      ((Element)v.get(76)).setAttribute("horizTitulo","1" );
      ((Element)v.get(76)).setAttribute("horizBase","1" );
      ((Element)v.get(75)).appendChild((Element)v.get(76));
      /* Termina nodo:76   */

      /* Empieza nodo:77 / Elemento padre: 75   */
      v.add(doc.createElement("COLOR"));
      ((Element)v.get(77)).setAttribute("borde","#999999" );
      ((Element)v.get(77)).setAttribute("vertCabecera","#E0E0E0" );
      ((Element)v.get(77)).setAttribute("vertDatos","#FFFFFF" );
      ((Element)v.get(77)).setAttribute("horizDatos","#FFFFFF" );
      ((Element)v.get(77)).setAttribute("horizCabecera","#999999" );
      ((Element)v.get(77)).setAttribute("horizTitulo","#999999" );
      ((Element)v.get(77)).setAttribute("horizBase","#999999" );
      ...
      ((Element)v.get(78)).setAttribute("colFondo","#CECFCE" );
      ((Element)v.get(78)).setAttribute("alto","22" );
      ((Element)v.get(78)).setAttribute("imgFondo","" );
      ((Element)v.get(78)).setAttribute("cod","00135" );
      ...
      ((Element)v.get(80)).setAttribute("ajustarMinimo","S" );
      ((Element)v.get(80)).setAttribute("permiteOrdenar","S" );
      ((Element)v.get(80)).setAttribute("blancosAInsertar","1" );
      ((Element)v.get(80)).setAttribute("sinSaltoLinea","S" );
      ((Element)v.get(80)).setAttribute("AnchoMinimizadas","48" );
      ((Element)v.get(80)).setAttribute("botonOrdenar","S" );
      ((Element)v.get(70)).appendChild((Element)v.get(80));

      /* Empieza nodo:81 / Elemento padre: 80   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(81)).setAttribute("ancho","40" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(84)).setAttribute("ancho","0" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(86)).setAttribute("ancho","0" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(92)).setAttribute("ancho","0" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(95)).setAttribute("ancho","0" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(98)).setAttribute("ancho","0" );
      ...
      /* Empieza nodo:99 / Elemento padre: 70   */
   }

   private void getXML450(Document doc) {
      v.add(doc.createElement("CABECERA"));
      ((Element)v.get(99)).setAttribute("alto","38" );
      ...
      ((Element)v.get(70)).appendChild((Element)v.get(99));

      /* Empieza nodo:100 / Elemento padre: 99   */
      v.add(doc.createElement("COL"));
      ((Element)v.get(100)).setAttribute("colFondo","" );
      ((Element)v.get(100)).setAttribute("ID","EstCab" );
      ((Element)v.get(100)).setAttribute("cod","BelMedioPago.codMediPago.label" );
      ...
      ((Element)v.get(102)).setAttribute("cod","ApeConfCentroDistribucion.descripcion.label" );
      ...
      ((Element)v.get(104)).setAttribute("cod","CobGuionArgumDetal.indValoDefe.label" );
      ((Element)v.get(99)).appendChild((Element)v.get(104));

      /* Elemento padre:104 / Elemento actual: 105   */
      v.add(doc.createTextNode("Valor por defecto"));
      ...
      ((Element)v.get(108)).setAttribute("cod","ApeConfCentroDistribucion.nivelOutsorcing.label" );
      ((Element)v.get(99)).appendChild((Element)v.get(108));

      /* Elemento padre:108 / Elemento actual: 109   */
      v.add(doc.createTextNode("Nivel de outsourcing"));
      ...
      ((Element)v.get(112)).setAttribute("cod","ApeParamLineaArmado.ordenListaPicado.label" );
      ((Element)v.get(99)).appendChild((Element)v.get(112));

      /* Elemento padre:112 / Elemento actual: 113   */
      v.add(doc.createTextNode("Orden Lista picado"));
      ...
      ((Element)v.get(116)).setAttribute("cod","ApeParamLineaArmado.ordenLista.label" );
      ((Element)v.get(99)).appendChild((Element)v.get(116));

      /* Elemento padre:116 / Elemento actual: 117   */
      v.add(doc.createTextNode("Orden"));
      ...
      ((Element)v.get(118)).setAttribute("cod","ApeParamLineaArmado.textoChequeo.label" );
      ((Element)v.get(99)).appendChild((Element)v.get(118));

      /* Elemento padre:118 / Elemento actual: 119   */
      v.add(doc.createTextNode("Texto Chequeo"));
      ...
      ((Element)v.get(120)).setAttribute("cod","ApeParamLineaArmado.textoPed.label" );
      ((Element)v.get(99)).appendChild((Element)v.get(120));

      /* Elemento padre:120 / Elemento actual: 121   */
      v.add(doc.createTextNode("Texto primeros pedidos"));
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(126)).setAttribute("cod","3443" );
      ((Element)v.get(99)).appendChild((Element)v.get(126));

      /* Elemento padre:126 / Elemento actual: 127   */
      v.add(doc.createTextNode("ImpresionDatosBasicos"));
      ...
      ((Element)v.get(134)).setAttribute("cod","" );
      ...
      /* Empieza nodo:136 / Elemento padre: 70   */
      ...
      ((Element)v.get(70)).appendChild((Element)v.get(136));
   ...
   private void getXML630(Document doc) {
      ...
      /* Empieza nodo:155 / Elemento padre: 70   */
      v.add(doc.createElement("ROWSET"));
      ((Element)v.get(70)).appendChild((Element)v.get(155));
      /* Termina nodo:155   */

      /* Empieza nodo:156 / Elemento padre: 70   */
      v.add(doc.createElement("PAGINADO"));
      ((Element)v.get(156)).setAttribute("nombre","mipgndo" );
      ((Element)v.get(156)).setAttribute("ancho","679" );
      ...
      ((Element)v.get(156)).setAttribute("conector","ConectorBuscarCargosAbonos" );
      ((Element)v.get(156)).setAttribute("rowset","" );
      ((Element)v.get(156)).setAttribute("cargainicial","N" );
      ((Element)v.get(156)).setAttribute("onload","procesarPaginado(mipgndo,msgError, ultima, rowset, 'muestraLista(ultima, rowset)')" );
      ((Element)v.get(70)).appendChild((Element)v.get(156));

      /* Empieza nodo:157 / Elemento padre: 156   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(157)).setAttribute("nombre","ret1" );
      ((Element)v.get(157)).setAttribute("x","37" );
      ((Element)v.get(157)).setAttribute("y","282" );
      ...
      ((Element)v.get(158)).setAttribute("y","282" );
      ...
      /* Empieza nodo:159 / Elemento padre: 69   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(159)).setAttribute("nombre","primera1" );
      ((Element)v.get(159)).setAttribute("x","20" );
      ((Element)v.get(159)).setAttribute("y","282" );
      ((Element)v.get(159)).setAttribute("ID","botonContenido" );
      ((Element)v.get(159)).setAttribute("img","primera_on" );
      ((Element)v.get(159)).setAttribute("tipo","-2" );
      ((Element)v.get(159)).setAttribute("estado","false" );
      ((Element)v.get(159)).setAttribute("alt","" );
      ((Element)v.get(159)).setAttribute("codigo","" );
      ((Element)v.get(159)).setAttribute("accion","mipgndo.retrocederPrimeraPagina();" );
      ((Element)v.get(69)).appendChild((Element)v.get(159));
      /* Termina nodo:159   */

      /* Empieza nodo:160 / Elemento padre: 69   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(160)).setAttribute("nombre","separa" );
      ((Element)v.get(160)).setAttribute("x","59" );
   }

   private void getXML720(Document doc) {
      ((Element)v.get(160)).setAttribute("y","278" );
      ...
      ((Element)v.get(69)).appendChild((Element)v.get(160));
      /* Termina nodo:160   */

      /* Empieza nodo:161 / Elemento padre: 69   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(161)).setAttribute("nombre","btnDetalle" );
      ((Element)v.get(161)).setAttribute("x","80" );
      ...
      ((Element)v.get(161)).setAttribute("cod","MMGGlobal.viewButton.label" );
      ((Element)v.get(161)).setAttribute("accion","onClickDetalle();" );
      ((Element)v.get(161)).setAttribute("ontab","onTab('btnDetalle');" );
      ((Element)v.get(161)).setAttribute("onshtab","onShTab('btnDetalle');" );
      ((Element)v.get(69)).appendChild((Element)v.get(161));
      /* Termina nodo:161   */

      /* Empieza nodo:162 / Elemento padre: 69   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(162)).setAttribute("nombre","btnModificar" );
      ((Element)v.get(162)).setAttribute("x","80" );
      ...
      ((Element)v.get(162)).setAttribute("accion","onClickModificar();" );
      ((Element)v.get(162)).setAttribute("ontab","onTab('btnModificar');" );
      ((Element)v.get(162)).setAttribute("onshtab","onShTab('btnModificar');" );
      ((Element)v.get(69)).appendChild((Element)v.get(162));
      /* Termina nodo:162   */
      /* Termina nodo:69   */
      /* Termina nodo:7   */
