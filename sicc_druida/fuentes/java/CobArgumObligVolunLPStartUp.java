/*
    INDRA/CAR/mmg
    $Id: CobArgumObligVolunLPStartUp.java,v 1.1 2009/12/03 18:42:57 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class CobArgumObligVolunLPStartUp extends MMGDruidaBase{
	...
	public CobArgumObligVolunLPStartUp(){
		super();
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			buildJsPageSize("CobArgumObligVolun");
			...
			asignarAtributo("PAGINA", "CobArgumObligVolunPage", "cod", "CobArgumObligVolun." + accion + ".label");
			...
			limpiarBotoneraLista("cobArgumObligVolun", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codArguObliVolu", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 1);");
		
		//Primero determianmos el nombre del campo en la entidad de oriegen donde se van a cargar los datos
		asignar("VAR", "idAttributeLovOpener", conectorParametro(PARAMETRO_LOV_ATTRIBUTO));
		asignar("VAR", "idEntityLovOpener", conectorParametro(PARAMETRO_LOV_ENTIDAD));
		//asignarAtributo("CAPA", "cobArgumObligVolunLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "CobArgumObligVolunPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		CobArgumObligVolunData cobArgumObligVolunQuery= new CobArgumObligVolunData();
		cobArgumObligVolunQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		CobArgumObligVolunData datosResult = (CobArgumObligVolunData)getSingleObject(BUSINESSID_QUERY, cobArgumObligVolunQuery, 
			cobArgumObligVolunQuery.clone(), "cobArgumObligVolun");
		...
		CobArgumObligVolunData cobArgumObligVolun = datosResult;
		asignar("TEXT", "codArguObliVolu", FormatUtils.formatObject(cobArgumObligVolun.getCodArguObliVolu(), 
		...
		asignarAtributo("TEXT", "codArguObliVolu", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		...
		asignarAtributo("TEXT", "codArguObliVolu", "req", "S");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "cobArgumObligVolunFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		CobArgumObligVolunData cobArgumObligVolunQuery= new CobArgumObligVolunData();
		cobArgumObligVolunQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(cobArgumObligVolun.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"cobArgumObligVolunFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"cobArgumObligVolunFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codArguObliVolu", "ontab","ejecutarAccionFocoModificacion(\"cobArgumObligVolunFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codArguObliVolu", "onshtab","ejecutarAccionFocoModificacion(\"cobArgumObligVolunFrm\",2, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","cobArgumObligVolunTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","cobArgumObligVolunTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codArguObliVolu...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","cobArgumObligVolunFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","cobArgumObligVolunListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","cobArgumObligVolunListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(CobArgumObligVolunData cobArgumObligVolun) throws Exception{
	...
	* @param cobArgumObligVolun La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(CobArgumObligVolunData cobArgumObligVolun) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		CobArgumObligVolunData cobArgumObligVolun = 
			(CobArgumObligVolunData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(cobArgumObligVolun);
		loadLeafDependenceCombos(cobArgumObligVolun);
	}
