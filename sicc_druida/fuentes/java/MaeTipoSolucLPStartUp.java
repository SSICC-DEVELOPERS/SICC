/*
    INDRA/CAR/mmg
    $Id: MaeTipoSolucLPStartUp.java,v 1.1 2009/12/03 18:33:13 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class MaeTipoSolucLPStartUp extends MMGDruidaBase{
	...
	public MaeTipoSolucLPStartUp(){
		super();
	}

	public void inicio() throws Exception {
		pagina("MaeTipoSolucPage");
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "MaeTipoSolucPage", "cod", "MaeTipoSoluc." + accion + ".label");
			...
			limpiarBotoneraLista("maeTipoSoluc", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codTipoSolu", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 2);");
		...
		//asignarAtributo("CAPA", "maeTipoSolucLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "MaeTipoSolucPage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("MaeTipoSolucLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		MaeTipoSolucData maeTipoSolucQuery= new MaeTipoSolucData();
		maeTipoSolucQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		MaeTipoSolucData datosResult = (MaeTipoSolucData)getSingleObject(BUSINESSID_QUERY, maeTipoSolucQuery, 
			maeTipoSolucQuery.clone(), "maeTipoSoluc");
		...
		preservaHiddensI18n(new Integer(1), "MAE_TIPO_SOLUC", "maeTipoSolucFrm", "Descripcion", true);
		...
		MaeTipoSolucData maeTipoSoluc = datosResult;
		asignar("TEXT", "codTipoSolu", FormatUtils.formatObject(maeTipoSoluc.getCodTipoSolu(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("AREATEXTO", "Descripcion", FormatUtils.formatObject(maeTipoSoluc.getDescripcion(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		loadLocalizationVars(maeTipoSoluc);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "codTipoSolu", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "MAE_TIPO_SOLUC", "maeTipoSolucFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "codTipoSolu", "req", "S");
		...
		asignarAtributo("AREATEXTO", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('maeTipoSolucFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "maeTipoSolucFrm", "oculto", "N");
		...
		traza("MMG::Creando MaeTipoSoluc");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		MaeTipoSolucData maeTipoSolucQuery= new MaeTipoSolucData();
		maeTipoSolucQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(maeTipoSoluc.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"maeTipoSolucFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"maeTipoSolucFrm\",1, false)");
					asignarAtributo("COMBO","paisOidPais", "ontab", "ejecutarAccionFocoModificacion(\"maeTipoSolucFrm\",2, true)");
					asignarAtributo("COMBO","paisOidPais", "onshtab", "ejecutarAccionFocoModificacion(\"maeTipoSolucFrm\",2, false)");
				asignarAtributo("AREATEXTO", "codTipoSolu", "ontab","ejecutarAccionFocoModificacion(\"maeTipoSolucFrm\",3, true)");
				asignarAtributo("AREATEXTO", "codTipoSolu", "onshtab","ejecutarAccionFocoModificacion(\"maeTipoSolucFrm\",3, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"maeTipoSolucFrm\",5, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"maeTipoSolucFrm\",5, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","maeTipoSolucTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","maeTipoSolucTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codTipoSolu...");		
				
					traza("MMG: en desactivateNonModifyFields encontrado atributo no editable...");
				
						// borrarCampo("codTipoSolu");
						asignarAtributo ("TEXT", "codTipoSolu", "disabled", "S");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","maeTipoSolucFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","maeTipoSolucListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","maeTipoSolucListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(MaeTipoSolucData maeTipoSoluc) throws Exception{
		...
		if(maeTipoSoluc != null && maeTipoSoluc.getPaisOidPais() != null){
				checkCombo("paisOidPais" , maeTipoSoluc.getPaisOidPais().getId().toString());
			}
	...
	* @param maeTipoSoluc La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(MaeTipoSolucData maeTipoSoluc) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		MaeTipoSolucData maeTipoSoluc = 
			(MaeTipoSolucData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(maeTipoSoluc.getPaisOidPais() != null){
			maeTipoSoluc.setPaisOidPais((es.indra.belcorp.mso.SegPaisViewData)
			getSingleObject(BUSINESSID_PAISOIDPAIS_QUERY, 
			maeTipoSoluc.getPaisOidPais(),
			maeTipoSoluc.getPaisOidPais().clone(),
			"segPaisView"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(maeTipoSoluc);
		loadLeafDependenceCombos(maeTipoSoluc);
	}
	...
	*/
	...
	protected void loadLocalizationVars(MaeTipoSolucData maeTipoSoluc) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("MAE_TIPO_SOLUC");
		mmgLocalizationQuery.setEntiPk(maeTipoSoluc.getId());
