...
public class SegCanalViewPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","segCanalViewList" );
      ...
      ((Element)v.get(14)).setAttribute("cod","SegCanalView.codCana.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","SegCanalView.Descripcion.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","SegCanalView.tipeOidTipoPeri.label" );
