...
public class ConectorBuscarTerritoriosNoAsociados  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","ConectorBuscarTerritoriosNoAsociados" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","APPBuscarTerritoriosNoAsociados" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(6)).setAttribute("NOMBRE","OID_TERR" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","COD_TERR" );
