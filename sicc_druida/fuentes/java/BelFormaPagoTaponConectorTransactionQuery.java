...
public class BelFormaPagoTaponConectorTransactionQuery  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("NOMBRE","BelFormaPagoTaponTransactionQuery" );
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector transaccional para la ejección de query sobre la entidad BelFormaPagoTapon" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","codFormPago" );
      ...
      ((Element)v.get(3)).setAttribute("LONGITUD","60" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(9)).setAttribute("NOMBRE","codFormPago" );
      ...
      ((Element)v.get(10)).setAttribute("LONGITUD","60" );
