...
public class contenido_premios_ranking_asignar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_premios_ranking_asignar" );
      ((Element)v.get(0)).setAttribute("cod","0528" );
      ((Element)v.get(0)).setAttribute("titulo","Asignar Premios de Ranking" );
      ...
      v.add(doc.createTextNode("\r   \r  \r  function onLoadPag()   {\r    configurarMenuSecundario('Formulario');\r    fMostrarMensajeError();\r  \r    DrdEnsanchaConMargenDcho('listado1',12);\r\r    document.all[\"Cplistado1\"].style.visibility='';\r    document.all[\"CpLin1listado1\"].style.visibility='';\r    document.all[\"CpLin2listado1\"].style.visibility='';\r    document.all[\"CpLin3listado1\"].style.visibility='';\r    document.all[\"CpLin4listado1\"].style.visibility='';\r\r    document.all[\"primera1Div\"].style.visibility='';\r    document.all[\"ret1Div\"].style.visibility='';\r    document.all[\"ava1Div\"].style.visibility='';\r    document.all[\"separaDiv\"].style.visibility='';\r    document.all[\"btnAsignarDiv\"].style.visibility='';	\r    eval (ON_RSZ);\r\r   }\r\r   function asignarPremios(){  \r   \r       if(listado1.codSeleccionados()!=\"\") {\r     \r           var gerentes = get('Formulario.gerentes');\r           var concurso = get('Formulario.concurso');\r           \r           var niveles = new String()\r           \r           if(listado1.codSeleccionados() != ''){\r              for(var k=0;k<listado1.codSeleccionados().length;k++){\r                 niveles = niveles + listado1.datos[k][10] + ',';\r                 \r              }\r           }\r           \r           niveles = niveles.substring(0, niveles.length - 1)\r           set('Formulario.paramGenerPremi', listado1.datos[0][9]);\r           \r           set('Formulario.conectorAction', 'LPMantenimientoRanking');\r           set('Formulario.accion', 'asignarPremios');\r           set('Formulario.niveles', niveles);\r           eval('Formulario').oculto = 'S';\r           \r           enviaSICC('Formulario');\r           \r       } else {\r           GestionarMensaje('4');\r       }\r            \r       \r   }\r   \r   \r"));
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(13)).setAttribute("nombre","gerentes" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(15)).setAttribute("nombre","niveles" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(16)).setAttribute("nombre","paramGenerPremi" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(25)).setAttribute("ancho","400" );
      ((Element)v.get(25)).setAttribute("alto","317" );
      ...
      ((Element)v.get(33)).setAttribute("cod","00290" );
      ...
      ((Element)v.get(36)).setAttribute("ancho","75" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(38)).setAttribute("ancho","50" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(42)).setAttribute("ancho","75" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(43)).setAttribute("ancho","180" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(44)).setAttribute("ancho","180" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(45)).setAttribute("ancho","180" );
      ...
      ((Element)v.get(48)).setAttribute("cod","1607" );
      ...
      ((Element)v.get(49)).setAttribute("cod","357" );
      ...
      ((Element)v.get(50)).setAttribute("cod","1665" );
      ...
      ((Element)v.get(51)).setAttribute("cod","1666" );
      ...
      ((Element)v.get(52)).setAttribute("cod","1667" );
      ...
      ((Element)v.get(53)).setAttribute("cod","1696" );
      ...
      ((Element)v.get(54)).setAttribute("cod","1667" );
      ...
      ((Element)v.get(55)).setAttribute("cod","1667" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(56)).setAttribute("cod","1667" );
      ...
      /* Empieza nodo:68 / Elemento padre: 25   */
      v.add(doc.createElement("ROWSET"));
      ((Element)v.get(25)).appendChild((Element)v.get(68));
      /* Termina nodo:68   */

      /* Empieza nodo:69 / Elemento padre: 25   */
      v.add(doc.createElement("PAGINADO"));
      ((Element)v.get(69)).setAttribute("nombre","mipgndo" );
      ((Element)v.get(69)).setAttribute("ancho","400" );
      ...
      ((Element)v.get(69)).setAttribute("conector","" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(72)).setAttribute("nombre","primera1" );
      ...
      ((Element)v.get(73)).setAttribute("y","306" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(74)).setAttribute("nombre","btnAsignar" );
      ((Element)v.get(74)).setAttribute("x","80" );
      ((Element)v.get(74)).setAttribute("y","307" );
      ((Element)v.get(74)).setAttribute("ID","botonContenido" );
      ((Element)v.get(74)).setAttribute("img","" );
      ((Element)v.get(74)).setAttribute("tipo","html" );
      ((Element)v.get(74)).setAttribute("estado","false" );
      ((Element)v.get(74)).setAttribute("cod","231" );
      ((Element)v.get(74)).setAttribute("accion","asignarPremios();" );
      ((Element)v.get(6)).appendChild((Element)v.get(74));
      /* Termina nodo:74   */

      /* Empieza nodo:75 / Elemento padre: 6   */
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(75)).setAttribute("nombre","capaEspacio" );
      ((Element)v.get(75)).setAttribute("alto","12" );
      ((Element)v.get(75)).setAttribute("ancho","100" );
      ((Element)v.get(75)).setAttribute("colorf","" );
      ((Element)v.get(75)).setAttribute("borde","0" );
      ((Element)v.get(75)).setAttribute("imagenf","" );
      ((Element)v.get(75)).setAttribute("repeat","" );
      ((Element)v.get(75)).setAttribute("padding","" );
      ((Element)v.get(75)).setAttribute("visibilidad","visible" );
      ((Element)v.get(75)).setAttribute("contravsb","" );
      ((Element)v.get(75)).setAttribute("x","0" );
      ((Element)v.get(75)).setAttribute("y","310" );
      ((Element)v.get(75)).setAttribute("zindex","" );
