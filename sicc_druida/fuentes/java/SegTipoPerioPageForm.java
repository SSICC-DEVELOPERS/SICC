...
public class SegTipoPerioPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","SegTipoPerio.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","SegTipoPerio.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('segTipoPerioFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('segTipoPerioFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(50)).setAttribute("nombre","codTipoPeriTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lblCodTipoPeri" );
      ((Element)v.get(54)).setAttribute("alto","13" );
      ((Element)v.get(54)).setAttribute("filas","1" );
      ((Element)v.get(54)).setAttribute("id","datosTitle" );
      ((Element)v.get(54)).setAttribute("cod","SegTipoPerio.codTipoPeri.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(55)).setAttribute("nombre","codTipoPeriWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(57)).setAttribute("nombre","codTipoPeri" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('segTipoPerioFrm',2, true)" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('segTipoPerioFrm', 2, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(58)).setAttribute("nombre","codTipoPeriGapTdId" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(64)).setAttribute("cod","SegTipoPerio.Descripcion.label" );
      ...
      ((Element)v.get(68)).setAttribute("ontab","ejecutarAccionFoco('segTipoPerioFrm',3, true)" );
      ((Element)v.get(68)).setAttribute("onshtab","ejecutarAccionFoco('segTipoPerioFrm', 3, false)" );
      ...
      ((Element)v.get(72)).setAttribute("href","javascript:openLocalizationDialog('segTipoPerioFrm', 'Descripcion', 1);" );
      ((Element)v.get(72)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"segTipoPerioFrm\",3, true)', 'ejecutarAccionFoco(\"segTipoPerioFrm\",3, false)')" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(76)).setAttribute("nombre","numDiasTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(81)).setAttribute("nombre","numDiasWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(83)).setAttribute("nombre","numDias" );
      ...
      ((Element)v.get(83)).setAttribute("ontab","ejecutarAccionFoco('segTipoPerioFrm',4, true)" );
      ((Element)v.get(83)).setAttribute("onshtab","ejecutarAccionFoco('segTipoPerioFrm', 4, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(84)).setAttribute("nombre","numDiasGapTdId" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(86)).setAttribute("nombre","numPeriAnioTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(91)).setAttribute("nombre","numPeriAnioWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(93)).setAttribute("nombre","numPeriAnio" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(93)).setAttribute("ontab","ejecutarAccionFoco('segTipoPerioFrm',5, true)" );
      ((Element)v.get(93)).setAttribute("onshtab","ejecutarAccionFoco('segTipoPerioFrm', 5, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(94)).setAttribute("nombre","numPeriAnioGapTdId" );
      ...
      /* Empieza nodo:108 / Elemento padre: 0   */
      v.add(doc.createElement("TR"));
      ((Element)v.get(108)).setAttribute("nombre","segTipoPerioTrButtons" );
      ((Element)v.get(0)).appendChild((Element)v.get(108));
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(115)).setAttribute("class","tablaTitle" );
      ((Element)v.get(115)).setAttribute("nombre","segTipoPerioTdQueryButton" );
      ((Element)v.get(114)).appendChild((Element)v.get(115));

      /* Empieza nodo:116 / Elemento padre: 115   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(116)).setAttribute("nombre","segTipoPerioQueryButton" );
      ((Element)v.get(116)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(116)).setAttribute("estado","false" );
      ((Element)v.get(116)).setAttribute("accion","segTipoPerioFirstPage();" );
      ...
      ((Element)v.get(117)).setAttribute("nombre","segTipoPerioTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(119)).setAttribute("nombre","segTipoPerioLovNullButton" );
      ((Element)v.get(119)).setAttribute("ID","botonContenido" );
      ((Element)v.get(119)).setAttribute("tipo","html" );
      ((Element)v.get(119)).setAttribute("accion","segTipoPerioLovNullSelectionAction();" );
      ((Element)v.get(119)).setAttribute("estado","true" );
      ((Element)v.get(119)).setAttribute("cod","MMGGlobal.lovNullButton.label" );
