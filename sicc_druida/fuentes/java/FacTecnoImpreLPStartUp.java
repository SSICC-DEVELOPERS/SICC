/*
    INDRA/CAR/mmg
    $Id: FacTecnoImpreLPStartUp.java,v 1.1 2009/12/03 18:43:39 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class FacTecnoImpreLPStartUp extends MMGDruidaBase{
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "FacTecnoImprePage", "cod", "FacTecnoImpre." + accion + ".label");
			...
			limpiarBotoneraLista("facTecnoImpre", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "desTecn", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 0, 50);");
		
		//Primero determianmos el nombre del campo en la entidad de oriegen donde se van a cargar los datos
		asignar("VAR", "idAttributeLovOpener", conectorParametro(PARAMETRO_LOV_ATTRIBUTO));
		asignar("VAR", "idEntityLovOpener", conectorParametro(PARAMETRO_LOV_ENTIDAD));
		//asignarAtributo("CAPA", "facTecnoImpreLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "FacTecnoImprePage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		FacTecnoImpreData facTecnoImpreQuery= new FacTecnoImpreData();
		facTecnoImpreQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		FacTecnoImpreData datosResult = (FacTecnoImpreData)getSingleObject(BUSINESSID_QUERY, facTecnoImpreQuery, 
			facTecnoImpreQuery.clone(), "facTecnoImpre");
		...
		FacTecnoImpreData facTecnoImpre = datosResult;
		asignar("TEXT", "desTecn", FormatUtils.formatObject(facTecnoImpre.getDesTecn(), 
		...
		asignarAtributo("TEXT", "desTecn", "disabled", "S");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "facTecnoImpreFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		FacTecnoImpreData facTecnoImpreQuery= new FacTecnoImpreData();
		facTecnoImpreQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(facTecnoImpre.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"facTecnoImpreFrm\",0, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"facTecnoImpreFrm\",0, false)");
				asignarAtributo("AREATEXTO", "desTecn", "ontab","ejecutarAccionFocoModificacion(\"facTecnoImpreFrm\",0, true)");
				asignarAtributo("AREATEXTO", "desTecn", "onshtab","ejecutarAccionFocoModificacion(\"facTecnoImpreFrm\",0, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","facTecnoImpreTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","facTecnoImpreTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es desTecn...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","facTecnoImpreFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","facTecnoImpreListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","facTecnoImpreListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(FacTecnoImpreData facTecnoImpre) throws Exception{
	...
	* @param facTecnoImpre La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(FacTecnoImpreData facTecnoImpre) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		FacTecnoImpreData facTecnoImpre = 
			(FacTecnoImpreData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(facTecnoImpre);
		loadLeafDependenceCombos(facTecnoImpre);
	}
