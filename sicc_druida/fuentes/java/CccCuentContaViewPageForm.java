...
public class CccCuentContaViewPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","CccCuentContaView.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","CccCuentContaView.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('cccCuentContaViewFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('cccCuentContaViewFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(54)).setAttribute("cod","CccCuentContaView.paisOidPais.label" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('cccCuentContaViewFrm',2, true);" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('cccCuentContaViewFrm',2, false);" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(76)).setAttribute("nombre","codCuenContTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(80)).setAttribute("nombre","lblCodCuenCont" );
      ((Element)v.get(80)).setAttribute("alto","13" );
      ((Element)v.get(80)).setAttribute("filas","1" );
      ((Element)v.get(80)).setAttribute("id","datosTitle" );
      ((Element)v.get(80)).setAttribute("cod","CccCuentContaView.codCuenCont.label" );
   ...
   private void getXML360(Document doc) {
      ((Element)v.get(81)).setAttribute("nombre","codCuenContWidgetTrId" );
      ...
      ((Element)v.get(83)).setAttribute("ontab","ejecutarAccionFoco('cccCuentContaViewFrm',3, true)" );
      ((Element)v.get(83)).setAttribute("onshtab","ejecutarAccionFoco('cccCuentContaViewFrm', 3, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(84)).setAttribute("nombre","codCuenContGapTdId" );
      ...
      ((Element)v.get(90)).setAttribute("cod","CccCuentContaView.Descripcion.label" );
      ...
      ((Element)v.get(94)).setAttribute("ontab","ejecutarAccionFoco('cccCuentContaViewFrm',4, true)" );
      ((Element)v.get(94)).setAttribute("onshtab","ejecutarAccionFoco('cccCuentContaViewFrm', 4, false)" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(98)).setAttribute("href","javascript:openLocalizationDialog('cccCuentContaViewFrm', 'Descripcion', 1);" );
      ((Element)v.get(98)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"cccCuentContaViewFrm\",4, true)', 'ejecutarAccionFoco(\"cccCuentContaViewFrm\",4, false)')" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(102)).setAttribute("nombre","codCuenSapTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(106)).setAttribute("nombre","lblCodCuenSap" );
      ((Element)v.get(106)).setAttribute("alto","13" );
      ((Element)v.get(106)).setAttribute("filas","1" );
      ((Element)v.get(106)).setAttribute("id","datosTitle" );
      ((Element)v.get(106)).setAttribute("cod","CccCuentContaView.codCuenSap.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(107)).setAttribute("nombre","codCuenSapWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(109)).setAttribute("nombre","codCuenSap" );
      ...
      ((Element)v.get(109)).setAttribute("size","10" );
      ...
      ((Element)v.get(109)).setAttribute("ontab","ejecutarAccionFoco('cccCuentContaViewFrm',5, true)" );
      ((Element)v.get(109)).setAttribute("onshtab","ejecutarAccionFoco('cccCuentContaViewFrm', 5, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(110)).setAttribute("nombre","codCuenSapGapTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(114)).setAttribute("nombre","formGapTr2" );
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(121)).setAttribute("nombre","formTr3" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(127)).setAttribute("nombre","valObseTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(132)).setAttribute("nombre","valObseWidgetTrId" );
      ...
      ((Element)v.get(134)).setAttribute("nombre","valObse" );
      ((Element)v.get(134)).setAttribute("valor","" );
      ((Element)v.get(134)).setAttribute("rows","3" );
      ((Element)v.get(134)).setAttribute("cols","40" );
   ...
   private void getXML630(Document doc) {
      ...
      ((Element)v.get(134)).setAttribute("ontab","ejecutarAccionFoco('cccCuentContaViewFrm',6, true)" );
      ((Element)v.get(134)).setAttribute("onshtab","ejecutarAccionFoco('cccCuentContaViewFrm',6, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(135)).setAttribute("nombre","valObseGapTdId" );
      ...
      /* Empieza nodo:139 / Elemento padre: 121   */
      v.add(doc.createElement("TD"));
      ((Element)v.get(139)).setAttribute("width","100%" );
      ((Element)v.get(121)).appendChild((Element)v.get(139));
      /* Termina nodo:139   */
      /* Termina nodo:121   */

      /* Empieza nodo:140 / Elemento padre: 15   */
      v.add(doc.createElement("TR"));
      ((Element)v.get(140)).setAttribute("nombre","formGapTr3" );
      ...
      /* Empieza nodo:149 / Elemento padre: 0   */
      v.add(doc.createElement("TR"));
      ((Element)v.get(149)).setAttribute("nombre","cccCuentContaViewTrButtons" );
      ((Element)v.get(0)).appendChild((Element)v.get(149));
      ...
      ((Element)v.get(156)).setAttribute("nombre","cccCuentContaViewTdQueryButton" );
   ...
   private void getXML720(Document doc) {
      ...
      ((Element)v.get(157)).setAttribute("nombre","cccCuentContaViewQueryButton" );
      ((Element)v.get(157)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(157)).setAttribute("estado","false" );
      ((Element)v.get(157)).setAttribute("accion","cccCuentContaViewFirstPage();" );
      ...
      ((Element)v.get(158)).setAttribute("nombre","cccCuentContaViewTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(160)).setAttribute("nombre","cccCuentContaViewLovNullButton" );
      ((Element)v.get(160)).setAttribute("ID","botonContenido" );
      ((Element)v.get(160)).setAttribute("tipo","html" );
      ((Element)v.get(160)).setAttribute("accion","cccCuentContaViewLovNullSelectionAction();" );
      ((Element)v.get(160)).setAttribute("estado","true" );
      ((Element)v.get(160)).setAttribute("cod","MMGGlobal.lovNullButton.label" );
