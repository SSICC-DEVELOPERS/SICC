...
public class SegSociePage  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","SegSociePage" );
      ((Element)v.get(0)).setAttribute("titulo","" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","" );
      ((Element)v.get(0)).setAttribute("onload","segSocieInitComponents()" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(3)).setAttribute("src","segsocie.js" );
      ((Element)v.get(0)).appendChild((Element)v.get(3));
      /* Termina nodo:3   */

      /* Empieza nodo:4 / Elemento padre: 0   */
      v.add(doc.createElement("FORMULARIO"));
      ((Element)v.get(4)).setAttribute("nombre","segSocieFrm" );
      ...
      ((Element)v.get(5)).setAttribute("valor","SegSocieLPExecution" );
      ...
      ((Element)v.get(6)).setAttribute("valor","SegSocieLPExecution" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(36)).setAttribute("nombre","segSocieFormLayer" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(51)).setAttribute("cod","SegSocie.legend.label" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(66)).setAttribute("cod","SegSocie.id.label" );
      ...
      ((Element)v.get(69)).setAttribute("ontab","ejecutarAccionFoco('segSocieFrm',1, true)" );
      ((Element)v.get(69)).setAttribute("onshtab","ejecutarAccionFoco('segSocieFrm', 1, false)" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(91)).setAttribute("cod","SegSocie.paisOidPais.label" );
      ...
      ((Element)v.get(94)).setAttribute("ontab","ejecutarAccionFoco('segSocieFrm',2, true);" );
      ((Element)v.get(94)).setAttribute("onshtab","ejecutarAccionFoco('segSocieFrm',2, false);" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(102)).setAttribute("cod","SegSocie.codSoci.label" );
      ...
      ((Element)v.get(105)).setAttribute("ontab","ejecutarAccionFoco('segSocieFrm',3, true)" );
      ((Element)v.get(105)).setAttribute("onshtab","ejecutarAccionFoco('segSocieFrm', 3, false)" );
      ...
      ((Element)v.get(112)).setAttribute("cod","SegSocie.valDeno.label" );
      ...
      ((Element)v.get(115)).setAttribute("ontab","ejecutarAccionFoco('segSocieFrm',4, true)" );
      ((Element)v.get(115)).setAttribute("onshtab","ejecutarAccionFoco('segSocieFrm', 4, false)" );
   ...
   private void getXML630(Document doc) {
      ((Element)v.get(137)).setAttribute("cod","SegSocie.valDire.label" );
      ...
      ((Element)v.get(140)).setAttribute("ontab","ejecutarAccionFoco('segSocieFrm',5, true)" );
      ((Element)v.get(140)).setAttribute("onshtab","ejecutarAccionFoco('segSocieFrm', 5, false)" );
      ...
      ((Element)v.get(147)).setAttribute("cod","SegSocie.valTlfn.label" );
      ...
      ((Element)v.get(150)).setAttribute("ontab","ejecutarAccionFoco('segSocieFrm',6, true)" );
      ((Element)v.get(150)).setAttribute("onshtab","ejecutarAccionFoco('segSocieFrm', 6, false)" );
   ...
   private void getXML720(Document doc) {
      ...
      ((Element)v.get(157)).setAttribute("cod","SegSocie.valFax.label" );
      ...
      ((Element)v.get(160)).setAttribute("ontab","ejecutarAccionFoco('segSocieFrm',7, true)" );
      ((Element)v.get(160)).setAttribute("onshtab","ejecutarAccionFoco('segSocieFrm', 7, false)" );
   ...
   private void getXML810(Document doc) {
      ...
      ((Element)v.get(182)).setAttribute("cod","SegSocie.valIdenFisc.label" );
      ...
      ((Element)v.get(185)).setAttribute("ontab","ejecutarAccionFoco('segSocieFrm',8, true)" );
      ((Element)v.get(185)).setAttribute("onshtab","ejecutarAccionFoco('segSocieFrm', 8, false)" );
   ...
   private void getXML900(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(200)).setAttribute("nombre","segSocieTrButtons" );
      ...
      ((Element)v.get(207)).setAttribute("nombre","segSocieTdQueryButton" );
      ((Element)v.get(206)).appendChild((Element)v.get(207));

      /* Empieza nodo:208 / Elemento padre: 207   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(208)).setAttribute("nombre","segSocieQueryButton" );
      ((Element)v.get(208)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(208)).setAttribute("estado","false" );
      ((Element)v.get(208)).setAttribute("accion","segSocieFirstPage();" );
      ...
      ((Element)v.get(209)).setAttribute("nombre","segSocieTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(211)).setAttribute("nombre","segSocieLovNullButton" );
      ((Element)v.get(211)).setAttribute("ID","botonContenido" );
      ((Element)v.get(211)).setAttribute("tipo","html" );
      ((Element)v.get(211)).setAttribute("accion","segSocieLovNullSelectionAction();" );
   ...
   private void getXML990(Document doc) {
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(214)).setAttribute("nombre","segSocieListLayer" );
      ...
      ((Element)v.get(215)).setAttribute("nombre","segSocieList" );
   ...
   private void getXML1080(Document doc) {
      ...
      ((Element)v.get(228)).setAttribute("cod","SegSocie.codSoci.label" );
      ...
      ((Element)v.get(229)).setAttribute("cod","SegSocie.valDeno.label" );
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(234)).setAttribute("nombre","segSocieListButtonsLayer" );
   ...
   private void getXML1170(Document doc) {
      ((Element)v.get(240)).setAttribute("nombre","segSociePaginationButtonBar" );
      ...
      ((Element)v.get(241)).setAttribute("nombre","segSocieFirstPageButton" );
      ((Element)v.get(241)).setAttribute("funcion","segSocieFirstPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(242)).setAttribute("nombre","segSocieFirstPageButtonGapTd" );
      ...
      v.add(doc.createElement("BTN"));
      ((Element)v.get(244)).setAttribute("nombre","segSociePreviousPageButton" );
      ((Element)v.get(244)).setAttribute("funcion","segSociePreviousPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(245)).setAttribute("nombre","segSociePreviousPageButtonGapTd" );
      ...
      v.add(doc.createElement("BTN"));
      ((Element)v.get(247)).setAttribute("nombre","segSocieNextPageButton" );
      ((Element)v.get(247)).setAttribute("funcion","segSocieNextPage();" );
      ...
      ((Element)v.get(250)).setAttribute("nombre","segSocieUpdateButtonTd" );
      ((Element)v.get(236)).appendChild((Element)v.get(250));

      /* Empieza nodo:251 / Elemento padre: 250   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(251)).setAttribute("nombre","segSocieUpdateButton" );
      ((Element)v.get(251)).setAttribute("ID","botonContenido" );
      ((Element)v.get(251)).setAttribute("tipo","html" );
      ((Element)v.get(251)).setAttribute("accion","segSocieUpdateSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(252)).setAttribute("nombre","segSocieUpdateButtonGapTd" );
      ...
      ((Element)v.get(254)).setAttribute("nombre","segSocieViewForRemoveButtonTd" );
      ((Element)v.get(236)).appendChild((Element)v.get(254));

      /* Empieza nodo:255 / Elemento padre: 254   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(255)).setAttribute("nombre","segSocieViewForRemoveButton" );
      ((Element)v.get(255)).setAttribute("ID","botonContenido" );
      ((Element)v.get(255)).setAttribute("tipo","html" );
      ((Element)v.get(255)).setAttribute("accion","segSocieViewSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(256)).setAttribute("nombre","segSocieViewForRemoveButtonGapTd" );
   ...
   private void getXML1260(Document doc) {
      ...
      ((Element)v.get(258)).setAttribute("nombre","segSocieLovSelectButtonTd" );
      ((Element)v.get(236)).appendChild((Element)v.get(258));

      /* Empieza nodo:259 / Elemento padre: 258   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(259)).setAttribute("nombre","segSocieLovSelectButton" );
      ((Element)v.get(259)).setAttribute("ID","botonContenido" );
      ((Element)v.get(259)).setAttribute("tipo","html" );
      ((Element)v.get(259)).setAttribute("accion","segSocieLovSelectionAction();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(260)).setAttribute("nombre","segSocieLovSelectButtonGapTd" );
      ...
      ((Element)v.get(262)).setAttribute("nombre","segSocieViewButtonTd" );
      ((Element)v.get(236)).appendChild((Element)v.get(262));

      /* Empieza nodo:263 / Elemento padre: 262   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(263)).setAttribute("nombre","segSocieViewButton" );
      ((Element)v.get(263)).setAttribute("ID","botonContenido" );
      ((Element)v.get(263)).setAttribute("tipo","html" );
      ((Element)v.get(263)).setAttribute("accion","segSocieViewSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(264)).setAttribute("nombre","segSocieViewButtonGapTd" );
