...
public class FACDTRZonaCampanaVariables extends LPSICCBase {           
   public FACDTRZonaCampanaVariables() {	 
     super();
  }
...
String accion = conectorParametroLimpia("accion","", true);
     ...
     try {
        ...
        if (accion.equals("generar")){
          ...
          //cargarPagina();
                 ...
                 cargarPagina();
                 getConfiguracionMenu("FACDTRZonaCampanaVariables");
        }
  ...
  private void cargarPagina() throws Exception{
     ...
     asignarAtributoPagina("cod","0808");   
     ...
     asignarAtributo("VAR", "lp", "valor", "FACDTRZonaCampanaVariables");
 ...
 private void generarReporte() throws Exception{
     ...
     datos.put(ConstantesREP.TITULO, "Resultados de zona por campaña de variables de venta");     
     traza("++++++Antes de enviar a reportes " + datos); 
     
     String formato = conectorParametroLimpia("formato", "", true);
     
       
     //ejecutarReporte(datos, "REPGenerarReporte", "RFD-003", formato);
     ejecutarReporte2(datos, "REPGenerarReporteBatch", "RD_RFD-003", formato);
