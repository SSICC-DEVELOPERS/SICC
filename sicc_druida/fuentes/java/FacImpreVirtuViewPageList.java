...
public class FacImpreVirtuViewPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","facImpreVirtuViewList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","FacImpreVirtuView.codImpr.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","FacImpreVirtuView.desImpr.label" );
