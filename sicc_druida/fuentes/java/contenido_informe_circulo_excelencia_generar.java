...
public class contenido_informe_circulo_excelencia_generar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_informe_circulo_excelencia_generar" );
      ((Element)v.get(0)).setAttribute("cod","0875" );
      ((Element)v.get(0)).setAttribute("titulo","Generar Informe Gerentes-Ganadoras Círculo de Excelencia" );
      ...
      v.add(doc.createTextNode("\r   \r   \r   function onLoad(){\r      configurarMenuSecundario('Formulario');\r      fMostrarMensajeError();\r      setearPais();\r      onchangePais();\r      initChecks();\r      focaliza('Formulario.cbPais');\r   }\r   function generar(formato){\r      \r      if(sicc_validaciones_generales()){\r        \r          var a = new Object();\r          a.accion = 'generar';\r          \r          a.pais = get('Formulario.cbPais');\r          a.marca = get('Formulario.cbMarca');  \r          a.canal = get('Formulario.cbCanal');\r          a.concurso = get('Formulario.cbConcurso');\r          \r          a.numeroSubgerenciaVentas = get('Formulario.txtNumSubgerencias');\r          a.numeroRegiones = get('Formulario.txtNumRegiones');\r          a.numeroZonas = get('Formulario.txtNumZonas');\r          \r          a.formato = formato;\r          \r          mostrarModalSICC('INCGerentesGanadorasCirculo','generar', a);\r          \r      }\r\r   }\r \r   \r\r   function fLimpiar(){\r     var aCombo = new Array(new Array(\"\",\"\"));\r     set_combo('Formulario.cbConcurso', aCombo, []);\r     \r     limpiarChecks();\r     \r     focaliza('Formulario.cbPais');\r\r    }\r   \r\r    function cambioRegion(){\r         opciones = new Array();\r         set_combo('Formulario.cbZona',opciones);                      \r              \r         var region = get('Formulario.cbRegion','V');\r         combo_add('Formulario.cbZona', '', '');\r         \r         for(var k=0;k<ListaZonas.datos.longitud;k++) {\r           for(var y=0;y<region.length;y++){\r              if (ListaZonas.datos.ij(k,1) == region[y]){     \r                  combo_add('Formulario.cbZona',ListaZonas.datos.ij(k,0),ListaZonas.datos.ij(k,2));\r                \r              }\r           }\r         }\r    }\r\r     function setearPais(){\r          var pais = get('Formulario.pais');\r          \r          iSeleccionado = new Array(); \r          iSeleccionado[0] = pais;\r          set('Formulario.cbPais',iSeleccionado);\r       }\r\r    function onchangePais() {\r          pais   = get('Formulario.cbPais');\r          idioma = get('Formulario.idioma');\r          \r          if (pais != '') {\r                var arrConcurso = new Array();\r                arrConcurso[arrConcurso.length] = [\"oidPais\", pais]; \r                arrConcurso[arrConcurso.length] = [\"oidAgrugacion\", \"0\"];\r                \r                recargaCombo('Formulario.cbConcurso','INCObtenerConcursosREP', 'es.indra.sicc.dtos.inc.DTOBusquedaClienteCalificado',arrConcurso );\r          }\r    \r    }       \r\r    function initChecks() {\r        accion(\"Formulario.txtNumSubgerencias\",\".disabled=true\");\r        accion(\"Formulario.txtNumRegiones\",\".disabled=true\");\r        accion(\"Formulario.txtNumZonas\",\".disabled=true\");\r    }\r    function limpiarChecks() {\r        accion(\"Formulario.ckSubgerencia\",\".checked=false\");\r        onchangeCkSubgerencia();\r        accion(\"Formulario.ckRegion\",\".checked=false\");\r        onchangeCkRegion();\r        accion(\"Formulario.ckZona\",\".checked=false\");\r        onchangeCkZona();\r    }\r    function onchangeCkSubgerencia() {\r        var estado = get('Formulario.ckSubgerencia');\r        \r        if(estado=='S') {\r            accion(\"Formulario.txtNumSubgerencias\",\".disabled=false\");\r            sicc_cambiar_estado('txtNumSubgerencias', true);\r        } else {\r            accion(\"Formulario.txtNumSubgerencias\",\".disabled=true\");\r            sicc_cambiar_estado('txtNumSubgerencias', false);\r            set(\"Formulario.txtNumSubgerencias\",\"\");\r        }\r            \r    }\r    function onchangeCkRegion() {\r        var estado = get('Formulario.ckRegion');\r        \r        if(estado=='S') {\r            accion(\"Formulario.txtNumRegiones\",\".disabled=false\");\r            sicc_cambiar_estado('txtNumRegiones', true);\r        } else {\r            accion(\"Formulario.txtNumRegiones\",\".disabled=true\");\r            sicc_cambiar_estado('txtNumRegiones', false);\r            set(\"Formulario.txtNumRegiones\",\"\");\r        }\r            \r    }\r    function onchangeCkZona() {\r        var estado = get('Formulario.ckZona');\r        \r        if(estado=='S') {\r            accion(\"Formulario.txtNumZonas\",\".disabled=false\");\r            sicc_cambiar_estado('txtNumZonas', true);\r        } else {\r            accion(\"Formulario.txtNumZonas\",\".disabled=true\");\r            sicc_cambiar_estado('txtNumZonas', false);\r            set(\"Formulario.txtNumZonas\",\"\");\r        }\r            \r    }\r\r\r\r   \r  \r    "));
      ...
      ((Element)v.get(10)).setAttribute("cod","1662" );
      ((Element)v.get(6)).appendChild((Element)v.get(10));
      /* Termina nodo:10   */

      /* Empieza nodo:11 / Elemento padre: 6   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(11)).setAttribute("name","txtNumSubgerencias" );
      ((Element)v.get(11)).setAttribute("required","false" );
      ((Element)v.get(11)).setAttribute("cod","2715" );
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(12)).setAttribute("name","txtNumRegiones" );
      ((Element)v.get(12)).setAttribute("required","false" );
      ((Element)v.get(12)).setAttribute("cod","1222" );
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(13)).setAttribute("name","txtNumZonas" );
      ((Element)v.get(13)).setAttribute("required","false" );
      ((Element)v.get(13)).setAttribute("cod","2121" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(56)).setAttribute("onchange","onchangePais()" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(107)).setAttribute("nombre","cbConcurso" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(148)).setAttribute("nombre","ckSubgerencia" );
      ((Element)v.get(148)).setAttribute("id","datosCampos" );
      ((Element)v.get(148)).setAttribute("check","N" );
      ((Element)v.get(148)).setAttribute("onclick","onchangeCkSubgerencia()" );
      ...
      v.add(doc.createElement("CHECKBOX"));
      ((Element)v.get(156)).setAttribute("nombre","ckRegion" );
      ((Element)v.get(156)).setAttribute("id","datosCampos" );
      ((Element)v.get(156)).setAttribute("onclick","onchangeCkRegion()" );
   ...
   private void getXML630(Document doc) {
      ...
      v.add(doc.createElement("CHECKBOX"));
      ((Element)v.get(164)).setAttribute("nombre","ckZona" );
      ((Element)v.get(164)).setAttribute("id","datosCampos" );
      ((Element)v.get(164)).setAttribute("onclick","onchangeCkZona()" );
      ...
      /* Empieza nodo:167 / Elemento padre: 144   */
      v.add(doc.createElement("td"));
      ((Element)v.get(167)).setAttribute("nowrap","nowrap" );
      ((Element)v.get(144)).appendChild((Element)v.get(167));

      /* Empieza nodo:168 / Elemento padre: 167   */
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(168)).setAttribute("nombre","txtNumZonas" );
      ...
      /* Empieza nodo:171 / Elemento padre: 116   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(116)).appendChild((Element)v.get(171));
      ...
      ((Element)v.get(184)).setAttribute("nombre","btnGenerarInforme" );
      ((Element)v.get(184)).setAttribute("ID","botonContenido" );
      ((Element)v.get(184)).setAttribute("tipo","html" );
      ((Element)v.get(184)).setAttribute("accion","generar('pdf')" );
   }

   private void getXML720(Document doc) {
      ((Element)v.get(184)).setAttribute("estado","false" );
      ((Element)v.get(184)).setAttribute("cod","2495" );
      ((Element)v.get(183)).appendChild((Element)v.get(184));
      /* Termina nodo:184   */

      /* Empieza nodo:185 / Elemento padre: 183   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(185)).setAttribute("nombre","btnGenerarExcel" );
      ((Element)v.get(185)).setAttribute("ID","botonContenido" );
      ((Element)v.get(185)).setAttribute("tipo","html" );
      ((Element)v.get(185)).setAttribute("accion","generar('xls')" );
      ((Element)v.get(185)).setAttribute("estado","false" );
      ((Element)v.get(185)).setAttribute("cod","2526" );
      ((Element)v.get(185)).setAttribute("ontab","focaliza('Formulario.cbPais')" );
