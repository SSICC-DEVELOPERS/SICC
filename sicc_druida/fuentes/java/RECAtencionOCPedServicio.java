...
public class RECAtencionOCPedServicio extends LPSICCBase {           
   public RECAtencionOCPedServicio() {	 
     super();
  }
     ...
     try {
        ...
        if (accion.equals("generar")){
          ...
          //cargarPagina();
           ...
           cargarPagina();
           getConfiguracionMenu("RECAtencionOCPedServicio");
        }
  ...
  private void cargarPagina() throws Exception{
     pagina("contenido_informe_atencion_pedido_servicio_generar");
     
     asignarAtributoPagina("cod", "0915");
     asignarAtributo("VAR", "lp", "valor", "RECAtencionOCPedServicio");
 ...
 private void generarReporte() throws Exception{
     ...
     datos.put(ConstantesREP.TITULO, "Atención con O/C y Pedido de Servicio");     
     traza("++++++Antes de enviar a reportes " + datos); 
        
     
     traza("el formaro es  " + formato);
    // ejecutarReporte(datos, "REPGenerarReporte", "RD_REP-113", formato);
     ejecutarReporte2(datos, "REPGenerarReporteBatch", "RD_REP-113", formato);
