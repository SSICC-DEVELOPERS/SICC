...
public class PreTipoEstraPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","preTipoEstraList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(17)).setAttribute("cod","PreTipoEstra.codTipoEstr.label" );
      ...
      ((Element)v.get(18)).setAttribute("cod","PreTipoEstra.desTipoEstr.label" );
      ...
      ((Element)v.get(19)).setAttribute("cod","PreTipoEstra.indEstrGrup.label" );
      ...
      ((Element)v.get(20)).setAttribute("cod","PreTipoEstra.indEstrCond.label" );
      ...
      ((Element)v.get(21)).setAttribute("cod","PreTipoEstra.indEstrVs.label" );
      ...
      ((Element)v.get(22)).setAttribute("cod","PreTipoEstra.indEstrPaqu.label" );
