...
public class contenido_informe_cupones_tramite_generar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_informe_cupones_tramite_generar" );
      ((Element)v.get(0)).setAttribute("cod","0850" );
      ((Element)v.get(0)).setAttribute("titulo","Generar informe cupones en trámite sin aplicar" );
      ...
      v.add(doc.createTextNode("\r   \r \r   function onLoad(){\r      configurarMenuSecundario('Formulario');\r      fMostrarMensajeError();\r      set('Formulario.txtFechaValorDesde', '01/01/2000');\r      set('Formulario.txtFechaProcesoDesde', '01/01/2000');\r      setearFechas();\r      focaliza('Formulario.txtFechaValorDesde');\r           \r      \r   }\r\r     function quitarItemVacio(elemento){\r      var elementoADevolver = new Array();\r     \r      for(var k=0;k<elemento.length;k++) {\r          if (elemento[k] != ''){                            \r             elementoADevolver[elementoADevolver.length] = elemento[k];\r          }\r      }\r         \r      return elementoADevolver;\r      \r   }\r   function generar(formato){\r      if(sicc_validaciones_generales()){\r         if(validarFechasValor()){\r            if(validarFechasProceso()){\r               /*recolectarParametros();\r               set('Formulario.conectorAction', 'CCCCuponesTramite');           \r               set('Formulario.accion', 'generar');\r               set('Formulario.formatoSalida', formato);\r               enviaSICC('Formulario');*/\r               var a = new Object();\r               a.accion = 'generar';\r               a.fechaValorDesde = get('Formulario.txtFechaValorDesde');  \r               a.fechaValorHasta = get('Formulario.txtFechaValorHasta');\r               a.fechaProcesoDesde = get('Formulario.txtFechaProcesoDesde');  \r               a.fechaProcesoHasta = get('Formulario.txtFechaProcesoHasta');\r               a.banco = quitarItemVacio(get('Formulario.cbBanco'));\r               a.bancoDesc = quitarItemVacio(get('Formulario.cbBanco', 'T'));\r               a.orden = get('Formulario.cbCriterioOrdenamiento');\r               a.ordenDesc = get('Formulario.cbCriterioOrdenamiento', 'T');\r               a.formatoSalida = formato;\r               mostrarModalSICC('CCCCuponesTramite','generar', a);  \r            }\r         }      \r      }\r   }\r\r   function setearFechas(){\r      var fechaActual = get('Formulario.fechaActual');\r      \r      set('Formulario.txtFechaValorHasta', fechaActual);\r      set('Formulario.txtFechaProcesoHasta', fechaActual);\r   \r   }\r\r\r   function validarFechasValor(){\r      \r      var fechaDesde = get('Formulario.txtFechaValorDesde');\r      var fechaHasta = get('Formulario.txtFechaValorHasta');\r      var formatoFecha = get('Formulario.hFormatoFechaPais');\r            \r     \r      if (! EsFechaValida_SICC(fechaDesde, \"Formulario\")){\r          GestionarMensaje(\"1006\", formatoFecha, null, null);\r          focaliza(\"Formulario.txtFechaValorDesde\");\r          return false;\r      }\r     \r      if(! EsFechaValida_SICC(fechaHasta, \"Formulario\")){\r          GestionarMensaje(\"1006\", formatoFecha, null, null);\r          focaliza(\"Formulario.txtFechaValorHasta\");\r          return false;\r      }\r                 \r      var errorLevel = EsFechaValida( fechaDesde, fechaHasta, \"Formulario\", \"S\");\r      if ( errorLevel == 3){\r          GestionarMensaje(\"1191\");\r          focaliza('Formulario.txtFechaValorDesde');\r          return false;\r      }\r     \r      return true;   \r   \r   }\r\r   function validarFechasProceso(){\r      \r      var fechaDesde = get('Formulario.txtFechaProcesoDesde');\r      var fechaHasta = get('Formulario.txtFechaProcesoHasta');\r      var formatoFecha = get('Formulario.hFormatoFechaPais');\r            \r      if(fechaDesde != ''){\r          if (! EsFechaValida_SICC(fechaDesde, \"Formulario\")){\r              GestionarMensaje(\"1006\", formatoFecha, null, null);\r              focaliza(\"Formulario.txtFechaProcesoDesde\");\r              return false;\r          }\r      }     \r      \r      if(fechaHasta != ''){\r          if(! EsFechaValida_SICC(fechaHasta, \"Formulario\")){\r              GestionarMensaje(\"1006\", formatoFecha, null, null);\r              focaliza(\"Formulario.txtFechaValorHasta\");\r              return false;\r          }\r      }\r                 \r      if((fechaDesde != '') && (fechaHasta != '')){\r          var errorLevel = EsFechaValida( fechaDesde, fechaHasta, \"Formulario\", \"S\");\r          if ( errorLevel == 3){\r              GestionarMensaje(\"1191\");\r              focaliza('Formulario.txtFechaValorDesde');\r              return false;\r          }\r      }\r     \r      return true;   \r   \r   }\r   function recolectarParametros(){\r           \r      set('Formulario.fechaValorDesde', get('Formulario.txtFechaValorDesde'));  \r      set('Formulario.fechaValorHasta', get('Formulario.txtFechaValorHasta'));\r      set('Formulario.fechaProcesoDesde', get('Formulario.txtFechaProcesoDesde'));  \r      set('Formulario.fechaProcesoHasta', get('Formulario.txtFechaProcesoHasta'));\r      set('Formulario.banco', get('Formulario.cbBanco'));\r      set('Formulario.orden', get('Formulario.cbCriterioOrdenamiento'));\r \r  \r   }\r\r   \r\r   function fLimpiar(){\r      focaliza('Formulario.txtFechaValorDesde');\r   }\r  \r   \r  \r  "));
      ...
      ((Element)v.get(5)).setAttribute("name","txtFechaValorDesde" );
      ((Element)v.get(5)).setAttribute("required","true" );
      ((Element)v.get(5)).setAttribute("cod","2667" );
      ((Element)v.get(4)).appendChild((Element)v.get(5));
      /* Termina nodo:5   */

      /* Empieza nodo:6 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(6)).setAttribute("name","txtFechaValorHasta" );
      ((Element)v.get(6)).setAttribute("required","true" );
      ((Element)v.get(6)).setAttribute("cod","2678" );
      ((Element)v.get(4)).appendChild((Element)v.get(6));
      /* Termina nodo:6   */

      /* Empieza nodo:7 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(7)).setAttribute("name","cbCriterioOrdenamiento" );
      ((Element)v.get(7)).setAttribute("required","true" );
      ((Element)v.get(7)).setAttribute("cod","2659" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(15)).setAttribute("nombre","banco" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(16)).setAttribute("nombre","fechaValorDesde" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(17)).setAttribute("nombre","fechaValorHasta" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(18)).setAttribute("nombre","fechaProcesoDesde" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(19)).setAttribute("nombre","fechaProcesoHasta" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(20)).setAttribute("nombre","fechaActual" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(21)).setAttribute("nombre","banco" );
   ...
   private void getXML90(Document doc) {
      ((Element)v.get(22)).setAttribute("nombre","orden" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(51)).setAttribute("nombre","lblFechaValorDesde" );
      ((Element)v.get(51)).setAttribute("alto","13" );
      ((Element)v.get(51)).setAttribute("filas","1" );
      ((Element)v.get(51)).setAttribute("id","datosTitle" );
      ((Element)v.get(51)).setAttribute("cod","2677" );
      ...
      ((Element)v.get(70)).setAttribute("nombre","txtFechaValorDesde" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(74)).setAttribute("nombre","txtFechaValorHasta" );
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(78)).setAttribute("nombre","txtFechaProcesoDesde" );
      ...
      ((Element)v.get(81)).setAttribute("valign","bottom" );
      ((Element)v.get(66)).appendChild((Element)v.get(81));

      /* Empieza nodo:82 / Elemento padre: 81   */
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(82)).setAttribute("nombre","txtFechaProcesoHasta" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(106)).setAttribute("nombre","cbBanco" );
      ((Element)v.get(106)).setAttribute("size","5" );
      ((Element)v.get(106)).setAttribute("multiple","S" );
   ...
   private void getXML450(Document doc) {
      ((Element)v.get(111)).setAttribute("nombre","cbCriterioOrdenamiento" );
      ((Element)v.get(111)).setAttribute("size","1" );
      ((Element)v.get(111)).setAttribute("multiple","N" );
      ((Element)v.get(111)).setAttribute("valorinicial","1" );
      ((Element)v.get(111)).setAttribute("textoinicial","Código" );
      ...
      ((Element)v.get(113)).setAttribute("ID","1" );
      ...
      ((Element)v.get(114)).setAttribute("VALOR","2" );
      ...
      ((Element)v.get(115)).setAttribute("VALOR","Fecha valor" );
      ...
      /* Empieza nodo:121 / Elemento padre: 33   */
      v.add(doc.createElement("td"));
      ((Element)v.get(33)).appendChild((Element)v.get(121));
      ...
      /* Empieza nodo:123 / Elemento padre: 25   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(25)).appendChild((Element)v.get(123));
      ...
      ((Element)v.get(131)).setAttribute("nombre","btnGenerarInforme" );
      ((Element)v.get(131)).setAttribute("ID","botonContenido" );
      ((Element)v.get(131)).setAttribute("tipo","html" );
      ((Element)v.get(131)).setAttribute("accion","generar();" );
      ((Element)v.get(131)).setAttribute("estado","false" );
      ((Element)v.get(131)).setAttribute("cod","2495" );
      ((Element)v.get(130)).appendChild((Element)v.get(131));
      /* Termina nodo:131   */

      /* Empieza nodo:132 / Elemento padre: 130   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(132)).setAttribute("nombre","btnGenerarExcel" );
      ((Element)v.get(132)).setAttribute("ID","botonContenido" );
      ((Element)v.get(132)).setAttribute("tipo","html" );
      ((Element)v.get(132)).setAttribute("accion","generar('xls');" );
      ((Element)v.get(132)).setAttribute("estado","false" );
      ((Element)v.get(132)).setAttribute("cod","2526" );
      ((Element)v.get(132)).setAttribute("ontab","focaliza('Formulario.txtFechaValorDesde')" );
