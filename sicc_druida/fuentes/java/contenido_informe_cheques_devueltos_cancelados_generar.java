...
public class contenido_informe_cheques_devueltos_cancelados_generar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_informe_cheques_devueltos_cancelados_generar" );
      ((Element)v.get(0)).setAttribute("cod","0844" );
      ((Element)v.get(0)).setAttribute("titulo","Generar informe resumen de cuenta corriente" );
      ...
      v.add(doc.createTextNode("\r   \r   \r   function onLoad(){\r      configurarMenuSecundario('Formulario');\r      fMostrarMensajeError();\r      setearFechas();\r      focaliza('Formulario.txtFechaCancelacionDesde');\r      \r   }\r   function generar(){\r      if(sicc_validaciones_generales()){\r        if(validarFechas()){\r            /*recolectarParametros();\r            set('Formulario.conectorAction', 'CCCChequesDevueltosCancelados');           \r            set('Formulario.accion', 'generar');\r            enviaSICC('Formulario');*/\r            var a = new Object();\r            a.accion = 'generar';\r            a.fechaDesde = get('Formulario.txtFechaCancelacionDesde');  \r            a.fechaHasta = get('Formulario.txtFechaCancelacionHasta');           \r            mostrarModalSICC('CCCChequesDevueltosCancelados','generar', a);  \r        }\r      }\r   }\r\r   function recolectarParametros(){\r           \r      set('Formulario.fechaDesde', get('Formulario.txtFechaCorteDesde'));  \r      set('Formulario.fechaHasta', get('Formulario.txtFechaCorteHasta'));\r    \r   }\r   \r\r   function fLimpiar(){\r     focaliza('Formulario.txtFechaCancelacionDesde');\r   }\r\r   function validarFechas(){\r      \r      var fechaDesde = get('Formulario.txtFechaCancelacionDesde');\r      var fechaHasta = get('Formulario.txtFechaCancelacionHasta');\r      var formatoFecha = get('Formulario.hFormatoFechaPais');\r            \r     \r      if (! EsFechaValida_SICC(fechaDesde, \"Formulario\")){\r          GestionarMensaje(\"1006\", formatoFecha, null, null);\r          focaliza(\"Formulario.txtFechaCancelacionDesde\");\r          return false;\r      }\r     \r      if(! EsFechaValida_SICC(fechaHasta, \"Formulario\")){\r          GestionarMensaje(\"1006\", formatoFecha, null, null);\r          focaliza(\"Formulario.txtFechaCancelacionHasta\");\r          return false;\r      }\r                 \r      var errorLevel = EsFechaValida( fechaDesde, fechaHasta, \"Formulario\", \"S\");\r      if ( errorLevel == 3){\r          GestionarMensaje(\"1191\");\r          focaliza('Formulario.txtFechaCancelacionDesde');\r          return false;\r      }\r     \r      return true;   \r   \r   }\r\r\r   function setearFechas(){\r      set('Formulario.txtFechaCancelacionDesde', '01/01/2000');\r      set('Formulario.txtFechaCancelacionHasta', get('Formulario.fechaActual'));\r      \r   }\r\r  \r\r   \r  \r  "));
      ...
      ((Element)v.get(5)).setAttribute("name","txtFechaCancelacionDesde" );
      ((Element)v.get(5)).setAttribute("required","true" );
      ((Element)v.get(5)).setAttribute("cod","2666" );
      ((Element)v.get(4)).appendChild((Element)v.get(5));
      /* Termina nodo:5   */

      /* Empieza nodo:6 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(6)).setAttribute("name","txtFechaCancelacionHasta" );
      ((Element)v.get(6)).setAttribute("required","true" );
      ((Element)v.get(6)).setAttribute("cod","2667" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(14)).setAttribute("nombre","fechaCancelacionDesde" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(15)).setAttribute("nombre","fechaCancelacionHasta" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(16)).setAttribute("nombre","orden" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(17)).setAttribute("nombre","fechaActual" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(49)).setAttribute("nombre","lblFechaCancelacionHasta" );
      ((Element)v.get(49)).setAttribute("alto","13" );
      ((Element)v.get(49)).setAttribute("filas","1" );
      ((Element)v.get(49)).setAttribute("id","datosTitle" );
      ((Element)v.get(49)).setAttribute("cod","2667" );
      ...
      ((Element)v.get(60)).setAttribute("nombre","txtFechaCancelacionDesde" );
      ((Element)v.get(60)).setAttribute("id","datosCampos" );
      ((Element)v.get(60)).setAttribute("max","10" );
      ((Element)v.get(60)).setAttribute("tipo","" );
      ((Element)v.get(60)).setAttribute("onchange","" );
      ((Element)v.get(60)).setAttribute("req","S" );
      ((Element)v.get(60)).setAttribute("size","12" );
      ((Element)v.get(60)).setAttribute("valor","" );
      ((Element)v.get(60)).setAttribute("validacion","" );
      ((Element)v.get(60)).setAttribute("onshtab","focalizaBotonHTML('botonContenido','btnGenerarInforme');" );
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(64)).setAttribute("nombre","txtFechaCancelacionHasta" );
   ...
   private void getXML270(Document doc) {
      ((Element)v.get(68)).setAttribute("nombre","cbOrden" );
      ((Element)v.get(68)).setAttribute("size","1" );
      ((Element)v.get(68)).setAttribute("multiple","N" );
      ((Element)v.get(68)).setAttribute("valorinicial","1" );
      ((Element)v.get(68)).setAttribute("textoinicial","Por consultora" );
      ...
      ((Element)v.get(71)).setAttribute("VALOR","2" );
      ...
      ((Element)v.get(72)).setAttribute("VALOR","Por fecha cancelación" );
      ...
      ((Element)v.get(88)).setAttribute("nombre","btnGenerarInforme" );
      ((Element)v.get(88)).setAttribute("ID","botonContenido" );
      ((Element)v.get(88)).setAttribute("tipo","html" );
      ((Element)v.get(88)).setAttribute("accion","generar()" );
      ((Element)v.get(88)).setAttribute("estado","false" );
      ((Element)v.get(88)).setAttribute("cod","2495" );
      ((Element)v.get(88)).setAttribute("ontab","focaliza('Formulario.txtFechaCancelacionDesde')" );
      ...
      /* Empieza nodo:91 / Elemento padre: 19   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(19)).appendChild((Element)v.get(91));
