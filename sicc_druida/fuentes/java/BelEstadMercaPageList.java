...
public class BelEstadMercaPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","belEstadMercaList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","BelEstadMerca.codEsta.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","BelEstadMerca.Descripcion.label" );
