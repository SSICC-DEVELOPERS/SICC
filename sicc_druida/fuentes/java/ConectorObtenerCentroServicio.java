...
public class ConectorObtenerCentroServicio  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","ConectorObtenerCentroServicio" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","DTOCentroServicio" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(9)).setAttribute("NOMBRE","OBSERVACIONES" );
