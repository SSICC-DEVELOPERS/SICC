...
public class SegPaisConectorQueryForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad SegPais" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGSegPaisQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGSegPaisQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","SegPaisFormFormatter" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(38)).setAttribute("NOMBRE","indImpuIncl" );
