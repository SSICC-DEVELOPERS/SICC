...
public class contenido_resultados_chequeos_buscar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_resultados_chequeos_buscar" );
      ((Element)v.get(0)).setAttribute("cod","0219" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(6)).setAttribute("src","contenido_resultados_chequeos_buscar.js" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(21)).setAttribute("nombre","nombre1" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(22)).setAttribute("nombre","nombre2" );
   ...
   private void getXML90(Document doc) {
      ((Element)v.get(23)).setAttribute("nombre","apellido1" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(24)).setAttribute("nombre","apellido2" );
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(44)).setAttribute("width","588" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(52)).setAttribute("nombre","lblCodigoCliente" );
      ...
      ((Element)v.get(59)).setAttribute("nombre","txtCodigoCliente" );
      ...
      ((Element)v.get(59)).setAttribute("onshtab","codigoClienteOnShTab();" );
      ((Element)v.get(59)).setAttribute("onblur","codigoClienteOnBlur();" );
      ...
      /* Empieza nodo:71 / Elemento padre: 26   */
      v.add(doc.createElement("tr"));
   }

   private void getXML270(Document doc) {
      ((Element)v.get(26)).appendChild((Element)v.get(71));
      ...
      ((Element)v.get(79)).setAttribute("nombre","btnAceptar" );
      ((Element)v.get(79)).setAttribute("ID","botonContenido" );
      ((Element)v.get(79)).setAttribute("tipo","html" );
      ((Element)v.get(79)).setAttribute("ontab","aceptarOnTab();" );
      ((Element)v.get(79)).setAttribute("accion","aceptarOnClick();" );
      ...
      /* Empieza nodo:82 / Elemento padre: 26   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(26)).appendChild((Element)v.get(82));
