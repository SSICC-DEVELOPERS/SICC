...
public class MaeNivelEstudPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","maeNivelEstudList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","MaeNivelEstud.codNiveEstu.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","MaeNivelEstud.Descripcion.label" );
