...
public class CobGuionArgumCabecViewPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","CobGuionArgumCabecView.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","CobGuionArgumCabecView.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('cobGuionArgumCabecViewFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('cobGuionArgumCabecViewFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(54)).setAttribute("cod","CobGuionArgumCabecView.codGuiaArgu.label" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('cobGuionArgumCabecViewFrm',2, true)" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('cobGuionArgumCabecViewFrm', 2, false)" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(75)).setAttribute("nombre","valObseTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(79)).setAttribute("nombre","lblValObse" );
      ((Element)v.get(79)).setAttribute("alto","13" );
      ((Element)v.get(79)).setAttribute("filas","1" );
      ((Element)v.get(79)).setAttribute("id","datosTitle" );
      ((Element)v.get(79)).setAttribute("cod","CobGuionArgumCabecView.valObse.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(80)).setAttribute("nombre","valObseWidgetTrId" );
   }
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(82)).setAttribute("nombre","valObse" );
      ((Element)v.get(82)).setAttribute("valor","" );
      ((Element)v.get(82)).setAttribute("rows","3" );
      ((Element)v.get(82)).setAttribute("cols","100" );
      ...
      ((Element)v.get(82)).setAttribute("ontab","ejecutarAccionFoco('cobGuionArgumCabecViewFrm',3, true)" );
      ((Element)v.get(82)).setAttribute("onshtab","ejecutarAccionFoco('cobGuionArgumCabecViewFrm',3, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(83)).setAttribute("nombre","valObseGapTdId" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(104)).setAttribute("cod","CobGuionArgumCabecView.Descripcion.label" );
      ...
      ((Element)v.get(108)).setAttribute("max","50" );
      ((Element)v.get(108)).setAttribute("onchange","" );
      ((Element)v.get(108)).setAttribute("req","N" );
      ((Element)v.get(108)).setAttribute("size","50" );
      ...
      ((Element)v.get(108)).setAttribute("ontab","ejecutarAccionFoco('cobGuionArgumCabecViewFrm',4, true)" );
      ((Element)v.get(108)).setAttribute("onshtab","ejecutarAccionFoco('cobGuionArgumCabecViewFrm', 4, false)" );
      ...
      ((Element)v.get(112)).setAttribute("href","javascript:openLocalizationDialog('cobGuionArgumCabecViewFrm', 'Descripcion', 1);" );
      ((Element)v.get(112)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"cobGuionArgumCabecViewFrm\",4, true)', 'ejecutarAccionFoco(\"cobGuionArgumCabecViewFrm\",4, false)')" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(116)).setAttribute("nombre","paisOidPaisTdId" );
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(120)).setAttribute("nombre","lblpaisOidPais" );
      ...
      ((Element)v.get(120)).setAttribute("cod","CobGuionArgumCabecView.paisOidPais.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(121)).setAttribute("nombre","paisOidPaisWidgetTrId" );
      ...
      ((Element)v.get(123)).setAttribute("nombre","paisOidPais" );
      ...
      ((Element)v.get(123)).setAttribute("ontab","ejecutarAccionFoco('cobGuionArgumCabecViewFrm',5, true);" );
      ((Element)v.get(123)).setAttribute("onshtab","ejecutarAccionFoco('cobGuionArgumCabecViewFrm',5, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(125)).setAttribute("nombre","paisOidPaisGapTdId" );
      ...
      /* Empieza nodo:129 / Elemento padre: 94   */
      v.add(doc.createElement("TD"));
      ((Element)v.get(129)).setAttribute("width","100%" );
      ((Element)v.get(94)).appendChild((Element)v.get(129));
      /* Termina nodo:129   */
      /* Termina nodo:94   */
   ...
   private void getXML630(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(139)).setAttribute("nombre","cobGuionArgumCabecViewTrButtons" );
      ...
      ((Element)v.get(146)).setAttribute("nombre","cobGuionArgumCabecViewTdQueryButton" );
      ((Element)v.get(145)).appendChild((Element)v.get(146));

      /* Empieza nodo:147 / Elemento padre: 146   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(147)).setAttribute("nombre","cobGuionArgumCabecViewQueryButton" );
      ((Element)v.get(147)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(147)).setAttribute("estado","false" );
      ((Element)v.get(147)).setAttribute("accion","cobGuionArgumCabecViewFirstPage();" );
      ...
      ((Element)v.get(148)).setAttribute("nombre","cobGuionArgumCabecViewTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(150)).setAttribute("nombre","cobGuionArgumCabecViewLovNullButton" );
      ((Element)v.get(150)).setAttribute("ID","botonContenido" );
      ((Element)v.get(150)).setAttribute("tipo","html" );
      ((Element)v.get(150)).setAttribute("accion","cobGuionArgumCabecViewLovNullSelectionAction();" );
