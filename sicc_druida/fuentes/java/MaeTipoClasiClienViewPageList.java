...
public class MaeTipoClasiClienViewPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","maeTipoClasiClienViewList" );
      ...
      ((Element)v.get(14)).setAttribute("cod","MaeTipoClasiClienView.codTipoClas.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","MaeTipoClasiClienView.Descripcion.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","MaeTipoClasiClienView.sbtiOidSubtClie.label" );
