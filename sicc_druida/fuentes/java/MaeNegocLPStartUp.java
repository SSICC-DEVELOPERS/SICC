/*
    INDRA/CAR/mmg
    $Id: MaeNegocLPStartUp.java,v 1.1 2009/12/03 18:37:25 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class MaeNegocLPStartUp extends MMGDruidaBase{
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "MaeNegocPage", "cod", "MaeNegoc." + accion + ".label");
			...
			limpiarBotoneraLista("maeNegoc", accion);
	...
	protected void cmdLov() throws Exception{
		...
		//asignarAtributo("CAPA", "maeNegocLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "MaeNegocPage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("MaeNegocLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		MaeNegocData maeNegocQuery= new MaeNegocData();
		maeNegocQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		MaeNegocData datosResult = (MaeNegocData)getSingleObject(BUSINESSID_QUERY, maeNegocQuery, 
			maeNegocQuery.clone(), "maeNegoc");
		...
		preservaHiddensI18n(new Integer(1), "MAE_NEGOC", "maeNegocFrm", "Descripcion", true);
		...
		MaeNegocData maeNegoc = datosResult;
		asignar("TEXT", "codNego", FormatUtils.formatObject(maeNegoc.getCodNego(), 
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "MAE_NEGOC", "maeNegocFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('maeNegocFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "maeNegocFrm", "oculto", "N");
		...
		traza("MMG::Creando MaeNegoc");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		MaeNegocData maeNegocQuery= new MaeNegocData();
		maeNegocQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(maeNegoc.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"maeNegocFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"maeNegocFrm\",1, false)");
					asignarAtributo("COMBO","paisOidPais", "ontab", "ejecutarAccionFocoModificacion(\"maeNegocFrm\",2, true)");
					asignarAtributo("COMBO","paisOidPais", "onshtab", "ejecutarAccionFocoModificacion(\"maeNegocFrm\",2, false)");
				asignarAtributo("AREATEXTO", "codNego", "ontab","ejecutarAccionFocoModificacion(\"maeNegocFrm\",3, true)");
				asignarAtributo("AREATEXTO", "codNego", "onshtab","ejecutarAccionFocoModificacion(\"maeNegocFrm\",3, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"maeNegocFrm\",4, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"maeNegocFrm\",4, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","maeNegocTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","maeNegocTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","maeNegocFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","maeNegocListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","maeNegocListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(MaeNegocData maeNegoc) throws Exception{
		...
		if(maeNegoc != null && maeNegoc.getPaisOidPais() != null){
				checkCombo("paisOidPais" , maeNegoc.getPaisOidPais().getId().toString());
			}
	...
	* @param maeNegoc La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(MaeNegocData maeNegoc) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		MaeNegocData maeNegoc = 
			(MaeNegocData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(maeNegoc.getPaisOidPais() != null){
			maeNegoc.setPaisOidPais((es.indra.belcorp.mso.SegPaisViewData)
			getSingleObject(BUSINESSID_PAISOIDPAIS_QUERY, 
			maeNegoc.getPaisOidPais(),
			maeNegoc.getPaisOidPais().clone(),
			"segPaisView"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(maeNegoc);
		loadLeafDependenceCombos(maeNegoc);
	}
	...
	*/
	...
	protected void loadLocalizationVars(MaeNegocData maeNegoc) throws Exception{
		...
		mmgLocalizationQuery.setEntiPk(maeNegoc.getId());
