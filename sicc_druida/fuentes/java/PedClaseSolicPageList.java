...
public class PedClaseSolicPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","pedClaseSolicList" );
      ...
      ((Element)v.get(14)).setAttribute("cod","PedClaseSolic.codClasSoli.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","PedClaseSolic.Descripcion.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","PedClaseSolic.indOrdeComp.label" );
