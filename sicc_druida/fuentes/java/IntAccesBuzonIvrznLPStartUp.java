/*
    INDRA/CAR/mmg
    $Id: IntAccesBuzonIvrznLPStartUp.java,v 1.1 2009/12/03 18:37:15 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class IntAccesBuzonIvrznLPStartUp extends MMGDruidaBase{
	...
	public static final String BUSINESSID_QUERY = "MMGIntAccesBuzonIvrznQueryFromToUserPage";
				...
				public static final String BUSINESSID_ZZONOIDZONA_QUERY ="MMGZonZonaView2QueryFromToUser";
				...
				public static final String ZZONOIDZONA_COMBO_CONNECTOR = "ZonZonaView2ConectorCombo";
	...
	public IntAccesBuzonIvrznLPStartUp(){
		super();
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			buildJsPageSize("IntAccesBuzonIvrzn");
			...
			asignarAtributo("PAGINA", "IntAccesBuzonIvrznPage", "cod", "IntAccesBuzonIvrzn." + accion + ".label");
			...
			limpiarBotoneraLista("intAccesBuzonIvrzn", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codAcceBuzoIvrz", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 4);");
		
		
		//Primero determianmos el nombre del campo en la entidad de oriegen donde se van a cargar los datos
		asignar("VAR", "idAttributeLovOpener", conectorParametro(PARAMETRO_LOV_ATTRIBUTO));
		asignar("VAR", "idEntityLovOpener", conectorParametro(PARAMETRO_LOV_ENTIDAD));
		//asignarAtributo("CAPA", "intAccesBuzonIvrznLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "IntAccesBuzonIvrznPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		IntAccesBuzonIvrznData intAccesBuzonIvrznQuery= new IntAccesBuzonIvrznData();
		intAccesBuzonIvrznQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		IntAccesBuzonIvrznData datosResult = (IntAccesBuzonIvrznData)getSingleObject(BUSINESSID_QUERY, intAccesBuzonIvrznQuery, 
			intAccesBuzonIvrznQuery.clone(), "intAccesBuzonIvrzn");
		...
		IntAccesBuzonIvrznData intAccesBuzonIvrzn = datosResult;
		asignar("TEXT", "codAcceBuzoIvrz", FormatUtils.formatObject(intAccesBuzonIvrzn.getCodAcceBuzoIvrz(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		es.indra.belcorp.mso.ZonZonaView2Data zzonOidZona = intAccesBuzonIvrzn.getZzonOidZona();
		...
		asignarAtributo("TEXT", "codAcceBuzoIvrz", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		...
		asignarAtributo("TEXT", "codAcceBuzoIvrz", "req", "S");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "intAccesBuzonIvrznFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		IntAccesBuzonIvrznData intAccesBuzonIvrznQuery= new IntAccesBuzonIvrznData();
		intAccesBuzonIvrznQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(intAccesBuzonIvrzn.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"intAccesBuzonIvrznFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"intAccesBuzonIvrznFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codAcceBuzoIvrz", "ontab","ejecutarAccionFocoModificacion(\"intAccesBuzonIvrznFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codAcceBuzoIvrz", "onshtab","ejecutarAccionFocoModificacion(\"intAccesBuzonIvrznFrm\",2, false)");
					asignarAtributo("COMBO","zzonOidZona_marcOidMarc", "ontab", "ejecutarAccionFocoModificacion(\"intAccesBuzonIvrznFrm\",3, true)");
					asignarAtributo("COMBO","zzonOidZona_marcOidMarc", "onshtab", "ejecutarAccionFocoModificacion(\"intAccesBuzonIvrznFrm\",3, false)");
					asignarAtributo("COMBO","zzonOidZona_canaOidCana", "ontab", "ejecutarAccionFocoModificacion(\"intAccesBuzonIvrznFrm\",3, true)");
					asignarAtributo("COMBO","zzonOidZona_canaOidCana", "onshtab", "ejecutarAccionFocoModificacion(\"intAccesBuzonIvrznFrm\",3, false)");
					asignarAtributo("COMBO","zzonOidZona", "ontab", "ejecutarAccionFocoModificacion(\"intAccesBuzonIvrznFrm\",3, true)");
					asignarAtributo("COMBO","zzonOidZona", "onshtab", "ejecutarAccionFocoModificacion(\"intAccesBuzonIvrznFrm\",3, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","intAccesBuzonIvrznTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","intAccesBuzonIvrznTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","intAccesBuzonIvrznFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","intAccesBuzonIvrznListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","intAccesBuzonIvrznListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(IntAccesBuzonIvrznData intAccesBuzonIvrzn) throws Exception{
		...
		asignarComboResultados(BUSINESSID_ZZONOIDZONA_MARCOIDMARC_QUERY,ZZONOIDZONA_MARCOIDMARC_COMBO_CONNECTOR, 
			zzonOidZona_marcOidMarc, zzonOidZona_marcOidMarc.clone(), "segMarca", "zzonOidZona_marcOidMarc", 
            "result_ROWSET" );
        
        // SPLATAS - 07/02/06
        // if(intAccesBuzonIvrzn != null && intAccesBuzonIvrzn.getZzonOidZona().getMarcOidMarc() != null){
		if(intAccesBuzonIvrzn != null && intAccesBuzonIvrzn.getZzonOidZona() != null
                && intAccesBuzonIvrzn.getZzonOidZona().getMarcOidMarc() != null){
			checkCombo("zzonOidZona_marcOidMarc" , 
                    intAccesBuzonIvrzn.getZzonOidZona().getMarcOidMarc().getId().toString());
		}
		
		asignarComboResultados(BUSINESSID_ZZONOIDZONA_CANAOIDCANA_QUERY,ZZONOIDZONA_CANAOIDCANA_COMBO_CONNECTOR, 
			zzonOidZona_canaOidCana, zzonOidZona_canaOidCana.clone(), "segCanalView", "zzonOidZona_canaOidCana", 
            "result_ROWSET" );
        
		// SPLATAS - 07/02/06
        // if(intAccesBuzonIvrzn != null && intAccesBuzonIvrzn.getZzonOidZona().getCanaOidCana() != null){
		if(intAccesBuzonIvrzn != null && intAccesBuzonIvrzn.getZzonOidZona() != null
                && intAccesBuzonIvrzn.getZzonOidZona().getCanaOidCana() != null){
			checkCombo("zzonOidZona_canaOidCana" , 
                    intAccesBuzonIvrzn.getZzonOidZona().getCanaOidCana().getId().toString());
		}
        
		String zzonOidZona_marcOidMarcDefaultValue = 
		...
		String zzonOidZona_canaOidCanaDefaultValue = 
	...
	*/
	public void cascadeComboLoad(HashMap checkedCombos, String comboName) throws Exception{
						...
						if(comboName.trim().equals("zzonOidZona_marcOidMarc")  || comboName.trim().equals("zzonOidZona_canaOidCana") ){
			...
			if(zzonOidZona_marcOidMarcDefaultValue != null &&zzonOidZona_canaOidCanaDefaultValue != null){
				ZonZonaView2Data zzonOidZona= new ZonZonaView2Data();
				...
				asignarComboResultados(BUSINESSID_ZZONOIDZONA_QUERY,ZZONOIDZONA_COMBO_CONNECTOR, 
					zzonOidZona, zzonOidZona.clone(), "zonZonaView2", "zzonOidZona", "result_ROWSET",false );
			}
		}
	...
	* @param intAccesBuzonIvrzn La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(IntAccesBuzonIvrznData intAccesBuzonIvrzn) 
		throws Exception{
		
						if(intAccesBuzonIvrzn.getZzonOidZona() != null){
			
						ZonZonaView2Data zzonOidZona = new ZonZonaView2Data();
			zzonOidZona.setMarcOidMarc(intAccesBuzonIvrzn.getZzonOidZona().getMarcOidMarc());
			zzonOidZona.setCanaOidCana(intAccesBuzonIvrzn.getZzonOidZona().getCanaOidCana());
			asignarComboResultados(BUSINESSID_ZZONOIDZONA_QUERY,ZZONOIDZONA_COMBO_CONNECTOR, zzonOidZona, zzonOidZona.clone(), "zonZonaView2", "zzonOidZona", "result_ROWSET");
			checkCombo("zzonOidZona" , intAccesBuzonIvrzn.getZzonOidZona().getId().toString());
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		IntAccesBuzonIvrznData intAccesBuzonIvrzn = 
			(IntAccesBuzonIvrznData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(intAccesBuzonIvrzn.getZzonOidZona() != null){
			intAccesBuzonIvrzn.setZzonOidZona((es.indra.belcorp.mso.ZonZonaView2Data)
			getSingleObject(BUSINESSID_ZZONOIDZONA_QUERY, 
			intAccesBuzonIvrzn.getZzonOidZona(),
			intAccesBuzonIvrzn.getZzonOidZona().clone(),
			"zonZonaView2"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(intAccesBuzonIvrzn);
		loadLeafDependenceCombos(intAccesBuzonIvrzn);
	}
