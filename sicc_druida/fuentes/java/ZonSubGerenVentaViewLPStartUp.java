/*
    INDRA/CAR/mmg
    $Id: ZonSubGerenVentaViewLPStartUp.java,v 1.1 2009/12/03 18:32:50 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class ZonSubGerenVentaViewLPStartUp extends MMGDruidaBase{
	//Constantes que definen la altura de los formularios según el modo
	public static final short QUERYFORM_SIZE = 483;
	public static final short CREATEFORM_SIZE = 473;
	public static final short UPDATEFORM_SIZE = 473;
	public static final short VIEWFORM_SIZE = 473;
	...
	public ZonSubGerenVentaViewLPStartUp(){
		super();
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			buildJsPageSize("ZonSubGerenVentaView");
			...
			asignarAtributo("PAGINA", "ZonSubGerenVentaViewPage", "cod", "ZonSubGerenVentaView." + accion + ".label");
			...
			limpiarBotoneraLista("zonSubGerenVentaView", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codSubgVent", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 2);");
		...
		asignarAtributo("TEXT", "desSubgVent", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 0, 40);");
		...
		//asignarAtributo("CAPA", "zonSubGerenVentaViewLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "ZonSubGerenVentaViewPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		ZonSubGerenVentaViewData zonSubGerenVentaViewQuery= new ZonSubGerenVentaViewData();
		zonSubGerenVentaViewQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		ZonSubGerenVentaViewData datosResult = (ZonSubGerenVentaViewData)getSingleObject(BUSINESSID_QUERY, zonSubGerenVentaViewQuery, 
			zonSubGerenVentaViewQuery.clone(), "zonSubGerenVentaView");
		...
		ZonSubGerenVentaViewData zonSubGerenVentaView = datosResult;
		es.indra.belcorp.mso.SegPaisViewData paisOidPais = zonSubGerenVentaView.getPaisOidPais();
		if(paisOidPais != null && paisOidPais.getId() != null) checkCombo("paisOidPais" , paisOidPais.getId().toString());
		asignar("TEXT", "codSubgVent", FormatUtils.formatObject(zonSubGerenVentaView.getCodSubgVent(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "indBorr", FormatUtils.formatObject(zonSubGerenVentaView.getIndBorr(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "indActi", FormatUtils.formatObject(zonSubGerenVentaView.getIndActi(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "codNse1", FormatUtils.formatObject(zonSubGerenVentaView.getCodNse1(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "codNse2", FormatUtils.formatObject(zonSubGerenVentaView.getCodNse2(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "codNse3", FormatUtils.formatObject(zonSubGerenVentaView.getCodNse3(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "desSubgVent", FormatUtils.formatObject(zonSubGerenVentaView.getDesSubgVent(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		es.indra.belcorp.mso.SegMarcaData marcOidMarc = zonSubGerenVentaView.getMarcOidMarc();
		if(marcOidMarc != null && marcOidMarc.getId() != null) checkCombo("marcOidMarc" , marcOidMarc.getId().toString());
		es.indra.belcorp.mso.SegCanalViewData canaOidCana = zonSubGerenVentaView.getCanaOidCana();
		...
		//Deshabilitamos todos los campos para que no se editen
					...
					asignarAtributo("COMBO", "paisOidPais", "disabled", "S");asignarAtributo("TEXT", "codSubgVent", "disabled", "S");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "zonSubGerenVentaViewFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		ZonSubGerenVentaViewData zonSubGerenVentaViewQuery= new ZonSubGerenVentaViewData();
		zonSubGerenVentaViewQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(zonSubGerenVentaView.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"zonSubGerenVentaViewFrm\",0, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"zonSubGerenVentaViewFrm\",0, false)");
					asignarAtributo("COMBO","paisOidPais", "ontab", "ejecutarAccionFocoModificacion(\"zonSubGerenVentaViewFrm\",0, true)");
					asignarAtributo("COMBO","paisOidPais", "onshtab", "ejecutarAccionFocoModificacion(\"zonSubGerenVentaViewFrm\",0, false)");
				asignarAtributo("AREATEXTO", "codSubgVent", "ontab","ejecutarAccionFocoModificacion(\"zonSubGerenVentaViewFrm\",0, true)");
				asignarAtributo("AREATEXTO", "codSubgVent", "onshtab","ejecutarAccionFocoModificacion(\"zonSubGerenVentaViewFrm\",0, false)");
				asignarAtributo("AREATEXTO", "indBorr", "ontab","ejecutarAccionFocoModificacion(\"zonSubGerenVentaViewFrm\",0, true)");
				asignarAtributo("AREATEXTO", "indBorr", "onshtab","ejecutarAccionFocoModificacion(\"zonSubGerenVentaViewFrm\",0, false)");
				asignarAtributo("AREATEXTO", "indActi", "ontab","ejecutarAccionFocoModificacion(\"zonSubGerenVentaViewFrm\",0, true)");
				asignarAtributo("AREATEXTO", "indActi", "onshtab","ejecutarAccionFocoModificacion(\"zonSubGerenVentaViewFrm\",0, false)");
				asignarAtributo("AREATEXTO", "codNse1", "ontab","ejecutarAccionFocoModificacion(\"zonSubGerenVentaViewFrm\",0, true)");
				asignarAtributo("AREATEXTO", "codNse1", "onshtab","ejecutarAccionFocoModificacion(\"zonSubGerenVentaViewFrm\",0, false)");
				asignarAtributo("AREATEXTO", "codNse2", "ontab","ejecutarAccionFocoModificacion(\"zonSubGerenVentaViewFrm\",0, true)");
				asignarAtributo("AREATEXTO", "codNse2", "onshtab","ejecutarAccionFocoModificacion(\"zonSubGerenVentaViewFrm\",0, false)");
				asignarAtributo("AREATEXTO", "codNse3", "ontab","ejecutarAccionFocoModificacion(\"zonSubGerenVentaViewFrm\",0, true)");
				asignarAtributo("AREATEXTO", "codNse3", "onshtab","ejecutarAccionFocoModificacion(\"zonSubGerenVentaViewFrm\",0, false)");
				asignarAtributo("AREATEXTO", "desSubgVent", "ontab","ejecutarAccionFocoModificacion(\"zonSubGerenVentaViewFrm\",0, true)");
				asignarAtributo("AREATEXTO", "desSubgVent", "onshtab","ejecutarAccionFocoModificacion(\"zonSubGerenVentaViewFrm\",0, false)");
					asignarAtributo("COMBO","marcOidMarc", "ontab", "ejecutarAccionFocoModificacion(\"zonSubGerenVentaViewFrm\",0, true)");
					asignarAtributo("COMBO","marcOidMarc", "onshtab", "ejecutarAccionFocoModificacion(\"zonSubGerenVentaViewFrm\",0, false)");
					asignarAtributo("COMBO","canaOidCana", "ontab", "ejecutarAccionFocoModificacion(\"zonSubGerenVentaViewFrm\",0, true)");
					asignarAtributo("COMBO","canaOidCana", "onshtab", "ejecutarAccionFocoModificacion(\"zonSubGerenVentaViewFrm\",0, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","zonSubGerenVentaViewTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","zonSubGerenVentaViewTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codSubgVent...");		
				...
				traza("MMG: el atributo es desSubgVent...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","zonSubGerenVentaViewFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","zonSubGerenVentaViewListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","zonSubGerenVentaViewListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(ZonSubGerenVentaViewData zonSubGerenVentaView) throws Exception{
		...
		if(zonSubGerenVentaView != null && zonSubGerenVentaView.getPaisOidPais() != null){
				checkCombo("paisOidPais" , zonSubGerenVentaView.getPaisOidPais().getId().toString());
			}
		...
		if(zonSubGerenVentaView != null && zonSubGerenVentaView.getMarcOidMarc() != null){
				checkCombo("marcOidMarc" , zonSubGerenVentaView.getMarcOidMarc().getId().toString());
			}
		...
		if(zonSubGerenVentaView != null && zonSubGerenVentaView.getCanaOidCana() != null){
				checkCombo("canaOidCana" , zonSubGerenVentaView.getCanaOidCana().getId().toString());
			}
	...
	* @param zonSubGerenVentaView La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(ZonSubGerenVentaViewData zonSubGerenVentaView) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		ZonSubGerenVentaViewData zonSubGerenVentaView = 
			(ZonSubGerenVentaViewData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(zonSubGerenVentaView.getPaisOidPais() != null){
			zonSubGerenVentaView.setPaisOidPais((es.indra.belcorp.mso.SegPaisViewData)
			getSingleObject(BUSINESSID_PAISOIDPAIS_QUERY, 
			zonSubGerenVentaView.getPaisOidPais(),
			zonSubGerenVentaView.getPaisOidPais().clone(),
			"segPaisView"));
		}
		if(zonSubGerenVentaView.getMarcOidMarc() != null){
			zonSubGerenVentaView.setMarcOidMarc((es.indra.belcorp.mso.SegMarcaData)
			getSingleObject(BUSINESSID_MARCOIDMARC_QUERY, 
			zonSubGerenVentaView.getMarcOidMarc(),
			zonSubGerenVentaView.getMarcOidMarc().clone(),
			"segMarca"));
		}
		if(zonSubGerenVentaView.getCanaOidCana() != null){
			zonSubGerenVentaView.setCanaOidCana((es.indra.belcorp.mso.SegCanalViewData)
			getSingleObject(BUSINESSID_CANAOIDCANA_QUERY, 
			zonSubGerenVentaView.getCanaOidCana(),
			zonSubGerenVentaView.getCanaOidCana().clone(),
			"segCanalView"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(zonSubGerenVentaView);
		loadLeafDependenceCombos(zonSubGerenVentaView);
	}
