...
public class BelCajaPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","belCajaList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","BelCaja.sbacOidSbac.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","BelCaja.codCaja.label" );
      ...
      ((Element)v.get(17)).setAttribute("cod","BelCaja.userOidUser.label" );
      ...
      ((Element)v.get(18)).setAttribute("cod","BelCaja.ticjOidTipoCaja.label" );
