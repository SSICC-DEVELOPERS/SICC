...
public class BelTipoMedioPagoPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","belTipoMedioPagoList" );
      ...
      ((Element)v.get(12)).setAttribute("cod","BelTipoMedioPago.Descripcion.label" );
