...
public class CccCuentContaPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","cccCuentContaList" );
      ...
      ((Element)v.get(14)).setAttribute("cod","CccCuentConta.codCuenCont.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","CccCuentConta.Descripcion.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","CccCuentConta.codCuenSap.label" );
