...
public class CarTipoReevaPage  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","CarTipoReevaPage" );
      ((Element)v.get(0)).setAttribute("titulo","" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","" );
      ((Element)v.get(0)).setAttribute("onload","carTipoReevaInitComponents()" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(3)).setAttribute("src","cartiporeeva.js" );
      ((Element)v.get(0)).appendChild((Element)v.get(3));
      /* Termina nodo:3   */

      /* Empieza nodo:4 / Elemento padre: 0   */
      v.add(doc.createElement("FORMULARIO"));
      ((Element)v.get(4)).setAttribute("nombre","carTipoReevaFrm" );
      ...
      ((Element)v.get(5)).setAttribute("valor","CarTipoReevaLPExecution" );
      ...
      ((Element)v.get(6)).setAttribute("valor","CarTipoReevaLPExecution" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(24)).setAttribute("nombre","carTipoReevaFormLayer" );
      ...
      ((Element)v.get(39)).setAttribute("cod","CarTipoReeva.legend.label" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(54)).setAttribute("cod","CarTipoReeva.id.label" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('carTipoReevaFrm',0, true)" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('carTipoReevaFrm', 0, false)" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(75)).setAttribute("nombre","carTipoReevaTrButtons" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(82)).setAttribute("nombre","carTipoReevaTdQueryButton" );
      ((Element)v.get(81)).appendChild((Element)v.get(82));

      /* Empieza nodo:83 / Elemento padre: 82   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(83)).setAttribute("nombre","carTipoReevaQueryButton" );
      ((Element)v.get(83)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(83)).setAttribute("estado","false" );
      ((Element)v.get(83)).setAttribute("accion","carTipoReevaFirstPage();" );
      ...
      ((Element)v.get(84)).setAttribute("nombre","carTipoReevaTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(86)).setAttribute("nombre","carTipoReevaLovNullButton" );
      ((Element)v.get(86)).setAttribute("ID","botonContenido" );
      ((Element)v.get(86)).setAttribute("tipo","html" );
      ((Element)v.get(86)).setAttribute("accion","carTipoReevaLovNullSelectionAction();" );
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(89)).setAttribute("nombre","carTipoReevaPreListLayer" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(118)).setAttribute("nombre","carTipoReevaListLayer" );
      ...
      ((Element)v.get(119)).setAttribute("nombre","carTipoReevaList" );
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(131)).setAttribute("nombre","carTipoReevaListButtonsLayer" );
   ...
   private void getXML630(Document doc) {
      ...
      ((Element)v.get(133)).setAttribute("nombre","carTipoReevaUpdateButtonTd" );
      ((Element)v.get(132)).appendChild((Element)v.get(133));

      /* Empieza nodo:134 / Elemento padre: 133   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(134)).setAttribute("nombre","carTipoReevaUpdateButton" );
      ((Element)v.get(134)).setAttribute("ID","botonContenido" );
      ((Element)v.get(134)).setAttribute("tipo","html" );
      ((Element)v.get(134)).setAttribute("accion","carTipoReevaUpdateSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(135)).setAttribute("nombre","carTipoReevaUpdateButtonGapTd" );
      ...
      ((Element)v.get(137)).setAttribute("nombre","carTipoReevaRemoveButtonTd" );
      ((Element)v.get(132)).appendChild((Element)v.get(137));

      /* Empieza nodo:138 / Elemento padre: 137   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(138)).setAttribute("nombre","carTipoReevaRemoveButton" );
      ((Element)v.get(138)).setAttribute("ID","botonContenido" );
      ((Element)v.get(138)).setAttribute("tipo","html" );
      ((Element)v.get(138)).setAttribute("accion","carTipoReevaRemoveSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(139)).setAttribute("nombre","carTipoReevaRemoveButtonGapTd" );
      ...
      ((Element)v.get(141)).setAttribute("nombre","carTipoReevaViewForRemoveButtonTd" );
      ((Element)v.get(132)).appendChild((Element)v.get(141));

      /* Empieza nodo:142 / Elemento padre: 141   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(142)).setAttribute("nombre","carTipoReevaViewForRemoveButton" );
      ((Element)v.get(142)).setAttribute("ID","botonContenido" );
      ((Element)v.get(142)).setAttribute("tipo","html" );
      ((Element)v.get(142)).setAttribute("accion","carTipoReevaViewSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(143)).setAttribute("nombre","carTipoReevaViewForRemoveButtonGapTd" );
      ...
      ((Element)v.get(145)).setAttribute("nombre","carTipoReevaLovSelectButtonTd" );
      ((Element)v.get(132)).appendChild((Element)v.get(145));

      /* Empieza nodo:146 / Elemento padre: 145   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(146)).setAttribute("nombre","carTipoReevaLovSelectButton" );
      ((Element)v.get(146)).setAttribute("ID","botonContenido" );
      ((Element)v.get(146)).setAttribute("tipo","html" );
      ((Element)v.get(146)).setAttribute("accion","carTipoReevaLovSelectionAction();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(147)).setAttribute("nombre","carTipoReevaLovSelectButtonGapTd" );
      ...
      ((Element)v.get(149)).setAttribute("nombre","carTipoReevaViewButtonTd" );
      ((Element)v.get(132)).appendChild((Element)v.get(149));

      /* Empieza nodo:150 / Elemento padre: 149   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(150)).setAttribute("nombre","carTipoReevaViewButton" );
      ((Element)v.get(150)).setAttribute("ID","botonContenido" );
      ((Element)v.get(150)).setAttribute("tipo","html" );
   }

   private void getXML720(Document doc) {
      ((Element)v.get(150)).setAttribute("accion","carTipoReevaViewSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(151)).setAttribute("nombre","carTipoReevaViewButtonGapTd" );
      ...
      ((Element)v.get(154)).setAttribute("nombre","carTipoReevaPaginationButtonBar" );
      ...
      ((Element)v.get(155)).setAttribute("nombre","carTipoReevaFirstPageButton" );
      ((Element)v.get(155)).setAttribute("funcion","carTipoReevaFirstPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(156)).setAttribute("nombre","carTipoReevaFirstPageButtonGapTd" );
      ...
      v.add(doc.createElement("BTN"));
      ((Element)v.get(158)).setAttribute("nombre","carTipoReevaPreviousPageButton" );
      ((Element)v.get(158)).setAttribute("funcion","carTipoReevaPreviousPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(159)).setAttribute("nombre","carTipoReevaPreviousPageButtonGapTd" );
      ...
      v.add(doc.createElement("BTN"));
      ((Element)v.get(161)).setAttribute("nombre","carTipoReevaNextPageButton" );
      ((Element)v.get(161)).setAttribute("funcion","carTipoReevaNextPage();" );
