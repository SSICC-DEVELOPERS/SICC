...
public class ConectorConsultarEtapasCobranza  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","ConectorConsultarCronogramaCobranza" );
