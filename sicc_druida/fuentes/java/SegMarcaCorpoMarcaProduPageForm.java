...
public class SegMarcaCorpoMarcaProduPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","SegMarcaCorpoMarcaProdu.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","SegMarcaCorpoMarcaProdu.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('segMarcaCorpoMarcaProduFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('segMarcaCorpoMarcaProduFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(54)).setAttribute("cod","SegMarcaCorpoMarcaProdu.marcOidMarc.label" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('segMarcaCorpoMarcaProduFrm',2, true);" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('segMarcaCorpoMarcaProduFrm',2, false);" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(76)).setAttribute("nombre","maprOidMarcProdTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(80)).setAttribute("nombre","lblmaprOidMarcProd" );
      ((Element)v.get(80)).setAttribute("id","datosTitle" );
      ((Element)v.get(80)).setAttribute("ancho","150" );
      ((Element)v.get(80)).setAttribute("alto","13" );
      ((Element)v.get(80)).setAttribute("cod","SegMarcaCorpoMarcaProdu.maprOidMarcProd.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(81)).setAttribute("nombre","maprOidMarcProdWidgetTrId" );
   }
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(83)).setAttribute("nombre","maprOidMarcProd" );
      ...
      ((Element)v.get(83)).setAttribute("ontab","ejecutarAccionFoco('segMarcaCorpoMarcaProduFrm',3, true);" );
      ((Element)v.get(83)).setAttribute("onshtab","ejecutarAccionFoco('segMarcaCorpoMarcaProduFrm',3, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(85)).setAttribute("nombre","maprOidMarcProdGapTdId" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(102)).setAttribute("nombre","paisOidPaisTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(106)).setAttribute("nombre","lblpaisOidPais" );
      ...
      ((Element)v.get(106)).setAttribute("cod","SegMarcaCorpoMarcaProdu.paisOidPais.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(107)).setAttribute("nombre","paisOidPaisWidgetTrId" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(109)).setAttribute("nombre","paisOidPais" );
      ...
      ((Element)v.get(109)).setAttribute("ontab","ejecutarAccionFoco('segMarcaCorpoMarcaProduFrm',5, true);" );
      ((Element)v.get(109)).setAttribute("onshtab","ejecutarAccionFoco('segMarcaCorpoMarcaProduFrm',5, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(111)).setAttribute("nombre","paisOidPaisGapTdId" );
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(125)).setAttribute("nombre","segMarcaCorpoMarcaProduTrButtons" );
      ...
      ((Element)v.get(132)).setAttribute("nombre","segMarcaCorpoMarcaProduTdQueryButton" );
      ((Element)v.get(131)).appendChild((Element)v.get(132));

      /* Empieza nodo:133 / Elemento padre: 132   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(133)).setAttribute("nombre","segMarcaCorpoMarcaProduQueryButton" );
      ((Element)v.get(133)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(133)).setAttribute("estado","false" );
      ((Element)v.get(133)).setAttribute("accion","segMarcaCorpoMarcaProduFirstPage();" );
      ...
      ((Element)v.get(134)).setAttribute("nombre","segMarcaCorpoMarcaProduTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(136)).setAttribute("nombre","segMarcaCorpoMarcaProduLovNullButton" );
      ((Element)v.get(136)).setAttribute("ID","botonContenido" );
      ((Element)v.get(136)).setAttribute("tipo","html" );
      ((Element)v.get(136)).setAttribute("accion","segMarcaCorpoMarcaProduLovNullSelectionAction();" );
