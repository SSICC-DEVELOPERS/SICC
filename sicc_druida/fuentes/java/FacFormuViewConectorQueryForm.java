...
public class FacFormuViewConectorQueryForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad FacFormuView" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGFacFormuViewQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGFacFormuViewQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","FacFormuViewFormFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(8)).setAttribute("NOMBRE","deimOidDestImpr" );
