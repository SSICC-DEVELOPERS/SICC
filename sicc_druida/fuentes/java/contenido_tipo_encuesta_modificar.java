...
public class contenido_tipo_encuesta_modificar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_tipo_encuesta_modificar" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","contenido_tipo_encuesta_modificar.js" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(14)).setAttribute("nombre","oidTipoEncuesta" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(15)).setAttribute("nombre","CodEncuesta" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(16)).setAttribute("nombre","descripcion" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(18)).setAttribute("nombre","desMarace" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(40)).setAttribute("width","584" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(48)).setAttribute("nombre","lblCodEncuesta" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(48)).setAttribute("cod","MaeEncueAplicClien.enseOidEncu.label" );
      ...
      ((Element)v.get(52)).setAttribute("cod","MaeEncueNse.Descripcion.label" );
      ...
      ((Element)v.get(59)).setAttribute("nombre","txtCodEncuesta" );
      ((Element)v.get(59)).setAttribute("id","datosCampos" );
      ((Element)v.get(59)).setAttribute("max","3" );
      ((Element)v.get(59)).setAttribute("tipo","" );
      ((Element)v.get(59)).setAttribute("onchange","" );
      ((Element)v.get(59)).setAttribute("req","N" );
      ((Element)v.get(59)).setAttribute("size","3" );
      ((Element)v.get(59)).setAttribute("valor","" );
      ((Element)v.get(59)).setAttribute("validacion","" );
      ((Element)v.get(59)).setAttribute("onshtab","onShTabTxtCodEncuesta();" );
      ((Element)v.get(59)).setAttribute("ontab","onTabTxtCodEncuesta();" );
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(63)).setAttribute("nombre","txtDescripcion" );
      ...
      ((Element)v.get(63)).setAttribute("size","30" );
      ((Element)v.get(63)).setAttribute("valor","" );
      ((Element)v.get(63)).setAttribute("validacion","" );
      ((Element)v.get(63)).setAttribute("onshtab","onShTabTxtDescripcion();" );
      ((Element)v.get(63)).setAttribute("ontab","onTabTxtDescripcion();" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(71)).setAttribute("width","584" );
      ...
      ((Element)v.get(76)).setAttribute("cod","MaeEncueNseView.marcOidMarc.label" );
      ...
      ((Element)v.get(83)).setAttribute("ontab","onTabCbMarca();" );
      ((Element)v.get(83)).setAttribute("onshtab","onShTabCbMarca();" );
      ...
      /* Empieza nodo:90 / Elemento padre: 34   */
      v.add(doc.createElement("table"));
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(34)).appendChild((Element)v.get(90));
      ...
      ((Element)v.get(93)).setAttribute("nombre","btnBuscar" );
      ((Element)v.get(93)).setAttribute("ID","botonContenido" );
      ((Element)v.get(93)).setAttribute("tipo","html" );
      ((Element)v.get(93)).setAttribute("accion","onClickBtnBuscar();" );
      ((Element)v.get(93)).setAttribute("estado","false" );
      ((Element)v.get(93)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(93)).setAttribute("ontab","onTabBtoBuscar();" );
      ((Element)v.get(93)).setAttribute("onshtab","onShTabBtoBuscar();" );
      ...
      /* Empieza nodo:96 / Elemento padre: 22   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(22)).appendChild((Element)v.get(96));
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(99)).setAttribute("width","756" );
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(103)).setAttribute("nombre","capaLista" );
      ((Element)v.get(103)).setAttribute("ancho","100%" );
      ((Element)v.get(103)).setAttribute("alto","330" );
      ((Element)v.get(103)).setAttribute("x","5" );
      ((Element)v.get(103)).setAttribute("y","170" );
      ...
      ((Element)v.get(103)).setAttribute("visibilidad","" );
      ...
      ((Element)v.get(104)).setAttribute("ancho","369" );
      ((Element)v.get(104)).setAttribute("alto","301" );
      ((Element)v.get(104)).setAttribute("x","12" );
      ((Element)v.get(104)).setAttribute("y","0" );
      ...
      ((Element)v.get(107)).setAttribute("aximROver","bot_despliega_columna_over.gif" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(112)).setAttribute("cod","00135" );
      ...
      ((Element)v.get(114)).setAttribute("botonOrdenar","S" );
      ...
      ((Element)v.get(119)).setAttribute("alto","25" );
      ...
      ((Element)v.get(120)).setAttribute("cod","MaeEncueAplicClien.enseOidEncu.label" );
      ((Element)v.get(119)).appendChild((Element)v.get(120));

      /* Elemento padre:120 / Elemento actual: 121   */
      v.add(doc.createTextNode("Codigo Encuesta"));
      ...
      ((Element)v.get(122)).setAttribute("cod","MaeEncueNse.Descripcion.label" );
      ...
      ((Element)v.get(124)).setAttribute("cod","MaeEncueNseView.marcOidMarc.label" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(126)).setAttribute("cod","MaeEncueNseView.marcOidMarc.label" );
      ((Element)v.get(119)).appendChild((Element)v.get(126));

      /* Elemento padre:126 / Elemento actual: 127   */
      v.add(doc.createTextNode("OID Marca"));
      ...
      ((Element)v.get(135)).setAttribute("y","282" );
      ...
      ((Element)v.get(136)).setAttribute("y","282" );
      ...
      /* Empieza nodo:137 / Elemento padre: 103   */
      v.add(doc.createElement("BOTON"));
      ...
      ((Element)v.get(103)).appendChild((Element)v.get(137));
      /* Termina nodo:137   */

      /* Empieza nodo:138 / Elemento padre: 103   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(138)).setAttribute("nombre","separa" );
      ((Element)v.get(138)).setAttribute("x","59" );
      ((Element)v.get(138)).setAttribute("y","278" );
   ...
   private void getXML630(Document doc) {
      ...
      ((Element)v.get(103)).appendChild((Element)v.get(138));
      /* Termina nodo:138   */

      /* Empieza nodo:139 / Elemento padre: 103   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(139)).setAttribute("nombre","btnDetalle" );
      ((Element)v.get(139)).setAttribute("x","80" );
      ((Element)v.get(139)).setAttribute("y","279" );
      ...
      ((Element)v.get(139)).setAttribute("cod","MMGGlobal.viewButton.label" );
      ((Element)v.get(139)).setAttribute("accion","onClickBtnDetalle();" );
      ((Element)v.get(139)).setAttribute("ontab","onTabBtnDetalle();" );
      ((Element)v.get(139)).setAttribute("onshtab","onShTabBtnDetalle();" );
      ((Element)v.get(103)).appendChild((Element)v.get(139));
      /* Termina nodo:139   */

      /* Empieza nodo:140 / Elemento padre: 103   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(140)).setAttribute("nombre","btnModificar" );
      ((Element)v.get(140)).setAttribute("x","80" );
      ((Element)v.get(140)).setAttribute("y","279" );
      ...
      ((Element)v.get(140)).setAttribute("cod","MMGGlobal.updateButton.label" );
      ((Element)v.get(140)).setAttribute("accion","onClickBtnModificar();" );
      ((Element)v.get(140)).setAttribute("ontab","ontabBtnModificar();" );
      ((Element)v.get(140)).setAttribute("onshtab","onshtabBtnModificar();" );
      ((Element)v.get(103)).appendChild((Element)v.get(140));
      /* Termina nodo:140   */
      /* Termina nodo:103   */
      /* Termina nodo:8   */
