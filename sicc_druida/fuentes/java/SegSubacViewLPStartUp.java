/*
    INDRA/CAR/mmg
    $Id: SegSubacViewLPStartUp.java,v 1.1 2009/12/03 18:33:16 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class SegSubacViewLPStartUp extends MMGDruidaBase{
	...
	public static final String BUSINESSID_QUERY = "MMGSegSubacViewQueryFromToUserPage";
	...
	public SegSubacViewLPStartUp(){
		super();
	}

	public void inicio() throws Exception {
		pagina("SegSubacViewPage");
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "SegSubacViewPage", "cod", "SegSubacView." + accion + ".label");
			...
			limpiarBotoneraLista("segSubacView", accion);
	...
	protected void cmdLov() throws Exception{
		...
		//asignarAtributo("CAPA", "segSubacViewLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "SegSubacViewPage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("SegSubacViewLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		SegSubacViewData segSubacViewQuery= new SegSubacViewData();
		segSubacViewQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		SegSubacViewData datosResult = (SegSubacViewData)getSingleObject(BUSINESSID_QUERY, segSubacViewQuery, 
			segSubacViewQuery.clone(), "segSubacView");
		...
		preservaHiddensI18n(new Integer(1), "SEG_SUBAC", "segSubacViewFrm", "Descripcion", true);
		...
		SegSubacViewData segSubacView = datosResult;
		asignar("TEXT", "Descripcion", FormatUtils.formatObject(segSubacView.getDescripcion(), 
		...
		loadLocalizationVars(segSubacView);
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "SEG_SUBAC", "segSubacViewFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('segSubacViewFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "segSubacViewFrm", "oculto", "N");
		...
		traza("MMG::Creando SegSubacView");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		SegSubacViewData segSubacViewQuery= new SegSubacViewData();
		segSubacViewQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(segSubacView.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"segSubacViewFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"segSubacViewFrm\",1, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"segSubacViewFrm\",2, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"segSubacViewFrm\",2, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","segSubacViewTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","segSubacViewTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","segSubacViewFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","segSubacViewListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","segSubacViewListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(SegSubacViewData segSubacView) throws Exception{
	...
	* @param segSubacView La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(SegSubacViewData segSubacView) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		SegSubacViewData segSubacView = 
			(SegSubacViewData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(segSubacView);
		loadLeafDependenceCombos(segSubacView);
	}
	...
	*/
	...
	protected void loadLocalizationVars(SegSubacViewData segSubacView) throws Exception{
		...
		mmgLocalizationQuery.setEntiPk(segSubacView.getId());
