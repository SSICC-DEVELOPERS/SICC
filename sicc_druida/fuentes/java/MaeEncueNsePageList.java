...
public class MaeEncueNsePageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","maeEncueNseList" );
      ...
      ((Element)v.get(14)).setAttribute("cod","MaeEncueNse.codTipoEncu.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","MaeEncueNse.Descripcion.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","MaeEncueNse.marcOidMarc.label" );
