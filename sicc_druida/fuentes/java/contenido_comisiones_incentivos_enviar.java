...
public class contenido_comisiones_incentivos_enviar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_comisiones_incentivos_enviar" );
      ((Element)v.get(0)).setAttribute("cod","0252" );
      ((Element)v.get(0)).setAttribute("titulo","Enviar comisiones e incentivos" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","Ingresar Comisiones e Incentivos" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(3)).setAttribute("src","contenido_comisiones_incentivos_enviar.js" );
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(6)).setAttribute("name","FechaDesde" );
      ((Element)v.get(6)).setAttribute("required","true" );
      ((Element)v.get(6)).setAttribute("cod","59" );
      ((Element)v.get(4)).appendChild((Element)v.get(6));
      /* Termina nodo:6   */

      /* Empieza nodo:7 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(7)).setAttribute("name","FechaHasta" );
      ((Element)v.get(7)).setAttribute("required","true" );
      ((Element)v.get(7)).setAttribute("cod","1339" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(14)).setAttribute("nombre","numeroLote" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(15)).setAttribute("nombre","fechaInterfaz" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(46)).setAttribute("nombre","lblLote" );
   ...
   private void getXML180(Document doc) {
      ((Element)v.get(46)).setAttribute("cod","680" );
      ...
      ((Element)v.get(50)).setAttribute("cod","844" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lblFechaDesde" );
      ((Element)v.get(54)).setAttribute("alto","13" );
      ((Element)v.get(54)).setAttribute("filas","1" );
      ((Element)v.get(54)).setAttribute("id","datosTitle" );
      ((Element)v.get(54)).setAttribute("cod","59" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(65)).setAttribute("nombre","lblvalorLote" );
      ...
      ((Element)v.get(69)).setAttribute("nombre","Descripcion" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(73)).setAttribute("nombre","FechaDesde" );
      ...
      ((Element)v.get(73)).setAttribute("onblur","fechaValida('FechaDesde')" );
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(77)).setAttribute("nombre","FechaHasta" );
      ...
      ((Element)v.get(77)).setAttribute("onblur","fechaValida('FechaHasta')" );
      ...
      /* Empieza nodo:83 / Elemento padre: 35   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(35)).appendChild((Element)v.get(83));
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(101)).setAttribute("cols","50" );
      ((Element)v.get(101)).setAttribute("id","datosCampos" );
      ((Element)v.get(101)).setAttribute("msjreq","" );
      ((Element)v.get(101)).setAttribute("nombre","areatxtObservaciones" );
      ((Element)v.get(101)).setAttribute("readonly","N" );
      ((Element)v.get(101)).setAttribute("req","N" );
      ((Element)v.get(101)).setAttribute("rows","3" );
      ((Element)v.get(101)).setAttribute("tabindex","2" );
      ((Element)v.get(101)).setAttribute("valor","" );
      ((Element)v.get(101)).setAttribute("max","240" );
   ...
   private void getXML450(Document doc) {
      ...
      /* Empieza nodo:112 / Elemento padre: 35   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(35)).appendChild((Element)v.get(112));
      ...
      ((Element)v.get(126)).setAttribute("nombre","ckComisiones" );
      ((Element)v.get(126)).setAttribute("id","datosCampos" );
      ((Element)v.get(126)).setAttribute("onclick","" );
      ((Element)v.get(126)).setAttribute("check","S" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(128)).setAttribute("nombre","lblComisiones" );
      ...
      ((Element)v.get(128)).setAttribute("cod","829" );
      ...
      v.add(doc.createElement("CHECKBOX"));
      ((Element)v.get(132)).setAttribute("nombre","ckIncentivos" );
   ...
   private void getXML540(Document doc) {
      ((Element)v.get(134)).setAttribute("nombre","lblIncentivos" );
      ...
      ((Element)v.get(134)).setAttribute("cod","903" );
      ...
      v.add(doc.createElement("IMG"));
      ((Element)v.get(137)).setAttribute("src","iconorequerido.gif" );
      ...
      ((Element)v.get(153)).setAttribute("nombre","btnEnviar" );
      ((Element)v.get(153)).setAttribute("ID","botonContenido" );
      ((Element)v.get(153)).setAttribute("tipo","html" );
      ((Element)v.get(153)).setAttribute("accion","onClickEnviar();" );
      ((Element)v.get(153)).setAttribute("ontab","onTab();" );
      ((Element)v.get(153)).setAttribute("estado","false" );
      ((Element)v.get(153)).setAttribute("cod","1597" );
      ...
      /* Empieza nodo:156 / Elemento padre: 20   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(20)).appendChild((Element)v.get(156));
   ...
   private void getXML630(Document doc) {
      v.add(doc.createElement("td"));
      ((Element)v.get(159)).setAttribute("width","756" );
