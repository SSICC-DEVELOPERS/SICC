...
public class ZonRegioViewPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","zonRegioViewList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(19)).setAttribute("cod","ZonRegioView.codRegi.label" );
      ...
      ((Element)v.get(20)).setAttribute("cod","ZonRegioView.indActi.label" );
      ...
      ((Element)v.get(21)).setAttribute("cod","ZonRegioView.indBorr.label" );
      ...
      ((Element)v.get(22)).setAttribute("cod","ZonRegioView.codNse1.label" );
      ...
      ((Element)v.get(23)).setAttribute("cod","ZonRegioView.codNse2.label" );
      ...
      ((Element)v.get(24)).setAttribute("cod","ZonRegioView.codNse3.label" );
      ...
      ((Element)v.get(25)).setAttribute("cod","ZonRegioView.desRegi.label" );
      ...
      ((Element)v.get(26)).setAttribute("cod","ZonRegioView.zsgvOidSubgVent.label" );
