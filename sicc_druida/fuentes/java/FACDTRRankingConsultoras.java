...
public class FACDTRRankingConsultoras extends LPSICCBase {           
   public FACDTRRankingConsultoras() {	 
     super();
  }
     ...
     try {
        ...
        if (accion.equals("generar")){
          ...
          //cargarPagina();
                 ...
                 cargarPagina();
                 getConfiguracionMenu("FACDTRRankingConsultoras");
        }
  ...
  private void cargarPagina() throws Exception{
     ...
     asignarAtributoPagina("cod","0815");     
     ...
     asignarAtributo("VAR", "lp", "valor", "FACDTRRankingConsultoras");
 ...
 private void generarReporte() throws Exception{
     ...
     datos.put(ConstantesREP.TITULO, "Ranking de Consultoras");     
     traza("++++++Antes de enviar a reportes " + datos); 
     
     String formato = conectorParametroLimpia("formato", "", true);
     
       
     //ejecutarReporte(datos, "REPGenerarReporte", "RFD-012", formato);
     ejecutarReporte2(datos, "REPGenerarReporteBatch", "RD_RFD-012", formato);
