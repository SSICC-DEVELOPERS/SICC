...
public class ZonTerriViewPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","zonTerriViewList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(17)).setAttribute("cod","ZonTerriView.codTerr.label" );
      ...
      ((Element)v.get(18)).setAttribute("cod","ZonTerriView.codNse1.label" );
      ...
      ((Element)v.get(19)).setAttribute("cod","ZonTerriView.codNse2.label" );
      ...
      ((Element)v.get(20)).setAttribute("cod","ZonTerriView.codNse3.label" );
      ...
      ((Element)v.get(21)).setAttribute("cod","ZonTerriView.indBorr.label" );
      ...
      ((Element)v.get(22)).setAttribute("cod","ZonTerriView.fecRtz.label" );
