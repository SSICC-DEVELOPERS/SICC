/*
    INDRA/CAR/mmg
    $Id: PedAtribEspecLPStartUp.java,v 1.1 2009/12/03 18:40:06 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class PedAtribEspecLPStartUp extends MMGDruidaBase{
	...
	public static final String BUSINESSID_QUERY = "MMGPedAtribEspecQueryFromToUserPage";
				...
				public static final String BUSINESSID_MODUOIDMODU_QUERY ="MMGSegModulQueryFromToUser";
				public static final String MODUOIDMODU_COMBO_CONNECTOR = "SegModulConectorCombo";
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "PedAtribEspecPage", "cod", "PedAtribEspec." + accion + ".label");
			...
			limpiarBotoneraLista("pedAtribEspec", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "desAtri", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 40);");
		asignarAtributo("TEXT", "valForm", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 0, 40);");
		
		
		//Primero determianmos el nombre del campo en la entidad de oriegen donde se van a cargar los datos
		asignar("VAR", "idAttributeLovOpener", conectorParametro(PARAMETRO_LOV_ATTRIBUTO));
		asignar("VAR", "idEntityLovOpener", conectorParametro(PARAMETRO_LOV_ENTIDAD));
		//asignarAtributo("CAPA", "pedAtribEspecLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "PedAtribEspecPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		PedAtribEspecData pedAtribEspecQuery= new PedAtribEspecData();
		pedAtribEspecQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		PedAtribEspecData datosResult = (PedAtribEspecData)getSingleObject(BUSINESSID_QUERY, pedAtribEspecQuery, 
			pedAtribEspecQuery.clone(), "pedAtribEspec");
		...
		PedAtribEspecData pedAtribEspec = datosResult;
		asignar("TEXT", "codAtri", FormatUtils.formatObject(pedAtribEspec.getCodAtri(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "desAtri", FormatUtils.formatObject(pedAtribEspec.getDesAtri(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "valForm", FormatUtils.formatObject(pedAtribEspec.getValForm(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		es.indra.belcorp.mso.SegModulData moduOidModu = pedAtribEspec.getModuOidModu();
		if(moduOidModu != null && moduOidModu.getId() != null) checkCombo("moduOidModu" , moduOidModu.getId().toString());
		...
		asignarAtributo("TEXT", "desAtri", "disabled", "S");
		asignarAtributo("TEXT", "valForm", "disabled", "S");
		
					asignarAtributo("COMBO", "moduOidModu", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		...
		asignarAtributo("TEXT", "desAtri", "req", "S");
		asignarAtributo("COMBO", "moduOidModu", "req", "S");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "pedAtribEspecFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		PedAtribEspecData pedAtribEspecQuery= new PedAtribEspecData();
		pedAtribEspecQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(pedAtribEspec.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"pedAtribEspecFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"pedAtribEspecFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codAtri", "ontab","ejecutarAccionFocoModificacion(\"pedAtribEspecFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codAtri", "onshtab","ejecutarAccionFocoModificacion(\"pedAtribEspecFrm\",2, false)");
				asignarAtributo("AREATEXTO", "desAtri", "ontab","ejecutarAccionFocoModificacion(\"pedAtribEspecFrm\",3, true)");
				asignarAtributo("AREATEXTO", "desAtri", "onshtab","ejecutarAccionFocoModificacion(\"pedAtribEspecFrm\",3, false)");
				asignarAtributo("AREATEXTO", "valForm", "ontab","ejecutarAccionFocoModificacion(\"pedAtribEspecFrm\",4, true)");
				asignarAtributo("AREATEXTO", "valForm", "onshtab","ejecutarAccionFocoModificacion(\"pedAtribEspecFrm\",4, false)");
					asignarAtributo("COMBO","moduOidModu", "ontab", "ejecutarAccionFocoModificacion(\"pedAtribEspecFrm\",5, true)");
					asignarAtributo("COMBO","moduOidModu", "onshtab", "ejecutarAccionFocoModificacion(\"pedAtribEspecFrm\",5, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","pedAtribEspecTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","pedAtribEspecTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es desAtri...");		
				
				traza("MMG: el atributo es valForm...");		
				
				traza("MMG: el atributo es moduOidModu...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","pedAtribEspecFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","pedAtribEspecListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","pedAtribEspecListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(PedAtribEspecData pedAtribEspec) throws Exception{
		HashMap checkedCombos = new HashMap();
		SegModulData moduOidModu = new SegModulData();
		
						asignarComboResultados(BUSINESSID_MODUOIDMODU_QUERY,MODUOIDMODU_COMBO_CONNECTOR, 
			moduOidModu, moduOidModu.clone(), "segModul", "moduOidModu", "result_ROWSET" );
		if(pedAtribEspec != null && pedAtribEspec.getModuOidModu() != null){
				checkCombo("moduOidModu" , pedAtribEspec.getModuOidModu().getId().toString());
			}
	...
	* @param pedAtribEspec La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(PedAtribEspecData pedAtribEspec) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		PedAtribEspecData pedAtribEspec = 
			(PedAtribEspecData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(pedAtribEspec.getModuOidModu() != null){
			pedAtribEspec.setModuOidModu((es.indra.belcorp.mso.SegModulData)
			getSingleObject(BUSINESSID_MODUOIDMODU_QUERY, 
			pedAtribEspec.getModuOidModu(),
			pedAtribEspec.getModuOidModu().clone(),
			"segModul"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(pedAtribEspec);
		loadLeafDependenceCombos(pedAtribEspec);
	}
