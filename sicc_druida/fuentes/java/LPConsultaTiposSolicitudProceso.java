 ...
 */
	...
	public class LPConsultaTiposSolicitudProceso  extends LPSICCBase {
		private String accion;
		private Long idioma = null;
		private Long pais = null;

		public LPConsultaTiposSolicitudProceso () {
			super();
		}
		...
		public void ejecucion() throws Exception {
			...
			try {
				traza("Entro al try de LO consulta");
				if (accion.equals("")) {
                  ///setea la última LP
				  conectorParametroSesion("UltimaLP","LPConsultaTiposSolicitudProceso"); 
	 ...
	 //Fin LPConsultaTiposSolicitudProceso 
