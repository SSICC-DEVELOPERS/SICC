/*
    INDRA/CAR/mmg
    $Id: FacTipoFormuLPStartUp.java,v 1.1 2009/12/03 18:41:22 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class FacTipoFormuLPStartUp extends MMGDruidaBase{
	...
	public static final String BUSINESSID_QUERY = "MMGFacTipoFormuQueryFromToUserPage";
	...
	public FacTipoFormuLPStartUp(){
		super();
	}

	public void inicio() throws Exception {
		pagina("FacTipoFormuPage");
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "FacTipoFormuPage", "cod", "FacTipoFormu." + accion + ".label");
			...
			limpiarBotoneraLista("facTipoFormu", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codTipoForm", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 1);");
		asignarAtributo("TEXT", "valDesc", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 0, 40);");
		
		//Primero determianmos el nombre del campo en la entidad de oriegen donde se van a cargar los datos
		asignar("VAR", "idAttributeLovOpener", conectorParametro(PARAMETRO_LOV_ATTRIBUTO));
		asignar("VAR", "idEntityLovOpener", conectorParametro(PARAMETRO_LOV_ENTIDAD));
		//asignarAtributo("CAPA", "facTipoFormuLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "FacTipoFormuPage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("FacTipoFormuLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		FacTipoFormuData facTipoFormuQuery= new FacTipoFormuData();
		facTipoFormuQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		FacTipoFormuData datosResult = (FacTipoFormuData)getSingleObject(BUSINESSID_QUERY, facTipoFormuQuery, 
			facTipoFormuQuery.clone(), "facTipoFormu");
		...
		FacTipoFormuData facTipoFormu = datosResult;
		asignar("TEXT", "codTipoForm", FormatUtils.formatObject(facTipoFormu.getCodTipoForm(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "valDesc", FormatUtils.formatObject(facTipoFormu.getValDesc(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		asignarAtributo("TEXT", "codTipoForm", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		...
		asignarAtributo("TEXT", "codTipoForm", "req", "S");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "facTipoFormuFrm", "oculto", "N");
		...
		traza("MMG::Creando FacTipoFormu");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		FacTipoFormuData facTipoFormuQuery= new FacTipoFormuData();
		facTipoFormuQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(facTipoFormu.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"facTipoFormuFrm\",0, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"facTipoFormuFrm\",0, false)");
				asignarAtributo("AREATEXTO", "codTipoForm", "ontab","ejecutarAccionFocoModificacion(\"facTipoFormuFrm\",0, true)");
				asignarAtributo("AREATEXTO", "codTipoForm", "onshtab","ejecutarAccionFocoModificacion(\"facTipoFormuFrm\",0, false)");
				asignarAtributo("AREATEXTO", "valDesc", "ontab","ejecutarAccionFocoModificacion(\"facTipoFormuFrm\",0, true)");
				asignarAtributo("AREATEXTO", "valDesc", "onshtab","ejecutarAccionFocoModificacion(\"facTipoFormuFrm\",0, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","facTipoFormuTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","facTipoFormuTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codTipoForm...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","facTipoFormuFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","facTipoFormuListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","facTipoFormuListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(FacTipoFormuData facTipoFormu) throws Exception{
	...
	* @param facTipoFormu La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(FacTipoFormuData facTipoFormu) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		FacTipoFormuData facTipoFormu = 
			(FacTipoFormuData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(facTipoFormu);
		loadLeafDependenceCombos(facTipoFormu);
	}
