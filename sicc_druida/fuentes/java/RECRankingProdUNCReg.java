...
public class RECRankingProdUNCReg extends LPSICCBase {           
   public RECRankingProdUNCReg() {	 
     super();
  }
     ...
     try {
        ...
        if (accion.equals("generar")){
          ...
          //cargarPagina();
           ...
           cargarPagina();
           getConfiguracionMenu("RECRankingProdUNCReg");
        }
  ...
  private void cargarPagina() throws Exception{
     ...
     asignarAtributoPagina("cod", "0905");
     asignarAtributo("VAR", "lp", "valor", "RECRankingProdUNCReg");
...
////////////////////////////////////////////////////////////////////////////////////////
    ...
    private void crearListaLP(Vector nomColumns, int cantColumns,
	 ...
	 traza("operaciones 1 " + operaciones1);
     ...
     String operaciones2        = conectorParametroLimpia("operaciones2", "", true);
	 	 traza("operaciones 2 " + operaciones2);
     ...
     String operaciones3        = conectorParametroLimpia("operaciones3", "", true);
	 	 traza("operaciones 3 " + operaciones3);
     ...
     String operaciones4        = conectorParametroLimpia("operaciones4", "", true);
	 	 traza("operaciones 4 " + operaciones4);
     ...
     if(tipoOrdenacion.equals("1")){
        ...
        reporte = "RD_REP-103_01";
     }
 
     datos.put(ConstantesREP.TITULO, "Ranking Unidad de Negocio Campaña Registro");     
