/*
    INDRA/CAR/mmg
    $Id: RecPreciLPStartUp.java,v 1.1 2009/12/03 18:35:36 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class RecPreciLPStartUp extends MMGDruidaBase{
	...
	public static final String BUSINESSID_QUERY = "MMGRecPreciQueryFromToUserPage";
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "RecPreciPage", "cod", "RecPreci." + accion + ".label");
			...
			limpiarBotoneraLista("recPreci", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codPrec", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 1);");
		
		//Primero determianmos el nombre del campo en la entidad de oriegen donde se van a cargar los datos
		asignar("VAR", "idAttributeLovOpener", conectorParametro(PARAMETRO_LOV_ATTRIBUTO));
		asignar("VAR", "idEntityLovOpener", conectorParametro(PARAMETRO_LOV_ENTIDAD));
		//asignarAtributo("CAPA", "recPreciLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "RecPreciPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		RecPreciData recPreciQuery= new RecPreciData();
		recPreciQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		RecPreciData datosResult = (RecPreciData)getSingleObject(BUSINESSID_QUERY, recPreciQuery, 
			recPreciQuery.clone(), "recPreci");
		...
		RecPreciData recPreci = datosResult;
		asignar("TEXT", "codPrec", FormatUtils.formatObject(recPreci.getCodPrec(), 
		...
		asignarAtributo("TEXT", "codPrec", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		...
		asignarAtributo("TEXT", "codPrec", "req", "S");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "recPreciFrm", "oculto", "N");
		...
		traza("MMG::Creando RecPreci");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		RecPreciData recPreciQuery= new RecPreciData();
		recPreciQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(recPreci.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"recPreciFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"recPreciFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codPrec", "ontab","ejecutarAccionFocoModificacion(\"recPreciFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codPrec", "onshtab","ejecutarAccionFocoModificacion(\"recPreciFrm\",2, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","recPreciTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","recPreciTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codPrec...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","recPreciFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","recPreciListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","recPreciListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(RecPreciData recPreci) throws Exception{
	...
	* @param recPreci La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(RecPreciData recPreci) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		RecPreciData recPreci = 
			(RecPreciData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(recPreci);
		loadLeafDependenceCombos(recPreci);
	}
