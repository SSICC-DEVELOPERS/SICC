...
public class SegVincuJerarPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","segVincuJerarList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(16)).setAttribute("cod","SegVincuJerar.marcOidMarc.label" );
      ...
      ((Element)v.get(17)).setAttribute("cod","SegVincuJerar.canaOidCana.label" );
      ...
      ((Element)v.get(18)).setAttribute("cod","SegVincuJerar.acceOidAcce.label" );
      ...
      ((Element)v.get(19)).setAttribute("cod","SegVincuJerar.sbacOidSbac.label" );
      ...
      ((Element)v.get(20)).setAttribute("cod","SegVincuJerar.sociOidSoci.label" );
