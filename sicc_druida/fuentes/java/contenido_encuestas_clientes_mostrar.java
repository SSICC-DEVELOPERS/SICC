...
public class contenido_encuestas_clientes_mostrar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_encuestas_clientes_mostrar" );
      ((Element)v.get(0)).setAttribute("cod","01045" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(29)).setAttribute("nombre","lblCodCliente" );
      ((Element)v.get(29)).setAttribute("alto","13" );
      ((Element)v.get(29)).setAttribute("filas","1" );
      ((Element)v.get(29)).setAttribute("valor","" );
      ((Element)v.get(29)).setAttribute("cod","263" );
      ...
      ((Element)v.get(36)).setAttribute("nombre","txtCodCliente" );
      ((Element)v.get(36)).setAttribute("id","datosCampos" );
      ((Element)v.get(36)).setAttribute("max","15" );
      ((Element)v.get(36)).setAttribute("tipo","" );
      ((Element)v.get(36)).setAttribute("onchange","" );
      ((Element)v.get(36)).setAttribute("req","S" );
      ((Element)v.get(36)).setAttribute("size","22" );
      ((Element)v.get(36)).setAttribute("valor","" );
      ((Element)v.get(36)).setAttribute("validacion","" );
      ((Element)v.get(36)).setAttribute("onshtab","" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(60)).setAttribute("nombre","cbPregunta" );
      ...
      ((Element)v.get(60)).setAttribute("textoinicial","xxxxxxxxxxxxxx1" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(65)).setAttribute("nombre","cbRespuesta" );
      ...
      ((Element)v.get(65)).setAttribute("textoinicial","xxxxxxxxxxxxxx1" );
   ...
   private void getXML270(Document doc) {
      ...
      /* Empieza nodo:74 / Elemento padre: 11   */
      v.add(doc.createElement("td"));
      ((Element)v.get(11)).appendChild((Element)v.get(74));
