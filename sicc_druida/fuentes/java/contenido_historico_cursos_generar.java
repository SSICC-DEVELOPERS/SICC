...
public class contenido_historico_cursos_generar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_historico_cursos_generar" );
      ((Element)v.get(0)).setAttribute("cod","" );
      ((Element)v.get(0)).setAttribute("titulo","" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","Generar Histórico de Cursos" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(5)).setAttribute("src","contenido_historico_cursos_generar.js" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(14)).setAttribute("nombre","oidSeleccionado" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(15)).setAttribute("nombre","fecha" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(35)).setAttribute("width","586" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(54)).setAttribute("ontab","focaliza('formulario.cbCanal');" );
      ((Element)v.get(54)).setAttribute("onshtab","desplazarSift();" );
      ((Element)v.get(54)).setAttribute("onchange","onSeleccionaMarca();" );
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(68)).setAttribute("width","586" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(73)).setAttribute("nombre","lblTipoCurso" );
      ...
      ((Element)v.get(73)).setAttribute("cod","758" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(77)).setAttribute("nombre","lblCodCurso" );
      ...
      ((Element)v.get(77)).setAttribute("cod","715" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(81)).setAttribute("nombre","lblNombreCurso" );
      ...
      ((Element)v.get(81)).setAttribute("cod","742" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(85)).setAttribute("nombre","lblFechaCurso" );
      ...
      ((Element)v.get(85)).setAttribute("cod","724" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(105)).setAttribute("nombre","txtFechaCurso" );
      ...
      ((Element)v.get(105)).setAttribute("onblur","comprobarFecha();" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(121)).setAttribute("ontab","desplazar();" );
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(131)).setAttribute("nombre","capaLista" );
      ...
      ((Element)v.get(132)).setAttribute("ancho","589" );
      ((Element)v.get(132)).setAttribute("alto","317" );
      ((Element)v.get(132)).setAttribute("x","12" );
      ((Element)v.get(132)).setAttribute("y","0" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(133)).setAttribute("precarga","S" );
      ((Element)v.get(133)).setAttribute("conROver","S" );
      ((Element)v.get(132)).appendChild((Element)v.get(133));

      /* Empieza nodo:134 / Elemento padre: 133   */
      v.add(doc.createElement("BTNSELECCION"));
      ((Element)v.get(134)).setAttribute("normal","btnLista2N.gif" );
      ((Element)v.get(134)).setAttribute("rollOver","btnLista2S.gif" );
      ((Element)v.get(134)).setAttribute("seleccionado","btnLista2M.gif" );
      ((Element)v.get(134)).setAttribute("desactivado","btnLista2D.gif" );
      ((Element)v.get(133)).appendChild((Element)v.get(134));
      /* Termina nodo:134   */

      /* Empieza nodo:135 / Elemento padre: 133   */
      v.add(doc.createElement("BTNMINIMIZAR"));
      ((Element)v.get(135)).setAttribute("minimizar","bot_pliega_columna_on.gif" );
      ((Element)v.get(135)).setAttribute("minimROver","bot_pliega_columna_over.gif" );
      ((Element)v.get(135)).setAttribute("maximizar","bot_despliega_columna_on.gif" );
      ((Element)v.get(135)).setAttribute("maximROver","bot_despliega_columna_over.gif" );
      ((Element)v.get(133)).appendChild((Element)v.get(135));
      /* Termina nodo:135   */

      /* Empieza nodo:136 / Elemento padre: 133   */
      v.add(doc.createElement("BTNORDENAR"));
      ((Element)v.get(136)).setAttribute("ordenar","ascendente_on.gif" );
      ((Element)v.get(136)).setAttribute("ordenarInv","descendente_on.gif" );
      ...
      ((Element)v.get(138)).setAttribute("borde","1" );
      ((Element)v.get(138)).setAttribute("horizDatos","1" );
      ((Element)v.get(138)).setAttribute("horizCabecera","1" );
      ((Element)v.get(138)).setAttribute("vertical","1" );
      ((Element)v.get(138)).setAttribute("horizTitulo","1" );
      ((Element)v.get(138)).setAttribute("horizBase","1" );
      ((Element)v.get(137)).appendChild((Element)v.get(138));
      /* Termina nodo:138   */

      /* Empieza nodo:139 / Elemento padre: 137   */
      v.add(doc.createElement("COLOR"));
      ((Element)v.get(139)).setAttribute("borde","#999999" );
      ((Element)v.get(139)).setAttribute("vertCabecera","#E0E0E0" );
      ((Element)v.get(139)).setAttribute("vertDatos","#FFFFFF" );
      ((Element)v.get(139)).setAttribute("horizDatos","#FFFFFF" );
      ((Element)v.get(139)).setAttribute("horizCabecera","#999999" );
      ((Element)v.get(139)).setAttribute("horizTitulo","#999999" );
      ((Element)v.get(139)).setAttribute("horizBase","#999999" );
      ...
      ((Element)v.get(140)).setAttribute("cod","00135" );
   ...
   private void getXML630(Document doc) {
      ...
      ((Element)v.get(157)).setAttribute("cod","724" );
      ...
      ((Element)v.get(158)).setAttribute("tipoEnvio","edicion" );
      ((Element)v.get(158)).setAttribute("formaEnvio","xml" );
      ((Element)v.get(158)).setAttribute("maxSel","-1" );
      ((Element)v.get(158)).setAttribute("msgErrMaxSel","" );
      ((Element)v.get(158)).setAttribute("coloresScrollNativo","#D4D0C8,black,white,#D4D0C8,#D4D0C8,#ECE9E4,black" );
      ((Element)v.get(158)).setAttribute("colorROver","#D0D9E8" );
      ((Element)v.get(158)).setAttribute("onLoad","" );
      ((Element)v.get(158)).setAttribute("colorSelecc","#D0D9E8" );
      ...
      ((Element)v.get(167)).setAttribute("ancho","589" );
   }
   ...
   private void getXML720(Document doc) {
      ...
      ((Element)v.get(167)).setAttribute("onload","procesarPaginado(mipgndo,msgError, ultima, rowset, 'muestraLista(ultima, rowset)')" );
      ...
      ((Element)v.get(168)).setAttribute("y","298" );
      ...
      ((Element)v.get(169)).setAttribute("y","298" );
      ...
      ((Element)v.get(170)).setAttribute("y","298" );
      ...
      ((Element)v.get(131)).appendChild((Element)v.get(171));
      /* Termina nodo:171   */

      /* Empieza nodo:172 / Elemento padre: 131   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(172)).setAttribute("nombre","GenerarHistorico" );
      ((Element)v.get(172)).setAttribute("x","80" );
      ((Element)v.get(172)).setAttribute("y","295" );
      ...
      ((Element)v.get(172)).setAttribute("ontab","focaliza('formulario.cbMarca');" );
      ((Element)v.get(172)).setAttribute("cod","732" );
      ((Element)v.get(172)).setAttribute("accion","onClickPasoHistorico()" );
      ((Element)v.get(172)).setAttribute("onshtab","desplazarONStab();" );
      ((Element)v.get(131)).appendChild((Element)v.get(172));
      /* Termina nodo:172   */
      /* Termina nodo:131   */
      ...
      ((Element)v.get(173)).setAttribute("y","479" );
