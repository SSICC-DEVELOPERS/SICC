/*
    INDRA/CAR/mmg
    $Id: MaeSubtiClienViewLPStartUp.java,v 1.1 2009/12/03 18:33:39 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class MaeSubtiClienViewLPStartUp extends MMGDruidaBase{
	...
	public MaeSubtiClienViewLPStartUp(){
		super();
	}

	public void inicio() throws Exception {
		pagina("MaeSubtiClienViewPage");
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			buildJsPageSize("MaeSubtiClienView");
			...
			asignarAtributo("PAGINA", "MaeSubtiClienViewPage", "cod", "MaeSubtiClienView." + accion + ".label");
			...
			limpiarBotoneraLista("maeSubtiClienView", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codSubtClie", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 2);");
		...
		//asignarAtributo("CAPA", "maeSubtiClienViewLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "MaeSubtiClienViewPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		MaeSubtiClienViewData maeSubtiClienViewQuery= new MaeSubtiClienViewData();
		maeSubtiClienViewQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		MaeSubtiClienViewData datosResult = (MaeSubtiClienViewData)getSingleObject(BUSINESSID_QUERY, maeSubtiClienViewQuery, 
			maeSubtiClienViewQuery.clone(), "maeSubtiClienView");
		...
		preservaHiddensI18n(new Integer(1), "MAE_SUBTI_CLIEN", "maeSubtiClienViewFrm", "Descripcion", true);
		...
		MaeSubtiClienViewData maeSubtiClienView = datosResult;
		es.indra.belcorp.mso.MaeTipoClienData ticlOidTipoClie = maeSubtiClienView.getTiclOidTipoClie();
		if(ticlOidTipoClie != null && ticlOidTipoClie.getId() != null) checkCombo("ticlOidTipoClie" , ticlOidTipoClie.getId().toString());
		asignar("TEXT", "codSubtClie", FormatUtils.formatObject(maeSubtiClienView.getCodSubtClie(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "Descripcion", FormatUtils.formatObject(maeSubtiClienView.getDescripcion(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		loadLocalizationVars(maeSubtiClienView);
		
			
		//Deshabilitamos todos los campos para que no se editen
		
					asignarAtributo("COMBO", "ticlOidTipoClie", "disabled", "S");asignarAtributo("TEXT", "codSubtClie", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "MAE_SUBTI_CLIEN", "maeSubtiClienViewFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "codSubtClie", "req", "S");
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('maeSubtiClienViewFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "maeSubtiClienViewFrm", "oculto", "N");
		...
		traza("MMG::Creando MaeSubtiClienView");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		MaeSubtiClienViewData maeSubtiClienViewQuery= new MaeSubtiClienViewData();
		maeSubtiClienViewQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(maeSubtiClienView.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"maeSubtiClienViewFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"maeSubtiClienViewFrm\",1, false)");
					asignarAtributo("COMBO","ticlOidTipoClie", "ontab", "ejecutarAccionFocoModificacion(\"maeSubtiClienViewFrm\",2, true)");
					asignarAtributo("COMBO","ticlOidTipoClie", "onshtab", "ejecutarAccionFocoModificacion(\"maeSubtiClienViewFrm\",2, false)");
				asignarAtributo("AREATEXTO", "codSubtClie", "ontab","ejecutarAccionFocoModificacion(\"maeSubtiClienViewFrm\",3, true)");
				asignarAtributo("AREATEXTO", "codSubtClie", "onshtab","ejecutarAccionFocoModificacion(\"maeSubtiClienViewFrm\",3, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"maeSubtiClienViewFrm\",4, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"maeSubtiClienViewFrm\",4, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","maeSubtiClienViewTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","maeSubtiClienViewTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codSubtClie...");		
				
					traza("MMG: en desactivateNonModifyFields encontrado atributo no editable...");
				
						// borrarCampo("codSubtClie");
						asignarAtributo ("TEXT", "codSubtClie", "disabled", "S");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","maeSubtiClienViewFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","maeSubtiClienViewListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","maeSubtiClienViewListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(MaeSubtiClienViewData maeSubtiClienView) throws Exception{
		...
		if(maeSubtiClienView != null && maeSubtiClienView.getTiclOidTipoClie() != null){
				checkCombo("ticlOidTipoClie" , maeSubtiClienView.getTiclOidTipoClie().getId().toString());
			}
	...
	* @param maeSubtiClienView La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(MaeSubtiClienViewData maeSubtiClienView) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		MaeSubtiClienViewData maeSubtiClienView = 
			(MaeSubtiClienViewData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(maeSubtiClienView.getTiclOidTipoClie() != null){
			maeSubtiClienView.setTiclOidTipoClie((es.indra.belcorp.mso.MaeTipoClienData)
			getSingleObject(BUSINESSID_TICLOIDTIPOCLIE_QUERY, 
			maeSubtiClienView.getTiclOidTipoClie(),
			maeSubtiClienView.getTiclOidTipoClie().clone(),
			"maeTipoClien"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(maeSubtiClienView);
		loadLeafDependenceCombos(maeSubtiClienView);
	}
	...
	*/
	...
	protected void loadLocalizationVars(MaeSubtiClienViewData maeSubtiClienView) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("MAE_SUBTI_CLIEN");
		mmgLocalizationQuery.setEntiPk(maeSubtiClienView.getId());
