...
public class LPBuscarMatrizCodigosReemplazo extends LPSICCBase{
  ...
  public LPBuscarMatrizCodigosReemplazo(){
  }

  public void inicio() throws Exception{
    pagina("contenido_matriz_reemplazos_consultar");
  }
  ...
  public void ejecucion() throws Exception{
    ...
    traza("accion: " + accion);
      ...
      asignarAtributoPagina("cod", "0180");
		}else{
      asignarAtributoPagina("cod", "0322");
		}
    ...
    try{
      if(accion.equals("")){
        ...
        conectorParametroSesion("UltimaLP", "LPBuscarMatrizCodigosReemplazo");
      ...
      this.lanzarPaginaError(ex);
		...
		getConfiguracionMenu("LPBuscarMatrizCodigosReemplazo");
  }
