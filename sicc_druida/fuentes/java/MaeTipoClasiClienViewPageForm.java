...
public class MaeTipoClasiClienViewPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","MaeTipoClasiClienView.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","MaeTipoClasiClienView.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('maeTipoClasiClienViewFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('maeTipoClasiClienViewFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(50)).setAttribute("nombre","codTipoClasTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lblCodTipoClas" );
      ((Element)v.get(54)).setAttribute("alto","13" );
      ((Element)v.get(54)).setAttribute("filas","1" );
      ((Element)v.get(54)).setAttribute("id","datosTitle" );
      ((Element)v.get(54)).setAttribute("cod","MaeTipoClasiClienView.codTipoClas.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(55)).setAttribute("nombre","codTipoClasWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(57)).setAttribute("nombre","codTipoClas" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('maeTipoClasiClienViewFrm',3, true)" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('maeTipoClasiClienViewFrm', 3, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(58)).setAttribute("nombre","codTipoClasGapTdId" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(64)).setAttribute("cod","MaeTipoClasiClienView.Descripcion.label" );
      ...
      ((Element)v.get(68)).setAttribute("ontab","ejecutarAccionFoco('maeTipoClasiClienViewFrm',4, true)" );
      ((Element)v.get(68)).setAttribute("onshtab","ejecutarAccionFoco('maeTipoClasiClienViewFrm', 4, false)" );
      ...
      ((Element)v.get(72)).setAttribute("href","javascript:openLocalizationDialog('maeTipoClasiClienViewFrm', 'Descripcion', 1);" );
      ((Element)v.get(72)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"maeTipoClasiClienViewFrm\",4, true)', 'ejecutarAccionFoco(\"maeTipoClasiClienViewFrm\",4, false)')" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(91)).setAttribute("nombre","sbtiOidSubtClie_ticlOidTipoClieTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(95)).setAttribute("nombre","lblsbtiOidSubtClie_ticlOidTipoClie" );
      ((Element)v.get(95)).setAttribute("id","datosTitle" );
      ((Element)v.get(95)).setAttribute("ancho","150" );
      ((Element)v.get(95)).setAttribute("alto","13" );
      ((Element)v.get(95)).setAttribute("cod","MaeSubtiClien.ticlOidTipoClie.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(96)).setAttribute("nombre","sbtiOidSubtClie_ticlOidTipoClieWidgetTrId" );
   ...
   private void getXML450(Document doc) {
      ((Element)v.get(98)).setAttribute("nombre","sbtiOidSubtClie_ticlOidTipoClie" );
      ...
      ((Element)v.get(98)).setAttribute("onchange","mmgDependeneChange('sbtiOidSubtClie_ticlOidTipoClie', 'sbtiOidSubtClie' , 'maeTipoClasiClienView')" );
      ...
      ((Element)v.get(98)).setAttribute("ontab","focaliza('maeTipoClasiClienViewFrm.sbtiOidSubtClie');" );
      ((Element)v.get(98)).setAttribute("onshtab","ejecutarAccionFoco('maeTipoClasiClienViewFrm',40, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(100)).setAttribute("nombre","sbtiOidSubtClie_ticlOidTipoClieGapTdId" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(102)).setAttribute("nombre","sbtiOidSubtClieTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(106)).setAttribute("nombre","lblsbtiOidSubtClie" );
      ...
      ((Element)v.get(106)).setAttribute("cod","MaeTipoClasiClienView.sbtiOidSubtClie.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(107)).setAttribute("nombre","sbtiOidSubtClieWidgetTrId" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(109)).setAttribute("nombre","sbtiOidSubtClie" );
      ...
      ((Element)v.get(109)).setAttribute("ontab","ejecutarAccionFoco('maeTipoClasiClienViewFrm',40, true);" );
      ((Element)v.get(109)).setAttribute("onshtab","focaliza('maeTipoClasiClienViewFrm.sbtiOidSubtClie_ticlOidTipoClie');" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(111)).setAttribute("nombre","sbtiOidSubtClieGapTdId" );
      ...
      /* Empieza nodo:115 / Elemento padre: 85   */
      v.add(doc.createElement("TD"));
      ((Element)v.get(115)).setAttribute("width","100%" );
   }

   private void getXML540(Document doc) {
      ((Element)v.get(85)).appendChild((Element)v.get(115));
      /* Termina nodo:115   */
      /* Termina nodo:85   */

      /* Empieza nodo:116 / Elemento padre: 15   */
      v.add(doc.createElement("TR"));
      ((Element)v.get(116)).setAttribute("nombre","formGapTr2" );
      ...
      /* Empieza nodo:125 / Elemento padre: 0   */
      v.add(doc.createElement("TR"));
      ((Element)v.get(125)).setAttribute("nombre","maeTipoClasiClienViewTrButtons" );
      ((Element)v.get(0)).appendChild((Element)v.get(125));
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(132)).setAttribute("class","tablaTitle" );
      ((Element)v.get(132)).setAttribute("nombre","maeTipoClasiClienViewTdQueryButton" );
      ((Element)v.get(131)).appendChild((Element)v.get(132));

      /* Empieza nodo:133 / Elemento padre: 132   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(133)).setAttribute("nombre","maeTipoClasiClienViewQueryButton" );
      ((Element)v.get(133)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(133)).setAttribute("estado","false" );
      ((Element)v.get(133)).setAttribute("accion","maeTipoClasiClienViewFirstPage();" );
      ...
      ((Element)v.get(134)).setAttribute("nombre","maeTipoClasiClienViewTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(136)).setAttribute("nombre","maeTipoClasiClienViewLovNullButton" );
      ((Element)v.get(136)).setAttribute("ID","botonContenido" );
      ((Element)v.get(136)).setAttribute("tipo","html" );
   }

   private void getXML630(Document doc) {
      ((Element)v.get(136)).setAttribute("accion","maeTipoClasiClienViewLovNullSelectionAction();" );
      ((Element)v.get(136)).setAttribute("estado","true" );
      ((Element)v.get(136)).setAttribute("cod","MMGGlobal.lovNullButton.label" );
