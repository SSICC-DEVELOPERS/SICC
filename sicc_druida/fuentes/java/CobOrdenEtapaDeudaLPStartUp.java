/*
    INDRA/CAR/mmg
    $Id: CobOrdenEtapaDeudaLPStartUp.java,v 1.1 2009/12/03 18:37:06 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class CobOrdenEtapaDeudaLPStartUp extends MMGDruidaBase{
	...
	public static final String BUSINESSID_QUERY = "MMGCobOrdenEtapaDeudaQueryFromToUserPage";
	...
	public CobOrdenEtapaDeudaLPStartUp(){
		super();
	}

	public void inicio() throws Exception {
		pagina("CobOrdenEtapaDeudaPage");
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			buildJsPageSize("CobOrdenEtapaDeuda");
			...
			asignarAtributo("PAGINA", "CobOrdenEtapaDeudaPage", "cod", "CobOrdenEtapaDeuda." + accion + ".label");
			...
			limpiarBotoneraLista("cobOrdenEtapaDeuda", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codOrdeEtapDeud", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 3);");
		
		//Primero determianmos el nombre del campo en la entidad de oriegen donde se van a cargar los datos
		asignar("VAR", "idAttributeLovOpener", conectorParametro(PARAMETRO_LOV_ATTRIBUTO));
		asignar("VAR", "idEntityLovOpener", conectorParametro(PARAMETRO_LOV_ENTIDAD));
		//asignarAtributo("CAPA", "cobOrdenEtapaDeudaLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "CobOrdenEtapaDeudaPage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("CobOrdenEtapaDeudaLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		CobOrdenEtapaDeudaData cobOrdenEtapaDeudaQuery= new CobOrdenEtapaDeudaData();
		cobOrdenEtapaDeudaQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		CobOrdenEtapaDeudaData datosResult = (CobOrdenEtapaDeudaData)getSingleObject(BUSINESSID_QUERY, cobOrdenEtapaDeudaQuery, 
			cobOrdenEtapaDeudaQuery.clone(), "cobOrdenEtapaDeuda");
		...
		preservaHiddensI18n(new Integer(1), "COB_ORDEN_ETAPA_DEUDA", "cobOrdenEtapaDeudaFrm", "Descripcion", true);
		...
		CobOrdenEtapaDeudaData cobOrdenEtapaDeuda = datosResult;
		asignar("TEXT", "codOrdeEtapDeud", FormatUtils.formatObject(cobOrdenEtapaDeuda.getCodOrdeEtapDeud(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "Descripcion", FormatUtils.formatObject(cobOrdenEtapaDeuda.getDescripcion(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		loadLocalizationVars(cobOrdenEtapaDeuda);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "codOrdeEtapDeud", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "COB_ORDEN_ETAPA_DEUDA", "cobOrdenEtapaDeudaFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "codOrdeEtapDeud", "req", "S");
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('cobOrdenEtapaDeudaFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "cobOrdenEtapaDeudaFrm", "oculto", "N");
		...
		traza("MMG::Creando CobOrdenEtapaDeuda");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		CobOrdenEtapaDeudaData cobOrdenEtapaDeudaQuery= new CobOrdenEtapaDeudaData();
		cobOrdenEtapaDeudaQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(cobOrdenEtapaDeuda.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"cobOrdenEtapaDeudaFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"cobOrdenEtapaDeudaFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codOrdeEtapDeud", "ontab","ejecutarAccionFocoModificacion(\"cobOrdenEtapaDeudaFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codOrdeEtapDeud", "onshtab","ejecutarAccionFocoModificacion(\"cobOrdenEtapaDeudaFrm\",2, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"cobOrdenEtapaDeudaFrm\",3, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"cobOrdenEtapaDeudaFrm\",3, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","cobOrdenEtapaDeudaTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","cobOrdenEtapaDeudaTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codOrdeEtapDeud...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","cobOrdenEtapaDeudaFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","cobOrdenEtapaDeudaListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","cobOrdenEtapaDeudaListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(CobOrdenEtapaDeudaData cobOrdenEtapaDeuda) throws Exception{
	...
	* @param cobOrdenEtapaDeuda La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(CobOrdenEtapaDeudaData cobOrdenEtapaDeuda) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		CobOrdenEtapaDeudaData cobOrdenEtapaDeuda = 
			(CobOrdenEtapaDeudaData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(cobOrdenEtapaDeuda);
		loadLeafDependenceCombos(cobOrdenEtapaDeuda);
	}
	...
	*/
	...
	protected void loadLocalizationVars(CobOrdenEtapaDeudaData cobOrdenEtapaDeuda) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("COB_ORDEN_ETAPA_DEUDA");
		mmgLocalizationQuery.setEntiPk(cobOrdenEtapaDeuda.getId());
