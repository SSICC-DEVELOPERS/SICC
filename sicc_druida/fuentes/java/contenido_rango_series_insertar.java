...
public class contenido_rango_series_insertar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_rango_series_insertar" );
      ((Element)v.get(0)).setAttribute("cod","0597" );
      ...
      v.add(doc.createTextNode("\r \r    function fGuardar(){\r        var x_desde =get('frmContenido.txtNSerDesde');\r        var x_hasta=get('frmContenido.txtNSerHasta');\r        if(!sicc_validaciones_generales()){\r            return false;\r        }\r                       \r        if (parseInt(x_desde,10)> parseInt(x_hasta,10)){  \r            var wnd = GestionarMensaje(\"2522\", null, null, null);\r            return;\r        }\r\r        if (get ('frmContenido.casoDeUso')=='insertar'){\r            set('frmContenido.accion','Guardar');\r        }else if (get ('frmContenido.casoDeUso')=='modificar'){\r            set('frmContenido.accion','guardar_modif');\r        }\r        enviaSICC('frmContenido');\r    }\r\r    function fVolver(){\r        window.close();\r    }\r\r    function despuesDeGuardar(){\r        \r        fLimpiarGenericoSICC();\r        fLimpiar();\r        setearValoresPorDefecto();\r    }\r    \r    function LoadBar(){\r        configurarMenuSecundario(\"frmContenido\");\r        fMostrarMensajeError();\r        if (get('frmContenido.accion')=='modificar'){\r            btnProxy(3,0);\r            btnProxy(2,1);\r            focaliza('frmContenido.txtNSerHasta','');\r            accion('frmContenido.txtNSerDesde','.disabled=true');\r            accion('frmContenido.cbCanal','.disabled=true');\r            accion('frmContenido.cbEstrategia','.disabled=true');\r            accion('frmContenido.cbMarca','.disabled=true');\r            accion('frmContenido.txtNSerDesde','.disabled=true');\r            cargarDatos();\r        }else if (get('frmContenido.accion')=='Mostrar datos'){\r            btnProxy(4,0);\r            btnProxy(7,0);\r            btnProxy(8,0);                \r            btnProxy(9,0);\r            btnProxy(3,0);\r            btnProxy(2,1);\r            btnProxy(5,0);\r            accion('frmContenido.txtNSerDesde','.disabled=true');\r            accion('frmContenido.cbCanal','.disabled=true');      \r            accion('frmContenido.cbEstrategia','.disabled=true');\r            accion('frmContenido.cbMarca','.disabled=true');\r            accion('frmContenido.txtNSerDesde','.disabled=true');\r            accion('frmContenido.txtNSerHasta','.disabled=true');\r            cargarDatos();\r            \r        }\r        if (get ('frmContenido.casoDeUso')=='insertar'){\r            setearValoresPorDefecto();\r        }        \r        try{\r            focaliza('frmContenido.cbMarca','');\r        }catch(e){\r            try{\r                focaliza('frmContenido.txtNSerHasta','');\r            }catch(e){}\r        } \r    }\r\r    function fLimpiar(){\r        if (get('frmContenido.accion')=='modificar' || get('frmContenido.accion')=='Mostrar datos'){\r            focaliza('frmContenido.txtNSerHasta','');\r            set('frmContenido.txtNSerDesde',get('frmContenido.desde'));\r            set('frmContenido.txtNSerHasta',get('frmContenido.hasta'));\r        }else{\r            setearValoresPorDefecto();\r        }\r        try{\r            focaliza('frmContenido.cbMarca','');\r        }catch(e){\r            focaliza('frmContenido.txtNSerHasta','');\r        } \r    }\r\r    function cargarDatos(){\r        var array = new Array();\r        array[0]='1';\r        array[1]=get('frmContenido.marca');\r        set_combo('frmContenido.cbMarca',[array,[' ',' ']]);\r\r        array[0]='1';\r        array[1]=get('frmContenido.canal');\r        set_combo('frmContenido.cbCanal',[array,[' ',' ']]);\r\r        array[0]='1';\r        array[1]=get('frmContenido.estrategia');\r        set_combo('frmContenido.cbEstrategia',[array,[' ',' ']]);\r\r        set('frmContenido.txtNSerDesde',get('frmContenido.desde'));\r        set('frmContenido.txtNSerHasta',get('frmContenido.hasta'));\r    }\r    function tabularTXTHasta(tipo){\r        if (!(get('frmContenido.accion')=='modificar' || get('frmContenido.accion')=='Mostrar datos')){\r            if (tipo=='tab'){\r                document.selection.empty();\r                focaliza('frmContenido.cbMarca','');\r            }else if (tipo=='shtab'){\r                focaliza('frmContenido.txtNSerDesde','');\r            }\r        }\r    }\r    function onErrorGuardar(){\r        focaliza('frmContenido.txtNSerHasta','');\r    }\r    \r    function setearValoresPorDefecto(){\r        var array = new Array();\r        array[0] = get('frmContenido.marca');\r        set('frmContenido.cbMarca',array);\r        array[0] = get('frmContenido.canal');\r        set('frmContenido.cbCanal',array);\r    }\r    \r\r"));
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(7)).setAttribute("name","cbEstrategia" );
      ((Element)v.get(7)).setAttribute("required","true" );
      ((Element)v.get(7)).setAttribute("cod","478" );
      ((Element)v.get(4)).appendChild((Element)v.get(7));
      /* Termina nodo:7   */

      /* Empieza nodo:8 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(8)).setAttribute("name","txtNSerDesde" );
      ((Element)v.get(8)).setAttribute("required","true" );
      ((Element)v.get(8)).setAttribute("cod","2091" );
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(9)).setAttribute("name","txtNSerHasta" );
      ((Element)v.get(9)).setAttribute("required","true" );
      ((Element)v.get(9)).setAttribute("cod","2092" );
      ...
      ((Element)v.get(15)).setAttribute("valor","LPMantenimientoRangoSeries" );
      ((Element)v.get(10)).appendChild((Element)v.get(15));
      /* Termina nodo:15   */

      /* Empieza nodo:16 / Elemento padre: 10   */
      v.add(doc.createElement("VAR"));
      ((Element)v.get(16)).setAttribute("nombre","oidRangoSerie" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(18)).setAttribute("nombre","estrategia" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(21)).setAttribute("nombre","desde" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(22)).setAttribute("nombre","hasta" );
      ...
      ((Element)v.get(38)).setAttribute("nombre","lblDatosRango" );
      ((Element)v.get(38)).setAttribute("alto","13" );
      ((Element)v.get(38)).setAttribute("filas","1" );
      ((Element)v.get(38)).setAttribute("valor","Datos de rango" );
      ((Element)v.get(38)).setAttribute("id","legend" );
      ((Element)v.get(38)).setAttribute("cod","00438" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(62)).setAttribute("nombre","lblPaisX" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(66)).setAttribute("onshtab","focaliza('frmContenido.txtNSerHasta','');" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(83)).setAttribute("nombre","lblEstrategia" );
      ...
      ((Element)v.get(83)).setAttribute("cod","478" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(87)).setAttribute("nombre","lblNSerDesde" );
      ((Element)v.get(87)).setAttribute("alto","13" );
      ((Element)v.get(87)).setAttribute("filas","1" );
      ((Element)v.get(87)).setAttribute("valor","Nº serie desde" );
      ((Element)v.get(87)).setAttribute("id","datosTitle" );
      ((Element)v.get(87)).setAttribute("cod","2091" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(91)).setAttribute("nombre","lblNSerHasta" );
      ((Element)v.get(91)).setAttribute("alto","13" );
      ((Element)v.get(91)).setAttribute("filas","1" );
      ((Element)v.get(91)).setAttribute("valor","Nº serie hasta" );
      ((Element)v.get(91)).setAttribute("id","datosTitle" );
      ((Element)v.get(91)).setAttribute("cod","2092" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(98)).setAttribute("nombre","cbEstrategia" );
      ...
      ((Element)v.get(103)).setAttribute("nombre","txtNSerDesde" );
      ((Element)v.get(103)).setAttribute("id","datosCampos" );
      ((Element)v.get(103)).setAttribute("max","9" );
      ...
      ((Element)v.get(106)).setAttribute("valign","top" );
   ...
   private void getXML450(Document doc) {
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(107)).setAttribute("nombre","txtNSerHasta" );
      ((Element)v.get(107)).setAttribute("id","datosCampos" );
      ((Element)v.get(107)).setAttribute("max","9" );
      ...
      ((Element)v.get(107)).setAttribute("ontab","tabularTXTHasta('tab')" );
      ((Element)v.get(107)).setAttribute("onshtab","tabularTXTHasta('shtab')" );
      ...
      /* Empieza nodo:110 / Elemento padre: 78   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(78)).appendChild((Element)v.get(110));
      ...
      /* Empieza nodo:113 / Elemento padre: 32   */
      v.add(doc.createElement("td"));
      ((Element)v.get(32)).appendChild((Element)v.get(113));
