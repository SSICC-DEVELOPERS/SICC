...
public class BelFormaPagoConectorQueryForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad BelFormaPago" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGBelFormaPagoQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGBelFormaPagoQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","BelFormaPagoFormFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","codFormPago" );
      ...
      ((Element)v.get(8)).setAttribute("LONGITUD","60" );
