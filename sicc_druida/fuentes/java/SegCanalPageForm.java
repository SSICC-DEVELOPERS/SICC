...
public class SegCanalPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","SegCanal.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","SegCanal.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('segCanalFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('segCanalFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(54)).setAttribute("cod","SegCanal.codCana.label" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('segCanalFrm',2, true)" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('segCanalFrm', 2, false)" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(64)).setAttribute("cod","SegCanal.Descripcion.label" );
      ...
      ((Element)v.get(68)).setAttribute("ontab","ejecutarAccionFoco('segCanalFrm',3, true)" );
      ((Element)v.get(68)).setAttribute("onshtab","ejecutarAccionFoco('segCanalFrm', 3, false)" );
      ...
      ((Element)v.get(72)).setAttribute("href","javascript:openLocalizationDialog('segCanalFrm', 'Descripcion', 1);" );
      ((Element)v.get(72)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"segCanalFrm\",3, true)', 'ejecutarAccionFoco(\"segCanalFrm\",3, false)')" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(83)).setAttribute("ontab","ejecutarAccionFoco('segCanalFrm',4, true);" );
      ((Element)v.get(83)).setAttribute("onshtab","ejecutarAccionFoco('segCanalFrm',4, false);" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(99)).setAttribute("nombre","segCanalTrButtons" );
      ...
      ((Element)v.get(106)).setAttribute("nombre","segCanalTdQueryButton" );
      ((Element)v.get(105)).appendChild((Element)v.get(106));

      /* Empieza nodo:107 / Elemento padre: 106   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(107)).setAttribute("nombre","segCanalQueryButton" );
      ((Element)v.get(107)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(107)).setAttribute("estado","false" );
      ((Element)v.get(107)).setAttribute("accion","segCanalFirstPage();" );
      ...
      ((Element)v.get(108)).setAttribute("nombre","segCanalTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(110)).setAttribute("nombre","segCanalLovNullButton" );
      ((Element)v.get(110)).setAttribute("ID","botonContenido" );
      ((Element)v.get(110)).setAttribute("tipo","html" );
      ((Element)v.get(110)).setAttribute("accion","segCanalLovNullSelectionAction();" );
