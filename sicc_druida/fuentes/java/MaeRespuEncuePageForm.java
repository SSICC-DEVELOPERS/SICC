...
public class MaeRespuEncuePageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","MaeRespuEncue.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","MaeRespuEncue.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('maeRespuEncueFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('maeRespuEncueFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(50)).setAttribute("nombre","prenOidPregTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lblprenOidPreg" );
      ((Element)v.get(54)).setAttribute("id","datosTitle" );
      ((Element)v.get(54)).setAttribute("ancho","150" );
      ((Element)v.get(54)).setAttribute("alto","13" );
      ((Element)v.get(54)).setAttribute("cod","MaeRespuEncue.prenOidPreg.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(55)).setAttribute("nombre","prenOidPregWidgetTrId" );
      ...
      ((Element)v.get(57)).setAttribute("nombre","prenOidPreg" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('maeRespuEncueFrm',2, true);" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('maeRespuEncueFrm',2, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(59)).setAttribute("nombre","prenOidPregGapTdId" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(76)).setAttribute("nombre","codRespTdId" );
   ...
   private void getXML360(Document doc) {
      ((Element)v.get(81)).setAttribute("nombre","codRespWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(83)).setAttribute("nombre","codResp" );
      ...
      ((Element)v.get(83)).setAttribute("ontab","ejecutarAccionFoco('maeRespuEncueFrm',3, true)" );
      ((Element)v.get(83)).setAttribute("onshtab","ejecutarAccionFoco('maeRespuEncueFrm', 3, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(84)).setAttribute("nombre","codRespGapTdId" );
   ...
   private void getXML450(Document doc) {
      v.add(doc.createElement("TD"));
      ((Element)v.get(101)).setAttribute("nombre","valPesoTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(106)).setAttribute("nombre","valPesoWidgetTrId" );
      ...
      ((Element)v.get(108)).setAttribute("ontab","ejecutarAccionFoco('maeRespuEncueFrm',4, true)" );
      ((Element)v.get(108)).setAttribute("onshtab","ejecutarAccionFoco('maeRespuEncueFrm', 4, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(109)).setAttribute("nombre","valPesoGapTdId" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(130)).setAttribute("cod","MaeRespuEncue.Descripcion.label" );
      ...
      ((Element)v.get(134)).setAttribute("max","50" );
      ...
      ((Element)v.get(134)).setAttribute("ontab","ejecutarAccionFoco('maeRespuEncueFrm',5, true)" );
      ((Element)v.get(134)).setAttribute("onshtab","ejecutarAccionFoco('maeRespuEncueFrm', 5, false)" );
      ...
      ((Element)v.get(138)).setAttribute("href","javascript:openLocalizationDialog('maeRespuEncueFrm', 'Descripcion', 1);" );
      ((Element)v.get(138)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"maeRespuEncueFrm\",5, true)', 'ejecutarAccionFoco(\"maeRespuEncueFrm\",5, false)')" );
   }
   ...
   private void getXML630(Document doc) {
      ...
      /* Empieza nodo:154 / Elemento padre: 0   */
      v.add(doc.createElement("TR"));
      ((Element)v.get(154)).setAttribute("nombre","maeRespuEncueTrButtons" );
      ((Element)v.get(0)).appendChild((Element)v.get(154));
   ...
   private void getXML720(Document doc) {
      ...
      ((Element)v.get(161)).setAttribute("nombre","maeRespuEncueTdQueryButton" );
      ((Element)v.get(160)).appendChild((Element)v.get(161));

      /* Empieza nodo:162 / Elemento padre: 161   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(162)).setAttribute("nombre","maeRespuEncueQueryButton" );
      ((Element)v.get(162)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(162)).setAttribute("estado","false" );
      ((Element)v.get(162)).setAttribute("accion","maeRespuEncueFirstPage();" );
      ...
      ((Element)v.get(163)).setAttribute("nombre","maeRespuEncueTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(165)).setAttribute("nombre","maeRespuEncueLovNullButton" );
      ((Element)v.get(165)).setAttribute("ID","botonContenido" );
      ((Element)v.get(165)).setAttribute("tipo","html" );
      ((Element)v.get(165)).setAttribute("accion","maeRespuEncueLovNullSelectionAction();" );
      ((Element)v.get(165)).setAttribute("estado","true" );
      ((Element)v.get(165)).setAttribute("cod","MMGGlobal.lovNullButton.label" );
