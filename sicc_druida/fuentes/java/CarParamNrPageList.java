...
public class CarParamNrPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","carParamNrList" );
      ...
      ((Element)v.get(14)).setAttribute("cod","CarParamNr.niriOidNiveRies.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","CarParamNr.valMini.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","CarParamNr.valMaxi.label" );
