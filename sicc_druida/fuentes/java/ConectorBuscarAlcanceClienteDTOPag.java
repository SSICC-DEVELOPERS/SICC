...
public class ConectorBuscarAlcanceClienteDTOPag  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","ConectorBuscarAlcanceClienteDTO" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","DTOEBuscarAlcanceClienteDTO " );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","clie_oid_clie" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(9)).setAttribute("NOMBRE","apellido" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(10)).setAttribute("NOMBRE","val_porc_desc" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(11)).setAttribute("NOMBRE","imp_fijo" );
