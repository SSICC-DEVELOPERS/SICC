...
public class PedUmbraFaltaConectorQueryForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad PedUmbraFalta" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGPedUmbraFaltaQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGPedUmbraFaltaQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","PedUmbraFaltaFormFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(9)).setAttribute("NOMBRE","valUmbrFalt" );
