...
public class FACDTRListadoNuevas extends LPSICCBase {           
   public FACDTRListadoNuevas() {	 
     super();
  }
     ...
     try {
        ...
        if (accion.equals("generar")){
          ...
          //cargarPagina();
                 ...
                 cargarPagina();
                 getConfiguracionMenu("FACDTRListadoNuevas");
        }
  ...
  private void cargarPagina() throws Exception{
     ...
     asignarAtributoPagina("cod","0812");         
     ...
     asignarAtributo("VAR", "lp", "valor", "FACDTRListadoNuevas");
 ...
 private void generarReporte() throws Exception{
     ...
     datos.put(ConstantesREP.TITULO, "Listado de Nuevas (Hasta su cuarto pedido)");     
     traza("++++++Antes de enviar a reportes " + datos); 
     
     String formato = conectorParametroLimpia("formato", "", true);
     
       
     //ejecutarReporte(datos, "REPGenerarReporte", "RFD-007", formato);
     ejecutarReporte2(datos, "REPGenerarReporteBatch", "RD_RFD-007", formato);
