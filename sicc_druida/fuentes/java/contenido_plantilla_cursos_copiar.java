...
public class contenido_plantilla_cursos_copiar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_plantilla_cursos_copiar" );
      ((Element)v.get(0)).setAttribute("titulo","" );
      ((Element)v.get(0)).setAttribute("cod","0201" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(3)).setAttribute("src","contenido_plantilla_cursos_copiar.js" );
      ...
      ((Element)v.get(5)).setAttribute("valor","copiar" );
      ...
      ((Element)v.get(6)).setAttribute("valor","LPCopiaPlantilla" );
      ((Element)v.get(4)).appendChild((Element)v.get(6));
      /* Termina nodo:6   */

      /* Empieza nodo:7 / Elemento padre: 4   */
      v.add(doc.createElement("VAR"));
      ((Element)v.get(7)).setAttribute("nombre","oidPlantilla" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(8)).setAttribute("nombre","listaVisible" );
      ((Element)v.get(8)).setAttribute("valor","hidden" );
      ...
      ((Element)v.get(9)).setAttribute("colorf","#F0F0F0" );
      ...
      ((Element)v.get(9)).setAttribute("visibilidad","" );
      ((Element)v.get(9)).setAttribute("contravsb","" );
      ((Element)v.get(9)).setAttribute("x","0" );
      ((Element)v.get(9)).setAttribute("y","0" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(24)).setAttribute("nombre","lblCriterios" );
      ((Element)v.get(24)).setAttribute("ancho","146" );
      ((Element)v.get(24)).setAttribute("alto","13" );
      ((Element)v.get(24)).setAttribute("filas","1" );
      ((Element)v.get(24)).setAttribute("valor","Datos de plantilla" );
      ((Element)v.get(24)).setAttribute("id","legend" );
      ((Element)v.get(24)).setAttribute("cod","0075" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(33)).setAttribute("nombre","lblNombrePlantilla" );
      ((Element)v.get(33)).setAttribute("ancho","85" );
      ...
      ((Element)v.get(33)).setAttribute("cod","743" );
      ...
      ((Element)v.get(40)).setAttribute("nombre","txtNombrePlantilla" );
      ((Element)v.get(40)).setAttribute("id","datosCampos" );
      ((Element)v.get(40)).setAttribute("max","30" );
      ((Element)v.get(40)).setAttribute("tipo","" );
      ((Element)v.get(40)).setAttribute("onchange","" );
      ((Element)v.get(40)).setAttribute("req","N" );
      ((Element)v.get(40)).setAttribute("size","40" );
      ((Element)v.get(40)).setAttribute("valor","" );
      ((Element)v.get(40)).setAttribute("validacion","" );
   ...
   private void getXML180(Document doc) {
      ...
      /* Empieza nodo:43 / Elemento padre: 25   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(25)).appendChild((Element)v.get(43));
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(55)).setAttribute("class","botonera" );
      ((Element)v.get(54)).appendChild((Element)v.get(55));

      /* Empieza nodo:56 / Elemento padre: 55   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(56)).setAttribute("nombre","btnBuscar" );
      ((Element)v.get(56)).setAttribute("ID","botonContenido" );
      ((Element)v.get(56)).setAttribute("tipo","html" );
      ((Element)v.get(56)).setAttribute("accion","accionBuscar();" );
      ((Element)v.get(56)).setAttribute("estado","false" );
      ((Element)v.get(56)).setAttribute("cod","1" );
      ...
      ((Element)v.get(66)).setAttribute("ancho","300" );
      ((Element)v.get(66)).setAttribute("alto","275" );
      ((Element)v.get(66)).setAttribute("x","12" );
      ((Element)v.get(66)).setAttribute("y","149" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(71)).setAttribute("vertical","0" );
      ...
      ((Element)v.get(72)).setAttribute("vertCabecera","#999999" );
      ((Element)v.get(72)).setAttribute("vertDatos","#999999" );
      ((Element)v.get(72)).setAttribute("horizDatos","#999999" );
      ...
      ((Element)v.get(74)).setAttribute("ancho","15" );
      ...
      ((Element)v.get(75)).setAttribute("orden","alfanumerico" );
      ...
      ((Element)v.get(76)).setAttribute("alto","20" );
      ((Element)v.get(76)).setAttribute("IDScroll","EstCab" );
      ((Element)v.get(76)).setAttribute("imgFondo","" );
      ((Element)v.get(76)).setAttribute("colFondo","#CCCCCC" );
      ...
      ((Element)v.get(77)).setAttribute("cod","8" );
      ...
      ((Element)v.get(79)).setAttribute("deseleccionaSiMaxSel","S" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(85)).setAttribute("x","104" );
      ((Element)v.get(85)).setAttribute("y","405" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(86)).setAttribute("nombre","Copiar" );
      ((Element)v.get(86)).setAttribute("x","13" );
      ((Element)v.get(86)).setAttribute("y","402" );
      ...
      ((Element)v.get(86)).setAttribute("cod","721" );
      ((Element)v.get(86)).setAttribute("accion","accionCopiar();" );
      ((Element)v.get(9)).appendChild((Element)v.get(86));
      /* Termina nodo:86   */

      /* Empieza nodo:87 / Elemento padre: 9   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(87)).setAttribute("nombre","primera1" );
      ((Element)v.get(87)).setAttribute("x","72" );
      ((Element)v.get(87)).setAttribute("y","405" );
      ((Element)v.get(87)).setAttribute("ID","botonContenido" );
      ((Element)v.get(87)).setAttribute("img","primera_on" );
      ...
      ((Element)v.get(87)).setAttribute("accion","mipgndo.retrocederPrimeraPagina();" );
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(88)).setAttribute("nombre","capaTitulo" );
      ((Element)v.get(88)).setAttribute("alto","50" );
      ...
      ((Element)v.get(88)).setAttribute("y","124" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(104)).setAttribute("bgcolor","#CCCCCC" );
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(106)).setAttribute("bgcolor","#CCCCCC" );
      ((Element)v.get(106)).setAttribute("valign","middle" );
      ((Element)v.get(106)).setAttribute("height","20" );
      ((Element)v.get(103)).appendChild((Element)v.get(106));

      /* Empieza nodo:107 / Elemento padre: 106   */
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(107)).setAttribute("nombre","lbltitulo" );
      ((Element)v.get(107)).setAttribute("ancho","293" );
      ...
      ((Element)v.get(107)).setAttribute("cod","00135" );
