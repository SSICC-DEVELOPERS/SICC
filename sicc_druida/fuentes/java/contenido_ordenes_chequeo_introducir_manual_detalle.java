...
public class contenido_ordenes_chequeo_introducir_manual_detalle  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_ordenes_chequeo_introducir_manual_detalle" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","contenido_ordenes_chequeo_introducir_manual_detalle.js" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(13)).setAttribute("nombre","hOidPeriodoDesde" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(14)).setAttribute("nombre","hOidPeriodoHasta" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(15)).setAttribute("nombre","hCodCliente" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(16)).setAttribute("nombre","hOidTipoChequeo" );
      ...
      ((Element)v.get(21)).setAttribute("ancho","400" );
      ((Element)v.get(21)).setAttribute("alto","317" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(27)).setAttribute("vertical","0" );
      ...
      ((Element)v.get(36)).setAttribute("cod","263" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(37)).setAttribute("cod","447" );
      ...
      ((Element)v.get(38)).setAttribute("cod","2851" );
      ...
      ((Element)v.get(44)).setAttribute("y","306" );
      ((Element)v.get(44)).setAttribute("control","|" );
      ((Element)v.get(44)).setAttribute("conector","conectorSandra" );
      ((Element)v.get(44)).setAttribute("onload","procesarPaginado(mipgndo, msgError, ultima, rowset)" );
      ...
      ((Element)v.get(45)).setAttribute("y","310" );
      ...
      ((Element)v.get(45)).setAttribute("ontab","document.all['ava1I'].parentElement.focus();" );
      ((Element)v.get(45)).setAttribute("onshtab","document.all['primera1I'].parentElement.focus();" );
      ...
      ((Element)v.get(46)).setAttribute("y","310" );
      ...
      ((Element)v.get(46)).setAttribute("ontab","document.all['primera1I'].parentElement.focus();" );
      ((Element)v.get(46)).setAttribute("onshtab","document.all['ret1I'].parentElement.focus();" );
      ...
      ((Element)v.get(47)).setAttribute("y","310" );
      ((Element)v.get(47)).setAttribute("ID","botonContenido" );
      ((Element)v.get(47)).setAttribute("img","primera_on" );
      ((Element)v.get(47)).setAttribute("tipo","-2" );
      ((Element)v.get(47)).setAttribute("estado","false" );
      ((Element)v.get(47)).setAttribute("alt","" );
      ((Element)v.get(47)).setAttribute("codigo","" );
      ((Element)v.get(47)).setAttribute("ontab","document.all['ret1I'].parentElement.focus();" );
   }

   private void getXML270(Document doc) {
      ((Element)v.get(47)).setAttribute("onshtab","document.all['ava1I'].parentElement.focus();" );
      ...
      ((Element)v.get(48)).setAttribute("y","306" );
      ...
      ((Element)v.get(49)).setAttribute("y","329" );
