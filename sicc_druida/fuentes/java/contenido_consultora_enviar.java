...
public class contenido_consultora_enviar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_consultora_enviar" );
      ((Element)v.get(0)).setAttribute("cod","0926" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","contenido_consultora_enviar.js" );
      ...
      ((Element)v.get(7)).setAttribute("cod","844" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(13)).setAttribute("nombre","loteH" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(14)).setAttribute("nombre","descripcionH" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(15)).setAttribute("nombre","observacionesH" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(33)).setAttribute("cod","0254" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(60)).setAttribute("nombre","txtDescripcion" );
      ...
      ((Element)v.get(60)).setAttribute("onshtab","" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(80)).setAttribute("nombre","areatxtObservaciones" );
      ...
      ((Element)v.get(80)).setAttribute("max","256" );
      ...
      /* Empieza nodo:88 / Elemento padre: 19   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(19)).appendChild((Element)v.get(88));
