...
public class MsgMedioEnvioPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","msgMedioEnvioList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","MsgMedioEnvio.codMediEnvi.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","MsgMedioEnvio.desMediEnvi.label" );
