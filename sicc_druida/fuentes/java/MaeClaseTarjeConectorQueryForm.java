...
public class MaeClaseTarjeConectorQueryForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad MaeClaseTarje" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGMaeClaseTarjeQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGMaeClaseTarjeQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","MaeClaseTarjeFormFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","codClasTarj" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(8)).setAttribute("NOMBRE","desClasTarj" );
