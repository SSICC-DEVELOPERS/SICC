...
public class PreIndicCuadrConectorQueryList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad PreIndicCuadr" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGPreIndicCuadrQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGPreIndicCuadrQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","PreIndicCuadrListFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","codIndiCuad" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(9)).setAttribute("NOMBRE","valFactCuad" );
