...
public class CccTipoTransPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","cccTipoTransList" );
      ...
      ((Element)v.get(14)).setAttribute("cod","CccTipoTrans.codTipoTran.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","CccTipoTrans.Descripcion.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","CccTipoTrans.codTipoTranCheq.label" );
