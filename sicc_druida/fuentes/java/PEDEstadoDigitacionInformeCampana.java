...
public class PEDEstadoDigitacionInformeCampana extends LPSICCBase {   
  
   Long pais = null;
   Long idioma = null;

   public PEDEstadoDigitacionInformeCampana() {	 
     super();
  }
     ...
     try {
        ...
        if (accion.equals("generar")){
          ...
          //cargarPagina();
           ...
           cargarPagina();
           getConfiguracionMenu("PEDEstadoDigitacionInformeCampana");
        }
  ...
  private void cargarPagina() throws Exception{
      pagina("contenido_informe_estado_campana_generar");   
 ...
 private void generarReporte() throws Exception{
     ...
     datos.put(ConstantesREP.TITULO, "Estado de Digitación por Campaña");
          
     traza("++++++Antes de enviar a reportes " + datos); 
     //ejecutarReporte(datos, "REPGenerarReporte", "RD_REP-020", null);
     ejecutarReporte2(datos, "REPGenerarReporteBatch", "RD_REP-020", "pdf");
