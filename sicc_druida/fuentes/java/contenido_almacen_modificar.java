...
public class contenido_almacen_modificar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_almacen_modificar" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(5)).setAttribute("src","contenido_almacen_modificar.js" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("nombre","lblCriteriosDeBusqueda" );
      ...
      ((Element)v.get(30)).setAttribute("id","primeraFila" );
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(32)).setAttribute("colspan","6" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(38)).setAttribute("nombre","lblCodAlma" );
      ...
      ((Element)v.get(38)).setAttribute("cod","BelAlmac.codAlma.label" );
      ...
      ((Element)v.get(42)).setAttribute("cod","BelAlmac.Descripcion.label" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(46)).setAttribute("nombre","lblIndInfoSap" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(46)).setAttribute("cod","BelAlmac.indInfoSap.label" );
      ...
      ((Element)v.get(53)).setAttribute("nombre","codAlma" );
      ((Element)v.get(53)).setAttribute("id","datosCampos" );
      ((Element)v.get(53)).setAttribute("max","3" );
      ((Element)v.get(53)).setAttribute("req","N" );
      ((Element)v.get(53)).setAttribute("size","3" );
      ((Element)v.get(53)).setAttribute("onshtab","focalizaShTab();" );
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(57)).setAttribute("nombre","txtDescripcion" );
      ...
      ((Element)v.get(61)).setAttribute("nombre","indInfoSap" );
      ((Element)v.get(61)).setAttribute("id","datosCampos" );
      ((Element)v.get(61)).setAttribute("onclick","" );
      ((Element)v.get(61)).setAttribute("check","N" );
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(65)).setAttribute("colspan","6" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(75)).setAttribute("nombre","lblCentroDistribucion" );
      ...
      ((Element)v.get(75)).setAttribute("cod","2054" );
      ...
      ((Element)v.get(82)).setAttribute("nombre","cbCentroDistribucion" );
      ...
      /* Empieza nodo:89 / Elemento padre: 26   */
      v.add(doc.createElement("fieldset"));
      ((Element)v.get(26)).appendChild((Element)v.get(89));
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(94)).setAttribute("nombre","capaLista" );
      ((Element)v.get(94)).setAttribute("ancho","100%" );
      ((Element)v.get(94)).setAttribute("alto","330" );
      ((Element)v.get(94)).setAttribute("x","5" );
      ((Element)v.get(94)).setAttribute("y","170" );
      ((Element)v.get(94)).setAttribute("colorf","" );
      ((Element)v.get(94)).setAttribute("borde","0" );
      ((Element)v.get(94)).setAttribute("imagenf","" );
      ((Element)v.get(94)).setAttribute("repeat","" );
      ((Element)v.get(94)).setAttribute("padding","" );
      ((Element)v.get(94)).setAttribute("visibilidad","" );
      ((Element)v.get(94)).setAttribute("contravsb","" );
      ((Element)v.get(94)).setAttribute("zindex","" );
      ((Element)v.get(6)).appendChild((Element)v.get(94));

      /* Empieza nodo:95 / Elemento padre: 94   */
      v.add(doc.createElement("LISTAEDITABLE"));
      ((Element)v.get(95)).setAttribute("nombre","listado1" );
      ((Element)v.get(95)).setAttribute("ancho","679" );
      ((Element)v.get(95)).setAttribute("alto","301" );
      ...
      ((Element)v.get(98)).setAttribute("aximROver","bot_despliega_columna_over.gif" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(110)).setAttribute("alto","25" );
      ...
      ((Element)v.get(111)).setAttribute("cod","BelAlmac.codAlma.label" );
      ...
      ((Element)v.get(112)).setAttribute("cod","BelAlmac.Descripcion.label" );
      ...
      ((Element)v.get(113)).setAttribute("cod","BelAlmac.indInfoSap.label" );
      ...
      ((Element)v.get(114)).setAttribute("cod","2054" );
      ...
      /* Empieza nodo:121 / Elemento padre: 95   */
      v.add(doc.createElement("PAGINADO"));
      ((Element)v.get(121)).setAttribute("nombre","mipgndo" );
      ((Element)v.get(121)).setAttribute("ancho","679" );
      ((Element)v.get(121)).setAttribute("sep","$" );
      ((Element)v.get(121)).setAttribute("x","12" );
      ((Element)v.get(121)).setAttribute("class","botonera" );
      ((Element)v.get(121)).setAttribute("y","294" );
   }

   private void getXML540(Document doc) {
      ((Element)v.get(121)).setAttribute("control","|" );
      ((Element)v.get(121)).setAttribute("conector","ConectorBuscarCargosAbonos" );
      ((Element)v.get(121)).setAttribute("rowset","" );
      ((Element)v.get(121)).setAttribute("cargainicial","N" );
      ((Element)v.get(121)).setAttribute("onload","procesarPaginado(mipgndo,msgError, ultima, rowset, 'muestraLista(ultima, rowset)')" );
      ((Element)v.get(95)).appendChild((Element)v.get(121));
      ...
      ((Element)v.get(124)).setAttribute("y","282" );
      ...
      ((Element)v.get(94)).appendChild((Element)v.get(125));
      /* Termina nodo:125   */

      /* Empieza nodo:126 / Elemento padre: 94   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(126)).setAttribute("nombre","Detalle" );
      ...
      ((Element)v.get(126)).setAttribute("accion","onClickDetalle();" );
      ((Element)v.get(126)).setAttribute("ontab","focalizaCod();" );
      ((Element)v.get(126)).setAttribute("onshtab","focalizaShTabBuscar();" );
      ((Element)v.get(94)).appendChild((Element)v.get(126));
      /* Termina nodo:126   */

      /* Empieza nodo:127 / Elemento padre: 94   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(127)).setAttribute("nombre","Modificar" );
      ((Element)v.get(127)).setAttribute("x","80" );
      ((Element)v.get(127)).setAttribute("y","279" );
      ...
      ((Element)v.get(127)).setAttribute("cod","MMGGlobal.updateButton.label" );
      ((Element)v.get(127)).setAttribute("accion","onClickModificar();" );
      ((Element)v.get(127)).setAttribute("ontab","focalizaCod();" );
      ((Element)v.get(127)).setAttribute("onshtab","focalizaShTabBuscar();" );
