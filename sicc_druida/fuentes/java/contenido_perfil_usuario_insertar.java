...
public class contenido_perfil_usuario_insertar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_perfil_usuario_insertar" );
      ...
      v.add(doc.createTextNode("\r  \r\r  function onLoadPag()   {\r  \r         fMostrarMensajeError();\r    DrdEnsanchaConMargenDcho('listado1',12);\r    document.all[\"Cplistado1\"].style.visibility='';\r    document.all[\"CpLin1listado1\"].style.visibility='';\r    document.all[\"CpLin2listado1\"].style.visibility='';\r    document.all[\"CpLin3listado1\"].style.visibility='';\r    document.all[\"CpLin4listado1\"].style.visibility='';\r    eval (ON_RSZ);\r    init();\r   }\r\r   function init() {      \r      configurarMenuSecundario(\"frmContenido\");\r      var casoUso = get(\"frmContenido.casoUso\");\r      \r      if(casoUso==\"insertar\") {\r         var nom = get(\"frmContenido.varNombre\");\r         set(\"frmContenido.txtPerfil\", nom);\r         focaliza(\"frmContenido.txtPerfil\");   \r         var exitoInserta = get(\"frmContenido.varExitoInserta\");          \r         if(exitoInserta == \"Exito\") {\r           fMostrarMensajeExito(\"insertar\");                   set(\"frmContenido.varExitoInserta\", \"\");        \r           var copia = get(\"frmContenido.varCopiar\");\r           if(copia==\"copiando\") {\r             window.close();\r           }           \r         }  \r      }\r\r      if(casoUso==\"consultar\") {\r                  var nom = get(\"frmContenido.varNombre\");\r                  set(\"frmContenido.txtPerfil\", nom);         \r                  accion(\"frmContenido.txtPerfil\", \".disabled=true\");\r         document.all[\"capaPrincipal\"].style.display='none';\r         document.all[\"miscroll\"].style.display='none';\r            listado1.tiposCol[1][6]=true; \r            listado1.actualizaDat();\r            listado1.repinta();\r      }\r\r           if(casoUso==\"modificar\") {\r\r                  var nom = get(\"frmContenido.varNombre\");\r         set(\"frmContenido.txtPerfil\", nom);         \r         accion(\"frmContenido.txtPerfil\", \".disabled=true\");      \r\r         var exitoModifica = get(\"frmContenido.varExitoModifica\");\r                  if(exitoModifica ==\"Exito\") {\r                      fMostrarMensajeExito(\"modificar\");\r           set(\"frmContenido.varExitoModifica\", \"\");                              window.close();\r         }     \r      }     \r      \r                               }\rfunction reInicio() {\r                      fLimpiarGenericoSICC();\r                      var datos = new Array();\r                      listado1.setDatos(datos);\r							 						    set(\"frmContenido.txtPerfil\", '');\r                      focaliza('frmContenido.txtPerfil');\r  }\r\r\r  function fLimpiar() {\r                    \r                    fLimpiarGenericoSICC();\r                    var nom = get(\"frmContenido.varNombre\");\r                    set(\"frmContenido.txtPerfil\", nom);\r                    focaliza('frmContenido.txtPerfil');\r                    var cod = listado1.codigos();\r                    listado1.selecciona(1);\r                    listado1.selecciona(0);\r                    var i=0;\r                     for (i=0;i<cod.length;i++){\r                      listado1.deselecciona(i) ;\r                    }\r                    for (i=0;i<cod.length;i++){\r                      listado1.selecciona(i) ;\r                    }\r                    listado1.eliminarSelecc();\r                    \r\r  }\r\r    function hayErrores() {\r         var codigoError = get(\"frmContenido.errCodigo\");\r         var descError = get(\"frmContenido.errDescripcion\");\r\r         if (codigoError == \"\") {\r           return false;\r         }\r                  else {\r           var casoUso = get(\"frmContenido.casoUso\");      \r           var copy = get(\"frmContenido.varCopiar\");\r\r           if(casoUso==\"insertar\") {\r             fMostrarMensajeError(codigoError, descError);\r             window.close();\r             return;\r           }\r\r           if(casoUso==\"consultar\") {\r             fMostrarMensajeError(codigoError, descError);\r             window.close();\r             return;\r           }\r\r           if(casoUso==\"modificar\") {\r             fMostrarMensajeError(codigoError, descError);\r             window.close();\r             return;\r           }\r\r           if(copy==\"copiando\") {\r             fMostrarMensajeError(codigoError, descError);\r             window.close();\r             return;\r           }          \r         \r           fMostrarMensajeError(codigoError, descError);    \r           set(\"frmContenido.conectorAction\", \"LPPerfiles\");           \r           set(\"frmContenido.accion\", \"\");      \r           enviaSICC(\"frmContenido\");    \r           return true;\r         }\r    }\r\r   function validaNombrePerfil(valor) {\r      var permitidos = \" 0123456789ABCDEFGHIJKLMNÑOPQRSTUVWXYZabcdefghijklmnñopqrstuvwxyz\";\r      var c;\r      for(var i=0; i<valor.length; i++) {\r           c = valor.charAt(i);\r           if (permitidos.indexOf(c) == -1 )     return false;\r      }\r      return true;\r   }\r\rfunction accionGuardar() {\r\r                                                               var casoUso = get(\"frmContenido.casoUso\");\r                  if(casoUso==\"insertar\") {      \r                                                                                          var nombre = get(\"frmContenido.txtPerfil\");\r                  nombre = cdos_trim(nombre);\r                  if(nombre==\"\") {\r                           GestionarMensaje(\"1065\", null, null, null);\r                         set(\"frmContenido.txtPerfil\",\"\");\r                           focaliza(\"frmContenido.txtPerfil\",\"\");\r                           return false;\r                  } else {\r                                                       set(\"frmContenido.txtPerfil\",nombre);\r                  }\r\r                                                                        var valnom = validaNombrePerfil(nombre);\r                  if (valnom != true) {\r                           GestionarMensaje(\"1086\", null, null, null);\r                           focaliza(\"frmContenido.txtPerfil\",\"\");\r                           return false;\r                  }\r         }     \r\r         var listadoDatos = listado1.datos;\r         var cantCodigos = listado1.codigos().length;\r\r                  for ( var i = 0; i < cantCodigos; i++) {\r         if (listadoDatos[i][2] == \"S\") {\r         var codigo = listadoDatos[i][0];\r         }           \r         }\r\r                  arrayFunc = listado1.codigos();\r\r         if(codigo==undefined) {        \r         set(\"frmContenido.inicio\",\"null\");  \r         }\r         else {\r         set(\"frmContenido.inicio\",codigo);\r         }\r\r         var nombrePerfil;\r\r         if(casoUso==\"insertar\") {\r         nombrePerfil = get(\"frmContenido.txtPerfil\");  \r         }     \r         if(casoUso==\"modificar\") {\r         nombrePerfil = get(\"frmContenido.varNombre\");\r         }          \r                  var valorCopia = get(\"frmContenido.varCopiar\");      \r         set(\"frmContenido.conectorAction\", \"LPPerfiles\");\r         set(\"frmContenido.funciones\",arrayFunc);      \r         set(\"frmContenido.accion\",\"guardar\");\r         set(\"frmContenido.varNombre\",nombrePerfil);\r         set(\"frmContenido.varCopiar\",valorCopia);\r         enviaSICC(\"frmContenido\");\r}\r   \r   function seleccionarFuncion(oid, nombre) {\r                        \r      var arrayVerificRepe = new Array();\r      arrayVerificRepe = listado1.codigos();\r\r            for(var i=0; i<arrayVerificRepe.length; i++) {\r         if (arrayVerificRepe[i] == oid) {\r           return false;\r         }\r      }\r      var ruta = obtengoRuta(oid);\r      agregarFuncion(oid, ruta);\r   }\r\r   function obtengoRuta(nId) {  \r      var cRuta;\r      var cOrig;\r      var arrayRutaOrig = new Array();\r      cRuta = \"Menu/\";\r      for(var i=0; i<name1.entradas.length; i++) {\r                  if (name1.entradas[i][2] == nId) {\r           cOrig = name1.entradas[i][0];\r           arrayRutaOrig = cOrig.split(\".name\");\r                           arrayRutaOrig[0] = \"\";\r                      for(var j=0; j<arrayRutaOrig.length; j++) {\r             for(var h=0; h<name1.entradas.length; h++) {\r                if (arrayRutaOrig[j] == name1.entradas[h][2]) {\r                                    cRuta = cRuta + name1.entradas[h][3] + '/';\r                  break;\r                } \r             }\r           } \r         }\r      }\r      cRuta = cRuta.substr(0, (cRuta.length-1));\r      return cRuta;\r    }\r\r   function agregarFuncion(oid, ruta) {      \r                                                      agregarFila(oid,ruta);\r   }\r\r   function agregarFila(oid,ruta) {\r      var nuevaFila = new Array();\r      \r      nuevaFila[0] = oid;                          \r                           nuevaFila[1] = ruta;			\r                           nuevaFila[2] = \"N\";\r      \r                           listado1.insertar(nuevaFila);\r    }\r\r   function fGuardar() {\r      accionGuardar();      \r   }\r\r   function inicioOnChange(filaCambiada) {      \r           var caso = get(\"frmContenido.casoUso\");\r      if(caso==\"consultar\") {\r         listado1.repintaDat();\r         return;\r      }\r   \r                     \r                                 listado1.actualizaDat();\r                           var listadoDatos = listado1.datos;\r                           var cantCodigos = listado1.codigos().length;\r                           \r                           listado1.actualizaDat();\r\r                           for ( var i = 0; i < cantCodigos; i++) {\r                                             if ( i != filaCambiada)\r             listadoDatos[i][2] = \"N\";\r      }                   \r                           listado1.setDatos(listadoDatos); 			\r    }\r\r    function focalizaNombre() {\r      focaliza(\"frmContenido.txtPerfil\");\r    }\r\r    function fBorrar() {\r            if (listado1.numSelecc()== 0) {\r         GestionarMensaje('1021',null,null,null);\r         return false;\r      }    \r      listado1.eliminarSelecc();          \r    }\r\r    function fVolver(){\r                  window.close();\r    }\r    \r"));
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(36)).setAttribute("cod","00507" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(55)).setAttribute("size","33" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(101)).setAttribute("y","74" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(123)).setAttribute("y","661" );
