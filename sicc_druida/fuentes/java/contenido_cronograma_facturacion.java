...
public class contenido_cronograma_facturacion  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_cronograma_facturacion" );
      ...
      v.add(doc.createTextNode("\r    \r\r	var aTipos = new Array();\r\r	function onLoadPag() {\r		configurarMenuSecundario(\"frmCronogramaFacturacion\");\r		set('frmCronogramaFacturacion.hlblActiFija',GestionarMensaje('1002'));\r		set('frmCronogramaFacturacion.hlblActiRefe',GestionarMensaje('1003'));\r    btnProxy(2, '0'); \r		focaliza('frmCronogramaFacturacion.txtNumeroDiasFinFacturacion');\r		generaArrayTipos();\r		if (aTipos.length > 0)\r			txt_to(\"lblGrupoDeZonasX\",aTipos[0][1]);\r	}\r\r	function generaArrayTipos() {\r		var tipos;\r		tipos = get('frmCronogramaFacturacion.hTipos');\r		longTipos =  get('frmCronogramaFacturacion.hLongTipos');\r		aTipos = new Array();\r		var i;\r		var pos;\r		var grupo;\r		var aGrupo;\r		for (i = 0; i < longTipos; i++) {\r			pos = tipos.indexOf('||');\r			if (pos > -1) {\r				grupo = tipos.substring(0, pos);\r				aGrupo = grupo.split(\"|\");\r								aTipos[i] = aGrupo;\r				tipos = tipos.substr(pos+2,tipos.length-pos);\r			} else {\r				grupo = tipos.substr(0, tipos.length);\r				aGrupo = grupo.split(\"|\");\r				aTipos[i] = aGrupo;\r			}\r					}\r	}\r\r	function fGuardar() {\r		    if (get('frmCronogramaFacturacion.txtNumeroDiasFinFacturacion') != \"\" &&\r        fValidarNumero(get('frmCronogramaFacturacion.txtNumeroDiasFinFacturacion'), 3, -999, 999) != 'OK') {\r        \r        GestionarMensaje('1297', sicc_obtenerDescripcion('txtNumeroDiasFinFacturacion'));\r        focaliza('frmCronogramaFacturacion.txtNumeroDiasFinFacturacion');\r        return;\r    }\r    if (get('frmCronogramaFacturacion.txtNumeroDiasIntervalo') != \"\" &&\r        fValidarNumero(get('frmCronogramaFacturacion.txtNumeroDiasIntervalo'), 3, -999, 999) != 'OK') {\r        \r        GestionarMensaje('1297', sicc_obtenerDescripcion('txtNumeroDiasIntervalo'));\r        focaliza('frmCronogramaFacturacion.txtNumeroDiasIntervalo');\r        return;\r    }\r    \r		var indice = parseInt(get('frmCronogramaFacturacion.hIndGrupo'),10);\r		if (indice == aTipos.length-1) {\r			aTipos[indice][3] = \"$\"+get('frmCronogramaFacturacion.txtNumeroDiasFinFacturacion'); 			aTipos[indice][4] = \"$\"+get('frmCronogramaFacturacion.txtNumeroDiasIntervalo'); 						generarArrayLP();\r						set('frmCronogramaFacturacion.hLblGrupoZona', GestionarMensaje('1244'));\r			set('frmCronogramaFacturacion.hLblZona', GestionarMensaje('1245'));\r			set('frmCronogramaFacturacion.accion', 'generaFase1');\r			set('frmCronogramaFacturacion.conectorAction', 'LPMantieneCronograma');\r			enviaSICC('frmCronogramaFacturacion');\r		} else {\r			aTipos[indice][3] = \"$\"+get('frmCronogramaFacturacion.txtNumeroDiasFinFacturacion'); 			aTipos[indice][4] = \"$\"+get('frmCronogramaFacturacion.txtNumeroDiasIntervalo'); 			set('frmCronogramaFacturacion.hIndGrupo',(indice+1)+\"\");\r			txt_to(\"lblGrupoDeZonasX\",aTipos[indice+1][1]); 			set('frmCronogramaFacturacion.txtNumeroDiasFinFacturacion',\"\");\r			set('frmCronogramaFacturacion.txtNumeroDiasIntervalo',\"\");\r			focaliza('frmCronogramaFacturacion.txtNumeroDiasFinFacturacion')\r		}\r\r	}\r\r	function generarArrayLP() {\r				var cad = \"\";\r		for (i = 0; i < aTipos.length; i++) {\r			for (j = 0; j < 5; j++) {\r				cad = cad + aTipos[i][j];\r				cad = cad + \"|\";\r							}\r			cad = cad + \"#|\";\r		}\r\r		set('frmCronogramaFacturacion.hVarGrupos',cad);\r	}\r\r	function fLimpiar() {\r    		if (aTipos.length > 0) {\r  		txt_to(\"lblGrupoDeZonasX\",aTipos[0][1]);\r											}\r	}\r\r\r\r\r    \r    "));
      ...
      ((Element)v.get(5)).setAttribute("name","txtNumeroDiasFinFacturacion" );
      ((Element)v.get(5)).setAttribute("required","false" );
      ((Element)v.get(5)).setAttribute("cod","182" );
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(6)).setAttribute("name","txtNumeroDiasIntervalo" );
      ((Element)v.get(6)).setAttribute("required","false" );
      ((Element)v.get(6)).setAttribute("cod","2213" );
      ...
      ((Element)v.get(7)).setAttribute("nombre","frmCronogramaFacturacion" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(13)).setAttribute("nombre","hTipos" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(14)).setAttribute("nombre","hIndGrupo" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(15)).setAttribute("nombre","hLongTipos" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(16)).setAttribute("nombre","hVecDiasSemana" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(17)).setAttribute("nombre","hVecMeses" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(18)).setAttribute("nombre","hLblGrupoZona" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(19)).setAttribute("nombre","hLblZona" );
   ...
   private void getXML90(Document doc) {
      v.add(doc.createElement("VAR"));
      ((Element)v.get(22)).setAttribute("nombre","hCodPeriodo" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(23)).setAttribute("nombre","hVarGrupos" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(24)).setAttribute("nombre","hlblActiFija" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(25)).setAttribute("nombre","hlblActiRefe" );
      ...
      ((Element)v.get(26)).setAttribute("nombre","capaBusqueda" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(50)).setAttribute("nombre","lblGrupoDeZonas" );
      ...
      ((Element)v.get(50)).setAttribute("cod","180" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lblNumeroDiasFinFacturacion" );
      ((Element)v.get(54)).setAttribute("alto","13" );
      ((Element)v.get(54)).setAttribute("filas","1" );
      ((Element)v.get(54)).setAttribute("valor","" );
      ((Element)v.get(54)).setAttribute("id","datosTitle" );
      ((Element)v.get(54)).setAttribute("cod","182" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(58)).setAttribute("nombre","lblNumeroDiasIntervalo" );
      ...
      ((Element)v.get(58)).setAttribute("cod","2213" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(65)).setAttribute("nombre","lblGrupoDeZonasX" );
   ...
   private void getXML270(Document doc) {
      ((Element)v.get(69)).setAttribute("nombre","txtNumeroDiasFinFacturacion" );
      ...
      ((Element)v.get(69)).setAttribute("onshtab","focaliza('frmCronogramaFacturacion.txtNumeroDiasIntervalo');" );
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(73)).setAttribute("nombre","txtNumeroDiasIntervalo" );
      ((Element)v.get(73)).setAttribute("id","datosCampos" );
      ((Element)v.get(73)).setAttribute("max","3" );
      ((Element)v.get(73)).setAttribute("tipo","" );
      ((Element)v.get(73)).setAttribute("onchange","" );
      ((Element)v.get(73)).setAttribute("req","N" );
      ((Element)v.get(73)).setAttribute("size","3" );
      ((Element)v.get(73)).setAttribute("valor","" );
      ((Element)v.get(73)).setAttribute("validacion","" );
      ((Element)v.get(73)).setAttribute("ontab","focaliza('frmCronogramaFacturacion.txtNumeroDiasFinFacturacion');" );
      ...
      /* Empieza nodo:79 / Elemento padre: 35   */
      v.add(doc.createElement("td"));
      ((Element)v.get(35)).appendChild((Element)v.get(79));
      ...
      /* Empieza nodo:81 / Elemento padre: 27   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(27)).appendChild((Element)v.get(81));
