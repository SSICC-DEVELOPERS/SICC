...
public class BelEstadMercaPage  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","BelEstadMercaPage" );
      ((Element)v.get(0)).setAttribute("titulo","" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","" );
      ((Element)v.get(0)).setAttribute("onload","belEstadMercaInitComponents()" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","belestadmerca.js" );
      ((Element)v.get(0)).appendChild((Element)v.get(4));
      /* Termina nodo:4   */

      /* Empieza nodo:5 / Elemento padre: 0   */
      v.add(doc.createElement("FORMULARIO"));
      ((Element)v.get(5)).setAttribute("nombre","belEstadMercaFrm" );
      ...
      ((Element)v.get(6)).setAttribute("valor","BelEstadMercaLPExecution" );
      ...
      ((Element)v.get(7)).setAttribute("valor","BelEstadMercaLPExecution" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(37)).setAttribute("nombre","belEstadMercaFormLayer" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(52)).setAttribute("cod","BelEstadMerca.legend.label" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(67)).setAttribute("cod","BelEstadMerca.id.label" );
      ...
      ((Element)v.get(70)).setAttribute("ontab","ejecutarAccionFoco('belEstadMercaFrm',1, true)" );
      ((Element)v.get(70)).setAttribute("onshtab","ejecutarAccionFoco('belEstadMercaFrm', 1, false)" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(92)).setAttribute("cod","BelEstadMerca.paisOidPais.label" );
      ...
      ((Element)v.get(95)).setAttribute("ontab","ejecutarAccionFoco('belEstadMercaFrm',2, true);" );
      ((Element)v.get(95)).setAttribute("onshtab","ejecutarAccionFoco('belEstadMercaFrm',2, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(99)).setAttribute("nombre","codEstaTdId" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(104)).setAttribute("nombre","codEstaWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(106)).setAttribute("nombre","codEsta" );
      ...
      ((Element)v.get(106)).setAttribute("ontab","ejecutarAccionFoco('belEstadMercaFrm',3, true)" );
      ((Element)v.get(106)).setAttribute("onshtab","ejecutarAccionFoco('belEstadMercaFrm', 3, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(107)).setAttribute("nombre","codEstaGapTdId" );
      ...
      ((Element)v.get(113)).setAttribute("cod","BelEstadMerca.Descripcion.label" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(117)).setAttribute("ontab","ejecutarAccionFoco('belEstadMercaFrm',4, true)" );
      ((Element)v.get(117)).setAttribute("onshtab","ejecutarAccionFoco('belEstadMercaFrm', 4, false)" );
      ...
      ((Element)v.get(121)).setAttribute("href","javascript:openLocalizationDialog('belEstadMercaFrm', 'Descripcion', 1);" );
      ((Element)v.get(121)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"belEstadMercaFrm\",4, true)', 'ejecutarAccionFoco(\"belEstadMercaFrm\",4, false)')" );
   ...
   private void getXML630(Document doc) {
      ((Element)v.get(137)).setAttribute("nombre","belEstadMercaTrButtons" );
      ...
      ((Element)v.get(144)).setAttribute("nombre","belEstadMercaTdQueryButton" );
      ((Element)v.get(143)).appendChild((Element)v.get(144));

      /* Empieza nodo:145 / Elemento padre: 144   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(145)).setAttribute("nombre","belEstadMercaQueryButton" );
      ((Element)v.get(145)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(145)).setAttribute("estado","false" );
      ((Element)v.get(145)).setAttribute("accion","belEstadMercaFirstPage();" );
      ...
      ((Element)v.get(146)).setAttribute("nombre","belEstadMercaTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(148)).setAttribute("nombre","belEstadMercaLovNullButton" );
      ((Element)v.get(148)).setAttribute("ID","botonContenido" );
      ((Element)v.get(148)).setAttribute("tipo","html" );
      ((Element)v.get(148)).setAttribute("accion","belEstadMercaLovNullSelectionAction();" );
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(151)).setAttribute("nombre","belEstadMercaListLayer" );
      ...
      ((Element)v.get(152)).setAttribute("nombre","belEstadMercaList" );
   ...
   private void getXML720(Document doc) {
      ...
      ((Element)v.get(165)).setAttribute("cod","BelEstadMerca.codEsta.label" );
      ...
      ((Element)v.get(166)).setAttribute("cod","BelEstadMerca.Descripcion.label" );
   ...
   private void getXML810(Document doc) {
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(171)).setAttribute("nombre","belEstadMercaListButtonsLayer" );
      ...
      ((Element)v.get(177)).setAttribute("nombre","belEstadMercaPaginationButtonBar" );
      ...
      ((Element)v.get(178)).setAttribute("nombre","belEstadMercaFirstPageButton" );
      ((Element)v.get(178)).setAttribute("funcion","belEstadMercaFirstPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(179)).setAttribute("nombre","belEstadMercaFirstPageButtonGapTd" );
      ...
      v.add(doc.createElement("BTN"));
      ((Element)v.get(181)).setAttribute("nombre","belEstadMercaPreviousPageButton" );
      ((Element)v.get(181)).setAttribute("funcion","belEstadMercaPreviousPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(182)).setAttribute("nombre","belEstadMercaPreviousPageButtonGapTd" );
   ...
   private void getXML900(Document doc) {
      ...
      v.add(doc.createElement("BTN"));
      ((Element)v.get(184)).setAttribute("nombre","belEstadMercaNextPageButton" );
      ((Element)v.get(184)).setAttribute("funcion","belEstadMercaNextPage();" );
      ...
      ((Element)v.get(187)).setAttribute("nombre","belEstadMercaUpdateButtonTd" );
      ((Element)v.get(173)).appendChild((Element)v.get(187));

      /* Empieza nodo:188 / Elemento padre: 187   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(188)).setAttribute("nombre","belEstadMercaUpdateButton" );
      ((Element)v.get(188)).setAttribute("ID","botonContenido" );
      ((Element)v.get(188)).setAttribute("tipo","html" );
      ((Element)v.get(188)).setAttribute("accion","belEstadMercaUpdateSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(189)).setAttribute("nombre","belEstadMercaUpdateButtonGapTd" );
      ...
      ((Element)v.get(191)).setAttribute("nombre","belEstadMercaViewForRemoveButtonTd" );
      ((Element)v.get(173)).appendChild((Element)v.get(191));

      /* Empieza nodo:192 / Elemento padre: 191   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(192)).setAttribute("nombre","belEstadMercaViewForRemoveButton" );
      ((Element)v.get(192)).setAttribute("ID","botonContenido" );
      ((Element)v.get(192)).setAttribute("tipo","html" );
      ((Element)v.get(192)).setAttribute("accion","belEstadMercaViewSelection();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(193)).setAttribute("nombre","belEstadMercaViewForRemoveButtonGapTd" );
      ...
      ((Element)v.get(195)).setAttribute("nombre","belEstadMercaLovSelectButtonTd" );
      ((Element)v.get(173)).appendChild((Element)v.get(195));

      /* Empieza nodo:196 / Elemento padre: 195   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(196)).setAttribute("nombre","belEstadMercaLovSelectButton" );
      ((Element)v.get(196)).setAttribute("ID","botonContenido" );
      ((Element)v.get(196)).setAttribute("tipo","html" );
      ((Element)v.get(196)).setAttribute("accion","belEstadMercaLovSelectionAction();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(197)).setAttribute("nombre","belEstadMercaLovSelectButtonGapTd" );
      ...
      ((Element)v.get(199)).setAttribute("nombre","belEstadMercaViewButtonTd" );
      ((Element)v.get(173)).appendChild((Element)v.get(199));

      /* Empieza nodo:200 / Elemento padre: 199   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(200)).setAttribute("nombre","belEstadMercaViewButton" );
      ((Element)v.get(200)).setAttribute("ID","botonContenido" );
      ((Element)v.get(200)).setAttribute("tipo","html" );
      ((Element)v.get(200)).setAttribute("accion","belEstadMercaViewSelection();" );
   ...
   private void getXML990(Document doc) {
      ((Element)v.get(201)).setAttribute("nombre","belEstadMercaViewButtonGapTd" );
