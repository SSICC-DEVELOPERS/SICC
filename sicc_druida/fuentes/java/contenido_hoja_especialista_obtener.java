...
public class contenido_hoja_especialista_obtener  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_hoja_especialista_obtener" );
      ((Element)v.get(0)).setAttribute("cod","0747" );
      ((Element)v.get(0)).setAttribute("titulo","Obtener hoja por especialista" );
      ...
      v.add(doc.createTextNode("\r   \r   \r   function onLoad(){\r      configurarMenuSecundario('Formulario');\r      fMostrarMensajeError();\r      posicionarCombos();\r      focaliza('Formulario.cbCanal');\r   }\r\r     function quitarItemVacio(elemento){\r      var elementoADevolver = new Array();\r     \r      for(var k=0;k<elemento.length;k++) {\r          if (elemento[k] != ''){                            \r             elementoADevolver[elementoADevolver.length] = elemento[k];\r          }\r      }\r         \r      return elementoADevolver;\r      \r   }\r   function generar(formato){\r      if(sicc_validaciones_generales()){\r         if(validarFechas()){\r            \r               /*recolectarParametros();\r               set('Formulario.conectorAction', 'BELHojaEspecialista');           \r               set('Formulario.accion', 'generar');*/\r               var a = new Object();\r               a.accion = 'generar';\r               a.canal = get('Formulario.cbCanal');  \r               a.acceso = get('Formulario.cbAcceso');\r               a.subacceso = quitarItemVacio(get('Formulario.cbSubacceso'));\r               a.caja = quitarItemVacio(get('Formulario.cbCaja'));\r               a.fechaDesde = get('Formulario.txtFechaDesde');\r               a.fechaHasta = get('Formulario.txtFechaHasta');\r               a.tipoReporte = get('Formulario.cbTipo');      \r               \r               if(formato == 'xls'){\r                  a.formatoSalida = formato;\r               }\r                              mostrarModalSICC('BELHojaEspecialista','generar', a);  \r             }\r          \r      }\r   }\r\r   function recolectarParametros(){\r               \r    set('Formulario.canal', get('Formulario.cbCanal') );  \r    set('Formulario.acceso', get('Formulario.cbAcceso'));\r    set('Formulario.subacceso', get('Formulario.cbSubacceso'));\r    set('Formulario.caja', get('Formulario.cbCaja'))\r    set('Formulario.fechaDesde', get('Formulario.txtFechaDesde'));\r    set('Formulario.fechaHasta', get('Formulario.txtFechaHasta'));\r    set('Formulario.tipoReporte', get('Formulario.cbTipo'));\r    \r        \r       \r   }\r \r   \r\r    function fLimpiar(){\r      var aCombo = new Array(new Array(\"\",\"\"));\r      set_combo('Formulario.cbAcceso', aCombo, []);\r      set_combo('Formulario.cbSubacceso', aCombo, []);\r      set_combo('Formulario.cbCaja', aCombo, []);\r      posicionarCombos();\r      focaliza('Formulario.cbCanal');\r \r   }\r  function posicionarCombos(){\r      var array = new Array();\r      array[0] = '1';\r      set('Formulario.cbTipo',array);\r  }\r   \r\r  function validarFechas(){\r      var fechaInicio = get('Formulario.txtFechaDesde');\r      var fechaFin = get('Formulario.txtFechaHasta');\r      var formatoFecha = get('Formulario.hFormatoFechaPais');\r           \r     \r      if (! EsFechaValida_SICC(fechaInicio , \"Formulario\")){\r         GestionarMensaje(\"1006\", formatoFecha, null, null);\r         focaliza(\"Formulario.txtFechaDesde\");\r         return false;\r      }\r     \r      if(! EsFechaValida_SICC(fechaFin , \"Formulario\")){\r         GestionarMensaje(\"1006\", formatoFecha, null, null);\r         focaliza(\"Formulario.txtFechaHasta\");\r         return false;\r      }\r               \r      var errorLevel = EsFechaValida( fechaInicio, fechaFin, \"Formulario\", \"S\");\r      if ( errorLevel == 3){\r         GestionarMensaje(\"1191\");\r         focaliza('Formulario.txtFechaDesde');\r         return false;\r      }\r     \r      return true;   \r   \r   }\r   \r\r function onchangeCanal(){\r       if(get('Formulario.cbCanal') != ''){\r         \r         var arr = new Array();\r         var idioma = get('Formulario.idioma');\r         var canal = get('Formulario.cbCanal');\r         \r         arr[arr.length] = [\"oidIdioma\", idioma];\r         arr[arr.length] = [\"oidCanal\", canal];\r             \r         recargaCombo(\"Formulario.cbAcceso\", \"SEGObtenerAccesosPorCanal\", \"es.indra.sicc.dtos.seg.DTOAccesosPorCanal\",arr);\r      \r      }else{\r         var aCombo = new Array(new Array(\"\",\"\"));\r         set_combo('Formulario.cbAcceso', aCombo, []);\r         set_combo('Formulario.cbSubacceso', aCombo, []);\r      }\r  }\r \r function onchangeAcceso(){\r    var arr = new Array();\r\r    if(get('Formulario.cbAcceso') != ''){\r\r       arr[arr.length] = new Array('oid', get('Formulario.cbAcceso')); \r       arr[arr.length] = new Array('oidIdioma', get('Formulario.idioma'));\r       arr[arr.length] = new Array('oidPais', get('Formulario.pais'));\r    \r       recargaCombo('Formulario.cbSubacceso', 'SegObtenerSubaccesosPorAcceso', 'es.indra.sicc.util.DTOOID', arr );\r    }else{\r       var aCombo = new Array(new Array(\"\",\"\"));\r       set_combo('Formulario.cbSubacceso', aCombo, []);\r    }\r   \r  }\r\r   function recargaComboCaja(){\r      opciones = new Array();\r      set_combo('Formulario.cbCaja',opciones);                      \r      var subacceso = get('Formulario.cbSubacceso','V');\r      combo_add('Formulario.cbCaja', '', '');\r     \r       for(var k=0;k<ListaCaja.datos.longitud;k++) {\r          for(var y=0;y<subacceso.length;y++){\r             if (ListaCaja.datos.ij(k,0) == subacceso[y]){ 			 \r                combo_add('Formulario.cbCaja',ListaCaja.datos.ij(k,1),ListaCaja.datos.ij(k,2));\r             }\r          }\r       }\r    \r  }\r \r\r  \r   "));
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(9)).setAttribute("name","txtFechaDesde" );
      ((Element)v.get(9)).setAttribute("required","true" );
      ((Element)v.get(9)).setAttribute("cod","59" );
      ((Element)v.get(5)).appendChild((Element)v.get(9));
      /* Termina nodo:9   */

      /* Empieza nodo:10 / Elemento padre: 5   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(10)).setAttribute("name","txtFechaHasta" );
      ((Element)v.get(10)).setAttribute("required","true" );
      ((Element)v.get(10)).setAttribute("cod","1339" );
      ((Element)v.get(5)).appendChild((Element)v.get(10));
      /* Termina nodo:10   */

      /* Empieza nodo:11 / Elemento padre: 5   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(11)).setAttribute("name","cbTipo" );
      ((Element)v.get(11)).setAttribute("required","true" );
      ((Element)v.get(11)).setAttribute("cod","755" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(21)).setAttribute("nombre","acceso" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(22)).setAttribute("nombre","subacceso" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(23)).setAttribute("nombre","caja" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(24)).setAttribute("nombre","fechaDesde" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(25)).setAttribute("nombre","fechaHasta" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(26)).setAttribute("nombre","tipoReporte" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(59)).setAttribute("nombre","lblAcceso" );
      ...
      ((Element)v.get(66)).setAttribute("onchange","onchangeCanal();" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(71)).setAttribute("nombre","cbAcceso" );
      ...
      ((Element)v.get(71)).setAttribute("onchange","onchangeAcceso();" );
   ...
   private void getXML360(Document doc) {
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(93)).setAttribute("nombre","lblFechaDesde" );
      ...
      ((Element)v.get(93)).setAttribute("cod","59" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(97)).setAttribute("nombre","lblFechaHasta" );
      ...
      ((Element)v.get(97)).setAttribute("cod","1339" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(101)).setAttribute("nombre","lblTipo" );
      ...
      ((Element)v.get(101)).setAttribute("cod","755" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(108)).setAttribute("nombre","cbSubacceso" );
      ...
      ((Element)v.get(108)).setAttribute("onchange","recargaComboCaja();" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(113)).setAttribute("nombre","cbCaja" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(118)).setAttribute("nombre","txtFechaDesde" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(126)).setAttribute("nombre","cbTipo" );
      ...
      ((Element)v.get(129)).setAttribute("VALOR","1" );
      ...
      ((Element)v.get(130)).setAttribute("VALOR","Detalle" );
      ...
      v.add(doc.createElement("ROW"));
      ((Element)v.get(131)).setAttribute("ID","2" );
   ...
   private void getXML540(Document doc) {
      ((Element)v.get(132)).setAttribute("VALOR","2" );
      ...
      ((Element)v.get(133)).setAttribute("VALOR","Resumen" );
      ...
      /* Empieza nodo:134 / Elemento padre: 104   */
      v.add(doc.createElement("td"));
      ((Element)v.get(134)).setAttribute("width","100%" );
      ((Element)v.get(104)).appendChild((Element)v.get(134));
      ...
      /* Empieza nodo:136 / Elemento padre: 80   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(80)).appendChild((Element)v.get(136));
      ...
      ((Element)v.get(149)).setAttribute("nombre","btnGenerarInforme" );
      ((Element)v.get(149)).setAttribute("ID","botonContenido" );
      ((Element)v.get(149)).setAttribute("tipo","html" );
      ((Element)v.get(149)).setAttribute("accion","generar();" );
      ((Element)v.get(149)).setAttribute("estado","false" );
      ((Element)v.get(149)).setAttribute("cod","2495" );
      ((Element)v.get(148)).appendChild((Element)v.get(149));
      /* Termina nodo:149   */

      /* Empieza nodo:150 / Elemento padre: 148   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(150)).setAttribute("nombre","btnGenerarExcel" );
      ((Element)v.get(150)).setAttribute("ID","botonContenido" );
      ((Element)v.get(150)).setAttribute("tipo","html" );
      ((Element)v.get(150)).setAttribute("accion","generar('xls')" );
      ((Element)v.get(150)).setAttribute("estado","false" );
      ((Element)v.get(150)).setAttribute("cod","2526" );
      ((Element)v.get(150)).setAttribute("ontab","focaliza('Formulario.cbCanal')" );
      ...
      /* Empieza nodo:153 / Elemento padre: 29   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(29)).appendChild((Element)v.get(153));
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(156)).setAttribute("width","756" );
   }
