...
public class LPDevolverDineroCliente extends LPSICCBase {
  ...
  public LPDevolverDineroCliente() 
  {
    super();
  }   
    public void ejecucion() throws Exception {
        ...
        this.asignarAtributoPagina( "cod", "0469" );
        this.getConfiguracionMenu("LPDevolverDineroCliente");
        try{
            muestraPagina();
        }catch(Exception e){
            logStackTrace(e);
