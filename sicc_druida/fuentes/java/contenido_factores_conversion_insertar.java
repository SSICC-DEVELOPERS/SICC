...
public class contenido_factores_conversion_insertar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_factores_conversion_insertar" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","contenido_factores_conversion_insertar.js" );
      ...
      ((Element)v.get(7)).setAttribute("name","cbMagnitud" );
      ((Element)v.get(7)).setAttribute("required","true" );
      ((Element)v.get(7)).setAttribute("cod","MaeMagni.codMagn.label" );
      ((Element)v.get(6)).appendChild((Element)v.get(7));
      /* Termina nodo:7   */

      /* Empieza nodo:8 / Elemento padre: 6   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(8)).setAttribute("name","cbUnidMedOrigen" );
      ((Element)v.get(8)).setAttribute("required","true" );
      ((Element)v.get(8)).setAttribute("cod","3099" );
      ((Element)v.get(6)).appendChild((Element)v.get(8));
      /* Termina nodo:8   */

      /* Empieza nodo:9 / Elemento padre: 6   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(9)).setAttribute("name","cbUnidMedDestino" );
      ((Element)v.get(9)).setAttribute("required","true" );
      ((Element)v.get(9)).setAttribute("cod","3100" );
      ((Element)v.get(6)).appendChild((Element)v.get(9));
      /* Termina nodo:9   */

      /* Empieza nodo:10 / Elemento padre: 6   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(10)).setAttribute("name","txtFactor" );
      ((Element)v.get(10)).setAttribute("required","true" );
      ((Element)v.get(10)).setAttribute("cod","3101" );
      ((Element)v.get(10)).setAttribute("format","m" );
      ((Element)v.get(10)).setAttribute("min","0" );
      ((Element)v.get(10)).setAttribute("max","9999.999" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(15)).setAttribute("nombre","oidFactoresConversion" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(18)).setAttribute("nombre","oidMagnitud" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(19)).setAttribute("nombre","oidUnidMedOrigen" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(20)).setAttribute("nombre","oidcbUnidMedDestino" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(38)).setAttribute("nombre","lblSeleccionOrdenAnaquel" );
      ((Element)v.get(38)).setAttribute("alto","13" );
      ((Element)v.get(38)).setAttribute("filas","1" );
      ((Element)v.get(38)).setAttribute("cod","00127" );
   ...
   private void getXML180(Document doc) {
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(47)).setAttribute("nombre","lblMagnitud" );
      ...
      ((Element)v.get(47)).setAttribute("cod","MaeMagni.codMagn.label" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(51)).setAttribute("nombre","lblUnidMedOrigen" );
      ((Element)v.get(51)).setAttribute("alto","13" );
      ((Element)v.get(51)).setAttribute("filas","1" );
      ((Element)v.get(51)).setAttribute("valor","" );
      ((Element)v.get(51)).setAttribute("id","datosTitle" );
      ((Element)v.get(51)).setAttribute("cod","3099" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(55)).setAttribute("nombre","lblUnidMedDestino" );
      ...
      ((Element)v.get(55)).setAttribute("cod","3100" );
      ...
      ((Element)v.get(62)).setAttribute("nombre","cbMagnitud" );
      ...
      ((Element)v.get(62)).setAttribute("onchange","onChangeMagnitud();" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(67)).setAttribute("nombre","cbUnidMedOrigen" );
   ...
   private void getXML270(Document doc) {
      ((Element)v.get(67)).setAttribute("onchange","onChangeUniMedOrig();" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(72)).setAttribute("nombre","cbUnidMedDestino" );
      ...
      ((Element)v.get(72)).setAttribute("onchange","onChangeUniMedDest();" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(87)).setAttribute("nombre","lblFactor" );
      ...
      ((Element)v.get(87)).setAttribute("cod","3101" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(94)).setAttribute("nombre","txtFactor" );
      ((Element)v.get(94)).setAttribute("id","datosCampos" );
      ((Element)v.get(94)).setAttribute("max","9" );
      ...
      /* Empieza nodo:97 / Elemento padre: 79   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(79)).appendChild((Element)v.get(97));
