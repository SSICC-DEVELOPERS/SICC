...
public class PedProceViewPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","PedProceView.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","PedProceView.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('pedProceViewFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('pedProceViewFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(54)).setAttribute("cod","PedProceView.codProc.label" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('pedProceViewFrm',2, true)" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('pedProceViewFrm', 2, false)" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(64)).setAttribute("cod","PedProceView.Descripcion.label" );
      ...
      ((Element)v.get(68)).setAttribute("ontab","ejecutarAccionFoco('pedProceViewFrm',3, true)" );
      ((Element)v.get(68)).setAttribute("onshtab","ejecutarAccionFoco('pedProceViewFrm', 3, false)" );
      ...
      ((Element)v.get(72)).setAttribute("href","javascript:openLocalizationDialog('pedProceViewFrm', 'Descripcion', 1);" );
      ((Element)v.get(72)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"pedProceViewFrm\",3, true)', 'ejecutarAccionFoco(\"pedProceViewFrm\",3, false)')" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(88)).setAttribute("nombre","pedProceViewTrButtons" );
      ...
      ((Element)v.get(95)).setAttribute("nombre","pedProceViewTdQueryButton" );
      ((Element)v.get(94)).appendChild((Element)v.get(95));

      /* Empieza nodo:96 / Elemento padre: 95   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(96)).setAttribute("nombre","pedProceViewQueryButton" );
      ((Element)v.get(96)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(96)).setAttribute("estado","false" );
      ((Element)v.get(96)).setAttribute("accion","pedProceViewFirstPage();" );
      ...
      ((Element)v.get(97)).setAttribute("nombre","pedProceViewTdLovNullSelectionButton" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(99)).setAttribute("nombre","pedProceViewLovNullButton" );
      ((Element)v.get(99)).setAttribute("ID","botonContenido" );
      ((Element)v.get(99)).setAttribute("tipo","html" );
      ((Element)v.get(99)).setAttribute("accion","pedProceViewLovNullSelectionAction();" );
