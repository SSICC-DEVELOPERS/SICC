/*
    INDRA/CAR/mmg
    $Id: PreArgumVentaLPStartUp.java,v 1.1 2009/12/03 18:42:19 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class PreArgumVentaLPStartUp extends MMGDruidaBase{
	...
	public static final String BUSINESSID_QUERY = "MMGPreArgumVentaQueryFromToUserPage";
	...
	public PreArgumVentaLPStartUp(){
		super();
	}

	public void inicio() throws Exception {
		pagina("PreArgumVentaPage");
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "PreArgumVentaPage", "cod", "PreArgumVenta." + accion + ".label");
			...
			limpiarBotoneraLista("preArgumVenta", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codArguVent", "validacion", "mensaje = ValidaInt(cdos_trim(valor), 4, 0, 9999);");
		asignarAtributo("TEXT", "Descripcion", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 0, 40);");
		
		//Primero determianmos el nombre del campo en la entidad de oriegen donde se van a cargar los datos
		asignar("VAR", "idAttributeLovOpener", conectorParametro(PARAMETRO_LOV_ATTRIBUTO));
		asignar("VAR", "idEntityLovOpener", conectorParametro(PARAMETRO_LOV_ENTIDAD));
		//asignarAtributo("CAPA", "preArgumVentaLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "PreArgumVentaPage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("PreArgumVentaLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		PreArgumVentaData preArgumVentaQuery= new PreArgumVentaData();
		preArgumVentaQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		PreArgumVentaData datosResult = (PreArgumVentaData)getSingleObject(BUSINESSID_QUERY, preArgumVentaQuery, 
			preArgumVentaQuery.clone(), "preArgumVenta");
		...
		preservaHiddensI18n(new Integer(1), "PRE_ARGUM_VENTA", "preArgumVentaFrm", "Descripcion", true);
		...
		PreArgumVentaData preArgumVenta = datosResult;
		asignar("TEXT", "codArguVent", FormatUtils.formatObject(preArgumVenta.getCodArguVent(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "Descripcion", FormatUtils.formatObject(preArgumVenta.getDescripcion(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "valFactRepe", FormatUtils.formatObject(preArgumVenta.getValFactRepe(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		loadLocalizationVars(preArgumVenta);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "codArguVent", "disabled", "S");
		asignarAtributo("TEXT", "Descripcion", "disabled", "S");
		asignarAtributo("TEXT", "valFactRepe", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "PRE_ARGUM_VENTA", "preArgumVentaFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "codArguVent", "req", "S");
		
		
		//Asiganamos a los campos internacionalizables la función de onblur para actualizar el 
		//valor del idioma por defecto
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('preArgumVentaFrm.Descripcion'))");
		...
		asignarAtributo("TEXT", "valFactRepe", "validacion", "mensaje = ValidaInt(cdos_trim(valor), 2, 0, 99);");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "preArgumVentaFrm", "oculto", "N");
		...
		traza("MMG::Creando PreArgumVenta");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		PreArgumVentaData preArgumVentaQuery= new PreArgumVentaData();
		preArgumVentaQuery.setId(new Long(id));
		...
		asignar("TEXT", "Descripcion", FormatUtils.formatObject(preArgumVenta.getDescripcion(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		es.indra.belcorp.mso.PreTipoEstraData tiesOidTipoEstr = preArgumVenta.getTiesOidTipoEstr();
		...
		//asignar("VAR","timestamp",Long.toString(preArgumVenta.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"preArgumVentaFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"preArgumVentaFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codArguVent", "ontab","ejecutarAccionFocoModificacion(\"preArgumVentaFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codArguVent", "onshtab","ejecutarAccionFocoModificacion(\"preArgumVentaFrm\",2, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"preArgumVentaFrm\",3, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"preArgumVentaFrm\",3, false)");
					asignarAtributo("COMBO","tiesOidTipoEstr", "ontab", "ejecutarAccionFocoModificacion(\"preArgumVentaFrm\",4, true)");
					asignarAtributo("COMBO","tiesOidTipoEstr", "onshtab", "ejecutarAccionFocoModificacion(\"preArgumVentaFrm\",4, false)");
				asignarAtributo("AREATEXTO", "valFactRepe", "ontab","ejecutarAccionFocoModificacion(\"preArgumVentaFrm\",5, true)");
				asignarAtributo("AREATEXTO", "valFactRepe", "onshtab","ejecutarAccionFocoModificacion(\"preArgumVentaFrm\",5, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","preArgumVentaTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","preArgumVentaTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","preArgumVentaFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","preArgumVentaListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","preArgumVentaListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(PreArgumVentaData preArgumVenta) throws Exception{
		...
		if(preArgumVenta != null && preArgumVenta.getTiesOidTipoEstr() != null){
				checkCombo("tiesOidTipoEstr" , preArgumVenta.getTiesOidTipoEstr().getId().toString());
			}
	...
	* @param preArgumVenta La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(PreArgumVentaData preArgumVenta) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		PreArgumVentaData preArgumVenta = 
			(PreArgumVentaData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(preArgumVenta.getTiesOidTipoEstr() != null){
			preArgumVenta.setTiesOidTipoEstr((es.indra.belcorp.mso.PreTipoEstraData)
			getSingleObject(BUSINESSID_TIESOIDTIPOESTR_QUERY, 
			preArgumVenta.getTiesOidTipoEstr(),
			preArgumVenta.getTiesOidTipoEstr().clone(),
			"preTipoEstra"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(preArgumVenta);
		loadLeafDependenceCombos(preArgumVenta);
	}
	...
	*/
	...
	protected void loadLocalizationVars(PreArgumVentaData preArgumVenta) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("PRE_ARGUM_VENTA");
		mmgLocalizationQuery.setEntiPk(preArgumVenta.getId());
