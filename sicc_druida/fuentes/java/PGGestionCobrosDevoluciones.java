...
public class PGGestionCobrosDevoluciones  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","PGGestionCobrosDevoluciones" );
      ...
      v.add(doc.createTextNode("\r   \r\r    function init() { \r    }\r\r    function onLoadPage() {\r    	configurarMenuSecundario(\"frmContenido\");\r    }\r\rfunction busquedaRapidaCliente(url) {\r	var parametros = new Object();  \r    var obj = mostrarModalSICC(url,'', parametros, '710', '550');                      \r	if(obj != null) {\r		document.applets[0].setOidCliente(obj[0]);\r		document.applets[0].setCodigoCliente(obj[1]);\r	}\r}\r\r\r/*\rfunction consultarModificarSolicitud(url, v_accion, v_operacion, v_oidCabeceraSolicitud) {\r	var parametros = new Object();  \r		parametros.operacion = v_operacion;\r	parametros.oidCabeceraSolicitud = v_oidCabeceraSolicitud;\r\r    var obj = mostrarModalSICC(url,v_accion, parametros, '600', '250');                      \r	if(obj != null) {\r		document.applets[0].setConsultoraRefencia(obj[1]);\r	}\r}\r*/\r\r\r"));
      ...
      ((Element)v.get(5)).setAttribute("valor","LPDevolverDineroCliente" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(12)).setAttribute("nombre","user" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(14)).setAttribute("nombre","belcenter" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(33)).setAttribute("width","660" );
      ...
      ((Element)v.get(44)).setAttribute("nombre","parametrosApplet" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(55)).setAttribute("width","750" );
