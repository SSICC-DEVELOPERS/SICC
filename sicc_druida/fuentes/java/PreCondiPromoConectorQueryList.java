...
public class PreCondiPromoConectorQueryList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad PreCondiPromo" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGPreCondiPromoQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGPreCondiPromoQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","PreCondiPromoListFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","codCondProm" );
