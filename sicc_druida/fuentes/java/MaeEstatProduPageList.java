...
public class MaeEstatProduPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","maeEstatProduList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","MaeEstatProdu.codEstaProd.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","MaeEstatProdu.Descripcion.label" );
