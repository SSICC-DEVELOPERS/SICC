...
public class EduPlantCursoEstatPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","EduPlantCursoEstat.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","EduPlantCursoEstat.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('eduPlantCursoEstatFrm',0, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('eduPlantCursoEstatFrm', 0, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(53)).setAttribute("nombre","mcurOidCursTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(57)).setAttribute("nombre","lblmcurOidCurs" );
      ((Element)v.get(57)).setAttribute("id","datosTitle" );
      ((Element)v.get(57)).setAttribute("ancho","100" );
      ((Element)v.get(57)).setAttribute("alto","13" );
      ((Element)v.get(57)).setAttribute("cod","EduPlantCursoEstat.mcurOidCurs.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(58)).setAttribute("nombre","mcurOidCursWidgetTrId" );
      ...
      ((Element)v.get(60)).setAttribute("nombre","mcurOidCurs" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(60)).setAttribute("ontab","ejecutarAccionFoco('eduPlantCursoEstatFrm',0, true);" );
      ((Element)v.get(60)).setAttribute("onshtab","ejecutarAccionFoco('eduPlantCursoEstatFrm',0, false);" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(62)).setAttribute("nombre","mcurOidCursViewLabelTrId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(64)).setAttribute("nombre","lblViewMcurOidCurs" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(65)).setAttribute("nombre","mcurOidCursGapTdId" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(82)).setAttribute("nombre","dpcuOidDetaPlanCursTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(86)).setAttribute("nombre","lbldpcuOidDetaPlanCurs" );
      ((Element)v.get(86)).setAttribute("id","datosTitle" );
      ((Element)v.get(86)).setAttribute("ancho","100" );
      ((Element)v.get(86)).setAttribute("alto","13" );
      ((Element)v.get(86)).setAttribute("cod","EduPlantCursoEstat.dpcuOidDetaPlanCurs.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(87)).setAttribute("nombre","dpcuOidDetaPlanCursWidgetTrId" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(89)).setAttribute("nombre","dpcuOidDetaPlanCurs" );
      ...
      ((Element)v.get(89)).setAttribute("ontab","ejecutarAccionFoco('eduPlantCursoEstatFrm',0, true);" );
      ((Element)v.get(89)).setAttribute("onshtab","ejecutarAccionFoco('eduPlantCursoEstatFrm',0, false);" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(91)).setAttribute("nombre","dpcuOidDetaPlanCursViewLabelTrId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(93)).setAttribute("nombre","lblViewDpcuOidDetaPlanCurs" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(94)).setAttribute("nombre","dpcuOidDetaPlanCursGapTdId" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(108)).setAttribute("nombre","eduPlantCursoEstatTrButtons" );
      ...
      ((Element)v.get(115)).setAttribute("nombre","eduPlantCursoEstatTdQueryButton" );
      ((Element)v.get(114)).appendChild((Element)v.get(115));

      /* Empieza nodo:116 / Elemento padre: 115   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(116)).setAttribute("nombre","eduPlantCursoEstatQueryButton" );
      ((Element)v.get(116)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(116)).setAttribute("estado","false" );
      ((Element)v.get(116)).setAttribute("accion","eduPlantCursoEstatFirstPage();" );
      ...
      ((Element)v.get(117)).setAttribute("nombre","eduPlantCursoEstatTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(119)).setAttribute("nombre","eduPlantCursoEstatLovNullButton" );
      ((Element)v.get(119)).setAttribute("ID","botonContenido" );
      ((Element)v.get(119)).setAttribute("tipo","html" );
      ((Element)v.get(119)).setAttribute("accion","eduPlantCursoEstatLovNullSelectionAction();" );
