...
public class contenido_cronograma_generar_zona  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_cronograma_generar_zona" );
      ...
      ((Element)v.get(1)).setAttribute("src","contenido_cronograma_generar_zona.js" );
      ...
      ((Element)v.get(7)).setAttribute("name","cbZonaReferencia" );
      ((Element)v.get(7)).setAttribute("group","grupo1" );
      ((Element)v.get(7)).setAttribute("required","true" );
      ((Element)v.get(7)).setAttribute("cod","3214" );
      ((Element)v.get(6)).appendChild((Element)v.get(7));
      /* Termina nodo:7   */

      /* Empieza nodo:8 / Elemento padre: 6   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(8)).setAttribute("name","cbZonasRegenerar" );
      ((Element)v.get(8)).setAttribute("group","grupo1" );
      ((Element)v.get(8)).setAttribute("required","true" );
      ((Element)v.get(8)).setAttribute("cod","3215" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(17)).setAttribute("nombre","hayQueBorrar" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(33)).setAttribute("nombre","lblCriteriosDeSeleccion" );
      ...
      ((Element)v.get(42)).setAttribute("cod","EduTipoCurso.marcOidMarc.label" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(46)).setAttribute("cod","FacAsignImpre.canaOidCana.label" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(50)).setAttribute("nombre","lblPeriodo" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lblGrupoZ" );
      ((Element)v.get(54)).setAttribute("alto","13" );
      ((Element)v.get(54)).setAttribute("filas","1" );
      ((Element)v.get(54)).setAttribute("valor","" );
      ((Element)v.get(54)).setAttribute("id","datosTitle" );
      ((Element)v.get(54)).setAttribute("cod","180" );
      ...
      ((Element)v.get(61)).setAttribute("onchange","onChangeCbMarca();" );
      ((Element)v.get(61)).setAttribute("ontab","tab('cbMarca')" );
      ((Element)v.get(61)).setAttribute("onshtab","shtab('cbMarca')" );
      ...
      ((Element)v.get(66)).setAttribute("ontab","tab('cbCanal')" );
   }

   private void getXML270(Document doc) {
      ((Element)v.get(66)).setAttribute("onshtab","shtab('cbCanal')" );
      ...
      ((Element)v.get(71)).setAttribute("ontab","tab('cbPeriodo')" );
      ((Element)v.get(71)).setAttribute("onshtab","shtab('cbPeriodo')" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(75)).setAttribute("nombre","cbGrupoZ" );
      ...
      ((Element)v.get(75)).setAttribute("onchange","onChangeGrupoZ();" );
      ((Element)v.get(75)).setAttribute("ontab","tab('cbGrupoZ')" );
      ((Element)v.get(75)).setAttribute("onshtab","shtab('cbGrupoZ')" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(89)).setAttribute("nombre","lblZonaReferencia" );
      ...
      ((Element)v.get(89)).setAttribute("cod","3214" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(93)).setAttribute("nombre","lblZonasRegenerar" );
      ...
      ((Element)v.get(93)).setAttribute("cod","3215" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(100)).setAttribute("nombre","cbZonaReferencia" );
      ((Element)v.get(100)).setAttribute("id","datosCampos" );
      ((Element)v.get(100)).setAttribute("size","4" );
      ((Element)v.get(100)).setAttribute("multiple","N" );
      ((Element)v.get(100)).setAttribute("req","S" );
      ((Element)v.get(100)).setAttribute("onchange","onChangeZonaRef();" );
      ((Element)v.get(100)).setAttribute("ontab","tab('cbZonaReferencia')" );
      ((Element)v.get(100)).setAttribute("onshtab","shtab('cbZonaReferencia')" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(105)).setAttribute("nombre","cbZonasRegenerar" );
      ...
      ((Element)v.get(105)).setAttribute("ontab","tab('cbZonasRegenerar')" );
      ((Element)v.get(105)).setAttribute("onshtab","shtab('cbZonasRegenerar')" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(114)).setAttribute("nombre","btnGenerar" );
      ((Element)v.get(114)).setAttribute("ID","botonContenido" );
      ((Element)v.get(114)).setAttribute("tipo","html" );
      ((Element)v.get(114)).setAttribute("accion","validarGeneracion()" );
      ((Element)v.get(114)).setAttribute("estado","false" );
      ((Element)v.get(114)).setAttribute("cod","190" );
