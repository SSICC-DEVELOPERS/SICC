...
public class GenPrincipalsPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","genPrincipalsList" );
      ...
      ((Element)v.get(14)).setAttribute("cod","GenPrincipals.name.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","GenPrincipals.type.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","GenPrincipals.description.label" );
