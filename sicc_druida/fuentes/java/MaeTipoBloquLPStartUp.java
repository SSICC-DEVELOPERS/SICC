/*
    INDRA/CAR/mmg
    $Id: MaeTipoBloquLPStartUp.java,v 1.1 2009/12/03 18:42:23 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class MaeTipoBloquLPStartUp extends MMGDruidaBase{
	...
	public static final String BUSINESSID_QUERY = "MMGMaeTipoBloquQueryFromToUserPage";
	...
	public MaeTipoBloquLPStartUp(){
		super();
	}

	public void inicio() throws Exception {
		pagina("MaeTipoBloquPage");
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "MaeTipoBloquPage", "cod", "MaeTipoBloqu." + accion + ".label");
			...
			limpiarBotoneraLista("maeTipoBloqu", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codTipoBloq", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 2);");
		...
		//asignarAtributo("CAPA", "maeTipoBloquLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "MaeTipoBloquPage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("MaeTipoBloquLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		MaeTipoBloquData maeTipoBloquQuery= new MaeTipoBloquData();
		maeTipoBloquQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		MaeTipoBloquData datosResult = (MaeTipoBloquData)getSingleObject(BUSINESSID_QUERY, maeTipoBloquQuery, 
			maeTipoBloquQuery.clone(), "maeTipoBloqu");
		...
		preservaHiddensI18n(new Integer(1), "MAE_TIPO_BLOQU", "maeTipoBloquFrm", "Descripcion", true);
		...
		MaeTipoBloquData maeTipoBloqu = datosResult;
		asignar("TEXT", "codTipoBloq", FormatUtils.formatObject(maeTipoBloqu.getCodTipoBloq(), 
		...
		loadLocalizationVars(maeTipoBloqu);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "codTipoBloq", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "MAE_TIPO_BLOQU", "maeTipoBloquFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "codTipoBloq", "req", "S");
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('maeTipoBloquFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "maeTipoBloquFrm", "oculto", "N");
		...
		traza("MMG::Creando MaeTipoBloqu");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		MaeTipoBloquData maeTipoBloquQuery= new MaeTipoBloquData();
		maeTipoBloquQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(maeTipoBloqu.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"maeTipoBloquFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"maeTipoBloquFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codTipoBloq", "ontab","ejecutarAccionFocoModificacion(\"maeTipoBloquFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codTipoBloq", "onshtab","ejecutarAccionFocoModificacion(\"maeTipoBloquFrm\",2, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"maeTipoBloquFrm\",3, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"maeTipoBloquFrm\",3, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","maeTipoBloquTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","maeTipoBloquTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","maeTipoBloquFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","maeTipoBloquListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","maeTipoBloquListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(MaeTipoBloquData maeTipoBloqu) throws Exception{
	...
	* @param maeTipoBloqu La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(MaeTipoBloquData maeTipoBloqu) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		MaeTipoBloquData maeTipoBloqu = 
			(MaeTipoBloquData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(maeTipoBloqu);
		loadLeafDependenceCombos(maeTipoBloqu);
	}
	...
	*/
	...
	protected void loadLocalizationVars(MaeTipoBloquData maeTipoBloqu) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("MAE_TIPO_BLOQU");
		mmgLocalizationQuery.setEntiPk(maeTipoBloqu.getId());
