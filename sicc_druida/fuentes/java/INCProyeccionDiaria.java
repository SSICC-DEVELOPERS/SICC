...
public class INCProyeccionDiaria extends LPSICCBase {
   
    public INCProyeccionDiaria() {
        super();
    }
    ...
    public void ejecucion() throws Exception {		
        ...
        try {
            ...
            if (accion.equals("generar")){
                ...
                cargarPagina();
                getConfiguracionMenu("INCProyeccionDiaria");
            }
    ...
    private void cargarPagina() throws Exception{
        pagina("contenido_informe_proyeccion_diaria_concursos_generar");   
    ...
    private void generarReporte() throws Exception{
        ...
        String campanaAnalisis = conectorParametroLimpia("campanaAnalisis", "", true);
        datos.put(ConstantesREP.CAMPANIASANALISIS, campanaAnalisis);
        
        String unidadesCompradas = conectorParametroLimpia("unidadesCompradas", "", true);
        datos.put(ConstantesREP.UNIDADESCOMPRADA, unidadesCompradas);
        
        String cantidadEstimadaPedidos = conectorParametroLimpia("cantidadEstimadaPedidos", "", true);
        datos.put(ConstantesREP.CANTIDADESTIMADAPEDIDO, cantidadEstimadaPedidos);
        
        
        datos.put(ConstantesREP.TITULO, "Proyeccion diaria de Consumo");
