...
public class contenido_lineas_producto_seleccionar_perf  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_lineas_producto_seleccionar_perf" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","contenido_lineas_producto_seleccionar_perf.js" );
      ...
      ((Element)v.get(6)).setAttribute("valor","LPDefinirCondicionOfertaPerf" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(34)).setAttribute("nombre","mipgndo" );
      ((Element)v.get(34)).setAttribute("ancho","400" );
      ((Element)v.get(34)).setAttribute("sep","$" );
      ((Element)v.get(34)).setAttribute("x","12" );
      ((Element)v.get(34)).setAttribute("class","botonera" );
      ((Element)v.get(34)).setAttribute("y","288" );
      ((Element)v.get(34)).setAttribute("control","|" );
   }

   private void getXML180(Document doc) {
      ((Element)v.get(34)).setAttribute("conector","conector_prototipo_2" );
      ((Element)v.get(34)).setAttribute("rowset","" );
      ((Element)v.get(34)).setAttribute("cargainicial","N" );
      ((Element)v.get(14)).appendChild((Element)v.get(34));

      /* Empieza nodo:35 / Elemento padre: 34   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(35)).setAttribute("nombre","ret1" );
      ((Element)v.get(35)).setAttribute("x","37" );
      ((Element)v.get(35)).setAttribute("y","292" );
      ((Element)v.get(35)).setAttribute("ID","botonContenido" );
      ((Element)v.get(35)).setAttribute("img","retroceder_on" );
      ((Element)v.get(35)).setAttribute("tipo","0" );
      ((Element)v.get(35)).setAttribute("estado","false" );
      ((Element)v.get(35)).setAttribute("alt","" );
      ((Element)v.get(35)).setAttribute("codigo","" );
      ((Element)v.get(35)).setAttribute("accion","mipgndo.retroceder();" );
      ((Element)v.get(34)).appendChild((Element)v.get(35));
      /* Termina nodo:35   */

      /* Empieza nodo:36 / Elemento padre: 34   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(36)).setAttribute("nombre","ava1" );
      ((Element)v.get(36)).setAttribute("x","52" );
      ((Element)v.get(36)).setAttribute("y","292" );
      ((Element)v.get(36)).setAttribute("ID","botonContenido" );
      ((Element)v.get(36)).setAttribute("img","avanzar_on" );
      ...
      ((Element)v.get(36)).setAttribute("accion","mipgndo.avanzar();" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(37)).setAttribute("nombre","primera1" );
      ((Element)v.get(37)).setAttribute("x","20" );
      ((Element)v.get(37)).setAttribute("y","292" );
      ((Element)v.get(37)).setAttribute("ID","botonContenido" );
      ((Element)v.get(37)).setAttribute("img","primera_on" );
      ((Element)v.get(37)).setAttribute("tipo","-2" );
      ((Element)v.get(37)).setAttribute("estado","false" );
      ((Element)v.get(37)).setAttribute("alt","" );
      ((Element)v.get(37)).setAttribute("codigo","" );
      ((Element)v.get(37)).setAttribute("accion","mipgndo.retrocederPrimeraPagina();" );
      ((Element)v.get(5)).appendChild((Element)v.get(37));
      /* Termina nodo:37   */

      /* Empieza nodo:38 / Elemento padre: 5   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(38)).setAttribute("nombre","separa" );
      ((Element)v.get(38)).setAttribute("x","59" );
      ((Element)v.get(38)).setAttribute("y","288" );
      ((Element)v.get(38)).setAttribute("ID","botonContenido" );
      ((Element)v.get(38)).setAttribute("img","separa_base" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(39)).setAttribute("nombre","Aceptar" );
      ((Element)v.get(39)).setAttribute("x","80" );
      ((Element)v.get(39)).setAttribute("y","289" );
      ((Element)v.get(39)).setAttribute("ID","botonContenido" );
      ((Element)v.get(39)).setAttribute("tipo","html" );
      ((Element)v.get(39)).setAttribute("estado","false" );
      ((Element)v.get(39)).setAttribute("cod","12" );
      ((Element)v.get(39)).setAttribute("accion","accionAnadir();" );
      ((Element)v.get(5)).appendChild((Element)v.get(39));
      /* Termina nodo:39   */

      /* Empieza nodo:40 / Elemento padre: 5   */
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(40)).setAttribute("nombre","capaEspacio" );
      ((Element)v.get(40)).setAttribute("alto","12" );
      ((Element)v.get(40)).setAttribute("ancho","50" );
      ...
      ((Element)v.get(40)).setAttribute("y","311" );
