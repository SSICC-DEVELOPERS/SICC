/*
    INDRA/CAR/mmg
    $Id: CarParamGenerCarteLPStartUp.java,v 1.1 2009/12/03 18:40:56 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class CarParamGenerCarteLPStartUp extends MMGDruidaBase{
	...
	public static final String BUSINESSID_QUERY = "MMGCarParamGenerCarteQueryFromToUserPage";
				...
				public static final String BUSINESSID_NIREOIDNIVEREDO_QUERY ="MMGCarNivelRedonQueryFromToUser";
				public static final String NIREOIDNIVEREDO_COMBO_CONNECTOR = "CarNivelRedonConectorCombo";
	
				public static final String BUSINESSID_INIJOIDINDINIVEJERA_QUERY ="MMGCarIndicNivelJerarQueryFromToUser";
				public static final String INIJOIDINDINIVEJERA_COMBO_CONNECTOR = "CarIndicNivelJerarConectorCombo";
	...
	public CarParamGenerCarteLPStartUp(){
		super();
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			buildJsPageSize("CarParamGenerCarte");
			...
			asignarAtributo("PAGINA", "CarParamGenerCartePage", "cod", "CarParamGenerCarte." + accion + ".label");
			...
			limpiarBotoneraLista("carParamGenerCarte", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "numPeriNuev", "validacion", "mensaje = ValidaInt(cdos_trim(valor), 2, 0, 99);");
		asignarAtributo("TEXT", "numPeriAnti", "validacion", "mensaje = ValidaInt(cdos_trim(valor), 2, 0, 99);");
		
		
		//Primero determianmos el nombre del campo en la entidad de oriegen donde se van a cargar los datos
		asignar("VAR", "idAttributeLovOpener", conectorParametro(PARAMETRO_LOV_ATTRIBUTO));
		asignar("VAR", "idEntityLovOpener", conectorParametro(PARAMETRO_LOV_ENTIDAD));
		//asignarAtributo("CAPA", "carParamGenerCarteLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "CarParamGenerCartePage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		CarParamGenerCarteData carParamGenerCarteQuery= new CarParamGenerCarteData();
		carParamGenerCarteQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		CarParamGenerCarteData datosResult = (CarParamGenerCarteData)getSingleObject(BUSINESSID_QUERY, carParamGenerCarteQuery, 
			carParamGenerCarteQuery.clone(), "carParamGenerCarte");
		...
		CarParamGenerCarteData carParamGenerCarte = datosResult;
		es.indra.belcorp.mso.CarNivelRedonData nireOidNiveRedo = carParamGenerCarte.getNireOidNiveRedo();
		if(nireOidNiveRedo != null && nireOidNiveRedo.getId() != null) checkCombo("nireOidNiveRedo" , nireOidNiveRedo.getId().toString());
		asignar("TEXT", "numPeriNuev", FormatUtils.formatObject(carParamGenerCarte.getNumPeriNuev(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "numPeriAnti", FormatUtils.formatObject(carParamGenerCarte.getNumPeriAnti(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		es.indra.belcorp.mso.CarIndicNivelJerarData inijOidIndiNiveJera = carParamGenerCarte.getInijOidIndiNiveJera();
		if(inijOidIndiNiveJera != null && inijOidIndiNiveJera.getId() != null) checkCombo("inijOidIndiNiveJera" , inijOidIndiNiveJera.getId().toString());
		...
		//Deshabilitamos todos los campos para que no se editen
					...
					asignarAtributo("COMBO", "nireOidNiveRedo", "disabled", "S");asignarAtributo("TEXT", "numPeriNuev", "disabled", "S");
		asignarAtributo("TEXT", "numPeriAnti", "disabled", "S");
		
					asignarAtributo("COMBO", "inijOidIndiNiveJera", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		...
		asignarAtributo("COMBO", "nireOidNiveRedo", "req", "S");
		asignarAtributo("TEXT", "numPeriNuev", "req", "S");
		asignarAtributo("TEXT", "numPeriAnti", "req", "S");
		asignarAtributo("COMBO", "inijOidIndiNiveJera", "req", "S");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "carParamGenerCarteFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		CarParamGenerCarteData carParamGenerCarteQuery= new CarParamGenerCarteData();
		carParamGenerCarteQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(carParamGenerCarte.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"carParamGenerCarteFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"carParamGenerCarteFrm\",1, false)");
					asignarAtributo("COMBO","paisOidPais", "ontab", "ejecutarAccionFocoModificacion(\"carParamGenerCarteFrm\",2, true)");
					asignarAtributo("COMBO","paisOidPais", "onshtab", "ejecutarAccionFocoModificacion(\"carParamGenerCarteFrm\",2, false)");
					asignarAtributo("COMBO","nireOidNiveRedo", "ontab", "ejecutarAccionFocoModificacion(\"carParamGenerCarteFrm\",3, true)");
					asignarAtributo("COMBO","nireOidNiveRedo", "onshtab", "ejecutarAccionFocoModificacion(\"carParamGenerCarteFrm\",3, false)");
				asignarAtributo("AREATEXTO", "numPeriNuev", "ontab","ejecutarAccionFocoModificacion(\"carParamGenerCarteFrm\",4, true)");
				asignarAtributo("AREATEXTO", "numPeriNuev", "onshtab","ejecutarAccionFocoModificacion(\"carParamGenerCarteFrm\",4, false)");
				asignarAtributo("AREATEXTO", "numPeriAnti", "ontab","ejecutarAccionFocoModificacion(\"carParamGenerCarteFrm\",5, true)");
				asignarAtributo("AREATEXTO", "numPeriAnti", "onshtab","ejecutarAccionFocoModificacion(\"carParamGenerCarteFrm\",5, false)");
					asignarAtributo("COMBO","inijOidIndiNiveJera", "ontab", "ejecutarAccionFocoModificacion(\"carParamGenerCarteFrm\",6, true)");
					asignarAtributo("COMBO","inijOidIndiNiveJera", "onshtab", "ejecutarAccionFocoModificacion(\"carParamGenerCarteFrm\",6, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","carParamGenerCarteTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","carParamGenerCarteTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es nireOidNiveRedo...");		
				
				traza("MMG: el atributo es numPeriNuev...");		
				
				traza("MMG: el atributo es numPeriAnti...");		
				
				traza("MMG: el atributo es inijOidIndiNiveJera...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","carParamGenerCarteFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","carParamGenerCarteListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","carParamGenerCarteListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(CarParamGenerCarteData carParamGenerCarte) throws Exception{
		...
		if(carParamGenerCarte != null && carParamGenerCarte.getPaisOidPais() != null){
				checkCombo("paisOidPais" , carParamGenerCarte.getPaisOidPais().getId().toString());
			}
		...
		CarNivelRedonData nireOidNiveRedo = new CarNivelRedonData();
		
						asignarComboResultados(BUSINESSID_NIREOIDNIVEREDO_QUERY,NIREOIDNIVEREDO_COMBO_CONNECTOR, 
			nireOidNiveRedo, nireOidNiveRedo.clone(), "carNivelRedon", "nireOidNiveRedo", "result_ROWSET" );
		if(carParamGenerCarte != null && carParamGenerCarte.getNireOidNiveRedo() != null){
				checkCombo("nireOidNiveRedo" , carParamGenerCarte.getNireOidNiveRedo().getId().toString());
			}
		CarIndicNivelJerarData inijOidIndiNiveJera = new CarIndicNivelJerarData();
		
						asignarComboResultados(BUSINESSID_INIJOIDINDINIVEJERA_QUERY,INIJOIDINDINIVEJERA_COMBO_CONNECTOR, 
			inijOidIndiNiveJera, inijOidIndiNiveJera.clone(), "carIndicNivelJerar", "inijOidIndiNiveJera", "result_ROWSET" );
		if(carParamGenerCarte != null && carParamGenerCarte.getInijOidIndiNiveJera() != null){
				checkCombo("inijOidIndiNiveJera" , carParamGenerCarte.getInijOidIndiNiveJera().getId().toString());
			}
	...
	* @param carParamGenerCarte La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(CarParamGenerCarteData carParamGenerCarte) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		CarParamGenerCarteData carParamGenerCarte = 
			(CarParamGenerCarteData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(carParamGenerCarte.getPaisOidPais() != null){
			carParamGenerCarte.setPaisOidPais((es.indra.belcorp.mso.SegPaisViewData)
			getSingleObject(BUSINESSID_PAISOIDPAIS_QUERY, 
			carParamGenerCarte.getPaisOidPais(),
			carParamGenerCarte.getPaisOidPais().clone(),
			"segPaisView"));
		}
		if(carParamGenerCarte.getNireOidNiveRedo() != null){
			carParamGenerCarte.setNireOidNiveRedo((es.indra.belcorp.mso.CarNivelRedonData)
			getSingleObject(BUSINESSID_NIREOIDNIVEREDO_QUERY, 
			carParamGenerCarte.getNireOidNiveRedo(),
			carParamGenerCarte.getNireOidNiveRedo().clone(),
			"carNivelRedon"));
		}
		if(carParamGenerCarte.getInijOidIndiNiveJera() != null){
			carParamGenerCarte.setInijOidIndiNiveJera((es.indra.belcorp.mso.CarIndicNivelJerarData)
			getSingleObject(BUSINESSID_INIJOIDINDINIVEJERA_QUERY, 
			carParamGenerCarte.getInijOidIndiNiveJera(),
			carParamGenerCarte.getInijOidIndiNiveJera().clone(),
			"carIndicNivelJerar"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(carParamGenerCarte);
		loadLeafDependenceCombos(carParamGenerCarte);
	}
