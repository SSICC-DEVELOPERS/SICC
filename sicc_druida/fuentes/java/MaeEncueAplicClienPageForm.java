...
public class MaeEncueAplicClienPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","MaeEncueAplicClien.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","MaeEncueAplicClien.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('maeEncueAplicClienFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('maeEncueAplicClienFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(54)).setAttribute("cod","MaeEncueAplicClien.clieOidClie.label" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('maeEncueAplicClienFrm',2, true);" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('maeEncueAplicClienFrm',2, false);" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(61)).setAttribute("nombre","reenOidResp_prenOidPregTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(65)).setAttribute("nombre","lblreenOidResp_prenOidPreg" );
      ((Element)v.get(65)).setAttribute("id","datosTitle" );
      ((Element)v.get(65)).setAttribute("ancho","150" );
      ((Element)v.get(65)).setAttribute("alto","13" );
      ((Element)v.get(65)).setAttribute("cod","MaeRespuEncue.prenOidPreg.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(66)).setAttribute("nombre","reenOidResp_prenOidPregWidgetTrId" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(68)).setAttribute("nombre","reenOidResp_prenOidPreg" );
      ...
      ((Element)v.get(68)).setAttribute("onchange","mmgDependeneChange('reenOidResp_prenOidPreg', 'reenOidResp' , 'maeEncueAplicClien')" );
      ...
      ((Element)v.get(68)).setAttribute("ontab","focaliza('maeEncueAplicClienFrm.reenOidResp');" );
      ((Element)v.get(68)).setAttribute("onshtab","ejecutarAccionFoco('maeEncueAplicClienFrm',4, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(70)).setAttribute("nombre","reenOidResp_prenOidPregGapTdId" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(72)).setAttribute("nombre","reenOidRespTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(76)).setAttribute("nombre","lblreenOidResp" );
      ((Element)v.get(76)).setAttribute("id","datosTitle" );
      ((Element)v.get(76)).setAttribute("ancho","150" );
      ((Element)v.get(76)).setAttribute("alto","13" );
      ((Element)v.get(76)).setAttribute("cod","MaeEncueAplicClien.reenOidResp.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(77)).setAttribute("nombre","reenOidRespWidgetTrId" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(79)).setAttribute("nombre","reenOidResp" );
      ...
      ((Element)v.get(79)).setAttribute("ontab","ejecutarAccionFoco('maeEncueAplicClienFrm',4, true);" );
      ((Element)v.get(79)).setAttribute("onshtab","focaliza('maeEncueAplicClienFrm.reenOidResp_prenOidPreg');" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(81)).setAttribute("nombre","reenOidRespGapTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(95)).setAttribute("nombre","maeEncueAplicClienTrButtons" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(102)).setAttribute("nombre","maeEncueAplicClienTdQueryButton" );
      ((Element)v.get(101)).appendChild((Element)v.get(102));

      /* Empieza nodo:103 / Elemento padre: 102   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(103)).setAttribute("nombre","maeEncueAplicClienQueryButton" );
      ((Element)v.get(103)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(103)).setAttribute("estado","false" );
      ((Element)v.get(103)).setAttribute("accion","maeEncueAplicClienFirstPage();" );
      ...
      ((Element)v.get(104)).setAttribute("nombre","maeEncueAplicClienTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(106)).setAttribute("nombre","maeEncueAplicClienLovNullButton" );
      ((Element)v.get(106)).setAttribute("ID","botonContenido" );
      ((Element)v.get(106)).setAttribute("tipo","html" );
      ((Element)v.get(106)).setAttribute("accion","maeEncueAplicClienLovNullSelectionAction();" );
