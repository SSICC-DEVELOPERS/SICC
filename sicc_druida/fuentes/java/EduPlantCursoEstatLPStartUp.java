/*
    INDRA/CAR/mmg
    $Id: EduPlantCursoEstatLPStartUp.java,v 1.1 2009/12/03 18:32:26 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class EduPlantCursoEstatLPStartUp extends MMGDruidaBase{
	//Constantes que definen la altura de los formularios según el modo
	public static final short QUERYFORM_SIZE = 153;
	public static final short CREATEFORM_SIZE = 153;
	public static final short UPDATEFORM_SIZE = 153;
	public static final short VIEWFORM_SIZE = 153;
	...
	public static final String BUSINESSID_DPCUOIDDETAPLANCURS_QUERY ="MMGEduPlantCursoDetalQueryFromToUser";public static final String DPCUOIDDETAPLANCURS_COMBO_CONNECTOR = "EduPlantCursoDetalConectorCombo";
	...
	public EduPlantCursoEstatLPStartUp(){
		super();
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			buildJsPageSize("EduPlantCursoEstat");
			...
			asignarAtributo("PAGINA", "EduPlantCursoEstatPage", "cod", "EduPlantCursoEstat." + accion + ".label");
			...
			limpiarBotoneraLista("eduPlantCursoEstat", accion);
	...
	protected void cmdLov() throws Exception{
		...
		//asignarAtributo("CAPA", "eduPlantCursoEstatLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "EduPlantCursoEstatPage", "onblur", "window.focus();");
	...
	protected void cmdView() throws Exception{
		...
		EduPlantCursoEstatData eduPlantCursoEstatQuery= new EduPlantCursoEstatData();
		eduPlantCursoEstatQuery.setId(new Integer(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		EduPlantCursoEstatData datosResult = (EduPlantCursoEstatData)getSingleObject(BUSINESSID_QUERY, eduPlantCursoEstatQuery, 
			eduPlantCursoEstatQuery.clone(), "eduPlantCursoEstat");
		...
		EduPlantCursoEstatData eduPlantCursoEstat = datosResult;
	...
	protected void cmdCreate() throws Exception{
		...
		asignarAtributo("COMBO", "dpcuOidDetaPlanCurs", "req", "S");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "eduPlantCursoEstatFrm", "oculto", "N");
		...
		EduPlantCursoEstatData eduPlantCursoEstatQuery= new EduPlantCursoEstatData();
		eduPlantCursoEstatQuery.setId(new Integer(id));
		...
		es.indra.belcorp.mso.EduMatriCursoData mcurOidCurs = eduPlantCursoEstat.getMcurOidCurs();
		if(mcurOidCurs != null && mcurOidCurs.getId() != null) checkCombo("mcurOidCurs" , mcurOidCurs.getId().toString());
	
		es.indra.belcorp.mso.EduPlantCursoDetalData dpcuOidDetaPlanCurs = eduPlantCursoEstat.getDpcuOidDetaPlanCurs();
		if(dpcuOidDetaPlanCurs != null && dpcuOidDetaPlanCurs.getId() != null) checkCombo("dpcuOidDetaPlanCurs" , dpcuOidDetaPlanCurs.getId().toString());
		...
		//asignar("VAR","timestamp",Long.toString(eduPlantCursoEstat.jdoGetTimeStamp()));
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","eduPlantCursoEstatTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","eduPlantCursoEstatTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","eduPlantCursoEstatFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","eduPlantCursoEstatPreListLayer", "y", String.valueOf(sizeForm + 24));
		asignarAtributo("CAPA","eduPlantCursoEstatListLayer", "y", String.valueOf(sizeForm + 46));		
		asignarAtributo("CAPA","eduPlantCursoEstatListButtonsLayer", "y", String.valueOf(sizeForm + 299));		
	}
	...
	*/
	protected void loadLeafDependenceCombos() throws Exception{
		...
		asignarComboResultados(BUSINESSID_DPCUOIDDETAPLANCURS_QUERY,DPCUOIDDETAPLANCURS_COMBO_CONNECTOR, new EduPlantCursoDetalData(), new EduPlantCursoDetalData(), "eduPlantCursoDetal", "dpcuOidDetaPlanCurs", "result_ROWSET" );
	...
	* @param eduPlantCursoEstat La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(EduPlantCursoEstatData eduPlantCursoEstat) 
		throws Exception{
		if(eduPlantCursoEstat.getMcurOidCurs() != null){
			checkCombo("mcurOidCurs" , eduPlantCursoEstat.getMcurOidCurs().getId().toString());
			}
		if(eduPlantCursoEstat.getDpcuOidDetaPlanCurs() != null){
			checkCombo("dpcuOidDetaPlanCurs" , eduPlantCursoEstat.getDpcuOidDetaPlanCurs().getId().toString());
			}
	...
	*/
	protected void setDependenceComboLabels(EduPlantCursoEstatData eduPlantCursoEstat) 
		throws Exception{
		asignarAtributo("LABELC", "lblViewMcurOidCurs", "valor",FormatUtils.formatObject(eduPlantCursoEstat.getMcurOidCurs()));
		asignarAtributo("LABELC", "lblViewDpcuOidDetaPlanCurs", "valor",FormatUtils.formatObject(eduPlantCursoEstat.getDpcuOidDetaPlanCurs()));
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		EduPlantCursoEstatData eduPlantCursoEstat = 
			(EduPlantCursoEstatData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(eduPlantCursoEstat.getMcurOidCurs() != null){
			eduPlantCursoEstat.setMcurOidCurs((es.indra.belcorp.mso.EduMatriCursoData)
			getSingleObject(BUSINESSID_MCUROIDCURS_QUERY, 
			eduPlantCursoEstat.getMcurOidCurs(),
			eduPlantCursoEstat.getMcurOidCurs().clone(),
			"eduMatriCurso"));
		}
		if(eduPlantCursoEstat.getDpcuOidDetaPlanCurs() != null){
			eduPlantCursoEstat.setDpcuOidDetaPlanCurs((es.indra.belcorp.mso.EduPlantCursoDetalData)
			getSingleObject(BUSINESSID_DPCUOIDDETAPLANCURS_QUERY, 
			eduPlantCursoEstat.getDpcuOidDetaPlanCurs(),
			eduPlantCursoEstat.getDpcuOidDetaPlanCurs().clone(),
			"eduPlantCursoDetal"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(eduPlantCursoEstat);
	}
	...
	*/
	protected void removeViewLabels() throws Exception{
		...
		borrarNodo("TR", "nombre", "dpcuOidDetaPlanCursViewLabelTrId");
	...
	*/
	protected void removeWidgets() throws Exception{
		...
		borrarNodo("TR", "nombre", "dpcuOidDetaPlanCursWidgetTrId");
