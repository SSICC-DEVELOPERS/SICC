...
public class GenPrincipalsPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","GenPrincipals.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","GenPrincipals.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('genPrincipalsFrm',0, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('genPrincipalsFrm', 0, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(50)).setAttribute("nombre","nameTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lblName" );
      ((Element)v.get(54)).setAttribute("alto","13" );
      ((Element)v.get(54)).setAttribute("filas","1" );
      ((Element)v.get(54)).setAttribute("id","datosTitle" );
      ((Element)v.get(54)).setAttribute("cod","GenPrincipals.name.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(55)).setAttribute("nombre","nameWidgetTrId" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('genPrincipalsFrm',0, true)" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('genPrincipalsFrm', 0, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(58)).setAttribute("nombre","nameGapTdId" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(75)).setAttribute("nombre","typeTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(80)).setAttribute("nombre","typeWidgetTrId" );
   }
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(82)).setAttribute("nombre","type" );
      ...
      ((Element)v.get(82)).setAttribute("ontab","ejecutarAccionFoco('genPrincipalsFrm',0, true)" );
      ((Element)v.get(82)).setAttribute("onshtab","ejecutarAccionFoco('genPrincipalsFrm', 0, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(83)).setAttribute("nombre","typeGapTdId" );
   ...
   private void getXML450(Document doc) {
      ((Element)v.get(100)).setAttribute("nombre","descriptionTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(105)).setAttribute("nombre","descriptionWidgetTrId" );
      ...
      ((Element)v.get(107)).setAttribute("ontab","ejecutarAccionFoco('genPrincipalsFrm',0, true)" );
      ((Element)v.get(107)).setAttribute("onshtab","ejecutarAccionFoco('genPrincipalsFrm', 0, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(108)).setAttribute("nombre","descriptionGapTdId" );
   ...
   private void getXML540(Document doc) {
      ...
      /* Empieza nodo:122 / Elemento padre: 0   */
      v.add(doc.createElement("TR"));
      ((Element)v.get(122)).setAttribute("nombre","genPrincipalsTrButtons" );
      ((Element)v.get(0)).appendChild((Element)v.get(122));
      ...
      ((Element)v.get(129)).setAttribute("nombre","genPrincipalsTdQueryButton" );
      ((Element)v.get(128)).appendChild((Element)v.get(129));

      /* Empieza nodo:130 / Elemento padre: 129   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(130)).setAttribute("nombre","genPrincipalsQueryButton" );
      ((Element)v.get(130)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(130)).setAttribute("estado","false" );
      ((Element)v.get(130)).setAttribute("accion","genPrincipalsFirstPage();" );
      ...
      ((Element)v.get(131)).setAttribute("nombre","genPrincipalsTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(133)).setAttribute("nombre","genPrincipalsLovNullButton" );
      ((Element)v.get(133)).setAttribute("ID","botonContenido" );
      ((Element)v.get(133)).setAttribute("tipo","html" );
      ((Element)v.get(133)).setAttribute("accion","genPrincipalsLovNullSelectionAction();" );
      ((Element)v.get(133)).setAttribute("estado","true" );
      ((Element)v.get(133)).setAttribute("cod","MMGGlobal.lovNullButton.label" );
