...
public class FacAsignImprePageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","facAsignImpreList" );
      ...
      ((Element)v.get(14)).setAttribute("cod","FacAsignImpre.imviOidImpr.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","FacAsignImpre.sbacOidSbac.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","FacAsignImpre.forsOidForm.label" );
