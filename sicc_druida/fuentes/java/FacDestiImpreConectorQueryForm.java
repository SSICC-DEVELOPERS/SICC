...
public class FacDestiImpreConectorQueryForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad FacDestiImpre" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGFacDestiImpreQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGFacDestiImpreQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","FacDestiImpreFormFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","desDest" );
