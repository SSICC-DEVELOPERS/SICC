...
public class COMResumenesComisionesPeriodos extends LPSICCBase {           
   public COMResumenesComisionesPeriodos() {	 
     super();
  }
     ...
     try {
        ...
        if (accion.equals("generar")){
          ...
          //cargarPagina();
           ...
           cargarPagina();
           getConfiguracionMenu("COMResumenesComisionesPeriodos");
        }
  ...
  private void cargarPagina() throws Exception{
     pagina("contenido_informe_resumen_comisiones_generar");   
  ...
  private void generarReporte() throws Exception{
     ...
     String tipoComision = conectorParametroLimpia("tipoComision", "", true);
     datos.put(ConstantesREP.TIPOCOMISION, tipoComision);
     
     String comision = conectorParametroLimpia("comision", "", true);
     datos.put(ConstantesREP.COMISION, comision);
     
     //String comisionDesc = conectorParametroLimpia("comisionDesc", "", true);
     //datos.put(ConstantesREP.COMISIONDESC, comisionDesc);
     ...
     datos.put(ConstantesREP.TITULO, "Resumen de comisiones por periodo");
     ...
     if(nivelReporte.equals("1")){
        reporte = "RD_REP-149";
     }else{
        reporte = "RD_REP-149_01";
     }
