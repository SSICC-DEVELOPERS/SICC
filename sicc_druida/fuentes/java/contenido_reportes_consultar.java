...
public class contenido_reportes_consultar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_reportes_consultar" );
      ((Element)v.get(0)).setAttribute("cod","0943" );
      ((Element)v.get(0)).setAttribute("titulo","Consultar Reportes" );
      ...
      v.add(doc.createTextNode("\r    \r       \r  function onLoadPag()   {\r  \r     ocultarLista();\r     DrdEnsanchaConMargenDcho('listado1',12);\r     eval (ON_RSZ);  \r     configurarMenuSecundario('Formulario');\r     fMostrarMensajeError();\r     focaliza('Formulario.txtFechaDesde');\r }\r\r\r   function ocultarLista() {\r        document.all[\"Cplistado1\"].style.visibility='hidden'; \r        document.all[\"CpLin1listado1\"].style.visibility='hidden';\r        document.all[\"CpLin2listado1\"].style.visibility='hidden' ;\r        document.all[\"CpLin3listado1\"].style.visibility='hidden' ;\r        document.all[\"CpLin4listado1\"].style.visibility='hidden';\r        document.all[\"primera1Div\"].style.visibility='hidden'; \r        document.all[\"ret1Div\"].style.visibility='hidden'; \r        document.all[\"ava1Div\"].style.visibility='hidden';   \r        document.all[\"separaDiv\"].style.visibility='hidden';\r        document.all[\"btnVisualizarDiv\"].style.visibility='hidden';\r        \r    }\r         \r    \r    function mostrarLista() {\r       document.all[\"Cplistado1\"].style.visibility='visible';\r       document.all[\"CpLin1listado1\"].style.visibility='visible';\r       document.all[\"CpLin2listado1\"].style.visibility='visible';\r       document.all[\"CpLin3listado1\"].style.visibility='visible';\r       document.all[\"CpLin4listado1\"].style.visibility='visible';\r       document.all[\"primera1Div\"].style.visibility='visible';\r       document.all[\"ret1Div\"].style.visibility='visible';\r       document.all[\"ava1Div\"].style.visibility='visible';\r       document.all[\"separaDiv\"].style.visibility='visible';\r       document.all[\"btnVisualizarDiv\"].style.visibility='visible';\r   }\r\r  function buscar(){\r  \r     if(validarFechas()){\r        var fechaDesde = get('Formulario.txtFechaDesde');\r        var fechaHasta = get('Formulario.txtFechaHasta');\r        var idioma     = get('Formulario.idioma');\r        var modulo     = get('Formulario.cbModulo');\r  	    var moduloFinal = ''; \r\r		if(modulo != ''){\r           moduloFinal = obtenerModulo(modulo);\r		}\r\r\r        var arrayDatos = new Array();\r\r\r        \r        arrayDatos[arrayDatos.length] = ['codModulo', moduloFinal];\r        arrayDatos[arrayDatos.length] = ['fechaDesde', fechaDesde];\r        arrayDatos[arrayDatos.length] = ['fechaHasta', fechaHasta];\r        arrayDatos[arrayDatos.length] = ['oidIdioma', idioma];\r        \r        \r        configurarPaginado( mipgndo, \"REPBusquedaReportes\", \"ConectorBusquedaReportes\", \"es.indra.sicc.rep.dtos.DTOCriteriosReportes\", arrayDatos);\r     }\r      \r   }\r\r   function obtenerModulo(modulo){\r      var moduloFinal;\r      \r	  if(modulo == '19'){ \r	     moduloFinal = 'CAR';\r	  }      \r	  \r	  if(modulo == '25'){ \r	     moduloFinal = 'APE';\r	  }\r	  \r	  if(modulo == '3'){ \r	     moduloFinal = 'BEL';\r	  }\r	  \r	  if(modulo == '21'){ \r	     moduloFinal = 'CAL';\r	  }\r\r	  if(modulo == '17'){ \r	     moduloFinal = 'COB';\r	  }\r\r	  if(modulo == '11'){ \r	     moduloFinal = 'COM';\r	  }\r	  \r	  if(modulo == '18'){ \r	     moduloFinal = 'CRA';\r	  }\r	  \r	  if(modulo == '23'){\r	     moduloFinal = 'CCC';\r	  }\r	  \r	  if(modulo == '7'){\r	     moduloFinal = 'DTO';\r	  }\r	  \r	  if(modulo == '10'){\r	     moduloFinal = 'EDU';\r	  }\r\r	  if(modulo == '22'){\r	     moduloFinal = 'FAC';\r	  }\r\r	  if(modulo == '14'){\r	     moduloFinal = 'GEN';\r	  }\r\r	  if(modulo == '13'){\r	     moduloFinal = 'INC';\r	  }\r\r	  if(modulo == '28'){\r	     moduloFinal = 'INT-OCM';\r	  }\r\r	  if(modulo == '27'){\r	     moduloFinal = 'INT-OCR';\r	  }\r\r	  if(modulo == '2'){\r	     moduloFinal = 'INT';\r	  }\r\r	  if(modulo == '16'){\r	     moduloFinal = 'MAE';\r	  }\r\r	  if(modulo == '9'){\r	     moduloFinal = 'MAV';\r	  }\r\r	  if(modulo == '5'){\r	     moduloFinal = 'PRE';\r	  }\r\r	  if(modulo == '6'){\r	     moduloFinal = 'MSG';\r	  }\r\r	  if(modulo == '8'){\r	     moduloFinal = 'MEN';\r	  }\r\r	  if(modulo == '26'){\r	     moduloFinal = 'NDG';\r	  }\r\r	  if(modulo == '1'){\r	     moduloFinal = 'PED';\r	  }\r\r	  if(modulo == '15'){\r	     moduloFinal = 'REC';\r	  }\r\r	  if(modulo == '4'){\r	     moduloFinal = 'REP';\r	  }\r\r	  if(modulo == '12'){\r	     moduloFinal = 'SEG';\r	  }\r\r	  if(modulo == '24'){\r	     moduloFinal = 'ZON';\r	  }\r\r\r	  \r	  return moduloFinal;\r   \r   \r   }\r\r\r  function validarFechas(){\r      var fechaDesde = get('Formulario.txtFechaDesde');\r      var fechaHasta = get('Formulario.txtFechaHasta');\r      var formatoFecha = get('Formulario.hFormatoFechaPais');\r            \r      if(fechaDesde != ''){\r        if (! EsFechaValida_SICC(fechaDesde , \"Formulario\")){\r            GestionarMensaje(\"1006\", formatoFecha, null, null);\r            focaliza(\"Formulario.txtFechaDesde\");\r            return false;\r        }\r      }\r      \r      if(fechaHasta != ''){\r        if(! EsFechaValida_SICC(fechaHasta , \"Formulario\")){\r            GestionarMensaje(\"1006\", formatoFecha, null, null);\r            focaliza(\"Formulario.txtFechaHasta\");\r            return false;\r        }\r      }\r      \r      if(fechaDesde != '' && fechaHasta != ''){           \r        var errorLevel = EsFechaValida( fechaDesde, fechaHasta, \"Formulario\", \"S\");\r        if ( errorLevel == 3){\r            GestionarMensaje(\"1191\");\r            focaliza('Formulario.txtFechaDesde');\r            return false;\r        }\r      }\r     \r      return true;   \r   \r   }\r\r\r   function fLimpiar(){\r      focaliza('Formulario.txtFechaDesde');\r   }\r   \r\r   \r\r    function prueba(ultima, rowset, error){\r       var tamano = rowset.length;\r    \r       if (tamano > 0) {\r          mostrarLista();\r          return true;\r       }else{\r          ocultarLista(); \r          cdos_mostrarAlert(error);\r          return false;\r     }\r  } \r\r  function visualizar(){\r       var codigos = new Array();\r       codigos = listado1.codSeleccionados();\r       var cant = codigos.length;\r         \r       if (cant == 1)  {\r          var posicion = obtenerPosicionListaEditable(listado1.codSeleccionados(),listado1);\r          \r          if (listado1.datos[posicion][5] != 'FINALIZADO') {     \r	    GestionarMensaje('50010',null,null,null);\r	  } else {\r            set('Formulario.conectorAction', 'REPGenBusquedaReportes');           \r            set('Formulario.accion', 'verReporte');\r                        set(\"Formulario.oidReporte\", listado1.datos[posicion][1]);\r            eval('Formulario').oculto = 'S';   \r	    \r	    set('Formulario.extension', listado1.datos[posicion][6]);\r\r            enviaSICC('Formulario');     \r	  }\r       } else { \r         if (cant > 1) {\r           GestionarMensaje('8',null,null,null);\r	 }else{\r           GestionarMensaje('4',null,null,null); \r	 }  \r       }\r      \r   }\r\r  function arrayComponentes(){\r\r    var arr = new Array();               \r    arr[arr.length]= new Array(\"txtFechaDesde\",\"\");\r    arr[arr.length]= new Array(\"txtFechaHasta\",\"\");    \r    arr[arr.length]= new Array(\"cbModulo\",\"\");\r    arr[arr.length]= new Array(\"btnBuscar\",\"BOTON\");\r    arr[arr.length]= new Array(\"btnVisualizar\",\"BOTON\");\r\r    return arr;\r  }\r\r  function tabGenerico(nombreComp, tipotab){       \r    var arr = arrayComponentes();\r    var tabular = false;\r    var nombreFormulario = getFormularioSICC();\r    var j = 0;\r    var k = arr.length;\r    if (tipotab != \"sh\") {\r	j = j-1;                \r	k = k-1;\r    }\r\r    while(j<k){\r	var t;\r	if(tipotab == \"sh\"){\r	  k--;\r	  t = k;\r	} else{\r	  j++;\r	  t = j;                  \r	}\r	  \r	var nombre = arr[t][0];\r	var tipo = arr[t][1];\r	if (tabular==false){\r	  if (nombreComp==nombre){\r	      tabular=true;\r	      if (tipotab == \"sh\"){\r		if (k==0) k= arr.length;\r	      } else {\r		if ((j+1)==arr.length)  j = -1;\r	      }\r	  }                \r	} else {\r	  try {\r	    var name = nombreFormulario+\".\"+nombre;\r	    if (tipo==\"BOTONXY\"){\r	       focalizaBotonHTML_XY(nombre);\r	    } else if (tipo==\"BOTON\") {\r               if (nombre=='btnVisualizar') {\r                 if ( document.all[\"Cplistado1\"].style.visibility=='visible' ) {\r		   focalizaBotonHTML(\"botonContenido\",nombre);\r		 }else{\r                   if (tipotab == \"sh\"){\r		     focaliza('Formulario.btnBuscar');\r		   }else{\r                     focaliza('Formulario.txtFechaDesde');\r		   }\r		 }\r               }else{ \r	         focalizaBotonHTML(\"botonContenido\",nombre);\r               } \r	    } else {\r	       focaliza(name);\r	    }\r	    return;\r	  } catch (e) {\r	  }\r	}\r    }\r  } \r   \r  \r \r"));
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(14)).setAttribute("nombre","oidReporte" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(15)).setAttribute("nombre","extension" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(34)).setAttribute("width","600" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(42)).setAttribute("nombre","lblFechaDesde" );
      ...
      ((Element)v.get(42)).setAttribute("cod","59" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(46)).setAttribute("nombre","lblFechaHasta" );
      ...
      ((Element)v.get(46)).setAttribute("cod","1339" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(50)).setAttribute("nombre","lblModulo" );
      ...
      ((Element)v.get(50)).setAttribute("cod","1257" );
      ...
      ((Element)v.get(57)).setAttribute("nombre","txtFechaDesde" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","tabGenerico('txtFechaDesde');" );
      ((Element)v.get(57)).setAttribute("onshtab","tabGenerico('txtFechaDesde','sh');" );
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(61)).setAttribute("nombre","txtFechaHasta" );
      ...
      ((Element)v.get(61)).setAttribute("size","12" );
      ((Element)v.get(61)).setAttribute("valor","" );
      ((Element)v.get(61)).setAttribute("validacion","" );
      ((Element)v.get(61)).setAttribute("ontab","tabGenerico('txtFechaHasta');" );
      ((Element)v.get(61)).setAttribute("onshtab","tabGenerico('txtFechaHasta','sh');" );
      ...
      ((Element)v.get(65)).setAttribute("nombre","cbModulo" );
   ...
   private void getXML270(Document doc) {
      ((Element)v.get(65)).setAttribute("ontab","tabGenerico('cbModulo');" );
      ((Element)v.get(65)).setAttribute("onshtab","tabGenerico('cbModulo','sh');" );
      ...
      /* Empieza nodo:72 / Elemento padre: 24   */
      v.add(doc.createElement("td"));
      ((Element)v.get(24)).appendChild((Element)v.get(72));
      ...
      /* Empieza nodo:74 / Elemento padre: 16   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(16)).appendChild((Element)v.get(74));
      ...
      ((Element)v.get(82)).setAttribute("ontab","tabGenerico('btnBuscar');" );
      ((Element)v.get(82)).setAttribute("onshtab","tabGenerico('btnBuscar','sh');" );
      ...
      /* Empieza nodo:85 / Elemento padre: 16   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(16)).appendChild((Element)v.get(85));
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(92)).setAttribute("ancho","510" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(105)).setAttribute("ancho","80" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(110)).setAttribute("cod","689" );
      ...
      ((Element)v.get(111)).setAttribute("cod","188" );
      ...
      ((Element)v.get(112)).setAttribute("cod","9" );
      ...
      ((Element)v.get(113)).setAttribute("cod","1257" );
      ...
      ((Element)v.get(114)).setAttribute("cod","596" );
      ...
      ((Element)v.get(115)).setAttribute("cod","755" );
      ...
      /* Empieza nodo:124 / Elemento padre: 92   */
      v.add(doc.createElement("PAGINADO"));
      ((Element)v.get(124)).setAttribute("nombre","mipgndo" );
      ((Element)v.get(124)).setAttribute("ancho","510" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(124)).setAttribute("onload","procesarPaginado(mipgndo,msgError, ultima, rowset, 'prueba(ultima, rowset)')" );
      ((Element)v.get(92)).appendChild((Element)v.get(124));

      /* Empieza nodo:125 / Elemento padre: 124   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(125)).setAttribute("nombre","ret1" );
      ((Element)v.get(125)).setAttribute("x","37" );
      ((Element)v.get(125)).setAttribute("y","422" );
      ...
      ((Element)v.get(126)).setAttribute("y","422" );
      ...
      ((Element)v.get(127)).setAttribute("y","422" );
      ...
      ((Element)v.get(128)).setAttribute("y","418" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(129)).setAttribute("nombre","btnVisualizar" );
      ((Element)v.get(129)).setAttribute("x","80" );
      ((Element)v.get(129)).setAttribute("y","419" );
      ...
      ((Element)v.get(129)).setAttribute("cod","1473" );
      ((Element)v.get(129)).setAttribute("accion","visualizar();" );
      ((Element)v.get(129)).setAttribute("ontab","tabGenerico('btnVisualizar');" );
      ((Element)v.get(129)).setAttribute("onshtab","tabGenerico('btnVisualizar','sh');" );
      ...
      ((Element)v.get(130)).setAttribute("y","441" );
