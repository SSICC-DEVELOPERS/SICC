...
public class MaeSuperGenerConectorQueryForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad MaeSuperGener" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGMaeSuperGenerQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGMaeSuperGenerQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","MaeSuperGenerFormFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(8)).setAttribute("NOMBRE","codSupeGene" );
