...
public class RecResulChequPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","RecResulChequ.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","RecResulChequ.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('recResulChequFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('recResulChequFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(54)).setAttribute("cod","RecResulChequ.paisOidPais.label" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('recResulChequFrm',2, true);" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('recResulChequFrm',2, false);" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(61)).setAttribute("nombre","codResuCheqTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(66)).setAttribute("nombre","codResuCheqWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(68)).setAttribute("nombre","codResuCheq" );
      ...
      ((Element)v.get(68)).setAttribute("ontab","ejecutarAccionFoco('recResulChequFrm',3, true)" );
      ((Element)v.get(68)).setAttribute("onshtab","ejecutarAccionFoco('recResulChequFrm', 3, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(69)).setAttribute("nombre","codResuCheqGapTdId" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(80)).setAttribute("nombre","formTr2" );
      ...
      ((Element)v.get(90)).setAttribute("cod","RecResulChequ.Descripcion.label" );
      ...
      ((Element)v.get(94)).setAttribute("ontab","ejecutarAccionFoco('recResulChequFrm',4, true)" );
      ((Element)v.get(94)).setAttribute("onshtab","ejecutarAccionFoco('recResulChequFrm', 4, false)" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(98)).setAttribute("href","javascript:openLocalizationDialog('recResulChequFrm', 'Descripcion', 1);" );
      ((Element)v.get(98)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"recResulChequFrm\",4, true)', 'ejecutarAccionFoco(\"recResulChequFrm\",4, false)')" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(102)).setAttribute("nombre","indResuTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(106)).setAttribute("nombre","lblIndResu" );
      ...
      ((Element)v.get(106)).setAttribute("cod","RecResulChequ.indResu.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(107)).setAttribute("nombre","indResuWidgetTrId" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(109)).setAttribute("nombre","indResu" );
      ...
      ((Element)v.get(109)).setAttribute("ontab","ejecutarAccionFoco('recResulChequFrm',5, true)" );
      ((Element)v.get(109)).setAttribute("onshtab","ejecutarAccionFoco('recResulChequFrm',5, false)" );
      ...
      ((Element)v.get(111)).setAttribute("ID","1" );
      ...
      ((Element)v.get(112)).setAttribute("VALOR","1" );
      ...
      ((Element)v.get(113)).setAttribute("VALOR","Si" );
      ...
      v.add(doc.createElement("ROW"));
      ((Element)v.get(114)).setAttribute("ID","0" );
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(115)).setAttribute("VALOR","0" );
      ...
      ((Element)v.get(116)).setAttribute("VALOR","No" );
      ...
      /* Empieza nodo:117 / Elemento padre: 85   */
      v.add(doc.createElement("TD"));
      ((Element)v.get(117)).setAttribute("nombre","indResuGapTdId" );
      ((Element)v.get(117)).setAttribute("nowrap","true" );
      ((Element)v.get(117)).setAttribute("class","datosCampos" );
      ((Element)v.get(85)).appendChild((Element)v.get(117));
      ...
      /* Empieza nodo:121 / Elemento padre: 80   */
      v.add(doc.createElement("TD"));
      ((Element)v.get(121)).setAttribute("width","100%" );
      ((Element)v.get(80)).appendChild((Element)v.get(121));
      /* Termina nodo:121   */
      /* Termina nodo:80   */
      ...
      /* Empieza nodo:131 / Elemento padre: 0   */
      v.add(doc.createElement("TR"));
      ((Element)v.get(131)).setAttribute("nombre","recResulChequTrButtons" );
      ((Element)v.get(0)).appendChild((Element)v.get(131));
   ...
   private void getXML630(Document doc) {
      ...
      ((Element)v.get(138)).setAttribute("nombre","recResulChequTdQueryButton" );
      ((Element)v.get(137)).appendChild((Element)v.get(138));

      /* Empieza nodo:139 / Elemento padre: 138   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(139)).setAttribute("nombre","recResulChequQueryButton" );
      ((Element)v.get(139)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(139)).setAttribute("estado","false" );
      ((Element)v.get(139)).setAttribute("accion","recResulChequFirstPage();" );
      ...
      ((Element)v.get(140)).setAttribute("nombre","recResulChequTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(142)).setAttribute("nombre","recResulChequLovNullButton" );
      ((Element)v.get(142)).setAttribute("ID","botonContenido" );
      ((Element)v.get(142)).setAttribute("tipo","html" );
      ((Element)v.get(142)).setAttribute("accion","recResulChequLovNullSelectionAction();" );
