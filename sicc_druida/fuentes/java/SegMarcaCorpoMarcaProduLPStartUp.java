/*
    INDRA/CAR/mmg
    $Id: SegMarcaCorpoMarcaProduLPStartUp.java,v 1.1 2009/12/03 18:35:46 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class SegMarcaCorpoMarcaProduLPStartUp extends MMGDruidaBase{
	...
	public SegMarcaCorpoMarcaProduLPStartUp(){
		super();
	}

	public void inicio() throws Exception {
		pagina("SegMarcaCorpoMarcaProduPage");
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			buildJsPageSize("SegMarcaCorpoMarcaProdu");
			...
			asignarAtributo("PAGINA", "SegMarcaCorpoMarcaProduPage", "cod", "SegMarcaCorpoMarcaProdu." + accion + ".label");
			...
			limpiarBotoneraLista("segMarcaCorpoMarcaProdu", accion);
	...
	protected void cmdLov() throws Exception{
		...
		//asignarAtributo("CAPA", "segMarcaCorpoMarcaProduLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "SegMarcaCorpoMarcaProduPage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("SegMarcaCorpoMarcaProduLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		SegMarcaCorpoMarcaProduData segMarcaCorpoMarcaProduQuery= new SegMarcaCorpoMarcaProduData();
		segMarcaCorpoMarcaProduQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		SegMarcaCorpoMarcaProduData datosResult = (SegMarcaCorpoMarcaProduData)getSingleObject(BUSINESSID_QUERY, segMarcaCorpoMarcaProduQuery, 
			segMarcaCorpoMarcaProduQuery.clone(), "segMarcaCorpoMarcaProdu");
		...
		SegMarcaCorpoMarcaProduData segMarcaCorpoMarcaProdu = datosResult;
		es.indra.belcorp.mso.SegMarcaData marcOidMarc = segMarcaCorpoMarcaProdu.getMarcOidMarc();
		if(marcOidMarc != null && marcOidMarc.getId() != null) checkCombo("marcOidMarc" , marcOidMarc.getId().toString());
		es.indra.belcorp.mso.SegMarcaProduData maprOidMarcProd = segMarcaCorpoMarcaProdu.getMaprOidMarcProd();
	...
	protected void cmdCreate() throws Exception{
		...
		asignarAtributo("COMBO", "maprOidMarcProd", "req", "S");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "segMarcaCorpoMarcaProduFrm", "oculto", "N");
		...
		traza("MMG::Creando SegMarcaCorpoMarcaProdu");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		SegMarcaCorpoMarcaProduData segMarcaCorpoMarcaProduQuery= new SegMarcaCorpoMarcaProduData();
		segMarcaCorpoMarcaProduQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(segMarcaCorpoMarcaProdu.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"segMarcaCorpoMarcaProduFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"segMarcaCorpoMarcaProduFrm\",1, false)");
					asignarAtributo("COMBO","marcOidMarc", "ontab", "ejecutarAccionFocoModificacion(\"segMarcaCorpoMarcaProduFrm\",2, true)");
					asignarAtributo("COMBO","marcOidMarc", "onshtab", "ejecutarAccionFocoModificacion(\"segMarcaCorpoMarcaProduFrm\",2, false)");
					asignarAtributo("COMBO","maprOidMarcProd", "ontab", "ejecutarAccionFocoModificacion(\"segMarcaCorpoMarcaProduFrm\",3, true)");
					asignarAtributo("COMBO","maprOidMarcProd", "onshtab", "ejecutarAccionFocoModificacion(\"segMarcaCorpoMarcaProduFrm\",3, false)");
					asignarAtributo("COMBO","paisOidPais", "ontab", "ejecutarAccionFocoModificacion(\"segMarcaCorpoMarcaProduFrm\",5, true)");
					asignarAtributo("COMBO","paisOidPais", "onshtab", "ejecutarAccionFocoModificacion(\"segMarcaCorpoMarcaProduFrm\",5, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","segMarcaCorpoMarcaProduTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","segMarcaCorpoMarcaProduTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","segMarcaCorpoMarcaProduFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","segMarcaCorpoMarcaProduListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","segMarcaCorpoMarcaProduListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(SegMarcaCorpoMarcaProduData segMarcaCorpoMarcaProdu) throws Exception{
		...
		if(segMarcaCorpoMarcaProdu != null && segMarcaCorpoMarcaProdu.getMarcOidMarc() != null){
				checkCombo("marcOidMarc" , segMarcaCorpoMarcaProdu.getMarcOidMarc().getId().toString());
			}
		...
		if(segMarcaCorpoMarcaProdu != null && segMarcaCorpoMarcaProdu.getMaprOidMarcProd() != null){
				checkCombo("maprOidMarcProd" , segMarcaCorpoMarcaProdu.getMaprOidMarcProd().getId().toString());
			}
		...
		if(segMarcaCorpoMarcaProdu != null && segMarcaCorpoMarcaProdu.getPaisOidPais() != null){
				checkCombo("paisOidPais" , segMarcaCorpoMarcaProdu.getPaisOidPais().getId().toString());
			}
	...
	* @param segMarcaCorpoMarcaProdu La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(SegMarcaCorpoMarcaProduData segMarcaCorpoMarcaProdu) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		SegMarcaCorpoMarcaProduData segMarcaCorpoMarcaProdu = 
			(SegMarcaCorpoMarcaProduData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(segMarcaCorpoMarcaProdu.getMarcOidMarc() != null){
			segMarcaCorpoMarcaProdu.setMarcOidMarc((es.indra.belcorp.mso.SegMarcaData)
			getSingleObject(BUSINESSID_MARCOIDMARC_QUERY, 
			segMarcaCorpoMarcaProdu.getMarcOidMarc(),
			segMarcaCorpoMarcaProdu.getMarcOidMarc().clone(),
			"segMarca"));
		}
		if(segMarcaCorpoMarcaProdu.getMaprOidMarcProd() != null){
			segMarcaCorpoMarcaProdu.setMaprOidMarcProd((es.indra.belcorp.mso.SegMarcaProduData)
			getSingleObject(BUSINESSID_MAPROIDMARCPROD_QUERY, 
			segMarcaCorpoMarcaProdu.getMaprOidMarcProd(),
			segMarcaCorpoMarcaProdu.getMaprOidMarcProd().clone(),
			"segMarcaProdu"));
		}
		if(segMarcaCorpoMarcaProdu.getPaisOidPais() != null){
			segMarcaCorpoMarcaProdu.setPaisOidPais((es.indra.belcorp.mso.SegPaisViewData)
			getSingleObject(BUSINESSID_PAISOIDPAIS_QUERY, 
			segMarcaCorpoMarcaProdu.getPaisOidPais(),
			segMarcaCorpoMarcaProdu.getPaisOidPais().clone(),
			"segPaisView"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(segMarcaCorpoMarcaProdu);
		loadLeafDependenceCombos(segMarcaCorpoMarcaProdu);
	}
