...
public class MMGExecuteUpdateConnector  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Descripcion: Conector generico mantenimientos MMG para ejecución de modificaciones" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGDTO" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGBusinessID" );
