...
public class contenido_informe_ganadoras_unidad_generar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_informe_ganadoras_unidad_generar" );
      ((Element)v.get(0)).setAttribute("cod","0887" );
      ((Element)v.get(0)).setAttribute("titulo","Generar Informe Ganadoras por Unidad Administrativa" );
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(11)).setAttribute("name","cbTerritorio" );
      ((Element)v.get(11)).setAttribute("required","true" );
      ((Element)v.get(11)).setAttribute("cod","126" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(136)).setAttribute("onchange","cambioZona();" );
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(157)).setAttribute("nombre","cbTerritorio" );
   ...
   private void getXML630(Document doc) {
      ...
      /* Empieza nodo:164 / Elemento padre: 37   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(37)).appendChild((Element)v.get(164));
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(182)).setAttribute("nombre","cbUnidadNegocio" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(187)).setAttribute("nombre","cbNegocio" );
   ...
   private void getXML720(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(208)).setAttribute("nombre","cbNumConcurso" );
   ...
   private void getXML810(Document doc) {
      ...
      /* Empieza nodo:215 / Elemento padre: 30   */
      v.add(doc.createElement("td"));
      ((Element)v.get(30)).appendChild((Element)v.get(215));
      ...
      /* Empieza nodo:217 / Elemento padre: 22   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(22)).appendChild((Element)v.get(217));
      ...
      ((Element)v.get(225)).setAttribute("nombre","btnGenerarInforme" );
      ((Element)v.get(225)).setAttribute("ID","botonContenido" );
      ((Element)v.get(225)).setAttribute("tipo","html" );
      ((Element)v.get(225)).setAttribute("accion","generar('pdf')" );
      ((Element)v.get(225)).setAttribute("estado","false" );
      ((Element)v.get(225)).setAttribute("cod","2495" );
      ((Element)v.get(225)).setAttribute("ontab","focaliza('Formulario.cbPais');" );
