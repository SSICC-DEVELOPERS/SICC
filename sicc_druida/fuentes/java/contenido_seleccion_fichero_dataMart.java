...
public class contenido_seleccion_fichero_dataMart  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_seleccion_fichero_dataMart" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(3)).setAttribute("src","contenido_seleccion_fichero_dataMart.js" );
      ...
      ((Element)v.get(5)).setAttribute("nombre","idioma" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(11)).setAttribute("nombre","indOrigen" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(12)).setAttribute("nombre","oidCurso" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(13)).setAttribute("nombre","oidCursoSeleccionado" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(17)).setAttribute("nombre","path" );
      ...
      ((Element)v.get(18)).setAttribute("nombre","capaFichero" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(49)).setAttribute("nombre","fichero2" );
      ((Element)v.get(49)).setAttribute("campo","frmUnico.path" );
      ((Element)v.get(49)).setAttribute("comprimir","NO" );
      ((Element)v.get(49)).setAttribute("descomprimir","NO" );
      ((Element)v.get(49)).setAttribute("drpath","" );
      ((Element)v.get(49)).setAttribute("funcion","onClickAceptar(file);" );
      ((Element)v.get(49)).setAttribute("id","datosCampos" );
      ((Element)v.get(49)).setAttribute("idenviar","datosCampos" );
      ((Element)v.get(49)).setAttribute("max","100" );
      ((Element)v.get(49)).setAttribute("ON","LPObjetoFicheroUpload" );
      ((Element)v.get(49)).setAttribute("readonly","N" );
      ((Element)v.get(49)).setAttribute("cod","12" );
      ((Element)v.get(49)).setAttribute("size","100" );
