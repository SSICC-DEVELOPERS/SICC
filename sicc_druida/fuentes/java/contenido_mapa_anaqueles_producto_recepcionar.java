...
public class contenido_mapa_anaqueles_producto_recepcionar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_mapa_anaqueles_producto_recepcionar" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(4)).setAttribute("src","contenido_mapa_anaqueles_producto_recepcionar.js" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(18)).setAttribute("nombre","hCbPeriodo" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(20)).setAttribute("nombre","hCbMapaCentroDistribucion" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(21)).setAttribute("nombre","hCbVersiones" );
   }
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(22)).setAttribute("nombre","hOidVersionDefault" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(47)).setAttribute("cod","EduTipoCurso.marcOidMarc.label" );
      ...
      ((Element)v.get(51)).setAttribute("cod","FacAsignImpre.canaOidCana.label" );
      ...
      ((Element)v.get(62)).setAttribute("onchange","onChangeCbMarca();" );
      ((Element)v.get(62)).setAttribute("onshtab","onShTABMarca();" );
      ((Element)v.get(62)).setAttribute("ontab","onTABMarca();" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(67)).setAttribute("onchange","onChangeCbCanal();" );
      ((Element)v.get(67)).setAttribute("onshtab","onShTABCanal();" );
      ((Element)v.get(67)).setAttribute("ontab","onTABCanal();" );
      ...
      ((Element)v.get(72)).setAttribute("onchange","onChangeCbPeriodo();" );
      ((Element)v.get(72)).setAttribute("onshtab","onShTABPeriodo();" );
      ((Element)v.get(72)).setAttribute("ontab","onTABPeriodo();" );
      ...
      ((Element)v.get(87)).setAttribute("cod","ApeConfCentroDistribucion.centroDistrib.label" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(91)).setAttribute("nombre","lblMapaCentroDistribucion" );
      ((Element)v.get(91)).setAttribute("alto","13" );
      ((Element)v.get(91)).setAttribute("filas","1" );
      ((Element)v.get(91)).setAttribute("valor","" );
      ((Element)v.get(91)).setAttribute("id","datosTitle" );
      ((Element)v.get(91)).setAttribute("cod","ApeGestVAsigProdAnaqueles.mapaCentro.label" );
      ...
      ((Element)v.get(98)).setAttribute("onshtab","onShTABCentrDistr();" );
      ((Element)v.get(98)).setAttribute("ontab","onTABCentrDistr();" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(103)).setAttribute("nombre","cbMapaCentroDistribucion" );
      ...
      ((Element)v.get(103)).setAttribute("onchange","onChangeCbMapaCentroDistribucion();" );
      ((Element)v.get(103)).setAttribute("onshtab","onShTABMapaCentrDistr();" );
      ((Element)v.get(103)).setAttribute("ontab","onTABMapaCentrDistr();" );
      ...
      /* Empieza nodo:110 / Elemento padre: 36   */
      v.add(doc.createElement("table"));
   }
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(36)).appendChild((Element)v.get(110));
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(118)).setAttribute("nombre","lblVersionAsignacion" );
      ...
      ((Element)v.get(118)).setAttribute("cod","3026" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(125)).setAttribute("nombre","cbVersionAsignacion" );
      ...
      ((Element)v.get(125)).setAttribute("onshtab","onShTABVersion();" );
      ((Element)v.get(125)).setAttribute("ontab","onTABVersion();" );
      ...
      /* Empieza nodo:132 / Elemento padre: 35   */
      v.add(doc.createElement("fieldset"));
      ((Element)v.get(35)).appendChild((Element)v.get(132));
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(136)).setAttribute("nombre","btnRecepcionar" );
      ((Element)v.get(136)).setAttribute("ID","botonContenido" );
      ((Element)v.get(136)).setAttribute("tipo","html" );
      ((Element)v.get(136)).setAttribute("accion","recepcion();" );
      ((Element)v.get(136)).setAttribute("estado","false" );
      ((Element)v.get(136)).setAttribute("cod","2265" );
      ((Element)v.get(136)).setAttribute("ontab","onTABBtnRece();" );
      ((Element)v.get(136)).setAttribute("onshtab","onShTABBtnRece();" );
