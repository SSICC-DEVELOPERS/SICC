...
public class INCRangoCuotas extends LPSICCBase {           
    public INCRangoCuotas() {	 
        super();
    }
    ...
    private void cargarPagina() throws Exception{
        pagina("contenido_informe_rango_cuotas_generar");   
    ...
    private void generarReporte() throws Exception{
        ...
        datos.put(ConstantesREP.TITULO, "Rango de Cuotas (Venta Incremental)");
        ...
        String reporte;
        if(region.equals("")){
           reporte = "RD_REP-057_02";
        }else{
           if(zona.equals("")){
             reporte = "RD_REP-057_01";   
           }else{          
              reporte = "RD_REP-057";    
          }
       }
