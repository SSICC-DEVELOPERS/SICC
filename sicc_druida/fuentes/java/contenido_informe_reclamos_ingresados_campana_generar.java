...
public class contenido_informe_reclamos_ingresados_campana_generar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_informe_reclamos_ingresados_campana_generar" );
      ((Element)v.get(0)).setAttribute("cod","0914" );
      ((Element)v.get(0)).setAttribute("titulo","Generar informe antigüedad de reclamos ingresados en una campaña" );
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(9)).setAttribute("name","cbOperacion" );
      ((Element)v.get(9)).setAttribute("required","true" );
      ((Element)v.get(9)).setAttribute("cod","406" );
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(11)).setAttribute("name","cbTipoDetalle" );
      ((Element)v.get(11)).setAttribute("required","true" );
      ((Element)v.get(11)).setAttribute("cod","2738" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(98)).setAttribute("nombre","cbOperacion" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(103)).setAttribute("nombre","cbTipoDetalle" );
      ...
      ((Element)v.get(103)).setAttribute("textoinicial","Región" );
      ...
      ((Element)v.get(107)).setAttribute("VALOR","Zona" );
      ...
      /* Empieza nodo:113 / Elemento padre: 33   */
      v.add(doc.createElement("td"));
      ((Element)v.get(33)).appendChild((Element)v.get(113));
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(123)).setAttribute("accion","generar('pdf')" );
      ((Element)v.get(123)).setAttribute("estado","false" );
      ((Element)v.get(123)).setAttribute("cod","2495" );
      ((Element)v.get(123)).setAttribute("ontab","focaliza('Formulario.cbMarca')" );
      ...
      /* Empieza nodo:126 / Elemento padre: 25   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(25)).appendChild((Element)v.get(126));
