...
public class PreConfiGpPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","PreConfiGp.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","PreConfiGp.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('preConfiGpFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('preConfiGpFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(54)).setAttribute("cod","PreConfiGp.paisOidPais.label" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('preConfiGpFrm',2, true);" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('preConfiGpFrm',2, false);" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(61)).setAttribute("nombre","marcOidMarcTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(66)).setAttribute("nombre","marcOidMarcWidgetTrId" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(68)).setAttribute("nombre","marcOidMarc" );
      ...
      ((Element)v.get(68)).setAttribute("ontab","ejecutarAccionFoco('preConfiGpFrm',3, true);" );
      ((Element)v.get(68)).setAttribute("onshtab","ejecutarAccionFoco('preConfiGpFrm',3, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(70)).setAttribute("nombre","marcOidMarcGapTdId" );
      ...
      ((Element)v.get(76)).setAttribute("cod","PreConfiGp.canaOidCana.label" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(79)).setAttribute("ontab","ejecutarAccionFoco('preConfiGpFrm',4, true);" );
      ((Element)v.get(79)).setAttribute("onshtab","ejecutarAccionFoco('preConfiGpFrm',4, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(83)).setAttribute("nombre","valIncrTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(88)).setAttribute("nombre","valIncrWidgetTrId" );
      ...
      ((Element)v.get(90)).setAttribute("ontab","ejecutarAccionFoco('preConfiGpFrm',5, true)" );
      ((Element)v.get(90)).setAttribute("onshtab","ejecutarAccionFoco('preConfiGpFrm', 5, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(91)).setAttribute("nombre","valIncrGapTdId" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(105)).setAttribute("nombre","preConfiGpTrButtons" );
      ...
      ((Element)v.get(112)).setAttribute("nombre","preConfiGpTdQueryButton" );
      ((Element)v.get(111)).appendChild((Element)v.get(112));

      /* Empieza nodo:113 / Elemento padre: 112   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(113)).setAttribute("nombre","preConfiGpQueryButton" );
      ((Element)v.get(113)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(113)).setAttribute("estado","false" );
      ((Element)v.get(113)).setAttribute("accion","preConfiGpFirstPage();" );
      ...
      ((Element)v.get(114)).setAttribute("nombre","preConfiGpTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(116)).setAttribute("nombre","preConfiGpLovNullButton" );
   }

   private void getXML540(Document doc) {
      ((Element)v.get(116)).setAttribute("ID","botonContenido" );
      ((Element)v.get(116)).setAttribute("tipo","html" );
      ((Element)v.get(116)).setAttribute("accion","preConfiGpLovNullSelectionAction();" );
