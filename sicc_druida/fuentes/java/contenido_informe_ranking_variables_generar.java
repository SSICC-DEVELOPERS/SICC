...
public class contenido_informe_ranking_variables_generar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_informe_ranking_variables_generar" );
      ((Element)v.get(0)).setAttribute("cod","0878" );
      ((Element)v.get(0)).setAttribute("titulo","Generar Informe Ranking de Variables Resumen por Región por Zona" );
      ...
      v.add(doc.createTextNode("\r\r\r\r  function onLoad(){\r  \r    configurarMenuSecundario('Formulario');\r    fMostrarMensajeError();\r    set('Formulario.txtAno',get('Formulario.anioDefault'));\r    setearPais();\r    cambioPais();\r    focaliza('Formulario.txtAno');\r    \r  }\r\r    function quitarItemVacio(elemento){\r      var elementoADevolver = new Array();\r     \r      for(var k=0;k<elemento.length;k++) {\r          if (elemento[k] != ''){                            \r             elementoADevolver[elementoADevolver.length] = elemento[k];\r          }\r      }\r         \r      return elementoADevolver;\r      \r   }\r\r\r  function anioActual() {\r    \r    d = new Date();\r    y = d.getFullYear();\r    return y;\r  \r  }\r\r  \r  function setearPais(){\r  \r    var pais = get('Formulario.pais');\r    \r    iSeleccionado = new Array();\r    iSeleccionado[0] = pais;\r    set('Formulario.cbPais',iSeleccionado);\r  \r  }\r\r\r  function fLimpiar(){\r    \r    var aCombo = new Array(new Array(\"\",\"\"));\r    \r    set('Formulario.txtAno',get('Formulario.anioDefault'));\r    \r    set_combo('Formulario.cbConcurso', aCombo, []);\r    set_combo('Formulario.cbSubgerenciaVentas', aCombo, []);\r    set_combo('Formulario.cbRegion', aCombo, []);\r    set_combo('Formulario.cbZona', aCombo, []);\r    \r    focaliza('Formulario.txtAno');\r    \r  }\r\r  \r  function cambioPais(){\r    \r    opciones = new Array();\r    \r    pais = get('Formulario.cbPais');\r    \r    if(pais != ''){\r      \r      var arr = new Array();\r      arr[arr.length] = [\"oidPais\", pais];\r      arr[arr.length] = [\"oidAgrugacion\", \"0\"];\r      recargaCombo('Formulario.cbConcurso','INCObtenerConcursosREP', 'es.indra.sicc.dtos.inc.DTOBusquedaClienteCalificado',arr);\r    \r    }\r    \r  }\r  \r\r  \r  function onChangePaisMarcaCanal(){\r    \r    opciones = new Array();\r    \r    pais = get('Formulario.cbPais');\r    marca = get('Formulario.cbMarca');\r    canal = get('Formulario.cbCanal');\r    \r    if(pais != '' && marca != '' && canal != ''){\r      \r      var arr = new Array();\r      \r      arr[arr.length] = [\"oidPais\", pais];\r      arr[arr.length] = [\"oidMarca\", marca];\r      arr[arr.length] = [\"oidCanal\", canal];\r      \r      recargaCombo(\"Formulario.cbSubgerenciaVentas\", \"ZONRecargaSubgerenciaVentas\", \"es.indra.sicc.dtos.zon.DTOUnidadAdministrativa\",arr);\r      recargaCombo(\"Formulario.cbRegion\", \"ZONRecargaRegiones\", \"es.indra.sicc.dtos.zon.DTOUnidadAdministrativa\",arr);\r      recargaCombo(\"Formulario.cbZona\", \"ZONRecargaZonas\", \"es.indra.sicc.dtos.zon.DTOUnidadAdministrativa\",arr);\r    \r    }else{\r    \r      var aCombo = new Array(new Array(\"\",\"\"));\r      \r      set_combo('Formulario.cbSubgerenciaVentas',aCombo, []);\r      set_combo('Formulario.cbRegion',aCombo, []);\r      set_combo('Formulario.cbZona',aCombo, []);\r    \r    }\r    \r  }\r\r\r  function cambioSGV(){\r    \r    pais = get('Formulario.cbPais');\r    marca = get('Formulario.cbMarca');\r    canal = get('Formulario.cbCanal');\r    sgv = get('Formulario.cbSubgerenciaVentas','V');\r    \r    \r    if (sgv.length == 1 ){\r      \r      var arr = new Array();\r      \r      arr[arr.length] = [\"oidPais\", pais];\r      arr[arr.length] = [\"oidMarca\", marca];\r      arr[arr.length] = [\"oidCanal\", canal];\r      arr[arr.length] = [\"oidSGV\", sgv];\r      \r      recargaCombo(\"Formulario.cbRegion\", \"ZONRecargaRegiones\", \"es.indra.sicc.dtos.zon.DTOUnidadAdministrativa\",arr);\r      recargaCombo(\"Formulario.cbZona\", \"ZONRecargaZonas\", \"es.indra.sicc.dtos.zon.DTOUnidadAdministrativa\",arr);\r      \r      accion(\"Formulario.cbRegion\",\".disabled=false\");\r      accion(\"Formulario.cbZona\",\".disabled=false\");\r    \r    }else{\r    \r      var aCombo = new Array(new Array(\"\",\"\"));\r      \r      set_combo('Formulario.cbRegion',aCombo, []);\r      set_combo('Formulario.cbZona',aCombo, []);\r      \r      accion(\"Formulario.cbRegion\",\".disabled=true\");\r      accion(\"Formulario.cbZona\",\".disabled=true\");\r    \r    }\r  \r  }\r\r\r  function cambioRegion(){\r    \r    pais = get('Formulario.cbPais');\r    marca = get('Formulario.cbMarca');\r    canal = get('Formulario.cbCanal');\r    sgv = get('Formulario.cbSubgerenciaVentas');\r    region = get('Formulario.cbRegion','V');\r    \r    if (region.length == 1){\r      \r      var arr = new Array();\r      \r      arr[arr.length] = [\"oidPais\", pais];\r      arr[arr.length] = [\"oidMarca\", marca];\r      arr[arr.length] = [\"oidCanal\", canal];\r      arr[arr.length] = [\"oidSGV\", sgv];\r      arr[arr.length] = [\"oidRegion\", region];\r      \r      recargaCombo(\"Formulario.cbZona\", \"ZONRecargaZonas\", \"es.indra.sicc.dtos.zon.DTOUnidadAdministrativa\",arr);\r      \r      accion(\"Formulario.cbZona\",\".disabled=false\");\r    \r    }else{\r    \r      var aCombo = new Array(new Array(\"\",\"\"));\r      \r      set_combo('Formulario.cbZona',aCombo, []);\r      \r      accion(\"Formulario.cbZona\",\".disabled=true\");\r      \r    }\r  \r  }\r\r  \r  function generar(formato){\r      \r    if(sicc_validaciones_generales()){\r         \r      var a = new Object();\r      a.accion = 'generar';\r      \r      a.anio = get('Formulario.txtAno');\r      a.pais = get('Formulario.cbPais');\r      a.marca = get('Formulario.cbMarca');\r      a.canal = get('Formulario.cbCanal');\r      a.concurso = get('Formulario.cbConcurso');\r      a.subgerenciaVentas = quitarItemVacio(get('Formulario.cbSubgerenciaVentas'));\r      a.region = quitarItemVacio(get('Formulario.cbRegion'));\r      a.zona = quitarItemVacio(get('Formulario.cbZona'));\r      \r      \r      a.formato = formato;\r      \r      mostrarModalSICC('INCRankingVariablesResumen','generar', a);\r      \r    }\r    \r  }\r\r\r\r\r\r"));
      ...
      ((Element)v.get(7)).setAttribute("name","txtAno" );
      ((Element)v.get(7)).setAttribute("required","true" );
      ((Element)v.get(7)).setAttribute("cod","171" );
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(11)).setAttribute("name","cbConcurso" );
      ((Element)v.get(11)).setAttribute("required","true" );
      ((Element)v.get(11)).setAttribute("cod","1662" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(20)).setAttribute("nombre","anioDefault" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(63)).setAttribute("nombre","cbPais" );
      ...
      ((Element)v.get(63)).setAttribute("onchange","onChangePaisMarcaCanal();cambioPais()" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(88)).setAttribute("onchange","onChangePaisMarcaCanal()" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(93)).setAttribute("onchange","onChangePaisMarcaCanal()" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(114)).setAttribute("nombre","cbConcurso" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(139)).setAttribute("nombre","cbSubgerenciaVentas" );
   }
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(139)).setAttribute("onchange","cambioSGV()" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(144)).setAttribute("nombre","cbRegion" );
      ...
      ((Element)v.get(144)).setAttribute("onchange","cambioRegion()" );
      ...
      /* Empieza nodo:148 / Elemento padre: 123   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(123)).appendChild((Element)v.get(148));
   ...
   private void getXML630(Document doc) {
      ...
      /* Empieza nodo:172 / Elemento padre: 30   */
      v.add(doc.createElement("td"));
      ((Element)v.get(30)).appendChild((Element)v.get(172));
      ...
      /* Empieza nodo:174 / Elemento padre: 22   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(22)).appendChild((Element)v.get(174));
      ...
      ((Element)v.get(182)).setAttribute("nombre","btnGenerarInforme" );
      ((Element)v.get(182)).setAttribute("ID","botonContenido" );
      ((Element)v.get(182)).setAttribute("tipo","html" );
      ((Element)v.get(182)).setAttribute("accion","generar('pdf')" );
      ((Element)v.get(182)).setAttribute("estado","false" );
      ((Element)v.get(182)).setAttribute("cod","2495" );
      ((Element)v.get(181)).appendChild((Element)v.get(182));
      /* Termina nodo:182   */

      /* Empieza nodo:183 / Elemento padre: 181   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(183)).setAttribute("nombre","btnGenerarExcel" );
      ((Element)v.get(183)).setAttribute("ID","botonContenido" );
      ((Element)v.get(183)).setAttribute("tipo","html" );
      ((Element)v.get(183)).setAttribute("accion","generar('excel')" );
      ((Element)v.get(183)).setAttribute("estado","false" );
      ((Element)v.get(183)).setAttribute("cod","2526" );
      ((Element)v.get(183)).setAttribute("ontab","focaliza('Formulario.txtAno')" );
      ...
      /* Empieza nodo:186 / Elemento padre: 22   */
   }

   private void getXML720(Document doc) {
      v.add(doc.createElement("tr"));
      ((Element)v.get(22)).appendChild((Element)v.get(186));
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(189)).setAttribute("width","756" );
      ...
      ((Element)v.get(192)).setAttribute("height","1" );
