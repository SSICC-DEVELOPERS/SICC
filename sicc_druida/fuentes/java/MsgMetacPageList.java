...
public class MsgMetacPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","msgMetacList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(16)).setAttribute("cod","MsgMetac.codMeta.label" );
      ...
      ((Element)v.get(17)).setAttribute("cod","MsgMetac.Descripcion.label" );
      ...
      ((Element)v.get(18)).setAttribute("cod","MsgMetac.timeOidTipo.label" );
      ...
      ((Element)v.get(19)).setAttribute("cod","MsgMetac.valEsta.label" );
      ...
      ((Element)v.get(20)).setAttribute("cod","MsgMetac.valLiteIden.label" );
