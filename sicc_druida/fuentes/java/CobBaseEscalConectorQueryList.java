...
public class CobBaseEscalConectorQueryList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad CobBaseEscal" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGCobBaseEscalQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGCobBaseEscalQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","CobBaseEscalListFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","codBaseEsca" );
