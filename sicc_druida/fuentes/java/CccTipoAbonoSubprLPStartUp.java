/*
    INDRA/CAR/mmg
    $Id: CccTipoAbonoSubprLPStartUp.java,v 1.1 2009/12/03 18:34:22 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class CccTipoAbonoSubprLPStartUp extends MMGDruidaBase{
	...
	public static final String BUSINESSID_QUERY = "MMGCccTipoAbonoSubprQueryFromToUserPage";
				...
				public static final String BUSINESSID_TCABOIDTCAB_QUERY ="MMGCccTipoCargoAbonoQueryFromToUser";
				public static final String TCABOIDTCAB_COMBO_CONNECTOR = "CccTipoCargoAbonoConectorCombo";
	
				public static final String BUSINESSID_CUCOOIDCUENCONT_QUERY ="MMGCccCuentContaQueryFromToUser";
				public static final String CUCOOIDCUENCONT_COMBO_CONNECTOR = "CccCuentContaConectorCombo";
	...
	public CccTipoAbonoSubprLPStartUp(){
		super();
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			buildJsPageSize("CccTipoAbonoSubpr");
			...
			asignarAtributo("PAGINA", "CccTipoAbonoSubprPage", "cod", "CccTipoAbonoSubpr." + accion + ".label");
			...
			limpiarBotoneraLista("cccTipoAbonoSubpr", accion);
	...
	protected void cmdLov() throws Exception{
		...
		//asignarAtributo("CAPA", "cccTipoAbonoSubprLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "CccTipoAbonoSubprPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		CccTipoAbonoSubprData cccTipoAbonoSubprQuery= new CccTipoAbonoSubprData();
		cccTipoAbonoSubprQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		CccTipoAbonoSubprData datosResult = (CccTipoAbonoSubprData)getSingleObject(BUSINESSID_QUERY, cccTipoAbonoSubprQuery, 
			cccTipoAbonoSubprQuery.clone(), "cccTipoAbonoSubpr");
		...
		CccTipoAbonoSubprData cccTipoAbonoSubpr = datosResult;
		es.indra.belcorp.mso.CccSubprData subpOidSubp = cccTipoAbonoSubpr.getSubpOidSubp();
		if(subpOidSubp != null && subpOidSubp.getId() != null) checkCombo("subpOidSubp" , subpOidSubp.getId().toString());
		es.indra.belcorp.mso.CccTipoCargoAbonoData tcabOidTcab = cccTipoAbonoSubpr.getTcabOidTcab();
		if(tcabOidTcab != null && tcabOidTcab.getId() != null) checkCombo("tcabOidTcab" , tcabOidTcab.getId().toString());
		es.indra.belcorp.mso.CccCuentContaData cucoOidCuenCont = cccTipoAbonoSubpr.getCucoOidCuenCont();
		...
		//Deshabilitamos todos los campos para que no se editen
					...
					asignarAtributo("COMBO", "tcabOidTcab", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		...
		asignarAtributo("COMBO", "tcabOidTcab", "req", "S");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "cccTipoAbonoSubprFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		CccTipoAbonoSubprData cccTipoAbonoSubprQuery= new CccTipoAbonoSubprData();
		cccTipoAbonoSubprQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(cccTipoAbonoSubpr.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"cccTipoAbonoSubprFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"cccTipoAbonoSubprFrm\",1, false)");
					asignarAtributo("COMBO","subpOidSubp_ccprOidProc", "ontab", "ejecutarAccionFocoModificacion(\"cccTipoAbonoSubprFrm\",3, true)");
					asignarAtributo("COMBO","subpOidSubp_ccprOidProc", "onshtab", "ejecutarAccionFocoModificacion(\"cccTipoAbonoSubprFrm\",3, false)");
					asignarAtributo("COMBO","subpOidSubp", "ontab", "ejecutarAccionFocoModificacion(\"cccTipoAbonoSubprFrm\",3, true)");
					asignarAtributo("COMBO","subpOidSubp", "onshtab", "ejecutarAccionFocoModificacion(\"cccTipoAbonoSubprFrm\",3, false)");
					asignarAtributo("COMBO","tcabOidTcab", "ontab", "ejecutarAccionFocoModificacion(\"cccTipoAbonoSubprFrm\",4, true)");
					asignarAtributo("COMBO","tcabOidTcab", "onshtab", "ejecutarAccionFocoModificacion(\"cccTipoAbonoSubprFrm\",4, false)");
					asignarAtributo("COMBO","cucoOidCuenCont", "ontab", "ejecutarAccionFocoModificacion(\"cccTipoAbonoSubprFrm\",5, true)");
					asignarAtributo("COMBO","cucoOidCuenCont", "onshtab", "ejecutarAccionFocoModificacion(\"cccTipoAbonoSubprFrm\",5, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","cccTipoAbonoSubprTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","cccTipoAbonoSubprTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es tcabOidTcab...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","cccTipoAbonoSubprFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","cccTipoAbonoSubprListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","cccTipoAbonoSubprListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(CccTipoAbonoSubprData cccTipoAbonoSubpr) throws Exception{
		...
		if(cccTipoAbonoSubpr != null && cccTipoAbonoSubpr.getSubpOidSubp().getCcprOidProc() != null){
				checkCombo("subpOidSubp_ccprOidProc" , cccTipoAbonoSubpr.getSubpOidSubp().getCcprOidProc().getId().toString());
			}
		CccTipoCargoAbonoData tcabOidTcab = new CccTipoCargoAbonoData();
		
						asignarComboResultados(BUSINESSID_TCABOIDTCAB_QUERY,TCABOIDTCAB_COMBO_CONNECTOR, 
			tcabOidTcab, tcabOidTcab.clone(), "cccTipoCargoAbono", "tcabOidTcab", "result_ROWSET" );
		if(cccTipoAbonoSubpr != null && cccTipoAbonoSubpr.getTcabOidTcab() != null){
				checkCombo("tcabOidTcab" , cccTipoAbonoSubpr.getTcabOidTcab().getId().toString());
			}
		CccCuentContaData cucoOidCuenCont = new CccCuentContaData();
		
						asignarComboResultados(BUSINESSID_CUCOOIDCUENCONT_QUERY,CUCOOIDCUENCONT_COMBO_CONNECTOR, 
			cucoOidCuenCont, cucoOidCuenCont.clone(), "cccCuentConta", "cucoOidCuenCont", "result_ROWSET" );
		if(cccTipoAbonoSubpr != null && cccTipoAbonoSubpr.getCucoOidCuenCont() != null){
				checkCombo("cucoOidCuenCont" , cccTipoAbonoSubpr.getCucoOidCuenCont().getId().toString());
			}
	...
	* @param cccTipoAbonoSubpr La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(CccTipoAbonoSubprData cccTipoAbonoSubpr) 
		throws Exception{
		
						if(cccTipoAbonoSubpr.getSubpOidSubp() != null){
			
						CccSubprData subpOidSubp = new CccSubprData();
			subpOidSubp.setCcprOidProc(cccTipoAbonoSubpr.getSubpOidSubp().getCcprOidProc());
			...
			checkCombo("subpOidSubp" , cccTipoAbonoSubpr.getSubpOidSubp().getId().toString());
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		CccTipoAbonoSubprData cccTipoAbonoSubpr = 
			(CccTipoAbonoSubprData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(cccTipoAbonoSubpr.getSubpOidSubp() != null){
			cccTipoAbonoSubpr.setSubpOidSubp((es.indra.belcorp.mso.CccSubprData)
			getSingleObject(BUSINESSID_SUBPOIDSUBP_QUERY, 
			cccTipoAbonoSubpr.getSubpOidSubp(),
			cccTipoAbonoSubpr.getSubpOidSubp().clone(),
			"cccSubpr"));
		}
		if(cccTipoAbonoSubpr.getTcabOidTcab() != null){
			cccTipoAbonoSubpr.setTcabOidTcab((es.indra.belcorp.mso.CccTipoCargoAbonoData)
			getSingleObject(BUSINESSID_TCABOIDTCAB_QUERY, 
			cccTipoAbonoSubpr.getTcabOidTcab(),
			cccTipoAbonoSubpr.getTcabOidTcab().clone(),
			"cccTipoCargoAbono"));
		}
		if(cccTipoAbonoSubpr.getCucoOidCuenCont() != null){
			cccTipoAbonoSubpr.setCucoOidCuenCont((es.indra.belcorp.mso.CccCuentContaData)
			getSingleObject(BUSINESSID_CUCOOIDCUENCONT_QUERY, 
			cccTipoAbonoSubpr.getCucoOidCuenCont(),
			cccTipoAbonoSubpr.getCucoOidCuenCont().clone(),
			"cccCuentConta"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(cccTipoAbonoSubpr);
		loadLeafDependenceCombos(cccTipoAbonoSubpr);
	}
