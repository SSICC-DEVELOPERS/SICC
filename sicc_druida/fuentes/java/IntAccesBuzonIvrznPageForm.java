...
public class IntAccesBuzonIvrznPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","IntAccesBuzonIvrzn.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","IntAccesBuzonIvrzn.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('intAccesBuzonIvrznFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('intAccesBuzonIvrznFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(50)).setAttribute("nombre","codAcceBuzoIvrzTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lblCodAcceBuzoIvrz" );
      ((Element)v.get(54)).setAttribute("alto","13" );
      ((Element)v.get(54)).setAttribute("filas","1" );
      ((Element)v.get(54)).setAttribute("id","datosTitle" );
      ((Element)v.get(54)).setAttribute("cod","IntAccesBuzonIvrzn.codAcceBuzoIvrz.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(55)).setAttribute("nombre","codAcceBuzoIvrzWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(57)).setAttribute("nombre","codAcceBuzoIvrz" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","focaliza('intAccesBuzonIvrznFrm.zzonOidZona_marcOidMarc');" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('intAccesBuzonIvrznFrm', 2, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(58)).setAttribute("nombre","codAcceBuzoIvrzGapTdId" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(75)).setAttribute("nombre","zzonOidZona_marcOidMarcTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(79)).setAttribute("nombre","lblzzonOidZona_marcOidMarc" );
      ((Element)v.get(79)).setAttribute("id","datosTitle" );
      ((Element)v.get(79)).setAttribute("ancho","150" );
      ((Element)v.get(79)).setAttribute("alto","13" );
      ((Element)v.get(79)).setAttribute("cod","ZonZonaView2.marcOidMarc.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(80)).setAttribute("nombre","zzonOidZona_marcOidMarcWidgetTrId" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(82)).setAttribute("nombre","zzonOidZona_marcOidMarc" );
      ...
      ((Element)v.get(82)).setAttribute("onchange","mmgDependeneChange('zzonOidZona_marcOidMarc', 'zzonOidZona' , 'intAccesBuzonIvrzn')" );
      ...
      ((Element)v.get(82)).setAttribute("ontab","focaliza('intAccesBuzonIvrznFrm.zzonOidZona_canaOidCana');" );
      ((Element)v.get(82)).setAttribute("onshtab","ejecutarAccionFoco('intAccesBuzonIvrznFrm',3, false);" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(84)).setAttribute("nombre","zzonOidZona_marcOidMarcGapTdId" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(86)).setAttribute("nombre","zzonOidZona_canaOidCanaTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(90)).setAttribute("nombre","lblzzonOidZona_canaOidCana" );
      ((Element)v.get(90)).setAttribute("id","datosTitle" );
      ((Element)v.get(90)).setAttribute("ancho","150" );
      ((Element)v.get(90)).setAttribute("alto","13" );
      ((Element)v.get(90)).setAttribute("cod","ZonZonaView2.canaOidCana.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(91)).setAttribute("nombre","zzonOidZona_canaOidCanaWidgetTrId" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(93)).setAttribute("nombre","zzonOidZona_canaOidCana" );
      ...
      ((Element)v.get(93)).setAttribute("onchange","mmgDependeneChange('zzonOidZona_canaOidCana', 'zzonOidZona' , 'intAccesBuzonIvrzn')" );
      ...
      ((Element)v.get(93)).setAttribute("ontab","focaliza('intAccesBuzonIvrznFrm.zzonOidZona');" );
      ((Element)v.get(93)).setAttribute("onshtab","focaliza('intAccesBuzonIvrznFrm.zzonOidZona_marcOidMarc');" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(95)).setAttribute("nombre","zzonOidZona_canaOidCanaGapTdId" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(97)).setAttribute("nombre","zzonOidZonaTdId" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(101)).setAttribute("nombre","lblzzonOidZona" );
      ...
      ((Element)v.get(101)).setAttribute("cod","IntAccesBuzonIvrzn.zzonOidZona.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(102)).setAttribute("nombre","zzonOidZonaWidgetTrId" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(104)).setAttribute("nombre","zzonOidZona" );
      ...
      ((Element)v.get(104)).setAttribute("ontab","ejecutarAccionFoco('intAccesBuzonIvrznFrm',3, true);" );
      ((Element)v.get(104)).setAttribute("onshtab","focaliza('intAccesBuzonIvrznFrm.zzonOidZona_canaOidCana');" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(106)).setAttribute("nombre","zzonOidZonaGapTdId" );
      ...
      /* Empieza nodo:110 / Elemento padre: 69   */
      v.add(doc.createElement("TD"));
      ((Element)v.get(110)).setAttribute("width","100%" );
      ((Element)v.get(69)).appendChild((Element)v.get(110));
      /* Termina nodo:110   */
      /* Termina nodo:69   */
      ...
      /* Empieza nodo:118 / Elemento padre: 8   */
   }
   ...
   private void getXML540(Document doc) {
      ...
      ((Element)v.get(8)).appendChild((Element)v.get(118));
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(120)).setAttribute("nombre","intAccesBuzonIvrznTrButtons" );
      ...
      ((Element)v.get(127)).setAttribute("nombre","intAccesBuzonIvrznTdQueryButton" );
      ((Element)v.get(126)).appendChild((Element)v.get(127));

      /* Empieza nodo:128 / Elemento padre: 127   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(128)).setAttribute("nombre","intAccesBuzonIvrznQueryButton" );
      ((Element)v.get(128)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(128)).setAttribute("estado","false" );
      ((Element)v.get(128)).setAttribute("accion","intAccesBuzonIvrznFirstPage();" );
      ...
      ((Element)v.get(129)).setAttribute("nombre","intAccesBuzonIvrznTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(131)).setAttribute("nombre","intAccesBuzonIvrznLovNullButton" );
      ((Element)v.get(131)).setAttribute("ID","botonContenido" );
      ((Element)v.get(131)).setAttribute("tipo","html" );
      ((Element)v.get(131)).setAttribute("accion","intAccesBuzonIvrznLovNullSelectionAction();" );
