...
public class PreEstraPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","preEstraList" );
      ...
      ((Element)v.get(14)).setAttribute("cod","PreEstra.codEstr.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","PreEstra.Descripcion.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","PreEstra.tiesOidTipoEstr.label" );
