/*
    INDRA/CAR/mmg
    $Id: IncDirigLPStartUp.java,v 1.1 2009/12/03 18:43:17 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class IncDirigLPStartUp extends MMGDruidaBase{
	...
	public static final String BUSINESSID_QUERY = "MMGIncDirigQueryFromToUserPage";
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "IncDirigPage", "cod", "IncDirig." + accion + ".label");
			...
			limpiarBotoneraLista("incDirig", accion);
	...
	protected void cmdLov() throws Exception{
		...
		//asignarAtributo("CAPA", "incDirigLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "IncDirigPage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("IncDirigLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		IncDirigData incDirigQuery= new IncDirigData();
		incDirigQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		IncDirigData datosResult = (IncDirigData)getSingleObject(BUSINESSID_QUERY, incDirigQuery, 
			incDirigQuery.clone(), "incDirig");
		...
		preservaHiddensI18n(new Integer(1), "INC_DIRIG", "incDirigFrm", "Descripcion", true);
		...
		IncDirigData incDirig = datosResult;
		asignar("TEXT", "Descripcion", FormatUtils.formatObject(incDirig.getDescripcion(), 
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "INC_DIRIG", "incDirigFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('incDirigFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "incDirigFrm", "oculto", "N");
		...
		traza("MMG::Creando IncDirig");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		IncDirigData incDirigQuery= new IncDirigData();
		incDirigQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(incDirig.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"incDirigFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"incDirigFrm\",1, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"incDirigFrm\",2, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"incDirigFrm\",2, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","incDirigTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","incDirigTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","incDirigFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","incDirigListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","incDirigListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(IncDirigData incDirig) throws Exception{
	...
	* @param incDirig La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(IncDirigData incDirig) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		IncDirigData incDirig = 
			(IncDirigData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(incDirig);
		loadLeafDependenceCombos(incDirig);
	}
	...
	*/
	...
	protected void loadLocalizationVars(IncDirigData incDirig) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("INC_DIRIG");
		mmgLocalizationQuery.setEntiPk(incDirig.getId());
