...
public class MaeTipoClienPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","maeTipoClienList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","MaeTipoClien.codTipoClie.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","MaeTipoClien.Descripcion.label" );
      ...
      ((Element)v.get(17)).setAttribute("cod","MaeTipoClien.indEvalEsta.label" );
      ...
      ((Element)v.get(18)).setAttribute("cod","MaeTipoClien.indEmpl.label" );
