...
public class INCRelacionGanadorasDespacho extends LPSICCBase {

  public INCRelacionGanadorasDespacho() {
    super();
  }
  ...
  public void ejecucion() throws Exception {		
    ...
    try {
      ...
      if (accion.equals("generar")){
        ...
        cargarPagina();
        getConfiguracionMenu("INCRelacionGanadorasDespacho");
      }
  ...
  private void cargarPagina() throws Exception{
    ...
    asignarAtributoPagina("cod", "0860");
    asignarAtributo("VAR", "lp", "valor", "INCRelacionGanadorasDespacho");
  ...
  private void generarReporte() throws Exception{
    ...
    datos.put(ConstantesREP.TITULO, "Relacion de Ganadoras en Campaña de Despacho");
    ...
    if(region.equals("")){
       reporte = "RD_REP-051_03";
    }else{
       if(zona.equals("")){
          reporte = "RD_REP-051_02";   
       }else{
          if(territorio.equals("")){
             reporte = "RD_REP-051_01";      
          }else{
            reporte = "RD_REP-051";    
          }
       }
