...
public class ConectorCargaPaisesEG  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Cargar Estructura Geopolítica de País" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","cadIn" );
