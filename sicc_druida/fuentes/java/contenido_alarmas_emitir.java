...
public class contenido_alarmas_emitir  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_alarmas_emitir" );
      ((Element)v.get(0)).setAttribute("cod","0571" );
      ...
      v.add(doc.createElement("JS"));
      ((Element)v.get(3)).setAttribute("src","contenido_alarmas_emitir.js" );
      ...
      ((Element)v.get(6)).setAttribute("cod","ApeAlarmasEmitir.centroDistrib.label" );
      ...
      ((Element)v.get(7)).setAttribute("cod","ApeGestVAsigProdAnaqueles.mapaCentro.label" );
      ...
      ((Element)v.get(8)).setAttribute("cod","ApeAlarmasEmitir.lineaArmado.label" );
   ...
   private void getXML90(Document doc) {
      ((Element)v.get(21)).setAttribute("nombre","hCbLineasCDDef" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(22)).setAttribute("nombre","descCD" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(23)).setAttribute("nombre","descMapaCD" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(24)).setAttribute("nombre","descLinea" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(25)).setAttribute("nombre","descMarca" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(27)).setAttribute("nombre","descPeriodo" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(47)).setAttribute("height","15" );
      ...
      ((Element)v.get(50)).setAttribute("width","15" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(52)).setAttribute("nombre","lblCentroDistribucion" );
      ((Element)v.get(52)).setAttribute("alto","13" );
      ((Element)v.get(52)).setAttribute("filas","1" );
      ((Element)v.get(52)).setAttribute("valor","" );
      ((Element)v.get(52)).setAttribute("id","datosTitle" );
      ((Element)v.get(52)).setAttribute("cod","ApeAlarmasEmitir.centroDistrib.label" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(56)).setAttribute("nombre","lblMapaCentroDistribucion" );
      ...
      ((Element)v.get(56)).setAttribute("cod","ApeGestVAsigProdAnaqueles.mapaCentro.label" );
      ...
      ((Element)v.get(60)).setAttribute("cod","ApeAlarmasEmitir.lineaArmado.label" );
   ...
   private void getXML270(Document doc) {
      ((Element)v.get(67)).setAttribute("onchange","onChangeCbCentroDistribucion();" );
      ((Element)v.get(67)).setAttribute("onshtab","focalizaBotonHTML('botonContenido', 'btnEjecutar');" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(72)).setAttribute("nombre","cbMapaCentroDistribucion" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(77)).setAttribute("nombre","cbLineaArmado" );
      ...
      ((Element)v.get(87)).setAttribute("width","15" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(120)).setAttribute("height","20" );
      ...
      /* Empieza nodo:121 / Elemento padre: 40   */
      v.add(doc.createElement("fieldset"));
      ((Element)v.get(40)).appendChild((Element)v.get(121));
      ...
      ((Element)v.get(125)).setAttribute("nombre","btnEjecutar" );
      ((Element)v.get(125)).setAttribute("ID","botonContenido" );
      ((Element)v.get(125)).setAttribute("tipo","html" );
      ((Element)v.get(125)).setAttribute("accion","onClickEjecutar();" );
      ((Element)v.get(125)).setAttribute("estado","false" );
      ((Element)v.get(125)).setAttribute("cod","ApeAlarmasEmitir.ejecutar.label" );
      ((Element)v.get(125)).setAttribute("ontab","foco('formulario.cbCentroDistribucion');" );
      ...
      /* Empieza nodo:126 / Elemento padre: 37   */
      v.add(doc.createElement("td"));
      ((Element)v.get(37)).appendChild((Element)v.get(126));
