...
public class ConectorBloquearClientes  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","ConectorBloquearClientes" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","DTOBloquearClientes" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","CCCBloquearClientes" );
