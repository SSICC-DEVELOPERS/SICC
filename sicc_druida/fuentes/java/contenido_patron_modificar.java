...
public class contenido_patron_modificar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_patron_modificar" );
      ((Element)v.get(0)).setAttribute("cod","" );
      ((Element)v.get(0)).setAttribute("titulo","" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","Modificar patrón" );
      ...
      v.add(doc.createTextNode("\r  \r\r  function onLoadPag()   {\r	configurarMenuSecundario('frmModificarPatron');\r    DrdEnsanchaConMargenDcho('listado1',12);\r    document.all[\"Cplistado1\"].style.visibility='hidden';\r    document.all[\"CpLin1listado1\"].style.visibility='hidden';\r    document.all[\"CpLin2listado1\"].style.visibility='hidden';\r    document.all[\"CpLin3listado1\"].style.visibility='hidden';\r    document.all[\"CpLin4listado1\"].style.visibility='hidden';\r    document.all[\"primera1Div\"].style.visibility='hidden';\r    document.all[\"ret1Div\"].style.visibility='hidden';\r    document.all[\"ava1Div\"].style.visibility='hidden';\r    document.all[\"separaDiv\"].style.visibility='hidden';\r    document.all[\"ModificarDiv\"].style.visibility='hidden';\r    document.all[\"DetalleDiv\"].style.visibility='hidden';\r	focaliza('frmModificarPatron.CodigoPatron','');\r	if (get('frmModificarPatron.hTipoPeriodoHabilitado') == 'false')\r		accion('frmModificarPatron.comboTipoPeriodo', '.disabled=true' );		\r	if (get('frmModificarPatron.hPeriodoCorporativoHabilitado') == 'false')\r		accion( 'frmModificarPatron.comboPeriodoCorporativo', '.disabled=true' );		\r\r    eval (ON_RSZ);  \r		return true;\r   }\r\r   function accionBuscar(){\r\r		var arr = new Array();\r		arr[arr.length] = new Array(\"codigo\",get('frmModificarPatron.CodigoPatron'));\r		arr[arr.length] = new Array(\"descripcion\",get('frmModificarPatron.Descripcion'));\r		arr[arr.length] = new Array(\"oidFormulario\",get('frmModificarPatron.cmbFormulario'));\r		arr[arr.length] = new Array(\"oidMedioEnvio\",get('frmModificarPatron.cmbMedioEnvio'));\r		var activo = get('frmModificarPatron.cmbActivo');\r		if (activo == '2')\r			arr[arr.length] = new Array(\"activo\",'true');\r		else if (activo == '1')\r			arr[arr.length] = new Array(\"activo\",'false');\r\r		var indicador = get('frmModificarPatron.cmbIndicadorPatronPeriodo');\r		if (indicador == '2')\r			arr[arr.length] = new Array(\"patronPeriodo\",\"true\");\r		else if (indicador == '1')\r			arr[arr.length] = new Array(\"patronPeriodo\",\"false\");	\r			\r		arr[arr.length] = new Array(\"oidPeriodo\",get('frmModificarPatron.comboPeriodoCorporativo'));\r						\r		configurarPaginado(mipgndo,'MSGBuscarPatrones','ConectorBuscarPatrones','es.indra.sicc.dtos.msg.DTOPatron',arr);\r\r   }\r\r   function patronPeriodoOnChange(){\r\r		if (get('frmModificarPatron.cmbIndicadorPatronPeriodo') == '2')  {\r			accion( 'frmModificarPatron.comboTipoPeriodo', '.disabled=false' );\r			accion( 'frmModificarPatron.comboPeriodoCorporativo', '.disabled=false' );\r			var arr = crearParametrosDTOBelcorp();\r			recargaCombo('frmModificarPatron.comboTipoPeriodo','SEGObtenerTiposPeriodo', 'es.indra.sicc.util.DTOBelcorp',arr);\r		} else {\r			set_combo('frmModificarPatron.comboTipoPeriodo',new Array(new Array(\"\",\"\")), [])\r			set_combo('frmModificarPatron.comboPeriodoCorporativo',new Array(new Array(\"\",\"\")), [])\r			accion( 'frmModificarPatron.comboTipoPeriodo', '.disabled=true' );\r			accion( 'frmModificarPatron.comboPeriodoCorporativo', '.disabled=true' );\r		}\r   }\r\r   function crearParametrosDTOBelcorp(){\r		var arr = new Array();\r		arr[arr.length] = new Array(\"oidPais\",get('frmModificarPatron.hPais'));\r		arr[arr.length] = new Array(\"oidIdioma\",get('frmModificarPatron.hIdioma'));\r		return arr;\r   }\r\r\r   function tipoPeriodoOnChange(){\r		if (get('frmModificarPatron.comboTipoPeriodo') != '')  {\r			var arr = new Array();\r			arr[arr.length] = new Array(\"oidTipoPeriodo\", get('frmModificarPatron.comboTipoPeriodo'));\r\r			recargaCombo('frmModificarPatron.comboPeriodoCorporativo','SEGObtenerPeriodosPorTipoPeriodo',\r						'es.indra.sicc.dtos.seg.DTOPeriodosPorTipoPeriodo',arr);\r		} else {\r			set_combo('frmModificarPatron.comboPeriodoCorporativo',new Array(new Array(\"\",\"\")), [])\r		}		\r   }\r\r   function muestraLista(ultima, rowset) {\r        var tamano = rowset.length;\r        if (tamano > 0) {\r			mostrarLista();\r		var i;\r		var index = 5;\r		var si = GestionarMensaje(85);\r		var no = GestionarMensaje(87);\r		\r		for( i = 0; i < rowset.length; i++ ){\r			if(rowset[i][index] == '0')  \r				rowset[i][index] = no;\r			else if(rowset[i][index] == '1')	\r				rowset[i][index] = si;\r			else  rowset[i][index] = '';\r		}\r\r		index = 6;\r		for( i = 0; i < rowset.length; i++ ){\r			if(rowset[i][index] == '0')  \r				rowset[i][index] = no;\r			else if(rowset[i][index] == '1')	\r				rowset[i][index] = si;\r			else  rowset[i][index] = '';\r		}\r		return true;\r        }else{\r			ocultarLista();\r        }\r				\r	}   \r\r	function mostrarLista(){\r			document.all[\"Cplistado1\"].style.visibility='';\r			document.all[\"CpLin1listado1\"].style.visibility='';\r			document.all[\"CpLin2listado1\"].style.visibility='';\r			document.all[\"CpLin3listado1\"].style.visibility='';\r			document.all[\"CpLin4listado1\"].style.visibility='';\r			document.all[\"primera1Div\"].style.visibility='';\r			document.all[\"ret1Div\"].style.visibility='';\r			document.all[\"ava1Div\"].style.visibility='';\r			document.all[\"separaDiv\"].style.visibility='';\r			set('frmModificarPatron.hListaResultadosOculta', 'N');\r			if (get('frmModificarPatron.opcionMenu') == 'Modificar patron'){\r				document.all[\"ModificarDiv\"].style.visibility='';\r				set('frmModificarPatron.hBotonDisponible', 'Modificar');\r			} else if ((get('frmModificarPatron.opcionMenu') == 'Eliminar patron') ||\r					 (get('frmModificarPatron.opcionMenu') == 'Consultar patron') ) {\r				set('frmModificarPatron.hBotonDisponible', 'Detalle');\r				document.all[\"DetalleDiv\"].style.visibility='';\r			}\r\r	}\r\r	function ocultarLista(){\r			document.all[\"Cplistado1\"].style.visibility='hidden';\r			document.all[\"CpLin1listado1\"].style.visibility='hidden';\r			document.all[\"CpLin2listado1\"].style.visibility='hidden';\r			document.all[\"CpLin3listado1\"].style.visibility='hidden';\r			document.all[\"CpLin4listado1\"].style.visibility='hidden';\r			document.all[\"primera1Div\"].style.visibility='hidden';\r			document.all[\"ret1Div\"].style.visibility='hidden';\r			document.all[\"ava1Div\"].style.visibility='hidden';\r			document.all[\"separaDiv\"].style.visibility='hidden';\r			document.all[\"ModificarDiv\"].style.visibility='hidden';\r			document.all[\"DetalleDiv\"].style.visibility='hidden';\r			set('frmModificarPatron.hBotonDisponible', 'none');\r\r	}\r\r	function accionModificar(){\r		if(listado1.numSelecc()== 1){\r			var obj = new Object();\r			var oidPatr = listado1.codSeleccionados();\r			obj.hOidPatron = oidPatr;\r			obj.opcionMenu = get('frmModificarPatron.opcionMenu');\r			var wndw = mostrarModalSICC('LPMantenimientoPatrones','Modificar patron',obj);\r			accionBuscar();\r		} else {\r			GestionarMensaje('4');\r		}\r	}\r\r	function fBorrar(){\r		accionEliminar();\r	}\r\r	function fLimpiar(){\r		set_combo('frmModificarPatron.comboTipoPeriodo',new Array(new Array(\"\",\"\")), [])\r		set_combo('frmModificarPatron.comboPeriodoCorporativo',new Array(new Array(\"\",\"\")), [])\r		accion( 'frmModificarPatron.comboTipoPeriodo', '.disabled=true' );\r		accion( 'frmModificarPatron.comboPeriodoCorporativo', '.disabled=true' );		\r		focaliza('frmModificarPatron.CodigoPatron','');\r	}\r\r	\r	function accionEliminar(){\r		if(listado1.numSelecc() >= 1){\r						eliminarFilas(listado1.codSeleccionados(),\"MSGEliminarPatron\", mipgndo);\r		} else {\r			GestionarMensaje('4');\r		}\r	}\r\r	function accionDetalle(){\r		if(listado1.numSelecc()== 1){\r			var obj = new Object();\r			var oidPatr = listado1.codSeleccionados();\r			obj.hOidPatron = oidPatr;\r			var wndw = mostrarModalSICC('LPMantenimientoPatrones','Mostrar detalle patron',obj);\r			accionBuscar();\r		} else {\r			GestionarMensaje('4');\r		}\r	}\r\r	function ontab_Buscar(){\r		var botonDisponible = get('frmModificarPatron.hBotonDisponible');\r		if (botonDisponible == 'none')\r			focaliza('frmModificarPatron.CodigoPatron','');\r		else\r			focalizaBotonHTML('botonContenido', botonDisponible);\r	}\r\r	function ontab_Modificar(){\r		focaliza('frmModificarPatron.CodigoPatron','');\r	}\r\r	function ontab_Detalle(){\r		focaliza('frmModificarPatron.CodigoPatron','');\r	}\r\r	function onshtab_Modificar(){\r		focalizaBotonHTML('botonContenido', 'btnBuscar');\r	}\r\r	function onshtab_Detalle(){\r		focalizaBotonHTML('botonContenido', 'btnBuscar');\r	}\r	\r	function onshtab_CodPatron(){\r		var botonDisponible = get('frmModificarPatron.hBotonDisponible');\r		if (botonDisponible == 'none')\r			focalizaBotonHTML('botonContenido', 'btnBuscar');			\r		else\r			focalizaBotonHTML('botonContenido', botonDisponible);\r	}\r\r   \r\r"));
      ...
      ((Element)v.get(6)).setAttribute("nombre","frmModificarPatron" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(15)).setAttribute("nombre","hOidPatron" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(16)).setAttribute("nombre","hBuscarHabilitado" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(17)).setAttribute("nombre","hListaResultadosOculta" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(18)).setAttribute("nombre","hDetalleOculto" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(19)).setAttribute("nombre","hTipoPeriodoHabilitado" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(20)).setAttribute("nombre","hPeriodoCorporativoHabilitado" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(21)).setAttribute("nombre","hBotonDisponible" );
      ((Element)v.get(21)).setAttribute("valor","none" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(36)).setAttribute("nombre","Seleccion" );
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(40)).setAttribute("width","631" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(48)).setAttribute("nombre","lblCodigoPatron" );
   }
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(48)).setAttribute("cod","823" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(56)).setAttribute("nombre","lblFormulario" );
      ...
      ((Element)v.get(56)).setAttribute("cod","2285" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(71)).setAttribute("nombre","cmbFormulario" );
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(76)).setAttribute("colspan","9" );
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(80)).setAttribute("width","631" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(85)).setAttribute("nombre","lblMedioEnvio" );
      ...
      ((Element)v.get(85)).setAttribute("cod","913" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(89)).setAttribute("nombre","lblActivo" );
      ...
      ((Element)v.get(89)).setAttribute("cod","795" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(93)).setAttribute("nombre","lblIndicadorPatronPeriodo" );
      ...
      ((Element)v.get(93)).setAttribute("cod","965" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(100)).setAttribute("nombre","cmbMedioEnvio" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(105)).setAttribute("nombre","cmbActivo" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(110)).setAttribute("nombre","cmbIndicadorPatronPeriodo" );
      ...
      ((Element)v.get(110)).setAttribute("onchange","patronPeriodoOnChange();" );
   ...
   private void getXML450(Document doc) {
      ...
      /* Empieza nodo:114 / Elemento padre: 80   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(80)).appendChild((Element)v.get(114));

      /* Empieza nodo:115 / Elemento padre: 114   */
      v.add(doc.createElement("td"));
      ((Element)v.get(115)).setAttribute("colspan","9" );
      ...
      /* Empieza nodo:117 / Elemento padre: 37   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(37)).appendChild((Element)v.get(117));
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(119)).setAttribute("width","631" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(124)).setAttribute("nombre","lblTipoPeriodo" );
      ...
      ((Element)v.get(124)).setAttribute("cod","132" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(128)).setAttribute("nombre","lblPeriodoCorporativo" );
      ...
      ((Element)v.get(128)).setAttribute("cod","2511" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(135)).setAttribute("nombre","comboTipoPeriodo" );
      ...
      ((Element)v.get(135)).setAttribute("onchange","tipoPeriodoOnChange();" );
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(140)).setAttribute("nombre","comboPeriodoCorporativo" );
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(145)).setAttribute("colspan","9" );
      ...
      ((Element)v.get(157)).setAttribute("nombre","btnBuscar" );
      ((Element)v.get(157)).setAttribute("ID","botonContenido" );
      ((Element)v.get(157)).setAttribute("tipo","html" );
      ((Element)v.get(157)).setAttribute("accion","accionBuscar();" );
      ((Element)v.get(157)).setAttribute("estado","false" );
      ((Element)v.get(157)).setAttribute("cod","1" );
      ((Element)v.get(157)).setAttribute("ontab","ontab_Buscar();" );
      ...
      /* Empieza nodo:160 / Elemento padre: 22   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(22)).appendChild((Element)v.get(160));
   ...
   private void getXML630(Document doc) {
      ...
      ((Element)v.get(167)).setAttribute("nombre","listado1" );
      ((Element)v.get(167)).setAttribute("ancho","635" );
      ((Element)v.get(167)).setAttribute("alto","317" );
      ((Element)v.get(167)).setAttribute("x","12" );
      ((Element)v.get(167)).setAttribute("y","202" );
   ...
   private void getXML720(Document doc) {
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(183)).setAttribute("ancho","130" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(184)).setAttribute("ancho","130" );
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(185)).setAttribute("ancho","130" );
      ...
      ((Element)v.get(186)).setAttribute("ajustarAMitadInf","S" );
      ...
      ((Element)v.get(187)).setAttribute("cod","823" );
      ...
      ((Element)v.get(189)).setAttribute("cod","9" );
      ...
      ((Element)v.get(191)).setAttribute("cod","2285" );
      ...
      ((Element)v.get(193)).setAttribute("cod","913" );
      ...
      ((Element)v.get(195)).setAttribute("cod","795" );
      ...
      ((Element)v.get(197)).setAttribute("cod","965" );
      ...
      ((Element)v.get(199)).setAttribute("cod","132" );
   }
   ...
   private void getXML810(Document doc) {
      ...
      v.add(doc.createTextNode("Tipo de período"));
      ...
      /* Empieza nodo:212 / Elemento padre: 167   */
      v.add(doc.createElement("ROWSET"));
      ((Element)v.get(167)).appendChild((Element)v.get(212));
      /* Termina nodo:212   */

      /* Empieza nodo:213 / Elemento padre: 167   */
      v.add(doc.createElement("PAGINADO"));
      ((Element)v.get(213)).setAttribute("nombre","mipgndo" );
      ((Element)v.get(213)).setAttribute("ancho","635" );
      ((Element)v.get(213)).setAttribute("sep","$" );
      ((Element)v.get(213)).setAttribute("x","12" );
      ((Element)v.get(213)).setAttribute("class","botonera" );
      ((Element)v.get(213)).setAttribute("y","496" );
      ...
      ((Element)v.get(215)).setAttribute("y","500" );
   ...
   private void getXML900(Document doc) {
      ...
      ((Element)v.get(6)).appendChild((Element)v.get(217));
      /* Termina nodo:217   */

      /* Empieza nodo:218 / Elemento padre: 6   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(218)).setAttribute("nombre","Modificar" );
      ((Element)v.get(218)).setAttribute("x","80" );
      ((Element)v.get(218)).setAttribute("y","497" );
      ...
      ((Element)v.get(218)).setAttribute("cod","2" );
      ((Element)v.get(218)).setAttribute("accion","accionModificar();" );
      ((Element)v.get(218)).setAttribute("ontab","ontab_Modificar();" );
      ((Element)v.get(218)).setAttribute("onshtab","onshtab_Modificar();" );
      ((Element)v.get(6)).appendChild((Element)v.get(218));
      /* Termina nodo:218   */

      /* Empieza nodo:219 / Elemento padre: 6   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(219)).setAttribute("nombre","Detalle" );
      ((Element)v.get(219)).setAttribute("x","80" );
      ((Element)v.get(219)).setAttribute("y","497" );
      ...
      ((Element)v.get(219)).setAttribute("cod","3" );
      ((Element)v.get(219)).setAttribute("accion","accionDetalle();" );
      ((Element)v.get(219)).setAttribute("ontab","ontab_Detalle();" );
      ((Element)v.get(219)).setAttribute("onshtab","onshtab_Detalle();" );
      ((Element)v.get(6)).appendChild((Element)v.get(219));
      /* Termina nodo:219   */

      /* Empieza nodo:220 / Elemento padre: 6   */
      ...
      ((Element)v.get(220)).setAttribute("y","519" );
      ((Element)v.get(220)).setAttribute("zindex","" );
      ((Element)v.get(6)).appendChild((Element)v.get(220));
      /* Termina nodo:220   */
      /* Termina nodo:6   */
