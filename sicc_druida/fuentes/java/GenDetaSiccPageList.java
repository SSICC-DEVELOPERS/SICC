...
public class GenDetaSiccPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","genDetaSiccList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(16)).setAttribute("cod","GenDetaSicc.enti.label" );
      ...
      ((Element)v.get(17)).setAttribute("cod","GenDetaSicc.entiPk.label" );
      ...
      ((Element)v.get(18)).setAttribute("cod","GenDetaSicc.atri.label" );
      ...
      ((Element)v.get(19)).setAttribute("cod","GenDetaSicc.deta.label" );
      ...
      ((Element)v.get(20)).setAttribute("cod","GenDetaSicc.idioOidIdio.label" );
