...
public class contenido_flujo_clientes_gerente_zona_obtener  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_flujo_clientes_gerente_zona_obtener" );
      ((Element)v.get(0)).setAttribute("cod","0742" );
      ((Element)v.get(0)).setAttribute("titulo","Obtener flujo de clientes por gerente de zona" );
      ...
      v.add(doc.createTextNode("\r   \r   \r   function onLoad(){\r      configurarMenuSecundario('Formulario');\r      fMostrarMensajeError();\r      focaliza('Formulario.cbPais');\r   }\r   function generar(){\r      \r      /*recolectarParametros();\r      \r      set('Formulario.conectorAction', 'LPFlujoClientesGerenteZona');           \r      set('Formulario.accion', 'generar');\r      \r      enviaSICC('Formulario');*/\r      var a = new Object();\r      a.accion = 'generar';\r      a.marca = get('Formulario.cbMarca');\r      a.canal = get('Formulario.cbCanal');\r      a.periodo = get('Formulario.cbPeriodoCierre');\r      a.periodoDesc = get('Formulario.cbPeriodoCierre', 'T');\r      a.subgerencia = get('Formulario.cbSubgerenciaVentas');\r      a.region = get('Formulario.cbRegion');\r      a.zona = get('Formulario.cbZona');\r      a.seccion = get('Formulario.cbSeccion');\r      a.territorio = get('Formulario.cbTerritorio');\r      a.codigoCliente = get('Formulario.txtCodCliente');          \r      mostrarModalSICC('LPFlujoClientesGerenteZona','generar', a);  \r\r   }\r   function buscarCliente(){ \r      var obj = new Object();\r\r      var whnd = mostrarModalSICC('LPBusquedaRapidaCliente','',obj);\r    \r      if(whnd==null){\r               }else{\r         var cod = whnd[1];\r                  set('Formulario.txtCodCliente', cod)\r      }		\r   }\r   \r\r function recargaRegiones(){\r      limpiarRegion();\r      if(get('Formulario.cbSubgerenciaVentas') != ''){\r         recargaCombo(\"Formulario.cbRegion\",\"ZONRecargaRegiones\", \"es.indra.sicc.dtos.zon.DTOUnidadAdministrativa\",[[\"oidSGV\", get('Formulario.cbSubgerenciaVentas')]]);        \r      }\r   \r   }\r   \r    function onchange_Region(){\r        limpiarZona();\r        if(get('Formulario.cbRegion') != ''){\r             recargaCombo('Formulario.cbZona', 'ZONRecargaZonas', 'es.indra.sicc.dtos.zon.DTOUnidadAdministrativa',[[ \"oidRegion\", get('Formulario.cbRegion') ]] );\r        }\r    }\r\r   function onchange_Zona(){\r		limpiarSeccion();\r		if(get('Formulario.cbZona') != ''){\r			var arr = new Array();\r			arr[arr.length] = ['cadena', get('Formulario.cbRegion')];\r			arr[arr.length] = ['oidPais', get('Formulario.cbPais')];\r			recargaCombo(\"Formulario.cbSeccion\", \"REPRecargaSecciones\", \"es.indra.sicc.util.DTOString\",arr);\r		} \r   }\r   \r\r function onchange_Seccion(){\r	limpiarTerritorio();\r	if(get('Formulario.cbSeccion')!= ''){\r		var arr = new Array();\r		arr[arr.length] = ['cadena', get('Formulario.cbSeccion')];\r		arr[arr.length] = ['oidPais', get('Formulario.cbPais')];\r		recargaCombo(\"Formulario.cbTerritorio\", \"REPRecargaTerrPorSecciones\", \"es.indra.sicc.util.DTOString\",arr);\r	}     \r }\r   \r\r   function limpiarRegion(){\r      var aCombo = new Array(new Array(\"\",\"\"));\r      set_combo('Formulario.cbRegion', aCombo, []);\r      set_combo('Formulario.cbZona', aCombo, []);\r      set_combo('Formulario.cbSeccion', aCombo, []);\r      set_combo('Formulario.cbTerritorio', aCombo, []);\r   }\r   \r\r   function limpiarZona(){\r      var aCombo = new Array(new Array(\"\",\"\"));\r      set_combo('Formulario.cbZona', aCombo, []);\r      set_combo('Formulario.cbSeccion', aCombo, []);\r      set_combo('Formulario.cbTerritorio', aCombo, []);\r   }\r   \r\r   function limpiarSeccion(){\r      var aCombo = new Array(new Array(\"\",\"\"));\r      set_combo('Formulario.cbSeccion', aCombo, []); \r      set_combo('Formulario.cbTerritorio', aCombo, []);\r   }\r\r\r   function limpiarTerritorio(){\r      var aCombo = new Array(new Array(\"\",\"\"));\r      set_combo('Formulario.cbTerritorio', aCombo, []);\r   }\r   \r\r\r   function recargaPeriodo(){\r   \r      var marca = get(\"Formulario.cbMarca\");\r      var canal = get(\"Formulario.cbCanal\");\r      var pais = get(\"Formulario.pais\");\r      var idioma = get(\"Formulario.idioma\");\r      \r      var arr = new Array();\r      var arr2 = new Array();\r      \r      arr[arr.length] = [\"oidIdioma\", idioma]; \r      arr[arr.length] = [\"oidPais\", pais]; \r      arr[arr.length] = [\"marca\", marca];\r      arr[arr.length] = [\"canal\", canal];\r      \r      arr2[arr2.length] = [\"oidIdioma\", idioma]; \r      arr2[arr2.length] = [\"oidPais\", pais]; \r      arr2[arr2.length] = [\"oidMarca\", marca]; \r      arr2[arr2.length] = [\"oidCanal\", canal]; \r      \r      if ( marca != \"\" && canal != \"\"){\r         \r         recargaCombo(\"Formulario.cbPeriodoCierre\",\"PRECargarPeriodos\",\"es.indra.sicc.dtos.cra.DTOPeriodo\",arr);\r         recargaCombo(\"Formulario.cbSubgerenciaVentas\",\"ZONRecargaSubgerenciaVentas\", \"es.indra.sicc.dtos.zon.DTOUnidadAdministrativa\",arr2);\r        \r      }else{\r         var aCombo = new Array(new Array(\"\",\"\"));\r         set_combo('Formulario.cbPeriodoCierre', aCombo, []);\r         set_combo('Formulario.cbSubgerenciaVentas', aCombo, []);\r         limpiarRegion();\r      \r      }\r   }\r   function fLimpiar(){\r     limpiarZona();  \r     var aCombo = new Array(new Array(\"\",\"\"));\r     set_combo('Formulario.cbPeriodoCierre', aCombo, []);\r     set_combo('Formulario.cbSubgerenciaVentas', aCombo, []);\r     \r   }\r  \r\r   function recolectarParametros(){\r      \r      set('Formulario.marca', get('Formulario.cbMarca') );\r      set('Formulario.canal', get('Formulario.cbCanal'));\r      set('Formulario.periodo', get('Formulario.cbPeriodoCierre'));\r      set('Formulario.subgerencia', get('Formulario.cbSubgerenciaVentas'));\r      set('Formulario.region', get('Formulario.cbRegion'));\r      set('Formulario.zona', get('Formulario.cbZona'));\r      set('Formulario.seccion', get('Formulario.cbSeccion'));\r      set('Formulario.territorio', get('Formulario.cbTerritorio'));\r      set('Formulario.codigoCliente', get('Formulario.txtCodCliente'));\r  \r   }\r   \r   \r  function clienteOnBlur() {\r\r        var longiCod = get('Formulario.hLongCliente');\r        var elTexto  = get('Formulario.txtCodCliente');\r\r        if(elTexto.length!=0){\r           var faltantes = longiCod -  elTexto.length;\r           var resultCod = new String(\"\");\r           if(faltantes > 0){\r              for(var t = 0 ; t<faltantes; t++){\r                  resultCod = resultCod + \"0\";\r              }\r         }\r         resultCod = resultCod + elTexto;\r         set('Formulario.txtCodCliente', resultCod);\r        }\r             \r   }\r   \r"));
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(16)).setAttribute("nombre","periodo" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(17)).setAttribute("nombre","subgerencia" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(21)).setAttribute("nombre","territorio" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(83)).setAttribute("onchange","recargaPeriodo();" );
      ...
      ((Element)v.get(88)).setAttribute("onchange","recargaPeriodo();" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(113)).setAttribute("nombre","cbPeriodoCierre" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(118)).setAttribute("onchange","recargaRegiones();" );
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(143)).setAttribute("nombre","cbRegion" );
      ...
      ((Element)v.get(143)).setAttribute("onchange","onchange_Region();" );
      ...
      ((Element)v.get(148)).setAttribute("onchange","onchange_Zona();" );
      ...
      /* Empieza nodo:155 / Elemento padre: 40   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(40)).appendChild((Element)v.get(155));
   ...
   private void getXML630(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(177)).setAttribute("nombre","cbSeccion" );
      ...
      ((Element)v.get(177)).setAttribute("onchange","onchange_Seccion();" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(182)).setAttribute("nombre","cbTerritorio" );
   ...
   private void getXML720(Document doc) {
      ...
      v.add(doc.createElement("IMG"));
      ((Element)v.get(191)).setAttribute("src","iconBuscar.gif" );
      ((Element)v.get(191)).setAttribute("onclick","buscarCliente();" );
      ...
      /* Empieza nodo:197 / Elemento padre: 33   */
      v.add(doc.createElement("td"));
      ((Element)v.get(33)).appendChild((Element)v.get(197));
      ...
      /* Empieza nodo:199 / Elemento padre: 25   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(25)).appendChild((Element)v.get(199));
      ...
      ((Element)v.get(207)).setAttribute("accion","generar();" );
      ...
      /* Empieza nodo:210 / Elemento padre: 25   */
   }

   private void getXML810(Document doc) {
      v.add(doc.createElement("tr"));
      ((Element)v.get(25)).appendChild((Element)v.get(210));
