...
public class contenido_informe_cronograma_regional_generar  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_informe_cronograma_regional_generar" );
      ((Element)v.get(0)).setAttribute("cod","0770" );
      ((Element)v.get(0)).setAttribute("titulo","Generar informe cronograma por regional" );
      ...
      v.add(doc.createTextNode("\r   \r   \r   function onLoad(){\r      configurarMenuSecundario('Formulario');\r      fMostrarMensajeError();\r      \r      focaliza('Formulario.cbCanal');\r   }\r   function generar(){\r      \r      if(sicc_validaciones_generales()){\r       \r            /*recolectarParametros();\r      \r            set('Formulario.conectorAction', 'CRACronoRegional');           \r            set('Formulario.accion', 'generar');\r      \r            enviaSICC('Formulario');*/\r            var a = new Object();\r            a.accion = 'generar';\r            a.marca = get('Formulario.cbMarca');  \r            a.canal = get('Formulario.cbCanal');\r            a.actividad = quitarItemVacio(get('Formulario.cbActividad'));\r            a.periodo = get('Formulario.cbPeriodo');\r            a.region = get('Formulario.cbRegion');        \r            mostrarModalSICC('CRACronoRegional','generar', a);  \r        \r      }\r\r   }\r\r   function recolectarParametros(){\r      \r      \r      \r      set('Formulario.marca', get('Formulario.cbMarca') );  \r      set('Formulario.canal', get('Formulario.cbCanal'));\r      set('Formulario.actividad', quitarItemVacio(get('Formulario.cbActividad')));\r      set('Formulario.periodo', get('Formulario.cbPeriodo'));\r      set('Formulario.region', get('Formulario.cbRegion'));\r      \r          \r      \r  \r   }\r   \r\r   function quitarItemVacio(elemento){\r      var elementoADevolver = new Array();\r           \r      for(var k=0;k<elemento.length;k++) {\r         if (elemento[k] != ''){ 			 \r            elementoADevolver[elementoADevolver.length] = elemento[k];\r         }\r      }\r            \r      return elementoADevolver;\r      \r   }\r\r \r   \r\r   function fLimpiar(){\r      var aCombo = new Array(new Array(\"\",\"\"));\r      set_combo('Formulario.cbActividad', aCombo, []);\r      set_combo('Formulario.cbPeriodo', aCombo, []);\r      set_combo('Formulario.cbRegion', aCombo, []);\r      focaliza('Formulario.cbCanal');\r \r   }\r   \r    function onchangeMarcaCanal(){\r       \r       marca  = get('Formulario.cbMarca');\r       canal  = get('Formulario.cbCanal');\r       pais   = get('Formulario.pais');\r       idioma = get('Formulario.idioma')\r       \r       if(marca != '' && canal != ''){\r                \r          var arr = new Array();\r          var arr2 = new Array();\r              \r          arr[arr.length] = [\"oidIdioma\", idioma]; \r          arr[arr.length] = [\"oidPais\", pais]; \r          arr[arr.length] = [\"marca\", marca];\r          arr[arr.length] = [\"canal\", canal];\r\r\r          arr2[arr2.length] = ['oidMarca', marca];\r          arr2[arr2.length] = ['oidCanal', canal];\r          arr2[arr2.length] = ['oidPais', pais];\r          arr2[arr2.length] = ['oidIdioma', idioma];\r          \r                   \r       \r          recargaCombo(\"Formulario.cbActividad\",\"CRAObtieneActividad\", \"es.indra.sicc.dtos.cra.DTOActividad\", arr2); \r          recargaCombo(\"Formulario.cbPeriodo\",\"PRECargarPeriodos\",\"es.indra.sicc.dtos.cra.DTOPeriodo\",arr);\r          recargaCombo(\"Formulario.cbRegion\",\"ZONRecargaRegiones\", \"es.indra.sicc.dtos.zon.DTOUnidadAdministrativa\",arr2);        \r          \r       \r       }else{\r         var aCombo = new Array(new Array(\"\",\"\"));\r         set_combo('Formulario.cbActividad', aCombo, []);\r         set_combo('Formulario.cbPeriodo', aCombo, []);\r         set_combo('Formulario.cbRegion', aCombo, []);\r       \r       }\r   \r    }  \r\r\r   \r"));
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(24)).setAttribute("nombre","region" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(102)).setAttribute("nombre","cbActividad" );
      ...
      /* Empieza nodo:114 / Elemento padre: 34   */
      v.add(doc.createElement("td"));
      ((Element)v.get(34)).appendChild((Element)v.get(114));
      ...
      /* Empieza nodo:116 / Elemento padre: 26   */
      v.add(doc.createElement("tr"));
   }

   private void getXML450(Document doc) {
      ((Element)v.get(26)).appendChild((Element)v.get(116));
      ...
      /* Empieza nodo:127 / Elemento padre: 26   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(26)).appendChild((Element)v.get(127));
