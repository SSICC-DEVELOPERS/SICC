...
public class MaeTipoVincuPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","maeTipoVincuList" );
      ...
      ((Element)v.get(14)).setAttribute("cod","MaeTipoVincu.codTipoVinc.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","MaeTipoVincu.Descripcion.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","MaeTipoVincu.indReco.label" );
