...
public class ConectorConsultarAsignacionProductosAnaqueles  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","APE Conector Consultar Asignacion Productos Anaqueles" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","DTOConsultaOrdenada" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","OID_ASIG_PROD_ANAQ" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(8)).setAttribute("NOMBRE","NUM_ANAQ" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(10)).setAttribute("NOMBRE","DESC_PROD" );
