...
public class CarJerarPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","CarJerar.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","CarJerar.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('carJerarFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('carJerarFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(50)).setAttribute("nombre","codJeraTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(54)).setAttribute("nombre","lblCodJera" );
      ((Element)v.get(54)).setAttribute("alto","13" );
      ((Element)v.get(54)).setAttribute("filas","1" );
      ((Element)v.get(54)).setAttribute("id","datosTitle" );
      ((Element)v.get(54)).setAttribute("cod","CarJerar.codJera.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(55)).setAttribute("nombre","codJeraWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(57)).setAttribute("nombre","codJera" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('carJerarFrm',2, true)" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('carJerarFrm', 2, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(58)).setAttribute("nombre","codJeraGapTdId" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(60)).setAttribute("nombre","numDiasTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(65)).setAttribute("nombre","numDiasWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(67)).setAttribute("nombre","numDias" );
      ...
      ((Element)v.get(67)).setAttribute("ontab","ejecutarAccionFoco('carJerarFrm',3, true)" );
      ((Element)v.get(67)).setAttribute("onshtab","ejecutarAccionFoco('carJerarFrm', 3, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(68)).setAttribute("nombre","numDiasGapTdId" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(70)).setAttribute("nombre","valPorcLineCredTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(74)).setAttribute("nombre","lblValPorcLineCred" );
      ((Element)v.get(74)).setAttribute("alto","13" );
      ((Element)v.get(74)).setAttribute("filas","1" );
      ((Element)v.get(74)).setAttribute("id","datosTitle" );
      ((Element)v.get(74)).setAttribute("cod","CarJerar.valPorcLineCred.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(75)).setAttribute("nombre","valPorcLineCredWidgetTrId" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(77)).setAttribute("nombre","valPorcLineCred" );
      ((Element)v.get(77)).setAttribute("id","datosCampos" );
      ((Element)v.get(77)).setAttribute("trim","S" );
      ((Element)v.get(77)).setAttribute("max","5" );
      ...
      ((Element)v.get(77)).setAttribute("ontab","ejecutarAccionFoco('carJerarFrm',4, true)" );
      ((Element)v.get(77)).setAttribute("onshtab","ejecutarAccionFoco('carJerarFrm', 4, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(78)).setAttribute("nombre","valPorcLineCredGapTdId" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(80)).setAttribute("nombre","valPorcMontMaxiTdId" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(84)).setAttribute("nombre","lblValPorcMontMaxi" );
      ((Element)v.get(84)).setAttribute("alto","13" );
      ((Element)v.get(84)).setAttribute("filas","1" );
      ((Element)v.get(84)).setAttribute("id","datosTitle" );
      ((Element)v.get(84)).setAttribute("cod","CarJerar.valPorcMontMaxi.label" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(85)).setAttribute("nombre","valPorcMontMaxiWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(87)).setAttribute("nombre","valPorcMontMaxi" );
      ...
      ((Element)v.get(87)).setAttribute("ontab","ejecutarAccionFoco('carJerarFrm',5, true)" );
      ((Element)v.get(87)).setAttribute("onshtab","ejecutarAccionFoco('carJerarFrm', 5, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(88)).setAttribute("nombre","valPorcMontMaxiGapTdId" );
      ...
      /* Empieza nodo:92 / Elemento padre: 44   */
      v.add(doc.createElement("TD"));
      ((Element)v.get(92)).setAttribute("width","100%" );
      ((Element)v.get(44)).appendChild((Element)v.get(92));
      /* Termina nodo:92   */
      /* Termina nodo:44   */
   ...
   private void getXML450(Document doc) {
      ...
      /* Empieza nodo:102 / Elemento padre: 0   */
      v.add(doc.createElement("TR"));
      ((Element)v.get(102)).setAttribute("nombre","carJerarTrButtons" );
      ((Element)v.get(0)).appendChild((Element)v.get(102));
      ...
      ((Element)v.get(109)).setAttribute("nombre","carJerarTdQueryButton" );
      ((Element)v.get(108)).appendChild((Element)v.get(109));

      /* Empieza nodo:110 / Elemento padre: 109   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(110)).setAttribute("nombre","carJerarQueryButton" );
      ((Element)v.get(110)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(110)).setAttribute("estado","false" );
      ((Element)v.get(110)).setAttribute("accion","carJerarFirstPage();" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(111)).setAttribute("class","tablaTitle" );
      ((Element)v.get(111)).setAttribute("nombre","carJerarTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(113)).setAttribute("nombre","carJerarLovNullButton" );
      ((Element)v.get(113)).setAttribute("ID","botonContenido" );
      ((Element)v.get(113)).setAttribute("tipo","html" );
      ((Element)v.get(113)).setAttribute("accion","carJerarLovNullSelectionAction();" );
   }

   private void getXML540(Document doc) {
      ((Element)v.get(113)).setAttribute("estado","true" );
      ((Element)v.get(113)).setAttribute("cod","MMGGlobal.lovNullButton.label" );
