/*
    INDRA/CAR/mmg
    $Id: CobTipoBalanLPStartUp.java,v 1.1 2009/12/03 18:38:28 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class CobTipoBalanLPStartUp extends MMGDruidaBase{
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "CobTipoBalanPage", "cod", "CobTipoBalan." + accion + ".label");
			...
			limpiarBotoneraLista("cobTipoBalan", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codTipoBala", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 1);");
		
		//Primero determianmos el nombre del campo en la entidad de oriegen donde se van a cargar los datos
		asignar("VAR", "idAttributeLovOpener", conectorParametro(PARAMETRO_LOV_ATTRIBUTO));
		asignar("VAR", "idEntityLovOpener", conectorParametro(PARAMETRO_LOV_ENTIDAD));
		//asignarAtributo("CAPA", "cobTipoBalanLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "CobTipoBalanPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		CobTipoBalanData cobTipoBalanQuery= new CobTipoBalanData();
		cobTipoBalanQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		CobTipoBalanData datosResult = (CobTipoBalanData)getSingleObject(BUSINESSID_QUERY, cobTipoBalanQuery, 
			cobTipoBalanQuery.clone(), "cobTipoBalan");
		...
		preservaHiddensI18n(new Integer(1), "COB_TIPO_BALAN", "cobTipoBalanFrm", "Descripcion", true);
		...
		CobTipoBalanData cobTipoBalan = datosResult;
		asignar("TEXT", "codTipoBala", FormatUtils.formatObject(cobTipoBalan.getCodTipoBala(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "Descripcion", FormatUtils.formatObject(cobTipoBalan.getDescripcion(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		loadLocalizationVars(cobTipoBalan);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "codTipoBala", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "COB_TIPO_BALAN", "cobTipoBalanFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "codTipoBala", "req", "S");
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('cobTipoBalanFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "cobTipoBalanFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		CobTipoBalanData cobTipoBalanQuery= new CobTipoBalanData();
		cobTipoBalanQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(cobTipoBalan.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"cobTipoBalanFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"cobTipoBalanFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codTipoBala", "ontab","ejecutarAccionFocoModificacion(\"cobTipoBalanFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codTipoBala", "onshtab","ejecutarAccionFocoModificacion(\"cobTipoBalanFrm\",2, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"cobTipoBalanFrm\",4, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"cobTipoBalanFrm\",4, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","cobTipoBalanTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","cobTipoBalanTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codTipoBala...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","cobTipoBalanFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","cobTipoBalanListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","cobTipoBalanListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(CobTipoBalanData cobTipoBalan) throws Exception{
	...
	* @param cobTipoBalan La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(CobTipoBalanData cobTipoBalan) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		CobTipoBalanData cobTipoBalan = 
			(CobTipoBalanData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(cobTipoBalan);
		loadLeafDependenceCombos(cobTipoBalan);
	}
	...
	*/
	...
	protected void loadLocalizationVars(CobTipoBalanData cobTipoBalan) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("COB_TIPO_BALAN");
		mmgLocalizationQuery.setEntiPk(cobTipoBalan.getId());
