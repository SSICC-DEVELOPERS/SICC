...
public class CobEtapaDeudaTipoCargoPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","cobEtapaDeudaTipoCargoList" );
      ...
      ((Element)v.get(14)).setAttribute("cod","CobEtapaDeudaTipoCargo.etdeOidEtapDeud.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","CobEtapaDeudaTipoCargo.tcabOidTipoCargAbon.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","CobEtapaDeudaTipoCargo.valDesc.label" );
