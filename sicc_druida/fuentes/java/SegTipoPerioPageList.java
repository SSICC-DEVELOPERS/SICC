...
public class SegTipoPerioPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","segTipoPerioList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","SegTipoPerio.codTipoPeri.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","SegTipoPerio.Descripcion.label" );
      ...
      ((Element)v.get(17)).setAttribute("cod","SegTipoPerio.numDias.label" );
      ...
      ((Element)v.get(18)).setAttribute("cod","SegTipoPerio.numPeriAnio.label" );
