...
public class PedSubtiPosicPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","pedSubtiPosicList" );
      ...
      ((Element)v.get(14)).setAttribute("cod","PedSubtiPosic.codSubtPosi.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","PedSubtiPosic.tposOidTipoPosi.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","PedSubtiPosic.Descripcion.label" );
