/*
    INDRA/CAR/mmg
    $Id: RecMotivRechaDesblLPStartUp.java,v 1.1 2009/12/03 18:38:48 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class RecMotivRechaDesblLPStartUp extends MMGDruidaBase{
	...
	public RecMotivRechaDesblLPStartUp(){
		super();
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			buildJsPageSize("RecMotivRechaDesbl");
			...
			asignarAtributo("PAGINA", "RecMotivRechaDesblPage", "cod", "RecMotivRechaDesbl." + accion + ".label");
			...
			limpiarBotoneraLista("recMotivRechaDesbl", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codRechDesb", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 2);");
		...
		//asignarAtributo("CAPA", "recMotivRechaDesblLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "RecMotivRechaDesblPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		RecMotivRechaDesblData recMotivRechaDesblQuery= new RecMotivRechaDesblData();
		recMotivRechaDesblQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		RecMotivRechaDesblData datosResult = (RecMotivRechaDesblData)getSingleObject(BUSINESSID_QUERY, recMotivRechaDesblQuery, 
			recMotivRechaDesblQuery.clone(), "recMotivRechaDesbl");
		...
		preservaHiddensI18n(new Integer(1), "REC_MOTIV_RECHA_DESBL", "recMotivRechaDesblFrm", "Descripcion", true);
		...
		RecMotivRechaDesblData recMotivRechaDesbl = datosResult;
		asignar("TEXT", "codRechDesb", FormatUtils.formatObject(recMotivRechaDesbl.getCodRechDesb(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "Descripcion", FormatUtils.formatObject(recMotivRechaDesbl.getDescripcion(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		loadLocalizationVars(recMotivRechaDesbl);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "codRechDesb", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "REC_MOTIV_RECHA_DESBL", "recMotivRechaDesblFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "codRechDesb", "req", "S");
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('recMotivRechaDesblFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "recMotivRechaDesblFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		RecMotivRechaDesblData recMotivRechaDesblQuery= new RecMotivRechaDesblData();
		recMotivRechaDesblQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(recMotivRechaDesbl.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"recMotivRechaDesblFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"recMotivRechaDesblFrm\",1, false)");
					asignarAtributo("COMBO","paisOidPais", "ontab", "ejecutarAccionFocoModificacion(\"recMotivRechaDesblFrm\",2, true)");
					asignarAtributo("COMBO","paisOidPais", "onshtab", "ejecutarAccionFocoModificacion(\"recMotivRechaDesblFrm\",2, false)");
				asignarAtributo("AREATEXTO", "codRechDesb", "ontab","ejecutarAccionFocoModificacion(\"recMotivRechaDesblFrm\",3, true)");
				asignarAtributo("AREATEXTO", "codRechDesb", "onshtab","ejecutarAccionFocoModificacion(\"recMotivRechaDesblFrm\",3, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"recMotivRechaDesblFrm\",4, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"recMotivRechaDesblFrm\",4, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","recMotivRechaDesblTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","recMotivRechaDesblTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","recMotivRechaDesblFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","recMotivRechaDesblListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","recMotivRechaDesblListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(RecMotivRechaDesblData recMotivRechaDesbl) throws Exception{
		...
		if(recMotivRechaDesbl != null && recMotivRechaDesbl.getPaisOidPais() != null){
				checkCombo("paisOidPais" , recMotivRechaDesbl.getPaisOidPais().getId().toString());
			}
	...
	* @param recMotivRechaDesbl La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(RecMotivRechaDesblData recMotivRechaDesbl) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		RecMotivRechaDesblData recMotivRechaDesbl = 
			(RecMotivRechaDesblData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(recMotivRechaDesbl.getPaisOidPais() != null){
			recMotivRechaDesbl.setPaisOidPais((es.indra.belcorp.mso.SegPaisViewData)
			getSingleObject(BUSINESSID_PAISOIDPAIS_QUERY, 
			recMotivRechaDesbl.getPaisOidPais(),
			recMotivRechaDesbl.getPaisOidPais().clone(),
			"segPaisView"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(recMotivRechaDesbl);
		loadLeafDependenceCombos(recMotivRechaDesbl);
	}
	...
	*/
	...
	protected void loadLocalizationVars(RecMotivRechaDesblData recMotivRechaDesbl) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("REC_MOTIV_RECHA_DESBL");
		mmgLocalizationQuery.setEntiPk(recMotivRechaDesbl.getId());
