...
public class contenido_niveles_segmentos  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_niveles_segmentos" );
      ((Element)v.get(0)).setAttribute("cod","01018" );
      ...
      ((Element)v.get(12)).setAttribute("valor","FACDTRNivelesSegmentos" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(19)).setAttribute("nombre","lp" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(79)).setAttribute("nombre","cbPeriodo" );
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(84)).setAttribute("colspan","7" );
      ...
      /* Empieza nodo:86 / Elemento padre: 33   */
      v.add(doc.createElement("table"));
      ...
      ((Element)v.get(33)).appendChild((Element)v.get(86));
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(102)).setAttribute("onchange","onchangeRegion();" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(107)).setAttribute("nombre","cbZona" );
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(112)).setAttribute("colspan","7" );
      ...
      /* Empieza nodo:114 / Elemento padre: 29   */
      v.add(doc.createElement("td"));
      ((Element)v.get(29)).appendChild((Element)v.get(114));
      ...
      /* Empieza nodo:116 / Elemento padre: 21   */
   }

   private void getXML450(Document doc) {
      v.add(doc.createElement("tr"));
      ((Element)v.get(21)).appendChild((Element)v.get(116));
      ...
      ((Element)v.get(124)).setAttribute("accion","generar('pdf')" );
      ((Element)v.get(124)).setAttribute("estado","false" );
      ((Element)v.get(124)).setAttribute("cod","2495" );
      ((Element)v.get(124)).setAttribute("ontab","focaliza('Formulario.cbMarca')" );
      ...
      /* Empieza nodo:127 / Elemento padre: 21   */
      v.add(doc.createElement("tr"));
      ((Element)v.get(21)).appendChild((Element)v.get(127));
