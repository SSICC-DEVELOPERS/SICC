...
public class contenido_estados_consolidados_buscar_detalle_2  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_estados_consolidados_buscar_detalle_2" );
      ((Element)v.get(0)).setAttribute("cod","0691" );
      ((Element)v.get(0)).setAttribute("titulo","" );
      ((Element)v.get(0)).setAttribute("estilos","estilosB3.css" );
      ((Element)v.get(0)).setAttribute("colorf","#F0F0F0" );
      ((Element)v.get(0)).setAttribute("msgle","" );
      ((Element)v.get(0)).setAttribute("onload","inic();" );
      ...
      v.add(doc.createTextNode("\r     \r	 var postNom = \"\";\r\r    function inic() {\r      configurarMenuSecundario(\"formulario\");\r      btnProxy(5, '1'); \r\r      window.returnValue = \"\";\r		  if (get('formulario.hModificar') == 'true') {\r			   document.all[\"capa2\"].style.visibility='hidden';\r			   document.all[\"capaSinCod\"].style.visibility='';\r          postNom = \"Sin\";\r			   setMV('formulario.txtCodigoPlantilla','N');\r			   setMV('formulario.txtDescripcion2','N');\r         focaliza('formulario.txtDescripcion2Sin');\r		  } else {\r			   document.all[\"capa2\"].style.visibility='';\r			   document.all[\"capaSinCod\"].style.visibility='hidden';\r			   setMV('formulario.txtDescripcion2Sin','N');\r         focaliza('formulario.txtCodigoPlantilla');\r		  }\r\r      mostrarCodigoError();\r\r    }\r\r    function fVolver(){\r         window.close();\r    }\r\r   function mostrarCodigoError() {  \r	     \r		  var vErrCodigo = get('formulario.errCodigo');\r		  var vErrDescrip = get('formulario.errDescripcion');\r\r		  if (get('formulario.errDescripcion')!=''){\r      		var wnd = fMostrarMensajeError( vErrCodigo,vErrDescrip);\r	     }		\r   }\r    \r    function aceptar() {\r                \r			if (get('formulario.hModificar') == 'true') {\r				  if (!sicc_validaciones_generales(\"grupo2\")) {\r						focaliza('formulario.txtDescripcion2Sin');\r					  return;\r					}\r			} else {\r				  if (!sicc_validaciones_generales(\"grupo1\")) {\r					  return;\r					}\r			}\r        \r        var ar = \"\";\r        ar = ar + get('formulario.txtCodigoPlantilla'+postNom);\r        ar = ar + \"|#|\" + get('formulario.txtDescripcion2'+postNom);\r        window.returnValue = ar;\r        window.close();\r    }\r\r  function shtabCodigo() {\r         focalizaBotonHTML('botonContenido','btnAceptar2');\r  }\r\r  function shtabAceptar() {\r  	  if (get('formulario.hModificar') == 'true') \r      		focaliza('formulario.txtDescripcion2Sin');\r      else\r      		focaliza('formulario.txtDescripcion2');\r  }\r\r  function tabAceptar() {\r  	  if (get('formulario.hModificar') == 'true') \r      		focaliza('formulario.txtDescripcion2Sin');\r      else\r      		focaliza('formulario.txtCodigoPlantilla');\r  }\r\r  function tabDesc() {\r      focalizaBotonHTML('botonContenido','btnAceptar2');\r  }\r\r  function tabDescSin() {\r      focalizaBotonHTML('botonContenido','btnAceptar2Sin');\r  }\r\r  function shtabDescSin() {\r         focalizaBotonHTML('botonContenido','btnAceptar2Sin');\r  }\r\r  \r\r  \r  "));
      ...
      ((Element)v.get(5)).setAttribute("name","txtCodigoPlantilla" );
      ((Element)v.get(5)).setAttribute("required","true" );
      ((Element)v.get(5)).setAttribute("cod","716" );
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(6)).setAttribute("name","txtDescripcion2" );
      ...
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(7)).setAttribute("name","txtDescripcion2Sin" );
      ...
      v.add(doc.createElement("VAR"));
      ((Element)v.get(14)).setAttribute("nombre","hModificar" );
      ...
      ((Element)v.get(15)).setAttribute("nombre","capa2" );
   ...
   private void getXML90(Document doc) {
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(39)).setAttribute("nombre","lblCodigoPlantilla" );
      ...
      ((Element)v.get(39)).setAttribute("cod","716" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(43)).setAttribute("nombre","lblDescripcion2" );
      ...
      ((Element)v.get(43)).setAttribute("cod","9" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(50)).setAttribute("nombre","txtCodigoPlantilla" );
      ((Element)v.get(50)).setAttribute("id","datosCampos" );
      ((Element)v.get(50)).setAttribute("max","4" );
      ...
      ((Element)v.get(50)).setAttribute("onshtab","shtabCodigo();" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(70)).setAttribute("nombre","btnAceptar2" );
      ((Element)v.get(70)).setAttribute("ID","botonContenido" );
      ((Element)v.get(70)).setAttribute("tipo","html" );
      ((Element)v.get(70)).setAttribute("accion","aceptar();" );
      ((Element)v.get(70)).setAttribute("estado","false" );
      ((Element)v.get(70)).setAttribute("cod","12" );
      ((Element)v.get(70)).setAttribute("ontab","tabAceptar();" );
      ((Element)v.get(70)).setAttribute("onshtab","shtabAceptar();" );
      ...
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(80)).setAttribute("nombre","capaSinCod" );
      ((Element)v.get(80)).setAttribute("visibilidad","hidden" );
   ...
   private void getXML360(Document doc) {
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(98)).setAttribute("colspan","2" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(104)).setAttribute("nombre","lblDescripcion2Sin" );
      ...
      ((Element)v.get(104)).setAttribute("cod","9" );
      ...
      v.add(doc.createElement("CTEXTO"));
      ((Element)v.get(111)).setAttribute("nombre","txtDescripcion2Sin" );
      ...
      ((Element)v.get(111)).setAttribute("ontab","tabDescSin();" );
      ((Element)v.get(111)).setAttribute("onshtab","shtabDescSin();" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("td"));
      ((Element)v.get(115)).setAttribute("colspan","2" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(127)).setAttribute("nombre","btnAceptar2Sin" );
      ((Element)v.get(127)).setAttribute("ID","botonContenido" );
      ((Element)v.get(127)).setAttribute("tipo","html" );
      ((Element)v.get(127)).setAttribute("accion","aceptar();" );
      ((Element)v.get(127)).setAttribute("estado","false" );
      ((Element)v.get(127)).setAttribute("cod","12" );
      ((Element)v.get(127)).setAttribute("ontab","tabAceptar();" );
      ((Element)v.get(127)).setAttribute("onshtab","shtabAceptar();" );
