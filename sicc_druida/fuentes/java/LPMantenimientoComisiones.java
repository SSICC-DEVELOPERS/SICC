  ...
  private ComposerViewElementList crearParametrosEntrada(){
	...
	*/    
	...
	public void cargaBuscarAceptarModificacion() throws Exception 
	{
		...
		asignarAtributo("VAR", "varOidPais", "valor", sPais);
		asignarAtributo("VAR", "varOidIdioma", "valor", sIdioma);			
		// dmorello, 29/05/2006: Se setea el siguiente VAR para que los botones Modificar y Confirmar se activen según corresponda
   ...
   /**
     ...
     * @date 06/06/2005
     * @author pperanzola
     * Calcula las metas de una comisión seleccionada previamente 
        Proceso 
        ======== 
        Se crea DTOOID 
        DTOOID.oid = oidComision 
