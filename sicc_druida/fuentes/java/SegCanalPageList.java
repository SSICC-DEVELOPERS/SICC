...
public class SegCanalPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","segCanalList" );
      ...
      ((Element)v.get(14)).setAttribute("cod","SegCanal.codCana.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","SegCanal.Descripcion.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","SegCanal.tipeOidTipoPeri.label" );
