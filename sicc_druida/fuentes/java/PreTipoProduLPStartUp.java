/*
    INDRA/CAR/mmg
    $Id: PreTipoProduLPStartUp.java,v 1.1 2009/12/03 18:42:09 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class PreTipoProduLPStartUp extends MMGDruidaBase{
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "PreTipoProduPage", "cod", "PreTipoProdu." + accion + ".label");
			...
			limpiarBotoneraLista("preTipoProdu", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codTipoProd", "validacion", "mensaje = ValidaInt(cdos_trim(valor), 1, 0, 9);");
		asignarAtributo("TEXT", "desTipoProd", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 0, 30);");
		

		//Primero determianmos el nombre del campo en la entidad de oriegen donde se van a cargar los datos
		asignar("VAR", "idAttributeLovOpener", conectorParametro(PARAMETRO_LOV_ATTRIBUTO));
		asignar("VAR", "idEntityLovOpener", conectorParametro(PARAMETRO_LOV_ENTIDAD));
		//asignarAtributo("CAPA", "preTipoProduLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "PreTipoProduPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		PreTipoProduData preTipoProduQuery= new PreTipoProduData();
		preTipoProduQuery.setId(new Integer(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		PreTipoProduData datosResult = (PreTipoProduData)getSingleObject(BUSINESSID_QUERY, preTipoProduQuery, 
			preTipoProduQuery.clone(), "preTipoProdu");
		...
		PreTipoProduData preTipoProdu = datosResult;
		asignar("TEXT", "codTipoProd", FormatUtils.formatObject(preTipoProdu.getCodTipoProd(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), MMGDruidaHelper.getUserDecimalFormatSymbols(this)));
		asignar("TEXT", "desTipoProd", FormatUtils.formatObject(preTipoProdu.getDesTipoProd(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), MMGDruidaHelper.getUserDecimalFormatSymbols(this)));
		...
		asignarAtributo("TEXT", "codTipoProd", "disabled", "S");
		asignarAtributo("TEXT", "desTipoProd", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		...
		asignarAtributo("TEXT", "codTipoProd", "req", "S");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "preTipoProduFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		PreTipoProduData preTipoProduQuery= new PreTipoProduData();
		preTipoProduQuery.setId(new Integer(id));
		...
		//asignar("VAR","timestamp",Long.toString(preTipoProdu.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"preTipoProduFrm\",0, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"preTipoProduFrm\",0, false)");
				asignarAtributo("AREATEXTO", "codTipoProd", "ontab","ejecutarAccionFocoModificacion(\"preTipoProduFrm\",0, true)");
				asignarAtributo("AREATEXTO", "codTipoProd", "onshtab","ejecutarAccionFocoModificacion(\"preTipoProduFrm\",0, false)");
				asignarAtributo("AREATEXTO", "desTipoProd", "ontab","ejecutarAccionFocoModificacion(\"preTipoProduFrm\",0, true)");
				asignarAtributo("AREATEXTO", "desTipoProd", "onshtab","ejecutarAccionFocoModificacion(\"preTipoProduFrm\",0, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","preTipoProduTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","preTipoProduTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codTipoProd...");		
				
				traza("MMG: el atributo es desTipoProd...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","preTipoProduFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","preTipoProduListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","preTipoProduListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(PreTipoProduData preTipoProdu) throws Exception{
	...
	* @param preTipoProdu La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(PreTipoProduData preTipoProdu) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		PreTipoProduData preTipoProdu = 
			(PreTipoProduData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(preTipoProdu);
		loadLeafDependenceCombos(preTipoProdu);
	}
