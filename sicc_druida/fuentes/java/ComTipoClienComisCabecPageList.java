...
public class ComTipoClienComisCabecPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","comTipoClienComisCabecList" );
      ...
      ((Element)v.get(14)).setAttribute("cod","ComTipoClienComisCabec.codClas.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(15)).setAttribute("cod","ComTipoClienComisCabec.codSubc.label" );
      ...
      ((Element)v.get(16)).setAttribute("cod","ComTipoClienComisCabec.Descripcion.label" );
