/*
    INDRA/CAR/mmg
    $Id: BelMedioPagoLPStartUp.java,v 1.1 2009/12/03 18:40:00 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class BelMedioPagoLPStartUp extends MMGDruidaBase{
	...
	public static final String BUSINESSID_QUERY = "MMGBelMedioPagoQueryFromToUserPage";
				...
				public static final String BUSINESSID_TMEPOIDTIPOMEDIPAGO_QUERY ="MMGBelTipoMedioPagoQueryFromToUser";
				public static final String TMEPOIDTIPOMEDIPAGO_COMBO_CONNECTOR = "BelTipoMedioPagoConectorCombo";
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "BelMedioPagoPage", "cod", "BelMedioPago." + accion + ".label");
			...
			limpiarBotoneraLista("belMedioPago", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codMediPago", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 3);");
		...
		//asignarAtributo("CAPA", "belMedioPagoLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "BelMedioPagoPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		BelMedioPagoData belMedioPagoQuery= new BelMedioPagoData();
		belMedioPagoQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		BelMedioPagoData datosResult = (BelMedioPagoData)getSingleObject(BUSINESSID_QUERY, belMedioPagoQuery, 
			belMedioPagoQuery.clone(), "belMedioPago");
		...
		preservaHiddensI18n(new Integer(1), "BEL_MEDIO_PAGO", "belMedioPagoFrm", "Descripcion", true);
		...
		BelMedioPagoData belMedioPago = datosResult;
		asignar("TEXT", "codMediPago", FormatUtils.formatObject(belMedioPago.getCodMediPago(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "Descripcion", FormatUtils.formatObject(belMedioPago.getDescripcion(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		es.indra.belcorp.mso.BelTipoMedioPagoData tmepOidTipoMediPago = belMedioPago.getTmepOidTipoMediPago();
		if(tmepOidTipoMediPago != null && tmepOidTipoMediPago.getId() != null) checkCombo("tmepOidTipoMediPago" , tmepOidTipoMediPago.getId().toString());
		...
		loadLocalizationVars(belMedioPago);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "codMediPago", "disabled", "S");
		asignarAtributo("TEXT", "Descripcion", "disabled", "S");
		
					asignarAtributo("COMBO", "tmepOidTipoMediPago", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "BEL_MEDIO_PAGO", "belMedioPagoFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "codMediPago", "req", "S");
		asignarAtributo("TEXT", "Descripcion", "req", "S");
		asignarAtributo("COMBO", "tmepOidTipoMediPago", "req", "S");
		
		
		//Asiganamos a los campos internacionalizables la función de onblur para actualizar el 
		//valor del idioma por defecto
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('belMedioPagoFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "belMedioPagoFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		BelMedioPagoData belMedioPagoQuery= new BelMedioPagoData();
		belMedioPagoQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(belMedioPago.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"belMedioPagoFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"belMedioPagoFrm\",1, false)");
					asignarAtributo("COMBO","paisOidPais", "ontab", "ejecutarAccionFocoModificacion(\"belMedioPagoFrm\",2, true)");
					asignarAtributo("COMBO","paisOidPais", "onshtab", "ejecutarAccionFocoModificacion(\"belMedioPagoFrm\",2, false)");
				asignarAtributo("AREATEXTO", "codMediPago", "ontab","ejecutarAccionFocoModificacion(\"belMedioPagoFrm\",3, true)");
				asignarAtributo("AREATEXTO", "codMediPago", "onshtab","ejecutarAccionFocoModificacion(\"belMedioPagoFrm\",3, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"belMedioPagoFrm\",4, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"belMedioPagoFrm\",4, false)");
					asignarAtributo("COMBO","tmepOidTipoMediPago", "ontab", "ejecutarAccionFocoModificacion(\"belMedioPagoFrm\",5, true)");
					asignarAtributo("COMBO","tmepOidTipoMediPago", "onshtab", "ejecutarAccionFocoModificacion(\"belMedioPagoFrm\",5, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","belMedioPagoTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","belMedioPagoTrButtons");
	...
	*/
	protected void removeNonSearchElements() throws Exception{
		borrarCampo("id");
		borrarCampo("paisOidPais");
		borrarCampo("tmepOidTipoMediPago");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","belMedioPagoFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","belMedioPagoListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","belMedioPagoListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(BelMedioPagoData belMedioPago) throws Exception{
		...
		if(belMedioPago != null && belMedioPago.getPaisOidPais() != null){
				checkCombo("paisOidPais" , belMedioPago.getPaisOidPais().getId().toString());
			}
		...
		BelTipoMedioPagoData tmepOidTipoMediPago = new BelTipoMedioPagoData();
		
						asignarComboResultados(BUSINESSID_TMEPOIDTIPOMEDIPAGO_QUERY,TMEPOIDTIPOMEDIPAGO_COMBO_CONNECTOR, 
			tmepOidTipoMediPago, tmepOidTipoMediPago.clone(), "belTipoMedioPago", "tmepOidTipoMediPago", "result_ROWSET" );
		if(belMedioPago != null && belMedioPago.getTmepOidTipoMediPago() != null){
				checkCombo("tmepOidTipoMediPago" , belMedioPago.getTmepOidTipoMediPago().getId().toString());
			}
	...
	* @param belMedioPago La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(BelMedioPagoData belMedioPago) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		BelMedioPagoData belMedioPago = 
			(BelMedioPagoData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(belMedioPago.getPaisOidPais() != null){
			belMedioPago.setPaisOidPais((es.indra.belcorp.mso.SegPaisViewData)
			getSingleObject(BUSINESSID_PAISOIDPAIS_QUERY, 
			belMedioPago.getPaisOidPais(),
			belMedioPago.getPaisOidPais().clone(),
			"segPaisView"));
		}
		if(belMedioPago.getTmepOidTipoMediPago() != null){
			belMedioPago.setTmepOidTipoMediPago((es.indra.belcorp.mso.BelTipoMedioPagoData)
			getSingleObject(BUSINESSID_TMEPOIDTIPOMEDIPAGO_QUERY, 
			belMedioPago.getTmepOidTipoMediPago(),
			belMedioPago.getTmepOidTipoMediPago().clone(),
			"belTipoMedioPago"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(belMedioPago);
		loadLeafDependenceCombos(belMedioPago);
	}
	...
	*/
	...
	protected void loadLocalizationVars(BelMedioPagoData belMedioPago) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("BEL_MEDIO_PAGO");
		mmgLocalizationQuery.setEntiPk(belMedioPago.getId());
