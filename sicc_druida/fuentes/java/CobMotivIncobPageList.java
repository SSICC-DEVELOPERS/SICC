...
public class CobMotivIncobPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","cobMotivIncobList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","CobMotivIncob.codMotiCobr.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","CobMotivIncob.valDescMotiCobr.label" );
