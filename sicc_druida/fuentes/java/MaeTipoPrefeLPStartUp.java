/*
    INDRA/CAR/mmg
    $Id: MaeTipoPrefeLPStartUp.java,v 1.1 2009/12/03 18:32:17 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class MaeTipoPrefeLPStartUp extends MMGDruidaBase{
	...
	public MaeTipoPrefeLPStartUp(){
		super();
	}

	public void inicio() throws Exception {
		pagina("MaeTipoPrefePage");
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "MaeTipoPrefePage", "cod", "MaeTipoPrefe." + accion + ".label");
			...
			limpiarBotoneraLista("maeTipoPrefe", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codTipoPref", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 2);");
		...
		//asignarAtributo("CAPA", "maeTipoPrefeLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "MaeTipoPrefePage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("MaeTipoPrefeLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		MaeTipoPrefeData maeTipoPrefeQuery= new MaeTipoPrefeData();
		maeTipoPrefeQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		MaeTipoPrefeData datosResult = (MaeTipoPrefeData)getSingleObject(BUSINESSID_QUERY, maeTipoPrefeQuery, 
			maeTipoPrefeQuery.clone(), "maeTipoPrefe");
		...
		preservaHiddensI18n(new Integer(1), "MAE_TIPO_PREFE", "maeTipoPrefeFrm", "Descripcion", true);
		...
		MaeTipoPrefeData maeTipoPrefe = datosResult;
		asignar("TEXT", "codTipoPref", FormatUtils.formatObject(maeTipoPrefe.getCodTipoPref(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "Descripcion", FormatUtils.formatObject(maeTipoPrefe.getDescripcion(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		loadLocalizationVars(maeTipoPrefe);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "codTipoPref", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "MAE_TIPO_PREFE", "maeTipoPrefeFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "codTipoPref", "req", "S");
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('maeTipoPrefeFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "maeTipoPrefeFrm", "oculto", "N");
		...
		traza("MMG::Creando MaeTipoPrefe");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		MaeTipoPrefeData maeTipoPrefeQuery= new MaeTipoPrefeData();
		maeTipoPrefeQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(maeTipoPrefe.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"maeTipoPrefeFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"maeTipoPrefeFrm\",1, false)");
					asignarAtributo("COMBO","paisOidPais", "ontab", "ejecutarAccionFocoModificacion(\"maeTipoPrefeFrm\",2, true)");
					asignarAtributo("COMBO","paisOidPais", "onshtab", "ejecutarAccionFocoModificacion(\"maeTipoPrefeFrm\",2, false)");
				asignarAtributo("AREATEXTO", "codTipoPref", "ontab","ejecutarAccionFocoModificacion(\"maeTipoPrefeFrm\",3, true)");
				asignarAtributo("AREATEXTO", "codTipoPref", "onshtab","ejecutarAccionFocoModificacion(\"maeTipoPrefeFrm\",3, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"maeTipoPrefeFrm\",4, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"maeTipoPrefeFrm\",4, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","maeTipoPrefeTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","maeTipoPrefeTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codTipoPref...");		
				
					traza("MMG: en desactivateNonModifyFields encontrado atributo no editable...");
				
						// borrarCampo("codTipoPref");
						asignarAtributo ("TEXT", "codTipoPref", "disabled", "S");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","maeTipoPrefeFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","maeTipoPrefeListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","maeTipoPrefeListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(MaeTipoPrefeData maeTipoPrefe) throws Exception{
		...
		if(maeTipoPrefe != null && maeTipoPrefe.getPaisOidPais() != null){
				checkCombo("paisOidPais" , maeTipoPrefe.getPaisOidPais().getId().toString());
			}
	...
	* @param maeTipoPrefe La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(MaeTipoPrefeData maeTipoPrefe) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		MaeTipoPrefeData maeTipoPrefe = 
			(MaeTipoPrefeData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(maeTipoPrefe.getPaisOidPais() != null){
			maeTipoPrefe.setPaisOidPais((es.indra.belcorp.mso.SegPaisViewData)
			getSingleObject(BUSINESSID_PAISOIDPAIS_QUERY, 
			maeTipoPrefe.getPaisOidPais(),
			maeTipoPrefe.getPaisOidPais().clone(),
			"segPaisView"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(maeTipoPrefe);
		loadLeafDependenceCombos(maeTipoPrefe);
	}
	...
	*/
	...
	protected void loadLocalizationVars(MaeTipoPrefeData maeTipoPrefe) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("MAE_TIPO_PREFE");
		mmgLocalizationQuery.setEntiPk(maeTipoPrefe.getId());
