...
public class PedTipoSolicPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","pedTipoSolicList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(23)).setAttribute("cod","PedTipoSolic.codTipoSoli.label" );
      ...
      ((Element)v.get(24)).setAttribute("cod","PedTipoSolic.ticlOidTipoClie.label" );
      ...
      ((Element)v.get(25)).setAttribute("cod","PedTipoSolic.marcOidMarc.label" );
      ...
      ((Element)v.get(26)).setAttribute("cod","PedTipoSolic.acceOidAcce.label" );
      ...
      ((Element)v.get(27)).setAttribute("cod","PedTipoSolic.clsoOidClasSoli.label" );
      ...
      ((Element)v.get(28)).setAttribute("cod","PedTipoSolic.indCons.label" );
      ...
      ((Element)v.get(29)).setAttribute("cod","PedTipoSolic.indSoliNega.label" );
      ...
      ((Element)v.get(30)).setAttribute("cod","PedTipoSolic.grsoOidGrupSoli.label" );
      ...
      ((Element)v.get(31)).setAttribute("cod","PedTipoSolic.indDevo.label" );
      ...
      ((Element)v.get(32)).setAttribute("cod","PedTipoSolic.indAnul.label" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(33)).setAttribute("cod","PedTipoSolic.sbacOidSbac.label" );
      ...
      ((Element)v.get(34)).setAttribute("cod","PedTipoSolic.codGrupSoli.label" );
