...
public class MaeTipoComunPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","maeTipoComunList" );
      ...
      ((Element)v.get(13)).setAttribute("cod","MaeTipoComun.codTipoComu.label" );
      ...
      ((Element)v.get(14)).setAttribute("cod","MaeTipoComun.Descripcion.label" );
