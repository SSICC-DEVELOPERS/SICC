/*
    INDRA/CAR/mmg
    $Id: PreCondiPromoLPStartUp.java,v 1.1 2009/12/03 18:37:01 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class PreCondiPromoLPStartUp extends MMGDruidaBase{
	...
	public PreCondiPromoLPStartUp(){
		super();
	}

	public void inicio() throws Exception {
		pagina("PreCondiPromoPage");
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "PreCondiPromoPage", "cod", "PreCondiPromo." + accion + ".label");
			...
			limpiarBotoneraLista("preCondiPromo", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codCondProm", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 4);");
		...
		//asignarAtributo("CAPA", "preCondiPromoLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "PreCondiPromoPage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("PreCondiPromoLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		PreCondiPromoData preCondiPromoQuery= new PreCondiPromoData();
		preCondiPromoQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		PreCondiPromoData datosResult = (PreCondiPromoData)getSingleObject(BUSINESSID_QUERY, preCondiPromoQuery, 
			preCondiPromoQuery.clone(), "preCondiPromo");
		...
		preservaHiddensI18n(new Integer(1), "PRE_CONDI_PROMO", "preCondiPromoFrm", "Descripcion", true);
		...
		PreCondiPromoData preCondiPromo = datosResult;
		asignar("TEXT", "codCondProm", FormatUtils.formatObject(preCondiPromo.getCodCondProm(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "Descripcion", FormatUtils.formatObject(preCondiPromo.getDescripcion(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		loadLocalizationVars(preCondiPromo);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "codCondProm", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "PRE_CONDI_PROMO", "preCondiPromoFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "codCondProm", "req", "S");
		
		
		//Asiganamos a los campos internacionalizables la función de onblur para actualizar el 
		//valor del idioma por defecto
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('preCondiPromoFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "preCondiPromoFrm", "oculto", "N");
		...
		traza("MMG::Creando PreCondiPromo");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		PreCondiPromoData preCondiPromoQuery= new PreCondiPromoData();
		preCondiPromoQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(preCondiPromo.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"preCondiPromoFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"preCondiPromoFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codCondProm", "ontab","ejecutarAccionFocoModificacion(\"preCondiPromoFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codCondProm", "onshtab","ejecutarAccionFocoModificacion(\"preCondiPromoFrm\",2, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"preCondiPromoFrm\",3, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"preCondiPromoFrm\",3, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","preCondiPromoTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","preCondiPromoTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codCondProm...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","preCondiPromoFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","preCondiPromoListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","preCondiPromoListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(PreCondiPromoData preCondiPromo) throws Exception{
	...
	* @param preCondiPromo La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(PreCondiPromoData preCondiPromo) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		PreCondiPromoData preCondiPromo = 
			(PreCondiPromoData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(preCondiPromo);
		loadLeafDependenceCombos(preCondiPromo);
	}
	...
	*/
	...
	protected void loadLocalizationVars(PreCondiPromoData preCondiPromo) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("PRE_CONDI_PROMO");
		mmgLocalizationQuery.setEntiPk(preCondiPromo.getId());
