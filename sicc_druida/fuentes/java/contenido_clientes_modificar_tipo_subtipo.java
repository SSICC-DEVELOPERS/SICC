...
public class contenido_clientes_modificar_tipo_subtipo  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_clientes_modificar_tipo_subtipo" );
      ((Element)v.get(0)).setAttribute("cod","MaeTipoSubtipoClien.update.label" );
      ...
      ((Element)v.get(5)).setAttribute("name","comboTipoCliente" );
      ((Element)v.get(5)).setAttribute("required","true" );
      ((Element)v.get(5)).setAttribute("cod","393" );
      ((Element)v.get(4)).appendChild((Element)v.get(5));
      /* Termina nodo:5   */

      /* Empieza nodo:6 / Elemento padre: 4   */
      v.add(doc.createElement("ELEMENTO"));
      ((Element)v.get(6)).setAttribute("name","comboSubtipoCliente" );
      ((Element)v.get(6)).setAttribute("required","true" );
      ((Element)v.get(6)).setAttribute("cod","595" );
      ...
      ((Element)v.get(7)).setAttribute("nombre","frmTipoSubtipo" );
      ((Element)v.get(0)).appendChild((Element)v.get(7));

      /* Empieza nodo:8 / Elemento padre: 7   */
      v.add(doc.createElement("CAPA"));
      ((Element)v.get(8)).setAttribute("nombre","capaEspacio1" );
      ...
      ((Element)v.get(11)).setAttribute("width","8" );
      ...
      ((Element)v.get(12)).setAttribute("width","9" );
      ...
      ((Element)v.get(16)).setAttribute("width","9" );
      ...
      ((Element)v.get(19)).setAttribute("width","9" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(23)).setAttribute("width","9" );
      ...
      ((Element)v.get(26)).setAttribute("width","9" );
      ...
      v.add(doc.createElement("table"));
      ((Element)v.get(34)).setAttribute("width","575" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(42)).setAttribute("nombre","lblTipoCliente" );
      ...
      ((Element)v.get(42)).setAttribute("cod","393" );
      ...
      v.add(doc.createElement("LABELC"));
      ((Element)v.get(46)).setAttribute("nombre","lblSubtipoCliente" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(46)).setAttribute("cod","595" );
      ...
      ((Element)v.get(53)).setAttribute("nombre","comboTipoCliente" );
      ...
      ((Element)v.get(53)).setAttribute("onshtab","" );
      ...
      v.add(doc.createElement("COMBO"));
      ((Element)v.get(58)).setAttribute("nombre","comboSubtipoCliente" );
      ...
      ((Element)v.get(58)).setAttribute("ontab","" );
      ...
      /* Empieza nodo:65 / Elemento padre: 24   */
      v.add(doc.createElement("td"));
      ((Element)v.get(24)).appendChild((Element)v.get(65));
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(75)).setAttribute("nombre","btnAceptar" );
      ((Element)v.get(75)).setAttribute("ID","botonContenido" );
      ((Element)v.get(75)).setAttribute("tipo","html" );
      ((Element)v.get(75)).setAttribute("accion",";" );
      ((Element)v.get(75)).setAttribute("estado","false" );
      ((Element)v.get(75)).setAttribute("cod","MMGGlobal.localization.bindbutton.label" );
