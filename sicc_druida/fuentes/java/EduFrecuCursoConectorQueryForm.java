...
public class EduFrecuCursoConectorQueryForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad EduFrecuCurso" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGEduFrecuCursoQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGEduFrecuCursoQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","EduFrecuCursoFormFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","codFrec" );
