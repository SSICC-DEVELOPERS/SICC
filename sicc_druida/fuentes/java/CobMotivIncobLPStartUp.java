/*
    INDRA/CAR/mmg
    $Id: CobMotivIncobLPStartUp.java,v 1.1 2009/12/03 18:35:42 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class CobMotivIncobLPStartUp extends MMGDruidaBase{
	...
	public CobMotivIncobLPStartUp(){
		super();
	}

	public void inicio() throws Exception {
		pagina("CobMotivIncobPage");
	}
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "CobMotivIncobPage", "cod", "CobMotivIncob." + accion + ".label");
			...
			limpiarBotoneraLista("cobMotivIncob", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codMotiCobr", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 2);");
		asignarAtributo("TEXT", "valDescMotiCobr", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 40);");
		
		//Primero determianmos el nombre del campo en la entidad de oriegen donde se van a cargar los datos
		asignar("VAR", "idAttributeLovOpener", conectorParametro(PARAMETRO_LOV_ATTRIBUTO));
		asignar("VAR", "idEntityLovOpener", conectorParametro(PARAMETRO_LOV_ENTIDAD));
		//asignarAtributo("CAPA", "cobMotivIncobLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "CobMotivIncobPage", "onblur", "window.focus();");
	...
	protected void cmdPreView() throws Exception{
		...
		conectorAction("CobMotivIncobLPStartUp");
	...
	*/
	protected void cmdView() throws Exception{
		...
		CobMotivIncobData cobMotivIncobQuery= new CobMotivIncobData();
		cobMotivIncobQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		CobMotivIncobData datosResult = (CobMotivIncobData)getSingleObject(BUSINESSID_QUERY, cobMotivIncobQuery, 
			cobMotivIncobQuery.clone(), "cobMotivIncob");
		...
		CobMotivIncobData cobMotivIncob = datosResult;
		asignar("TEXT", "codMotiCobr", FormatUtils.formatObject(cobMotivIncob.getCodMotiCobr(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "valDescMotiCobr", FormatUtils.formatObject(cobMotivIncob.getValDescMotiCobr(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		asignarAtributo("TEXT", "codMotiCobr", "disabled", "S");
		asignarAtributo("TEXT", "valDescMotiCobr", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		...
		asignarAtributo("TEXT", "codMotiCobr", "req", "S");
		asignarAtributo("TEXT", "valDescMotiCobr", "req", "S");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "cobMotivIncobFrm", "oculto", "N");
		...
		traza("MMG::Creando CobMotivIncob");
		String id = conectorParametro("idSelection");
		traza("MMG:: id del atributo a modificar: " + id);
	
		//Construimos el mso con los elementos de la búsqueda
		CobMotivIncobData cobMotivIncobQuery= new CobMotivIncobData();
		cobMotivIncobQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(cobMotivIncob.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"cobMotivIncobFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"cobMotivIncobFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codMotiCobr", "ontab","ejecutarAccionFocoModificacion(\"cobMotivIncobFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codMotiCobr", "onshtab","ejecutarAccionFocoModificacion(\"cobMotivIncobFrm\",2, false)");
				asignarAtributo("AREATEXTO", "valDescMotiCobr", "ontab","ejecutarAccionFocoModificacion(\"cobMotivIncobFrm\",3, true)");
				asignarAtributo("AREATEXTO", "valDescMotiCobr", "onshtab","ejecutarAccionFocoModificacion(\"cobMotivIncobFrm\",3, false)");
					asignarAtributo("COMBO","paisOidPais", "ontab", "ejecutarAccionFocoModificacion(\"cobMotivIncobFrm\",4, true)");
					asignarAtributo("COMBO","paisOidPais", "onshtab", "ejecutarAccionFocoModificacion(\"cobMotivIncobFrm\",4, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","cobMotivIncobTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","cobMotivIncobTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codMotiCobr...");		
				
					traza("MMG: en desactivateNonModifyFields encontrado atributo no editable...");
				
						// borrarCampo("codMotiCobr");
						asignarAtributo ("TEXT", "codMotiCobr", "disabled", "S");
				traza("MMG: el atributo es valDescMotiCobr...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","cobMotivIncobFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","cobMotivIncobListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","cobMotivIncobListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(CobMotivIncobData cobMotivIncob) throws Exception{
		...
		if(cobMotivIncob != null && cobMotivIncob.getPaisOidPais() != null){
				checkCombo("paisOidPais" , cobMotivIncob.getPaisOidPais().getId().toString());
			}
	...
	* @param cobMotivIncob La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(CobMotivIncobData cobMotivIncob) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		CobMotivIncobData cobMotivIncob = 
			(CobMotivIncobData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(cobMotivIncob.getPaisOidPais() != null){
			cobMotivIncob.setPaisOidPais((es.indra.belcorp.mso.SegPaisViewData)
			getSingleObject(BUSINESSID_PAISOIDPAIS_QUERY, 
			cobMotivIncob.getPaisOidPais(),
			cobMotivIncob.getPaisOidPais().clone(),
			"segPaisView"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(cobMotivIncob);
		loadLeafDependenceCombos(cobMotivIncob);
	}
