...
public class ConectorGuardarEstadoMAV  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","guardar estado" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","DTOEstadoMAV" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MAVGuardarEstadoMAV" );
