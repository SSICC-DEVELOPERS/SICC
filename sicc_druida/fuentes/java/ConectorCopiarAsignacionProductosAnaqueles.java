...
public class ConectorCopiarAsignacionProductosAnaqueles  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","APE Conector Copiar Asignacion de Productos a Anaqueles" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","DTOAsignacionProductoAnaquelCabecera" );
