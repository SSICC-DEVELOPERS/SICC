/*
    INDRA/CAR/mmg
    $Id: PreTipoEstraLPStartUp.java,v 1.1 2009/12/03 18:33:33 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class PreTipoEstraLPStartUp extends MMGDruidaBase{
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "PreTipoEstraPage", "cod", "PreTipoEstra." + accion + ".label");
			...
			limpiarBotoneraLista("preTipoEstra", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codTipoEstr", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 2);");
		asignarAtributo("TEXT", "desTipoEstr", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 30);");
		asignarAtributo("TEXT", "indEstrGrup", "validacion", "mensaje = ValidaInt(cdos_trim(valor), 1, 0, 9);");
		asignarAtributo("TEXT", "indEstrCond", "validacion", "mensaje = ValidaInt(cdos_trim(valor), 1, 0, 9);");
		asignarAtributo("TEXT", "indEstrVs", "validacion", "mensaje = ValidaInt(cdos_trim(valor), 1, 0, 9);");
		asignarAtributo("TEXT", "indEstrPaqu", "validacion", "mensaje = ValidaInt(cdos_trim(valor), 1, 0, 9);");
		
		//Primero determianmos el nombre del campo en la entidad de oriegen donde se van a cargar los datos
		asignar("VAR", "idAttributeLovOpener", conectorParametro(PARAMETRO_LOV_ATTRIBUTO));
		asignar("VAR", "idEntityLovOpener", conectorParametro(PARAMETRO_LOV_ENTIDAD));
		//asignarAtributo("CAPA", "preTipoEstraLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "PreTipoEstraPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		PreTipoEstraData preTipoEstraQuery= new PreTipoEstraData();
		preTipoEstraQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		PreTipoEstraData datosResult = (PreTipoEstraData)getSingleObject(BUSINESSID_QUERY, preTipoEstraQuery, 
			preTipoEstraQuery.clone(), "preTipoEstra");
		...
		PreTipoEstraData preTipoEstra = datosResult;
		asignar("TEXT", "codTipoEstr", FormatUtils.formatObject(preTipoEstra.getCodTipoEstr(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "desTipoEstr", FormatUtils.formatObject(preTipoEstra.getDesTipoEstr(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "indEstrGrup", FormatUtils.formatObject(preTipoEstra.getIndEstrGrup(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "indEstrCond", FormatUtils.formatObject(preTipoEstra.getIndEstrCond(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "indEstrVs", FormatUtils.formatObject(preTipoEstra.getIndEstrVs(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "indEstrPaqu", FormatUtils.formatObject(preTipoEstra.getIndEstrPaqu(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		...
		asignarAtributo("TEXT", "codTipoEstr", "disabled", "S");
		asignarAtributo("TEXT", "desTipoEstr", "disabled", "S");
		asignarAtributo("TEXT", "indEstrGrup", "disabled", "S");
		asignarAtributo("TEXT", "indEstrCond", "disabled", "S");
		asignarAtributo("TEXT", "indEstrVs", "disabled", "S");
		asignarAtributo("TEXT", "indEstrPaqu", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		...
		asignarAtributo("TEXT", "codTipoEstr", "req", "S");
		asignarAtributo("TEXT", "desTipoEstr", "req", "S");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "preTipoEstraFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		PreTipoEstraData preTipoEstraQuery= new PreTipoEstraData();
		preTipoEstraQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(preTipoEstra.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"preTipoEstraFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"preTipoEstraFrm\",1, false)");
				asignarAtributo("AREATEXTO", "codTipoEstr", "ontab","ejecutarAccionFocoModificacion(\"preTipoEstraFrm\",2, true)");
				asignarAtributo("AREATEXTO", "codTipoEstr", "onshtab","ejecutarAccionFocoModificacion(\"preTipoEstraFrm\",2, false)");
				asignarAtributo("AREATEXTO", "desTipoEstr", "ontab","ejecutarAccionFocoModificacion(\"preTipoEstraFrm\",3, true)");
				asignarAtributo("AREATEXTO", "desTipoEstr", "onshtab","ejecutarAccionFocoModificacion(\"preTipoEstraFrm\",3, false)");
				asignarAtributo("AREATEXTO", "indEstrGrup", "ontab","ejecutarAccionFocoModificacion(\"preTipoEstraFrm\",4, true)");
				asignarAtributo("AREATEXTO", "indEstrGrup", "onshtab","ejecutarAccionFocoModificacion(\"preTipoEstraFrm\",4, false)");
				asignarAtributo("AREATEXTO", "indEstrCond", "ontab","ejecutarAccionFocoModificacion(\"preTipoEstraFrm\",5, true)");
				asignarAtributo("AREATEXTO", "indEstrCond", "onshtab","ejecutarAccionFocoModificacion(\"preTipoEstraFrm\",5, false)");
				asignarAtributo("AREATEXTO", "indEstrVs", "ontab","ejecutarAccionFocoModificacion(\"preTipoEstraFrm\",6, true)");
				asignarAtributo("AREATEXTO", "indEstrVs", "onshtab","ejecutarAccionFocoModificacion(\"preTipoEstraFrm\",6, false)");
				asignarAtributo("AREATEXTO", "indEstrPaqu", "ontab","ejecutarAccionFocoModificacion(\"preTipoEstraFrm\",7, true)");
				asignarAtributo("AREATEXTO", "indEstrPaqu", "onshtab","ejecutarAccionFocoModificacion(\"preTipoEstraFrm\",7, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","preTipoEstraTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","preTipoEstraTrButtons");
	...
	*/
	protected void desactivateNonModifyFields() throws Exception{
			traza("MMG: en desactivateNonModifyFields ");		
				...
				traza("MMG: el atributo es codTipoEstr...");		
				
				traza("MMG: el atributo es desTipoEstr...");		
				
				traza("MMG: el atributo es indEstrGrup...");		
				
				traza("MMG: el atributo es indEstrCond...");		
				
				traza("MMG: el atributo es indEstrVs...");		
				
				traza("MMG: el atributo es indEstrPaqu...");		
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","preTipoEstraFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","preTipoEstraListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","preTipoEstraListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(PreTipoEstraData preTipoEstra) throws Exception{
	...
	* @param preTipoEstra La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(PreTipoEstraData preTipoEstra) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		PreTipoEstraData preTipoEstra = 
			(PreTipoEstraData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		...
		loadNonLeafDependenceCombos(preTipoEstra);
		loadLeafDependenceCombos(preTipoEstra);
	}
