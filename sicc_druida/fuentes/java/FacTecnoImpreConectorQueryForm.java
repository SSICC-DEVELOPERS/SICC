...
public class FacTecnoImpreConectorQueryForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad FacTecnoImpre" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGFacTecnoImpreQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGFacTecnoImpreQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","FacTecnoImpreFormFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","desTecn" );
