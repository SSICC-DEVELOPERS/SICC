...
public class CccProcePageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","CccProce.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","CccProce.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('cccProceFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('cccProceFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(54)).setAttribute("cod","CccProce.paisOidPais.label" );
      ...
      ((Element)v.get(57)).setAttribute("ontab","ejecutarAccionFoco('cccProceFrm',2, true);" );
      ((Element)v.get(57)).setAttribute("onshtab","ejecutarAccionFoco('cccProceFrm',2, false);" );
   ...
   private void getXML270(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(76)).setAttribute("nombre","codProcTdId" );
   ...
   private void getXML360(Document doc) {
      ((Element)v.get(81)).setAttribute("nombre","codProcWidgetTrId" );
      ...
      ((Element)v.get(83)).setAttribute("ontab","ejecutarAccionFoco('cccProceFrm',3, true)" );
      ((Element)v.get(83)).setAttribute("onshtab","ejecutarAccionFoco('cccProceFrm', 3, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(84)).setAttribute("nombre","codProcGapTdId" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(86)).setAttribute("nombre","desProcTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(91)).setAttribute("nombre","desProcWidgetTrId" );
      ...
      v.add(doc.createElement("TEXT"));
      ((Element)v.get(93)).setAttribute("nombre","desProc" );
      ...
      ((Element)v.get(93)).setAttribute("ontab","ejecutarAccionFoco('cccProceFrm',4, true)" );
      ((Element)v.get(93)).setAttribute("onshtab","ejecutarAccionFoco('cccProceFrm', 4, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(94)).setAttribute("nombre","desProcGapTdId" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(96)).setAttribute("nombre","indCvDireTdId" );
   ...
   private void getXML450(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(101)).setAttribute("nombre","indCvDireWidgetTrId" );
      ...
      ((Element)v.get(103)).setAttribute("nombre","indCvDire" );
      ...
      ((Element)v.get(103)).setAttribute("ontab","ejecutarAccionFoco('cccProceFrm',5, true)" );
      ((Element)v.get(103)).setAttribute("onshtab","ejecutarAccionFoco('cccProceFrm',5, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(104)).setAttribute("nombre","indCvDireGapTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(108)).setAttribute("nombre","formGapTr2" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(115)).setAttribute("nombre","formTr3" );
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(121)).setAttribute("nombre","valObseTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(126)).setAttribute("nombre","valObseWidgetTrId" );
      ...
      ((Element)v.get(128)).setAttribute("nombre","valObse" );
      ((Element)v.get(128)).setAttribute("valor","" );
      ((Element)v.get(128)).setAttribute("rows","3" );
      ((Element)v.get(128)).setAttribute("cols","40" );
      ...
      ((Element)v.get(128)).setAttribute("ontab","ejecutarAccionFoco('cccProceFrm',6, true)" );
      ((Element)v.get(128)).setAttribute("onshtab","ejecutarAccionFoco('cccProceFrm',6, false)" );
      ...
      v.add(doc.createElement("TD"));
      ((Element)v.get(129)).setAttribute("nombre","valObseGapTdId" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(134)).setAttribute("nombre","formGapTr3" );
   ...
   private void getXML630(Document doc) {
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(143)).setAttribute("nombre","cccProceTrButtons" );
      ...
      ((Element)v.get(150)).setAttribute("nombre","cccProceTdQueryButton" );
      ((Element)v.get(149)).appendChild((Element)v.get(150));

      /* Empieza nodo:151 / Elemento padre: 150   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(151)).setAttribute("nombre","cccProceQueryButton" );
      ((Element)v.get(151)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(151)).setAttribute("estado","false" );
      ((Element)v.get(151)).setAttribute("accion","cccProceFirstPage();" );
      ...
      ((Element)v.get(152)).setAttribute("nombre","cccProceTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(154)).setAttribute("nombre","cccProceLovNullButton" );
      ((Element)v.get(154)).setAttribute("ID","botonContenido" );
      ((Element)v.get(154)).setAttribute("tipo","html" );
      ((Element)v.get(154)).setAttribute("accion","cccProceLovNullSelectionAction();" );
