...
public class IncDirigPageForm  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(14)).setAttribute("cod","IncDirig.legend.label" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(29)).setAttribute("cod","IncDirig.id.label" );
      ...
      ((Element)v.get(32)).setAttribute("ontab","ejecutarAccionFoco('incDirigFrm',1, true)" );
      ((Element)v.get(32)).setAttribute("onshtab","ejecutarAccionFoco('incDirigFrm', 1, false)" );
   ...
   private void getXML180(Document doc) {
      ...
      ((Element)v.get(54)).setAttribute("cod","IncDirig.Descripcion.label" );
      ...
      ((Element)v.get(58)).setAttribute("ontab","ejecutarAccionFoco('incDirigFrm',2, true)" );
      ((Element)v.get(58)).setAttribute("onshtab","ejecutarAccionFoco('incDirigFrm', 2, false)" );
   ...
   private void getXML270(Document doc) {
      ...
      ((Element)v.get(62)).setAttribute("href","javascript:openLocalizationDialog('incDirigFrm', 'Descripcion', 1);" );
      ((Element)v.get(62)).setAttribute("onKeyDown","javascript:mmgImgEventDispatcherForFocus(event, 'ejecutarAccionFoco(\"incDirigFrm\",2, true)', 'ejecutarAccionFoco(\"incDirigFrm\",2, false)')" );
      ...
      v.add(doc.createElement("TR"));
      ((Element)v.get(78)).setAttribute("nombre","incDirigTrButtons" );
   ...
   private void getXML360(Document doc) {
      ...
      ((Element)v.get(85)).setAttribute("nombre","incDirigTdQueryButton" );
      ((Element)v.get(84)).appendChild((Element)v.get(85));

      /* Empieza nodo:86 / Elemento padre: 85   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(86)).setAttribute("nombre","incDirigQueryButton" );
      ((Element)v.get(86)).setAttribute("cod","MMGGlobal.queryButton.label" );
      ((Element)v.get(86)).setAttribute("estado","false" );
      ((Element)v.get(86)).setAttribute("accion","incDirigFirstPage();" );
      ...
      ((Element)v.get(87)).setAttribute("nombre","incDirigTdLovNullSelectionButton" );
      ...
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(89)).setAttribute("nombre","incDirigLovNullButton" );
      ((Element)v.get(89)).setAttribute("ID","botonContenido" );
      ((Element)v.get(89)).setAttribute("tipo","html" );
      ((Element)v.get(89)).setAttribute("accion","incDirigLovNullSelectionAction();" );
