...
public class ConectorReimprimirFichasIncripcion  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Modificar Impuestos" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","DTOReimprimirFichasInscripcion" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MAEReimprimirFichasInscripcion" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(5)).setAttribute("NOMBRE","DTOReimprimirFichasInscripcion" );
