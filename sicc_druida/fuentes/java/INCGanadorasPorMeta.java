...
public class INCGanadorasPorMeta extends LPSICCBase {           
    public INCGanadorasPorMeta() {
        super();
    }
    ...
    public void ejecucion() throws Exception {		
        ...
        try {
            ...
            if (accion.equals("generar")){
                ...
                cargarPagina();
                getConfiguracionMenu("INCGanadorasPorMeta");
            }
        } catch (Exception ex) {
    ...
    private void cargarPagina() throws Exception{
        pagina("contenido_informe_ganadoras_meta_generar");   
    ...
    private void generarReporte() throws Exception{
        ...
        datos.put(ConstantesREP.NUMEROCONCURSO, concurso);
        ...
        String avanceDesde  = conectorParametroLimpia("avanceDesde", "", true);
        if(!avanceDesde.equals("")){
        //  datos.put(ConstantesREP.AVANCEDESDE, avanceDesde);
        }
        
        String avanceHasta  = conectorParametroLimpia("avanceHasta", "", true);
        if(!avanceHasta.equals("")){
        //   datos.put(ConstantesREP.AVANCEHASTA, avanceHasta);
        }
        
        
        
        datos.put(ConstantesREP.TITULO, "Ganadoras por meta");
        ...
        if(region.equals("")){
           reporte = "RD_REP-071_02";    
        }else{
           if(zona.equals("")){
              reporte = "RD_REP-071_01";
           }else{
              reporte = "RD_REP-071";
           }
        }   
