/*
    INDRA/CAR/mmg
    $Id: PedTipoDespaLPStartUp.java,v 1.1 2009/12/03 18:34:59 pecbazalar Exp $
    DESC
*/
import java.util.*;
...
public class PedTipoDespaLPStartUp extends MMGDruidaBase{
	...
	public void ejecucion() throws Exception {
		try{
			...
			asignarAtributo("PAGINA", "PedTipoDespaPage", "cod", "PedTipoDespa." + accion + ".label");
			...
			limpiarBotoneraLista("pedTipoDespa", accion);
	...
	protected void cmdLov() throws Exception{
		...
		asignarAtributo("TEXT", "codTipoDesp", "validacion", "mensaje = ValidaLongitud(cdos_trim(valor), 1, 3);");
		...
		//asignarAtributo("CAPA", "pedTipoDespaLovLayer", "visibilidad", "visible");
		asignarAtributo("PAGINA", "PedTipoDespaPage", "onblur", "window.focus();");
	...
	*/
	protected void cmdView() throws Exception{
		...
		PedTipoDespaData pedTipoDespaQuery= new PedTipoDespaData();
		pedTipoDespaQuery.setId(new Long(conectorParametro("idSelection")));
		
		//Asiganmos el valor a la variable de acción anterior para poder volver hacia atras y hacer requery
		asignar("VAR", VAR_ACCION_ANTERIOR, conectorParametro(VAR_ACCION_ANTERIOR));
		
		//Sacamos de la base de datos la entidad a visualizar
		PedTipoDespaData datosResult = (PedTipoDespaData)getSingleObject(BUSINESSID_QUERY, pedTipoDespaQuery, 
			pedTipoDespaQuery.clone(), "pedTipoDespa");
		...
		preservaHiddensI18n(new Integer(1), "PED_TIPO_DESPA", "pedTipoDespaFrm", "Descripcion", true);
		...
		PedTipoDespaData pedTipoDespa = datosResult;
		asignar("TEXT", "codTipoDesp", FormatUtils.formatObject(pedTipoDespa.getCodTipoDesp(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignar("TEXT", "Descripcion", FormatUtils.formatObject(pedTipoDespa.getDescripcion(), 
			 MMGDruidaHelper.getUserDecimalFormatPattern(this), decimalFormatSymbols));
		asignarAtributo("CHECKBOX", "indCron" , "check", FormatUtils.formatObject(
			pedTipoDespa.getIndCron(), 
		...
		loadLocalizationVars(pedTipoDespa);
		
			
		//Deshabilitamos todos los campos para que no se editen
		asignarAtributo("TEXT", "codTipoDesp", "disabled", "S");
		asignarAtributo("TEXT", "Descripcion", "disabled", "S");
		
					asignarAtributo("CHECKBOX", "indCron", "disabled", "S");
	...
	protected void cmdCreate() throws Exception{
		//Creamos los campos ocultos para la internacionalización
		preservaHiddensI18n(new Integer(1), "PED_TIPO_DESPA", "pedTipoDespaFrm", "Descripcion", false);
		...
		asignarAtributo("TEXT", "codTipoDesp", "req", "S");
		...
		asignarAtributo("TEXT", "Descripcion", "onblur", "setDefaultLanguageValue('Descripcion', get('pedTipoDespaFrm.Descripcion'))");
	...
	protected void cmdUpdateForm() throws Exception{
		...
		//asignarAtributo("FORMULARIO", "pedTipoDespaFrm", "oculto", "N");
		...
		//Construimos el mso con los elementos de la búsqueda
		PedTipoDespaData pedTipoDespaQuery= new PedTipoDespaData();
		pedTipoDespaQuery.setId(new Long(id));
		...
		//asignar("VAR","timestamp",Long.toString(pedTipoDespa.jdoGetTimeStamp()));
	...
	*/
	protected void cambiarAcciones() throws Exception{
				asignarAtributo("AREATEXTO", "id", "ontab","ejecutarAccionFocoModificacion(\"pedTipoDespaFrm\",1, true)");
				asignarAtributo("AREATEXTO", "id", "onshtab","ejecutarAccionFocoModificacion(\"pedTipoDespaFrm\",1, false)");
					asignarAtributo("COMBO","paisOidPais", "ontab", "ejecutarAccionFocoModificacion(\"pedTipoDespaFrm\",2, true)");
					asignarAtributo("COMBO","paisOidPais", "onshtab", "ejecutarAccionFocoModificacion(\"pedTipoDespaFrm\",2, false)");
				asignarAtributo("AREATEXTO", "codTipoDesp", "ontab","ejecutarAccionFocoModificacion(\"pedTipoDespaFrm\",3, true)");
				asignarAtributo("AREATEXTO", "codTipoDesp", "onshtab","ejecutarAccionFocoModificacion(\"pedTipoDespaFrm\",3, false)");
				asignarAtributo("AREATEXTO", "Descripcion", "ontab","ejecutarAccionFocoModificacion(\"pedTipoDespaFrm\",4, true)");
				asignarAtributo("AREATEXTO", "Descripcion", "onshtab","ejecutarAccionFocoModificacion(\"pedTipoDespaFrm\",4, false)");
				asignarAtributo("TEXT", "indCron", "ontab","ejecutarAccionFocoModificacion(\"pedTipoDespaFrm\",5, true)");
				asignarAtributo("TEXT", "indCron", "onshtab","ejecutarAccionFocoModificacion(\"pedTipoDespaFrm\",5, false)");
	}
	...
	protected void removeLovElements() throws Exception{
		borrarNodo("TD","nombre","pedTipoDespaTdLovNullSelectionButton");
	}
	
	protected void removeQueryElements() throws Exception{
		//Borramos los botones para realizar la búsuqeda
		borrarNodo("TR","nombre","pedTipoDespaTrButtons");
	...
	*/
	protected void establecerSizeCapas(String accion, String origen) throws Exception{
		...
		asignarAtributo("CAPA","pedTipoDespaFormLayer", "alto", String.valueOf(sizeForm));		
		
		//Estabelcemos la posicion y de la capa correspondiente a la lista y de su botonera
		asignarAtributo("CAPA","pedTipoDespaListLayer", "y", String.valueOf(sizeForm + 26));		
		asignarAtributo("CAPA","pedTipoDespaListButtonsLayer", "y", String.valueOf(sizeForm + 278));		
	}

	/**
	* Nos permite cargar las combos finales de la jerarquías de dependencia
	*/
	protected void loadLeafDependenceCombos(PedTipoDespaData pedTipoDespa) throws Exception{
		...
		if(pedTipoDespa != null && pedTipoDespa.getPaisOidPais() != null){
				checkCombo("paisOidPais" , pedTipoDespa.getPaisOidPais().getId().toString());
			}
	...
	* @param pedTipoDespa La el objetopar la cual se va a realizar la carga
	*/
	protected void loadNonLeafDependenceCombos(PedTipoDespaData pedTipoDespa) 
		throws Exception{
	...
	*/
	protected void loadNonLeafDependenceCombosForRequery() throws Exception{
		...
		PedTipoDespaData pedTipoDespa = 
			(PedTipoDespaData) conectorParametroSesion(SESSION_ATTRIBUTE_LAST_QUERY_OBJ_FROM);
		
		//Cargamos todos los objetos completos correspodnientes a los valores de los
		//Campos que sean raiz de una jerarquía de combos dependientes
		if(pedTipoDespa.getPaisOidPais() != null){
			pedTipoDespa.setPaisOidPais((es.indra.belcorp.mso.SegPaisViewData)
			getSingleObject(BUSINESSID_PAISOIDPAIS_QUERY, 
			pedTipoDespa.getPaisOidPais(),
			pedTipoDespa.getPaisOidPais().clone(),
			"segPaisView"));
		}
		
		//Una vez que tenemos completo los datos de los atributos raices de jerarquías de dependencias
		//cargamos las combos y seleccionamos elementos
		loadNonLeafDependenceCombos(pedTipoDespa);
		loadLeafDependenceCombos(pedTipoDespa);
	}
	...
	*/
	...
	protected void loadLocalizationVars(PedTipoDespaData pedTipoDespa) throws Exception{
		GenDetaSiccData mmgLocalizationQuery = null;
		Vector mmgLocalizationDatosResult = null;
		mmgLocalizationQuery = new GenDetaSiccData();
		mmgLocalizationQuery.setEnti("PED_TIPO_DESPA");
		mmgLocalizationQuery.setEntiPk(pedTipoDespa.getId());
