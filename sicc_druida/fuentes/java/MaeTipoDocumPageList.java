...
public class MaeTipoDocumPageList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","maeTipoDocumList" );
   ...
   private void getXML90(Document doc) {
      ...
      ((Element)v.get(19)).setAttribute("cod","MaeTipoDocum.codTipoDocu.label" );
      ...
      ((Element)v.get(20)).setAttribute("cod","MaeTipoDocum.indObli.label" );
      ...
      ((Element)v.get(21)).setAttribute("cod","MaeTipoDocum.Descripcion.label" );
      ...
      ((Element)v.get(22)).setAttribute("cod","MaeTipoDocum.valSigl.label" );
      ...
      ((Element)v.get(23)).setAttribute("cod","MaeTipoDocum.valLong.label" );
      ...
      ((Element)v.get(24)).setAttribute("cod","MaeTipoDocum.indDni.label" );
      ...
      ((Element)v.get(25)).setAttribute("cod","MaeTipoDocum.indDocIdenFisc.label" );
      ...
      ((Element)v.get(26)).setAttribute("cod","MaeTipoDocum.tidoOidTipoDocu.label" );
