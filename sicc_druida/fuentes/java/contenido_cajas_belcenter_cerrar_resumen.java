...
public class contenido_cajas_belcenter_cerrar_resumen  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("nombre","contenido_cajas_belcenter_cerrar_resumen" );
      ...
      v.add(doc.createTextNode("\r         \r\rfunction onLoadPag() {\r  configurarMenuSecundario(\"formularios\");\r  \r  DrdEnsanchaConMargenDcho('listado1',24);\r	    \r	document.all[\"Cplistado1\"].style.visibility='';\r	document.all[\"CpLin1listado1\"].style.visibility='';\r	document.all[\"CpLin2listado1\"].style.visibility='';\r	document.all[\"CpLin3listado1\"].style.visibility='';\r	document.all[\"CpLin4listado1\"].style.visibility='';	\r	document.all[\"primera1Div\"].style.visibility='hidden';\r	document.all[\"ret1Div\"].style.visibility='hidden';\r	document.all[\"ava1Div\"].style.visibility='hidden';\r	document.all[\"separaDiv\"].style.visibility='hidden';\r	  \r	eval (ON_RSZ);\r\r  datosCabecera();\r\r  if (get('formularios.errDescripcion')!='') {\r        var wnd = fMostrarMensajeError(get('formularios.errCodigo'), get('formularios.errDescripcion'));\r        window.close();\r  }\r}\r\rfunction datosCabecera() {\r  var canal = get(\"formularios.varCanal\");\r  var acceso = get(\"formularios.varAcceso\");\r  var subacceso = get(\"formularios.varSubacceso\");\r  var fecha = get(\"formularios.varFecha\");\r  var estado = get(\"formularios.varEstado\");\r  \r  txt_to(\"lbldtCanal\", canal);\r  txt_to(\"lbldtAcceso\", acceso);\r  txt_to(\"lbldtSubacceso\", subacceso);\r  txt_to(\"lbldtFecha\", fecha);\r  txt_to(\"lbldtEstado\", estado);         \r}\r\rfunction fVolver() {    \r  window.close();\r}\r\r\r"));
      ...
      ((Element)v.get(16)).setAttribute("nombre","capaFormularios" );
   ...
   private void getXML450(Document doc) {
      ...
      ((Element)v.get(128)).setAttribute("ancho","632" );
      ((Element)v.get(128)).setAttribute("alto","295" );
      ((Element)v.get(128)).setAttribute("x","24" );
      ((Element)v.get(128)).setAttribute("y","146" );
      ...
      ((Element)v.get(136)).setAttribute("cod","00133" );
   ...
   private void getXML540(Document doc) {
      ...
      v.add(doc.createElement("COL"));
      ((Element)v.get(143)).setAttribute("ancho","80" );
      ...
      ((Element)v.get(145)).setAttribute("cod","1556" );
      ...
      ((Element)v.get(146)).setAttribute("cod","136" );
      ...
      ((Element)v.get(147)).setAttribute("cod","673" );
      ...
      ((Element)v.get(148)).setAttribute("cod","1216" );
      ...
      ((Element)v.get(149)).setAttribute("cod","573" );
      ...
      ((Element)v.get(150)).setAttribute("cod","668" );
      ...
      ((Element)v.get(151)).setAttribute("maxSel","0" );
   ...
   private void getXML630(Document doc) {
      ...
      ((Element)v.get(161)).setAttribute("x","64" );
      ((Element)v.get(161)).setAttribute("y","444" );
      ...
      ((Element)v.get(162)).setAttribute("x","32" );
      ((Element)v.get(162)).setAttribute("y","444" );
      ...
      /* Empieza nodo:163 / Elemento padre: 6   */
      v.add(doc.createElement("BOTON"));
      ((Element)v.get(163)).setAttribute("nombre","separa" );
      ((Element)v.get(163)).setAttribute("x","71" );
      ...
      ((Element)v.get(6)).appendChild((Element)v.get(163));
      /* Termina nodo:163   */
      /* Termina nodo:6   */
