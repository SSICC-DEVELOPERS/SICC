 ...
 * Componente:    LPModificaCronograma 
 * Fecha:             14/06/2004
 * Observaciones:     
 * @version        1.0
 * @autor           Luis Ramos
...
public class LPModificaCronograma extends LPSICCBase {

	public LPModificaCronograma() {
		super();
	}
    ...
    setTrazaFichero();
      ...
      if (mAccion.equals("")) {
          ...
          conectorActionParametro("accion","muestraModificaCronograma");
