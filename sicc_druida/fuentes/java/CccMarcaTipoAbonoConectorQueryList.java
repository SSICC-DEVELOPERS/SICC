...
public class CccMarcaTipoAbonoConectorQueryList  implements es.indra.druida.base.ObjetoXML {
...
/* Primer nodo */
   ...
   private void getXML0(Document doc) {
      ...
      ((Element)v.get(0)).setAttribute("OBSERVACIONES","Conector para la consulta sobre la entidad CccMarcaTipoAbono" );
      ...
      ((Element)v.get(2)).setAttribute("NOMBRE","MMGCccMarcaTipoAbonoQueryID" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(3)).setAttribute("NOMBRE","MMGCccMarcaTipoAbonoQueryDTO" );
      ...
      ((Element)v.get(5)).setAttribute("FORMATO","CccMarcaTipoAbonoListFormatter" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(7)).setAttribute("NOMBRE","valObse" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(8)).setAttribute("NOMBRE","masiOidMarcSali" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(9)).setAttribute("NOMBRE","taspOidTipoAbonSubp" );
      ...
      v.add(doc.createElement("CAMPO"));
      ((Element)v.get(10)).setAttribute("NOMBRE","indEntrSali" );
